...
`}function oe(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}const _=e=>Object.prototype.toString.call(e??0).slice(8,-1),ae=e=>_(e)=="Object",z=Object.getPrototypeOf,R=e=>["Object","Array"].includes(_(e));function ne(){let e;const r=new Set,t=c=>c.__isState;let o=c=>t(c)?c._val:c,a=c=>t(c)?c.oldVal:c,n=c=>c.map(o);function s(c){e||(e=window.requestAnimationFrame(()=>{c(),e=void 0}))}const i=()=>s(()=>r.forEach(c=>c.bindings=c.bindings.filter(f=>{var v;return(v=f.dom)==null?void 0:v.isConnected})));let l=c=>{var f;for(let v of c.bindings){let{deps:w,dom:x,render:T,renderItem:k}=v;const A=n(w);if(k&&c.arrayOp)(f=d({...c.arrayOp,dom:x,renderDomItem:C=>p(k({deps:A})(C))})[c.arrayOp.method])==null||f.call(),i();else{let C=T({dom:x,oldValues:w.map(a),renderItem:k})(...A);C!==x&&(C!=null?x.replaceWith(v.dom=p(C)):(x.remove(),v.dom=void 0))}}c.arrayOp=null};const m=({state:c,data:f,parentProp:v=[]})=>({get(w,x,T){var k;if(x==="_isProxy")return!0;if(!((k=w[x])!=null&&k._isProxy)&&R(w[x]))w[x]=new Proxy(w[x],m({state:c,data:f,parentProp:[...v,x]}));else if(["splice","push","pop","shift","unshift"].includes(x)){const A=w[x];return(...C)=>{const I=A.apply(w,C);return c.arrayOp={method:x,args:C},l(c),I}}return Reflect.get(w,x,T)},set(w,x,T,k){const A=Reflect.set(w,x,T,k);return c.arrayOp={method:"setItem",args:{prop:x,value:T},newTarget:w,parentProp:[...v,x],data:f},l(c),A}}),u=(c,f)=>new Proxy(f,m({state:c,data:f})),d=({dom:c,parentProp:f,args:v,depsValues:w,renderDomItem:x,data:T})=>({assign:()=>c.replaceChildren(...v.map(x)),setItem:()=>{const k=f[0],A=c.children[k],C=T[k];A&&A.replaceWith(x(C))},push:()=>c.append(...v.map(x)),pop:()=>c.lastChild&&c.removeChild(c.lastChild),shift:()=>c.firstChild&&c.removeChild(c.firstChild),unshift:()=>{const k=x(v[0],w);c.firstChild?c.firstChild.before(k):c.appendChild(k)},splice:()=>{const[k,A,...C]=v;for(let I=Math.min(k+A-1,c.children.length-1);I>=k;I--)c.children[I].remove();if(C.length>0){const I=C.forEach(x);c.children[k]?c.children[k].after(I):c.append(...I)}}});let h=c=>({oldVal:c,bindings:[],arrayOp:null,__isState:!0,get _val(){const f=this;return f.valProxy??(f.valProxy=R(c)?u(f,c):c,f.valProxy)},set _val(f){this.valProxy=f},get val(){return this._val},set val(f){let v=this,w=v._val;R(f)?(v._val=u(v,f),v.arrayOp={method:"assign",args:f},l(v)):f!==w&&(v._val=f,l(v)),v.oldVal=w}}),p=c=>c.nodeType?c:new Text(c),b=(c,...f)=>{if(f.length==0)return c;const v=[];for(let w of f.flat(1/0))w!=null&&v.push(t(w)?$({deps:[w],render:()=>x=>x}):p(w));return c.append(...v),c};const g={},y=(c,f)=>c?Object.getOwnPropertyDescriptor(c,f)??y(z(c),f):void 0,S=(c,f,v)=>{var w;return g[c+","+f]??(g[c+","+f]=((w=y(v,f))==null?void 0:w.set)??0)},E=c=>new Proxy(function(v,...w){let[x,...T]=ae(w[0])?w:[{},...w],k=c?document.createElementNS(c,v):document.createElement(v);for(let[A,C]of Object.entries(x)){let I=S(v,A,z(k))?B=>k[A]=B:B=>k.setAttribute(A,B);C==null||(t(C)?$({deps:[C],render:()=>B=>(I(B),k)}):C.renderProp?$({deps:C.deps,render:({})=>(...B)=>(I(C.renderProp({dom:k})(...B)),k)}):I(C))}return b(k,...T)},{get:(f,v)=>f.bind(void 0,v)});let $=({deps:c,render:f,renderItem:v})=>{const w=f({renderItem:v})(...n(c));if(w!=null){const x=p(w),T={deps:c,render:f,renderItem:v,dom:x};for(let k of c)t(k)&&(r.add(k),k.bindings.push(T));return x}};return{tags:E(),tagsNS:E,state:h,bind:$}}const se=e=>{let r=0,t=11;for(;r<e.length;)t=101*t+e.charCodeAt(r++)>>>0;return"bau"+t},ie=(e,r,t)=>{const o=document.createElement("style");o.id=r,o.appendChild(new Text(t)),e.appendChild(o)},le=(e,r)=>e.reduce((t,o,a)=>t+o+(r[a]??""),"");function ce({target:e=document.head}={}){const r=t=>(o,...a)=>{const n=le(o,a),s=se(n);return!document.getElementById(s)&&ie(e,s,t(s,n)),s};return{css:r((t,o)=>`.${t} { ${o} }`),keyframes:r((t,o)=>`@keyframes ${t} { ${o} }`),createGlobalStyles:r((t,o)=>o)}}function de(e={}){return{bau:ne(),...ce(),tr:r=>r,...e}}function M(...e){return e.filter(r=>r).join(" ")}function P(e,r={}){const{bau:t,css:o}=e;t.tags;const a={root:o`
    ...
    `};return function(s,...i){const{fullWidth:l,label:m,primary:u,accent:d,raised:h,disabled:p,ripple:b,href:g,icon:y,...S}=s;return(g?t.tags.a:t.tags.button)({...S,class:M(a.root,g?a.a:a.button,h?a.raised:a.flat,!h&&u&&a.flatPrimary,!h&&d&&a.flatAccent,h&&u&&a.raisedPrimary,h&&d&&a.raisedAccent,b&&a.rippledisabled&&a.disabled,p&&h&&a.raisedDisabled,l&&a.fullWidth,s.class),href:g,...!g&&{type:"button"}},i)}}const ue=()=>[{name:"Alert",id:"alert"},{name:"Alert Stack",id:"alert-stack"},{name:"Avatar",id:"avatar"},{name:"Button",id:"button"},{name:"Checkbox",id:"checkbox"},{name:"Drawer",id:"drawer"},{name:"File Input",id:"file-input"},{name:"Form",id:"form"},{name:"Input",id:"input"},{name:"Modal",id:"modal"},{name:"Spinner",id:"spinner"},{name:"Switch",id:"switch"},{name:"Tabs",id:"tabs"},{name:"TreeView",id:"treeview"}];function pe(e){const{tr:r,bau:t,css:o}=e,{ul:a,li:n,nav:s,a:i}=t.tags;return function(){return s({class:o`
        ...
        `},a(ue().map(({name:m,id:u})=>n(i({href:`#${u}`},m)))))}}function me(e){const{tr:r,bau:t,css:o}=e,{i:a,header:n,h1:s,div:i,a:l}=t.tags,{svg:m,path:u}=t.tagsNS("http://www.w3.org/2000/svg"),d=t.state(!0),h=P(e),p=pe(e),b=()=>a({class:o`
          color: var(--font-color-inverse);
        `},m({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},u({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),g=()=>i({class:o`
          display: flex;
          justify-content: flex-start;
          align-items: center;
          background-color: var(--color-primary);
          color: var(--font-color-inverse);
        `},h({onclick:()=>d.val=!d.val},b()),s(r("Bau Components Story Book")));return function(){return n(g(),p())}}const be=e=>{const{bau:r,css:t}=e,{div:o}=r.tags,a=me(e);return function({component:s}){return o({class:t`
          display: grid;
...
`,{base:e`
 ...
 `}),we=e=>{const{tr:r,bau:t,keyframes:o}=e,{section:a,div:n,h3:s}=t.tags,i=ve(),l=P(e),m=ye({keyframes:o});return function(){const u=t.state(!0),d=a({id:"animate"});return d.appendChild(n(s("Test Animate"),n(l({onclick:()=>{u.val=!u.val}},t.bind({deps:[u],render:()=>h=>h?"Hide":"Show"}))),n(t.bind({deps:[u],render:()=>h=>h?i({parent:d,Component:()=>n("Ciao"),animationHide:`${m.hideRight} 0.5s`,animationShow:`${m.showRight} 0.5s`}):""})))),d}};function xe(e,r={}){const{bau:t,css:o}=e,{cssOverride:a}=r,{span:n,img:s}=t.tags,i=t.state(!0),l=t.state(!1),m=()=>i.val=!1,u=d=>{i.val=!1,l.val=!0};return function({width:h=60,height:p=60,...b},...g){return n({class:M(a)},t.bind({deps:[i],render:()=>y=>y?"Loading...":""}),t.bind({deps:[l],render:()=>y=>y?"Error":""}),s({width:h,height:p,onload:m,onerror:u,...b}))}}const ke=e=>{const{tr:r,bau:t,css:o}=e,{section:a,h2:n}=t.tags,s=xe(e,{cssOverride:o`
  ...
  `},m={stack:a`
    ...
    `},u=p=>s({class:m.item,onclick:()=>d.remove(p)},p.component()),d=(p,...b)=>s({class:m.stack},o.bind({deps:[i],render:({renderItem:g})=>y=>s(y.map(g())),renderItem:()=>u}));d.add=({component:p})=>{const b={id:Math.random().toString(10).split(".")[1],component:p,status:"inserting"};i.val.length>=r&&d.remove({id:i.val[0].id}),i.val.push(b),setTimeout(()=>d.remove(b),t)};const h=({id:p,status:b})=>{const g=i.val.findIndex(y=>y.id===p);g!=-1&&(i.val[g].status=b)};return d.remove=({id:p})=>{h({id:p,status:"removing"});const b=i.val.findIndex(g=>g.id===p);b!=-1&&i.val.splice(b,1)},d},Ce=e=>{const{tr:r,bau:t}=e,{section:o,h1:a}=t.tags,n=Se(e),s=P(e),i=W(e);return function(){return o({id:"alert-stack"},n(),a("Alert stack"),s({raised:!0,onclick:m=>{n.add({component:()=>i({severity:"success"},r("Infrastructure Created"))})}},"success alert"))}},Ee=e=>{const{tr:r,bau:t,css:o}=e,{section:a,p:n,h2:s,h3:i}=t.tags,l=P(e);return()=>a({id:"button",class:o`
          & button {
            margin: 0.5rem;
          }
  ...
  `;return function({openState:s},...i){return o({class:a},o({class:{deps:[s],renderProp:()=>l=>M("overlay",l&&"overlay-open")}}),o({class:{deps:[s],renderProp:()=>l=>M("content",l&&"content-open")}},...i))}}const Ie=e=>{const{tr:r,bau:t}=e,{section:o,div:a,h3:n,h2:s}=t.tags,i=t.state(!1),l=Te(e),m=P(e);return()=>o({id:"drawer"},s(r("Drawer")),m({raised:!0,onclick:()=>{i.val=!i.val}},"OPEN DRAWER"),l({openState:i},"Drawer Content"))};function Me(e,r={}){const{bau:t,css:o}=e,{div:a,span:n,label:s,input:i}=t.tags,l={base:o`
    ...
    `};return function(u,...d){const{Component:h,disabled:p,...b}=u;return a({class:M(l.base,p&&l.disabled)},s(h({disabled:p}),i({type:"file",disabled:p,...b})),n({class:"filename-display"}))}}const N=window._SVG_SPRITE_IDS_=window._SVG_SPRITE_IDS_||[],D=document.createElementNS("http://www.w3.org/2000/svg","svg");D.style.position="absolute";D.style.width="0";D.style.height="0";function F(){document.body.insertBefore(D,document.body.firstChild)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",F):F();function Pe(e,r){(N.indexOf(r)>-1||document.getElementById(r))&&console.warn(`Icon #${r} was duplicately registered. It must be globally unique.`),N.push(r),D.insertAdjacentHTML("beforeend",e)}Pe('<symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 294.156 294.156" id="icon-uploadIcon-13ee25"><path d="M227.002 108.256c-2.755-41.751-37.6-74.878-80.036-74.878-42.447 0-77.298 33.141-80.038 74.907C28.978 113.059 0 145.39 0 184.184c0 42.234 34.36 76.595 76.595 76.595h116.483a6 6 0 0 0 0-12H76.595C40.977 248.778 12 219.801 12 184.184c0-34.275 26.833-62.568 61.087-64.411a6 6 0 0 0 5.668-6.346c.09-37.536 30.654-68.049 68.211-68.049 37.563 0 68.132 30.518 68.211 68.063a6 6 0 0 0 5.687 6.321c34.37 1.741 61.292 30.038 61.292 64.421 0 19.526-8.698 37.801-23.864 50.138a5.999 5.999 0 0 0-.868 8.44 5.999 5.999 0 0 0 8.44.868c17.98-14.626 28.292-36.293 28.292-59.447 0-38.913-29.076-71.256-67.154-75.926z" /><path d="M140.966 141.078v76.511a6 6 0 0 0 12 0v-76.511a6 6 0 0 0-12 0z" /><path d="M181.283 152.204a6 6 0 0 0 4.243-10.242l-34.317-34.317a6 6 0 0 0-8.485 0l-34.317 34.317a6 6 0 0 0 8.485 8.485l30.074-30.074 30.074 30.074a5.986 5.986 0 0 0 4.243 1.757z" /></symbol>',"icon-uploadIcon-13ee25");const Be="icon-uploadIcon-13ee25",De=e=>{const{tr:r,bau:t,css:o}=e,{svg:a,use:n}=t.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:i,h3:l,h2:m,span:u}=t.tags,d=t.state("No file selected"),h=Me(e),p=g=>{const y=g.target.files[0];y?d.val=y.name:d.val="No file selected"},b=({disabled:g})=>i({class:M(o`
          ...
          `,g&&o`
            ...
            `)},a(n({href:`#${Be}`})),u(r("Choose a file to upload")));return()=>s({id:"fileInput"},m(r("FileInput Examples")),l("File Input"),h({Component:b,name:"file",accept:"text/*",onchange:p}),i("File selected: ",d),l("File Input disabled"),h({Component:b,name:"file",accept:"text/*",disabled:!0,onchange:p}))},Le=({css:e,createGlobalStyles:r})=>(r`
:root {
...
`,{base:e`
  ...
  `;return function({open:i},...l){return a({class:n},...l)}}const Ne=e=>{const{tr:r,bau:t}=e,{section:o,div:a,main:n,h3:s,h2:i,header:l,footer:m,p:u}=t.tags,d=P(e),h=ze(e),p=()=>n(Array(10).fill("").map((g,y)=>u(y+1,". "))),b=h({id:"my-dialog"},l("Header"),p(),m(d({onclick:()=>{b.close()}},"Cancel"),d({primary:!0,raised:!0,onclick:()=>{b.close()}},"OK")));return()=>o({id:"modal"},i(r("Modal Examples")),d({raised:!0,onclick:()=>{b.showModal()}},"OPEN MODAL"),b)};function Fe(e,r={}){const{bau:t,css:o}=e,{svg:a,animate:n,animateTransform:s,rect:i}=t.tagsNS("http://www.w3.org/2000/svg");return function({size:m=36,color:u="primary",visibility:d=!0}={}){return a({class:o`
  ...
  `;return function({id:i,...l},...m){return a({class:n,type:"checkbox",required:"required",id:i,...l})}}const _e=e=>{const{tr:r,bau:t,css:o}=e,{section:a,form:n,label:s,div:i,h2:l}=t.tags,m=je(e);return()=>a({id:"switch"},l(r("Switch Examples")),n(i({class:o`
            ...
            `},s({for:"my-switch"},"My shinny switch"),m({id:"my-switch"}))))};function H(e,{tabDefs:r}){const{bau:t,css:o}=e,{div:a,ul:n,li:s}=t.tags,i=t.state(r),l=t.state(r[0]),m=d=>i.val.find(h=>h.name==d),u={base:o`
      display: flex;
      flex-direction: column;
      & ul {
        display: flex;
    ...
    `};return function(h,...p){const b=y=>{const{Header:S,disabled:E,name:$}=y;return s({class:{deps:[l],renderProp:()=>c=>M(c.name==$&&"active",E&&"disabled")},onclick:c=>c.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:$},bubbles:!0}))},S(y))},g=a({class:M(u.base,h.class)},t.bind({deps:[i],render:({renderItem:y})=>S=>n(S.map(y())),renderItem:()=>b}),t.bind({deps:[l],render:()=>({Content:y})=>y?y({}):""}));return g.addEventListener("tab.select",y=>{var $,c;const{tabName:S}=y.detail,E=m(S);E&&(($=l.val.exit)==null||$.call(),l.val=E,(c=E.enter)==null||c.call())},!1),g.addEventListener("tab.add",y=>{var E;const{tab:S}=y.detail;(E=S.enter)==null||E.call(),i.val.push(S)},!1),g.addEventListener("tab.remove",y=>{var E;const S=i.val.findIndex($=>$.name==y.detail.tabName);S>0&&((E=i.val[S].exit)==null||E.call(),i.val.splice(S,1))},!1),g}}const Ve=e=>{const{tr:r,bau:t,css:o}=e,{section:a,div:n,h3:s,h2:i,p:l,i:m}=t.tags,u=(...S)=>n({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...S),d=()=>({name:"New Tab",Header:({name:S})=>n(S),Content:()=>n("My Paragraph")}),h=P(e),b=H(e,{tabDefs:[{name:"Tab1",Header:({})=>n("TAB 1"),Content:({})=>n(l("My Tab 1 Content"))},{name:"Tab2",Header:({tab:S})=>n("TAB 2"),Content:({})=>n(l("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:({})=>n("Tab Disabled")}]}),y=H(e,{tabDefs:[{name:"Tab1",Header:({store:S})=>n(m({class:o`
                font-size: 1rem;
                margin: 0 0.3rem;
