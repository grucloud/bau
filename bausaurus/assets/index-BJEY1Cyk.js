import { b as button, g as globalStyle, h as header, f as footer, c as createContext, m as mountApp } from "./utils-BdvSFzeB.js";
(function polyfill() {
...
img  {
  ...
  const className = css`
    ...
    grid-template-columns: minmax(15%, 200px) minmax(50%, 70%) minmax(
        20%,
        350px
      );
