...
const toc = { "children": [] };
const breadcrumbs = [{ "name": "Configuration", "href": "/bau/bausaurus/docs/Configuration" }];
const paginationNav = { "previous": { "name": "Commands", "href": "/bau/bausaurus/docs/Commands" }, "next": { "name": "Markdown", "href": "/bau/bausaurus/docs/Markdown" } };
...
<pre><code class="language-js hljs" data-code="import docApp from &quot;./src/appDoc/DocApp.js&quot;;
...
" style="position: relative;"><span class="hljs-keyword">import</span> docApp <span class="hljs-keyword">from</span> <span class="hljs-string">"./src/appDoc/DocApp.js"</span>;
