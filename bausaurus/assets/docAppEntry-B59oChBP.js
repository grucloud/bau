import { i as inBrowser, a as isProd, p as pathFromLocation, g as globalStyle, t as toPropsAndChildren, b as button, h as header, f as footer, c as createContext, m as mountApp } from "./utils-DXF4jtzJ.js";
const docPath = "/docs/";
...
function animate(context2, options = {}) {
  const { bau, window } = context2;
  const { div } = bau.tags;
  const noop = () => void 0;
  return function Animate({ animationHide = noop, animationShow = noop, ...props }, child) {
    return div(
      {
        class: ["animate", options == null ? void 0 : options.class, props.class],
    ...
    return ul(
      {
        ...
        class: [
          ...
          size,
          options == null ? void 0 : options.class,
          props == null ? void 0 : props.class.join(" ")
        ]
      },
      ...children
    );
...
function drillDownMenu(context2, options = {}) {
  ...
  const pathFromHref = ({ target }) => {
    let path = `${target.closest("a").pathname.replace(".md", "").replace(baseUrl, "")}${target.hash}`;
    if (!hashBased) {
...
function breadcrumbs(context2, options = {}) {
  ...
  return function Breadcrumbs(...args) {
    ...
    return ul(
      {
        ...props,
        class: [className, options == null ? void 0 : options.class, props == null ? void 0 : props.class]
      },
      items.map(
        ({ href, name }) => li(
          (href != void 0 ? Button : span)(
            {
              href: `${config.base}${href}`,
              color,
              variant,
