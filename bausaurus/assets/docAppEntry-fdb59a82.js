import { i as inBrowser, a as isProd, p as pathFromLocation, g as globalStyle, b as button, d as classNames, t as toPropsAndChildren, h as header, f as footer, c as createContext, m as mountApp } from "./utils-7f798357.js";
...
function drillDownMenu(context2, options) {
  ...
  const renderMenuItemDefault = ({ name, href }) => a(
    {
      href: `${base}${href}`
    },
    name
