import { i as inBrowser, a as isProd, p as pathFromLocation, g as globalStyle, t as toPropsAndChildren, d as classNames, b as button, h as header, f as footer, c as createContext, m as mountApp } from "./utils-d4ce76ed.js";
...
function drillDownMenu(context2, options = {}) {
      ...
      (subTree) => li(
        {
          class: () => classNames(
            ...
            isActive({ pathname: pathnameState2.val, subTree }) && "active"
          )
        },
  ...
  const Menu = ({ variant, color, size, currentTree, pathnameState: pathnameState2 }) => {
    ...
    return div(
      ...
      children && renderList ? renderList({
        ...
        color,
        size
      }) : renderListDefault({ children, pathnameState: pathnameState2, variant, color, size })
    );
  };
  ...
  window.document.addEventListener("click", (event) => {
    ...
    if (target.tagName === "A" && href && !href.startsWith("http") && !href.startsWith("#") && !href.startsWith("?")) {
