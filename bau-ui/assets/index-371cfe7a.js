...
`);function V(e,t={}){const{bau:n,css:o}=e,a=o`
    ...
    ${So()}
  `;return function(...s){let[{size:r=t.size??"md",variant:c=t.variant??"none",color:l=t.color??"none",href:u,...d},...p]=W(s);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:M("button",t.class,c,r,l,a,d.class),href:u},p)}}const Co="light",Eo=()=>ee.map(e=>`
...
`);function at(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Co);const l=o`
    ...
    ${Eo()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:f=t.color??"neutral",...h},...w]=W(d);return i({required:"required",title:"Switch Theme",...h,class:M("theme-switch",f,g,p,l,t==null?void 0:t.class,h.class),type:"checkbox",checked:r()=="dark",onclick:v=>{s(v.target.checked?"dark":"light")}},...w)}}function ko(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:g,li:f}=n.tags,{svg:h,path:w}=n.tagsNS("http://www.w3.org/2000/svg"),v=i.drawerOpen,x=V(e,{class:o`
    ...
    `}),S=at(e),k=()=>s(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},w({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),A=()=>l({class:o`
        ...
        `},A(),$())}}function To({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:d}=t.tags,p=({links:h,title:w})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},u({class:n`
          ...
          `},p({title:"Bau UI",links:g}),p({title:"Bau Ecosystem",links:f})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},i("v0.47.3"),i("MIT license")))}}function Ce(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:e`
   ...
   `});function rt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=R=>{var y;return((y=R.parentTree.data)==null?void 0:y.href)??R.parentTree.children[0].data.href},u=({variant:R,color:y,size:m,currentTree:b,data:C})=>S(T({variant:R,color:y,size:m,href:`${c}${l(b)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),T({variant:R,color:y,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
    ...
    `}),{hideToLeft:I,hideToRight:D}=Ao(e),_=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,F=({children:R,pathnameState:y,variant:m,color:b,size:C})=>$({class:M(m,b,C)},R.map(E=>w({class:()=>M(E.children&&"has-children",h({pathname:y.val,subTree:E})&&"active")},f({variant:m,color:b,size:C,subTree:E})))),te=({variant:R,color:y,size:m,currentTree:b,pathnameState:C})=>{const{children:E,parentTree:O,data:B,renderList:G}=b;return x({class:M("drillDownMenu",R,y,m)},O&&g({variant:R,color:y,size:m,data:B,currentTree:b}),E&&G?G({renderListDefault:F,children:E,pathnameState:C,variant:R,color:y,size:m}):F({children:E,pathnameState:C,variant:R,color:y,size:m}))},K=({tree:R,pathname:y})=>{let m=_t({})({...R}),b=Lt(y)(m);return b||(b=m),b},J=n.state(a.location.pathname.replace(c,""));return a.document.addEventListener("click",R=>{const{target:y}=R,m=y.getAttribute("href");if(y.tagName==="A"&&m&&!m.startsWith("http")&&!m.startsWith("#")){let b=m.replace(c,"");r||(b=b.replace(y.hash,"")),J.val=b}}),function(y){const{size:m=t.size??"md",variant:b=t.variant??"plain",color:C=t.color??"neutral",tree:E,...O}=y;let B,G=n.derive(()=>(B=K({tree:E,pathname:J.val}),B)),z=1;const L=Q=>{const{dataset:ae}=Q.target;ae.buttonback=="true"?z=-1:ae.ischild=="false"?z=1:ae.ischild=="true"&&(z=0)},X=Q=>{switch(Q){case 1:return`${I} ${ze}`;case-1:return`${D} ${ze}`;default:return""}},ne=Q=>{switch(Q){case 1:return`${D} ${ze} reverse`;case-1:return`${I} ${ze} reverse`;default:return""}};return v({class:M(_,b,C,m,t==null?void 0:t.class,O.class),onclick:L},A({animationHide:()=>X(z),animationShow:()=>ne(z)},n.bind({deps:[G],render:()=>()=>te({variant:b,color:C,size:m,currentTree:B,pathnameState:J})})))}}const Io=()=>ee.map(e=>`
&.input.${e} {
...
`);function ve(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(r){const{variant:c=t.variant??"outline",color:l=t.color??"neutral",...u}=r;return a({type:"text",...u,class:M("input",t.class,t.size??"md",l,c,i,u.class)})}}function st(e,t={}){const{bau:n,css:o,window:a}=e,i=ve(e,t);return function(r){const{variant:c=t.variant??"outline",color:l=t.color??"neutral",...u}=r,p=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(c=="solid"?"--font-color-inverse-secondary":`--color-${l}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,g=o`
    ...
    `;return i({type:"search",...u,color:l,variant:c,class:M("inputSearch",t.class,g,u.class)})}}function zt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:d,span:p}=n.tags,g=st(e,{variant:"plain",color:"neutral",size:"sm"}),h={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:k,variant:A,color:$,size:T})=>{const I=n.state(""),D=n.derive(()=>I.val==""?S:S.filter(F=>F.data.name.match(new RegExp(`${I.val}`,"i")))),_=F=>{I.val=F.target.value};return r({class:o`
        ...
        `},g({autocomplete:!1,name:"search",autofocus:!0,value:I,placeholder:`Search ${D.val.length} components`,size:22,oninput:_}),()=>x({children:D.val,pathnameState:k,variant:A,color:$,size:T}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let w=!1;const v=rt(e);return function(){return r({bauMounted:({element:S})=>{s.innerWidth<=640&&(w=!0,i.drawerOpen.val=!1)},onclick:S=>{w&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:M(o`
          ...
          `)},v({tree:h}))}}const Do=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:i}=t.tags,s=Ge(e),r=ko(e),c=zt(e),l=To(e),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:d,...p},...g]=W(r);return a({...p,onclick:d,class:M("chip",t.class,c,l,u,d&&"clickable",i,p.class)},...g)}}function No(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;V(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function $o({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,d=({maxSize:p=151})=>({libName:g,size:f})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},g.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Bo(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=No(e),l=Mo(e),u=V(e);Ue(e);const d=$o(e),p=(...v)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=W(r);return a({...d,class:M("paper",c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}function tn(e,t={}){const{bau:n,css:o,window:a}=e,{nav:i,ul:s,li:r,a:c}=n.tags,{headerSelector:l="h2,h3"}=t,u=n.state("no"),d=(w,v)=>{let x=null;return(...S)=>{a.clearTimeout(x),x=a.setTimeout(()=>w(...S),v)}},p=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,g=({value:w,id:v,children:x=[]})=>{const S=c({class:()=>u.val==v?"active":"",href:`#${v}`});return S.innerHTML=w,r({class:()=>u.val==v?"active":""},S,x.length>0&&s(x.map(g)))},f=w=>w.tagName.charAt(1),h=({contentEl:w})=>{const v=w.querySelectorAll(l);let x=2,S={},k={children:[]},A=k;const $=A;let T=[A];return[...v].forEach(I=>{const D=f(I);I.setAttribute("id",I.textContent),!I.innerHTML.includes("<button")&&(S={value:I.innerHTML,id:I.id??I.textContent,children:[]},x==D?(k=S,A.children.push(k)):x<D?(T.push(A),A=k,k.children.push(S),k=S):x>D&&(A=T[D-1],T=T.slice(0,D-1),A.children.push(S),k=S),x=D)}),$};return function(...v){let[{size:x=t.size??"md",variant:S=t.variant??"plain",color:k=t.color??"neutral",contentEl:A,...$}]=W(v);const T=h({contentEl:A}),I=d(()=>{const _=[...A.querySelectorAll(l)].find(F=>{const{top:te,height:K}=F.getBoundingClientRect();if(te+K>60)return!0});_&&(u.val=_==null?void 0:_.id)},100);return i({...$,class:M("tableOfContent",x,S,k,p,t==null?void 0:t.class,$==null?void 0:$.class),bauMounted:()=>{a.addEventListener("scroll",I)},bauUnmounted:()=>{a.removeEventListener("scroll",I)}},T.children&&s(T.children.map(g)))}}const nn=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
    ...
    `}),f=nn(e),h=za(e),w=({text:v})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:x})=>{x.innerHTML=Te.highlight(v,{language:"js"}).value}}));return function(x){const S=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},s(x.title),r(x.description),x.gridItem&&[c("Variant/Color"),!x.variantColorTableDisable&&x.gridItem&&g(f({Item:x.gridItem(e)})),c("Size"),r("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),x.gridItem&&g(h({item:x.gridItem}))],c("Usage"),l("Import"),w({text:x.importStatement}),c("Examples"),x.examples.map(k=>i(l(k.title),r(k.description),g(k.createComponent(e)({})),w({text:k.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
...
`);function We(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${Ra()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:f=t.color??"neutral",data:h=[],...w}]=W(d);const v=n.state(""),x=dt(e,{size:p,variant:g,color:f}),S=A=>$=>{v.val==A?v.val="":v.val=A},k=A=>{const{Header:$,Content:T,name:I}=A,D=()=>r({class:()=>M(v.val==I&&"active")},c({type:"button","aria-controls":`bau-${I}`,"aria-expanded":({element:F})=>v.val==I},$(A))),_=()=>a({id:`bau-${I}`,"data-state":({element:F})=>v.val==I},T(A));return s({class:M(f,g,p),onclick:S(I)},x({Header:D,Content:_}))};return a({class:M("accordion",l,t==null?void 0:t.class,w.class)},i(h.map(k)))}}const on=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],s=We(e,t);return r=>s({...r,data:i})},ja=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=We(e);return()=>i({data:a,color:"neutral",variant:"outline"})},Ha=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,rr={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:ar,createComponent:or}]},sr=e=>{const t=H(e);return()=>t(rr)},ir=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=Ge(e),s=V(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`,dr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:cr,createComponent:ir},{title:"Component hide and show",description:"Hide and show a component",code:ur,createComponent:lr}]},pr=e=>{const t=H(e);return()=>t(dr)};function sn(e,t={}){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:f=t.variant??"plain",color:h=t.color??"neutral",width:w=40,height:v=40,...x},...S]=W(p);return a({class:M(u,t==null?void 0:t.class,x.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:w,height:v,onload:c,onerror:l,class:M(h,f,g,u,t==null?void 0:t.class,x.class),...x}))}}const cn=(e,t)=>{const{css:n}=e,o=sn(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
100% {
  ...
  `;return function({size:u=t.size??"md",color:d=t.color??"primary",variant:p=t.variant??"outline",visibility:g=!0,...f}={}){const h=o`
      ...
      ${fr()}
    `;return i({class:{deps:[g],renderProp:()=>w=>M("spinner",h,d,p,w==!1?"":"visibility",t==null?void 0:t.class,f.class)},version:"1.1",x:"0px",y:"0px",width:je[u],height:je[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...f},s({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const vr=()=>ee.map(e=>`
...
`);function mt(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${vr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",label:p,placeholder:g,Option:f,options:h,getOptionLabel:w=({label:Y})=>Y,onSelect:v=()=>{},id:x,required:S,name:k,loading:A,...$},...T]=W(c);const I=pt(e),D=V(e),_=ve(e,{variant:u,color:d,size:l}),F=Ce(e),te=Me(e,{variant:u,color:d,size:l}),K=n.state($.value);n.derive(()=>{K.val&&(ae.value=w(K.val),v(K.val))});const J=n.state(""),R=n.state(!1),y=n.state(0),m=()=>{R.val=!1},b=n.state(h),C=Y=>se=>Y.val&&w(se)==w(Y.val),E=()=>{me.openDialog(),R.val=!0,J.val="",b.val=h,y.val=h.findIndex(C(K));const Y=pe.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),Q.scrollIntoView({block:"end"}))},O=()=>{me.closeDialog(),R.val=!1,J.val="",y.val=0},B=Y=>{const{value:se}=Y.target;J.val=se,se?b.val=h.filter(ge=>w(ge).match(new RegExp(`${se}`,"i"))):b.val=h},G=Y=>{me.open?O():E()},z=({option:Y,index:se})=>ge=>{K.val=Y,y.val=se,O()},L=()=>{const Y=pe.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},X=Y=>{switch(Y.key){case"Escape":O();break;case"ArrowDown":y.val<b.val.length-1?y.val++:y.val=0,L();break;case"ArrowUp":y.val<=0?y.val=b.val.length-1:y.val--,L();break;case"Enter":me.open?(K.val=b.val[y.val],J.val="",O()):E(),Y.preventDefault();break}},ne=D({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":R,"aria-label":p,onclick:G,variant:u,color:d,size:l,class:A==!0&&"loading",disabled:A},()=>K.val?w(K.val):p,()=>A==!0&&te({visibility:A})),Q=_({value:J,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":R,oninput:B,onkeydown:X,...$}),ae=_({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,value:J,required:S,name:k}),pe=a({class:M(u,d,l,"content")},Q,()=>F({class:M(u,d,l)},b.val.map((Y,se)=>i({class:()=>M(y.val==se&&"active",C(K)(Y)&&"selected"),onclick:z({option:Y,index:se})},f(Y))))),me=I({id:x,triggerEl:ne,contentEl:pe,onClose:m,class:o`
        overflow: hidden;
      `});return a({...$,class:M("autocomplete",s,t==null?void 0:t.class,$==null?void 0:$.class)},ne,ae,me)}}const ln=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=mt(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ar={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Tr,createComponent:kr}],gridItem:dn},Ir=e=>{const t=H(e);return()=>t(Ar)};function gt(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,{separator:c="〉"}=t,l=V(e),u=o`
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:f=t.variant??"plain",color:h=t.color??"neutral",items:w,...v},...x]=W(p);return i({...v,class:M(u,t==null?void 0:t.class,v==null?void 0:v.class)},w.map(({href:S,name:k})=>s((S?l:r)({href:`${a.base}${S}`,color:h,variant:f,size:g,class:M(h,f,g)},k))))}}const pn=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=gt(e,t);return a=>o({...a,...n})},Dr=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=gt(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},Nr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,Lr=e=>{const{bau:t}=e,{section:n}=t.tags,o=V(e),a=()=>{alert("Click")};return()=>n(o({disabled:!0,color:"primary",variant:"outline",onclick:a},"Click me"))},zr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`);function bt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${Hr()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=W(r);return a({...d,class:M("button-group",l,u,c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const gn=(e,t)=>{const n=["ONE","TWO","THREE"],o=V(e,t),a=bt(e,t);return i=>a({...i},n.map(s=>o(i,s)))},Gr=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=V(e),i=bt(e),s="primary",r="solid";return()=>n(i({color:s,variant:r},o.map(c=>a({color:s,variant:r},c))))},Ur=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,qr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Kr,createComponent:Vr}],gridItem:hn},Xr=e=>{const t=H(e);return()=>t(qr)};function Zr(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:g,Previous:f,Next:h,...w}]=W(c);const v=()=>{s.val<=0?s.val=p.length-1:s.val--},x=()=>{s.val>=p.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(g));return a({...w,class:M("carousel",l,i,t==null?void 0:t.class,w==null?void 0:w.class)},a({class:M("control","control-previous"),onclick:v},f()),a({class:M("control","control-next"),onclick:x},h()),S)}}const Yr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],Jr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=V(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,as={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:os,createComponent:ns}],gridItem:fn},rs=e=>{const t=H(e);return()=>t(as)};function vn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=W(r);return a({type:"checkbox",required:"required",...d,class:M(i,u,l,c,t==null?void 0:t.class,d==null?void 0:d.class)})}}const xn=(e,t)=>{const{bau:n,css:o}=e,{label:a}=n.tags,i=vn(e,t);return s=>a({class:o`
          display: flex;
...
`,cs={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:is,createComponent:ss}],gridItem:xn},ls=e=>{const t=H(e);return()=>t(cs)},us=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=dt(e),i=V(e,{variant:"outline"}),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},ds=`import button from "@grucloud/bau-ui/button";
...
`,ps={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:ds,createComponent:us}]},ms=e=>{const t=H(e);return()=>t(ps)};function gs(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u,openState:d,...p},...g]=W(r);return a({class:M(i,t==null?void 0:t.class,p.class)},a({class:()=>M("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>M("content",d.val&&"content-open")},g))}}const bs=e=>{const{bau:t}=e,{section:n,p:o}=t.tags,a=t.state(!1),i=gs(e),s=V(e),r=zt(e);return()=>n(o("Click on the button to open and close the drawer."),s({color:"neutral",variant:"outline",onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),i({openState:a},r()))},hs=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,ks={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Es,createComponent:Cs}],gridItem:yn},Ts=e=>{const t=H(e);return()=>t(ks)};function $e(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:d,...p},...g]=W(r);return a({...p,class:M("form",u,l,c,i,t==null?void 0:t.class,p==null?void 0:p.class)},...g)}}function ft(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:g,...f},...h]=W(l);const w=V(e),v=Me(e);return n.bind({deps:[g],render:()=>x=>w({...f,class:M("loadingButton",u,d,p,r,x&&"loading",t==null?void 0:t.class,f==null?void 0:f.class)},v({size:u,variant:d,color:p,visibility:x}),i({class:x&&"loading"},h))})}}const As=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=ft(e),d=Ne(e,{variant:"outline",color:"danger"}),p=ve(e),g=$e(e,{class:n`
      align-items: center;
      & > header {
        text-align: center;
      }
...
`),r=a`
  ...
  `,c=o`
    ...
    ${s()}
  `;return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"plain",color:g=t.color??"neutral",running:f,...h}]=W(u);return i({...h,role:"progressbar",class:{deps:[f],renderProp:()=>w=>M("linearProgress",d,g,c,w&&"running",t==null?void 0:t.class,h==null?void 0:h.class)}})}}const kn=(e,t)=>{const n=En(e,t);return o=>n({...o,running:!0})},Rs=e=>{const{bau:t}=e,{section:n,hr:o}=t.tags,a=V(e),i=En(e),s=t.state(!1);return()=>n(a({variant:"solid",color:"primary",onclick:()=>s.val=!s.val},()=>s.val?"Stop":"Start"),o,i({running:s}))},js=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`))()}
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",...g},...f]=W(l);return a({class:M("modal",r,p,d,u,t==null?void 0:t.class,g==null?void 0:g.class)},i(...f))}}const An=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:s}=t.tags,r=V(e),c=vt(e),l=()=>o(Array(10).fill("").map((d,p)=>s(p+1,". Some text here"))),u=d=>{const p=c({id:"my-dialog",...d},a("Header"),l(),i(r({variant:"outline",color:d.color,onclick:()=>{p.close()}},"Cancel"),r({variant:"solid",color:d.color,onclick:()=>{p.close()}},"OK")));return p};return d=>{const p=u(d);return n(r({...d,onclick:()=>{p.showModal()}},"OPEN MODAL"),p)}},ei=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:s}=t.tags,r="neutral",c=V(e),l=vt(e),u=()=>o(Array(10).fill("").map((p,g)=>s(g+1,". Some text here"))),d=l({id:"my-dialog"},a("Header"),u(),i(c({variant:"outline",color:r,onclick:()=>{d.close()}},"Cancel"),c({variant:"solid",color:r,onclick:()=>{d.close()}},"OK")));return()=>n(c({variant:"solid",color:"neutral",onclick:()=>{d.showModal()}},"OPEN MODAL"),d)},ti=`import modal from "@grucloud/bau-ui/modal";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",...p}]=W(c);return a({...p,type:"radio",class:M("radio-button",l,d,u,s,t==null?void 0:t.class,p==null?void 0:p.class)})}}const Dn=(e,t)=>{const{bau:n,css:o}=e,{label:a,form:i}=n.tags,s=In(e,t);return r=>i({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`);function Ve(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=V(e),l=pt(e),u=Ce(e),d=o`
    ...
    ${Si()}
  `;return function(...g){let[{size:f=t.size??"md",variant:h=t.variant??"outline",color:w=t.color??"neutral",label:v,Option:x,options:S,getOptionLabel:k=({label:E})=>E,...A},...$]=W(g);const T=n.state(A.value),I=n.state(!1),D=n.state(0),_=()=>{b.openDialog(),b.focus(),I.val=!0},F=()=>{b.closeDialog(),I.val=!1},te=()=>{I.val=!1},K=E=>{b.open?F():_(),E.preventDefault()},J=({option:E,index:O})=>B=>{T.val=k(E),C.value=T.val,C.setCustomValidity(""),D.val=O,F(),B.preventDefault()},R=E=>{switch(E.preventDefault(),E.key){case"Escape":F();break;case"ArrowDown":D.val<S.length-1?D.val++:D.val=0;break;case"ArrowUp":D.val<=0?D.val=S.length-1:D.val--;break;case"Enter":b.open?(T.val=k(S[D.val]),F()):_();break}},y=()=>u({tabindex:"0",class:M(w,h)},S.map((E,O)=>i({class:()=>M(D.val==O&&"active"),onclick:J({option:E,index:O})},x(E)))),m=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":I,"aria-label":v,onclick:K,color:w,variant:h,size:f},()=>!T.val&&v,T),b=l({triggerEl:m,contentEl:y(),onClose:te}),C=s(A,r({value:""},"--Select Category--"),S.map(E=>r(k(E))));return C.value=A.value,a({...A,class:M("select",w,f,d,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:R},C,m,b)}}const Nn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Ve(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function On(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
    ...
    ${Wi()}
  `;return function(...u){let[{color:d,variant:p="plain",size:g,stepperDefs:f=[],activeStepIndex:h,...w},...v]=W(u);const x=n.state(f.map(($,T)=>({...$,index:T}))),S=n.derive(()=>x.val[h.val]),k=$=>{const{Header:T,disabled:I,name:D,index:_}=$;return s({class:()=>M(S.val.name==D&&"active",h.val<_&&"not-completed",h.val>_&&"completed",I&&"disabled")},r({class:"step-number"},_+1),r({class:"step-label"},()=>T($)))};return a({class:M("stepper",p,g,d,c,t==null?void 0:t.class,w.class)},n.loop(x,i(),k),n.bind({deps:[S],render:()=>$=>$.Content?$.Content({}):""}))}}const Vi=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=On(e),r=V(e),c=({name:f})=>f,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},g=()=>a({class:n`
          display: flex;
          justify-content: space-around;
...
`,qi=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=V(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
            display: flex;
            flex-direction: column;
            gap: 1rem;
        ...
        `},...i)}},Xe=e=>{const{bau:t}=e,{i:n}=t.tags,o=V(e);return function({onclick:i}){return o({onclick:i,variant:"outline",color:"primary"},n("◀"),"Previous")}},le="https://github.com/grucloud/grucloud/",ue="main",Xi={AWS:[{title:"EC2 an instance with public address",description:"Deploy a EC2 virtual machine attached to an elastic public address",url:le,branch:ue,directory:"examples/aws/ec2"},{title:"EKS",description:"Deploy a kubernetes cluster with EKS",url:le,branch:ue,directory:"examples/aws/EKS/eks-simple"},{title:"Route53 TXT Record",description:"Create an Hosted Zone and a TXT record",url:le,branch:ue,directory:"examples/aws/route53/dns-validation-record-txt"}],Azure:[{title:"Virtual machine",description:"Deploy a virtual machine with a public address, protected by a firewall",url:le,branch:ue,directory:"examples/azure/Compute/vm"}],Google:[{title:"Virtual machine",description:"Deploy a virtual machine on the default network",resources:["compute.instance"],url:le,branch:ue,directory:"examples/google/vm"},{title:"Virtual machine inside a network",description:"Create a network, a sub-network, a virtual machine and firewall rules for HTTP/HTTPS",url:le,branch:ue,directory:"examples/google/vm-network",resources:["compute.network","compute.subnetwork","compute.subnetwork"]},{title:"Secure static website",description:"Deploy a static website served with HTTPS",url:le,branch:ue,directory:"examples/google/storage/website-https"},{title:"DNS records",description:"Manages DNS records such as A, CNAME, TXT and MX records",url:le,branch:ue,directory:"examples/google/dns/github-page"}]},Zi=e=>{const{bau:t,css:n}=e,{li:o,strong:a,span:i}=t.tags;return function({project:r,onclickItem:c}){return o({onclick:c(r),class:n`
          flex-direction: column;
          align-items: flex-start;
        `},a(r.title),i(r.description))}},Yi=e=>{const{bau:t,css:n}=e,{strong:o,small:a}=t.tags,i=V(e);return function({item:r,onclickItem:c}){return i({onclick:c(r),class:n`
          &.button {
            flex-direction: column;
            align-items: flex-start;
            text-align: left;
    ...
    `;return S({name:"form-config-azure",onsubmit:T,"data-infra-create":!0,class:I},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",g("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",x({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("Tenant Id"),s("Retrieve the ",g("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",x({"data-input-azure-tenant-id":!0,placeholder:"Tenant Id",name:"tenantId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",g("APP_ID")," and ",g("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),f({class:n`
                  ...
                  flex-direction: column;
                  gap: 1rem;
                `},r("App Id",x({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",minLength:36,maxLength:36,size:36,required:!0})),r("Password",x({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",minLength:8,maxLength:64,size:64,required:!0})))))),v(w({onclick:A}),h({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},nc=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:g,a:f,table:h,tbody:w,th:v,tr:x,td:S}=t.tags,{svg:k,use:A}=t.tagsNS("http://www.w3.org/2000/svg"),$=ht(e),T=V(e),I=$e(e),D=Xe(e),_=qe(e);return function({onclickPrevious:te,onclickNext:K}){const J=t.state("No file selected"),R=t.state({}),y=t.state(!0),m=B=>{const G=B.target.files[0];if(G){J.val=G.name;const z=new FileReader;z.readAsText(G),z.onload=()=>{try{debugger;if(z.result){const L=JSON.parse(z.result);R.val=L,L.project_id&&(y.val=!1)}}catch{}},z.onerror=()=>{console.log(z.error)}}else J.val=""},b=({fileName:B,content:G})=>h({class:n`
...
`);function _n(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${ic()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=W(r);return a({...d,class:M("switch",i,u,l,c,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...p)}}const Ln=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:i}=n.tags,s=_n(e,t);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`);function Be(e,t={}){const{bau:n,css:o,window:a}=e,{tabDefs:i}=t,{div:s,ul:r,li:c}=n.tags,l=o`
    ...
    ${pc()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:f=t.color??"neutral",...h},...w]=W(d);const v=n.state(i),x=a.location.hash.slice(1),S=T=>v.val.find(I=>I.name==T),k=n.state(S(x)??i[0]),A=T=>{const{Header:I,disabled:D,name:_}=T;return c({class:()=>M(k.val.name==_&&"active",D&&"disabled"),onclick:F=>F.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:_},bubbles:!0}))},I(T))},$=s({class:M("tabs",g,p,f,l,t==null?void 0:t.class,h.class)},n.loop(v,r(),A),()=>k.val.Content?k.val.Content(h):"");return $.addEventListener("tab.select",T=>{var _,F;const{tabName:I}=T.detail,D=S(I);D&&((_=k.val.exit)==null||_.call(),k.val=D,(F=D.enter)==null||F.call())},!1),$.addEventListener("tab.add",T=>{var D;const{tab:I}=T.detail;(D=I.enter)==null||D.call(),v.val.push(I)},!1),$.addEventListener("tab.remove",T=>{var D;const I=v.val.findIndex(_=>_.name==T.detail.tabName);I>0&&((D=v.val[I].exit)==null||D.call(),v.val.splice(I,1))},!1),$}}const zn=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,s=Be(e,{tabDefs:[{name:"Tab1",Header:()=>o("TAB"),Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>o("TAB 2"),Content:()=>o(a("My tab 2 Content"))}],...t});return r=>s(r)},mc=e=>{const{bau:t}=e,{div:n,p:o,a}=t.tags,s=Be(e,{tabDefs:[{name:"Tab1",Header:()=>a({href:"#Tab1"},"TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>a({href:"#Tab2"},"TAB 2"),Content:()=>n(o("My tab 2 Content"))}],variant:"outline",color:"neutral"});return()=>s({})},gc=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=W(c);return i({...l,class:M("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const Cc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(w,v,x,S,k){return{name:w,calories:v,fat:x,carbs:S,protein:k}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],g=({name:w,calories:v})=>s(i(w),i({class:n`
            text-align: right;
          `},v)),f=()=>c(s(a({class:n`
              text-align: left;
...
`,Oc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Pc,createComponent:Bc}]},_c=e=>{const t=H(e);return()=>t(Oc)};function jn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=bt(e),s=V(e),r=Me(e),c=o`
  ...
  `,l=({label:f,icon:h,...w})=>s({"aria-label":f,title:f,...w},h),u=({count:f,totalCount:h,page:w,rowsPerPage:v})=>a({class:"pages-numbers"},Number(w-1)*Number(v)+(f>0?1:0),"-",Math.min(w*v,h)," of ",h),d=({count:f,page:h,rowsPerPage:w})=>a({class:"pages-numbers"},(h-1)*w+(f>0?1:0),"-",h*w),p=f=>f<=1,g=(f,h,w)=>f>=Math.ceil(h/w);return function(...h){let[{size:w=t.size??"md",variant:v=t.variant??"outline",color:x=t.color??"neutral",count:S=0,totalCount:k=0,page:A=1,rowsPerPage:$=50,onPageChange:T,isLoading:I=!1,disableFirst:D=()=>p(A),disablePrevious:_=()=>p(A),disableNext:F=()=>g(A,k,$),disableLast:te=()=>g(A,k,$),...K},...J]=W(h);const R=Math.max(0,Math.ceil(k/$)),y=T({page:1}),m=T({page:A-1}),b=T({page:A+1}),C=T({page:R}),E=[{label:"First",icon:"⟪",onclick:y,disabled:D()},{label:"Previous",icon:"⟨",onclick:m,disabled:_()},{label:"Next",icon:"⟩",onclick:b,disabled:F()},{label:"Last",icon:"⟫",onclick:C,disabled:te()}];return a({...K,class:M("table-pagination",c,I&&"disabled",t==null?void 0:t.class,K==null?void 0:K.class)},r({class:"spinner",visibility:I,size:"md"}),k>0?u({count:S,totalCount:k,page:A,maxPages:R,rowsPerPage:$}):d({count:S,page:A,maxPages:R,rowsPerPage:$}),i({variant:v,color:x},E.map(O=>l({...O,variant:v,color:x}))))}}const Lc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),zc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=Lc(45),u=({name:x,email:S})=>i(a(x),a(S)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),p=jn(e),g=Pe(e,{class:n`
      max-width: 650px;
    `}),f=t.state(l),h=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),w=t.derive(()=>f.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),v=({page:x})=>S=>{h.val.page=x};return()=>g(s(d(),()=>c(w.val.map(u))),()=>p({...h.val,onPageChange:v}))},Rc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),g=t.derive(()=>d.val.length),f=t.state(1),h=t.state(10),w=t.derive(()=>d.val),v=D=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(D).toString()}`,x=({page:D})=>_=>{f.val=D,S(v({page:D,per_page:h.val}))};S(v({page:1,per_page:h.val}));async function S(D){try{u.val=!0;const _=await fetch(D,{});if(_.ok){const F=await _.json();d.val=F;return}throw _}catch(_){p.val=_.message}finally{u.val=!1}}const k=({name:D,description:_,stargazers_count:F})=>i(a(D),a(_),a({class:n`
            text-align: right;
          `},F)),A=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),$=jn(e),T=Pe(e,{class:n`
      min-width: 650px;
    `}),I=({message:D})=>l(D);return()=>T(()=>$({rowsPerPage:h.val,page:f.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:x,disableNext:()=>!1}),s(A(),()=>p.val&&I({message:p.val}),()=>c(w.val.map(k))))},jc=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=zc(e),l=Rc(e),u=(...d)=>a({class:n`
  ...
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",selected:p=!1,disabled:g,onChange:f,...h},...w]=W(c);return i({type:"button",...h,"aria-pressed":{deps:[p],renderProp:()=>v=>v},class:{deps:[p],renderProp:()=>v=>M("toggle",l,d,u,s,v&&"selected",t==null?void 0:t.class,h==null?void 0:h.class)},disabled:g},w)}}const Hn=(e,t)=>{const{bau:n}=e,o=Oe(e,t);return a=>{const i=n.state(!1);return o({...a,selected:i,onclick:()=>i.val=!i.val},"Toggle Me")}},Hc=e=>{const{bau:t}=e,{section:n}=t.tags,o=Oe(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Gc=`import toggle from "@grucloud/bau-ui/toggle";
...
`);function xt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${Wc()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",exclusive:d=!1,onChange:p=()=>{},...g},...f]=W(r);const h=new Set,w=v=>{const{value:x}=v.target;d?(h.clear(),h.add(x)):h.has(x)?h.delete(x):h.add(x),p({event:v,values:[...h]})};return a({...g,class:M("toggle-group",c,u,l,i,t==null?void 0:t.class,g==null?void 0:g.class),onclick:w},...f)}}const Gn=(e,t)=>{const{bau:n}=e,o=xt(e,t),a=Oe(e,t);return i=>{const s=n.state([""]),r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...i,onChange:({values:l})=>{s.val=l}},r.map(({label:l,value:u})=>()=>a({...i,value:u,selected:s.val.includes(u),"area-label":l},l)))}},Vc=e=>{const{bau:t}=e,{section:n}=t.tags,o=t.state([""]),a=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i=Oe(e),s=xt(e),r="primary",c="solid",l=({values:u})=>{o.val=u};return()=>n(s({color:r,variant:c,exclusive:!0,onChange:l},a.map(({label:u,value:d})=>()=>i({color:r,variant:c,value:d,selected:o.val.includes(d),"area-label":u},u))))},Kc=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
...
`,{nav:e`
  ...
  `});function Wn(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=cl({css:o,createGlobalStyles:a}),d=dt(e),p=({depth:g=1,maxDepth:f,color:h,variant:w,size:v})=>x=>{const{children:S,expanded:k}=x,A=n.state(!k),$=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:I=>{S&&(A.val=!A.val)}},i(x.data)),T=()=>s({class:M(h,v)},S.map(p({depth:g+1,maxDepth:f})));return r(d({size:v,Header:$,Content:S&&g<f&&T}))};return function({tree:f,maxDepth:h=1/0,size:w=t.size??"md",variant:v=t.variant??"outline",color:x=t.color??"neutral",...S}){return c({class:M(u.nav,w,v,x,t==null?void 0:t.class,S.class)},f.children&&s(f.children.map(p({maxDepth:h,color:x,variant:v,size:w}))))}}const Vn=(e,t)=>{const{bau:n}=e,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Wn(e,{renderMenuItem:({name:r,href:c})=>o({href:c},r),...t});return r=>s({...r,tree:a})},ll=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Wn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},ul=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
