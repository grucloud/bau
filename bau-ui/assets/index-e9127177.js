...
`,Ka={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:Ga,createComponent:Ha},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Fa,createComponent:Ua},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Va,createComponent:Wa}],gridItem:an},Xa=e=>{const t=j(e);return()=>t(Ka)},qa={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Za=()=>ee.map(e=>`
&.alert {
  &.plain.${e} {
    & .icon {
      color: var(--color-${e})
...
`,Ir={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Ar,createComponent:Tr}],gridItem:pn},Dr=e=>{const t=j(e);return()=>t(Ir)};function gt(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,{separator:c="〉"}=t,l=V(e),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:f=t.variant??"plain",color:h=t.color??"neutral",items:w,...v},...x]=F(p);return i({...v,class:M(u,t==null?void 0:t.class,v==null?void 0:v.class)},w.map(({href:S,name:k})=>s((S?l:r)({href:`${a.base}${S}`,color:h,variant:f,size:g,class:M(h,f,g)},k))))}}const mn=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=gt(e,t);return a=>o({...a,...n})},Nr=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=gt(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},Mr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,$r=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=gt(e,{variant:"plain",color:"neutral",separator:"/"});return()=>n(a(o))},Br=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
  type BreadcrumbsProps,
} from "@grucloud/bau-ui/breadcrumbs";
...
`,ms={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:ps,createComponent:ds}]},gs=e=>{const t=j(e);return()=>t(ms)};function bs(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u,openState:d,...p},...g]=F(r);return a({class:M(i,t==null?void 0:t.class,p.class)},a({class:()=>M("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>M("content",d.val&&"content-open")},g))}}const hs=e=>{const{bau:t}=e,{section:n,p:o}=t.tags,a=t.state(!1),i=bs(e),s=V(e),r=Rt(e);return()=>n(o("Click on the button to open and close the drawer."),s({color:"neutral",variant:"outline",onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),i({openState:a},r()))},fs=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,vs={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:fs,createComponent:hs}]},xs=e=>{const t=j(e);return()=>t(vs)},yn=(e,t)=>{const n={data:{name:"Root Menu",href:"#drilldown-gallery"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},o=rt(e,t);return a=>o({id:"drilldown-gallery",tree:n,...a})},ws=e=>{const{bau:t}=e,{section:n}=t.tags,o={data:{name:"Root Menu",href:"#drilldown-example"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},a=rt(e,{base:"/components/drillDownMenu",hashBased:!0});return()=>n({id:"drilldown-example"},a({tree:o}))},ys=`import drillDownMenu, { type Tree } from "@grucloud/bau-ui/drillDownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ss={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:ys,createComponent:ws}],gridItem:(e,t)=>yn(e,{base:"/components/drillDownMenu",hashBased:!0,...t})},Cs=e=>{const t=j(e);return()=>t(Ss)};function ht(e,t={}){const{bau:n,css:o}=e,{div:a,label:i,input:s}=n.tags,r={base:o`
      display: inline-flex;
      & input {
        width: 0.1px;
        height: 0.1px;
    ...
    `};return function(l,...u){const{size:d=t.size??"md",variant:p=t.variant??"outline",color:g=t.color??"neutral",Component:f,disabled:h,...w}=l;return a({class:M(r.base,h&&r.disabled,t==null?void 0:t.class,l.class)},i({class:M(p,g,d)},f({disabled:h}),s({type:"file",disabled:h,...w})))}}const Sn=(e,t)=>{const{tr:n,bau:o,css:a,config:i}=e,{svg:s,use:r}=o.tagsNS("http://www.w3.org/2000/svg"),{div:c,span:l}=o.tags,u=o.state("No file selected"),d=ht(e,t),p=f=>{const h=f.target.files[0];h?u.val=h.name:u.val="No file selected"},g=({disabled:f})=>c({class:M(a`
          ...
          `,f&&o`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),l(t("Choose a file to upload")));return()=>r(d({Component:g,name:"file",accept:"text/*",onchange:p}),c("File selected: ",u))},ks=`import classNames from "@grucloud/bau-css/classNames";
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:g,...f},...h]=F(l);const w=V(e),v=Me(e);return n.bind({deps:[g],render:()=>x=>w({...f,class:M("loadingButton",u,d,p,r,x&&"loading",t==null?void 0:t.class,f==null?void 0:f.class)},v({size:u,variant:d,color:p,visibility:x}),i({class:x&&"loading"},h))})}}const Is=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=ft(e),d=Ne(e,{variant:"outline",color:"danger"}),p=ve(e),g=$e(e,{class:n`
      align-items: center;
      & > header {
        text-align: center;
      }
...
`,Ns={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Login page",description:"A login page.",code:Ds,createComponent:Is}]},Ms=e=>{const t=j(e);return()=>t(Ns)},Cn=(e,t={})=>{const n=ve(e,t);return o=>n({name:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,placeholder:"Enter text",...o})},$s=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=ve(e);return()=>n(o("Basic input"),a({id:"my-input",name:"my-input",placeholder:"Enter Text"}),o("Disabled input"),a({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))},Bs=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ps={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:Bs,createComponent:$s}],gridItem:Cn},Os=e=>{const t=j(e);return()=>t(Ps)},En=(e,t={})=>{const n=st(e,t);return o=>n({name:`myinputSearch-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinputSearch-gallery-${t.color??o.color}-${t.variant??o.variant}-${o.size??t.size}`,placeholder:"Enter text",...o})},_s=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=st(e);return()=>n(o("Basic inputSearch"),a({id:"my-inputSearch",name:"my-inputSearch",placeholder:"Enter Text"}),o("Disabled inputSearch"),a({name:"my-inputSearch-disabled",placeholder:"Enter Text",disabled:!0}))},Ls=`import inputSearch from "@grucloud/bau-ui/inputSearch";
import { Context } from "@grucloud/bau-ui/context";
...
`,zs={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:Ls,createComponent:_s}],gridItem:En},Rs=e=>{const t=j(e);return()=>t(zs)};function kn(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=()=>ee.map(l=>`
&.${l}{
...
`),r=a`
  ...
  `,c=o`
    ...
    ${s()}
  `;return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"plain",color:g=t.color??"neutral",running:f,...h}]=F(u);return i({...h,role:"progressbar",class:{deps:[f],renderProp:()=>w=>M("linearProgress",d,g,c,w&&"running",t==null?void 0:t.class,h==null?void 0:h.class)}})}}const Tn=(e,t)=>{const n=kn(e,t);return o=>n({...o,running:!0})},js=e=>{const{bau:t}=e,{section:n,hr:o}=t.tags,a=V(e),i=kn(e),s=t.state(!1);return()=>n(a({variant:"solid",color:"primary",onclick:()=>s.val=!s.val},()=>s.val?"Stop":"Start"),o,i({running:s}))},Hs=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Gs={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:Hs,createComponent:js}],gridItem:Tn},Us=e=>{const t=j(e);return()=>t(Gs)},An=(e,t)=>{const n=ft(e,t);return o=>n({...o,loading:!0},"Save")},Fs=e=>{const{bau:t}=e,{section:n}=t.tags,o=ft(e),a=t.state(!0);return()=>n(o({variant:"solid",color:"primary",loading:a,onclick:()=>a.val=!a.val},"Save"))},Ws=`import loadingButton from "@grucloud/bau-ui/loadingButton";
...
`,Vs={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:Ws,createComponent:Fs}],gridItem:An},Ks=e=>{const t=j(e);return()=>t(Vs)},Xs=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],qs=(e,t)=>{const{bau:n,css:o}=e,{span:a,li:i}=n.tags,s=Ce(e,t),r=({code:c,label:l})=>i({class:o`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return c=>s({...c},Xs.map(r))},Zs=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Ys=e=>{const{bau:t,css:n}=e,{section:o,span:a,li:i}=t.tags,s=Ce(e),r=({code:c,label:l})=>i({class:n`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return()=>o(s({variant:"outline",color:"primary"},Zs.map(r)))},Js=`import list from "@grucloud/bau-ui/list";
import { Context } from "@grucloud/bau-ui/context";
...
`,Qs={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:Js,createComponent:Ys}],gridItem:qs},ei=e=>{const t=j(e);return()=>t(Qs)};function vt(e,t={}){const{bau:n,css:o}=e,{dialog:a,div:i}=n.tags,r=o`
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
    border-radius: var(--global-radius);
    min-width: 400px;
...
`,oi={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:ni,createComponent:ti}],gridItem:In},ai=e=>{const t=j(e);return()=>t(oi)},ri=e=>{const{bau:t}=e,{section:n,div:o,h1:a,p:i}=t.tags,s=V(e),r=pt(e),c=()=>s({variant:"outline",color:"success",onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),l=()=>o({},a("My content"),i("My Content")),u=c(),d=r({id:"my-popover-left",triggerEl:u,contentEl:l()});return()=>n(o(u,d))},si=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,ii={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:si,createComponent:ri}]},ci=e=>{const t=j(e);return()=>t(ii)};function li(e,t={}){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,pi={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:di,createComponent:ui}]},mi=e=>{const t=j(e);return()=>t(pi)},gi=(e,t)=>{const{bau:n}=e,{div:o}=n.tags,a=De(e,t);return i=>a({...i},o(`Paper ${t.size??""}`))},bi=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=De(e);return()=>n(a({size:"md"},o("My content")))},hi=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`,fi={title:"Paper",package:"paper",description:"The paper component displays child components on a surface area.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paper/paper.js",importStatement:'import paper from "@grucloud/bau-ui/paper";',examples:[{title:"Default",description:"A simple paper.",code:hi,createComponent:bi}],variantColorTableDisable:!0,gridItem:gi},vi=e=>{const t=j(e);return()=>t(fi)};function Dn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    &.sm {
      transform: scale(0.8);
    }
    &.md {
...
`,yi={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:wi,createComponent:xi}],gridItem:Nn},Si=e=>{const t=j(e);return()=>t(yi)},Ci=()=>ee.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function Ve(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=V(e),l=pt(e),u=Ce(e),d=o`
  ...
  `;return function(...g){let[{size:f=t.size??"md",variant:h=t.variant??"outline",color:w=t.color??"neutral",label:v,Option:x,options:S,getOptionLabel:k=({label:E})=>E,...A},...$]=F(g);const T=n.state(A.value),I=n.state(!1),D=n.state(0),_=()=>{b.openDialog(),b.focus(),I.val=!0},W=()=>{b.closeDialog(),I.val=!1},te=()=>{I.val=!1},K=E=>{b.open?W():_(),E.preventDefault()},J=({option:E,index:O})=>B=>{T.val=k(E),C.value=T.val,C.setCustomValidity(""),D.val=O,W(),B.preventDefault()},R=E=>{switch(E.preventDefault(),E.key){case"Escape":W();break;case"ArrowDown":D.val<S.length-1?D.val++:D.val=0;break;case"ArrowUp":D.val<=0?D.val=S.length-1:D.val--;break;case"Enter":b.open?(T.val=k(S[D.val]),W()):_();break}},y=()=>u({tabindex:"0",class:M(w,h)},S.map((E,O)=>i({class:()=>M(D.val==O&&"active"),onclick:J({option:E,index:O})},x(E)))),m=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":I,"aria-label":v,onclick:K,color:w,variant:h,size:f},()=>!T.val&&v,T),b=l({triggerEl:m,contentEl:y(),onClose:te}),C=s(A,r({value:""},"--Select Category--"),S.map(E=>r(k(E))));return C.value=A.value,a({...A,class:M("select",w,f,d,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:R},C,m,b)}}const Mn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Ve(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return l=>s({...l,options:r,Option:c,getOptionLabel:({label:u})=>u,label:"Select a country..."})},Ei=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=Ve(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return()=>o(s({options:r,Option:c,getOptionLabel:({label:l})=>l,label:"Select a country..."}))},ki=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ti=e=>{const{bau:t}=e,{span:n,form:o}=t.tags,a=Ve(e),i=["eu-north-1","ap-south-1","eu-west-3","eu-west-2","eu-west-1","ap-northeast-3","ap-northeast-2","ap-northeast-1","sa-east-1","ca-central-1","ap-southeast-1","ap-southeast-2","eu-central-1","us-east-1","us-east-2","us-west-1","us-west-2"],s=r=>n({},r);return()=>o(a({options:i,Option:s,label:"Select a region",getOptionLabel:r=>r}))},Ai=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ii={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:ki,createComponent:Ei},{title:"Select AWS region",description:"Select the AWS region",code:Ai,createComponent:Ti}],gridItem:Mn},Di=e=>{const t=j(e);return()=>t(Ii)};function $n(e,t={}){const{bau:n,css:o}=e,{select:a}=n.tags,i=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",...d},...p]=F(r);return a({...d,class:M("select-native",u,c,l,i,t==null?void 0:t.class,d==null?void 0:d.class)},p)}}const Bn=(e,t)=>{const{bau:n}=e,{option:o}=n.tags,a=$n(e,t),i=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return s=>a(s,i.map(({label:r,phone:c})=>o({value:c},r)))},Ni=e=>{const{bau:t}=e,{section:n,option:o}=t.tags,a=$n(e),i=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>n(a(i.map(({label:s,phone:r})=>o({value:r},s))))},Mi=`import selectNative from "@grucloud/bau-ui/selectNative";
import { Context } from "@grucloud/bau-ui/context";
...
`,$i={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Mi,createComponent:Ni}],gridItem:Bn},Bi=e=>{const t=j(e);return()=>t($i)};function xt(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
    0% {
      transform: translateX(-100%);
    }
    50% {
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",...g},...f]=F(l);return i({...g,class:M("skeleton",u,r,t==null?void 0:t.class,g==null?void 0:g.class)},...f)}}const Pi=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=xt(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
        ...
        `}),new Array(4).fill("").map(()=>i({class:n`
            ...
            width: 100%;
            height: 2rem;
          `})));return()=>o(s())},Oi=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,_i=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=xt(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
        `},new Array(4).fill("").map(()=>a({class:n`
            ...
            `}),i({class:n`
              ...
              width: 100%;
              height: 2rem;
            `}))));return()=>o(s())},Li=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,zi=e=>{const{bau:t,css:n}=e,{section:o,table:a,tbody:i,tr:s,td:r}=t.tags,c=xt(e,{class:n`
    ...
    `}),l=()=>a(i(new Array(8).fill("").map(()=>s(r(c({class:n`
                ...
                `})),r(c()),r(c()),r(c()),r(c({class:n`
                  width: 20rem;
                `}))))));return()=>o(l())},Ri=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,ji={title:"Skeleton",package:"skeleton",description:"The skeleton component is used a loading indicator",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/skeleton/skeleton.js",importStatement:'import skeleton from "@grucloud/bau-ui/skeleton";',examples:[{title:"Card",description:"A card skeleton.",code:Oi,createComponent:Pi},{title:"List",description:"A list skeleton.",code:Li,createComponent:_i},{title:"Table",description:"A table skeleton.",code:Ri,createComponent:zi}],variantColorTableDisable:!0,variantSizeDisable:!0},Hi=e=>{const t=j(e);return()=>t(ji)};function Ke(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    ${(()=>ee.map(r=>`
&.slider.${r} {
  accent-color: var(--color-${r});
}
...
`,Fi=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:s,br:r,option:c}=t.tags,l=t.state(0),u=p=>{l.val=p==null?void 0:p.target.value},d=Ke(e);return()=>o(a(i({for:"temp"},"Choose a comfortable temperature"),r,d({oninput:u,class:n`
            width: 300px;
            margin: 0;
...
`,Vi=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:s,br:r,option:c}=t.tags,l=t.state(0),u=p=>{l.val=p==null?void 0:p.target.value},d=Ke(e);return()=>o(a({class:n`
            display: flex;
          ...
          `}),s({id:"markers-vertical",class:n`
              ...
              flex-direction: column;
              justify-content: space-between;
            `},["0","25","50","75","100"].reverse().map(p=>c({value:Number(p),label:p})))))},Ki=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Xi={title:"Slide",package:"slider",description:"The slider component allows a user to to choose a number between a range.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/slider/slider.js",importStatement:'import slider from "@grucloud/bau-ui/slider";',examples:[{title:"Default",description:"A simple slider.",code:Ui,createComponent:Gi},{title:"Horizontal Mark",description:"A slider with horizontal mark.",code:Wi,createComponent:Fi},{title:"Vertical Mark",description:"A vertical slider with marks.",code:Ki,createComponent:Vi}],gridItem:Pn},qi=e=>{const t=j(e);return()=>t(Xi)},On=(e,t)=>{const n=Me(e,t);return o=>n({...o})},Zi=e=>{const{bau:t}=e,{section:n}=t.tags,o=V(e),a=Me(e,{size:"lg"}),i=t.state(!0);return()=>n(o({variant:"solid",color:"primary",onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),a({visibility:i}))},Yi=`import spinner from "@grucloud/bau-ui/spinner";
import button from "@grucloud/bau-ui/button";
...
`,Ji={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:Yi,createComponent:Zi}],gridItem:On},Qi=e=>{const t=j(e);return()=>t(Ji)},ec=()=>ee.map(e=>`
`).join(`
`);function _n(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
    ...
    ${ec()}
  `;return function(...u){let[{color:d,variant:p="plain",size:g,stepperDefs:f=[],activeStepIndex:h,...w},...v]=F(u);const x=n.state(f.map(($,T)=>({...$,index:T}))),S=n.derive(()=>x.val[h.val]),k=$=>{const{Header:T,disabled:I,name:D,index:_}=$;return s({class:()=>M(S.val.name==D&&"active",h.val<_&&"not-completed",h.val>_&&"completed",I&&"disabled")},r({class:"step-number"},_+1),r({class:"step-label"},()=>T($)))};return a({class:M("stepper",p,g,d,c,t==null?void 0:t.class,w.class)},n.loop(x,i(),k),n.bind({deps:[S],render:()=>$=>$.Content?$.Content({}):""}))}}const tc=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=_n(e),r=V(e),c=({name:f})=>f,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},g=()=>a({class:n`
          display: flex;
          justify-content: space-around;
        `},r({onclick:d,variant:"outline",color:"primary"},"Previous"),r({onclick:p,variant:"solid",color:"primary"},"Next"));return()=>o({class:n`
          ...
          flex-direction: column;
          gap: 1rem;
        `},s({stepperDefs:l,activeStepIndex:u}),g())},nc=`import stepper, { type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
...
`,oc=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=V(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
            display: flex;
            flex-direction: column;
            gap: 1rem;
          ...
          display: flex;
          gap: 1rem;
        `},...i)}},qe=e=>{const{bau:t}=e,{i:n}=t.tags,o=V(e);return function({onclick:i}){return o({onclick:i,variant:"outline",color:"primary"},n("◀"),"Previous")}},le="https://github.com/grucloud/grucloud/",ue="main",ac={AWS:[{title:"EC2 an instance with public address",description:"Deploy a EC2 virtual machine attached to an elastic public address",url:le,branch:ue,directory:"examples/aws/ec2"},{title:"EKS",description:"Deploy a kubernetes cluster with EKS",url:le,branch:ue,directory:"examples/aws/EKS/eks-simple"},{title:"Route53 TXT Record",description:"Create an Hosted Zone and a TXT record",url:le,branch:ue,directory:"examples/aws/route53/dns-validation-record-txt"}],Azure:[{title:"Virtual machine",description:"Deploy a virtual machine with a public address, protected by a firewall",url:le,branch:ue,directory:"examples/azure/Compute/vm"}],Google:[{title:"Virtual machine",description:"Deploy a virtual machine on the default network",resources:["compute.instance"],url:le,branch:ue,directory:"examples/google/vm"},{title:"Virtual machine inside a network",description:"Create a network, a sub-network, a virtual machine and firewall rules for HTTP/HTTPS",url:le,branch:ue,directory:"examples/google/vm-network",resources:["compute.network","compute.subnetwork","compute.subnetwork"]},{title:"Secure static website",description:"Deploy a static website served with HTTPS",url:le,branch:ue,directory:"examples/google/storage/website-https"},{title:"DNS records",description:"Manages DNS records such as A, CNAME, TXT and MX records",url:le,branch:ue,directory:"examples/google/dns/github-page"}]},rc=e=>{const{bau:t,css:n}=e,{li:o,strong:a,span:i}=t.tags;return function({project:r,onclickItem:c}){return o({onclick:c(r),class:n`
          flex-direction: column;
          align-items: flex-start;
        `},a(r.title),i(r.description))}},sc=e=>{const{bau:t,css:n}=e,{strong:o,small:a}=t.tags,i=V(e);return function({item:r,onclickItem:c}){return i({onclick:c(r),class:n`
          &.button {
            flex-direction: column;
            align-items: flex-start;
            text-align: left;
    ...
    `;return S({name:"form-config-azure",onsubmit:T,"data-infra-create":!0,class:I},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",g("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",x({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("Tenant Id"),s("Retrieve the ",g("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",x({"data-input-azure-tenant-id":!0,placeholder:"Tenant Id",name:"tenantId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",g("APP_ID")," and ",g("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),f({class:n`
                  ...
                  flex-direction: column;
                  gap: 1rem;
                `},r("App Id",x({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",minLength:36,maxLength:36,size:36,required:!0})),r("Password",x({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",minLength:8,maxLength:64,size:64,required:!0})))))),v(w({onclick:A}),h({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},dc=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:g,a:f,table:h,tbody:w,th:v,tr:x,td:S}=t.tags,{svg:k,use:A}=t.tagsNS("http://www.w3.org/2000/svg"),$=ht(e),T=V(e),I=$e(e),D=qe(e),_=Xe(e);return function({onclickPrevious:te,onclickNext:K}){const J=t.state("No file selected"),R=t.state({}),y=t.state(!0),m=B=>{const G=B.target.files[0];if(G){J.val=G.name;const z=new FileReader;z.readAsText(G),z.onload=()=>{try{debugger;if(z.result){const L=JSON.parse(z.result);R.val=L,L.project_id&&(y.val=!1)}}catch{}},z.onerror=()=>{console.log(z.error)}}else J.val=""},b=({fileName:B,content:G})=>h({class:n`
...
`,gc={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Simple Stepper",description:"A simple stepper.",code:nc,createComponent:tc},{title:"Cloud Config Stepper",description:"Configure cloud provider",code:mc,createComponent:pc}]},bc=e=>{const t=j(e);return()=>t(gc)},hc=()=>ee.map(e=>`
&.switch.plain.${e} {
  &::after {
...
`);function Ln(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=F(r);return a({...d,class:M("switch",i,u,l,c,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...p)}}const zn=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:i}=n.tags,s=Ln(e,t);return r=>a({class:o`
        ...
        `},i("off ",s({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),i("on ",s({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},fc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i}=t.tags,s=Ln(e);return()=>o(a(i({class:n`
              display: flex;
              align-items: center;
              gap: 0.5rem;
            `},"My shinny switch",s({variant:"outline",id:"my-shinny-switch"}))))},vc=`import createSwitch from "@grucloud/bau-ui/switch";
import { Context } from "@grucloud/bau-ui/context";
...
`,xc={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:vc,createComponent:fc}],gridItem:zn},wc=e=>{const t=j(e);return()=>t(xc)},yc=()=>ee.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`,Ec=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Be(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB 1"),Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>n("Tab Disabled"),Content:()=>n(o("My Content Disabled"))}]});return()=>i({variant:"outline",color:"success"})},kc=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,jn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]},Tc=e=>{const{css:t}=e,n=Be(e,{tabDefs:jn(e)});return()=>n({variant:"outline",color:"neutral",class:t`
...
`,Ic=e=>{const{css:t}=e,n=jn(e),o=Be(e,{tabDefs:n});return()=>o({variant:"outline",color:"neutral",class:t`
        & ul {
          justify-content: center;
        }
...
`,Nc={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Cc,createComponent:Sc},{title:"Extended Tabs",description:"An extended tabs.",code:kc,createComponent:Ec},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:Ac,createComponent:Tc},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:Dc,createComponent:Ic}],gridItem:Rn},Mc=e=>{const t=j(e);return()=>t(Nc)};function Pe(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i}=n.tags;a`
  :root {
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=F(c);return i({...l,class:M("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const $c=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(w,v,x,S,k){return{name:w,calories:v,fat:x,carbs:S,protein:k}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],g=({name:w,calories:v})=>s(i(w),i({class:n`
            text-align: right;
          `},v)),f=()=>c(s(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(h(r(u("Basic Table"),f(),l(p.map(g)))))},Bc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ee(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Pc=[Ee("Frozen yoghurt",159,6,24,4),Ee("Ice cream sandwich",237,9,37,4.3),Ee("Eclair",262,16,24,6),Ee("Cupcake",305,3.7,67,4.3),Ee("Gingerbread",356,16,49,3.9)],Oc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags,d=({name:f,calories:h})=>s(i(f),i({class:n`
            text-align: right;
          `},h)),p=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(g(r(u("Table Dense"),p(),l(Pc.map(d)))))},_c=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function ke(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Lc=[ke("Frozen yoghurt",159,6,24,4),ke("Ice cream sandwich",237,9,37,4.3),ke("Eclair",262,16,24,6),ke("Cupcake",305,3.7,67,4.3),ke("Gingerbread",356,16,49,3.9)],zc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags,d=({name:f,calories:h})=>s(i(f),i({class:n`
            text-align: right;
          `},h)),p=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(g(r(u("Table Zebra"),p(),l(Lc.map(d)))))},Rc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,jc={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Bc,createComponent:$c},{title:"Dense",description:"A dense table.",code:_c,createComponent:Oc},{title:"Zebra",description:"A zebra table.",code:Rc,createComponent:zc}]},Hc=e=>{const t=j(e);return()=>t(jc)},Gc=e=>{const{bau:t,css:n}=e,{h1:o,h2:a,h3:i,section:s,article:r}=t.tags,c=nn(e),l=r({id:"content",class:n`
        grid-area: content;
...
`,Fc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Uc,createComponent:Gc}]},Wc=e=>{const t=j(e);return()=>t(Fc)};function Hn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=bt(e),s=V(e),r=Me(e),c=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,l=({label:f,icon:h,...w})=>s({"aria-label":f,title:f,...w},h),u=({count:f,totalCount:h,page:w,rowsPerPage:v})=>a({class:"pages-numbers"},Number(w-1)*Number(v)+(f>0?1:0),"-",Math.min(w*v,h)," of ",h),d=({count:f,page:h,rowsPerPage:w})=>a({class:"pages-numbers"},(h-1)*w+(f>0?1:0),"-",h*w),p=f=>f<=1,g=(f,h,w)=>f>=Math.ceil(h/w);return function(...h){let[{size:w=t.size??"md",variant:v=t.variant??"outline",color:x=t.color??"neutral",count:S=0,totalCount:k=0,page:A=1,rowsPerPage:$=50,onPageChange:T,isLoading:I=!1,disableFirst:D=()=>p(A),disablePrevious:_=()=>p(A),disableNext:W=()=>g(A,k,$),disableLast:te=()=>g(A,k,$),...K},...J]=F(h);const R=Math.max(0,Math.ceil(k/$)),y=T({page:1}),m=T({page:A-1}),b=T({page:A+1}),C=T({page:R}),E=[{label:"First",icon:"⟪",onclick:y,disabled:D()},{label:"Previous",icon:"⟨",onclick:m,disabled:_()},{label:"Next",icon:"⟩",onclick:b,disabled:W()},{label:"Last",icon:"⟫",onclick:C,disabled:te()}];return a({...K,class:M("table-pagination",c,I&&"disabled",t==null?void 0:t.class,K==null?void 0:K.class)},r({class:"spinner",visibility:I,size:"md"}),k>0?u({count:S,totalCount:k,page:A,maxPages:R,rowsPerPage:$}):d({count:S,page:A,maxPages:R,rowsPerPage:$}),i({variant:v,color:x},E.map(O=>l({...O,variant:v,color:x}))))}}const Vc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Kc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=Vc(45),u=({name:x,email:S})=>i(a(x),a(S)),d=()=>r(o({class:n`
    ...
    `}),f=t.state(l),h=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),w=t.derive(()=>f.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),v=({page:x})=>S=>{h.val.page=x};return()=>g(s(d(),()=>c(w.val.map(u))),()=>p({...h.val,onPageChange:v}))},Xc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),g=t.derive(()=>d.val.length),f=t.state(1),h=t.state(10),w=t.derive(()=>d.val),v=D=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(D).toString()}`,x=({page:D})=>_=>{f.val=D,S(v({page:D,per_page:h.val}))};S(v({page:1,per_page:h.val}));async function S(D){try{u.val=!0;const _=await fetch(D,{});if(_.ok){const W=await _.json();d.val=W;return}throw _}catch(_){p.val=_.message}finally{u.val=!1}}const k=({name:D,description:_,stargazers_count:W})=>i(a(D),a(_),a({class:n`
      ...
      min-width: 650px;
    `}),I=({message:D})=>l(D);return()=>T(()=>$({rowsPerPage:h.val,page:f.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:x,disableNext:()=>!1}),s(A(),()=>p.val&&I({message:p.val}),()=>c(w.val.map(k))))},qc=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=Kc(e),l=Xc(e),u=(...d)=>a({class:n`
...
`,Jc={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:Yc,createComponent:Zc}],gridItem:Gn},Qc=e=>{const t=j(e);return()=>t(Jc)},el=()=>ee.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`,ol=e=>{const{bau:t}=e,{section:n}=t.tags,o=t.state([""]),a=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i=Oe(e),s=wt(e),r="primary",c="solid",l=({values:u})=>{o.val=u};return()=>n(s({color:r,variant:c,onChange:l},a.map(({label:u,value:d})=>()=>i({color:r,variant:c,value:d,selected:o.val.includes(d),"area-label":u},u))))},al=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
...
`,rl={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:nl,createComponent:tl},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:al,createComponent:ol}],gridItem:Un},sl=e=>{const t=j(e);return()=>t(rl)};function yt(e,t={}){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,ll=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i,section:s}=t.tags,r=Ue(e,{variant:"outline",color:"primary"}),c=yt(e),l=()=>o(a("A ",i("tooltip")," can be any component")),u=()=>s({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
        `},o({class:n`
          ...
          `},c({side:"left-end",titleEl:l()},r("left end")),c({side:"right-end",titleEl:l()},r("right end"))),o({class:n`
            display: flex;
            justify-content: space-around;
          `},c({side:"bottom-start",titleEl:l()},r("bottom start")),c({side:"bottom-centered",titleEl:l()},r("bottom centered")),c({side:"bottom-end",titleEl:l()},r("bottom end"))));return()=>u()},ul=`import tooltip from "@grucloud/bau-ui/tooltip";
...
`,dl={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import tooltip from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:cl,createComponent:il},{title:"Grid",description:"Various tooltip position",code:ul,createComponent:ll}],gridItem:Fn},pl=e=>{const t=j(e);return()=>t(dl)},Wn=(e,t)=>{const n=at(e,t);return o=>n(o)},ml=e=>{const{bau:t}=e,{section:n}=t.tags,o=at(e);return()=>n(o({}))},gl=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,bl={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:gl,createComponent:ml}],gridItem:Wn},hl=e=>{const t=j(e);return()=>t(bl)},fl=({css:e,createGlobalStyles:t})=>(t`
:root {
...
`,wl={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:xl,createComponent:vl}],gridItem:Kn},yl=e=>{const t=j(e);return()=>t(wl)},Sl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:s,ul:r,li:c}=t.tags,l=on(e),u=V(e),d=[{name:"Accordion",Item:an(e)},{name:"Alert",Item:sn(e)},{name:"Autocomplete",Item:un(e)},{name:"Avatar",Item:ln(e)},{name:"Badge",Item:pn(e)},{name:"Breadcrumbs",Item:mn(e)},{name:"Button",Item:gn(e)},{name:"Button Group",Item:bn(e)},{name:"Calendar",Item:fn(e)},{name:"Checkbox",Item:wn(e)},{name:"Chip",Item:vn(e)},{name:"DrillDown Menu",Item:yn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:Sn(e)},{name:"Input",Item:Cn(e)},{name:"Input Search",Item:En(e)},{name:"Linear Progress",Item:Tn(e)},{name:"Loading Button",Item:An(e)},{name:"Modal",Item:In(e)},{name:"Radio Button",Item:Nn(e)},{name:"Select",Item:Mn(e)},{name:"Select Native",Item:Bn(e)},{name:"Slider",Item:Pn(e)},{name:"Spinner",Item:On(e)},{name:"Switch",Item:zn(e)},{name:"Tabs",Item:Rn(e)},{name:"Theme Switch",Item:Wn(e)},{name:"Toggle",Item:Gn(e)},{name:"Toggle Group",Item:Un(e)},{name:"Tooltip",Item:Fn(e)},{name:"Tree View",Item:Kn(e)}];return()=>o({class:n`
        ...
        `},i("Bau Component Gallery"),s("This page displays the components with various colors and variants."),r({class:n`
          ...
          `},d.map(({name:p})=>c(u({color:"primary",variant:"solid",href:`#${p}`,size:"sm"},p)))),d.map(p=>a({id:p.name,class:n`
              ...
              padding: 1rem;
              margin: 1rem;
            `},l(p))))},Cl=({context:e})=>{const t=Sl(e);return[{path:"",action:n=>({title:"Bau UI",component:Po(e)})},{path:"GettingStarted",action:n=>({title:"Getting Started",component:za(e)})},{path:"components",action:()=>({title:"Component",component:t}),children:[{path:"accordion",action:()=>({title:"Accordion",component:Xa(e)})},{path:"alert",action:()=>({title:"Alert",component:nr(e)})},{path:"alertStack",action:()=>({title:"Alert Stack",component:ir(e)})},{path:"animate",action:()=>({title:"Animate",component:mr(e)})},{path:"autocomplete",action:()=>({title:"Autocomplete",component:kr(e)})},{path:"avatar",action:()=>({title:"Avatar",component:fr(e)})},{path:"badge",action:()=>({title:"Badge",component:Dr(e)})},{path:"breadcrumb",action:()=>({title:"Breadcrumb",component:Or(e)})},{path:"button",action:()=>({title:"Button",component:Hr(e)})},{path:"buttonGroup",action:()=>({title:"Button Group",component:Vr(e)})},{path:"calendar",action:()=>({title:"Calendar",component:Zr(e)})},{path:"carousel",action:()=>({title:"Carousel",component:ns(e)})},{path:"chip",action:()=>({title:"Chip",component:ss(e)})},{path:"checkbox",action:()=>({title:"Checkbox",component:us(e)})},{path:"collapsible",action:()=>({title:"Collapsible",component:gs(e)})},{path:"drawer",action:()=>({title:"Drawer",component:xs(e)})},{path:"drillDownMenu",action:()=>({title:"DrillDown Menu",component:Cs(e)})},{path:"fileInput",action:()=>({title:"File Input",component:As(e)})},{path:"form",action:()=>({title:"Form",component:Ms(e)})},{path:"input",action:()=>({title:"Input",component:Os(e)})},{path:"inputSearch",action:()=>({title:"Input Search",component:Rs(e)})},{path:"linearProgress",action:()=>({title:"Linear Progress",component:Us(e)})},{path:"list",action:()=>({title:"List",component:ei(e)})},{path:"loadingButton",action:()=>({title:"Loading Button",component:Ks(e)})},{path:"modal",action:()=>({title:"Modal",component:ai(e)})},{path:"paginationNavigation",action:()=>({title:"Pagination Navigation",component:mi(e)})},{path:"paper",action:()=>({title:"Paper",component:vi(e)})},{path:"popover",action:()=>({title:"Popover",component:ci(e)})},{path:"radioButton",action:()=>({title:"Radio Button",component:Si(e)})},{path:"select",action:()=>({title:"Select",component:Di(e)})},{path:"selectNative",action:()=>({title:"Select Native",component:Bi(e)})},{path:"skeleton",action:()=>({title:"Skeleton",component:Hi(e)})},{path:"slider",action:()=>({title:"Slider",component:qi(e)})},{path:"spinner",action:()=>({title:"Spinner",component:Qi(e)})},{path:"stepper",action:()=>({title:"Stepper",component:bc(e)})},{path:"switch",action:()=>({title:"Switch",component:wc(e)})},{path:"table",action:()=>({title:"Table",component:Hc(e)})},{path:"tableOfContent",action:()=>({title:"Table",component:Wc(e)})},{path:"tablePagination",action:()=>({title:"Table Pagination",component:qc(e)})},{path:"tabs",action:()=>({title:"Tabs",component:Mc(e)})},{path:"toggle",action:()=>({title:"Toggle",component:Qc(e)})},{path:"toggleGroup",action:()=>({title:"Toggle Group",component:sl(e)})},{path:"tooltip",action:()=>({title:"Tooltip",component:pl(e)})},{path:"themeSwitch",action:()=>({title:"Theme Switch",component:hl(e)})},{path:"treeView",action:()=>({title:"Tree View",component:yl(e)})}]},{path:"pages",action:n=>({title:"Pages",component:Lo(e)})}]},El=e=>({title:e.tr("Page Not Found"),component:()=>"Not Found"}),kl=({context:e,LayoutDefault:t,config:{base:n=""}})=>{const{window:o,bau:a,states:i}=e,s=a.state(),r=t({componentState:s});return document.getElementById("app").replaceChildren(r),({router:l})=>{const u=o.location.pathname.replace(n,""),{title:d,component:p,Layout:g=t}=l.resolve({pathname:u});s.val=p({}),document.title=`${d}`}},Tl=e=>{const{createGlobalStyles:t}=e;t`
    :root {
      --header-height: 3rem;
    }
    html {
  ...
  `};po();const Xn={title:"Bau",base:"/bau/bau-ui"},he=wo({config:Xn}),{bau:Al}=he;he.states={drawerOpen:Al.state(!0)};Tl(he);to({routes:Cl({context:he}),onLocationChange:kl({context:he,LayoutDefault:No(he),config:Xn}),notFoundRoute:El(he)});
