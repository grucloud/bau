...
`);function se(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
    ...
    ${Io()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",...f},...v]=W(d);return r({required:"required",title:"Switch Theme",name:"theme-switch",...f,class:B("theme-switch",p,b,m,c,e==null?void 0:e.class,f.class),type:"checkbox",checked:s()=="dark",onclick:x=>{i(x.target.checked?"dark":"light")}},...v)}}function Mo(t){const{tr:e,bau:n,css:o,config:a,states:r}=t,{i,header:s,h1:l,div:c,a:u,img:d,b:m,ul:b,li:p}=n.tags,{svg:f,path:v}=n.tagsNS("http://www.w3.org/2000/svg"),x=r.drawerOpen,h=P(t,{class:o`
      background: transparent;
    `}),w=se(t),S=()=>i(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},v({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),E=()=>c({class:o`
          display: flex;
          align-items: center;
          & a {
            color: var(--color-inverse);
          }
        `},h({"aria-label":"drawer",variant:"none",color:"none",onclick:()=>x.val=!x.val},S()),u({href:`${a.base}/`,class:o`
            text-decoration: none;
            font-size: x-large;
          ...
          padding: 1rem;
          align-items: center;
        `},w(),h({class:o``,target:"_blank",href:"https://github.com/grucloud/bau",title:"Bau's Github"},d({class:o`
            border-radius: 50%;
            background: black;
  ...
  `,hideToRight:t`
   ...
   `});function ie(t,e={}){const{bau:n,css:o,window:a,config:r}=t,{base:i="",hashBased:s=!1}=e,l=`${r.base}${i}`,c=z=>{var C;return((C=z.parentTree.data)==null?void 0:C.href)??z.parentTree.children[0].data.href},u=({variant:z,color:C,size:g,currentTree:y,data:k})=>w(A({variant:z,color:C,size:g,href:`${l}${c(y)}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),A({variant:z,color:C,size:g,href:`${l}${k.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},k.name)),d=({size:z,subTree:{data:{name:C,href:g},children:y=[]}})=>A({size:z,href:`${l}${g}`,"data-ischild":!y.length},C),m=({pathname:z,subTree:C})=>{var g;return z===((g=C==null?void 0:C.data)==null?void 0:g.href)},{renderHeader:b=u,renderMenuItem:p=d,isActive:f=m}=e,{li:v,nav:x,div:h,header:w,a:S}=n.tags,E=Jt(t),D=vt(t),A=P(t,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:I,hideToRight:N}=Oo(t),$=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:B("input",e.class,e.size??"md",c,l,r,u.class)})}}function ce(t,e={}){const{bau:n,css:o,window:a}=t,r=dt(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,b=o`
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:B("inputSearch",e.class,b,u.class)})}}function Ge(t){const{tr:e,bau:n,css:o,config:a,states:r,window:i}=t,{div:s,ul:l,li:c,nav:u,a:d,span:m,form:b}=n.tags,p=ce(t,{variant:"plain",color:"neutral",size:"sm"}),v={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:w,children:S,pathnameState:E,variant:D,color:A,size:I})=>{const N=n.state(""),$=n.derive(()=>N.val==""?S:S.filter(j=>j.data.name.match(new RegExp(`${N.val}`,"i")))),L=j=>{N.val=j.target.value};return b({class:o`
          display: flex;
          flex-direction: column;
        `},p({autocomplete:"off",name:"component-search",autofocus:!0,value:N,placeholder:`Search ${$.val.length} components`,size:32,oninput:L}),()=>w({children:$.val,pathnameState:E,variant:D,color:A,size:I}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Key Value List",href:"/components/keyValueList"}},{data:{name:"Lazy",href:"/components/lazy"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Multi Select",href:"/components/multiSelect"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Radio Button Group",href:"/components/radioButtonGroup"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let x=!1;const h=ie(t);return function(){return s({bauMounted:({element:S})=>{i.innerWidth<=640&&(x=!0,r.drawerOpen.val=!1)},onclick:S=>{x&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(r.drawerOpen.val=!1)},style:()=>r.drawerOpen.val?"display:block;":"display:none;",class:B(o`
          ...
          `)},h({tree:v}))}}const Lo=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:r}=e.tags,i=Jt(t),s=Mo(t),l=Ge(t),c=No(t),u=a`
    from {
      opacity: 1;
    }
    to {
...
"Click me"
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("paper",l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}function an(t,e={}){const{bau:n,css:o,window:a}=t,{nav:r,ul:i,li:s,a:l}=n.tags,{headerSelector:c="h2,h3"}=e,u=n.state("no"),d=(v,x)=>{let h=null;return(...w)=>{a.clearTimeout(h),h=a.setTimeout(()=>v(...w),x)}},m=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,b=({value:v,id:x,children:h=[]})=>{const w=l({class:()=>u.val==x?"active":"",href:`#${x}`});return w.innerHTML=v,s({class:()=>u.val==x?"active":""},w,h.length>0&&i(h.map(b)))},p=v=>v.tagName.charAt(1),f=({contentEl:v})=>{const x=v.querySelectorAll(c);let h=2,w={},S={children:[]},E=S;const D=E;let A=[E];return[...x].forEach(I=>{const N=p(I);I.setAttribute("id",I.textContent),!I.innerHTML.includes("<button")&&(w={value:I.innerHTML,id:I.id??I.textContent,children:[]},h==N?(S=w,E.children.push(S)):h<N?(A.push(E),E=S,S.children.push(w),S=w):h>N&&(E=A[N-1],A=A.slice(0,N-1),E.children.push(w),S=w),h=N)}),D};return function(...x){let[{size:h=e.size??"md",variant:w=e.variant??"plain",color:S=e.color??"neutral",contentEl:E,...D}]=W(x);const A=f({contentEl:E}),I=d(()=>{const $=[...E.querySelectorAll(c)].find(L=>{const{top:j,height:G}=L.getBoundingClientRect();if(j+G>60)return!0});$&&(u.val=$==null?void 0:$.id)},100);return r({...D,class:B("tableOfContent",h,w,S,m,e==null?void 0:e.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",I)},bauUnmounted:()=>{a.removeEventListener("scroll",I)}},A.children&&i(A.children.map(b)))}}const rn=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
    ...
    `}),p=rn(t),f=Ua(t),v=({text:x})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:h})=>{h.innerHTML=It.highlight(x,{language:"js"}).value}}));return function(h){const w=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},i(h.title),s(h.description),h.gridItem&&!h.variantColorTableDisable&&[l("Variant/Color"),b(p({Item:h.gridItem(t)}))],h.gridItem&&!h.variantSizeDisable&&[l("Size"),s("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),b(f({item:h.gridItem}))],l("Usage"),c("Import"),v({text:h.importStatement}),l("Examples"),h.examples.map(S=>r(c(S.title),s(S.description),b(S.createComponent(t)({})),v({text:S.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
...
`).join(`
`);function Wt(t,e={}){const{bau:n,css:o}=t,{div:a,ul:r,li:i,h3:s,button:l}=n.tags,c=o`
    & ul {
      display: inline-flex;
      flex-direction: column;
      justify-content: flex-start;
    ...
    ${Va()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",data:f=[],...v}]=W(d);const x=n.state(""),h=be(t,{size:m,variant:b,color:p}),w=E=>D=>{x.val==E?x.val="":x.val=E},S=E=>{const{Header:D,Content:A,name:I}=E,N=()=>s({class:()=>B(x.val==I&&"active")},l({type:"button","aria-controls":`bau-${I}`,"aria-expanded":({element:L})=>x.val==I},D(E))),$=()=>a({id:`bau-${I}`,"data-state":({element:L})=>x.val==I},A(E));return i({class:B(p,b,m),onclick:w(I)},h({Header:N,Content:$}))};return a({class:B("accordion",c,e==null?void 0:e.class,v.class)},r(f.map(S)))}}const sn=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Wt(t,e);return s=>i({...s,data:r})},Ja=t=>{const{bau:e}=t,{div:n,p:o,section:a}=e.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Wt(t,{color:"neutral",variant:"outline"});return()=>a(i({data:r}))},qa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,cn=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Wa=t=>{const{css:e}=t,n=cn(t),o=Wt(t,{color:"warning",class:e`
      &.accordion {
        & ul {
          & li {
            width: fit-content;
...
`,Xa=t=>{const{css:e}=t,n=cn(t),o=Wt(t,{color:"success",variant:"outline",class:e`
      &.accordion {
        & ul {
          & li {
            & h3 {
...
`,sr={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:or,createComponent:nr},{title:"Custom Alert ",description:"A custom alert.",code:rr,createComponent:ar}],gridItem:ln},ir=t=>{const e=F(t);return()=>e(sr)},cr=(t,e={})=>{const{bau:n,css:o,keyframes:a}=t,{limit:r=10,deleteAfterDuration:i=15e3}=e,{div:s}=n.tags,l=n.state([]),c={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},d=({id:m,status:b})=>{const p=l.val.findIndex(f=>f.id===m);p!=-1&&(l.val[p].status=b)};return function(b={},...p){const f=({id:h})=>{d({id:h,status:"removing"});const w=l.val.findIndex(S=>S.id===h);w!=-1&&l.val.splice(w,1)},v=({Component:h})=>{const w={id:Math.random().toString(10).split(".")[1],Component:h,status:"inserting"};l.val.length>=r&&f({id:l.val[0].id}),l.val.push(w),setTimeout(()=>f(w),i)},x=h=>s({class:u.item,onclick:()=>f(h)},h.Component());return document.addEventListener("alert.add",h=>v(h.detail)),document.addEventListener("alert.remove",h=>f(h.detail)),s({class:B(u.stack,e==null?void 0:e.class,b.class)},n.loop(l,s(),x))}},lr=t=>{const{tr:e,bau:n}=t,{section:o}=n.tags,a=cr(t,{deleteAfterDuration:2e4}),r=P(t),i=Et(t);return()=>o(a(),r({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>i({color:"success"},e("Infrastructure Created"))}}))}},"Success Alert"))},ur=`import { Context } from "@grucloud/bau-ui/context";
...
`,hr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:fr,createComponent:gr}]},vr=t=>{const e=F(t);return()=>e(hr)};function kt(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:f=e.color??"neutral",width:v=40,height:x=40,alt:h,...w},...S]=W(m);const E=kt(t,{class:B(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${x}px;
          width: ${v}px;
        `,e==null?void 0:e.class,w.class)});return a({class:B(u,e==null?void 0:e.class,w.class)},()=>i.val&&E(),()=>s.val&&h,r({alt:h,width:v,height:x,onload:l,onerror:c,class:()=>B(!i.val&&"visible",s.val&&"hide",f,p,b,u,e==null?void 0:e.class,w.class),...w}))}}const un=(t,e)=>{const{css:n}=t,o=ge(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`,Cr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:yr,createComponent:xr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:wr,createComponent:Sr}],gridItem:un},kr=t=>{const e=F(t);return()=>e(Cr)};function $t(t,e){const{bau:n,css:o,window:a}=t,{dialog:r}=n.tags,i=o`
    ...
    opacity: 0;
  `;return function(...l){let[{contentEl:c,triggerEl:u,onClose:d,...m},...b]=W(l);const p=x=>{v.style.opacity=1,v.showModal();const h=u.getBoundingClientRect(),w=v.getBoundingClientRect();h.x<a.innerWidth/2?v.style.left=h.left+"px":v.style.left=h.right-w.width+"px",h.y<a.innerHeight/2?(v.style.top=h.top+h.height+"px",v.style.height=Math.min(v.scrollHeight,a.innerHeight-h.top-h.height)+"px"):(v.style.top=Math.max(0,h.top-w.height)+"px",v.scrollHeight>h.top&&(v.style.height=h.top+"px"))},f=x=>{const h=()=>{v.close(),v.removeEventListener("transitionend",h)};v.addEventListener("transitionend",h),v.style.opacity=0},v=r({role:"presentation",class:B("popover",i,e==null?void 0:e.class,m==null?void 0:m.class),onclick:x=>{x.target===v&&(f(),d==null||d.call())}},c);return v.closeDialog=f,v.openDialog=p,v}}const Ut={sm:12,md:16,lg:24},Er=()=>ot.map(t=>`
&.${t} {
...
`);function Kt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:b,Option:p,options:f,defaultOption:v,getOptionLabel:x,getOptionValue:h,onSelect:w=()=>{},id:S,required:E,name:D,loading:A,...I},...N]=W(l);const $=$t(t),L=P(t),j=dt(t,{variant:u,color:d,size:c}),G=vt(t),U=bt(t,{variant:u,color:d,size:c}),z=n.state(v),C=n.state(I.value),g=n.state(!1),y=n.state(0),k=()=>{g.val=!1},T=n.state(f),H=Q=>at=>Q.val&&x(at)==x(Q.val),R=()=>{ut.openDialog(),g.val=!0,C.val="",T.val=f,y.val=f.findIndex(H(z));const Q=Dt.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ct.scrollIntoView({block:"end"}))},V=()=>{ut.closeDialog(),g.val=!1,y.val=0},J=Q=>{const{value:at}=Q.target;C.val=at,at?T.val=f.filter(_t=>x(_t).match(new RegExp(`${at}`,"i"))):T.val=f},M=Q=>{ut.open?V():R()},X=Q=>{z.val=Q,lt.value=h(Q)},nt=({option:Q,index:at})=>_t=>{X(Q),y.val=at,V()},Z=()=>{const Q=Dt.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":y.val<T.val.length-1?y.val++:y.val=0,Z();break;case"ArrowUp":y.val<=0?y.val=T.val.length-1:y.val--,Z();break;case"Enter":ut.open?(X(T.val[y.val]),V()):R(),Q.preventDefault();break}},rt=L({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":g,"aria-label":m,onclick:M,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>z.val?x(z.val):m,()=>A==!0&&U({visibility:A})),ct=j({value:C,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":g,oninput:J,onkeydown:Y,...I}),lt=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:v&&h(v),required:E,name:D}),Dt=a({class:B(u,d,c,"content")},ct,()=>G({class:B(u,d,c)},T.val.map((Q,at)=>r({class:()=>B(y.val==at&&"active",H(z)(Q)&&"selected"),onclick:nt({option:Q,index:at})},p(Q))))),ut=$({id:S,triggerEl:rt,contentEl:Dt,onClose:k,class:o`
        overflow: hidden;
      `});return a({...I,class:B("autocomplete",i,e==null?void 0:e.class,I==null?void 0:I.class)},n.bind({deps:[z],render:()=>Q=>{Q&&(lt.value=h(Q),w(Q))}}),rt,lt,ut)}}const dn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Kt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=P(t,{variant:"outline"}),c=P(t,{variant:"solid",color:"primary"}),u=Kt(t),d=e.state([]),m=e.state(!1),b=e.state("");async function p({url:h,transform:w=S=>S}){try{m.val=!0;const S=await fetch(h,{});if(S.ok){const E=await S.json();d.val=w(E)}else b.val=S.statusText}catch(S){b.val=S.message}finally{m.val=!1}}const f=()=>p({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((w,S)=>w.name.common.localeCompare(S.name.common))});f();const v=h=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(h.flag),s(h.name.common)),x=h=>{h.preventDefault();const w=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(w))};return()=>o({onsubmit:x},a({class:n`
            display: flex;
            gap: 1rem;
...
`,Or={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Ar,createComponent:Dr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Nr,createComponent:Mr},{title:"Default Option",description:"A autocomplete with a default option.",code:Ir,createComponent:Br}],gridItem:dn},$r=t=>{const e=F(t);return()=>e(Or)};function mn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,zr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Pr,createComponent:Lr}],gridItem:pn},Rr=t=>{const e=F(t);return()=>e(zr)};function fe(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=P(t),u=o`
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:f=e.color??"neutral",items:v,...x},...h]=W(m);return r({...x,class:B(u,e==null?void 0:e.class,x==null?void 0:x.class)},v.map(({href:w,name:S})=>i((w!=null?c:s)({href:`${a.base}${w}`,color:f,variant:p,size:b,class:B(f,p,b)},S))))}}const bn=(t,e)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=fe(t,e);return a=>o({...a,...n})},_r=t=>{const{bau:e}=t,{section:n}=e.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=fe(t,{variant:"outline",color:"neutral"});return()=>n(a(o))},jr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,as={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:os,createComponent:ns}],gridItem:vn},rs=t=>{const e=F(t);return()=>e(as)};function ss(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:b,Previous:p,Next:f,...v}]=W(l);const x=()=>{i.val<=0?i.val=m.length-1:i.val--},h=()=>{i.val>=m.length-1?i.val=0:i.val++},w=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(b));return a({...v,class:B("carousel",c,r,e==null?void 0:e.class,v==null?void 0:v.class)},a({class:B("control","control-previous"),onclick:x},p()),a({class:B("control","control-next"),onclick:h},f()),w)}}const is=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],cs=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,r=P(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,Ms={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Is,createComponent:Bs}],variantColorTableDisable:!0,variantSizeDisable:!0},Ns=t=>{const e=F(t);return()=>e(Ms)};function Os(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...m},...b]=W(s);return a({class:B(r,e==null?void 0:e.class,m.class)},a({class:()=>B("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>B("content",d.val&&"content-open")},b))}}const $s=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=e.state(!1),r=Os(t),i=P(t,{color:"neutral",variant:"outline"}),s=Ge(t);return()=>n(o("Click on the button to open and close the drawer."),i({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),r({openState:a},s()))},Ls=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`);function Sn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=P(t),s=$t(t),l=vt(t),c=o`
    ${Rs()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"outline",color:p=e.color??"neutral",label:f,ListItem:v,items:x,...h},...w]=W(d);const S=n.state(0),E=()=>{G.openDialog(),G.focus()},D=()=>{G.closeDialog()},A=()=>{G.open?D():E()},I=U=>{A(),U.preventDefault()},N=({item:U,index:z})=>C=>{S.val=z,D(),C.preventDefault()},$=U=>{switch(U.preventDefault(),U.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},L=()=>l({tabindex:"0",class:B(p,b)},x.map((U,z)=>r({class:()=>B(S.val==z&&"active"),onclick:N({item:U,index:z})},v(U)))),j=i({type:"button",onclick:I,color:p,variant:b,size:m},f),G=s({triggerEl:j,contentEl:L()});return a({...h,class:B("dropdownMenu",p,m,c,e==null?void 0:e.class,h==null?void 0:h.class),onkeydown:$},j,G)}}const _s=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=Sn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},js=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=Sn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Gs=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Js={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Vs,createComponent:Us}],gridItem:(t,e)=>wn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},qs=t=>{const e=F(t);return()=>e(Js)};function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",Component:p,disabled:f,...v}=c;return a({class:B(s.base,f&&s.disabled,e==null?void 0:e.class,c.class)},r({class:B(m,b,d)},p({disabled:f}),i({type:"file",disabled:f,...v})))}}const kn=(t,e)=>{const{tr:n,bau:o,css:a,config:r}=t,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=Cn(t,e),m=p=>{const f=p.target.files[0];f?u.val=f.name:u.val="No file selected"},b=({disabled:p})=>l({class:B(a`
          ...
          `,p&&a`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${r.base}/uploadIcon.svg#Capa_1`})),c(n("Choose a file to upload")));return p=>d({Component:b,name:"file",accept:"text/*",onchange:m,...p})},Ws=t=>{const{tr:e,bau:n,css:o,config:a}=t,{svg:r,use:i}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,span:c}=n.tags,u=n.state("No file selected"),d=Cn(t),m=p=>{const f=p.target.files[0];f?u.val=f.name:u.val="No file selected"},b=({disabled:p})=>l({class:B(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`,s=o`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",loading:b,...p},...f]=W(c);const v=P(t),x=bt(t);return n.bind({deps:[b],render:()=>h=>v({...p,class:B("loadingButton",u,d,m,s,h&&"loading",e==null?void 0:e.class,p==null?void 0:p.class)},x({size:u,variant:d,color:m,visibility:h}),r({class:h&&"loading"},f))})}}const Ys=t=>{const{bau:e,css:n,config:o}=t,{section:a,h1:r,header:i,label:s,img:l,footer:c}=e.tags,u=ve(t,{variant:"solid",color:"primary"}),d=Et(t,{variant:"outline",color:"danger"}),m=dt(t),b=yt(t,{class:n`
      max-width: 400px;
      & > header {
        text-align: center;
      }
    ...
    `});return function({onLoggedIn:f=()=>{}}){const v=e.state(!1),x=e.state("");return b({onsubmit:async w=>{w.preventDefault();const{username:S,password:E}=Object.fromEntries(new FormData(w.currentTarget));try{v.val=!0;const D=await fetch("/auth/login",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:S,password:E})});if(D.ok){const A=await D.json();f(A)}else D.status==401?x.val="Invalid username or password":x.val=D.statusText}catch(D){x.val=D.message}finally{v.val=!1}}},i(l({width:"100",height:"100",src:`${o.base}/gc.svg`}),r("Login to Grucloud")),a(()=>x.val&&d(x.val),s("Email",m({type:"email",autofocus:!0,placeholder:"Email",name:"username",autocomplete:"username",required:!0})),s("Password",m({type:"password",placeholder:"Password",name:"password",autocomplete:"current-password",minlength:"8",required:!0}))),c(u({type:"submit",loading:v},"Login")))}},Qs=`import form from "@grucloud/bau-ui/form";
...
`,ti=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:r,footer:i}=e.tags,s=yt(t),l=P(t,{variant:"solid",color:"primary"}),c=dt(t);return function({onSubmitted:d=()=>{}}){return s({onsubmit:async b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p)),d(p)}},a(o("Form with input")),n(r("Branch",c({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(l({type:"submit"},"Click")))}},ei=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`,yi={title:"KeyValueList",package:"keyValueList",description:"The keyValueList component displays a list of key value pair",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/keyValueList/keyValueList.js",importStatement:'import keyValueList from "@grucloud/bau-ui/keyValueList";',examples:[{title:"Vertical keyValueList",description:"A vertical keyValueList.",code:hi,createComponent:fi},{title:"Horizontal keyValueList",description:"A horizontal keyValueList.",code:xi,createComponent:vi}]},Si=t=>{const e=F(t);return()=>e(yi)},wi="modulepreload",Ci=function(t){return"/bau/bau-ui/"+t},Le={},An=function(e,n,o){if(!n||n.length===0)return e();const a=document.getElementsByTagName("link");return Promise.all(n.map(r=>{if(r=Ci(r),r in Le)return;Le[r]=!0;const i=r.endsWith(".css"),s=i?'[rel="stylesheet"]':"";if(!!o)for(let u=a.length-1;u>=0;u--){const d=a[u];if(d.href===r&&(!i||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${r}"]${s}`))return;const c=document.createElement("link");if(c.rel=i?"stylesheet":wi,i||(c.as="script",c.crossOrigin=""),c.href=r,document.head.appendChild(c),i)return new Promise((u,d)=>{c.addEventListener("load",u),c.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${r}`)))})})).then(()=>e())};function Bn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=bt(t,{size:"lg"}),i=Et(t,{color:"danger"}),s=()=>a({class:o`
          ...
          justify-content: center;
          align-items: center;
        `},r({visibility:!0})),l=c=>i(c.message);return function({getModule:u,loading:d=s,error:m=l,props:b={}}){const p=n.state(void 0),f=n.state(!0),v=n.state(!1);return u().then(x=>{n.batch(()=>{p.val=x.default(t),f.val=!1})}).catch(x=>{v.val=x.message}),a(()=>{if(v.val)return m({message:v.val});if(f.val)return d();if(p.val)return p.val(b)})}}const ki=t=>{const{bau:e}=t,{section:n}=e.tags,o=e.state(!1),a=Bn(t),r=P(t);return()=>n(r({onclick:()=>o.val=!o.val},()=>o.val?"Hide":"Show"),()=>o.val&&a({getModule:()=>An(()=>import("./myComponent-a7adf959.js"),[]),props:{message:"myValue"}}))},Ei=`import { Context } from "@grucloud/bau-ui/context";
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",running:p,...f}]=W(u);return r({...f,role:"progressbar",class:{deps:[p],renderProp:()=>v=>B("linearProgress",d,b,l,v&&"running",e==null?void 0:e.class,f==null?void 0:f.class)}})}}const Mn=(t,e)=>{const n=In(t,e);return o=>n({...o,running:!0})},Ii=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=P(t,{variant:"solid",color:"primary"}),r=In(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({running:i}))},Mi=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Ni={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:Mi,createComponent:Ii}],gridItem:Mn},Oi=t=>{const e=F(t);return()=>e(Ni)},Nn=(t,e)=>{const n=ve(t,e);return o=>n({...o,loading:!0},"Save")},$i=t=>{const{bau:e}=t,{section:n}=e.tags,o=ve(t,{variant:"solid",color:"primary"}),a=e.state(!0);return()=>n(o({loading:a,onclick:()=>a.val=!a.val},"Save"))},Li=`import loadingButton from "@grucloud/bau-ui/loadingButton";
...
`);function Xi(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=P(t),l=$t(t),c=vt(t),u=Tt(t,{color:"neutral",variant:"outline"}),d=o`
    ...
    ${Ki()}
  `;return function(...b){let[{size:p=e.size??"md",variant:f=e.variant??"outline",color:v=e.color??"neutral",name:x,label:h,Option:w,options:S,defaultValue:E=[],getOptionLabel:D,getOptionValue:A,renderValue:I,onSelect:N=()=>{},loading:$,...L},...j]=W(b);const G=bt(t,{variant:f,color:v,size:p}),U=n.state(E),z=n.state(!1),C=n.state(0),g=()=>{X.openDialog(),X.focus(),z.val=!0},y=()=>{X.closeDialog(),z.val=!1},k=()=>{z.val=!1},T=Z=>{X.open?y():g(),Z.preventDefault()},H=()=>Array.from(nt.selectedOptions).map(({value:Z})=>S.find(Y=>A(Y)==Z)),R=Z=>{switch(Z.preventDefault(),Z.key){case"Escape":y();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Y=Z.currentTarget.querySelectorAll("input")[C.val];Y.checked=!Y.checked;const rt=nt.options[C.val+1];rt.selected=!rt.selected,U.val=H()}else g();break}},V=Z=>Y=>{const rt=[...nt.options].find(({value:ct})=>ct==A(Z));Y.target.checked?rt.selected=!0:rt.selected=!1,U.val=H()},J=()=>c({tabindex:"0",class:B(v,f)},S.map((Z,Y)=>r({class:()=>B(C.val==Y&&"active")},n.tags.label(u({checked:E.find(rt=>A(rt)==A(Z)),name:`${x}-${A(Z)}`,onchange:V(Z)}),w(Z))))),M=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":z,"aria-label":h,onclick:T,color:v,variant:f,size:p,class:$==!0&&"loading",disabled:$},()=>U.val.length?I(U.val):h,()=>$==!0&&G({visibility:$})),X=l({triggerEl:M,contentEl:J(),onClose:k}),nt=i({name:x,multiple:!0,...L},n.tags.option({value:""},"--Category--"),S.map(Z=>n.tags.option({value:A(Z),selected:E.find(Y=>A(Y)==A(Z))},D(Z))));return a({...L,class:B("multiSelect",v,p,d,e==null?void 0:e.class,L==null?void 0:L.class),onkeydown:R},nt,M,X)}}const Zi=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=Xi(t),l=P(t,{variant:"outline",color:"neutral"}),c=Ot(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=b=>a(b.group),m=b=>{b.preventDefault();const{selectedOptions:p}=b.target.elements.myMultiSelect;var f=Array.from(p).map(({value:v})=>v);alert(JSON.stringify(f))};return()=>r({onsubmit:m,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
        `},s({name:"myMultiSelect",options:u,Option:d,defaultValue:[{group:"IAM"}],getOptionValue:({group:b})=>b,getOptionLabel:({group:b})=>b,renderValue:b=>o({class:n`
                ...
                align-items: center;
                gap: 0.2rem;
              `},b.map(p=>c(p.group))),label:"Select services"}),i(l({type:"submit"},"Submit")))},Yi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,rc={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:ac,createComponent:oc}]},sc=t=>{const e=F(t);return()=>e(rc)};function ic(t,e={}){const{bau:n,css:o,config:a}=t,{div:r,a:i,span:s,nav:l}=n.tags,c=o`
  ...
  `,u=({text:d})=>({name:m,label:b,href:p})=>i({href:`${a.base}${p}`},s({class:"sublabel"},d),r({class:`label ${d}`},b??m));return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:f=e.color??"neutral",data:v={},...x}]=W(m);const{next:h,previous:w}=v;return l({"data-paginationnav":JSON.stringify(v),"aria-label":"pages navigation",...x,class:B("paginationNavigation",b,c,e==null?void 0:e.class,x==null?void 0:x.class)},(w==null?void 0:w.href)&&u({text:"Previous"})(w),(h==null?void 0:h.href)&&u({text:"Next"})(h))}}const cc=t=>{const{bau:e}=t,{section:n}=e.tags,o=ic(t,{variant:"solid",color:"primary"}),a={next:{name:"next page",label:"Popover",href:"/components/popover"},previous:{name:"previous page",label:"Paper",href:"/components/paper"}};return()=>n(o({data:a}))},lc=`import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";
...
`,xc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:vc,createComponent:hc}],gridItem:Ln},yc=t=>{const e=F(t);return()=>e(xc)};function Xt(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=xe(t),l=o`
  ...
  `).join(`
`))()};
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"none",color:b=e.color??"neutral",name:p,oninput:f,value:v,radios:x=[],...h}]=W(u);return a({...h,class:B("radioButtonGroup",d,b,m,l,e==null?void 0:e.class,h==null?void 0:h.class)},x.map(({id:w,Label:S})=>r(i({size:d,variant:m,color:b,id:w,name:p,checked:v==w,value:w,oninput:f}),S())))}}const Sc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,p:r}=e.tags,i=Xt(t),s=P(t,{variant:"outline",color:"primary"}),l=e.state("two"),c=({target:d})=>l.val=d.id,u=d=>{d.preventDefault(),alert(l.val)};return()=>n({onsubmit:u},o(i({oninput:c,name:"myRadio",value:l.val,radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]}),r("CheckedState: ",l)),a(s({type:"submit"},"Submit")))},wc=`import { Context } from "@grucloud/bau-ui/context";
...
`,Cc=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Xt(t),i=P(t,{variant:"outline",color:"primary"}),s=l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))};return()=>n({onsubmit:s},o(r({name:"myRadio",value:"one",radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},kc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`);function Lt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,l=P(t),c=$t(t),u=vt(t),d=o`
    ...
    ${Mc()}
  `;return function(...b){let[{size:p=e.size??"md",variant:f=e.variant??"outline",color:v=e.color??"neutral",label:x,Option:h,options:w,defaultOption:S,getOptionLabel:E,getOptionValue:D,onSelect:A=()=>{},loading:I,...N},...$]=W(b);const L=bt(t,{variant:f,color:v,size:p}),j=n.state(S?E(S):x),G=n.state(!1),U=n.state(0),z=()=>{V.openDialog(),V.focus(),G.val=!0},C=()=>{V.closeDialog(),G.val=!1},g=()=>{G.val=!1},y=M=>{V.open?C():z(),M.preventDefault()},k=({option:M,index:X})=>nt=>{j.val=E(M),J.value=D(M),J.setCustomValidity(""),U.val=X,C(),A(M),nt.preventDefault()},T=M=>{switch(M.preventDefault(),M.key){case"Escape":C();break;case"ArrowDown":U.val<w.length-1?U.val++:U.val=0;break;case"ArrowUp":U.val<=0?U.val=w.length-1:U.val--;break;case"Enter":V.open?(j.val=E(w[U.val]),J.value=D(s),C()):z();break}},H=()=>u({tabindex:"0",class:B(v,f)},w.map((M,X)=>r({class:()=>B(U.val==X&&"active"),onclick:k({option:M,index:X})},h(M)))),R=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":G,"aria-label":x,onclick:y,color:v,variant:f,size:p,class:I==!0&&"loading",disabled:I},()=>!j.val&&x,j,()=>I==!0&&L({visibility:I})),V=c({triggerEl:R,contentEl:H(),onClose:g}),J=i(N,s({value:""},"--Select Category--"),w.map(M=>s({value:D(M)},E(M))));return S?J.value=D(S):J.value=N.value,a({...N,class:B("select",v,p,d,e==null?void 0:e.class,N==null?void 0:N.class),onkeydown:T},J,R,V)}}const Pn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Lt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(c.label),r(c.code));return c=>i({...c,options:s,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},Nc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Lt(t),c=P(t,{variant:"solid",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],d=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(b.label),s(b.code)),m=b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))};return()=>o({onsubmit:m},a(l({name:"country",options:u,Option:d,getOptionValue:({code:b})=>b,getOptionLabel:({label:b})=>b,label:"Select a country..."})),r(c({type:"submit"},"Submit")))},Oc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,$c=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Lt(t),c=P(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(p.label),s(p.code)),b=p=>{p.preventDefault();const f=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(f))};return()=>o({onsubmit:b},a(l({name:"country",options:d,Option:m,defaultOption:d.find(({code:p})=>p==u),getOptionValue:({code:p})=>p,getOptionLabel:({label:p})=>p,label:"Select a country..."})),r(c({type:"submit"},"Submit")))},Lc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,Rc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=P(t,{variant:"outline"}),c=P(t,{variant:"solid",color:"primary"}),u=Lt(t),d=e.state([]),m=e.state(!1),b=e.state("");async function p({url:h,transform:w=S=>S}){try{m.val=!0;const S=await fetch(h,{});if(S.ok){const E=await S.json();d.val=w(E)}else b.val=S.statusText}catch(S){b.val=S.message}finally{m.val=!1}}const f=()=>p({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((w,S)=>w.name.common.localeCompare(S.name.common))});f();const v=h=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(h.flag),i(h.name.common)),x=h=>{h.preventDefault();const w=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(w))};return()=>o({onsubmit:x},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:d.val,Option:v,getOptionValue:({name:h})=>h.common,getOptionLabel:({name:h})=>h.common,label:"Country",id:"country",loading:m.val,required:!0}),l({onclick:()=>f()},"Reload")),r(c({type:"submit"},"Submit")))},_c=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`,jc={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Oc,createComponent:Nc},{title:"Default Option",description:"Select with a default option",code:Lc,createComponent:$c},{title:"Select AWS region",description:"Select the AWS region",code:zc,createComponent:Pc},{title:"Loading Indicator",description:"Select with a loading indicator",code:_c,createComponent:Rc}],gridItem:Pn},Gc=t=>{const e=F(t);return()=>e(jc)};function zn(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
...
`).join(`
`))()};
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...b]=W(l);return a({...m,type:"range",class:B("slider",d,u,c,i,e==null?void 0:e.class,m.class)},...b)}}const _n=t=>{const{bau:e}=t,n=e.state(0),o=r=>{n.val=r==null?void 0:r.target.value},a=Zt(t);return r=>a({...r,oninput:o})},nl=t=>{const{bau:e}=t,{section:n,form:o,label:a,br:r}=e.tags,i=e.state(0),s=c=>{i.val=c==null?void 0:c.target.value},l=Zt(t);return()=>n(o(a("Slider with step, min and max",r,l({oninput:s,name:"slider-simple",step:20,min:-100,max:100}))))},ol=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,al=t=>{const{bau:e,css:n}=t,{section:o,form:a,label:r,datalist:i,br:s,option:l}=e.tags,c=e.state(0),u=m=>{c.val=m==null?void 0:m.target.value},d=Zt(t);return()=>o(a(r({for:"temp"},"Choose a comfortable temperature"),s,d({oninput:u,class:n`
            width: 300px;
            margin: 0;
          `,id:"temp",name:"temp",list:"markers"}),i({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(m=>l({value:Number(m),label:m})))))},rl=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,sl=t=>{const{bau:e,css:n}=t,{section:o,form:a,label:r,datalist:i,br:s,option:l}=e.tags,c=e.state(0),u=m=>{c.val=m==null?void 0:m.target.value},d=Zt(t);return()=>o(a({class:n`
            display: flex;
          ...
          `}),i({id:"markers-vertical",class:n`
              ...
              flex-direction: column;
              justify-content: space-between;
            `},["0","25","50","75","100"].reverse().map(m=>l({value:Number(m),label:m})))))},il=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,cl={title:"Slide",package:"slider",description:"The slider component allows a user to to choose a number between a range.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/slider/slider.js",importStatement:'import slider from "@grucloud/bau-ui/slider";',examples:[{title:"Default",description:"A simple slider.",code:ol,createComponent:nl},{title:"Horizontal Mark",description:"A slider with horizontal mark.",code:rl,createComponent:al},{title:"Vertical Mark",description:"A vertical slider with marks.",code:il,createComponent:sl}],gridItem:_n},ll=t=>{const e=F(t);return()=>e(cl)},jn=(t,e)=>{const n=bt(t,e);return o=>n({...o})},ul=t=>{const{bau:e}=t,{section:n}=e.tags,o=P(t,{variant:"solid",color:"primary"}),a=bt(t,{size:"lg"}),r=e.state(!0);return()=>n(o({onclick:()=>r.val=!r.val},()=>r.val?"Stop":"Start"),a({visibility:r}))},dl=`import spinner from "@grucloud/bau-ui/spinner";
import button from "@grucloud/bau-ui/button";
...
`,ml={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:dl,createComponent:ul}],gridItem:jn},pl=t=>{const e=F(t);return()=>e(ml)},bl=()=>ot.map(t=>"").join(`
`),Gn=(t,e)=>(n,o)=>{const a=new URLSearchParams(t.window.location.search);return a.delete(e),a.append(e,n),o&&Object.entries(o).map(([r,i])=>(a.delete(r),a.append(r,i))),`?${a.toString()}`};function Hn(t,e={}){const{bau:n,css:o,window:a}=t,{div:r,ul:i,li:s,span:l,section:c}=n.tags,u=o`
  ...
  `;return function(...m){let[{color:b,variant:p="plain",size:f,stepperDefs:v=[],stepperName:x,activeStepIndex:h=n.state(0),...w},...S]=W(m);const E=n.state(v.map((L,j)=>({...L,index:j}))),D=n.state([]);a.history.pushState=new Proxy(a.history.pushState,{apply:(L,j,G)=>{L.apply(j,G);const U=G[2]??"";console.log("stepper pushState ",U),["?","#"].includes(U[0])&&$()}});const A=n.derive(()=>E.val[h.val]),I=L=>{const{Header:j,disabled:G,name:U,index:z}=L;return s({class:()=>B(A.val.name==U&&"active",h.val<z&&"not-completed",h.val>z&&"completed",G&&"disabled")},l({class:"step-number"},z+1),l({class:"step-label"},()=>j(L)))},N=L=>v.findIndex(({name:j})=>j==L.name),$=()=>{const j=new URLSearchParams(a.location.search).get(x)??v[0].name,G=Math.max(v.findIndex(({name:U})=>U==j),0);G<h.val&&(console.log("remove last step"),D.val.pop()),D.val.some(({name:U})=>j==U)||(console.log("add new step"),D.val.push(v[G])),h.val=G};return $(),r({bauMounted:({element:L})=>{a.addEventListener("popstate",$)},bauUnmounted:()=>{a.removeEventListener("popstate",$)},class:B("stepper",p,f,b,u,e==null?void 0:e.class,w.class)},n.loop(E,i(),I),n.loop(D,c(),L=>r({class:()=>B("content",L.name==A.val.name&&"visible")},L.Content({nextStep:v[N(L)+1],previousStep:v[N(L)-1]}))))}}const Pe="my-wizard",gl=t=>{const{bau:e,window:n}=t,{footer:o,p:a,label:r,section:i,a:s,ul:l,li:c}=e.tags,u=dt(t),d=yt(t),m=Hn(t),b=Gn(t,Pe),p=P(t,{variant:"outline",color:"primary"}),f=P(t,{variant:"solid",color:"primary"}),v=({nextStep:w})=>S=>{S.preventDefault();const{organization:E}=S.target.elements;n.history.pushState("","",b(w.name,{organization:E.value}))},x=w=>{var A;w.preventDefault();const{organization:S}=(A=n.document.forms)==null?void 0:A.formStep1.elements,D=new URLSearchParams(n.location.search).get("choice");alert(`organization ${S.value}, choice:${D}`)},h=[{name:"step1",Header:()=>"Step 1",Content:({nextStep:w})=>d({onsubmit:v({nextStep:w}),id:"formStep1"},r("Organization",u({autofocus:!0,placeholder:"Organization",name:"organization"})),o(f({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:w,previousStep:S})=>d(l(c(s({href:b(w.name,{choice:"choice1"})},"Choice 1")),c(s({href:b(w.name,{choice:"choice2"})},"Choice 2"))),o(p({href:b(S.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:w})=>d({onsubmit:x},a("My stepper 3 Content"),o(p({href:b(w.name)},"Previous: Step 2"),f({type:"submit"},"Save")))}];return()=>i(m({stepperDefs:h,stepperName:Pe}))},fl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,ze="stepper-vertical",hl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=e.tags,d=dt(t),m=yt(t),b=Hn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
    ...
    `}),p=Gn(t,ze),f=P(t,{variant:"outline",color:"primary"}),v=P(t,{variant:"solid",color:"primary"}),x=({nextStep:S})=>E=>{E.preventDefault();const{organization:D}=E.target.elements;n.history.pushState("","",p(S.name,{organization:D.value}))},h=S=>{var I;S.preventDefault();const{organization:E}=(I=n.document.forms)==null?void 0:I.formStep1.elements,A=new URLSearchParams(n.location.search).get("choice");alert(`organization ${E.value}, choice:${A}`)},w=[{name:"step1",Header:()=>"Step 1",Content:({nextStep:S})=>m({onsubmit:x({nextStep:S}),id:"formStep1"},i("Organization",d({autofocus:!0,placeholder:"Organization",name:"organization"})),a(v({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:S,previousStep:E})=>m(c(u(l({href:p(S.name,{choice:"choice1"})},"Choice 1")),u(l({href:p(S.name,{choice:"choice2"})},"Choice 2"))),a(f({href:p(E.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:S})=>m({onsubmit:h},r("My stepper 3 Content"),a(f({href:p(S.name)},"Previous: Step 2"),v({type:"submit"},"Save")))}];return()=>s(b({stepperDefs:w,stepperName:ze}))},vl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,xl={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Horizontal Stepper",description:"A simple horizontal stepper.",code:fl,createComponent:gl},{title:"Vertical Stepper",description:"A simple vertical stepper.",code:vl,createComponent:hl}]},yl=t=>{const e=F(t);return()=>e(xl)},Sl=()=>ot.map(t=>`
&.switch.plain.${t} {
  &::after {
...
`);function Fn(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("switch",r,u,c,l,e==null?void 0:e.class,d.class),type:"checkbox"},...m)}}const Un=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Fn(t,e);return s=>a({class:o`
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},wl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r}=e.tags,i=Fn(t,{variant:"outline"}),s=P(t,{variant:"outline",color:"primary"}),l=c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))};return()=>a({onsubmit:l},r({class:n`
            ...
            align-items: center;
            gap: 0.5rem;
          `},"My shinny switch",i({name:"my-shinny-switch"})),o(s({type:"submit"},"Submit")))},Cl=`import { Context } from "@grucloud/bau-ui/context";
...
`,kl={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:Cl,createComponent:wl}],gridItem:Un},El=t=>{const e=F(t);return()=>e(kl)},Tl=()=>ot.map(t=>`
&.tabs.solid.${t} {
}
`).join(`
`);function Pt(t,e={}){const{bau:n,css:o,window:a}=t,{tabDefs:r}=e,{div:i,ul:s,li:l,a:c}=n.tags,u=o`
    ...
    ${Tl()}
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:f=e.color??"neutral",tabsKey:v="tabs",...x},...h]=W(m);const w=n.state(r),S=$=>w.val.find(L=>L.name==$),E=n.state(r[0]),D=()=>{var j,G;const L=new URLSearchParams(a.location.search).get(v)??r[0].name;if(L!=E.val.name){const U=S(L);(j=E.val.exit)==null||j.call(),E.val=U,(G=U==null?void 0:U.enter)==null||G.call()}};D(),a.history.pushState=new Proxy(a.history.pushState,{apply:($,L,j)=>{$.apply(L,j);const G=j[2]??"";["?","#"].includes(G[0])&&D()}});const A=$=>{const L=new URLSearchParams(a.location.search);return L.delete(v),L.append(v,$),`?${L.toString()}`},I=$=>{const{Header:L,disabled:j,name:G}=$;return l({class:()=>B(E.val.name==G&&"active",j&&"disabled")},c({href:A(G)},L($)))},N=i({class:B("tabs",p,b,f,u,e==null?void 0:e.class,x.class),bauMounted:({element:$})=>{a.addEventListener("popstate",D)},bauUnmounted:()=>{a.removeEventListener("popstate",D)}},n.loop(w,s(),I),n.bind({deps:[E],render:()=>({Content:$})=>$?$(x):""}));return N.addEventListener("tab.add",$=>{var j;const{tab:L}=$.detail;(j=L.enter)==null||j.call(),w.val.push(L)},!1),N.addEventListener("tab.remove",$=>{var j;const L=w.val.findIndex(G=>G.name==$.detail.tabName);L>0&&((j=w.val[L].exit)==null||j.call(),w.val.splice(L,1))},!1),N}}const Dl=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=Pt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]});return()=>r({})},Al=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Bl=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=Pt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>"Tab Disabled",Content:()=>n(o("My Content Disabled"))}],variant:"plain",color:"neutral"});return()=>r({tabsKey:"my-tab"})},Il=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vn=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Tab1",Header:()=>"TAB",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]},Ml=t=>{const{css:e}=t,n=Pt(t,{tabDefs:Vn(t),class:e`
      flex-direction: column-reverse;
    `});return()=>n({})},Nl=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ol=t=>{const{css:e}=t,n=Vn(t),o=Pt(t,{tabDefs:n,class:e`
      & ul {
        justify-content: center;
      }
    `});return()=>o({})},$l=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ll={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Al,createComponent:Dl},{title:"Extended Tabs",description:"An extended tabs.",code:Il,createComponent:Bl},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:Nl,createComponent:Ml},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:$l,createComponent:Ol}]},Pl=t=>{const e=F(t);return()=>e(Ll)};function zt(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:r}=n.tags;a`
  :root {
...
`;const i=o`
    ...
    width: fit-content;
  `;return function(...l){let[{...c},...u]=W(l);return r({...c,class:B("table-container",i,e==null?void 0:e.class,c==null?void 0:c.class)},...u)}}const zl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags;function d(v,x,h,w,S){return{name:v,calories:x,fat:h,carbs:w,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],b=({name:v,calories:x})=>i(r(v),r({class:n`
            text-align: right;
          `},x)),p=()=>l(i(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(f(s(u("Basic Table"),p(),c(m.map(b)))))},Rl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function At(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const _l=[At("Frozen yoghurt",159,6,24,4),At("Ice cream sandwich",237,9,37,4.3),At("Eclair",262,16,24,6),At("Cupcake",305,3.7,67,4.3),At("Gingerbread",356,16,49,3.9)],jl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:f})=>i(r(p),r({class:n`
    ...
    `});return()=>o(b(s(u("Table Dense"),m(),c(_l.map(d)))))},Gl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Bt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Hl=[Bt("Frozen yoghurt",159,6,24,4),Bt("Ice cream sandwich",237,9,37,4.3),Bt("Eclair",262,16,24,6),Bt("Cupcake",305,3.7,67,4.3),Bt("Gingerbread",356,16,49,3.9)],Fl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:f})=>i(r(p),r({class:n`
            text-align: right;
          `},f)),m=()=>l(i(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(b(s(u("Table Zebra"),m(),c(Hl.map(d)))))},Ul=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vl={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Rl,createComponent:zl},{title:"Dense",description:"A dense table.",code:Gl,createComponent:jl},{title:"Zebra",description:"A zebra table.",code:Ul,createComponent:Fl}]},Jl=t=>{const e=F(t);return()=>e(Vl)},ql=t=>{const{bau:e,css:n}=t,{h1:o,h2:a,h3:r,section:i,article:s}=e.tags,l=an(t),c=s({id:"content",class:n`
        grid-area: content;
...
`,Kl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Wl,createComponent:ql}]},Xl=t=>{const e=F(t);return()=>e(Kl)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=he(t),i=P(t),s=bt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:p,icon:f,...v})=>i({"aria-label":p,title:p,...v},f),u=({count:p,totalCount:f,page:v,rowsPerPage:x})=>a({class:"pages-numbers"},Number(v-1)*Number(x)+(p>0?1:0),"-",Math.min(v*x,f)," of ",f),d=({count:p,page:f,rowsPerPage:v})=>a({class:"pages-numbers"},(f-1)*v+(p>0?1:0),"-",f*v),m=p=>p<=1,b=(p,f,v)=>p>=Math.ceil(f/v);return function(...f){let[{size:v=e.size??"md",variant:x=e.variant??"outline",color:h=e.color??"neutral",count:w=0,totalCount:S=0,page:E=1,rowsPerPage:D=50,onPageChange:A,isLoading:I=!1,disableFirst:N=()=>m(E),disablePrevious:$=()=>m(E),disableNext:L=()=>b(E,S,D),disableLast:j=()=>b(E,S,D),...G},...U]=W(f);const z=Math.max(0,Math.ceil(S/D)),C=A({page:1}),g=A({page:E-1}),y=A({page:E+1}),k=A({page:z}),T=[{label:"First",icon:"⟪",onclick:C,disabled:N()},{label:"Previous",icon:"⟨",onclick:g,disabled:$()},{label:"Next",icon:"⟩",onclick:y,disabled:L()},{label:"Last",icon:"⟫",onclick:k,disabled:j()}];return a({...G,class:B("table-pagination",l,I&&"disabled",e==null?void 0:e.class,G==null?void 0:G.class)},s({class:"spinner",visibility:I,size:"md"}),S>0?u({count:w,totalCount:S,page:E,maxPages:z,rowsPerPage:D}):d({count:w,page:E,maxPages:z,rowsPerPage:D}),r({variant:x,color:h},T.map(H=>c({...H,variant:x,color:h}))))}}const Zl=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Yl=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=Zl(45),u=({name:h,email:w})=>r(a(h),a(w)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=Jn(t),b=zt(t,{class:n`
      max-width: 650px;
    `}),p=e.state(c),f=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),v=e.derive(()=>p.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),x=({page:h})=>w=>{f.val.page=h};return()=>b(i(d(),()=>l(v.val.map(u))),()=>m({...f.val,onPageChange:x}))},Ql=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),b=e.derive(()=>d.val.length),p=e.state(1),f=e.state(10),v=e.derive(()=>d.val),x=N=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(N).toString()}`,h=({page:N})=>$=>{p.val=N,w(x({page:N,per_page:f.val}))};w(x({page:1,per_page:f.val}));async function w(N){try{u.val=!0;const $=await fetch(N,{});if($.ok){const L=await $.json();d.val=L;return}throw $}catch($){m.val=$.message}finally{u.val=!1}}const S=({name:N,description:$,stargazers_count:L})=>r(a(N),a($),a({class:n`
            text-align: right;
          `},L)),E=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),I=({message:N})=>c(N);return()=>A(()=>D({rowsPerPage:f.val,page:p.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:h,disableNext:()=>!1}),i(E(),()=>m.val&&I({message:m.val}),()=>l(v.val.map(S))))},tu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=Yl(t),c=Ql(t),u=(...d)=>a({class:n`
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",selected:m=!1,disabled:b,onChange:p,...f},...v]=W(l);return r({type:"button",...f,"aria-pressed":{deps:[m],renderProp:()=>x=>x},class:{deps:[m],renderProp:()=>x=>B("toggle",c,d,u,i,x&&"selected",e==null?void 0:e.class,f==null?void 0:f.class)},disabled:b},v)}}const qn=(t,e)=>{const{bau:n}=t,o=Rt(t,e);return a=>{const r=n.state(!1);return o({...a,selected:r,onclick:()=>r.val=!r.val},"Toggle Me")}},eu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Rt(t,{variant:"plain"}),i=P(t,{variant:"outline",color:"primary"}),s=e.state(!1),l=c=>{var m;c.preventDefault();const d=(m=c.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:m.name;alert(d)};return()=>n({onsubmit:l},o(r({name:"my-toogle",selected:s,onclick:()=>s.val=!s.val},"Toggle Me")),a(i({type:"submit"},"Submit")))},nu=`import { Context } from "@grucloud/bau-ui/context";
...
`,ou={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:nu,createComponent:eu}],gridItem:qn},au=t=>{const e=F(t);return()=>e(ou)},ru=()=>ot.map(t=>`
&.toggle-group.${t} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${t}) !important;
  }
...
`,uu={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:iu,createComponent:su},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:lu,createComponent:cu}],gridItem:Wn},du=t=>{const e=F(t);return()=>e(uu)};function Se(t,e={}){const{bau:n,css:o,window:a}=t,{div:r}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
  ...
  `;return function(...l){let[{titleEl:c,side:u="bottom-start",size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",...p},...f]=W(l);const v=r({class:B("container",...u.split("-"))},r({class:B("content",b,m,d),role:"tooltip"},c)),x=A=>`move-to-${A}`,h=(A,I,N)=>{if(A()){const $=x(I);v.classList.add($),v.classList.add(I),v.classList.remove(N)}},w=(A,I)=>{const N=x(A);v.classList.contains(N)&&(v.classList.remove(N),v.classList.add(I),v.classList.remove(A))},S=A=>{const I=v.getBoundingClientRect();h(()=>I.x<0,"right","left"),h(()=>I.x+I.width>a.innerWidth,"left","right"),h(()=>I.y<0,"bottom","top"),h(()=>I.bottom>a.innerHeight,"top","bottom"),v.classList.add("visible")},E=A=>{v.classList.remove("visible"),w("right","left"),w("left","right"),w("bottom","top"),w("top","bottom")};return r({...p,class:B("tooltip",i,e==null?void 0:e.class,p==null?void 0:p.class),bauMounted:({element:A})=>{A.addEventListener("mouseover",S),A.addEventListener("mouseout",E)},bauUnmounted:({element:A})=>{A.removeEventListener("mouseover",S),A.removeEventListener("mouseout",E)}},...f,v)}}const Kn=(t,e)=>{const{bau:n}=t,{div:o,p:a,em:r}=n.tags,i=P(t),s=Se(t,e),l=()=>o(a("A ",r("tooltip")," can be any component"));return c=>s({titleEl:l(),...c},i(c,`${c.color} ${c.variant}`))},mu=t=>{const{bau:e}=t,{div:n,p:o,em:a}=e.tags,r=P(t),i=Se(t),s=()=>n(o("A ",a("tooltip")," can be any component"));return()=>i({side:"bottom-start",titleEl:s()},r("tooltip"))},pu=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,bu=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:r,section:i}=e.tags,s=Ot(t,{variant:"outline",color:"primary"}),l=Se(t),c=()=>o(a("A ",r("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
...
`,fu={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import tooltip from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:pu,createComponent:mu},{title:"Grid",description:"Various tooltip position",code:gu,createComponent:bu}],gridItem:Kn},hu=t=>{const e=F(t);return()=>e(fu)},Xn=(t,e)=>{const n=se(t,e);return o=>n(o)},vu=t=>{const{bau:e}=t,{section:n}=e.tags,o=se(t);return()=>n(o({}))},xu=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,yu={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:xu,createComponent:vu}],gridItem:Xn},Su=t=>{const e=F(t);return()=>e(yu)},Zn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Zn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},wu=({css:t,createGlobalStyles:e})=>(e`
:root {
...
`,{nav:t`
  ...
  `});function we(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{renderMenuItem:r}=e,{ul:i,li:s,nav:l,div:c}=n.tags,u=wu({css:o,createGlobalStyles:a}),d=be(t),m=({depth:b=1,maxDepth:p,parent:f,color:v,variant:x,size:h})=>w=>{const{children:S,expanded:E}=w,D=n.state(!E),A=()=>c({class:o`
              cursor: ${S?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:N=>{S&&(D.val=!D.val)}},r({item:w,parent:f,depth:b})),I=()=>i({class:B(v,h)},S.map(m({depth:b+1,maxDepth:p,parent:w})));return s(S.length?d({expanded:E,Header:A,Content:S&&b<p&&I}):A())};return function({tree:p,maxDepth:f=1/0,size:v=e.size??"md",variant:x=e.variant??"outline",color:h=e.color??"neutral",...w}){return l({class:B(u.nav,v,x,h,e==null?void 0:e.class,w.class)},i(m({maxDepth:f,color:h,variant:x,size:v})(Zn({})({...p}))))}}const Yn=(t,e)=>{const{bau:n}=t,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=we(t,{renderMenuItem:({item:{data:{name:s,href:l}}})=>o({href:l},s),...e});return s=>i({...s,tree:a})},Cu=t=>{const{bau:e}=t,{a:n}=e.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},r=we(t,{renderMenuItem:({item:{data:{name:i,href:s}}})=>n({href:s},i)});return()=>r({tree:o})},ku=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,Eu=t=>{const{bau:e,css:n,window:o}=t,{form:a,label:r,article:i,footer:s}=e.tags,l=Tt(t,{color:"neutral",variant:"outline"}),c=P(t,{variant:"solid",color:"danger"}),u=e.state(0),d=S=>{S.preventDefault();const E=Object.fromEntries(new FormData(S.currentTarget));alert(JSON.stringify(E))},m={data:{name:"Resources"},expanded:!0,children:[{data:{name:"EC2"},expanded:!0,children:[{data:{name:"Vpc",id:"EC2::Vpc"}},{data:{name:"Subnet",id:"EC2::Subnet"}}]},{data:{name:"IAM"},children:[{data:{name:"Role",id:"IAM:Role"}}]}]},b=({id:S,name:E})=>S??E,p=S=>o.document.getElementById(b(S)),f=({onNode:S})=>E=>{S(E);const{children:D=[]}=E;D.map(f({onNode:S}))},v=({parent:S})=>{if(S){const{children:E}=S,D=p(S.data);if(D){const A=E.every(I=>{const{checked:N,indeterminate:$}=p(I.data);return!N&&!$});D.indeterminate=!A&&E.some(I=>!p(I.data).checked),D.checked=E.every(I=>p(I.data).checked)}v({parent:S.parent})}},x=({item:S,parent:E})=>D=>{v({parent:E}),f({onNode:N=>{const $=p(N.data);$&&($.checked=D.target.checked,$.indeterminate=!1)}})(S);const I=D.currentTarget.querySelectorAll('input[type="checkbox"][data-type="resources"]:checked');u.val=I.length,D.stopPropagation()},w=we(t,{renderMenuItem:({item:S,parent:E})=>{const{name:D,id:A}=S.data,I=b(S.data);return r({class:n`
          display: flex;
          align-items: center;
          padding-right: 1rem;
        `,onclick:N=>N.stopPropagation()},l({onclick:x({item:S,parent:E}),name:I,id:I,"data-type":A?"resources":"group"}),D)}});return()=>a({onsubmit:d},i(w({tree:m})),s(c({type:"submit"},()=>`Delete ${u.val} Resource(s)`)))},Tu=`import { Context } from "@grucloud/bau-ui/context";
...
`,Du={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Simple",description:"A simple treeview.",code:ku,createComponent:Cu},{title:"Checkable",description:"A treeview with checkboxes.",code:Tu,createComponent:Eu}],gridItem:Yn},Au=t=>{const e=F(t);return()=>e(Du)},Bu=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,i=Pt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...e});return s=>i(s)},Iu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h1:r,p:i,ul:s,li:l}=e.tags,c=rn(t),u=P(t),d=[{name:"Accordion",Item:sn(t)},{name:"Alert",Item:ln(t)},{name:"Autocomplete",Item:dn(t)},{name:"Avatar",Item:un(t)},{name:"Badge",Item:pn(t)},{name:"Breadcrumbs",Item:bn(t)},{name:"Button",Item:gn(t)},{name:"Button Group",Item:fn(t)},{name:"Calendar",Item:vn(t)},{name:"Checkbox",Item:yn(t)},{name:"Chip",Item:xn(t)},{name:"DrillDown Menu",Item:wn(t,{base:"/components",hashBased:!0})},{name:"File Input",Item:kn(t)},{name:"Input",Item:En(t)},{name:"Input Search",Item:Tn(t)},{name:"Linear Progress",Item:Mn(t)},{name:"Loading Button",Item:Nn(t)},{name:"Modal",Item:$n(t)},{name:"Radio Button",Item:Ln(t)},{name:"Select",Item:Pn(t)},{name:"Select Native",Item:Rn(t)},{name:"Slider",Item:_n(t)},{name:"Spinner",Item:jn(t)},{name:"Switch",Item:Un(t)},{name:"Tabs",Item:Bu(t)},{name:"Theme Switch",Item:Xn(t)},{name:"Toggle",Item:qn(t)},{name:"Toggle Group",Item:Wn(t)},{name:"Tooltip",Item:Kn(t)},{name:"Tree View",Item:Yn(t)}];return()=>o({class:n`
          overflow-y: scroll;
  ...
  `};ho();const Qn={title:"Bau",base:"/bau/bau-ui"},ft=Eo({config:Qn}),{bau:Lu}=ft;ft.states={drawerOpen:Lu.state(!0)};$u(ft);ro({routes:Mu({context:ft}),onLocationChange:Ou({context:ft,LayoutDefault:Lo(ft),config:Qn}),notFoundRoute:Nu(ft)});
