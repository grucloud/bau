...
`)}
  ...
  `}function vo(){const t=document.getElementById("loading");t&&t.classList.add("m-fadeOut")}let ie=t=>Object.prototype.toString.call(t??0).slice(8,-1),yo=t=>ie(t)=="Object",Be=t=>ie(t)=="Function",oe=t=>["Object","Array"].includes(ie(t)),Ne=Object.getPrototypeOf,ae=t=>kt(t)?t.val:t,kt=t=>t==null?void 0:t.__isState,xo=["splice","push","pop","shift","unshift","sort","reverse"],Vt=(t,e)=>{const n=new Array(t.length);for(let o=0;o<t.length;o++)n[o]=e(t[o],o);return n};const J=t=>!kt(t[0])&&yo(t[0])?t:[{},...t];function wo(t){let e=(t==null?void 0:t.window)??window,{document:n}=e,o,a=new Set,r=new Set,i=!1,s,l=C=>n.createElement(C),c=(C,v,w)=>{let E=s;s=v;let T=C(w);return s=E,T},u=()=>{o||(o=e.requestAnimationFrame(()=>{a.forEach(C=>{C.bindings=C.bindings.filter(v=>{var w;return(w=v.element)==null?void 0:w.isConnected}),!C.bindings.length&&!C.computed&&a.delete(C)}),o=void 0}))},d=(C,v,w,E,T,F)=>{var j;if(i){r.add(C);return}for(let V of C.bindings){let{deps:q,element:I,renderInferred:X,render:nt,renderItem:Z}=V;if(Z&&v)(j=b(I,E,(...Y)=>f(Z(...Y)),w,T,F)[v])==null||j.call();else{let Y=X?X({element:I}):nt({element:I,renderItem:Z})(...q.map(ae));Y!==I&&I.replaceWith(V.element=f(Y))}}x(C),u()},m=(C,v,w=[])=>({get(E,T,F){var j;if(s==null||s.add(C),T==="_isProxy")return!0;if(!((j=E[T])!=null&&j._isProxy)&&!kt(E[T])&&oe(E[T]))E[T]=new Proxy(E[T],m(C,v,[...w,T]));else if(xo.includes(T)){let V=E[T];return(...q)=>{let I=V.apply(E,q);return d(C,T,I,q,v,w),I}}return Reflect.get(E,T,F)},set(E,T,F,j){let V=Reflect.set(E,T,F,j);return d(C,"setItem",V,{prop:T,value:F},v,[...w,T]),V}}),p=(C,v)=>new Proxy(v,m(C,v)),b=(C,v,w,E,T,F)=>{let j=()=>C.replaceChildren(...Vt(E,w)),V=q=>C[q]&&C.removeChild(C[q]);return{assign:j,sort:j,reverse:j,setItem:()=>{var I;let q=F[0];(I=C.children[q])==null||I.replaceWith(w(T[q],q))},push:()=>C.append(...Vt(v,(q,I)=>w(q,T.length+I))),unshift:()=>C.prepend(...Vt(v,w)),pop:()=>V("lastChild"),shift:()=>V("firstChild"),splice:()=>{const{length:q}=C.children;let[I,X=q,...nt]=v;for(let Z=I>=0?Math.min(I+X-1,q-1):q-1;Z>=(I>=0?I:q+I);Z--)C.children[Z].remove();if(nt.length){let Z=nt.forEach((Y,rt)=>w(Y,I+rt));C.children[I]?C.children[I].after(...Z):C.append(...Z)}}}},g=C=>({oldVal:C,bindings:[],listeners:[],__isState:!0,get val(){let v=this;return s==null||s.add(v),v.valProxy??(v.valProxy=oe(C)?p(v,C):C,v.valProxy)},set val(v){let w=this,E=w.val;oe(v)?(w.valProxy=p(w,v),d(w,"assign",v)):v!==E&&(w.valProxy=v,d(w)),w.oldVal=E}}),f=C=>{if(C==null||C===!1){const v=l("span");return v.style.display="none",v}else return C.nodeType?C:n.createTextNode(C)},y=(C,v)=>{let w=new Set;return v.val=c(C,w),w},h=C=>{let v=g(),w=y(C,v);v.computed=!0;for(let E of w)E.listeners.push({computed:C,deps:w,state:v});return v},x=C=>{for(let v of[...C.listeners])y(v.computed,v.state)},S=(C,...v)=>{if(v.length){let w=[];for(let E of v.flat(1/0))E!=null&&w.push(kt(E)?G({deps:[E],render:()=>T=>T}):Be(E)?_({renderInferred:E}):f(E));C.append(...w)}},k={},D=(C,v)=>C&&(Object.getOwnPropertyDescriptor(C,v)??D(Ne(C),v)),A=(C,v,w)=>{var E;return k[C+","+v]??(k[C+","+v]=((E=D(w,v))==null?void 0:E.set)??0)},N=(C,v)=>new e.MutationObserver((w,E)=>{w.filter(T=>T.removedNodes).forEach(T=>[...T.removedNodes].find(F=>F===C&&(v({element:C}),E.disconnect(),!0)))}).observe(C.parentNode,{childList:!0}),M=(C,v)=>new e.MutationObserver((w,E)=>w.forEach(T=>v({record:T,element:C}))).observe(C,{childList:!0}),$=C=>new Proxy(function(w,...E){var V;let[T,...F]=J(E),j=C?n.createElementNS(C,w):l(w);for(let[q,I]of Object.entries(T)){if(q.startsWith("bau"))continue;let X=A(w,q,Ne(j))?nt=>nt!==void 0&&(j[q]=nt):nt=>j.setAttribute(q,nt);I==null||(kt(I)?G({deps:[I],render:()=>()=>(X(I.val),j)}):Be(I)&&(!q.startsWith("on")||I.isDerived)?_({renderInferred:()=>(X(I({element:j})),j)}):I.renderProp?G({deps:I.deps,render:()=>()=>(X(I.renderProp({element:j})(...I.deps.map(ae))),j)}):X(I))}return T.bauChildMutated&&M(j,T.bauChildMutated),S(j,...F),j.autofocus&&j.focus&&e.requestAnimationFrame(()=>j.focus()),(V=T.bauCreated)==null||V.call(T,{element:j}),T.bauMounted&&e.requestAnimationFrame(()=>T.bauMounted({element:j})),T.bauUnmounted&&e.requestAnimationFrame(()=>N(j,T.bauUnmounted)),j},{get:(v,w)=>v.bind(void 0,w)}),P=(C,v,w)=>{C.element=f(w);for(let E of v)kt(E)&&(a.add(E),E.bindings.push(C));return C.element},_=({renderInferred:C,element:v})=>{let w=new Set,E=c(C,w,{element:v});return P({renderInferred:C},w,E)},G=({deps:C,element:v,render:w,renderItem:E})=>P({deps:C,render:w,renderItem:E},C,w({element:v,renderItem:E})(...C.map(ae))),R=(C,v,w)=>G({deps:[C],render:({renderItem:E})=>T=>(v.append(...Vt(T,E)),v),renderItem:w}),z=async C=>{i=!0;const v=await C();return i=!1,r.forEach(d),r.clear(),v};return{tags:$(),tagsNS:$,state:g,bind:G,loop:R,derive:h,stateSet:a,batch:z}}const So=t=>{let e=0,n=11;for(;e<t.length;)n=101*n+t.charCodeAt(e++)>>>0;return"bau"+n},Co=(t,e,n,o)=>{const a=t.createElement("style");a.id=n,a.append(o),(e??t.head).append(a)},ko=(t,e)=>t.reduce((n,o,a)=>n+o+(e[a]??""),"");function Eo(t){let{document:e}=(t==null?void 0:t.window)??window;const n=o=>(a,...r)=>{const i=ko(a,r),s=So(i);return!e.getElementById(s)&&Co(e,t==null?void 0:t.target,s,o(s,i)),s};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function To(t){const e=wo(),n=Eo();return ho(n),{bau:e,...n,tr:o=>o,window,...t}}function B(...t){return t.filter(e=>e).join(" ")}function Xt(t,e={}){const{bau:n,window:o}=t,{div:a}=n.tags,r=()=>{};return function({animationHide:s=r,animationShow:l=r,...c},u){return a({class:B("animate",e==null?void 0:e.class,c.class),bauChildMutated:({record:d,element:m})=>{[...d.removedNodes].forEach(p=>{if(!s()||p.getAttribute("cloned"))return;const b=p.cloneNode(!0);o.requestAnimationFrame(()=>{b.setAttribute("cloned",!0),b.style.top=0,b.style.left=0,b.style.width=p.getAttribute("width"),b.style.height=p.getAttribute("height"),b.style.position="absolute",b.style.animation=s(),d.target.appendChild(b),b.addEventListener("animationend",()=>{var g;return(g=b.parentNode)==null?void 0:g.removeChild(b)})})}),[...d.addedNodes].forEach(p=>{p.getAttribute("cloned")||o.requestAnimationFrame(()=>{m.style.position="relative";const b=p.getBoundingClientRect();if(p.setAttribute("width",b.width+"px"),p.setAttribute("height",b.height+"px"),l()){p.style.animation=l();const g=()=>{p.removeEventListener("animationend",g),p.style.animation=""};p.addEventListener("animationend",g)}})})},...c},u)}}const ot=["neutral","primary","success","danger","warning"],Do=["plain","outline","solid"],Ao=["sm","md","lg"],Bo=()=>ot.map(t=>`
&.button.plain.${t} {
  &:focus {
...
`);function ce(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(No);const c=o`
  ...
  `,P=({children:z,pathnameState:C,variant:v,color:w,size:E})=>D({class:B(v,w,E)},z.map(T=>f({class:()=>B(T.children&&"has-children",g({pathname:C.val,subTree:T})&&"active")},b({variant:v,color:w,size:E,subTree:T})))),_=({variant:z,color:C,size:v,currentTree:w,pathnameState:E})=>{const{children:T,parentTree:F,data:j,renderList:V}=w;return h({class:B("drillDownMenu",z,C,v)},F&&p({variant:z,color:C,size:v,data:j,currentTree:w}),T&&V?V({renderListDefault:P,children:T,pathnameState:E,variant:z,color:C,size:v}):P({children:T,pathnameState:E,variant:z,color:C,size:v}))},G=({tree:z,pathname:C})=>{let v=Fe({})({...z}),w=He(C)(v);return w||(w=v),w},R=({target:z})=>{let v=z.closest("a").getAttribute("href").replace(l,"");return s||(v=v.replace(z.hash,"")),v};return function(C){const{size:v=e.size??"md",variant:w=e.variant??"plain",color:E=e.color??"neutral",tree:T,...F}=C,j=n.state(a.location.pathname.replace(l,""));let V=G({tree:T,pathname:j.val});const q=n.state(JSON.stringify(V.data));let I;a.document.addEventListener("click",Y=>{const{target:rt}=Y,ct=rt.closest("a");if(!ct)return;const lt=ct.getAttribute("href");lt&&!lt.startsWith("http")&&!lt.startsWith("#")&&!lt.startsWith("?")&&(V=G({tree:T,pathname:R(Y)}),q.val=JSON.stringify(V.data),j.val=R({target:rt}))});const X=Y=>{const{buttonback:rt,ischild:ct}=Y.target.dataset;rt=="true"?I=-1:ct=="false"?I=1:ct=="true"&&(I=0)},nt=Y=>{switch(Y){case 1:return`${N} ${Jt}`;case-1:return`${M} ${Jt}`;default:return""}},Z=Y=>{switch(Y){case 1:return`${M} ${Jt} reverse`;case-1:return`${N} ${Jt} reverse`;default:return""}};return y({class:B($,w,E,v,e==null?void 0:e.class,F.class),onclick:X},k({animationHide:()=>nt(I),animationShow:()=>Z(I)},n.bind({deps:[q],render:()=>()=>_({variant:w,color:E,size:v,currentTree:V,pathnameState:j})})))}}const Lo=()=>ot.map(t=>`
&.input.${t} {
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:B("input",e.class,e.size??"md",c,l,r,u.class)})}}function ue(t,e={}){const{bau:n,css:o,window:a}=t,r=dt(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,p=o`
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:B("inputSearch",e.class,p,u.class)})}}function Ve(t){const{tr:e,bau:n,css:o,config:a,states:r,window:i}=t,{div:s,ul:l,li:c,nav:u,a:d,span:m,form:p}=n.tags,b=ue(t,{variant:"plain",color:"neutral",size:"sm",class:o`
      margin: 0.5rem;
  ...
  `,s=({title:l,Content:c})=>o({className:"feature"},a(l),r(c()));return function({featuresContent:c}){return o({class:i},c.map(s))}}function jo({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:r,dd:i,div:s,aside:l,footer:c,a:u}=e.tags,d=({maxSize:m=151})=>({libName:p,size:b})=>s({class:n`
        ...
        `},l({class:n`
          ...
          `},p.map(d({}))),c({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function _o(t){const{bau:e,css:n,config:o}=t,{div:a,p:r,a:i,section:s}=e.tags,l=zo(t),c=Ro(t),u=O(t);zt(t);const d=jo(t),m=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("paper",l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}function ln(t,e={}){const{bau:n,css:o,window:a}=t,{nav:r,ul:i,li:s,a:l}=n.tags,{headerSelector:c="h2,h3"}=e,u=n.state("no"),d=(f,y)=>{let h=null;return(...x)=>{a.clearTimeout(h),h=a.setTimeout(()=>f(...x),y)}},m=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,p=({value:f,id:y,children:h=[]})=>{const x=l({class:()=>u.val==y?"active":"",href:`#${y}`});return x.innerHTML=f,s({class:()=>u.val==y?"active":""},x,h.length>0&&i(h.map(p)))},b=f=>f.tagName.charAt(1),g=({contentEl:f})=>{const y=f.querySelectorAll(c);let h=2,x={},S={children:[]},k=S;const D=k;let A=[k];return[...y].forEach(N=>{const M=b(N);N.setAttribute("id",N.textContent),!N.innerHTML.includes("<button")&&(x={value:N.innerHTML,id:N.id??N.textContent,children:[]},h==M?(S=x,k.children.push(S)):h<M?(A.push(k),k=S,S.children.push(x),S=x):h>M&&(k=A[M-1],A=A.slice(0,M-1),k.children.push(x),S=x),h=M)}),D};return function(...y){let[{size:h=e.size??"md",variant:x=e.variant??"plain",color:S=e.color??"neutral",contentEl:k,...D}]=J(y);const A=g({contentEl:k}),N=d(()=>{const $=[...k.querySelectorAll(c)].find(P=>{const{top:_,height:G}=P.getBoundingClientRect();if(_+G>60)return!0});$&&(u.val=$==null?void 0:$.id)},100);return r({...D,class:B("tableOfContent",h,x,S,m,e==null?void 0:e.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",N)},bauUnmounted:()=>{a.removeEventListener("scroll",N)}},A.children&&i(A.children.map(p)))}}const un=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(l(i(c(m??""),ot.map(p=>c(p)))),r(Do.map(p=>i(c(p),ot.map((b,g)=>s(d({color:b,variant:p},{index:g}))))))))}},Va=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Ao.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},H=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;It.registerLanguage("javascript",cn);const m=ln(t),p=ge(t,{class:n`
      &.paper {
...
`);function Dt(t,e={}){const{bau:n,css:o}=t,{div:a,i:r}=n.tags,i=o`
    ...
    ${nr()}
  `,s=O(t),l=({onclick:c})=>s({"aria-label":"Close",onclick:c,class:"button-close"},"✖");return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",onRemove:b,...g},...f]=J(u);return a({...g,class:B("alert",`alert-${m}`,e.class,m,p,d,i,g.class),role:"alert"},r({class:"icon"},er[p]),a({class:"content"},...f),b&&l({onclick:b}))}}const pn=(t,e)=>{const n=Dt(t,e);return o=>n({...o},`Alert ${(e==null?void 0:e.size)??""} `)},or=t=>{const{bau:e}=t,{h4:n,p:o}=e.tags,a=Dt(t,{color:"danger"});return()=>a(n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},ar=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,ir={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:ar,createComponent:or},{title:"Custom Alert ",description:"A custom alert.",code:sr,createComponent:rr}],gridItem:pn},cr=t=>{const e=H(t);return()=>e(ir)},lr=(t,e={})=>{const{bau:n,css:o,keyframes:a}=t,{limit:r=10,deleteAfterDuration:i=15e3}=e,{div:s}=n.tags,l=n.state([]),c={inserting:a`
...
`,vr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:gr,createComponent:br},{title:"Component hide and show",description:"Hide and show a component",code:hr,createComponent:fr}]},yr=t=>{const e=H(t);return()=>e(vr)};function Tt(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
    0% {
      transform: translateX(-100%);
    }
    50% {
  ...
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",width:f=40,height:y=40,alt:h,...x},...S]=J(m);const k=Tt(t,{class:B(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${y}px;
          width: ${f}px;
        `,e==null?void 0:e.class,x.class)});return a({class:B(u,e==null?void 0:e.class,x.class)},()=>i.val&&k(),()=>s.val&&h,r({alt:h,width:f,height:y,onload:l,onerror:c,class:()=>B(!i.val&&"visible",s.val&&"hide",g,b,p,u,e==null?void 0:e.class,x.class),...x}))}}const bn=(t,e)=>{const{css:n}=t,o=he(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`,kr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:wr,createComponent:xr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:Cr,createComponent:Sr}],gridItem:bn},Er=t=>{const e=H(t);return()=>e(kr)};function Rt(t,e){const{bau:n,css:o,window:a}=t,{dialog:r}=n.tags,i=o`
    width: fit-content;
    margin: 0;
...
`);function jt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Dr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:p,Option:b,options:g,defaultOption:f,getOptionLabel:y,getOptionValue:h,onSelect:x=()=>{},id:S,required:k,name:D,loading:A,...N},...M]=J(l);const $=Rt(t),P=O(t),_=dt(t,{variant:u,color:d,size:c}),G=yt(t),R=bt(t,{variant:u,color:d,size:c}),z=n.state(f),C=n.state(N.value),v=n.state(!1),w=n.state(0),E=()=>{v.val=!1},T=n.state(g),F=Q=>at=>Q.val&&y(at)==y(Q.val),j=()=>{ut.openDialog(),v.val=!0,C.val="",T.val=g,w.val=g.findIndex(F(z));const Q=Nt.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ct.scrollIntoView({block:"end"}))},V=()=>{ut.closeDialog(),v.val=!1,w.val=0},q=Q=>{const{value:at}=Q.target;C.val=at,at?T.val=g.filter(Ft=>y(Ft).match(new RegExp(`${at}`,"i"))):T.val=g},I=Q=>{ut.open?V():j()},X=Q=>{z.val=Q,lt.value=h(Q)},nt=({option:Q,index:at})=>Ft=>{X(Q),w.val=at,V()},Z=()=>{const Q=Nt.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":w.val<T.val.length-1?w.val++:w.val=0,Z();break;case"ArrowUp":w.val<=0?w.val=T.val.length-1:w.val--,Z();break;case"Enter":ut.open?(X(T.val[w.val]),V()):j(),Q.preventDefault();break}},rt=P({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":v,"aria-label":m,onclick:I,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>z.val?y(z.val):m,()=>A==!0&&R({visibility:A})),ct=_({value:C,placeholder:p,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":v,oninput:q,onkeydown:Y,...N}),lt=_({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:f&&h(f),required:k,"aria-hidden":!1,"aria-label":D,name:D}),Nt=a({class:B(u,d,c,"content")},ct,()=>G({class:B(u,d,c)},T.val.map((Q,at)=>r({class:()=>B(w.val==at&&"active",F(z)(Q)&&"selected"),onclick:nt({option:Q,index:at})},b(Q))))),ut=$({id:S,triggerEl:rt,contentEl:Nt,onClose:E,class:o`
        overflow: hidden;
      `});return a({...N,class:B("autocomplete",i,e==null?void 0:e.class,N==null?void 0:N.class)},n.bind({deps:[z],render:()=>Q=>{Q&&(lt.value=h(Q),x(Q))}}),rt,lt,ut)}}const gn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=jt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(c.label),r(c.code));return c=>i({...c,options:s,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",name:"country","aria-label":"country"})},Ar=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Br=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,article:i,footer:s}=e.tags,l=jt(t),c=O(t,{variant:"outline",color:"primary"}),u=d=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Or=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=jt(t),c=O(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ir=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=O(t,{variant:"outline"}),c=O(t,{variant:"solid",color:"primary"}),u=jt(t),d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Lr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=jt(t),c=O(t,{variant:"outline",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],d=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,zr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Nr,createComponent:Br},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:$r,createComponent:Ir},{title:"Default Option",description:"A autocomplete with a default option.",code:Mr,createComponent:Or},{title:"URL State",description:"A autocomplete with the state in the URL",code:Pr,createComponent:Lr}],gridItem:gn},Rr=t=>{const e=H(t);return()=>e(zr)};function fn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...p]=J(s);return a({...m,class:B("badge",r,e==null?void 0:e.class,m==null?void 0:m.class)},a({class:B(u,c,l)},d),...p)}}const hn=(t,e)=>{const n=fn(t,e);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},jr=t=>{const{bau:e}=t,{section:n}=e.tags,o=fn(t);return()=>n(o({content:"10"},"☏"))},_r=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ur={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:_r,createComponent:jr}],gridItem:hn},Gr=t=>{const e=H(t);return()=>e(Ur)};function ve(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=O(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`,qr={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:Hr,createComponent:Fr},{title:"Separator",description:"A breadcrumbs with a custom separator.",code:Jr,createComponent:Vr}],gridItem:vn},Wr=t=>{const e=H(t);return()=>e(qr)},yn=(t,e={})=>{const n=O(t,e);return o=>n({...o},`${o.variant} ${o.color} ${e.size??""}`)},Kr=t=>{const{bau:e}=t,{section:n}=e.tags,o=O(t,{color:"primary",variant:"outline"});return()=>n(o({onclick:()=>{alert("Click")}},"Click me"))},Xr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`);function ye(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    ...
    ${es()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("button-group",c,u,l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}const xn=(t,e)=>{const n=["ONE","TWO","THREE"],o=O(t,e),a=ye(t,e);return r=>a({...r},n.map(i=>o(r,i)))},ns=t=>{const{bau:e}=t,{section:n}=e.tags,o=["ONE","TWO","THREE"],a="primary",r="solid",i=O(t,{color:a,variant:r}),s=ye(t,{color:a,variant:r});return()=>{const l=c=>u=>{alert(c)};return n(s(o.map(c=>i({onclick:l(c)},c))))}},os=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,as={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:os,createComponent:ns}],gridItem:xn},rs=t=>{const e=H(t);return()=>e(as)};function xe(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>ot.map(s=>`
...
`,us={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Uncontrolled Calendar",description:"A simple calendar.",code:is,createComponent:ss},{title:"Controlled Calendar",description:"A controlled calendar.",code:ls,createComponent:cs}],gridItem:wn},ds=t=>{const e=H(t);return()=>e(us)};function ms(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    display: inline-block;
    position: relative;
    overflow: hidden;
    & img {
...
`,fs={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:gs,createComponent:bs}]},hs=t=>{const e=H(t);return()=>e(fs)},Sn=(t,e)=>{const n=zt(t,e);return o=>n({...o},`Chip ${o.color} ${o.variant} ${o.size??""}`)},vs=t=>{const{bau:e}=t,{section:n}=e.tags,o=zt(t,{variant:"outline",color:"primary"});return()=>n(o("My Chip"))},ys=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,xs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:ys,createComponent:vs}],gridItem:Sn},ws=t=>{const e=H(t);return()=>e(xs)};function wt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({type:"checkbox",...d,class:B(r,u,c,l,e==null?void 0:e.class,d==null?void 0:d.class)})}}const Cn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,r=wt(t,e);return i=>a({class:o`
          display: flex;
...
`,$s={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Is,createComponent:Ms}]},Ls=t=>{const e=H(t);return()=>e($s)};function Ps(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    display: flex;
    align-items: center;
    .content {
      margin: 1rem;
...
`,js={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Rs,createComponent:zs}],variantColorTableDisable:!0,variantSizeDisable:!0},_s=t=>{const e=H(t);return()=>e(js)};function Us(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...m},...p]=J(s);return a({class:B(r,e==null?void 0:e.class,m.class)},a({class:()=>B("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>B("content",d.val&&"content-open")},p))}}const Gs=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=Us(t),r=O(t,{color:"neutral",variant:"outline"}),i=Ve(t);return()=>{const s=e.state(!1);return n(o("Click on the button to open and close the drawer."),r({onclick:()=>{s.val=!s.val}},"OPEN DRAWER"),a({openState:s},i()))}},Fs=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Hs={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:Fs,createComponent:Gs}]},Vs=t=>{const e=H(t);return()=>e(Hs)},Js=()=>ot.map(t=>`
`).join(`
`);function kn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=O(t),s=Rt(t),l=yt(t),c=o`
    ${Js()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"outline",color:b=e.color??"neutral",label:g,ListItem:f,items:y,...h},...x]=J(d);const S=n.state(0),k=()=>{G.openDialog(),G.focus()},D=()=>{G.closeDialog()},A=()=>{G.open?D():k()},N=R=>{A(),R.preventDefault()},M=({item:R,index:z})=>C=>{S.val=z,D(),C.preventDefault()},$=R=>{switch(R.preventDefault(),R.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},P=()=>l({tabindex:"0",class:B(b,p)},y.map((R,z)=>r({class:()=>B(S.val==z&&"active"),onclick:M({item:R,index:z})},f(R)))),_=i({type:"button",onclick:N,color:b,variant:p,size:m},g),G=s({triggerEl:_,contentEl:P()});return a({...h,class:B("dropdownMenu",b,m,c,e==null?void 0:e.class,h==null?void 0:h.class),onkeydown:$},_,G)}}const qs=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=kn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},Ws=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=kn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Ks=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,ti={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Qs,createComponent:Ys}],gridItem:(t,e)=>En(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},ei=t=>{const e=H(t);return()=>e(ti)};function Tn(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",Component:b,disabled:g,...f}=c;return a({class:B(s.base,g&&s.disabled,e==null?void 0:e.class,c.class)},r({class:B(m,p,d)},b({disabled:g}),i({type:"file",disabled:g,...f})))}}const Dn=(t,e)=>{const{tr:n,bau:o,css:a,config:r}=t,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=Tn(t,e),m=b=>{const g=b.target.files[0];g?u.val=g.name:u.val="No file selected"},p=({disabled:b})=>l({class:B(a`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`,Si={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:wi,createComponent:xi}],gridItem:Bn},Ci=t=>{const e=H(t);return()=>e(Si)};function Nn(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding-left: 0;
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:p=e.color??"neutral",running:b,...g}]=J(u);return r({...g,role:"progressbar",class:{deps:[b],renderProp:()=>f=>B("linearProgress",d,p,l,f&&"running",e==null?void 0:e.class,g==null?void 0:g.class)}})}}const $n=(t,e)=>{const n=In(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},Ri=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=O(t,{variant:"solid",color:"primary"}),r=In(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},ji=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Zi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:Xi,createComponent:Ki}],gridItem:qi},Yi=t=>{const e=H(t);return()=>e(Zi)};function Pn(t,e={}){const{bau:n,css:o,window:a}=t,{dialog:r,div:i}=n.tags,l=o`
    margin: auto;
    padding: 1rem;
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
...
`,ec={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:tc,createComponent:Qi}],gridItem:zn},nc=t=>{const e=H(t);return()=>e(ec)},oc=()=>ot.map(t=>`
& button.plain.${t}::after {
  color: var(--color-${t});
}
& button.outline.${t}::after {
...
`).join(`
`);function ac(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=O(t),l=Rt(t),c=yt(t),u=wt(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${oc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",name:y,label:h,Option:x,options:S,defaultValue:k=[],getOptionLabel:D,getOptionValue:A,renderValue:N,onSelect:M=()=>{},loading:$,...P},..._]=J(p);const G=bt(t,{variant:g,color:f,size:b}),R=n.state(k),z=n.state(!1),C=n.state(0),v=()=>{X.openDialog(),X.focus(),z.val=!0},w=()=>{X.closeDialog(),z.val=!1},E=()=>{z.val=!1},T=Z=>{X.open?w():v(),Z.preventDefault()},F=()=>Array.from(nt.selectedOptions).map(({value:Z})=>S.find(Y=>A(Y)==Z)),j=Z=>{switch(Z.preventDefault(),Z.key){case"Escape":w();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Y=Z.currentTarget.querySelectorAll("input")[C.val];Y.checked=!Y.checked;const rt=nt.options[C.val+1];rt.selected=!rt.selected,R.val=F()}else v();break}},V=Z=>Y=>{const rt=[...nt.options].find(({value:ct})=>ct==A(Z));Y.target.checked?rt.selected=!0:rt.selected=!1,R.val=F()},q=()=>c({tabindex:"0",class:B(f,g)},S.map((Z,Y)=>r({class:()=>B(C.val==Y&&"active")},n.tags.label(u({checked:k.find(rt=>A(rt)==A(Z)),name:`${y}-${A(Z)}`,onchange:V(Z)}),x(Z))))),I=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":z,"aria-label":h,onclick:T,color:f,variant:g,size:b,class:$==!0&&"loading",disabled:$},()=>R.val.length?N(R.val):h,()=>$==!0&&G({visibility:$})),X=l({triggerEl:I,contentEl:q(),onClose:E}),nt=i({name:y,multiple:!0,...P},n.tags.option({value:""},"--Category--"),S.map(Z=>n.tags.option({value:A(Z),selected:k.find(Y=>A(Y)==A(Z))},D(Z))));return a({...P,class:B("multiSelect",f,b,d,e==null?void 0:e.class,P==null?void 0:P.class),onkeydown:j},nt,I,X)}}const rc=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=ac(t),l=O(t,{variant:"outline",color:"neutral"}),c=zt(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=m=>a(m.group);return()=>r({onsubmit:p=>{p.preventDefault();const{selectedOptions:b}=p.target.elements.myMultiSelect,g=Array.from(b).map(({value:f})=>f);alert(JSON.stringify(g))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,lc={title:"MultiSelect",package:"multiSelect",description:"The multiSelect component allows user to select multiple items from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/multiSelect/multiSelect.js",importStatement:'import multiSelect from "@grucloud/bau-ui/multiSelect";',examples:[{title:"Simple Multi Select",description:"A simple multi select.",code:sc,createComponent:rc},{title:"Native Multi Select",description:"A native multi select.",code:cc,createComponent:ic}]},uc=t=>{const e=H(t);return()=>e(lc)},dc=t=>{const{bau:e}=t,{section:n,div:o,h1:a,p:r}=e.tags,i=O(t,{variant:"outline",color:"success"}),s=Rt(t),l=()=>i({onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),c=()=>o({},a("My content"),r("My Content")),u=l(),d=s({id:"my-popover-left",triggerEl:u,contentEl:c()});return()=>n(o(u,d))},mc=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,pc={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:mc,createComponent:dc}]},bc=t=>{const e=H(t);return()=>e(pc)};function gc(t,e={}){const{bau:n,css:o,config:a}=t,{div:r,a:i,span:s,nav:l}=n.tags,c=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,vc={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:hc,createComponent:fc}]},yc=t=>{const e=H(t);return()=>e(vc)},xc=(t,e)=>{const{bau:n}=t,{div:o}=n.tags,a=ge(t,e);return r=>a({...r},o(`Paper ${e.size??""}`))},wc=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=ge(t,{size:"md"});return()=>n(a(o("My content")))},Sc=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`,Cc={title:"Paper",package:"paper",description:"The paper component displays child components on a surface area.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paper/paper.js",importStatement:'import paper from "@grucloud/bau-ui/paper";',examples:[{title:"Default",description:"A simple paper.",code:Sc,createComponent:wc}],variantColorTableDisable:!0,gridItem:xc},kc=t=>{const e=H(t);return()=>e(Cc)};function Se(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    cursor: pointer;
    &.sm {
      transform: scale(0.8);
    }
...
`).join(`
`))()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=J(l);return a({...m,type:"radio",class:B("radio-button",c,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class)})}}const Rn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:r}=n.tags,i=Se(t,e);return s=>r({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,Dc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Tc,createComponent:Ec}],gridItem:Rn},Ac=t=>{const e=H(t);return()=>e(Dc)};function _t(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=Se(t),l=o`
    display: flex;
    flex-direction: row;
    gap: 0.5rem;
    & label {
...
`,Ic=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=_t(t),i=O(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))}},o(r({name:"myRadio",value:"one",radios:[{value:"one",Label:()=>"One"},{value:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},$c=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,jc={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:$c,createComponent:Ic},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Nc,createComponent:Bc},{title:"Url State Radio Button Group",description:"A radio button group with the state in the URL",code:Mc,createComponent:Oc},{title:"Label with Image",description:"A label with an image.",code:Pc,createComponent:Lc},{title:"Label with description",description:"A label with name and description.",code:Rc,createComponent:zc}]},_c=t=>{const e=H(t);return()=>e(jc)};function Pt(t,e={}){const{bau:n,css:o,window:a}=t,{section:r,article:i,div:s}=n.tags,{document:l}=a,{direction:c="horizontal"}=e,u=o`
  ...
  `;function d(...b){let[g,...f]=J(b);return r({...g,class:B("resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u)},f)}function m(...b){let[g,...f]=J(b);return i({...g,class:B("resizablePanel",g==null?void 0:g.class)},f)}function p(...b){let[g,...f]=J(b),y=0,h=0,x,S,k,D,A;const N=()=>c==="horizontal",M=R=>N()?$(R):P(R),$=R=>{const z=R.clientX-y;A&&(D.style.width=`${A.width+z}px`),k&&(S.style.width=`${k.width-z}px`)},P=R=>{const z=R.clientY-h;console.log("mouseMoveHandlerHorizontal dy",z,"width"),A&&(D.style.height=`${A.height+z}px`),k&&(S.style.height=`${k.height-z}px`)},_=()=>{console.log("mouseUpHandler"),S=null,D=null,k=null,A=null,x.style.cursor=null,x.style["user-select"]="auto",l.removeEventListener("mousemove",M),l.removeEventListener("mouseup",_)},G=R=>{y=R.clientX,h=R.clientY;const{target:z}=R,C=z.closest(".handle");x=z.closest(".resizablePanelGroup"),console.log("mouseDownHandler",y,h,x),x.style.cursor=N()?"col-resize":"row-resize",x.style["user-select"]="none",S=C.nextSibling,D=C.previousSibling,D&&(A=D.getBoundingClientRect()),S&&(k=S.getBoundingClientRect()),l.addEventListener("mousemove",M),l.addEventListener("mouseup",_)};return s({...g,class:B("handle",c),role:"separator",bauMounted:({element:R})=>{R.addEventListener("mousedown",G)},bauUnmounted:({element:R})=>{R.removeEventListener("mousedown",G)}},f)}return{PanelGroup:d,Panel:m,Handle:p}}const Uc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Pt(t,{class:n`
      display: inline-flex;
...
`).join(`
`);function At(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,l=O(t),c=Rt(t),u=yt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Zc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",label:y,Option:h,options:x,defaultOption:S,getOptionLabel:k,getOptionValue:D,onSelect:A=()=>{},loading:N,...M},...$]=J(p);const P=bt(t,{variant:g,color:f,size:b}),_=n.state(S?k(S):y),G=n.state(!1),R=n.state(0),z=()=>{V.openDialog(),V.focus(),G.val=!0},C=()=>{V.closeDialog(),G.val=!1},v=()=>{G.val=!1},w=I=>{V.open?C():z(),I.preventDefault()},E=({option:I,index:X})=>nt=>{_.val=k(I),q.value=D(I),q.setCustomValidity(""),R.val=X,C(),A(I),nt.preventDefault()},T=I=>{switch(I.preventDefault(),I.key){case"Escape":C();break;case"ArrowDown":R.val<x.length-1?R.val++:R.val=0;break;case"ArrowUp":R.val<=0?R.val=x.length-1:R.val--;break;case"Enter":V.open?(_.val=k(x[R.val]),q.value=D(s),C()):z();break}},F=()=>u({tabindex:"0",class:B(f,g)},x.map((I,X)=>r({class:()=>B(R.val==X&&"active"),onclick:E({option:I,index:X})},h(I)))),j=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":G,"aria-label":y,onclick:w,color:f,variant:g,size:b,class:N==!0&&"loading",disabled:N},()=>!_.val&&y,_,()=>N==!0&&P({visibility:N})),V=c({triggerEl:j,contentEl:F(),onClose:v}),q=i({...M,"aria-label":y},s({value:""},"--Select Category--"),x.map(I=>s({value:D(I)},k(I))));return S?q.value=D(S):q.value=M.value,a({...M,class:B("select",f,b,d,e==null?void 0:e.class,M==null?void 0:M.class),onkeydown:T},q,j,V)}}const jn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=At(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(c.label),r(c.code));return c=>i({...c,options:s,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},Yc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=At(t),c=O(t,{variant:"solid",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,tl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=At(t),c=O(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,nl=t=>{const{bau:e,css:n,window:o}=t,{form:a,article:r,footer:i,div:s,span:l}=e.tags,c="country",u=At(t),d=O(t,{variant:"solid",color:"primary"}),m=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],p=b=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,sl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=O(t,{variant:"outline"}),c=O(t,{variant:"solid",color:"primary"}),u=At(t),d=m=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,cl={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Qc,createComponent:Yc},{title:"Default Option",description:"Select with a default option",code:el,createComponent:tl},{title:"State in URL",description:"Select with state in URL",code:ol,createComponent:nl},{title:"Select AWS region",description:"Select the AWS region",code:rl,createComponent:al},{title:"Loading Indicator",description:"Select with a loading indicator",code:il,createComponent:sl}],gridItem:jn},ll=t=>{const e=H(t);return()=>e(cl)};function Ce(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("select-native",u,l,c,r,e==null?void 0:e.class,d==null?void 0:d.class)},m)}}const _n=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=Ce(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},r.map(({label:s,phone:l})=>o({value:l},s)))},ul=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,r=O(t,{variant:"outline",color:"primary"}),i=Ce(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),s.map(({label:c,phone:u})=>n({value:u},c))),a(r({type:"submit"},"Submit")))},dl=`import { Context } from "@grucloud/bau-ui/context";
...
`,bl={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:dl,createComponent:ul},{title:"State URL",description:"A selectNative with state in URL",code:pl,createComponent:ml}],gridItem:_n},gl=t=>{const e=H(t);return()=>e(bl)},fl=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=Tt(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`).join(`
`))()};
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...p]=J(l);return a({...m,type:"range",class:B("slider",d,u,c,i,e==null?void 0:e.class,m.class)},...p)}}const Un=t=>{const{bau:e}=t,n=e.state(0),o=r=>{n.val=r==null?void 0:r.target.value},a=Bt(t);return r=>a({"aria-label":"slider",...r,oninput:o})},Tl=t=>{const{bau:e}=t,{form:n,article:o,label:a,br:r,footer:i}=e.tags,s=Bt(t),l=O(t,{variant:"solid",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(a("Slider with step, min and max",r,s({name:"slider-simple",step:20,min:-100,max:100}))),i(l({type:"submit"},"Submit")))},Dl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Ml=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=Bt(t),d=O(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o({class:n`
            display: flex;
...
`,_l={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:jl,createComponent:Rl}],gridItem:Gn},Ul=t=>{const e=H(t);return()=>e(_l)},Gl=()=>ot.map(t=>"").join(`
...
`,ql={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Horizontal Stepper",description:"A simple horizontal stepper.",code:Hl,createComponent:Fl},{title:"Vertical Stepper",description:"A simple vertical stepper.",code:Jl,createComponent:Vl}]},Wl=t=>{const e=H(t);return()=>e(ql)},Kl=()=>ot.map(t=>`
&.switch.plain.${t} {
  &::after {
...
`);function Qt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("switch",r,u,c,l,e==null?void 0:e.class,d.class),type:"checkbox"},...m)}}const Vn=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Qt(t,e);return s=>a({class:o`
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},Xl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Qt(t,{variant:"outline",color:"primary"}),l=O(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
...
`,Yl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Qt(t,{variant:"outline",color:"primary"}),l=O(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`,tu=t=>{const{bau:e,css:n,window:o}=t,{footer:a,form:r,label:i,article:s}=e.tags,l="my-shinny-switch",c=Qt(t,{variant:"outline",color:"primary"}),u=O(t,{variant:"outline",color:"primary"}),d=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`);function Ut(t,e={}){const{bau:n,css:o,window:a}=t,{tabDefs:r}=e,{div:i,ul:s,li:l,a:c}=n.tags,u=o`
    ...
    ${au()}
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",tabsKey:f="tabs",...y},...h]=J(m);const x=n.state(r),S=$=>x.val.find(P=>P.name==$),k=n.state(r[0]),D=()=>{var _,G;const P=new URLSearchParams(a.location.search).get(f)??r[0].name;if(P!=k.val.name){const R=S(P);(_=k.val.exit)==null||_.call(),k.val=R,(G=R==null?void 0:R.enter)==null||G.call()}};D(),a.history.pushState=new Proxy(a.history.pushState,{apply:($,P,_)=>{$.apply(P,_);const G=_[2]??"";["?","#"].includes(G[0])&&D()}});const A=$=>{const P=new URLSearchParams(a.location.search);return P.delete(f),P.append(f,$),`?${P.toString()}`},N=$=>{const{Header:P,disabled:_,name:G}=$;return l({class:()=>B(k.val.name==G&&"active",_&&"disabled")},c({href:A(G)},P($)))},M=i({class:B("tabs",b,p,g,u,e==null?void 0:e.class,y.class),bauMounted:({element:$})=>{a.addEventListener("popstate",D)},bauUnmounted:()=>{a.removeEventListener("popstate",D)}},n.loop(x,s(),N),n.bind({deps:[k],render:()=>({Content:$})=>$?$(y):""}));return M.addEventListener("tab.add",$=>{var _;const{tab:P}=$.detail;(_=P.enter)==null||_.call(),x.val.push(P)},!1),M.addEventListener("tab.remove",$=>{var _;const P=x.val.findIndex(G=>G.name==$.detail.tabName);P>0&&((_=x.val[P].exit)==null||_.call(),x.val.splice(P,1))},!1),M}}const ru=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=Ut(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]});return()=>r({})},su=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,pu={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:su,createComponent:ru},{title:"Extended Tabs",description:"An extended tabs.",code:cu,createComponent:iu},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:uu,createComponent:lu},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:mu,createComponent:du}]},bu=t=>{const e=H(t);return()=>e(pu)};function Gt(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:r}=n.tags;a`
  :root {
...
`,Du={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Tu,createComponent:Eu}]},Au=t=>{const e=H(t);return()=>e(Du)};function qn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=ye(t),i=O(t),s=bt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:b,icon:g,...f})=>i({"aria-label":b,title:b,...f},g),u=({count:b,totalCount:g,page:f,rowsPerPage:y})=>a({class:"pages-numbers"},Number(f-1)*Number(y)+(b>0?1:0),"-",Math.min(f*y,g)," of ",g),d=({count:b,page:g,rowsPerPage:f})=>a({class:"pages-numbers"},(g-1)*f+(b>0?1:0),"-",g*f),m=b=>b<=1,p=(b,g,f)=>b>=Math.ceil(g/f);return function(...g){let[{size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",count:x=0,totalCount:S=0,page:k=1,rowsPerPage:D=50,onPageChange:A,isLoading:N=!1,disableFirst:M=()=>m(k),disablePrevious:$=()=>m(k),disableNext:P=()=>p(k,S,D),disableLast:_=()=>p(k,S,D),...G},...R]=J(g);const z=Math.max(0,Math.ceil(S/D)),C=A({page:1}),v=A({page:k-1}),w=A({page:k+1}),E=A({page:z}),T=[{label:"First",icon:"⟪",onclick:C,disabled:M()},{label:"Previous",icon:"⟨",onclick:v,disabled:$()},{label:"Next",icon:"⟩",onclick:w,disabled:P()},{label:"Last",icon:"⟫",onclick:E,disabled:_()}];return a({...G,class:B("table-pagination",l,N&&"disabled",e==null?void 0:e.class,G==null?void 0:G.class)},s({class:"spinner",visibility:N,size:"md"}),S>0?u({count:x,totalCount:S,page:k,maxPages:z,rowsPerPage:D}):d({count:x,page:k,maxPages:z,rowsPerPage:D}),r({variant:y,color:h},T.map(F=>c({...F,variant:y,color:h}))))}}const Bu=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=Bu(45),u=({name:b,email:g})=>r(a(b),a(g)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
    ...
    `});return()=>{const b=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),f=e.derive(()=>b.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:h})=>x=>{g.val.page=h};return p(i(d(),()=>l(f.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Ou=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),p=e.derive(()=>d.val.length),b=e.state(1),g=e.state(10),f=e.derive(()=>d.val),y=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,h=({page:M})=>$=>{b.val=M,x(y({page:M,per_page:g.val}))};x(y({page:1,per_page:g.val}));async function x(M){try{u.val=!0;const $=await fetch(M,{});if($.ok){const P=await $.json();d.val=P;return}throw $}catch($){m.val=$.message}finally{u.val=!1}}const S=({name:M,description:$,stargazers_count:P})=>r(a(M),a($),a({class:n`
      ...
      min-width: 650px;
    `}),N=({message:M})=>c(M);return()=>A(()=>D({rowsPerPage:g.val,page:b.val,count:p.val,totalCount:-1,isLoading:u.val,onPageChange:h,disableNext:()=>!1}),i(k(),()=>m.val&&N({message:m.val}),()=>l(f.val.map(S))))},Mu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=Nu(t),c=Ou(t),u=(...d)=>a({class:n`
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",onclick:m,...p},...b]=J(l);return r({type:"button",...p,onclick:g=>{const{target:f}=g,y=f.getAttribute("aria-pressed");f.setAttribute("aria-pressed",y=="true"?"false":"true"),m&&m(g)},class:B("toggle",c,d,u,i,e==null?void 0:e.class,p==null?void 0:p.class)},b)}}const Wn=(t,e)=>{const{bau:n}=t,o=St(t,e);return a=>{const r=n.state(!1);return o({...a,selected:r,onclick:()=>r.val=!r.val},"Toggle Me")}},Iu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=St(t,{variant:"plain"}),i=O(t,{variant:"outline",color:"primary"});return()=>{const s=e.state(!1);return n({onsubmit:c=>{c.preventDefault(),alert(s.val)}},o(r({name:"my-toogle","aria-pressed":s,onclick:()=>s.val=!s.val},"Toggle Me")),a(i({type:"submit"},"Submit")))}},$u=`import { Context } from "@grucloud/bau-ui/context";
...
`,Hu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=St(t,{variant:s,color:i}),c=ke(t,{variant:s,color:i}),u=O(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{b.preventDefault();const f=[...b.currentTarget.querySelectorAll("button[aria-pressed=true]")].map(({name:y})=>y);alert(JSON.stringify(f))}},o(c({onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),a(u({type:"submit"},"Submit")))}},Vu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,nd={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:ed,createComponent:td}],gridItem:Zn},od=t=>{const e=H(t);return()=>e(nd)},Yn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Yn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},ad=({css:t,createGlobalStyles:e})=>(e`
:root {
