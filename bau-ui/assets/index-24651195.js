...
`).join(`
`),io=()=>rt.map(([e])=>[`--color-${e}-s: var(--color-${e}-dark-s);`]).join(`
...
`);function po({createGlobalStyles:e},{colorPalette:t=rt}={}){e`
    :root {
      --color-scheme: light;
...
`);function it(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Eo);const l=o`
  ...
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",...h},...x]=U(d);return i({required:"required",title:"Switch Theme",...h,class:I("theme-switch",b,g,p,l,t==null?void 0:t.class,h.class),type:"checkbox",checked:r()=="dark",onclick:v=>{s(v.target.checked?"dark":"light")}},...x)}}function To(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:g,li:b}=n.tags,{svg:h,path:x}=n.tagsNS("http://www.w3.org/2000/svg"),v=i.drawerOpen,w=V(e,{class:o`
    ...
    `}),S=it(e),E=()=>s(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},x({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),D=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
  ...
  `,hideToRight:e`
   ...
   `});function ct(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=L=>{var y;return((y=L.parentTree.data)==null?void 0:y.href)??L.parentTree.children[0].data.href},u=({variant:L,color:y,size:m,currentTree:f,data:C})=>S(A({variant:L,color:y,size:m,href:`${c}${l(f)}`,class:o`
            flex-grow: 0;
    ...
    `}),{hideToLeft:T,hideToRight:M}=Do(e),_=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
...
`);function fe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Mo()}
  `;return function(r){const{variant:c=t.variant??"outline",color:l=t.color??"neutral",...u}=r;return a({type:"text",...u,class:I("input",t.class,t.size??"md",l,c,i,u.class)})}}function lt(e,t={}){const{bau:n,css:o,window:a}=e,i=fe(e,t);return function(r){const{variant:c=t.variant??"outline",color:l=t.color??"neutral",...u}=r,p=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(c=="solid"?"--font-color-inverse-secondary":`--color-${l}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,g=o`
      &.inputSearch {
        margin: 0.5rem 1rem;
        padding-left: 1.8rem;
        background-image: ${p};
    ...
    `;return i({type:"search",...u,color:l,variant:c,class:I("inputSearch",t.class,g,u.class)})}}function Rt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:d,span:p}=n.tags,g=lt(e,{variant:"plain",color:"neutral",size:"sm"}),h={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:w,children:S,pathnameState:E,variant:D,color:$,size:A})=>{const T=n.state(""),M=n.derive(()=>T.val==""?S:S.filter(W=>W.data.name.match(new RegExp(`${T.val}`,"i")))),_=W=>{T.val=W.target.value};return r({class:o`
        ...
        `},g({autocomplete:!1,name:"search",autofocus:!0,value:T,placeholder:`Search ${M.val.length} components`,size:22,oninput:_}),()=>w({children:M.val,pathnameState:E,variant:D,color:$,size:A}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let x=!1;const v=ct(e);return function(){return r({bauMounted:({element:S})=>{s.innerWidth<=640&&(x=!0,i.drawerOpen.val=!1)},onclick:S=>{x&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:I(o`
          ...
          `)},v({tree:h}))}}const No=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:i}=t.tags,s=Fe(e),r=To(e),c=Rt(e),l=Io(e),u=a`
    from {
      opacity: 1;
    }
    to {
...
"Click me"
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=U(r);return a({...d,class:I("paper",c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}function nn(e,t={}){const{bau:n,css:o,window:a}=e,{nav:i,ul:s,li:r,a:c}=n.tags,{headerSelector:l="h2,h3"}=t,u=n.state("no"),d=(x,v)=>{let w=null;return(...S)=>{a.clearTimeout(w),w=a.setTimeout(()=>x(...S),v)}},p=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,g=({value:x,id:v,children:w=[]})=>{const S=c({class:()=>u.val==v?"active":"",href:`#${v}`});return S.innerHTML=x,r({class:()=>u.val==v?"active":""},S,w.length>0&&s(w.map(g)))},b=x=>x.tagName.charAt(1),h=({contentEl:x})=>{const v=x.querySelectorAll(l);let w=2,S={},E={children:[]},D=E;const $=D;let A=[D];return[...v].forEach(T=>{const M=b(T);T.setAttribute("id",T.textContent),!T.innerHTML.includes("<button")&&(S={value:T.innerHTML,id:T.id??T.textContent,children:[]},w==M?(E=S,D.children.push(E)):w<M?(A.push(D),D=E,E.children.push(S),E=S):w>M&&(D=A[M-1],A=A.slice(0,M-1),D.children.push(S),E=S),w=M)}),$};return function(...v){let[{size:w=t.size??"md",variant:S=t.variant??"plain",color:E=t.color??"neutral",contentEl:D,...$}]=U(v);const A=h({contentEl:D}),T=d(()=>{const _=[...D.querySelectorAll(l)].find(W=>{const{top:Y,height:q}=W.getBoundingClientRect();if(Y+q>60)return!0});_&&(u.val=_==null?void 0:_.id)},100);return i({...$,class:I("tableOfContent",w,S,E,p,t==null?void 0:t.class,$==null?void 0:$.class),bauMounted:()=>{a.addEventListener("scroll",T)},bauUnmounted:()=>{a.removeEventListener("scroll",T)}},A.children&&s(A.children.map(g)))}}const on=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
        ...
        `},a(c(s(l(p??""),te.map(g=>l(g)))),i(So.map(g=>s(l(g),te.map((b,h)=>r(d({color:b,variant:g},{index:h}))))))))}},ja=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:i}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Co.map((s,r)=>i(e,{size:s})({color:"success",variant:"outline"},{size:s,index:r})))}},H=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:i,h1:s,p:r,h2:c,h3:l,pre:u,code:d}=t.tags;Ie.registerLanguage("javascript",tn);const p=nn(e),g=Ne(e,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),b=on(e),h=ja(e),x=({text:v})=>u({class:n`
          display: inline-block;
        ...
        `},S,p({contentEl:S}))}};function gt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    overflow: hidden;
    background-color: inherit;
    display: flex;
    flex-direction: column;
...
`,rn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Fa=e=>{const{css:t}=e,n=rn(e),o=Ke(e);return()=>o({color:"warning",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,Wa=e=>{const{css:t}=e,n=rn(e),o=Ke(e);return()=>o({color:"success",variant:"outline",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              & h3 {
...
`,qa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:Ua,createComponent:Ga},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Va,createComponent:Fa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Ka,createComponent:Wa}],gridItem:an},Xa=e=>{const t=H(e);return()=>t(qa)},Za={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Ya=()=>te.map(e=>`
&.alert {
  &.plain.${e} {
    & .icon {
      color: var(--color-${e})
...
`,mr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:ur,createComponent:lr},{title:"Component hide and show",description:"Hide and show a component",code:pr,createComponent:dr}]},gr=e=>{const t=H(e);return()=>t(mr)};function cn(e,t={}){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:h=t.color??"neutral",width:x=40,height:v=40,...w},...S]=U(p);return a({class:I(u,t==null?void 0:t.class,w.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:x,height:v,onload:c,onerror:l,class:I(h,b,g,u,t==null?void 0:t.class,w.class),...w}))}}const ln=(e,t)=>{const{css:n}=e,o=cn(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
100% {
  ...
  `;return function({size:u=t.size??"md",color:d=t.color??"primary",variant:p=t.variant??"outline",visibility:g=!0,...b}={}){const h=o`
      ...
      ${xr()}
    `;return i({class:{deps:[g],renderProp:()=>x=>I("spinner",h,d,p,x==!1?"":"visibility",t==null?void 0:t.class,b.class)},version:"1.1",x:"0px",y:"0px",width:Ge[u],height:Ge[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...b},s({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const wr=()=>te.map(e=>`
...
`,Cr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=Xe(e),r="AD",c=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=u=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(u.label),i(u.code));debugger;return()=>o(s({options:c,Option:l,defaultOption:c.find(({code:u})=>u==r),getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",id:"country"}))},kr=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
...
`,Er=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=V(e,{variant:"outline"}),r=Xe(e),c=t.state([]),l=t.state(!1),u=t.state("");async function d({url:b,transform:h=x=>x}){try{l.val=!0;const x=await fetch(b,{});if(x.ok){const v=await x.json();c.val=h(v)}else u.val=x.statusText}catch(x){u.val=x.message}finally{l.val=!1}}const p=()=>d({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:b=>b.sort((h,x)=>h.name.common.localeCompare(x.name.common))});p();const g=b=>a({class:n`
        ...
        `},i(b.flag),i(b.name.common));return()=>o(a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>r({options:c.val,Option:g,getOptionValue:({name:b})=>b.common,getOptionLabel:({name:b})=>b.common,label:"Country",placeholder:"Search countries",id:"country",loading:l.val}),s({onclick:()=>p()},"Reload")))},Ar=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,Tr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Sr,createComponent:yr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Ar,createComponent:Er},{title:"Default Option",description:"A autocomplete with a default option.",code:kr,createComponent:Cr}],gridItem:un},Ir=e=>{const t=H(e);return()=>t(Tr)};function dn(e,t={}){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,Or=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=bt(e,{variant:"plain",color:"neutral",separator:"/"});return()=>n(a(o))},Lr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
  type BreadcrumbsProps,
} from "@grucloud/bau-ui/breadcrumbs";
...
`,Hr=e=>{const{bau:t}=e,{section:n}=t.tags,o=V(e),a=()=>{alert("Click")};return()=>n(o({disabled:!0,color:"primary",variant:"outline",onclick:a},"Click me"))},Gr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ur={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Solid Button",description:"A simple button.",code:jr,createComponent:Rr},{title:"Disabled Button",description:"A disabled button.",code:Gr,createComponent:Hr}],gridItem:gn},Fr=e=>{const t=H(e);return()=>t(Ur)},Vr=()=>te.map(e=>`
&.button-group.${e} {
...
`,qr={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:Kr,createComponent:Wr}],gridItem:bn},Xr=e=>{const t=H(e);return()=>t(qr)};function hn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>te.map(r=>`
...
`,Jr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Yr,createComponent:Zr}],gridItem:fn},Qr=e=>{const t=H(e);return()=>t(Jr)};function es(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:g,Previous:b,Next:h,...x}]=U(c);const v=()=>{s.val<=0?s.val=p.length-1:s.val--},w=()=>{s.val>=p.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(g));return a({...x,class:I("carousel",l,i,t==null?void 0:t.class,x==null?void 0:x.class)},a({class:I("control","control-previous"),onclick:v},b()),a({class:I("control","control-next"),onclick:w},h()),S)}}const ts=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ns=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=V(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,cs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:is,createComponent:ss}],gridItem:vn},ls=e=>{const t=H(e);return()=>t(cs)};function xn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=U(r);return a({type:"checkbox",required:"required",...d,class:I(i,u,l,c,t==null?void 0:t.class,d==null?void 0:d.class)})}}const wn=(e,t)=>{const{bau:n,css:o}=e,{label:a}=n.tags,i=xn(e,t);return s=>a({class:o`
          ...
          color: var(--color-content-secondary);
          padding: 0.2rem;
        `},`${s.color} ${s.variant} ${s.size??""}`,i({id:`myCheckbox-gallery-${s.color}-${s.variant}-${s.size}`,name:`myCheckbox-gallery-${s.color}-${s.variant}`,...s}))},us=e=>{const{bau:t,css:n}=e,{section:o,label:a}=t.tags,i=xn(e),s=t.state(!1),r=c=>{s.val=!!c.target.checked};return()=>o(a({class:n`
            display: inline-flex;
            font-size: smaller;
            align-items: center;
            justify-content: space-between;
...
`,ps={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:ds,createComponent:us}],gridItem:wn},ms=e=>{const t=H(e);return()=>t(ps)},gs=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=gt(e),i=V(e,{variant:"outline"}),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},bs=`import button from "@grucloud/bau-ui/button";
...
`,hs={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:bs,createComponent:gs}]},fs=e=>{const t=H(e);return()=>t(hs)};function vs(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=U(r);return a({...d,class:I("divider",c,i,t==null?void 0:t.class,d==null?void 0:d.class)},a({class:"content"},...p))}}const xs=e=>{const{bau:t}=e,{section:n}=t.tags,o=vs(e);return()=>n(o("OR"))},ws=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,ys={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:ws,createComponent:xs}],variantColorTableDisable:!0,variantSizeDisable:!0},Ss=e=>{const t=H(e);return()=>t(ys)};function Cs(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    position: fixed;
    top: 80px;
    left: 0px;
    z-index: 2;
...
`,As={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:Es,createComponent:ks}]},Ts=e=>{const t=H(e);return()=>t(As)},Is=()=>te.map(e=>`
`).join(`
`);function yn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=V(e),r=qe(e),c=he(e),l=o`
    ${Is()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",label:h,ListItem:x,items:v,...w},...S]=U(d);const E=n.state(0),D=()=>{q.openDialog(),q.focus()},$=()=>{q.closeDialog()},A=()=>{q.open?$():D()},T=K=>{A(),K.preventDefault()},M=({item:K,index:L})=>y=>{E.val=L,$(),y.preventDefault()},_=K=>{switch(K.preventDefault(),K.key){case"Escape":$();break;case"ArrowDown":E.val<options.length-1?E.val++:E.val=0;break;case"ArrowUp":E.val<=0?E.val=options.length-1:E.val--;break;case"Enter":A();break}},W=()=>c({tabindex:"0",class:I(b,g)},v.map((K,L)=>i({class:()=>I(E.val==L&&"active"),onclick:M({item:K,index:L})},x(K)))),Y=s({type:"button",onclick:T,color:b,variant:g,size:p},h),q=r({triggerEl:Y,contentEl:W()});return a({...w,class:I("dropdownMenu",b,p,l,t==null?void 0:t.class,w==null?void 0:w.class),onkeydown:_},Y,q)}}const Ds=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,i=yn(e,t),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>i({...c,items:s,ListItem:r,label:"Action"})},Ms=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,i=yn(e),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(i({items:s,ListItem:r,label:"Action"}))},Ns=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ls={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Os,createComponent:Ps}],gridItem:(e,t)=>Sn(e,{base:"/components/drillDownMenu",hashBased:!0,...t})},zs=e=>{const t=H(e);return()=>t(Ls)};function ft(e,t={}){const{bau:n,css:o}=e,{div:a,label:i,input:s}=n.tags,r={base:o`
      display: inline-flex;
      & input {
        width: 0.1px;
        height: 0.1px;
    ...
    `};return function(l,...u){const{size:d=t.size??"md",variant:p=t.variant??"outline",color:g=t.color??"neutral",Component:b,disabled:h,...x}=l;return a({class:I(r.base,h&&r.disabled,t==null?void 0:t.class,l.class)},i({class:I(p,g,d)},b({disabled:h}),s({type:"file",disabled:h,...x})))}}const Cn=(e,t)=>{const{tr:n,bau:o,css:a,config:i}=e,{svg:s,use:r}=o.tagsNS("http://www.w3.org/2000/svg"),{div:c,span:l}=o.tags,u=o.state("No file selected"),d=ft(e,t),p=b=>{const h=b.target.files[0];h?u.val=h.name:u.val="No file selected"},g=({disabled:b})=>c({class:I(a`
          ...
          `,b&&o`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),l(t("Choose a file to upload")));return()=>r(d({Component:g,name:"file",accept:"text/*",onchange:p}),c("File selected: ",u))},Rs=`import classNames from "@grucloud/bau-css/classNames";
...
`,js={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Rs,createComponent:_s}],gridItem:Cn},Hs=e=>{const t=H(e);return()=>t(js)};function Be(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    align-items: stretch;
    gap: 1rem;
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:d,...p},...g]=U(r);return a({...p,class:I("form",u,l,c,i,t==null?void 0:t.class,p==null?void 0:p.class)},...g)}}function vt(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,Js={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:Ys,createComponent:Zs}],gridItem:En},Qs=e=>{const t=H(e);return()=>t(Js)};function An(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=()=>te.map(l=>`
&.${l}{
...
`,si={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:ri,createComponent:ai}],gridItem:In},ii=e=>{const t=H(e);return()=>t(si)},ci=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],li=(e,t)=>{const{bau:n,css:o}=e,{span:a,li:i}=n.tags,s=he(e,t),r=({code:c,label:l})=>i({class:o`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return c=>s({...c},ci.map(r))},ui=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],di=e=>{const{bau:t,css:n}=e,{section:o,span:a,li:i}=t.tags,s=he(e),r=({code:c,label:l})=>i({class:n`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return()=>o(s({variant:"outline",color:"primary"},ui.map(r)))},pi=`import list from "@grucloud/bau-ui/list";
import { Context } from "@grucloud/bau-ui/context";
...
`,mi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:pi,createComponent:di}],gridItem:li},gi=e=>{const t=H(e);return()=>t(mi)};function xt(e,t={}){const{bau:n,css:o}=e,{dialog:a,div:i}=n.tags,r=o`
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
    border-radius: var(--global-radius);
    min-width: 400px;
...
`,yi={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:wi,createComponent:xi}]},Si=e=>{const t=H(e);return()=>t(yi)};function Ci(e,t={}){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,Ai={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:Ei,createComponent:ki}]},Ti=e=>{const t=H(e);return()=>t(Ai)},Ii=(e,t)=>{const{bau:n}=e,{div:o}=n.tags,a=Ne(e,t);return i=>a({...i},o(`Paper ${t.size??""}`))},Di=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=Ne(e);return()=>n(a({size:"md"},o("My content")))},Mi=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`,Oi={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Pi,createComponent:Bi}],gridItem:Nn},Li=e=>{const t=H(e);return()=>t(Oi)},zi=()=>te.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function ke(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=V(e),l=qe(e),u=he(e),d=o`
    ...
    ${zi()}
  `;return function(...g){let[{size:b=t.size??"md",variant:h=t.variant??"outline",color:x=t.color??"neutral",label:v,Option:w,options:S,defaultOption:E,getOptionLabel:D,getOptionValue:$,onSelect:A=()=>{},loading:T,...M},..._]=U(g);const W=Ce(e,{variant:h,color:x,size:b}),Y=n.state(E?D(E):v),q=n.state(!1),K=n.state(0),L=()=>{j.openDialog(),j.focus(),q.val=!0},y=()=>{j.closeDialog(),q.val=!1},m=()=>{q.val=!1},f=B=>{j.open?y():L(),B.preventDefault()},C=({option:B,index:X})=>ne=>{Y.val=D(B),z.value=$(B),z.setCustomValidity(""),K.val=X,y(),A(B),ne.preventDefault()},k=B=>{switch(B.preventDefault(),B.key){case"Escape":y();break;case"ArrowDown":K.val<S.length-1?K.val++:K.val=0;break;case"ArrowUp":K.val<=0?K.val=S.length-1:K.val--;break;case"Enter":j.open?(Y.val=D(S[K.val]),z.value=$(r),y()):L();break}},R=()=>u({tabindex:"0",class:I(x,h)},S.map((B,X)=>i({class:()=>I(K.val==X&&"active"),onclick:C({option:B,index:X})},w(B)))),P=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":q,"aria-label":v,onclick:f,color:x,variant:h,size:b,class:T==!0&&"loading",disabled:T},()=>!Y.val&&v,Y,()=>T==!0&&W({visibility:T})),j=l({triggerEl:P,contentEl:R(),onClose:m}),z=s(M,r({value:""},"--Select Category--"),S.map(B=>r({value:$(B)},D(B))));return z.value=M.value,a({...M,class:I("select",x,b,d,t==null?void 0:t.class,M==null?void 0:M.class),onkeydown:k},z,P,j)}}const $n=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=ke(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return l=>s({...l,options:r,Option:c,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},_i=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=ke(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return()=>o(s({options:r,Option:c,getOptionValue:({code:l})=>l,getOptionLabel:({label:l})=>l,label:"Select a country..."}))},Ri=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,ji=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=ke(e),r="AD",c=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],l=u=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(u.label),i(u.code));return()=>o(s({options:c,Option:l,defaultOption:c.find(({code:u})=>u==r),getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."}))},Hi=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,Gi=e=>{const{bau:t}=e,{span:n,form:o}=t.tags,a=ke(e),i=["eu-north-1","ap-south-1","eu-west-3","eu-west-2","eu-west-1","ap-northeast-3","ap-northeast-2","ap-northeast-1","sa-east-1","ca-central-1","ap-southeast-1","ap-southeast-2","eu-central-1","us-east-1","us-east-2","us-west-1","us-west-2"],s=r=>n({},r);return()=>o(a({options:i,Option:s,label:"Select a region",getOptionValue:r=>r,getOptionLabel:r=>r}))},Ui=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,Fi=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=V(e,{variant:"outline"}),r=ke(e),c=t.state([]),l=t.state(!1),u=t.state("");async function d({url:b,transform:h=x=>x}){try{l.val=!0;const x=await fetch(b,{});if(x.ok){const v=await x.json();c.val=h(v)}else u.val=x.statusText}catch(x){u.val=x.message}finally{l.val=!1}}const p=()=>d({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:b=>b.sort((h,x)=>h.name.common.localeCompare(x.name.common))});p();const g=b=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(b.flag),i(b.name.common));return()=>o(a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>r({options:c.val,Option:g,getOptionValue:({name:b})=>b.common,getOptionLabel:({name:b})=>b.common,label:"Country",id:"country",loading:l.val}),s({onclick:()=>p()},"Reload")))},Vi=`import { Context } from "@grucloud/bau-ui/context";
...
`,Zi={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Xi,createComponent:qi}],gridItem:Pn},Yi=e=>{const t=H(e);return()=>t(Zi)};function wt(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
    0% {
      transform: translateX(-100%);
    }
    50% {
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",...g},...b]=U(l);return i({...g,class:I("skeleton",u,r,t==null?void 0:t.class,g==null?void 0:g.class)},...b)}}const Ji=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=wt(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,ec=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=wt(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,nc=e=>{const{bau:t,css:n}=e,{section:o,table:a,tbody:i,tr:s,td:r}=t.tags,c=wt(e,{class:n`
      height: 2rem;
      width: 10rem;
    `}),l=()=>a(i(new Array(8).fill("").map(()=>s(r(c({class:n`
                ...
                `})),r(c()),r(c()),r(c()),r(c({class:n`
                  width: 20rem;
                `}))))));return()=>o(l())},oc=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,cc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:s,br:r,option:c}=t.tags,l=t.state(0),u=p=>{l.val=p==null?void 0:p.target.value},d=Ze(e);return()=>o(a(i({for:"temp"},"Choose a comfortable temperature"),r,d({oninput:u,class:n`
            width: 300px;
            margin: 0;
          `,id:"temp",name:"temp",list:"markers"}),s({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(p=>c({value:Number(p),label:p})))))},lc=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,uc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:s,br:r,option:c}=t.tags,l=t.state(0),u=p=>{l.val=p==null?void 0:p.target.value},d=Ze(e);return()=>o(a({class:n`
            display: flex;
...
`,hc={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:bc,createComponent:gc}],gridItem:Ln},fc=e=>{const t=H(e);return()=>t(hc)},vc=()=>te.map(e=>`
`).join(`
`);function zn(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
  ...
  `;return function(...u){let[{color:d,variant:p="plain",size:g,stepperDefs:b=[],activeStepIndex:h,...x},...v]=U(u);const w=n.state(b.map(($,A)=>({...$,index:A}))),S=n.derive(()=>w.val[h.val]),E=$=>{const{Header:A,disabled:T,name:M,index:_}=$;return s({class:()=>I(S.val.name==M&&"active",h.val<_&&"not-completed",h.val>_&&"completed",T&&"disabled")},r({class:"step-number"},_+1),r({class:"step-label"},()=>A($)))};return a({class:I("stepper",p,g,d,c,t==null?void 0:t.class,x.class)},n.loop(w,i(),E),n.bind({deps:[S],render:()=>$=>$.Content?$.Content({}):""}))}}const xc=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=zn(e),r=V(e),c=({name:b})=>b,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},g=()=>a({class:n`
        ...
        `},r({onclick:d,variant:"outline",color:"primary"},"Previous"),r({onclick:p,variant:"solid",color:"primary"},"Next"));return()=>o({class:n`
          ...
          flex-direction: column;
          gap: 1rem;
        `},s({stepperDefs:l,activeStepIndex:u}),g())},wc=`import stepper, { type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
...
`,yc=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=V(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
    ...
    `;return S({name:"form-config-azure",onsubmit:A,"data-infra-create":!0,class:T},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",g("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",w({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("Tenant Id"),s("Retrieve the ",g("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",w({"data-input-azure-tenant-id":!0,placeholder:"Tenant Id",name:"tenantId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",g("APP_ID")," and ",g("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),b({class:n`
                  ...
                  flex-direction: column;
                  gap: 1rem;
                `},r("App Id",w({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",minLength:36,maxLength:36,size:36,required:!0})),r("Password",w({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",minLength:8,maxLength:64,size:64,required:!0})))))),v(x({onclick:D}),h({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},Dc=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:g,a:b,table:h,tbody:x,th:v,tr:w,td:S}=t.tags,{svg:E,use:D}=t.tagsNS("http://www.w3.org/2000/svg"),$=ft(e),A=V(e),T=Be(e),M=Je(e),_=Ye(e);return function({onclickPrevious:Y,onclickNext:q}){const K=t.state("No file selected"),L=t.state({}),y=t.state(!0),m=P=>{const j=P.target.files[0];if(j){K.val=j.name;const z=new FileReader;z.readAsText(j),z.onload=()=>{try{debugger;if(z.result){const B=JSON.parse(z.result);L.val=B,B.project_id&&(y.val=!1)}}catch{}},z.onerror=()=>{console.log(z.error)}}else K.val=""},f=({fileName:P,content:j})=>h({class:n`
    ...
    `;return T({name:"form-config-google",class:R,onsubmit:k,"data-infra-create":!0},s(i("Google Configuration"),r("GruCloud requires a read-only service account to scan a project's architecture. Please select the service account credential JSON file for the project that will be scanned. Follow the following steps to create and upload this file.")),a(u(d("Visit the ",b({href:"https://console.cloud.google.com/iam-admin/serviceaccounts",target:"_blank"},"service account page")," on the google cloud console"),d("Select your project"),d("Click on ",g("CREATE SERVICE ACCOUNT"),""),d("Set the ",g("Service account name")," to 'grucloud' for instance"),d("Click on ",g("CREATE"),""),d("Select the basic role 'Viewer'"),d("Click on ",g("CONTINUE"),""),d("Click on ",g("DONE"),""),d("Go to the ",g("Actions")," column, click on the three dot icon of the newly created service account"),d("Click on ",g("Manage keys"),""),d("Click on ",g("ADD KEYS"),", then ",g("Create new key"),""),d("Click on ",g("CREATE")," to download the credential file in JSON format.")),$({"data-input-google-upload":!0,Component:C,name:"file",accept:"application/JSON",onchange:m}),()=>f({fileName:K.val,content:L.val})),_(M({onclick:Y}),()=>A({type:"submit",variant:"outline",color:"primary",disabled:y.val},"Next",l("▶"))))}},Mc=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=zn(e),r=yc(e),c=Tc(e),l=Ic(e),u=Dc(e),d=Ec(e),p=t.state(""),g=t.state(0),b=({name:h})=>h;return function(){const x=A=>()=>{p.val=A,g.val++},v=()=>{g.val++},w=()=>{g.val++},E=[{name:"Provider Selection",Header:b,Content:()=>r({onclickProvider:x}),enter:async()=>{p.val=""}},{name:"Import",Header:()=>"Import Project",Content:()=>d({providerName:p.val,onclickPrevious:D,onclickImportExistingInfra:v,onclickImportFromTemplate:w})},{name:"Configuration",Header:()=>`Configuration ${p.val}`,Content:()=>{switch(p.val){case"AWS":return c({onclickPrevious:D,onclickNext:$});case"Azure":return l({onclickPrevious:D,onclickNext:$});case"Google":return u({onclickPrevious:D,onclickNext:$})}}},{name:"Scan",Header:b,Content:()=>a(i("My stepper 3 Content"))}],D=()=>{g.val>0&&g.val--},$=()=>{E.length>g.val+1&&g.val++};return o({class:n`
          ...
          flex-direction: column;
          gap: 1rem;
        `},s({stepperDefs:E,activeStepIndex:g}))}},Nc=`import stepper, { type StepperPage } from "@grucloud/bau-ui/stepper";
import { Context } from "@grucloud/bau-ui/context";
...
`,$c={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Simple Stepper",description:"A simple stepper.",code:wc,createComponent:xc},{title:"Cloud Config Stepper",description:"Configure cloud provider",code:Nc,createComponent:Mc}]},Bc=e=>{const t=H(e);return()=>t($c)},Pc=()=>te.map(e=>`
&.switch.plain.${e} {
  &::after {
...
`);function _n(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Pc()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=U(r);return a({...d,class:I("switch",i,u,l,c,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...p)}}const Rn=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:i}=n.tags,s=_n(e,t);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},i("off ",s({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),i("on ",s({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},Oc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i}=t.tags,s=_n(e);return()=>o(a(i({class:n`
              display: flex;
              align-items: center;
              gap: 0.5rem;
...
`,zc={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:Lc,createComponent:Oc}],gridItem:Rn},_c=e=>{const t=H(e);return()=>t(zc)},Rc=()=>te.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`,Gc=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Pe(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB 1"),Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>n("Tab Disabled"),Content:()=>n(o("My Content Disabled"))}]});return()=>i({variant:"outline",color:"success"})},Uc=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Hn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]},Fc=e=>{const{css:t}=e,n=Pe(e,{tabDefs:Hn(e)});return()=>n({variant:"outline",color:"neutral",class:t`
...
`,Wc=e=>{const{css:t}=e,n=Hn(e),o=Pe(e,{tabDefs:n});return()=>o({variant:"outline",color:"neutral",class:t`
        & ul {
          justify-content: center;
        }
...
`,qc={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Hc,createComponent:jc},{title:"Extended Tabs",description:"An extended tabs.",code:Uc,createComponent:Gc},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:Vc,createComponent:Fc},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:Kc,createComponent:Wc}],gridItem:jn},Xc=e=>{const t=H(e);return()=>t(qc)};function Oe(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i}=n.tags;a`
  :root {
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=U(c);return i({...l,class:I("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const Zc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(x,v,w,S,E){return{name:x,calories:v,fat:w,carbs:S,protein:E}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],g=({name:x,calories:v})=>s(i(x),i({class:n`
            text-align: right;
          `},v)),b=()=>c(s(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(h(r(u("Basic Table"),b(),l(p.map(g)))))},Yc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ae(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Jc=[Ae("Frozen yoghurt",159,6,24,4),Ae("Ice cream sandwich",237,9,37,4.3),Ae("Eclair",262,16,24,6),Ae("Cupcake",305,3.7,67,4.3),Ae("Gingerbread",356,16,49,3.9)],Qc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags,d=({name:b,calories:h})=>s(i(b),i({class:n`
            text-align: right;
          `},h)),p=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(g(r(u("Table Dense"),p(),l(Jc.map(d)))))},el=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Te(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const tl=[Te("Frozen yoghurt",159,6,24,4),Te("Ice cream sandwich",237,9,37,4.3),Te("Eclair",262,16,24,6),Te("Cupcake",305,3.7,67,4.3),Te("Gingerbread",356,16,49,3.9)],nl=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags,d=({name:b,calories:h})=>s(i(b),i({class:n`
            text-align: right;
          `},h)),p=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(g(r(u("Table Zebra"),p(),l(tl.map(d)))))},ol=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,al={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Yc,createComponent:Zc},{title:"Dense",description:"A dense table.",code:el,createComponent:Qc},{title:"Zebra",description:"A zebra table.",code:ol,createComponent:nl}]},rl=e=>{const t=H(e);return()=>t(al)},sl=e=>{const{bau:t,css:n}=e,{h1:o,h2:a,h3:i,section:s,article:r}=t.tags,c=nn(e),l=r({id:"content",class:n`
        grid-area: content;
      `},o({id:"h1"},"h1"),a({id:"h2-1"},"h2 1"),i({id:"h3-1-1"},"h3 1 1"),i({id:"h3-1-2"},"h3 1 2"),a({id:"h2-2"},"h2 2"),i({id:"h3-2-1"},"h3 2 1"));return()=>s({class:n`
          ...
          grid-template-areas: "content toc";
        `},l,c({contentEl:l}))},il=`import tableOfContent from "@grucloud/bau-ui/tableOfContent";
import { Context } from "@grucloud/bau-ui/context";
...
`,cl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:il,createComponent:sl}]},ll=e=>{const t=H(e);return()=>t(cl)};function Gn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=ht(e),s=V(e),r=Ce(e),c=o`
  ...
  `,l=({label:b,icon:h,...x})=>s({"aria-label":b,title:b,...x},h),u=({count:b,totalCount:h,page:x,rowsPerPage:v})=>a({class:"pages-numbers"},Number(x-1)*Number(v)+(b>0?1:0),"-",Math.min(x*v,h)," of ",h),d=({count:b,page:h,rowsPerPage:x})=>a({class:"pages-numbers"},(h-1)*x+(b>0?1:0),"-",h*x),p=b=>b<=1,g=(b,h,x)=>b>=Math.ceil(h/x);return function(...h){let[{size:x=t.size??"md",variant:v=t.variant??"outline",color:w=t.color??"neutral",count:S=0,totalCount:E=0,page:D=1,rowsPerPage:$=50,onPageChange:A,isLoading:T=!1,disableFirst:M=()=>p(D),disablePrevious:_=()=>p(D),disableNext:W=()=>g(D,E,$),disableLast:Y=()=>g(D,E,$),...q},...K]=U(h);const L=Math.max(0,Math.ceil(E/$)),y=A({page:1}),m=A({page:D-1}),f=A({page:D+1}),C=A({page:L}),k=[{label:"First",icon:"⟪",onclick:y,disabled:M()},{label:"Previous",icon:"⟨",onclick:m,disabled:_()},{label:"Next",icon:"⟩",onclick:f,disabled:W()},{label:"Last",icon:"⟫",onclick:C,disabled:Y()}];return a({...q,class:I("table-pagination",c,T&&"disabled",t==null?void 0:t.class,q==null?void 0:q.class)},r({class:"spinner",visibility:T,size:"md"}),E>0?u({count:S,totalCount:E,page:D,maxPages:L,rowsPerPage:$}):d({count:S,page:D,maxPages:L,rowsPerPage:$}),i({variant:v,color:w},k.map(R=>l({...R,variant:v,color:w}))))}}const ul=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),dl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=ul(45),u=({name:w,email:S})=>i(a(w),a(S)),d=()=>r(o({class:n`
    ...
    `}),b=t.state(l),h=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),x=t.derive(()=>b.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),v=({page:w})=>S=>{h.val.page=w};return()=>g(s(d(),()=>c(x.val.map(u))),()=>p({...h.val,onPageChange:v}))},pl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),g=t.derive(()=>d.val.length),b=t.state(1),h=t.state(10),x=t.derive(()=>d.val),v=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,w=({page:M})=>_=>{b.val=M,S(v({page:M,per_page:h.val}))};S(v({page:1,per_page:h.val}));async function S(M){try{u.val=!0;const _=await fetch(M,{});if(_.ok){const W=await _.json();d.val=W;return}throw _}catch(_){p.val=_.message}finally{u.val=!1}}const E=({name:M,description:_,stargazers_count:W})=>i(a(M),a(_),a({class:n`
      ...
      min-width: 650px;
    `}),T=({message:M})=>l(M);return()=>A(()=>$({rowsPerPage:h.val,page:b.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:w,disableNext:()=>!1}),s(D(),()=>p.val&&T({message:p.val}),()=>c(x.val.map(E))))},ml=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=dl(e),l=pl(e),u=(...d)=>a({class:n`
...
`,hl={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:bl,createComponent:gl}],gridItem:Un},fl=e=>{const t=H(e);return()=>t(hl)},vl=()=>te.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`,Cl={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:wl,createComponent:xl},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Sl,createComponent:yl}],gridItem:Fn},kl=e=>{const t=H(e);return()=>t(Cl)};function St(e,t={}){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,Tl=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i,section:s}=t.tags,r=Ve(e,{variant:"outline",color:"primary"}),c=St(e),l=()=>o(a("A ",i("tooltip")," can be any component")),u=()=>s({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
        `},o({class:n`
          ...
          `},c({side:"left-end",titleEl:l()},r("left end")),c({side:"right-end",titleEl:l()},r("right end"))),o({class:n`
            display: flex;
            justify-content: space-around;
          `},c({side:"bottom-start",titleEl:l()},r("bottom start")),c({side:"bottom-centered",titleEl:l()},r("bottom centered")),c({side:"bottom-end",titleEl:l()},r("bottom end"))));return()=>u()},Il=`import tooltip from "@grucloud/bau-ui/tooltip";
...
`,Bl={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:$l,createComponent:Nl}],gridItem:Wn},Pl=e=>{const t=H(e);return()=>t(Bl)},Ol=({css:e,createGlobalStyles:t})=>(t`
:root {
...
`,{nav:e`
  ...
  `});function Kn(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Ol({css:o,createGlobalStyles:a}),d=gt(e),p=({depth:g=1,maxDepth:b,color:h,variant:x,size:v})=>w=>{const{children:S,expanded:E}=w,D=n.state(!E),$=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:T=>{S&&(D.val=!D.val)}},i(w.data)),A=()=>s({class:I(h,v)},S.map(p({depth:g+1,maxDepth:b})));return r(d({size:v,Header:$,Content:S&&g<b&&A}))};return function({tree:b,maxDepth:h=1/0,size:x=t.size??"md",variant:v=t.variant??"outline",color:w=t.color??"neutral",...S}){return c({class:I(u.nav,x,v,w,t==null?void 0:t.class,S.class)},b.children&&s(b.children.map(p({maxDepth:h,color:w,variant:v,size:x}))))}}const qn=(e,t)=>{const{bau:n}=e,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Kn(e,{renderMenuItem:({name:r,href:c})=>o({href:c},r),...t});return r=>s({...r,tree:a})},Ll=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Kn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},zl=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,_l={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:zl,createComponent:Ll}],gridItem:qn},Rl=e=>{const t=H(e);return()=>t(_l)},jl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:s,ul:r,li:c}=t.tags,l=on(e),u=V(e),d=[{name:"Accordion",Item:an(e)},{name:"Alert",Item:sn(e)},{name:"Autocomplete",Item:un(e)},{name:"Avatar",Item:ln(e)},{name:"Badge",Item:pn(e)},{name:"Breadcrumbs",Item:mn(e)},{name:"Button",Item:gn(e)},{name:"Button Group",Item:bn(e)},{name:"Calendar",Item:fn(e)},{name:"Checkbox",Item:wn(e)},{name:"Chip",Item:vn(e)},{name:"DrillDown Menu",Item:Sn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:Cn(e)},{name:"Input",Item:kn(e)},{name:"Input Search",Item:En(e)},{name:"Linear Progress",Item:Tn(e)},{name:"Loading Button",Item:In(e)},{name:"Modal",Item:Dn(e)},{name:"Radio Button",Item:Nn(e)},{name:"Select",Item:$n(e)},{name:"Select Native",Item:Pn(e)},{name:"Slider",Item:On(e)},{name:"Spinner",Item:Ln(e)},{name:"Switch",Item:Rn(e)},{name:"Tabs",Item:jn(e)},{name:"Theme Switch",Item:Wn(e)},{name:"Toggle",Item:Un(e)},{name:"Toggle Group",Item:Fn(e)},{name:"Tooltip",Item:Vn(e)},{name:"Tree View",Item:qn(e)}];return()=>o({class:n`
  ...
  `};mo();const Xn={title:"Bau",base:"/bau/bau-ui"},ge=yo({config:Xn}),{bau:Vl}=ge;ge.states={drawerOpen:Vl.state(!0)};Fl(ge);no({routes:Hl({context:ge}),onLocationChange:Ul({context:ge,LayoutDefault:No(ge),config:Xn}),notFoundRoute:Gl(ge)});
