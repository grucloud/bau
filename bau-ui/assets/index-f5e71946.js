...
`);function ie(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
    ...
    ${No()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",...g},...f]=V(d);return r({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:["theme-switch",p,b,m,c,e==null?void 0:e.class,g.class],type:"checkbox",checked:s()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...f)}}function Oo(t){const{tr:e,bau:n,css:o,config:a,states:r}=t,{i,header:s,h1:l,div:c,a:u,img:d,b:m,ul:b,li:p}=n.tags,{svg:g,path:f}=n.tagsNS("http://www.w3.org/2000/svg"),y=r.drawerOpen,h=N(t,{class:o`
    ...
    `}),x=ie(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),k=()=>c({class:o`
        ...
        `},h({"aria-label":"drawer",variant:"none",color:"none",onclick:()=>y.val=!y.val},S()),u({href:`${a.base}/`,class:o`
          ...
          padding: 1rem;
          align-items: center;
        `},x(),h({target:"_blank",href:"https://github.com/grucloud/bau",title:"Bau's Github"},d({class:o`
            border-radius: 50%;
            background: black;
        ...
        `},d(f),s(g.map(({href:y,name:h})=>l(i({href:y},h))))),b=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],p=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
  ...
  `,hideToRight:t`
   ...
   `});function ce(t,e={}){const{bau:n,css:o,window:a,config:r}=t,{base:i="",hashBased:s=!1}=e,l=`${r.base}${i}`,c=P=>{var C;return((C=P.parentTree.data)==null?void 0:C.href)??P.parentTree.children[0].data.href},u=({variant:P,color:C,size:v,currentTree:w,data:E})=>x(A({variant:P,color:C,size:v,href:`${l}${c(w)}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),A({variant:P,color:C,size:v,href:`${l}${E.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},E.name)),d=({size:P,subTree:{data:{name:C,href:v},children:w=[]}})=>A({size:P,href:`${l}${v}`,"data-ischild":!w.length},C),m=({pathname:P,subTree:C})=>{var v;return P===((v=C==null?void 0:C.data)==null?void 0:v.href)},{renderHeader:b=u,renderMenuItem:p=d,isActive:g=m}=e,{li:f,nav:y,div:h,header:x,a:S}=n.tags,k=Kt(t),D=vt(t),A=N(t,{class:o`
      &.button {
...
`);function ut(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:["input",e.class,e.size??"md",c,l,r,s.class.join(" ")]})}}function le(t,e={}){const{bau:n,css:o,window:a}=t,r=ut(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,b=o`
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:["inputSearch",e.class,b,u.class]})}}function He(t){const{tr:e,bau:n,css:o,config:a,states:r,window:i}=t,{div:s,ul:l,li:c,nav:u,a:d,span:m,form:b}=n.tags,p=le(t,{variant:"plain",color:"neutral",size:"sm",class:o`
      margin: 0.5rem;
    `}),f={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:k,variant:D,color:A,size:B})=>{const O=n.state(""),I=n.derive(()=>O.val==""?S:S.filter(j=>j.data.name.match(new RegExp(`${O.val}`,"i")))),L=j=>{O.val=j.target.value};return b({class:o`
          display: flex;
          flex-direction: column;
          gap: 0;
...
"Click me"
  ...
  `,b=({value:f,id:y,children:h=[]})=>{const x=l({class:()=>u.val==y?"active":"",href:`#${y}`});return x.innerHTML=f,s({class:()=>u.val==y?"active":""},x,h.length>0&&i(h.map(b)))},p=f=>f.tagName.charAt(1),g=({contentEl:f})=>{const y=f.querySelectorAll(c);let h=2,x={},S={children:[]},k=S;const D=k;let A=[k];return[...y].forEach(B=>{const O=p(B);B.setAttribute("id",B.textContent),!B.innerHTML.includes("<button")&&(x={value:B.innerHTML,id:B.id??B.textContent,children:[]},h==O?(S=x,k.children.push(S)):h<O?(A.push(k),k=S,S.children.push(x),S=x):h>O&&(k=A[O-1],A=A.slice(0,O-1),k.children.push(x),S=x),h=O)}),D};return function(...y){let[{size:h=e.size??"md",variant:x=e.variant??"plain",color:S=e.color??"neutral",contentEl:k,...D}]=V(y);const A=g({contentEl:k}),B=d(()=>{const I=[...k.querySelectorAll(c)].find(L=>{const{top:j,height:U}=L.getBoundingClientRect();if(j+U>60)return!0});I&&(u.val=I==null?void 0:I.id)},100);return r({...D,class:["tableOfContent",h,x,S,m,e==null?void 0:e.class,D==null?void 0:D.class],bauMounted:()=>{a.addEventListener("scroll",B)},bauUnmounted:()=>{a.removeEventListener("scroll",B)}},A.children&&i(A.children.map(b)))}}const ln=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(l(i(c(m??""),nt.map(b=>c(b)))),r(To.map(b=>i(c(b),nt.map((p,g)=>s(d({color:p,variant:b},{index:g}))))))))}},Ha=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Do.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;Mt.registerLanguage("javascript",sn);const m=cn(t),b=be(t,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),p=ln(t),g=Ha(t),f=({text:y})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:h})=>{h.innerHTML=Mt.highlight(y,{language:"js"}).value}}));return function(h){const x=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},i(h.title),s(h.description),h.gridItem&&!h.variantColorTableDisable&&[l("Variant/Color"),b(p({Item:h.gridItem(t)}))],h.gridItem&&!h.variantSizeDisable&&[l("Size"),s("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),b(g({item:h.gridItem}))],l("Usage"),c("Import"),f({text:h.importStatement}),l("Examples"),h.examples.map(S=>r(c(S.title),s(S.description),b(S.createComponent(t)({})),f({text:S.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
...
`);function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,ul:r,li:i,h3:s,button:l}=n.tags,c=o`
    ...
    ${Va()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",data:g=[],...f}]=V(d);const y=n.state(""),h=ge(t,{size:m,variant:b,color:p}),x=k=>D=>{y.val==k?y.val="":y.val=k},S=k=>{const{Header:D,Content:A,name:B}=k,O=()=>s({class:()=>y.val==B&&"active"},l({type:"button","aria-controls":`bau-${B}`,"aria-expanded":({element:L})=>y.val==B},D(k))),I=()=>a({id:`bau-${B}`,"data-state":({element:L})=>y.val==B},A(k));return i({class:[p,b,m],onclick:x(B)},h({Header:O,Content:I}))};return a({class:["accordion",c,e==null?void 0:e.class,f.class]},r(g.map(S)))}}const un=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Zt(t,e);return s=>i({...s,data:r})},Ja=t=>{const{bau:e}=t,{div:n,p:o,section:a}=e.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Zt(t,{color:"neutral",variant:"outline"});return()=>a(i({data:r}))},qa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,hr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:fr,createComponent:gr}]},vr=t=>{const e=F(t);return()=>e(hr)};function Et(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",width:f=40,height:y=40,alt:h,...x},...S]=V(m);const k=Et(t,{class:[o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${y}px;
          width: ${f}px;
        `,e==null?void 0:e.class,x.class]});return a({class:[u,e==null?void 0:e.class,x.class]},()=>i.val&&k(),()=>s.val&&h,r({alt:h,width:f,height:y,onload:l,onerror:c,class:()=>[!i.val&&"visible",s.val&&"hide",g,p,b,u,e==null?void 0:e.class,x.class],...x}))}}const pn=(t,e)=>{const{css:n}=t,o=fe(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
100% {
  ...
  `;return function({size:u=e.size??"md",color:d=e.color??"primary",variant:m=e.variant??"outline",visibility:b=!0,...p}={}){const g=o`
      ...
      ${Er()}
    `;return r({class:{deps:[b],renderProp:()=>f=>["spinner",g,d,m,f==!1?"":"visibility",e==null?void 0:e.class,p.class]},version:"1.1",x:"0px",y:"0px",width:qt[u],height:qt[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...p},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Tr=()=>nt.map(t=>`
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=N(t,{variant:"outline"}),c=N(t,{variant:"solid",color:"primary"}),u=Rt(t),d=m=>i({class:n`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},s(m.flag),s(m.name.common));return()=>{const m=e.state([]),b=e.state(!1),p=e.state("");async function g({url:h,transform:x=S=>S}){try{b.val=!0;const S=await fetch(h,{});if(S.ok){const k=await S.json();m.val=x(k)}else p.val=S.statusText}catch(S){p.val=S.message}finally{b.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((x,S)=>x.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:h=>{h.preventDefault();const x=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(x))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({options:m.val,Option:d,getOptionValue:({name:h})=>h.common,getOptionLabel:({name:h})=>h.common,label:"Country",placeholder:"Search countries",name:"country",loading:b.val}),l({onclick:f},"Reload")),r(c({type:"submit"},"Submit")))}},Ir=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,$r=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Rt(t),c=N(t,{variant:"outline",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],d=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(b.label),s(b.code)),m="country";return()=>{const b=h=>{h.preventDefault();const x=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(x))},g=new URLSearchParams(window.location.search).get("country"),f=({code:h})=>h,y=h=>{const x=new URLSearchParams(window.location.search);x.delete(m),x.append(m,f(h)),window.history.replaceState("","",`?${x.toString()}${window.location.hash}`)};return o({onsubmit:b},a(l({name:m,options:u,Option:d,defaultOption:u.find(({code:h})=>h==g),getOptionValue:({code:h})=>h,getOptionLabel:({label:h})=>h,label:"Country",placeholder:"Search countries",onSelect:y})),r(c({type:"submit"},"Submit")))}},Lr=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,Pr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Br,createComponent:Ar},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Ir,createComponent:Mr},{title:"Default Option",description:"A autocomplete with a default option.",code:Or,createComponent:Nr},{title:"URL State",description:"A autocomplete with the state in the URL",code:Lr,createComponent:$r}],gridItem:bn},zr=t=>{const e=F(t);return()=>e(Pr)};function gn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=V(s);return a({...m,class:["badge",r,e==null?void 0:e.class,m==null?void 0:m.class]},a({class:[u,c,l]},d),...b)}}const fn=(t,e)=>{const n=gn(t,e);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},Rr=t=>{const{bau:e}=t,{section:n}=e.tags,o=gn(t);return()=>n(o({content:"10"},"☏"))},jr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,ls={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Uncontrolled Calendar",description:"A simple calendar.",code:ss,createComponent:rs},{title:"Controlled Calendar",description:"A controlled calendar.",code:cs,createComponent:is}],gridItem:xn},us=t=>{const e=F(t);return()=>e(ls)};function ds(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:b,Previous:p,Next:g,...f}]=V(l);const y=()=>{i.val<=0?i.val=m.length-1:i.val--},h=()=>{i.val>=m.length-1?i.val=0:i.val++},x=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(b));return a({...f,class:["carousel",c,r,e==null?void 0:e.class,f==null?void 0:f.class]},a({class:["control","control-previous"],onclick:y},p()),a({class:["control","control-next"],onclick:h},g()),x)}}const ms=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ps=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,r=N(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`);function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=N(t),s=zt(t),l=vt(t),c=o`
    ${Vs()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"outline",color:p=e.color??"neutral",label:g,ListItem:f,items:y,...h},...x]=V(d);const S=n.state(0),k=()=>{U.openDialog(),U.focus()},D=()=>{U.closeDialog()},A=()=>{U.open?D():k()},B=z=>{A(),z.preventDefault()},O=({item:z,index:P})=>C=>{S.val=P,D(),C.preventDefault()},I=z=>{switch(z.preventDefault(),z.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},L=()=>l({tabindex:"0",class:[p,b]},y.map((z,P)=>r({class:()=>[S.val==P&&"active"],onclick:O({item:z,index:P})},f(z)))),j=i({type:"button",onclick:B,color:p,variant:b,size:m},g),U=s({triggerEl:j,contentEl:L()});return a({...h,class:["dropdownMenu",p,m,c,e==null?void 0:e.class,h==null?void 0:h.class],onkeydown:I},j,U)}}const Js=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=Cn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},qs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=Cn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Ws=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Qs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Ys,createComponent:Zs}],gridItem:(t,e)=>kn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},ti=t=>{const e=F(t);return()=>e(Qs)};function En(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",Component:p,disabled:g,...f}=c;return a({class:[s.base,g&&s.disabled,e==null?void 0:e.class,c.class]},r({class:[m,b,d]},p({disabled:g}),i({type:"file",disabled:g,...f})))}}const Tn=(t,e)=>{const{tr:n,bau:o,css:a,config:r}=t,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=En(t,e),m=p=>{const g=p.target.files[0];g?u.val=g.name:u.val="No file selected"},b=({disabled:p})=>l({class:[a`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`,oi={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:ni,createComponent:ei}],gridItem:Tn},ai=t=>{const e=F(t);return()=>e(oi)};function bt(t,e={}){const{bau:n,css:o}=t,{form:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=V(s);return a({...m,class:["form",u,c,l,r,e==null?void 0:e.class,m==null?void 0:m.class]},...b)}}function xe(t,e={}){const{bau:n,css:o,keyframes:a}=t,{span:r}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,Di={title:"KeyValueList",package:"keyValueList",description:"The keyValueList component displays a list of key value pair",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/keyValueList/keyValueList.js",importStatement:'import keyValueList from "@grucloud/bau-ui/keyValueList";',examples:[{title:"Vertical keyValueList",description:"A vertical keyValueList.",code:ki,createComponent:Ci},{title:"Horizontal keyValueList",description:"A horizontal keyValueList.",code:Ti,createComponent:Ei}]},Ai=t=>{const e=F(t);return()=>e(Di)},Bi="modulepreload",Ni=function(t){return"/bau/bau-ui/"+t},Re={},Nn=function(e,n,o){if(!n||n.length===0)return e();const a=document.getElementsByTagName("link");return Promise.all(n.map(r=>{if(r=Ni(r),r in Re)return;Re[r]=!0;const i=r.endsWith(".css"),s=i?'[rel="stylesheet"]':"";if(!!o)for(let u=a.length-1;u>=0;u--){const d=a[u];if(d.href===r&&(!i||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${r}"]${s}`))return;const c=document.createElement("link");if(c.rel=i?"stylesheet":Bi,i||(c.as="script",c.crossOrigin=""),c.href=r,document.head.appendChild(c),i)return new Promise((u,d)=>{c.addEventListener("load",u),c.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${r}`)))})})).then(()=>e())};function On(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=pt(t,{size:"lg"}),i=Tt(t,{color:"danger"}),s=()=>a({class:o`
          ...
          justify-content: center;
          align-items: center;
        `},r({visibility:!0})),l=c=>i(c.message);return function({getModule:u,loading:d=s,error:m=l,props:b={}}){const p=n.state(void 0),g=n.state(!0),f=n.state(!1);return u().then(y=>{n.batch(()=>{p.val=y.default(t),g.val=!1})}).catch(y=>{f.val=y.message}),a(()=>{if(f.val)return m({message:f.val});if(g.val)return d();if(p.val)return p.val(b)})}}const Oi=t=>{const{bau:e}=t,{section:n}=e.tags,o=On(t),a=N(t);return()=>{const r=e.state(!1);return n(a({onclick:()=>r.val=!r.val},()=>r.val?"Hide":"Show"),()=>r.val&&o({getModule:()=>Nn(()=>import("./myComponent-a7adf959.js"),[]),props:{message:"myValue"}}))}},Mi=`import { Context } from "@grucloud/bau-ui/context";
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",running:p,...g}]=V(u);return r({...g,role:"progressbar",class:{deps:[p],renderProp:()=>f=>["linearProgress",d,b,l,f&&"running",e==null?void 0:e.class,g==null?void 0:g.class]}})}}const In=(t,e)=>{const n=Mn(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},zi=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=N(t,{variant:"solid",color:"primary"}),r=Mn(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},Ri=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`);function oc(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=N(t),l=zt(t),c=vt(t),u=xt(t,{color:"neutral",variant:"outline"}),d=o`
    ...
    ${nc()}
  `;return function(...b){let[{size:p=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",name:y,label:h,Option:x,options:S,defaultValue:k=[],getOptionLabel:D,getOptionValue:A,renderValue:B,onSelect:O=()=>{},loading:I,...L},...j]=V(b);const U=pt(t,{variant:g,color:f,size:p}),z=n.state(k),P=n.state(!1),C=n.state(0),v=()=>{X.openDialog(),X.focus(),P.val=!0},w=()=>{X.closeDialog(),P.val=!1},E=()=>{P.val=!1},T=W=>{X.open?w():v(),W.preventDefault()},G=()=>Array.from(tt.selectedOptions).map(({value:W})=>S.find(Z=>A(Z)==W)),R=W=>{switch(W.preventDefault(),W.key){case"Escape":w();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Z=W.currentTarget.querySelectorAll("input")[C.val];Z.checked=!Z.checked;const at=tt.options[C.val+1];at.selected=!at.selected,z.val=G()}else v();break}},H=W=>Z=>{const at=[...tt.options].find(({value:it})=>it==A(W));Z.target.checked?at.selected=!0:at.selected=!1,z.val=G()},J=()=>c({tabindex:"0",class:[f,g]},S.map((W,Z)=>r({class:()=>C.val==Z&&"active"},n.tags.label(u({checked:k.find(at=>A(at)==A(W)),name:`${y}-${A(W)}`,onchange:H(W)}),x(W))))),M=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":P,"aria-label":h,onclick:T,color:f,variant:g,size:p,class:I==!0&&"loading",disabled:I},()=>z.val.length?B(z.val):h,()=>I==!0&&U({visibility:I})),X=l({triggerEl:M,contentEl:J(),onClose:E}),tt=i({name:y,multiple:!0,...L},n.tags.option({value:""},"--Category--"),S.map(W=>n.tags.option({value:A(W),selected:k.find(Z=>A(Z)==A(W))},D(W))));return a({...L,class:["multiSelect",f,p,d,e==null?void 0:e.class,L==null?void 0:L.class],onkeydown:R},tt,M,X)}}const ac=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=oc(t),l=N(t,{variant:"outline",color:"neutral"}),c=Pt(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=m=>a(m.group);return()=>r({onsubmit:b=>{b.preventDefault();const{selectedOptions:p}=b.target.elements.myMultiSelect,g=Array.from(p).map(({value:f})=>f);alert(JSON.stringify(g))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,Rc={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:Ic,createComponent:Mc},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Bc,createComponent:Ac},{title:"Url State Radio Button Group",description:"A radio button group with the state in the URL",code:Oc,createComponent:Nc},{title:"Label with Image",description:"A label with an image.",code:Lc,createComponent:$c},{title:"Label with description",description:"A label with name and description.",code:zc,createComponent:Pc}]},jc=t=>{const e=F(t);return()=>e(Rc)};function Lt(t,e={}){const{bau:n,css:o,window:a}=t,{section:r,article:i,div:s}=n.tags,{document:l}=a,{direction:c="horizontal"}=e,u=o`
  ...
  `;function d(...p){let[g,...f]=V(p);return r({...g,class:["resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u]},f)}function m(...p){let[g,...f]=V(p);return i({...g,class:["resizablePanel",g==null?void 0:g.class]},f)}function b(...p){let[g,...f]=V(p),y=0,h=0,x,S,k,D,A;const B=()=>c==="horizontal",O=z=>B()?I(z):L(z),I=z=>{const P=z.clientX-y;A&&(D.style.width=`${A.width+P}px`),k&&(S.style.width=`${k.width-P}px`)},L=z=>{const P=z.clientY-h;A&&(D.style.height=`${A.height+P}px`),k&&(S.style.height=`${k.height-P}px`)},j=()=>{S=null,D=null,k=null,A=null,x.style.cursor=null,x.style["user-select"]="auto",l.removeEventListener("mousemove",O),l.removeEventListener("mouseup",j)},U=z=>{y=z.clientX,h=z.clientY;const{target:P}=z,C=P.closest(".handle");x=P.closest(".resizablePanelGroup"),x.style.cursor=B()?"col-resize":"row-resize",x.style["user-select"]="none",S=C.nextSibling,D=C.previousSibling,D&&(A=D.getBoundingClientRect()),S&&(k=S.getBoundingClientRect()),l.addEventListener("mousemove",O),l.addEventListener("mouseup",j)};return s({...g,class:["handle",c],role:"separator",bauMounted:({element:z})=>{z.addEventListener("mousedown",U)},bauUnmounted:({element:z})=>{z.removeEventListener("mousedown",U)}},f)}return{PanelGroup:d,Panel:m,Handle:b}}const _c=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
      display: inline-flex;
...
`);function Dt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,l=N(t),c=zt(t),u=vt(t),d=o`
    ...
    ${Xc()}
  `;return function(...b){let[{size:p=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",label:y,Option:h,options:x,defaultOption:S,getOptionLabel:k,getOptionValue:D,onSelect:A=()=>{},loading:B,...O},...I]=V(b);const L=pt(t,{variant:g,color:f,size:p}),j=n.state(S?k(S):y),U=n.state(!1),z=n.state(0),P=()=>{H.openDialog(),H.focus(),U.val=!0},C=()=>{H.closeDialog(),U.val=!1},v=()=>{U.val=!1},w=M=>{H.open?C():P(),M.preventDefault()},E=({option:M,index:X})=>tt=>{j.val=k(M),J.value=D(M),J.setCustomValidity(""),z.val=X,C(),A(M),tt.preventDefault()},T=M=>{switch(M.preventDefault(),M.key){case"Escape":C();break;case"ArrowDown":z.val<x.length-1?z.val++:z.val=0;break;case"ArrowUp":z.val<=0?z.val=x.length-1:z.val--;break;case"Enter":H.open?(j.val=k(x[z.val]),J.value=D(s),C()):P();break}},G=()=>u({tabindex:"0",class:[f,g]},x.map((M,X)=>r({class:()=>z.val==X&&"active",onclick:E({option:M,index:X})},h(M)))),R=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":U,"aria-label":y,onclick:w,color:f,variant:g,size:p,class:B==!0&&"loading",disabled:B},()=>!j.val&&y,j,()=>B==!0&&L({visibility:B})),H=c({triggerEl:R,contentEl:G(),onClose:v}),J=i({...O,"aria-label":y},s({value:""},"--Select Category--"),x.map(M=>s({value:D(M)},k(M))));return S?J.value=D(S):J.value=O.value,a({...O,class:["select",f,p,d,e==null?void 0:e.class,O==null?void 0:O.class],onkeydown:T},J,R,H)}}const Rn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Dt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,rl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=N(t,{variant:"outline"}),c=N(t,{variant:"solid",color:"primary"}),u=Dt(t),d=m=>s({class:n`
        ...
        `},i(m.flag),i(m.name.common));return()=>{const m=e.state([]),b=e.state(!1),p=e.state("");async function g({url:h,transform:x=S=>S}){try{b.val=!0;const S=await fetch(h,{});if(S.ok){const k=await S.json();m.val=x(k)}else p.val=S.statusText}catch(S){p.val=S.message}finally{b.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((x,S)=>x.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:h=>{h.preventDefault();const x=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(x))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:m.val,Option:d,getOptionValue:({name:h})=>h.common,getOptionLabel:({name:h})=>h.common,label:"Country",id:"country",loading:b.val,required:!0}),l({onclick:()=>f()},"Reload")),r(c({type:"submit"},"Submit")))}},sl=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`;function Nt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const fu=[Nt("Frozen yoghurt",159,6,24,4),Nt("Ice cream sandwich",237,9,37,4.3),Nt("Eclair",262,16,24,6),Nt("Cupcake",305,3.7,67,4.3),Nt("Gingerbread",356,16,49,3.9)],hu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:g})=>i(r(p),r({class:n`
    ...
    `});return()=>o(b(s(u("Table Dense"),m(),c(fu.map(d)))))},vu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Tu={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Eu,createComponent:ku}]},Du=t=>{const e=F(t);return()=>e(Tu)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=ve(t),i=N(t),s=pt(t),l=o`
  ...
  `,c=({label:p,icon:g,...f})=>i({"aria-label":p,title:p,...f},g),u=({count:p,totalCount:g,page:f,rowsPerPage:y})=>a({class:"pages-numbers"},Number(f-1)*Number(y)+(p>0?1:0),"-",Math.min(f*y,g)," of ",g),d=({count:p,page:g,rowsPerPage:f})=>a({class:"pages-numbers"},(g-1)*f+(p>0?1:0),"-",g*f),m=p=>p<=1,b=(p,g,f)=>p>=Math.ceil(g/f);return function(...g){let[{size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",count:x=0,totalCount:S=0,page:k=1,rowsPerPage:D=50,onPageChange:A,isLoading:B=!1,disableFirst:O=()=>m(k),disablePrevious:I=()=>m(k),disableNext:L=()=>b(k,S,D),disableLast:j=()=>b(k,S,D),...U},...z]=V(g);const P=Math.max(0,Math.ceil(S/D)),C=A({page:1}),v=A({page:k-1}),w=A({page:k+1}),E=A({page:P}),T=[{label:"First",icon:"⟪",onclick:C,disabled:O()},{label:"Previous",icon:"⟨",onclick:v,disabled:I()},{label:"Next",icon:"⟩",onclick:w,disabled:L()},{label:"Last",icon:"⟫",onclick:E,disabled:j()}];return a({...U,class:["table-pagination",l,B&&"disabled",e==null?void 0:e.class,U==null?void 0:U.class]},s({class:"spinner",visibility:B,size:"md"}),S>0?u({count:x,totalCount:S,page:k,maxPages:P,rowsPerPage:D}):d({count:x,page:k,maxPages:P,rowsPerPage:D}),r({variant:y,color:h},T.map(G=>c({...G,variant:y,color:h}))))}}const Au=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Bu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=Au(45),u=({name:p,email:g})=>r(a(p),a(g)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=Jn(t),b=Ut(t,{class:n`
      max-width: 650px;
    `});return()=>{const p=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),f=e.derive(()=>p.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:h})=>x=>{g.val.page=h};return b(i(d(),()=>l(f.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),b=e.derive(()=>d.val.length),p=e.state(1),g=e.state(10),f=e.derive(()=>d.val),y=O=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(O).toString()}`,h=({page:O})=>I=>{p.val=O,x(y({page:O,per_page:g.val}))};x(y({page:1,per_page:g.val}));async function x(O){try{u.val=!0;const I=await fetch(O,{});if(I.ok){const L=await I.json();d.val=L;return}throw I}catch(I){m.val=I.message}finally{u.val=!1}}const S=({name:O,description:I,stargazers_count:L})=>r(a(O),a(I),a({class:n`
            text-align: right;
          `},L)),k=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),B=({message:O})=>c(O);return()=>A(()=>D({rowsPerPage:g.val,page:p.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:h,disableNext:()=>!1}),i(k(),()=>m.val&&B({message:m.val}),()=>l(f.val.map(S))))},Ou=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=Bu(t),c=Nu(t),u=(...d)=>a({class:n`
...
`);function Ce(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    ...
    ${_u()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",exclusive:d=!1,onChange:m=()=>{},...b},...p]=V(s);const g=new Set,f=y=>{const{value:h}=y.target;d?(g.clear(),g.add(h)):g.has(h)?g.delete(h):g.add(h),m({event:y,values:[...g]})};return a({...b,class:["toggle-group",l,u,c,r,e==null?void 0:e.class,b==null?void 0:b.class],onclick:f},...p)}}const Wn=(t,e)=>{const{bau:n}=t,o=Ce(t,e),a=wt(t,e);return r=>{const i=n.state([""]),s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...r,onChange:({values:c})=>{i.val=c}},s.map(({label:c,value:u})=>()=>a({...r,value:u,selected:i.val.includes(u),"area-label":c},c)))}},Uu=t=>{const{bau:e}=t,{form:n,footer:o,article:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=wt(t,{color:i,variant:s}),c=Ce(t,{color:i,variant:s}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{var y;p.preventDefault();const f=(y=p.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:y.name;alert(f)}},a(c({exclusive:!0,onChange:({values:p})=>{d.val=p}},r.map(({label:p,value:g})=>()=>l({value:g,name:p,selected:d.val.includes(g)},p)))),o(u({type:"submit"},"Submit")))}},Gu=`import { Context } from "@grucloud/bau-ui/context";
...
`,{nav:t`
  ...
  `});function Ee(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{renderMenuItem:r}=e,{ul:i,li:s,nav:l,div:c}=n.tags,u=od({css:o,createGlobalStyles:a}),d=ge(t),m=({depth:b=1,maxDepth:p,parent:g,color:f,variant:y,size:h})=>x=>{const{children:S,expanded:k}=x,D=n.state(!k),A=()=>c({class:o`
              cursor: ${S?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:O=>{S&&(D.val=!D.val)}},r({item:x,parent:g,depth:b})),B=()=>i({class:[f,h]},S.map(m({depth:b+1,maxDepth:p,parent:x})));return s(S.length?d({expanded:k,Header:A,Content:S&&b<p&&B}):A())};return function({tree:p,maxDepth:g=1/0,size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",...x}){return l({class:[u.nav,f,y,h,e==null?void 0:e.class,x.class]},i(m({maxDepth:g,color:h,variant:y,size:f})(Zn({})({...p}))))}}const Yn=(t,e)=>{const{bau:n}=t,{a:o,span:a}=n.tags,r={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Ee(t,{renderMenuItem:({item:{data:{name:l,href:c}}})=>c?o({href:c},l):a(l),...e});return l=>s({...l,tree:r})},ad=t=>{const{bau:e}=t,{a:n,span:o}=e.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ee(t,{renderMenuItem:({item:{data:{name:s,href:l}}})=>l?n({href:l},s):o(s)});return()=>i({tree:a})},rd=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
