...
`)}
  ...
  `}function fn(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let Ke=e=>Object.prototype.toString.call(e??0).slice(8,-1),vn=e=>Ke(e)=="Object",gt=e=>Ke(e)=="Function",Ve=e=>["Object","Array"].includes(Ke(e)),ft=Object.getPrototypeOf,Xe=e=>he(e)?e.val:e,he=e=>e==null?void 0:e.__isState,xn=["splice","push","pop","shift","unshift","sort","reverse"],$e=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const Q=e=>!he(e[0])&&vn(e[0])?e:[{},...e];function wn(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,r=new Set,s=!1,i,c=f=>n.createElement(f),l=(f,E,p)=>{let b=i;i=E;let x=f(p);return i=b,x},m=()=>{o||(o=window.requestAnimationFrame(()=>{a.forEach(f=>{f.bindings=f.bindings.filter(E=>{var p;return(p=E.element)==null?void 0:p.isConnected}),!f.bindings.length&&!f.computed&&a.delete(f)}),o=void 0}))},d=(f,E,p,b,x,I)=>{var T;if(s){r.add(f);return}for(let z of f.bindings){let{deps:R,element:H,renderInferred:L,render:X,renderItem:te}=z;if(te&&E)(T=y(H,b,(...re)=>h(te(...re)),p,x,I)[E])==null||T.call();else{let re=L?L({element:H}):X({element:H,renderItem:te})(...R.map(Xe));re!==H&&H.replaceWith(z.element=h(re))}}A(f),m()},u=(f,E,p=[])=>({get(b,x,I){var T;if(i==null||i.add(f),x==="_isProxy")return!0;if(!((T=b[x])!=null&&T._isProxy)&&!he(b[x])&&Ve(b[x]))b[x]=new Proxy(b[x],u(f,E,[...p,x]));else if(xn.includes(x)){let z=b[x];return(...R)=>{let H=z.apply(b,R);return d(f,x,H,R,E,p),H}}return Reflect.get(b,x,I)},set(b,x,I,T){let z=Reflect.set(b,x,I,T);return d(f,"setItem",z,{prop:x,value:I},E,[...p,x]),z}}),v=(f,E)=>new Proxy(E,u(f,E)),y=(f,E,p,b,x,I)=>{let T=()=>f.replaceChildren(...$e(b,p)),z=R=>f[R]&&f.removeChild(f[R]);return{assign:T,sort:T,reverse:T,setItem:()=>{var H;let R=I[0];(H=f.children[R])==null||H.replaceWith(p(x[R],R))},push:()=>f.append(...$e(E,(R,H)=>p(R,x.length+H))),unshift:()=>f.prepend(...$e(E,p)),pop:()=>z("lastChild"),shift:()=>z("firstChild"),splice:()=>{let[R,H,...L]=E;const{length:X}=f.children;for(let te=R>=0?Math.min(R+H-1,X-1):X-1;te>=(R>=0?R:X+R);te--)f.children[te].remove();if(L.length){let te=L.forEach((re,pe)=>p(re,R+pe));f.children[R]?f.children[R].after(...te):f.append(...te)}}}},g=f=>({oldVal:f,bindings:[],listeners:[],__isState:!0,get val(){let E=this;return i==null||i.add(E),E.valProxy??(E.valProxy=Ve(f)?v(E,f):f,E.valProxy)},set val(E){let p=this,b=p.val;Ve(E)?(p.valProxy=v(p,E),d(p,"assign",E)):E!==b&&(p.valProxy=E,d(p)),p.oldVal=b}}),h=f=>f==null||f===!1?c("span"):f.nodeType?f:n.createTextNode(f),S=(f,E)=>{let p=new Set;return E.val=l(f,p),p},C=f=>{let E=g(),p=S(f,E);E.computed=!0;for(let b of p)b.listeners.push({computed:f,deps:p,state:E});return E},A=f=>{for(let E of[...f.listeners])S(E.computed,E.state)},D=(f,...E)=>{if(E.length){let p=[];for(let b of E.flat(1/0))b!=null&&p.push(he(b)?U({deps:[b],render:()=>x=>x}):gt(b)?K({renderInferred:b}):h(b));f.append(...p)}},B={},P=(f,E)=>f&&(Object.getOwnPropertyDescriptor(f,E)??P(ft(f),E)),N=(f,E,p)=>{var b;return B[f+","+E]??(B[f+","+E]=((b=P(p,E))==null?void 0:b.set)??0)},O=(f,E)=>new MutationObserver((p,b)=>{p.filter(x=>x.removedNodes).forEach(x=>[...x.removedNodes].find(I=>I===f&&(E({element:f}),b.disconnect(),!0)))}).observe(f.parentNode,{childList:!0}),_=f=>new Proxy(function(p,...b){var z;let[x,...I]=Q(b),T=f?n.createElementNS(f,p):c(p);for(let[R,H]of Object.entries(x)){if(R.startsWith("bau"))continue;let L=N(p,R,ft(T))?X=>T[R]=X:X=>T.setAttribute(R,X);H==null||(he(H)?U({deps:[H],render:()=>()=>(L(H.val),T)}):gt(H)&&(!R.startsWith("on")||H.isDerived)?K({renderInferred:()=>(L(H({element:T})),T)}):H.renderProp?U({deps:H.deps,render:()=>()=>(L(H.renderProp({element:T})(...H.deps.map(Xe))),T)}):L(H))}return D(T,...I),(z=x.bauCreated)==null||z.call(x,{element:T}),x.bauMounted&&t.requestAnimationFrame(()=>x.bauMounted({element:T})),x.bauUnmounted&&t.requestAnimationFrame(()=>O(T,x.bauUnmounted)),T},{get:(E,p)=>E.bind(void 0,p)}),G=(f,E,p)=>{f.element=h(p);for(let b of E)he(b)&&(a.add(b),b.bindings.push(f));return f.element},K=({renderInferred:f,element:E})=>{let p=new Set,b=l(f,p,{element:E});return G({renderInferred:f},p,b)},U=({deps:f,element:E,render:p,renderItem:b})=>G({deps:f,render:p,renderItem:b},f,p({element:E,renderItem:b})(...f.map(Xe))),W=(f,E,p)=>U({deps:[f],render:({renderItem:b})=>x=>(E.append(...$e(x,b)),E),renderItem:p}),Z=f=>{s=!0,f(),s=!1,r.forEach(d),r.clear()};return{tags:_(),tagsNS:_,state:g,bind:U,loop:W,derive:C,stateSet:a,batch:Z}}const yn=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},En=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Cn=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function Sn(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...r)=>{const s=Cn(a,r),i=yn(s);return!t.getElementById(i)&&En(t,e==null?void 0:e.target,i,o(i,s)),i};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function kn(e){return{bau:wn(),...Sn(),tr:n=>n,window,...e}}function $(...e){return e.filter(t=>t).join(" ")}function ee(e,t){const{bau:n,css:o}=e,a={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
...
`))()}
 ...
 `});function Oe(e,t){const{bau:n,css:o,window:a}=e,{base:r=""}=t,s=({currentTree:U,data:W,onclickBack:Z})=>h(D({variant:"plain",href:`${r}${U.parentTree.children[0].data.href}`,onclick:Z({currentTree:U}),class:o`
          ...
          `,"data-buttonback":!0},"←"),D({variant:"plain",href:`${r}${W.href}`,class:o`
            flex-grow: 1;
          `},W.name)),i=({data:{name:U,href:W},children:Z=[]})=>D({href:`${r}${W}`,"data-ischild":Z.length==0},U),c=({subTree:U})=>{var W;return a.location.pathname.replace(r,"")===((W=U==null?void 0:U.data)==null?void 0:W.href)},{renderHeader:l=s,renderMenuItem:m=i,isActive:d=c}=t,{ul:u,li:v,nav:y,div:g,header:h,a:S}=n.tags,C=_t(),A=Ce(e),D=ee(e,{class:o`
      &.button {
...
https://github.com/highlightjs/highlight.js/issues/2277`),T=p,I=b),x===void 0&&(x=!0);const z={code:I,language:T};f("before:highlight",z);const R=z.result?z.result:d(z.language,z.code,x);return R.code=z.code,f("after:highlight",R),R}function d(p,b,x,I){const T=Object.create(null);function z(k,M){return k.keywords[M]}function R(){if(!j.keywords){V.addText(J);return}let k=0;j.keywordPatternRe.lastIndex=0;let M=j.keywordPatternRe.exec(J),F="";for(;M;){F+=J.substring(k,M.index);const Y=ae.case_insensitive?M[0].toLowerCase():M[0],ne=z(j,Y);if(ne){const[se,nn]=ne;if(V.addText(F),F="",T[Y]=(T[Y]||0)+1,T[Y]<=Io&&(Ie+=nn),se.startsWith("_"))F+=M[0];else{const on=ae.classNameAliases[se]||se;X(M[0],on)}}else F+=M[0];k=j.keywordPatternRe.lastIndex,M=j.keywordPatternRe.exec(J)}F+=J.substring(k),V.addText(F)}function H(){if(J==="")return;let k=null;if(typeof j.subLanguage=="string"){if(!t[j.subLanguage]){V.addText(J);return}k=d(j.subLanguage,J,!0,w[j.subLanguage]),w[j.subLanguage]=k._top}else k=v(J,j.subLanguage.length?j.subLanguage:null);j.relevance>0&&(Ie+=k.relevance),V.__addSublanguage(k._emitter,k.language)}function L(){j.subLanguage!=null?H():R(),J=""}function X(k,M){k!==""&&(V.startScope(M),V.addText(k),V.endScope())}function te(k,M){let F=1;const Y=M.length-1;for(;F<=Y;){if(!k._emit[F]){F++;continue}const ne=ae.classNameAliases[k[F]]||k[F],se=M[F];ne?X(se,ne):(J=se,R(),J=""),F++}}function re(k,M){return k.scope&&typeof k.scope=="string"&&V.openNode(ae.classNameAliases[k.scope]||k.scope),k.beginScope&&(k.beginScope._wrap?(X(J,ae.classNameAliases[k.beginScope._wrap]||k.beginScope._wrap),J=""):k.beginScope._multi&&(te(k.beginScope,M),J="")),j=Object.create(k,{parent:{value:j}}),j}function pe(k,M,F){let Y=Wn(k.endRe,F);if(Y){if(k["on:end"]){const ne=new xt(k);k["on:end"](M,ne),ne.isMatchIgnored&&(Y=!1)}if(Y){for(;k.endsParent&&k.parent;)k=k.parent;return k}}if(k.endsWithParent)return pe(k.parent,M,F)}function ze(k){return j.matcher.regexIndex===0?(J+=k[0],1):(We=!0,0)}function Me(k){const M=k[0],F=k.rule,Y=new xt(F),ne=[F.__beforeBegin,F["on:begin"]];for(const se of ne)if(se&&(se(k,Y),Y.isMatchIgnored))return ze(M);return F.skip?J+=M:(F.excludeBegin&&(J+=M),L(),!F.returnBegin&&!F.excludeBegin&&(J=M)),re(F,k),F.returnBegin?0:M.length}function bt(k){const M=k[0],F=b.substring(k.index),Y=pe(j,k,F);if(!Y)return kt;const ne=j;j.endScope&&j.endScope._wrap?(L(),X(M,j.endScope._wrap)):j.endScope&&j.endScope._multi?(L(),te(j.endScope,k)):ne.skip?J+=M:(ne.returnEnd||ne.excludeEnd||(J+=M),L(),ne.excludeEnd&&(J=M));do j.scope&&V.closeNode(),!j.skip&&!j.subLanguage&&(Ie+=j.relevance),j=j.parent;while(j!==Y.parent);return Y.starts&&re(Y.starts,k),ne.returnEnd?0:M.length}function Ge(){const k=[];for(let M=j;M!==ae;M=M.parent)M.scope&&k.unshift(M.scope);k.forEach(M=>V.openNode(M))}let me={};function De(k,M){const F=M&&M[0];if(J+=k,F==null)return L(),0;if(me.type==="begin"&&M.type==="end"&&me.index===M.index&&F===""){if(J+=b.slice(M.index,M.index+1),!a){const Y=new Error(`0 width match regex (${p})`);throw Y.languageName=p,Y.badRule=me.rule,Y}return 1}if(me=M,M.type==="begin")return Me(M);if(M.type==="illegal"&&!x){const Y=new Error('Illegal lexeme "'+F+'" for mode "'+(j.scope||"<unnamed>")+'"');throw Y.mode=j,Y}else if(M.type==="end"){const Y=bt(M);if(Y!==kt)return Y}if(M.type==="illegal"&&F==="")return 1;if(Fe>1e5&&Fe>M.index*3)throw new Error("potential infinite loop, way more iterations than matches");return J+=F,F.length}const ae=_(p);if(!ae)throw ue(r.replace("{}",p)),new Error('Unknown language: "'+p+'"');const Ue=Ao(ae);let ve="",j=I||Ue;const w={},V=new i.__emitter(i);Ge();let J="",Ie=0,le=0,Fe=0,We=!1;try{if(ae.__emitTokens)ae.__emitTokens(b,V);else{for(j.matcher.considerAll();;){Fe++,We?We=!1:j.matcher.considerAll(),j.matcher.lastIndex=le;const k=j.matcher.exec(b);if(!k)break;const M=b.substring(le,k.index),F=De(M,k);le=k.index+F}De(b.substring(le))}return V.finalize(),ve=V.toHTML(),{language:p,value:ve,relevance:Ie,illegal:!1,_emitter:V,_top:j}}catch(k){if(k.message&&k.message.includes("Illegal"))return{language:p,value:Ze(b),illegal:!0,relevance:0,_illegalBy:{message:k.message,index:le,context:b.slice(le-100,le+100),mode:k.mode,resultSoFar:ve},_emitter:V};if(a)return{language:p,value:Ze(b),illegal:!1,relevance:0,errorRaised:k,_emitter:V,_top:j};throw k}}function u(p){const b={value:Ze(p),illegal:!1,relevance:0,_top:s,_emitter:new i.__emitter(i)};return b._emitter.addText(p),b}function v(p,b){b=b||i.languages||Object.keys(t);const x=u(p),I=b.filter(_).filter(K).map(L=>d(L,p,!1));I.unshift(x);const T=I.sort((L,X)=>{if(L.relevance!==X.relevance)return X.relevance-L.relevance;if(L.language&&X.language){if(_(L.language).supersetOf===X.language)return 1;if(_(X.language).supersetOf===L.language)return-1}return 0}),[z,R]=T,H=z;return H.secondBest=R,H}function y(p,b,x){const I=b&&n[b]||x;p.classList.add("hljs"),p.classList.add(`language-${I}`)}function g(p){let b=null;const x=l(p);if(c(x))return;if(f("before:highlightElement",{el:p,language:x}),p.children.length>0&&(i.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(p)),i.throwUnescapedHTML))throw new Do("One of your code blocks includes unescaped HTML.",p.innerHTML);b=p;const I=b.textContent,T=x?m(I,{language:x,ignoreIllegals:!0}):v(I);p.innerHTML=T.value,y(p,x,T.language),p.result={language:T.language,re:T.relevance,relevance:T.relevance},T.secondBest&&(p.secondBest={language:T.secondBest.language,relevance:T.secondBest.relevance}),f("after:highlightElement",{el:p,result:T,text:I})}function h(p){i=St(i,p)}const S=()=>{D(),be("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function C(){D(),be("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let A=!1;function D(){if(document.readyState==="loading"){A=!0;return}document.querySelectorAll(i.cssSelector).forEach(g)}function B(){A&&D()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",B,!1);function P(p,b){let x=null;try{x=b(e)}catch(I){if(ue("Language definition for '{}' could not be registered.".replace("{}",p)),a)ue(I);else throw I;x=s}x.name||(x.name=p),t[p]=x,x.rawDefinition=b.bind(null,e),x.aliases&&G(x.aliases,{languageName:p})}function N(p){delete t[p];for(const b of Object.keys(n))n[b]===p&&delete n[b]}function O(){return Object.keys(t)}function _(p){return p=(p||"").toLowerCase(),t[p]||t[n[p]]}function G(p,{languageName:b}){typeof p=="string"&&(p=[p]),p.forEach(x=>{n[x.toLowerCase()]=b})}function K(p){const b=_(p);return b&&!b.disableAutodetect}function U(p){p["before:highlightBlock"]&&!p["before:highlightElement"]&&(p["before:highlightElement"]=b=>{p["before:highlightBlock"](Object.assign({block:b.el},b))}),p["after:highlightBlock"]&&!p["after:highlightElement"]&&(p["after:highlightElement"]=b=>{p["after:highlightBlock"](Object.assign({block:b.el},b))})}function W(p){U(p),o.push(p)}function Z(p){const b=o.indexOf(p);b!==-1&&o.splice(b,1)}function f(p,b){const x=p;o.forEach(function(I){I[x]&&I[x](b)})}function E(p){return be("10.7.0","highlightBlock will be removed entirely in v12.0"),be("10.7.0","Please use highlightElement now."),g(p)}Object.assign(e,{highlight:m,highlightAuto:v,highlightAll:D,highlightElement:g,highlightBlock:E,configure:h,initHighlighting:S,initHighlightingOnLoad:C,registerLanguage:P,unregisterLanguage:N,listLanguages:O,getLanguage:_,registerAliases:G,autoDetection:K,inherit:St,addPlugin:W,removePlugin:Z}),e.debugMode=function(){a=!1},e.safeMode=function(){a=!0},e.versionString=Mo,e.regex={concat:de,lookahead:jt,either:qe,optional:Un,anyNumberOfTimes:Gn};for(const p in Ne)typeof Ne[p]=="object"&&Pt(Ne[p]);return Object.assign(e,Ne),e},ge=Zt({});ge.newInstance=()=>Zt({});var $o=ge;ge.HighlightJS=ge;ge.default=ge;const At=Pn($o),Tt="[A-Za-z$_][0-9A-Za-z$_]*",No=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],_o=["true","false","null","undefined","NaN","Infinity"],Kt=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Yt=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],qt=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],Bo=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],Oo=[].concat(qt,Kt,Yt);function Ro(e){const t=e.regex,n=(b,{after:x})=>{const I="</"+b[0].slice(1);return b.input.indexOf(I,x)!==-1},o=Tt,a={begin:"<>",end:"</>"},r=/<[A-Za-z0-9\\._:-]+\s*\/>/,s={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(b,x)=>{const I=b[0].length+b.index,T=b.input[I];if(T==="<"||T===","){x.ignoreMatch();return}T===">"&&(n(b,{after:I})||x.ignoreMatch());let z;const R=b.input.substring(I);if(z=R.match(/^\s*=/)){x.ignoreMatch();return}if((z=R.match(/^\s+extends\s+/))&&z.index===0){x.ignoreMatch();return}}},i={$pattern:Tt,keyword:No,literal:_o,built_in:Oo,"variable.language":Bo},c="[0-9](_?[0-9])*",l=`\\.(${c})`,m="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",d={className:"number",variants:[{begin:`(\\b(${m})((${l})|\\.)?|(${l}))[eE][+-]?(${c})\\b`},{begin:`\\b(${m})\\b((${l})\\b|\\.)?|(${l})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},u={className:"subst",begin:"\\$\\{",end:"\\}",keywords:i,contains:[]},v={begin:"html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,u],subLanguage:"xml"}},y={begin:"css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,u],subLanguage:"css"}},g={begin:"gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,u],subLanguage:"graphql"}},h={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,u]},C={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:o+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},A=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,v,y,g,h,{match:/\$\d+/},d];u.contains=A.concat({begin:/\{/,end:/\}/,keywords:i,contains:["self"].concat(A)});const D=[].concat(C,u.contains),B=D.concat([{begin:/\(/,end:/\)/,keywords:i,contains:["self"].concat(D)}]),P={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:i,contains:B},N={variants:[{match:[/class/,/\s+/,o,/\s+/,/extends/,/\s+/,t.concat(o,"(",t.concat(/\./,o),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,o],scope:{1:"keyword",3:"title.class"}}]},O={relevance:0,match:t.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Kt,...Yt]}},_={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},G={variants:[{match:[/function/,/\s+/,o,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[P],illegal:/%/},K={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function U(b){return t.concat("(?!",b.join("|"),")")}const W={match:t.concat(/\b/,U([...qt,"super","import"]),o,t.lookahead(/\(/)),className:"title.function",relevance:0},Z={begin:t.concat(/\./,t.lookahead(t.concat(o,/(?![0-9A-Za-z$_(])/))),end:o,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},f={match:[/get|set/,/\s+/,o,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},P]},E="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",p={match:[/const|var|let/,/\s+/,o,/\s*/,/=\s*/,/(async\s*)?/,t.lookahead(E)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[P]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:i,exports:{PARAMS_CONTAINS:B,CLASS_REFERENCE:O},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),_,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,v,y,g,h,C,{match:/\$\d+/},d,O,{className:"attr",begin:o+t.lookahead(":"),relevance:0},p,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[C,e.REGEXP_MODE,{className:"function",begin:E,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:i,contains:B}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:a.begin,end:a.end},{match:r},{begin:s.begin,"on:begin":s.isTrulyOpeningTag,end:s.end}],subLanguage:"xml",contains:[{begin:s.begin,end:s.end,skip:!0,contains:["self"]}]}]},G,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[P,e.inherit(e.TITLE_MODE,{begin:o,className:"title.function"})]},{match:/\.\.\./,relevance:0},Z,{match:"\\$"+o,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[P]},W,K,N,f,{match:/\$[(.]/}]}}const Jt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:r,tr:s,td:i,thead:c,th:l}=t.tags,m=["sm","md","lg"];return function({Item:u,name:v}){return o({class:n`
        ...
        `},a(c(s(l(v??"Variant/Color"),oe.map(y=>l(y)))),r(An.map(y=>s(l(y),oe.map((g,h)=>i(u({color:g,variant:y,size:m[h%3]},{index:h}))))))))}},q=e=>{const{bau:t,css:n}=e,{article:o,section:a,h1:r,p:s,h2:i,h3:c,pre:l,div:m,code:d}=t.tags;At.registerLanguage("javascript",Ro);const u=Jt(e),v=({text:y})=>l({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:g})=>{g.innerHTML=At.highlight(y,{language:"js"}).value}}));return function(g){return o({class:n``},r(g.title),s(g.description),g.gridItem&&[i("Gallery"),g.gridItem&&u({Item:g.gridItem(e)})],i("Usage"),c("Import"),v({text:g.importStatement}),i("Examples"),g.examples.map(h=>a(r(h.title),s(h.description),m(h.createComponent(e)()),v({text:h.code}))))}},Po=()=>oe.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`);function Se(e,t){const{bau:n,css:o}=e,{accordionDefs:a}=t,{div:r,ul:s,li:i,header:c,h3:l,button:m}=n.tags,d=n.state(""),u=g=>h=>{d.val==g?d.val="":d.val=g},v=({element:g,open:h})=>{const S=()=>{g.removeEventListener("transitionend",S)};function C(D){D.addEventListener("transitionend",S),window.requestAnimationFrame(()=>{D.style.height="0px"})}function A(D){D.addEventListener("transitionend",S),D.style.height=D.scrollHeight+"px"}g.scrollHeight!=0&&(h?A(g):C(g))},y=o`
    ...
    ${Po()}
  `;return function(...h){let[{color:S,variant:C="outline",size:A="md",content:D,...B},...P]=Q(h);const N=O=>{const{Header:_,Content:G,name:K}=O;return i({class:$(S,C,A),onclick:u(K)},l({class:()=>$(d.val==K&&"active")},m({type:"button","aria-controls":`bau-${K}`,"aria-expanded":({element:U})=>d.val==K},_(O))),r({class:"content",role:"region",id:`bau-${K}`,"data-state":({element:U})=>{const W=d.val==K;return v({element:U,open:W}),W}},G(O)))};return r({class:$("accordion",y,t==null?void 0:t.class,B.class)},s(a.map(N)))}}const Lo=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,r=Se(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]});return s=>r({...s})},jo=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,r=Se(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]});return()=>r({color:"neutral",variant:"outline"})},Ho=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,Qt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},zo=e=>{const{css:t}=e,n=Qt(e),o=Se(e,{accordionDefs:n});return()=>o({color:"warning",class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,Wo={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:Ho,createComponent:jo},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Go,createComponent:zo},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Fo,createComponent:Uo}],gridItem:Lo},Vo=e=>{const t=q(e);return()=>t(Wo)},Xo={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Zo=({css:e,createGlobalStyles:t})=>{t`
:root {
...
`,Qo=e=>{const{css:t}=e,n=ke(e,{class:t`
      &.alert {
...
`,sa={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:ra,createComponent:aa}]},ia=e=>{const t=q(e);return()=>t(sa)},ca=({keyframes:e})=>({hideRight:e`
 ...
 `}),la=e=>{const{bau:t}=e,{section:n,div:o,h1:a}=t.tags,r=_t(),s=ee(e),i=ca(e);return function(){const c=t.state(!0),l=o(),m=d=>{l.replaceChildren(r({parent:l,animationHide:`${i.hideRight} 0.5s`,animationShow:`${i.showRight} 0.5s`},o(d.val?"Ciao":"")))};return m(c),n({id:"animate"},o(a("Test Animate"),o(s({onclick:()=>{c.val=!c.val,m(c)}},()=>c.val?"Hide":"Show")),l))}};function et(e,t){const{bau:n,css:o}=e,{span:a,img:r}=n.tags,s=n.state(!0),i=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,i.val=!0},m=o`
  ...
  `;return function(...u){let[{color:v,variant:y="outline",size:g="md",width:h=30,height:S=30,...C},...A]=Q(u);return a({class:$(m,t==null?void 0:t.class,C.class)},()=>s.val?"Loading...":"",()=>i.val&&"Error",r({width:h,height:S,onload:c,onerror:l,class:$(v,y,g,m,t==null?void 0:t.class,C.class),...C}))}}const ua=e=>{const{css:t}=e,n=et(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function nt(e,t){const{bau:n,css:o}=e,{div:a,li:r,ul:s}=n.tags,i=tt(e),c=ee(e),l=Pe(e),m=Ce(e),d=o`
    ...
    ${ga()}
  `,u=n.state(""),v=n.state(""),y=n.state(!1),g=n.state(0),h=()=>{y.val=!1};return function(...C){let[{variant:A="outline",color:D,size:B="md",id:P,label:N,placeholder:O,Option:_,options:G,getOptionLabel:K=({label:L})=>L,...U},...W]=Q(C);const Z=n.state(G),f=()=>{H.openDialog(),y.val=!0,v.val="",Z.val=G},E=()=>{H.closeDialog(),y.val=!1,v.val=""},p=L=>{const{value:X}=L.target;v.val=X,X?Z.val=G.filter(te=>K(te).match(new RegExp(`${X}`,"i"))):Z.val=G},b=L=>{y.val?E():f()},x=({option:L,index:X})=>te=>{u.val=K(L),g.val=X,E()},I=L=>{switch(console.log("onkeydown",L.key,g.val),L.key){case"Escape":E();break;case"ArrowDown":g.val<Z.val.length-1?g.val++:g.val=0;break;case"ArrowUp":g.val<=0?g.val=Z.val.length-1:g.val--;break;case"Enter":u.val=K(Z.val[g.val]),v.val="",E();break}},T=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":y,"aria-label":N,onclick:b,variant:A,color:D,size:B},()=>!u.val&&N,u),z=l({id:P,value:v,placeholder:O,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":y,oninput:p,onkeydown:I,variant:A,color:D,size:B}),H=i({id:P,triggerEl:T,contentEl:(()=>a({class:$(A,D,B,"content")},z,()=>m({class:$(A,D,B)},Z.val.map((L,X)=>r({class:()=>$(g.val==X&&"active"),onclick:x({option:L,index:X})},_(L))))))(),onClose:h});return a({...U,class:$("autocomplete",d,t==null?void 0:t.class,U==null?void 0:U.class)},T,H)}}const fa=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,r=nt(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],i=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,ka={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Sa,createComponent:Ca}],gridItem:Ea},Aa=e=>{const t=q(e);return()=>t(ka)};function at(e,t){const{bau:n,css:o}=e,{ul:a,li:r,a:s,span:i}=n.tags,c=ee(e),l=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...d){let[{color:u,variant:v="outline",size:y="md",items:g,...h},...S]=Q(d);return a({...h,class:$(l,t==null?void 0:t.class,h==null?void 0:h.class)},g.map(({href:C,name:A})=>r((C?c:i)({href:C,color:u,variant:v,size:y,class:$(u,v,y)},A))))}}const Ta=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=at(e);return o=>n({...o,...t})},Ma=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=at(e);return()=>n(a(o))},Da=`import breadcrumbs, {
...
`,Va={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Wa,createComponent:Fa}],gridItem:Ua},Xa=e=>{const t=q(e);return()=>t(Va)};function st(e,t){const{bau:n,css:o}=e,{span:a}=n.tags,r=o`
    display: inline-block;
    border-radius: var(--global-radius);
...
`,pr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:dr,createComponent:ur}],gridItem:lr},mr=e=>{const t=q(e);return()=>t(pr)};function ct(e,t){const{bau:n,css:o}=e,{div:a,span:r,label:s,input:i}=n.tags,c={base:o`
    ...
    `};return function(m,...d){const{variant:u="outline",color:v="neutral",size:y="md",Component:g,disabled:h,...S}=m;return a({class:$(c.base,h&&c.disabled,t==null?void 0:t.class,m.class)},s({class:$(u,v,y)},g({disabled:h}),i({type:"file",disabled:h,...S})),r({class:"filename-display"}))}}const br=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:r,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:i,span:c}=n.tags,l=n.state("No file selected"),m=ct(e),d=v=>{const y=v.target.files[0];y?l.val=y.name:l.val="No file selected"},u=({disabled:v})=>i({class:$(o`
          ...
          `,v&&o`
            ...
            `)},r({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return v=>m({Component:u,name:"file",accept:"text/*",onchange:d,...v})},hr=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:r,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:i,div:c,span:l}=n.tags,m=n.state("No file selected"),d=ct(e),u=y=>{const g=y.target.files[0];g?m.val=g.name:m.val="No file selected"},v=({disabled:y})=>c({class:$(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`);function ut(e,t){const{bau:n,css:o}=e,{div:a,li:r}=n.tags,s=ee(e),i=tt(e),c=Ce(e),l=o`
    ...
    ${_r()}
  `,m=n.state(""),d=n.state(!1),u=n.state(0);return function(...y){let[{color:g="neutral",variant:h="outline",size:S="md",id:C,label:A,Option:D,options:B,getOptionLabel:P=({label:b})=>b,...N},...O]=Q(y);const _=()=>{p.openDialog(),p.focus(),d.val=!0},G=()=>{p.closeDialog(),d.val=!1},K=()=>{d.val=!1},U=b=>{d.val?G():_()},W=({option:b,index:x})=>I=>{m.val=P(b),u.val=x,G()},Z=b=>{switch(b.preventDefault(),b.key){case"Escape":G();break;case"ArrowDown":u.val<B.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=B.length-1:u.val--;break;case"Enter":d.val?(m.val=P(B[u.val]),G()):_();break}},f=()=>c({tabindex:"0",class:$(g,h)},B.map((b,x)=>r({class:()=>$(u.val==x&&"active"),onclick:W({option:b,index:x})},D(b)))),E=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":d,"aria-label":A,onclick:U,color:g,variant:h,size:S},()=>!m.val&&A,m),p=i({id:C,triggerEl:E,contentEl:f(),onClose:K});return a({...N,class:$("select",g,S,l,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:Z},E,p)}}const Br=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,r=ut(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],i=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Pr={title:"Modal",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Default",description:"A simple select.",code:Rr,createComponent:Or}],gridItem:Br},Lr=e=>{const t=q(e);return()=>t(Pr)};function Ae(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    ${(()=>oe.map(i=>`
&.slider.${i} {
  accent-color: var(--color-${i});
}
...
`,Gr=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:r,datalist:s,br:i,option:c}=t.tags,l=t.state(0),m=u=>{l.val=u==null?void 0:u.target.value},d=Ae(e);return()=>o(a(r({for:"temp"},"Choose a comfortable temperature"),i,d({oninput:m,class:n`
            width: 300px;
            margin: 0;
...
`,Fr=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:r,datalist:s,br:i,option:c}=t.tags,l=t.state(0),m=u=>{l.val=u==null?void 0:u.target.value},d=Ae(e);return()=>o(a({class:n`
            display: flex;
...
`,en=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]},ds=e=>{const{css:t}=e,n=fe(e,{tabDefs:en(e)});return()=>n({variant:"outline",color:"neutral",class:t`
...
`,ms=e=>{const{css:t}=e,n=en(e),o=fe(e,{tabDefs:n});return()=>o({variant:"outline",color:"neutral",class:t`
        & ul {
          justify-content: center;
        }
...
`,ks={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:vs,createComponent:fs},{title:"Dense",description:"A dense table.",code:ys,createComponent:ws},{title:"Zebra",description:"A zebra table.",code:Ss,createComponent:Cs}]},As=e=>{const t=q(e);return()=>t(ks)};function tn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,r=Le(e),s=ee(e),i=je(e),c=o`
  ...
  `,l=({label:y,icon:g,...h})=>s({"aria-label":y,title:y,...h},g),m=({count:y,totalCount:g,page:h,rowsPerPage:S})=>a({class:"pages-numbers"},Number(h-1)*Number(S)+(y>0?1:0),"-",Math.min(h*S,g)," of ",g),d=({count:y,page:g,rowsPerPage:h})=>a({class:"pages-numbers"},(g-1)*h+(y>0?1:0),"-",g*h),u=y=>y<=1,v=(y,g,h)=>y>=Math.ceil(g/h);return function(...g){let[{count:h=0,totalCount:S=0,page:C=1,rowsPerPage:A=50,onPageChange:D,isLoading:B=!1,disableFirst:P=()=>u(C),disablePrevious:N=()=>u(C),disableNext:O=()=>v(C,S,A),disableLast:_=()=>v(C,S,A),...G},...K]=Q(g);const U=Math.max(0,Math.ceil(S/A)),W=D({page:1}),Z=D({page:C-1}),f=D({page:C+1}),E=D({page:U}),p=[{label:"First",icon:"⟪",onclick:W,disabled:P()},{label:"Previous",icon:"⟨",onclick:Z,disabled:N()},{label:"Next",icon:"⟩",onclick:f,disabled:O()},{label:"Last",icon:"⟫",onclick:E,disabled:_()}];return a({...G,class:$("table-pagination",c,B&&"disabled",t==null?void 0:t.class,G==null?void 0:G.class)},i({class:"spinner",visibility:B,size:"md"}),S>0?m({count:h,totalCount:S,page:C,maxPages:U,rowsPerPage:A}):d({count:h,page:C,maxPages:U,rowsPerPage:A}),r({variant:"outline",color:"neutral"},p.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const Ts=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Ms=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:r,table:s,thead:i,tbody:c}=t.tags,l=Ts(45),m=({name:C,email:A})=>r(a(C),a(A)),d=()=>i(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),u=tn(e),v=Te(e,{class:n`
      max-width: 650px;
    `}),y=t.state(l),g=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=t.derive(()=>y.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),S=({page:C})=>A=>{g.val.page=C};return()=>v(s(d(),()=>c(h.val.map(m))),()=>u({...g.val,onPageChange:S}))},Ds=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:r,table:s,thead:i,tbody:c,div:l}=t.tags,m=t.state(!1),d=t.state([]),u=t.state(""),v=t.derive(()=>d.val.length),y=t.state(1),g=t.state(10),h=t.derive(()=>d.val),S=_=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(_).toString()}`,C=({page:_})=>G=>{y.val=_,A(S({page:_,per_page:g.val}))};A(S({page:1,per_page:g.val}));async function A(_){try{m.val=!0;const G=await fetch(_,{});if(G.ok){const K=await G.json();d.val=K;return}throw G}catch(G){u.val=G.message}finally{m.val=!1}}const D=({name:_,description:G,stargazers_count:K})=>r(a(_),a(G),a({class:n`
            text-align: right;
          `},K)),B=()=>i(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
  ...
  `;return function(...c){let[{titleEl:l,side:m="bottom-start",color:d="neutral",variant:u="outline",size:v="md",...y},...g]=Q(c);const h=r({class:$("container",...m.split("-"))},r({class:$("content",d,u,v),role:"tooltip"},l)),S=N=>`move-to-${N}`,C=(N,O,_)=>{if(N()){const G=S(O);h.classList.add(G),h.classList.add(O),h.classList.remove(_)}},A=(N,O)=>{const _=S(N);h.classList.contains(_)&&(h.classList.remove(_),h.classList.add(O),h.classList.remove(N))},D=N=>{const O=h.getBoundingClientRect();C(()=>O.x<0,"right","left"),C(()=>O.x+O.width>a.innerWidth,"left","right"),C(()=>O.y<0,"bottom","top"),C(()=>O.bottom>a.innerHeight,"top","bottom"),h.classList.add("visible")},B=N=>{h.classList.remove("visible"),A("right","left"),A("left","right"),A("bottom","top"),A("top","bottom")};return r({...y,class:$("tooltip",s,t==null?void 0:t.class,y==null?void 0:y.class),bauMounted:({element:N})=>{N.addEventListener("mouseover",D),N.addEventListener("mouseout",B)},bauUnmounted:({element:N})=>{N.removeEventListener("mouseover",D),N.removeEventListener("mouseout",B)}},...g,h)}}const $s=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:r}=t.tags,s=ee(e),i=He(e),c=()=>o({class:n`
          font-size: larger;
        `},a("A ",r("tooltip")," can be any component"));return l=>i({titleEl:c(),...l},s(l,`${l.color} ${l.variant}`))},Ns=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,r=ee(e),s=He(e),i=()=>n(o("A ",a("tooltip")," can be any component"));return()=>s({side:"bottom-start",titleEl:i()},r("tooltip"))},_s=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Bs=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:r}=t.tags,s=ee(e),i=He(e),c=()=>o(a("A ",r("tooltip")," can be any component")),l=()=>[o({class:n`
          display: flex;
          justify-content: space-around;
...
`,oi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:ni,createComponent:ti}],gridItem:Qs},ai=e=>{const t=q(e);return()=>t(oi)},ri=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:r,h1:s,span:i,p:c,ul:l,li:m,a:d,main:u,header:v,footer:y,label:g}=t.tags,{svg:h,use:S}=t.tagsNS("http://www.w3.org/2000/svg"),C=Jt(e),D=Se(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>r(c("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>r(c("Item 2 Content"))},{name:"Item3",Header:()=>"Item 3",Content:()=>r(c("Item 3 content"))}]}),B=ke(e),P=nt(e),N=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],O=w=>r({class:n`
    ...
    `}),G=ot(e),K={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},U=at(e),W=ee(e),Z=Le(e),f=rt(e),E=it(e),p=st(e),b={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#m1"},children:[{data:{name:"Sub Menu 1",href:"#menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu2"}}]},x=Oe(e,{base:o.base+"/components"}),I=({disabled:w})=>r({class:$(n`
          ...
          `,w&&n`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},h({width:100,height:100,fill:"currentColor"},S({href:"uploadIcon.svg#Capa_1"})),i("Choose a file to upload")),T=ct(e),z=Pe(e),R=lt(e),H=()=>u(Array(10).fill("").map((w,V)=>c(V+1,". Some text here"))),L=w=>{const V=R({id:"my-dialog",...w},v("Header"),H(),y(W({...w,variant:"outline",onclick:()=>{V.close()}},"Cancel"),W({...w,variant:"solid",onclick:()=>{V.close()}},"OK")));return V},X=ut(e),te=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],re=w=>r({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(w.label),i(w.code)),pe=Ae(e),ze=je(e),Me=dt(e),Ge=fe(e,{tabDefs:[{name:"Tab1",Header:()=>r("TAB"),Content:()=>r(c("My Tab 1 Content"))},{name:"Tab2",Header:()=>r("TAB 2"),Content:()=>r(c("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>r("Tab Disabled"),Content:()=>r(c("My tab Disabled"))}]}),me=Be(e),De=()=>i("My tooltip"),ae=He(e),Ue={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},ve=pt(e,{renderMenuItem:({name:w,href:V})=>d({href:V,onclick:J=>{J.preventDefault()}},w)}),j=[{name:"Accordion",Item:w=>D({...w})},{name:"Alert",Item:w=>B({...w},`Alert ${w.color}`)},{name:"Autocomplete",Item:w=>P({...w,options:N,Option:O,getOptionLabel:({label:V})=>V,label:"Country",placeholder:"Search countries",id:"country"})},{name:"Avatar",Item:w=>_({...w,src:"./grucloud.svg",alt:"GruCloud"})},{name:"Badge",Item:(w,{index:V})=>G({...w,content:`${V*100}`},"☏")},{name:"Breadcrumbs",Item:w=>U({...w,...K})},{name:"Button",Item:w=>W({...w},`${w.variant} ${w.color}`)},{name:"Button Group",Item:w=>Z({...w},["ONE","TWO","THREE"].map(V=>W(w,V)))},{name:"Calendar",Item:w=>r({class:n`
              border: 1px dotted var(--color-emphasis-200);
              font-size: smaller;
              color: var(--color-content-secondary);
              padding: 0.2rem;
