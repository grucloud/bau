    ...
    `}),C=ie(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),T=()=>l({class:o`
        ...
        `},u({class:n`
          ...
          `},m({title:"Bau UI",links:b}),m({title:"Bau Ecosystem",links:p})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},r("v0.94.0"),r("MIT license")))}}function xt(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `,d=(m="")=>`${u} ease-in-out 0.5s ${m}`;return function({componentState:b}){return r({class:n`
        ...
        `},s(),c(),i({class:n`
            ...
            margin: 0 1rem;
            display: grid;
          `,animationHide:()=>d(),animationShow:()=>d("reverse")},()=>b.val),l())}};function Pt(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
    display: inline-flex;
    align-items: center;
    flex-grow: 0;
    box-sizing: border-box;
  ...
  `,s=({title:c,Content:l})=>o({className:"feature"},a(c),r(l()));return function({featuresContent:l}){return o({class:i},l.map(s))}}function jo({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:r,dd:i,div:s,aside:c,footer:l,a:u}=e.tags,d=({maxSize:m=151})=>({libName:b,size:p})=>s({class:n`
        ...
        `},c({class:n`
          ...
          `},b.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function _o(t){const{bau:e,css:n,config:o}=t,{div:a,p:r,a:i,section:s}=e.tags,c=zo(t),l=Ro(t),u=O(t);Pt(t);const d=jo(t),m=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `,b=({value:f,id:y,children:h=[]})=>{const C=c({class:()=>u.val==y?"active":"",href:`#${y}`});return C.innerHTML=f,s({class:()=>u.val==y?"active":""},C,h.length>0&&i(h.map(b)))},p=f=>f.tagName.charAt(1),g=({contentEl:f})=>{const y=f.querySelectorAll(l);let h=2,C={},S={children:[]},T=S;const D=T;let A=[T];return[...y].forEach(N=>{const B=p(N);N.setAttribute("id",N.textContent),!N.innerHTML.includes("<button")&&(C={value:N.innerHTML,id:N.id??N.textContent,children:[]},h==B?(S=C,T.children.push(S)):h<B?(A.push(T),T=S,S.children.push(C),S=C):h>B&&(T=A[B-1],A=A.slice(0,B-1),T.children.push(C),S=C),h=B)}),D};return function(...y){let[{size:h=e.size??"md",variant:C=e.variant??"plain",color:S=e.color??"neutral",contentEl:T,...D}]=V(y);const A=g({contentEl:T}),N=d(()=>{const $=[...T.querySelectorAll(l)].find(z=>{const{top:G,height:H}=z.getBoundingClientRect();if(G+H>60)return!0});$&&(u.val=$==null?void 0:$.id)},100);return r({...D,class:["tableOfContent",h,C,S,m,e==null?void 0:e.class,D==null?void 0:D.class],bauMounted:()=>{a.addEventListener("scroll",N)},bauUnmounted:()=>{a.removeEventListener("scroll",N)}},A.children&&i(A.children.map(b)))}}const ln=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:c,th:l}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(c(i(l(m??""),nt.map(b=>l(b)))),r(Ao.map(b=>i(l(b),nt.map((p,g)=>s(d({color:p,variant:b},{index:g}))))))))}},Va=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Do.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:c,h3:l,pre:u,code:d}=e.tags;Mt.registerLanguage("javascript",sn);const m=cn(t),b=be(t,{class:n`
      &.paper {
...
&.alert {
  ...
  `).join(`
`);function At(t,e={}){const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=o`
    display: inline-flex;
    max-width: 600px;
    justify-content: flex-start;
    align-items: center;
...
`,hs={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:gs,createComponent:bs}]},fs=t=>{const e=F(t);return()=>e(hs)},wn=(t,e)=>{const n=Pt(t,e);return o=>n({...o},`Chip ${o.color} ${o.variant} ${o.size??""}`)},vs=t=>{const{bau:e}=t,{section:n}=e.tags,o=Pt(t,{variant:"outline",color:"primary"});return()=>n(o("My Chip"))},ys=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,xs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:ys,createComponent:vs}],gridItem:wn},ws=t=>{const e=F(t);return()=>e(xs)};function St(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},m]=V(s);return a({type:"checkbox",...d,class:[r,u,l,c,e==null?void 0:e.class,d==null?void 0:d.class]})}}const Sn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,r=St(t,e);return i=>a({class:o`
        ...
        `},`${i.color} ${i.variant} ${i.size??""}`,r({id:`myCheckbox-gallery-${i.color}-${i.variant}-${i.size}`,name:`myCheckbox-gallery-${i.color}-${i.variant}`,...i}))},Ss=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,label:i}=e.tags,s=St(t,{color:"neutral",variant:"outline"}),c=O(t,{variant:"outline",color:"primary"});return()=>{const l=e.state(!1),u=m=>l.val=m.target.checked;return o({onsubmit:m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(b))}},a(i({class:n`
              ...
              color: var(--color-content-secondary);
              gap: 1rem;
            `},"My Checkbox",s({name:"myCheckbox",checked:l,onchange:u}))),r(c({type:"submit"},"Submit")))}},Cs=`import { Context } from "@grucloud/bau-ui/context";
...
`,Es=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:r,form:i}=e.tags,s=St(t,{color:"neutral",variant:"outline"}),c=O(t,{variant:"outline",color:"primary"});return()=>i({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & article {
        ...
        `},r(o("My Checkbox",s({name:"my-checkbox-uncontrolled"})),o("My Checkbox with default",s({name:"my-checkbox-uncontrolled-default",defaultChecked:"on"}))),a(c({type:"submit"},"Submit")))},ks=`import checkbox from "@grucloud/bau-ui/checkbox";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Ts=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:r,form:i}=e.tags,s=St(t,{color:"neutral",variant:"outline"}),c=O(t,{variant:"outline",color:"primary"}),l=O(t,{variant:"solid",color:"primary"});return()=>{const u=m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(b))},d=m=>{const b=window.document.getElementById("my-checkbox");b&&(b.indeterminate=!b.indeterminate)};return i({onsubmit:u,class:n`
        ...
        `},r(o("My Checkbox",s({id:"my-checkbox",name:"my-checkbox"})),c({onclick:d},"Toggle Indeterminate")),a(l({type:"submit"},"Submit")))}},As=`import checkbox from "@grucloud/bau-ui/checkbox";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,$s={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Is,createComponent:Ms}]},Ls=t=>{const e=F(t);return()=>e($s)};function Ps(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},m]=V(s);return a({...d,class:["divider",c,r,e==null?void 0:e.class,d==null?void 0:d.class]},a({class:"content"},m))}}const zs=t=>{const{bau:e}=t,{section:n}=e.tags,o=Ps(t);return()=>n(o("OR"))},Rs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,js={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Rs,createComponent:zs}],variantColorTableDisable:!0,variantSizeDisable:!0},_s=t=>{const e=F(t);return()=>e(js)};function Us(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:c,variant:l="outline",size:u,openState:d,...m},b]=V(s);return a({class:[r,e==null?void 0:e.class,m.class]},a({class:()=>["overlay",d.val&&"overlay-open"],onclick:()=>{d.val=!1}}),a({class:()=>["content",d.val&&"content-open"]},b))}}const Gs=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=Us(t),r=O(t,{color:"neutral",variant:"outline"}),i=He(t);return()=>{const s=e.state(!1);return n(o("Click on the button to open and close the drawer."),r({onclick:()=>{s.val=!s.val}},"OPEN DRAWER"),a({openState:s},i()))}},Fs=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Hs={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:Fs,createComponent:Gs}]},Vs=t=>{const e=F(t);return()=>e(Hs)},Js=()=>nt.map(t=>`
`).join(`
`);function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=O(t),s=zt(t),c=xt(t),l=o`
    ${Js()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"outline",color:p=e.color??"neutral",label:g,ListItem:f,items:y,...h},C]=V(d);const S=n.state(0),T=()=>{H.openDialog(),H.focus()},D=()=>{H.closeDialog()},A=()=>{H.open?D():T()},N=j=>{A(),j.preventDefault()},B=({item:j,index:w})=>k=>{S.val=w,D(),k.preventDefault()},$=j=>{switch(j.preventDefault(),j.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},z=()=>c({tabindex:"0",class:[p,b]},y.map((j,w)=>r({class:()=>[S.val==w&&"active"],onclick:B({item:j,index:w})},f(j)))),G=i({type:"button",onclick:N,color:p,variant:b,size:m},g),H=s({triggerEl:G,contentEl:z()});return a({...h,class:["dropdownMenu",p,m,l,e==null?void 0:e.class,h==null?void 0:h.class],onkeydown:$},G,H)}}const qs=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=Cn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=c=>o(a(c.label));return c=>r({...c,items:i,ListItem:s,label:"Action"})},Ws=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=Cn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Ks=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,ci=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:r,footer:i}=e.tags,s=gt(t),c=O(t,{variant:"solid",color:"primary"}),l=dt(t);return function({onSubmitted:d=()=>{}}){return s({onsubmit:async b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p)),d(p)}},a(o("Form with input")),n(r("Branch",l({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(c({type:"submit"},"Click")))}},li=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`,hi=t=>{const{bau:e}=t,{article:n,footer:o,label:a}=e.tags,r=dt(t),i=gt(t),s=O(t,{variant:"solid",color:"primary"});return()=>{const c=e.state(""),l=e.derive(()=>c.val=="");return i({onsubmit:m=>{m.preventDefault(),alert(c.val)}},n(a("Input",r({name:"my-input",placeholder:"Enter Text",value:c,oninput:m=>c.val=m.target.value}))),o(s({type:"submit",disabled:l},"Submit")))}},fi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,Si={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:wi,createComponent:xi}],gridItem:Dn},Ci=t=>{const e=F(t);return()=>e(Si)};function Bn(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding-left: 0;
  ...
  `;return function(...s){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},m]=V(s);return a({...d,class:["keyValueList",r,e==null?void 0:e.class,d==null?void 0:d.class]},m)}}const Ei=t=>{const{bau:e}=t,{section:n,li:o,label:a,span:r}=e.tags,i=Bn(t);return()=>n(i(o(a("My label"),r("My Value")),o(a("My other label"),r("My Other Value"))))},ki=`import keyValueList from "@grucloud/bau-ui/keyValueList";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ti=t=>{const{bau:e,css:n}=t,{section:o,li:a,label:r,span:i}=e.tags,s=Bn(t,{class:n`
    ...
    `});return()=>o(s(a(r("My label"),i("My Value")),a(r("My other label"),i("My Other Value"))))},Ai=`import keyValueList from "@grucloud/bau-ui/keyValueList";
import { Context } from "@grucloud/bau-ui/context";
...
`,Di={title:"KeyValueList",package:"keyValueList",description:"The keyValueList component displays a list of key value pair",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/keyValueList/keyValueList.js",importStatement:'import keyValueList from "@grucloud/bau-ui/keyValueList";',examples:[{title:"Vertical keyValueList",description:"A vertical keyValueList.",code:ki,createComponent:Ei},{title:"Horizontal keyValueList",description:"A horizontal keyValueList.",code:Ai,createComponent:Ti}]},Bi=t=>{const e=F(t);return()=>e(Di)},Ni="modulepreload",Oi=function(t){return"/bau/bau-ui/"+t},Re={},Nn=function(e,n,o){let a=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.all(n.map(s=>{if(s=Oi(s),s in Re)return;Re[s]=!0;const c=s.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${l}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":Ni,c||(u.as="script"),u.crossOrigin="",u.href=s,i&&u.setAttribute("nonce",i),document.head.appendChild(u),c)return new Promise((d,m)=>{u.addEventListener("load",d),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${s}`)))})}))}return a.then(()=>e()).catch(r=>{const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r})};function On(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=bt(t,{size:"lg"}),i=At(t,{color:"danger"}),s=()=>a({class:o`
          height: 100%;
          display: flex;
          justify-content: center;
          align-items: center;
        `},r({visibility:!0})),c=l=>i(l.message);return function({getModule:u,loading:d=s,error:m=c,props:b={}}){const p=n.state(void 0),g=n.state(!0),f=n.state(!1);return u().then(y=>{p.val=y.default(t),g.val=!1}).catch(y=>{f.val=y.message}),a(()=>{if(f.val)return m({message:f.val});if(g.val)return d();if(p.val)return p.val(b)})}}const Mi=t=>{const{bau:e}=t,{section:n}=e.tags,o=On(t),a=O(t);return()=>{const r=e.state(!1);return n(a({onclick:()=>r.val=!r.val},()=>r.val?"Hide":"Show"),()=>r.val&&o({getModule:()=>Nn(()=>import("./myComponent-B8W3Hpri.js"),[]),props:{message:"myValue"}}))}},Ii=`import { Context } from "@grucloud/bau-ui/context";
...
`,$i=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=e.state(!1),r=On(t,{loading:()=>o("My Custom Loading"),error:s=>o("My Custom Error")}),i=O(t);return()=>n(i({onclick:()=>a.val=!a.val},()=>a.val?"Hide":"Show"),()=>a.val&&r({getModule:()=>Nn(()=>import("./myComponent-B8W3Hpri.js"),[]),props:{message:"Additional Props here"}}))},Li=`import { Context } from "@grucloud/bau-ui/context";
import lazy from "@grucloud/bau-ui/lazy";
import button from "@grucloud/bau-ui/button";
export default (context: Context) => {
  const { bau } = context;
...
`),s=a`
  ...
  `,c=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",running:p,...g}]=V(u);return r({...g,role:"progressbar",class:{deps:[p],renderProp:()=>f=>["linearProgress",d,b,c,f&&"running",e==null?void 0:e.class,g==null?void 0:g.class]}})}}const In=(t,e)=>{const n=Mn(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},Ri=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=O(t,{variant:"solid",color:"primary"}),r=Mn(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},ji=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Hi={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:Fi,createComponent:Gi}],gridItem:$n},Vi=t=>{const e=F(t);return()=>e(Hi)},Ji=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],qi=(t,e)=>{const{bau:n,css:o}=t,{span:a,li:r}=n.tags,i=xt(t,e),s=({code:c,label:l})=>r({class:o`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return c=>i({...c},Ji.map(s))},Wi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Ki=t=>{const{bau:e,css:n}=t,{section:o,span:a,li:r}=e.tags,i=xt(t,{variant:"outline",color:"primary"}),s=({code:c,label:l})=>r({class:n`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return()=>o(i(Wi.map(s)))},Xi=`import list from "@grucloud/bau-ui/list";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:Xi,createComponent:Ki}],gridItem:qi},Yi=t=>{const e=F(t);return()=>e(Zi)};function Ln(t,e={}){const{bau:n,css:o,window:a}=t,{dialog:r,div:i}=n.tags,c=o`
    margin: auto;
    padding: 1rem;
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
...
`,ec={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:tc,createComponent:Qi}],gridItem:Pn},nc=t=>{const e=F(t);return()=>e(ec)},oc=()=>nt.map(t=>`
& button.plain.${t}::after {
  color: var(--color-${t});
}
& button.outline.${t}::after {
...
`).join(`
`);function ac(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=O(t),c=zt(t),l=xt(t),u=St(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
...
`,ic=t=>{const{bau:e,css:n}=t,{select:o,option:a,form:r}=e.tags,i=O(t,{variant:"outline",color:"neutral"}),s=[{group:"Cabrinha"},{group:"Core"},{group:"Duotone"},{group:"Naish"},{group:"Reedin"},{group:"Slingshot"}],c=l=>{l.preventDefault();const{selectedOptions:u}=l.target.elements.myNativeMultiSelect;var d=Array.from(u).map(({value:m})=>m);alert(JSON.stringify(d))};return()=>r({onsubmit:c,class:n`
          ...
          flex-direction: column;
          gap: 1rem;
        `},o({multiple:!0,name:"myNativeMultiSelect"},s.map(({group:l})=>a({value:l},l))),i({type:"submit"},"Submit"))},cc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,lc={title:"MultiSelect",package:"multiSelect",description:"The multiSelect component allows user to select multiple items from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/multiSelect/multiSelect.js",importStatement:'import multiSelect from "@grucloud/bau-ui/multiSelect";',examples:[{title:"Simple Multi Select",description:"A simple multi select.",code:sc,createComponent:rc},{title:"Native Multi Select",description:"A native multi select.",code:cc,createComponent:ic}]},uc=t=>{const e=F(t);return()=>e(lc)},dc=t=>{const{bau:e}=t,{section:n,div:o,h1:a,p:r}=e.tags,i=O(t,{variant:"outline",color:"success"}),s=zt(t),c=()=>i({onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),l=()=>o({},a("My content"),r("My Content")),u=c(),d=s({id:"my-popover-left",triggerEl:u,contentEl:l()});return()=>n(o(u,d))},mc=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,pc={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:mc,createComponent:dc}]},bc=t=>{const e=F(t);return()=>e(pc)};function gc(t,e={}){const{bau:n,css:o,config:a}=t,{div:r,a:i,span:s,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,vc={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:fc,createComponent:hc}]},yc=t=>{const e=F(t);return()=>e(vc)},xc=(t,e)=>{const{bau:n}=t,{div:o}=n.tags,a=be(t,e);return r=>a({...r},o(`Paper ${e.size??""}`))},wc=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=be(t,{size:"md"});return()=>n(a(o("My content")))},Sc=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`)}
  `;return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=V(c);return a({...m,type:"radio",class:["radio-button",l,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class]})}}const zn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:r}=n.tags,i=we(t,e);return s=>r({class:o`
        ...
        `,onsubmit:p},i(c(l("One or two"),o("One",u({id:"one",name:"radio",checked:!0,value:m,oninput:b})),o("Two",u({id:"two",name:"radio",value:m,oninput:b}))),a("Choice: ",m)),s(d({type:"submit"},"Submit")))}},Tc=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ac={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Tc,createComponent:kc}],gridItem:zn},Dc=t=>{const e=F(t);return()=>e(Ac)};function jt(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=we(t),c=o`
    display: flex;
    flex-direction: row;
    gap: 0.5rem;
    & label {
  ...
  `).join(`
`)};
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"none",color:b=e.color??"neutral",name:p,oninput:g,radios:f=[],...y}]=V(u);return a({class:["radioButtonGroup",d,b,m,c,e==null?void 0:e.class,y==null?void 0:y.class]},f.map(({value:h,Label:C})=>r(i({...y,size:d,variant:m,color:b,id:h,name:p,checked:h==y.value,value:h,oninput:g}),C())))}}const Bc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,p:r}=e.tags,i=jt(t),s=O(t,{variant:"outline",color:"primary"});return()=>{const c=e.state("two");return n({onsubmit:d=>{d.preventDefault(),alert(c.val)}},o(i({oninput:({target:d})=>c.val=d.value,name:"myRadio",value:c.val,radios:[{value:"one",Label:()=>"One"},{value:"two",Label:()=>"Two"}]}),r("CheckedState: ",c)),a(s({type:"submit"},"Submit")))}},Nc=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ic=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=jt(t),i=O(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:c=>{c.preventDefault();const l=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(l))}},o(r({name:"myRadio",value:"one",radios:[{value:"one",Label:()=>"One"},{value:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},$c=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
  ...
  `;function d(...p){let[g,f]=V(p);return r({...g,class:["resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u]},f)}function m(...p){let[g,f]=V(p);return i({...g,class:["resizablePanel",g==null?void 0:g.class]},f)}function b(...p){let[g,f]=V(p),y=0,h=0,C,S,T,D,A;const N=()=>l==="horizontal",B=j=>N()?$(j):z(j),$=j=>{const w=j.clientX-y;A&&(D.style.width=`${A.width+w}px`),T&&(S.style.width=`${T.width-w}px`)},z=j=>{const w=j.clientY-h;A&&(D.style.height=`${A.height+w}px`),T&&(S.style.height=`${T.height-w}px`)},G=()=>{S=null,D=null,T=null,A=null,C.style.cursor=null,C.style["user-select"]="auto",c.removeEventListener("mousemove",B),c.removeEventListener("mouseup",G)},H=j=>{y=j.clientX,h=j.clientY;const{target:w}=j,k=w.closest(".handle");C=w.closest(".resizablePanelGroup"),C.style.cursor=N()?"col-resize":"row-resize",C.style["user-select"]="none",S=k.nextSibling,D=k.previousSibling,D&&(A=D.getBoundingClientRect()),S&&(T=S.getBoundingClientRect()),c.addEventListener("mousemove",B),c.addEventListener("mouseup",G)};return s({...g,class:["handle",l],role:"separator",bauMounted:({element:j})=>{j.addEventListener("mousedown",H)},bauUnmounted:({element:j})=>{j.removeEventListener("mousedown",H)}},f)}return{PanelGroup:d,Panel:m,Handle:b}}const Uc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
    ...
    `}),c=()=>i({class:n`
        ...
        `},a("Resize me")),l=()=>a({class:n`
          ...
          padding: 0.2rem;
          z-index: 1;
        `},"⋮");return()=>o(r(c(),s(l())))},Gc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`,Fc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
      display: inline-flex;
      border: 1px var(--color-emphasis-100) solid;
      width: 600px;
    `}),c=()=>i({class:n`
        ...
        `},a("Panel1")),l=()=>i({class:n`
          ...
          width: 100px;
          height: 100px;
        `},a("Panel2"));return()=>o(r(c(),s(),l()))},Hc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{direction:"vertical",class:n`
      display: inline-flex;
      flex-direction: column;
    ...
    `}),c=()=>i({class:n`
        ...
        `},a("Panel2")),u=()=>a({class:n`
          ...
          z-index: 1;
          line-height: 0.5;
        `},"⋯");return()=>o(r(c(),s(u()),l()))},Jc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`,qc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
      display: inline-flex;
    ...
    `}),l=()=>i({class:n`
        ...
        `},a("Main")),d=()=>i({class:n`
          ...
          align-items: center;
          min-height: 2rem;
        `},a("Footer"));return()=>o(r(l(),s(),c.PanelGroup(u(),c.Handle(),d())))},Wc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function Dt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,c=O(t),l=zt(t),u=xt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
...
`,tl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,c=Dt(t),l=O(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(b.label),s(b.code));return()=>o({onsubmit:p=>{p.preventDefault();const g=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(g))}},a(c({name:"country",options:d,Option:m,defaultOption:d.find(({code:p})=>p==u),getOptionValue:({code:p})=>p,getOptionLabel:({label:p})=>p,label:"Select a country..."})),r(l({type:"submit"},"Submit")))},el=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,nl=t=>{const{bau:e,css:n,window:o}=t,{form:a,article:r,footer:i,div:s,span:c}=e.tags,l="country",u=Dt(t),d=O(t,{variant:"solid",color:"primary"}),m=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],b=p=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},c(p.label),c(p.code));return()=>{const p=h=>{h.preventDefault();const C=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(C))},g=({code:h})=>h,f=h=>{const C=new URLSearchParams(o.location.search);C.delete(l),C.append(l,g(h)),o.history.replaceState("","",`?${C.toString()}${o.location.hash}`)},y=new URLSearchParams(o.location.search);return a({onsubmit:p},r(u({name:l,options:m,Option:b,defaultOption:m.find(({code:h})=>h==y.get(l)),getOptionValue:g,getOptionLabel:({label:h})=>h,label:"Select a country...",onSelect:f})),i(d({type:"submit"},"Submit")))}},ol=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,al=t=>{const{bau:e}=t,{form:n,article:o,footer:a,span:r}=e.tags,i=Dt(t),s=O(t,{variant:"solid",color:"primary"}),c=["eu-north-1","ap-south-1","eu-west-3","eu-west-2","eu-west-1","ap-northeast-3","ap-northeast-2","ap-northeast-1","sa-east-1","ca-central-1","ap-southeast-1","ap-southeast-2","eu-central-1","us-east-1","us-east-2","us-west-1","us-west-2"],l=u=>r({},u);return()=>n({onsubmit:d=>{d.preventDefault();const m=Object.fromEntries(new FormData(d.currentTarget));alert(JSON.stringify(m))}},o(i({name:"region",options:c,Option:l,label:"Select a region",getOptionValue:d=>d,getOptionLabel:d=>d,required:!0,oninvalid:d=>{d.target.setCustomValidity("Please select an AWS region")}})),a(s({type:"submit"},"Submit")))},rl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,sl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,c=O(t,{variant:"outline"}),l=O(t,{variant:"solid",color:"primary"}),u=Dt(t),d=m=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(m.flag),i(m.name.common));return()=>{const m=e.state([]),b=e.state(!1),p=e.state("");async function g({url:h,transform:C=S=>S}){try{b.val=!0;const S=await fetch(h,{});if(S.ok){const T=await S.json();m.val=C(T)}else p.val=S.statusText}catch(S){p.val=S.message}finally{b.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((C,S)=>C.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:h=>{h.preventDefault();const C=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(C))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:m.val,Option:d,getOptionValue:({name:h})=>h.common,getOptionLabel:({name:h})=>h.common,label:"Country",id:"country",loading:b.val,required:!0}),c({onclick:()=>f()},"Reload")),r(l({type:"submit"},"Submit")))}},il=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`,cl={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Qc,createComponent:Yc},{title:"Default Option",description:"Select with a default option",code:el,createComponent:tl},{title:"State in URL",description:"Select with state in URL",code:ol,createComponent:nl},{title:"Select AWS region",description:"Select the AWS region",code:rl,createComponent:al},{title:"Loading Indicator",description:"Select with a loading indicator",code:il,createComponent:sl}],gridItem:Rn},ll=t=>{const e=F(t);return()=>e(cl)};function Se(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...s){let[{size:c=e.size??"md",variant:l=e.variant??"outline",color:u=e.color??"neutral",...d},m]=V(s);return a({...d,class:["select-native",u,c,l,r,e==null?void 0:e.class,d==null?void 0:d.class]},m)}}const jn=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=Se(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},r.map(({label:s,phone:c})=>o({value:c},s)))},ul=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,r=O(t,{variant:"outline",color:"primary"}),i=Se(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:l=>{l.preventDefault();const u=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),s.map(({label:l,phone:u})=>n({value:u},l))),a(r({type:"submit"},"Submit")))},dl=`import { Context } from "@grucloud/bau-ui/context";
...
`,bl={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:dl,createComponent:ul},{title:"State URL",description:"A selectNative with state in URL",code:pl,createComponent:ml}],gridItem:jn},gl=t=>{const e=F(t);return()=>e(bl)},hl=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=Tt(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,xl=t=>{const{bau:e,css:n}=t,{section:o,table:a,tbody:r,tr:i,td:s}=e.tags,c=Tt(t,{class:n`
      height: 2rem;
      width: 10rem;
...
`,Sl=t=>{const{bau:e,css:n}=t,{section:o,header:a,span:r,article:i}=e.tags,s=n`
  ...
  `,c=Tt(t,{class:n`
    ...
    `}),l=Tt(t);function u({columnsSize:d=4}){return o({class:s},a(new Array(d).fill("").map(()=>c(r("1")))),i(l("")))}return()=>o(u({columnsSize:3}))},Cl=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`)};
  `;return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},b]=V(c);return a({...m,type:"range",class:["slider",d,u,l,i,e==null?void 0:e.class,m.class]},b)}}const _n=t=>{const{bau:e}=t,n=e.state(0),o=r=>{n.val=r==null?void 0:r.target.value},a=Bt(t);return r=>a({"aria-label":"slider",...r,oninput:o})},Tl=t=>{const{bau:e}=t,{form:n,article:o,label:a,br:r,footer:i}=e.tags,s=Bt(t),c=O(t,{variant:"solid",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(a("Slider with step, min and max",r,s({name:"slider-simple",step:20,min:-100,max:100}))),i(c({type:"submit"},"Submit")))},Al=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Ml=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:c,option:l}=e.tags,u=Bt(t),d=O(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))}},o({class:n`
            display: flex;
...
`,_l={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:jl,createComponent:Rl}],gridItem:Un},Ul=t=>{const e=F(t);return()=>e(_l)},Gl=()=>nt.map(t=>"").join(`
...
`,_e="stepper-vertical",Vl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:c,ul:l,li:u}=e.tags,d=dt(t),m=gt(t),b=Fn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`,ql={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Horizontal Stepper",description:"A simple horizontal stepper.",code:Hl,createComponent:Fl},{title:"Vertical Stepper",description:"A simple vertical stepper.",code:Jl,createComponent:Vl}]},Wl=t=>{const e=F(t);return()=>e(ql)},Kl=()=>nt.map(t=>`
&.switch.plain.${t} {
  &::after {
...
`);function Zt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},m]=V(s);return a({...d,class:["switch",r,u,l,c,e==null?void 0:e.class,d.class],type:"checkbox"},m)}}const Hn=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Zt(t,e);return s=>a({class:o`
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},Xl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Zt(t,{variant:"outline",color:"primary"}),c=O(t,{variant:"outline",color:"primary"}),l=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
...
`,Yl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Zt(t,{variant:"outline",color:"primary"}),c=O(t,{variant:"outline",color:"primary"}),l=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`,tu=t=>{const{bau:e,css:n,window:o}=t,{footer:a,form:r,label:i,article:s}=e.tags,c="my-shinny-switch",l=Zt(t,{variant:"outline",color:"primary"}),u=O(t,{variant:"outline",color:"primary"}),d=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`,iu=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=_t(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>"Tab Disabled",Content:()=>n(o("My Content Disabled"))}],variant:"plain",color:"neutral"});return()=>r({tabsKey:"my-tab"})},cu=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,pu={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:su,createComponent:ru},{title:"Extended Tabs",description:"An extended tabs.",code:cu,createComponent:iu},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:uu,createComponent:lu},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:mu,createComponent:du}]},bu=t=>{const e=F(t);return()=>e(pu)};function Ut(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:r}=n.tags;a`
  :root {
...
`;const i=o`
  ...
  `;return function(...c){let[l,u]=V(c);return r({...l,class:["table-container",i,e==null?void 0:e.class,l==null?void 0:l.class]},u)}}const gu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:c,tbody:l,caption:u}=e.tags;function d(f,y,h,C,S){return{name:f,calories:y,fat:h,carbs:C,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],b=({name:f,calories:y})=>i(r(f),r({class:n`
      ...
      max-width: 650px;
    `});return()=>o(g(s(u("Basic Table"),p(),l(m.map(b)))))},hu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Nt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const fu=[Nt("Frozen yoghurt",159,6,24,4),Nt("Ice cream sandwich",237,9,37,4.3),Nt("Eclair",262,16,24,6),Nt("Cupcake",305,3.7,67,4.3),Nt("Gingerbread",356,16,49,3.9)],vu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:c,tbody:l,caption:u}=e.tags,d=({name:p,calories:g})=>i(r(p),r({class:n`
    ...
    `});return()=>o(b(s(u("Table Dense"),m(),l(fu.map(d)))))},yu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ot(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const xu=[Ot("Frozen yoghurt",159,6,24,4),Ot("Ice cream sandwich",237,9,37,4.3),Ot("Eclair",262,16,24,6),Ot("Cupcake",305,3.7,67,4.3),Ot("Gingerbread",356,16,49,3.9)],wu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:c,tbody:l,caption:u}=e.tags,d=({name:p,calories:g})=>i(r(p),r({class:n`
    ...
    `});return()=>o(b(s(u("Table Zebra"),m(),l(xu.map(d)))))},Su=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Au={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Tu,createComponent:ku}]},Du=t=>{const e=F(t);return()=>e(Au)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=ve(t),i=O(t),s=bt(t),c=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,l=({label:p,icon:g,...f})=>i({"aria-label":p,title:p,...f},g),u=({count:p,totalCount:g,page:f,rowsPerPage:y})=>a({class:"pages-numbers"},Number(f-1)*Number(y)+(p>0?1:0),"-",Math.min(f*y,g)," of ",g),d=({count:p,page:g,rowsPerPage:f})=>a({class:"pages-numbers"},(g-1)*f+(p>0?1:0),"-",g*f),m=p=>p<=1,b=(p,g,f)=>p>=Math.ceil(g/f);return function(...g){let[{size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",count:C=0,totalCount:S=0,page:T=1,rowsPerPage:D=50,onPageChange:A,isLoading:N=!1,disableFirst:B=()=>m(T),disablePrevious:$=()=>m(T),disableNext:z=()=>b(T,S,D),disableLast:G=()=>b(T,S,D),...H}]=V(g);const j=Math.max(0,Math.ceil(S/D)),w=A({page:1}),k=A({page:T-1}),v=A({page:T+1}),x=A({page:j}),E=[{label:"First",icon:"⟪",onclick:w,disabled:B()},{label:"Previous",icon:"⟨",onclick:k,disabled:$()},{label:"Next",icon:"⟩",onclick:v,disabled:z()},{label:"Last",icon:"⟫",onclick:x,disabled:G()}];return a({...H,class:["table-pagination",c,N&&"disabled",e==null?void 0:e.class,H==null?void 0:H.class]},s({class:"spinner",visibility:N,size:"md"}),S>0?u({count:C,totalCount:S,page:T,maxPages:j,rowsPerPage:D}):d({count:C,page:T,maxPages:j,rowsPerPage:D}),r({variant:y,color:h},E.map(M=>l({...M,variant:y,color:h}))))}}const Bu=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:c}=e.tags,l=Bu(45),u=({name:p,email:g})=>r(a(p),a(g)),d=()=>s(o({class:n`
    ...
    `});return()=>{const p=e.state(l),g=e.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),f=e.derive(()=>p.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:h})=>C=>{g.val.page=h};return b(i(d(),()=>c(f.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Ou=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:c,div:l}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),b=e.derive(()=>d.val.length),p=e.state(1),g=e.state(10),f=e.derive(()=>d.val),y=B=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(B).toString()}`,h=({page:B})=>$=>{p.val=B,C(y({page:B,per_page:g.val}))};C(y({page:1,per_page:g.val}));async function C(B){try{u.val=!0;const $=await fetch(B,{});if($.ok){const z=await $.json();d.val=z;return}throw $}catch($){m.val=$.message}finally{u.val=!1}}const S=({name:B,description:$,stargazers_count:z})=>r(a(B),a($),a({class:n`
      ...
      min-width: 650px;
    `}),N=({message:B})=>l(B);return()=>A(()=>D({rowsPerPage:g.val,page:p.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:h,disableNext:()=>!1}),i(T(),()=>m.val&&N({message:m.val}),()=>c(f.val.map(S))))},Mu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,c=Nu(t),l=Ou(t),u=(...d)=>a({class:n`
        ...
        `},d);return()=>o({id:"pagination"},i(s("Table Pagination")),r("Asynchronous Pagination"),u(l()),r("Simple Pagination"),u(c()))},Iu=()=>nt.map(t=>`
`).join(`
`);function qn(t,e={}){const{bau:n,css:o}=t,{textarea:a,div:r}=n.tags,i=s=>{s.target.parentNode.dataset.value=s.target.value};return function({size:c=e.size??"md",color:l=e.color??"primary",variant:u=e.variant??"outline",...d}={}){const m=o`
    ...
    `;return r({class:["textarea-autosize",m]},a({...d,oninput:i}))}}const $u=t=>{const{bau:e,css:n}=t,{form:o,label:a,span:r,footer:i,p:s}=e.tags,c=qn(t),l=O(t),u=m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.target));alert(b.message)},d=n`
    display: flex;
    .textarea-autosize {
      width: 100%;
    }
  `;return()=>o({onsubmit:u,class:d},a(r("Your Message:"),s(c({name:"message",placeholder:"Enter your message",rows:3}))),i(l({type:"submit"},"Submit")))},Lu=`import { Context } from "@grucloud/bau-ui/context";
...
`,Pu=t=>{const{bau:e,css:n}=t,{form:o,label:a,span:r,footer:i,p:s}=e.tags,c=qn(t),l=O(t),u=e.state(""),d=b=>{b.preventDefault(),alert(u.val)},m=n`
    display: flex;
    .textarea-autosize {
      min-width: 370px;
    }
  `;return()=>o({onsubmit:d,class:m},a(r("Your Message:"),s(c({name:"message",placeholder:"Enter your message",rows:2,value:u,onchange:b=>u.val=b.target.value}))),i(l({type:"submit"},"Submit")))},zu=`import { Context } from "@grucloud/bau-ui/context";
import textareaAutosize from "@grucloud/bau-ui/textareaAutosize";
import button from "@grucloud/bau-ui/button";
...
`,Ru={title:"TextareaAutosize",package:"textareaAutosize",description:"The textareaAutosize component displays an html textarea with automatic sizing.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/textareaAutosize/textareaAutosize.js",importStatement:'import textareaAutosize from "@grucloud/bau-ui/textareaAutosize";',examples:[{title:"Uncontrolled",description:"A simple uncontrolled textareaAutosize.",code:Lu,createComponent:$u},{title:"Controlled",description:"A simple controlled textareaAutosize.",code:zu,createComponent:Pu}]},ju=t=>{const e=F(t);return()=>e(Ru)};function ht(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{button:r}=n.tags;a`
    :root {
...
`,Zu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",c=ht(t,{variant:s,color:i}),l=Yt(t,{variant:s,color:i}),u=O(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{p.preventDefault();const f=[...p.currentTarget.querySelectorAll("button[selected=true]")].map(({name:y})=>y);alert(JSON.stringify(f))}},o(l({onChange:({values:p})=>{d.val=p}},r.map(({label:p,value:g})=>()=>c({value:g,name:p,selected:d.val.includes(g)},p)))),a(u({type:"submit"},"Submit")))}},Yu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,ed={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Xu,createComponent:Ku},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Yu,createComponent:Zu},{title:"State in URL",description:"A toggleGroup with state in the URL.",code:td,createComponent:Qu}],gridItem:Kn},nd=t=>{const e=F(t);return()=>e(ed)};function Ce(t,e={}){const{bau:n,css:o,window:a}=t,{div:r}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,rd=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:r,section:i}=e.tags,s=Pt(t,{variant:"outline",color:"primary"}),c=Ce(t),l=()=>o(a("A ",r("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
        `},o({class:n`
          ...
          `},c({side:"left-end",titleEl:l()},s("left end")),c({side:"right-end",titleEl:l()},s("right end"))),o({class:n`
            display: flex;
            justify-content: space-around;
          `},c({side:"bottom-start",titleEl:l()},s("bottom start")),c({side:"bottom-centered",titleEl:l()},s("bottom centered")),c({side:"bottom-end",titleEl:l()},s("bottom end"))));return()=>u()},sd=`import tooltip from "@grucloud/bau-ui/tooltip";
import chip from "@grucloud/bau-ui/chip";
...
`,dd={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:ud,createComponent:ld}],gridItem:Zn},md=t=>{const e=F(t);return()=>e(dd)},Yn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Yn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},pd=({css:t,createGlobalStyles:e})=>(e`
:root {
