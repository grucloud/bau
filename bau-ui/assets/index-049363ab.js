...
https://github.com/highlightjs/highlight.js/issues/2277`),T=m,D=b),x===void 0&&(x=!0);const z={code:D,language:T};f("before:highlight",z);const O=z.result?z.result:d(z.language,z.code,x);return O.code=z.code,f("after:highlight",O),O}function d(m,b,x,D){const T=Object.create(null);function z(C,A){return C.keywords[A]}function O(){if(!L.keywords){ee.addText(Y);return}let C=0;L.keywordPatternRe.lastIndex=0;let A=L.keywordPatternRe.exec(Y),U="";for(;A;){U+=Y.substring(C,A.index);const X=oe.case_insensitive?A[0].toLowerCase():A[0],te=z(L,X);if(te){const[re,Tn]=te;if(ee.addText(U),U="",T[X]=(T[X]||0)+1,T[X]<=na&&(Ce+=Tn),re.startsWith("_"))U+=A[0];else{const An=oe.classNameAliases[re]||re;G(A[0],An)}}else U+=A[0];C=L.keywordPatternRe.lastIndex,A=L.keywordPatternRe.exec(Y)}U+=Y.substring(C),ee.addText(U)}function j(){if(Y==="")return;let C=null;if(typeof L.subLanguage=="string"){if(!t[L.subLanguage]){ee.addText(Y);return}C=d(L.subLanguage,Y,!0,qe[L.subLanguage]),qe[L.subLanguage]=C._top}else C=v(Y,L.subLanguage.length?L.subLanguage:null);L.relevance>0&&(Ce+=C.relevance),ee.__addSublanguage(C._emitter,C.language)}function P(){L.subLanguage!=null?j():O(),Y=""}function G(C,A){C!==""&&(ee.startScope(A),ee.addText(C),ee.endScope())}function Q(C,A){let U=1;const X=A.length-1;for(;U<=X;){if(!C._emit[U]){U++;continue}const te=oe.classNameAliases[C[U]]||C[U],re=A[U];te?G(re,te):(Y=re,O(),Y=""),U++}}function ae(C,A){return C.scope&&typeof C.scope=="string"&&ee.openNode(oe.classNameAliases[C.scope]||C.scope),C.beginScope&&(C.beginScope._wrap?(G(Y,oe.classNameAliases[C.beginScope._wrap]||C.beginScope._wrap),Y=""):C.beginScope._multi&&(Q(C.beginScope,A),Y="")),L=Object.create(C,{parent:{value:L}}),L}function ye(C,A,U){let X=vo(C.endRe,U);if(X){if(C["on:end"]){const te=new nt(C);C["on:end"](A,te),te.isMatchIgnored&&(X=!1)}if(X){for(;C.endsParent&&C.parent;)C=C.parent;return C}}if(C.endsWithParent)return ye(C.parent,A,U)}function yn(C){return L.matcher.regexIndex===0?(Y+=C[0],1):(_e=!0,0)}function En(C){const A=C[0],U=C.rule,X=new nt(U),te=[U.__beforeBegin,U["on:begin"]];for(const re of te)if(re&&(re(C,X),X.isMatchIgnored))return yn(A);return U.skip?Y+=A:(U.excludeBegin&&(Y+=A),P(),!U.returnBegin&&!U.excludeBegin&&(Y=A)),ae(U,C),U.returnBegin?0:A.length}function Cn(C){const A=C[0],U=b.substring(C.index),X=ye(L,C,U);if(!X)return ct;const te=L;L.endScope&&L.endScope._wrap?(P(),G(A,L.endScope._wrap)):L.endScope&&L.endScope._multi?(P(),Q(L.endScope,C)):te.skip?Y+=A:(te.returnEnd||te.excludeEnd||(Y+=A),P(),te.excludeEnd&&(Y=A));do L.scope&&ee.closeNode(),!L.skip&&!L.subLanguage&&(Ce+=L.relevance),L=L.parent;while(L!==X.parent);return X.starts&&ae(X.starts,C),te.returnEnd?0:A.length}function Sn(){const C=[];for(let A=L;A!==oe;A=A.parent)A.scope&&C.unshift(A.scope);C.forEach(A=>ee.openNode(A))}let Ee={};function Ye(C,A){const U=A&&A[0];if(Y+=C,U==null)return P(),0;if(Ee.type==="begin"&&A.type==="end"&&Ee.index===A.index&&U===""){if(Y+=b.slice(A.index,A.index+1),!a){const X=new Error(`0 width match regex (${m})`);throw X.languageName=m,X.badRule=Ee.rule,X}return 1}if(Ee=A,A.type==="begin")return En(A);if(A.type==="illegal"&&!x){const X=new Error('Illegal lexeme "'+U+'" for mode "'+(L.scope||"<unnamed>")+'"');throw X.mode=L,X}else if(A.type==="end"){const X=Cn(A);if(X!==ct)return X}if(A.type==="illegal"&&U==="")return 1;if($e>1e5&&$e>A.index*3)throw new Error("potential infinite loop, way more iterations than matches");return Y+=U,U.length}const oe=$(m);if(!oe)throw le(i.replace("{}",m)),new Error('Unknown language: "'+m+'"');const kn=Jo(oe);let Ne="",L=D||kn;const qe={},ee=new s.__emitter(s);Sn();let Y="",Ce=0,ce=0,$e=0,_e=!1;try{if(oe.__emitTokens)oe.__emitTokens(b,ee);else{for(L.matcher.considerAll();;){$e++,_e?_e=!1:L.matcher.considerAll(),L.matcher.lastIndex=ce;const C=L.matcher.exec(b);if(!C)break;const A=b.substring(ce,C.index),U=Ye(A,C);ce=C.index+U}Ye(b.substring(ce))}return ee.finalize(),Ne=ee.toHTML(),{language:m,value:Ne,relevance:Ce,illegal:!1,_emitter:ee,_top:L}}catch(C){if(C.message&&C.message.includes("Illegal"))return{language:m,value:Re(b),illegal:!0,relevance:0,_illegalBy:{message:C.message,index:ce,context:b.slice(ce-100,ce+100),mode:C.mode,resultSoFar:Ne},_emitter:ee};if(a)return{language:m,value:Re(b),illegal:!1,relevance:0,errorRaised:C,_emitter:ee,_top:L};throw C}}function u(m){const b={value:Re(m),illegal:!1,relevance:0,_top:r,_emitter:new s.__emitter(s)};return b._emitter.addText(m),b}function v(m,b){b=b||s.languages||Object.keys(t);const x=u(m),D=b.filter($).filter(K).map(P=>d(P,m,!1));D.unshift(x);const T=D.sort((P,G)=>{if(P.relevance!==G.relevance)return G.relevance-P.relevance;if(P.language&&G.language){if($(P.language).supersetOf===G.language)return 1;if($(G.language).supersetOf===P.language)return-1}return 0}),[z,O]=T,j=z;return j.secondBest=O,j}function w(m,b,x){const D=b&&n[b]||x;m.classList.add("hljs"),m.classList.add(`language-${D}`)}function g(m){let b=null;const x=l(m);if(c(x))return;if(f("before:highlightElement",{el:m,language:x}),m.children.length>0&&(s.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(m)),s.throwUnescapedHTML))throw new ta("One of your code blocks includes unescaped HTML.",m.innerHTML);b=m;const D=b.textContent,T=x?p(D,{language:x,ignoreIllegals:!0}):v(D);m.innerHTML=T.value,w(m,x,T.language),m.result={language:T.language,re:T.relevance,relevance:T.relevance},T.secondBest&&(m.secondBest={language:T.secondBest.language,relevance:T.secondBest.relevance}),f("after:highlightElement",{el:m,result:T,text:D})}function h(m){s=it(s,m)}const S=()=>{M(),de("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function E(){M(),de("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let k=!1;function M(){if(document.readyState==="loading"){k=!0;return}document.querySelectorAll(s.cssSelector).forEach(g)}function _(){k&&M()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",_,!1);function R(m,b){let x=null;try{x=b(e)}catch(D){if(le("Language definition for '{}' could not be registered.".replace("{}",m)),a)le(D);else throw D;x=r}x.name||(x.name=m),t[m]=x,x.rawDefinition=b.bind(null,e),x.aliases&&H(x.aliases,{languageName:m})}function N(m){delete t[m];for(const b of Object.keys(n))n[b]===m&&delete n[b]}function B(){return Object.keys(t)}function $(m){return m=(m||"").toLowerCase(),t[m]||t[n[m]]}function H(m,{languageName:b}){typeof m=="string"&&(m=[m]),m.forEach(x=>{n[x.toLowerCase()]=b})}function K(m){const b=$(m);return b&&!b.disableAutodetect}function F(m){m["before:highlightBlock"]&&!m["before:highlightElement"]&&(m["before:highlightElement"]=b=>{m["before:highlightBlock"](Object.assign({block:b.el},b))}),m["after:highlightBlock"]&&!m["after:highlightElement"]&&(m["after:highlightElement"]=b=>{m["after:highlightBlock"](Object.assign({block:b.el},b))})}function V(m){F(m),o.push(m)}function W(m){const b=o.indexOf(m);b!==-1&&o.splice(b,1)}function f(m,b){const x=m;o.forEach(function(D){D[x]&&D[x](b)})}function y(m){return de("10.7.0","highlightBlock will be removed entirely in v12.0"),de("10.7.0","Please use highlightElement now."),g(m)}Object.assign(e,{highlight:p,highlightAuto:v,highlightAll:M,highlightElement:g,highlightBlock:y,configure:h,initHighlighting:S,initHighlightingOnLoad:E,registerLanguage:R,unregisterLanguage:N,listLanguages:B,getLanguage:$,registerAliases:H,autoDetection:K,inherit:it,addPlugin:V,removePlugin:W}),e.debugMode=function(){a=!1},e.safeMode=function(){a=!0},e.versionString=ea,e.regex={concat:ue,lookahead:Et,either:He,optional:go,anyNumberOfTimes:ho};for(const m in ke)typeof ke[m]=="object"&&wt(ke[m]);return Object.assign(e,ke),e},me=Nt({});me.newInstance=()=>Nt({});var oa=me;me.HighlightJS=me;me.default=me;const lt=lo(oa),ut="[A-Za-z$_][0-9A-Za-z$_]*",aa=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],ra=["true","false","null","undefined","NaN","Infinity"],$t=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],_t=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],Bt=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],sa=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],ia=[].concat(Bt,$t,_t);function ca(e){const t=e.regex,n=(b,{after:x})=>{const D="</"+b[0].slice(1);return b.input.indexOf(D,x)!==-1},o=ut,a={begin:"<>",end:"</>"},i=/<[A-Za-z0-9\\._:-]+\s*\/>/,r={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(b,x)=>{const D=b[0].length+b.index,T=b.input[D];if(T==="<"||T===","){x.ignoreMatch();return}T===">"&&(n(b,{after:D})||x.ignoreMatch());let z;const O=b.input.substring(D);if(z=O.match(/^\s*=/)){x.ignoreMatch();return}if((z=O.match(/^\s+extends\s+/))&&z.index===0){x.ignoreMatch();return}}},s={$pattern:ut,keyword:aa,literal:ra,built_in:ia,"variable.language":sa},c="[0-9](_?[0-9])*",l=`\\.(${c})`,p="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",d={className:"number",variants:[{begin:`(\\b(${p})((${l})|\\.)?|(${l}))[eE][+-]?(${c})\\b`},{begin:`\\b(${p})\\b((${l})\\b|\\.)?|(${l})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},u={className:"subst",begin:"\\$\\{",end:"\\}",keywords:s,contains:[]},v={begin:"html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,u],subLanguage:"xml"}},w={begin:"css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,u],subLanguage:"css"}},g={begin:"gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,u],subLanguage:"graphql"}},h={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,u]},E={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:o+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},k=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,v,w,g,h,{match:/\$\d+/},d];u.contains=k.concat({begin:/\{/,end:/\}/,keywords:s,contains:["self"].concat(k)});const M=[].concat(E,u.contains),_=M.concat([{begin:/\(/,end:/\)/,keywords:s,contains:["self"].concat(M)}]),R={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:s,contains:_},N={variants:[{match:[/class/,/\s+/,o,/\s+/,/extends/,/\s+/,t.concat(o,"(",t.concat(/\./,o),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,o],scope:{1:"keyword",3:"title.class"}}]},B={relevance:0,match:t.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...$t,..._t]}},$={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},H={variants:[{match:[/function/,/\s+/,o,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[R],illegal:/%/},K={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function F(b){return t.concat("(?!",b.join("|"),")")}const V={match:t.concat(/\b/,F([...Bt,"super","import"]),o,t.lookahead(/\(/)),className:"title.function",relevance:0},W={begin:t.concat(/\./,t.lookahead(t.concat(o,/(?![0-9A-Za-z$_(])/))),end:o,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},f={match:[/get|set/,/\s+/,o,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},R]},y="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",m={match:[/const|var|let/,/\s+/,o,/\s*/,/=\s*/,/(async\s*)?/,t.lookahead(y)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[R]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:s,exports:{PARAMS_CONTAINS:_,CLASS_REFERENCE:B},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),$,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,v,w,g,h,E,{match:/\$\d+/},d,B,{className:"attr",begin:o+t.lookahead(":"),relevance:0},m,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[E,e.REGEXP_MODE,{className:"function",begin:y,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:s,contains:_}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:a.begin,end:a.end},{match:i},{begin:r.begin,"on:begin":r.isTrulyOpeningTag,end:r.end}],subLanguage:"xml",contains:[{begin:r.begin,end:r.end,skip:!0,contains:["self"]}]}]},H,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[R,e.inherit(e.TITLE_MODE,{begin:o,className:"title.function"})]},{match:/\.\.\./,relevance:0},W,{match:"\\$"+o,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[R]},V,K,N,f,{match:/\$[(.]/}]}}const Ot=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:r,td:s,thead:c,th:l}=t.tags,p=["sm","md","lg"];return function({Item:u,name:v}){return o({class:n`
        ...
        `},a(c(r(l(v??"Variant/Color"),ne.map(w=>l(w)))),i(Kn.map(w=>r(l(w),ne.map((g,h)=>s(u({color:g,variant:w,size:p[h%3]},{index:h}))))))))}},Z=e=>{const{bau:t,css:n}=e,{article:o,section:a,h1:i,p:r,h2:s,h3:c,pre:l,div:p,code:d}=t.tags;lt.registerLanguage("javascript",ca);const u=Ot(e),v=({text:w})=>l({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:g})=>{g.innerHTML=lt.highlight(w,{language:"js"}).value}}));return function(g){return o({class:n``},i(g.title),r(g.description),g.gridItem&&[s("Gallery"),g.gridItem&&u({Item:g.gridItem(e)})],s("Usage"),c("Import"),v({text:g.importStatement}),s("Examples"),g.examples.map(h=>a(i(h.title),r(h.description),p(h.createComponent(e)()),v({text:h.code}))))}},la=()=>ne.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`,Pt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},pa=e=>{const{css:t}=e,n=Pt(e),o=Me(e,{accordionDefs:n});return()=>o({color:"warning",class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,ba=e=>{const{css:t}=e,n=Pt(e),o=Me(e,{accordionDefs:n});return()=>o({color:"success",variant:"outline",class:t`
        &.accordion {
          & ul {
            & li {
              & h3 {
...
`,ga={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:da,createComponent:ua},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:ma,createComponent:pa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:ha,createComponent:ba}],gridItem:Rt},fa=e=>{const t=Z(e);return()=>t(ga)},va={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},xa=({css:e,createGlobalStyles:t})=>{t`
:root {
...
`).join(`
`);function De(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i,i:r}=n.tags;xa({css:o,createGlobalStyles:a});const s=o`
    display: flex;
    max-width: 600px;
    justify-content: flex-start;
    align-items: center;
...
`,Ca=e=>{const{css:t}=e,n=De(e,{class:t`
      &.alert {
        border: 3px dotted !important;
        height: 80px;
      }
    `});return()=>n({color:"warning"},"Your coffee supply is getting low.")},Sa=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,ka={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ea,createComponent:ya},{title:"Custom Alert ",description:"A custom alert.",code:Sa,createComponent:Ca}],gridItem:Lt},Ta=e=>{const t=Z(e);return()=>t(ka)},Aa=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:r=15e3}=t,{div:s}=n.tags,c=n.state([]),l={inserting:a`
...
`,Ia={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:Da,createComponent:Ma}]},Na=e=>{const t=Z(e);return()=>t(Ia)},$a=({keyframes:e})=>({hideRight:e`
 ...
 `}),_a=e=>{const{bau:t}=e,{section:n,div:o,h1:a}=t.tags,i=gt(),r=J(e),s=$a(e);return function(){const c=t.state(!0),l=o(),p=d=>{l.replaceChildren(i({parent:l,animationHide:`${s.hideRight} 0.5s`,animationShow:`${s.showRight} 0.5s`},o(d.val?"Ciao":"")))};return p(c),n({id:"animate"},o(a("Test Animate"),o(r({onclick:()=>{c.val=!c.val,p(c)}},()=>c.val?"Hide":"Show")),l))}};function jt(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,r=n.state(!0),s=n.state(!1),c=()=>r.val=!1,l=d=>{r.val=!1,s.val=!0},p=o`
  ...
  `;return function(...u){let[{color:v,variant:w="outline",size:g="md",width:h=30,height:S=30,...E},...k]=q(u);return a({class:I(p,t==null?void 0:t.class,E.class)},()=>r.val?"Loading...":"",()=>s.val&&"Error",i({width:h,height:S,onload:c,onerror:l,class:I(v,w,g,p,t==null?void 0:t.class,E.class),...E}))}}const zt=e=>{const{css:t}=e,n=jt(e,{class:t`
    ...
    `});return o=>n({...o,src:"https://www.gravatar.com/avatar/00000000000000000000000000000000?d=robohash&f=y",alt:"my avatar"})},Ba=e=>{const{bau:t,css:n}=e,{section:o}=t.tags,a=jt(e,{class:n`
      > img {
        background: var(--color-gray-100);
        border-radius: 50%;
      }
    `});return()=>o(a({src:"https://www.gravatar.com/avatar/00000000000000000000000000000000?d=robohash&f=y",alt:"my avatar"}))},Oa=`import avatar from "@grucloud/bau-ui/avatar";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ra={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:Oa,createComponent:Ba}],gridItem:zt},Pa=e=>{const t=Z(e);return()=>t(Ra)};function Ge(e,t){const{bau:n,css:o,window:a}=e,{dialog:i}=n.tags,r=o`
    width: fit-content;
    margin: 0;
...
`);function We(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${La()}
  `;return function(s){const{size:c="md",variant:l="outline",color:p="neutral",name:d,id:u,disabled:v,...w}=s;return a({...w,class:I("input",c,p,l,i,t==null?void 0:t.class,w.class)})}}const ja=()=>ne.map(e=>`
...
`);function Ht(e,t){const{bau:n,css:o}=e,{div:a,li:i,ul:r}=n.tags,s=Ge(e),c=J(e),l=We(e),p=ve(e),d=o`
  ...
  `,u=n.state(""),v=n.state(""),w=n.state(!1),g=n.state(0),h=()=>{w.val=!1};return function(...E){let[{variant:k="outline",color:M,size:_="md",id:R,label:N,placeholder:B,Option:$,options:H,getOptionLabel:K=({label:P})=>P,...F},...V]=q(E);const W=n.state(H),f=()=>{j.openDialog(),w.val=!0,v.val="",W.val=H},y=()=>{j.closeDialog(),w.val=!1,v.val=""},m=P=>{const{value:G}=P.target;v.val=G,G?W.val=H.filter(Q=>K(Q).match(new RegExp(`${G}`,"i"))):W.val=H},b=P=>{w.val?y():f()},x=({option:P,index:G})=>Q=>{u.val=K(P),g.val=G,y()},D=P=>{switch(console.log("onkeydown",P.key,g.val),P.key){case"Escape":y();break;case"ArrowDown":g.val<W.val.length-1?g.val++:g.val=0;break;case"ArrowUp":g.val<=0?g.val=W.val.length-1:g.val--;break;case"Enter":u.val=K(W.val[g.val]),v.val="",y();break}},T=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":w,"aria-label":N,onclick:b,variant:k,color:M,size:_},()=>!u.val&&N,u),z=l({id:R,value:v,placeholder:B,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":w,oninput:m,onkeydown:D,variant:k,color:M,size:_}),j=s({id:R,triggerEl:T,contentEl:(()=>a({class:I(k,M,_,"content")},z,()=>p({class:I(k,M,_)},W.val.map((P,G)=>i({class:()=>I(g.val==G&&"active"),onclick:x({option:P,index:G})},$(P))))))(),onClose:h});return a({...F,class:I("autocomplete",d,t==null?void 0:t.class,F==null?void 0:F.class)},T,j)}}const Ut=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ht(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],s=c=>o({class:n`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},a(c.label),a(c.code));return c=>i({...c,options:r,Option:s,getOptionLabel:({label:l})=>l,label:"Country",placeholder:"Search countries",id:"country"})},za=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,r=Ht(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return()=>o(r({options:s,Option:c,getOptionLabel:({label:l})=>l,label:"Country",placeholder:"Search countries",id:"country"}))},Ha=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ua={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Default",description:"A simple autocomplete.",code:Ha,createComponent:za}],gridItem:Ut},Fa=e=>{const t=Z(e);return()=>t(Ua)};function Ft(e,t){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,Va={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Wa,createComponent:Ga}],gridItem:Gt},Xa=e=>{const t=Z(e);return()=>t(Va)};function Wt(e,t){const{bau:n,css:o}=e,{ul:a,li:i,a:r,span:s}=n.tags,c=J(e),l=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`,Ya={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:Ka,createComponent:Za}],gridItem:Vt},qa=e=>{const t=Z(e);return()=>t(Ya)},Xt=e=>{const t=J(e);return n=>t({...n},`${n.variant} ${n.color} ${n.size}`)},Ja=e=>{const{bau:t}=e,{section:n}=t.tags,o=J(e),a=()=>{alert("Click")};return()=>n(o({color:"primary",variant:"outline",onclick:a},"Click me"))},Qa=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,er={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Default",description:"A simple button.",code:Qa,createComponent:Ja}],gridItem:Xt},tr=e=>{const t=Z(e);return()=>t(er)},nr=()=>ne.map(e=>`
&.button-group.${e} {
...
`);function Ve(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${nr()}
  `;return function(...s){let[{variant:c="outline",size:l="md",color:p,...d},...u]=q(s);return a({...d,class:I("button-group",c,p,l,i,t==null?void 0:t.class,d==null?void 0:d.class)},...u)}}const Zt=e=>{const t=["ONE","TWO","THREE"],n=J(e),o=Ve(e);return a=>o({...a},t.map(i=>n(a,i)))},or=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=J(e),i=Ve(e),r="primary",s="solid";return()=>n(i({color:r,variant:s},o.map(c=>a({color:r,variant:s},c))))},ar=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,rr={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:ar,createComponent:or}],gridItem:Zt},sr=e=>{const t=Z(e);return()=>t(rr)};function Kt(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>ne.map(s=>`
...
`,lr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:cr,createComponent:ir}],gridItem:Yt},ur=e=>{const t=Z(e);return()=>t(lr)};function qt(e,t){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
    display: inline-block;
    border-radius: var(--global-radius);
...
`,mr={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:pr,createComponent:dr}],gridItem:Jt},br=e=>{const t=Z(e);return()=>t(mr)};function Qt(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
  ...
  `;return function(...s){let[{color:c,variant:l="outline",size:p="md",...d},...u]=q(s);return a({type:"checkbox",required:"required",...d,class:I(i,c,l,p,t==null?void 0:t.class,d==null?void 0:d.class)})}}const en=e=>{const{bau:t,css:n}=e,{label:o}=t.tags,a=Qt(e);return i=>o({class:n`
          ...
          padding: 0.2rem;
        `},`${i.color} ${i.variant} ${i.size}`,a({id:`myCheckbox-gallery-${i.color}-${i.variant}-${i.size}`,name:`myCheckbox-gallery-${i.color}-${i.variant}`,...i}))},hr=e=>{const{bau:t,css:n}=e,{section:o,label:a}=t.tags,i=Qt(e),r=t.state(!1),s=c=>{r.val=!!c.target.checked};return()=>o(a({class:n`
            display: inline-flex;
            font-size: smaller;
            align-items: center;
            justify-content: space-between;
            color: var(--color-content-secondary);
            gap: 1rem;
          `},"My Checkbox",i({color:"neutral",variant:"outline",id:"my-checkbox",name:"myCheckbox",checked:r,onchange:s})))},gr=`import checkbox from "@grucloud/bau-ui/checkbox";
import { Context } from "@grucloud/bau-ui/context";
...
`,fr={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:gr,createComponent:hr}],gridItem:en},vr=e=>{const t=Z(e);return()=>t(fr)};function xr(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    position: fixed;
    top: 80px;
    left: 0px;
    z-index: 2;
  ...
  `;return function(...s){let[{color:c,variant:l="outline",size:p,openState:d,...u},...v]=q(s);return a({class:I(i,t==null?void 0:t.class,u.class)},a({class:()=>I("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>I("content",d.val&&"content-open")},v))}}const wr=e=>{const{bau:t}=e,{section:n,p:o}=t.tags,a=t.state(!1),i=xr(e),r=J(e),s=xt(e);return()=>n(o("Click on the button to open and close the drawer."),r({color:"neutral",variant:"outline",onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),i({openState:a},s()))},yr=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Er={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:yr,createComponent:wr}]},Cr=e=>{const t=Z(e);return()=>t(Er)},tn=e=>{const{config:t}=e,n={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},o=je(e,{base:t.base+"/components/drillDownMenu"});return a=>o({tree:n,...a})},Sr=e=>{const{bau:t,config:n}=e,{section:o}=t.tags,a=t.state(window.location.pathname.replace(n.base,"")),i={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},r=je(e,{base:n.base+"/components/drillDownMenu"});return()=>o(r({tree:i,pathnameState:a}))},kr=`import drillDownMenu, { type Tree } from "@grucloud/bau-ui/drillDownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Tr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:kr,createComponent:Sr}],gridItem:tn},Ar=e=>{const t=Z(e);return()=>t(Tr)};function nn(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:r,input:s}=n.tags,c={base:o`
      display: inline-block;
      > * {
        margin: 1rem 0;
      }
    ...
    `};return function(p,...d){const{variant:u="outline",color:v="neutral",size:w="md",Component:g,disabled:h,...S}=p;return a({class:I(c.base,h&&c.disabled,t==null?void 0:t.class,p.class)},r({class:I(u,v,w)},g({disabled:h}),s({type:"file",disabled:h,...S})),i({class:"filename-display"}))}}const on=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:r}=n.tagsNS("http://www.w3.org/2000/svg"),{div:s,span:c}=n.tags,l=n.state("No file selected"),p=nn(e),d=v=>{const w=v.target.files[0];w?l.val=w.name:l.val="No file selected"},u=({disabled:v})=>s({class:I(o`
          ...
          `,w&&o`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},i({width:100,height:100,fill:"currentColor"},r({href:`${a.base}/uploadIcon.svg#Capa_1`})),l(t("Choose a file to upload")));return()=>s(d({Component:v,name:"file",accept:"text/*",onchange:u}),c("File selected: ",p))},Dr=`import classNames from "@grucloud/bau-css/classNames";
...
`,Ir={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Dr,createComponent:Mr}],gridItem:on},Nr=e=>{const t=Z(e);return()=>t(Ir)},an=e=>{const t=We(e);return n=>t({name:`myinput-gallery-${n.color}-${n.variant}-${n.size}`,id:`myinput-gallery-${n.color}-${n.variant}-${n.size}`,placeholder:"Enter text",...n})},$r=e=>{const{bau:t}=e,{section:n}=t.tags,o=We(e);return()=>n(o({id:"my-input",name:"my-input",placeholder:"Enter Text"}))},_r=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,Br={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:_r,createComponent:$r}],gridItem:an},Or=e=>{const t=Z(e);return()=>t(Br)},Rr=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Pr=e=>{const{bau:t,css:n}=e,{span:o,li:a}=t.tags,i=ve(e),r=({code:s,label:c})=>a({class:n`
          display: flex;
          gap: 1rem;
        `},o(s),o(c));return s=>i({...s},Rr.map(r))},Lr=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],jr=e=>{const{bau:t,css:n}=e,{section:o,span:a,li:i}=t.tags,r=ve(e),s=({code:c,label:l})=>i({class:n`
          display: flex;
          gap: 1rem;
        `},a(c),a(l));return()=>o(r({variant:"outline",color:"primary"},Lr.map(s)))},zr=`import list from "@grucloud/bau-ui/list";
import { Context } from "@grucloud/bau-ui/context";
...
`,Hr={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:zr,createComponent:jr}],gridItem:Pr},Ur=e=>{const t=Z(e);return()=>t(Hr)};function rn(e,t){const{bau:n,css:o}=e,{dialog:a}=n.tags,r=o`
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
    top: 0;
    left: 0;
...
`,Wr={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:Gr,createComponent:Fr}],gridItem:sn},Vr=e=>{const t=Z(e);return()=>t(Wr)},Xr=e=>{const{bau:t}=e,{section:n,div:o,h1:a,p:i}=t.tags,r=J(e),s=Ge(e),c=()=>r({variant:"outline",color:"success",onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),l=()=>o({},a("My content"),i("My Content")),p=c(),d=s({id:"my-popover-left",triggerEl:p,contentEl:l()});return()=>n(o(p,d))},Zr=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Kr={title:"Popover",package:"popover",description:"The popover component display a dialog next to a composant.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Zr,createComponent:Xr}]},Yr=e=>{const t=Z(e);return()=>t(Kr)},qr=()=>ne.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function cn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,r=J(e),s=Ge(e),c=ve(e),l=o`
  ...
  `,p=n.state(""),d=n.state(!1),u=n.state(0);return function(...w){let[{color:g="neutral",variant:h="outline",size:S="md",id:E,label:k,Option:M,options:_,getOptionLabel:R=({label:b})=>b,...N},...B]=q(w);const $=()=>{m.openDialog(),m.focus(),d.val=!0},H=()=>{m.closeDialog(),d.val=!1},K=()=>{d.val=!1},F=b=>{d.val?H():$()},V=({option:b,index:x})=>D=>{p.val=R(b),u.val=x,H()},W=b=>{switch(b.preventDefault(),b.key){case"Escape":H();break;case"ArrowDown":u.val<_.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=_.length-1:u.val--;break;case"Enter":d.val?(p.val=R(_[u.val]),H()):$();break}},f=()=>c({tabindex:"0",class:I(g,h)},_.map((b,x)=>i({class:()=>I(u.val==x&&"active"),onclick:V({option:b,index:x})},M(b)))),y=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":d,"aria-label":k,onclick:F,color:g,variant:h,size:S},()=>!p.val&&k,p),m=s({id:E,triggerEl:y,contentEl:f(),onClose:K});return a({...N,class:I("select",g,S,l,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:W},y,m)}}const ln=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=cn(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],s=c=>o({class:n`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},a(c.label),a(c.code));return c=>i({...c,options:r,Option:s,getOptionLabel:({label:l})=>l,label:"Select a country..."})},Jr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,r=cn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return()=>o(r({options:s,Option:c,getOptionLabel:({label:l})=>l,label:"Select a country..."}))},Qr=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,es={title:"Modal",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Default",description:"A simple select.",code:Qr,createComponent:Jr}],gridItem:ln},ts=e=>{const t=Z(e);return()=>t(es)};function Ie(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    ${(()=>ne.map(s=>`
&.slider.${s} {
  accent-color: var(--color-${s});
}
...
`,as=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:r,br:s,option:c}=t.tags,l=t.state(0),p=u=>{l.val=u==null?void 0:u.target.value},d=Ie(e);return()=>o(a(i({for:"temp"},"Choose a comfortable temperature"),s,d({oninput:p,class:n`
            width: 300px;
            margin: 0;
          `,id:"temp",name:"temp",list:"markers"}),r({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(u=>c({value:Number(u),label:u})))))},rs=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,ss=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:r,br:s,option:c}=t.tags,l=t.state(0),p=u=>{l.val=u==null?void 0:u.target.value},d=Ie(e);return()=>o(a({class:n`
            display: flex;
          ...
          `}),r({id:"markers-vertical",class:n`
              ...
              flex-direction: column;
              justify-content: space-between;
            `},["0","25","50","75","100"].reverse().map(u=>c({value:Number(u),label:u})))))},is=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,ps={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:ds,createComponent:us}],gridItem:dn},ms=e=>{const t=Z(e);return()=>t(ps)},bs=()=>ne.map(e=>`
&.switch.plain.${e} {
  &::after {
...
`);function pn(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...s){let[{color:c="neutral",variant:l="plain",size:p="md",...d},...u]=q(s);return a({...d,class:I("switch",i,c,l,p,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...u)}}const mn=e=>{const{bau:t,css:n}=e,{form:o,label:a}=t.tags,i=pn(e);return r=>o({class:n`
        ...
        `},a("off ",i({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),a("on ",i({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},hs=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i}=t.tags,r=pn(e);return()=>o(a(i({class:n`
              display: flex;
              align-items: center;
              gap: 0.5rem;
            `},"My shinny switch",r({variant:"outline",id:"my-shinny-switch"}))))},gs=`import createSwitch from "@grucloud/bau-ui/switch";
import { Context } from "@grucloud/bau-ui/context";
...
`,fs={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:gs,createComponent:hs}],gridItem:mn},vs=e=>{const t=Z(e);return()=>t(fs)},xs=()=>ne.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`,Es=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=xe(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB 1"),Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>n("Tab Disabled"),Content:()=>n(o("My Content Disabled"))}]});return()=>i({variant:"outline",color:"success"})},Cs=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,hn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]},Ss=e=>{const{css:t}=e,n=xe(e,{tabDefs:hn(e)});return()=>n({variant:"outline",color:"neutral",class:t`
...
`,Ts=e=>{const{css:t}=e,n=hn(e),o=xe(e,{tabDefs:n});return()=>o({variant:"outline",color:"neutral",class:t`
        & ul {
          justify-content: center;
        }
      `})},As=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ms={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:ys,createComponent:ws},{title:"Extended Tabs",description:"An extended tabs.",code:Cs,createComponent:Es},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:ks,createComponent:Ss},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:As,createComponent:Ts}],gridItem:bn},Ds=e=>{const t=Z(e);return()=>t(Ms)};function we(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i}=n.tags;a`
  :root {
...
`;const r=o`
    ...
    box-shadow: var(--shadow-s);
    border-radius: var(--global-radius);
  `;return function(...c){let[{...l},...p]=q(c);return i({...l,class:I("table-container",r,t==null?void 0:t.class,l==null?void 0:l.class)},...p)}}const Is=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:r,table:s,thead:c,tbody:l,caption:p}=t.tags;function d(h,S,E,k,M){return{name:h,calories:S,fat:E,carbs:k,protein:M}}const u=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],v=({name:h,calories:S})=>r(i(h),i({class:n`
            text-align: right;
          `},S)),w=()=>c(r(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(g(s(p("Basic Table"),w(),l(u.map(v)))))},Ns=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function be(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const $s=[be("Frozen yoghurt",159,6,24,4),be("Ice cream sandwich",237,9,37,4.3),be("Eclair",262,16,24,6),be("Cupcake",305,3.7,67,4.3),be("Gingerbread",356,16,49,3.9)],_s=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:r,table:s,thead:c,tbody:l,caption:p}=t.tags,d=({name:w,calories:g})=>r(i(w),i({class:n`
            text-align: right;
          `},g)),u=()=>c(r(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(v(s(p("Table Dense"),u(),l($s.map(d)))))},Bs=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function he(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Os=[he("Frozen yoghurt",159,6,24,4),he("Ice cream sandwich",237,9,37,4.3),he("Eclair",262,16,24,6),he("Cupcake",305,3.7,67,4.3),he("Gingerbread",356,16,49,3.9)],Rs=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:r,table:s,thead:c,tbody:l,caption:p}=t.tags,d=({name:w,calories:g})=>r(i(w),i({class:n`
            text-align: right;
          `},g)),u=()=>c(r(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(v(s(p("Table Zebra"),u(),l(Os.map(d)))))},Ps=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ls={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Ns,createComponent:Is},{title:"Dense",description:"A dense table.",code:Bs,createComponent:_s},{title:"Zebra",description:"A zebra table.",code:Ps,createComponent:Rs}]},js=e=>{const t=Z(e);return()=>t(Ls)};function gn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=Ve(e),r=J(e),s=Xe(e),c=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,l=({label:w,icon:g,...h})=>r({"aria-label":w,title:w,...h},g),p=({count:w,totalCount:g,page:h,rowsPerPage:S})=>a({class:"pages-numbers"},Number(h-1)*Number(S)+(w>0?1:0),"-",Math.min(h*S,g)," of ",g),d=({count:w,page:g,rowsPerPage:h})=>a({class:"pages-numbers"},(g-1)*h+(w>0?1:0),"-",g*h),u=w=>w<=1,v=(w,g,h)=>w>=Math.ceil(g/h);return function(...g){let[{count:h=0,totalCount:S=0,page:E=1,rowsPerPage:k=50,onPageChange:M,isLoading:_=!1,disableFirst:R=()=>u(E),disablePrevious:N=()=>u(E),disableNext:B=()=>v(E,S,k),disableLast:$=()=>v(E,S,k),...H},...K]=q(g);const F=Math.max(0,Math.ceil(S/k)),V=M({page:1}),W=M({page:E-1}),f=M({page:E+1}),y=M({page:F}),m=[{label:"First",icon:"⟪",onclick:V,disabled:R()},{label:"Previous",icon:"⟨",onclick:W,disabled:N()},{label:"Next",icon:"⟩",onclick:f,disabled:B()},{label:"Last",icon:"⟫",onclick:y,disabled:$()}];return a({...H,class:I("table-pagination",c,_&&"disabled",t==null?void 0:t.class,H==null?void 0:H.class)},s({class:"spinner",visibility:_,size:"md"}),S>0?p({count:h,totalCount:S,page:E,maxPages:F,rowsPerPage:k}):d({count:h,page:E,maxPages:F,rowsPerPage:k}),i({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const zs=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Hs=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:r,thead:s,tbody:c}=t.tags,l=zs(45),p=({name:E,email:k})=>i(a(E),a(k)),d=()=>s(o({class:n`
    ...
    `}),w=t.state(l),g=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=t.derive(()=>w.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),S=({page:E})=>k=>{g.val.page=E};return()=>v(r(d(),()=>c(h.val.map(p))),()=>u({...g.val,onPageChange:S}))},Us=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:r,thead:s,tbody:c,div:l}=t.tags,p=t.state(!1),d=t.state([]),u=t.state(""),v=t.derive(()=>d.val.length),w=t.state(1),g=t.state(10),h=t.derive(()=>d.val),S=$=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams($).toString()}`,E=({page:$})=>H=>{w.val=$,k(S({page:$,per_page:g.val}))};k(S({page:1,per_page:g.val}));async function k($){try{p.val=!0;const H=await fetch($,{});if(H.ok){const K=await H.json();d.val=K;return}throw H}catch(H){u.val=H.message}finally{p.val=!1}}const M=({name:$,description:H,stargazers_count:K})=>i(a($),a(H),a({class:n`
      ...
      min-width: 650px;
    `}),B=({message:$})=>l($);return()=>N(()=>R({rowsPerPage:g.val,page:w.val,count:v.val,totalCount:-1,isLoading:p.val,onPageChange:E,disableNext:()=>!1}),r(_(),()=>u.val&&B({message:u.val}),()=>c(h.val.map(M))))},Fs=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:r,tr:s}=t.tags,c=Hs(e),l=Us(e),p=(...d)=>a({class:n`
  ...
  `;return function(...c){let[{titleEl:l,side:p="bottom-start",color:d="neutral",variant:u="outline",size:v="md",...w},...g]=q(c);const h=i({class:I("container",...p.split("-"))},i({class:I("content",d,u,v),role:"tooltip"},l)),S=N=>`move-to-${N}`,E=(N,B,$)=>{if(N()){const H=S(B);h.classList.add(H),h.classList.add(B),h.classList.remove($)}},k=(N,B)=>{const $=S(N);h.classList.contains($)&&(h.classList.remove($),h.classList.add(B),h.classList.remove(N))},M=N=>{const B=h.getBoundingClientRect();E(()=>B.x<0,"right","left"),E(()=>B.x+B.width>a.innerWidth,"left","right"),E(()=>B.y<0,"bottom","top"),E(()=>B.bottom>a.innerHeight,"top","bottom"),h.classList.add("visible")},_=N=>{h.classList.remove("visible"),k("right","left"),k("left","right"),k("bottom","top"),k("top","bottom")};return i({...w,class:I("tooltip",r,t==null?void 0:t.class,w==null?void 0:w.class),bauMounted:({element:N})=>{N.addEventListener("mouseover",M),N.addEventListener("mouseout",_)},bauUnmounted:({element:N})=>{N.removeEventListener("mouseover",M),N.removeEventListener("mouseout",_)}},...g,h)}}const fn=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,r=J(e),s=Ze(e),c=()=>o({class:n`
          font-size: larger;
        `},a("A ",i("tooltip")," can be any component"));return l=>s({titleEl:c(),...l},r(l,`${l.color} ${l.variant}`))},Gs=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=J(e),r=Ze(e),s=()=>n(o("A ",a("tooltip")," can be any component"));return()=>r({side:"bottom-start",titleEl:s()},i("tooltip"))},Ws=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vs=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,r=J(e),s=Ze(e),c=()=>o(a("A ",i("tooltip")," can be any component")),l=()=>[o({class:n`
          display: flex;
          justify-content: space-around;
        ...
        `},s({side:"left-end",titleEl:c()},r("left end")),s({side:"right-end",titleEl:c()},r("right end"))),o({class:n`
          display: flex;
          justify-content: space-around;
        `},s({side:"bottom-start",titleEl:c()},r("bottom start")),s({side:"bottom-centered",titleEl:c()},r("bottom centered")),s({side:"bottom-end",titleEl:c()},r("bottom end")))];return()=>l()},Xs=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zs={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import createSwitch from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:Ws,createComponent:Gs},{title:"Grid",description:"Various tooltip position",code:Xs,createComponent:Vs}],gridItem:fn},Ks=e=>{const t=Z(e);return()=>t(Zs)},vn=e=>{const t=Le(e);return n=>t(n)},Ys=e=>{const{bau:t}=e,{section:n}=t.tags,o=Le(e);return()=>n(o({}))},qs=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,Js={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:qs,createComponent:Ys}],gridItem:vn},Qs=e=>{const t=Z(e);return()=>t(Js)},ei=({css:e,createGlobalStyles:t})=>(t`
:root {
...
`,oi={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:ni,createComponent:ti}],gridItem:wn},ai=e=>{const t=Z(e);return()=>t(oi)},ri=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:r,ul:s,li:c}=t.tags,l=Ot(e),p=J(e),d=[{name:"Accordion",Item:Rt(e)},{name:"Alert",Item:Lt(e)},{name:"Autocomplete",Item:Ut(e)},{name:"Avatar",Item:zt(e)},{name:"Badge",Item:Gt(e)},{name:"Breadcrumbs",Item:Vt(e)},{name:"Button",Item:Xt(e)},{name:"Button Group",Item:Zt(e)},{name:"Calendar",Item:Yt(e)},{name:"Checkbox",Item:en(e)},{name:"Chip",Item:Jt(e)},{name:"DrillDown Menu",Item:tn(e)},{name:"File Input",Item:on(e)},{name:"Input",Item:an(e)},{name:"Modal",Item:sn(e)},{name:"Select",Item:ln(e)},{name:"Slider",Item:un(e)},{name:"Spinner",Item:dn(e)},{name:"Switch",Item:mn(e)},{name:"Tabs",Item:bn(e)},{name:"Theme Switch",Item:vn(e)},{name:"Tooltip",Item:fn(e)},{name:"Tree View",Item:wn(e)}];return()=>o(i("Bau Component Gallery"),r("This page displays the components with various colors and variants."),s({class:n`
          ...
          `},d.map(({name:u})=>c(p({color:"primary",variant:"solid",href:`#${u}`},u)))),d.map(u=>a({id:u.name,class:n`
              ...
              padding: 1rem;
              margin: 1rem;
            `},l(u))))},si=({context:e})=>[{path:"",action:t=>({title:"Bau UI",component:ro(e)})},{path:"components",action:()=>({title:"Component",component:ri(e)}),children:[{path:"accordion",action:()=>({title:"Accordion",component:fa(e)})},{path:"alert",action:()=>({title:"Alert",component:Ta(e)})},{path:"alertStack",action:()=>({title:"Alert Stack",component:Na(e)})},{path:"animate",action:()=>({title:"Animate",component:_a(e)})},{path:"autocomplete",action:()=>({title:"Autocomplete",component:Fa(e)})},{path:"avatar",action:()=>({title:"Avatar",component:Pa(e)})},{path:"badge",action:()=>({title:"Badge",component:Xa(e)})},{path:"breadcrumb",action:()=>({title:"Breadcrumb",component:qa(e)})},{path:"button",action:()=>({title:"Button",component:tr(e)})},{path:"buttonGroup",action:()=>({title:"Button Group",component:sr(e)})},{path:"calendar",action:()=>({title:"Calendar",component:ur(e)})},{path:"chip",action:()=>({title:"Chip",component:br(e)})},{path:"checkbox",action:()=>({title:"Checkbox",component:vr(e)})},{path:"drawer",action:()=>({title:"Drawer",component:Cr(e)})},{path:"drillDownMenu",action:()=>({title:"DrillDown Menu",component:Ar(e)})},{path:"fileInput",action:()=>({title:"File Input",component:Nr(e)})},{path:"input",action:()=>({title:"Input",component:Or(e)})},{path:"list",action:()=>({title:"List",component:Ur(e)})},{path:"modal",action:()=>({title:"Modal",component:Vr(e)})},{path:"popover",action:()=>({title:"Popover",component:Yr(e)})},{path:"select",action:()=>({title:"Select",component:ts(e)})},{path:"slider",action:()=>({title:"Slider",component:ls(e)})},{path:"spinner",action:()=>({title:"Spinner",component:ms(e)})},{path:"switch",action:()=>({title:"Switch",component:vs(e)})},{path:"table",action:()=>({title:"Table",component:js(e)})},{path:"tablePagination",action:()=>({title:"Table Pagination",component:Fs(e)})},{path:"tabs",action:()=>({title:"Tabs",component:Ds(e)})},{path:"tooltip",action:()=>({title:"Tooltip",component:Ks(e)})},{path:"themeSwitch",action:()=>({title:"Theme Switch",component:Qs(e)})},{path:"treeView",action:()=>({title:"Tree View",component:ai(e)})}]},{path:"pages",action:t=>({title:"Pages",component:co(e)})}],ii=e=>({title:e.tr("Page Not Found"),component:()=>"Not Found"}),ci=({context:e,LayoutDefault:t,config:{base:n=""}})=>{const{window:o,bau:a,states:i}=e,r=a.state(),s=t({componentState:r});return document.getElementById("app").replaceChildren(s),({router:l})=>{const p=o.location.pathname.replace(n,""),{title:d,component:u,Layout:v=t}=l.resolve({pathname:p});i.pathname.val=p,r.val=u,document.title=`${d}`}},li=e=>{const{createGlobalStyles:t}=e;jn(e,{colorPalette:[["neutral",{h:"0",s:"0%",l:"20%"}],["primary",{h:"230",s:"48%",l:"20%"}],["secondary",{h:"338",s:"100%",l:"20%"}],["success",{h:"120",s:"100%",l:"20%"}],["info",{h:"194",s:"80%",l:"20%"}],["warning",{h:"43",s:"100%",l:"20%"}],["danger",{h:"358",s:"95%",l:"20%"}]]}),t`
    :root {
      --header-height: 3rem;
    }
    html {
