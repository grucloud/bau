(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function n(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=n(a);fetch(a.href,r)}})();const oo=(e,t)=>({...e,paths:[...t,e.path]}),_t=({paths:e=[],routes:t})=>t.flatMap(({children:n,...o})=>{const a=oo(o,e);return n?[a,..._t({paths:[...e,o.path],routes:n})]:a}),ao=({paths:e})=>{const t=e.map(n=>n instanceof RegExp?n.source:n).map(n=>String.raw`\/${n}`).join("");return new RegExp(`^${t}$`)},ro=({routes:e=[],notFoundRoute:t})=>{const n=_t({routes:e}).map(o=>({...o,regex:ao(o)}));return{resolve:({pathname:o})=>{const a=n.find(({regex:r})=>r.test(o));return a?a.action({match:o.match(a.regex)}):t}}};function so({routes:e,notFoundRoute:t,onLocationChange:n}){let o={...window.location};const a=i=>{o={...i}},r=ro({routes:e,notFoundRoute:t});return window.addEventListener("popstate",i=>{o.pathname!=i.target.location.pathname&&n({router:r}),a(i.target.location)}),window.history.pushState=new Proxy(window.history.pushState,{apply:(i,s,l)=>{i.apply(s,l),o.pathname!=window.location.pathname&&n({router:r}),a(window.location)}}),document.addEventListener("click",i=>{const{target:s}=i,l=s.closest("a");if(!l)return;const c=l.getAttribute("href");c&&!c.startsWith("http")&&!c.replace(window.location.pathname,"").startsWith("#")&&(console.log("bau router click",c),history.pushState({},null,c),a(window.location),["?","#"].includes(c[0])||window.scrollTo({top:0,left:0}),i.preventDefault())}),n({router:r}),r}const at=[["neutral",{h:"0",s:"0%",l:"50%"}],["primary",{h:"230",s:"70%",l:"30%"}],["secondary",{h:"338",s:"70%",l:"50%"}],["success",{h:"120",s:"70%",l:"25%"}],["info",{h:"194",s:"70%",l:"30%"}],["warning",{h:"43",s:"70%",l:"25%"}],["danger",{h:"358",s:"70%",l:"30%"}]],io=[["light","1.15"],["lighter","1.3"],["lightest","1.5"]],co=[["dark","0.9"],["darker","0.7"],["darkest","0.5"]],kt=e=>`var(--color-${e})`,lo=e=>`var(--color-${e}-lightest)`,uo=()=>at.map(([e])=>`
.outline.${e} {
...
`),bo=([e,{h:t,s:n,l:o}])=>[`--color-${e}-h: ${t};`,`--color-${e}-l: ${o};`,`--color-${e}-base-s: ${n};`,`--color-${e}-s: var(--color-${e}-base-s);`,`--color-${e}-dark-s: calc(${n} - 25%);`,`--color-${e}-hsl: var(--color-${e}-h), var(--color-${e}-s), var(--color-${e}-l);`,`--color-${e}: hsl(var(--color-${e}-hsl));`,...io.map(([a,r])=>`--color-${e}-${a}: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) * ${r}));`),...co.map(([a,r])=>`--color-${e}-${a}: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) * ${r}));`),`--color-${e}-contrast-background: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) / var(--contrast-background-value)));`,`--color-${e}-contrast-foreground: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) * var(--contrast-foreground-value)));`].join(`
...
`)}
  ...
  `}function fo(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let rt=e=>Object.prototype.toString.call(e??0).slice(8,-1),vo=e=>rt(e)=="Object",Tt=e=>rt(e)=="Function",tt=e=>["Object","Array"].includes(rt(e)),At=Object.getPrototypeOf,nt=e=>we(e)?e.val:e,we=e=>e==null?void 0:e.__isState,xo=["splice","push","pop","shift","unshift","sort","reverse"],Ge=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const K=e=>!we(e[0])&&vo(e[0])?e:[{},...e];function yo(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,r=new Set,i=!1,s,l=w=>n.createElement(w),c=(w,h,v)=>{let k=s;s=h;let E=w(v);return s=k,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(w=>{w.bindings=w.bindings.filter(h=>{var v;return(v=h.element)==null?void 0:v.isConnected}),!w.bindings.length&&!w.computed&&a.delete(w)}),o=void 0}))},d=(w,h,v,k,E,G)=>{var z;if(i){r.add(w);return}for(let V of w.bindings){let{deps:J,element:I,renderInferred:q,render:ne,renderItem:Z}=V;if(Z&&h)(z=m(I,k,(...Y)=>b(Z(...Y)),v,E,G)[h])==null||z.call();else{let Y=q?q({element:I}):ne({element:I,renderItem:Z})(...J.map(nt));Y!==I&&I.replaceWith(V.element=b(Y))}}S(w),u()},p=(w,h,v=[])=>({get(k,E,G){var z;if(s==null||s.add(w),E==="_isProxy")return!0;if(!((z=k[E])!=null&&z._isProxy)&&!we(k[E])&&tt(k[E]))k[E]=new Proxy(k[E],p(w,h,[...v,E]));else if(xo.includes(E)){let V=k[E];return(...J)=>{let I=V.apply(k,J);return d(w,E,I,J,h,v),I}}return Reflect.get(k,E,G)},set(k,E,G,z){let V=Reflect.set(k,E,G,z);return d(w,"setItem",V,{prop:E,value:G},h,[...v,E]),V}}),g=(w,h)=>new Proxy(h,p(w,h)),m=(w,h,v,k,E,G)=>{let z=()=>w.replaceChildren(...Ge(k,v)),V=J=>w[J]&&w.removeChild(w[J]);return{assign:z,sort:z,reverse:z,setItem:()=>{var I;let J=G[0];(I=w.children[J])==null||I.replaceWith(v(E[J],J))},push:()=>w.append(...Ge(h,(J,I)=>v(J,E.length+I))),unshift:()=>w.prepend(...Ge(h,v)),pop:()=>V("lastChild"),shift:()=>V("firstChild"),splice:()=>{const{length:J}=w.children;let[I,q=J,...ne]=h;for(let Z=I>=0?Math.min(I+q-1,J-1):J-1;Z>=(I>=0?I:J+I);Z--)w.children[Z].remove();if(ne.length){let Z=ne.forEach((Y,re)=>v(Y,I+re));w.children[I]?w.children[I].after(...Z):w.append(...Z)}}}},f=w=>({oldVal:w,bindings:[],listeners:[],__isState:!0,get val(){let h=this;return s==null||s.add(h),h.valProxy??(h.valProxy=tt(w)?g(h,w):w,h.valProxy)},set val(h){let v=this,k=v.val;tt(h)?(v.valProxy=g(v,h),d(v,"assign",h)):h!==k&&(v.valProxy=h,d(v)),v.oldVal=k}}),b=w=>{if(w==null||w===!1){const h=l("span");return h.style.display="none",h}else return w.nodeType?w:n.createTextNode(w)},y=(w,h)=>{let v=new Set;return h.val=c(w,v),v},x=w=>{let h=f(),v=y(w,h);h.computed=!0;for(let k of v)k.listeners.push({computed:w,deps:v,state:h});return h},S=w=>{for(let h of[...w.listeners])y(h.computed,h.state)},C=(w,...h)=>{if(h.length){let v=[];for(let k of h.flat(1/0))k!=null&&v.push(we(k)?_({deps:[k],render:()=>E=>E}):Tt(k)?j({renderInferred:k}):b(k));w.append(...v)}},T={},A=(w,h)=>w&&(Object.getOwnPropertyDescriptor(w,h)??A(At(w),h)),B=(w,h,v)=>{var k;return T[w+","+h]??(T[w+","+h]=((k=A(v,h))==null?void 0:k.set)??0)},D=(w,h)=>new t.MutationObserver((v,k)=>{v.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(G=>G===w&&(h({element:w}),k.disconnect(),!0)))}).observe(w.parentNode,{childList:!0}),$=(w,h)=>new t.MutationObserver((v,k)=>v.forEach(E=>h({record:E,element:w}))).observe(w,{childList:!0}),L=w=>new Proxy(function(v,...k){var V;let[E,...G]=K(k),z=w?n.createElementNS(w,v):l(v);for(let[J,I]of Object.entries(E)){if(J.startsWith("bau"))continue;let q=B(v,J,At(z))?ne=>ne!==void 0&&(z[J]=ne):ne=>z.setAttribute(J,ne);I==null||(we(I)?_({deps:[I],render:()=>()=>(q(I.val),z)}):Tt(I)&&(!J.startsWith("on")||I.isDerived)?j({renderInferred:()=>(q(I({element:z})),z)}):I.renderProp?_({deps:I.deps,render:()=>()=>(q(I.renderProp({element:z})(...I.deps.map(nt))),z)}):q(I))}return E.bauChildMutated&&$(z,E.bauChildMutated),C(z,...G),z.autofocus&&z.focus&&t.requestAnimationFrame(()=>z.focus()),(V=E.bauCreated)==null||V.call(E,{element:z}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:z})),E.bauUnmounted&&t.requestAnimationFrame(()=>D(z,E.bauUnmounted)),z},{get:(h,v)=>h.bind(void 0,v)}),O=(w,h,v)=>{w.element=b(v);for(let k of h)we(k)&&(a.add(k),k.bindings.push(w));return w.element},j=({renderInferred:w,element:h})=>{let v=new Set,k=c(w,v,{element:h});return O({renderInferred:w},v,k)},_=({deps:w,element:h,render:v,renderItem:k})=>O({deps:w,render:v,renderItem:k},w,v({element:h,renderItem:k})(...w.map(nt))),F=(w,h,v)=>_({deps:[w],render:({renderItem:k})=>E=>(h.append(...Ge(E,k)),h),renderItem:v}),P=w=>{i=!0,w(),i=!1,r.forEach(d),r.clear()};return{tags:L(),tagsNS:L,state:f,bind:_,loop:F,derive:x,stateSet:a,batch:P}}const wo=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},So=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Co=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function ko(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...r)=>{const i=Co(a,r),s=wo(i);return!t.getElementById(s)&&So(t,e==null?void 0:e.target,s,o(s,i)),s};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function Eo(e){const t=yo(),n=ko();return ho(n),{bau:t,...n,tr:o=>o,window,...e}}function M(...e){return e.filter(t=>t).join(" ")}function We(e,t={}){const{bau:n,window:o}=e,{div:a}=n.tags,r=()=>{};return function({animationHide:s=r,animationShow:l=r,...c},u){return a({class:M("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:d,element:p})=>{[...d.removedNodes].forEach(g=>{if(!s()||g.getAttribute("cloned"))return;const m=g.cloneNode(!0);o.requestAnimationFrame(()=>{m.setAttribute("cloned",!0),m.style.top=0,m.style.left=0,m.style.width=g.getAttribute("width"),m.style.height=g.getAttribute("height"),m.style.position="absolute",m.style.animation=s(),d.target.appendChild(m),m.addEventListener("animationend",()=>{var f;return(f=m.parentNode)==null?void 0:f.removeChild(m)})})}),[...d.addedNodes].forEach(g=>{g.getAttribute("cloned")||o.requestAnimationFrame(()=>{p.style.position="relative";const m=g.getBoundingClientRect();if(g.setAttribute("width",m.width+"px"),g.setAttribute("height",m.height+"px"),l()){g.style.animation=l();const f=()=>{g.removeEventListener("animationend",f),g.style.animation=""};g.addEventListener("animationend",f)}})})},...c},u)}}const oe=["neutral","primary","success","danger","warning"],To=["plain","outline","solid"],Ao=["sm","md","lg"],Do=()=>oe.map(e=>`
&.button.plain.${e} {
  &:focus {
...
`).join(`
`);function H(e,t={}){const{bau:n,css:o}=e,a=o`
    color: inherit;
    display: inline-flex;
    align-items: center;
    ...
    ${Do()}
  `;return function(...i){let[{size:s=t.size??"md",variant:l=t.variant??"none",color:c=t.color??"none",href:u,...d},...p]=K(i);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:M("button",t.class,l,s,c,a,d.class),href:u},p)}}const Mo="light",Bo=()=>oe.map(e=>`
...
`);function st(e,t={}){const{bau:n,css:o,window:a}=e,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Mo);const c=o`
    ...
    ${Bo()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:m=t.color??"neutral",...f},...b]=K(d);return r({required:"required",title:"Switch Theme",...f,class:M("theme-switch",m,g,p,c,t==null?void 0:t.class,f.class),type:"checkbox",checked:s()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...b)}}function Io(e){const{tr:t,bau:n,css:o,config:a,states:r}=e,{i,header:s,h1:l,div:c,a:u,img:d,b:p,ul:g,li:m}=n.tags,{svg:f,path:b}=n.tagsNS("http://www.w3.org/2000/svg"),y=r.drawerOpen,x=H(e,{class:o`
    ...
    `}),S=st(e),C=()=>i(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},b({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),T=()=>c({class:o`
        ...
        `},u({class:n`
          ...
          `},p({title:"Bau UI",links:g}),p({title:"Bau Ecosystem",links:m})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},r("v0.69.0"),r("MIT license")))}}function ve(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("list",r,u,c,l,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const He="0.3s",jt=({parent:e,grandParent:t})=>n=>{const{children:o,...a}=n,r={...a};return r.children=o==null?void 0:o.map(jt({parent:n,grandParent:e})),e&&(e.parentTree=t),r.parentTree=e,r},Gt=e=>t=>{var n;if(!e)return t;if(((n=t==null?void 0:t.data)==null?void 0:n.href)==e)return t.children?t:t.parentTree;if(t.children)for(let o=0;o<t.children.length;o++){const a=Gt(e)(t.children[o]);if(a)return a}},$o=({keyframes:e})=>({hideToLeft:e`
  from {
  ...
  `,hideToRight:e`
   ...
   `});function it(e,t={}){const{bau:n,css:o,window:a,config:r}=e,{base:i="",hashBased:s=!1}=t,l=`${r.base}${i}`,c=P=>{var w;return((w=P.parentTree.data)==null?void 0:w.href)??P.parentTree.children[0].data.href},u=({variant:P,color:w,size:h,currentTree:v,data:k})=>S(B({variant:P,color:w,size:h,href:`${l}${c(v)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),B({variant:P,color:w,size:h,href:`${l}${k.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},k.name)),d=({size:P,subTree:{data:{name:w,href:h},children:v=[]}})=>B({size:P,href:`${l}${h}`,"data-ischild":!v.length},w),p=({pathname:P,subTree:w})=>{var h;return P===((h=w==null?void 0:w.data)==null?void 0:h.href)},{renderHeader:g=u,renderMenuItem:m=d,isActive:f=p}=t,{li:b,nav:y,div:x,header:S,a:C}=n.tags,T=We(e),A=ve(e),B=H(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:D,hideToRight:$}=$o(e),L=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,O=({children:P,pathnameState:w,variant:h,color:v,size:k})=>A({class:M(h,v,k)},P.map(E=>b({class:()=>M(E.children&&"has-children",f({pathname:w.val,subTree:E})&&"active")},m({variant:h,color:v,size:k,subTree:E})))),j=({variant:P,color:w,size:h,currentTree:v,pathnameState:k})=>{const{children:E,parentTree:G,data:z,renderList:V}=v;return x({class:M("drillDownMenu",P,w,h)},G&&g({variant:P,color:w,size:h,data:z,currentTree:v}),E&&V?V({renderListDefault:O,children:E,pathnameState:k,variant:P,color:w,size:h}):O({children:E,pathnameState:k,variant:P,color:w,size:h}))},_=({tree:P,pathname:w})=>{let h=jt({})({...P}),v=Gt(w)(h);return v||(v=h),v},F=({target:P})=>{let h=P.closest("a").getAttribute("href").replace(l,"");return s||(h=h.replace(P.hash,"")),h};return function(w){const{size:h=t.size??"md",variant:v=t.variant??"plain",color:k=t.color??"neutral",tree:E,...G}=w,z=n.state(a.location.pathname.replace(l,""));let V=_({tree:E,pathname:z.val});const J=n.state(JSON.stringify(V.data));let I;a.document.addEventListener("click",Y=>{const{target:re}=Y,ce=re.closest("a");if(!ce)return;const le=ce.getAttribute("href");le&&!le.startsWith("http")&&!le.startsWith("#")&&!le.startsWith("?")&&(V=_({tree:E,pathname:F(Y)}),J.val=JSON.stringify(V.data),z.val=F({target:re}))});const q=Y=>{const{buttonback:re,ischild:ce}=Y.target.dataset;re=="true"?I=-1:ce=="false"?I=1:ce=="true"&&(I=0)},ne=Y=>{switch(Y){case 1:return`${D} ${He}`;case-1:return`${$} ${He}`;default:return""}},Z=Y=>{switch(Y){case 1:return`${$} ${He} reverse`;case-1:return`${D} ${He} reverse`;default:return""}};return y({class:M(L,v,k,h,t==null?void 0:t.class,G.class),onclick:q},T({animationHide:()=>ne(I),animationShow:()=>Z(I)},n.bind({deps:[J],render:()=>()=>j({variant:v,color:k,size:h,currentTree:V,pathnameState:z})})))}}const Lo=()=>oe.map(e=>`
&.input.${e} {
...
`);function pe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    ...
    ${Lo()}
  `;return function(s){const{variant:l=t.variant??"outline",color:c=t.color??"neutral",...u}=s;return a({type:"text",...u,class:M("input",t.class,t.size??"md",c,l,r,u.class)})}}function ct(e,t={}){const{bau:n,css:o,window:a}=e,r=pe(e,t);return function(s){const{variant:l=t.variant??"outline",color:c=t.color??"neutral",...u}=s,p=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,g=o`
      &.inputSearch {
        margin: 0.5rem 1rem;
        padding-left: 1.8rem;
        background-image: ${p};
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:M("inputSearch",t.class,g,u.class)})}}function Ht(e){const{tr:t,bau:n,css:o,config:a,states:r,window:i}=e,{div:s,ul:l,li:c,nav:u,a:d,span:p}=n.tags,g=ct(e,{variant:"plain",color:"neutral",size:"sm"}),f={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:C,variant:T,color:A,size:B})=>{const D=n.state(""),$=n.derive(()=>D.val==""?S:S.filter(O=>O.data.name.match(new RegExp(`${D.val}`,"i")))),L=O=>{D.val=O.target.value};return s({class:o`
        ...
        `},g({autocomplete:!1,name:"search",autofocus:!0,value:D,placeholder:`Search ${$.val.length} components`,size:22,oninput:L}),()=>x({children:$.val,pathnameState:C,variant:T,color:A,size:B}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Key Value List",href:"/components/keyValueList"}},{data:{name:"Lazy",href:"/components/lazy"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Multi Select",href:"/components/multiSelect"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Radio Button Group",href:"/components/radioButtonGroup"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let b=!1;const y=it(e);return function(){return s({bauMounted:({element:S})=>{i.innerWidth<=640&&(b=!0,r.drawerOpen.val=!1)},onclick:S=>{b&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(r.drawerOpen.val=!1)},style:()=>r.drawerOpen.val?"display:block;":"display:none;",class:M(o`
          ...
          `)},y({tree:f}))}}const Oo=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:r}=t.tags,i=We(e),s=Io(e),l=Ht(e),c=No(e),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"outline",color:u=t.color??"neutral",onclick:d,...p},...g]=K(s);return a({...p,onclick:d,class:M("chip",t.class,l,c,u,d&&"clickable",r,p.class)},...g)}}function Po(e){const{bau:t,css:n,config:o}=e,{div:a,h1:r,h2:i,p:s}=t.tags;H(e);const l=n`
  ...
  `,s=({title:l,Content:c})=>o({className:"feature"},a(l),r(c()));return function({featuresContent:c}){return o({class:i},c.map(s))}}function Ro({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:r,dd:i,div:s,aside:l,footer:c,a:u}=t.tags,d=({maxSize:p=151})=>({libName:g,size:m})=>s({class:n`
        ...
        `},l({class:n`
          ...
          `},g.map(d({}))),c({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function _o(e){const{bau:t,css:n,config:o}=e,{div:a,p:r,a:i,section:s}=t.tags,l=Po(e),c=zo(e),u=H(e);Ne(e);const d=Ro(e),p=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
        ...
        `},r({class:o`
          ...
          `},i(t("Pages Examples")),Go(e)()))}}function Uo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function Ut(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{const n=e[t],o=typeof n;(o==="object"||o==="function")&&!Object.isFrozen(n)&&Ut(n)}),e}class Dt{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function Ft(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function me(e,...t){const n=Object.create(null);for(const o in e)n[o]=e[o];return t.forEach(function(o){for(const a in o)n[a]=o[a]}),n}const Fo="</span>",Mt=e=>!!e.scope,Vo=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){const n=e.split(".");return[`${t}${n.shift()}`,...n.map((o,a)=>`${o}${"_".repeat(a+1)}`)].join(" ")}return`${t}${e}`};class Wo{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=Ft(t)}openNode(t){if(!Mt(t))return;const n=Vo(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){Mt(t)&&(this.buffer+=Fo)}value(){return this.buffer}span(t){this.buffer+=`<span class="${t}">`}}const Bt=(e={})=>{const t={children:[]};return Object.assign(t,e),t};class lt{constructor(){this.rootNode=Bt(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){const n=Bt({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(o=>this._walk(t,o)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{lt._collapse(n)}))}}class Ko extends lt{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){const o=t.root;n&&(o.scope=`language:${n}`),this.add(o)}toHTML(){return new Wo(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function Be(e){return e?typeof e=="string"?e:e.source:null}function Vt(e){return xe("(?=",e,")")}function Jo(e){return xe("(?:",e,")*")}function Xo(e){return xe("(?:",e,")?")}function xe(...e){return e.map(n=>Be(n)).join("")}function qo(e){const t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function ut(...e){return"("+(qo(e).capture?"":"?:")+e.map(o=>Be(o)).join("|")+")"}function Wt(e){return new RegExp(e.toString()+"|").exec("").length-1}function Zo(e,t){const n=e&&e.exec(t);return n&&n.index===0}const Yo=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function dt(e,{joinWith:t}){let n=0;return e.map(o=>{n+=1;const a=n;let r=Be(o),i="";for(;r.length>0;){const s=Yo.exec(r);if(!s){i+=r;break}i+=r.substring(0,s.index),r=r.substring(s.index+s[0].length),s[0][0]==="\\"&&s[1]?i+="\\"+String(Number(s[1])+a):(i+=s[0],s[0]==="("&&n++)}return i}).map(o=>`(${o})`).join(t)}const Qo=/\b\B/,Kt="[a-zA-Z]\\w*",pt="[a-zA-Z_]\\w*",Jt="\\b\\d+(\\.\\d+)?",Xt="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",qt="\\b(0b[01]+)",ea="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",ta=(e={})=>{const t=/^#![ ]*\//;return e.binary&&(e.begin=xe(t,/.*\b/,e.binary,/\b.*/)),me({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,o)=>{n.index!==0&&o.ignoreMatch()}},e)},Ie={begin:"\\\\[\\s\\S]",relevance:0},na={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[Ie]},oa={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[Ie]},aa={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Ke=function(e,t,n={}){const o=me({scope:"comment",begin:e,end:t,contains:[]},n);o.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const a=ut("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return o.contains.push({begin:xe(/[ ]+/,"(",a,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),o},ra=Ke("//","$"),sa=Ke("/\\*","\\*/"),ia=Ke("#","$"),ca={scope:"number",begin:Jt,relevance:0},la={scope:"number",begin:Xt,relevance:0},ua={scope:"number",begin:qt,relevance:0},da={begin:/(?=\/[^/\n]*\/)/,contains:[{scope:"regexp",begin:/\//,end:/\/[gimuy]*/,illegal:/\n/,contains:[Ie,{begin:/\[/,end:/\]/,relevance:0,contains:[Ie]}]}]},pa={scope:"title",begin:Kt,relevance:0},ma={scope:"title",begin:pt,relevance:0},ga={begin:"\\.\\s*"+pt,relevance:0},ba=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})};var Ue=Object.freeze({__proto__:null,MATCH_NOTHING_RE:Qo,IDENT_RE:Kt,UNDERSCORE_IDENT_RE:pt,NUMBER_RE:Jt,C_NUMBER_RE:Xt,BINARY_NUMBER_RE:qt,RE_STARTERS_RE:ea,SHEBANG:ta,BACKSLASH_ESCAPE:Ie,APOS_STRING_MODE:na,QUOTE_STRING_MODE:oa,PHRASAL_WORDS_MODE:aa,COMMENT:Ke,C_LINE_COMMENT_MODE:ra,C_BLOCK_COMMENT_MODE:sa,HASH_COMMENT_MODE:ia,NUMBER_MODE:ca,C_NUMBER_MODE:la,BINARY_NUMBER_MODE:ua,REGEXP_MODE:da,TITLE_MODE:pa,UNDERSCORE_TITLE_MODE:ma,METHOD_GUARD:ga,END_SAME_AS_BEGIN:ba});function ha(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function fa(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function va(e,t){t&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=ha,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function xa(e,t){Array.isArray(e.illegal)&&(e.illegal=ut(...e.illegal))}function ya(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function wa(e,t){e.relevance===void 0&&(e.relevance=1)}const Sa=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");const n=Object.assign({},e);Object.keys(e).forEach(o=>{delete e[o]}),e.keywords=n.keywords,e.begin=xe(n.beforeMatch,Vt(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},Ca=["of","and","for","in","not","or","if","then","parent","list","value"],ka="keyword";function Zt(e,t,n=ka){const o=Object.create(null);return typeof e=="string"?a(n,e.split(" ")):Array.isArray(e)?a(n,e):Object.keys(e).forEach(function(r){Object.assign(o,Zt(e[r],t,r))}),o;function a(r,i){t&&(i=i.map(s=>s.toLowerCase())),i.forEach(function(s){const l=s.split("|");o[l[0]]=[r,Ea(l[0],l[1])]})}}function Ea(e,t){return t?Number(t):Ta(e)?0:1}function Ta(e){return Ca.includes(e.toLowerCase())}const It={},fe=e=>{console.error(e)},Nt=(e,...t)=>{console.log(`WARN: ${e}`,...t)},ye=(e,t)=>{It[`${e}/${t}`]||(console.log(`Deprecated as of ${e}. ${t}`),It[`${e}/${t}`]=!0)},Ve=new Error;function Yt(e,t,{key:n}){let o=0;const a=e[n],r={},i={};for(let s=1;s<=t.length;s++)i[s+o]=a[s],r[s+o]=!0,o+=Wt(t[s-1]);e[n]=i,e[n]._emit=r,e[n]._multi=!0}function Aa(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw fe("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ve;if(typeof e.beginScope!="object"||e.beginScope===null)throw fe("beginScope must be object"),Ve;Yt(e,e.begin,{key:"beginScope"}),e.begin=dt(e.begin,{joinWith:""})}}function Da(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw fe("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ve;if(typeof e.endScope!="object"||e.endScope===null)throw fe("endScope must be object"),Ve;Yt(e,e.end,{key:"endScope"}),e.end=dt(e.end,{joinWith:""})}}function Ma(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function Ba(e){Ma(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),Aa(e),Da(e)}function Ia(e){function t(i,s){return new RegExp(Be(i),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(s?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(s,l){l.position=this.position++,this.matchIndexes[this.matchAt]=l,this.regexes.push([l,s]),this.matchAt+=Wt(s)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const s=this.regexes.map(l=>l[1]);this.matcherRe=t(dt(s,{joinWith:"|"}),!0),this.lastIndex=0}exec(s){this.matcherRe.lastIndex=this.lastIndex;const l=this.matcherRe.exec(s);if(!l)return null;const c=l.findIndex((d,p)=>p>0&&d!==void 0),u=this.matchIndexes[c];return l.splice(0,c),Object.assign(l,u)}}class o{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(s){if(this.multiRegexes[s])return this.multiRegexes[s];const l=new n;return this.rules.slice(s).forEach(([c,u])=>l.addRule(c,u)),l.compile(),this.multiRegexes[s]=l,l}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(s,l){this.rules.push([s,l]),l.type==="begin"&&this.count++}exec(s){const l=this.getMatcher(this.regexIndex);l.lastIndex=this.lastIndex;let c=l.exec(s);if(this.resumingScanAtSamePosition()&&!(c&&c.index===this.lastIndex)){const u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,c=u.exec(s)}return c&&(this.regexIndex+=c.position+1,this.regexIndex===this.count&&this.considerAll()),c}}function a(i){const s=new o;return i.contains.forEach(l=>s.addRule(l.begin,{rule:l,type:"begin"})),i.terminatorEnd&&s.addRule(i.terminatorEnd,{type:"end"}),i.illegal&&s.addRule(i.illegal,{type:"illegal"}),s}function r(i,s){const l=i;if(i.isCompiled)return l;[fa,ya,Ba,Sa].forEach(u=>u(i,s)),e.compilerExtensions.forEach(u=>u(i,s)),i.__beforeBegin=null,[va,xa,wa].forEach(u=>u(i,s)),i.isCompiled=!0;let c=null;return typeof i.keywords=="object"&&i.keywords.$pattern&&(i.keywords=Object.assign({},i.keywords),c=i.keywords.$pattern,delete i.keywords.$pattern),c=c||/\w+/,i.keywords&&(i.keywords=Zt(i.keywords,e.case_insensitive)),l.keywordPatternRe=t(c,!0),s&&(i.begin||(i.begin=/\B|\b/),l.beginRe=t(l.begin),!i.end&&!i.endsWithParent&&(i.end=/\B|\b/),i.end&&(l.endRe=t(l.end)),l.terminatorEnd=Be(l.end)||"",i.endsWithParent&&s.terminatorEnd&&(l.terminatorEnd+=(i.end?"|":"")+s.terminatorEnd)),i.illegal&&(l.illegalRe=t(i.illegal)),i.contains||(i.contains=[]),i.contains=[].concat(...i.contains.map(function(u){return Na(u==="self"?i:u)})),i.contains.forEach(function(u){r(u,l)}),i.starts&&r(i.starts,s),l.matcher=a(l),l}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=me(e.classNameAliases||{}),r(e)}function Qt(e){return e?e.endsWithParent||Qt(e.starts):!1}function Na(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return me(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:Qt(e)?me(e,{starts:e.starts?me(e.starts):null}):Object.isFrozen(e)?me(e):e}var $a="11.8.0";class La extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}}const ot=Ft,$t=me,Lt=Symbol("nomatch"),Oa=7,en=function(e){const t=Object.create(null),n=Object.create(null),o=[];let a=!0;const r="Could not find the language '{}', did you forget to load/include a language module?",i={disableAutodetect:!0,name:"Plain text",contains:[]};let s={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:Ko};function l(h){return s.noHighlightRe.test(h)}function c(h){let v=h.className+" ";v+=h.parentNode?h.parentNode.className:"";const k=s.languageDetectRe.exec(v);if(k){const E=$(k[1]);return E||(Nt(r.replace("{}",k[1])),Nt("Falling back to no-highlight mode for this block.",h)),E?k[1]:"no-highlight"}return v.split(/\s+/).find(E=>l(E)||$(E))}function u(h,v,k){let E="",G="";typeof v=="object"?(E=h,k=v.ignoreIllegals,G=v.language):(ye("10.7.0","highlight(lang, code, ...args) has been deprecated."),ye("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),G=h,E=v),k===void 0&&(k=!0);const z={code:E,language:G};P("before:highlight",z);const V=z.result?z.result:d(z.language,z.code,k);return V.code=z.code,P("after:highlight",V),V}function d(h,v,k,E){const G=Object.create(null);function z(N,R){return N.keywords[R]}function V(){if(!W.keywords){se.addText(te);return}let N=0;W.keywordPatternRe.lastIndex=0;let R=W.keywordPatternRe.exec(te),X="";for(;R;){X+=te.substring(N,R.index);const ee=ae.case_insensitive?R[0].toLowerCase():R[0],ie=z(W,ee);if(ie){const[de,to]=ie;if(se.addText(X),X="",G[ee]=(G[ee]||0)+1,G[ee]<=Oa&&(je+=to),de.startsWith("_"))X+=R[0];else{const no=ae.classNameAliases[de]||de;q(R[0],no)}}else X+=R[0];N=W.keywordPatternRe.lastIndex,R=W.keywordPatternRe.exec(te)}X+=te.substring(N),se.addText(X)}function J(){if(te==="")return;let N=null;if(typeof W.subLanguage=="string"){if(!t[W.subLanguage]){se.addText(te);return}N=d(W.subLanguage,te,!0,Ct[W.subLanguage]),Ct[W.subLanguage]=N._top}else N=g(te,W.subLanguage.length?W.subLanguage:null);W.relevance>0&&(je+=N.relevance),se.__addSublanguage(N._emitter,N.language)}function I(){W.subLanguage!=null?J():V(),te=""}function q(N,R){N!==""&&(se.startScope(R),se.addText(N),se.endScope())}function ne(N,R){let X=1;const ee=R.length-1;for(;X<=ee;){if(!N._emit[X]){X++;continue}const ie=ae.classNameAliases[N[X]]||N[X],de=R[X];ie?q(de,ie):(te=de,V(),te=""),X++}}function Z(N,R){return N.scope&&typeof N.scope=="string"&&se.openNode(ae.classNameAliases[N.scope]||N.scope),N.beginScope&&(N.beginScope._wrap?(q(te,ae.classNameAliases[N.beginScope._wrap]||N.beginScope._wrap),te=""):N.beginScope._multi&&(ne(N.beginScope,R),te="")),W=Object.create(N,{parent:{value:W}}),W}function Y(N,R,X){let ee=Zo(N.endRe,X);if(ee){if(N["on:end"]){const ie=new Dt(N);N["on:end"](R,ie),ie.isMatchIgnored&&(ee=!1)}if(ee){for(;N.endsParent&&N.parent;)N=N.parent;return N}}if(N.endsWithParent)return Y(N.parent,R,X)}function re(N){return W.matcher.regexIndex===0?(te+=N[0],1):(et=!0,0)}function ce(N){const R=N[0],X=N.rule,ee=new Dt(X),ie=[X.__beforeBegin,X["on:begin"]];for(const de of ie)if(de&&(de(N,ee),ee.isMatchIgnored))return re(R);return X.skip?te+=R:(X.excludeBegin&&(te+=R),I(),!X.returnBegin&&!X.excludeBegin&&(te=R)),Z(X,N),X.returnBegin?0:R.length}function le(N){const R=N[0],X=v.substring(N.index),ee=Y(W,N,X);if(!ee)return Lt;const ie=W;W.endScope&&W.endScope._wrap?(I(),q(R,W.endScope._wrap)):W.endScope&&W.endScope._multi?(I(),ne(W.endScope,N)):ie.skip?te+=R:(ie.returnEnd||ie.excludeEnd||(te+=R),I(),ie.excludeEnd&&(te=R));do W.scope&&se.closeNode(),!W.skip&&!W.subLanguage&&(je+=W.relevance),W=W.parent;while(W!==ee.parent);return ee.starts&&Z(ee.starts,N),ie.returnEnd?0:R.length}function Te(){const N=[];for(let R=W;R!==ae;R=R.parent)R.scope&&N.unshift(R.scope);N.forEach(R=>se.openNode(R))}let ue={};function Q(N,R){const X=R&&R[0];if(te+=N,X==null)return I(),0;if(ue.type==="begin"&&R.type==="end"&&ue.index===R.index&&X===""){if(te+=v.slice(R.index,R.index+1),!a){const ee=new Error(`0 width match regex (${h})`);throw ee.languageName=h,ee.badRule=ue.rule,ee}return 1}if(ue=R,R.type==="begin")return ce(R);if(R.type==="illegal"&&!k){const ee=new Error('Illegal lexeme "'+X+'" for mode "'+(W.scope||"<unnamed>")+'"');throw ee.mode=W,ee}else if(R.type==="end"){const ee=le(R);if(ee!==Lt)return ee}if(R.type==="illegal"&&X==="")return 1;if(Qe>1e5&&Qe>R.index*3)throw new Error("potential infinite loop, way more iterations than matches");return te+=X,X.length}const ae=$(h);if(!ae)throw fe(r.replace("{}",h)),new Error('Unknown language: "'+h+'"');const _e=Ia(ae);let Ye="",W=E||_e;const Ct={},se=new s.__emitter(s);Te();let te="",je=0,be=0,Qe=0,et=!1;try{if(ae.__emitTokens)ae.__emitTokens(v,se);else{for(W.matcher.considerAll();;){Qe++,et?et=!1:W.matcher.considerAll(),W.matcher.lastIndex=be;const N=W.matcher.exec(v);if(!N)break;const R=v.substring(be,N.index),X=Q(R,N);be=N.index+X}Q(v.substring(be))}return se.finalize(),Ye=se.toHTML(),{language:h,value:Ye,relevance:je,illegal:!1,_emitter:se,_top:W}}catch(N){if(N.message&&N.message.includes("Illegal"))return{language:h,value:ot(v),illegal:!0,relevance:0,_illegalBy:{message:N.message,index:be,context:v.slice(be-100,be+100),mode:N.mode,resultSoFar:Ye},_emitter:se};if(a)return{language:h,value:ot(v),illegal:!1,relevance:0,errorRaised:N,_emitter:se,_top:W};throw N}}function p(h){const v={value:ot(h),illegal:!1,relevance:0,_top:i,_emitter:new s.__emitter(s)};return v._emitter.addText(h),v}function g(h,v){v=v||s.languages||Object.keys(t);const k=p(h),E=v.filter($).filter(O).map(I=>d(I,h,!1));E.unshift(k);const G=E.sort((I,q)=>{if(I.relevance!==q.relevance)return q.relevance-I.relevance;if(I.language&&q.language){if($(I.language).supersetOf===q.language)return 1;if($(q.language).supersetOf===I.language)return-1}return 0}),[z,V]=G,J=z;return J.secondBest=V,J}function m(h,v,k){const E=v&&n[v]||k;h.classList.add("hljs"),h.classList.add(`language-${E}`)}function f(h){let v=null;const k=c(h);if(l(k))return;if(P("before:highlightElement",{el:h,language:k}),h.children.length>0&&(s.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(h)),s.throwUnescapedHTML))throw new La("One of your code blocks includes unescaped HTML.",h.innerHTML);v=h;const E=v.textContent,G=k?u(E,{language:k,ignoreIllegals:!0}):g(E);h.innerHTML=G.value,m(h,k,G.language),h.result={language:G.language,re:G.relevance,relevance:G.relevance},G.secondBest&&(h.secondBest={language:G.secondBest.language,relevance:G.secondBest.relevance}),P("after:highlightElement",{el:h,result:G,text:E})}function b(h){s=$t(s,h)}const y=()=>{C(),ye("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function x(){C(),ye("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let S=!1;function C(){if(document.readyState==="loading"){S=!0;return}document.querySelectorAll(s.cssSelector).forEach(f)}function T(){S&&C()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",T,!1);function A(h,v){let k=null;try{k=v(e)}catch(E){if(fe("Language definition for '{}' could not be registered.".replace("{}",h)),a)fe(E);else throw E;k=i}k.name||(k.name=h),t[h]=k,k.rawDefinition=v.bind(null,e),k.aliases&&L(k.aliases,{languageName:h})}function B(h){delete t[h];for(const v of Object.keys(n))n[v]===h&&delete n[v]}function D(){return Object.keys(t)}function $(h){return h=(h||"").toLowerCase(),t[h]||t[n[h]]}function L(h,{languageName:v}){typeof h=="string"&&(h=[h]),h.forEach(k=>{n[k.toLowerCase()]=v})}function O(h){const v=$(h);return v&&!v.disableAutodetect}function j(h){h["before:highlightBlock"]&&!h["before:highlightElement"]&&(h["before:highlightElement"]=v=>{h["before:highlightBlock"](Object.assign({block:v.el},v))}),h["after:highlightBlock"]&&!h["after:highlightElement"]&&(h["after:highlightElement"]=v=>{h["after:highlightBlock"](Object.assign({block:v.el},v))})}function _(h){j(h),o.push(h)}function F(h){const v=o.indexOf(h);v!==-1&&o.splice(v,1)}function P(h,v){const k=h;o.forEach(function(E){E[k]&&E[k](v)})}function w(h){return ye("10.7.0","highlightBlock will be removed entirely in v12.0"),ye("10.7.0","Please use highlightElement now."),f(h)}Object.assign(e,{highlight:u,highlightAuto:g,highlightAll:C,highlightElement:f,highlightBlock:w,configure:b,initHighlighting:y,initHighlightingOnLoad:x,registerLanguage:A,unregisterLanguage:B,listLanguages:D,getLanguage:$,registerAliases:L,autoDetection:O,inherit:$t,addPlugin:_,removePlugin:F}),e.debugMode=function(){a=!1},e.safeMode=function(){a=!0},e.versionString=$a,e.regex={concat:xe,lookahead:Vt,either:ut,optional:Xo,anyNumberOfTimes:Jo};for(const h in Ue)typeof Ue[h]=="object"&&Ut(Ue[h]);return Object.assign(e,Ue),e},Se=en({});Se.newInstance=()=>en({});var Pa=Se;Se.HighlightJS=Se;Se.default=Se;const Me=Uo(Pa),Ot="[A-Za-z$_][0-9A-Za-z$_]*",za=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],Ra=["true","false","null","undefined","NaN","Infinity"],tn=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],nn=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],on=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],_a=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],ja=[].concat(on,tn,nn);function an(e){const t=e.regex,n=(v,{after:k})=>{const E="</"+v[0].slice(1);return v.input.indexOf(E,k)!==-1},o=Ot,a={begin:"<>",end:"</>"},r=/<[A-Za-z0-9\\._:-]+\s*\/>/,i={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(v,k)=>{const E=v[0].length+v.index,G=v.input[E];if(G==="<"||G===","){k.ignoreMatch();return}G===">"&&(n(v,{after:E})||k.ignoreMatch());let z;const V=v.input.substring(E);if(z=V.match(/^\s*=/)){k.ignoreMatch();return}if((z=V.match(/^\s+extends\s+/))&&z.index===0){k.ignoreMatch();return}}},s={$pattern:Ot,keyword:za,literal:Ra,built_in:ja,"variable.language":_a},l="[0-9](_?[0-9])*",c=`\\.(${l})`,u="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",d={className:"number",variants:[{begin:`(\\b(${u})((${c})|\\.)?|(${c}))[eE][+-]?(${l})\\b`},{begin:`\\b(${u})\\b((${c})\\b|\\.)?|(${c})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},p={className:"subst",begin:"\\$\\{",end:"\\}",keywords:s,contains:[]},g={begin:"html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,p],subLanguage:"xml"}},m={begin:"css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,p],subLanguage:"css"}},f={begin:"gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,p],subLanguage:"graphql"}},b={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,p]},x={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:o+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},S=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,g,m,f,b,{match:/\$\d+/},d];p.contains=S.concat({begin:/\{/,end:/\}/,keywords:s,contains:["self"].concat(S)});const C=[].concat(x,p.contains),T=C.concat([{begin:/\(/,end:/\)/,keywords:s,contains:["self"].concat(C)}]),A={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:s,contains:T},B={variants:[{match:[/class/,/\s+/,o,/\s+/,/extends/,/\s+/,t.concat(o,"(",t.concat(/\./,o),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,o],scope:{1:"keyword",3:"title.class"}}]},D={relevance:0,match:t.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...tn,...nn]}},$={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},L={variants:[{match:[/function/,/\s+/,o,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[A],illegal:/%/},O={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function j(v){return t.concat("(?!",v.join("|"),")")}const _={match:t.concat(/\b/,j([...on,"super","import"]),o,t.lookahead(/\(/)),className:"title.function",relevance:0},F={begin:t.concat(/\./,t.lookahead(t.concat(o,/(?![0-9A-Za-z$_(])/))),end:o,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},P={match:[/get|set/,/\s+/,o,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},A]},w="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",h={match:[/const|var|let/,/\s+/,o,/\s*/,/=\s*/,/(async\s*)?/,t.lookahead(w)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[A]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:s,exports:{PARAMS_CONTAINS:T,CLASS_REFERENCE:D},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),$,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,g,m,f,b,x,{match:/\$\d+/},d,D,{className:"attr",begin:o+t.lookahead(":"),relevance:0},h,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[x,e.REGEXP_MODE,{className:"function",begin:w,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:s,contains:T}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:a.begin,end:a.end},{match:r},{begin:i.begin,"on:begin":i.isTrulyOpeningTag,end:i.end}],subLanguage:"xml",contains:[{begin:i.begin,end:i.end,skip:!0,contains:["self"]}]}]},L,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[A,e.inherit(e.TITLE_MODE,{begin:o,className:"title.function"})]},{match:/\.\.\./,relevance:0},F,{match:"\\$"+o,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[A]},_,O,B,P,{match:/\$[(.]/}]}}function Ga(e){return{name:"Shell Session",aliases:["console","shellsession"],contains:[{className:"meta.prompt",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]}}const Ha=e=>{const{bau:t,css:n}=e,{pre:o,code:a}=t.tags;return Me.registerLanguage("javascript",an),Me.registerLanguage("sh",Ga),function({text:i,language:s="js"}){const l=a({class:`hljs language-${s}`});return l.innerHTML=Me.highlight(i,{language:s}).value,o({class:n`
          display: inline-block;
...
"Click me"
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("paper",l,r,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}function rn(e,t={}){const{bau:n,css:o,window:a}=e,{nav:r,ul:i,li:s,a:l}=n.tags,{headerSelector:c="h2,h3"}=t,u=n.state("no"),d=(b,y)=>{let x=null;return(...S)=>{a.clearTimeout(x),x=a.setTimeout(()=>b(...S),y)}},p=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,g=({value:b,id:y,children:x=[]})=>{const S=l({class:()=>u.val==y?"active":"",href:`#${y}`});return S.innerHTML=b,s({class:()=>u.val==y?"active":""},S,x.length>0&&i(x.map(g)))},m=b=>b.tagName.charAt(1),f=({contentEl:b})=>{const y=b.querySelectorAll(c);let x=2,S={},C={children:[]},T=C;const A=T;let B=[T];return[...y].forEach(D=>{const $=m(D);D.setAttribute("id",D.textContent),!D.innerHTML.includes("<button")&&(S={value:D.innerHTML,id:D.id??D.textContent,children:[]},x==$?(C=S,T.children.push(C)):x<$?(B.push(T),T=C,C.children.push(S),C=S):x>$&&(T=B[$-1],B=B.slice(0,$-1),T.children.push(S),C=S),x=$)}),A};return function(...y){let[{size:x=t.size??"md",variant:S=t.variant??"plain",color:C=t.color??"neutral",contentEl:T,...A}]=K(y);const B=f({contentEl:T}),D=d(()=>{const L=[...T.querySelectorAll(c)].find(O=>{const{top:j,height:_}=O.getBoundingClientRect();if(j+_>60)return!0});L&&(u.val=L==null?void 0:L.id)},100);return r({...A,class:M("tableOfContent",x,S,C,p,t==null?void 0:t.class,A==null?void 0:A.class),bauMounted:()=>{a.addEventListener("scroll",D)},bauUnmounted:()=>{a.removeEventListener("scroll",D)}},B.children&&i(B.children.map(g)))}}const sn=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=t.tags;return function({Item:d,name:p}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(l(i(c(p??""),oe.map(g=>c(g)))),r(To.map(g=>i(c(g),oe.map((m,f)=>s(d({color:m,variant:g},{index:f}))))))))}},Fa=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Ao.map((i,s)=>r(e,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},U=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=t.tags;Me.registerLanguage("javascript",an);const p=rn(e),g=mt(e,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),m=sn(e),f=Fa(e),b=({text:y})=>u({class:n`
          display: inline-block;
...
`);function Je(e,t={}){const{bau:n,css:o}=e,{div:a,ul:r,li:i,h3:s,button:l}=n.tags,c=o`
    ...
    ${Va()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:m=t.color??"neutral",data:f=[],...b}]=K(d);const y=n.state(""),x=gt(e,{size:p,variant:g,color:m}),S=T=>A=>{y.val==T?y.val="":y.val=T},C=T=>{const{Header:A,Content:B,name:D}=T,$=()=>s({class:()=>M(y.val==D&&"active")},l({type:"button","aria-controls":`bau-${D}`,"aria-expanded":({element:O})=>y.val==D},A(T))),L=()=>a({id:`bau-${D}`,"data-state":({element:O})=>y.val==D},B(T));return i({class:M(m,g,p),onclick:S(D)},x({Header:$,Content:L}))};return a({class:M("accordion",c,t==null?void 0:t.class,b.class)},r(f.map(C)))}}const cn=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Je(e,t);return s=>i({...s,data:r})},Wa=e=>{const{bau:t}=e,{div:n,p:o,section:a}=t.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Je(e);return()=>a(i({data:r,color:"neutral",variant:"outline"}))},Ka=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,ln=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Ja=e=>{const{css:t}=e,n=ln(e),o=Je(e);return()=>o({color:"warning",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,qa=e=>{const{css:t}=e,n=ln(e),o=Je(e);return()=>o({color:"success",variant:"outline",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              & h3 {
...
`,Ya={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:Ka,createComponent:Wa},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Xa,createComponent:Ja},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Za,createComponent:qa}],gridItem:cn},Qa=e=>{const t=U(e);return()=>t(Ya)},er={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},tr=()=>oe.map(e=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`);function ke(e,t={}){const{bau:n,css:o}=e,{div:a,i:r}=n.tags,i=o`
    ...
    ${tr()}
  `,s=H(e),l=({onclick:c})=>s({"aria-label":"Close",onclick:c,class:"button-close"},"✖");return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"outline",color:g=t.color??"neutral",onRemove:m,...f},...b]=K(u);return a({...f,class:M("alert",`alert-${p}`,t.class,p,g,d,i,f.class),role:"alert"},r({class:"icon"},er[g]),a({class:"content"},...b),m&&l({onclick:m}))}}const un=(e,t)=>{const n=ke(e,t);return o=>n({...o},`Alert ${(t==null?void 0:t.size)??""} `)},nr=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=ke(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},or=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,fr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:gr,createComponent:mr},{title:"Component hide and show",description:"Hide and show a component",code:hr,createComponent:br}]},vr=e=>{const t=U(e);return()=>t(fr)};function Ce(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:r}=n.tags,i=a`
  ...
  `;return function(...c){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",...g},...m]=K(c);return r({...g,class:M("skeleton",u,s,t==null?void 0:t.class,g==null?void 0:g.class)},...m)}}function bt(e,t={}){const{bau:n,css:o}=e,{div:a,img:r}=n.tags,i=n.state(!0),s=n.state(!1),l=()=>i.val=!1,c=d=>{i.val=!1,s.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:m=t.variant??"plain",color:f=t.color??"neutral",width:b=40,height:y=40,alt:x,...S},...C]=K(p);const T=Ce(e,{class:M(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${y}px;
          width: ${b}px;
        `,t==null?void 0:t.class,S.class)});return a({class:M(u,t==null?void 0:t.class,S.class)},()=>i.val&&T(),()=>s.val&&x,r({alt:x,width:b,height:y,onload:l,onerror:c,class:()=>M(!i.val&&"visible",s.val&&"hide",f,m,g,u,t==null?void 0:t.class,S.class),...S}))}}const dn=(e,t)=>{const{css:n}=e,o=bt(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
`,Cr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:yr,createComponent:xr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:Sr,createComponent:wr}],gridItem:dn},kr=e=>{const t=U(e);return()=>t(Cr)};function $e(e,t){const{bau:n,css:o,window:a}=e,{dialog:r}=n.tags,i=o`
    width: fit-content;
    margin: 0;
...
100% {
  ...
  `;return function({size:u=t.size??"md",color:d=t.color??"primary",variant:p=t.variant??"outline",visibility:g=!0,...m}={}){const f=o`
      ...
      ${Er()}
    `;return r({class:{deps:[g],renderProp:()=>b=>M("spinner",f,d,p,b==!1?"":"visibility",t==null?void 0:t.class,m.class)},version:"1.1",x:"0px",y:"0px",width:Fe[u],height:Fe[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...m},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Tr=()=>oe.map(e=>`
...
`);function Xe(e,t={}){const{bau:n,css:o}=e,{div:a,li:r}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",label:p,placeholder:g,Option:m,options:f,defaultOption:b,getOptionLabel:y,getOptionValue:x,onSelect:S=()=>{},id:C,required:T,name:A,loading:B,...D},...$]=K(l);const L=$e(e),O=H(e),j=pe(e,{variant:u,color:d,size:c}),_=ve(e),F=ge(e,{variant:u,color:d,size:c}),P=n.state(b),w=n.state(D.value),h=n.state(!1),v=n.state(0),k=()=>{h.val=!1},E=n.state(f),G=Q=>ae=>Q.val&&y(ae)==y(Q.val),z=()=>{ue.openDialog(),h.val=!0,w.val="",E.val=f,v.val=f.findIndex(G(P));const Q=Te.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ce.scrollIntoView({block:"end"}))},V=()=>{ue.closeDialog(),h.val=!1,v.val=0},J=Q=>{const{value:ae}=Q.target;w.val=ae,ae?E.val=f.filter(_e=>y(_e).match(new RegExp(`${ae}`,"i"))):E.val=f},I=Q=>{ue.open?V():z()},q=Q=>{P.val=Q,le.value=x(Q)},ne=({option:Q,index:ae})=>_e=>{q(Q),v.val=ae,V()},Z=()=>{const Q=Te.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":v.val<E.val.length-1?v.val++:v.val=0,Z();break;case"ArrowUp":v.val<=0?v.val=E.val.length-1:v.val--,Z();break;case"Enter":ue.open?(q(E.val[v.val]),V()):z(),Q.preventDefault();break}},re=O({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,"aria-label":p,onclick:I,variant:u,color:d,size:c,class:B==!0&&"loading",disabled:B},()=>P.val?y(P.val):p,()=>B==!0&&F({visibility:B})),ce=j({value:w,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:J,onkeydown:Y,...D}),le=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:b&&x(b),required:T,name:A}),Te=a({class:M(u,d,c,"content")},ce,()=>_({class:M(u,d,c)},E.val.map((Q,ae)=>r({class:()=>M(v.val==ae&&"active",G(P)(Q)&&"selected"),onclick:ne({option:Q,index:ae})},m(Q))))),ue=L({id:C,triggerEl:re,contentEl:Te,onClose:k,class:o`
        overflow: hidden;
      `});return a({...D,class:M("autocomplete",i,t==null?void 0:t.class,D==null?void 0:D.class)},n.bind({deps:[P],render:()=>Q=>{Q&&(le.value=x(Q),S(Q))}}),re,le,ue)}}const pn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:r}=n.tags,i=Xe(e,t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,$r={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Dr,createComponent:Ar},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Nr,createComponent:Ir},{title:"Default Option",description:"A autocomplete with a default option.",code:Br,createComponent:Mr}],gridItem:pn},Lr=e=>{const t=U(e);return()=>t($r)};function mn(e,t={}){const{bau:n,css:o}=e,{span:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",content:d,...p},...g]=K(s);return a({...p,class:M("badge",r,t==null?void 0:t.class,p==null?void 0:p.class)},a({class:M(u,c,l)},d),...g)}}const gn=(e,t)=>{const n=mn(e,t);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},Or=e=>{const{bau:t}=e,{section:n}=t.tags,o=mn(e);return()=>n(o({content:"10"},"☏"))},Pr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,zr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Pr,createComponent:Or}],gridItem:gn},Rr=e=>{const t=U(e);return()=>t(zr)};function ht(e,t={}){const{bau:n,css:o,config:a}=e,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=t,c=H(e),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:m=t.variant??"plain",color:f=t.color??"neutral",items:b,...y},...x]=K(p);return r({...y,class:M(u,t==null?void 0:t.class,y==null?void 0:y.class)},b.map(({href:S,name:C})=>i((S!=null?c:s)({href:`${a.base}${S}`,color:f,variant:m,size:g,class:M(f,m,g)},C))))}}const bn=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=ht(e,t);return a=>o({...a,...n})},_r=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=ht(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},jr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,Ur={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:jr,createComponent:_r},{title:"Separator",description:"A breadcrumbs with a custom separator.",code:Hr,createComponent:Gr}],gridItem:bn},Fr=e=>{const t=U(e);return()=>t(Ur)},hn=(e,t={})=>{const n=H(e,t);return o=>n({...o},`${o.variant} ${o.color} ${t.size??""}`)},Vr=e=>{const{bau:t}=e,{section:n}=t.tags,o=H(e),a=()=>{alert("Click")};return()=>n(o({color:"primary",variant:"outline",onclick:a},"Click me"))},Wr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Kr=e=>{const{bau:t}=e,{section:n}=t.tags,o=H(e),a=()=>{alert("Click")};return()=>n(o({disabled:!0,color:"primary",variant:"outline",onclick:a},"Click me"))},Jr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`);function ft(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,r=o`
    ...
    ${Zr()}
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("button-group",c,u,l,r,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const fn=(e,t)=>{const n=["ONE","TWO","THREE"],o=H(e,t),a=ft(e,t);return r=>a({...r},n.map(i=>o(r,i)))},Yr=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=H(e),r=ft(e),i="primary",s="solid";return()=>n(r({color:i,variant:s},o.map(l=>a({color:i,variant:s},l))))},Qr=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,as={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:os,createComponent:ns}],gridItem:xn},rs=e=>{const t=U(e);return()=>t(as)};function ss(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,r=o`
    display: inline-block;
    position: relative;
    overflow: hidden;
    & img {
  ...
  `,i=n.state(0);return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:g,Previous:m,Next:f,...b}]=K(l);const y=()=>{i.val<=0?i.val=p.length-1:i.val--},x=()=>{i.val>=p.length-1?i.val=0:i.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},p.map(g));return a({...b,class:M("carousel",c,r,t==null?void 0:t.class,b==null?void 0:b.class)},a({class:M("control","control-previous"),onclick:y},m()),a({class:M("control","control-next"),onclick:x},f()),S)}}const is=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],cs=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,r=H(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,us={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:ls,createComponent:cs}]},ds=e=>{const t=U(e);return()=>t(us)},yn=(e,t)=>{const n=Ne(e,t);return o=>n({...o},`Chip ${o.color} ${o.variant} ${o.size??""}`)},ps=e=>{const{bau:t}=e,{section:n}=t.tags,o=Ne(e);return()=>n(o({variant:"outline",color:"primary"},"My Chip"))},ms=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,gs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:ms,createComponent:ps}],gridItem:yn},bs=e=>{const t=U(e);return()=>t(gs)};function Ee(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    margin: 0.5rem;
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({type:"checkbox",...d,class:M(r,u,c,l,t==null?void 0:t.class,d==null?void 0:d.class)})}}const wn=(e,t)=>{const{bau:n,css:o}=e,{label:a}=n.tags,r=Ee(e,t);return i=>a({class:o`
          display: flex;
...
`,vs=e=>{const{bau:t,css:n}=e,{label:o,footer:a,article:r,form:i}=t.tags,s=Ee(e,{color:"neutral",variant:"outline"}),l=H(e,{variant:"outline",color:"primary"}),c=u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.target.closest("form")));alert(JSON.stringify(d))};return()=>i({onsubmit:c,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & label {
...
`,Ts={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Es,createComponent:ks}]},As=e=>{const t=U(e);return()=>t(Ts)};function Ds(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("divider",l,r,t==null?void 0:t.class,d==null?void 0:d.class)},a({class:"content"},...p))}}const Ms=e=>{const{bau:t}=e,{section:n}=t.tags,o=Ds(e);return()=>n(o("OR"))},Bs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Is={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Bs,createComponent:Ms}],variantColorTableDisable:!0,variantSizeDisable:!0},Ns=e=>{const t=U(e);return()=>t(Is)};function $s(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...p},...g]=K(s);return a({class:M(r,t==null?void 0:t.class,p.class)},a({class:()=>M("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>M("content",d.val&&"content-open")},g))}}const Ls=e=>{const{bau:t}=e,{section:n,p:o}=t.tags,a=t.state(!1),r=$s(e),i=H(e),s=Ht(e);return()=>n(o("Click on the button to open and close the drawer."),i({color:"neutral",variant:"outline",onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),r({openState:a},s()))},Os=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function Sn(e,t={}){const{bau:n,css:o}=e,{div:a,li:r}=n.tags,i=H(e),s=$e(e),l=ve(e),c=o`
    ${Rs()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:m=t.color??"neutral",label:f,ListItem:b,items:y,...x},...S]=K(d);const C=n.state(0),T=()=>{_.openDialog(),_.focus()},A=()=>{_.closeDialog()},B=()=>{_.open?A():T()},D=F=>{B(),F.preventDefault()},$=({item:F,index:P})=>w=>{C.val=P,A(),w.preventDefault()},L=F=>{switch(F.preventDefault(),F.key){case"Escape":A();break;case"ArrowDown":C.val<options.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=options.length-1:C.val--;break;case"Enter":B();break}},O=()=>l({tabindex:"0",class:M(m,g)},y.map((F,P)=>r({class:()=>M(C.val==P&&"active"),onclick:$({item:F,index:P})},b(F)))),j=i({type:"button",onclick:D,color:m,variant:g,size:p},f),_=s({triggerEl:j,contentEl:O()});return a({...x,class:M("dropdownMenu",m,p,c,t==null?void 0:t.class,x==null?void 0:x.class),onkeydown:L},j,_)}}const _s=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,r=Sn(e,t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},js=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,r=Sn(e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Gs=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ws={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Vs,createComponent:Fs}],gridItem:(e,t)=>Cn(e,{base:"/components/drillDownMenu",hashBased:!0,...t})},Ks=e=>{const t=U(e);return()=>t(Ws)};function kn(e,t={}){const{bau:n,css:o}=e,{div:a,label:r,input:i}=n.tags,s={base:o`
      display: inline-flex;
      & input {
        width: 0.1px;
        height: 0.1px;
    ...
    `};return function(c,...u){const{size:d=t.size??"md",variant:p=t.variant??"outline",color:g=t.color??"neutral",Component:m,disabled:f,...b}=c;return a({class:M(s.base,f&&s.disabled,t==null?void 0:t.class,c.class)},r({class:M(p,g,d)},m({disabled:f}),i({type:"file",disabled:f,...b})))}}const En=(e,t)=>{const{tr:n,bau:o,css:a,config:r}=e,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=kn(e,t),p=m=>{const f=m.target.files[0];f?u.val=f.name:u.val="No file selected"},g=({disabled:m})=>l({class:M(a`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,m&&a`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${r.base}/uploadIcon.svg#Capa_1`})),c(n("Choose a file to upload")));return m=>d({Component:g,name:"file",accept:"text/*",onchange:p,...m})},Js=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:r,use:i}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,span:c}=n.tags,u=n.state("No file selected"),d=kn(e),p=m=>{const f=m.target.files[0];f?u.val=f.name:u.val="No file selected"},g=({disabled:m})=>l({class:M(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`,qs={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Xs,createComponent:Js}],gridItem:En},Zs=e=>{const t=U(e);return()=>t(qs)};function Le(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",content:d,...p},...g]=K(s);return a({...p,class:M("form",u,c,l,r,t==null?void 0:t.class,p==null?void 0:p.class)},...g)}}function vt(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:r}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,s=o`
  ...
  `;return function(...c){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:g,...m},...f]=K(c);const b=H(e),y=ge(e);return n.bind({deps:[g],render:()=>x=>b({...m,class:M("loadingButton",u,d,p,s,x&&"loading",t==null?void 0:t.class,m==null?void 0:m.class)},y({size:u,variant:d,color:p,visibility:x}),r({class:x&&"loading"},f))})}}const Ys=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:r,header:i,label:s,img:l,footer:c}=t.tags,u=vt(e),d=ke(e,{variant:"outline",color:"danger"}),p=pe(e),g=Le(e,{class:n`
      max-width: 400px;
      & > header {
        text-align: center;
      }
...
`,ci={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:ii,createComponent:si}],gridItem:Tn},li=e=>{const t=U(e);return()=>t(ci)},An=(e,t={})=>{const n=ct(e,t);return o=>n({name:`myinputSearch-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinputSearch-gallery-${t.color??o.color}-${t.variant??o.variant}-${o.size??t.size}`,placeholder:"Enter text",...o})},ui=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=ct(e);return()=>n(o("Basic inputSearch"),a({id:"my-inputSearch",name:"my-inputSearch",placeholder:"Enter Text"}),o("Disabled inputSearch"),a({name:"my-inputSearch-disabled",placeholder:"Enter Text",disabled:!0}))},di=`import inputSearch from "@grucloud/bau-ui/inputSearch";
import { Context } from "@grucloud/bau-ui/context";
...
`,pi={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:di,createComponent:ui}],gridItem:An},mi=e=>{const t=U(e);return()=>t(pi)};function Dn(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("keyValueList",r,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const gi=e=>{const{bau:t}=e,{section:n,li:o,label:a,span:r}=t.tags,i=Dn(e);return()=>n(i(o(a("My label"),r("My Value")),o(a("My other label"),r("My Other Value"))))},bi=`import keyValueList from "@grucloud/bau-ui/keyValueList";
import { Context } from "@grucloud/bau-ui/context";
...
`,hi=e=>{const{bau:t,css:n}=e,{section:o,li:a,label:r,span:i}=t.tags,s=Dn(e,{class:n`
      &.keyValueList {
        flex-direction: row;
        gap: 1rem;
      }
...
`,ki=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=t.state(!1),r=Bn(e,{loading:()=>o("My Custom Loading"),error:s=>o("My Custom Error")}),i=H(e);return()=>n(i({onclick:()=>a.val=!a.val},()=>a.val?"Hide":"Show"),()=>a.val&&r({getModule:()=>Mn(()=>import("./myComponent-a7adf959.js"),[]),props:{message:"Additional Props here"}}))},Ei=`import { Context } from "@grucloud/bau-ui/context";
import lazy from "@grucloud/bau-ui/lazy";
import button from "@grucloud/bau-ui/button";
export default (context: Context) => {
  const { bau } = context;
...
`,Ti={title:"Lazy",package:"lazy",description:"The lazy component delays the loading of a component, hence improving the initial bundle size.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/lazy/lazy.js",importStatement:'import lazy from "@grucloud/bau-ui/lazy";',examples:[{title:"Simple",description:"Lazy load a component.",code:Ci,createComponent:Si},{title:"Custom Loader",description:"Custom loader and error",code:Ei,createComponent:ki}]},Ai=e=>{const t=U(e);return()=>t(Ti)};function In(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:r}=n.tags,i=()=>oe.map(c=>`
&.${c}{
...
`,Li={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:$i,createComponent:Ni}],gridItem:$n},Oi=e=>{const t=U(e);return()=>t(Li)},Pi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],zi=(e,t)=>{const{bau:n,css:o}=e,{span:a,li:r}=n.tags,i=ve(e,t),s=({code:l,label:c})=>r({class:o`
          display: flex;
          gap: 1rem;
...
`).join(`
`))()}
  `;return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"plain",color:g=t.color??"neutral",...m},...f]=K(u);const b=r({...m,bauMounted:()=>{new URLSearchParams(a.location.search).get("modal")==(m.id??"modal")&&b.showModal()},class:M("modal",l,g,p,d,t==null?void 0:t.class,m==null?void 0:m.class)},f);return new MutationObserver(x=>{const S=new URLSearchParams(a.location.search);x[0].attributeName=="open"&&(b.open?S.set("modal",b.id??"modal"):S.delete("modal"),a.history.pushState("","",`?${S.toString()}`))}).observe(b,{attributes:!0}),b}}const On=(e,t={})=>{const{bau:n}=e,{form:o,section:a,main:r,header:i,footer:s,p:l,h1:c}=n.tags,u=H(e),d=Ln(e,t),p=()=>r(Array(20).fill("").map((m,f)=>l(f+1,". Some text here"))),g=m=>{const f=d({id:`dialog-${m.color}-${m.variant}-${t.size}`,...m},o(i(c("Header")),p(),s(u({variant:"outline",color:m.color,onclick:()=>{f.close()}},"Cancel"),u({variant:"solid",color:m.color,onclick:()=>{f.close()}},"OK"))));return f};return m=>{const f=g(m);return a(u({...m,onclick:()=>{f.showModal()}},"OPEN MODAL"),f)}},Ui=e=>{const{bau:t}=e,{form:n,section:o,main:a,header:r,footer:i,p:s}=t.tags,l="neutral",c=H(e),u=Ln(e),d=()=>a(Array(10).fill("").map((g,m)=>s(m+1,". Some text here"))),p=u({id:"my-dialog"},n(r("Header"),d(),i(c({variant:"outline",color:l,onclick:()=>{p.close()}},"Cancel"),c({variant:"solid",color:l,onclick:()=>{p.close()}},"OK"))));return()=>o(c({variant:"solid",color:"neutral",onclick:()=>{p.showModal()}},"OPEN MODAL"),p)},Fi=`import modal from "@grucloud/bau-ui/modal";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function Ji(e,t={}){const{bau:n,css:o}=e,{div:a,li:r,select:i}=n.tags,s=H(e),l=$e(e),c=ve(e),u=Ee(e,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Ki()}
  `;return function(...g){let[{size:m=t.size??"md",variant:f=t.variant??"outline",color:b=t.color??"neutral",name:y,label:x,Option:S,options:C,defaultValue:T=[],getOptionLabel:A,getOptionValue:B,renderValue:D,onSelect:$=()=>{},loading:L,...O},...j]=K(g);const _=ge(e,{variant:f,color:b,size:m}),F=n.state(T),P=n.state(!1),w=n.state(0),h=()=>{q.openDialog(),q.focus(),P.val=!0},v=()=>{q.closeDialog(),P.val=!1},k=()=>{P.val=!1},E=Z=>{q.open?v():h(),Z.preventDefault()},G=()=>Array.from(ne.selectedOptions).map(({value:Z})=>C.find(Y=>B(Y)==Z)),z=Z=>{switch(Z.preventDefault(),Z.key){case"Escape":v();break;case"ArrowDown":w.val<C.length-1?w.val++:w.val=0;break;case"ArrowUp":w.val<=0?w.val=C.length-1:w.val--;break;case"Enter":if(q.open){const Y=Z.currentTarget.querySelectorAll("input")[w.val];Y.checked=!Y.checked;const re=ne.options[w.val+1];re.selected=!re.selected,F.val=G()}else h();break}},V=Z=>Y=>{const re=[...ne.options].find(({value:ce})=>ce==B(Z));Y.target.checked?re.selected=!0:re.selected=!1,F.val=G()},J=()=>c({tabindex:"0",class:M(b,f)},C.map((Z,Y)=>r({class:()=>M(w.val==Y&&"active")},n.tags.label(u({checked:T.find(re=>B(re)==B(Z)),name:`${y}-${B(Z)}`,onchange:V(Z)}),S(Z))))),I=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":P,"aria-label":x,onclick:E,color:b,variant:f,size:m,class:L==!0&&"loading",disabled:L},()=>F.val.length?D(F.val):x,()=>L==!0&&_({visibility:L})),q=l({triggerEl:I,contentEl:J(),onClose:k}),ne=i({name:y,multiple:!0,...O},n.tags.option({value:""},"--Category--"),C.map(Z=>n.tags.option({value:B(Z),selected:T.find(Y=>B(Y)==B(Z))},A(Z))));return a({...O,class:M("multiSelect",b,m,d,t==null?void 0:t.class,O==null?void 0:O.class),onkeydown:z},ne,I,q)}}const Xi=e=>{const{bau:t,css:n}=e,{div:o,span:a,form:r,footer:i}=t.tags,s=Ji(e),l=H(e,{variant:"outline",color:"neutral"}),c=Ne(e,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=g=>a(g.group),p=g=>{g.preventDefault();const{selectedOptions:m}=g.target.elements.myMultiSelect;var f=Array.from(m).map(({value:b})=>b);alert(JSON.stringify(f))};return()=>r({onsubmit:p,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
&.radio-button.${s} {
  ...
  `).join(`
`))()}
  `;return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",...p}]=K(l);return a({...p,type:"radio",class:M("radio-button",c,d,u,i,t==null?void 0:t.class,p==null?void 0:p.class)})}}const Pn=(e,t)=>{const{bau:n,css:o}=e,{label:a,form:r}=n.tags,i=xt(e,t);return s=>r({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,fc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:hc,createComponent:bc}],gridItem:Pn},vc=e=>{const t=U(e);return()=>t(fc)};function qe(e,t={}){const{bau:n,css:o}=e,{div:a,label:r}=n.tags,i=xt(e),l=o`
  ...
  `).join(`
`))()};
  `;return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"none",color:g=t.color??"neutral",name:m,oninput:f,value:b,radios:y=[],...x}]=K(u);return a({...x,class:M("radioButtonGroup",d,g,p,l,t==null?void 0:t.class,x==null?void 0:x.class)},y.map(({id:S,Label:C})=>r(i({size:d,variant:p,color:g,id:S,name:m,checked:b==S,value:S,oninput:f}),C())))}}const xc=e=>{const{bau:t}=e,{form:n,article:o,footer:a,p:r}=t.tags,i=qe(e),s=H(e,{variant:"outline",color:"primary"}),l=t.state("two"),c=({target:d})=>l.val=d.id,u=d=>{d.preventDefault(),alert(l.val)};return()=>n({onsubmit:u},o(i({oninput:c,name:"myRadio",value:l.val,radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]}),r("CheckedState: ",l)),a(s({type:"submit"},"Submit")))},yc=`import { Context } from "@grucloud/bau-ui/context";
...
`,wc=e=>{const{bau:t}=e,{form:n,article:o,footer:a}=t.tags,r=qe(e),i=H(e,{variant:"outline",color:"primary"}),s=l=>{l.preventDefault();const c=l.target.closest("form"),u=Object.fromEntries(new FormData(c));alert(JSON.stringify(u))};return()=>n({onsubmit:s},o(r({name:"myRadio",value:"one",radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},Sc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Ec=e=>{const{bau:t}=e,{form:n,article:o,footer:a,small:r,div:i}=t.tags,s=qe(e),l=H(e,{variant:"outline",color:"primary"}),c=u=>{u.preventDefault();const d=u.target.closest("form"),p=Object.fromEntries(new FormData(d));alert(JSON.stringify(p))};return()=>n({onsubmit:c},o(s({name:"git_provider_type",value:"",radios:[{id:"GitHub",Label:()=>i("GitHub",r("Login with GitHub"))},{id:"GitLab",Label:()=>i("GitLab",r("Login with GitLab"))}]})),a(l({type:"submit"},"Submit")))},Tc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function Oe(e,t={}){const{bau:n,css:o}=e,{div:a,li:r,select:i,option:s}=n.tags,l=H(e),c=$e(e),u=ve(e),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Mc()}
  `;return function(...g){let[{size:m=t.size??"md",variant:f=t.variant??"outline",color:b=t.color??"neutral",label:y,Option:x,options:S,defaultOption:C,getOptionLabel:T,getOptionValue:A,onSelect:B=()=>{},loading:D,...$},...L]=K(g);const O=ge(e,{variant:f,color:b,size:m}),j=n.state(C?T(C):y),_=n.state(!1),F=n.state(0),P=()=>{V.openDialog(),V.focus(),_.val=!0},w=()=>{V.closeDialog(),_.val=!1},h=()=>{_.val=!1},v=I=>{V.open?w():P(),I.preventDefault()},k=({option:I,index:q})=>ne=>{j.val=T(I),J.value=A(I),J.setCustomValidity(""),F.val=q,w(),B(I),ne.preventDefault()},E=I=>{switch(I.preventDefault(),I.key){case"Escape":w();break;case"ArrowDown":F.val<S.length-1?F.val++:F.val=0;break;case"ArrowUp":F.val<=0?F.val=S.length-1:F.val--;break;case"Enter":V.open?(j.val=T(S[F.val]),J.value=A(s),w()):P();break}},G=()=>u({tabindex:"0",class:M(b,f)},S.map((I,q)=>r({class:()=>M(F.val==q&&"active"),onclick:k({option:I,index:q})},x(I)))),z=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":_,"aria-label":y,onclick:v,color:b,variant:f,size:m,class:D==!0&&"loading",disabled:D},()=>!j.val&&y,j,()=>D==!0&&O({visibility:D})),V=c({triggerEl:z,contentEl:G(),onClose:h}),J=i($,s({value:""},"--Select Category--"),S.map(I=>s({value:A(I)},T(I))));return J.value=$.value,a({...$,class:M("select",b,m,d,t==null?void 0:t.class,$==null?void 0:$.class),onkeydown:E},J,z,V)}}const zn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:r}=n.tags,i=Oe(e,t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Pc=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:r}=t.tags,i=H(e,{variant:"outline"}),s=Oe(e),l=t.state([]),c=t.state(!1),u=t.state("");async function d({url:m,transform:f=b=>b}){try{c.val=!0;const b=await fetch(m,{});if(b.ok){const y=await b.json();l.val=f(y)}else u.val=b.statusText}catch(b){u.val=b.message}finally{c.val=!1}}const p=()=>d({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:m=>m.sort((f,b)=>f.name.common.localeCompare(b.name.common))});p();const g=m=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(m.flag),r(m.name.common));return()=>o(a({class:n`
...
`,Rc={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Ic,createComponent:Bc},{title:"Default Option",description:"Select with a default option",code:$c,createComponent:Nc},{title:"Select AWS region",description:"Select the AWS region",code:Oc,createComponent:Lc},{title:"Loading Indicator",description:"Select with a loading indicator",code:zc,createComponent:Pc}],gridItem:zn},_c=e=>{const t=U(e);return()=>t(Rc)};function Rn(e,t={}){const{bau:n,css:o}=e,{select:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"outline",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("select-native",u,l,c,r,t==null?void 0:t.class,d==null?void 0:d.class)},p)}}const _n=(e,t)=>{const{bau:n}=e,{option:o}=n.tags,a=Rn(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a(i,r.map(({label:s,phone:l})=>o({value:l},s)))},jc=e=>{const{bau:t}=e,{section:n,option:o}=t.tags,a=Rn(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>n(a(r.map(({label:i,phone:s})=>o({value:s},i))))},Gc=`import selectNative from "@grucloud/bau-ui/selectNative";
import { Context } from "@grucloud/bau-ui/context";
...
`,Hc={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Gc,createComponent:jc}],gridItem:_n},Uc=e=>{const t=U(e);return()=>t(Hc)},Fc=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,r=Ce(e),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`),Hn=(e,t)=>(n,o)=>{const a=new URLSearchParams(e.window.location.search);return a.delete(t),a.append(t,n),o&&Object.entries(o).map(([r,i])=>(a.delete(r),a.append(r,i))),`?${a.toString()}`};function Un(e,t={}){const{bau:n,css:o,window:a}=e,{div:r,ul:i,li:s,span:l,section:c}=n.tags,u=o`
  ...
  `;return function(...p){let[{color:g,variant:m="plain",size:f,stepperDefs:b=[],stepperName:y,activeStepIndex:x=n.state(0),...S},...C]=K(p);const T=n.state(b.map((O,j)=>({...O,index:j}))),A=n.state([]);a.history.pushState=new Proxy(a.history.pushState,{apply:(O,j,_)=>{O.apply(j,_);const F=_[2]??"";console.log("stepper pushState ",F),["?","#"].includes(F[0])&&L()}});const B=n.derive(()=>T.val[x.val]),D=O=>{const{Header:j,disabled:_,name:F,index:P}=O;return s({class:()=>M(B.val.name==F&&"active",x.val<P&&"not-completed",x.val>P&&"completed",_&&"disabled")},l({class:"step-number"},P+1),l({class:"step-label"},()=>j(O)))},$=O=>b.findIndex(({name:j})=>j==O.name),L=()=>{const j=new URLSearchParams(a.location.search).get(y)??b[0].name,_=Math.max(b.findIndex(({name:F})=>F==j),0);_<x.val&&(console.log("remove last step"),A.val.pop()),A.val.some(({name:F})=>j==F)||(console.log("add new step"),A.val.push(b[_])),x.val=_};return L(),r({bauMounted:({element:O})=>{a.addEventListener("popstate",L)},bauUnmounted:()=>{a.removeEventListener("popstate",L)},class:M("stepper",m,f,g,u,t==null?void 0:t.class,S.class)},n.loop(T,i(),D),n.loop(A,c(),O=>r({class:()=>M("content",O.name==B.val.name&&"visible")},O.Content({nextStep:b[$(O)+1],previousStep:b[$(O)-1]}))))}}const zt="my-wizard",ml=e=>{const{bau:t,window:n}=e,{footer:o,p:a,label:r,section:i,a:s,ul:l,li:c}=t.tags,u=pe(e),d=Le(e),p=Un(e),g=Hn(e,zt),m=H(e,{variant:"outline",color:"primary"}),f=H(e,{variant:"solid",color:"primary"}),b=({nextStep:S})=>C=>{C.preventDefault();const{organization:T}=C.target.elements;n.history.pushState("","",g(S.name,{organization:T.value}))},y=S=>{var B;S.preventDefault();const{organization:C}=(B=n.document.forms)==null?void 0:B.formStep1.elements,A=new URLSearchParams(n.location.search).get("choice");alert(`organization ${C.value}, choice:${A}`)},x=[{name:"step1",Header:()=>"Step 1",Content:({nextStep:S})=>d({onsubmit:b({nextStep:S}),id:"formStep1"},r("Organization",u({autofocus:!0,placeholder:"Organization",name:"organization"})),o(f({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:S,previousStep:C})=>d(l(c(s({href:g(S.name,{choice:"choice1"})},"Choice 1")),c(s({href:g(S.name,{choice:"choice2"})},"Choice 2"))),o(m({href:g(C.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:S})=>d({onsubmit:y},a("My stepper 3 Content"),o(m({href:g(S.name)},"Previous: Step 2"),f({type:"submit"},"Save")))}];return()=>i(p({stepperDefs:x,stepperName:zt}))},gl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,Rt="stepper-vertical",bl=e=>{const{bau:t,window:n,css:o}=e,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=t.tags,d=pe(e),p=Le(e),g=Un(e,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`).join(`
`);function Fn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    cursor: pointer;
    position: relative;
    ...
    ${xl()}
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(s);return a({...d,class:M("switch",r,u,c,l,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...p)}}const Vn=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:r}=n.tags,i=Fn(e,t);return s=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},yl=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:r}=t.tags,i=Fn(e);return()=>o(a(r({class:n`
              display: flex;
              align-items: center;
              gap: 0.5rem;
...
`,Sl={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:wl,createComponent:yl}],gridItem:Vn},Cl=e=>{const t=U(e);return()=>t(Sl)},kl=()=>oe.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
`);function Pe(e,t={}){const{bau:n,css:o,window:a}=e,{tabDefs:r}=t,{div:i,ul:s,li:l,a:c}=n.tags,u=o`
    ...
    ${kl()}
  `;return function(...p){let[{size:g=t.size??"md",variant:m=t.variant??"plain",color:f=t.color??"neutral",tabsKey:b="tabs",...y},...x]=K(p);const S=n.state(r),C=L=>S.val.find(O=>O.name==L),T=n.state(r[0]),A=()=>{var _,F;const O=new URLSearchParams(a.location.search).get(b)??r[0].name,j=C(O);(_=T.val.exit)==null||_.call(),T.val=j,(F=j==null?void 0:j.enter)==null||F.call()};A(),a.history.pushState=new Proxy(a.history.pushState,{apply:(L,O,j)=>{L.apply(O,j);const _=j[2]??"";["?","#"].includes(_[0])&&A()}});const B=L=>{const O=new URLSearchParams(a.location.search);return O.delete(b),O.append(b,L),`?${O.toString()}`},D=L=>{const{Header:O,disabled:j,name:_}=L;return l({class:()=>M(T.val.name==_&&"active",j&&"disabled")},c({href:B(_)},O(L)))},$=i({class:M("tabs",m,g,f,u,t==null?void 0:t.class,y.class),bauMounted:({element:L})=>{a.addEventListener("popstate",A)},bauUnmounted:()=>{a.removeEventListener("popstate",A)}},n.loop(S,s(),D),n.bind({deps:[T],render:()=>({Content:L})=>L?L(y):""}));return $.addEventListener("tab.add",L=>{var j;const{tab:O}=L.detail;(j=O.enter)==null||j.call(),S.val.push(O)},!1),$.addEventListener("tab.remove",L=>{var j;const O=S.val.findIndex(_=>_.name==L.detail.tabName);O>0&&((j=S.val[O].exit)==null||j.call(),S.val.splice(O,1))},!1),$}}const El=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,r=Pe(e,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]});return()=>r({})},Tl=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Wn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>"TAB",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]},Ml=e=>{const{css:t}=e,n=Pe(e,{tabDefs:Wn(e),class:t`
...
`,Il=e=>{const{css:t}=e,n=Wn(e),o=Pe(e,{tabDefs:n,class:t`
      & ul {
        justify-content: center;
      }
...
`;const i=o`
    ...
    width: fit-content;
  `;return function(...l){let[{...c},...u]=K(l);return r({...c,class:M("table-container",i,t==null?void 0:t.class,c==null?void 0:c.class)},...u)}}const Ol=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=t.tags;function d(b,y,x,S,C){return{name:b,calories:y,fat:x,carbs:S,protein:C}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],g=({name:b,calories:y})=>i(r(b),r({class:n`
            text-align: right;
          `},y)),m=()=>l(i(a({class:n`
              text-align: left;
...
`,Kl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Wl,createComponent:Vl}]},Jl=e=>{const t=U(e);return()=>t(Kl)};function Kn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,r=ft(e),i=H(e),s=ge(e),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:m,icon:f,...b})=>i({"aria-label":m,title:m,...b},f),u=({count:m,totalCount:f,page:b,rowsPerPage:y})=>a({class:"pages-numbers"},Number(b-1)*Number(y)+(m>0?1:0),"-",Math.min(b*y,f)," of ",f),d=({count:m,page:f,rowsPerPage:b})=>a({class:"pages-numbers"},(f-1)*b+(m>0?1:0),"-",f*b),p=m=>m<=1,g=(m,f,b)=>m>=Math.ceil(f/b);return function(...f){let[{size:b=t.size??"md",variant:y=t.variant??"outline",color:x=t.color??"neutral",count:S=0,totalCount:C=0,page:T=1,rowsPerPage:A=50,onPageChange:B,isLoading:D=!1,disableFirst:$=()=>p(T),disablePrevious:L=()=>p(T),disableNext:O=()=>g(T,C,A),disableLast:j=()=>g(T,C,A),..._},...F]=K(f);const P=Math.max(0,Math.ceil(C/A)),w=B({page:1}),h=B({page:T-1}),v=B({page:T+1}),k=B({page:P}),E=[{label:"First",icon:"⟪",onclick:w,disabled:$()},{label:"Previous",icon:"⟨",onclick:h,disabled:L()},{label:"Next",icon:"⟩",onclick:v,disabled:O()},{label:"Last",icon:"⟫",onclick:k,disabled:j()}];return a({..._,class:M("table-pagination",l,D&&"disabled",t==null?void 0:t.class,_==null?void 0:_.class)},s({class:"spinner",visibility:D,size:"md"}),C>0?u({count:S,totalCount:C,page:T,maxPages:P,rowsPerPage:A}):d({count:S,page:T,maxPages:P,rowsPerPage:A}),r({variant:y,color:x},E.map(G=>c({...G,variant:y,color:x}))))}}const Xl=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),ql=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=t.tags,c=Xl(45),u=({name:x,email:S})=>r(a(x),a(S)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),p=Kn(e),g=ze(e,{class:n`
      max-width: 650px;
    `}),m=t.state(c),f=t.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),b=t.derive(()=>m.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),y=({page:x})=>S=>{f.val.page=x};return()=>g(i(d(),()=>l(b.val.map(u))),()=>p({...f.val,onPageChange:y}))},Zl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),g=t.derive(()=>d.val.length),m=t.state(1),f=t.state(10),b=t.derive(()=>d.val),y=$=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams($).toString()}`,x=({page:$})=>L=>{m.val=$,S(y({page:$,per_page:f.val}))};S(y({page:1,per_page:f.val}));async function S($){try{u.val=!0;const L=await fetch($,{});if(L.ok){const O=await L.json();d.val=O;return}throw L}catch(L){p.val=L.message}finally{u.val=!1}}const C=({name:$,description:L,stargazers_count:O})=>r(a($),a(L),a({class:n`
            text-align: right;
          `},O)),T=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),A=Kn(e),B=ze(e,{class:n`
      min-width: 650px;
    `}),D=({message:$})=>c($);return()=>B(()=>A({rowsPerPage:f.val,page:m.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:x,disableNext:()=>!1}),i(T(),()=>p.val&&D({message:p.val}),()=>l(b.val.map(C))))},Yl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:r,h2:i,tr:s}=t.tags,l=ql(e),c=Zl(e),u=(...d)=>a({class:n`
...
`,tu={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:eu,createComponent:Ql}],gridItem:Jn},nu=e=>{const t=U(e);return()=>t(tu)},ou=()=>oe.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`);function yt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,r=o`
    ...
    ${ou()}
  `;return function(...s){let[{size:l=t.size??"md",variant:c=t.variant??"outline",color:u=t.color??"neutral",exclusive:d=!1,onChange:p=()=>{},...g},...m]=K(s);const f=new Set,b=y=>{const{value:x}=y.target;d?(f.clear(),f.add(x)):f.has(x)?f.delete(x):f.add(x),p({event:y,values:[...f]})};return a({...g,class:M("toggle-group",l,u,c,r,t==null?void 0:t.class,g==null?void 0:g.class),onclick:b},...m)}}const Xn=(e,t)=>{const{bau:n}=e,o=yt(e,t),a=Re(e,t);return r=>{const i=n.state([""]),s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...r,onChange:({values:c})=>{i.val=c}},s.map(({label:c,value:u})=>()=>a({...r,value:u,selected:i.val.includes(u),"area-label":c},c)))}},au=e=>{const{bau:t}=e,{section:n}=t.tags,o=t.state([""]),a=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],r=Re(e),i=yt(e),s="primary",l="solid",c=({values:u})=>{o.val=u};return()=>n(i({color:s,variant:l,exclusive:!0,onChange:c},a.map(({label:u,value:d})=>()=>r({color:s,variant:l,value:d,selected:o.val.includes(d),"area-label":u},u))))},ru=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
...
`,cu={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:ru,createComponent:au},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:iu,createComponent:su}],gridItem:Xn},lu=e=>{const t=U(e);return()=>t(cu)};function wt(e,t={}){const{bau:n,css:o,window:a}=e,{div:r}=n.tags,i=o`
  ...
  `;return function(...l){let[{titleEl:c,side:u="bottom-start",size:d=t.size??"md",variant:p=t.variant??"outline",color:g=t.color??"neutral",...m},...f]=K(l);const b=r({class:M("container",...u.split("-"))},r({class:M("content",g,p,d),role:"tooltip"},c)),y=B=>`move-to-${B}`,x=(B,D,$)=>{if(B()){const L=y(D);b.classList.add(L),b.classList.add(D),b.classList.remove($)}},S=(B,D)=>{const $=y(B);b.classList.contains($)&&(b.classList.remove($),b.classList.add(D),b.classList.remove(B))},C=B=>{const D=b.getBoundingClientRect();x(()=>D.x<0,"right","left"),x(()=>D.x+D.width>a.innerWidth,"left","right"),x(()=>D.y<0,"bottom","top"),x(()=>D.bottom>a.innerHeight,"top","bottom"),b.classList.add("visible")},T=B=>{b.classList.remove("visible"),S("right","left"),S("left","right"),S("bottom","top"),S("top","bottom")};return r({...m,class:M("tooltip",i,t==null?void 0:t.class,m==null?void 0:m.class),bauMounted:({element:B})=>{B.addEventListener("mouseover",C),B.addEventListener("mouseout",T)},bauUnmounted:({element:B})=>{B.removeEventListener("mouseover",C),B.removeEventListener("mouseout",T)}},...f,b)}}const qn=(e,t)=>{const{bau:n}=e,{div:o,p:a,em:r}=n.tags,i=H(e),s=wt(e,t),l=()=>o(a("A ",r("tooltip")," can be any component"));return c=>s({titleEl:l(),...c},i(c,`${c.color} ${c.variant}`))},uu=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,r=H(e),i=wt(e),s=()=>n(o("A ",a("tooltip")," can be any component"));return()=>i({side:"bottom-start",titleEl:s()},r("tooltip"))},du=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,vu={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:fu,createComponent:hu}],gridItem:Zn},xu=e=>{const t=U(e);return()=>t(vu)},Yn=({parent:e,grandParent:t})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Yn({parent:n,grandParent:e})),e&&(e.parent=t),r.parent=e,r},yu=({css:e,createGlobalStyles:t})=>(t`
:root {
...
`,{nav:e`
  ...
  `});function St(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:r}=t,{ul:i,li:s,nav:l,div:c}=n.tags,u=yu({css:o,createGlobalStyles:a}),d=gt(e),p=({depth:g=1,maxDepth:m,parent:f,color:b,variant:y,size:x})=>S=>{const{children:C,expanded:T}=S,A=n.state(!T),B=()=>c({class:o`
              cursor: ${C?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:$=>{C&&(A.val=!A.val)}},r({item:S,parent:f,depth:g})),D=()=>i({class:M(b,x)},C.map(p({depth:g+1,maxDepth:m,parent:S})));return s(d({expanded:T,Header:B,Content:C&&g<m&&D}))};return function({tree:m,maxDepth:f=1/0,size:b=t.size??"md",variant:y=t.variant??"outline",color:x=t.color??"neutral",...S}){return l({class:M(u.nav,b,y,x,t==null?void 0:t.class,S.class)},i(p({maxDepth:f,color:x,variant:y,size:b})(Yn({})({...m}))))}}const Qn=(e,t)=>{const{bau:n}=e,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=St(e,{renderMenuItem:({item:{data:{name:s,href:l}}})=>o({href:l},s),...t});return s=>i({...s,tree:a})},wu=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},r=St(e,{renderMenuItem:({item:{data:{name:i,href:s}}})=>n({href:s},i)});return()=>r({tree:o})},Su=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,Cu=e=>{const{bau:t,css:n,window:o}=e,{form:a,label:r,article:i,footer:s}=t.tags,l=Ee(e,{color:"neutral",variant:"outline"}),c=H(e,{variant:"solid",color:"danger"}),u=t.state(0),d=C=>{C.preventDefault();const T=C.target.closest("form"),A=Object.fromEntries(new FormData(T));alert(JSON.stringify(A))},p={data:{name:"Resources"},expanded:!0,children:[{data:{name:"EC2"},expanded:!0,children:[{data:{name:"Vpc",id:"EC2::Vpc"}},{data:{name:"Subnet",id:"EC2::Subnet"}}]},{data:{name:"IAM"},children:[{data:{name:"Role",id:"IAM:Role"}}]}]},g=({id:C,name:T})=>C??T,m=C=>o.document.getElementById(g(C)),f=({onNode:C})=>T=>{C(T);const{children:A=[]}=T;A.map(f({onNode:C}))},b=({parent:C})=>{if(C){const{children:T}=C,A=m(C.data);if(A){const B=T.every(D=>{const{checked:$,indeterminate:L}=m(D.data);return!$&&!L});A.indeterminate=!B&&T.some(D=>!m(D.data).checked),A.checked=T.every(D=>m(D.data).checked)}b({parent:C.parent})}},y=({item:C,parent:T})=>A=>{b({parent:T}),f({onNode:$=>{const L=m($.data);L&&(L.checked=A.target.checked,L.indeterminate=!1)}})(C);const D=A.target.closest("form").querySelectorAll('input[type="checkbox"][data-type="resources"]:checked');u.val=D.length,A.stopPropagation()},S=St(e,{renderMenuItem:({item:C,parent:T})=>{const{name:A,id:B}=C.data,D=g(C.data);return r({class:n`
          display: flex;
          align-items: center;
          padding-right: 1rem;
        `,onclick:$=>$.stopPropagation()},l({onclick:y({item:C,parent:T}),name:D,id:D,"data-type":B?"resources":"group"}),A)}});return()=>a({onsubmit:d},i(S({tree:p})),s(c({type:"submit"},()=>`Delete ${u.val} Resource(s)`)))},ku=`import { Context } from "@grucloud/bau-ui/context";
...
`,Eu={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Simple",description:"A simple treeview.",code:Su,createComponent:wu},{title:"Checkable",description:"A treeview with checkboxes.",code:ku,createComponent:Cu}],gridItem:Qn},Tu=e=>{const t=U(e);return()=>t(Eu)},Au=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=Pe(e,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...t});return s=>i(s)},Du=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:r,p:i,ul:s,li:l}=t.tags,c=sn(e),u=H(e),d=[{name:"Accordion",Item:cn(e)},{name:"Alert",Item:un(e)},{name:"Autocomplete",Item:pn(e)},{name:"Avatar",Item:dn(e)},{name:"Badge",Item:gn(e)},{name:"Breadcrumbs",Item:bn(e)},{name:"Button",Item:hn(e)},{name:"Button Group",Item:fn(e)},{name:"Calendar",Item:xn(e)},{name:"Checkbox",Item:wn(e)},{name:"Chip",Item:yn(e)},{name:"DrillDown Menu",Item:Cn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:En(e)},{name:"Input",Item:Tn(e)},{name:"Input Search",Item:An(e)},{name:"Linear Progress",Item:Nn(e)},{name:"Loading Button",Item:$n(e)},{name:"Modal",Item:On(e)},{name:"Radio Button",Item:Pn(e)},{name:"Select",Item:zn(e)},{name:"Select Native",Item:_n(e)},{name:"Slider",Item:jn(e)},{name:"Spinner",Item:Gn(e)},{name:"Switch",Item:Vn(e)},{name:"Tabs",Item:Au(e)},{name:"Theme Switch",Item:Zn(e)},{name:"Toggle",Item:Jn(e)},{name:"Toggle Group",Item:Xn(e)},{name:"Tooltip",Item:qn(e)},{name:"Tree View",Item:Qn(e)}];return()=>o({class:n`
          overflow-y: scroll;
  ...
  `};fo();const eo={title:"Bau",base:"/bau/bau-ui"},he=Eo({config:eo}),{bau:$u}=he;he.states={drawerOpen:$u.state(!0)};Nu(he);so({routes:Mu({context:he}),onLocationChange:Iu({context:he,LayoutDefault:Oo(he),config:eo}),notFoundRoute:Bu(he)});
