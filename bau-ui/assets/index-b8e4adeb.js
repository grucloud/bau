...
`);function se(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
    ...
    ${No()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"plain",color:b=e.color??"neutral",...g},...h]=W(d);return r({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:B("theme-switch",b,p,m,c,e==null?void 0:e.class,g.class),type:"checkbox",checked:s()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...h)}}function Io(t){const{tr:e,bau:n,css:o,config:a,states:r}=t,{i,header:s,h1:l,div:c,a:u,img:d,b:m,ul:p,li:b}=n.tags,{svg:g,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),y=r.drawerOpen,v=M(t,{class:o`
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:B("input",e.class,e.size??"md",c,l,r,u.class)})}}function ce(t,e={}){const{bau:n,css:o,window:a}=t,r=dt(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,p=o`
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:B("inputSearch",e.class,p,u.class)})}}function He(t){const{tr:e,bau:n,css:o,config:a,states:r,window:i}=t,{div:s,ul:l,li:c,nav:u,a:d,span:m,form:p}=n.tags,b=ce(t,{variant:"plain",color:"neutral",size:"sm",class:o`
      margin: 0.5rem;
    `}),h={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:w,children:S,pathnameState:E,variant:D,color:A,size:N})=>{const O=n.state(""),L=n.derive(()=>O.val==""?S:S.filter(_=>_.data.name.match(new RegExp(`${O.val}`,"i")))),P=_=>{O.val=_.target.value};return p({class:o`
        ...
        `},b({autocomplete:"off",name:"component-search",autofocus:!0,value:O,placeholder:`Search ${L.val.length} components`,size:32,oninput:P}),()=>w({children:L.val,pathnameState:E,variant:D,color:A,size:N}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Key Value List",href:"/components/keyValueList"}},{data:{name:"Lazy",href:"/components/lazy"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Multi Select",href:"/components/multiSelect"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Radio Button Group",href:"/components/radioButtonGroup"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let y=!1;const v=ie(t);return function(){return s({bauMounted:({element:S})=>{i.innerWidth<=640&&(y=!0,r.drawerOpen.val=!1)},onclick:S=>{y&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(r.drawerOpen.val=!1)},style:()=>r.drawerOpen.val?"display:block;":"display:none;",class:B(o`
          ...
          `)},v({tree:h}))}}const Lo=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:r}=e.tags,i=qt(t),s=Io(t),l=He(t),c=Mo(t),u=a`
    from {
      opacity: 1;
    }
    to {
...
"Click me"
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("paper",l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}function sn(t,e={}){const{bau:n,css:o,window:a}=t,{nav:r,ul:i,li:s,a:l}=n.tags,{headerSelector:c="h2,h3"}=e,u=n.state("no"),d=(h,y)=>{let v=null;return(...w)=>{a.clearTimeout(v),v=a.setTimeout(()=>h(...w),y)}},m=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,p=({value:h,id:y,children:v=[]})=>{const w=l({class:()=>u.val==y?"active":"",href:`#${y}`});return w.innerHTML=h,s({class:()=>u.val==y?"active":""},w,v.length>0&&i(v.map(p)))},b=h=>h.tagName.charAt(1),g=({contentEl:h})=>{const y=h.querySelectorAll(c);let v=2,w={},S={children:[]},E=S;const D=E;let A=[E];return[...y].forEach(N=>{const O=b(N);N.setAttribute("id",N.textContent),!N.innerHTML.includes("<button")&&(w={value:N.innerHTML,id:N.id??N.textContent,children:[]},v==O?(S=w,E.children.push(S)):v<O?(A.push(E),E=S,S.children.push(w),S=w):v>O&&(E=A[O-1],A=A.slice(0,O-1),E.children.push(w),S=w),v=O)}),D};return function(...y){let[{size:v=e.size??"md",variant:w=e.variant??"plain",color:S=e.color??"neutral",contentEl:E,...D}]=W(y);const A=g({contentEl:E}),N=d(()=>{const L=[...E.querySelectorAll(c)].find(P=>{const{top:_,height:G}=P.getBoundingClientRect();if(_+G>60)return!0});L&&(u.val=L==null?void 0:L.id)},100);return r({...D,class:B("tableOfContent",v,w,S,m,e==null?void 0:e.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",N)},bauUnmounted:()=>{a.removeEventListener("scroll",N)}},A.children&&i(A.children.map(p)))}}const cn=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(l(i(c(m??""),ot.map(p=>c(p)))),r(To.map(p=>i(c(p),ot.map((b,g)=>s(d({color:b,variant:p},{index:g}))))))))}},Ua=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Do.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},H=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;Nt.registerLanguage("javascript",rn);const m=sn(t),p=pe(t,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),b=cn(t),g=Ua(t),h=({text:y})=>u({class:n`
          display: inline-block;
...
`,Ya={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:qa,createComponent:Ja},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Ka,createComponent:Wa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Za,createComponent:Xa}],gridItem:ln},Qa=t=>{const e=H(t);return()=>e(Ya)},tr={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},er=()=>ot.map(t=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`);function Et(t,e={}){const{bau:n,css:o}=t,{div:a,i:r}=n.tags,i=o`
    ...
    ${er()}
  `,s=M(t),l=({onclick:c})=>s({"aria-label":"Close",onclick:c,class:"button-close"},"✖");return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",onRemove:b,...g},...h]=W(u);return a({...g,class:B("alert",`alert-${m}`,e.class,m,p,d,i,g.class),role:"alert"},r({class:"icon"},tr[p]),a({class:"content"},...h),b&&l({onclick:b}))}}const dn=(t,e)=>{const n=Et(t,e);return o=>n({...o},`Alert ${(e==null?void 0:e.size)??""} `)},nr=t=>{const{bau:e}=t,{h4:n,p:o}=e.tags,a=Et(t,{color:"danger"});return()=>a(n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},or=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,hr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:fr,createComponent:gr}]},vr=t=>{const e=H(t);return()=>e(hr)};function kt(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",width:h=40,height:y=40,alt:v,...w},...S]=W(m);const E=kt(t,{class:B(o`
          ...
          height: ${y}px;
          width: ${h}px;
        `,e==null?void 0:e.class,w.class)});return a({class:B(u,e==null?void 0:e.class,w.class)},()=>i.val&&E(),()=>s.val&&v,r({alt:v,width:h,height:y,onload:l,onerror:c,class:()=>B(!i.val&&"visible",s.val&&"hide",g,b,p,u,e==null?void 0:e.class,w.class),...w}))}}const mn=(t,e)=>{const{css:n}=t,o=ge(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`);function Xt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:p,Option:b,options:g,defaultOption:h,getOptionLabel:y,getOptionValue:v,onSelect:w=()=>{},id:S,required:E,name:D,loading:A,...N},...O]=W(l);const L=$t(t),P=M(t),_=dt(t,{variant:u,color:d,size:c}),G=yt(t),U=bt(t,{variant:u,color:d,size:c}),z=n.state(h),C=n.state(N.value),f=n.state(!1),x=n.state(0),k=()=>{f.val=!1},T=n.state(g),F=Q=>at=>Q.val&&y(at)==y(Q.val),j=()=>{ut.openDialog(),f.val=!0,C.val="",T.val=g,x.val=g.findIndex(F(z));const Q=Dt.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ct.scrollIntoView({block:"end"}))},V=()=>{ut.closeDialog(),f.val=!1,x.val=0},J=Q=>{const{value:at}=Q.target;C.val=at,at?T.val=g.filter(_t=>y(_t).match(new RegExp(`${at}`,"i"))):T.val=g},I=Q=>{ut.open?V():j()},X=Q=>{z.val=Q,lt.value=v(Q)},nt=({option:Q,index:at})=>_t=>{X(Q),x.val=at,V()},Z=()=>{const Q=Dt.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":x.val<T.val.length-1?x.val++:x.val=0,Z();break;case"ArrowUp":x.val<=0?x.val=T.val.length-1:x.val--,Z();break;case"Enter":ut.open?(X(T.val[x.val]),V()):j(),Q.preventDefault();break}},rt=P({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":f,"aria-label":m,onclick:I,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>z.val?y(z.val):m,()=>A==!0&&U({visibility:A})),ct=_({value:C,placeholder:p,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":f,oninput:J,onkeydown:Y,...N}),lt=_({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=M(t,{variant:"outline"}),c=M(t,{variant:"solid",color:"primary"}),u=Xt(t),d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,jr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:zr,createComponent:Pr}],gridItem:gn},Rr=t=>{const e=H(t);return()=>e(jr)};function fe(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=M(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`,Ur={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:Gr,createComponent:_r},{title:"Separator",description:"A breadcrumbs with a custom separator.",code:Hr,createComponent:Fr}],gridItem:fn},Vr=t=>{const e=H(t);return()=>e(Ur)},hn=(t,e={})=>{const n=M(t,e);return o=>n({...o},`${o.variant} ${o.color} ${e.size??""}`)},Jr=t=>{const{bau:e}=t,{section:n}=e.tags,o=M(t,{color:"primary",variant:"outline"});return()=>n(o({onclick:()=>{alert("Click")}},"Click me"))},qr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Xr={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Solid Button",description:"A simple button.",code:qr,createComponent:Jr},{title:"Disabled Button",description:"A disabled button.",code:Kr,createComponent:Wr}],gridItem:hn},Zr=t=>{const e=H(t);return()=>e(Xr)},Yr=()=>ot.map(t=>`
&.button-group.${t} {
...
`);function he(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    ...
    ${Yr()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("button-group",c,u,l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}const vn=(t,e)=>{const n=["ONE","TWO","THREE"],o=M(t,e),a=he(t,e);return r=>a({...r},n.map(i=>o(r,i)))},Qr=t=>{const{bau:e}=t,{section:n}=e.tags,o=["ONE","TWO","THREE"],a="primary",r="solid",i=M(t,{color:a,variant:r}),s=he(t,{color:a,variant:r});return()=>{const l=c=>u=>{alert(c)};return n(s(o.map(c=>i({onclick:l(c)},c))))}},ts=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,es={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:ts,createComponent:Qr}],gridItem:vn},ns=t=>{const e=H(t);return()=>e(es)};function ve(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>ot.map(s=>`
...
`))()}
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...p]=W(l);return a({...m,type:"date",class:B("calendar",i,d,u,c,e==null?void 0:e.class,m==null?void 0:m.class)},...p)}}const yn=(t,e)=>{const n=ve(t,e),o=({props:a={},options:r={}})=>`myinput-gallery-${a.color??r.color}-${a.variant??r.variant}-${a.size??r.size}`;return a=>n({"aria-label":o({props:a,options:e}),...a})},os=t=>{const{bau:e}=t,{form:n,footer:o,article:a,label:r}=e.tags,i=ve(t),s=M(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},a(r("Start date:",i({name:"start",min:"2023-01-01",max:"2024-12-31",required:!0}))),o(s({type:"submit"},"Submit")))},as=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,ps={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:ms,createComponent:ds}]},bs=t=>{const e=H(t);return()=>e(ps)},xn=(t,e)=>{const n=Ot(t,e);return o=>n({...o},`Chip ${o.color} ${o.variant} ${o.size??""}`)},gs=t=>{const{bau:e}=t,{section:n}=e.tags,o=Ot(t,{variant:"outline",color:"primary"});return()=>n(o("My Chip"))},fs=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,hs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:fs,createComponent:gs}],gridItem:xn},vs=t=>{const e=H(t);return()=>e(hs)};function Tt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
    margin: 0.5rem;
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({type:"checkbox",...d,class:B(r,u,c,l,e==null?void 0:e.class,d==null?void 0:d.class)})}}const Sn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,r=Tt(t,e);return i=>a({class:o`
          display: flex;
...
`,Ss=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:r,form:i}=e.tags,s=Tt(t,{color:"neutral",variant:"outline"}),l=M(t,{variant:"outline",color:"primary"});return()=>i({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & article {
...
`,$s={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Os,createComponent:Ms}],variantColorTableDisable:!0,variantSizeDisable:!0},Ls=t=>{const e=H(t);return()=>e($s)};function Ps(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...m},...p]=W(s);return a({class:B(r,e==null?void 0:e.class,m.class)},a({class:()=>B("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>B("content",d.val&&"content-open")},p))}}const zs=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=Ps(t),r=M(t,{color:"neutral",variant:"outline"}),i=He(t);return()=>{const s=e.state(!1);return n(o("Click on the button to open and close the drawer."),r({onclick:()=>{s.val=!s.val}},"OPEN DRAWER"),a({openState:s},i()))}},js=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`);function wn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=M(t),s=$t(t),l=yt(t),c=o`
    ${Gs()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"outline",color:b=e.color??"neutral",label:g,ListItem:h,items:y,...v},...w]=W(d);const S=n.state(0),E=()=>{G.openDialog(),G.focus()},D=()=>{G.closeDialog()},A=()=>{G.open?D():E()},N=U=>{A(),U.preventDefault()},O=({item:U,index:z})=>C=>{S.val=z,D(),C.preventDefault()},L=U=>{switch(U.preventDefault(),U.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},P=()=>l({tabindex:"0",class:B(b,p)},y.map((U,z)=>r({class:()=>B(S.val==z&&"active"),onclick:O({item:U,index:z})},h(U)))),_=i({type:"button",onclick:N,color:b,variant:p,size:m},g),G=s({triggerEl:_,contentEl:P()});return a({...v,class:B("dropdownMenu",b,m,c,e==null?void 0:e.class,v==null?void 0:v.class),onkeydown:L},_,G)}}const Fs=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=wn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},Hs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=wn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Us=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ks={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Ws,createComponent:qs}],gridItem:(t,e)=>Cn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},Xs=t=>{const e=H(t);return()=>e(Ks)};function kn(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
      display: inline-flex;
      & input {
        width: 0.1px;
        height: 0.1px;
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",Component:b,disabled:g,...h}=c;return a({class:B(s.base,g&&s.disabled,e==null?void 0:e.class,c.class)},r({class:B(m,p,d)},b({disabled:g}),i({type:"file",disabled:g,...h})))}}const En=(t,e)=>{const{tr:n,bau:o,css:a,config:r}=t,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=kn(t,e),m=b=>{const g=b.target.files[0];g?u.val=g.name:u.val="No file selected"},p=({disabled:b})=>l({class:B(a`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`,Si=t=>{const{bau:e,css:n}=t,{section:o,li:a,label:r,span:i}=e.tags,s=An(t,{class:n`
      &.keyValueList {
        flex-direction: row;
        gap: 1rem;
      }
...
`,Bi=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=e.state(!1),r=Nn(t,{loading:()=>o("My Custom Loading"),error:s=>o("My Custom Error")}),i=M(t);return()=>n(i({onclick:()=>a.val=!a.val},()=>a.val?"Hide":"Show"),()=>a.val&&r({getModule:()=>Bn(()=>import("./myComponent-a7adf959.js"),[]),props:{message:"Additional Props here"}}))},Ni=`import { Context } from "@grucloud/bau-ui/context";
import lazy from "@grucloud/bau-ui/lazy";
import button from "@grucloud/bau-ui/button";
export default (context: Context) => {
  const { bau } = context;
...
`,Ii={title:"Lazy",package:"lazy",description:"The lazy component delays the loading of a component, hence improving the initial bundle size.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/lazy/lazy.js",importStatement:'import lazy from "@grucloud/bau-ui/lazy";',examples:[{title:"Simple",description:"Lazy load a component.",code:Ai,createComponent:Di},{title:"Custom Loader",description:"Custom loader and error",code:Ni,createComponent:Bi}]},Mi=t=>{const e=H(t);return()=>e(Ii)};function In(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=()=>ot.map(c=>`
&.${c}{
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:p=e.color??"neutral",running:b,...g}]=W(u);return r({...g,role:"progressbar",class:{deps:[b],renderProp:()=>h=>B("linearProgress",d,p,l,h&&"running",e==null?void 0:e.class,g==null?void 0:g.class)}})}}const Mn=(t,e)=>{const n=In(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},Oi=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=M(t,{variant:"solid",color:"primary"}),r=In(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},$i=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Xi={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:Ki,createComponent:Wi}],gridItem:Ln},Zi=t=>{const e=H(t);return()=>e(Xi)},Yi=()=>ot.map(t=>`
& button.plain.${t}::after {
  color: var(--color-${t});
}
& button.outline.${t}::after {
...
`).join(`
`);function Qi(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=M(t),l=$t(t),c=yt(t),u=Tt(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
...
&.radio-button.${s} {
  ...
  `).join(`
`))()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=W(l);return a({...m,type:"radio",class:B("radio-button",c,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class)})}}const Pn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:r}=n.tags,i=xe(t,e);return s=>r({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,wc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Sc,createComponent:xc}],gridItem:Pn},Cc=t=>{const e=H(t);return()=>e(wc)};function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=xe(t),l=o`
    display: flex;
    flex-direction: row;
    gap: 0.5rem;
    & label {
  ...
  `).join(`
`))()};
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"none",color:p=e.color??"neutral",name:b,oninput:g,value:h,radios:y=[],...v}]=W(u);return a({...v,class:B("radioButtonGroup",d,p,m,l,e==null?void 0:e.class,v==null?void 0:v.class)},y.map(({id:w,Label:S})=>r(i({size:d,variant:m,color:p,id:w,name:b,checked:h==w,value:w,oninput:g}),S())))}}const kc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,p:r}=e.tags,i=Zt(t),s=M(t,{variant:"outline",color:"primary"});return()=>{const l=e.state("two");return n({onsubmit:d=>{d.preventDefault(),alert(l.val)}},o(i({oninput:({target:d})=>l.val=d.id,name:"myRadio",value:l.val,radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]}),r("CheckedState: ",l)),a(s({type:"submit"},"Submit")))}},Ec=`import { Context } from "@grucloud/bau-ui/context";
...
`,Tc=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Zt(t),i=M(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))}},o(r({name:"myRadio",value:"one",radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},Dc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,zc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Lt(t),c=M(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Gc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=M(t,{variant:"outline"}),c=M(t,{variant:"solid",color:"primary"}),u=Lt(t),d=m=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Hc={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Pc,createComponent:Lc},{title:"Default Option",description:"Select with a default option",code:jc,createComponent:zc},{title:"Select AWS region",description:"Select the AWS region",code:_c,createComponent:Rc},{title:"Loading Indicator",description:"Select with a loading indicator",code:Fc,createComponent:Gc}],gridItem:zn},Uc=t=>{const e=H(t);return()=>e(Hc)};function jn(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("select-native",u,l,c,r,e==null?void 0:e.class,d==null?void 0:d.class)},m)}}const Rn=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=jn(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},r.map(({label:s,phone:l})=>o({value:l},s)))},Vc=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,r=M(t,{variant:"outline",color:"primary"}),i=jn(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),s.map(({label:c,phone:u})=>n({value:u},c))),a(r({type:"submit"},"Submit")))},Jc=`import { Context } from "@grucloud/bau-ui/context";
...
`,qc={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Jc,createComponent:Vc}],gridItem:Rn},Wc=t=>{const e=H(t);return()=>e(qc)},Kc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=kt(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,dl=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=Pt(t),d=M(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o({class:n`
            display: flex;
...
`,hl={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:fl,createComponent:gl}],gridItem:Gn},vl=t=>{const e=H(t);return()=>e(hl)},yl=()=>ot.map(t=>"").join(`
...
`,Re="stepper-vertical",wl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=e.tags,d=dt(t),m=gt(t),p=Hn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`).join(`
`);function Se(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
    cursor: pointer;
    position: relative;
    ...
    ${Tl()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("switch",r,u,c,l,e==null?void 0:e.class,d.class),type:"checkbox"},...m)}}const Un=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Se(t,e);return s=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},Dl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Se(t,{variant:"outline",color:"primary"}),l=M(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
...
`,Il={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Uncontrolled Switch",description:"A uncontrolled switch.",code:Al,createComponent:Dl},{title:"Controlled Switch",description:"A controlled switch.",code:Nl,createComponent:Bl}],gridItem:Un},Ml=t=>{const e=H(t);return()=>e(Il)},Ol=()=>ot.map(t=>`
&.tabs.solid.${t} {
}
`).join(`
...
`,Pl=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=zt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>"Tab Disabled",Content:()=>n(o("My Content Disabled"))}],variant:"plain",color:"neutral"});return()=>r({tabsKey:"my-tab"})},zl=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vn=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Tab1",Header:()=>"TAB",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]},jl=t=>{const{css:e}=t,n=zt(t,{tabDefs:Vn(t),class:e`
      flex-direction: column-reverse;
    `});return()=>n({})},Rl=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,_l=t=>{const{css:e}=t,n=Vn(t),o=zt(t,{tabDefs:n,class:e`
      & ul {
        justify-content: center;
      }
    `});return()=>o({})},Gl=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Fl={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Ll,createComponent:$l},{title:"Extended Tabs",description:"An extended tabs.",code:zl,createComponent:Pl},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:Rl,createComponent:jl},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:Gl,createComponent:_l}]},Hl=t=>{const e=H(t);return()=>e(Fl)};function jt(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:r}=n.tags;a`
  :root {
...
`;const i=o`
  ...
  `;return function(...l){let[{...c},...u]=W(l);return r({...c,class:B("table-container",i,e==null?void 0:e.class,c==null?void 0:c.class)},...u)}}const Ul=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags;function d(h,y,v,w,S){return{name:h,calories:y,fat:v,carbs:w,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],p=({name:h,calories:y})=>i(r(h),r({class:n`
      ...
      max-width: 650px;
    `});return()=>o(g(s(u("Basic Table"),b(),c(m.map(p)))))},Vl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function At(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Jl=[At("Frozen yoghurt",159,6,24,4),At("Ice cream sandwich",237,9,37,4.3),At("Eclair",262,16,24,6),At("Cupcake",305,3.7,67,4.3),At("Gingerbread",356,16,49,3.9)],ql=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
    ...
    `});return()=>o(p(s(u("Table Dense"),m(),c(Jl.map(d)))))},Wl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Bt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Kl=[Bt("Frozen yoghurt",159,6,24,4),Bt("Ice cream sandwich",237,9,37,4.3),Bt("Eclair",262,16,24,6),Bt("Cupcake",305,3.7,67,4.3),Bt("Gingerbread",356,16,49,3.9)],Xl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
            text-align: right;
          `},g)),m=()=>l(i(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(p(s(u("Table Zebra"),m(),c(Kl.map(d)))))},Zl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Yl={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Vl,createComponent:Ul},{title:"Dense",description:"A dense table.",code:Wl,createComponent:ql},{title:"Zebra",description:"A zebra table.",code:Zl,createComponent:Xl}]},Ql=t=>{const e=H(t);return()=>e(Yl)},tu=t=>{const{bau:e,css:n}=t,{h1:o,h2:a,h3:r,section:i,article:s}=e.tags,l=sn(t),c=s({id:"content",class:n`
        grid-area: content;
...
`,nu={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:eu,createComponent:tu}]},ou=t=>{const e=H(t);return()=>e(nu)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=he(t),i=M(t),s=bt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:b,icon:g,...h})=>i({"aria-label":b,title:b,...h},g),u=({count:b,totalCount:g,page:h,rowsPerPage:y})=>a({class:"pages-numbers"},Number(h-1)*Number(y)+(b>0?1:0),"-",Math.min(h*y,g)," of ",g),d=({count:b,page:g,rowsPerPage:h})=>a({class:"pages-numbers"},(g-1)*h+(b>0?1:0),"-",g*h),m=b=>b<=1,p=(b,g,h)=>b>=Math.ceil(g/h);return function(...g){let[{size:h=e.size??"md",variant:y=e.variant??"outline",color:v=e.color??"neutral",count:w=0,totalCount:S=0,page:E=1,rowsPerPage:D=50,onPageChange:A,isLoading:N=!1,disableFirst:O=()=>m(E),disablePrevious:L=()=>m(E),disableNext:P=()=>p(E,S,D),disableLast:_=()=>p(E,S,D),...G},...U]=W(g);const z=Math.max(0,Math.ceil(S/D)),C=A({page:1}),f=A({page:E-1}),x=A({page:E+1}),k=A({page:z}),T=[{label:"First",icon:"⟪",onclick:C,disabled:O()},{label:"Previous",icon:"⟨",onclick:f,disabled:L()},{label:"Next",icon:"⟩",onclick:x,disabled:P()},{label:"Last",icon:"⟫",onclick:k,disabled:_()}];return a({...G,class:B("table-pagination",l,N&&"disabled",e==null?void 0:e.class,G==null?void 0:G.class)},s({class:"spinner",visibility:N,size:"md"}),S>0?u({count:w,totalCount:S,page:E,maxPages:z,rowsPerPage:D}):d({count:w,page:E,maxPages:z,rowsPerPage:D}),r({variant:y,color:v},T.map(F=>c({...F,variant:y,color:v}))))}}const au=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),ru=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=au(45),u=({name:b,email:g})=>r(a(b),a(g)),d=()=>s(o({class:n`
    ...
    `});return()=>{const b=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),h=e.derive(()=>b.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:v})=>w=>{g.val.page=v};return p(i(d(),()=>l(h.val.map(u))),()=>m({...g.val,onPageChange:y}))}},su=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),p=e.derive(()=>d.val.length),b=e.state(1),g=e.state(10),h=e.derive(()=>d.val),y=O=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(O).toString()}`,v=({page:O})=>L=>{b.val=O,w(y({page:O,per_page:g.val}))};w(y({page:1,per_page:g.val}));async function w(O){try{u.val=!0;const L=await fetch(O,{});if(L.ok){const P=await L.json();d.val=P;return}throw L}catch(L){m.val=L.message}finally{u.val=!1}}const S=({name:O,description:L,stargazers_count:P})=>r(a(O),a(L),a({class:n`
      ...
      min-width: 650px;
    `}),N=({message:O})=>c(O);return()=>A(()=>D({rowsPerPage:g.val,page:b.val,count:p.val,totalCount:-1,isLoading:u.val,onPageChange:v,disableNext:()=>!1}),i(E(),()=>m.val&&N({message:m.val}),()=>l(h.val.map(S))))},iu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=ru(t),c=su(t),u=(...d)=>a({class:n`
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",selected:m=!1,disabled:p,onChange:b,...g},...h]=W(l);return r({type:"button",...g,"aria-pressed":{deps:[m],renderProp:()=>y=>y},class:{deps:[m],renderProp:()=>y=>B("toggle",c,d,u,i,y&&"selected",e==null?void 0:e.class,g==null?void 0:g.class)},disabled:p},h)}}const qn=(t,e)=>{const{bau:n}=t,o=Rt(t,e);return a=>{const r=n.state(!1);return o({...a,selected:r,onclick:()=>r.val=!r.val},"Toggle Me")}},cu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Rt(t,{variant:"plain"}),i=M(t,{variant:"outline",color:"primary"});return()=>{const s=e.state(!1);return n({onsubmit:c=>{var m;c.preventDefault();const d=(m=c.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:m.name;alert(d)}},o(r({name:"my-toogle",selected:s,onclick:()=>s.val=!s.val},"Toggle Me")),a(i({type:"submit"},"Submit")))}},lu=`import { Context } from "@grucloud/bau-ui/context";
...
`,uu={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:lu,createComponent:cu}],gridItem:qn},du=t=>{const e=H(t);return()=>e(uu)},mu=()=>ot.map(t=>`
&.toggle-group.${t} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${t}) !important;
  }
...
`,gu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=Rt(t,{variant:s,color:i}),c=we(t,{variant:s,color:i}),u=M(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{b.preventDefault();const h=[...b.currentTarget.querySelectorAll("button[aria-pressed=true]")].map(({name:y})=>y);alert(JSON.stringify(h))}},o(c({onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),a(u({type:"submit"},"Submit")))}},fu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,hu={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:bu,createComponent:pu},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:fu,createComponent:gu}],gridItem:Wn},vu=t=>{const e=H(t);return()=>e(hu)};function Ce(t,e={}){const{bau:n,css:o,window:a}=t,{div:r}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
  ...
  `;return function(...l){let[{titleEl:c,side:u="bottom-start",size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",...b},...g]=W(l);const h=r({class:B("container",...u.split("-"))},r({class:B("content",p,m,d),role:"tooltip"},c)),y=A=>`move-to-${A}`,v=(A,N,O)=>{if(A()){const L=y(N);h.classList.add(L),h.classList.add(N),h.classList.remove(O)}},w=(A,N)=>{const O=y(A);h.classList.contains(O)&&(h.classList.remove(O),h.classList.add(N),h.classList.remove(A))},S=A=>{const N=h.getBoundingClientRect();v(()=>N.x<0,"right","left"),v(()=>N.x+N.width>a.innerWidth,"left","right"),v(()=>N.y<0,"bottom","top"),v(()=>N.bottom>a.innerHeight,"top","bottom"),h.classList.add("visible")},E=A=>{h.classList.remove("visible"),w("right","left"),w("left","right"),w("bottom","top"),w("top","bottom")};return r({...b,class:B("tooltip",i,e==null?void 0:e.class,b==null?void 0:b.class),bauMounted:({element:A})=>{A.addEventListener("mouseover",S),A.addEventListener("mouseout",E)},bauUnmounted:({element:A})=>{A.removeEventListener("mouseover",S),A.removeEventListener("mouseout",E)}},...g,h)}}const Kn=(t,e)=>{const{bau:n}=t,{div:o,p:a,em:r}=n.tags,i=M(t),s=Ce(t,e),l=()=>o(a("A ",r("tooltip")," can be any component"));return c=>s({titleEl:l(),...c},i(c,`${c.color} ${c.variant}`))},yu=t=>{const{bau:e}=t,{div:n,p:o,em:a}=e.tags,r=M(t),i=Ce(t),s=()=>n(o("A ",a("tooltip")," can be any component"));return()=>i({side:"bottom-start",titleEl:s()},r("tooltip"))},xu=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Su=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:r,section:i}=e.tags,s=Ot(t,{variant:"outline",color:"primary"}),l=Ce(t),c=()=>o(a("A ",r("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
        `},o({class:n`
          ...
          `},l({side:"left-end",titleEl:c()},s("left end")),l({side:"right-end",titleEl:c()},s("right end"))),o({class:n`
            display: flex;
            justify-content: space-around;
          `},l({side:"bottom-start",titleEl:c()},s("bottom start")),l({side:"bottom-centered",titleEl:c()},s("bottom centered")),l({side:"bottom-end",titleEl:c()},s("bottom end"))));return()=>u()},wu=`import tooltip from "@grucloud/bau-ui/tooltip";
import chip from "@grucloud/bau-ui/chip";
...
`,Cu={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import tooltip from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:xu,createComponent:yu},{title:"Grid",description:"Various tooltip position",code:wu,createComponent:Su}],gridItem:Kn},ku=t=>{const e=H(t);return()=>e(Cu)},Xn=(t,e)=>{const n=se(t,e);return o=>n(o)},Eu=t=>{const{bau:e}=t,{section:n}=e.tags,o=se(t);return()=>n(o({}))},Tu=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,Du={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:Tu,createComponent:Eu}],gridItem:Xn},Au=t=>{const e=H(t);return()=>e(Du)},Zn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Zn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},Bu=({css:t,createGlobalStyles:e})=>(e`
:root {
...
`,Mu=t=>{const{bau:e,css:n,window:o}=t,{form:a,label:r,article:i,footer:s}=e.tags,l=Tt(t,{color:"neutral",variant:"outline"}),c=M(t,{variant:"solid",color:"danger"}),u=e.state(0),d=S=>{S.preventDefault();const E=Object.fromEntries(new FormData(S.currentTarget));alert(JSON.stringify(E))},m={data:{name:"Resources"},expanded:!0,children:[{data:{name:"EC2"},expanded:!0,children:[{data:{name:"Vpc",id:"EC2::Vpc"}},{data:{name:"Subnet",id:"EC2::Subnet"}}]},{data:{name:"IAM"},children:[{data:{name:"Role",id:"IAM:Role"}}]}]},p=({id:S,name:E})=>S??E,b=S=>o.document.getElementById(p(S)),g=({onNode:S})=>E=>{S(E);const{children:D=[]}=E;D.map(g({onNode:S}))},h=({parent:S})=>{if(S){const{children:E}=S,D=b(S.data);if(D){const A=E.every(N=>{const{checked:O,indeterminate:L}=b(N.data);return!O&&!L});D.indeterminate=!A&&E.some(N=>!b(N.data).checked),D.checked=E.every(N=>b(N.data).checked)}h({parent:S.parent})}},y=({item:S,parent:E})=>D=>{h({parent:E}),g({onNode:O=>{const L=b(O.data);L&&(L.checked=D.target.checked,L.indeterminate=!1)}})(S);const N=D.currentTarget.querySelectorAll('input[type="checkbox"][data-type="resources"]:checked');u.val=N.length,D.stopPropagation()},w=ke(t,{renderMenuItem:({item:S,parent:E})=>{const{name:D,id:A}=S.data,N=p(S.data);return r({class:n`
          display: flex;
          align-items: center;
          padding-right: 1rem;
        `,onclick:O=>O.stopPropagation()},l({onclick:y({item:S,parent:E}),name:N,id:N,"data-type":A?"resources":"group"}),D)}});return()=>a({onsubmit:d},i(w({tree:m})),s(c({type:"submit"},()=>`Delete ${u.val} Resource(s)`)))},Ou=`import { Context } from "@grucloud/bau-ui/context";
...
`,$u={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Simple",description:"A simple treeview.",code:Iu,createComponent:Nu},{title:"Checkable",description:"A treeview with checkboxes.",code:Ou,createComponent:Mu}],gridItem:Yn},Lu=t=>{const e=H(t);return()=>e($u)},Pu=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,i=zt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...e});return s=>i(s)},zu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h1:r,p:i,ul:s,li:l}=e.tags,c=cn(t),u=M(t),d=[{name:"Accordion",Item:ln(t)},{name:"Alert",Item:dn(t)},{name:"Autocomplete",Item:pn(t)},{name:"Avatar",Item:mn(t)},{name:"Badge",Item:gn(t)},{name:"Breadcrumbs",Item:fn(t)},{name:"Button",Item:hn(t)},{name:"Button Group",Item:vn(t)},{name:"Calendar",Item:yn(t)},{name:"Checkbox",Item:Sn(t)},{name:"Chip",Item:xn(t)},{name:"DrillDown Menu",Item:Cn(t,{base:"/components",hashBased:!0})},{name:"File Input",Item:En(t)},{name:"Input",Item:Tn(t)},{name:"Input Search",Item:Dn(t)},{name:"Linear Progress",Item:Mn(t)},{name:"Loading Button",Item:On(t)},{name:"Modal",Item:Ln(t)},{name:"Radio Button",Item:Pn(t)},{name:"Select",Item:zn(t)},{name:"Select Native",Item:Rn(t)},{name:"Slider",Item:_n(t)},{name:"Spinner",Item:Gn(t)},{name:"Switch",Item:Un(t)},{name:"Tabs",Item:Pu(t)},{name:"Theme Switch",Item:Xn(t)},{name:"Toggle",Item:qn(t)},{name:"Toggle Group",Item:Wn(t)},{name:"Tooltip",Item:Kn(t)},{name:"Tree View",Item:Yn(t)}];return()=>o({class:n`
          overflow-y: scroll;
  ...
  `};ho();const Qn={title:"Bau",base:"/bau/bau-ui"},ht=Eo({config:Qn}),{bau:Fu}=ht;ht.states={drawerOpen:Fu.state(!0)};Gu(ht);ro({routes:ju({context:ht}),onLocationChange:_u({context:ht,LayoutDefault:Lo(ht),config:Qn}),notFoundRoute:Ru(ht)});
