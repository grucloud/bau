...
`)}
  ...
  `}function co(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let nt=e=>Object.prototype.toString.call(e??0).slice(8,-1),lo=e=>nt(e)=="Object",yt=e=>nt(e)=="Function",Je=e=>["Object","Array"].includes(nt(e)),wt=Object.getPrototypeOf,Qe=e=>fe(e)?e.val:e,fe=e=>e==null?void 0:e.__isState,uo=["splice","push","pop","shift","unshift","sort","reverse"],Le=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const V=e=>!fe(e[0])&&lo(e[0])?e:[{},...e];function po(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=w=>n.createElement(w),l=(w,m,h)=>{let C=r;r=m;let E=w(h);return r=C,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(w=>{w.bindings=w.bindings.filter(m=>{var h;return(h=m.element)==null?void 0:h.isConnected}),!w.bindings.length&&!w.computed&&a.delete(w)}),o=void 0}))},p=(w,m,h,C,E,R)=>{var P;if(s){i.add(w);return}for(let F of w.bindings){let{deps:U,element:$,renderInferred:q,render:ne,renderItem:ee}=F;if(ee&&m)(P=b($,C,(...ae)=>v(ee(...ae)),h,E,R)[m])==null||P.call();else{let ae=q?q({element:$}):ne({element:$,renderItem:ee})(...U.map(Qe));ae!==$&&$.replaceWith(F.element=v(ae))}}S(w),u()},d=(w,m,h=[])=>({get(C,E,R){var P;if(r==null||r.add(w),E==="_isProxy")return!0;if(!((P=C[E])!=null&&P._isProxy)&&!fe(C[E])&&Je(C[E]))C[E]=new Proxy(C[E],d(w,m,[...h,E]));else if(uo.includes(E)){let F=C[E];return(...U)=>{let $=F.apply(C,U);return p(w,E,$,U,m,h),$}}return Reflect.get(C,E,R)},set(C,E,R,P){let F=Reflect.set(C,E,R,P);return p(w,"setItem",F,{prop:E,value:R},m,[...h,E]),F}}),g=(w,m)=>new Proxy(m,d(w,m)),b=(w,m,h,C,E,R)=>{let P=()=>w.replaceChildren(...Le(C,h)),F=U=>w[U]&&w.removeChild(w[U]);return{assign:P,sort:P,reverse:P,setItem:()=>{var $;let U=R[0];($=w.children[U])==null||$.replaceWith(h(E[U],U))},push:()=>w.append(...Le(m,(U,$)=>h(U,E.length+$))),unshift:()=>w.prepend(...Le(m,h)),pop:()=>F("lastChild"),shift:()=>F("firstChild"),splice:()=>{const{length:U}=w.children;let[$,q=U,...ne]=m;for(let ee=$>=0?Math.min($+q-1,U-1):U-1;ee>=($>=0?$:U+$);ee--)w.children[ee].remove();if(ne.length){let ee=ne.forEach((ae,be)=>h(ae,$+be));w.children[$]?w.children[$].after(...ee):w.append(...ee)}}}},f=w=>({oldVal:w,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=Je(w)?g(m,w):w,m.valProxy)},set val(m){let h=this,C=h.val;Je(m)?(h.valProxy=g(h,m),p(h,"assign",m)):m!==C&&(h.valProxy=m,p(h)),h.oldVal=C}}),v=w=>{if(w==null||w===!1){const m=c("span");return m.style.display="none",m}else return w.nodeType?w:n.createTextNode(w)},x=(w,m)=>{let h=new Set;return m.val=l(w,h),h},y=w=>{let m=f(),h=x(w,m);m.computed=!0;for(let C of h)C.listeners.push({computed:w,deps:h,state:m});return m},S=w=>{for(let m of[...w.listeners])x(m.computed,m.state)},k=(w,...m)=>{if(m.length){let h=[];for(let C of m.flat(1/0))C!=null&&h.push(fe(C)?H({deps:[C],render:()=>E=>E}):yt(C)?Z({renderInferred:C}):v(C));w.append(...h)}},I={},B=(w,m)=>w&&(Object.getOwnPropertyDescriptor(w,m)??B(wt(w),m)),T=(w,m,h)=>{var C;return I[w+","+m]??(I[w+","+m]=((C=B(h,m))==null?void 0:C.set)??0)},A=(w,m)=>new t.MutationObserver((h,C)=>{h.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(R=>R===w&&(m({element:w}),C.disconnect(),!0)))}).observe(w.parentNode,{childList:!0}),N=(w,m)=>new t.MutationObserver((h,C)=>h.forEach(E=>m({record:E,element:w}))).observe(w,{childList:!0}),z=w=>new Proxy(function(h,...C){var F;let[E,...R]=V(C),P=w?n.createElementNS(w,h):c(h);for(let[U,$]of Object.entries(E)){if(U.startsWith("bau"))continue;let q=T(h,U,wt(P))?ne=>P[U]=ne:ne=>P.setAttribute(U,ne);$==null||(fe($)?H({deps:[$],render:()=>()=>(q($.val),P)}):yt($)&&(!U.startsWith("on")||$.isDerived)?Z({renderInferred:()=>(q($({element:P})),P)}):$.renderProp?H({deps:$.deps,render:()=>()=>(q($.renderProp({element:P})(...$.deps.map(Qe))),P)}):q($))}return E.bauChildMutated&&N(P,E.bauChildMutated),k(P,...R),P.autofocus&&P.focus&&t.requestAnimationFrame(()=>P.focus()),(F=E.bauCreated)==null||F.call(E,{element:P}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:P})),E.bauUnmounted&&t.requestAnimationFrame(()=>A(P,E.bauUnmounted)),P},{get:(m,h)=>m.bind(void 0,h)}),_=(w,m,h)=>{w.element=v(h);for(let C of m)fe(C)&&(a.add(C),C.bindings.push(w));return w.element},Z=({renderInferred:w,element:m})=>{let h=new Set,C=l(w,h,{element:m});return _({renderInferred:w},h,C)},H=({deps:w,element:m,render:h,renderItem:C})=>_({deps:w,render:h,renderItem:C},w,h({element:m,renderItem:C})(...w.map(Qe))),W=(w,m,h)=>H({deps:[w],render:({renderItem:C})=>E=>(m.append(...Le(E,C)),m),renderItem:h}),L=w=>{s=!0,w(),s=!1,i.forEach(p),i.clear()};return{tags:z(),tagsNS:z,state:f,bind:H,loop:W,derive:y,stateSet:a,batch:L}}const mo=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},go=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},bo=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function ho(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=bo(a,i),r=mo(s);return!t.getElementById(r)&&go(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function fo(e){const t=po(),n=ho();return io(n),{bau:t,...n,tr:o=>o,window,...e}}function D(...e){return e.filter(t=>t).join(" ")}function He(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:D("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:p})=>{[...u.removedNodes].forEach(d=>{if(!s()||d.getAttribute("cloned"))return;const g=d.cloneNode(!0);g.setAttribute("cloned",!0),g.style.top=0,g.style.left=0,g.style.width=d.getAttribute("width"),g.style.height=d.getAttribute("height"),g.style.position="absolute",g.style.animation=s(),u.target.appendChild(g),g.addEventListener("animationend",()=>{var b;return(b=g.parentNode)==null?void 0:b.removeChild(g)})}),[...u.addedNodes].forEach(d=>{if(d.getAttribute("cloned"))return;p.style.position="relative";const g=d.getBoundingClientRect();if(d.setAttribute("width",g.width+"px"),d.setAttribute("height",g.height+"px"),r()){d.style.animation=r();const b=()=>{d.removeEventListener("animationend",b),d.style.animation=""};d.addEventListener("animationend",b)}})},...c},l)}}const te=["neutral","primary","success","danger","warning"],vo=["plain","outline","solid"],xo=["sm","md","lg"],yo=()=>te.map(e=>`
&.button.plain.${e} {
  &:focus {
...
`);function K(e,t={}){const{bau:n,css:o}=e,a=o`
    ...
    ${yo()}
  `;return function(...s){let[{size:r=t.size??"md",variant:c=t.variant??"none",color:l=t.color??"none",href:u,...p},...d]=V(s);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...p,class:D("button",t.class,c,r,l,a,p.class),href:u},d)}}const wo="light",So=()=>te.map(e=>`
...
`);function ot(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(wo);const l=o`
  ...
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",...f},...v]=V(p);return i({required:"required",title:"Switch Theme",...f,class:D("theme-switch",b,g,d,l,t==null?void 0:t.class,f.class),type:"checkbox",checked:r()=="dark",onclick:x=>{s(x.target.checked?"dark":"light")}},...v)}}function Co(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:p,b:d,ul:g,li:b}=n.tags,{svg:f,path:v}=n.tagsNS("http://www.w3.org/2000/svg"),x=i.drawerOpen,y=K(e,{class:o`
    ...
    `}),S=ot(e),k=()=>s(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},v({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),I=()=>l({class:o`
        ...
        `},I(),B())}}function Eo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:p}=t.tags,d=({links:f,title:v})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
  ...
  `,hideToRight:e`
   ...
   `});function at(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=L=>{var w;return((w=L.parentTree.data)==null?void 0:w.href)??L.parentTree.children[0].data.href},u=({variant:L,color:w,size:m,currentTree:h,data:C})=>S(T({variant:L,color:w,size:m,href:`${c}${l(h)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),T({variant:L,color:w,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},C.name)),p=({size:L,subTree:{data:{name:w,href:m},children:h=[]}})=>T({size:L,href:`${c}${m}`,"data-ischild":!h.length},w),d=({pathname:L,subTree:w})=>{var m;return L===((m=w==null?void 0:w.data)==null?void 0:m.href)},{renderHeader:g=u,renderMenuItem:b=p,isActive:f=d}=t,{li:v,nav:x,div:y,header:S,a:k}=n.tags,I=He(e),B=xe(e),T=K(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:A,hideToRight:N}=ko(e),z=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,_=({children:L,pathnameState:w,variant:m,color:h,size:C})=>B({class:D(m,h,C)},L.map(E=>v({class:()=>D(E.children&&"has-children",f({pathname:w.val,subTree:E})&&"active")},b({variant:m,color:h,size:C,subTree:E})))),Z=({variant:L,color:w,size:m,currentTree:h,pathnameState:C})=>{const{children:E,parentTree:R,data:P,renderList:F}=h;return y({class:D("drillDownMenu",L,w,m)},R&&g({variant:L,color:w,size:m,data:P,currentTree:h}),E&&F?F({renderListDefault:_,children:E,pathnameState:C,variant:L,color:w,size:m}):_({children:E,pathnameState:C,variant:L,color:w,size:m}))},H=({tree:L,pathname:w})=>{let m=$t({})({...L}),h=Bt(w)(m);return h||(h=m),h},W=n.state(a.location.pathname.replace(c,""));return a.document.addEventListener("click",L=>{const{target:w}=L,m=w.getAttribute("href");if(w.tagName==="A"&&m&&!m.startsWith("http")&&!m.startsWith("#")&&!m.startsWith("?")){let h=m.replace(c,"");r||(h=h.replace(w.hash,"")),W.val=h}}),function(w){const{size:m=t.size??"md",variant:h=t.variant??"plain",color:C=t.color??"neutral",tree:E,...R}=w;let P,F=n.derive(()=>(P=H({tree:E,pathname:W.val}),P)),U=1;const $=ee=>{const{dataset:ae}=ee.target;ae.buttonback=="true"?U=-1:ae.ischild=="false"?U=1:ae.ischild=="true"&&(U=0)},q=ee=>{switch(ee){case 1:return`${A} ${_e}`;case-1:return`${N} ${_e}`;default:return""}},ne=ee=>{switch(ee){case 1:return`${N} ${_e} reverse`;case-1:return`${A} ${_e} reverse`;default:return""}};return x({class:D(z,h,C,m,t==null?void 0:t.class,R.class),onclick:$},I({animationHide:()=>q(U),animationShow:()=>ne(U)},n.bind({deps:[F],render:()=>()=>Z({variant:h,color:C,size:m,currentTree:P,pathnameState:W})})))}}const To=()=>te.map(e=>`
&.input.${e} {
...
`);function ye(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:p,...d},...g]=V(r);return a({...d,onclick:p,class:D("chip",t.class,c,l,u,p&&"clickable",i,d.class)},...g)}}function Do(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;K(e);const c=n`
...
"Click me"
  ...
  `,g=({value:v,id:x,children:y=[]})=>{const S=c({class:()=>u.val==x?"active":"",href:`#${x}`});return S.innerHTML=v,r({class:()=>u.val==x?"active":""},S,y.length>0&&s(y.map(g)))},b=v=>v.tagName.charAt(1),f=({contentEl:v})=>{const x=v.querySelectorAll(l);let y=2,S={},k={children:[]},I=k;const B=I;let T=[I];return[...x].forEach(A=>{const N=b(A);A.setAttribute("id",A.textContent),!A.innerHTML.includes("<button")&&(S={value:A.innerHTML,id:A.id??A.textContent,children:[]},y==N?(k=S,I.children.push(k)):y<N?(T.push(I),I=k,k.children.push(S),k=S):y>N&&(I=T[N-1],T=T.slice(0,N-1),I.children.push(S),k=S),y=N)}),B};return function(...x){let[{size:y=t.size??"md",variant:S=t.variant??"plain",color:k=t.color??"neutral",contentEl:I,...B}]=V(x);const T=f({contentEl:I}),A=p(()=>{const z=[...I.querySelectorAll(l)].find(_=>{const{top:Z,height:H}=_.getBoundingClientRect();if(Z+H>60)return!0});z&&(u.val=z==null?void 0:z.id)},100);return i({...B,class:D("tableOfContent",y,S,k,d,t==null?void 0:t.class,B==null?void 0:B.class),bauMounted:()=>{a.addEventListener("scroll",A)},bauUnmounted:()=>{a.removeEventListener("scroll",A)}},T.children&&s(T.children.map(g)))}}const Jt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:p,name:d}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(c(s(l(d??""),te.map(g=>l(g)))),i(vo.map(g=>s(l(g),te.map((b,f)=>r(p({color:b,variant:g},{index:f}))))))))}},La=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:i}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},xo.map((s,r)=>i(e,{size:s})({color:"success",variant:"outline"},{size:s,index:r})))}},j=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:i,h1:s,p:r,h2:c,h3:l,pre:u,code:p}=t.tags;ke.registerLanguage("javascript",qt);const d=Yt(e),g=De(e,{class:n`
      &.paper {
...
`);function Fe(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${_a()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",data:f=[],...v}]=V(p);const x=n.state(""),y=ut(e,{size:d,variant:g,color:b}),S=I=>B=>{x.val==I?x.val="":x.val=I},k=I=>{const{Header:B,Content:T,name:A}=I,N=()=>r({class:()=>D(x.val==A&&"active")},c({type:"button","aria-controls":`bau-${A}`,"aria-expanded":({element:_})=>x.val==A},B(I))),z=()=>a({id:`bau-${A}`,"data-state":({element:_})=>x.val==A},T(I));return s({class:D(b,g,d),onclick:S(A)},y({Header:N,Content:z}))};return a({class:D("accordion",l,t==null?void 0:t.class,v.class)},i(f.map(k)))}}const Qt=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],s=Fe(e,t);return r=>s({...r,data:i})},za=e=>{const{bau:t}=e,{div:n,p:o,section:a}=t.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],s=Fe(e);return()=>a(s({data:i,color:"neutral",variant:"outline"}))},Ra=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,Fa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:Ra,createComponent:za},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Ha,createComponent:ja},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Ga,createComponent:Ua}],gridItem:Qt},Va=e=>{const t=j(e);return()=>t(Fa)},Wa={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Xa=()=>te.map(e=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`);function Me(e,t={}){const{bau:n,css:o}=e,{div:a,i}=n.tags,s=o`
    ...
    ${Xa()}
  `,r=K(e),c=({onclick:l})=>r({"aria-label":"Close",onclick:l,class:"button-close"},"✖");return function(...u){let[{size:p=t.size??"md",variant:d=t.variant??"outline",color:g=t.color??"neutral",onRemove:b,...f},...v]=V(u);return a({...f,class:D("alert",`alert-${d}`,t.class,d,g,p,s,f.class),role:"alert"},i({class:"icon"},Wa[g]),a({class:"content"},...v),b&&c({onclick:b}))}}const tn=(e,t)=>{const n=Me(e,t);return o=>n({...o},`Alert ${(t==null?void 0:t.size)??""} `)},Za=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=Me(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},Ka=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ja={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ka,createComponent:Za},{title:"Custom Alert ",description:"A custom alert.",code:Ya,createComponent:qa}],gridItem:tn},Qa=e=>{const t=j(e);return()=>t(Ja)},er=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
...
`,or={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:nr,createComponent:tr}]},ar=e=>{const t=j(e);return()=>t(or)},rr=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=He(e),s=K(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`,lr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:sr,createComponent:rr},{title:"Component hide and show",description:"Hide and show a component",code:cr,createComponent:ir}]},ur=e=>{const t=j(e);return()=>t(lr)};function Ve(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
    0% {
      transform: translateX(-100%);
    }
    50% {
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",...g},...b]=V(l);return i({...g,class:D("skeleton",u,r,t==null?void 0:t.class,g==null?void 0:g.class)},...b)}}function dt(e,t={}){const{bau:n,css:o}=e,{div:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...d){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:f=t.color??"neutral",width:v=40,height:x=40,alt:y,...S},...k]=V(d);const I=Ve(e,{class:D(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${x}px;
          width: ${v}px;
        `,t==null?void 0:t.class,S.class)});return a({class:D(u,t==null?void 0:t.class,S.class)},()=>s.val&&I(),()=>r.val&&y,i({width:v,height:x,onload:c,onerror:l,class:()=>D(!s.val&&"visible",r.val&&"hide",f,b,g,u,t==null?void 0:t.class,S.class),...S}))}}const nn=(e,t)=>{const{css:n}=e,o=dt(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
`);function Xe(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${vr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",label:d,placeholder:g,Option:b,options:f,defaultOption:v,getOptionLabel:x,getOptionValue:y,onSelect:S=()=>{},id:k,required:I,name:B,loading:T,...A},...N]=V(c);const z=We(e),_=K(e),Z=ye(e,{variant:u,color:p,size:l}),H=xe(e),W=we(e,{variant:u,color:p,size:l}),L=n.state(v),w=n.state(A.value),m=n.state(!1),h=n.state(0),C=()=>{m.val=!1},E=n.state(f),R=J=>se=>J.val&&x(se)==x(J.val),P=()=>{ue.openDialog(),m.val=!0,w.val="",E.val=f,h.val=f.findIndex(R(L));const J=Se.querySelector("li.selected");J&&(J.scrollIntoView({block:"center"}),be.scrollIntoView({block:"end"}))},F=()=>{ue.closeDialog(),m.val=!1,w.val="",h.val=0},U=J=>{const{value:se}=J.target;w.val=se,se?E.val=f.filter(ie=>x(ie).match(new RegExp(`${se}`,"i"))):E.val=f},$=J=>{ue.open?F():P()},q=({option:J,index:se})=>ie=>{L.val=J,h.val=se,F()},ne=()=>{const J=Se.querySelector("li.active");J&&J.scrollIntoView({block:"center",behavior:"smooth"})},ee=J=>{switch(J.key){case"Escape":F();break;case"ArrowDown":h.val<E.val.length-1?h.val++:h.val=0,ne();break;case"ArrowUp":h.val<=0?h.val=E.val.length-1:h.val--,ne();break;case"Enter":ue.open?(L.val=E.val[h.val],w.val="",F()):P(),J.preventDefault();break}},ae=_({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":m,"aria-label":d,onclick:$,variant:u,color:p,size:l,class:T==!0&&"loading",disabled:T},()=>L.val?x(L.val):d,()=>T==!0&&W({visibility:T})),be=Z({value:w,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":m,oninput:U,onkeydown:ee,...A}),Pe=Z({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,value:w,required:I,name:B}),Se=a({class:D(u,p,l,"content")},be,()=>H({class:D(u,p,l)},E.val.map((J,se)=>i({class:()=>D(h.val==se&&"active",R(L)(J)&&"selected"),onclick:q({option:J,index:se})},b(J))))),ue=z({id:k,triggerEl:ae,contentEl:Se,onClose:C,class:o`
        overflow: hidden;
      `});return n.derive(()=>{L.val&&(Pe.value=y(L.val),S(L.val))}),a({...A,class:D("autocomplete",s,t==null?void 0:t.class,A==null?void 0:A.class)},ae,Pe,ue)}}const on=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Xe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,kr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:yr,createComponent:xr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Er,createComponent:Cr},{title:"Default Option",description:"A autocomplete with a default option.",code:Sr,createComponent:wr}],gridItem:on},Tr=e=>{const t=j(e);return()=>t(kr)};function an(e,t={}){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,Mr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Dr,createComponent:Ar}],gridItem:rn},Ir=e=>{const t=j(e);return()=>t(Mr)};function pt(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,{separator:c="〉"}=t,l=K(e),u=o`
  ...
  `;return function(...d){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:f=t.color??"neutral",items:v,...x},...y]=V(d);return i({...x,class:D(u,t==null?void 0:t.class,x==null?void 0:x.class)},v.map(({href:S,name:k})=>s((S?l:r)({href:`${a.base}${S}`,color:f,variant:b,size:g,class:D(f,b,g)},k))))}}const sn=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=pt(e,t);return a=>o({...a,...n})},Nr=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=pt(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},$r=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,Hr={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Solid Button",description:"A simple button.",code:zr,createComponent:_r},{title:"Disabled Button",description:"A disabled button.",code:jr,createComponent:Rr}],gridItem:cn},Ur=e=>{const t=j(e);return()=>t(Hr)},Gr=()=>te.map(e=>`
&.button-group.${e} {
...
`,Wr={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:Vr,createComponent:Fr}],gridItem:ln},Xr=e=>{const t=j(e);return()=>t(Wr)};function un(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>te.map(r=>`
...
`,qr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Kr,createComponent:Zr}],gridItem:dn},Yr=e=>{const t=j(e);return()=>t(qr)};function Jr(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    display: inline-block;
    position: relative;
    overflow: hidden;
    & img {
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:p=t.color??"neutral",slides:d,Slide:g,Previous:b,Next:f,...v}]=V(c);const x=()=>{s.val<=0?s.val=d.length-1:s.val--},y=()=>{s.val>=d.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},d.map(g));return a({...v,class:D("carousel",l,i,t==null?void 0:t.class,v==null?void 0:v.class)},a({class:D("control","control-previous"),onclick:x},b()),a({class:D("control","control-next"),onclick:y},f()),S)}}const Qr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],es=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=K(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,ss={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:rs,createComponent:as}],gridItem:pn},is=e=>{const t=j(e);return()=>t(ss)};function mn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=V(r);return a({type:"checkbox",required:"required",...p,class:D(i,u,l,c,t==null?void 0:t.class,p==null?void 0:p.class)})}}const gn=(e,t)=>{const{bau:n,css:o}=e,{label:a}=n.tags,i=mn(e,t);return s=>a({class:o`
          display: flex;
...
`,us={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:ls,createComponent:cs}],gridItem:gn},ds=e=>{const t=j(e);return()=>t(us)},ps=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=ut(e),i=K(e,{variant:"outline"}),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},ms=`import button from "@grucloud/bau-ui/button";
...
`,gs={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:ms,createComponent:ps}]},bs=e=>{const t=j(e);return()=>t(gs)};function hs(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=V(r);return a({...p,class:D("divider",c,i,t==null?void 0:t.class,p==null?void 0:p.class)},a({class:"content"},...d))}}const fs=e=>{const{bau:t}=e,{section:n}=t.tags,o=hs(e);return()=>n(o("OR"))},vs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Es={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:Cs,createComponent:Ss}]},ks=e=>{const t=j(e);return()=>t(Es)},Ts=()=>te.map(e=>`
`).join(`
`);function bn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=K(e),r=We(e),c=xe(e),l=o`
    ${Ts()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",label:f,ListItem:v,items:x,...y},...S]=V(p);const k=n.state(0),I=()=>{H.openDialog(),H.focus()},B=()=>{H.closeDialog()},T=()=>{H.open?B():I()},A=W=>{T(),W.preventDefault()},N=({item:W,index:L})=>w=>{k.val=L,B(),w.preventDefault()},z=W=>{switch(W.preventDefault(),W.key){case"Escape":B();break;case"ArrowDown":k.val<options.length-1?k.val++:k.val=0;break;case"ArrowUp":k.val<=0?k.val=options.length-1:k.val--;break;case"Enter":T();break}},_=()=>c({tabindex:"0",class:D(b,g)},x.map((W,L)=>i({class:()=>D(k.val==L&&"active"),onclick:N({item:W,index:L})},v(W)))),Z=s({type:"button",onclick:A,color:b,variant:g,size:d},f),H=r({triggerEl:Z,contentEl:_()});return a({...y,class:D("dropdownMenu",b,d,l,t==null?void 0:t.class,y==null?void 0:y.class),onkeydown:z},Z,H)}}const As=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,i=bn(e,t),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>i({...c,items:s,ListItem:r,label:"Action"})},Ds=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,i=bn(e),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(i({items:s,ListItem:r,label:"Action"}))},Ms=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,zs={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:_s,createComponent:Ls}],gridItem:vn},Rs=e=>{const t=j(e);return()=>t(zs)};function xn(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:p,...d},...g]=V(r);return a({...d,class:D("form",u,l,c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}function gt(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,Us={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Login page",description:"A login page.",code:Hs,createComponent:js}]},Gs=e=>{const t=j(e);return()=>t(Us)},yn=(e,t={})=>{const n=ye(e,t);return o=>n({name:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,placeholder:"Enter text",...o})},Fs=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=ye(e);return()=>n(o("Basic input"),a({id:"my-input",name:"my-input",placeholder:"Enter Text"}),o("Disabled input"),a({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))},Vs=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ws={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:Vs,createComponent:Fs}],gridItem:yn},Xs=e=>{const t=j(e);return()=>t(Ws)},wn=(e,t={})=>{const n=rt(e,t);return o=>n({name:`myinputSearch-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinputSearch-gallery-${t.color??o.color}-${t.variant??o.variant}-${o.size??t.size}`,placeholder:"Enter text",...o})},Zs=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=rt(e);return()=>n(o("Basic inputSearch"),a({id:"my-inputSearch",name:"my-inputSearch",placeholder:"Enter Text"}),o("Disabled inputSearch"),a({name:"my-inputSearch-disabled",placeholder:"Enter Text",disabled:!0}))},Ks=`import inputSearch from "@grucloud/bau-ui/inputSearch";
import { Context } from "@grucloud/bau-ui/context";
...
`,ai={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:oi,createComponent:ni}],gridItem:En},ri=e=>{const t=j(e);return()=>t(ai)},si=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],ii=(e,t)=>{const{bau:n,css:o}=e,{span:a,li:i}=n.tags,s=xe(e,t),r=({code:c,label:l})=>i({class:o`
          display: flex;
          gap: 1rem;
...
`,di={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:ui,createComponent:li}],gridItem:ii},pi=e=>{const t=j(e);return()=>t(di)};function kn(e,t={}){const{bau:n,css:o}=e,{dialog:a,div:i}=n.tags,r=o`
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
    border-radius: var(--global-radius);
    min-width: 400px;
...
`,xi={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:vi,createComponent:fi}]},yi=e=>{const t=j(e);return()=>t(xi)};function wi(e,t={}){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,Ei={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:Ci,createComponent:Si}]},ki=e=>{const t=j(e);return()=>t(Ei)},Ti=(e,t)=>{const{bau:n}=e,{div:o}=n.tags,a=De(e,t);return i=>a({...i},o(`Paper ${t.size??""}`))},Ai=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=De(e);return()=>n(a({size:"md"},o("My content")))},Di=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:p=t.color??"neutral",...d}]=V(c);return a({...d,type:"radio",class:D("radio-button",l,p,u,s,t==null?void 0:t.class,d==null?void 0:d.class)})}}const Dn=(e,t)=>{const{bau:n,css:o}=e,{label:a,form:i}=n.tags,s=An(e,t);return r=>i({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,Bi={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:$i,createComponent:Ni}],gridItem:Dn},Pi=e=>{const t=j(e);return()=>t(Bi)},Oi=()=>te.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function Ie(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=K(e),l=We(e),u=xe(e),p=o`
    ...
    ${Oi()}
  `;return function(...g){let[{size:b=t.size??"md",variant:f=t.variant??"outline",color:v=t.color??"neutral",label:x,Option:y,options:S,defaultOption:k,getOptionLabel:I,getOptionValue:B,onSelect:T=()=>{},loading:A,...N},...z]=V(g);const _=we(e,{variant:f,color:v,size:b}),Z=n.state(k?I(k):x),H=n.state(!1),W=n.state(0),L=()=>{F.openDialog(),F.focus(),H.val=!0},w=()=>{F.closeDialog(),H.val=!1},m=()=>{H.val=!1},h=$=>{F.open?w():L(),$.preventDefault()},C=({option:$,index:q})=>ne=>{Z.val=I($),U.value=B($),U.setCustomValidity(""),W.val=q,w(),T($),ne.preventDefault()},E=$=>{switch($.preventDefault(),$.key){case"Escape":w();break;case"ArrowDown":W.val<S.length-1?W.val++:W.val=0;break;case"ArrowUp":W.val<=0?W.val=S.length-1:W.val--;break;case"Enter":F.open?(Z.val=I(S[W.val]),U.value=B(r),w()):L();break}},R=()=>u({tabindex:"0",class:D(v,f)},S.map(($,q)=>i({class:()=>D(W.val==q&&"active"),onclick:C({option:$,index:q})},y($)))),P=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":H,"aria-label":x,onclick:h,color:v,variant:f,size:b,class:A==!0&&"loading",disabled:A},()=>!Z.val&&x,Z,()=>A==!0&&_({visibility:A})),F=l({triggerEl:P,contentEl:R(),onClose:m}),U=s(N,r({value:""},"--Select Category--"),S.map($=>r({value:B($)},I($))));return U.value=N.value,a({...N,class:D("select",v,b,p,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:E},U,P,F)}}const Mn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Ie(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Fi={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:_i,createComponent:Li},{title:"Default Option",description:"Select with a default option",code:Ri,createComponent:zi},{title:"Select AWS region",description:"Select the AWS region",code:Hi,createComponent:ji},{title:"Loading Indicator",description:"Select with a loading indicator",code:Gi,createComponent:Ui}],gridItem:Mn},Vi=e=>{const t=j(e);return()=>t(Fi)};function In(e,t={}){const{bau:n,css:o}=e,{select:a}=n.tags,i=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
...
`,Zi={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Xi,createComponent:Wi}],gridItem:Nn},Ki=e=>{const t=j(e);return()=>t(Zi)},qi=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=Ve(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,gc={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:mc,createComponent:pc}],gridItem:Bn},bc=e=>{const t=j(e);return()=>t(gc)},hc=()=>te.map(e=>"").join(`
`),fc=(e,t)=>(n,o)=>{const a=new URLSearchParams(e.window.location.search);return a.delete(t),a.append(t,n),o&&Object.entries(o).map(([i,s])=>(a.delete(i),a.append(i,s))),`?${a.toString()}`};function vc(e,t={}){const{bau:n,css:o,window:a}=e,{div:i,ul:s,li:r,span:c,section:l}=n.tags,u=o`
    display: flex;
    flex-direction: column;
    padding: 1rem;
    & > ul {
  ...
  `;return function(...d){let[{color:g,variant:b="plain",size:f,stepperDefs:v=[],stepperName:x,activeStepIndex:y=n.state(0),...S},...k]=V(d);const I=n.state(v.map((_,Z)=>({..._,index:Z}))),B=n.state([]),T=()=>{const Z=new URLSearchParams(a.location.search).get(x)??v[0].name,H=Math.max(v.findIndex(({name:W})=>W==Z),0);H<y.val&&(console.log("remove last step"),B.val.pop()),B.val.some(({name:W})=>Z==W)||(console.log("add new step"),B.val.push(v[H])),y.val=H};T(),a.history.pushState=new Proxy(a.history.pushState,{apply:(_,Z,H)=>{_.apply(Z,H),console.log("stepper pushState");const W=H[2]??"";["?","#"].includes(W[0])&&T()}}),document.addEventListener("click",_=>{const{target:Z}=_,H=Z.getAttribute("href");Z.tagName==="A"&&H&&["?","#"].includes(H[0])&&(console.log("stepper click"),_.preventDefault())}),a.addEventListener("popstate",_=>{T()});const A=n.derive(()=>I.val[y.val]),N=_=>{const{Header:Z,disabled:H,name:W,index:L}=_;return r({class:()=>D(A.val.name==W&&"active",y.val<L&&"not-completed",y.val>L&&"completed",H&&"disabled")},c({class:"step-number"},L+1),c({class:"step-label"},()=>Z(_)))},z=_=>v.findIndex(({name:Z})=>Z==_.name);return i({class:D("stepper",b,f,g,u,t==null?void 0:t.class,S.class)},n.loop(I,s(),N),n.loop(B,l(),_=>i({class:()=>D("content",_.name==A.val.name&&"visible")},_.Content({nextStep:v[z(_)+1],previousStep:v[z(_)-1]}))))}}const It="my-wizard",xc=e=>{const{bau:t,window:n}=e,{footer:o,p:a,label:i,section:s,a:r,ul:c,li:l}=t.tags,u=ye(e),p=xn(e),d=vc(e),g=fc(e,It),b=K(e,{variant:"outline",color:"primary"}),f=K(e,{variant:"solid",color:"primary"}),v=({nextStep:S})=>k=>{k.preventDefault();const{organization:I}=k.target.elements;n.history.pushState("","",g(S.name,{organization:I.value}))},x=S=>{var T;S.preventDefault();const{organization:k}=(T=n.document.forms)==null?void 0:T.formStep1.elements,B=new URLSearchParams(n.location.search).get("choice");alert(`organization ${k.value}, choice:${B}`)},y=[{name:"step1",Header:()=>"Step 1",Content:({nextStep:S})=>p({onsubmit:v({nextStep:S}),id:"formStep1"},i("Organization",u({autofocus:!0,placeholder:"Organization",name:"organization",required:!0,minLength:3})),o(f({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:S,previousStep:k})=>p(c(l(r({href:g(S.name,{choice:"choice1"})},"Choice 1")),l(r({href:g(S.name,{choice:"choice2"})},"Choice 2"))),o(b({href:g(k.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:S})=>p({onsubmit:x},a("My stepper 3 Content"),o(b({href:g(S.name)},"Previous: Step 2"),f({type:"submit"},"Save")))}];return()=>s(d({stepperDefs:y,stepperName:It}))},yc=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
...
`);function Pn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Cc()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=V(r);return a({...p,class:D("switch",i,u,l,c,t==null?void 0:t.class,p.class),type:"checkbox",required:"required"},...d)}}const On=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:i}=n.tags,s=Pn(e,t);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,Tc={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:kc,createComponent:Ec}],gridItem:On},Ac=e=>{const t=j(e);return()=>t(Tc)},Dc=()=>te.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
`);function Ne(e,t={}){const{bau:n,css:o,window:a}=e,{tabDefs:i}=t,{div:s,ul:r,li:c}=n.tags,l=o`
    ...
    ${Dc()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",...f},...v]=V(p);const x=n.state(i),y=a.location.hash.slice(1),S=T=>x.val.find(A=>A.name==T),k=n.state(S(y)??i[0]),I=T=>{const{Header:A,disabled:N,name:z}=T;return c({class:()=>D(k.val.name==z&&"active",N&&"disabled"),onclick:_=>_.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:z},bubbles:!0}))},A(T))},B=s({class:D("tabs",g,d,b,l,t==null?void 0:t.class,f.class)},n.loop(x,r(),I),()=>k.val.Content?k.val.Content(f):"");return B.addEventListener("tab.select",T=>{var z,_;const{tabName:A}=T.detail,N=S(A);N&&((z=k.val.exit)==null||z.call(),k.val=N,(_=N.enter)==null||_.call())},!1),B.addEventListener("tab.add",T=>{var N;const{tab:A}=T.detail;(N=A.enter)==null||N.call(),x.val.push(A)},!1),B.addEventListener("tab.remove",T=>{var N;const A=x.val.findIndex(z=>z.name==T.detail.tabName);A>0&&((N=x.val[A].exit)==null||N.call(),x.val.splice(A,1))},!1),B}}const Ln=(e,t)=>{const{bau:n}=e,{div:o,p:a,a:i}=n.tags,r=Ne(e,{tabDefs:[{name:"Tab1",Header:()=>i({href:"#Tab1"},"TAB 1"),Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>i({href:"#Tab2"},"TAB 2"),Content:()=>o(a("My tab 2 Content"))}],...t});return c=>r(c)},Mc=e=>{const{bau:t}=e,{div:n,p:o,a}=t.tags,s=Ne(e,{tabDefs:[{name:"Tab1",Header:()=>a({href:"#Tab1"},"TAB 1"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>a({href:"#Tab2"},"TAB 2"),Content:()=>n(o("My tab 2 Content"))}],variant:"outline",color:"neutral"});return()=>s({})},Ic=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=V(c);return i({...l,class:D("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const Rc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function p(v,x,y,S,k){return{name:v,calories:x,fat:y,carbs:S,protein:k}}const d=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],g=({name:v,calories:x})=>s(i(v),i({class:n`
            text-align: right;
          `},x)),b=()=>c(s(a({class:n`
              text-align: left;
...
`,Yc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:qc,createComponent:Kc}]},Jc=e=>{const t=j(e);return()=>t(Yc)};function zn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=mt(e),s=K(e),r=we(e),c=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,l=({label:b,icon:f,...v})=>s({"aria-label":b,title:b,...v},f),u=({count:b,totalCount:f,page:v,rowsPerPage:x})=>a({class:"pages-numbers"},Number(v-1)*Number(x)+(b>0?1:0),"-",Math.min(v*x,f)," of ",f),p=({count:b,page:f,rowsPerPage:v})=>a({class:"pages-numbers"},(f-1)*v+(b>0?1:0),"-",f*v),d=b=>b<=1,g=(b,f,v)=>b>=Math.ceil(f/v);return function(...f){let[{size:v=t.size??"md",variant:x=t.variant??"outline",color:y=t.color??"neutral",count:S=0,totalCount:k=0,page:I=1,rowsPerPage:B=50,onPageChange:T,isLoading:A=!1,disableFirst:N=()=>d(I),disablePrevious:z=()=>d(I),disableNext:_=()=>g(I,k,B),disableLast:Z=()=>g(I,k,B),...H},...W]=V(f);const L=Math.max(0,Math.ceil(k/B)),w=T({page:1}),m=T({page:I-1}),h=T({page:I+1}),C=T({page:L}),E=[{label:"First",icon:"⟪",onclick:w,disabled:N()},{label:"Previous",icon:"⟨",onclick:m,disabled:z()},{label:"Next",icon:"⟩",onclick:h,disabled:_()},{label:"Last",icon:"⟫",onclick:C,disabled:Z()}];return a({...H,class:D("table-pagination",c,A&&"disabled",t==null?void 0:t.class,H==null?void 0:H.class)},r({class:"spinner",visibility:A,size:"md"}),k>0?u({count:S,totalCount:k,page:I,maxPages:L,rowsPerPage:B}):p({count:S,page:I,maxPages:L,rowsPerPage:B}),i({variant:x,color:y},E.map(R=>l({...R,variant:x,color:y}))))}}const Qc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),el=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=Qc(45),u=({name:y,email:S})=>i(a(y),a(S)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),d=zn(e),g=$e(e,{class:n`
      max-width: 650px;
    `}),b=t.state(l),f=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),v=t.derive(()=>b.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),x=({page:y})=>S=>{f.val.page=y};return()=>g(s(p(),()=>c(v.val.map(u))),()=>d({...f.val,onPageChange:x}))},tl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),p=t.state([]),d=t.state(""),g=t.derive(()=>p.val.length),b=t.state(1),f=t.state(10),v=t.derive(()=>p.val),x=N=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(N).toString()}`,y=({page:N})=>z=>{b.val=N,S(x({page:N,per_page:f.val}))};S(x({page:1,per_page:f.val}));async function S(N){try{u.val=!0;const z=await fetch(N,{});if(z.ok){const _=await z.json();p.val=_;return}throw z}catch(z){d.val=z.message}finally{u.val=!1}}const k=({name:N,description:z,stargazers_count:_})=>i(a(N),a(z),a({class:n`
            text-align: right;
          `},_)),I=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),A=({message:N})=>l(N);return()=>T(()=>B({rowsPerPage:f.val,page:b.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:y,disableNext:()=>!1}),s(I(),()=>d.val&&A({message:d.val}),()=>c(v.val.map(k))))},nl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=el(e),l=tl(e),u=(...p)=>a({class:n`
...
`,rl={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:al,createComponent:ol}],gridItem:Rn},sl=e=>{const t=j(e);return()=>t(rl)},il=()=>te.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`,Sl={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:wl,createComponent:yl}],gridItem:Un},Cl=e=>{const t=j(e);return()=>t(Sl)},El=({css:e,createGlobalStyles:t})=>(t`
:root {
