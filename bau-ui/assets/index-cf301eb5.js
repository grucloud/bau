    ...
    `}),w=se(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),E=()=>c({class:o`
        ...
        `},u({class:n`
          ...
          `},m({title:"Bau UI",links:p}),m({title:"Bau Ecosystem",links:b})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},r("v0.77.0"),r("MIT license")))}}function yt(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
...
`);function Se(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("switch",r,u,c,l,e==null?void 0:e.class,d.class),type:"checkbox"},...m)}}const Un=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Se(t,e);return s=>a({class:o`
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},Dl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Se(t,{variant:"outline"}),l=M(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`,Bl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Se(t,{variant:"outline"}),l=M(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
