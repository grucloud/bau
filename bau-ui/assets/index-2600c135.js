...
`)}
  ...
  `}function Gn(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let Fe=e=>Object.prototype.toString.call(e??0).slice(8,-1),Fn=e=>Fe(e)=="Object",st=e=>Fe(e)=="Function",ze=e=>["Object","Array"].includes(Fe(e)),it=Object.getPrototypeOf,He=e=>me(e)?e.val:e,me=e=>e==null?void 0:e.__isState,Vn=["splice","push","pop","shift","unshift","sort","reverse"],ke=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const Z=e=>!me(e[0])&&Fn(e[0])?e:[{},...e];function Wn(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=v=>n.createElement(v),l=(v,m,b)=>{let x=r;r=m;let C=v(b);return r=x,C},d=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(v=>{v.bindings=v.bindings.filter(m=>{var b;return(b=m.element)==null?void 0:b.isConnected}),!v.bindings.length&&!v.computed&&a.delete(v)}),o=void 0}))},p=(v,m,b,x,C,O)=>{var $;if(s){i.add(v);return}for(let W of v.bindings){let{deps:_,element:I,renderInferred:F,render:J,renderItem:ee}=W;if(ee&&m)($=f(I,x,(...ae)=>g(ee(...ae)),b,C,O)[m])==null||$.call();else{let ae=F?F({element:I}):J({element:I,renderItem:ee})(..._.map(He));ae!==I&&I.replaceWith(W.element=g(ae))}}S(v),d()},u=(v,m,b=[])=>({get(x,C,O){var $;if(r==null||r.add(v),C==="_isProxy")return!0;if(!(($=x[C])!=null&&$._isProxy)&&!me(x[C])&&ze(x[C]))x[C]=new Proxy(x[C],u(v,m,[...b,C]));else if(Vn.includes(C)){let W=x[C];return(..._)=>{let I=W.apply(x,_);return p(v,C,I,_,m,b),I}}return Reflect.get(x,C,O)},set(x,C,O,$){let W=Reflect.set(x,C,O,$);return p(v,"setItem",W,{prop:C,value:O},m,[...b,C]),W}}),h=(v,m)=>new Proxy(m,u(v,m)),f=(v,m,b,x,C,O)=>{let $=()=>v.replaceChildren(...ke(x,b)),W=_=>v[_]&&v.removeChild(v[_]);return{assign:$,sort:$,reverse:$,setItem:()=>{var I;let _=O[0];(I=v.children[_])==null||I.replaceWith(b(C[_],_))},push:()=>v.append(...ke(m,(_,I)=>b(_,C.length+I))),unshift:()=>v.prepend(...ke(m,b)),pop:()=>W("lastChild"),shift:()=>W("firstChild"),splice:()=>{let[_,I,...F]=m;const{length:J}=v.children;for(let ee=_>=0?Math.min(_+I-1,J-1):J-1;ee>=(_>=0?_:J+_);ee--)v.children[ee].remove();if(F.length){let ee=F.forEach((ae,Pe)=>b(ae,_+Pe));v.children[_]?v.children[_].after(...ee):v.append(...ee)}}}},w=v=>({oldVal:v,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=ze(v)?h(m,v):v,m.valProxy)},set val(m){let b=this,x=b.val;ze(m)?(b.valProxy=h(b,m),p(b,"assign",m)):m!==x&&(b.valProxy=m,p(b)),b.oldVal=x}}),g=v=>v==null||v===!1?c("span"):v.nodeType?v:n.createTextNode(v),y=(v,m)=>{let b=new Set;return m.val=l(v,b),b},E=v=>{let m=w(),b=y(v,m);m.computed=!0;for(let x of b)x.listeners.push({computed:v,deps:b,state:m});return m},S=v=>{for(let m of[...v.listeners])y(m.computed,m.state)},N=(v,...m)=>{if(m.length){let b=[];for(let x of m.flat(1/0))x!=null&&b.push(me(x)?z({deps:[x],render:()=>C=>C}):st(x)?Q({renderInferred:x}):g(x));v.append(...b)}},P={},B=(v,m)=>v&&(Object.getOwnPropertyDescriptor(v,m)??B(it(v),m)),M=(v,m,b)=>{var x;return P[v+","+m]??(P[v+","+m]=((x=B(b,m))==null?void 0:x.set)??0)},R=(v,m)=>new t.MutationObserver((b,x)=>{b.filter(C=>C.removedNodes).forEach(C=>[...C.removedNodes].find(O=>O===v&&(m({element:v}),x.disconnect(),!0)))}).observe(v.parentNode,{childList:!0}),D=(v,m)=>new t.MutationObserver((b,x)=>b.forEach(C=>m({record:C,element:v}))).observe(v,{childList:!0}),j=v=>new Proxy(function(b,...x){var W;let[C,...O]=Z(x),$=v?n.createElementNS(v,b):c(b);for(let[_,I]of Object.entries(C)){if(_.startsWith("bau"))continue;let F=M(b,_,it($))?J=>$[_]=J:J=>$.setAttribute(_,J);I==null||(me(I)?z({deps:[I],render:()=>()=>(F(I.val),$)}):st(I)&&(!_.startsWith("on")||I.isDerived)?Q({renderInferred:()=>(F(I({element:$})),$)}):I.renderProp?z({deps:I.deps,render:()=>()=>(F(I.renderProp({element:$})(...I.deps.map(He))),$)}):F(I))}return C.bauChildMutated&&D($,C.bauChildMutated),N($,...O),(W=C.bauCreated)==null||W.call(C,{element:$}),C.bauMounted&&t.requestAnimationFrame(()=>C.bauMounted({element:$})),C.bauUnmounted&&t.requestAnimationFrame(()=>R($,C.bauUnmounted)),$},{get:(m,b)=>m.bind(void 0,b)}),Y=(v,m,b)=>{v.element=g(b);for(let x of m)me(x)&&(a.add(x),x.bindings.push(v));return v.element},Q=({renderInferred:v,element:m})=>{let b=new Set,x=l(v,b,{element:m});return Y({renderInferred:v},b,x)},z=({deps:v,element:m,render:b,renderItem:x})=>Y({deps:v,render:b,renderItem:x},v,b({element:m,renderItem:x})(...v.map(He))),G=(v,m,b)=>z({deps:[v],render:({renderItem:x})=>C=>(m.append(...ke(C,x)),m),renderItem:b}),U=v=>{s=!0,v(),s=!1,i.forEach(p),i.clear()};return{tags:j(),tagsNS:j,state:w,bind:z,loop:G,derive:E,stateSet:a,batch:U}}const Xn=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},Zn=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Kn=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function Yn(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=Kn(a,i),r=Xn(s);return!t.getElementById(r)&&Zn(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function qn(e){const t=Wn(),n=Yn();return Un(n),{bau:t,...n,tr:o=>o,window,...e}}function T(...e){return e.filter(t=>t).join(" ")}function De(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:T("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:d,element:p})=>{[...d.removedNodes].forEach(u=>{if(!s()||u.getAttribute("cloned"))return;const h=u.cloneNode(!0);h.setAttribute("cloned",!0),h.style.top=0,h.style.left=0,h.style.width=u.getAttribute("width"),h.style.height=u.getAttribute("height"),h.style.position="absolute",h.style.animation=s(),d.target.appendChild(h),h.addEventListener("animationend",()=>h.parentNode.removeChild(h))}),[...d.addedNodes].forEach(u=>{if(u.getAttribute("cloned"))return;p.style.position="relative";const h=u.getBoundingClientRect();if(u.setAttribute("width",h.width+"px"),u.setAttribute("height",h.height+"px"),r()){u.style.animation=r();const f=()=>{u.removeEventListener("animationend",f),u.style.animation=""};u.addEventListener("animationend",f)}})},...c},l)}}function q(e,t){const{bau:n,css:o}=e,a={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
...
`);function Ve(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=d=>{a.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(eo);const l=o`
    ...
    ${to()}
  `;return function(...p){let[{color:u,variant:h="outline",size:f="md",...w},...g]=Z(p);return i({required:"required",title:"Switch Theme",...w,class:T("theme-switch",u,h,f,l,t==null?void 0:t.class,w.class),type:"checkbox",checked:r()=="dark",onclick:y=>{s(y.target.checked?"dark":"light")}},...g)}}function no(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:d,img:p,b:u,ul:h,li:f}=n.tags,{svg:w,path:g}=n.tagsNS("http://www.w3.org/2000/svg"),y=i.drawerOpen,E=q(e,{class:o`
      background: transparent;
    `}),S=Ve(e),N=()=>s(w({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},g({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),P=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
        ...
        `},P(),B())}}function oo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:d,h1:p}=t.tags,u=({links:w,title:g})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},p(g),r(w.map(({href:y,name:E})=>c(s({href:y},E))))),h=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],f=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
        ...
        `},d({class:n`
            ...
            gap: 10rem;
          `},u({title:"Bau UI",links:h}),u({title:"Bau Ecosystem",links:f})),d({class:n`
            display: flex;
            justify-content: center;
            align-items: center;
            gap: 1rem;
  ...
  `,hideToRight:e`
   ...
   `});function We(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=z=>{var G;return((G=z.parentTree.data)==null?void 0:G.href)??z.parentTree.children[0].data.href},d=({variant:z,color:G,size:U,currentTree:v,data:m})=>S(M({variant:z,color:G,size:U,href:`${c}${l(v)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),M({variant:z,color:G,size:U,href:`${c}${m.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},m.name)),p=({size:z,subTree:{data:{name:G,href:U},children:v=[]}})=>M({size:z,href:`${c}${U}`,"data-ischild":!v.length},G),u=({pathname:z,subTree:G})=>{var U;return z===((U=G==null?void 0:G.data)==null?void 0:U.href)},{renderHeader:h=d,renderMenuItem:f=p,isActive:w=u}=t,{li:g,nav:y,div:E,header:S,a:N}=n.tags,P=De(e),B=we(e),M=q(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:R,hideToRight:D}=ao(e),j=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,Y=({variant:z,color:G,size:U,currentTree:v,pathnameState:m})=>{const{children:b,parentTree:x,data:C}=v;return E({class:T("drillDownMenu",z,G,U)},x&&h({variant:z,color:G,size:U,data:C,currentTree:v}),b&&B({class:T(z,G,U)},b.map(O=>g({class:()=>T(O.children&&"has-children",w({pathname:m.val,subTree:O})&&"active")},f({variant:z,color:G,size:U,subTree:O})))))},Q=({tree:z,pathname:G})=>{let U=vt({})(structuredClone(z)),v=xt(G)(U);return v||(console.error("drilldown no sub tree",G),v=U),v};return function(G){const{variant:U="plain",color:v="neutral",size:m="md",tree:b,...x}=G,C=n.state(a.location.pathname.replace(c,"")),O=n.derive(()=>Q({tree:b,pathname:C.val}));a.document.addEventListener("click",F=>{const{target:J}=F,ee=J.getAttribute("href");if(J.tagName==="A"&&ee&&!ee.startsWith("http")){let ae=ee.replace(c,"");r||(ae=ae.replace(J.hash,"")),C.val=ae}});let $=1;const W=F=>{const{dataset:J}=F.target;J.buttonback=="true"?$=-1:J.ischild=="false"?$=1:J.ischild=="true"&&($=0)},_=F=>{switch(F){case 1:return`${R} ${Te}`;case-1:return`${D} ${Te}`;default:return""}},I=F=>{switch(F){case 1:return`${D} ${Te} reverse`;case-1:return`${R} ${Te} reverse`;default:return""}};return y({class:T(j,t==null?void 0:t.class,x.class),onclick:W},P({animationHide:()=>_($),animationShow:()=>I($)},()=>Y({variant:U,color:v,size:m,currentTree:O.val,pathnameState:C})))}}const ro={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function wt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:d,a:p,span:u}=n.tags;let h=!1;const f=We(e);return function(){return r({bauMounted:({element:g})=>{s.innerWidth<=640&&(h=!0,i.drawerOpen.val=!1)},onclick:g=>{h&&!g.target.dataset.buttonback&&!g.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:T(o`
            grid-area: sidebar;
            position: sticky;
          ...
          `)},f({tree:ro}))}}const so=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:i}=t.tags,s=De(e),r=no(e),c=wt(e),l=oo(e),d=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function lo({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:d}=t.tags,p=({maxSize:u=151})=>({libName:h,size:f})=>r({class:n`
            display: flex;
            margin: 0.3rem;
          `},i({class:n`
              display: flex;
            ...
            `},r({class:n`
                ...
                padding: 0 0.5rem;
                border-radius: 10px;
              `},f)));return function({data:h=[]}){return o({class:n`
          box-shadow: var(--shadow-m);
          border: 1px solid var(--color-emphasis-200);
          padding: 1rem;
        `},c({class:n`
...
"Click me"
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:d="md",...p},...u]=Z(r);return a({...p,class:T("paper",d,i,t==null?void 0:t.class,p==null?void 0:p.class)},...u)}}const Rt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:p,name:u}){return o({class:n`
        ...
        `},a(c(s(l(u??""),oe.map(h=>l(h)))),i(Jn.map(h=>s(l(h),oe.map((f,w)=>r(p({color:f,variant:h},{index:w}))))))))}},ga=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:i}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
...
`).join(`
`);function _e(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,header:r,h3:c,button:l}=n.tags,d=n.state(""),p=f=>w=>{d.val==f?d.val="":d.val=f},u=({element:f,open:w})=>{const g=()=>{f.removeEventListener("transitionend",g)};function y(S){S.addEventListener("transitionend",g),window.requestAnimationFrame(()=>{S.style.height="0px"})}function E(S){S.addEventListener("transitionend",g),S.style.height=S.scrollHeight+"px"}f.scrollHeight!=0&&(w?E(f):y(f))},h=o`
    & ul {
      display: flex;
      flex-direction: column;
      justify-content: flex-start;
    ...
    ${fa()}
  `;return function(...w){let[{color:g,variant:y="outline",size:E="md",data:S=[],...N},...P]=Z(w);const B=M=>{const{Header:R,Content:D,name:j}=M;return s({class:T(g,y,E),onclick:p(j)},c({class:()=>T(d.val==j&&"active")},l({type:"button","aria-controls":`bau-${j}`,"aria-expanded":({element:Y})=>d.val==j},R(M))),a({class:"content",role:"region",id:`bau-${j}`,"data-state":({element:Y})=>{const Q=d.val==j;return u({element:Y,open:Q}),Q}},D(M)))};return a({class:T("accordion",h,t==null?void 0:t.class,N.class)},i(S.map(B)))}}const Lt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=_e(e);return s=>i({...s,data:a})},va=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=_e(e);return()=>i({data:a,color:"neutral",variant:"outline"})},xa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`);function Be(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i,i:s}=n.tags;Aa({css:o,createGlobalStyles:a});const r=o`
    ...
    ${Ma()}
  `,c=q(e),l=({onclick:d})=>c({"aria-label":"Close",onclick:d,class:"button-close"},"✖");return function(p,...u){const{variant:h="outline",color:f="neutral",size:w="md",onRemove:g,...y}=p;return i({...y,class:T(`alert-${h}`,h,f,w,r,t==null?void 0:t.class,p.class,"alert"),role:"alert"},s({class:"icon"},Ta[f]),i({class:"content"},...u),g&&l({onclick:g}))}}const zt=e=>{const t=Be(e);return n=>t({...n},`Alert ${n.variant} ${n.color}`)},Da=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=Be(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},Ia=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,_a={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ia,createComponent:Da},{title:"Custom Alert ",description:"A custom alert.",code:Na,createComponent:$a}],gridItem:zt},Ba=e=>{const t=V(e);return()=>t(_a)},Oa=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},d={stack:o`
    ...
    `},p=({id:u,status:h})=>{const f=c.val.findIndex(w=>w.id===u);f!=-1&&(c.val[f].status=h)};return function(h={},...f){const w=({id:E})=>{p({id:E,status:"removing"});const S=c.val.findIndex(N=>N.id===E);S!=-1&&c.val.splice(S,1)},g=({Component:E})=>{const S={id:Math.random().toString(10).split(".")[1],Component:E,status:"inserting"};c.val.length>=i&&w({id:c.val[0].id}),c.val.push(S),setTimeout(()=>w(S),s)},y=E=>r({class:d.item,onclick:()=>w(E)},E.Component());return document.addEventListener("alert.add",E=>g(E.detail)),document.addEventListener("alert.remove",E=>w(E.detail)),r({class:T(d.stack,t==null?void 0:t.class,h.class)},n.loop(c,r(),y))}},Pa=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Oa(e,{deleteAfterDuration:2e4}),i=q(e),s=Be(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Ra=`import { Context } from "@grucloud/bau-ui/context";
...
`,Fa={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:Ha,createComponent:za},{title:"Component hide and show",description:"Hide and show a component",code:Ga,createComponent:Ua}]},Va=e=>{const t=V(e);return()=>t(Fa)};function Ht(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},d=o`
  ...
  `;return function(...u){let[{color:h,variant:f="outline",size:w="md",width:g=30,height:y=30,...E},...S]=Z(u);return a({class:T(d,t==null?void 0:t.class,E.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:g,height:y,onload:c,onerror:l,class:T(h,f,w,d,t==null?void 0:t.class,E.class),...E}))}}const Ut=e=>{const{css:t}=e,n=Ht(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function Je(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Ya()}
  `;return function(r){const{size:c="md",variant:l="outline",color:d="neutral",name:p,id:u,disabled:h,...f}=r;return a({...f,class:T("input",c,d,l,i,t==null?void 0:t.class,f.class)})}}const qa=()=>oe.map(e=>`
...
`);function Gt(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=qe(e),r=q(e),c=Je(e),l=we(e),d=o`
    ...
    ${qa()}
  `,p=n.state(""),u=n.state(""),h=n.state(!1),f=n.state(0),w=()=>{h.val=!1};return function(...y){let[{variant:E="outline",color:S,size:N="md",id:P,label:B,placeholder:M,Option:R,options:D,getOptionLabel:j=({label:_})=>_,...Y},...Q]=Z(y);const z=n.state(D),G=()=>{W.openDialog(),h.val=!0,u.val="",z.val=D},U=()=>{W.closeDialog(),h.val=!1,u.val=""},v=_=>{const{value:I}=_.target;u.val=I,I?z.val=D.filter(F=>j(F).match(new RegExp(`${I}`,"i"))):z.val=D},m=_=>{h.val?U():G()},b=({option:_,index:I})=>F=>{p.val=j(_),f.val=I,U()},x=_=>{switch(console.log("onkeydown",_.key,f.val),_.key){case"Escape":U();break;case"ArrowDown":f.val<z.val.length-1?f.val++:f.val=0;break;case"ArrowUp":f.val<=0?f.val=z.val.length-1:f.val--;break;case"Enter":p.val=j(z.val[f.val]),u.val="",U();break}},C=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,"aria-label":B,onclick:m,variant:E,color:S,size:N},()=>!p.val&&B,p),O=c({id:P,value:u,placeholder:M,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:v,onkeydown:x,variant:E,color:S,size:N}),W=s({id:P,triggerEl:C,contentEl:(()=>a({class:T(E,S,N,"content")},O,()=>l({class:T(E,S,N)},z.val.map((_,I)=>i({class:()=>T(f.val==I&&"active"),onclick:b({option:_,index:I})},R(_))))))(),onClose:w});return a({...Y,class:T("autocomplete",d,t==null?void 0:t.class,Y==null?void 0:Y.class)},C,W)}}const Ft=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Gt(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,yr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:wr,createComponent:xr}],gridItem:Jt},Cr=e=>{const t=V(e);return()=>t(yr)};function Er(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{color:l,variant:d="plain",size:p="md",slides:u,Slide:h,Previous:f,Next:w,...g}]=Z(c);const y=()=>{s.val<=0?s.val=u.length-1:s.val--},E=()=>{s.val>=u.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},u.map(h));return a({...g,class:T("carousel",p,i,t==null?void 0:t.class,g==null?void 0:g.class)},a({class:T("control","control-previous"),onclick:y},f()),a({class:T("control","control-next"),onclick:E},w()),S)}}const Sr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],kr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=q(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,Kr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Zr,createComponent:Xr}],gridItem:e=>on(e,{base:"/components/drillDownMenu",hashBased:!0})},Yr=e=>{const t=V(e);return()=>t(Kr)};function an(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(d,...p){const{variant:u="outline",color:h="neutral",size:f="md",Component:w,disabled:g,...y}=d;return a({class:T(c.base,g&&c.disabled,t==null?void 0:t.class,d.class)},s({class:T(u,h,f)},w({disabled:g}),r({type:"file",disabled:g,...y})),i({class:"filename-display"}))}}const rn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),d=an(e),p=h=>{const f=h.target.files[0];f?l.val=f.name:l.val="No file selected"},u=({disabled:h})=>r({class:T(o`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,h&&o`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return h=>d({Component:u,name:"file",accept:"text/*",onchange:p,...h})},qr=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,d=n.state("No file selected"),p=an(e),u=f=>{const w=f.target.files[0];w?d.val=w.name:d.val="No file selected"},h=({disabled:f})=>c({class:T(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`);function un(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=q(e),r=qe(e),c=we(e),l=o`
    ...
    ${ks()}
  `,d=n.state(""),p=n.state(!1),u=n.state(0);return function(...f){let[{color:w="neutral",variant:g="outline",size:y="md",id:E,label:S,Option:N,options:P,getOptionLabel:B=({label:b})=>b,...M},...R]=Z(f);const D=()=>{m.openDialog(),m.focus(),p.val=!0},j=()=>{m.closeDialog(),p.val=!1},Y=()=>{p.val=!1},Q=b=>{p.val?j():D()},z=({option:b,index:x})=>C=>{d.val=B(b),u.val=x,j()},G=b=>{switch(b.preventDefault(),b.key){case"Escape":j();break;case"ArrowDown":u.val<P.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=P.length-1:u.val--;break;case"Enter":p.val?(d.val=B(P[u.val]),j()):D();break}},U=()=>c({tabindex:"0",class:T(w,g)},P.map((b,x)=>i({class:()=>T(u.val==x&&"active"),onclick:z({option:b,index:x})},N(b)))),v=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":S,onclick:Q,color:w,variant:g,size:y},()=>!d.val&&S,d),m=r({id:E,triggerEl:v,contentEl:U(),onClose:Y});return a({...M,class:T("select",w,y,l,t==null?void 0:t.class,M==null?void 0:M.class),onkeydown:G},v,m)}}const dn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=un(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function ye(e,t){const{bau:n,css:o}=e,{tabDefs:a}=t,{div:i,ul:s,li:r}=n.tags,c=n.state(a),l=n.state(a[0]),d=u=>c.val.find(h=>h.name==u),p={base:o`
      ...
      ${Xs()}
    `};return function(...h){let[{color:f,variant:w="plain",size:g,...y},...E]=Z(h);const S=P=>{const{Header:B,disabled:M,name:R}=P;return r({class:()=>T(l.val.name==R&&"active",M&&"disabled"),onclick:D=>D.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:R},bubbles:!0}))},B(P))},N=i({class:T("tabs",p.base,w,g,f,t==null?void 0:t.class,y.class)},n.loop(c,s(),S),()=>l.val.Content?l.val.Content({}):"");return N.addEventListener("tab.select",P=>{var R,D;const{tabName:B}=P.detail,M=d(B);M&&((R=l.val.exit)==null||R.call(),l.val=M,(D=M.enter)==null||D.call())},!1),N.addEventListener("tab.add",P=>{var M;const{tab:B}=P.detail;(M=B.enter)==null||M.call(),c.val.push(B)},!1),N.addEventListener("tab.remove",P=>{var M;const B=c.val.findIndex(R=>R.name==P.detail.tabName);B>0&&((M=c.val[B].exit)==null||M.call(),c.val.splice(B,1))},!1),N}}const gn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=ye(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return s=>i(s)},Zs=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=ye(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return()=>i({variant:"outline",color:"neutral"})},Ks=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    box-shadow: var(--shadow-s);
    border-radius: var(--global-radius);
  `;return function(...c){let[{...l},...d]=Z(c);return i({...l,class:T("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...d)}}const ai=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:d}=t.tags;function p(g,y,E,S,N){return{name:g,calories:y,fat:E,carbs:S,protein:N}}const u=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],h=({name:g,calories:y})=>s(i(g),i({class:n`
            text-align: right;
          `},y)),f=()=>c(s(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(w(r(d("Basic Table"),f(),l(u.map(h)))))},ri=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,pi={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:ri,createComponent:ai},{title:"Dense",description:"A dense table.",code:ci,createComponent:ii},{title:"Zebra",description:"A zebra table.",code:di,createComponent:ui}]},mi=e=>{const t=V(e);return()=>t(pi)};function vn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=Qe(e),s=q(e),r=et(e),c=o`
  ...
  `,l=({label:f,icon:w,...g})=>s({"aria-label":f,title:f,...g},w),d=({count:f,totalCount:w,page:g,rowsPerPage:y})=>a({class:"pages-numbers"},Number(g-1)*Number(y)+(f>0?1:0),"-",Math.min(g*y,w)," of ",w),p=({count:f,page:w,rowsPerPage:g})=>a({class:"pages-numbers"},(w-1)*g+(f>0?1:0),"-",w*g),u=f=>f<=1,h=(f,w,g)=>f>=Math.ceil(w/g);return function(...w){let[{count:g=0,totalCount:y=0,page:E=1,rowsPerPage:S=50,onPageChange:N,isLoading:P=!1,disableFirst:B=()=>u(E),disablePrevious:M=()=>u(E),disableNext:R=()=>h(E,y,S),disableLast:D=()=>h(E,y,S),...j},...Y]=Z(w);const Q=Math.max(0,Math.ceil(y/S)),z=N({page:1}),G=N({page:E-1}),U=N({page:E+1}),v=N({page:Q}),m=[{label:"First",icon:"⟪",onclick:z,disabled:B()},{label:"Previous",icon:"⟨",onclick:G,disabled:M()},{label:"Next",icon:"⟩",onclick:U,disabled:R()},{label:"Last",icon:"⟫",onclick:v,disabled:D()}];return a({...j,class:T("table-pagination",c,P&&"disabled",t==null?void 0:t.class,j==null?void 0:j.class)},r({class:"spinner",visibility:P,size:"md"}),y>0?d({count:g,totalCount:y,page:E,maxPages:Q,rowsPerPage:S}):p({count:g,page:E,maxPages:Q,rowsPerPage:S}),i({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const bi=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),hi=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=bi(45),d=({name:E,email:S})=>i(a(E),a(S)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),u=vn(e),h=Ce(e,{class:n`
      max-width: 650px;
    `}),f=t.state(l),w=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),g=t.derive(()=>f.val.slice(w.val.page*w.val.rowsPerPage,(w.val.page+1)*w.val.rowsPerPage)),y=({page:E})=>S=>{w.val.page=E};return()=>h(s(p(),()=>c(g.val.map(d))),()=>u({...w.val,onPageChange:y}))},gi=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,d=t.state(!1),p=t.state([]),u=t.state(""),h=t.derive(()=>p.val.length),f=t.state(1),w=t.state(10),g=t.derive(()=>p.val),y=D=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(D).toString()}`,E=({page:D})=>j=>{f.val=D,S(y({page:D,per_page:w.val}))};S(y({page:1,per_page:w.val}));async function S(D){try{d.val=!0;const j=await fetch(D,{});if(j.ok){const Y=await j.json();p.val=Y;return}throw j}catch(j){u.val=j.message}finally{d.val=!1}}const N=({name:D,description:j,stargazers_count:Y})=>i(a(D),a(j),a({class:n`
            text-align: right;
          `},Y)),P=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),R=({message:D})=>l(D);return()=>M(()=>B({rowsPerPage:w.val,page:f.val,count:h.val,totalCount:-1,isLoading:d.val,onPageChange:E,disableNext:()=>!1}),s(P(),()=>u.val&&R({message:u.val}),()=>c(g.val.map(N))))},fi=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=hi(e),l=gi(e),d=(...p)=>a({class:n`
  ...
  `;return function(...c){let[{titleEl:l,side:d="bottom-start",color:p="neutral",variant:u="outline",size:h="md",...f},...w]=Z(c);const g=i({class:T("container",...d.split("-"))},i({class:T("content",p,u,h),role:"tooltip"},l)),y=M=>`move-to-${M}`,E=(M,R,D)=>{if(M()){const j=y(R);g.classList.add(j),g.classList.add(R),g.classList.remove(D)}},S=(M,R)=>{const D=y(M);g.classList.contains(D)&&(g.classList.remove(D),g.classList.add(R),g.classList.remove(M))},N=M=>{const R=g.getBoundingClientRect();E(()=>R.x<0,"right","left"),E(()=>R.x+R.width>a.innerWidth,"left","right"),E(()=>R.y<0,"bottom","top"),E(()=>R.bottom>a.innerHeight,"top","bottom"),g.classList.add("visible")},P=M=>{g.classList.remove("visible"),S("right","left"),S("left","right"),S("bottom","top"),S("top","bottom")};return i({...f,class:T("tooltip",s,t==null?void 0:t.class,f==null?void 0:f.class),bauMounted:({element:M})=>{M.addEventListener("mouseover",N),M.addEventListener("mouseout",P)},bauUnmounted:({element:M})=>{M.removeEventListener("mouseover",N),M.removeEventListener("mouseout",P)}},...w,g)}}const xn=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,s=q(e),r=tt(e),c=()=>o({class:n`
          font-size: larger;
...
`,{nav:e`
  ...
  `,expanded:e`
    ...
    `});function yn(e,t){const{bau:n,css:o,createGlobalStyles:a,window:i}=e,{renderMenuItem:s}=t,{ul:r,li:c,nav:l,div:d}=n.tags,p=Mi({css:o,createGlobalStyles:a}),u=({element:g,closeState:y})=>{g.scrollHeight!=0&&(y.val?h(g):f(g))};function h(g){g.style.height=g.scrollHeight+"px";const y=()=>{g.removeEventListener("transitionend",y)};g.addEventListener("transitionend",y),i.requestAnimationFrame(()=>{g.style.height="0px"})}function f(g){const y=()=>{g.removeEventListener("transitionend",y),g.style.height=null};g.addEventListener("transitionend",y),g.style.height=g.scrollHeight+"px"}const w=({depth:g=1,maxDepth:y,color:E,variant:S,size:N})=>P=>{const{children:B,expanded:M}=P,R=n.state(!M);return c({class:()=>T(B?R.val?p.collapsed:p.expanded:"")},d({class:o`
              cursor: pointer;
            `,onclick:D=>{B&&(R.val=!R.val)}},s(P.data)),B&&g<y&&r({class:T(E,N),bauMounted:({element:D})=>{R.val&&(D.style.height="0px")},"aria-expanded":({element:D})=>(u({element:D,closeState:R}),!R.val)},B.map(w({depth:g+1,maxDepth:y}))))};return function({tree:y,maxDepth:E=1/0,size:S="md",variant:N="plain",color:P="neutral",...B}){return l({class:T(p.nav,S,N,P,t==null?void 0:t.class,B.class)},y.children&&r(y.children.map(w({maxDepth:E,color:P,variant:N,size:S}))))}}const Cn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=yn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Di=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=yn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Ii=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
