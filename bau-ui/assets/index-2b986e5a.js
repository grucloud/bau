...
`);function ct(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Ao);const l=o`
  ...
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",...h},...x]=V(d);return i({required:"required",title:"Switch Theme",...h,class:N("theme-switch",b,g,p,l,t==null?void 0:t.class,h.class),type:"checkbox",checked:r()=="dark",onclick:v=>{s(v.target.checked?"dark":"light")}},...x)}}function Io(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:g,li:b}=n.tags,{svg:h,path:x}=n.tagsNS("http://www.w3.org/2000/svg"),v=i.drawerOpen,w=U(e,{class:o`
    ...
    `}),S=ct(e),E=()=>s(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},x({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),I=()=>l({class:o`
        ...
        `},I(),$())}}function Do({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:d}=t.tags,p=({links:h,title:x})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
  ...
  `,hideToRight:e`
   ...
   `});function lt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=z=>{var y;return((y=z.parentTree.data)==null?void 0:y.href)??z.parentTree.children[0].data.href},u=({variant:z,color:y,size:m,currentTree:f,data:C})=>S(D({variant:z,color:y,size:m,href:`${c}${l(f)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),D({variant:z,color:y,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},C.name)),d=({size:z,subTree:{data:{name:y,href:m},children:f=[]}})=>D({size:z,href:`${c}${m}`,"data-ischild":!f.length},y),p=({pathname:z,subTree:y})=>{var m;return z===((m=y==null?void 0:y.data)==null?void 0:m.href)},{renderHeader:g=u,renderMenuItem:b=d,isActive:h=p}=t,{li:x,nav:v,div:w,header:S,a:E}=n.tags,I=Ue(e),$=fe(e),D=U(e,{class:o`
      &.button {
...
"Click me"
  ...
  `,g=({value:x,id:v,children:w=[]})=>{const S=c({class:()=>u.val==v?"active":"",href:`#${v}`});return S.innerHTML=x,r({class:()=>u.val==v?"active":""},S,w.length>0&&s(w.map(g)))},b=x=>x.tagName.charAt(1),h=({contentEl:x})=>{const v=x.querySelectorAll(l);let w=2,S={},E={children:[]},I=E;const $=I;let D=[I];return[...v].forEach(T=>{const A=b(T);T.setAttribute("id",T.textContent),!T.innerHTML.includes("<button")&&(S={value:T.innerHTML,id:T.id??T.textContent,children:[]},w==A?(E=S,I.children.push(E)):w<A?(D.push(I),I=E,E.children.push(S),E=S):w>A&&(I=D[A-1],D=D.slice(0,A-1),I.children.push(S),E=S),w=A)}),$};return function(...v){let[{size:w=t.size??"md",variant:S=t.variant??"plain",color:E=t.color??"neutral",contentEl:I,...$}]=V(v);const D=h({contentEl:I}),T=d(()=>{const O=[...I.querySelectorAll(l)].find(H=>{const{top:X,height:q}=H.getBoundingClientRect();if(X+q>60)return!0});O&&(u.val=O==null?void 0:O.id)},100);return i({...$,class:N("tableOfContent",w,S,E,p,t==null?void 0:t.class,$==null?void 0:$.class),bauMounted:()=>{a.addEventListener("scroll",T)},bauUnmounted:()=>{a.removeEventListener("scroll",T)}},D.children&&s(D.children.map(g)))}}const rn=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
...
`);function qe(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${Ga()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",data:h=[],...x}]=V(d);const v=n.state(""),w=bt(e,{size:p,variant:g,color:b}),S=I=>$=>{v.val==I?v.val="":v.val=I},E=I=>{const{Header:$,Content:D,name:T}=I,A=()=>r({class:()=>N(v.val==T&&"active")},c({type:"button","aria-controls":`bau-${T}`,"aria-expanded":({element:H})=>v.val==T},$(I))),O=()=>a({id:`bau-${T}`,"data-state":({element:H})=>v.val==T},D(I));return s({class:N(b,g,p),onclick:S(T)},w({Header:A,Content:O}))};return a({class:N("accordion",l,t==null?void 0:t.class,x.class)},i(h.map(E)))}}const sn=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],s=qe(e,t);return r=>s({...r,data:i})},Fa=e=>{const{bau:t}=e,{div:n,p:o,section:a}=t.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],s=qe(e);return()=>a(s({data:i,color:"neutral",variant:"outline"}))},Ua=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,gr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:dr,createComponent:ur},{title:"Component hide and show",description:"Hide and show a component",code:mr,createComponent:pr}]},br=e=>{const t=G(e);return()=>t(gr)};function Ke(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:h=t.color??"neutral",width:x=40,height:v=40,alt:w,...S},...E]=V(p);const I=Ke(e,{class:N(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${v}px;
          width: ${x}px;
        `,t==null?void 0:t.class,S.class)});return a({class:N(u,t==null?void 0:t.class,S.class)},()=>s.val&&I(),()=>r.val&&w,i({width:x,height:v,onload:c,onerror:l,class:()=>N(!s.val&&"visible",r.val&&"hide",h,b,g,u,t==null?void 0:t.class,S.class),...S}))}}const un=(e,t)=>{const{css:n}=e,o=ht(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
`);function Ze(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${Cr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",label:p,placeholder:g,Option:b,options:h,defaultOption:x,getOptionLabel:v,getOptionValue:w,onSelect:S=()=>{},id:E,required:I,name:$,loading:D,...T},...A]=V(c);const O=Xe(e),H=U(e),X=pe(e,{variant:u,color:d,size:l}),q=fe(e),K=Ce(e,{variant:u,color:d,size:l}),z=n.state(x),y=n.state(T.value),m=n.state(!1),f=n.state(0),C=()=>{m.val=!1},k=n.state(h),R=J=>se=>J.val&&v(se)==v(J.val),P=()=>{me.openDialog(),m.val=!0,y.val="",k.val=h,f.val=h.findIndex(R(z));const J=Ae.querySelector("li.selected");J&&(J.scrollIntoView({block:"center"}),xe.scrollIntoView({block:"end"}))},j=()=>{me.closeDialog(),m.val=!1,y.val="",f.val=0},_=J=>{const{value:se}=J.target;y.val=se,se?k.val=h.filter(ie=>v(ie).match(new RegExp(`${se}`,"i"))):k.val=h},B=J=>{me.open?j():P()},Z=({option:J,index:se})=>ie=>{z.val=J,f.val=se,j()},ne=()=>{const J=Ae.querySelector("li.active");J&&J.scrollIntoView({block:"center",behavior:"smooth"})},ee=J=>{switch(J.key){case"Escape":j();break;case"ArrowDown":f.val<k.val.length-1?f.val++:f.val=0,ne();break;case"ArrowUp":f.val<=0?f.val=k.val.length-1:f.val--,ne();break;case"Enter":me.open?(z.val=k.val[f.val],y.val="",j()):P(),J.preventDefault();break}},ae=H({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":m,"aria-label":p,onclick:B,variant:u,color:d,size:l,class:D==!0&&"loading",disabled:D},()=>z.val?v(z.val):p,()=>D==!0&&K({visibility:D})),xe=X({value:y,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":m,oninput:_,onkeydown:ee,...T}),ze=X({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,value:y,required:I,name:$}),Ae=a({class:N(u,d,l,"content")},xe,()=>q({class:N(u,d,l)},k.val.map((J,se)=>i({class:()=>N(f.val==se&&"active",R(z)(J)&&"selected"),onclick:Z({option:J,index:se})},b(J))))),me=O({id:E,triggerEl:ae,contentEl:Ae,onClose:C,class:o`
        overflow: hidden;
...
`);function Sn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=U(e),r=Xe(e),c=fe(e),l=o`
    ${Ms()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",label:h,ListItem:x,items:v,...w},...S]=V(d);const E=n.state(0),I=()=>{q.openDialog(),q.focus()},$=()=>{q.closeDialog()},D=()=>{q.open?$():I()},T=K=>{D(),K.preventDefault()},A=({item:K,index:z})=>y=>{E.val=z,$(),y.preventDefault()},O=K=>{switch(K.preventDefault(),K.key){case"Escape":$();break;case"ArrowDown":E.val<options.length-1?E.val++:E.val=0;break;case"ArrowUp":E.val<=0?E.val=options.length-1:E.val--;break;case"Enter":D();break}},H=()=>c({tabindex:"0",class:N(b,g)},v.map((K,z)=>i({class:()=>N(E.val==z&&"active"),onclick:A({item:K,index:z})},x(K)))),X=s({type:"button",onclick:T,color:b,variant:g,size:p},h),q=r({triggerEl:X,contentEl:H()});return a({...w,class:N("dropdownMenu",b,p,l,t==null?void 0:t.class,w==null?void 0:w.class),onkeydown:O},X,q)}}const $s=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,i=Sn(e,t),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>i({...c,items:s,ListItem:r,label:"Action"})},Bs=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,i=Sn(e),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(i({items:s,ListItem:r,label:"Action"}))},Ps=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:g,...b},...h]=V(l);const x=U(e),v=Ce(e);return n.bind({deps:[g],render:()=>w=>x({...b,class:N("loadingButton",u,d,p,r,w&&"loading",t==null?void 0:t.class,b==null?void 0:b.class)},v({size:u,variant:d,color:p,visibility:w}),i({class:w&&"loading"},h))})}}const Vs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=wt(e),d=Be(e,{variant:"outline",color:"danger"}),p=pe(e),g=ke(e,{class:n`
    ...
    `}),b=$e(e,{class:n`
      max-width: 400px;
    `});return function({onLoggedIn:x=()=>{}}){const v=t.state(!1),w=t.state("");return b(g({onsubmit:async E=>{const{username:I,password:$}=E.target.elements;E.preventDefault();try{v.val=!0;const D=await fetch("/auth/login",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:I.value,password:$.value})});if(D.ok){const T=await D.json();x(T)}else D.status==401?w.val="Invalid username or password":w.val=D.statusText}catch(D){w.val=D.message}finally{v.val=!1}}},s(c({width:"100",height:"100",src:`${o.base}/gc.svg`}),i("Login to Grucloud")),a(()=>w.val&&d(w.val),r("Email",p({type:"email",autofocus:!0,placeholder:"Email",name:"username",autocomplete:"username",required:!0})),r("Password",p({type:"password",placeholder:"Password",name:"password",autocomplete:"current-password",minlength:"8",required:!0}))),l(u({type:"submit",variant:"solid",color:"primary",loading:v},"Login"))))}},Ws=`import form from "@grucloud/bau-ui/form";
...
`);function Ee(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=U(e),l=Xe(e),u=fe(e),d=o`
    ...
    ${ji()}
  `;return function(...g){let[{size:b=t.size??"md",variant:h=t.variant??"outline",color:x=t.color??"neutral",label:v,Option:w,options:S,defaultOption:E,getOptionLabel:I,getOptionValue:$,onSelect:D=()=>{},loading:T,...A},...O]=V(g);const H=Ce(e,{variant:h,color:x,size:b}),X=n.state(E?I(E):v),q=n.state(!1),K=n.state(0),z=()=>{j.openDialog(),j.focus(),q.val=!0},y=()=>{j.closeDialog(),q.val=!1},m=()=>{q.val=!1},f=B=>{j.open?y():z(),B.preventDefault()},C=({option:B,index:Z})=>ne=>{X.val=I(B),_.value=$(B),_.setCustomValidity(""),K.val=Z,y(),D(B),ne.preventDefault()},k=B=>{switch(B.preventDefault(),B.key){case"Escape":y();break;case"ArrowDown":K.val<S.length-1?K.val++:K.val=0;break;case"ArrowUp":K.val<=0?K.val=S.length-1:K.val--;break;case"Enter":j.open?(X.val=I(S[K.val]),_.value=$(r),y()):z();break}},R=()=>u({tabindex:"0",class:N(x,h)},S.map((B,Z)=>i({class:()=>N(K.val==Z&&"active"),onclick:C({option:B,index:Z})},w(B)))),P=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":q,"aria-label":v,onclick:f,color:x,variant:h,size:b,class:T==!0&&"loading",disabled:T},()=>!X.val&&v,X,()=>T==!0&&H({visibility:T})),j=l({triggerEl:P,contentEl:R(),onClose:m}),_=s(A,r({value:""},"--Select Category--"),S.map(B=>r({value:$(B)},I(B))));return _.value=A.value,a({...A,class:N("select",x,b,d,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:k},_,P,j)}}const Bn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Ee(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function _n(e,t={}){const{bau:n,css:o,window:a}=e,{div:i,ul:s,li:r,span:c,footer:l}=n.tags,u=o`
  ...
  `;return function(...p){let[{color:g,variant:b="plain",size:h,stepperDefs:x=[],activeStepIndex:v=n.state(0),...w},...S]=V(p);const E=n.state(x.map((A,O)=>({...A,index:O}))),I=()=>{const A=a.location.hash.slice(1).split("?")[0];console.log("hashchange",A);const O=x.findIndex(({name:H})=>H==A);O>=0?v.val=O:v.val=0};I(),a.history.pushState=new Proxy(a.history.pushState,{apply:(A,O,H)=>{A.apply(O,H);const X=H[2]??"";["?","#"].includes(X[0])&&I()}}),document.addEventListener("click",A=>{const{target:O}=A,H=O.getAttribute("href");O.tagName==="A"&&H&&["?","#"].includes(H[0])&&I()}),a.addEventListener("popstate",A=>{I()});const $=n.derive(()=>E.val[v.val]),D=A=>{const{Header:O,disabled:H,name:X,index:q}=A;return r({class:()=>N($.val.name==X&&"active",v.val<q&&"not-completed",v.val>q&&"completed",H&&"disabled")},c({class:"step-number"},q+1),c({class:"step-label"},()=>O(A)))};return i({class:N("stepper",b,h,g,u,t==null?void 0:t.class,w.class)},n.loop(E,s(),D),x.map(A=>i({class:()=>N("content",A.name==$.val.name&&"visible")},()=>A.Content?A.Content(w):"",l(A.Footer?A.Footer(w):""))))}}const Sc=e=>{const{bau:t,window:n}=e,{footer:o,p:a,label:i,section:s,a:r,ul:c,li:l}=t.tags,u=pe(e),d=ke(e),p=_n(e),g=U(e,{variant:"outline",color:"primary"}),b=U(e,{variant:"solid",color:"primary"}),h=w=>{w.preventDefault(),n.history.pushState("","","#step2")},x=w=>{var $;w.preventDefault();const{organization:S}=($=n.document.forms)==null?void 0:$.formStep1.elements,I=new URLSearchParams(n.location.search).get("choice");alert(`organization ${S.value}, choice:${I}`)},v=[{name:"step1",Header:()=>"Step 1",Content:()=>d({onsubmit:h,id:"formStep1"},i("Organization",u({autofocus:!0,placeholder:"Organization",name:"organization",required:!0,minLength:3})),o(b({type:"submit"},"Next: Step 2")))},{name:"step2",Header:()=>"Step 2",Content:()=>d(c(l(r({href:"?choice=choice1#step3"},"Choice 1")),l(r({href:"?choice=choice2#step3"},"Choice 2"))),o(g({href:"#step1"},"Previous: Step 1")))},{name:"step3",Header:()=>"Step 3",Content:()=>d({onsubmit:x},a("My stepper 3 Content"),o(g({href:"#step2"},"Previous: Step 2"),b({type:"submit"},"Save")))}];return()=>s(p({stepperDefs:v}))},Cc=`import stepper, { type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
...
`);function Pe(e,t={}){const{bau:n,css:o,window:a}=e,{tabDefs:i}=t,{div:s,ul:r,li:c}=n.tags,l=o`
    ...
    ${Hc()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",...h},...x]=V(d);const v=n.state(i),w=a.location.hash.slice(1),S=D=>v.val.find(T=>T.name==D),E=n.state(S(w)??i[0]),I=D=>{const{Header:T,disabled:A,name:O}=D;return c({class:()=>N(E.val.name==O&&"active",A&&"disabled"),onclick:H=>H.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:O},bubbles:!0}))},T(D))},$=s({class:N("tabs",g,p,b,l,t==null?void 0:t.class,h.class)},n.loop(v,r(),I),()=>E.val.Content?E.val.Content(h):"");return $.addEventListener("tab.select",D=>{var O,H;const{tabName:T}=D.detail,A=S(T);A&&((O=E.val.exit)==null||O.call(),E.val=A,(H=A.enter)==null||H.call())},!1),$.addEventListener("tab.add",D=>{var A;const{tab:T}=D.detail;(A=T.enter)==null||A.call(),v.val.push(T)},!1),$.addEventListener("tab.remove",D=>{var A;const T=v.val.findIndex(O=>O.name==D.detail.tabName);T>0&&((A=v.val[T].exit)==null||A.call(),v.val.splice(T,1))},!1),$}}const Hn=(e,t)=>{const{bau:n}=e,{div:o,p:a,a:i}=n.tags,r=Pe(e,{tabDefs:[{name:"Tab1",Header:()=>i({href:"#Tab1"},"TAB 1"),Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>i({href:"#Tab2"},"TAB 2"),Content:()=>o(a("My tab 2 Content"))}],...t});return c=>r(c)},Gc=e=>{const{bau:t}=e,{div:n,p:o,a}=t.tags,s=Pe(e,{tabDefs:[{name:"Tab1",Header:()=>a({href:"#Tab1"},"TAB 1"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>a({href:"#Tab2"},"TAB 2"),Content:()=>n(o("My tab 2 Content"))}],variant:"outline",color:"neutral"});return()=>s({})},Fc=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,ul={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:ll,createComponent:cl}]},dl=e=>{const t=G(e);return()=>t(ul)};function Fn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=vt(e),s=U(e),r=Ce(e),c=o`
  ...
  `,l=({label:b,icon:h,...x})=>s({"aria-label":b,title:b,...x},h),u=({count:b,totalCount:h,page:x,rowsPerPage:v})=>a({class:"pages-numbers"},Number(x-1)*Number(v)+(b>0?1:0),"-",Math.min(x*v,h)," of ",h),d=({count:b,page:h,rowsPerPage:x})=>a({class:"pages-numbers"},(h-1)*x+(b>0?1:0),"-",h*x),p=b=>b<=1,g=(b,h,x)=>b>=Math.ceil(h/x);return function(...h){let[{size:x=t.size??"md",variant:v=t.variant??"outline",color:w=t.color??"neutral",count:S=0,totalCount:E=0,page:I=1,rowsPerPage:$=50,onPageChange:D,isLoading:T=!1,disableFirst:A=()=>p(I),disablePrevious:O=()=>p(I),disableNext:H=()=>g(I,E,$),disableLast:X=()=>g(I,E,$),...q},...K]=V(h);const z=Math.max(0,Math.ceil(E/$)),y=D({page:1}),m=D({page:I-1}),f=D({page:I+1}),C=D({page:z}),k=[{label:"First",icon:"⟪",onclick:y,disabled:A()},{label:"Previous",icon:"⟨",onclick:m,disabled:O()},{label:"Next",icon:"⟩",onclick:f,disabled:H()},{label:"Last",icon:"⟫",onclick:C,disabled:X()}];return a({...q,class:N("table-pagination",c,T&&"disabled",t==null?void 0:t.class,q==null?void 0:q.class)},r({class:"spinner",visibility:T,size:"md"}),E>0?u({count:S,totalCount:E,page:I,maxPages:z,rowsPerPage:$}):d({count:S,page:I,maxPages:z,rowsPerPage:$}),i({variant:v,color:w},k.map(R=>l({...R,variant:v,color:w}))))}}const pl=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),ml=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=pl(45),u=({name:w,email:S})=>i(a(w),a(S)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
    ...
    `}),b=t.state(l),h=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),x=t.derive(()=>b.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),v=({page:w})=>S=>{h.val.page=w};return()=>g(s(d(),()=>c(x.val.map(u))),()=>p({...h.val,onPageChange:v}))},gl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),g=t.derive(()=>d.val.length),b=t.state(1),h=t.state(10),x=t.derive(()=>d.val),v=A=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(A).toString()}`,w=({page:A})=>O=>{b.val=A,S(v({page:A,per_page:h.val}))};S(v({page:1,per_page:h.val}));async function S(A){try{u.val=!0;const O=await fetch(A,{});if(O.ok){const H=await O.json();d.val=H;return}throw O}catch(O){p.val=O.message}finally{u.val=!1}}const E=({name:A,description:O,stargazers_count:H})=>i(a(A),a(O),a({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),$=Fn(e),D=Oe(e,{class:n`
      min-width: 650px;
    `}),T=({message:A})=>l(A);return()=>D(()=>$({rowsPerPage:h.val,page:b.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:w,disableNext:()=>!1}),s(I(),()=>p.val&&T({message:p.val}),()=>c(x.val.map(E))))},bl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=ml(e),l=gl(e),u=(...d)=>a({class:n`
...
`,El={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Sl,createComponent:yl},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:kl,createComponent:Cl}],gridItem:Vn},Al=e=>{const t=G(e);return()=>t(El)};function Ct(e,t={}){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",size:d=t.size??"md",variant:p=t.variant??"outline",color:g=t.color??"neutral",...b},...h]=V(c);const x=i({class:N("container",...u.split("-"))},i({class:N("content",g,p,d),role:"tooltip"},l)),v=D=>`move-to-${D}`,w=(D,T,A)=>{if(D()){const O=v(T);x.classList.add(O),x.classList.add(T),x.classList.remove(A)}},S=(D,T)=>{const A=v(D);x.classList.contains(A)&&(x.classList.remove(A),x.classList.add(T),x.classList.remove(D))},E=D=>{const T=x.getBoundingClientRect();w(()=>T.x<0,"right","left"),w(()=>T.x+T.width>a.innerWidth,"left","right"),w(()=>T.y<0,"bottom","top"),w(()=>T.bottom>a.innerHeight,"top","bottom"),x.classList.add("visible")},I=D=>{x.classList.remove("visible"),S("right","left"),S("left","right"),S("bottom","top"),S("top","bottom")};return i({...b,class:N("tooltip",s,t==null?void 0:t.class,b==null?void 0:b.class),bauMounted:({element:D})=>{D.addEventListener("mouseover",E),D.addEventListener("mouseout",I)},bauUnmounted:({element:D})=>{D.removeEventListener("mouseover",E),D.removeEventListener("mouseout",I)}},...h,x)}}const Wn=(e,t)=>{const{bau:n}=e,{div:o,p:a,em:i}=n.tags,s=U(e),r=Ct(e,t),c=()=>o(a("A ",i("tooltip")," can be any component"));return l=>r({titleEl:c(),...l},s(l,`${l.color} ${l.variant}`))},Tl=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=U(e),s=Ct(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return()=>s({side:"bottom-start",titleEl:r()},i("tooltip"))},Il=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,{nav:e`
  ...
  `});function Kn(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=zl({css:o,createGlobalStyles:a}),d=bt(e),p=({depth:g=1,maxDepth:b,color:h,variant:x,size:v})=>w=>{const{children:S,expanded:E}=w,I=n.state(!E),$=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:T=>{S&&(I.val=!I.val)}},i(w.data)),D=()=>s({class:N(h,v)},S.map(p({depth:g+1,maxDepth:b})));return r(d({size:v,Header:$,Content:S&&g<b&&D}))};return function({tree:b,maxDepth:h=1/0,size:x=t.size??"md",variant:v=t.variant??"outline",color:w=t.color??"neutral",...S}){return c({class:N(u.nav,x,v,w,t==null?void 0:t.class,S.class)},b.children&&s(b.children.map(p({maxDepth:h,color:w,variant:v,size:x}))))}}const Xn=(e,t)=>{const{bau:n}=e,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Kn(e,{renderMenuItem:({name:r,href:c})=>o({href:c},r),...t});return r=>s({...r,tree:a})},_l=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Kn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Rl=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
