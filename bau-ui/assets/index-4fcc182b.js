  ...
  `,hideToRight:e`
   ...
   `});function it(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=z=>{var y;return((y=z.parentTree.data)==null?void 0:y.href)??z.parentTree.children[0].data.href},u=({variant:z,color:y,size:m,currentTree:f,data:C})=>S(E({variant:z,color:y,size:m,href:`${c}${l(f)}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),E({variant:z,color:y,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},C.name)),d=({size:z,subTree:{data:{name:y,href:m},children:f=[]}})=>E({size:z,href:`${c}${m}`,"data-ischild":!f.length},y),p=({pathname:z,subTree:y})=>{var m;return z===((m=y==null?void 0:y.data)==null?void 0:m.href)},{renderHeader:g=u,renderMenuItem:b=d,isActive:h=p}=t,{li:w,nav:x,div:v,header:S,a:T}=n.tags,N=Ue(e),M=he(e),E=W(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:D,hideToRight:$}=Do(e),O=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
...
`);function fe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:d,...p},...g]=F(r);return a({...p,onclick:d,class:I("chip",t.class,c,l,u,d&&"clickable",i,p.class)},...g)}}function $o(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;W(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function Po({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,d=({maxSize:p=151})=>({libName:g,size:b})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},g.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Oo(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=$o(e),l=Bo(e),u=W(e);Fe(e);const d=Po(e),p=(...x)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
`,ir={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:sr,createComponent:rr}]},cr=e=>{const t=j(e);return()=>t(ir)},lr=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=Ue(e),s=W(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`,Rr=e=>{const{bau:t}=e,{section:n}=t.tags,o=W(e),a=()=>{alert("Click")};return()=>n(o({disabled:!0,color:"primary",variant:"outline",onclick:a},"Click me"))},jr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Xr,createComponent:qr}],gridItem:fn},Yr=e=>{const t=j(e);return()=>t(Zr)};function Jr(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:g,Previous:b,Next:h,...w}]=F(c);const x=()=>{s.val<=0?s.val=p.length-1:s.val--},v=()=>{s.val>=p.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(g));return a({...w,class:I("carousel",l,i,t==null?void 0:t.class,w==null?void 0:w.class)},a({class:I("control","control-previous"),onclick:x},b()),a({class:I("control","control-next"),onclick:v},h()),S)}}const Qr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],es=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=W(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,us={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:ls,createComponent:cs}],gridItem:wn},ds=e=>{const t=j(e);return()=>t(us)},ps=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=mt(e),i=W(e,{variant:"outline"}),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},ms=`import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function yn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=W(e),r=Ke(e),c=he(e),l=o`
    ${Ts()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",label:h,ListItem:w,items:x,...v},...S]=F(d);const T=n.state(0),N=()=>{q.openDialog(),q.focus()},M=()=>{q.closeDialog()},E=()=>{q.open?M():N()},D=K=>{E(),K.preventDefault()},$=({item:K,index:z})=>y=>{T.val=z,M(),y.preventDefault()},O=K=>{switch(K.preventDefault(),K.key){case"Escape":M();break;case"ArrowDown":T.val<options.length-1?T.val++:T.val=0;break;case"ArrowUp":T.val<=0?T.val=options.length-1:T.val--;break;case"Enter":E();break}},H=()=>c({tabindex:"0",class:I(b,g)},x.map((K,z)=>i({class:()=>I(T.val==z&&"active"),onclick:$({item:K,index:z})},w(K)))),Q=s({type:"button",onclick:D,color:b,variant:g,size:p},h),q=r({triggerEl:Q,contentEl:H()});return a({...v,class:I("dropdownMenu",b,p,l,t==null?void 0:t.class,v==null?void 0:v.class),onkeydown:O},Q,q)}}const As=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,i=yn(e,t),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>i({...c,items:s,ListItem:r,label:"Action"})},Is=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,i=yn(e),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(i({items:s,ListItem:r,label:"Action"}))},Ds=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function qe(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=W(e),l=Ke(e),u=he(e),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Oi()}
  `;return function(...g){let[{size:b=t.size??"md",variant:h=t.variant??"outline",color:w=t.color??"neutral",label:x,Option:v,options:S,getOptionLabel:T=({label:A})=>A,getOptionValue:N=({label:A})=>A,onSelect:M=()=>{},...E},...D]=F(g);const $=n.state(x),O=n.state(!1),H=n.state(0),Q=()=>{k.openDialog(),k.focus(),O.val=!0},q=()=>{k.closeDialog(),O.val=!1},K=()=>{O.val=!1},z=A=>{k.open?q():Q(),A.preventDefault()},y=({option:A,index:G})=>_=>{$.val=T(A),L.value=N(A),L.setCustomValidity(""),H.val=G,q(),M(A),_.preventDefault()},m=A=>{switch(A.preventDefault(),A.key){case"Escape":q();break;case"ArrowDown":H.val<S.length-1?H.val++:H.val=0;break;case"ArrowUp":H.val<=0?H.val=S.length-1:H.val--;break;case"Enter":k.open?($.val=T(S[H.val]),L.value=N(r),q()):Q();break}},f=()=>u({tabindex:"0",class:I(w,h)},S.map((A,G)=>i({class:()=>I(H.val==G&&"active"),onclick:y({option:A,index:G})},v(A)))),C=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":O,"aria-label":x,onclick:z,color:w,variant:h,size:b},()=>!$.val&&x,$),k=l({triggerEl:C,contentEl:f(),onClose:K}),L=s(E,r({value:""},"--Select Category--"),S.map(A=>r({value:N(A)},T(A))));return L.value=E.value,a({...E,class:I("select",w,b,d,t==null?void 0:t.class,E==null?void 0:E.class),onkeydown:m},L,C,k)}}const $n=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=qe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function zn(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
    ...
    ${pc()}
  `;return function(...u){let[{color:d,variant:p="plain",size:g,stepperDefs:b=[],activeStepIndex:h,...w},...x]=F(u);const v=n.state(b.map((M,E)=>({...M,index:E}))),S=n.derive(()=>v.val[h.val]),T=M=>{const{Header:E,disabled:D,name:$,index:O}=M;return s({class:()=>I(S.val.name==$&&"active",h.val<O&&"not-completed",h.val>O&&"completed",D&&"disabled")},r({class:"step-number"},O+1),r({class:"step-label"},()=>E(M)))};return a({class:I("stepper",p,g,d,c,t==null?void 0:t.class,w.class)},n.loop(v,i(),T),n.bind({deps:[S],render:()=>M=>M.Content?M.Content({}):""}))}}const mc=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=zn(e),r=W(e),c=({name:b})=>b,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},g=()=>a({class:n`
          display: flex;
          justify-content: space-around;
...
`,bc=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=W(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
            display: flex;
            flex-direction: column;
            gap: 1rem;
        ...
        `},...i)}},Ye=e=>{const{bau:t}=e,{i:n}=t.tags,o=W(e);return function({onclick:i}){return o({onclick:i,variant:"outline",color:"primary"},n("◀"),"Previous")}},le="https://github.com/grucloud/grucloud/",ue="main",hc={AWS:[{title:"EC2 an instance with public address",description:"Deploy a EC2 virtual machine attached to an elastic public address",url:le,branch:ue,directory:"examples/aws/ec2"},{title:"EKS",description:"Deploy a kubernetes cluster with EKS",url:le,branch:ue,directory:"examples/aws/EKS/eks-simple"},{title:"Route53 TXT Record",description:"Create an Hosted Zone and a TXT record",url:le,branch:ue,directory:"examples/aws/route53/dns-validation-record-txt"}],Azure:[{title:"Virtual machine",description:"Deploy a virtual machine with a public address, protected by a firewall",url:le,branch:ue,directory:"examples/azure/Compute/vm"}],Google:[{title:"Virtual machine",description:"Deploy a virtual machine on the default network",resources:["compute.instance"],url:le,branch:ue,directory:"examples/google/vm"},{title:"Virtual machine inside a network",description:"Create a network, a sub-network, a virtual machine and firewall rules for HTTP/HTTPS",url:le,branch:ue,directory:"examples/google/vm-network",resources:["compute.network","compute.subnetwork","compute.subnetwork"]},{title:"Secure static website",description:"Deploy a static website served with HTTPS",url:le,branch:ue,directory:"examples/google/storage/website-https"},{title:"DNS records",description:"Manages DNS records such as A, CNAME, TXT and MX records",url:le,branch:ue,directory:"examples/google/dns/github-page"}]},fc=e=>{const{bau:t,css:n}=e,{li:o,strong:a,span:i}=t.tags;return function({project:r,onclickItem:c}){return o({onclick:c(r),class:n`
          flex-direction: column;
          align-items: flex-start;
        `},a(r.title),i(r.description))}},vc=e=>{const{bau:t,css:n}=e,{strong:o,small:a}=t.tags,i=W(e);return function({item:r,onclickItem:c}){return i({onclick:c(r),class:n`
          &.button {
            flex-direction: column;
            align-items: flex-start;
            text-align: left;
