...
`)}
  ...
  `}function so(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let et=e=>Object.prototype.toString.call(e??0).slice(8,-1),io=e=>et(e)=="Object",xt=e=>et(e)=="Function",Ze=e=>["Object","Array"].includes(et(e)),wt=Object.getPrototypeOf,Ye=e=>be(e)?e.val:e,be=e=>e==null?void 0:e.__isState,co=["splice","push","pop","shift","unshift","sort","reverse"],Be=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const V=e=>!be(e[0])&&io(e[0])?e:[{},...e];function lo(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=C=>n.createElement(C),l=(C,g,w)=>{let S=r;r=g;let E=C(w);return r=S,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(C=>{C.bindings=C.bindings.filter(g=>{var w;return(w=g.element)==null?void 0:w.isConnected}),!C.bindings.length&&!C.computed&&a.delete(C)}),o=void 0}))},d=(C,g,w,S,E,R)=>{var $;if(s){i.add(C);return}for(let F of C.bindings){let{deps:_,element:P,renderInferred:X,render:Q,renderItem:te}=F;if(te&&g)($=v(P,S,(...ae)=>x(te(...ae)),w,E,R)[g])==null||$.call();else{let ae=X?X({element:P}):Q({element:P,renderItem:te})(..._.map(Ye));ae!==P&&P.replaceWith(F.element=x(ae))}}y(C),u()},p=(C,g,w=[])=>({get(S,E,R){var $;if(r==null||r.add(C),E==="_isProxy")return!0;if(!(($=S[E])!=null&&$._isProxy)&&!be(S[E])&&Ze(S[E]))S[E]=new Proxy(S[E],p(C,g,[...w,E]));else if(co.includes(E)){let F=S[E];return(..._)=>{let P=F.apply(S,_);return d(C,E,P,_,g,w),P}}return Reflect.get(S,E,R)},set(S,E,R,$){let F=Reflect.set(S,E,R,$);return d(C,"setItem",F,{prop:E,value:R},g,[...w,E]),F}}),m=(C,g)=>new Proxy(g,p(C,g)),v=(C,g,w,S,E,R)=>{let $=()=>C.replaceChildren(...Be(S,w)),F=_=>C[_]&&C.removeChild(C[_]);return{assign:$,sort:$,reverse:$,setItem:()=>{var P;let _=R[0];(P=C.children[_])==null||P.replaceWith(w(E[_],_))},push:()=>C.append(...Be(g,(_,P)=>w(_,E.length+P))),unshift:()=>C.prepend(...Be(g,w)),pop:()=>F("lastChild"),shift:()=>F("firstChild"),splice:()=>{let[_,P,...X]=g;const{length:Q}=C.children;for(let te=_>=0?Math.min(_+P-1,Q-1):Q-1;te>=(_>=0?_:Q+_);te--)C.children[te].remove();if(X.length){let te=X.forEach((ae,Ve)=>w(ae,_+Ve));C.children[_]?C.children[_].after(...te):C.append(...te)}}}},b=C=>({oldVal:C,bindings:[],listeners:[],__isState:!0,get val(){let g=this;return r==null||r.add(g),g.valProxy??(g.valProxy=Ze(C)?m(g,C):C,g.valProxy)},set val(g){let w=this,S=w.val;Ze(g)?(w.valProxy=m(w,g),d(w,"assign",g)):g!==S&&(w.valProxy=g,d(w)),w.oldVal=S}}),x=C=>C==null||C===!1?c("span"):C.nodeType?C:n.createTextNode(C),h=(C,g)=>{let w=new Set;return g.val=l(C,w),w},f=C=>{let g=b(),w=h(C,g);g.computed=!0;for(let S of w)S.listeners.push({computed:C,deps:w,state:g});return g},y=C=>{for(let g of[...C.listeners])h(g.computed,g.state)},k=(C,...g)=>{if(g.length){let w=[];for(let S of g.flat(1/0))S!=null&&w.push(be(S)?j({deps:[S],render:()=>E=>E}):xt(S)?J({renderInferred:S}):x(S));C.append(...w)}},T={},A=(C,g)=>C&&(Object.getOwnPropertyDescriptor(C,g)??A(wt(C),g)),D=(C,g,w)=>{var S;return T[C+","+g]??(T[C+","+g]=((S=A(w,g))==null?void 0:S.set)??0)},M=(C,g)=>new t.MutationObserver((w,S)=>{w.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(R=>R===C&&(g({element:C}),S.disconnect(),!0)))}).observe(C.parentNode,{childList:!0}),N=(C,g)=>new t.MutationObserver((w,S)=>w.forEach(E=>g({record:E,element:C}))).observe(C,{childList:!0}),L=C=>new Proxy(function(w,...S){var F;let[E,...R]=V(S),$=C?n.createElementNS(C,w):c(w);for(let[_,P]of Object.entries(E)){if(_.startsWith("bau"))continue;let X=D(w,_,wt($))?Q=>$[_]=Q:Q=>$.setAttribute(_,Q);P==null||(be(P)?j({deps:[P],render:()=>()=>(X(P.val),$)}):xt(P)&&(!_.startsWith("on")||P.isDerived)?J({renderInferred:()=>(X(P({element:$})),$)}):P.renderProp?j({deps:P.deps,render:()=>()=>(X(P.renderProp({element:$})(...P.deps.map(Ye))),$)}):X(P))}return E.bauChildMutated&&N($,E.bauChildMutated),k($,...R),(F=E.bauCreated)==null||F.call(E,{element:$}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:$})),E.bauUnmounted&&t.requestAnimationFrame(()=>M($,E.bauUnmounted)),$},{get:(g,w)=>g.bind(void 0,w)}),K=(C,g,w)=>{C.element=x(w);for(let S of g)be(S)&&(a.add(S),S.bindings.push(C));return C.element},J=({renderInferred:C,element:g})=>{let w=new Set,S=l(C,w,{element:g});return K({renderInferred:C},w,S)},j=({deps:C,element:g,render:w,renderItem:S})=>K({deps:C,render:w,renderItem:S},C,w({element:g,renderItem:S})(...C.map(Ye))),W=(C,g,w)=>j({deps:[C],render:({renderItem:S})=>E=>(g.append(...Be(E,S)),g),renderItem:w}),U=C=>{s=!0,C(),s=!1,i.forEach(d),i.clear()};return{tags:L(),tagsNS:L,state:b,bind:j,loop:W,derive:f,stateSet:a,batch:U}}const uo=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},po=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},mo=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function go(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=mo(a,i),r=uo(s);return!t.getElementById(r)&&po(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function bo(e){const t=lo(),n=go();return ro(n),{bau:t,...n,tr:o=>o,window,...e}}function B(...e){return e.filter(t=>t).join(" ")}function Re(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:B("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:d})=>{[...u.removedNodes].forEach(p=>{if(!s()||p.getAttribute("cloned"))return;const m=p.cloneNode(!0);m.setAttribute("cloned",!0),m.style.top=0,m.style.left=0,m.style.width=p.getAttribute("width"),m.style.height=p.getAttribute("height"),m.style.position="absolute",m.style.animation=s(),u.target.appendChild(m),m.addEventListener("animationend",()=>{var v;return(v=m.parentNode)==null?void 0:v.removeChild(m)})}),[...u.addedNodes].forEach(p=>{if(p.getAttribute("cloned"))return;d.style.position="relative";const m=p.getBoundingClientRect();if(p.setAttribute("width",m.width+"px"),p.setAttribute("height",m.height+"px"),r()){p.style.animation=r();const v=()=>{p.removeEventListener("animationend",v),p.style.animation=""};p.addEventListener("animationend",v)}})},...c},l)}}function q(e,t={}){const{bau:n,css:o}=e,a=o`
    color: inherit;
    display: inline-flex;
    align-items: center;
...
`);function tt(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(vo);const l=o`
    ...
    ${xo()}
  `;return function(...d){let[{color:p,variant:m="outline",size:v="md",...b},...x]=V(d);return i({required:"required",title:"Switch Theme",...b,class:B("theme-switch",p,m,v,l,t==null?void 0:t.class,b.class),type:"checkbox",checked:r()=="dark",onclick:h=>{s(h.target.checked?"dark":"light")}},...x)}}function wo(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:m,li:v}=n.tags,{svg:b,path:x}=n.tagsNS("http://www.w3.org/2000/svg"),h=i.drawerOpen,f=q(e,{class:o`
    ...
    `}),y=tt(e),k=()=>s(b({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},x({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),T=()=>l({class:o`
        ...
        `},f({"aria-label":"drawer",variant:"none",color:"none",onclick:()=>h.val=!h.val},k()),u({href:`${a.base}/`,class:o`
            text-decoration: none;
            font-size: x-large;
          ...
          padding: 1rem;
          align-items: center;
        `},y(),f({class:o``,target:"_blank",href:"https://github.com/grucloud/bau",title:"Bau's Github"},d({class:o`
            border-radius: 50%;
            background: black;
        ...
        `},T(),A())}}function yo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:d}=t.tags,p=({links:b,title:x})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},d(x),r(b.map(({href:h,name:f})=>c(s({href:h},f))))),m=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],v=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
        ...
        `},u({class:n`
            ...
            gap: 10rem;
          `},p({title:"Bau UI",links:m}),p({title:"Bau Ecosystem",links:v})),u({class:n`
            display: flex;
            justify-content: center;
            align-items: center;
            gap: 1rem;
  ...
  `,hideToRight:e`
   ...
   `});function nt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=j=>{var W;return((W=j.parentTree.data)==null?void 0:W.href)??j.parentTree.children[0].data.href},u=({variant:j,color:W,size:U,currentTree:C,data:g})=>y(D({variant:j,color:W,size:U,href:`${c}${l(C)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),D({variant:j,color:W,size:U,href:`${c}${g.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},g.name)),d=({size:j,subTree:{data:{name:W,href:U},children:C=[]}})=>D({size:j,href:`${c}${U}`,"data-ischild":!C.length},W),p=({pathname:j,subTree:W})=>{var U;return j===((U=W==null?void 0:W.data)==null?void 0:U.href)},{renderHeader:m=u,renderMenuItem:v=d,isActive:b=p}=t,{li:x,nav:h,div:f,header:y,a:k}=n.tags,T=Re(e),A=fe(e),D=q(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:M,hideToRight:N}=Co(e),L=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,K=({variant:j,color:W,size:U,currentTree:C,pathnameState:g})=>{const{children:w,parentTree:S,data:E}=C;return f({class:B("drillDownMenu",j,W,U)},S&&m({variant:j,color:W,size:U,data:E,currentTree:C}),w&&A({class:B(j,W,U)},w.map(R=>x({class:()=>B(R.children&&"has-children",b({pathname:g.val,subTree:R})&&"active")},v({variant:j,color:W,size:U,subTree:R})))))},J=({tree:j,pathname:W})=>{let U=Nt({})(structuredClone(j)),C=Mt(W)(U);return C||(console.error("drilldown no sub tree",W),C=U),C};return function(W){const{variant:U="plain",color:C="neutral",size:g="md",tree:w,...S}=W,E=n.state(a.location.pathname.replace(c,"")),R=n.derive(()=>J({tree:w,pathname:E.val}));a.document.addEventListener("click",X=>{const{target:Q}=X,te=Q.getAttribute("href");if(Q.tagName==="A"&&te&&!te.startsWith("http")){let ae=te.replace(c,"");r||(ae=ae.replace(Q.hash,"")),E.val=ae}});let $=1;const F=X=>{const{dataset:Q}=X.target;Q.buttonback=="true"?$=-1:Q.ischild=="false"?$=1:Q.ischild=="true"&&($=0)},_=X=>{switch(X){case 1:return`${M} ${$e}`;case-1:return`${N} ${$e}`;default:return""}},P=X=>{switch(X){case 1:return`${N} ${$e} reverse`;case-1:return`${M} ${$e} reverse`;default:return""}};return h({class:B(L,t==null?void 0:t.class,S.class),onclick:F},T({animationHide:()=>_($),animationShow:()=>P($)},()=>K({variant:U,color:C,size:g,currentTree:R.val,pathnameState:E})))}}const So={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function Bt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:d,span:p}=n.tags;let m=!1;const v=nt(e);return function(){return r({bauMounted:({element:x})=>{s.innerWidth<=640&&(m=!0,i.drawerOpen.val=!1)},onclick:x=>{m&&!x.target.dataset.buttonback&&!x.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:B(o`
          ...
          `)},v({tree:So}))}}const Eo=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:i}=t.tags,s=Re(e),r=wo(e),c=Bt(e),l=yo(e),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...r){let[{size:c="md",variant:l="outline",color:u="neutral",onclick:d,...p},...m]=V(r);return a({...p,onclick:d,class:B("chip",t.class,t.variant,t.size,t.color,c,l,u,d&&"clickable",i,p.class)},...m)}}function ko(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;q(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function Ao({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,d=({maxSize:p=151})=>({libName:m,size:v})=>r({class:n`
            display: flex;
            margin: 0.3rem;
          `},i({class:n`
              display: flex;
            ...
            `},r({class:n`
                ...
                padding: 0 0.5rem;
                border-radius: 10px;
              `},v)));return function({data:m=[]}){return o({class:n`
          box-shadow: var(--shadow-m);
          border: 1px solid var(--color-emphasis-200);
          padding: 1rem;
        `},c({class:n`
          ...
          `},m.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Io(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=ko(e),l=To(e),u=q(e);Le(e);const d=Ao(e),p=(...h)=>a({class:n`
...
"Click me"
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",...d},...p]=V(r);return a({...d,class:B("paper",u,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}function Xt(e,t={}){const{bau:n,css:o,window:a}=e,{nav:i,ul:s,li:r,a:c}=n.tags,{headerSelector:l="h2,h3"}=t,u=n.state("no"),d=(x,h)=>{let f=null;return(...y)=>{a.clearTimeout(f),f=a.setTimeout(()=>x(...y),h)}},p=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,m=({value:x,id:h,children:f=[]})=>{const y=c({class:()=>u.val==h?"active":"",href:`#${h}`});return y.innerHTML=x,r({class:()=>u.val==h?"active":""},y,f.length>0&&s(f.map(m)))},v=x=>x.tagName.charAt(1),b=({contentEl:x})=>{const h=x.querySelectorAll(l);let f=2,y={},k={children:[]},T=k;const A=T;let D=[T];return[...h].forEach(M=>{const N=v(M);M.setAttribute("id",M.textContent),!M.innerHTML.includes("<button")&&(y={value:M.innerHTML,id:M.id??M.textContent,children:[]},f==N?(k=y,T.children.push(k)):f<N?(D.push(T),T=k,k.children.push(y),k=y):f>N&&(T=D[N-1],D=D.slice(0,N-1),T.children.push(y),k=y),f=N)}),A};return function(...h){let[{color:f,variant:y,size:k="md",contentEl:T,...A}]=V(h);const D=b({contentEl:T}),M=d(()=>{const L=[...T.querySelectorAll(l)].find(K=>{const{top:J,height:j}=K.getBoundingClientRect();if(J+j>60)return!0});L&&(u.val=L==null?void 0:L.id)},100);return i({...A,class:B("tableOfContent",k,y,f,p,t==null?void 0:t.class,A==null?void 0:A.class),bauMounted:()=>{a.addEventListener("scroll",M)},bauUnmounted:()=>{a.removeEventListener("scroll",M)}},D.children&&s(D.children.map(m)))}}const Zt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(c(s(l(p??""),ee.map(m=>l(m)))),i(ho.map(m=>s(l(m),ee.map((v,b)=>r(d({color:v,variant:m},{index:b}))))))))}},$a=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:i}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
    ...
    `}),v=Zt(e),b=$a(e),x=({text:h})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:f})=>{f.innerHTML=ye.highlight(h,{language:"js"}).value}}));return function(f){const y=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},s(f.title),r(f.description),f.gridItem&&[c("Variant/Color"),!f.variantColorTableDisable&&f.gridItem&&m(v({Item:f.gridItem(e)})),c("Size"),r("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),f.gridItem&&m(b({Item:f.gridItem(e)}))],c("Usage"),l("Import"),x({text:f.importStatement}),c("Examples"),f.examples.map(k=>i(l(k.title),r(k.description),m(k.createComponent(e)()),x({text:k.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
        ...
        `},y,p({contentEl:y}))}};function it(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    overflow: hidden;
    background-color: inherit;
    display: flex;
    flex-direction: column;
  ...
  `,s=({element:l,closeState:u})=>{l.scrollHeight!=0&&(u.val?r(l):c(l))};function r(l){l.style.height=l.scrollHeight+"px";const u=()=>{l.removeEventListener("transitionend",u)};l.addEventListener("transitionend",u),window.requestAnimationFrame(()=>{l.style.height="0px"})}function c(l){const u=()=>{l.removeEventListener("transitionend",u),l.style.height=null};l.addEventListener("transitionend",u),l.style.height=l.scrollHeight+"px"}return function(...u){let[{color:d,variant:p="plain",size:m="md",Header:v,Content:b,close:x=!0,...h}]=V(u);const f=n.state(x);return a({...h,class:B("collapsible",m,i,t==null?void 0:t.class,h==null?void 0:h.class)},a({class:()=>B("header",b?f.val?"close":"open":""),onclick:y=>{f.val=!f.val,y.stopPropagation()}},v()),a({class:"content",role:"region",bauMounted:({element:y})=>{f.val&&(y.style.height="0px")},"aria-expanded":({element:y})=>(s({element:y,closeState:f}),!f.val)},b&&b()))}}const Pa=()=>ee.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`);function ze(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${Pa()}
  `;return function(...d){let[{color:p,variant:m="outline",size:v="md",data:b=[],...x}]=V(d);const h=n.state(""),f=it(e),y=T=>A=>{h.val==T?h.val="":h.val=T},k=T=>{const{Header:A,Content:D,name:M}=T,N=()=>r({class:()=>B(h.val==M&&"active")},c({type:"button","aria-controls":`bau-${M}`,"aria-expanded":({element:K})=>h.val==M},A(T))),L=()=>a({id:`bau-${M}`,"data-state":({element:K})=>h.val==M},D(T));return s({class:B(p,m,v),onclick:y(M)},f({Header:N,Content:L}))};return a({class:B("accordion",l,t==null?void 0:t.class,x.class)},i(b.map(k)))}}const Yt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=ze(e);return s=>i({...s,data:a})},Oa=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=ze(e);return()=>i({data:a,color:"neutral",variant:"outline"})},_a=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,Xa={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Va,createComponent:Wa},{title:"Custom Alert ",description:"A custom alert.",code:qa,createComponent:Ka}],gridItem:Qt},Za=e=>{const t=H(e);return()=>t(Xa)},Ya=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},d=({id:p,status:m})=>{const v=c.val.findIndex(b=>b.id===p);v!=-1&&(c.val[v].status=m)};return function(m={},...v){const b=({id:f})=>{d({id:f,status:"removing"});const y=c.val.findIndex(k=>k.id===f);y!=-1&&c.val.splice(y,1)},x=({Component:f})=>{const y={id:Math.random().toString(10).split(".")[1],Component:f,status:"inserting"};c.val.length>=i&&b({id:c.val[0].id}),c.val.push(y),setTimeout(()=>b(y),s)},h=f=>r({class:u.item,onclick:()=>b(f)},f.Component());return document.addEventListener("alert.add",f=>x(f.detail)),document.addEventListener("alert.remove",f=>b(f.detail)),r({class:B(u.stack,t==null?void 0:t.class,m.class)},n.loop(c,r(),h))}},Ja=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Ya(e,{deleteAfterDuration:2e4}),i=q(e),s=ke(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Qa=`import { Context } from "@grucloud/bau-ui/context";
...
`,sr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:or,createComponent:nr},{title:"Component hide and show",description:"Hide and show a component",code:rr,createComponent:ar}]},ir=e=>{const t=H(e);return()=>t(sr)};function en(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{color:m,variant:v="outline",size:b="md",width:x=30,height:h=30,...f},...y]=V(p);return a({class:B(u,t==null?void 0:t.class,f.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:x,height:h,onload:c,onerror:l,class:B(m,v,b,u,t==null?void 0:t.class,f.class),...f}))}}const tn=e=>{const{css:t}=e,n=en(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`,ur={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:lr,createComponent:cr}],gridItem:tn},dr=e=>{const t=H(e);return()=>t(ur)};function ct(e,t){const{bau:n,css:o,window:a}=e,{dialog:i}=n.tags,s=Ee(e,{class:o`
    ...
    opacity: 0;
  `;return function(...l){let[{contentEl:u,triggerEl:d,onClose:p,...m},...v]=V(l);const b=f=>{h.style.opacity=1,h.showModal();const y=d.getBoundingClientRect(),k=h.getBoundingClientRect();y.x<a.innerWidth/2?h.style.left=y.left+"px":h.style.left=y.right-k.width+"px",y.y<a.innerHeight/2?h.style.top=y.top+y.height+"px":(h.style.top=Math.max(0,y.top-k.height)+"px",k.height>y.top&&(h.style.height=y.top+"px"))},x=f=>{const y=()=>{h.close(),h.removeEventListener("transitionend",y)};h.addEventListener("transitionend",y),h.style.opacity=0},h=i({role:"presentation",class:B("popover",r,t==null?void 0:t.class,m==null?void 0:m.class),onclick:f=>f.target===h&&(x(),p==null?void 0:p.call())},s(u));return h.closeDialog=x,h.openDialog=b,h}}const pr=()=>ee.map(e=>`
&.input.${e} {
...
`);function ve(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${pr()}
  `;return function(r){const{size:c="md",variant:l="outline",color:u="neutral",disabled:d,...p}=r;return a({type:"text",...p,disabled:d,class:B("input",t.class,t.variant,t.size,t.color,c,u,l,i,d&&"disabled",p.class)})}}const mr=()=>ee.map(e=>`
...
& button.outline.${e}::after {
  ...
  `).join(`
`);function nn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=ct(e),r=q(e),c=ve(e),l=fe(e),u=o`
    & button {
      &::after {
        content: "\u25BC";
        padding: 0 0.3rem;
    ...
    ${mr()}
  `;return function(...p){let[{variant:m="outline",color:v,size:b="md",id:x,label:h,placeholder:f,Option:y,options:k,getOptionLabel:T=({label:_})=>_,...A},...D]=V(p);const M=n.state(""),N=n.state(""),L=n.state(!1),K=n.state(0),J=()=>{L.val=!1},j=n.state(k),W=()=>{F.openDialog(),L.val=!0,N.val="",j.val=k},U=()=>{F.closeDialog(),L.val=!1,N.val=""},C=_=>{const{value:P}=_.target;N.val=P,P?j.val=k.filter(X=>T(X).match(new RegExp(`${P}`,"i"))):j.val=k},g=_=>{L.val?U():W()},w=({option:_,index:P})=>X=>{M.val=T(_),K.val=P,U()},S=_=>{switch(console.log("onkeydown",_.key,K.val),_.key){case"Escape":U();break;case"ArrowDown":K.val<j.val.length-1?K.val++:K.val=0;break;case"ArrowUp":K.val<=0?K.val=j.val.length-1:K.val--;break;case"Enter":M.val=T(j.val[K.val]),N.val="",U();break}},E=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":L,"aria-label":h,onclick:g,variant:m,color:v,size:b},()=>!M.val&&h,M),R=c({id:x,value:N,placeholder:f,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":L,oninput:C,onkeydown:S,variant:m,color:v,size:b}),F=s({id:x,triggerEl:E,contentEl:(()=>a({class:B(m,v,b,"content")},R,()=>l({class:B(m,v,b)},j.val.map((_,P)=>i({class:()=>B(K.val==P&&"active"),onclick:w({option:_,index:P})},y(_))))))(),onClose:J});return a({...A,class:B("autocomplete",u,t==null?void 0:t.class,A==null?void 0:A.class)},E,F)}}const on=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=nn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,wr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:xr,createComponent:vr}],gridItem:rn},yr=e=>{const t=H(e);return()=>t(wr)};function sn(e,t){const{bau:n,css:o}=e,{ul:a,li:i,span:s}=n.tags,r=q(e),c=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...u){let[{color:d="neutral",variant:p="plain",size:m="md",items:v,...b},...x]=V(u);return a({...b,class:B(c,t==null?void 0:t.class,b==null?void 0:b.class)},v.map(({href:h,name:f})=>i((h?r:s)({href:h,color:d,variant:p,size:m,class:B(d,p,m)},f))))}}const cn=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=sn(e);return o=>n({...o,...t})},Cr=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=sn(e);return()=>n(a(o))},Sr=`import breadcrumbs, {
...
`,jr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Lr,createComponent:Rr}],gridItem:pn},zr=e=>{const t=H(e);return()=>t(jr)};function Hr(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{color:l,variant:u="plain",size:d="md",slides:p,Slide:m,Previous:v,Next:b,...x}]=V(c);const h=()=>{s.val<=0?s.val=p.length-1:s.val--},f=()=>{s.val>=p.length-1?s.val=0:s.val++},y=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(m));return a({...x,class:B("carousel",d,i,t==null?void 0:t.class,x==null?void 0:x.class)},a({class:B("control","control-previous"),onclick:h},v()),a({class:B("control","control-next"),onclick:f},b()),y)}}const Gr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],Ur=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=q(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,ps={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:ds,createComponent:us}],gridItem:e=>hn(e,{base:"/components/drillDownMenu",hashBased:!0})},ms=e=>{const t=H(e);return()=>t(ps)};function ut(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(u,...d){const{variant:p="outline",color:m="neutral",size:v="md",Component:b,disabled:x,...h}=u;return a({class:B(c.base,x&&c.disabled,t==null?void 0:t.class,u.class)},s({class:B(p,m,v)},b({disabled:x}),r({type:"file",disabled:x,...h})),i({class:"filename-display"}))}}const fn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),u=ut(e),d=m=>{const v=m.target.files[0];v?l.val=v.name:l.val="No file selected"},p=({disabled:m})=>r({class:B(o`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,m&&o`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return m=>u({Component:p,name:"file",accept:"text/*",onchange:d,...m})},gs=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,u=n.state("No file selected"),d=ut(e),p=v=>{const b=v.target.files[0];b?u.val=b.name:u.val="No file selected"},m=({disabled:v})=>c({class:B(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
100% {
  ...
  `;return function({size:u="md",color:d="primary",variant:p="outline",visibility:m=!0,...v}={}){const b=o`
      visibility: hidden;
      opacity: 0;
      ...
      ${vs()}
    `;return i({class:{deps:[m],renderProp:()=>x=>B("spinner",b,d,p,x==!1?"":"visibility",t==null?void 0:t.class,v.class)},version:"1.1",x:"0px",y:"0px",width:Oe[u],height:Oe[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...v},s({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}function dt(e,t){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...l){let[{color:u,variant:d="plain",size:p="md",loading:m,...v},...b]=V(l);const x=q(e),h=He(e);return n.bind({deps:[m],render:()=>f=>x({...v,class:B("loadingButton",p,d,u,r,f&&"loading",t==null?void 0:t.class,v==null?void 0:v.class)},h({size:p,variant:d,color:u,visibility:f}),i({class:f&&"loading"},b))})}}const xs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c}=t.tags,l=dt(e),u=ke(e,{variant:"outline",color:"danger"}),d=ve(e),p=Te(e,{class:n`
      align-items: center;
      & > header {
        text-align: center;
      }
    `}),m=Ee(e,{class:n`
      max-width: 400px;
    `});return function(){const b=t.state(""),x=t.state(!1),h=t.state("");return m(p({onsubmit:async y=>{const{username:k,password:T}=y.target.elements;y.preventDefault();try{x.val=!0;const A=await fetch("/auth/login",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:k.value,password:T.value})});if(A.ok){const D=await A.json();b.val=D}else A.status==422?h.val="Invalid username or password":h.val=A.statusText}catch(A){h.val=A.message}finally{x.val=!1}}},s(c({width:"100",src:`${o.base}/gc.svg`}),i("Login")),a(()=>h.val&&u(h.val),r("Username",d({autofocus:!0,placeholder:"Username",name:"username",pattern:String.raw`\w{3,64}`,title:"Length should be greater than 3 and below 64 characters",required:!0})),r("Password",d({type:"password",placeholder:"Password",name:"password",pattern:String.raw`\w{8,128}`,title:"Length should be greater than 8 and below 128 characters",required:!0})),l({type:"submit",variant:"solid",color:"primary",loading:x},"Login"))))}},ws=`import form from "@grucloud/bau-ui/form";
...
`,qs={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Ks,createComponent:Vs}]},Xs=e=>{const t=H(e);return()=>t(qs)};function Zs(e,t){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
  ...
  `,u=({text:d})=>({name:p,label:m,href:v})=>s({href:`${a.base}${v}`},r({class:"sublabel"},d),i({class:`label ${d}`},m??p));return function(...p){let[{color:m,variant:v="plain",size:b="md",data:x={},...h}]=V(p);const{next:f,previous:y}=x;return c({"data-paginationnav":JSON.stringify(x),"aria-label":"pages navigation",...h,class:B("paginationNavigation",b,l,t==null?void 0:t.class,h==null?void 0:h.class)},(y==null?void 0:y.href)&&u({text:"Previous"})(y),(f==null?void 0:f.href)&&u({text:"Next"})(f))}}const Ys=e=>{const{bau:t}=e,{section:n}=t.tags,o=Zs(e),a={next:{name:"next page",label:"Popover",href:"/components/popover"},previous:{name:"previous page",label:"Paper",href:"/components/paper"}};return()=>n(o({variant:"solid",color:"primary",data:a}))},Js=`import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";
...
`);function Ge(e,t){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=q(e),l=ct(e),u=fe(e),d=o`
    ...
    ${ui()}
  `;return function(...m){let[{color:v="neutral",variant:b="outline",size:x="md",label:h,Option:f,options:y,getOptionLabel:k=({label:E})=>E,...T},...A]=V(m);const D=n.state(""),M=n.state(!1),N=n.state(0),L=()=>{w.openDialog(),w.focus(),M.val=!0},K=()=>{w.closeDialog(),M.val=!1},J=()=>{M.val=!1},j=E=>{M.val?K():L(),E.preventDefault()},W=({option:E,index:R})=>$=>{D.val=k(E),S.value=D.val,S.setCustomValidity(""),N.val=R,K(),$.preventDefault()},U=E=>{switch(E.preventDefault(),E.key){case"Escape":K();break;case"ArrowDown":N.val<y.length-1?N.val++:N.val=0;break;case"ArrowUp":N.val<=0?N.val=y.length-1:N.val--;break;case"Enter":M.val?(D.val=k(y[N.val]),K()):L();break}},C=()=>u({tabindex:"0",class:B(v,b)},y.map((E,R)=>i({class:()=>B(N.val==R&&"active"),onclick:W({option:E,index:R})},f(E)))),g=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":M,"aria-label":h,onclick:j,color:v,variant:b,size:x},()=>!D.val&&h,D),w=l({triggerEl:g,contentEl:C(),onClose:J}),S=s(T,r({value:""},"--Select Category--"),y.map(E=>r(k(E))));return a({...T,class:B("select",v,x,d,t==null?void 0:t.class,T==null?void 0:T.class),onkeydown:U},S,g,w)}}const kn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ge(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function In(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
    ...
    ${Di()}
  `;return function(...u){let[{color:d,variant:p="plain",size:m,stepperDefs:v=[],activeStepIndex:b,...x},...h]=V(u);const f=n.state(v.map((A,D)=>({...A,index:D}))),y=n.derive(()=>f.val[b.val]),k=A=>{const{Header:D,disabled:M,name:N,index:L}=A;return s({class:()=>B(y.val.name==N&&"active",b.val<L&&"not-completed",b.val>L&&"completed",M&&"disabled")},r({class:"step-number"},L+1),r({class:"step-label"},()=>D(A)))};return a({class:B("stepper",p,m,d,c,t==null?void 0:t.class,x.class)},n.loop(f,i(),k),n.bind({deps:[y],render:()=>A=>A.Content?A.Content({}):""}))}}const Ni=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=In(e),r=q(e),c=({name:v})=>v,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},m=()=>a({class:n`
          display: flex;
          justify-content: space-around;
...
`,Bi=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=q(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
    ...
    `;return y({name:"form-config-azure",onsubmit:D,"data-infra-create":!0,class:M},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",m("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",f({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",pattern:String.raw`\w{32,32}`,title:"Length should be 32 characters.",required:!0}))),u(d("Tenant Id"),s("Retrieve the ",m("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",f({"data-input-azure-tenant-id":!0,autofocus:!0,placeholder:"Tenant Id",name:"tenantId",pattern:String.raw`\w{36,36}`,title:"Length should be 36 characters.",required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",m("APP_ID")," and ",m("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),v({class:n`
                  display: flex;
                  gap: 1rem;
                `},r("App Id",f({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",pattern:String.raw`\w{36,36}`,title:"Length should be 36 characters.",required:!0})),r("Password",f({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",pattern:String.raw`\w{8,64}`,title:"Length should be greater than 8 and below 64",required:!0})))))),h(x({onclick:T}),b({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},zi=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:m,a:v,table:b,tbody:x,th:h,tr:f,td:y}=t.tags,{svg:k,use:T}=t.tagsNS("http://www.w3.org/2000/svg"),A=ut(e),D=q(e),M=Te(e),N=We(e),L=Fe(e);return function({onclickPrevious:J,onclickNext:j}){const W=t.state("No file selected"),U=t.state({}),C=t.state(!0),g=$=>{const F=$.target.files[0];if(F){W.val=F.name;const _=new FileReader;_.readAsText(F),_.onload=()=>{try{debugger;if(_.result){const P=JSON.parse(_.result);U.val=P,P.project_id&&(C.val=!1)}}catch{}},_.onerror=()=>{console.log(_.error)}}else W.val=""},w=({fileName:$,content:F})=>b({class:n`
          ...
          `},x(f(h("Credential File"),y($)),f(h("Project Name"),y(F.project_id)),f(h("Service Account"),y(F.client_email)))),S=({})=>c({class:n`
            display: inline-flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
    ...
    `;return M({name:"form-config-google",class:R,onsubmit:E,"data-infra-create":!0},s(i("Google Configuration"),r("GruCloud requires a read-only service account to scan a project's architecture. Please select the service account credential JSON file for the project that will be scanned. Follow the following steps to create and upload this file.")),a(u(d("Visit the ",v({href:"https://console.cloud.google.com/iam-admin/serviceaccounts",target:"_blank"},"service account page")," on the google cloud console"),d("Select your project"),d("Click on ",m("CREATE SERVICE ACCOUNT"),""),d("Set the ",m("Service account name")," to 'grucloud' for instance"),d("Click on ",m("CREATE"),""),d("Select the basic role 'Viewer'"),d("Click on ",m("CONTINUE"),""),d("Click on ",m("DONE"),""),d("Go to the ",m("Actions")," column, click on the three dot icon of the newly created service account"),d("Click on ",m("Manage keys"),""),d("Click on ",m("ADD KEYS"),", then ",m("Create new key"),""),d("Click on ",m("CREATE")," to download the credential file in JSON format.")),A({"data-input-google-upload":!0,Component:S,name:"file",accept:"application/JSON",onchange:g}),()=>w({fileName:W.val,content:U.val})),L(N({onclick:J}),()=>D({type:"submit",variant:"outline",color:"primary",disabled:C.val},"Next",l("▶"))))}},Hi=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=In(e),r=Bi(e),c=Li(e),l=ji(e),u=zi(e),d=_i(e),p=t.state(""),m=t.state(0),v=({name:b})=>b;return function(){const x=D=>()=>{p.val=D,m.val++},h=()=>{m.val++},f=()=>{m.val++},k=[{name:"Provider Selection",Header:v,Content:()=>r({onclickProvider:x}),enter:async()=>{p.val=""}},{name:"Import",Header:()=>"Import Project",Content:()=>d({providerName:p.val,onclickPrevious:T,onclickImportExistingInfra:h,onclickImportFromTemplate:f})},{name:"Configuration",Header:()=>`Configuration ${p.val}`,Content:()=>{switch(p.val){case"AWS":return c({onclickPrevious:T,onclickNext:A});case"Azure":return l({onclickPrevious:T,onclickNext:A});case"Google":return u({onclickPrevious:T,onclickNext:A})}}},{name:"Scan",Header:v,Content:()=>a(i("My stepper 3 Content"))}],T=()=>{m.val>0&&m.val--},A=()=>{k.length>m.val+1&&m.val++};return o({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
...
`);function Ae(e,t){const{bau:n,css:o}=e,{tabDefs:a}=t,{div:i,ul:s,li:r}=n.tags,c=o`
    ...
    ${Zi()}
  `;return function(...u){let[{color:d,variant:p="plain",size:m,...v},...b]=V(u);const x=n.state(a),h=n.state(a[0]),f=T=>x.val.find(A=>A.name==T),y=T=>{const{Header:A,disabled:D,name:M}=T;return r({class:()=>B(h.val.name==M&&"active",D&&"disabled"),onclick:N=>N.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:M},bubbles:!0}))},A(T))},k=i({class:B("tabs",p,m,d,c,t==null?void 0:t.class,v.class)},n.loop(x,s(),y),()=>h.val.Content?h.val.Content({}):"");return k.addEventListener("tab.select",T=>{var M,N;const{tabName:A}=T.detail,D=f(A);D&&((M=h.val.exit)==null||M.call(),h.val=D,(N=D.enter)==null||N.call())},!1),k.addEventListener("tab.add",T=>{var D;const{tab:A}=T.detail;(D=A.enter)==null||D.call(),x.val.push(A)},!1),k.addEventListener("tab.remove",T=>{var D;const A=x.val.findIndex(M=>M.name==T.detail.tabName);A>0&&((D=x.val[A].exit)==null||D.call(),x.val.splice(A,1))},!1),k}}const Mn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Ae(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return s=>i(s)},Yi=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Ae(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return()=>i({variant:"outline",color:"neutral"})},Ji=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    box-shadow: var(--shadow-s);
    border-radius: var(--global-radius);
  `;return function(...c){let[{...l},...u]=V(c);return i({...l,class:B("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const ic=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(x,h,f,y,k){return{name:x,calories:h,fat:f,carbs:y,protein:k}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],m=({name:x,calories:h})=>s(i(x),i({class:n`
            text-align: right;
          `},h)),v=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
              text-align: right;
            `,title:"Calories"},"Calories"))),b=Ie(e,{class:n`
      max-width: 650px;
    `});return()=>o(b(r(u("Basic Table"),v(),l(p.map(m)))))},cc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,xc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:vc,createComponent:fc}]},wc=e=>{const t=H(e);return()=>t(xc)};function $n(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=lt(e),s=q(e),r=He(e),c=o`
  ...
  `,l=({label:v,icon:b,...x})=>s({"aria-label":v,title:v,...x},b),u=({count:v,totalCount:b,page:x,rowsPerPage:h})=>a({class:"pages-numbers"},Number(x-1)*Number(h)+(v>0?1:0),"-",Math.min(x*h,b)," of ",b),d=({count:v,page:b,rowsPerPage:x})=>a({class:"pages-numbers"},(b-1)*x+(v>0?1:0),"-",b*x),p=v=>v<=1,m=(v,b,x)=>v>=Math.ceil(b/x);return function(...b){let[{count:x=0,totalCount:h=0,page:f=1,rowsPerPage:y=50,onPageChange:k,isLoading:T=!1,disableFirst:A=()=>p(f),disablePrevious:D=()=>p(f),disableNext:M=()=>m(f,h,y),disableLast:N=()=>m(f,h,y),...L},...K]=V(b);const J=Math.max(0,Math.ceil(h/y)),j=k({page:1}),W=k({page:f-1}),U=k({page:f+1}),C=k({page:J}),g=[{label:"First",icon:"⟪",onclick:j,disabled:A()},{label:"Previous",icon:"⟨",onclick:W,disabled:D()},{label:"Next",icon:"⟩",onclick:U,disabled:M()},{label:"Last",icon:"⟫",onclick:C,disabled:N()}];return a({...L,class:B("table-pagination",c,T&&"disabled",t==null?void 0:t.class,L==null?void 0:L.class)},r({class:"spinner",visibility:T,size:"md"}),h>0?u({count:x,totalCount:h,page:f,maxPages:J,rowsPerPage:y}):d({count:x,page:f,maxPages:J,rowsPerPage:y}),i({variant:"outline",color:"neutral"},g.map(w=>l({...w,variant:"outline",color:"neutral"}))))}}const yc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Cc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=yc(45),u=({name:f,email:y})=>i(a(f),a(y)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),p=$n(e),m=Ie(e,{class:n`
      max-width: 650px;
    `}),v=t.state(l),b=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),x=t.derive(()=>v.val.slice(b.val.page*b.val.rowsPerPage,(b.val.page+1)*b.val.rowsPerPage)),h=({page:f})=>y=>{b.val.page=f};return()=>m(s(d(),()=>c(x.val.map(u))),()=>p({...b.val,onPageChange:h}))},Sc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),m=t.derive(()=>d.val.length),v=t.state(1),b=t.state(10),x=t.derive(()=>d.val),h=N=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(N).toString()}`,f=({page:N})=>L=>{v.val=N,y(h({page:N,per_page:b.val}))};y(h({page:1,per_page:b.val}));async function y(N){try{u.val=!0;const L=await fetch(N,{});if(L.ok){const K=await L.json();d.val=K;return}throw L}catch(L){p.val=L.message}finally{u.val=!1}}const k=({name:N,description:L,stargazers_count:K})=>i(a(N),a(L),a({class:n`
            text-align: right;
          `},K)),T=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),A=$n(e),D=Ie(e,{class:n`
      min-width: 650px;
    `}),M=({message:N})=>l(N);return()=>D(()=>A({rowsPerPage:b.val,page:v.val,count:m.val,totalCount:-1,isLoading:u.val,onPageChange:f,disableNext:()=>!1}),s(T(),()=>p.val&&M({message:p.val}),()=>c(x.val.map(k))))},Ec=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=Cc(e),l=Sc(e),u=(...d)=>a({class:n`
  ...
  `;return function(...c){let[{color:l,variant:u,size:d="md",selected:p=!1,disabled:m,onChange:v,...b},...x]=V(c);return i({type:"button",...b,"aria-pressed":{deps:[p],renderProp:()=>h=>h},class:{deps:[p],renderProp:()=>h=>B("toggle",d,l,u,s,h&&"selected",t==null?void 0:t.class,b==null?void 0:b.class)},disabled:m},x)}}const Pn=e=>{const{bau:t}=e,n=De(e);return console.log("grid item"),o=>{const a=t.state(!1);return n({...o,selected:a,onclick:()=>a.val=!a.val},"Toggle Me")}},kc=e=>{const{bau:t}=e,{section:n}=t.tags,o=De(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Tc=`import toggle from "@grucloud/bau-ui/toggle";
...
`,Pc={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Mc,createComponent:Nc},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:$c,createComponent:Bc}],gridItem:On},Oc=e=>{const t=H(e);return()=>t(Pc)};function gt(e,t){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",color:d="neutral",variant:p="outline",size:m="md",...v},...b]=V(c);const x=i({class:B("container",...u.split("-"))},i({class:B("content",d,p,m),role:"tooltip"},l)),h=D=>`move-to-${D}`,f=(D,M,N)=>{if(D()){const L=h(M);x.classList.add(L),x.classList.add(M),x.classList.remove(N)}},y=(D,M)=>{const N=h(D);x.classList.contains(N)&&(x.classList.remove(N),x.classList.add(M),x.classList.remove(D))},k=D=>{const M=x.getBoundingClientRect();f(()=>M.x<0,"right","left"),f(()=>M.x+M.width>a.innerWidth,"left","right"),f(()=>M.y<0,"bottom","top"),f(()=>M.bottom>a.innerHeight,"top","bottom"),x.classList.add("visible")},T=D=>{x.classList.remove("visible"),y("right","left"),y("left","right"),y("bottom","top"),y("top","bottom")};return i({...v,class:B("tooltip",s,t==null?void 0:t.class,v==null?void 0:v.class),bauMounted:({element:D})=>{D.addEventListener("mouseover",k),D.addEventListener("mouseout",T)},bauUnmounted:({element:D})=>{D.removeEventListener("mouseover",k),D.removeEventListener("mouseout",T)}},...b,x)}}const _n=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=q(e),s=gt(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return c=>s({titleEl:r(),...c},i(c,`${c.color} ${c.variant}`))},_c=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=q(e),s=gt(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return()=>s({side:"bottom-start",titleEl:r()},i("tooltip"))},Rc=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,{nav:e`
  ...
  `});function Ln(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Vc({css:o,createGlobalStyles:a}),d=it(e),p=({depth:m=1,maxDepth:v,color:b,variant:x,size:h})=>f=>{const{children:y,expanded:k}=f,T=n.state(!k),A=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:M=>{y&&(T.val=!T.val)}},i(f.data)),D=()=>s({class:B(b,h)},y.map(p({depth:m+1,maxDepth:v})));return r(d({Header:A,Content:y&&m<v&&D}))};return function({tree:v,maxDepth:b=1/0,size:x="md",variant:h="plain",color:f="neutral",...y}){return c({class:B(u.nav,x,h,f,t==null?void 0:t.class,y.class)},v.children&&s(v.children.map(p({maxDepth:b,color:f,variant:h,size:x}))))}}const jn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ln(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Kc=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ln(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},qc=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
