...
`);function Ve(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(eo);const l=o`
  ...
  `;return function(...p){let[{color:d,variant:h="outline",size:g="md",...x},...v]=Z(p);return i({required:"required",title:"Switch Theme",...x,class:T("theme-switch",d,h,g,l,t==null?void 0:t.class,x.class),type:"checkbox",checked:r()=="dark",onclick:y=>{s(y.target.checked?"dark":"light")}},...v)}}function no(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:p,b:d,ul:h,li:g}=n.tags,{svg:x,path:v}=n.tagsNS("http://www.w3.org/2000/svg"),y=i.drawerOpen,E=Y(e,{class:o`
    ...
    `}),k=Ve(e),$=()=>s(x({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},v({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),_=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
        ...
        `},_(),R())}}function oo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:p}=t.tags,d=({links:x,title:v})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
  ...
  `,hideToRight:e`
   ...
   `});function We(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=L=>{var G;return((G=L.parentTree.data)==null?void 0:G.href)??L.parentTree.children[0].data.href},u=({variant:L,color:G,size:U,currentTree:f,data:m})=>k(I({variant:L,color:G,size:U,href:`${c}${l(f)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),I({variant:L,color:G,size:U,href:`${c}${m.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},m.name)),p=({size:L,subTree:{data:{name:G,href:U},children:f=[]}})=>I({size:L,href:`${c}${U}`,"data-ischild":!f.length},G),d=({pathname:L,subTree:G})=>{var U;return L===((U=G==null?void 0:G.data)==null?void 0:U.href)},{renderHeader:h=u,renderMenuItem:g=p,isActive:x=d}=t,{li:v,nav:y,div:E,header:k,a:$}=n.tags,_=De(e),R=we(e),I=Y(e,{class:o`
      &.button {
  ...
  `,q=({variant:L,color:G,size:U,currentTree:f,pathnameState:m})=>{const{children:b,parentTree:w,data:C}=f;return E({class:T("drillDownMenu",L,G,U)},w&&h({variant:L,color:G,size:U,data:C,currentTree:f}),b&&R({class:T(L,G,U)},b.map(O=>v({class:()=>T(O.children&&"has-children",x({pathname:m.val,subTree:O})&&"active")},g({variant:L,color:G,size:U,subTree:O})))))},Q=({tree:L,pathname:G})=>{let U=xt({})(structuredClone(L)),f=wt(G)(U);return f||(console.error("drilldown no sub tree",G),f=U),f};return function(G){const{variant:U="plain",color:f="neutral",size:m="md",tree:b,...w}=G,C=n.state(a.location.pathname.replace(c,"")),O=n.derive(()=>Q({tree:b,pathname:C.val}));a.document.addEventListener("click",F=>{const{target:J}=F,ee=J.getAttribute("href");if(J.tagName==="A"&&ee&&!ee.startsWith("http")){let ae=ee.replace(c,"");r||(ae=ae.replace(J.hash,"")),C.val=ae}});let N=1;const W=F=>{const{dataset:J}=F.target;J.buttonback=="true"?N=-1:J.ischild=="false"?N=1:J.ischild=="true"&&(N=0)},B=F=>{switch(F){case 1:return`${z} ${Te}`;case-1:return`${M} ${Te}`;default:return""}},D=F=>{switch(F){case 1:return`${M} ${Te} reverse`;case-1:return`${z} ${Te} reverse`;default:return""}};return y({class:T(H,t==null?void 0:t.class,w.class),onclick:W},_({animationHide:()=>B(N),animationShow:()=>D(N)},()=>q({variant:U,color:f,size:m,currentTree:O.val,pathnameState:C})))}}const ro={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function yt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:p,span:d}=n.tags;let h=!1;const g=We(e);return function(){return r({bauMounted:({element:v})=>{s.innerWidth<=640&&(h=!0,i.drawerOpen.val=!1)},onclick:v=>{h&&!v.target.dataset.buttonback&&!v.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:T(o`
            grid-area: sidebar;
            position: sticky;
...
"Click me"
  ...
  `,s=({element:l,closeState:u})=>{l.scrollHeight!=0&&(u.val?r(l):c(l))};function r(l){l.style.height=l.scrollHeight+"px";const u=()=>{l.removeEventListener("transitionend",u)};l.addEventListener("transitionend",u),window.requestAnimationFrame(()=>{l.style.height="0px"})}function c(l){const u=()=>{l.removeEventListener("transitionend",u),l.style.height="auto"};l.addEventListener("transitionend",u),l.style.height=l.scrollHeight+"px"}return function(...u){let[{color:p,variant:d="plain",size:h="md",Header:g,Content:x,close:v=!0,containerTag:y="div",...E},...k]=Z(u);const $=n.state(v);return a({...E,class:T("collapsible",h,i,t==null?void 0:t.class,E==null?void 0:E.class)},a({class:()=>T("header",x?$.val?"close":"open":""),onclick:_=>{$.val=!$.val,_.stopPropagation()}},g()),a({class:"content",role:"region",bauMounted:({element:_})=>{$.val&&(_.style.height="0px")},"aria-expanded":({element:_})=>(s({element:_,closeState:$}),!$.val)},x&&x()))}}const fa=()=>oe.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`);function _e(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=n.state(""),u=qe(e),p=h=>g=>{l.val==h?l.val="":l.val=h},d=o`
    ...
    ${fa()}
  `;return function(...g){let[{color:x,variant:v="outline",size:y="md",data:E=[],...k},...$]=Z(g);const _=R=>{const{Header:I,Content:z,name:M}=R,H=()=>r({class:()=>T(l.val==M&&"active")},c({type:"button","aria-controls":`bau-${M}`,"aria-expanded":({element:Q})=>l.val==M},I(R))),q=()=>a({id:`bau-${M}`,"data-state":({element:Q})=>l.val==M},z(R));return s({class:T(x,v,y),onclick:p(M)},u({Header:H,Content:q}))};return a({class:T("accordion",d,t==null?void 0:t.class,k.class)},i(E.map(_)))}}const jt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=_e(e);return s=>i({...s,data:a})},va=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=_e(e);return()=>i({data:a,color:"neutral",variant:"outline"})},xa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,_a={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ia,createComponent:Da},{title:"Custom Alert ",description:"A custom alert.",code:Na,createComponent:$a}],gridItem:Ht},Ba=e=>{const t=V(e);return()=>t(_a)},Oa=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},p=({id:d,status:h})=>{const g=c.val.findIndex(x=>x.id===d);g!=-1&&(c.val[g].status=h)};return function(h={},...g){const x=({id:E})=>{p({id:E,status:"removing"});const k=c.val.findIndex($=>$.id===E);k!=-1&&c.val.splice(k,1)},v=({Component:E})=>{const k={id:Math.random().toString(10).split(".")[1],Component:E,status:"inserting"};c.val.length>=i&&x({id:c.val[0].id}),c.val.push(k),setTimeout(()=>x(k),s)},y=E=>r({class:u.item,onclick:()=>x(E)},E.Component());return document.addEventListener("alert.add",E=>v(E.detail)),document.addEventListener("alert.remove",E=>x(E.detail)),r({class:T(u.stack,t==null?void 0:t.class,h.class)},n.loop(c,r(),y))}},Pa=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Oa(e,{deleteAfterDuration:2e4}),i=Y(e),s=Be(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Ra=`import { Context } from "@grucloud/bau-ui/context";
...
`,Fa={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:Ha,createComponent:za},{title:"Component hide and show",description:"Hide and show a component",code:Ga,createComponent:Ua}]},Va=e=>{const t=V(e);return()=>t(Fa)};function Ut(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...d){let[{color:h,variant:g="outline",size:x="md",width:v=30,height:y=30,...E},...k]=Z(d);return a({class:T(u,t==null?void 0:t.class,E.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:v,height:y,onload:c,onerror:l,class:T(h,g,x,u,t==null?void 0:t.class,E.class),...E}))}}const Gt=e=>{const{css:t}=e,n=Ut(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function Ft(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=Je(e),r=Y(e),c=Qe(e),l=we(e),u=o`
    ...
    ${qa()}
  `,p=n.state(""),d=n.state(""),h=n.state(!1),g=n.state(0),x=()=>{h.val=!1};return function(...y){let[{variant:E="outline",color:k,size:$="md",id:_,label:R,placeholder:I,Option:z,options:M,getOptionLabel:H=({label:B})=>B,...q},...Q]=Z(y);const L=n.state(M),G=()=>{W.openDialog(),h.val=!0,d.val="",L.val=M},U=()=>{W.closeDialog(),h.val=!1,d.val=""},f=B=>{const{value:D}=B.target;d.val=D,D?L.val=M.filter(F=>H(F).match(new RegExp(`${D}`,"i"))):L.val=M},m=B=>{h.val?U():G()},b=({option:B,index:D})=>F=>{p.val=H(B),g.val=D,U()},w=B=>{switch(console.log("onkeydown",B.key,g.val),B.key){case"Escape":U();break;case"ArrowDown":g.val<L.val.length-1?g.val++:g.val=0;break;case"ArrowUp":g.val<=0?g.val=L.val.length-1:g.val--;break;case"Enter":p.val=H(L.val[g.val]),d.val="",U();break}},C=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,"aria-label":R,onclick:m,variant:E,color:k,size:$},()=>!p.val&&R,p),O=c({id:_,value:d,placeholder:I,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:f,onkeydown:w,variant:E,color:k,size:$}),W=s({id:_,triggerEl:C,contentEl:(()=>a({class:T(E,k,$,"content")},O,()=>l({class:T(E,k,$)},L.val.map((B,D)=>i({class:()=>T(g.val==D&&"active"),onclick:b({option:B,index:D})},z(B))))))(),onClose:x});return a({...q,class:T("autocomplete",u,t==null?void 0:t.class,q==null?void 0:q.class)},C,W)}}const Vt=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ft(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,yr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:wr,createComponent:xr}],gridItem:Qt},Cr=e=>{const t=V(e);return()=>t(yr)};function Er(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{color:l,variant:u="plain",size:p="md",slides:d,Slide:h,Previous:g,Next:x,...v}]=Z(c);const y=()=>{s.val<=0?s.val=d.length-1:s.val--},E=()=>{s.val>=d.length-1?s.val=0:s.val++},k=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},d.map(h));return a({...v,class:T("carousel",p,i,t==null?void 0:t.class,v==null?void 0:v.class)},a({class:T("control","control-previous"),onclick:y},g()),a({class:T("control","control-next"),onclick:E},x()),k)}}const Sr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],kr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=Y(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`);function un(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=Y(e),r=Je(e),c=we(e),l=o`
    ...
    ${Ss()}
  `,u=n.state(""),p=n.state(!1),d=n.state(0);return function(...g){let[{color:x="neutral",variant:v="outline",size:y="md",id:E,label:k,Option:$,options:_,getOptionLabel:R=({label:b})=>b,...I},...z]=Z(g);const M=()=>{m.openDialog(),m.focus(),p.val=!0},H=()=>{m.closeDialog(),p.val=!1},q=()=>{p.val=!1},Q=b=>{p.val?H():M()},L=({option:b,index:w})=>C=>{u.val=R(b),d.val=w,H()},G=b=>{switch(b.preventDefault(),b.key){case"Escape":H();break;case"ArrowDown":d.val<_.length-1?d.val++:d.val=0;break;case"ArrowUp":d.val<=0?d.val=_.length-1:d.val--;break;case"Enter":p.val?(u.val=R(_[d.val]),H()):M();break}},U=()=>c({tabindex:"0",class:T(x,v)},_.map((b,w)=>i({class:()=>T(d.val==w&&"active"),onclick:L({option:b,index:w})},$(b)))),f=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":k,onclick:Q,color:x,variant:v,size:y},()=>!u.val&&k,u),m=r({id:E,triggerEl:f,contentEl:U(),onClose:q});return a({...I,class:T("select",x,y,l,t==null?void 0:t.class,I==null?void 0:I.class),onkeydown:G},f,m)}}const dn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=un(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function ye(e,t){const{bau:n,css:o}=e,{tabDefs:a}=t,{div:i,ul:s,li:r}=n.tags,c=n.state(a),l=n.state(a[0]),u=d=>c.val.find(h=>h.name==d),p={base:o`
      ...
      ${Ws()}
    `};return function(...h){let[{color:g,variant:x="plain",size:v,...y},...E]=Z(h);const k=_=>{const{Header:R,disabled:I,name:z}=_;return r({class:()=>T(l.val.name==z&&"active",I&&"disabled"),onclick:M=>M.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:z},bubbles:!0}))},R(_))},$=i({class:T("tabs",p.base,x,v,g,t==null?void 0:t.class,y.class)},n.loop(c,s(),k),()=>l.val.Content?l.val.Content({}):"");return $.addEventListener("tab.select",_=>{var z,M;const{tabName:R}=_.detail,I=u(R);I&&((z=l.val.exit)==null||z.call(),l.val=I,(M=I.enter)==null||M.call())},!1),$.addEventListener("tab.add",_=>{var I;const{tab:R}=_.detail;(I=R.enter)==null||I.call(),c.val.push(R)},!1),$.addEventListener("tab.remove",_=>{var I;const R=c.val.findIndex(z=>z.name==_.detail.tabName);R>0&&((I=c.val[R].exit)==null||I.call(),c.val.splice(R,1))},!1),$}}const gn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=ye(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return s=>i(s)},Xs=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=ye(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return()=>i({variant:"outline",color:"neutral"})},Zs=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    box-shadow: var(--shadow-s);
    border-radius: var(--global-radius);
  `;return function(...c){let[{...l},...u]=Z(c);return i({...l,class:T("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const oi=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function p(v,y,E,k,$){return{name:v,calories:y,fat:E,carbs:k,protein:$}}const d=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],h=({name:v,calories:y})=>s(i(v),i({class:n`
            text-align: right;
          `},y)),g=()=>c(s(a({class:n`
              text-align: left;
...
`,di={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:ai,createComponent:oi},{title:"Dense",description:"A dense table.",code:ii,createComponent:si},{title:"Zebra",description:"A zebra table.",code:ui,createComponent:li}]},pi=e=>{const t=V(e);return()=>t(di)};function vn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=et(e),s=Y(e),r=tt(e),c=o`
  ...
  `,l=({label:g,icon:x,...v})=>s({"aria-label":g,title:g,...v},x),u=({count:g,totalCount:x,page:v,rowsPerPage:y})=>a({class:"pages-numbers"},Number(v-1)*Number(y)+(g>0?1:0),"-",Math.min(v*y,x)," of ",x),p=({count:g,page:x,rowsPerPage:v})=>a({class:"pages-numbers"},(x-1)*v+(g>0?1:0),"-",x*v),d=g=>g<=1,h=(g,x,v)=>g>=Math.ceil(x/v);return function(...x){let[{count:v=0,totalCount:y=0,page:E=1,rowsPerPage:k=50,onPageChange:$,isLoading:_=!1,disableFirst:R=()=>d(E),disablePrevious:I=()=>d(E),disableNext:z=()=>h(E,y,k),disableLast:M=()=>h(E,y,k),...H},...q]=Z(x);const Q=Math.max(0,Math.ceil(y/k)),L=$({page:1}),G=$({page:E-1}),U=$({page:E+1}),f=$({page:Q}),m=[{label:"First",icon:"⟪",onclick:L,disabled:R()},{label:"Previous",icon:"⟨",onclick:G,disabled:I()},{label:"Next",icon:"⟩",onclick:U,disabled:z()},{label:"Last",icon:"⟫",onclick:f,disabled:M()}];return a({...H,class:T("table-pagination",c,_&&"disabled",t==null?void 0:t.class,H==null?void 0:H.class)},r({class:"spinner",visibility:_,size:"md"}),y>0?u({count:v,totalCount:y,page:E,maxPages:Q,rowsPerPage:k}):p({count:v,page:E,maxPages:Q,rowsPerPage:k}),i({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const mi=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),bi=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=mi(45),u=({name:E,email:k})=>i(a(E),a(k)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),d=vn(e),h=Ce(e,{class:n`
      max-width: 650px;
    `}),g=t.state(l),x=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),v=t.derive(()=>g.val.slice(x.val.page*x.val.rowsPerPage,(x.val.page+1)*x.val.rowsPerPage)),y=({page:E})=>k=>{x.val.page=E};return()=>h(s(p(),()=>c(v.val.map(u))),()=>d({...x.val,onPageChange:y}))},hi=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),p=t.state([]),d=t.state(""),h=t.derive(()=>p.val.length),g=t.state(1),x=t.state(10),v=t.derive(()=>p.val),y=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,E=({page:M})=>H=>{g.val=M,k(y({page:M,per_page:x.val}))};k(y({page:1,per_page:x.val}));async function k(M){try{u.val=!0;const H=await fetch(M,{});if(H.ok){const q=await H.json();p.val=q;return}throw H}catch(H){d.val=H.message}finally{u.val=!1}}const $=({name:M,description:H,stargazers_count:q})=>i(a(M),a(H),a({class:n`
            text-align: right;
          `},q)),_=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),z=({message:M})=>l(M);return()=>I(()=>R({rowsPerPage:x.val,page:g.val,count:h.val,totalCount:-1,isLoading:u.val,onPageChange:E,disableNext:()=>!1}),s(_(),()=>d.val&&z({message:d.val}),()=>c(v.val.map($))))},gi=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=bi(e),l=hi(e),u=(...p)=>a({class:n`
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",color:p="neutral",variant:d="outline",size:h="md",...g},...x]=Z(c);const v=i({class:T("container",...u.split("-"))},i({class:T("content",p,d,h),role:"tooltip"},l)),y=I=>`move-to-${I}`,E=(I,z,M)=>{if(I()){const H=y(z);v.classList.add(H),v.classList.add(z),v.classList.remove(M)}},k=(I,z)=>{const M=y(I);v.classList.contains(M)&&(v.classList.remove(M),v.classList.add(z),v.classList.remove(I))},$=I=>{const z=v.getBoundingClientRect();E(()=>z.x<0,"right","left"),E(()=>z.x+z.width>a.innerWidth,"left","right"),E(()=>z.y<0,"bottom","top"),E(()=>z.bottom>a.innerHeight,"top","bottom"),v.classList.add("visible")},_=I=>{v.classList.remove("visible"),k("right","left"),k("left","right"),k("bottom","top"),k("top","bottom")};return i({...g,class:T("tooltip",s,t==null?void 0:t.class,g==null?void 0:g.class),bauMounted:({element:I})=>{I.addEventListener("mouseover",$),I.addEventListener("mouseout",_)},bauUnmounted:({element:I})=>{I.removeEventListener("mouseover",$),I.removeEventListener("mouseout",_)}},...x,v)}}const xn=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,s=Y(e),r=nt(e),c=()=>o({class:n`
          font-size: larger;
...
`,{nav:e`
  ...
  `});function yn(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Ai({css:o,createGlobalStyles:a}),p=qe(e),d=({depth:h=1,maxDepth:g,color:x,variant:v,size:y})=>E=>{const{children:k,expanded:$}=E,_=n.state(!$),R=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:z=>{k&&(_.val=!_.val)}},i(E.data)),I=()=>s({class:T(x,y)},k.map(d({depth:h+1,maxDepth:g})));return r({},p({Header:R,Content:k&&h<g&&I}))};return function({tree:g,maxDepth:x=1/0,size:v="md",variant:y="plain",color:E="neutral",...k}){return c({class:T(u.nav,v,y,E,t==null?void 0:t.class,k.class)},g.children&&s(g.children.map(d({maxDepth:x,color:E,variant:y,size:v}))))}}const Cn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=yn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Mi=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=yn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Di=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
