...
`)}
  ...
  `}function Hn(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let Ge=e=>Object.prototype.toString.call(e??0).slice(8,-1),Un=e=>Ge(e)=="Object",rt=e=>Ge(e)=="Function",je=e=>["Object","Array"].includes(Ge(e)),st=Object.getPrototypeOf,ze=e=>me(e)?e.val:e,me=e=>e==null?void 0:e.__isState,Gn=["splice","push","pop","shift","unshift","sort","reverse"],ke=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const q=e=>!me(e[0])&&Un(e[0])?e:[{},...e];function Fn(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=f=>n.createElement(f),l=(f,m,b)=>{let w=r;r=m;let y=f(b);return r=w,y},d=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(f=>{f.bindings=f.bindings.filter(m=>{var b;return(b=m.element)==null?void 0:b.isConnected}),!f.bindings.length&&!f.computed&&a.delete(f)}),o=void 0}))},p=(f,m,b,w,y,_)=>{var $;if(s){i.add(f);return}for(let Z of f.bindings){let{deps:z,element:T,renderInferred:U,render:Y,renderItem:ee}=Z;if(ee&&m)($=x(T,w,(...ae)=>h(ee(...ae)),b,y,_)[m])==null||$.call();else{let ae=U?U({element:T}):Y({element:T,renderItem:ee})(...z.map(ze));ae!==T&&T.replaceWith(Z.element=h(ae))}}k(f),d()},u=(f,m,b=[])=>({get(w,y,_){var $;if(r==null||r.add(f),y==="_isProxy")return!0;if(!(($=w[y])!=null&&$._isProxy)&&!me(w[y])&&je(w[y]))w[y]=new Proxy(w[y],u(f,m,[...b,y]));else if(Gn.includes(y)){let Z=w[y];return(...z)=>{let T=Z.apply(w,z);return p(f,y,T,z,m,b),T}}return Reflect.get(w,y,_)},set(w,y,_,$){let Z=Reflect.set(w,y,_,$);return p(f,"setItem",Z,{prop:y,value:_},m,[...b,y]),Z}}),g=(f,m)=>new Proxy(m,u(f,m)),x=(f,m,b,w,y,_)=>{let $=()=>f.replaceChildren(...ke(w,b)),Z=z=>f[z]&&f.removeChild(f[z]);return{assign:$,sort:$,reverse:$,setItem:()=>{var T;let z=_[0];(T=f.children[z])==null||T.replaceWith(b(y[z],z))},push:()=>f.append(...ke(m,(z,T)=>b(z,y.length+T))),unshift:()=>f.prepend(...ke(m,b)),pop:()=>Z("lastChild"),shift:()=>Z("firstChild"),splice:()=>{let[z,T,...U]=m;const{length:Y}=f.children;for(let ee=z>=0?Math.min(z+T-1,Y-1):Y-1;ee>=(z>=0?z:Y+z);ee--)f.children[ee].remove();if(U.length){let ee=U.forEach((ae,Oe)=>b(ae,z+Oe));f.children[z]?f.children[z].after(...ee):f.append(...ee)}}}},v=f=>({oldVal:f,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=je(f)?g(m,f):f,m.valProxy)},set val(m){let b=this,w=b.val;je(m)?(b.valProxy=g(b,m),p(b,"assign",m)):m!==w&&(b.valProxy=m,p(b)),b.oldVal=w}}),h=f=>f==null||f===!1?c("span"):f.nodeType?f:n.createTextNode(f),C=(f,m)=>{let b=new Set;return m.val=l(f,b),b},E=f=>{let m=v(),b=C(f,m);m.computed=!0;for(let w of b)w.listeners.push({computed:f,deps:b,state:m});return m},k=f=>{for(let m of[...f.listeners])C(m.computed,m.state)},B=(f,...m)=>{if(m.length){let b=[];for(let w of m.flat(1/0))w!=null&&b.push(me(w)?G({deps:[w],render:()=>y=>y}):rt(w)?J({renderInferred:w}):h(w));f.append(...b)}},N={},O=(f,m)=>f&&(Object.getOwnPropertyDescriptor(f,m)??O(st(f),m)),M=(f,m,b)=>{var w;return N[f+","+m]??(N[f+","+m]=((w=O(b,m))==null?void 0:w.set)??0)},R=(f,m)=>new t.MutationObserver((b,w)=>{b.filter(y=>y.removedNodes).forEach(y=>[...y.removedNodes].find(_=>_===f&&(m({element:f}),w.disconnect(),!0)))}).observe(f.parentNode,{childList:!0}),I=(f,m)=>new t.MutationObserver((b,w)=>b.forEach(y=>m({record:y,element:f}))).observe(f,{childList:!0}),L=f=>new Proxy(function(b,...w){var Z;let[y,..._]=q(w),$=f?n.createElementNS(f,b):c(b);for(let[z,T]of Object.entries(y)){if(z.startsWith("bau"))continue;let U=M(b,z,st($))?Y=>$[z]=Y:Y=>$.setAttribute(z,Y);T==null||(me(T)?G({deps:[T],render:()=>()=>(U(T.val),$)}):rt(T)&&(!z.startsWith("on")||T.isDerived)?J({renderInferred:()=>(U(T({element:$})),$)}):T.renderProp?G({deps:T.deps,render:()=>()=>(U(T.renderProp({element:$})(...T.deps.map(ze))),$)}):U(T))}return y.bauChildMutated&&I($,y.bauChildMutated),B($,..._),(Z=y.bauCreated)==null||Z.call(y,{element:$}),y.bauMounted&&t.requestAnimationFrame(()=>y.bauMounted({element:$})),y.bauUnmounted&&t.requestAnimationFrame(()=>R($,y.bauUnmounted)),$},{get:(m,b)=>m.bind(void 0,b)}),K=(f,m,b)=>{f.element=h(b);for(let w of m)me(w)&&(a.add(w),w.bindings.push(f));return f.element},J=({renderInferred:f,element:m})=>{let b=new Set,w=l(f,b,{element:m});return K({renderInferred:f},b,w)},G=({deps:f,element:m,render:b,renderItem:w})=>K({deps:f,render:b,renderItem:w},f,b({element:m,renderItem:w})(...f.map(ze))),j=(f,m,b)=>G({deps:[f],render:({renderItem:w})=>y=>(m.append(...ke(y,w)),m),renderItem:b}),F=f=>{s=!0,f(),s=!1,i.forEach(p),i.clear()};return{tags:L(),tagsNS:L,state:v,bind:G,loop:j,derive:E,stateSet:a,batch:F}}const Vn=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},Wn=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Zn=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function Xn(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=Zn(a,i),r=Vn(s);return!t.getElementById(r)&&Wn(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function Kn(e){const t=Fn(),n=Xn();return zn(n),{bau:t,...n,tr:o=>o,window,...e}}function D(...e){return e.filter(t=>t).join(" ")}function De(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:D("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:d,element:p})=>{[...d.removedNodes].forEach(u=>{if(!s()||u.getAttribute("cloned"))return;const g=u.cloneNode(!0);g.setAttribute("cloned",!0),g.style.top=0,g.style.left=0,g.style.width=u.getAttribute("width"),g.style.height=u.getAttribute("height"),g.style.position="absolute",g.style.animation=s(),d.target.appendChild(g),g.addEventListener("animationend",()=>g.parentNode.removeChild(g))}),[...d.addedNodes].forEach(u=>{if(u.getAttribute("cloned"))return;p.style.position="relative";const g=u.getBoundingClientRect();if(u.setAttribute("width",g.width+"px"),u.setAttribute("height",g.height+"px"),r()){u.style.animation=r();const x=()=>{u.removeEventListener("animationend",x),u.style.animation=""};u.addEventListener("animationend",x)}})},...c},l)}}function Q(e,t){const{bau:n,css:o}=e,a={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
    ...
    `,a:o``,disabled:o`
      ...
      cursor: not-allowed;
      pointer-events: none;
    `};return function(...s){let[{color:r,variant:c,size:l="md",disabled:d,href:p,...u},...g]=q(s);return(p?n.tags.a:n.tags.button)({...u,class:D("button",a.root,c,l,r,p?a.a:a.button,d&&a.disabled,t==null?void 0:t.class,u.class),disabled:d,href:p,...!p&&{type:"button"}},g)}}const oe=["neutral","primary","success","danger","warning"],Yn=["plain","outline","solid"],qn=["sm","md","lg"],Jn="light",Qn=()=>oe.map(e=>`
...
`);function Fe(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=d=>{a.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Jn);const l=o`
    ...
    ${Qn()}
  `;return function(...p){let[{color:u,variant:g="outline",size:x="md",...v},...h]=q(p);return i({required:"required",title:"Switch Theme",...v,class:D("theme-switch",u,g,x,l,t==null?void 0:t.class,v.class),type:"checkbox",checked:r()=="dark",onclick:C=>{s(C.target.checked?"dark":"light")}},...h)}}function eo(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:d,img:p,b:u,ul:g,li:x}=n.tags,{svg:v,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),C=i.drawerOpen,E=Q(e,{class:o`
      background: transparent;
    `}),k=Fe(e),B=()=>s(v({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),N=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
            color: var(--color-inverse);
          }
        `},E({"aria-label":"drawer",variant:"none",color:"none",onclick:()=>C.val=!C.val},B()),d({href:`${a.base}/`,class:o`
            text-decoration: none;
            font-size: x-large;
        ...
        `},N(),O())}}function to({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:d,h1:p}=t.tags,u=({links:v,title:h})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},p(h),r(v.map(({href:C,name:E})=>c(s({href:C},E))))),g=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],x=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
...
`).join(`
`))()}
  `;return function(...c){let[{color:l="neutral",variant:d="plain",size:p,...u},...g]=q(c);return a({...u,class:D("list",s,l,d,p,t==null?void 0:t.class,u==null?void 0:u.class)},...g)}}const Te="0.3s",ft=({parent:e,grandParent:t})=>n=>{const{children:o,...a}=n,i=structuredClone(a);return i.children=o==null?void 0:o.map(ft({parent:n,grandParent:e})),e&&(e.parentTree=t),i.parentTree=e,i},vt=e=>t=>{var n;if(!e)return t;if(((n=t==null?void 0:t.data)==null?void 0:n.href)==e)return t.children?t:t.parentTree;if(t.children)for(let o=0;o<t.children.length;o++){const a=vt(e)(t.children[o]);if(a)return a}},no=({keyframes:e})=>({hideToLeft:e`
  from {
  ...
  `,hideToRight:e`
   ...
   `});function Ve(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=G=>{var j;return((j=G.parentTree.data)==null?void 0:j.href)??G.parentTree.children[0].data.href},d=({variant:G,color:j,size:F,currentTree:f,data:m})=>k(M({variant:G,color:j,size:F,href:`${c}${l(f)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),M({variant:G,color:j,size:F,href:`${c}${m.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},m.name)),p=({size:G,subTree:{data:{name:j,href:F},children:f=[]}})=>M({size:G,href:`${c}${F}`,"data-ischild":!f.length},j),u=({pathname:G,subTree:j})=>{var F;return G===((F=j==null?void 0:j.data)==null?void 0:F.href)},{renderHeader:g=d,renderMenuItem:x=p,isActive:v=u}=t,{li:h,nav:C,div:E,header:k,a:B}=n.tags,N=De(e),O=we(e),M=Q(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:R,hideToRight:I}=no(e),L=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,K=({variant:G,color:j,size:F,currentTree:f,pathnameState:m})=>{const{children:b,parentTree:w,data:y}=f;return E({class:D("drillDownMenu",G,j,F)},w&&g({variant:G,color:j,size:F,data:y,currentTree:f}),b&&O({class:D(G,j,F)},b.map(_=>h({class:()=>D(_.children&&"has-children",v({pathname:m.val,subTree:_})&&"active")},x({variant:G,color:j,size:F,subTree:_})))))},J=({tree:G,pathname:j})=>{let F=ft({})(structuredClone(G)),f=vt(j)(F);return f||(console.error("drilldown no sub tree",j),f=F),f};return function(j){const{variant:F="plain",color:f="neutral",size:m="md",tree:b,...w}=j,y=n.state(a.location.pathname.replace(c,"")),_=n.derive(()=>J({tree:b,pathname:y.val}));a.document.addEventListener("click",U=>{const{target:Y}=U,ee=Y.getAttribute("href");if(Y.tagName==="A"&&ee&&!ee.startsWith("http")){let ae=ee.replace(c,"");r||(ae=ae.replace(Y.hash,"")),y.val=ae}});let $=1;const Z=U=>{const{dataset:Y}=U.target;Y.buttonback=="true"?$=-1:Y.ischild=="false"?$=1:Y.ischild=="true"&&($=0)},z=U=>{switch(U){case 1:return`${R} ${Te}`;case-1:return`${I} ${Te}`;default:return""}},T=U=>{switch(U){case 1:return`${I} ${Te} reverse`;case-1:return`${R} ${Te} reverse`;default:return""}};return C({class:D(L,t==null?void 0:t.class,w.class),onclick:Z},N({animationHide:()=>z($),animationShow:()=>T($)},()=>K({variant:F,color:f,size:m,currentTree:_.val,pathnameState:y})))}}const oo={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tab",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function xt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:d,a:p,span:u}=n.tags;let g=!1;const x=Ve(e);return function(){return r({bauMounted:({element:h})=>{s.innerWidth<=640&&(g=!0,i.drawerOpen.val=!1)},onclick:h=>{g&&!h.target.dataset.buttonback&&!h.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:D(o`
            grid-area: sidebar;
            position: sticky;
          ...
          `)},x({tree:oo}))}}const ao=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:i}=t.tags,s=De(e),r=eo(e),c=xt(e),l=to(e),d=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...r){let[{size:c="md",variant:l="outline",color:d="neutral",onclick:p,...u},...g]=q(r);return a({...u,onclick:p,class:D("chip",i,c,l,d,p&&"clickable",t==null?void 0:t.class,u==null?void 0:u.class)},...g)}}function ro(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;Q(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function io({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:d}=t.tags,p=({maxSize:u=151})=>({libName:g,size:x})=>r({class:n`
            display: flex;
            margin: 0.3rem;
          `},i({class:n`
              display: flex;
...
"Click me"
        ...
        `},a(c(s(l(u??""),oe.map(g=>l(g)))),i(Yn.map(g=>s(l(g),oe.map((x,v)=>r(p({color:x,variant:g},{index:v}))))))))}},ba=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:i}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
        `},qn.map((s,r)=>i({color:"success",variant:"outline",size:s},{index:r})))}},W=e=>{const{bau:t,css:n}=e,{article:o,section:a,h1:i,p:s,h2:r,h3:c,pre:l,div:d,code:p}=t.tags;fe.registerLanguage("javascript",Ot);const u=Rt(e),g=ba(e),x=({text:v})=>l({class:n`
          display: inline-block;
        `},p({class:"hljs language-js",bauCreated:({element:h})=>{h.innerHTML=fe.highlight(v,{language:"js"}).value}}));return function(h){return o({class:n``},i(h.title),s(h.description),h.gridItem&&[r("Variant/Color"),h.gridItem&&u({Item:h.gridItem(e)}),r("Size"),s("Component with size: ",p("sm"),", ",p("md"),", and ",p("lg")),h.gridItem&&g({Item:h.gridItem(e)})],r("Usage"),c("Import"),x({text:h.importStatement}),r("Examples"),h.examples.map(C=>a(i(C.title),s(C.description),d(C.createComponent(e)()),x({text:C.code}))))}},ha=()=>oe.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`).join(`
`);function Ne(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,header:r,h3:c,button:l}=n.tags,d=n.state(""),p=x=>v=>{d.val==x?d.val="":d.val=x},u=({element:x,open:v})=>{const h=()=>{x.removeEventListener("transitionend",h)};function C(k){k.addEventListener("transitionend",h),window.requestAnimationFrame(()=>{k.style.height="0px"})}function E(k){k.addEventListener("transitionend",h),k.style.height=k.scrollHeight+"px"}x.scrollHeight!=0&&(v?E(x):C(x))},g=o`
    & ul {
      display: flex;
      flex-direction: column;
      justify-content: flex-start;
    ...
    ${ha()}
  `;return function(...v){let[{color:h,variant:C="outline",size:E="md",data:k=[],...B},...N]=q(v);const O=M=>{const{Header:R,Content:I,name:L}=M;return s({class:D(h,C,E),onclick:p(L)},c({class:()=>D(d.val==L&&"active")},l({type:"button","aria-controls":`bau-${L}`,"aria-expanded":({element:K})=>d.val==L},R(M))),a({class:"content",role:"region",id:`bau-${L}`,"data-state":({element:K})=>{const J=d.val==L;return u({element:K,open:J}),J}},I(M)))};return a({class:D("accordion",g,t==null?void 0:t.class,B.class)},i(k.map(O)))}}const Lt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Ne(e);return s=>i({...s,data:a})},ga=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Ne(e);return()=>i({data:a,color:"neutral",variant:"outline"})},fa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,Pt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},va=e=>{const{css:t}=e,n=Pt(e),o=Ne(e);return()=>o({color:"warning",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,wa=e=>{const{css:t}=e,n=Pt(e),o=Ne(e);return()=>o({color:"success",variant:"outline",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              & h3 {
...
`,$a={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ma,createComponent:Aa},{title:"Custom Alert ",description:"A custom alert.",code:Ia,createComponent:Da}],gridItem:jt},Na=e=>{const t=W(e);return()=>t($a)},_a=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},d={stack:o`
    ...
    `},p=({id:u,status:g})=>{const x=c.val.findIndex(v=>v.id===u);x!=-1&&(c.val[x].status=g)};return function(g={},...x){const v=({id:E})=>{p({id:E,status:"removing"});const k=c.val.findIndex(B=>B.id===E);k!=-1&&c.val.splice(k,1)},h=({Component:E})=>{const k={id:Math.random().toString(10).split(".")[1],Component:E,status:"inserting"};c.val.length>=i&&v({id:c.val[0].id}),c.val.push(k),setTimeout(()=>v(k),s)},C=E=>r({class:d.item,onclick:()=>v(E)},E.Component());return document.addEventListener("alert.add",E=>h(E.detail)),document.addEventListener("alert.remove",E=>v(E.detail)),r({class:D(d.stack,t==null?void 0:t.class,g.class)},n.loop(c,r(),C))}},Ba=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=_a(e,{deleteAfterDuration:2e4}),i=Q(e),s=_e(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Oa=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ua={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:ja,createComponent:Pa},{title:"Component hide and show",description:"Hide and show a component",code:Ha,createComponent:za}]},Ga=e=>{const t=W(e);return()=>t(Ua)};function zt(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},d=o`
  ...
  `;return function(...u){let[{color:g,variant:x="outline",size:v="md",width:h=30,height:C=30,...E},...k]=q(u);return a({class:D(d,t==null?void 0:t.class,E.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:h,height:C,onload:c,onerror:l,class:D(g,x,v,d,t==null?void 0:t.class,E.class),...E}))}}const Ht=e=>{const{css:t}=e,n=zt(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function qe(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Xa()}
  `;return function(r){const{size:c="md",variant:l="outline",color:d="neutral",name:p,id:u,disabled:g,...x}=r;return a({...x,class:D("input",c,d,l,i,t==null?void 0:t.class,x.class)})}}const Ka=()=>oe.map(e=>`
...
`);function Ut(e,t){const{bau:n,css:o}=e,{div:a,li:i,ul:s}=n.tags,r=Ye(e),c=Q(e),l=qe(e),d=we(e),p=o`
    ...
    ${Ka()}
  `,u=n.state(""),g=n.state(""),x=n.state(!1),v=n.state(0),h=()=>{x.val=!1};return function(...E){let[{variant:k="outline",color:B,size:N="md",id:O,label:M,placeholder:R,Option:I,options:L,getOptionLabel:K=({label:T})=>T,...J},...G]=q(E);const j=n.state(L),F=()=>{z.openDialog(),x.val=!0,g.val="",j.val=L},f=()=>{z.closeDialog(),x.val=!1,g.val=""},m=T=>{const{value:U}=T.target;g.val=U,U?j.val=L.filter(Y=>K(Y).match(new RegExp(`${U}`,"i"))):j.val=L},b=T=>{x.val?f():F()},w=({option:T,index:U})=>Y=>{u.val=K(T),v.val=U,f()},y=T=>{switch(console.log("onkeydown",T.key,v.val),T.key){case"Escape":f();break;case"ArrowDown":v.val<j.val.length-1?v.val++:v.val=0;break;case"ArrowUp":v.val<=0?v.val=j.val.length-1:v.val--;break;case"Enter":u.val=K(j.val[v.val]),g.val="",f();break}},_=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":x,"aria-label":M,onclick:b,variant:k,color:B,size:N},()=>!u.val&&M,u),$=l({id:O,value:g,placeholder:R,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":x,oninput:m,onkeydown:y,variant:k,color:B,size:N}),z=r({id:O,triggerEl:_,contentEl:(()=>a({class:D(k,B,N,"content")},$,()=>d({class:D(k,B,N)},j.val.map((T,U)=>i({class:()=>D(v.val==U&&"active"),onclick:w({option:T,index:U})},I(T))))))(),onClose:h});return a({...J,class:D("autocomplete",p,t==null?void 0:t.class,J==null?void 0:J.class)},_,z)}}const Gt=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ut(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ja={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Default",description:"A simple autocomplete.",code:qa,createComponent:Ya}],gridItem:Gt},Qa=e=>{const t=W(e);return()=>t(Ja)};function Ft(e,t){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:d="md",content:p,...u},...g]=q(r);return a({...u,class:D("badge",i,t==null?void 0:t.class,u==null?void 0:u.class)},a({class:D(c,l,d)},p),...g)}}const Vt=e=>{const t=Ft(e);return(n,{index:o})=>t({...n,content:`${o*100}`},"☏")},er=e=>{const{bau:t}=e,{section:n}=t.tags,o=Ft(e);return()=>n(o({content:"10"},"☏"))},tr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,nr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:tr,createComponent:er}],gridItem:Vt},or=e=>{const t=W(e);return()=>t(nr)};function Wt(e,t){const{bau:n,css:o}=e,{ul:a,li:i,span:s}=n.tags,r=Q(e),c=o`
  ...
  `;return function(...d){let[{color:p="neutral",variant:u="plain",size:g="md",items:x,...v},...h]=q(d);return a({...v,class:D(c,t==null?void 0:t.class,v==null?void 0:v.class)},x.map(({href:C,name:E})=>i((C?r:s)({href:C,color:p,variant:u,size:g,class:D(p,u,g)},E))))}}const Zt=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=Wt(e);return o=>n({...o,...t})},ar=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=Wt(e);return()=>n(a(o))},rr=`import breadcrumbs, {
...
`,Er={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:Cr,createComponent:yr}],gridItem:Jt},Sr=e=>{const t=W(e);return()=>t(Er)};function Qt(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:d="md",...p},...u]=q(r);return a({type:"checkbox",required:"required",...p,class:D(i,c,l,d,t==null?void 0:t.class,p==null?void 0:p.class)})}}const en=e=>{const{bau:t,css:n}=e,{label:o}=t.tags,a=Qt(e);return i=>o({class:n`
          display: flex;
...
`,Rr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Or,createComponent:Br}],gridItem:e=>tn(e,{base:"/components/drillDownMenu",hashBased:!0})},Lr=e=>{const t=W(e);return()=>t(Rr)};function nn(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(d,...p){const{variant:u="outline",color:g="neutral",size:x="md",Component:v,disabled:h,...C}=d;return a({class:D(c.base,h&&c.disabled,t==null?void 0:t.class,d.class)},s({class:D(u,g,x)},v({disabled:h}),r({type:"file",disabled:h,...C})),i({class:"filename-display"}))}}const on=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),d=nn(e),p=g=>{const x=g.target.files[0];x?l.val=x.name:l.val="No file selected"},u=({disabled:g})=>r({class:D(o`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,g&&o`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return g=>d({Component:u,name:"file",accept:"text/*",onchange:p,...g})},Pr=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,d=n.state("No file selected"),p=nn(e),u=x=>{const v=x.target.files[0];v?d.val=v.name:d.val="No file selected"},g=({disabled:x})=>c({class:D(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`);function cn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=Q(e),r=Ye(e),c=we(e),l=o`
    ...
    ${is()}
  `,d=n.state(""),p=n.state(!1),u=n.state(0);return function(...x){let[{color:v="neutral",variant:h="outline",size:C="md",id:E,label:k,Option:B,options:N,getOptionLabel:O=({label:b})=>b,...M},...R]=q(x);const I=()=>{m.openDialog(),m.focus(),p.val=!0},L=()=>{m.closeDialog(),p.val=!1},K=()=>{p.val=!1},J=b=>{p.val?L():I()},G=({option:b,index:w})=>y=>{d.val=O(b),u.val=w,L()},j=b=>{switch(b.preventDefault(),b.key){case"Escape":L();break;case"ArrowDown":u.val<N.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=N.length-1:u.val--;break;case"Enter":p.val?(d.val=O(N[u.val]),L()):I();break}},F=()=>c({tabindex:"0",class:D(v,h)},N.map((b,w)=>i({class:()=>D(u.val==w&&"active"),onclick:G({option:b,index:w})},B(b)))),f=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":k,onclick:J,color:v,variant:h,size:C},()=>!d.val&&k,d),m=r({id:E,triggerEl:f,contentEl:F(),onClose:K});return a({...M,class:D("select",v,C,l,t==null?void 0:t.class,M==null?void 0:M.class),onkeydown:j},f,m)}}const ln=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=cn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function pn(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Ss()}
  `;return function(...r){let[{color:c="neutral",variant:l="plain",size:d="md",...p},...u]=q(r);return a({...p,class:D("switch",i,c,l,d,t==null?void 0:t.class,p.class),type:"checkbox",required:"required"},...u)}}const mn=e=>{const{bau:t,css:n}=e,{form:o,label:a}=t.tags,i=pn(e);return s=>o({class:n`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`);function ye(e,t){const{bau:n,css:o}=e,{tabDefs:a}=t,{div:i,ul:s,li:r}=n.tags,c=n.state(a),l=n.state(a[0]),d=u=>c.val.find(g=>g.name==u),p={base:o`
      ...
      ${Ds()}
    `};return function(...g){let[{color:x,variant:v="plain",size:h,...C},...E]=q(g);const k=N=>{const{Header:O,disabled:M,name:R}=N;return r({class:()=>D(l.val.name==R&&"active",M&&"disabled"),onclick:I=>I.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:R},bubbles:!0}))},O(N))},B=i({class:D("tabs",p.base,v,h,x,t==null?void 0:t.class,C.class)},n.loop(c,s(),k),()=>l.val.Content?l.val.Content({}):"");return B.addEventListener("tab.select",N=>{var R,I;const{tabName:O}=N.detail,M=d(O);M&&((R=l.val.exit)==null||R.call(),l.val=M,(I=M.enter)==null||I.call())},!1),B.addEventListener("tab.add",N=>{var M;const{tab:O}=N.detail;(M=O.enter)==null||M.call(),c.val.push(O)},!1),B.addEventListener("tab.remove",N=>{var M;const O=c.val.findIndex(R=>R.name==N.detail.tabName);O>0&&((M=c.val[O].exit)==null||M.call(),c.val.splice(O,1))},!1),B}}const bn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=ye(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return s=>i(s)},Is=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=ye(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return()=>i({variant:"outline",color:"neutral"})},$s=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    box-shadow: var(--shadow-s);
    border-radius: var(--global-radius);
  `;return function(...c){let[{...l},...d]=q(c);return i({...l,class:D("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...d)}}const zs=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:d}=t.tags;function p(h,C,E,k,B){return{name:h,calories:C,fat:E,carbs:k,protein:B}}const u=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],g=({name:h,calories:C})=>s(i(h),i({class:n`
            text-align: right;
          `},C)),x=()=>c(s(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(v(r(d("Basic Table"),x(),l(u.map(g)))))},Hs=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Xs={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Hs,createComponent:zs},{title:"Dense",description:"A dense table.",code:Fs,createComponent:Gs},{title:"Zebra",description:"A zebra table.",code:Zs,createComponent:Ws}]},Ks=e=>{const t=W(e);return()=>t(Xs)};function gn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=Je(e),s=Q(e),r=Qe(e),c=o`
  ...
  `,l=({label:x,icon:v,...h})=>s({"aria-label":x,title:x,...h},v),d=({count:x,totalCount:v,page:h,rowsPerPage:C})=>a({class:"pages-numbers"},Number(h-1)*Number(C)+(x>0?1:0),"-",Math.min(h*C,v)," of ",v),p=({count:x,page:v,rowsPerPage:h})=>a({class:"pages-numbers"},(v-1)*h+(x>0?1:0),"-",v*h),u=x=>x<=1,g=(x,v,h)=>x>=Math.ceil(v/h);return function(...v){let[{count:h=0,totalCount:C=0,page:E=1,rowsPerPage:k=50,onPageChange:B,isLoading:N=!1,disableFirst:O=()=>u(E),disablePrevious:M=()=>u(E),disableNext:R=()=>g(E,C,k),disableLast:I=()=>g(E,C,k),...L},...K]=q(v);const J=Math.max(0,Math.ceil(C/k)),G=B({page:1}),j=B({page:E-1}),F=B({page:E+1}),f=B({page:J}),m=[{label:"First",icon:"⟪",onclick:G,disabled:O()},{label:"Previous",icon:"⟨",onclick:j,disabled:M()},{label:"Next",icon:"⟩",onclick:F,disabled:R()},{label:"Last",icon:"⟫",onclick:f,disabled:I()}];return a({...L,class:D("table-pagination",c,N&&"disabled",t==null?void 0:t.class,L==null?void 0:L.class)},r({class:"spinner",visibility:N,size:"md"}),C>0?d({count:h,totalCount:C,page:E,maxPages:J,rowsPerPage:k}):p({count:h,page:E,maxPages:J,rowsPerPage:k}),i({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const Ys=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),qs=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=Ys(45),d=({name:E,email:k})=>i(a(E),a(k)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),u=gn(e),g=Ce(e,{class:n`
      max-width: 650px;
    `}),x=t.state(l),v=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=t.derive(()=>x.val.slice(v.val.page*v.val.rowsPerPage,(v.val.page+1)*v.val.rowsPerPage)),C=({page:E})=>k=>{v.val.page=E};return()=>g(s(p(),()=>c(h.val.map(d))),()=>u({...v.val,onPageChange:C}))},Js=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,d=t.state(!1),p=t.state([]),u=t.state(""),g=t.derive(()=>p.val.length),x=t.state(1),v=t.state(10),h=t.derive(()=>p.val),C=I=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(I).toString()}`,E=({page:I})=>L=>{x.val=I,k(C({page:I,per_page:v.val}))};k(C({page:1,per_page:v.val}));async function k(I){try{d.val=!0;const L=await fetch(I,{});if(L.ok){const K=await L.json();p.val=K;return}throw L}catch(L){u.val=L.message}finally{d.val=!1}}const B=({name:I,description:L,stargazers_count:K})=>i(a(I),a(L),a({class:n`
            text-align: right;
          `},K)),N=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),O=gn(e),M=Ce(e,{class:n`
      min-width: 650px;
    `}),R=({message:I})=>l(I);return()=>M(()=>O({rowsPerPage:v.val,page:x.val,count:g.val,totalCount:-1,isLoading:d.val,onPageChange:E,disableNext:()=>!1}),s(N(),()=>u.val&&R({message:u.val}),()=>c(h.val.map(B))))},Qs=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=qs(e),l=Js(e),d=(...p)=>a({class:n`
  ...
  `;return function(...c){let[{titleEl:l,side:d="bottom-start",color:p="neutral",variant:u="outline",size:g="md",...x},...v]=q(c);const h=i({class:D("container",...d.split("-"))},i({class:D("content",p,u,g),role:"tooltip"},l)),C=M=>`move-to-${M}`,E=(M,R,I)=>{if(M()){const L=C(R);h.classList.add(L),h.classList.add(R),h.classList.remove(I)}},k=(M,R)=>{const I=C(M);h.classList.contains(I)&&(h.classList.remove(I),h.classList.add(R),h.classList.remove(M))},B=M=>{const R=h.getBoundingClientRect();E(()=>R.x<0,"right","left"),E(()=>R.x+R.width>a.innerWidth,"left","right"),E(()=>R.y<0,"bottom","top"),E(()=>R.bottom>a.innerHeight,"top","bottom"),h.classList.add("visible")},N=M=>{h.classList.remove("visible"),k("right","left"),k("left","right"),k("bottom","top"),k("top","bottom")};return i({...x,class:D("tooltip",s,t==null?void 0:t.class,x==null?void 0:x.class),bauMounted:({element:M})=>{M.addEventListener("mouseover",B),M.addEventListener("mouseout",N)},bauUnmounted:({element:M})=>{M.removeEventListener("mouseover",B),M.removeEventListener("mouseout",N)}},...v,h)}}const fn=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,s=Q(e),r=et(e),c=()=>o({class:n`
          font-size: larger;
