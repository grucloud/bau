...
`).join(`
`),qn=()=>Ke.map(([e])=>[`--color-${e}-s: var(--color-${e}-dark-s);`]).join(`
...
`);function eo({createGlobalStyles:e},{colorPalette:t=Ke}={}){e`
    :root {
      --color-scheme: light;
...
`)}
  ...
  `}function to(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let Ze=e=>Object.prototype.toString.call(e??0).slice(8,-1),no=e=>Ze(e)=="Object",ut=e=>Ze(e)=="Function",Fe=e=>["Object","Array"].includes(Ze(e)),dt=Object.getPrototypeOf,We=e=>me(e)?e.val:e,me=e=>e==null?void 0:e.__isState,oo=["splice","push","pop","shift","unshift","sort","reverse"],Te=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const F=e=>!me(e[0])&&no(e[0])?e:[{},...e];function ao(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,r=!1,s,c=y=>n.createElement(y),l=(y,m,b)=>{let C=s;s=m;let E=y(b);return s=C,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(y=>{y.bindings=y.bindings.filter(m=>{var b;return(b=m.element)==null?void 0:b.isConnected}),!y.bindings.length&&!y.computed&&a.delete(y)}),o=void 0}))},p=(y,m,b,C,E,L)=>{var _;if(r){i.add(y);return}for(let K of y.bindings){let{deps:O,element:B,renderInferred:V,render:J,renderItem:te}=K;if(te&&m)(_=h(B,C,(...ae)=>x(te(...ae)),b,E,L)[m])==null||_.call();else{let ae=V?V({element:B}):J({element:B,renderItem:te})(...O.map(We));ae!==B&&B.replaceWith(K.element=x(ae))}}S(y),u()},d=(y,m,b=[])=>({get(C,E,L){var _;if(s==null||s.add(y),E==="_isProxy")return!0;if(!((_=C[E])!=null&&_._isProxy)&&!me(C[E])&&Fe(C[E]))C[E]=new Proxy(C[E],d(y,m,[...b,E]));else if(oo.includes(E)){let K=C[E];return(...O)=>{let B=K.apply(C,O);return p(y,E,B,O,m,b),B}}return Reflect.get(C,E,L)},set(C,E,L,_){let K=Reflect.set(C,E,L,_);return p(y,"setItem",K,{prop:E,value:L},m,[...b,E]),K}}),g=(y,m)=>new Proxy(m,d(y,m)),h=(y,m,b,C,E,L)=>{let _=()=>y.replaceChildren(...Te(C,b)),K=O=>y[O]&&y.removeChild(y[O]);return{assign:_,sort:_,reverse:_,setItem:()=>{var B;let O=L[0];(B=y.children[O])==null||B.replaceWith(b(E[O],O))},push:()=>y.append(...Te(m,(O,B)=>b(O,E.length+B))),unshift:()=>y.prepend(...Te(m,b)),pop:()=>K("lastChild"),shift:()=>K("firstChild"),splice:()=>{let[O,B,...V]=m;const{length:J}=y.children;for(let te=O>=0?Math.min(O+B-1,J-1):J-1;te>=(O>=0?O:J+O);te--)y.children[te].remove();if(V.length){let te=V.forEach((ae,ze)=>b(ae,O+ze));y.children[O]?y.children[O].after(...te):y.append(...te)}}}},f=y=>({oldVal:y,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return s==null||s.add(m),m.valProxy??(m.valProxy=Fe(y)?g(m,y):y,m.valProxy)},set val(m){let b=this,C=b.val;Fe(m)?(b.valProxy=g(b,m),p(b,"assign",m)):m!==C&&(b.valProxy=m,p(b)),b.oldVal=C}}),x=y=>y==null||y===!1?c("span"):y.nodeType?y:n.createTextNode(y),w=(y,m)=>{let b=new Set;return m.val=l(y,b),b},v=y=>{let m=f(),b=w(y,m);m.computed=!0;for(let C of b)C.listeners.push({computed:y,deps:b,state:m});return m},S=y=>{for(let m of[...y.listeners])w(m.computed,m.state)},I=(y,...m)=>{if(m.length){let b=[];for(let C of m.flat(1/0))C!=null&&b.push(me(C)?z({deps:[C],render:()=>E=>E}):ut(C)?ee({renderInferred:C}):x(C));y.append(...b)}},N={},P=(y,m)=>y&&(Object.getOwnPropertyDescriptor(y,m)??P(dt(y),m)),A=(y,m,b)=>{var C;return N[y+","+m]??(N[y+","+m]=((C=P(b,m))==null?void 0:C.set)??0)},$=(y,m)=>new t.MutationObserver((b,C)=>{b.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(L=>L===y&&(m({element:y}),C.disconnect(),!0)))}).observe(y.parentNode,{childList:!0}),D=(y,m)=>new t.MutationObserver((b,C)=>b.forEach(E=>m({record:E,element:y}))).observe(y,{childList:!0}),R=y=>new Proxy(function(b,...C){var K;let[E,...L]=F(C),_=y?n.createElementNS(y,b):c(b);for(let[O,B]of Object.entries(E)){if(O.startsWith("bau"))continue;let V=A(b,O,dt(_))?J=>_[O]=J:J=>_.setAttribute(O,J);B==null||(me(B)?z({deps:[B],render:()=>()=>(V(B.val),_)}):ut(B)&&(!O.startsWith("on")||B.isDerived)?ee({renderInferred:()=>(V(B({element:_})),_)}):B.renderProp?z({deps:B.deps,render:()=>()=>(V(B.renderProp({element:_})(...B.deps.map(We))),_)}):V(B))}return E.bauChildMutated&&D(_,E.bauChildMutated),I(_,...L),(K=E.bauCreated)==null||K.call(E,{element:_}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:_})),E.bauUnmounted&&t.requestAnimationFrame(()=>$(_,E.bauUnmounted)),_},{get:(m,b)=>m.bind(void 0,b)}),q=(y,m,b)=>{y.element=x(b);for(let C of m)me(C)&&(a.add(C),C.bindings.push(y));return y.element},ee=({renderInferred:y,element:m})=>{let b=new Set,C=l(y,b,{element:m});return q({renderInferred:y},b,C)},z=({deps:y,element:m,render:b,renderItem:C})=>q({deps:y,render:b,renderItem:C},y,b({element:m,renderItem:C})(...y.map(We))),W=(y,m,b)=>z({deps:[y],render:({renderItem:C})=>E=>(m.append(...Te(E,C)),m),renderItem:b}),U=y=>{r=!0,y(),r=!1,i.forEach(p),i.clear()};return{tags:R(),tagsNS:R,state:f,bind:z,loop:W,derive:v,stateSet:a,batch:U}}const ro=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},so=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},io=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function co(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const r=io(a,i),s=ro(r);return!t.getElementById(s)&&so(t,e==null?void 0:e.target,s,o(s,r)),s};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function lo(e){const t=ao(),n=co();return eo(n),{bau:t,...n,tr:o=>o,window,...e}}function T(...e){return e.filter(t=>t).join(" ")}function Ne(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:r=a,animationShow:s=a,...c},l){return o({class:T("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:p})=>{[...u.removedNodes].forEach(d=>{if(!r()||d.getAttribute("cloned"))return;const g=d.cloneNode(!0);g.setAttribute("cloned",!0),g.style.top=0,g.style.left=0,g.style.width=d.getAttribute("width"),g.style.height=d.getAttribute("height"),g.style.position="absolute",g.style.animation=r(),u.target.appendChild(g),g.addEventListener("animationend",()=>{var h;return(h=g.parentNode)==null?void 0:h.removeChild(g)})}),[...u.addedNodes].forEach(d=>{if(d.getAttribute("cloned"))return;p.style.position="relative";const g=d.getBoundingClientRect();if(d.setAttribute("width",g.width+"px"),d.setAttribute("height",g.height+"px"),s()){d.style.animation=s();const h=()=>{d.removeEventListener("animationend",h),d.style.animation=""};d.addEventListener("animationend",h)}})},...c},l)}}function Z(e,t){const{bau:n,css:o}=e,a={root:o`
    ...
    `,a:o``,disabled:o`
      ...
      cursor: not-allowed;
      pointer-events: none;
    `};return function(...r){let[{color:s,variant:c,size:l="md",disabled:u,href:p,...d},...g]=F(r);return(p?n.tags.a:n.tags.button)({...!p&&{type:"button"},...d,class:T("button",a.root,c,l,s,p?a.a:a.button,u&&a.disabled,t==null?void 0:t.class,d.class),disabled:u,href:p},g)}}const Q=["neutral","primary","success","danger","warning"],uo=["plain","outline","solid"],po=["sm","md","lg"],mo="light",go=()=>Q.map(e=>`
...
`);function Xe(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,r=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},c=s();c?r(c):a.matchMedia("(prefers-color-scheme: dark)").matches?r("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?r("light"):r(mo);const l=o`
  ...
  `,hideToRight:e`
   ...
   `});function qe(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:r="",hashBased:s=!1}=t,c=`${i.base}${r}`,l=z=>{var W;return((W=z.parentTree.data)==null?void 0:W.href)??z.parentTree.children[0].data.href},u=({variant:z,color:W,size:U,currentTree:y,data:m})=>S(A({variant:z,color:W,size:U,href:`${c}${l(y)}`,class:o`
            flex-grow: 0;
    ...
    `}),{hideToLeft:$,hideToRight:D}=fo(e),R=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `;return function(...s){let[{size:c="md",variant:l="outline",color:u="neutral",onclick:p,...d},...g]=F(s);return a({...d,onclick:p,class:T("chip",i,c,l,u,p&&"clickable",t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}function wo(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:r,p:s}=t.tags;Z(e);const c=n`
  ...
  `,s=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:r},l.map(s))}}function Co({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:r,div:s,aside:c,footer:l,a:u}=t.tags,p=({maxSize:d=151})=>({libName:g,size:h})=>s({class:n`
        ...
        `},c({class:n`
          ...
          `},g.map(p({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function So(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:r,section:s}=t.tags,c=wo(e),l=yo(e),u=Z(e);$e(e);const p=Co(e),d=(...w)=>a({class:n`
        ...
        `},i({class:o`
          ...
          `},r(t("Pages Examples")),ko(e)()))}}function Ao(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function Et(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{const n=e[t],o=typeof n;(o==="object"||o==="function")&&!Object.isFrozen(n)&&Et(n)}),e}class pt{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function kt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ie(e,...t){const n=Object.create(null);for(const o in e)n[o]=e[o];return t.forEach(function(o){for(const a in o)n[a]=o[a]}),n}const Io="</span>",mt=e=>!!e.scope,Do=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){const n=e.split(".");return[`${t}${n.shift()}`,...n.map((o,a)=>`${o}${"_".repeat(a+1)}`)].join(" ")}return`${t}${e}`};class Mo{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=kt(t)}openNode(t){if(!mt(t))return;const n=Do(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){mt(t)&&(this.buffer+=Io)}value(){return this.buffer}span(t){this.buffer+=`<span class="${t}">`}}const gt=(e={})=>{const t={children:[]};return Object.assign(t,e),t};class Ye{constructor(){this.rootNode=gt(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){const n=gt({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(o=>this._walk(t,o)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{Ye._collapse(n)}))}}class No extends Ye{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){const o=t.root;n&&(o.scope=`language:${n}`),this.add(o)}toHTML(){return new Mo(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function ve(e){return e?typeof e=="string"?e:e.source:null}function Tt(e){return de("(?=",e,")")}function $o(e){return de("(?:",e,")*")}function Bo(e){return de("(?:",e,")?")}function de(...e){return e.map(n=>ve(n)).join("")}function Po(e){const t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function Je(...e){return"("+(Po(e).capture?"":"?:")+e.map(o=>ve(o)).join("|")+")"}function At(e){return new RegExp(e.toString()+"|").exec("").length-1}function _o(e,t){const n=e&&e.exec(t);return n&&n.index===0}const Oo=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function Qe(e,{joinWith:t}){let n=0;return e.map(o=>{n+=1;const a=n;let i=ve(o),r="";for(;i.length>0;){const s=Oo.exec(i);if(!s){r+=i;break}r+=i.substring(0,s.index),i=i.substring(s.index+s[0].length),s[0][0]==="\\"&&s[1]?r+="\\"+String(Number(s[1])+a):(r+=s[0],s[0]==="("&&n++)}return r}).map(o=>`(${o})`).join(t)}const Ro=/\b\B/,It="[a-zA-Z]\\w*",et="[a-zA-Z_]\\w*",Dt="\\b\\d+(\\.\\d+)?",Mt="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",Nt="\\b(0b[01]+)",Lo="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",jo=(e={})=>{const t=/^#![ ]*\//;return e.binary&&(e.begin=de(t,/.*\b/,e.binary,/\b.*/)),ie({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,o)=>{n.index!==0&&o.ignoreMatch()}},e)},xe={begin:"\\\\[\\s\\S]",relevance:0},zo={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[xe]},Ho={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[xe]},Go={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Be=function(e,t,n={}){const o=ie({scope:"comment",begin:e,end:t,contains:[]},n);o.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const a=Je("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return o.contains.push({begin:de(/[ ]+/,"(",a,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),o},Uo=Be("//","$"),Fo=Be("/\\*","\\*/"),Wo=Be("#","$"),Vo={scope:"number",begin:Dt,relevance:0},Ko={scope:"number",begin:Mt,relevance:0},Zo={scope:"number",begin:Nt,relevance:0},Xo={begin:/(?=\/[^/\n]*\/)/,contains:[{scope:"regexp",begin:/\//,end:/\/[gimuy]*/,illegal:/\n/,contains:[xe,{begin:/\[/,end:/\]/,relevance:0,contains:[xe]}]}]},qo={scope:"title",begin:It,relevance:0},Yo={scope:"title",begin:et,relevance:0},Jo={begin:"\\.\\s*"+et,relevance:0},Qo=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})};var Ie=Object.freeze({__proto__:null,MATCH_NOTHING_RE:Ro,IDENT_RE:It,UNDERSCORE_IDENT_RE:et,NUMBER_RE:Dt,C_NUMBER_RE:Mt,BINARY_NUMBER_RE:Nt,RE_STARTERS_RE:Lo,SHEBANG:jo,BACKSLASH_ESCAPE:xe,APOS_STRING_MODE:zo,QUOTE_STRING_MODE:Ho,PHRASAL_WORDS_MODE:Go,COMMENT:Be,C_LINE_COMMENT_MODE:Uo,C_BLOCK_COMMENT_MODE:Fo,HASH_COMMENT_MODE:Wo,NUMBER_MODE:Vo,C_NUMBER_MODE:Ko,BINARY_NUMBER_MODE:Zo,REGEXP_MODE:Xo,TITLE_MODE:qo,UNDERSCORE_TITLE_MODE:Yo,METHOD_GUARD:Jo,END_SAME_AS_BEGIN:Qo});function ea(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function ta(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function na(e,t){t&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=ea,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function oa(e,t){Array.isArray(e.illegal)&&(e.illegal=Je(...e.illegal))}function aa(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function ra(e,t){e.relevance===void 0&&(e.relevance=1)}const sa=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");const n=Object.assign({},e);Object.keys(e).forEach(o=>{delete e[o]}),e.keywords=n.keywords,e.begin=de(n.beforeMatch,Tt(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},ia=["of","and","for","in","not","or","if","then","parent","list","value"],ca="keyword";function $t(e,t,n=ca){const o=Object.create(null);return typeof e=="string"?a(n,e.split(" ")):Array.isArray(e)?a(n,e):Object.keys(e).forEach(function(i){Object.assign(o,$t(e[i],t,i))}),o;function a(i,r){t&&(r=r.map(s=>s.toLowerCase())),r.forEach(function(s){const c=s.split("|");o[c[0]]=[i,la(c[0],c[1])]})}}function la(e,t){return t?Number(t):ua(e)?0:1}function ua(e){return ia.includes(e.toLowerCase())}const bt={},ue=e=>{console.error(e)},ht=(e,...t)=>{console.log(`WARN: ${e}`,...t)},pe=(e,t)=>{bt[`${e}/${t}`]||(console.log(`Deprecated as of ${e}. ${t}`),bt[`${e}/${t}`]=!0)},Me=new Error;function Bt(e,t,{key:n}){let o=0;const a=e[n],i={},r={};for(let s=1;s<=t.length;s++)r[s+o]=a[s],i[s+o]=!0,o+=At(t[s-1]);e[n]=r,e[n]._emit=i,e[n]._multi=!0}function da(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw ue("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Me;if(typeof e.beginScope!="object"||e.beginScope===null)throw ue("beginScope must be object"),Me;Bt(e,e.begin,{key:"beginScope"}),e.begin=Qe(e.begin,{joinWith:""})}}function pa(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw ue("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Me;if(typeof e.endScope!="object"||e.endScope===null)throw ue("endScope must be object"),Me;Bt(e,e.end,{key:"endScope"}),e.end=Qe(e.end,{joinWith:""})}}function ma(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function ga(e){ma(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),da(e),pa(e)}function ba(e){function t(r,s){return new RegExp(ve(r),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(s?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(s,c){c.position=this.position++,this.matchIndexes[this.matchAt]=c,this.regexes.push([c,s]),this.matchAt+=At(s)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const s=this.regexes.map(c=>c[1]);this.matcherRe=t(Qe(s,{joinWith:"|"}),!0),this.lastIndex=0}exec(s){this.matcherRe.lastIndex=this.lastIndex;const c=this.matcherRe.exec(s);if(!c)return null;const l=c.findIndex((p,d)=>d>0&&p!==void 0),u=this.matchIndexes[l];return c.splice(0,l),Object.assign(c,u)}}class o{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(s){if(this.multiRegexes[s])return this.multiRegexes[s];const c=new n;return this.rules.slice(s).forEach(([l,u])=>c.addRule(l,u)),c.compile(),this.multiRegexes[s]=c,c}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(s,c){this.rules.push([s,c]),c.type==="begin"&&this.count++}exec(s){const c=this.getMatcher(this.regexIndex);c.lastIndex=this.lastIndex;let l=c.exec(s);if(this.resumingScanAtSamePosition()&&!(l&&l.index===this.lastIndex)){const u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,l=u.exec(s)}return l&&(this.regexIndex+=l.position+1,this.regexIndex===this.count&&this.considerAll()),l}}function a(r){const s=new o;return r.contains.forEach(c=>s.addRule(c.begin,{rule:c,type:"begin"})),r.terminatorEnd&&s.addRule(r.terminatorEnd,{type:"end"}),r.illegal&&s.addRule(r.illegal,{type:"illegal"}),s}function i(r,s){const c=r;if(r.isCompiled)return c;[ta,aa,ga,sa].forEach(u=>u(r,s)),e.compilerExtensions.forEach(u=>u(r,s)),r.__beforeBegin=null,[na,oa,ra].forEach(u=>u(r,s)),r.isCompiled=!0;let l=null;return typeof r.keywords=="object"&&r.keywords.$pattern&&(r.keywords=Object.assign({},r.keywords),l=r.keywords.$pattern,delete r.keywords.$pattern),l=l||/\w+/,r.keywords&&(r.keywords=$t(r.keywords,e.case_insensitive)),c.keywordPatternRe=t(l,!0),s&&(r.begin||(r.begin=/\B|\b/),c.beginRe=t(c.begin),!r.end&&!r.endsWithParent&&(r.end=/\B|\b/),r.end&&(c.endRe=t(c.end)),c.terminatorEnd=ve(c.end)||"",r.endsWithParent&&s.terminatorEnd&&(c.terminatorEnd+=(r.end?"|":"")+s.terminatorEnd)),r.illegal&&(c.illegalRe=t(r.illegal)),r.contains||(r.contains=[]),r.contains=[].concat(...r.contains.map(function(u){return ha(u==="self"?r:u)})),r.contains.forEach(function(u){i(u,c)}),r.starts&&i(r.starts,s),c.matcher=a(c),c}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=ie(e.classNameAliases||{}),i(e)}function Pt(e){return e?e.endsWithParent||Pt(e.starts):!1}function ha(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return ie(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:Pt(e)?ie(e,{starts:e.starts?ie(e.starts):null}):Object.isFrozen(e)?ie(e):e}var fa="11.8.0";class va extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}}const Ve=kt,ft=ie,vt=Symbol("nomatch"),xa=7,_t=function(e){const t=Object.create(null),n=Object.create(null),o=[];let a=!0;const i="Could not find the language '{}', did you forget to load/include a language module?",r={disableAutodetect:!0,name:"Plain text",contains:[]};let s={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:No};function c(m){return s.noHighlightRe.test(m)}function l(m){let b=m.className+" ";b+=m.parentNode?m.parentNode.className:"";const C=s.languageDetectRe.exec(b);if(C){const E=D(C[1]);return E||(ht(i.replace("{}",C[1])),ht("Falling back to no-highlight mode for this block.",m)),E?C[1]:"no-highlight"}return b.split(/\s+/).find(E=>c(E)||D(E))}function u(m,b,C){let E="",L="";typeof b=="object"?(E=m,C=b.ignoreIllegals,L=b.language):(pe("10.7.0","highlight(lang, code, ...args) has been deprecated."),pe("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),L=m,E=b),C===void 0&&(C=!0);const _={code:E,language:L};U("before:highlight",_);const K=_.result?_.result:p(_.language,_.code,C);return K.code=_.code,U("after:highlight",K),K}function p(m,b,C,E){const L=Object.create(null);function _(k,M){return k.keywords[M]}function K(){if(!j.keywords){ne.addText(Y);return}let k=0;j.keywordPatternRe.lastIndex=0;let M=j.keywordPatternRe.exec(Y),G="";for(;M;){G+=Y.substring(k,M.index);const X=re.case_insensitive?M[0].toLowerCase():M[0],oe=_(j,X);if(oe){const[se,zn]=oe;if(ne.addText(G),G="",L[X]=(L[X]||0)+1,L[X]<=xa&&(ke+=zn),se.startsWith("_"))G+=M[0];else{const Hn=re.classNameAliases[se]||se;V(M[0],Hn)}}else G+=M[0];k=j.keywordPatternRe.lastIndex,M=j.keywordPatternRe.exec(Y)}G+=Y.substring(k),ne.addText(G)}function O(){if(Y==="")return;let k=null;if(typeof j.subLanguage=="string"){if(!t[j.subLanguage]){ne.addText(Y);return}k=p(j.subLanguage,Y,!0,it[j.subLanguage]),it[j.subLanguage]=k._top}else k=g(Y,j.subLanguage.length?j.subLanguage:null);j.relevance>0&&(ke+=k.relevance),ne.__addSublanguage(k._emitter,k.language)}function B(){j.subLanguage!=null?O():K(),Y=""}function V(k,M){k!==""&&(ne.startScope(M),ne.addText(k),ne.endScope())}function J(k,M){let G=1;const X=M.length-1;for(;G<=X;){if(!k._emit[G]){G++;continue}const oe=re.classNameAliases[k[G]]||k[G],se=M[G];oe?V(se,oe):(Y=se,K(),Y=""),G++}}function te(k,M){return k.scope&&typeof k.scope=="string"&&ne.openNode(re.classNameAliases[k.scope]||k.scope),k.beginScope&&(k.beginScope._wrap?(V(Y,re.classNameAliases[k.beginScope._wrap]||k.beginScope._wrap),Y=""):k.beginScope._multi&&(J(k.beginScope,M),Y="")),j=Object.create(k,{parent:{value:j}}),j}function ae(k,M,G){let X=_o(k.endRe,G);if(X){if(k["on:end"]){const oe=new pt(k);k["on:end"](M,oe),oe.isMatchIgnored&&(X=!1)}if(X){for(;k.endsParent&&k.parent;)k=k.parent;return k}}if(k.endsWithParent)return ae(k.parent,M,G)}function ze(k){return j.matcher.regexIndex===0?(Y+=k[0],1):(Ue=!0,0)}function On(k){const M=k[0],G=k.rule,X=new pt(G),oe=[G.__beforeBegin,G["on:begin"]];for(const se of oe)if(se&&(se(k,X),X.isMatchIgnored))return ze(M);return G.skip?Y+=M:(G.excludeBegin&&(Y+=M),B(),!G.returnBegin&&!G.excludeBegin&&(Y=M)),te(G,k),G.returnBegin?0:M.length}function Rn(k){const M=k[0],G=b.substring(k.index),X=ae(j,k,G);if(!X)return vt;const oe=j;j.endScope&&j.endScope._wrap?(B(),V(M,j.endScope._wrap)):j.endScope&&j.endScope._multi?(B(),J(j.endScope,k)):oe.skip?Y+=M:(oe.returnEnd||oe.excludeEnd||(Y+=M),B(),oe.excludeEnd&&(Y=M));do j.scope&&ne.closeNode(),!j.skip&&!j.subLanguage&&(ke+=j.relevance),j=j.parent;while(j!==X.parent);return X.starts&&te(X.starts,k),oe.returnEnd?0:M.length}function Ln(){const k=[];for(let M=j;M!==re;M=M.parent)M.scope&&k.unshift(M.scope);k.forEach(M=>ne.openNode(M))}let Ee={};function st(k,M){const G=M&&M[0];if(Y+=k,G==null)return B(),0;if(Ee.type==="begin"&&M.type==="end"&&Ee.index===M.index&&G===""){if(Y+=b.slice(M.index,M.index+1),!a){const X=new Error(`0 width match regex (${m})`);throw X.languageName=m,X.badRule=Ee.rule,X}return 1}if(Ee=M,M.type==="begin")return On(M);if(M.type==="illegal"&&!C){const X=new Error('Illegal lexeme "'+G+'" for mode "'+(j.scope||"<unnamed>")+'"');throw X.mode=j,X}else if(M.type==="end"){const X=Rn(M);if(X!==vt)return X}if(M.type==="illegal"&&G==="")return 1;if(Ge>1e5&&Ge>M.index*3)throw new Error("potential infinite loop, way more iterations than matches");return Y+=G,G.length}const re=D(m);if(!re)throw ue(i.replace("{}",m)),new Error('Unknown language: "'+m+'"');const jn=ba(re);let He="",j=E||jn;const it={},ne=new s.__emitter(s);Ln();let Y="",ke=0,ce=0,Ge=0,Ue=!1;try{if(re.__emitTokens)re.__emitTokens(b,ne);else{for(j.matcher.considerAll();;){Ge++,Ue?Ue=!1:j.matcher.considerAll(),j.matcher.lastIndex=ce;const k=j.matcher.exec(b);if(!k)break;const M=b.substring(ce,k.index),G=st(M,k);ce=k.index+G}st(b.substring(ce))}return ne.finalize(),He=ne.toHTML(),{language:m,value:He,relevance:ke,illegal:!1,_emitter:ne,_top:j}}catch(k){if(k.message&&k.message.includes("Illegal"))return{language:m,value:Ve(b),illegal:!0,relevance:0,_illegalBy:{message:k.message,index:ce,context:b.slice(ce-100,ce+100),mode:k.mode,resultSoFar:He},_emitter:ne};if(a)return{language:m,value:Ve(b),illegal:!1,relevance:0,errorRaised:k,_emitter:ne,_top:j};throw k}}function d(m){const b={value:Ve(m),illegal:!1,relevance:0,_top:r,_emitter:new s.__emitter(s)};return b._emitter.addText(m),b}function g(m,b){b=b||s.languages||Object.keys(t);const C=d(m),E=b.filter(D).filter(q).map(B=>p(B,m,!1));E.unshift(C);const L=E.sort((B,V)=>{if(B.relevance!==V.relevance)return V.relevance-B.relevance;if(B.language&&V.language){if(D(B.language).supersetOf===V.language)return 1;if(D(V.language).supersetOf===B.language)return-1}return 0}),[_,K]=L,O=_;return O.secondBest=K,O}function h(m,b,C){const E=b&&n[b]||C;m.classList.add("hljs"),m.classList.add(`language-${E}`)}function f(m){let b=null;const C=l(m);if(c(C))return;if(U("before:highlightElement",{el:m,language:C}),m.children.length>0&&(s.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(m)),s.throwUnescapedHTML))throw new va("One of your code blocks includes unescaped HTML.",m.innerHTML);b=m;const E=b.textContent,L=C?u(E,{language:C,ignoreIllegals:!0}):g(E);m.innerHTML=L.value,h(m,C,L.language),m.result={language:L.language,re:L.relevance,relevance:L.relevance},L.secondBest&&(m.secondBest={language:L.secondBest.language,relevance:L.secondBest.relevance}),U("after:highlightElement",{el:m,result:L,text:E})}function x(m){s=ft(s,m)}const w=()=>{I(),pe("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function v(){I(),pe("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let S=!1;function I(){if(document.readyState==="loading"){S=!0;return}document.querySelectorAll(s.cssSelector).forEach(f)}function N(){S&&I()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",N,!1);function P(m,b){let C=null;try{C=b(e)}catch(E){if(ue("Language definition for '{}' could not be registered.".replace("{}",m)),a)ue(E);else throw E;C=r}C.name||(C.name=m),t[m]=C,C.rawDefinition=b.bind(null,e),C.aliases&&R(C.aliases,{languageName:m})}function A(m){delete t[m];for(const b of Object.keys(n))n[b]===m&&delete n[b]}function $(){return Object.keys(t)}function D(m){return m=(m||"").toLowerCase(),t[m]||t[n[m]]}function R(m,{languageName:b}){typeof m=="string"&&(m=[m]),m.forEach(C=>{n[C.toLowerCase()]=b})}function q(m){const b=D(m);return b&&!b.disableAutodetect}function ee(m){m["before:highlightBlock"]&&!m["before:highlightElement"]&&(m["before:highlightElement"]=b=>{m["before:highlightBlock"](Object.assign({block:b.el},b))}),m["after:highlightBlock"]&&!m["after:highlightElement"]&&(m["after:highlightElement"]=b=>{m["after:highlightBlock"](Object.assign({block:b.el},b))})}function z(m){ee(m),o.push(m)}function W(m){const b=o.indexOf(m);b!==-1&&o.splice(b,1)}function U(m,b){const C=m;o.forEach(function(E){E[C]&&E[C](b)})}function y(m){return pe("10.7.0","highlightBlock will be removed entirely in v12.0"),pe("10.7.0","Please use highlightElement now."),f(m)}Object.assign(e,{highlight:u,highlightAuto:g,highlightAll:I,highlightElement:f,highlightBlock:y,configure:x,initHighlighting:w,initHighlightingOnLoad:v,registerLanguage:P,unregisterLanguage:A,listLanguages:$,getLanguage:D,registerAliases:R,autoDetection:q,inherit:ft,addPlugin:z,removePlugin:W}),e.debugMode=function(){a=!1},e.safeMode=function(){a=!0},e.versionString=fa,e.regex={concat:de,lookahead:Tt,either:Je,optional:Bo,anyNumberOfTimes:$o};for(const m in Ie)typeof Ie[m]=="object"&&Et(Ie[m]);return Object.assign(e,Ie),e},ge=_t({});ge.newInstance=()=>_t({});var wa=ge;ge.HighlightJS=ge;ge.default=ge;const fe=Ao(wa),xt="[A-Za-z$_][0-9A-Za-z$_]*",ya=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],Ca=["true","false","null","undefined","NaN","Infinity"],Ot=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Rt=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],Lt=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],Sa=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],Ea=[].concat(Lt,Ot,Rt);function jt(e){const t=e.regex,n=(b,{after:C})=>{const E="</"+b[0].slice(1);return b.input.indexOf(E,C)!==-1},o=xt,a={begin:"<>",end:"</>"},i=/<[A-Za-z0-9\\._:-]+\s*\/>/,r={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(b,C)=>{const E=b[0].length+b.index,L=b.input[E];if(L==="<"||L===","){C.ignoreMatch();return}L===">"&&(n(b,{after:E})||C.ignoreMatch());let _;const K=b.input.substring(E);if(_=K.match(/^\s*=/)){C.ignoreMatch();return}if((_=K.match(/^\s+extends\s+/))&&_.index===0){C.ignoreMatch();return}}},s={$pattern:xt,keyword:ya,literal:Ca,built_in:Ea,"variable.language":Sa},c="[0-9](_?[0-9])*",l=`\\.(${c})`,u="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${u})((${l})|\\.)?|(${l}))[eE][+-]?(${c})\\b`},{begin:`\\b(${u})\\b((${l})\\b|\\.)?|(${l})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},d={className:"subst",begin:"\\$\\{",end:"\\}",keywords:s,contains:[]},g={begin:"html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,d],subLanguage:"xml"}},h={begin:"css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,d],subLanguage:"css"}},f={begin:"gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,d],subLanguage:"graphql"}},x={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,d]},v={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:o+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},S=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,g,h,f,x,{match:/\$\d+/},p];d.contains=S.concat({begin:/\{/,end:/\}/,keywords:s,contains:["self"].concat(S)});const I=[].concat(v,d.contains),N=I.concat([{begin:/\(/,end:/\)/,keywords:s,contains:["self"].concat(I)}]),P={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:s,contains:N},A={variants:[{match:[/class/,/\s+/,o,/\s+/,/extends/,/\s+/,t.concat(o,"(",t.concat(/\./,o),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,o],scope:{1:"keyword",3:"title.class"}}]},$={relevance:0,match:t.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Ot,...Rt]}},D={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},R={variants:[{match:[/function/,/\s+/,o,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[P],illegal:/%/},q={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function ee(b){return t.concat("(?!",b.join("|"),")")}const z={match:t.concat(/\b/,ee([...Lt,"super","import"]),o,t.lookahead(/\(/)),className:"title.function",relevance:0},W={begin:t.concat(/\./,t.lookahead(t.concat(o,/(?![0-9A-Za-z$_(])/))),end:o,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},U={match:[/get|set/,/\s+/,o,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},P]},y="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",m={match:[/const|var|let/,/\s+/,o,/\s*/,/=\s*/,/(async\s*)?/,t.lookahead(y)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[P]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:s,exports:{PARAMS_CONTAINS:N,CLASS_REFERENCE:$},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),D,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,g,h,f,x,v,{match:/\$\d+/},p,$,{className:"attr",begin:o+t.lookahead(":"),relevance:0},m,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[v,e.REGEXP_MODE,{className:"function",begin:y,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:s,contains:N}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:a.begin,end:a.end},{match:i},{begin:r.begin,"on:begin":r.isTrulyOpeningTag,end:r.end}],subLanguage:"xml",contains:[{begin:r.begin,end:r.end,skip:!0,contains:["self"]}]}]},R,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[P,e.inherit(e.TITLE_MODE,{begin:o,className:"title.function"})]},{match:/\.\.\./,relevance:0},W,{match:"\\$"+o,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[P]},z,q,A,U,{match:/\$[(.]/}]}}function ka(e){return{name:"Shell Session",aliases:["console","shellsession"],contains:[{className:"meta.prompt",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]}}const Ta=e=>{const{bau:t,css:n}=e,{pre:o,code:a}=t.tags;return fe.registerLanguage("javascript",jt),fe.registerLanguage("sh",ka),function({text:r,language:s="js"}){const c=a({class:`hljs language-${s}`});return c.innerHTML=fe.highlight(r,{language:s}).value,o({class:n`
          display: inline-block;
...
"Click me"
  ...
  `,g=({value:x,id:w,children:v=[]})=>{const S=c({class:()=>u.val==w?"active":"",href:`#${w}`});return S.innerHTML=x,s({class:()=>u.val==w?"active":""},S,v.length>0&&r(v.map(g)))},h=x=>x.tagName.charAt(1),f=({contentEl:x})=>{const w=x.querySelectorAll(l);let v=2,S={},I={children:[]},N=I;const P=N;let A=[N];return[...w].forEach($=>{const D=h($);$.setAttribute("id",$.textContent),!$.innerHTML.includes("<button")&&(S={value:$.innerHTML,id:$.id??$.textContent,children:[]},v==D?(I=S,N.children.push(I)):v<D?(A.push(N),N=I,I.children.push(S),I=S):v>D&&(N=A[D-1],A=A.slice(0,D-1),N.children.push(S),I=S),v=D)}),P};return function(...w){let[{color:v,variant:S,size:I="md",contentEl:N,...P}]=F(w);const A=f({contentEl:N}),$=p(()=>{const R=[...N.querySelectorAll(l)].find(q=>{const{top:ee,height:z}=q.getBoundingClientRect();if(ee+z>60)return!0});R&&(u.val=R==null?void 0:R.id)},100);return i({...P,class:T("tableOfContent",I,S,v,d,t==null?void 0:t.class,P==null?void 0:P.class),bauMounted:()=>{a.addEventListener("scroll",$)},bauUnmounted:()=>{a.removeEventListener("scroll",$)}},A.children&&r(A.children.map(g)))}}const Ht=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:r,td:s,thead:c,th:l}=t.tags;return function({Item:p,name:d}){return o({class:n`
    ...
    `}),h=Ht(e),f=Ia(e),x=({text:w})=>u({class:n`
        ...
        `},S,d({contentEl:S}))}};function tt(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    overflow: hidden;
    background-color: inherit;
    display: flex;
    flex-direction: column;
...
`).join(`
`);function _e(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:r,h3:s,button:c}=n.tags,l=n.state(""),u=tt(e),p=g=>h=>{l.val==g?l.val="":l.val=g},d=o`
    & ul {
      display: flex;
      flex-direction: column;
      justify-content: flex-start;
...
`,Oa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:Na,createComponent:Ma},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Ba,createComponent:$a},{title:"Customize the icon",description:"Customize the icon with a cross.",code:_a,createComponent:Pa}],gridItem:Gt},Ra=e=>{const t=H(e);return()=>t(Oa)},La={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},ja=({css:e,createGlobalStyles:t})=>{t`
:root {
...
`,Wa={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ga,createComponent:Ha},{title:"Custom Alert ",description:"A custom alert.",code:Fa,createComponent:Ua}],gridItem:Ft},Va=e=>{const t=H(e);return()=>t(Wa)},Ka=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:r=15e3}=t,{div:s}=n.tags,c=n.state([]),l={inserting:a`
...
`,qa={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:Xa,createComponent:Za}]},Ya=e=>{const t=H(e);return()=>t(qa)},Ja=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=Ne(e),r=Z(e),s=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`);function Re(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${cr()}
  `;return function(s){const{size:c="md",variant:l="outline",color:u="neutral",disabled:p,...d}=s;return a({type:"text",...d,disabled:p,class:T("input",c,u,l,i,p&&"disabled",t==null?void 0:t.class,d.class)})}}const lr=()=>Q.map(e=>`
...
& button.outline.${e}::after {
  ...
  `).join(`
`);function Kt(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,r=nt(e),s=Z(e),c=Re(e),l=we(e),u=o`
    & button {
      &::after {
        content: "\u25BC";
        padding: 0 0.3rem;
    ...
    ${lr()}
  `,p=n.state(""),d=n.state(""),g=n.state(!1),h=n.state(0),f=()=>{g.val=!1};return function(...w){let[{variant:v="outline",color:S,size:I="md",id:N,label:P,placeholder:A,Option:$,options:D,getOptionLabel:R=({label:O})=>O,...q},...ee]=F(w);const z=n.state(D),W=()=>{K.openDialog(),g.val=!0,d.val="",z.val=D},U=()=>{K.closeDialog(),g.val=!1,d.val=""},y=O=>{const{value:B}=O.target;d.val=B,B?z.val=D.filter(V=>R(V).match(new RegExp(`${B}`,"i"))):z.val=D},m=O=>{g.val?U():W()},b=({option:O,index:B})=>V=>{p.val=R(O),h.val=B,U()},C=O=>{switch(console.log("onkeydown",O.key,h.val),O.key){case"Escape":U();break;case"ArrowDown":h.val<z.val.length-1?h.val++:h.val=0;break;case"ArrowUp":h.val<=0?h.val=z.val.length-1:h.val--;break;case"Enter":p.val=R(z.val[h.val]),d.val="",U();break}},E=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":g,"aria-label":P,onclick:m,variant:v,color:S,size:I},()=>!p.val&&P,p),L=c({id:N,value:d,placeholder:A,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":g,oninput:y,onkeydown:C,variant:v,color:S,size:I}),K=r({id:N,triggerEl:E,contentEl:(()=>a({class:T(v,S,I,"content")},L,()=>l({class:T(v,S,I)},z.val.map((O,B)=>i({class:()=>T(h.val==B&&"active"),onclick:b({option:O,index:B})},$(O))))))(),onClose:f});return a({...q,class:T("autocomplete",u,t==null?void 0:t.class,q==null?void 0:q.class)},E,K)}}const Zt=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Kt(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],s=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},a(c.label),a(c.code));return c=>i({...c,options:r,Option:s,getOptionLabel:({label:l})=>l,label:"Country",placeholder:"Search countries",id:"country"})},ur=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,r=Kt(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,pr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Default",description:"A simple autocomplete.",code:dr,createComponent:ur}],gridItem:Zt},mr=e=>{const t=H(e);return()=>t(pr)};function Xt(e,t){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
  ...
  `;return function(...s){let[{color:c,variant:l="outline",size:u="md",content:p,...d},...g]=F(s);return a({...d,class:T("badge",i,t==null?void 0:t.class,d==null?void 0:d.class)},a({class:T(c,l,u)},p),...g)}}const qt=e=>{const t=Xt(e);return(n,{index:o})=>t({...n,content:`${o*100}`},"☏")},gr=e=>{const{bau:t}=e,{section:n}=t.tags,o=Xt(e);return()=>n(o({content:"10"},"☏"))},br=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,Dr={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:Ir,createComponent:Ar}],gridItem:en},Mr=e=>{const t=H(e);return()=>t(Dr)};function tn(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>Q.map(s=>`
...
`,Br={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:$r,createComponent:Nr}],gridItem:nn},Pr=e=>{const t=H(e);return()=>t(Br)};function _r(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,r=n.state(0);return function(...c){let[{color:l,variant:u="plain",size:p="md",slides:d,Slide:g,Previous:h,Next:f,...x}]=F(c);const w=()=>{r.val<=0?r.val=d.length-1:r.val--},v=()=>{r.val>=d.length-1?r.val=0:r.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*r.val}%);`},d.map(g));return a({...x,class:T("carousel",p,i,t==null?void 0:t.class,x==null?void 0:x.class)},a({class:T("control","control-previous"),onclick:w},h()),a({class:T("control","control-next"),onclick:v},f()),S)}}const Or=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],Rr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=Z(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,Kr={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:Vr,createComponent:Wr}],gridItem:rn},Zr=e=>{const t=H(e);return()=>t(Kr)},Xr=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=tt(e),i=Z(e),r=()=>i("Header"),s=()=>o("Content");return()=>n(a({Header:r,Content:s}))},qr=`import button from "@grucloud/bau-ui/button";
...
`,ns={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:ts,createComponent:es}]},os=e=>{const t=H(e);return()=>t(ns)},sn=(e,t)=>{const n={data:{name:"Root Menu",href:"#drilldown-gallery"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},o=qe(e,t);return a=>o({id:"drilldown-gallery",tree:n,...a})},as=e=>{const{bau:t}=e,{section:n}=t.tags,o={data:{name:"Root Menu",href:"#drilldown-example"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},a=qe(e,{base:"/components/drillDownMenu",hashBased:!0});return()=>n({id:"drilldown-example"},a({tree:o}))},rs=`import drillDownMenu, { type Tree } from "@grucloud/bau-ui/drillDownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
100% {
  ...
  `;return function({size:u="md",color:p="primary",variant:d="outline",visibility:g=!0,...h}={}){const f=o`
      ...
      ${ws()}
    `;return i({class:{deps:[g],renderProp:()=>x=>T("spinner",f,p,d,x==!1?"":"visibility",t==null?void 0:t.class,h.class)},version:"1.1",x:"0px",y:"0px",width:De[u],height:De[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...h},r({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}function mn(e,t){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,r=a`
0% {
      opacity: 1;
}
100% {
...
`).join(`
`))()}
  `;return function(...c){let[{color:l="neutral",variant:u="outline",size:p="md",...d},...g]=F(c);return a({class:T("modal",r,l,u,p,t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}const hn=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:r}=t.tags,s=Z(e),c=bn(e),l=()=>o(Array(10).fill("").map((p,d)=>r(d+1,". Some text here"))),u=p=>{const d=c({id:"my-dialog",...p},a("Header"),l(),i(s({variant:"outline",color:p.color,onclick:()=>{d.close()}},"Cancel"),s({variant:"solid",color:p.color,onclick:()=>{d.close()}},"OK")));return d};return p=>{const d=u(p);return n(s({...p,onclick:()=>{d.showModal()}},"OPEN MODAL"),d)}},$s=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:r}=t.tags,s="neutral",c=Z(e),l=bn(e),u=()=>o(Array(10).fill("").map((d,g)=>r(g+1,". Some text here"))),p=l({id:"my-dialog"},a("Header"),u(),i(c({variant:"outline",color:s,onclick:()=>{p.close()}},"Cancel"),c({variant:"solid",color:s,onclick:()=>{p.close()}},"OK")));return()=>n(c({variant:"solid",color:"neutral",onclick:()=>{p.showModal()}},"OPEN MODAL"),p)},Bs=`import modal from "@grucloud/bau-ui/modal";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zs={title:"Paper",package:"paper",description:"The paper component displays child components on a surface area.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paper/paper.js",importStatement:'import paper from "@grucloud/bau-ui/paper";',examples:[{title:"Default",description:"A simple paper.",code:Ks,createComponent:Vs}],variantColorTableDisable:!0,gridItem:Ws},Xs=e=>{const t=H(e);return()=>t(Zs)};function fn(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    &.sm {
      transform: scale(0.8);
    }
    &.md {
...
`,Js={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Ys,createComponent:qs}],gridItem:vn},Qs=e=>{const t=H(e);return()=>t(Js)},ei=()=>Q.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`).join(`
`);function xn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,r=Z(e),s=nt(e),c=we(e),l=o`
    & button {
      &::after {
        content: "\u25BC";
        padding: 0.3rem;
    ...
    ${ei()}
  `,u=n.state(""),p=n.state(!1),d=n.state(0);return function(...h){let[{color:f="neutral",variant:x="outline",size:w="md",id:v,label:S,Option:I,options:N,getOptionLabel:P=({label:b})=>b,...A},...$]=F(h);const D=()=>{m.openDialog(),m.focus(),p.val=!0},R=()=>{m.closeDialog(),p.val=!1},q=()=>{p.val=!1},ee=b=>{p.val?R():D()},z=({option:b,index:C})=>E=>{u.val=P(b),d.val=C,R()},W=b=>{switch(b.preventDefault(),b.key){case"Escape":R();break;case"ArrowDown":d.val<N.length-1?d.val++:d.val=0;break;case"ArrowUp":d.val<=0?d.val=N.length-1:d.val--;break;case"Enter":p.val?(u.val=P(N[d.val]),R()):D();break}},U=()=>c({tabindex:"0",class:T(f,x)},N.map((b,C)=>i({class:()=>T(d.val==C&&"active"),onclick:z({option:b,index:C})},I(b)))),y=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":S,onclick:ee,color:f,variant:x,size:w},()=>!u.val&&S,u),m=s({id:v,triggerEl:y,contentEl:U(),onClose:q});return a({...A,class:T("select",f,w,l,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:W},y,m)}}const wn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=xn(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],s=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,oi={title:"Modal",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Default",description:"A simple select.",code:ni,createComponent:ti}],gridItem:wn},ai=e=>{const t=H(e);return()=>t(oi)};function je(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,r=o`
    ${(()=>Q.map(s=>`
&.slider.${s} {
  accent-color: var(--color-${s});
}
...
`,ii=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:r,br:s,option:c}=t.tags,l=t.state(0),u=d=>{l.val=d==null?void 0:d.target.value},p=je(e);return()=>o(a(i({for:"temp"},"Choose a comfortable temperature"),s,p({oninput:u,class:n`
            width: 300px;
            margin: 0;
...
`,li=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i,datalist:r,br:s,option:c}=t.tags,l=t.state(0),u=d=>{l.val=d==null?void 0:d.target.value},p=je(e);return()=>o(a({class:n`
            display: flex;
...
`,wi=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i}=t.tags,r=Z(e);return function({onclickProvider:c}){return o(i("Provider selection"),a({class:n`
            display: flex;
            flex-direction: column;
            gap: 1rem;
          `},r({onclick:c("AWS"),variant:"outline",color:"primary"},"AWS"),r({onclick:c("Azure"),variant:"outline",color:"primary"},"Azure")))}},yi=e=>{const{bau:t,css:n}=e,{section:o,form:a,h1:i,header:r,footer:s,p:c,label:l,i:u}=t.tags,p=Z(e),d=Re(e);return function({onclickPrevious:h,onclickNext:f}){return a({name:"config-aws",onsubmit:w=>{w.preventDefault(),f()},"data-infra-create":!0,class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          & section {
        ...
        `},r(i("AWS Configuration"),c("Please provide the following information to create and scan a new infrastructure")),o(l("Infrastructure Name",d({autofocus:!0,placeholder:"Infrastructure Name",name:"infraName",pattern:String.raw`\w{3,64}`,title:"Length should be greater than 3 and below 64",required:!0})),l("Access Key Id",d({placeholder:"Access Key Id",name:"accessKeyId",pattern:String.raw`\w{16,128}`,title:"Length should be greater than 16 and below 128",required:!0})),l("Secret Key",d({placeholder:"Secret Key",name:"secretKey",pattern:String.raw`\w{16,128}`,title:"Length should be greater than 16 and below 128",required:!0}))),s({class:n`
            display: flex;
            gap: 1rem;
          `},p({onclick:h,variant:"outline",color:"primary"},u("◀"),"Previous"),p({type:"submit",variant:"outline",color:"primary"},"Next",u("▶"))))}},Ci=e=>{const{bau:t,css:n}=e,{section:o,h1:a,footer:i}=t.tags,r=Z(e);return function({onclickPrevious:c,onclickNext:l}){return o(a("Azure Configuration"),i({class:n`
            display: flex;
            gap: 1rem;
          `},r({onclick:c,variant:"outline",color:"primary"},"Previous"),r({onclick:l,variant:"outline",color:"primary"},"Next")))}},Si=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,r=Sn(e),s=wi(e),c=yi(e),l=Ci(e),u=t.state(""),p=t.state(0),d=({name:v})=>v,g=v=>()=>{u.val=v,p.val++},f=[{name:"Provider Selection",Header:d,Content:()=>s({onclickProvider:g}),enter:async()=>{u.val=""}},{name:"Configuration",Header:()=>`Configuration ${u.val}`,Content:()=>{switch(u.val){case"AWS":return c({onclickPrevious:x,onclickNext:w});case"Azure":return l({onclickPrevious:x,onclickNext:w})}}},{name:"Scan",Header:d,Content:()=>a(i("My stepper 3 Content"))}],x=()=>{p.val>0&&p.val--},w=()=>{f.length>p.val+1&&p.val++};return()=>o({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
        `},r({stepperDefs:f,activeStepIndex:p}))},Ei=`import stepper, { type StepperPage } from "@grucloud/bau-ui/stepper";
import { Context } from "@grucloud/bau-ui/context";
...
`);function En(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...s){let[{color:c="neutral",variant:l="plain",size:u="md",...p},...d]=F(s);return a({...p,class:T("switch",i,c,l,u,t==null?void 0:t.class,p.class),type:"checkbox",required:"required"},...d)}}const kn=e=>{const{bau:t,css:n}=e,{form:o,label:a}=t.tags,i=En(e);return r=>o({class:n`
        ...
        `},a("off ",i({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),a("on ",i({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},Ii=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i}=t.tags,r=En(e);return()=>o(a(i({class:n`
              ...
              align-items: center;
              gap: 0.5rem;
            `},"My shinny switch",r({variant:"outline",id:"my-shinny-switch"}))))},Di=`import createSwitch from "@grucloud/bau-ui/switch";
import { Context } from "@grucloud/bau-ui/context";
...
`,Mi={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:Di,createComponent:Ii}],gridItem:kn},Ni=e=>{const t=H(e);return()=>t(Mi)},$i=()=>Q.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`;function be(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Wi=[be("Frozen yoghurt",159,6,24,4),be("Ice cream sandwich",237,9,37,4.3),be("Eclair",262,16,24,6),be("Cupcake",305,3.7,67,4.3),be("Gingerbread",356,16,49,3.9)],Vi=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:r,table:s,thead:c,tbody:l,caption:u}=t.tags,p=({name:h,calories:f})=>r(i(h),i({class:n`
    ...
    `});return()=>o(g(s(u("Table Dense"),d(),l(Wi.map(p)))))},Ki=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function he(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Zi=[he("Frozen yoghurt",159,6,24,4),he("Ice cream sandwich",237,9,37,4.3),he("Eclair",262,16,24,6),he("Cupcake",305,3.7,67,4.3),he("Gingerbread",356,16,49,3.9)],Xi=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:r,table:s,thead:c,tbody:l,caption:u}=t.tags,p=({name:h,calories:f})=>r(i(h),i({class:n`
            text-align: right;
          `},f)),d=()=>c(r(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(g(s(u("Table Zebra"),d(),l(Zi.map(p)))))},qi=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Yi={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Fi,createComponent:Ui},{title:"Dense",description:"A dense table.",code:Ki,createComponent:Vi},{title:"Zebra",description:"A zebra table.",code:qi,createComponent:Xi}]},Ji=e=>{const t=H(e);return()=>t(Yi)},Qi=e=>{const{bau:t,css:n}=e,{h1:o,h2:a,h3:i,section:r,article:s}=t.tags,c=zt(e),l=s({id:"content",class:n`
        grid-area: content;
...
`,tc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:ec,createComponent:Qi}]},nc=e=>{const t=H(e);return()=>t(tc)};function In(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=ot(e),r=Z(e),s=Le(e),c=o`
  ...
  `,l=({label:h,icon:f,...x})=>r({"aria-label":h,title:h,...x},f),u=({count:h,totalCount:f,page:x,rowsPerPage:w})=>a({class:"pages-numbers"},Number(x-1)*Number(w)+(h>0?1:0),"-",Math.min(x*w,f)," of ",f),p=({count:h,page:f,rowsPerPage:x})=>a({class:"pages-numbers"},(f-1)*x+(h>0?1:0),"-",f*x),d=h=>h<=1,g=(h,f,x)=>h>=Math.ceil(f/x);return function(...f){let[{count:x=0,totalCount:w=0,page:v=1,rowsPerPage:S=50,onPageChange:I,isLoading:N=!1,disableFirst:P=()=>d(v),disablePrevious:A=()=>d(v),disableNext:$=()=>g(v,w,S),disableLast:D=()=>g(v,w,S),...R},...q]=F(f);const ee=Math.max(0,Math.ceil(w/S)),z=I({page:1}),W=I({page:v-1}),U=I({page:v+1}),y=I({page:ee}),m=[{label:"First",icon:"⟪",onclick:z,disabled:P()},{label:"Previous",icon:"⟨",onclick:W,disabled:A()},{label:"Next",icon:"⟩",onclick:U,disabled:$()},{label:"Last",icon:"⟫",onclick:y,disabled:D()}];return a({...R,class:T("table-pagination",c,N&&"disabled",t==null?void 0:t.class,R==null?void 0:R.class)},s({class:"spinner",visibility:N,size:"md"}),w>0?u({count:x,totalCount:w,page:v,maxPages:ee,rowsPerPage:S}):p({count:x,page:v,maxPages:ee,rowsPerPage:S}),i({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const oc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),ac=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:r,thead:s,tbody:c}=t.tags,l=oc(45),u=({name:v,email:S})=>i(a(v),a(S)),p=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),d=In(e),g=Ce(e,{class:n`
      max-width: 650px;
    `}),h=t.state(l),f=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),x=t.derive(()=>h.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),w=({page:v})=>S=>{f.val.page=v};return()=>g(r(p(),()=>c(x.val.map(u))),()=>d({...f.val,onPageChange:w}))},rc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:r,thead:s,tbody:c,div:l}=t.tags,u=t.state(!1),p=t.state([]),d=t.state(""),g=t.derive(()=>p.val.length),h=t.state(1),f=t.state(10),x=t.derive(()=>p.val),w=D=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(D).toString()}`,v=({page:D})=>R=>{h.val=D,S(w({page:D,per_page:f.val}))};S(w({page:1,per_page:f.val}));async function S(D){try{u.val=!0;const R=await fetch(D,{});if(R.ok){const q=await R.json();p.val=q;return}throw R}catch(R){d.val=R.message}finally{u.val=!1}}const I=({name:D,description:R,stargazers_count:q})=>i(a(D),a(R),a({class:n`
            text-align: right;
          `},q)),N=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),$=({message:D})=>l(D);return()=>A(()=>P({rowsPerPage:f.val,page:h.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:v,disableNext:()=>!1}),r(N(),()=>d.val&&$({message:d.val}),()=>c(x.val.map(I))))},sc=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:r,tr:s}=t.tags,c=ac(e),l=rc(e),u=(...p)=>a({class:n`
...
`,lc={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:cc,createComponent:ic}],gridItem:Dn},uc=e=>{const t=H(e);return()=>t(lc)},dc=()=>Q.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`,hc={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:mc,createComponent:pc},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:bc,createComponent:gc}],gridItem:Mn},fc=e=>{const t=H(e);return()=>t(hc)};function rt(e,t){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,r=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",color:p="neutral",variant:d="outline",size:g="md",...h},...f]=F(c);const x=i({class:T("container",...u.split("-"))},i({class:T("content",p,d,g),role:"tooltip"},l)),w=A=>`move-to-${A}`,v=(A,$,D)=>{if(A()){const R=w($);x.classList.add(R),x.classList.add($),x.classList.remove(D)}},S=(A,$)=>{const D=w(A);x.classList.contains(D)&&(x.classList.remove(D),x.classList.add($),x.classList.remove(A))},I=A=>{const $=x.getBoundingClientRect();v(()=>$.x<0,"right","left"),v(()=>$.x+$.width>a.innerWidth,"left","right"),v(()=>$.y<0,"bottom","top"),v(()=>$.bottom>a.innerHeight,"top","bottom"),x.classList.add("visible")},N=A=>{x.classList.remove("visible"),S("right","left"),S("left","right"),S("bottom","top"),S("top","bottom")};return i({...h,class:T("tooltip",r,t==null?void 0:t.class,h==null?void 0:h.class),bauMounted:({element:A})=>{A.addEventListener("mouseover",I),A.addEventListener("mouseout",N)},bauUnmounted:({element:A})=>{A.removeEventListener("mouseover",I),A.removeEventListener("mouseout",N)}},...f,x)}}const Nn=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,r=Z(e),s=rt(e),c=()=>o({class:n`
          font-size: larger;
        `},a("A ",i("tooltip")," can be any component"));return l=>s({titleEl:c(),...l},r(l,`${l.color} ${l.variant}`))},vc=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=Z(e),r=rt(e),s=()=>n(o("A ",a("tooltip")," can be any component"));return()=>r({side:"bottom-start",titleEl:s()},i("tooltip"))},xc=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
