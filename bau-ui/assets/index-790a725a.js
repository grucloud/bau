(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(r){if(r.ep)return;r.ep=!0;const a=n(r);fetch(r.href,a)}})();const Je=(e,t)=>({...e,paths:[...t,e.path]}),ke=({paths:e=[],routes:t})=>t.flatMap(({children:n,...o})=>{const r=Je(o,e);return n?[r,...ke({paths:[...e,o.path],routes:n})]:r}),Qe=({paths:e})=>{const t=e.map(n=>n instanceof RegExp?n.source:n).map(n=>String.raw`\/${n}`).join("");return new RegExp(`^${t}$`)},et=({routes:e=[],notFoundRoute:t})=>{const n=ke({routes:e}).map(o=>({...o,regex:Qe(o)}));return{resolve:({pathname:o})=>{const r=n.find(({regex:a})=>a.test(o));return r?r.action({match:o.match(r.regex)}):t}}};function tt({routes:e,notFoundRoute:t,onLocationChange:n}){const o=et({routes:e,notFoundRoute:t});return window.addEventListener("popstate",r=>{r.state!=null&&n({router:o})}),window.history.pushState=new Proxy(window.history.pushState,{apply:(r,a,s)=>{r.apply(a,s),n({router:o})}}),document.addEventListener("click",r=>{const{target:a}=r,s=a.getAttribute("href");a.tagName==="A"&&s&&!a.href.startsWith("http")&&!s.replace(window.localtion.pathname,"").startsWith("#")&&(history.pushState({},null,s),r.preventDefault())}),n({router:o}),o}const Ce=[["neutral",{h:"0%",s:"0%",l:"62%"}],["primary",{h:"230",s:"48%",l:"47%"}],["secondary",{h:"338",s:"100%",l:"48%"}],["success",{h:"120",s:"100%",l:"32%"}],["info",{h:"194",s:"80%",l:"62%"}],["warning",{h:"43",s:"100%",l:"50%"}],["danger",{h:"358",s:"95%",l:"60%"}]],at=[["light","1.15"],["lighter","1.3"],["lightest","1.5"]],nt=[["dark","0.9"],["darker","0.7"],["darkest","0.5"]],te=e=>`var(--color-${e}-darkest)`,ot=e=>`var(--color-${e}-lightest)`,rt=()=>Ce.map(([e])=>`
.plain.${e} {
...
`),Se=({dark:e})=>new Array(20).fill("").map((t,n)=>`--color-emphasis-${n*50}: var(--color-gray-${e?1e3-n*50:n*50});`).join(`
...
`);function it({createGlobalStyles:e},{colorPalette:t=Ce}={}){e`
:root {
  --color-scheme: light;
...
`}function ct(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let me=e=>Object.prototype.toString.call(e??0).slice(8,-1),dt=e=>me(e)=="Object",ve=e=>me(e)=="Function",se=e=>["Object","Array"].includes(me(e)),we=Object.getPrototypeOf,le=e=>Q(e)?e.val:e,Q=e=>e==null?void 0:e.__isState,ut=["splice","push","pop","shift","unshift","sort","reverse"],ae=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const U=e=>!Q(e[0])&&dt(e[0])?e:[{},...e];function mt(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,r=new Set,a=new Set,s=!1,l,i=f=>n.createElement(f),m=(f,y,k)=>{let C=l;l=y;let T=f(k);return l=C,T},d=()=>{o||(o=window.requestAnimationFrame(()=>{r.forEach(f=>{f.bindings=f.bindings.filter(y=>{var k;return(k=y.element)==null?void 0:k.isConnected}),!f.bindings.length&&!f.computed&&r.delete(f)}),o=void 0}))},c=(f,y,k,C,T,_)=>{var z;if(s){a.add(f);return}for(let X of f.bindings){let{deps:L,element:H,renderInferred:R,render:G,renderItem:V}=X;if(V&&y)(z=g(H,C,(...K)=>b(V(...K)),k,T,_)[y])==null||z.call();else{let K=R?R({element:H}):G({element:H,renderItem:V})(...L.map(le));K!==H&&H.replaceWith(X.element=b(K))}}E(f),d()},u=(f,y,k=[])=>({get(C,T,_){var z;if(l==null||l.add(f),T==="_isProxy")return!0;if(!((z=C[T])!=null&&z._isProxy)&&!Q(C[T])&&se(C[T]))C[T]=new Proxy(C[T],u(f,y,[...k,T]));else if(ut.includes(T)){let X=C[T];return(...L)=>{let H=X.apply(C,L);return c(f,T,H,L,y,k),H}}return Reflect.get(C,T,_)},set(C,T,_,z){let X=Reflect.set(C,T,_,z);return c(f,"setItem",X,{prop:T,value:_},y,[...k,T]),X}}),p=(f,y)=>new Proxy(y,u(f,y)),g=(f,y,k,C,T,_)=>{let z=()=>f.replaceChildren(...ae(C,k)),X=L=>f[L]&&f.removeChild(f[L]);return{assign:z,sort:z,reverse:z,setItem:()=>{var H;let L=_[0];(H=f.children[L])==null||H.replaceWith(k(T[L],L))},push:()=>f.append(...ae(y,(L,H)=>k(L,T.length+H))),unshift:()=>f.prepend(...ae(y,k)),pop:()=>X("lastChild"),shift:()=>X("firstChild"),splice:()=>{let[L,H,...R]=y;const{length:G}=f.children;for(let V=L>=0?Math.min(L+H-1,G-1):G-1;V>=(L>=0?L:G+L);V--)f.children[V].remove();if(R.length){let V=R.forEach((K,re)=>k(K,L+re));f.children[L]?f.children[L].after(...V):f.append(...V)}}}},h=f=>({oldVal:f,bindings:[],listeners:[],__isState:!0,get val(){let y=this;return l==null||l.add(y),y.valProxy??(y.valProxy=se(f)?p(y,f):f,y.valProxy)},set val(y){let k=this,C=k.val;se(y)?(k.valProxy=p(k,y),c(k,"assign",y)):y!==C&&(k.valProxy=y,c(k)),k.oldVal=C}}),b=f=>f==null||f===!1?i("span"):f.nodeType?f:n.createTextNode(f),v=(f,y)=>{let k=new Set;return y.val=m(f,k),k},w=f=>{let y=h(),k=v(f,y);y.computed=!0;for(let C of k)C.listeners.push({computed:f,deps:k,state:y});return y},E=f=>{for(let y of[...f.listeners])v(y.computed,y.state)},S=(f,...y)=>{if(y.length){let k=[];for(let C of y.flat(1/0))C!=null&&k.push(Q(C)?P({deps:[C],render:()=>T=>T}):ve(C)?B({renderInferred:C}):b(C));f.append(...k)}},I={},N=(f,y)=>f&&(Object.getOwnPropertyDescriptor(f,y)??N(we(f),y)),A=(f,y,k)=>{var C;return I[f+","+y]??(I[f+","+y]=((C=N(k,y))==null?void 0:C.set)??0)},D=(f,y)=>new MutationObserver((k,C)=>{k.filter(T=>T.removedNodes).forEach(T=>[...T.removedNodes].find(_=>_===f&&(y({element:f}),C.disconnect(),!0)))}).observe(f.parentNode,{childList:!0}),M=f=>new Proxy(function(k,...C){var X;let[T,..._]=U(C),z=f?n.createElementNS(f,k):i(k);for(let[L,H]of Object.entries(T)){if(L.startsWith("bau"))continue;let R=A(k,L,we(z))?G=>z[L]=G:G=>z.setAttribute(L,G);H==null||(Q(H)?P({deps:[H],render:()=>()=>(R(H.val),z)}):ve(H)&&(!L.startsWith("on")||H.isDerived)?B({renderInferred:()=>(R(H({element:z})),z)}):H.renderProp?P({deps:H.deps,render:()=>()=>(R(H.renderProp({element:z})(...H.deps.map(le))),z)}):R(H))}return S(z,..._),(X=T.bauCreated)==null||X.call(T,{element:z}),T.bauMounted&&t.requestAnimationFrame(()=>T.bauMounted({element:z})),T.bauUnmounted&&t.requestAnimationFrame(()=>D(z,T.bauUnmounted)),z},{get:(y,k)=>y.bind(void 0,k)}),O=(f,y,k)=>{f.element=b(k);for(let C of y)Q(C)&&(r.add(C),C.bindings.push(f));return f.element},B=({renderInferred:f,element:y})=>{let k=new Set,C=m(f,k,{element:y});return O({renderInferred:f},k,C)},P=({deps:f,element:y,render:k,renderItem:C})=>O({deps:f,render:k,renderItem:C},f,k({element:y,renderItem:C})(...f.map(le))),j=(f,y,k)=>P({deps:[f],render:({renderItem:C})=>T=>(y.append(...ae(T,C)),y),renderItem:k}),q=f=>{s=!0,f(),s=!1,a.forEach(c),a.clear()};return{tags:M(),tagsNS:M,state:h,bind:P,loop:j,derive:w,stateSet:r,batch:q}}const pt=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},ht=(e,t,n,o)=>{const r=e.createElement("style");r.id=n,r.append(o),(t??e.head).append(r)},bt=(e,t)=>e.reduce((n,o,r)=>n+o+(t[r]??""),"");function gt(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(r,...a)=>{const s=bt(r,a),l=pt(s);return!t.getElementById(l)&&ht(t,e==null?void 0:e.target,l,o(l,s)),l};return{css:n((o,r)=>`.${o} { ${r} }`),keyframes:n((o,r)=>`@keyframes ${o} { ${r} }`),createGlobalStyles:n((o,r)=>r)}}function ft({config:e}){const t=mt();return{bau:t,...gt(),tr:n=>n,window,states:{pathname:t.state(window.location.pathname.replace(e.base,""))},config:e}}function $(...e){return e.filter(t=>t).join(" ")}function Y(e,t){const{bau:n,css:o}=e,r={root:o`
    ...
    `};return function(...s){let[{color:l,variant:i="outline",size:m,disabled:d,href:c,...u},...p]=U(s);return(c?n.tags.a:n.tags.button)({...u,class:$(r.root,i,m,l,c?r.a:r.button,d&&r.disabled,t==null?void 0:t.class,u.class),disabled:d,href:c,...!c&&{type:"button"}},p)}}function vt(e){const{tr:t,bau:n,css:o,config:r}=e,{i:a,header:s,h1:l,div:i,a:m,img:d,b:c,ul:u,li:p}=n.tags,{svg:g,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),b=n.state(!0),v=Y(e),w=()=>a({class:o`
        ...
        `},v({"aria-label":"drawer",variant:"plain",color:"none",onclick:()=>b.val=!b.val},w()),m({href:`${r.base}/`,class:o`
          ...
          padding: 1rem;
        `,target:"_blank",href:"https://github.com/grucloud/bau"},d({alt:"GitHub",src:"./github-mark-white.svg",width:30,height:30}));return function(){return s({class:o`
          z-index: 2;
          position: sticky;
          top: 0;
          grid-area: header;
        ...
        `},r("version: 0.40.0"))}}function Ee(e,t={}){return function({parent:o,animationHide:r,animationShow:a},s){s.style.animation=a;const l=()=>{s.removeEventListener("animationend",l),s.style.animation=""};return s.addEventListener("animationend",l),new MutationObserver((i,m)=>{i.filter(d=>d.removedNodes).forEach(d=>[...d.removedNodes].find(c=>{o.style.position="relative";const u=c.cloneNode(!0);return u.style.top=0,u.style.left=0,u.style.position="absolute",u.style.animation=r,d.previousSibling?d.previousSibling.after(u):d.nextSibling?d.nextSibling.before(u):d.target&&d.target.appendChild(u),u.addEventListener("animationend",()=>u.parentNode.removeChild(u)),m.disconnect(),!0}))}).observe(o,{childList:!0,subtree:!0}),s}}const ye="0.3s",Te=({parent:e,grandParent:t})=>n=>{const{children:o,...r}=n,a=structuredClone(r);return a.children=o==null?void 0:o.map(Te({parent:n,grandParent:e})),e&&(e.parentTree=t),a.parentTree=e,a},$e=e=>t=>{var n;if(!e)return t;if(((n=t==null?void 0:t.data)==null?void 0:n.href)==e)return t.children?t:t.parentTree;if(t.children)for(let o=0;o<t.children.length;o++){const r=$e(e)(t.children[o]);if(r)return r}},yt=({createGlobalStyles:e,keyframes:t})=>(e`
:root {
...
`,{hideToLeft:t`
 ...
 `});function pe(e,t){const{bau:n,css:o,window:r}=e,{base:a=""}=t,s=({currentTree:B,data:P,onclickBack:j})=>b(E({href:`${a}${B.parentTree.children[0].data.href}`,onclick:j({currentTree:B}),class:o`
            min-width: 3rem;
          `},"←"),E({href:`${a}${P.href}`,class:o`
            flex-grow: 1;
            justify-content: flex-start;
          `},P.name)),l=({name:B,href:P})=>v({href:`${a}${P}`},B),i=({subTree:B})=>{var P;return r.location.pathname.replace(a,"")===((P=B==null?void 0:B.data)==null?void 0:P.href)},{renderHeader:m=s,renderMenuItem:d=l,isActive:c=i}=t,{ul:u,li:p,nav:g,div:h,header:b,a:v}=n.tags,w=Ee(),E=Y(e),{hideToLeft:S,hideToRight:I,showFromRight:N,showFromLeft:A}=yt(e),D=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & a,
  ...
  `,M=({variant:B,color:P,size:j,onclickItem:q,onclickBack:f,currentTree:y,pathnameState:k})=>{const{children:C,parentTree:T,data:_}=y;return console.log("Menu",y,k.val),h({class:$("drillDownMenu",B,P,j)},T&&m({data:_,currentTree:y,onclickBack:f}),C&&u(C.map(z=>p({class:()=>$(z.children&&"has-children",c({pathname:k.val,subTree:z})&&"is-active"),onclick:z.children&&q({currentTree:z})},d(z.data)))))},O=({tree:B,pathnameStateInitial:P})=>{let j=Te({})(B),q=$e(P)(j);return q||(q=j),q};return function(P){const{variant:j="plain",color:q="neutral",size:f,tree:y,pathnameState:k=n.state(r.location.pathname),...C}=P,T=k.val,_=({currentTree:H})=>R=>X(R,L,H,!0),z=({currentTree:H})=>R=>X(R,L,H.parentTree,!1),X=(H,R,G,V)=>{R.firstChild.replaceChildren(w({parent:R,animationHide:`${V?S:I} ${ye}`,animationShow:`${V?N:A} ${ye}`},M({variant:j,color:q,size:f,currentTree:G,onclickItem:_,onclickBack:z,pathnameState:k})))},L=g({class:$(D,t==null?void 0:t.class,C.class)},h(M({variant:j,color:q,size:f,currentTree:O({tree:y,pathnameStateInitial:T}),onclickItem:_,onclickBack:z,pathnameState:k})));return L}}const xt={data:{name:"Root"},children:[{data:{name:"Bau UI",href:"/"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tab",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function Ae(e){const{tr:t,bau:n,css:o,config:r,states:a}=e,{div:s,ul:l,li:i,nav:m,a:d,span:c}=n.tags,u=pe(e,{base:r.base});return function(){return s({class:o`
          grid-area: sidebar;
          position: sticky;
        ...
        `},u({tree:xt,pathnameState:a.pathname}))}}const kt=e=>{const{bau:t,css:n}=e,{div:o}=t.tags,r=vt(e),a=Ae(e),s=wt(e);return function({componentState:i}){return o({class:n`
          display: grid;
        ...
        `},r(),a(),()=>i.val&&i.val({}),s())}};function Ct(e){const{bau:t,css:n,config:o}=e,{div:r,h1:a,h2:s,p:l}=t.tags;Y(e);const i=n`
  ...
  `;return function(...b){let[{color:v,variant:w="outline",size:E,content:S,...I},...N]=U(b);const A=D=>{const{Header:M,Content:O,name:B}=D;return l({class:$(v,w,E),onclick:u(B)},m({class:()=>$(c.val==B&&"active")},d({type:"button","aria-controls":`bau-${B}`,"aria-expanded":({element:P})=>c.val==B},M(D))),a({class:"content",role:"region",id:`bau-${B}`,"data-state":({element:P})=>{const j=c.val==B;return p({element:P,open:j}),j}},O(D)))};return a({class:$("accordion",g,t==null?void 0:t.class,I.class)},s(r.map(A)))}}const Z=["neutral","primary","success","danger","warning"],Tt=["plain","outline","solid"],F=e=>{const{bau:t,css:n}=e,{div:o,table:r,tbody:a,tr:s,td:l,thead:i,th:m}=t.tags;return function({Item:c,name:u}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},r(i(s(m(u??"Variant/Color"),Z.map(p=>m(p)))),a(Tt.map(p=>s(m(p),Z.map((g,h)=>l(c({color:g,variant:p},{index:h}))))))))}},$t=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i}=n.tags,m=F(e),d=(...p)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...p),u=Ie(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>a(i("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>a(i("Item 2 Content"))},{name:"Item3",Header:()=>"Item 3",Content:()=>a(i("Item 3 content"))}]});return()=>r({id:"accordion"},l(t("Accordion")),s("Basic Accordion"),d(u({})),s("Accordion Table"),m({Item:p=>u({...p})}),s("Accordion width: fit-content"),d(u({color:"warning",class:o`
            &.accordion {
              & ul {
                & li {
                  width: fit-content;
          ...
          `})),s("Accordion icon cross"),d(u({color:"success",variant:"outline",class:o`
            &.accordion {
              & ul {
                & li {
                  & header {
...
`};function oe(e,t){const{bau:n,css:o,createGlobalStyles:r}=e,{div:a}=n.tags;It({css:o,createGlobalStyles:r});const s=o`
 ...
 `}),Nt=e=>{const{bau:t}=e,{section:n,div:o,h1:r}=t.tags,a=Ee(),s=Y(e),l=Pt(e);return function(){const i=t.state(!0),m=o(),d=c=>{m.replaceChildren(a({parent:m,animationHide:`${l.hideRight} 0.5s`,animationShow:`${l.showRight} 0.5s`},o(c.val?"Ciao":"")))};return d(i),n({id:"animate"},o(r("Test Animate"),o(s({onclick:()=>{i.val=!i.val,d(i)}},()=>i.val?"Hide":"Show")),m))}};function Me(e,t){const{bau:n}=e,{span:o,img:r}=n.tags,a=n.state(!0),s=n.state(!1),l=()=>a.val=!1,i=m=>{a.val=!1,s.val=!0};return function(...d){let[{color:c,variant:u="outline",size:p,width:g=60,height:h=60,...b},...v]=U(d);return o({class:$(t==null?void 0:t.class,b.class)},()=>a.val?"Loading...":"",()=>s.val&&"Error",r({width:g,height:h,onload:l,onerror:i,class:$(t==null?void 0:t.class,c,u,p,b.class),...b}))}}const zt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,h2:a,h3:s}=n.tags,l=o`
    > img {
      background: var(--color-gray-100);
      border-radius: 50%;
      margin: 0.3rem;
    }
  `,i=F(e),m=Me(e,{class:o`
      > img {
        background: var(--color-gray-100);
        border-radius: 50%;
        margin: 0.3rem;
  ...
  `,p=n.state(""),g=n.state(""),h=n.state(!1),b=n.state(0),v=()=>{h.val=!1};return function(...E){let[{variant:S="outline",color:I,size:N,id:A,label:D,placeholder:M,Option:O,options:B,getOptionLabel:P=({label:G})=>G,...j},...q]=U(E);const f=n.state(B),y=()=>{R.openDialog(),h.val=!0,g.val="",f.val=B},k=()=>{R.closeDialog(),h.val=!1,g.val=""},C=G=>{const{value:V}=G.target;g.val=V,V?f.val=B.filter(K=>P(K).match(new RegExp(`${V}`,"i"))):f.val=B},T=G=>{console.log("onclickButton",h.val),h.val?k():y()},_=G=>V=>{p.val=P(G),k()},z=G=>{switch(G.key){case"Escape":k();break;case"ArrowDown":b.val++;break;case"ArrowUp":b.val--;break;case"Enter":p.val=P(f.val[b.val]),g.val="",k();break}},X=d({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,onclick:T,class:$(S,I,N)},()=>!p.val&&n.tags.label(D),p),L=a({id:A,value:g,placeholder:M,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:C,onkeydown:z,class:$(S,I,N)}),R=c({id:A,triggerEl:X,contentEl:(()=>r({class:$(S,I,N,"content")},L,()=>s(f.val.map((G,V)=>l({class:()=>$(b.val==V&&"active"),onclick:_(G)},O(G))))))(),onClose:v});return r({...j,class:$("autocomplete",u,t==null?void 0:t.class,j==null?void 0:j.class)},X,R)}}const Lt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:i}=n.tags,m=(...g)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...g),d=F(e),c=Be(e),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],p=g=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,content:c,...u},...p]=U(l);return r({...u,class:$("badge",a,t==null?void 0:t.class,u==null?void 0:u.class)},r({class:$(i,m,d)},c),...p)}}const Ht=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s}=t.tags,l=(...c)=>r({class:n`
    ...
    `});return()=>o({id:"badge"},s("Badge"),a("Basic Badge"),l(m({content:"10"},"☏")),a("Badges Table"),i({Item:(c,{index:u})=>m({...c,content:`${u*100}`},"☏")}),a("Badge custom"),l(d({content:"1"},"☏")))};function De(e,t){const{bau:n,css:o}=e,{ul:r,li:a,a:s,span:l}=n.tags,i=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`).join(`
`);function Pe(e,t){const{bau:n,css:o}=e,{div:r}=n.tags,a=o`
    display: inline-flex;
    border-radius: var(--global-radius);
    & button {
      border-radius: 0;
...
`))()}
  ...
  `;return function(...l){let[{size:i,variant:m="outline",color:d="neutral",onclick:c,...u},...p]=U(l);return r({...u,onclick:c,class:$("chip",a,i,m,d,c&&"clickable",t==null?void 0:t.class,u==null?void 0:u.class)},...p)}}const Vt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l}=n.tags,i=F(e),m=(...c)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...c),d=Ne(e);return()=>r({id:"chip"},l(t("Chip")),s("Chip Default"),m(d("My Chip")),s("Chip Clickable"),m(d({color:"danger",onclick:()=>{alert("Clicked")}},"Chip")),s("Chip Table"),i({Item:c=>d({...c},`Chip ${c.color}`)}))};function ze(e,t={}){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,openState:c,...u},...p]=U(l);return r({class:$(a,t==null?void 0:t.class,u.class)},r({class:()=>$("overlay",c.val&&"overlay-open"),onclick:()=>{c.val=!1}}),r({class:()=>$("content",c.val&&"content-open")},p))}}const Xt=e=>{const{tr:t,bau:n}=e,{section:o,h2:r}=n.tags,a=n.state(!1),s=_t(e),l=Y(e),i=Ae(e);return()=>o({id:"drawer"},r(t("Drawer")),l({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),s({openState:a},i()))},Wt=e=>{const{tr:t,bau:n,window:o,config:r}=e,{section:a,h2:s,h3:l}=n.tags,i=n.state(o.location.pathname.replace(r.base,"")),m=F(e),d={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},c=pe(e,{base:r.base+"/components/drillDownMenu"});return()=>a({id:"drillDownMenu"},s(t("Drill Down Menu")),c({tree:d,pathnameState:i}),l("Drill Down Table"),m({Item:u=>c({tree:d,...u})}))};function Le(e,t){const{bau:n,css:o}=e,{div:r,span:a,label:s,input:l}=n.tags,i={base:o`
...
`).join(`
`);function He(e,t){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
    display: inline-block;
    font-size: large;
    padding: 1rem;
    height: 2.5rem;
...
`))()}
  ...
  `,d=n.state(""),c=n.state(!1),u=n.state(0);return function(...g){let[{color:h="neutral",variant:b="outline",size:v,id:w,label:E,Option:S,options:I,getOptionLabel:N=({label:C})=>C,...A},...D]=U(g);const M=()=>{k.openDialog(),c.val=!0},O=()=>{k.closeDialog(),c.val=!1},B=()=>{c.val=!1},P=C=>{c.val?O():M()},j=C=>T=>{d.val=N(C),O()},q=C=>{switch(C.preventDefault(),C.key){case"Escape":O();break;case"ArrowDown":u.val<I.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=I.length-1:u.val--;break;case"Enter":c.val?(d.val=N(I[u.val]),O()):M();break}},f=()=>a(I.map((C,T)=>s({class:()=>$(u.val==T&&"active"),onclick:j(C)},S(C)))),y=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":c,onclick:P,class:$(h,b,v)},()=>!d.val&&n.tags.label(E),d),k=i({id:w,triggerEl:y,contentEl:f(),onClose:B});return r({...A,class:$("select",m,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:q},y,k)}}const Qt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:i}=n.tags,m=(...g)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...g),d=F(e),c=je(e),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],p=g=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
  ...
  `;return function(...i){let[{color:m="neutral",variant:d="outline",size:c,...u},...p]=U(i);return r({...u,type:"range",class:$("slider",m,d,c,s,t==null?void 0:t.class,u.class)},...p)}}const ea=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i,label:m,datalist:d,option:c,br:u}=n.tags,p=n.state(0),g=S=>{p.val=S==null?void 0:S.target.value},h=(...S)=>a({class:o`
        ...
        `},...S),b=F(e),v=ne(e),w=ne(e),E=ne(e);return()=>r({id:"slider"},l(t("Slider")),i("Slider value: ",p),s("Basic Slider"),h(v({oninput:g,name:"slider-simple"})),s(t("Slider Table")),b({Item:S=>v(S)}),s("Slider Min Max: -1000 1000"),h(w({oninput:g,min:-1e3,max:1e3})),s("Slider Step 20"),h(v({oninput:g,step:20,min:-100,max:100})),s("Slider Vertical"),h(a({class:o`
          ...
          `,id:"temp",name:"temp",list:"markers"}),d({id:"markers",class:o`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(S=>c({value:Number(S),label:S})))))},xe={sm:16,md:32,lg:64};function be(e,t={}){const{bau:n,css:o}=e,{svg:r,animate:a,animateTransform:s,rect:l}=n.tagsNS("http://www.w3.org/2000/svg");return function({size:m="md",color:d="color-base",variant:c="outline",visibility:u=!0,...p}={}){return r({class:$(o`
            visibility: ${u?"visible":"hidden"};
            color: var(--color-${d});
          `,t.class,p.class),version:"1.1",id:"L6",x:"0px",y:"0px",width:xe[m],height:xe[m],viewBox:"0 0 100 100",enableBackground:"new 0 0 100 100"},l({fill:"none",stroke:"currentColor",strokeWidth:"4",x:"25",y:"25",width:"50",height:"50"},s({attributeName:"transform",dur:"0.4s",from:"0 50 50",to:"180 50 50",type:"rotate",id:"strokeBox",attributeType:"XML",begin:"rectBox.end"})),l({x:"27",y:"27",fill:"currentColor",width:"46",height:"50"},a({attributeName:"height",dur:"1.3s",attributeType:"XML",from:"50",to:"0",id:"rectBox",fill:"freeze",begin:"0s;strokeBox.end"})))}}const ta=e=>{const{tr:t,bau:n}=e,{section:o,h2:r,h3:a}=n.tags,s=F(e),l=be(e);return()=>o({id:"spinner"},r(t("Spinner Examples")),a(t("Spinner Table")),s({Item:i=>l(i)}))},aa=()=>Z.map(e=>`
&.switch.plain.${e} {
  &::after {
    background-color: var(--color-emphasis-100);
  }
...
`);function Ge(e,t){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
  ...
  `;return function(...l){let[{color:i="neutral",variant:m="plain",size:d,...c},...u]=U(l);return r({...c,class:$("switch",a,i,m,d,t==null?void 0:t.class,c.class),type:"checkbox",required:"required"},...u)}}const na=e=>{const{tr:t,bau:n,css:o}=e,{section:r,form:a,label:s,div:l,h2:i}=n.tags,m=F(e),d=Ge(e);return()=>r({id:"switch"},i(t("Switch Examples")),a(l({class:o`
    ...
    `};return function(...p){let[{color:g,variant:h="plain",size:b,...v},...w]=U(p);const E=I=>{const{Header:N,disabled:A,name:D}=I;return l({class:()=>$(m.val.name==D&&"active",A&&"disabled"),onclick:M=>M.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:D},bubbles:!0}))},N(I))},S=a({class:$(c.base,h,b,g,t==null?void 0:t.class,v.class)},n.loop(i,s(),E),()=>m.val.Content?m.val.Content({}):"");return S.addEventListener("tab.select",I=>{var D,M;const{tabName:N}=I.detail,A=d(N);A&&((D=m.val.exit)==null||D.call(),m.val=A,(M=A.enter)==null||M.call())},!1),S.addEventListener("tab.add",I=>{var A;const{tab:N}=I.detail;(A=N.enter)==null||A.call(),i.val.push(N)},!1),S.addEventListener("tab.remove",I=>{var A;const N=i.val.findIndex(D=>D.name==I.detail.tabName);N>0&&((A=i.val[N].exit)==null||A.call(),i.val.splice(N,1))},!1),S}}const oa=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i,i:m}=n.tags,d=F(e),c=Y(e),u=(...w)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...w),p=()=>({name:"New Tab",Header:({name:w})=>a(w),Content:()=>a("My Paragraph")}),h=de(e,{tabDefs:[{name:"Tab1",Header:()=>a("TAB"),Content:()=>a(i("My Tab 1 Content"))},{name:"Tab2",Header:()=>a("TAB 2"),Content:()=>a(i("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>a("Tab Disabled"),Content:()=>a(i("My tab Disabled"))}]}),v=de(e,{tabDefs:[{name:"Tab1",Header:()=>a(m({class:o`
          ...
          `})),s("Add and remove tabs"),u(v({})),l(t("Tabs Table")),d({Item:w=>h(w)}))};function J(e,t){const{bau:n,css:o,createGlobalStyles:r}=e,{div:a}=n.tags;r`
  :root {
  ...
  `,i=({label:p,icon:g,...h})=>a({variant:"plain","aria-label":p,title:p,...h},g),m=({count:p,totalCount:g,page:h,rowsPerPage:b})=>r({class:"pages-numbers"},Number(h-1)*Number(b)+(p>0?1:0),"-",Math.min(h*b,g)," of ",g),d=({count:p,page:g,rowsPerPage:h})=>r({class:"pages-numbers"},(g-1)*h+(p>0?1:0),"-",g*h),c=p=>p<=1,u=(p,g,h)=>p>=Math.ceil(g/h);return function(...g){let[{count:h=0,totalCount:b=0,page:v=1,rowsPerPage:w=50,onPageChange:E,isLoading:S=!1,disableFirst:I=()=>c(v),disablePrevious:N=()=>c(v),disableNext:A=()=>u(v,b,w),disableLast:D=()=>u(v,b,w),...M},...O]=U(g);const B=Math.max(0,Math.ceil(b/w)),P=E({page:1}),j=E({page:v-1}),q=E({page:v+1}),f=E({page:B});return r({...M,class:$("table-pagination",l,S&&"disabled",t==null?void 0:t.class,M==null?void 0:M.class)},s({class:"spinner",visibility:S,size:"md"}),b>0?m({count:h,totalCount:b,page:v,maxPages:B,rowsPerPage:w}):d({count:h,page:v,maxPages:B,rowsPerPage:w}),r(i({label:"First",icon:"⟪",onclick:P,disabled:I()}),i({label:"Previous",icon:"⟨",onclick:j,disabled:N()}),i({label:"Next",icon:"⟩",onclick:q,disabled:A()}),i({label:"Last",icon:"⟫",onclick:f,disabled:D()})))}}const sa=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.col"})),la=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:i}=t.tags,m=sa(45),d=({name:w,email:E})=>a(r(w),r(E)),c=()=>l(o({class:n`
    ...
    `}),g=t.state(m),h=t.state({count:m.length,totalCount:m.length,page:1,rowsPerPage:10}),b=t.derive(()=>g.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),v=({page:w})=>E=>{h.val.page=w};return()=>p(s(c(),()=>i(b.val.map(d))),()=>u({...h.val,onPageChange:v}))},ia=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:i,div:m}=t.tags,d=t.state(!1),c=t.state([]),u=t.state(""),p=t.derive(()=>c.val.length),g=t.state(1),h=t.state(10),b=t.derive(()=>c.val),v=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,w=({page:M})=>O=>{g.val=M,E(v({page:M,per_page:h.val}))};E(v({page:1,per_page:h.val}));async function E(M){try{d.val=!0;const O=await fetch(M,{});if(O.ok){const B=await O.json();c.val=B;return}throw O}catch(O){u.val=O.message}finally{d.val=!1}}const S=({name:M,description:O,stargazers_count:B})=>a(r(M),r(O),r({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),N=Fe(e),A=J(e,{class:n`
      min-width: 650px;
    `}),D=({message:M})=>m(M);return()=>A(()=>N({rowsPerPage:h.val,page:g.val,count:p.val,totalCount:-1,isLoading:d.val,onPageChange:w,disableNext:()=>!1}),s(I(),()=>u.val&&D({message:u.val}),()=>i(b.val.map(S))))},ca=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s,tr:l}=t.tags,i=la(e),m=ia(e),d=(...c)=>r({class:n`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
          & .table-container {
            width: 100%;
    ...
    `}),p=()=>a({class:o`
        ...
        `},c({side:"bottom-start",titleEl:p()},d({},"bottom start")),c({side:"bottom-centered",titleEl:p()},d({},"bottom centered")),c({side:"bottom-end",titleEl:p()},d({},"bottom end")))];return()=>r({id:"tooltip"},s(t("Tooltip")),a({class:o`
          ...
          `},g()),s(t("Tooltip custom")),a({class:o`
            ...
            flex-direction: column;
            gap: 1rem;
          `},u({titleEl:p()},d({},"custom tooltip"))),s(t("Tooltip Table")),m({Item:h=>c({titleEl:p(),...h},d({},`${h.color} ${h.variant}`))}))},ua="light";function Re(e,t){const{bau:n,css:o,window:r}=e,{input:a}=n.tags,s=d=>{r.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},l=()=>{try{return localStorage.getItem("theme")}catch{}},i=l();i?s(i):r.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):r.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(ua);const m=o`
    position: relative;
    width: 2rem;
    height: 2rem;
    display: flex;
...
`,{nav:e`
  ...
  `,expanded:e`
    ...
    `});function Ve(e,t){const{bau:n,css:o,createGlobalStyles:r,window:a}=e,{renderMenuItem:s}=t,{ul:l,li:i,nav:m,div:d}=n.tags,c=pa({css:o,createGlobalStyles:r}),u=({element:b,closeState:v})=>{b.scrollHeight!=0&&(v.val?p(b):g(b))};function p(b){b.style.height=b.scrollHeight+"px";const v=()=>{b.removeEventListener("transitionend",v)};b.addEventListener("transitionend",v),a.requestAnimationFrame(()=>{b.style.height="0px"})}function g(b){const v=()=>{b.removeEventListener("transitionend",v),b.style.height=null};b.addEventListener("transitionend",v),b.style.height=b.scrollHeight+"px"}const h=({depth:b=1,maxDepth:v})=>w=>{const{children:E,expanded:S}=w,I=n.state(!S);return i({class:()=>$(E?I.val?c.collapsed:c.expanded:"")},d({class:o`
        ...
        `},a({class:o`
          ...
          `},s(t("Pages Examples")),ga(e)()))}}const va=e=>{const{bau:t,css:n,config:o}=e,{section:r,div:a,h1:s,span:l,p:i,ul:m,li:d,a:c,main:u,header:p,footer:g}=t.tags,{svg:h,use:b}=t.tagsNS("http://www.w3.org/2000/svg"),v=F(e),E=Ie(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>a(i("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>a(i("Item 2 Content"))},{name:"Item3",Header:()=>"Item 3",Content:()=>a(i("Item 3 content"))}]}),S=oe(e),I=Be(e),N=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],A=x=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},l(x.label),l(x.code)),D=Me(e,{class:n`
      > img {
        background: var(--color-gray-100);
        border-radius: 50%;
        margin: 0.3rem;
      }
    `}),M=ie(e),O={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},B=De(e),P=Y(e),j=Pe(e),q=ce(e),f=ze(e),y=Ne(e),k={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#m1"},children:[{data:{name:"Sub Menu 1",href:"#menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu2"}}]},C=pe(e,{base:o.base+"/components"}),T=({disabled:x})=>a({class:$(n`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
          ...
          `,x&&n`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},h({width:100,height:100,fill:"currentColor"},b({href:"uploadIcon.svg#Capa_1"})),l("Choose a file to upload")),_=Le(e),z=He(e),X=Oe(e),L=()=>u(Array(10).fill("").map((x,W)=>i(W+1,". Some text here"))),H=x=>{const W=X({id:"my-dialog",...x},p("Header"),L(),g(P({variant:"outline",onclick:()=>{W.close()}},"Cancel"),P({variant:"solid",onclick:()=>{W.close()}},"OK")));return W},R=je(e),G=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],V=x=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},l(x.label),l(x.code)),K=ne(e),re=be(e),ge=Ge(e),_e=de(e,{tabDefs:[{name:"Tab1",Header:()=>a("TAB"),Content:()=>a(i("My Tab 1 Content"))},{name:"Tab2",Header:()=>a("TAB 2"),Content:()=>a(i("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>a("Tab Disabled"),Content:()=>a(i("My tab Disabled"))}]}),Xe=Re(e),We=()=>l("My tooltip"),qe=ue(e),Ye={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},Ke=Ve(e,{renderMenuItem:({name:x,href:W})=>c({href:W,onclick:Ze=>{Ze.preventDefault()}},x)}),fe=[{name:"Accordion",Item:x=>E({...x})},{name:"Alert",Item:x=>S({...x},`Alert ${x.color}`)},{name:"Autocomplete",Item:x=>I({...x,options:N,Option:A,getOptionLabel:({label:W})=>W,label:"Country",placeholder:"Search countries",id:"country"})},{name:"Avatar",Item:x=>D({...x,src:"./grucloud.svg",alt:"GruCloud"})},{name:"Badge",Item:(x,{index:W})=>M({...x,content:`${W*100}`},"☏")},{name:"Breadcrumbs",Item:x=>B({...x,...O})},{name:"Button",Item:x=>P({...x},`${x.variant} ${x.color}`)},{name:"Button Group",Item:x=>j({...x},P({},"ONE"),P({},"TWO"),P({},"THREE"))},{name:"Calendar",Item:x=>q({...x})},{name:"Checkbox",Item:(x,{index:W})=>f({id:`myCheckbox-${W}`,name:`myCheckbox-${W}`,...x})},{name:"Chip",Item:x=>y({...x},`Chip ${x.color}`)},{name:"DrillDown Menu",Item:x=>C({tree:k,...x})},{name:"File Input",Item:x=>_({Component:T,name:"file",accept:"text/*",onchange,...x})},{name:"Input",Item:x=>z({name:"my-input",id:"my-input-with",placeholder:"Enter text",...x})},{name:"Modal",Item:x=>{const W=H(x);return a(P({...x,onclick:()=>{W.showModal()}},"OPEN MODAL"),W)}},{name:"Select",Item:x=>a(R({...x,options:G,Option:V,getOptionLabel:({label:W})=>W,label:"Select a country..."}))},{name:"Slider",Item:x=>K(x)},{name:"Spinner",Item:x=>re(x)},{name:"Switch",Item:x=>a(ge({...x,id:"my-switch"}),ge({...x,id:"my-switch-checked",checked:!0}))},{name:"Tabs",Item:x=>_e(x)},{name:"Theme Switch",Item:x=>Xe(x)},{name:"Tooltip",Item:x=>qe({titleEl:We(),...x},P({},`${x.color} ${x.variant}`))},{name:"Tree View",Item:x=>Ke({...x,tree:Ye})}];return()=>r(s("Bau Component Gallery"),i("This page displays the components with various colors and variants."),m({class:n`
            display: inline-flex;
            flex-wrap: wrap;
            gap: 1rem;
            list-style: none;
            padding: 0;
          `},fe.map(({name:x})=>d(y({color:"primary"},c({href:`#${x}`},x))))),fe.map(x=>a({id:x.name,class:n`
  ...
  `};ct();const Ue={title:"Bau",base:"/bau/bau-ui"},ee=ft({config:Ue});ka(ee);Ca(ee);tt({routes:wa({context:ee}),onLocationChange:xa({context:ee,LayoutDefault:kt(ee),config:Ue}),notFoundRoute:ya(ee)});
