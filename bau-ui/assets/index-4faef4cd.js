...
`);function X(e,t={}){const{bau:n,css:o}=e,a=o`
    ...
    ${So()}
  `;return function(...s){let[{size:r=t.size??"md",variant:c=t.variant??"none",color:l=t.color??"none",href:u,...p},...d]=Z(s);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...p,class:D("button",t.class,c,r,l,a,p.class),href:u},d)}}const Co="light",Eo=()=>oe.map(e=>`
...
`);function st(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Co);const l=o`
    ...
    `}),w=st(e),k=()=>s(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),A=()=>l({class:o`
        ...
        `},u({class:n`
          ...
          `},d({title:"Bau UI",links:b}),d({title:"Bau Ecosystem",links:g})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},i("v0.63.0"),i("MIT license")))}}function be(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,N=({children:z,pathnameState:S,variant:m,color:v,size:C})=>B({class:D(m,v,C)},z.map(E=>f({class:()=>D(E.children&&"has-children",h({pathname:S.val,subTree:E})&&"active")},g({variant:m,color:v,size:C,subTree:E})))),R=({variant:z,color:S,size:m,currentTree:v,pathnameState:C})=>{const{children:E,parentTree:H,data:L,renderList:G}=v;return y({class:D("drillDownMenu",z,S,m)},H&&b({variant:z,color:S,size:m,data:L,currentTree:v}),E&&G?G({renderListDefault:N,children:E,pathnameState:C,variant:z,color:S,size:m}):N({children:E,pathnameState:C,variant:z,color:S,size:m}))},j=({tree:z,pathname:S})=>{let m=Lt({})({...z}),v=zt(S)(m);return v||(v=m),v},U=n.state(a.location.pathname.replace(c,""));return a.document.addEventListener("click",z=>{const{target:S}=z,m=S.getAttribute("href");if(S.tagName==="A"&&m&&!m.startsWith("http")&&!m.startsWith("#")&&!m.startsWith("?")){let v=m.replace(c,"");r||(v=v.replace(S.hash,"")),U.val=v}}),function(S){const{size:m=t.size??"md",variant:v=t.variant??"plain",color:C=t.color??"neutral",tree:E,...H}=S;let L;n.derive(()=>(L=j({tree:E,pathname:U.val}),L));let G=n.state(0);const W=ee=>{const{dataset:K}=ee.target;K.buttonback=="true"?G.val=-1:K.ischild=="false"?G.val=1:K.ischild=="true"},$=ee=>{switch(ee.val){case 1:return`${M} ${Ue}`;case-1:return`${P} ${Ue}`;default:return""}},J=ee=>{switch(ee.val){case 1:return`${P} ${Ue} reverse`;case-1:return`${M} ${Ue} reverse`;default:return""}};return x({class:D(O,v,C,m,t==null?void 0:t.class,H.class),onclick:W},A({animationHide:()=>$(G),animationShow:()=>J(G)},n.bind({deps:[G],render:()=>()=>R({variant:v,color:C,size:m,currentTree:L,pathnameState:U})})))}}const Do=()=>oe.map(e=>`
&.input.${e} {
...
`);function ue(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:p,...d},...b]=Z(r);return a({...d,onclick:p,class:D("chip",t.class,c,l,u,p&&"clickable",i,d.class)},...b)}}function Io(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;X(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function $o({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,p=({maxSize:d=151})=>({libName:b,size:g})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},b.map(p({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Bo(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=Io(e),l=No(e),u=X(e);Ie(e);const p=$o(e),d=(...x)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `,b=({value:f,id:x,children:y=[]})=>{const w=c({class:()=>u.val==x?"active":"",href:`#${x}`});return w.innerHTML=f,r({class:()=>u.val==x?"active":""},w,y.length>0&&s(y.map(b)))},g=f=>f.tagName.charAt(1),h=({contentEl:f})=>{const x=f.querySelectorAll(l);let y=2,w={},k={children:[]},A=k;const B=A;let T=[A];return[...x].forEach(M=>{const P=g(M);M.setAttribute("id",M.textContent),!M.innerHTML.includes("<button")&&(w={value:M.innerHTML,id:M.id??M.textContent,children:[]},y==P?(k=w,A.children.push(k)):y<P?(T.push(A),A=k,k.children.push(w),k=w):y>P&&(A=T[P-1],T=T.slice(0,P-1),A.children.push(w),k=w),y=P)}),B};return function(...x){let[{size:y=t.size??"md",variant:w=t.variant??"plain",color:k=t.color??"neutral",contentEl:A,...B}]=Z(x);const T=h({contentEl:A}),M=p(()=>{const O=[...A.querySelectorAll(l)].find(N=>{const{top:R,height:j}=N.getBoundingClientRect();if(R+j>60)return!0});O&&(u.val=O==null?void 0:O.id)},100);return i({...B,class:D("tableOfContent",y,w,k,d,t==null?void 0:t.class,B==null?void 0:B.class),bauMounted:()=>{a.addEventListener("scroll",M)},bauUnmounted:()=>{a.removeEventListener("scroll",M)}},T.children&&s(T.children.map(b)))}}const nn=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:p,name:d}){return o({class:n`
        ...
        `},a(c(s(l(d??""),oe.map(b=>l(b)))),i(yo.map(b=>s(l(b),oe.map((g,h)=>r(p({color:g,variant:b},{index:h}))))))))}},_a=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:i}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},wo.map((s,r)=>i(e,{size:s})({color:"success",variant:"outline"},{size:s,index:r})))}},F=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:i,h1:s,p:r,h2:c,h3:l,pre:u,code:p}=t.tags;Te.registerLanguage("javascript",en);const d=tn(e),b=Ne(e,{class:n`
      &.paper {
...
`,Wa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:Ha,createComponent:ja},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Ga,createComponent:Ua},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Va,createComponent:Fa}],gridItem:on},Xa=e=>{const t=F(e);return()=>t(Wa)},Za={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Ka=()=>oe.map(e=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`);function $e(e,t={}){const{bau:n,css:o}=e,{div:a,i}=n.tags,s=o`
    ...
    ${Ka()}
  `,r=X(e),c=({onclick:l})=>r({"aria-label":"Close",onclick:l,class:"button-close"},"✖");return function(...u){let[{size:p=t.size??"md",variant:d=t.variant??"outline",color:b=t.color??"neutral",onRemove:g,...h},...f]=Z(u);return a({...h,class:D("alert",`alert-${d}`,t.class,d,b,p,s,h.class),role:"alert"},i({class:"icon"},Za[b]),a({class:"content"},...f),g&&c({onclick:g}))}}const rn=(e,t)=>{const n=$e(e,t);return o=>n({...o},`Alert ${(t==null?void 0:t.size)??""} `)},qa=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=$e(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},Ja=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,er={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ja,createComponent:qa},{title:"Custom Alert ",description:"A custom alert.",code:Qa,createComponent:Ya}],gridItem:rn},tr=e=>{const t=F(e);return()=>t(er)},nr=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
...
`,rr={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:ar,createComponent:or}]},sr=e=>{const t=F(e);return()=>t(rr)},ir=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=We(e),s=X(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`,dr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:cr,createComponent:ir},{title:"Component hide and show",description:"Hide and show a component",code:ur,createComponent:lr}]},pr=e=>{const t=F(e);return()=>t(dr)};function Se(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",...b},...g]=Z(l);return i({...b,class:D("skeleton",u,r,t==null?void 0:t.class,b==null?void 0:b.class)},...g)}}function gt(e,t={}){const{bau:n,css:o}=e,{div:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...d){let[{size:b=t.size??"md",variant:g=t.variant??"plain",color:h=t.color??"neutral",width:f=40,height:x=40,alt:y,...w},...k]=Z(d);const A=Se(e,{class:D(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${x}px;
...
`,fr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:gr,createComponent:mr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:hr,createComponent:br}],gridItem:sn},vr=e=>{const t=F(e);return()=>t(fr)};function Be(e,t){const{bau:n,css:o,window:a}=e,{dialog:i}=n.tags,s=Ne(e,{class:o`
      &.paper {
        padding: 0;
      }
    `}),r=o`
...
`);function Ke(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${yr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",label:d,placeholder:b,Option:g,options:h,defaultOption:f,getOptionLabel:x,getOptionValue:y,onSelect:w=()=>{},id:k,required:A,name:B,loading:T,...M},...P]=Z(c);const O=Be(e),N=X(e),R=ue(e,{variant:u,color:p,size:l}),j=be(e),U=fe(e,{variant:u,color:p,size:l}),z=n.state(f),S=n.state(M.value),m=n.state(!1),v=n.state(0),C=()=>{m.val=!1},E=n.state(h),H=Y=>ae=>Y.val&&x(ae)==x(Y.val),L=()=>{ce.openDialog(),m.val=!0,S.val="",E.val=h,v.val=h.findIndex(H(z));const Y=Ee.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),ve.scrollIntoView({block:"end"}))},G=()=>{ce.closeDialog(),m.val=!1,v.val=0},W=Y=>{const{value:ae}=Y.target;S.val=ae,ae?E.val=h.filter(Re=>x(Re).match(new RegExp(`${ae}`,"i"))):E.val=h},$=Y=>{ce.open?G():L()},J=Y=>{z.val=Y,Ce.value=y(Y)},ee=({option:Y,index:ae})=>Re=>{J(Y),v.val=ae,G()},K=()=>{const Y=Ee.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},ne=Y=>{switch(Y.key){case"Escape":G();break;case"ArrowDown":v.val<E.val.length-1?v.val++:v.val=0,K();break;case"ArrowUp":v.val<=0?v.val=E.val.length-1:v.val--,K();break;case"Enter":ce.open?(J(E.val[v.val]),G()):L(),Y.preventDefault();break}},ie=N({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":m,"aria-label":d,onclick:$,variant:u,color:p,size:l,class:T==!0&&"loading",disabled:T},()=>z.val?x(z.val):d,()=>T==!0&&U({visibility:T})),ve=R({value:S,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":m,oninput:W,onkeydown:ne,...M}),Ce=R({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:f&&y(f),required:A,name:B}),Ee=a({class:D(u,p,l,"content")},ve,()=>j({class:D(u,p,l)},E.val.map((Y,ae)=>i({class:()=>D(v.val==ae&&"active",H(z)(Y)&&"selected"),onclick:ee({option:Y,index:ae})},g(Y))))),ce=O({id:k,triggerEl:ie,contentEl:Ee,onClose:C,class:o`
        overflow: hidden;
...
`,Tr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Sr,createComponent:wr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Ar,createComponent:kr},{title:"Default Option",description:"A autocomplete with a default option.",code:Er,createComponent:Cr}],gridItem:cn},Dr=e=>{const t=F(e);return()=>t(Tr)};function ln(e,t={}){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`);function ht(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${Vr()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=Z(r);return a({...p,class:D("button-group",l,u,c,i,t==null?void 0:t.class,p==null?void 0:p.class)},...d)}}const mn=(e,t)=>{const n=["ONE","TWO","THREE"],o=X(e,t),a=ht(e,t);return i=>a({...i},n.map(s=>o(i,s)))},Wr=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=X(e),i=ht(e),s="primary",r="solid";return()=>n(i({color:s,variant:r},o.map(c=>a({color:s,variant:r},c))))},Xr=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Yr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Jr,createComponent:qr}],gridItem:bn},Qr=e=>{const t=F(e);return()=>t(Yr)};function es(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:p=t.color??"neutral",slides:d,Slide:b,Previous:g,Next:h,...f}]=Z(c);const x=()=>{s.val<=0?s.val=d.length-1:s.val--},y=()=>{s.val>=d.length-1?s.val=0:s.val++},w=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},d.map(b));return a({...f,class:D("carousel",l,i,t==null?void 0:t.class,f==null?void 0:f.class)},a({class:D("control","control-previous"),onclick:x},g()),a({class:D("control","control-next"),onclick:y},h()),w)}}const ts=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ns=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=X(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,cs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:is,createComponent:ss}],gridItem:hn},ls=e=>{const t=F(e);return()=>t(cs)};function qe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    margin: 0.5rem;
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=Z(r);return a({type:"checkbox",...p,class:D(i,u,l,c,t==null?void 0:t.class,p==null?void 0:p.class)})}}const fn=(e,t)=>{const{bau:n,css:o}=e,{label:a}=n.tags,i=qe(e,t);return s=>a({class:o`
          display: flex;
...
`,ps=e=>{const{bau:t,css:n}=e,{label:o,form:a}=t.tags,i=qe(e,{color:"neutral",variant:"outline"}),s=X(e),r=c=>{c.preventDefault();const l=Object.fromEntries(new FormData(c.target.closest("form")));alert(JSON.stringify(l))};return()=>a({onsubmit:r,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & label {
...
`,vs={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:fs,createComponent:hs}]},xs=e=>{const t=F(e);return()=>t(vs)};function ys(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    display: flex;
    align-items: center;
    .content {
      margin: 1rem;
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=Z(r);return a({...p,class:D("divider",c,i,t==null?void 0:t.class,p==null?void 0:p.class)},a({class:"content"},...d))}}const ws=e=>{const{bau:t}=e,{section:n}=t.tags,o=ys(e);return()=>n(o("OR"))},Ss=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Us={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Hs,createComponent:js}],gridItem:wn},Gs=e=>{const t=F(e);return()=>t(Us)};function Oe(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:p,...d},...b]=Z(r);return a({...d,class:D("form",u,l,c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...b)}}function ft(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",loading:b,...g},...h]=Z(l);const f=X(e),x=fe(e);return n.bind({deps:[b],render:()=>y=>f({...g,class:D("loadingButton",u,p,d,r,y&&"loading",t==null?void 0:t.class,g==null?void 0:g.class)},x({size:u,variant:p,color:d,visibility:y}),i({class:y&&"loading"},h))})}}const Fs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=ft(e),p=$e(e,{variant:"outline",color:"danger"}),d=ue(e),b=Oe(e,{class:n`
      & > header {
        text-align: center;
      }
      & > footer {
...
`,qs={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Simple form",description:"A simple form.",code:Xs,createComponent:Ws},{title:"Form with state",description:"A form with input state and a dervied state.",code:Ks,createComponent:Zs},{title:"Login page",description:"A login page.",code:Vs,createComponent:Fs}]},Js=e=>{const t=F(e);return()=>t(qs)},Sn=(e,t={})=>{const n=ue(e,t);return o=>n({name:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,placeholder:"Enter text",...o})},Ys=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=ue(e);return()=>n(o("Basic input"),a({id:"my-input",name:"my-input",placeholder:"Enter Text"}),o("Disabled input"),a({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))},Qs=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,ai={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:oi,createComponent:ni}],gridItem:Cn},ri=e=>{const t=F(e);return()=>t(ai)};function En(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=()=>oe.map(l=>`
&.${l}{
...
`),r=a`
  ...
  `,c=o`
    ...
    ${s()}
  `;return function(...u){let[{size:p=t.size??"md",variant:d=t.variant??"plain",color:b=t.color??"neutral",running:g,...h}]=Z(u);return i({...h,role:"progressbar",class:{deps:[g],renderProp:()=>f=>D("linearProgress",p,b,c,f&&"running",t==null?void 0:t.class,h==null?void 0:h.class)}})}}const kn=(e,t)=>{const n=En(e,t);return o=>n({...o,running:!0})},si=e=>{const{bau:t}=e,{section:n,hr:o}=t.tags,a=X(e),i=En(e),s=t.state(!1);return()=>n(a({variant:"solid",color:"primary",onclick:()=>s.val=!s.val},()=>s.val?"Stop":"Start"),o,i({running:s}))},ii=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,xi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:vi,createComponent:fi}],gridItem:bi},yi=e=>{const t=F(e);return()=>t(xi)};function Tn(e,t={}){const{bau:n,css:o,window:a}=e,{dialog:i,div:s}=n.tags,c=o`
    margin: auto;
    padding: 1rem;
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
...
`).join(`
`);function Ai(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s}=n.tags,r=X(e),c=Be(e),l=be(e),u=qe(e,{color:"neutral",variant:"outline"}),p=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${ki()}
  `;return function(...b){let[{size:g=t.size??"md",variant:h=t.variant??"outline",color:f=t.color??"neutral",name:x,label:y,Option:w,options:k,defaultValue:A=[],getOptionLabel:B,getOptionValue:T,renderValue:M,onSelect:P=()=>{},loading:O,...N},...R]=Z(b);const j=fe(e,{variant:h,color:f,size:g}),U=n.state(A),z=n.state(!1),S=n.state(0),m=()=>{J.openDialog(),J.focus(),z.val=!0},v=()=>{J.closeDialog(),z.val=!1},C=()=>{z.val=!1},E=K=>{J.open?v():m(),K.preventDefault()},H=()=>Array.from(ee.selectedOptions).map(({value:K})=>k.find(ne=>T(ne)==K)),L=K=>{switch(K.preventDefault(),K.key){case"Escape":v();break;case"ArrowDown":S.val<k.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=k.length-1:S.val--;break;case"Enter":if(J.open){const ne=K.currentTarget.querySelectorAll("input")[S.val];ne.checked=!ne.checked;const ie=ee.options[S.val+1];ie.selected=!ie.selected,U.val=H()}else m();break}},G=K=>ne=>{const ie=[...ee.options].find(({value:ve})=>ve==T(K));ne.target.checked?ie.selected=!0:ie.selected=!1,U.val=H()},W=()=>l({tabindex:"0",class:D(f,h)},k.map((K,ne)=>i({class:()=>D(S.val==ne&&"active")},n.tags.label(u({checked:A.find(ie=>T(ie)==T(K)),name:`${x}-${T(K)}`,onchange:G(K)}),w(K))))),$=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":z,"aria-label":y,onclick:E,color:f,variant:h,size:g,class:O==!0&&"loading",disabled:O},()=>U.val.length?M(U.val):y,()=>O==!0&&j({visibility:O})),J=c({triggerEl:$,contentEl:W(),onClose:C}),ee=s({name:x,multiple:!0,...N},n.tags.option({value:""},"--Category--"),k.map(K=>n.tags.option({value:T(K),selected:A.find(ne=>T(ne)==T(K))},B(K))));return a({...N,class:D("multiSelect",f,g,p,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:L},ee,$,J)}}const Ti=e=>{const{bau:t,css:n}=e,{div:o,span:a,form:i,footer:s}=t.tags,r=Ai(e),c=X(e,{variant:"outline",color:"neutral"}),l=Ie(e,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],p=b=>a(b.group),d=b=>{b.preventDefault();const{selectedOptions:g}=b.target.elements.myMultiSelect;var h=Array.from(g).map(({value:f})=>f);alert(JSON.stringify(h))};return()=>i({onsubmit:d,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,Pi={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Oi,createComponent:Bi}]},Li=e=>{const t=F(e);return()=>t(Pi)};function zi(e,t={}){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,ji={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:Ri,createComponent:_i}]},Hi=e=>{const t=F(e);return()=>t(ji)},Ui=(e,t)=>{const{bau:n}=e,{div:o}=n.tags,a=Ne(e,t);return i=>a({...i},o(`Paper ${t.size??""}`))},Gi=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=Ne(e);return()=>n(a({size:"md"},o("My content")))},Fi=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:p=t.color??"neutral",...d}]=Z(c);return a({...d,type:"radio",class:D("radio-button",l,p,u,s,t==null?void 0:t.class,d==null?void 0:d.class)})}}const In=(e,t)=>{const{bau:n,css:o}=e,{label:a,form:i}=n.tags,s=Mn(e,t);return r=>i({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`).join(`
`);function Pe(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=X(e),l=Be(e),u=be(e),p=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Ji()}
  `;return function(...b){let[{size:g=t.size??"md",variant:h=t.variant??"outline",color:f=t.color??"neutral",label:x,Option:y,options:w,defaultOption:k,getOptionLabel:A,getOptionValue:B,onSelect:T=()=>{},loading:M,...P},...O]=Z(b);const N=fe(e,{variant:h,color:f,size:g}),R=n.state(k?A(k):x),j=n.state(!1),U=n.state(0),z=()=>{G.openDialog(),G.focus(),j.val=!0},S=()=>{G.closeDialog(),j.val=!1},m=()=>{j.val=!1},v=$=>{G.open?S():z(),$.preventDefault()},C=({option:$,index:J})=>ee=>{R.val=A($),W.value=B($),W.setCustomValidity(""),U.val=J,S(),T($),ee.preventDefault()},E=$=>{switch($.preventDefault(),$.key){case"Escape":S();break;case"ArrowDown":U.val<w.length-1?U.val++:U.val=0;break;case"ArrowUp":U.val<=0?U.val=w.length-1:U.val--;break;case"Enter":G.open?(R.val=A(w[U.val]),W.value=B(r),S()):z();break}},H=()=>u({tabindex:"0",class:D(f,h)},w.map(($,J)=>i({class:()=>D(U.val==J&&"active"),onclick:C({option:$,index:J})},y($)))),L=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":j,"aria-label":x,onclick:v,color:f,variant:h,size:g,class:M==!0&&"loading",disabled:M},()=>!R.val&&x,R,()=>M==!0&&N({visibility:M})),G=l({triggerEl:L,contentEl:H(),onClose:m}),W=s(P,r({value:""},"--Select Category--"),w.map($=>r({value:B($)},A($))));return W.value=P.value,a({...P,class:D("select",f,g,p,t==null?void 0:t.class,P==null?void 0:P.class),onkeydown:E},W,L,G)}}const Nn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Pe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,ac=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=X(e,{variant:"outline"}),r=Pe(e),c=t.state([]),l=t.state(!1),u=t.state("");async function p({url:g,transform:h=f=>f}){try{l.val=!0;const f=await fetch(g,{});if(f.ok){const x=await f.json();c.val=h(x)}else u.val=f.statusText}catch(f){u.val=f.message}finally{l.val=!1}}const d=()=>p({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:g=>g.sort((h,f)=>h.name.common.localeCompare(f.name.common))});d();const b=g=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(g.flag),i(g.name.common));return()=>o(a({class:n`
...
`,uc={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:lc,createComponent:cc}],gridItem:Bn},dc=e=>{const t=F(e);return()=>t(uc)},pc=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=Se(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`);function _n(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Hc()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=Z(r);return a({...p,class:D("switch",i,u,l,c,t==null?void 0:t.class,p.class),type:"checkbox",required:"required"},...d)}}const Rn=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:i}=n.tags,s=_n(e,t);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,Fc={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:Gc,createComponent:Uc}],gridItem:Rn},Vc=e=>{const t=F(e);return()=>t(Fc)},Wc=()=>oe.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=Z(c);return i({...l,class:D("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const ol=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function p(f,x,y,w,k){return{name:f,calories:x,fat:y,carbs:w,protein:k}}const d=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],b=({name:f,calories:x})=>s(i(f),i({class:n`
            text-align: right;
          `},x)),g=()=>c(s(a({class:n`
              text-align: left;
...
`,bl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:gl,createComponent:ml}]},hl=e=>{const t=F(e);return()=>t(bl)};function Hn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=ht(e),s=X(e),r=fe(e),c=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",selected:d=!1,disabled:b,onChange:g,...h},...f]=Z(c);return i({type:"button",...h,"aria-pressed":{deps:[d],renderProp:()=>x=>x},class:{deps:[d],renderProp:()=>x=>D("toggle",l,p,u,s,x&&"selected",t==null?void 0:t.class,h==null?void 0:h.class)},disabled:b},f)}}const Un=(e,t)=>{const{bau:n}=e,o=_e(e,t);return a=>{const i=n.state(!1);return o({...a,selected:i,onclick:()=>i.val=!i.val},"Toggle Me")}},wl=e=>{const{bau:t}=e,{section:n}=t.tags,o=_e(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Sl=`import toggle from "@grucloud/bau-ui/toggle";
...
`,Il={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Tl,createComponent:Al},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Ml,createComponent:Dl}],gridItem:Gn},Nl=e=>{const t=F(e);return()=>t(Il)};function xt(e,t={}){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",size:p=t.size??"md",variant:d=t.variant??"outline",color:b=t.color??"neutral",...g},...h]=Z(c);const f=i({class:D("container",...u.split("-"))},i({class:D("content",b,d,p),role:"tooltip"},l)),x=T=>`move-to-${T}`,y=(T,M,P)=>{if(T()){const O=x(M);f.classList.add(O),f.classList.add(M),f.classList.remove(P)}},w=(T,M)=>{const P=x(T);f.classList.contains(P)&&(f.classList.remove(P),f.classList.add(M),f.classList.remove(T))},k=T=>{const M=f.getBoundingClientRect();y(()=>M.x<0,"right","left"),y(()=>M.x+M.width>a.innerWidth,"left","right"),y(()=>M.y<0,"bottom","top"),y(()=>M.bottom>a.innerHeight,"top","bottom"),f.classList.add("visible")},A=T=>{f.classList.remove("visible"),w("right","left"),w("left","right"),w("bottom","top"),w("top","bottom")};return i({...g,class:D("tooltip",s,t==null?void 0:t.class,g==null?void 0:g.class),bauMounted:({element:T})=>{T.addEventListener("mouseover",k),T.addEventListener("mouseout",A)},bauUnmounted:({element:T})=>{T.removeEventListener("mouseover",k),T.removeEventListener("mouseout",A)}},...h,f)}}const Fn=(e,t)=>{const{bau:n}=e,{div:o,p:a,em:i}=n.tags,s=X(e),r=xt(e,t),c=()=>o(a("A ",i("tooltip")," can be any component"));return l=>r({titleEl:c(),...l},s(l,`${l.color} ${l.variant}`))},$l=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=X(e),s=xt(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return()=>s({side:"bottom-start",titleEl:r()},i("tooltip"))},Bl=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
