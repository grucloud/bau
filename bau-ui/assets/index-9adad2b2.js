...
`);function se(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
    ...
    ${Io()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",...g},...h]=W(d);return r({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:B("theme-switch",p,b,m,c,e==null?void 0:e.class,g.class),type:"checkbox",checked:s()=="dark",onclick:x=>{i(x.target.checked?"dark":"light")}},...h)}}function No(t){const{tr:e,bau:n,css:o,config:a,states:r}=t,{i,header:s,h1:l,div:c,a:u,img:d,b:m,ul:b,li:p}=n.tags,{svg:g,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),x=r.drawerOpen,v=P(t,{class:o`
    ...
    `}),w=se(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),E=()=>c({class:o`
        ...
        `},d(h),s(g.map(({href:x,name:v})=>l(i({href:x},v))))),b=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],p=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",onclick:d,...m},...b]=W(s);return a({...m,onclick:d,class:B("chip",e.class,l,c,u,d&&"clickable",r,m.class)},...b)}}function Po(t){const{bau:e,css:n,config:o}=t,{div:a,h1:r,h2:i,p:s}=e.tags;P(t);const l=n`
...
"Click me"
  ...
  `,b=({value:h,id:x,children:v=[]})=>{const w=l({class:()=>u.val==x?"active":"",href:`#${x}`});return w.innerHTML=h,s({class:()=>u.val==x?"active":""},w,v.length>0&&i(v.map(b)))},p=h=>h.tagName.charAt(1),g=({contentEl:h})=>{const x=h.querySelectorAll(c);let v=2,w={},S={children:[]},E=S;const D=E;let A=[E];return[...x].forEach(I=>{const M=p(I);I.setAttribute("id",I.textContent),!I.innerHTML.includes("<button")&&(w={value:I.innerHTML,id:I.id??I.textContent,children:[]},v==M?(S=w,E.children.push(S)):v<M?(A.push(E),E=S,S.children.push(w),S=w):v>M&&(E=A[M-1],A=A.slice(0,M-1),E.children.push(w),S=w),v=M)}),D};return function(...x){let[{size:v=e.size??"md",variant:w=e.variant??"plain",color:S=e.color??"neutral",contentEl:E,...D}]=W(x);const A=g({contentEl:E}),I=d(()=>{const $=[...E.querySelectorAll(c)].find(L=>{const{top:j,height:G}=L.getBoundingClientRect();if(j+G>60)return!0});$&&(u.val=$==null?void 0:$.id)},100);return r({...D,class:B("tableOfContent",v,w,S,m,e==null?void 0:e.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",I)},bauUnmounted:()=>{a.removeEventListener("scroll",I)}},A.children&&i(A.children.map(b)))}}const rn=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(l(i(c(m??""),ot.map(b=>c(b)))),r(To.map(b=>i(c(b),ot.map((p,g)=>s(d({color:p,variant:b},{index:g}))))))))}},Ua=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
        `},Do.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;It.registerLanguage("javascript",on);const m=an(t),b=pe(t,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),p=rn(t),g=Ua(t),h=({text:x})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:v})=>{v.innerHTML=It.highlight(x,{language:"js"}).value}}));return function(v){const w=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},i(v.title),s(v.description),v.gridItem&&!v.variantColorTableDisable&&[l("Variant/Color"),b(p({Item:v.gridItem(t)}))],v.gridItem&&!v.variantSizeDisable&&[l("Size"),s("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),b(g({item:v.gridItem}))],l("Usage"),c("Import"),h({text:v.importStatement}),l("Examples"),v.examples.map(S=>r(c(S.title),s(S.description),b(S.createComponent(t)({})),h({text:S.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
...
`);function Et(t,e={}){const{bau:n,css:o}=t,{div:a,i:r}=n.tags,i=o`
    ...
    ${er()}
  `,s=P(t),l=({onclick:c})=>s({"aria-label":"Close",onclick:c,class:"button-close"},"✖");return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",onRemove:p,...g},...h]=W(u);return a({...g,class:B("alert",`alert-${m}`,e.class,m,b,d,i,g.class),role:"alert"},r({class:"icon"},tr[b]),a({class:"content"},...h),p&&l({onclick:p}))}}const ln=(t,e)=>{const n=Et(t,e);return o=>n({...o},`Alert ${(e==null?void 0:e.size)??""} `)},nr=t=>{const{bau:e}=t,{h4:n,p:o}=e.tags,a=Et(t,{color:"danger"});return()=>a(n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},or=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,hr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:fr,createComponent:gr}]},vr=t=>{const e=F(t);return()=>e(hr)};function kt(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",...b},...p]=W(c);return r({...b,class:B("skeleton",u,s,e==null?void 0:e.class,b==null?void 0:b.class)},...p)}}function ge(t,e={}){const{bau:n,css:o}=t,{div:a,img:r}=n.tags,i=n.state(!0),s=n.state(!1),l=()=>i.val=!1,c=d=>{i.val=!1,s.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",width:h=40,height:x=40,alt:v,...w},...S]=W(m);const E=kt(t,{class:B(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${x}px;
          width: ${h}px;
        `,e==null?void 0:e.class,w.class)});return a({class:B(u,e==null?void 0:e.class,w.class)},()=>i.val&&E(),()=>s.val&&v,r({alt:v,width:h,height:x,onload:l,onerror:c,class:()=>B(!i.val&&"visible",s.val&&"hide",g,p,b,u,e==null?void 0:e.class,w.class),...w}))}}const un=(t,e)=>{const{css:n}=t,o=ge(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
100% {
  ...
  `;return function({size:u=e.size??"md",color:d=e.color??"primary",variant:m=e.variant??"outline",visibility:b=!0,...p}={}){const g=o`
      ...
      ${Er()}
    `;return r({class:{deps:[b],renderProp:()=>h=>B("spinner",g,d,m,h==!1?"":"visibility",e==null?void 0:e.class,p.class)},version:"1.1",x:"0px",y:"0px",width:Vt[u],height:Vt[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...p},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Tr=()=>ot.map(t=>`
...
`);function Xt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:b,Option:p,options:g,defaultOption:h,getOptionLabel:x,getOptionValue:v,onSelect:w=()=>{},id:S,required:E,name:D,loading:A,...I},...M]=W(l);const $=$t(t),L=P(t),j=dt(t,{variant:u,color:d,size:c}),G=xt(t),U=bt(t,{variant:u,color:d,size:c}),z=n.state(h),C=n.state(I.value),f=n.state(!1),y=n.state(0),k=()=>{f.val=!1},T=n.state(g),H=Q=>at=>Q.val&&x(at)==x(Q.val),R=()=>{ut.openDialog(),f.val=!0,C.val="",T.val=g,y.val=g.findIndex(H(z));const Q=Dt.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ct.scrollIntoView({block:"end"}))},V=()=>{ut.closeDialog(),f.val=!1,y.val=0},J=Q=>{const{value:at}=Q.target;C.val=at,at?T.val=g.filter(jt=>x(jt).match(new RegExp(`${at}`,"i"))):T.val=g},N=Q=>{ut.open?V():R()},X=Q=>{z.val=Q,lt.value=v(Q)},nt=({option:Q,index:at})=>jt=>{X(Q),y.val=at,V()},Z=()=>{const Q=Dt.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":y.val<T.val.length-1?y.val++:y.val=0,Z();break;case"ArrowUp":y.val<=0?y.val=T.val.length-1:y.val--,Z();break;case"Enter":ut.open?(X(T.val[y.val]),V()):R(),Q.preventDefault();break}},rt=L({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":f,"aria-label":m,onclick:N,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>z.val?x(z.val):m,()=>A==!0&&U({visibility:A})),ct=j({value:C,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":f,oninput:J,onkeydown:Y,...I}),lt=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:h&&v(h),required:E,"aria-hidden":!1,"aria-label":D,name:D}),Dt=a({class:B(u,d,c,"content")},ct,()=>G({class:B(u,d,c)},T.val.map((Q,at)=>r({class:()=>B(y.val==at&&"active",H(z)(Q)&&"selected"),onclick:nt({option:Q,index:at})},p(Q))))),ut=$({id:S,triggerEl:rt,contentEl:Dt,onClose:k,class:o`
        overflow: hidden;
...
`,Ir=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Xt(t),c=P(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=P(t,{variant:"outline"}),c=P(t,{variant:"solid",color:"primary"}),u=Xt(t),d=m=>i({class:n`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},s(m.flag),s(m.name.common));return()=>{const m=e.state([]),b=e.state(!1),p=e.state("");async function g({url:v,transform:w=S=>S}){try{b.val=!0;const S=await fetch(v,{});if(S.ok){const E=await S.json();m.val=w(E)}else p.val=S.statusText}catch(S){p.val=S.message}finally{b.val=!1}}const h=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:v=>v.sort((w,S)=>w.name.common.localeCompare(S.name.common))});return h(),o({onsubmit:v=>{v.preventDefault();const w=Object.fromEntries(new FormData(v.currentTarget));alert(JSON.stringify(w))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({options:m.val,Option:d,getOptionValue:({name:v})=>v.common,getOptionLabel:({name:v})=>v.common,label:"Country",placeholder:"Search countries",name:"country",loading:b.val}),l({onclick:h},"Reload")),r(c({type:"submit"},"Submit")))}},Or=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,$r={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Br,createComponent:Ar},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Or,createComponent:Mr},{title:"Default Option",description:"A autocomplete with a default option.",code:Nr,createComponent:Ir}],gridItem:dn},Lr=t=>{const e=F(t);return()=>e($r)};function mn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=W(s);return a({...m,class:B("badge",r,e==null?void 0:e.class,m==null?void 0:m.class)},a({class:B(u,c,l)},d),...b)}}const pn=(t,e)=>{const n=mn(t,e);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},Pr=t=>{const{bau:e}=t,{section:n}=e.tags,o=mn(t);return()=>n(o({content:"10"},"☏"))},zr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,Rr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:zr,createComponent:Pr}],gridItem:pn},_r=t=>{const e=F(t);return()=>e(Rr)};function fe(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=P(t),u=o`
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",items:h,...x},...v]=W(m);return r({...x,class:B(u,e==null?void 0:e.class,x==null?void 0:x.class)},h.map(({href:w,name:S})=>i((w!=null?c:s)({href:`${a.base}${w}`,color:g,variant:p,size:b,class:B(g,p,b)},S))))}}const bn=(t,e)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=fe(t,e);return a=>o({...a,...n})},jr=t=>{const{bau:e}=t,{section:n}=e.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=fe(t,{variant:"outline",color:"neutral"});return()=>n(a(o))},Gr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`))()}
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...b]=W(l);return a({...m,type:"date",class:B("calendar",i,d,u,c,e==null?void 0:e.class,m==null?void 0:m.class)},...b)}}const vn=(t,e)=>{const n=hn(t,e),o=({props:a={},options:r={}})=>`myinput-gallery-${a.color??r.color}-${a.variant??r.variant}-${a.size??r.size}`;return a=>n({"aria-label":o({props:a,options:e}),...a})},os=t=>{const{bau:e}=t,{section:n,label:o}=e.tags,a=e.state("2023-08-08"),r=hn(t);return()=>n(o("Start date:",r({id:"start",min:"2023-01-01",max:"2024-12-31",value:a.val,oninput:i=>{a.val=i.target.value}})))},as=`import calendar from "@grucloud/bau-ui/calendar";
import { Context } from "@grucloud/bau-ui/context";
...
`,rs={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:as,createComponent:os}],gridItem:vn},ss=t=>{const e=F(t);return()=>e(rs)};function is(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:b,Previous:p,Next:g,...h}]=W(l);const x=()=>{i.val<=0?i.val=m.length-1:i.val--},v=()=>{i.val>=m.length-1?i.val=0:i.val++},w=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(b));return a({...h,class:B("carousel",c,r,e==null?void 0:e.class,h==null?void 0:h.class)},a({class:B("control","control-previous"),onclick:x},p()),a({class:B("control","control-next"),onclick:v},g()),w)}}const cs=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ls=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,r=P(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,Ms={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Ns,createComponent:Is}],variantColorTableDisable:!0,variantSizeDisable:!0},Os=t=>{const e=F(t);return()=>e(Ms)};function $s(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...m},...b]=W(s);return a({class:B(r,e==null?void 0:e.class,m.class)},a({class:()=>B("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>B("content",d.val&&"content-open")},b))}}const Ls=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=e.state(!1),r=$s(t),i=P(t,{color:"neutral",variant:"outline"}),s=Ge(t);return()=>n(o("Click on the button to open and close the drawer."),i({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),r({openState:a},s()))},Ps=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`);function Sn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=P(t),s=$t(t),l=xt(t),c=o`
    ${_s()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"outline",color:p=e.color??"neutral",label:g,ListItem:h,items:x,...v},...w]=W(d);const S=n.state(0),E=()=>{G.openDialog(),G.focus()},D=()=>{G.closeDialog()},A=()=>{G.open?D():E()},I=U=>{A(),U.preventDefault()},M=({item:U,index:z})=>C=>{S.val=z,D(),C.preventDefault()},$=U=>{switch(U.preventDefault(),U.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},L=()=>l({tabindex:"0",class:B(p,b)},x.map((U,z)=>r({class:()=>B(S.val==z&&"active"),onclick:M({item:U,index:z})},h(U)))),j=i({type:"button",onclick:I,color:p,variant:b,size:m},g),G=s({triggerEl:j,contentEl:L()});return a({...v,class:B("dropdownMenu",p,m,c,e==null?void 0:e.class,v==null?void 0:v.class),onkeydown:$},j,G)}}const js=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=Sn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},Gs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=Sn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Hs=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,qs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Js,createComponent:Vs}],gridItem:(t,e)=>wn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},Ws=t=>{const e=F(t);return()=>e(qs)};function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",Component:p,disabled:g,...h}=c;return a({class:B(s.base,g&&s.disabled,e==null?void 0:e.class,c.class)},r({class:B(m,b,d)},p({disabled:g}),i({type:"file",disabled:g,...h})))}}const kn=(t,e)=>{const{tr:n,bau:o,css:a,config:r}=t,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=Cn(t,e),m=p=>{const g=p.target.files[0];g?u.val=g.name:u.val="No file selected"},b=({disabled:p})=>l({class:B(a`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,p&&a`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${r.base}/uploadIcon.svg#Capa_1`})),c(n("Choose a file to upload")));return p=>d({Component:b,name:"file",accept:"text/*",onchange:m,...p})},Ks=t=>{const{tr:e,bau:n,css:o,config:a}=t,{svg:r,use:i}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,span:c}=n.tags,u=n.state("No file selected"),d=Cn(t),m=p=>{const g=p.target.files[0];g?u.val=g.name:u.val="No file selected"},b=({disabled:p})=>l({class:B(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
          ...
          `,p&&o`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},r({width:100,height:100,fill:"currentColor"},i({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(e("Choose a file to upload")));return()=>s(d({Component:b,name:"file",accept:"text/*",onchange:m}),l("File selected: ",u))},Xs=`import classNames from "@grucloud/bau-css/classNames";
...
`,Zs={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Xs,createComponent:Ks}],gridItem:kn},Ys=t=>{const e=F(t);return()=>e(Zs)};function gt(t,e={}){const{bau:n,css:o}=t,{form:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=W(s);return a({...m,class:B("form",u,c,l,r,e==null?void 0:e.class,m==null?void 0:m.class)},...b)}}function ve(t,e={}){const{bau:n,css:o,keyframes:a}=t,{span:r}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,s=o`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",loading:b,...p},...g]=W(c);const h=P(t),x=bt(t);return n.bind({deps:[b],render:()=>v=>h({...p,class:B("loadingButton",u,d,m,s,v&&"loading",e==null?void 0:e.class,p==null?void 0:p.class)},x({size:u,variant:d,color:m,visibility:v}),r({class:v&&"loading"},g))})}}const Qs=t=>{const{bau:e,css:n,config:o}=t,{section:a,h1:r,header:i,label:s,img:l,footer:c}=e.tags,u=ve(t,{variant:"solid",color:"primary"}),d=Et(t,{variant:"outline",color:"danger"}),m=dt(t),b=gt(t,{class:n`
      max-width: 400px;
      & > header {
        text-align: center;
      }
...
`,ei=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:r,footer:i}=e.tags,s=gt(t),l=P(t,{variant:"solid",color:"primary"}),c=dt(t);return function({onSubmitted:d=()=>{}}){return s({onsubmit:async b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p)),d(p)}},a(o("Form with input")),n(r("Branch",c({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(l({type:"submit"},"Click")))}},ni=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`,oi=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:r,footer:i,em:s,span:l}=e.tags,c=e.state(""),u=e.derive(()=>c.val!=="Delete"),d=gt(t),m=P(t,{variant:"solid",color:"danger"}),b=dt(t);return function({onSubmitted:g=()=>{}}){return d({onsubmit:async x=>{x.preventDefault(),g()}},a(o("Delete Protection")),n(r(l("Type ",s("Delete")," to confirm the destruction of the resource."),b({autofocus:!0,placeholder:"Type 'Delete'",name:"check",required:!0,value:c,oninput:x=>c.val=x.target.value}))),i(m({type:"submit",disabled:u},"Delete")))}},ai=`import { Context } from "@grucloud/bau-ui/context";
...
`,Si={title:"KeyValueList",package:"keyValueList",description:"The keyValueList component displays a list of key value pair",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/keyValueList/keyValueList.js",importStatement:'import keyValueList from "@grucloud/bau-ui/keyValueList";',examples:[{title:"Vertical keyValueList",description:"A vertical keyValueList.",code:vi,createComponent:hi},{title:"Horizontal keyValueList",description:"A horizontal keyValueList.",code:yi,createComponent:xi}]},wi=t=>{const e=F(t);return()=>e(Si)},Ci="modulepreload",ki=function(t){return"/bau/bau-ui/"+t},Le={},An=function(e,n,o){if(!n||n.length===0)return e();const a=document.getElementsByTagName("link");return Promise.all(n.map(r=>{if(r=ki(r),r in Le)return;Le[r]=!0;const i=r.endsWith(".css"),s=i?'[rel="stylesheet"]':"";if(!!o)for(let u=a.length-1;u>=0;u--){const d=a[u];if(d.href===r&&(!i||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${r}"]${s}`))return;const c=document.createElement("link");if(c.rel=i?"stylesheet":Ci,i||(c.as="script",c.crossOrigin=""),c.href=r,document.head.appendChild(c),i)return new Promise((u,d)=>{c.addEventListener("load",u),c.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${r}`)))})})).then(()=>e())};function Bn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=bt(t,{size:"lg"}),i=Et(t,{color:"danger"}),s=()=>a({class:o`
          ...
          justify-content: center;
          align-items: center;
        `},r({visibility:!0})),l=c=>i(c.message);return function({getModule:u,loading:d=s,error:m=l,props:b={}}){const p=n.state(void 0),g=n.state(!0),h=n.state(!1);return u().then(x=>{n.batch(()=>{p.val=x.default(t),g.val=!1})}).catch(x=>{h.val=x.message}),a(()=>{if(h.val)return m({message:h.val});if(g.val)return d();if(p.val)return p.val(b)})}}const Ei=t=>{const{bau:e}=t,{section:n}=e.tags,o=e.state(!1),a=Bn(t),r=P(t);return()=>n(r({onclick:()=>o.val=!o.val},()=>o.val?"Hide":"Show"),()=>o.val&&a({getModule:()=>An(()=>import("./myComponent-a7adf959.js"),[]),props:{message:"myValue"}}))},Ti=`import { Context } from "@grucloud/bau-ui/context";
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",running:p,...g}]=W(u);return r({...g,role:"progressbar",class:{deps:[p],renderProp:()=>h=>B("linearProgress",d,b,l,h&&"running",e==null?void 0:e.class,g==null?void 0:g.class)}})}}const Nn=(t,e)=>{const n=In(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},Ni=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=P(t,{variant:"solid",color:"primary"}),r=In(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},Mi=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`))()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",...p},...g]=W(u);const h=r({...p,bauMounted:()=>{new URLSearchParams(a.location.search).get("modal")==(p.id??"modal")&&h.showModal()},class:B("modal",l,b,m,d,e==null?void 0:e.class,p==null?void 0:p.class)},g);return new MutationObserver(v=>{const w=new URLSearchParams(a.location.search);v[0].attributeName=="open"&&(h.open?w.set("modal",h.id??"modal"):w.delete("modal"),a.history.pushState("","",`?${w.toString()}`))}).observe(h,{attributes:!0}),h}}const $n=(t,e={})=>{const{bau:n,window:o}=t,{document:a}=o,{form:r,section:i,main:s,header:l,footer:c,p:u,h1:d}=n.tags,m=P(t),b=On(t,e),p=()=>s(Array(20).fill("").map((x,v)=>u(v+1,". Some text here"))),g=x=>`dialog-${x.color}-${x.variant}-${e.size}`,h=x=>b({id:g(x),...x},r(l(d("Header")),p(),c(m({variant:"outline",color:x.color,onclick:v=>{v.target.closest("dialog").close()}},"Cancel"),m({variant:"solid",color:x.color,onclick:v=>{v.target.closest("dialog").close()}},"OK"))));return x=>i(m({...x,onclick:()=>{a.getElementById(g(x)).showModal()}},"OPEN MODAL"),h(x))},Ji=t=>{const{bau:e,window:n}=t,{document:o}=n,{form:a,section:r,main:i,header:s,footer:l,p:c}=e.tags,d=P(t,{color:"neutral"}),m=On(t),b=()=>i(Array(10).fill("").map((p,g)=>c(g+1,". Some text here")));return()=>r(d({variant:"solid",onclick:()=>{o.getElementById("my-dialog").showModal()}},"OPEN MODAL"),m({id:"my-dialog"},a(s("Header"),b(),l(d({variant:"outline",onclick:p=>{p.target.closest("dialog").close()}},"Cancel"),d({variant:"solid",onclick:p=>{p.target.closest("dialog").close()}},"OK")))))},qi=`import modal from "@grucloud/bau-ui/modal";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`);function Zi(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=P(t),l=$t(t),c=xt(t),u=Tt(t,{color:"neutral",variant:"outline"}),d=o`
    ...
    ${Xi()}
  `;return function(...b){let[{size:p=e.size??"md",variant:g=e.variant??"outline",color:h=e.color??"neutral",name:x,label:v,Option:w,options:S,defaultValue:E=[],getOptionLabel:D,getOptionValue:A,renderValue:I,onSelect:M=()=>{},loading:$,...L},...j]=W(b);const G=bt(t,{variant:g,color:h,size:p}),U=n.state(E),z=n.state(!1),C=n.state(0),f=()=>{X.openDialog(),X.focus(),z.val=!0},y=()=>{X.closeDialog(),z.val=!1},k=()=>{z.val=!1},T=Z=>{X.open?y():f(),Z.preventDefault()},H=()=>Array.from(nt.selectedOptions).map(({value:Z})=>S.find(Y=>A(Y)==Z)),R=Z=>{switch(Z.preventDefault(),Z.key){case"Escape":y();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Y=Z.currentTarget.querySelectorAll("input")[C.val];Y.checked=!Y.checked;const rt=nt.options[C.val+1];rt.selected=!rt.selected,U.val=H()}else f();break}},V=Z=>Y=>{const rt=[...nt.options].find(({value:ct})=>ct==A(Z));Y.target.checked?rt.selected=!0:rt.selected=!1,U.val=H()},J=()=>c({tabindex:"0",class:B(h,g)},S.map((Z,Y)=>r({class:()=>B(C.val==Y&&"active")},n.tags.label(u({checked:E.find(rt=>A(rt)==A(Z)),name:`${x}-${A(Z)}`,onchange:V(Z)}),w(Z))))),N=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":z,"aria-label":v,onclick:T,color:h,variant:g,size:p,class:$==!0&&"loading",disabled:$},()=>U.val.length?I(U.val):v,()=>$==!0&&G({visibility:$})),X=l({triggerEl:N,contentEl:J(),onClose:k}),nt=i({name:x,multiple:!0,...L},n.tags.option({value:""},"--Category--"),S.map(Z=>n.tags.option({value:A(Z),selected:E.find(Y=>A(Y)==A(Z))},D(Z))));return a({...L,class:B("multiSelect",h,p,d,e==null?void 0:e.class,L==null?void 0:L.class),onkeydown:R},nt,N,X)}}const Yi=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=Zi(t),l=P(t,{variant:"outline",color:"neutral"}),c=Ot(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=b=>a(b.group),m=b=>{b.preventDefault();const{selectedOptions:p}=b.target.elements.myMultiSelect;var g=Array.from(p).map(({value:h})=>h);alert(JSON.stringify(g))};return()=>r({onsubmit:m,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
        `},s({name:"myMultiSelect",options:u,Option:d,defaultValue:[{group:"IAM"}],getOptionValue:({group:b})=>b,getOptionLabel:({group:b})=>b,renderValue:b=>o({class:n`
                ...
                align-items: center;
                gap: 0.2rem;
              `},b.map(p=>c(p.group))),label:"Select services"}),i(l({type:"submit"},"Submit")))},Qi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,yc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:xc,createComponent:vc}],gridItem:Ln},Sc=t=>{const e=F(t);return()=>e(yc)};function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=xe(t),l=o`
  ...
  `).join(`
`))()};
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"none",color:b=e.color??"neutral",name:p,oninput:g,value:h,radios:x=[],...v}]=W(u);return a({...v,class:B("radioButtonGroup",d,b,m,l,e==null?void 0:e.class,v==null?void 0:v.class)},x.map(({id:w,Label:S})=>r(i({size:d,variant:m,color:b,id:w,name:p,checked:h==w,value:w,oninput:g}),S())))}}const wc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,p:r}=e.tags,i=Zt(t),s=P(t,{variant:"outline",color:"primary"}),l=e.state("two"),c=({target:d})=>l.val=d.id,u=d=>{d.preventDefault(),alert(l.val)};return()=>n({onsubmit:u},o(i({oninput:c,name:"myRadio",value:l.val,radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]}),r("CheckedState: ",l)),a(s({type:"submit"},"Submit")))},Cc=`import { Context } from "@grucloud/bau-ui/context";
...
`,kc=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Zt(t),i=P(t,{variant:"outline",color:"primary"}),s=l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))};return()=>n({onsubmit:s},o(r({name:"myRadio",value:"one",radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},Ec=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Lc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Lt(t),c=P(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},s(p.label),s(p.code)),b=p=>{p.preventDefault();const g=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(g))};return()=>o({onsubmit:b},a(l({name:"country",options:d,Option:m,defaultOption:d.find(({code:p})=>p==u),getOptionValue:({code:p})=>p,getOptionLabel:({label:p})=>p,label:"Select a country..."})),r(c({type:"submit"},"Submit")))},Pc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,zc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,span:r}=e.tags,i=Lt(t),s=P(t,{variant:"solid",color:"primary"}),l=["eu-north-1","ap-south-1","eu-west-3","eu-west-2","eu-west-1","ap-northeast-3","ap-northeast-2","ap-northeast-1","sa-east-1","ca-central-1","ap-southeast-1","ap-southeast-2","eu-central-1","us-east-1","us-east-2","us-west-1","us-west-2"],c=d=>r({},d),u=d=>{d.preventDefault();const m=Object.fromEntries(new FormData(d.currentTarget));alert(JSON.stringify(m))};return()=>n({onsubmit:u},o(i({name:"region",options:l,Option:c,label:"Select a region",getOptionValue:d=>d,getOptionLabel:d=>d,required:!0,oninvalid:d=>{d.target.setCustomValidity("Please select an AWS region")}})),a(s({type:"submit"},"Submit")))},Rc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,_c=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=P(t,{variant:"outline"}),c=P(t,{variant:"solid",color:"primary"}),u=Lt(t),d=e.state([]),m=e.state(!1),b=e.state("");async function p({url:v,transform:w=S=>S}){try{m.val=!0;const S=await fetch(v,{});if(S.ok){const E=await S.json();d.val=w(E)}else b.val=S.statusText}catch(S){b.val=S.message}finally{m.val=!1}}const g=()=>p({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:v=>v.sort((w,S)=>w.name.common.localeCompare(S.name.common))});g();const h=v=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(v.flag),i(v.name.common)),x=v=>{v.preventDefault();const w=Object.fromEntries(new FormData(v.currentTarget));alert(JSON.stringify(w))};return()=>o({onsubmit:x},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:d.val,Option:h,getOptionValue:({name:v})=>v.common,getOptionLabel:({name:v})=>v.common,label:"Country",id:"country",loading:m.val,required:!0}),l({onclick:()=>g()},"Reload")),r(c({type:"submit"},"Submit")))},jc=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`,il=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=Pt(t),d=P(t,{variant:"solid",color:"primary"}),m=b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))};return()=>r({onsubmit:m},o(i({for:"temp"},"Choose a comfortable temperature"),l,u({class:n`
            width: 300px;
            margin: 0;
          `,id:"temp",name:"temp",list:"markers"}),s({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(b=>c({value:Number(b),label:b})))),a(d({type:"submit"},"Submit")))},cl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import slider from "@grucloud/bau-ui/slider";
...
`,ll=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=e.state(0),d=g=>{u.val=g==null?void 0:g.target.value},m=Pt(t),b=P(t,{variant:"solid",color:"primary"}),p=g=>{g.preventDefault();const h=Object.fromEntries(new FormData(g.currentTarget));alert(JSON.stringify(h))};return()=>r({onsubmit:p},o({class:n`
            display: flex;
          ...
          `}),s({id:"markers-vertical",class:n`
              ...
              flex-direction: column;
              justify-content: space-between;
            `},["0","25","50","75","100"].reverse().map(g=>c({value:Number(g),label:g})))),a(b({type:"submit"},"Submit")))},ul=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import slider from "@grucloud/bau-ui/slider";
...
`,ze="stepper-vertical",yl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=e.tags,d=dt(t),m=gt(t),b=Hn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
    ...
    `}),p=Gn(t,ze),g=P(t,{variant:"outline",color:"primary"}),h=P(t,{variant:"solid",color:"primary"}),x=({nextStep:S})=>E=>{E.preventDefault();const{organization:D}=E.target.elements;n.history.pushState("","",p(S.name,{organization:D.value}))},v=S=>{var I;S.preventDefault();const{organization:E}=(I=n.document.forms)==null?void 0:I.formStep1.elements,A=new URLSearchParams(n.location.search).get("choice");alert(`organization ${E.value}, choice:${A}`)},w=[{name:"step1",Header:()=>"Step 1",Content:({nextStep:S})=>m({onsubmit:x({nextStep:S}),id:"formStep1"},i("Organization",d({autofocus:!0,placeholder:"Organization",name:"organization"})),a(h({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:S,previousStep:E})=>m(c(u(l({href:p(S.name,{choice:"choice1"})},"Choice 1")),u(l({href:p(S.name,{choice:"choice2"})},"Choice 2"))),a(g({href:p(E.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:S})=>m({onsubmit:v},r("My stepper 3 Content"),a(g({href:p(S.name)},"Previous: Step 2"),h({type:"submit"},"Save")))}];return()=>s(b({stepperDefs:w,stepperName:ze}))},Sl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`;const i=o`
  ...
  `;return function(...l){let[{...c},...u]=W(l);return r({...c,class:B("table-container",i,e==null?void 0:e.class,c==null?void 0:c.class)},...u)}}const jl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags;function d(h,x,v,w,S){return{name:h,calories:x,fat:v,carbs:w,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],b=({name:h,calories:x})=>i(r(h),r({class:n`
      ...
      max-width: 650px;
    `});return()=>o(g(s(u("Basic Table"),p(),c(m.map(b)))))},Gl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function At(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Hl=[At("Frozen yoghurt",159,6,24,4),At("Ice cream sandwich",237,9,37,4.3),At("Eclair",262,16,24,6),At("Cupcake",305,3.7,67,4.3),At("Gingerbread",356,16,49,3.9)],Fl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:g})=>i(r(p),r({class:n`
          ...
          `},g)),m=()=>l(i(a({class:n`
            ...
            `,title:"Product Name"},"Product Name"),a({class:n`
              text-align: right;
            `,title:"Calories"},"Calories"))),b=Rt(t,{class:n`
      & td,
      th {
        padding: 0.4rem;
      }
    `});return()=>o(b(s(u("Table Dense"),m(),c(Hl.map(d)))))},Ul=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Bt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Vl=[Bt("Frozen yoghurt",159,6,24,4),Bt("Ice cream sandwich",237,9,37,4.3),Bt("Eclair",262,16,24,6),Bt("Cupcake",305,3.7,67,4.3),Bt("Gingerbread",356,16,49,3.9)],Jl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:g})=>i(r(p),r({class:n`
    ...
    `});return()=>o(b(s(u("Table Zebra"),m(),c(Vl.map(d)))))},ql=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Yl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Zl,createComponent:Xl}]},Ql=t=>{const e=F(t);return()=>e(Yl)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=he(t),i=P(t),s=bt(t),l=o`
  ...
  `,c=({label:p,icon:g,...h})=>i({"aria-label":p,title:p,...h},g),u=({count:p,totalCount:g,page:h,rowsPerPage:x})=>a({class:"pages-numbers"},Number(h-1)*Number(x)+(p>0?1:0),"-",Math.min(h*x,g)," of ",g),d=({count:p,page:g,rowsPerPage:h})=>a({class:"pages-numbers"},(g-1)*h+(p>0?1:0),"-",g*h),m=p=>p<=1,b=(p,g,h)=>p>=Math.ceil(g/h);return function(...g){let[{size:h=e.size??"md",variant:x=e.variant??"outline",color:v=e.color??"neutral",count:w=0,totalCount:S=0,page:E=1,rowsPerPage:D=50,onPageChange:A,isLoading:I=!1,disableFirst:M=()=>m(E),disablePrevious:$=()=>m(E),disableNext:L=()=>b(E,S,D),disableLast:j=()=>b(E,S,D),...G},...U]=W(g);const z=Math.max(0,Math.ceil(S/D)),C=A({page:1}),f=A({page:E-1}),y=A({page:E+1}),k=A({page:z}),T=[{label:"First",icon:"⟪",onclick:C,disabled:M()},{label:"Previous",icon:"⟨",onclick:f,disabled:$()},{label:"Next",icon:"⟩",onclick:y,disabled:L()},{label:"Last",icon:"⟫",onclick:k,disabled:j()}];return a({...G,class:B("table-pagination",l,I&&"disabled",e==null?void 0:e.class,G==null?void 0:G.class)},s({class:"spinner",visibility:I,size:"md"}),S>0?u({count:w,totalCount:S,page:E,maxPages:z,rowsPerPage:D}):d({count:w,page:E,maxPages:z,rowsPerPage:D}),r({variant:x,color:v},T.map(H=>c({...H,variant:x,color:v}))))}}const tu=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),eu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=tu(45),u=({name:v,email:w})=>r(a(v),a(w)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=Jn(t),b=Rt(t,{class:n`
      max-width: 650px;
    `}),p=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),h=e.derive(()=>p.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),x=({page:v})=>w=>{g.val.page=v};return()=>b(i(d(),()=>l(h.val.map(u))),()=>m({...g.val,onPageChange:x}))},nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),b=e.derive(()=>d.val.length),p=e.state(1),g=e.state(10),h=e.derive(()=>d.val),x=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,v=({page:M})=>$=>{p.val=M,w(x({page:M,per_page:g.val}))};w(x({page:1,per_page:g.val}));async function w(M){try{u.val=!0;const $=await fetch(M,{});if($.ok){const L=await $.json();d.val=L;return}throw $}catch($){m.val=$.message}finally{u.val=!1}}const S=({name:M,description:$,stargazers_count:L})=>r(a(M),a($),a({class:n`
            text-align: right;
          `},L)),E=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),I=({message:M})=>c(M);return()=>A(()=>D({rowsPerPage:g.val,page:p.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:v,disableNext:()=>!1}),i(E(),()=>m.val&&I({message:m.val}),()=>l(h.val.map(S))))},ou=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=eu(t),c=nu(t),u=(...d)=>a({class:n`
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",selected:m=!1,disabled:b,onChange:p,...g},...h]=W(l);return r({type:"button",...g,"aria-pressed":{deps:[m],renderProp:()=>x=>x},class:{deps:[m],renderProp:()=>x=>B("toggle",c,d,u,i,x&&"selected",e==null?void 0:e.class,g==null?void 0:g.class)},disabled:b},h)}}const qn=(t,e)=>{const{bau:n}=t,o=_t(t,e);return a=>{const r=n.state(!1);return o({...a,selected:r,onclick:()=>r.val=!r.val},"Toggle Me")}},au=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=_t(t,{variant:"plain"}),i=P(t,{variant:"outline",color:"primary"}),s=e.state(!1),l=c=>{var m;c.preventDefault();const d=(m=c.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:m.name;alert(d)};return()=>n({onsubmit:l},o(r({name:"my-toogle",selected:s,onclick:()=>s.val=!s.val},"Toggle Me")),a(i({type:"submit"},"Submit")))},ru=`import { Context } from "@grucloud/bau-ui/context";
...
`);function ye(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    ...
    ${cu()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",exclusive:d=!1,onChange:m=()=>{},...b},...p]=W(s);const g=new Set,h=x=>{const{value:v}=x.target;d?(g.clear(),g.add(v)):g.has(v)?g.delete(v):g.add(v),m({event:x,values:[...g]})};return a({...b,class:B("toggle-group",l,u,c,r,e==null?void 0:e.class,b==null?void 0:b.class),onclick:h},...p)}}const Wn=(t,e)=>{const{bau:n}=t,o=ye(t,e),a=_t(t,e);return r=>{const i=n.state([""]),s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...r,onChange:({values:c})=>{i.val=c}},s.map(({label:c,value:u})=>()=>a({...r,value:u,selected:i.val.includes(u),"area-label":c},c)))}},lu=t=>{const{bau:e}=t,{form:n,footer:o,article:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=_t(t,{color:i,variant:s}),c=ye(t,{color:i,variant:s}),u=P(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{var x;p.preventDefault();const h=(x=p.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:x.name;alert(h)}},a(c({exclusive:!0,onChange:({values:p})=>{d.val=p}},r.map(({label:p,value:g})=>()=>l({value:g,name:p,selected:d.val.includes(g)},p)))),o(u({type:"submit"},"Submit")))}},uu=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,du=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=_t(t,{variant:s,color:i}),c=ye(t,{variant:s,color:i}),u=P(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{p.preventDefault();const h=[...p.currentTarget.querySelectorAll("button[aria-pressed=true]")].map(({name:x})=>x);alert(JSON.stringify(h))}},o(c({onChange:({values:p})=>{d.val=p}},r.map(({label:p,value:g})=>()=>l({value:g,name:p,selected:d.val.includes(g)},p)))),a(u({type:"submit"},"Submit")))}},mu=`import { Context } from "@grucloud/bau-ui/context";
...
`,{nav:t`
  ...
  `});function we(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{renderMenuItem:r}=e,{ul:i,li:s,nav:l,div:c}=n.tags,u=Eu({css:o,createGlobalStyles:a}),d=be(t),m=({depth:b=1,maxDepth:p,parent:g,color:h,variant:x,size:v})=>w=>{const{children:S,expanded:E}=w,D=n.state(!E),A=()=>c({class:o`
              cursor: ${S?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:M=>{S&&(D.val=!D.val)}},r({item:w,parent:g,depth:b})),I=()=>i({class:B(h,v)},S.map(m({depth:b+1,maxDepth:p,parent:w})));return s(S.length?d({expanded:E,Header:A,Content:S&&b<p&&I}):A())};return function({tree:p,maxDepth:g=1/0,size:h=e.size??"md",variant:x=e.variant??"outline",color:v=e.color??"neutral",...w}){return l({class:B(u.nav,h,x,v,e==null?void 0:e.class,w.class)},i(m({maxDepth:g,color:v,variant:x,size:h})(Zn({})({...p}))))}}const Yn=(t,e)=>{const{bau:n}=t,{a:o,span:a}=n.tags,r={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=we(t,{renderMenuItem:({item:{data:{name:l,href:c}}})=>c?o({href:c},l):a(l),...e});return l=>s({...l,tree:r})},Tu=t=>{const{bau:e}=t,{a:n,span:o}=e.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=we(t,{renderMenuItem:({item:{data:{name:s,href:l}}})=>l?n({href:l},s):o(s)});return()=>i({tree:a})},Du=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
