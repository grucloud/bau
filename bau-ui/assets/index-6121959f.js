...
`)}
  ...
  `;return function(...s){let[{size:r=t.size??"md",variant:c=t.variant??"plain",color:l=t.color??"neutral",href:u,...d},...p]=V(s);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:B("button",t.class,c,r,l,a,d.class),href:u},p)}}const ee=["neutral","primary","success","danger","warning"],ho=["plain","outline","solid"],fo=["sm","md","lg"],vo="light",xo=()=>ee.map(e=>`
...
`);function tt(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(vo);const l=o`
    ...
    ${xo()}
  `;return function(...d){let[{color:p,variant:m="outline",size:f="md",...v},...h]=V(d);return i({required:"required",title:"Switch Theme",...v,class:B("theme-switch",p,m,f,l,t==null?void 0:t.class,v.class),type:"checkbox",checked:r()=="dark",onclick:x=>{s(x.target.checked?"dark":"light")}},...h)}}function wo(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:m,li:f}=n.tags,{svg:v,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),x=i.drawerOpen,b=K(e,{class:o`
      background: transparent;
    `}),y=tt(e),k=()=>s(v({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),A=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
            color: var(--color-inverse);
          }
        `},b({"aria-label":"drawer",variant:"none",color:"none",onclick:()=>x.val=!x.val},k()),u({href:`${a.base}/`,class:o`
            text-decoration: none;
            font-size: x-large;
        ...
        `},A(),N())}}function yo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:d}=t.tags,p=({links:v,title:h})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},d(h),r(v.map(({href:x,name:b})=>c(s({href:x},b))))),m=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],f=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
  ...
  `,hideToRight:e`
   ...
   `});function nt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=z=>{var W;return((W=z.parentTree.data)==null?void 0:W.href)??z.parentTree.children[0].data.href},u=({variant:z,color:W,size:U,currentTree:C,data:g})=>y(T({variant:z,color:W,size:U,href:`${c}${l(C)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),T({variant:z,color:W,size:U,href:`${c}${g.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},g.name)),d=({size:z,subTree:{data:{name:W,href:U},children:C=[]}})=>T({size:z,href:`${c}${U}`,"data-ischild":!C.length},W),p=({pathname:z,subTree:W})=>{var U;return z===((U=W==null?void 0:W.data)==null?void 0:U.href)},{renderHeader:m=u,renderMenuItem:f=d,isActive:v=p}=t,{li:h,nav:x,div:b,header:y,a:k}=n.tags,A=Re(e),N=fe(e),T=K(e,{class:o`
      &.button {
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function Ao({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,d=({maxSize:p=151})=>({libName:m,size:f})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},m.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Io(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=ko(e),l=To(e),u=K(e);Le(e);const d=Ao(e),p=(...x)=>a({class:n`
...
"Click me"
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=V(r);return a({...d,class:B("paper",c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}function Xt(e,t={}){const{bau:n,css:o,window:a}=e,{nav:i,ul:s,li:r,a:c}=n.tags,{headerSelector:l="h2,h3"}=t,u=n.state("no"),d=(h,x)=>{let b=null;return(...y)=>{a.clearTimeout(b),b=a.setTimeout(()=>h(...y),x)}},p=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,m=({value:h,id:x,children:b=[]})=>{const y=c({class:()=>u.val==x?"active":"",href:`#${x}`});return y.innerHTML=h,r({class:()=>u.val==x?"active":""},y,b.length>0&&s(b.map(m)))},f=h=>h.tagName.charAt(1),v=({contentEl:h})=>{const x=h.querySelectorAll(l);let b=2,y={},k={children:[]},A=k;const N=A;let T=[A];return[...x].forEach(D=>{const M=f(D);D.setAttribute("id",D.textContent),!D.innerHTML.includes("<button")&&(y={value:D.innerHTML,id:D.id??D.textContent,children:[]},b==M?(k=y,A.children.push(k)):b<M?(T.push(A),A=k,k.children.push(y),k=y):b>M&&(A=T[M-1],T=T.slice(0,M-1),A.children.push(y),k=y),b=M)}),N};return function(...x){let[{color:b,variant:y,size:k="md",contentEl:A,...N}]=V(x);const T=v({contentEl:A}),D=d(()=>{const L=[...A.querySelectorAll(l)].find(q=>{const{top:J,height:z}=q.getBoundingClientRect();if(J+z>60)return!0});L&&(u.val=L==null?void 0:L.id)},100);return i({...N,class:B("tableOfContent",k,y,b,p,t==null?void 0:t.class,N==null?void 0:N.class),bauMounted:()=>{a.addEventListener("scroll",D)},bauUnmounted:()=>{a.removeEventListener("scroll",D)}},T.children&&s(T.children.map(m)))}}const Zt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(c(s(l(p??""),ee.map(m=>l(m)))),i(ho.map(m=>s(l(m),ee.map((f,v)=>r(d({color:f,variant:m},{index:v}))))))))}},$a=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:i}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
    ...
    `}),f=Zt(e),v=$a(e),h=({text:x})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:b})=>{b.innerHTML=ye.highlight(x,{language:"js"}).value}}));return function(b){const y=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},s(b.title),r(b.description),b.gridItem&&[c("Variant/Color"),!b.variantColorTableDisable&&b.gridItem&&m(f({Item:b.gridItem(e)})),c("Size"),r("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),b.gridItem&&m(v({Item:b.gridItem(e)}))],c("Usage"),l("Import"),h({text:b.importStatement}),c("Examples"),b.examples.map(k=>i(l(k.title),r(k.description),m(k.createComponent(e)({})),h({text:k.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
  ...
  `,s=({element:l,closeState:u})=>{l.scrollHeight!=0&&(u.val?r(l):c(l))};function r(l){l.style.height=l.scrollHeight+"px";const u=()=>{l.removeEventListener("transitionend",u)};l.addEventListener("transitionend",u),window.requestAnimationFrame(()=>{l.style.height="0px"})}function c(l){const u=()=>{l.removeEventListener("transitionend",u),l.style.height=null};l.addEventListener("transitionend",u),l.style.height=l.scrollHeight+"px"}return function(...u){let[{color:d,variant:p="plain",size:m="md",Header:f,Content:v,close:h=!0,...x}]=V(u);const b=n.state(h);return a({...x,class:B("collapsible",m,i,t==null?void 0:t.class,x==null?void 0:x.class)},a({class:()=>B("header",v?b.val?"close":"open":""),onclick:y=>{b.val=!b.val,y.stopPropagation()}},f()),a({class:"content",role:"region",bauMounted:({element:y})=>{b.val&&(y.style.height="0px")},"aria-expanded":({element:y})=>(s({element:y,closeState:b}),!b.val)},v&&v()))}}const Pa=()=>ee.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`);function je(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${Pa()}
  `;return function(...d){let[{size:p=t.size??"md",variant:m=t.variant??"plain",color:f=t.color??"neutral",data:v=[],...h}]=V(d);const x=n.state(""),b=it(e),y=A=>N=>{x.val==A?x.val="":x.val=A},k=A=>{const{Header:N,Content:T,name:D}=A,M=()=>r({class:()=>B(x.val==D&&"active")},c({type:"button","aria-controls":`bau-${D}`,"aria-expanded":({element:q})=>x.val==D},N(A))),L=()=>a({id:`bau-${D}`,"data-state":({element:q})=>x.val==D},T(A));return s({class:B(f,m,p),onclick:y(D)},b({Header:M,Content:L}))};return a({class:B("accordion",l,t==null?void 0:t.class,h.class)},i(v.map(k)))}}const Yt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=je(e);return s=>i({...s,data:a})},Oa=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=je(e);return()=>i({data:a,color:"neutral",variant:"outline"})},_a=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,Xa={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Va,createComponent:Wa},{title:"Custom Alert ",description:"A custom alert.",code:qa,createComponent:Ka}],gridItem:Qt},Za=e=>{const t=H(e);return()=>t(Xa)},Ya=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},d=({id:p,status:m})=>{const f=c.val.findIndex(v=>v.id===p);f!=-1&&(c.val[f].status=m)};return function(m={},...f){const v=({id:b})=>{d({id:b,status:"removing"});const y=c.val.findIndex(k=>k.id===b);y!=-1&&c.val.splice(y,1)},h=({Component:b})=>{const y={id:Math.random().toString(10).split(".")[1],Component:b,status:"inserting"};c.val.length>=i&&v({id:c.val[0].id}),c.val.push(y),setTimeout(()=>v(y),s)},x=b=>r({class:u.item,onclick:()=>v(b)},b.Component());return document.addEventListener("alert.add",b=>h(b.detail)),document.addEventListener("alert.remove",b=>v(b.detail)),r({class:B(u.stack,t==null?void 0:t.class,m.class)},n.loop(c,r(),x))}},Ja=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Ya(e,{deleteAfterDuration:2e4}),i=K(e),s=ke(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Qa=`import { Context } from "@grucloud/bau-ui/context";
...
`,sr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:or,createComponent:nr},{title:"Component hide and show",description:"Hide and show a component",code:rr,createComponent:ar}]},ir=e=>{const t=H(e);return()=>t(sr)};function en(e,t={}){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{size:m=t.size??"md",variant:f=t.variant??"plain",color:v=t.color??"neutral",width:h=40,height:x=40,...b},...y]=V(p);return a({class:B(u,t==null?void 0:t.class,b.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:h,height:x,onload:c,onerror:l,class:B(v,f,m,u,t==null?void 0:t.class,b.class),...b}))}}const tn=e=>{const{css:t}=e,n=en(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`,ur={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:lr,createComponent:cr}],gridItem:tn},dr=e=>{const t=H(e);return()=>t(ur)};function ct(e,t){const{bau:n,css:o,window:a}=e,{dialog:i}=n.tags,s=Ee(e,{class:o`
    ...
    opacity: 0;
  `;return function(...l){let[{contentEl:u,triggerEl:d,onClose:p,...m},...f]=V(l);const v=b=>{x.style.opacity=1,x.showModal();const y=d.getBoundingClientRect(),k=x.getBoundingClientRect();y.x<a.innerWidth/2?x.style.left=y.left+"px":x.style.left=y.right-k.width+"px",y.y<a.innerHeight/2?x.style.top=y.top+y.height+"px":(x.style.top=Math.max(0,y.top-k.height)+"px",k.height>y.top&&(x.style.height=y.top+"px"))},h=b=>{const y=()=>{x.close(),x.removeEventListener("transitionend",y)};x.addEventListener("transitionend",y),x.style.opacity=0},x=i({role:"presentation",class:B("popover",r,t==null?void 0:t.class,m==null?void 0:m.class),onclick:b=>b.target===x&&(h(),p==null?void 0:p.call())},s(u));return x.closeDialog=h,x.openDialog=v,x}}const pr=()=>ee.map(e=>`
&.input.${e} {
...
`);function ve(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${pr()}
  `;return function(r){const{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",...d}=r;return a({type:"text",...d,disabled,class:B("input",t.class,c,u,l,i,d.class)})}}const mr=()=>ee.map(e=>`
...
`);function nn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=ct(e),r=K(e),c=ve(e),l=fe(e),u=o`
    ...
    ${mr()}
  `;return function(...p){let[{size:m=k.size??"md",variant:f=k.variant??"plain",color:v=k.color??"neutral",id:h,label:x,placeholder:b,Option:y,options:k,getOptionLabel:A=({label:_})=>_,...N},...T]=V(p);const D=n.state(""),M=n.state(""),L=n.state(!1),q=n.state(0),J=()=>{L.val=!1},z=n.state(k),W=()=>{F.openDialog(),L.val=!0,M.val="",z.val=k},U=()=>{F.closeDialog(),L.val=!1,M.val=""},C=_=>{const{value:P}=_.target;M.val=P,P?z.val=k.filter(X=>A(X).match(new RegExp(`${P}`,"i"))):z.val=k},g=_=>{L.val?U():W()},w=({option:_,index:P})=>X=>{D.val=A(_),q.val=P,U()},S=_=>{switch(console.log("onkeydown",_.key,q.val),_.key){case"Escape":U();break;case"ArrowDown":q.val<z.val.length-1?q.val++:q.val=0;break;case"ArrowUp":q.val<=0?q.val=z.val.length-1:q.val--;break;case"Enter":D.val=A(z.val[q.val]),M.val="",U();break}},E=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":L,"aria-label":x,onclick:g,variant:f,color:v,size:m},()=>!D.val&&x,D),R=c({id:h,value:M,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":L,oninput:C,onkeydown:S,variant:f,color:v,size:m}),F=s({id:h,triggerEl:E,contentEl:(()=>a({class:B(f,v,m,"content")},R,()=>l({class:B(f,v,m)},z.val.map((_,P)=>i({class:()=>B(q.val==P&&"active"),onclick:w({option:_,index:P})},y(_))))))(),onClose:J});return a({...N,class:B("autocomplete",u,t==null?void 0:t.class,N==null?void 0:N.class)},E,F)}}const on=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=nn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,wr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:xr,createComponent:vr}],gridItem:rn},yr=e=>{const t=H(e);return()=>t(wr)};function sn(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,c=K(e),l=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...d){let[{size:p=t.size??"md",variant:m=t.variant??"plain",color:f=t.color??"neutral",items:v,...h},...x]=V(d);return i({...h,class:B(l,t==null?void 0:t.class,h==null?void 0:h.class)},v.map(({href:b,name:y})=>s((b?c:r)({href:`${a.base}${b}`,color:f,variant:m,size:p,class:B(f,m,p)},y))))}}const cn=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=sn(e);return o=>n({...o,...t})},Cr=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=sn(e);return()=>n(a(o))},Sr=`import breadcrumbs, {
...
`);function lt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${Br()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=V(r);return a({...d,class:B("button-group",l,u,c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const un=e=>{const t=["ONE","TWO","THREE"],n=K(e),o=lt(e);return a=>o({...a},t.map(i=>n(a,i)))},$r=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=K(e),i=lt(e),s="primary",r="solid";return()=>n(i({color:s,variant:r},o.map(c=>a({color:s,variant:r},c))))},Pr=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,zr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Lr,createComponent:Rr}],gridItem:pn},jr=e=>{const t=H(e);return()=>t(zr)};function Hr(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:m,Previous:f,Next:v,...h}]=V(c);const x=()=>{s.val<=0?s.val=p.length-1:s.val--},b=()=>{s.val>=p.length-1?s.val=0:s.val++},y=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(m));return a({...h,class:B("carousel",l,i,t==null?void 0:t.class,h==null?void 0:h.class)},a({class:B("control","control-previous"),onclick:x},f()),a({class:B("control","control-next"),onclick:b},v()),y)}}const Gr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],Ur=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=K(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,Xr={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:qr,createComponent:Kr}],gridItem:mn},Zr=e=>{const t=H(e);return()=>t(Xr)};function gn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=V(r);return a({type:"checkbox",required:"required",...d,class:B(i,u,l,c,t==null?void 0:t.class,d==null?void 0:d.class)})}}const bn=e=>{const{bau:t,css:n}=e,{label:o}=t.tags,a=gn(e);return i=>o({class:n`
          display: flex;
...
`,ps={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:ds,createComponent:us}],gridItem:e=>hn(e,{base:"/components/drillDownMenu",hashBased:!0})},ms=e=>{const t=H(e);return()=>t(ps)};function ut(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(u,...d){const{size:p=t.size??"md",variant:m=t.variant??"plain",color:f=t.color??"neutral",Component:v,disabled:h,...x}=u;return a({class:B(c.base,h&&c.disabled,t==null?void 0:t.class,u.class)},s({class:B(m,f,p)},v({disabled:h}),r({type:"file",disabled:h,...x})),i({class:"filename-display"}))}}const fn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),u=ut(e),d=m=>{const f=m.target.files[0];f?l.val=f.name:l.val="No file selected"},p=({disabled:m})=>r({class:B(o`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,m&&o`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return m=>u({Component:p,name:"file",accept:"text/*",onchange:d,...m})},gs=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,u=n.state("No file selected"),d=ut(e),p=f=>{const v=f.target.files[0];v?u.val=v.name:u.val="No file selected"},m=({disabled:f})=>c({class:B(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`,hs={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:bs,createComponent:gs}],gridItem:fn},fs=e=>{const t=H(e);return()=>t(hs)};function Te(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:d,...p},...m]=V(r);return a({...p,class:B("form",u,l,c,i,t==null?void 0:t.class,p==null?void 0:p.class)},...m)}}const Oe={sm:12,md:16,lg:24},vs=()=>ee.map(e=>`
&.${e} {
...
100% {
  ...
  `;return function({size:u=t.size??"md",color:d=t.color??"primary",variant:p=t.variant??"outline",visibility:m=!0,...f}={}){const v=o`
      visibility: hidden;
      opacity: 0;
      ...
      ${vs()}
    `;return i({class:{deps:[m],renderProp:()=>h=>B("spinner",v,d,p,h==!1?"":"visibility",t==null?void 0:t.class,f.class)},version:"1.1",x:"0px",y:"0px",width:Oe[u],height:Oe[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...f},s({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}function dt(e,t){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:m,...f},...v]=V(l);const h=K(e),x=He(e);return n.bind({deps:[m],render:()=>b=>h({...f,class:B("loadingButton",u,d,p,r,b&&"loading",t==null?void 0:t.class,f==null?void 0:f.class)},x({size:u,variant:d,color:p,visibility:b}),i({class:b&&"loading"},v))})}}const xs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=dt(e),d=ke(e,{variant:"outline",color:"danger"}),p=ve(e),m=Te(e,{class:n`
      align-items: center;
      & > header {
        text-align: center;
      }
...
`),r=a`
  ...
  `,c=o`
    ...
    ${s()}
  `;return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"plain",color:m=t.color??"neutral",running:f,...v}]=V(u);return i({...v,role:"progressbar",class:{deps:[f],renderProp:()=>h=>B("linearProgress",d,m,c,h&&"running",t==null?void 0:t.class,v==null?void 0:v.class)}})}}const wn=e=>{const t=xn(e);return n=>t({...n,running:!0})},As=e=>{const{bau:t}=e,{section:n,hr:o}=t.tags,a=K(e),i=xn(e),s=t.state(!1);return()=>n(a({variant:"solid",color:"primary",onclick:()=>s.val=!s.val},()=>s.val?"Stop":"Start"),o,i({running:s}))},Is=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,qs={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Ks,createComponent:Vs}]},Xs=e=>{const t=H(e);return()=>t(qs)};function Zs(e,t){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
  ...
  `,u=({text:d})=>({name:p,label:m,href:f})=>s({href:`${a.base}${f}`},r({class:"sublabel"},d),i({class:`label ${d}`},m??p));return function(...p){let[{size:m=t.size??"md",variant:f=t.variant??"plain",color:v=t.color??"neutral",data:h={},...x}]=V(p);const{next:b,previous:y}=h;return c({"data-paginationnav":JSON.stringify(h),"aria-label":"pages navigation",...x,class:B("paginationNavigation",m,l,t==null?void 0:t.class,x==null?void 0:x.class)},(y==null?void 0:y.href)&&u({text:"Previous"})(y),(b==null?void 0:b.href)&&u({text:"Next"})(b))}}const Ys=e=>{const{bau:t}=e,{section:n}=t.tags,o=Zs(e),a={next:{name:"next page",label:"Popover",href:"/components/popover"},previous:{name:"previous page",label:"Paper",href:"/components/paper"}};return()=>n(o({variant:"solid",color:"primary",data:a}))},Js=`import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",...p}]=V(c);return a({...p,type:"radio",class:B("radio-button",l,d,u,s,t==null?void 0:t.class,p==null?void 0:p.class)})}}const En=e=>{const{bau:t,css:n}=e,{label:o,form:a}=t.tags,i=Sn(e);return s=>a({class:n`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`);function Ge(e,t){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=K(e),l=ct(e),u=fe(e),d=o`
    ...
    ${ui()}
  `;return function(...m){let[{size:f=y.size??"md",variant:v=y.variant??"plain",color:h=y.color??"neutral",label:x,Option:b,options:y,getOptionLabel:k=({label:E})=>E,...A},...N]=V(m);const T=n.state(""),D=n.state(!1),M=n.state(0),L=()=>{w.openDialog(),w.focus(),D.val=!0},q=()=>{w.closeDialog(),D.val=!1},J=()=>{D.val=!1},z=E=>{D.val?q():L(),E.preventDefault()},W=({option:E,index:R})=>$=>{T.val=k(E),S.value=T.val,S.setCustomValidity(""),M.val=R,q(),$.preventDefault()},U=E=>{switch(E.preventDefault(),E.key){case"Escape":q();break;case"ArrowDown":M.val<y.length-1?M.val++:M.val=0;break;case"ArrowUp":M.val<=0?M.val=y.length-1:M.val--;break;case"Enter":D.val?(T.val=k(y[M.val]),q()):L();break}},C=()=>u({tabindex:"0",class:B(h,v)},y.map((E,R)=>i({class:()=>B(M.val==R&&"active"),onclick:W({option:E,index:R})},b(E)))),g=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":D,"aria-label":x,onclick:z,color:h,variant:v,size:f},()=>!T.val&&x,T),w=l({triggerEl:g,contentEl:C(),onClose:J}),S=s(A,r({value:""},"--Select Category--"),y.map(E=>r(k(E))));return a({...A,class:B("select",h,f,d,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:U},S,g,w)}}const kn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ge(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function In(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
    ...
    ${Di()}
  `;return function(...u){let[{color:d,variant:p="plain",size:m,stepperDefs:f=[],activeStepIndex:v,...h},...x]=V(u);const b=n.state(f.map((N,T)=>({...N,index:T}))),y=n.derive(()=>b.val[v.val]),k=N=>{const{Header:T,disabled:D,name:M,index:L}=N;return s({class:()=>B(y.val.name==M&&"active",v.val<L&&"not-completed",v.val>L&&"completed",D&&"disabled")},r({class:"step-number"},L+1),r({class:"step-label"},()=>T(N)))};return a({class:B("stepper",p,m,d,c,t==null?void 0:t.class,h.class)},n.loop(b,i(),k),n.bind({deps:[y],render:()=>N=>N.Content?N.Content({}):""}))}}const Ni=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=In(e),r=K(e),c=({name:f})=>f,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},m=()=>a({class:n`
          display: flex;
          justify-content: space-around;
...
`,Bi=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=K(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
    ...
    `;return y({name:"form-config-azure",onsubmit:T,"data-infra-create":!0,class:D},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",m("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",b({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",pattern:String.raw`\w{32,32}`,title:"Length should be 32 characters.",required:!0}))),u(d("Tenant Id"),s("Retrieve the ",m("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",b({"data-input-azure-tenant-id":!0,autofocus:!0,placeholder:"Tenant Id",name:"tenantId",pattern:String.raw`\w{36,36}`,title:"Length should be 36 characters.",required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",m("APP_ID")," and ",m("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),f({class:n`
                  display: flex;
                  gap: 1rem;
                `},r("App Id",b({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",pattern:String.raw`\w{36,36}`,title:"Length should be 36 characters.",required:!0})),r("Password",b({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",pattern:String.raw`\w{8,64}`,title:"Length should be greater than 8 and below 64",required:!0})))))),x(h({onclick:A}),v({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},ji=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:m,a:f,table:v,tbody:h,th:x,tr:b,td:y}=t.tags,{svg:k,use:A}=t.tagsNS("http://www.w3.org/2000/svg"),N=ut(e),T=K(e),D=Te(e),M=We(e),L=Fe(e);return function({onclickPrevious:J,onclickNext:z}){const W=t.state("No file selected"),U=t.state({}),C=t.state(!0),g=$=>{const F=$.target.files[0];if(F){W.val=F.name;const _=new FileReader;_.readAsText(F),_.onload=()=>{try{debugger;if(_.result){const P=JSON.parse(_.result);U.val=P,P.project_id&&(C.val=!1)}}catch{}},_.onerror=()=>{console.log(_.error)}}else W.val=""},w=({fileName:$,content:F})=>v({class:n`
          ...
          `},h(b(x("Credential File"),y($)),b(x("Project Name"),y(F.project_id)),b(x("Service Account"),y(F.client_email)))),S=({})=>c({class:n`
            display: inline-flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`);function Ae(e,t){const{bau:n,css:o}=e,{tabDefs:a}=t,{div:i,ul:s,li:r}=n.tags,c=o`
    ...
    ${Zi()}
  `;return function(...u){let[{color:d,variant:p="plain",size:m,...f},...v]=V(u);const h=n.state(a),x=n.state(a[0]),b=A=>h.val.find(N=>N.name==A),y=A=>{const{Header:N,disabled:T,name:D}=A;return r({class:()=>B(x.val.name==D&&"active",T&&"disabled"),onclick:M=>M.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:D},bubbles:!0}))},N(A))},k=i({class:B("tabs",p,m,d,c,t==null?void 0:t.class,f.class)},n.loop(h,s(),y),()=>x.val.Content?x.val.Content({}):"");return k.addEventListener("tab.select",A=>{var D,M;const{tabName:N}=A.detail,T=b(N);T&&((D=x.val.exit)==null||D.call(),x.val=T,(M=T.enter)==null||M.call())},!1),k.addEventListener("tab.add",A=>{var T;const{tab:N}=A.detail;(T=N.enter)==null||T.call(),h.val.push(N)},!1),k.addEventListener("tab.remove",A=>{var T;const N=h.val.findIndex(D=>D.name==A.detail.tabName);N>0&&((T=h.val[N].exit)==null||T.call(),h.val.splice(N,1))},!1),k}}const Mn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Ae(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return s=>i(s)},Yi=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Ae(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return()=>i({variant:"outline",color:"neutral"})},Ji=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=V(c);return i({...l,class:B("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const ic=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(h,x,b,y,k){return{name:h,calories:x,fat:b,carbs:y,protein:k}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],m=({name:h,calories:x})=>s(i(h),i({class:n`
            text-align: right;
          `},x)),f=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
              text-align: right;
            `,title:"Calories"},"Calories"))),v=Ie(e,{class:n`
      max-width: 650px;
    `});return()=>o(v(r(u("Basic Table"),f(),l(p.map(m)))))},cc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,xc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:vc,createComponent:fc}]},wc=e=>{const t=H(e);return()=>t(xc)};function $n(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=lt(e),s=K(e),r=He(e),c=o`
  ...
  `,l=({label:f,icon:v,...h})=>s({"aria-label":f,title:f,...h},v),u=({count:f,totalCount:v,page:h,rowsPerPage:x})=>a({class:"pages-numbers"},Number(h-1)*Number(x)+(f>0?1:0),"-",Math.min(h*x,v)," of ",v),d=({count:f,page:v,rowsPerPage:h})=>a({class:"pages-numbers"},(v-1)*h+(f>0?1:0),"-",v*h),p=f=>f<=1,m=(f,v,h)=>f>=Math.ceil(v/h);return function(...v){let[{count:h=0,totalCount:x=0,page:b=1,rowsPerPage:y=50,onPageChange:k,isLoading:A=!1,disableFirst:N=()=>p(b),disablePrevious:T=()=>p(b),disableNext:D=()=>m(b,x,y),disableLast:M=()=>m(b,x,y),...L},...q]=V(v);const J=Math.max(0,Math.ceil(x/y)),z=k({page:1}),W=k({page:b-1}),U=k({page:b+1}),C=k({page:J}),g=[{label:"First",icon:"⟪",onclick:z,disabled:N()},{label:"Previous",icon:"⟨",onclick:W,disabled:T()},{label:"Next",icon:"⟩",onclick:U,disabled:D()},{label:"Last",icon:"⟫",onclick:C,disabled:M()}];return a({...L,class:B("table-pagination",c,A&&"disabled",t==null?void 0:t.class,L==null?void 0:L.class)},r({class:"spinner",visibility:A,size:"md"}),x>0?u({count:h,totalCount:x,page:b,maxPages:J,rowsPerPage:y}):d({count:h,page:b,maxPages:J,rowsPerPage:y}),i({variant:"outline",color:"neutral"},g.map(w=>l({...w,variant:"outline",color:"neutral"}))))}}const yc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Cc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=yc(45),u=({name:b,email:y})=>i(a(b),a(y)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),p=$n(e),m=Ie(e,{class:n`
      max-width: 650px;
    `}),f=t.state(l),v=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=t.derive(()=>f.val.slice(v.val.page*v.val.rowsPerPage,(v.val.page+1)*v.val.rowsPerPage)),x=({page:b})=>y=>{v.val.page=b};return()=>m(s(d(),()=>c(h.val.map(u))),()=>p({...v.val,onPageChange:x}))},Sc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),m=t.derive(()=>d.val.length),f=t.state(1),v=t.state(10),h=t.derive(()=>d.val),x=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,b=({page:M})=>L=>{f.val=M,y(x({page:M,per_page:v.val}))};y(x({page:1,per_page:v.val}));async function y(M){try{u.val=!0;const L=await fetch(M,{});if(L.ok){const q=await L.json();d.val=q;return}throw L}catch(L){p.val=L.message}finally{u.val=!1}}const k=({name:M,description:L,stargazers_count:q})=>i(a(M),a(L),a({class:n`
            text-align: right;
          `},q)),A=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),D=({message:M})=>l(M);return()=>T(()=>N({rowsPerPage:v.val,page:f.val,count:m.val,totalCount:-1,isLoading:u.val,onPageChange:b,disableNext:()=>!1}),s(A(),()=>p.val&&D({message:p.val}),()=>c(h.val.map(k))))},Ec=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=Cc(e),l=Sc(e),u=(...d)=>a({class:n`
  ...
  `;return function(...c){let[{color:l,variant:u,size:d="md",selected:p=!1,disabled:m,onChange:f,...v},...h]=V(c);return i({type:"button",...v,"aria-pressed":{deps:[p],renderProp:()=>x=>x},class:{deps:[p],renderProp:()=>x=>B("toggle",d,l,u,s,x&&"selected",t==null?void 0:t.class,v==null?void 0:v.class)},disabled:m},h)}}const Pn=e=>{const{bau:t}=e,n=De(e);return console.log("grid item"),o=>{const a=t.state(!1);return n({...o,selected:a,onclick:()=>a.val=!a.val},"Toggle Me")}},kc=e=>{const{bau:t}=e,{section:n}=t.tags,o=De(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Tc=`import toggle from "@grucloud/bau-ui/toggle";
...
`,Pc={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Mc,createComponent:Nc},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:$c,createComponent:Bc}],gridItem:On},Oc=e=>{const t=H(e);return()=>t(Pc)};function gt(e,t){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",color:d="neutral",variant:p="outline",size:m="md",...f},...v]=V(c);const h=i({class:B("container",...u.split("-"))},i({class:B("content",d,p,m),role:"tooltip"},l)),x=T=>`move-to-${T}`,b=(T,D,M)=>{if(T()){const L=x(D);h.classList.add(L),h.classList.add(D),h.classList.remove(M)}},y=(T,D)=>{const M=x(T);h.classList.contains(M)&&(h.classList.remove(M),h.classList.add(D),h.classList.remove(T))},k=T=>{const D=h.getBoundingClientRect();b(()=>D.x<0,"right","left"),b(()=>D.x+D.width>a.innerWidth,"left","right"),b(()=>D.y<0,"bottom","top"),b(()=>D.bottom>a.innerHeight,"top","bottom"),h.classList.add("visible")},A=T=>{h.classList.remove("visible"),y("right","left"),y("left","right"),y("bottom","top"),y("top","bottom")};return i({...f,class:B("tooltip",s,t==null?void 0:t.class,f==null?void 0:f.class),bauMounted:({element:T})=>{T.addEventListener("mouseover",k),T.addEventListener("mouseout",A)},bauUnmounted:({element:T})=>{T.removeEventListener("mouseover",k),T.removeEventListener("mouseout",A)}},...v,h)}}const _n=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=K(e),s=gt(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return c=>s({titleEl:r(),...c},i(c,`${c.color} ${c.variant}`))},_c=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,i=K(e),s=gt(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return()=>s({side:"bottom-start",titleEl:r()},i("tooltip"))},Rc=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,{nav:e`
  ...
  `});function Ln(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Vc({css:o,createGlobalStyles:a}),d=it(e),p=({depth:m=1,maxDepth:f,color:v,variant:h,size:x})=>b=>{const{children:y,expanded:k}=b,A=n.state(!k),N=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:D=>{y&&(A.val=!A.val)}},i(b.data)),T=()=>s({class:B(v,x)},y.map(p({depth:m+1,maxDepth:f})));return r(d({Header:N,Content:y&&m<f&&T}))};return function({tree:f,maxDepth:v=1/0,size:h="md",variant:x="plain",color:b="neutral",...y}){return c({class:B(u.nav,h,x,b,t==null?void 0:t.class,y.class)},f.children&&s(f.children.map(p({maxDepth:v,color:b,variant:x,size:h}))))}}const zn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ln(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Kc=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ln(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},qc=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
