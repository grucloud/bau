...
`);function ie(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
  ...
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"plain",color:b=e.color??"neutral",...g},...f]=W(d);return r({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:B("theme-switch",b,p,m,c,e==null?void 0:e.class,g.class),type:"checkbox",checked:s()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...f)}}function Mo(t){const{tr:e,bau:n,css:o,config:a,states:r}=t,{i,header:s,h1:l,div:c,a:u,img:d,b:m,ul:p,li:b}=n.tags,{svg:g,path:f}=n.tagsNS("http://www.w3.org/2000/svg"),y=r.drawerOpen,v=M(t,{class:o`
    ...
    `}),w=ie(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),E=()=>c({class:o`
          display: flex;
          align-items: center;
          & a {
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("list",r,u,c,l,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}const Ut="0.3s",Ge=({parent:t,grandParent:e})=>n=>{const{children:o,...a}=n,r={...a};return r.children=o==null?void 0:o.map(Ge({parent:n,grandParent:t})),t&&(t.parentTree=e),r.parentTree=t,r},Fe=t=>e=>{var n;if(!t)return e;if(((n=e==null?void 0:e.data)==null?void 0:n.href)==t)return e.children?e:e.parentTree;if(e.children)for(let o=0;o<e.children.length;o++){const a=Fe(t)(e.children[o]);if(a)return a}},Oo=({keyframes:t})=>({hideToLeft:t`
  from {
  ...
  `,hideToRight:t`
   ...
   `});function ce(t,e={}){const{bau:n,css:o,window:a,config:r}=t,{base:i="",hashBased:s=!1}=e,l=`${r.base}${i}`,c=z=>{var C;return((C=z.parentTree.data)==null?void 0:C.href)??z.parentTree.children[0].data.href},u=({variant:z,color:C,size:h,currentTree:x,data:k})=>w(A({variant:z,color:C,size:h,href:`${l}${c(x)}`,class:o`
            flex-grow: 0;
  ...
  `,P=({children:z,pathnameState:C,variant:h,color:x,size:k})=>D({class:B(h,x,k)},z.map(T=>f({class:()=>B(T.children&&"has-children",g({pathname:C.val,subTree:T})&&"active")},b({variant:h,color:x,size:k,subTree:T})))),_=({variant:z,color:C,size:h,currentTree:x,pathnameState:k})=>{const{children:T,parentTree:F,data:j,renderList:V}=x;return v({class:B("drillDownMenu",z,C,h)},F&&p({variant:z,color:C,size:h,data:j,currentTree:x}),T&&V?V({renderListDefault:P,children:T,pathnameState:k,variant:z,color:C,size:h}):P({children:T,pathnameState:k,variant:z,color:C,size:h}))},G=({tree:z,pathname:C})=>{let h=Ge({})({...z}),x=Fe(C)(h);return x||(x=h),x},H=({target:z})=>{let h=z.closest("a").getAttribute("href").replace(l,"");return s||(h=h.replace(z.hash,"")),h};return function(C){const{size:h=e.size??"md",variant:x=e.variant??"plain",color:k=e.color??"neutral",tree:T,...F}=C,j=n.state(a.location.pathname.replace(l,""));let V=G({tree:T,pathname:j.val});const J=n.state(JSON.stringify(V.data));let I;a.document.addEventListener("click",Y=>{const{target:rt}=Y,ct=rt.closest("a");if(!ct)return;const lt=ct.getAttribute("href");lt&&!lt.startsWith("http")&&!lt.startsWith("#")&&!lt.startsWith("?")&&(V=G({tree:T,pathname:H(Y)}),J.val=JSON.stringify(V.data),j.val=H({target:rt}))});const X=Y=>{const{buttonback:rt,ischild:ct}=Y.target.dataset;rt=="true"?I=-1:ct=="false"?I=1:ct=="true"&&(I=0)},nt=Y=>{switch(Y){case 1:return`${N} ${Ut}`;case-1:return`${O} ${Ut}`;default:return""}},Z=Y=>{switch(Y){case 1:return`${O} ${Ut} reverse`;case-1:return`${N} ${Ut} reverse`;default:return""}};return y({class:B(L,x,k,h,e==null?void 0:e.class,F.class),onclick:X},E({animationHide:()=>nt(I),animationShow:()=>Z(I)},n.bind({deps:[J],render:()=>()=>_({variant:x,color:k,size:h,currentTree:V,pathnameState:j})})))}}const $o=()=>ot.map(t=>`
&.input.${t} {
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:B("input",e.class,e.size??"md",c,l,r,u.class)})}}function le(t,e={}){const{bau:n,css:o,window:a}=t,r=dt(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,p=o`
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:B("inputSearch",e.class,p,u.class)})}}function Ue(t){const{tr:e,bau:n,css:o,config:a,states:r,window:i}=t,{div:s,ul:l,li:c,nav:u,a:d,span:m,form:p}=n.tags,b=le(t,{variant:"plain",color:"neutral",size:"sm",class:o`
      margin: 0.5rem;
    `}),f={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:w,children:S,pathnameState:E,variant:D,color:A,size:N})=>{const O=n.state(""),L=n.derive(()=>O.val==""?S:S.filter(_=>_.data.name.match(new RegExp(`${O.val}`,"i")))),P=_=>{O.val=_.target.value};return p({class:o`
          display: flex;
          flex-direction: column;
          gap: 0;
        `},b({autocomplete:"off",name:"component-search",autofocus:!0,value:O,placeholder:`Search ${L.val.length} components`,size:32,oninput:P}),()=>w({children:L.val,pathnameState:E,variant:D,color:A,size:N}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Key Value List",href:"/components/keyValueList"}},{data:{name:"Lazy",href:"/components/lazy"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Multi Select",href:"/components/multiSelect"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Radio Button Group",href:"/components/radioButtonGroup"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let y=!1;const v=ce(t);return function(){return s({bauMounted:({element:S})=>{i.innerWidth<=640&&(y=!0,r.drawerOpen.val=!1)},onclick:S=>{y&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(r.drawerOpen.val=!1)},style:()=>r.drawerOpen.val?"display:block;":"display:none;",class:B(o`
          ...
          `)},v({tree:f}))}}const Lo=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:r}=e.tags,i=qt(t),s=Mo(t),l=Ue(t),c=Io(t),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `,s=({title:l,Content:c})=>o({className:"feature"},a(l),r(c()));return function({featuresContent:c}){return o({class:i},c.map(s))}}function jo({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:r,dd:i,div:s,aside:l,footer:c,a:u}=e.tags,d=({maxSize:m=151})=>({libName:p,size:b})=>s({class:n`
        ...
        `},l({class:n`
          ...
          `},p.map(d({}))),c({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Ro(t){const{bau:e,css:n,config:o}=t,{div:a,p:r,a:i,section:s}=e.tags,l=Po(t),c=zo(t),u=M(t);Ot(t);const d=jo(t),m=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("paper",l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}function sn(t,e={}){const{bau:n,css:o,window:a}=t,{nav:r,ul:i,li:s,a:l}=n.tags,{headerSelector:c="h2,h3"}=e,u=n.state("no"),d=(f,y)=>{let v=null;return(...w)=>{a.clearTimeout(v),v=a.setTimeout(()=>f(...w),y)}},m=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,p=({value:f,id:y,children:v=[]})=>{const w=l({class:()=>u.val==y?"active":"",href:`#${y}`});return w.innerHTML=f,s({class:()=>u.val==y?"active":""},w,v.length>0&&i(v.map(p)))},b=f=>f.tagName.charAt(1),g=({contentEl:f})=>{const y=f.querySelectorAll(c);let v=2,w={},S={children:[]},E=S;const D=E;let A=[E];return[...y].forEach(N=>{const O=b(N);N.setAttribute("id",N.textContent),!N.innerHTML.includes("<button")&&(w={value:N.innerHTML,id:N.id??N.textContent,children:[]},v==O?(S=w,E.children.push(S)):v<O?(A.push(E),E=S,S.children.push(w),S=w):v>O&&(E=A[O-1],A=A.slice(0,O-1),E.children.push(w),S=w),v=O)}),D};return function(...y){let[{size:v=e.size??"md",variant:w=e.variant??"plain",color:S=e.color??"neutral",contentEl:E,...D}]=W(y);const A=g({contentEl:E}),N=d(()=>{const L=[...E.querySelectorAll(c)].find(P=>{const{top:_,height:G}=P.getBoundingClientRect();if(_+G>60)return!0});L&&(u.val=L==null?void 0:L.id)},100);return r({...D,class:B("tableOfContent",v,w,S,m,e==null?void 0:e.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",N)},bauUnmounted:()=>{a.removeEventListener("scroll",N)}},A.children&&i(A.children.map(p)))}}const cn=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(l(i(c(m??""),ot.map(p=>c(p)))),r(To.map(p=>i(c(p),ot.map((b,g)=>s(d({color:b,variant:p},{index:g}))))))))}},Ha=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Do.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},U=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;Nt.registerLanguage("javascript",rn);const m=sn(t),p=be(t,{class:n`
      &.paper {
    ...
    `}),b=cn(t),g=Ha(t),f=({text:y})=>u({class:n`
        ...
        `},w,m({contentEl:w}))}};function ge(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    overflow: hidden;
    background-color: inherit;
    display: flex;
    flex-direction: column;
...
`);function Kt(t,e={}){const{bau:n,css:o}=t,{div:a,ul:r,li:i,h3:s,button:l}=n.tags,c=o`
    ...
    ${Va()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"plain",color:b=e.color??"neutral",data:g=[],...f}]=W(d);const y=n.state(""),v=ge(t,{size:m,variant:p,color:b}),w=E=>D=>{y.val==E?y.val="":y.val=E},S=E=>{const{Header:D,Content:A,name:N}=E,O=()=>s({class:()=>B(y.val==N&&"active")},l({type:"button","aria-controls":`bau-${N}`,"aria-expanded":({element:P})=>y.val==N},D(E))),L=()=>a({id:`bau-${N}`,"data-state":({element:P})=>y.val==N},A(E));return i({class:B(b,p,m),onclick:w(N)},v({Header:O,Content:L}))};return a({class:B("accordion",c,e==null?void 0:e.class,f.class)},r(g.map(S)))}}const ln=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Kt(t,e);return s=>i({...s,data:r})},Ja=t=>{const{bau:e}=t,{div:n,p:o,section:a}=e.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Kt(t,{color:"neutral",variant:"outline"});return()=>a(i({data:r}))},qa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,un=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Wa=t=>{const{css:e}=t,n=un(t),o=Kt(t,{color:"warning",class:e`
      &.accordion {
        & ul {
          & li {
            width: fit-content;
...
`,Xa=t=>{const{css:e}=t,n=un(t),o=Kt(t,{color:"success",variant:"outline",class:e`
      &.accordion {
        & ul {
          & li {
            & h3 {
...
`,Ya={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:qa,createComponent:Ja},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Ka,createComponent:Wa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Za,createComponent:Xa}],gridItem:ln},Qa=t=>{const e=U(t);return()=>e(Ya)},tr={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},er=()=>ot.map(t=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`,hr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:fr,createComponent:gr}]},vr=t=>{const e=U(t);return()=>e(hr)};function Et(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",width:f=40,height:y=40,alt:v,...w},...S]=W(m);const E=Et(t,{class:B(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${y}px;
          width: ${f}px;
        `,e==null?void 0:e.class,w.class)});return a({class:B(u,e==null?void 0:e.class,w.class)},()=>i.val&&E(),()=>s.val&&v,r({alt:v,width:f,height:y,onload:l,onerror:c,class:()=>B(!i.val&&"visible",s.val&&"hide",g,b,p,u,e==null?void 0:e.class,w.class),...w}))}}const mn=(t,e)=>{const{css:n}=t,o=fe(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`,Cr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:xr,createComponent:yr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:wr,createComponent:Sr}],gridItem:mn},kr=t=>{const e=U(t);return()=>e(Cr)};function $t(t,e){const{bau:n,css:o,window:a}=t,{dialog:r}=n.tags,i=o`
    ...
    opacity: 0;
  `;return function(...l){let[{contentEl:c,triggerEl:u,onClose:d,...m},...p]=W(l);const b=y=>{f.style.opacity=1,f.showModal();const v=u.getBoundingClientRect(),w=f.getBoundingClientRect();v.x<a.innerWidth/2?f.style.left=v.left+"px":f.style.left=v.right-w.width+"px",v.y<a.innerHeight/2?(f.style.top=v.top+v.height+"px",f.style.height=Math.min(f.scrollHeight,a.innerHeight-v.top-v.height)+"px"):(f.style.top=Math.max(0,v.top-w.height)+"px",f.scrollHeight>v.top&&(f.style.height=v.top+"px"))},g=y=>{const v=()=>{f.close(),f.removeEventListener("transitionend",v)};f.addEventListener("transitionend",v),f.style.opacity=0},f=r({role:"presentation",class:B("popover",i,e==null?void 0:e.class,m==null?void 0:m.class),onclick:y=>{y.target===f&&(g(),d==null||d.call())}},c);return f.closeDialog=g,f.openDialog=b,f}}const Vt={sm:12,md:16,lg:24},Er=()=>ot.map(t=>`
&.${t} {
...
100% {
  ...
  `;return function({size:u=e.size??"md",color:d=e.color??"primary",variant:m=e.variant??"outline",visibility:p=!0,...b}={}){const g=o`
      ...
      ${Er()}
    `;return r({class:{deps:[p],renderProp:()=>f=>B("spinner",g,d,m,f==!1?"":"visibility",e==null?void 0:e.class,b.class)},version:"1.1",x:"0px",y:"0px",width:Vt[u],height:Vt[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...b},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Tr=()=>ot.map(t=>`
...
`);function Xt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:p,Option:b,options:g,defaultOption:f,getOptionLabel:y,getOptionValue:v,onSelect:w=()=>{},id:S,required:E,name:D,loading:A,...N},...O]=W(l);const L=$t(t),P=M(t),_=dt(t,{variant:u,color:d,size:c}),G=yt(t),H=bt(t,{variant:u,color:d,size:c}),z=n.state(f),C=n.state(N.value),h=n.state(!1),x=n.state(0),k=()=>{h.val=!1},T=n.state(g),F=Q=>at=>Q.val&&y(at)==y(Q.val),j=()=>{ut.openDialog(),h.val=!0,C.val="",T.val=g,x.val=g.findIndex(F(z));const Q=Dt.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ct.scrollIntoView({block:"end"}))},V=()=>{ut.closeDialog(),h.val=!1,x.val=0},J=Q=>{const{value:at}=Q.target;C.val=at,at?T.val=g.filter(_t=>y(_t).match(new RegExp(`${at}`,"i"))):T.val=g},I=Q=>{ut.open?V():j()},X=Q=>{z.val=Q,lt.value=v(Q)},nt=({option:Q,index:at})=>_t=>{X(Q),x.val=at,V()},Z=()=>{const Q=Dt.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":x.val<T.val.length-1?x.val++:x.val=0,Z();break;case"ArrowUp":x.val<=0?x.val=T.val.length-1:x.val--,Z();break;case"Enter":ut.open?(X(T.val[x.val]),V()):j(),Q.preventDefault();break}},rt=P({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,"aria-label":m,onclick:I,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>z.val?y(z.val):m,()=>A==!0&&H({visibility:A})),ct=_({value:C,placeholder:p,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:J,onkeydown:Y,...N}),lt=_({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:f&&v(f),required:E,"aria-hidden":!1,"aria-label":D,name:D}),Dt=a({class:B(u,d,c,"content")},ct,()=>G({class:B(u,d,c)},T.val.map((Q,at)=>r({class:()=>B(x.val==at&&"active",F(z)(Q)&&"selected"),onclick:nt({option:Q,index:at})},b(Q))))),ut=L({id:S,triggerEl:rt,contentEl:Dt,onClose:k,class:o`
        overflow: hidden;
      `});return a({...N,class:B("autocomplete",i,e==null?void 0:e.class,N==null?void 0:N.class)},n.bind({deps:[z],render:()=>Q=>{Q&&(lt.value=v(Q),w(Q))}}),rt,lt,ut)}}const pn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Xt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(c.label),r(c.code));return c=>i({...c,options:s,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",name:"country","aria-label":"country"})},Dr=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Ar=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,article:i,footer:s}=e.tags,l=Xt(t),c=M(t,{variant:"outline",color:"primary"}),u=d=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Nr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Xt(t),c=M(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ir=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=M(t,{variant:"outline"}),c=M(t,{variant:"solid",color:"primary"}),u=Xt(t),d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(m.flag),s(m.name.common));return()=>{const m=e.state([]),p=e.state(!1),b=e.state("");async function g({url:v,transform:w=S=>S}){try{p.val=!0;const S=await fetch(v,{});if(S.ok){const E=await S.json();m.val=w(E)}else b.val=S.statusText}catch(S){b.val=S.message}finally{p.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:v=>v.sort((w,S)=>w.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:v=>{v.preventDefault();const w=Object.fromEntries(new FormData(v.currentTarget));alert(JSON.stringify(w))}},a({class:n`
            display: flex;
            gap: 1rem;
...
`,$r={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Br,createComponent:Ar},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Or,createComponent:Ir},{title:"Default Option",description:"A autocomplete with a default option.",code:Mr,createComponent:Nr}],gridItem:pn},Lr=t=>{const e=U(t);return()=>e($r)};function bn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,jr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:zr,createComponent:Pr}],gridItem:gn},Rr=t=>{const e=U(t);return()=>e(jr)};function he(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=M(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`,Fr=t=>{const{bau:e}=t,{section:n}=e.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=he(t,{variant:"plain",color:"neutral",separator:"/"});return()=>n(a(o))},Ur=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
  type BreadcrumbsProps,
} from "@grucloud/bau-ui/breadcrumbs";
...
`,Hr={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:Gr,createComponent:_r},{title:"Separator",description:"A breadcrumbs with a custom separator.",code:Ur,createComponent:Fr}],gridItem:fn},Vr=t=>{const e=U(t);return()=>e(Hr)},hn=(t,e={})=>{const n=M(t,e);return o=>n({...o},`${o.variant} ${o.color} ${e.size??""}`)},Jr=t=>{const{bau:e}=t,{section:n}=e.tags,o=M(t,{color:"primary",variant:"outline"});return()=>n(o({onclick:()=>{alert("Click")}},"Click me"))},qr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Xr={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Solid Button",description:"A simple button.",code:qr,createComponent:Jr},{title:"Disabled Button",description:"A disabled button.",code:Kr,createComponent:Wr}],gridItem:hn},Zr=t=>{const e=U(t);return()=>e(Xr)},Yr=()=>ot.map(t=>`
&.button-group.${t} {
...
`,es={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:ts,createComponent:Qr}],gridItem:vn},ns=t=>{const e=U(t);return()=>e(es)};function ye(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>ot.map(s=>`
...
`,is={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Uncontrolled Calendar",description:"A simple calendar.",code:as,createComponent:os},{title:"Controlled Calendar",description:"A controlled calendar.",code:ss,createComponent:rs}],gridItem:yn},cs=t=>{const e=U(t);return()=>e(is)};function ls(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:p,Previous:b,Next:g,...f}]=W(l);const y=()=>{i.val<=0?i.val=m.length-1:i.val--},v=()=>{i.val>=m.length-1?i.val=0:i.val++},w=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(p));return a({...f,class:B("carousel",c,r,e==null?void 0:e.class,f==null?void 0:f.class)},a({class:B("control","control-previous"),onclick:y},b()),a({class:B("control","control-next"),onclick:v},g()),w)}}const us=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ds=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,r=M(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,ps={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:ms,createComponent:ds}]},bs=t=>{const e=U(t);return()=>e(ps)},xn=(t,e)=>{const n=Ot(t,e);return o=>n({...o},`Chip ${o.color} ${o.variant} ${o.size??""}`)},gs=t=>{const{bau:e}=t,{section:n}=e.tags,o=Ot(t,{variant:"outline",color:"primary"});return()=>n(o("My Chip"))},fs=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,hs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:fs,createComponent:gs}],gridItem:xn},vs=t=>{const e=U(t);return()=>e(hs)};function St(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
    margin: 0.5rem;
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({type:"checkbox",...d,class:B(r,u,c,l,e==null?void 0:e.class,d==null?void 0:d.class)})}}const Sn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,r=St(t,e);return i=>a({class:o`
          display: flex;
...
`,Ss=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:r,form:i}=e.tags,s=St(t,{color:"neutral",variant:"outline"}),l=M(t,{variant:"outline",color:"primary"});return()=>i({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & article {
        ...
        `},r(o("My Checkbox",s({name:"my-checkbox-uncontrolled"})),o("My Checkbox with default",s({name:"my-checkbox-uncontrolled-default",defaultChecked:"on"}))),a(l({type:"submit"},"Submit")))},ws=`import checkbox from "@grucloud/bau-ui/checkbox";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Ms={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Ns,createComponent:Bs}]},Is=t=>{const e=U(t);return()=>e(Ms)};function Os(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    display: flex;
    align-items: center;
    .content {
      margin: 1rem;
...
`,Ps={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:Ls,createComponent:$s}],variantColorTableDisable:!0,variantSizeDisable:!0},zs=t=>{const e=U(t);return()=>e(Ps)};function js(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...m},...p]=W(s);return a({class:B(r,e==null?void 0:e.class,m.class)},a({class:()=>B("overlay",d.val&&"overlay-open"),onclick:()=>{d.val=!1}}),a({class:()=>B("content",d.val&&"content-open")},p))}}const Rs=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=js(t),r=M(t,{color:"neutral",variant:"outline"}),i=Ue(t);return()=>{const s=e.state(!1);return n(o("Click on the button to open and close the drawer."),r({onclick:()=>{s.val=!s.val}},"OPEN DRAWER"),a({openState:s},i()))}},_s=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Gs={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:_s,createComponent:Rs}]},Fs=t=>{const e=U(t);return()=>e(Gs)},Us=()=>ot.map(t=>`
`).join(`
`);function wn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=M(t),s=$t(t),l=yt(t),c=o`
    ${Us()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"outline",color:b=e.color??"neutral",label:g,ListItem:f,items:y,...v},...w]=W(d);const S=n.state(0),E=()=>{G.openDialog(),G.focus()},D=()=>{G.closeDialog()},A=()=>{G.open?D():E()},N=H=>{A(),H.preventDefault()},O=({item:H,index:z})=>C=>{S.val=z,D(),C.preventDefault()},L=H=>{switch(H.preventDefault(),H.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},P=()=>l({tabindex:"0",class:B(b,p)},y.map((H,z)=>r({class:()=>B(S.val==z&&"active"),onclick:O({item:H,index:z})},f(H)))),_=i({type:"button",onclick:N,color:b,variant:p,size:m},g),G=s({triggerEl:_,contentEl:P()});return a({...v,class:B("dropdownMenu",b,m,c,e==null?void 0:e.class,v==null?void 0:v.class),onkeydown:L},_,G)}}const Hs=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=wn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},Vs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=wn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Js=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Xs,createComponent:Ks}],gridItem:(t,e)=>Cn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},Ys=t=>{const e=U(t);return()=>e(Zs)};function kn(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
      display: inline-flex;
      & input {
        width: 0.1px;
        height: 0.1px;
...
`,s=o`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",loading:p,...b},...g]=W(c);const f=M(t),y=bt(t);return n.bind({deps:[p],render:()=>v=>f({...b,class:B("loadingButton",u,d,m,s,v&&"loading",e==null?void 0:e.class,b==null?void 0:b.class)},y({size:u,variant:d,color:m,visibility:v}),r({class:v&&"loading"},g))})}}const oi=t=>{const{bau:e,css:n,config:o}=t,{section:a,h1:r,header:i,label:s,img:l,footer:c}=e.tags,u=xe(t,{variant:"solid",color:"primary"}),d=Tt(t,{variant:"outline",color:"danger"}),m=dt(t),p=gt(t,{class:n`
    ...
    `});return function({onLoggedIn:g=()=>{}}){const f=e.state(!1),y=e.state("");return p({onsubmit:async w=>{w.preventDefault();const{username:S,password:E}=Object.fromEntries(new FormData(w.currentTarget));try{f.val=!0;const D=await fetch("/auth/login",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:S,password:E})});if(D.ok){const A=await D.json();g(A)}else D.status==401?y.val="Invalid username or password":y.val=D.statusText}catch(D){y.val=D.message}finally{f.val=!1}}},i(l({width:"100",height:"100",src:`${o.base}/gc.svg`}),r("Login to Grucloud")),a(()=>y.val&&d(y.val),s("Email",m({type:"email",autofocus:!0,placeholder:"Email",name:"username",autocomplete:"username",required:!0})),s("Password",m({type:"password",placeholder:"Password",name:"password",autocomplete:"current-password",minlength:"8",required:!0}))),c(u({type:"submit",loading:f},"Login")))}},ai=`import form from "@grucloud/bau-ui/form";
...
`,yi={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:vi,createComponent:hi}],gridItem:Dn},xi=t=>{const e=U(t);return()=>e(yi)};function An(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding-left: 0;
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("keyValueList",r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}const Si=t=>{const{bau:e}=t,{section:n,li:o,label:a,span:r}=e.tags,i=An(t);return()=>n(i(o(a("My label"),r("My Value")),o(a("My other label"),r("My Other Value"))))},wi=`import keyValueList from "@grucloud/bau-ui/keyValueList";
import { Context } from "@grucloud/bau-ui/context";
...
`,Oi={title:"Lazy",package:"lazy",description:"The lazy component delays the loading of a component, hence improving the initial bundle size.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/lazy/lazy.js",importStatement:'import lazy from "@grucloud/bau-ui/lazy";',examples:[{title:"Simple",description:"Lazy load a component.",code:Ni,createComponent:Bi},{title:"Custom Loader",description:"Custom loader and error",code:Ii,createComponent:Mi}]},$i=t=>{const e=U(t);return()=>e(Oi)};function Mn(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=()=>ot.map(c=>`
&.${c}{
...
`,zi={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:Pi,createComponent:Li}],gridItem:In},ji=t=>{const e=U(t);return()=>e(zi)},On=(t,e)=>{const n=xe(t,e);return o=>n({...o,loading:!0},"Save")},Ri=t=>{const{bau:e}=t,{section:n}=e.tags,o=xe(t,{variant:"solid",color:"primary"});return()=>{const a=e.state(!0);return n(o({loading:a,onclick:()=>a.val=!a.val},"Save"))}},_i=`import { Context } from "@grucloud/bau-ui/context";
import loadingButton from "@grucloud/bau-ui/loadingButton";
...
`,Gi={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:_i,createComponent:Ri}],gridItem:On},Fi=t=>{const e=U(t);return()=>e(Gi)},Ui=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Hi=(t,e)=>{const{bau:n,css:o}=t,{span:a,li:r}=n.tags,i=yt(t,e),s=({code:l,label:c})=>r({class:o`
          display: flex;
          gap: 1rem;
        `},a(l),a(c));return l=>i({...l},Ui.map(s))},Vi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Ji=t=>{const{bau:e,css:n}=t,{section:o,span:a,li:r}=e.tags,i=yt(t,{variant:"outline",color:"primary"}),s=({code:l,label:c})=>r({class:n`
          display: flex;
          gap: 1rem;
...
`,Wi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:qi,createComponent:Ji}],gridItem:Hi},Ki=t=>{const e=U(t);return()=>e(Wi)};function $n(t,e={}){const{bau:n,css:o,window:a}=t,{dialog:r,div:i}=n.tags,l=o`
    margin: auto;
    padding: 1rem;
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
...
`,Yi={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:Zi,createComponent:Xi}],gridItem:Ln},Qi=t=>{const e=U(t);return()=>e(Yi)},tc=()=>ot.map(t=>`
& button.plain.${t}::after {
  color: var(--color-${t});
}
& button.outline.${t}::after {
...
`).join(`
`);function ec(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=M(t),l=$t(t),c=yt(t),u=St(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${tc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",name:y,label:v,Option:w,options:S,defaultValue:E=[],getOptionLabel:D,getOptionValue:A,renderValue:N,onSelect:O=()=>{},loading:L,...P},..._]=W(p);const G=bt(t,{variant:g,color:f,size:b}),H=n.state(E),z=n.state(!1),C=n.state(0),h=()=>{X.openDialog(),X.focus(),z.val=!0},x=()=>{X.closeDialog(),z.val=!1},k=()=>{z.val=!1},T=Z=>{X.open?x():h(),Z.preventDefault()},F=()=>Array.from(nt.selectedOptions).map(({value:Z})=>S.find(Y=>A(Y)==Z)),j=Z=>{switch(Z.preventDefault(),Z.key){case"Escape":x();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Y=Z.currentTarget.querySelectorAll("input")[C.val];Y.checked=!Y.checked;const rt=nt.options[C.val+1];rt.selected=!rt.selected,H.val=F()}else h();break}},V=Z=>Y=>{const rt=[...nt.options].find(({value:ct})=>ct==A(Z));Y.target.checked?rt.selected=!0:rt.selected=!1,H.val=F()},J=()=>c({tabindex:"0",class:B(f,g)},S.map((Z,Y)=>r({class:()=>B(C.val==Y&&"active")},n.tags.label(u({checked:E.find(rt=>A(rt)==A(Z)),name:`${y}-${A(Z)}`,onchange:V(Z)}),w(Z))))),I=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":z,"aria-label":v,onclick:T,color:f,variant:g,size:b,class:L==!0&&"loading",disabled:L},()=>H.val.length?N(H.val):v,()=>L==!0&&G({visibility:L})),X=l({triggerEl:I,contentEl:J(),onClose:k}),nt=i({name:y,multiple:!0,...P},n.tags.option({value:""},"--Category--"),S.map(Z=>n.tags.option({value:A(Z),selected:E.find(Y=>A(Y)==A(Z))},D(Z))));return a({...P,class:B("multiSelect",f,b,d,e==null?void 0:e.class,P==null?void 0:P.class),onkeydown:j},nt,I,X)}}const nc=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=ec(t),l=M(t,{variant:"outline",color:"neutral"}),c=Ot(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=m=>a(m.group);return()=>r({onsubmit:p=>{p.preventDefault();const{selectedOptions:b}=p.target.elements.myMultiSelect,g=Array.from(b).map(({value:f})=>f);alert(JSON.stringify(g))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,uc={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:lc,createComponent:cc}]},dc=t=>{const e=U(t);return()=>e(uc)};function mc(t,e={}){const{bau:n,css:o,config:a}=t,{div:r,a:i,span:s,nav:l}=n.tags,c=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,gc={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:bc,createComponent:pc}]},fc=t=>{const e=U(t);return()=>e(gc)},hc=(t,e)=>{const{bau:n}=t,{div:o}=n.tags,a=be(t,e);return r=>a({...r},o(`Paper ${e.size??""}`))},vc=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=be(t,{size:"md"});return()=>n(a(o("My content")))},yc=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`,xc={title:"Paper",package:"paper",description:"The paper component displays child components on a surface area.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paper/paper.js",importStatement:'import paper from "@grucloud/bau-ui/paper";',examples:[{title:"Default",description:"A simple paper.",code:yc,createComponent:vc}],variantColorTableDisable:!0,gridItem:hc},Sc=t=>{const e=U(t);return()=>e(xc)};function Se(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    cursor: pointer;
    &.sm {
      transform: scale(0.8);
    }
...
&.radio-button.${s} {
  ...
  `).join(`
`))()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=W(l);return a({...m,type:"radio",class:B("radio-button",c,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class)})}}const Pn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:r}=n.tags,i=Se(t,e);return s=>r({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,kc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Cc,createComponent:wc}],gridItem:Pn},Ec=t=>{const e=U(t);return()=>e(kc)};function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=Se(t),l=o`
    display: flex;
    flex-direction: row;
    gap: 0.5rem;
    & label {
  ...
  `).join(`
`))()};
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"none",color:p=e.color??"neutral",name:b,oninput:g,value:f,radios:y=[],...v}]=W(u);return a({...v,class:B("radioButtonGroup",d,p,m,l,e==null?void 0:e.class,v==null?void 0:v.class)},y.map(({id:w,Label:S})=>r(i({size:d,variant:m,color:p,id:w,name:b,checked:f==w,value:w,oninput:g}),S())))}}const Tc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,p:r}=e.tags,i=Zt(t),s=M(t,{variant:"outline",color:"primary"});return()=>{const l=e.state("two");return n({onsubmit:d=>{d.preventDefault(),alert(l.val)}},o(i({oninput:({target:d})=>l.val=d.id,name:"myRadio",value:l.val,radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]}),r("CheckedState: ",l)),a(s({type:"submit"},"Submit")))}},Dc=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ac=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Zt(t),i=M(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))}},o(r({name:"myRadio",value:"one",radios:[{id:"one",Label:()=>"One"},{id:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},Bc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Nc=t=>{const{bau:e,config:n}=t,{form:o,article:a,footer:r,img:i}=e.tags,s=Zt(t),l=M(t,{variant:"outline",color:"primary"}),c=()=>i({src:`${n.base}/login/github.svg#Capa_1`,alt:"GitHub",width:28,height:28}),u=()=>i({src:`${n.base}/login/gitlab-logo.svg#Capa_1`,alt:"GitLab",width:28,height:28});return()=>o({onsubmit:m=>{m.preventDefault();const p=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(p))}},a(s({name:"git_provider_type",value:"",radios:[{id:"GitHub",Label:()=>[c(),"GitHub"]},{id:"GitLab",Label:()=>[u(),"GitLab"]}]})),r(l({type:"submit"},"Submit")))},Mc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Ic=t=>{const{bau:e}=t,{form:n,article:o,footer:a,small:r,div:i}=e.tags,s=Zt(t),l=M(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(s({name:"git_provider_type",value:"",radios:[{id:"GitHub",Label:()=>i("GitHub",r("Login with GitHub"))},{id:"GitLab",Label:()=>i("GitLab",r("Login with GitLab"))}]})),a(l({type:"submit"},"Submit")))},Oc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,$c={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:Bc,createComponent:Ac},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Dc,createComponent:Tc},{title:"Label with Image",description:"A label with an image.",code:Mc,createComponent:Nc},{title:"Label with description",description:"A label with name and description.",code:Oc,createComponent:Ic}]},Lc=t=>{const e=U(t);return()=>e($c)},Pc=()=>ot.map(t=>`
& button.plain.${t}::after {
  color: var(--color-${t});
}
& button.outline.${t}::after {
...
`).join(`
`);function Lt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,l=M(t),c=$t(t),u=yt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Pc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",label:y,Option:v,options:w,defaultOption:S,getOptionLabel:E,getOptionValue:D,onSelect:A=()=>{},loading:N,...O},...L]=W(p);const P=bt(t,{variant:g,color:f,size:b}),_=n.state(S?E(S):y),G=n.state(!1),H=n.state(0),z=()=>{V.openDialog(),V.focus(),G.val=!0},C=()=>{V.closeDialog(),G.val=!1},h=()=>{G.val=!1},x=I=>{V.open?C():z(),I.preventDefault()},k=({option:I,index:X})=>nt=>{_.val=E(I),J.value=D(I),J.setCustomValidity(""),H.val=X,C(),A(I),nt.preventDefault()},T=I=>{switch(I.preventDefault(),I.key){case"Escape":C();break;case"ArrowDown":H.val<w.length-1?H.val++:H.val=0;break;case"ArrowUp":H.val<=0?H.val=w.length-1:H.val--;break;case"Enter":V.open?(_.val=E(w[H.val]),J.value=D(s),C()):z();break}},F=()=>u({tabindex:"0",class:B(f,g)},w.map((I,X)=>r({class:()=>B(H.val==X&&"active"),onclick:k({option:I,index:X})},v(I)))),j=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":G,"aria-label":y,onclick:x,color:f,variant:g,size:b,class:N==!0&&"loading",disabled:N},()=>!_.val&&y,_,()=>N==!0&&P({visibility:N})),V=c({triggerEl:j,contentEl:F(),onClose:h}),J=i({...O,"aria-label":y},s({value:""},"--Select Category--"),w.map(I=>s({value:D(I)},E(I))));return S?J.value=D(S):J.value=O.value,a({...O,class:B("select",f,b,d,e==null?void 0:e.class,O==null?void 0:O.class),onkeydown:T},J,j,V)}}const zn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Lt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(c.label),r(c.code));return c=>i({...c,options:s,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},zc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Lt(t),c=M(t,{variant:"solid",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(m.label),s(m.code));return()=>o({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},a(l({name:"country",options:u,Option:d,getOptionValue:({code:p})=>p,getOptionLabel:({label:p})=>p,label:"Select a country..."})),r(c({type:"submit"},"Submit")))},jc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Rc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Lt(t),c=M(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(p.label),s(p.code));return()=>o({onsubmit:b=>{b.preventDefault();const g=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(g))}},a(l({name:"country",options:d,Option:m,defaultOption:d.find(({code:b})=>b==u),getOptionValue:({code:b})=>b,getOptionLabel:({label:b})=>b,label:"Select a country..."})),r(c({type:"submit"},"Submit")))},_c=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,Gc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,span:r}=e.tags,i=Lt(t),s=M(t,{variant:"solid",color:"primary"}),l=["eu-north-1","ap-south-1","eu-west-3","eu-west-2","eu-west-1","ap-northeast-3","ap-northeast-2","ap-northeast-1","sa-east-1","ca-central-1","ap-southeast-1","ap-southeast-2","eu-central-1","us-east-1","us-east-2","us-west-1","us-west-2"],c=u=>r({},u);return()=>n({onsubmit:d=>{d.preventDefault();const m=Object.fromEntries(new FormData(d.currentTarget));alert(JSON.stringify(m))}},o(i({name:"region",options:l,Option:c,label:"Select a region",getOptionValue:d=>d,getOptionLabel:d=>d,required:!0,oninvalid:d=>{d.target.setCustomValidity("Please select an AWS region")}})),a(s({type:"submit"},"Submit")))},Fc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,Uc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=M(t,{variant:"outline"}),c=M(t,{variant:"solid",color:"primary"}),u=Lt(t),d=m=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(m.flag),i(m.name.common));return()=>{const m=e.state([]),p=e.state(!1),b=e.state("");async function g({url:v,transform:w=S=>S}){try{p.val=!0;const S=await fetch(v,{});if(S.ok){const E=await S.json();m.val=w(E)}else b.val=S.statusText}catch(S){b.val=S.message}finally{p.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:v=>v.sort((w,S)=>w.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:v=>{v.preventDefault();const w=Object.fromEntries(new FormData(v.currentTarget));alert(JSON.stringify(w))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:m.val,Option:d,getOptionValue:({name:v})=>v.common,getOptionLabel:({name:v})=>v.common,label:"Country",id:"country",loading:p.val,required:!0}),l({onclick:()=>f()},"Reload")),r(c({type:"submit"},"Submit")))}},Hc=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`,Vc={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:jc,createComponent:zc},{title:"Default Option",description:"Select with a default option",code:_c,createComponent:Rc},{title:"Select AWS region",description:"Select the AWS region",code:Fc,createComponent:Gc},{title:"Loading Indicator",description:"Select with a loading indicator",code:Hc,createComponent:Uc}],gridItem:zn},Jc=t=>{const e=U(t);return()=>e(Vc)};function jn(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("select-native",u,l,c,r,e==null?void 0:e.class,d==null?void 0:d.class)},m)}}const Rn=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=jn(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},r.map(({label:s,phone:l})=>o({value:l},s)))},qc=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,r=M(t,{variant:"outline",color:"primary"}),i=jn(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),s.map(({label:c,phone:u})=>n({value:u},c))),a(r({type:"submit"},"Submit")))},Wc=`import { Context } from "@grucloud/bau-ui/context";
...
`,Kc={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Wc,createComponent:qc}],gridItem:Rn},Xc=t=>{const e=U(t);return()=>e(Kc)},Zc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=Et(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,Qc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=Et(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,el=t=>{const{bau:e,css:n}=t,{section:o,table:a,tbody:r,tr:i,td:s}=e.tags,l=Et(t,{class:n`
      height: 2rem;
      width: 10rem;
    `}),c=()=>a(r(new Array(8).fill("").map(()=>i(s(l({class:n`
                ...
                `})),s(l()),s(l()),s(l()),s(l({class:n`
                  width: 20rem;
                `}))))));return()=>o(c())},nl=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,ol=t=>{const{bau:e,css:n}=t,{section:o,header:a,span:r,article:i}=e.tags,s=n`
    display: flex;
    flex-direction: column;
    & header {
      display: inline-flex;
  ...
  `,l=Et(t,{class:n`
    ...
    `}),c=Et(t);function u({columnsSize:d=4}){return o({class:s},a(new Array(d).fill("").map(()=>l(r("1")))),i(c("")))}return()=>o(u({columnsSize:3}))},al=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,rl={title:"Skeleton",package:"skeleton",description:"The skeleton component is used a loading indicator",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/skeleton/skeleton.js",importStatement:'import skeleton from "@grucloud/bau-ui/skeleton";',examples:[{title:"Card",description:"A card skeleton.",code:Yc,createComponent:Zc},{title:"List",description:"A list skeleton.",code:tl,createComponent:Qc},{title:"Table",description:"A table skeleton.",code:nl,createComponent:el},{title:"Tabs",description:"A tabs skeleton.",code:al,createComponent:ol}],variantColorTableDisable:!0,variantSizeDisable:!0},sl=t=>{const e=U(t);return()=>e(rl)};function Pt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    ${(()=>ot.map(s=>`
&.slider.${s} {
  accent-color: var(--color-${s});
}
`).join(`
`))()};
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...p]=W(l);return a({...m,type:"range",class:B("slider",d,u,c,i,e==null?void 0:e.class,m.class)},...p)}}const _n=t=>{const{bau:e}=t,n=e.state(0),o=r=>{n.val=r==null?void 0:r.target.value},a=Pt(t);return r=>a({"aria-label":"slider",...r,oninput:o})},il=t=>{const{bau:e}=t,{form:n,article:o,label:a,br:r,footer:i}=e.tags,s=Pt(t),l=M(t,{variant:"solid",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(a("Slider with step, min and max",r,s({name:"slider-simple",step:20,min:-100,max:100}))),i(l({type:"submit"},"Submit")))},cl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,dl=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=Pt(t),d=M(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o(i({for:"temp"},"Choose a comfortable temperature"),l,u({class:n`
          ...
          `,id:"temp",name:"temp",list:"markers"}),s({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(p=>c({value:Number(p),label:p})))),a(d({type:"submit"},"Submit")))},ml=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import slider from "@grucloud/bau-ui/slider";
...
`,pl=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=Pt(t),d=M(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o({class:n`
            display: flex;
...
`,gl={title:"Slide",package:"slider",description:"The slider component allows a user to to choose a number between a range.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/slider/slider.js",importStatement:'import slider from "@grucloud/bau-ui/slider";',examples:[{title:"Uncontrolled slider",description:"A uncontrolled slider.",code:cl,createComponent:il},{title:"Controlled slider",description:"A controlled slider.",code:ul,createComponent:ll},{title:"Horizontal Mark",description:"A slider with horizontal mark.",code:ml,createComponent:dl},{title:"Vertical Mark",description:"A vertical slider with marks.",code:bl,createComponent:pl}],gridItem:_n},fl=t=>{const e=U(t);return()=>e(gl)},Gn=(t,e)=>{const n=bt(t,e);return o=>n({...o})},hl=t=>{const{bau:e}=t,{section:n}=e.tags,o=M(t,{variant:"solid",color:"primary"}),a=bt(t,{size:"lg"});return()=>{const r=e.state(!0);return n(o({onclick:()=>r.val=!r.val},()=>r.val?"Stop":"Start"),a({visibility:r}))}},vl=`import spinner from "@grucloud/bau-ui/spinner";
import button from "@grucloud/bau-ui/button";
...
`,yl={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:vl,createComponent:hl}],gridItem:Gn},xl=t=>{const e=U(t);return()=>e(yl)},Sl=()=>ot.map(t=>"").join(`
`),Fn=(t,e)=>(n,o)=>{const a=new URLSearchParams(t.window.location.search);return a.delete(e),a.append(e,n),o&&Object.entries(o).map(([r,i])=>(a.delete(r),a.append(r,i))),`?${a.toString()}`};function Un(t,e={}){const{bau:n,css:o,window:a}=t,{div:r,ul:i,li:s,span:l,section:c}=n.tags,u=o`
    display: flex;
    flex-direction: column;
    & > ul {
      display: flex;
...
`,Re="stepper-vertical",kl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=e.tags,d=dt(t),m=gt(t),p=Un(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`,Tl={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Horizontal Stepper",description:"A simple horizontal stepper.",code:Cl,createComponent:wl},{title:"Vertical Stepper",description:"A simple vertical stepper.",code:El,createComponent:kl}]},Dl=t=>{const e=U(t);return()=>e(Tl)},Al=()=>ot.map(t=>`
&.switch.plain.${t} {
  &::after {
...
`);function Yt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=W(s);return a({...d,class:B("switch",r,u,c,l,e==null?void 0:e.class,d.class),type:"checkbox"},...m)}}const Hn=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Yt(t,e);return s=>a({class:o`
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},Bl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Yt(t,{variant:"outline",color:"primary"}),l=M(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
...
`,Ll={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Uncontrolled Switch",description:"A uncontrolled switch.",code:Nl,createComponent:Bl},{title:"Controlled Switch",description:"A controlled switch.",code:Il,createComponent:Ml},{title:"State in URL",description:"A switch with state in URL",code:$l,createComponent:Ol}],gridItem:Hn},Pl=t=>{const e=U(t);return()=>e(Ll)},zl=()=>ot.map(t=>`
&.tabs.solid.${t} {
}
`).join(`
`);function zt(t,e={}){const{bau:n,css:o,window:a}=t,{tabDefs:r}=e,{div:i,ul:s,li:l,a:c}=n.tags,u=o`
    ...
    ${zl()}
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",tabsKey:f="tabs",...y},...v]=W(m);const w=n.state(r),S=L=>w.val.find(P=>P.name==L),E=n.state(r[0]),D=()=>{var _,G;const P=new URLSearchParams(a.location.search).get(f)??r[0].name;if(P!=E.val.name){const H=S(P);(_=E.val.exit)==null||_.call(),E.val=H,(G=H==null?void 0:H.enter)==null||G.call()}};D(),a.history.pushState=new Proxy(a.history.pushState,{apply:(L,P,_)=>{L.apply(P,_);const G=_[2]??"";["?","#"].includes(G[0])&&D()}});const A=L=>{const P=new URLSearchParams(a.location.search);return P.delete(f),P.append(f,L),`?${P.toString()}`},N=L=>{const{Header:P,disabled:_,name:G}=L;return l({class:()=>B(E.val.name==G&&"active",_&&"disabled")},c({href:A(G)},P(L)))},O=i({class:B("tabs",b,p,g,u,e==null?void 0:e.class,y.class),bauMounted:({element:L})=>{a.addEventListener("popstate",D)},bauUnmounted:()=>{a.removeEventListener("popstate",D)}},n.loop(w,s(),N),n.bind({deps:[E],render:()=>({Content:L})=>L?L(y):""}));return O.addEventListener("tab.add",L=>{var _;const{tab:P}=L.detail;(_=P.enter)==null||_.call(),w.val.push(P)},!1),O.addEventListener("tab.remove",L=>{var _;const P=w.val.findIndex(G=>G.name==L.detail.tabName);P>0&&((_=w.val[P].exit)==null||_.call(),w.val.splice(P,1))},!1),O}}const jl=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=zt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]});return()=>r({})},Rl=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,_l=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=zt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>"Tab Disabled",Content:()=>n(o("My Content Disabled"))}],variant:"plain",color:"neutral"});return()=>r({tabsKey:"my-tab"})},Gl=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vn=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Tab1",Header:()=>"TAB",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]},Fl=t=>{const{css:e}=t,n=zt(t,{tabDefs:Vn(t),class:e`
      flex-direction: column-reverse;
    `});return()=>n({})},Ul=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Hl=t=>{const{css:e}=t,n=Vn(t),o=zt(t,{tabDefs:n,class:e`
      & ul {
        justify-content: center;
      }
    `});return()=>o({})},Vl=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Jl={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Rl,createComponent:jl},{title:"Extended Tabs",description:"An extended tabs.",code:Gl,createComponent:_l},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:Ul,createComponent:Fl},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:Vl,createComponent:Hl}]},ql=t=>{const e=U(t);return()=>e(Jl)};function jt(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:r}=n.tags;a`
  :root {
...
`;const i=o`
    ...
    width: fit-content;
  `;return function(...l){let[{...c},...u]=W(l);return r({...c,class:B("table-container",i,e==null?void 0:e.class,c==null?void 0:c.class)},...u)}}const Wl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags;function d(f,y,v,w,S){return{name:f,calories:y,fat:v,carbs:w,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],p=({name:f,calories:y})=>i(r(f),r({class:n`
            text-align: right;
          `},y)),b=()=>l(i(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(g(s(u("Basic Table"),b(),c(m.map(p)))))},Kl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function At(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Xl=[At("Frozen yoghurt",159,6,24,4),At("Ice cream sandwich",237,9,37,4.3),At("Eclair",262,16,24,6),At("Cupcake",305,3.7,67,4.3),At("Gingerbread",356,16,49,3.9)],Zl=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
    ...
    `});return()=>o(p(s(u("Table Dense"),m(),c(Xl.map(d)))))},Yl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Bt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const Ql=[Bt("Frozen yoghurt",159,6,24,4),Bt("Ice cream sandwich",237,9,37,4.3),Bt("Eclair",262,16,24,6),Bt("Cupcake",305,3.7,67,4.3),Bt("Gingerbread",356,16,49,3.9)],tu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
    ...
    `});return()=>o(p(s(u("Table Zebra"),m(),c(Ql.map(d)))))},eu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,nu={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Kl,createComponent:Wl},{title:"Dense",description:"A dense table.",code:Yl,createComponent:Zl},{title:"Zebra",description:"A zebra table.",code:eu,createComponent:tu}]},ou=t=>{const e=U(t);return()=>e(nu)},au=t=>{const{bau:e,css:n}=t,{h1:o,h2:a,h3:r,section:i,article:s}=e.tags,l=sn(t),c=s({id:"content",class:n`
        grid-area: content;
      `},o({id:"h1"},"h1"),a({id:"h2-1"},"h2 1"),r({id:"h3-1-1"},"h3 1 1"),r({id:"h3-1-2"},"h3 1 2"),a({id:"h2-2"},"h2 2"),r({id:"h3-2-1"},"h3 2 1"));return()=>i({class:n`
          ...
          grid-template-areas: "content toc";
        `},c,l({contentEl:c}))},ru=`import tableOfContent from "@grucloud/bau-ui/tableOfContent";
import { Context } from "@grucloud/bau-ui/context";
...
`,su={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:ru,createComponent:au}]},iu=t=>{const e=U(t);return()=>e(su)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=ve(t),i=M(t),s=bt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:b,icon:g,...f})=>i({"aria-label":b,title:b,...f},g),u=({count:b,totalCount:g,page:f,rowsPerPage:y})=>a({class:"pages-numbers"},Number(f-1)*Number(y)+(b>0?1:0),"-",Math.min(f*y,g)," of ",g),d=({count:b,page:g,rowsPerPage:f})=>a({class:"pages-numbers"},(g-1)*f+(b>0?1:0),"-",g*f),m=b=>b<=1,p=(b,g,f)=>b>=Math.ceil(g/f);return function(...g){let[{size:f=e.size??"md",variant:y=e.variant??"outline",color:v=e.color??"neutral",count:w=0,totalCount:S=0,page:E=1,rowsPerPage:D=50,onPageChange:A,isLoading:N=!1,disableFirst:O=()=>m(E),disablePrevious:L=()=>m(E),disableNext:P=()=>p(E,S,D),disableLast:_=()=>p(E,S,D),...G},...H]=W(g);const z=Math.max(0,Math.ceil(S/D)),C=A({page:1}),h=A({page:E-1}),x=A({page:E+1}),k=A({page:z}),T=[{label:"First",icon:"⟪",onclick:C,disabled:O()},{label:"Previous",icon:"⟨",onclick:h,disabled:L()},{label:"Next",icon:"⟩",onclick:x,disabled:P()},{label:"Last",icon:"⟫",onclick:k,disabled:_()}];return a({...G,class:B("table-pagination",l,N&&"disabled",e==null?void 0:e.class,G==null?void 0:G.class)},s({class:"spinner",visibility:N,size:"md"}),S>0?u({count:w,totalCount:S,page:E,maxPages:z,rowsPerPage:D}):d({count:w,page:E,maxPages:z,rowsPerPage:D}),r({variant:y,color:v},T.map(F=>c({...F,variant:y,color:v}))))}}const cu=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),lu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=cu(45),u=({name:b,email:g})=>r(a(b),a(g)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=Jn(t),p=jt(t,{class:n`
      max-width: 650px;
    `});return()=>{const b=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),f=e.derive(()=>b.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:v})=>w=>{g.val.page=v};return p(i(d(),()=>l(f.val.map(u))),()=>m({...g.val,onPageChange:y}))}},uu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),p=e.derive(()=>d.val.length),b=e.state(1),g=e.state(10),f=e.derive(()=>d.val),y=O=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(O).toString()}`,v=({page:O})=>L=>{b.val=O,w(y({page:O,per_page:g.val}))};w(y({page:1,per_page:g.val}));async function w(O){try{u.val=!0;const L=await fetch(O,{});if(L.ok){const P=await L.json();d.val=P;return}throw L}catch(L){m.val=L.message}finally{u.val=!1}}const S=({name:O,description:L,stargazers_count:P})=>r(a(O),a(L),a({class:n`
            text-align: right;
          `},P)),E=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),N=({message:O})=>c(O);return()=>A(()=>D({rowsPerPage:g.val,page:b.val,count:p.val,totalCount:-1,isLoading:u.val,onPageChange:v,disableNext:()=>!1}),i(E(),()=>m.val&&N({message:m.val}),()=>l(f.val.map(S))))},du=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=lu(t),c=uu(t),u=(...d)=>a({class:n`
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",selected:m=!1,disabled:p,onChange:b,...g},...f]=W(l);return r({type:"button",...g,"aria-pressed":{deps:[m],renderProp:()=>y=>y},class:{deps:[m],renderProp:()=>y=>B("toggle",c,d,u,i,y&&"selected",e==null?void 0:e.class,g==null?void 0:g.class)},disabled:p},f)}}const qn=(t,e)=>{const{bau:n}=t,o=Rt(t,e);return a=>{const r=n.state(!1);return o({...a,selected:r,onclick:()=>r.val=!r.val},"Toggle Me")}},mu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Rt(t,{variant:"plain"}),i=M(t,{variant:"outline",color:"primary"});return()=>{const s=e.state(!1);return n({onsubmit:c=>{var m;c.preventDefault();const d=(m=c.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:m.name;alert(d)}},o(r({name:"my-toogle",selected:s,onclick:()=>s.val=!s.val},"Toggle Me")),a(i({type:"submit"},"Submit")))}},pu=`import { Context } from "@grucloud/bau-ui/context";
...
`,bu={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:pu,createComponent:mu}],gridItem:qn},gu=t=>{const e=U(t);return()=>e(bu)},fu=()=>ot.map(t=>`
&.toggle-group.${t} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${t}) !important;
  }
...
`).join(`
`);function we(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    display: inline-flex;
    border-radius: var(--global-radius);
    & button:not(:last-child) {
      border-top-right-radius: 0;
    ...
    ${fu()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",exclusive:d=!1,onChange:m=()=>{},...p},...b]=W(s);const g=new Set,f=y=>{const{value:v}=y.target;d?(g.clear(),g.add(v)):g.has(v)?g.delete(v):g.add(v),m({event:y,values:[...g]})};return a({...p,class:B("toggle-group",l,u,c,r,e==null?void 0:e.class,p==null?void 0:p.class),onclick:f},...b)}}const Wn=(t,e)=>{const{bau:n}=t,o=we(t,e),a=Rt(t,e);return r=>{const i=n.state([""]),s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...r,onChange:({values:c})=>{i.val=c}},s.map(({label:c,value:u})=>()=>a({...r,value:u,selected:i.val.includes(u),"area-label":c},c)))}},hu=t=>{const{bau:e}=t,{form:n,footer:o,article:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=Rt(t,{color:i,variant:s}),c=we(t,{color:i,variant:s}),u=M(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{var y;b.preventDefault();const f=(y=b.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:y.name;alert(f)}},a(c({exclusive:!0,onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),o(u({type:"submit"},"Submit")))}},vu=`import { Context } from "@grucloud/bau-ui/context";
...
`,yu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=Rt(t,{variant:s,color:i}),c=we(t,{variant:s,color:i}),u=M(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{b.preventDefault();const f=[...b.currentTarget.querySelectorAll("button[aria-pressed=true]")].map(({name:y})=>y);alert(JSON.stringify(f))}},o(c({onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),a(u({type:"submit"},"Submit")))}},xu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,Su={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:vu,createComponent:hu},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:xu,createComponent:yu}],gridItem:Wn},wu=t=>{const e=U(t);return()=>e(Su)};function Ce(t,e={}){const{bau:n,css:o,window:a}=t,{div:r}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,Eu=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:r,section:i}=e.tags,s=Ot(t,{variant:"outline",color:"primary"}),l=Ce(t),c=()=>o(a("A ",r("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
        `},o({class:n`
          ...
          `},l({side:"left-end",titleEl:c()},s("left end")),l({side:"right-end",titleEl:c()},s("right end"))),o({class:n`
            display: flex;
            justify-content: space-around;
          `},l({side:"bottom-start",titleEl:c()},s("bottom start")),l({side:"bottom-centered",titleEl:c()},s("bottom centered")),l({side:"bottom-end",titleEl:c()},s("bottom end"))));return()=>u()},Tu=`import tooltip from "@grucloud/bau-ui/tooltip";
import chip from "@grucloud/bau-ui/chip";
...
`,Mu={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:Nu,createComponent:Bu}],gridItem:Xn},Iu=t=>{const e=U(t);return()=>e(Mu)},Zn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Zn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},Ou=({css:t,createGlobalStyles:e})=>(e`
:root {
...
`,{nav:t`
  ...
  `});function ke(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{renderMenuItem:r}=e,{ul:i,li:s,nav:l,div:c}=n.tags,u=Ou({css:o,createGlobalStyles:a}),d=ge(t),m=({depth:p=1,maxDepth:b,parent:g,color:f,variant:y,size:v})=>w=>{const{children:S,expanded:E}=w,D=n.state(!E),A=()=>c({class:o`
              cursor: ${S?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:O=>{S&&(D.val=!D.val)}},r({item:w,parent:g,depth:p})),N=()=>i({class:B(f,v)},S.map(m({depth:p+1,maxDepth:b,parent:w})));return s(S.length?d({expanded:E,Header:A,Content:S&&p<b&&N}):A())};return function({tree:b,maxDepth:g=1/0,size:f=e.size??"md",variant:y=e.variant??"outline",color:v=e.color??"neutral",...w}){return l({class:B(u.nav,f,y,v,e==null?void 0:e.class,w.class)},i(m({maxDepth:g,color:v,variant:y,size:f})(Zn({})({...b}))))}}const Yn=(t,e)=>{const{bau:n}=t,{a:o,span:a}=n.tags,r={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=ke(t,{renderMenuItem:({item:{data:{name:l,href:c}}})=>c?o({href:c},l):a(l),...e});return l=>s({...l,tree:r})},$u=t=>{const{bau:e}=t,{a:n,span:o}=e.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=ke(t,{renderMenuItem:({item:{data:{name:s,href:l}}})=>l?n({href:l},s):o(s)});return()=>i({tree:a})},Lu=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,Pu=t=>{const{bau:e,css:n,window:o}=t,{form:a,label:r,article:i,footer:s}=e.tags,l=St(t,{color:"neutral",variant:"outline"}),c=M(t,{variant:"solid",color:"danger"}),u=e.state(0),d=S=>{S.preventDefault();const E=Object.fromEntries(new FormData(S.currentTarget));alert(JSON.stringify(E))},m={data:{name:"Resources"},expanded:!0,children:[{data:{name:"EC2"},expanded:!0,children:[{data:{name:"Vpc",id:"EC2::Vpc"}},{data:{name:"Subnet",id:"EC2::Subnet"}}]},{data:{name:"IAM"},children:[{data:{name:"Role",id:"IAM:Role"}}]}]},p=({id:S,name:E})=>S??E,b=S=>o.document.getElementById(p(S)),g=({onNode:S})=>E=>{S(E);const{children:D=[]}=E;D.map(g({onNode:S}))},f=({parent:S})=>{if(S){const{children:E}=S,D=b(S.data);if(D){const A=E.every(N=>{const{checked:O,indeterminate:L}=b(N.data);return!O&&!L});D.indeterminate=!A&&E.some(N=>!b(N.data).checked),D.checked=E.every(N=>b(N.data).checked)}f({parent:S.parent})}},y=({item:S,parent:E})=>D=>{f({parent:E}),g({onNode:O=>{const L=b(O.data);L&&(L.checked=D.target.checked,L.indeterminate=!1)}})(S);const N=D.currentTarget.querySelectorAll('input[type="checkbox"][data-type="resources"]:checked');u.val=N.length,D.stopPropagation()},w=ke(t,{renderMenuItem:({item:S,parent:E})=>{const{name:D,id:A}=S.data,N=p(S.data);return r({class:n`
          display: flex;
          align-items: center;
          padding-right: 1rem;
        `,onclick:O=>O.stopPropagation()},l({onclick:y({item:S,parent:E}),name:N,id:N,"data-type":A?"resources":"group"}),D)}});return()=>a({onsubmit:d},i(w({tree:m})),s(c({type:"submit"},()=>`Delete ${u.val} Resource(s)`)))},zu=`import { Context } from "@grucloud/bau-ui/context";
...
`,ju={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Simple",description:"A simple treeview.",code:Lu,createComponent:$u},{title:"Checkable",description:"A treeview with checkboxes.",code:zu,createComponent:Pu}],gridItem:Yn},Ru=t=>{const e=U(t);return()=>e(ju)},_u=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,i=zt(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...e});return s=>i(s)},Gu=t=>{const{bau:e,css:n}=t,{section:o,div:a,h1:r,p:i,ul:s,li:l}=e.tags,c=cn(t),u=M(t),d=[{name:"Accordion",Item:ln(t)},{name:"Alert",Item:dn(t)},{name:"Autocomplete",Item:pn(t)},{name:"Avatar",Item:mn(t)},{name:"Badge",Item:gn(t)},{name:"Breadcrumbs",Item:fn(t)},{name:"Button",Item:hn(t)},{name:"Button Group",Item:vn(t)},{name:"Calendar",Item:yn(t)},{name:"Checkbox",Item:Sn(t)},{name:"Chip",Item:xn(t)},{name:"DrillDown Menu",Item:Cn(t,{base:"/components",hashBased:!0})},{name:"File Input",Item:En(t)},{name:"Input",Item:Tn(t)},{name:"Input Search",Item:Dn(t)},{name:"Linear Progress",Item:In(t)},{name:"Loading Button",Item:On(t)},{name:"Modal",Item:Ln(t)},{name:"Radio Button",Item:Pn(t)},{name:"Select",Item:zn(t)},{name:"Select Native",Item:Rn(t)},{name:"Slider",Item:_n(t)},{name:"Spinner",Item:Gn(t)},{name:"Switch",Item:Hn(t)},{name:"Tabs",Item:_u(t)},{name:"Theme Switch",Item:Xn(t)},{name:"Toggle",Item:qn(t)},{name:"Toggle Group",Item:Wn(t)},{name:"Tooltip",Item:Kn(t)},{name:"Tree View",Item:Yn(t)}];return()=>o({class:n`
          overflow-y: scroll;
  ...
  `};ho();const Qn={title:"Bau",base:"/bau/bau-ui"},ht=Eo({config:Qn}),{bau:Ju}=ht;ht.states={drawerOpen:Ju.state(!0)};Vu(ht);ro({routes:Fu({context:ht}),onLocationChange:Hu({context:ht,LayoutDefault:Lo(ht),config:Qn}),notFoundRoute:Uu(ht)});
