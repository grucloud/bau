...
`).join(`
`),Pn=()=>zt.map(([t])=>[`--color-${t}-s: var(--color-${t}-dark-s);`]).join(`
...
`)}
  ...
  `}function Un(){const t=document.getElementById("loading");t&&t.classList.add("m-fadeOut")}let Ht=t=>Object.prototype.toString.call(t??0).slice(8,-1),Gn=t=>Ht(t)=="Object",re=t=>Ht(t)=="Function",Pt=t=>["Object","Array"].includes(Ht(t)),se=Object.getPrototypeOf,Lt=t=>mt(t)?t.val:t,mt=t=>t==null?void 0:t.__isState,Fn=["splice","push","pop","shift","unshift","sort","reverse"],kt=(t,e)=>{const n=new Array(t.length);for(let o=0;o<t.length;o++)n[o]=e(t[o],o);return n};const Z=t=>!mt(t[0])&&Gn(t[0])?t:[{},...t];function Vn(t){let e=(t==null?void 0:t.window)??window,{document:n}=e,o,a=new Set,i=new Set,s=!1,r,c=v=>n.createElement(v),l=(v,d,b)=>{let w=r;r=d;let y=v(b);return r=w,y},p=()=>{o||(o=window.requestAnimationFrame(()=>{a.forEach(v=>{v.bindings=v.bindings.filter(d=>{var b;return(b=d.element)==null?void 0:b.isConnected}),!v.bindings.length&&!v.computed&&a.delete(v)}),o=void 0}))},m=(v,d,b,w,y,L)=>{var _;if(s){i.add(v);return}for(let U of v.bindings){let{deps:z,element:M,renderInferred:G,render:et,renderItem:ot}=U;if(ot&&d)(_=x(M,w,(...rt)=>h(ot(...rt)),b,y,L)[d])==null||_.call();else{let rt=G?G({element:M}):et({element:M,renderItem:ot})(...z.map(Lt));rt!==M&&M.replaceWith(U.element=h(rt))}}k(v),p()},u=(v,d,b=[])=>({get(w,y,L){var _;if(r==null||r.add(v),y==="_isProxy")return!0;if(!((_=w[y])!=null&&_._isProxy)&&!mt(w[y])&&Pt(w[y]))w[y]=new Proxy(w[y],u(v,d,[...b,y]));else if(Fn.includes(y)){let U=w[y];return(...z)=>{let M=U.apply(w,z);return m(v,y,M,z,d,b),M}}return Reflect.get(w,y,L)},set(w,y,L,_){let U=Reflect.set(w,y,L,_);return m(v,"setItem",U,{prop:y,value:L},d,[...b,y]),U}}),g=(v,d)=>new Proxy(d,u(v,d)),x=(v,d,b,w,y,L)=>{let _=()=>v.replaceChildren(...kt(w,b)),U=z=>v[z]&&v.removeChild(v[z]);return{assign:_,sort:_,reverse:_,setItem:()=>{var M;let z=L[0];(M=v.children[z])==null||M.replaceWith(b(y[z],z))},push:()=>v.append(...kt(d,(z,M)=>b(z,y.length+M))),unshift:()=>v.prepend(...kt(d,b)),pop:()=>U("lastChild"),shift:()=>U("firstChild"),splice:()=>{let[z,M,...G]=d;const{length:et}=v.children;for(let ot=z>=0?Math.min(z+M-1,et-1):et-1;ot>=(z>=0?z:et+z);ot--)v.children[ot].remove();if(G.length){let ot=G.forEach((rt,_t)=>b(rt,z+_t));v.children[z]?v.children[z].after(...ot):v.append(...ot)}}}},f=v=>({oldVal:v,bindings:[],listeners:[],__isState:!0,get val(){let d=this;return r==null||r.add(d),d.valProxy??(d.valProxy=Pt(v)?g(d,v):v,d.valProxy)},set val(d){let b=this,w=b.val;Pt(d)?(b.valProxy=g(b,d),m(b,"assign",d)):d!==w&&(b.valProxy=d,m(b)),b.oldVal=w}}),h=v=>v==null||v===!1?c("span"):v.nodeType?v:n.createTextNode(v),C=(v,d)=>{let b=new Set;return d.val=l(v,b),b},E=v=>{let d=f(),b=C(v,d);d.computed=!0;for(let w of b)w.listeners.push({computed:v,deps:b,state:d});return d},k=v=>{for(let d of[...v.listeners])C(d.computed,d.state)},I=(v,...d)=>{if(d.length){let b=[];for(let w of d.flat(1/0))w!=null&&b.push(mt(w)?q({deps:[w],render:()=>y=>y}):re(w)?F({renderInferred:w}):h(w));v.append(...b)}},B={},R=(v,d)=>v&&(Object.getOwnPropertyDescriptor(v,d)??R(se(v),d)),N=(v,d,b)=>{var w;return B[v+","+d]??(B[v+","+d]=((w=R(b,d))==null?void 0:w.set)??0)},O=(v,d)=>new MutationObserver((b,w)=>{b.filter(y=>y.removedNodes).forEach(y=>[...y.removedNodes].find(L=>L===v&&(d({element:v}),w.disconnect(),!0)))}).observe(v.parentNode,{childList:!0}),T=(v,d)=>new MutationObserver((b,w)=>b.forEach(y=>d({record:y,element:v}))).observe(v,{childList:!0}),$=v=>new Proxy(function(b,...w){var U;let[y,...L]=Z(w),_=v?n.createElementNS(v,b):c(b);for(let[z,M]of Object.entries(y)){if(z.startsWith("bau"))continue;let G=N(b,z,se(_))?et=>_[z]=et:et=>_.setAttribute(z,et);M==null||(mt(M)?q({deps:[M],render:()=>()=>(G(M.val),_)}):re(M)&&(!z.startsWith("on")||M.isDerived)?F({renderInferred:()=>(G(M({element:_})),_)}):M.renderProp?q({deps:M.deps,render:()=>()=>(G(M.renderProp({element:_})(...M.deps.map(Lt))),_)}):G(M))}return y.bauOnChildMutation&&T(_,y.bauOnChildMutation),I(_,...L),(U=y.bauCreated)==null||U.call(y,{element:_}),y.bauMounted&&e.requestAnimationFrame(()=>y.bauMounted({element:_})),y.bauUnmounted&&e.requestAnimationFrame(()=>O(_,y.bauUnmounted)),_},{get:(d,b)=>d.bind(void 0,b)}),H=(v,d,b)=>{v.element=h(b);for(let w of d)mt(w)&&(a.add(w),w.bindings.push(v));return v.element},F=({renderInferred:v,element:d})=>{let b=new Set,w=l(v,b,{element:d});return H({renderInferred:v},b,w)},q=({deps:v,element:d,render:b,renderItem:w})=>H({deps:v,render:b,renderItem:w},v,b({element:d,renderItem:w})(...v.map(Lt))),Y=(v,d,b)=>q({deps:[v],render:({renderItem:w})=>y=>(d.append(...kt(y,w)),d),renderItem:b}),J=v=>{s=!0,v(),s=!1,i.forEach(m),i.clear()};return{tags:$(),tagsNS:$,state:f,bind:q,loop:Y,derive:E,stateSet:a,batch:J}}const Wn=t=>{let e=0,n=11;for(;e<t.length;)n=101*n+t.charCodeAt(e++)>>>0;return"bau"+n},Xn=(t,e,n,o)=>{const a=t.createElement("style");a.id=n,a.append(o),(e??t.head).append(a)},Zn=(t,e)=>t.reduce((n,o,a)=>n+o+(e[a]??""),"");function Kn(t){let{document:e}=(t==null?void 0:t.window)??window;const n=o=>(a,...i)=>{const s=Zn(a,i),r=Wn(s);return!e.getElementById(r)&&Xn(e,t==null?void 0:t.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function Yn(t){const e=Vn(),n=Kn();return Hn(n),{bau:e,...n,tr:o=>o,window,...t}}function D(...t){return t.filter(e=>e).join(" ")}function K(t,e){const{bau:n,css:o}=t,a={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
...
`).join(`
`);function Ut(t,e){const{bau:n,css:o,window:a}=t,{input:i}=n.tags,s=p=>{a.document.documentElement.setAttribute("data-theme",p),localStorage.setItem("theme",p)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Jn);const l=o`
    position: relative;
    display: flex;
    justify-content: center;
    align-items: center;
  ...
  `;return function(...m){let[{color:u,variant:g="outline",size:x="md",...f},...h]=Z(m);return i({required:"required",title:"Switch Theme",...f,class:D("theme-switch",u,g,x,l,e==null?void 0:e.class,f.class),type:"checkbox",checked:r()=="dark",onclick:C=>{s(C.target.checked?"dark":"light")}},...h)}}function to(t){const{tr:e,bau:n,css:o,config:a,states:i}=t,{i:s,header:r,h1:c,div:l,a:p,img:m,b:u,ul:g,li:x}=n.tags,{svg:f,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),C=i.drawerOpen,E=K(t,{class:o`
    ...
    `}),k=Ut(t),I=()=>s(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),B=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
...
`).join(`
`))()}
  `;return function(...c){let[{color:l="neutral",variant:p="plain",size:m,...u},...g]=Z(c);return a({...u,class:D("list",s,l,p,m,e==null?void 0:e.class,u==null?void 0:u.class)},...g)}}const Tt="0.3s",xe=({parent:t,grandParent:e})=>n=>{const{children:o,...a}=n,i=structuredClone(a);return i.children=o==null?void 0:o.map(xe({parent:n,grandParent:t})),t&&(t.parentTree=e),i.parentTree=t,i},we=t=>e=>{var n;if(!t)return e;if(((n=e==null?void 0:e.data)==null?void 0:n.href)==t)return e.children?e:e.parentTree;if(e.children)for(let o=0;o<e.children.length;o++){const a=we(t)(e.children[o]);if(a)return a}},no=({keyframes:t})=>({hideToLeft:t`
  from {
  ...
  `,hideToRight:t`
   ...
   `});function Gt(t,e){const{bau:n,css:o,window:a}=t,{base:i=""}=e,s=({currentTree:T,data:$})=>f(k({variant:"plain",href:`${i}${T.parentTree.children[0].data.href}`,class:o`
            flex-grow: 0;
  ...
  `,N=({variant:T,color:$,size:H,currentTree:F,pathnameState:q})=>{const{children:Y,parentTree:J,data:v}=F;return x({class:D("drillDownMenu",T,$,H)},J&&l({data:v,currentTree:F}),Y&&E({class:D(T,$,H)},Y.map(d=>u({class:()=>D(d.children&&"has-children",m({pathname:q.val,subTree:d})&&"active")},p(d)))))},O=({tree:T,pathname:$})=>{let H=xe({})(structuredClone(T)),F=we($)(H);return F||(console.log("drilldown no sub tree",$),F=H),F};return function($){const{variant:H="plain",color:F="neutral",size:q="md",tree:Y,pathnameState:J=n.state(a.location.pathname),...v}=$;let d=1;const b=_=>{const{dataset:U}=_.target;U.buttonback=="true"?d=-1:U.ischild=="false"?d=1:U.ischild=="true"&&(d=0)},w=n.derive(()=>O({tree:Y,pathname:J.val})),y=_=>{switch(_){case 1:return`${I} ${Tt}`;case-1:return`${B} ${Tt}`;default:return""}},L=_=>{switch(_){case 1:return`${B} ${Tt} reverse`;case-1:return`${I} ${Tt} reverse`;default:return""}};return g({class:D(R,e==null?void 0:e.class,v.class),onclick:b},C({animationHide:()=>y(d),animationShow:()=>L(d)},()=>N({variant:H,color:F,size:q,currentTree:w.val,pathnameState:J})))}}const oo={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tab",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function ye(t){const{tr:e,bau:n,css:o,config:a,states:i,window:s}=t,{div:r,ul:c,li:l,nav:p,a:m,span:u}=n.tags;let g=!1;const x=Gt(t,{base:a.base});return function(){return r({bauMounted:({element:h})=>{s.innerWidth<=640&&(g=!0,i.drawerOpen.val=!1)},onclick:h=>{g&&!h.target.dataset.buttonback&&!h.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:D(o`
            grid-area: sidebar;
            position: sticky;
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function io({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:p}=e.tags,m=({maxSize:u=151})=>({libName:g,size:x})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},g.map(m({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",p({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function co(t){const{bau:e,css:n,config:o}=t,{div:a,p:i,a:s,section:r}=e.tags,c=ro(t),l=so(t),p=K(t);Ft(t);const m=io(t),u=(...C)=>a({class:n`
...
"Click me"
        ...
        `},a(c(s(l(g??"Variant/Color"),nt.map(x=>l(x)))),i(qn.map(x=>s(l(x),nt.map((f,h)=>r(u({color:f,variant:x,size:p[h%3]},{index:h}))))))))}},W=t=>{const{bau:e,css:n}=t,{article:o,section:a,h1:i,p:s,h2:r,h3:c,pre:l,div:p,code:m}=e.tags;ft.registerLanguage("javascript",Pe);const u=Le(t),g=({text:x})=>l({class:n`
          display: inline-block;
...
`).join(`
`);function It(t,e){const{bau:n,css:o}=t,{accordionDefs:a}=e,{div:i,ul:s,li:r,header:c,h3:l,button:p}=n.tags,m=n.state(""),u=f=>h=>{m.val==f?m.val="":m.val=f},g=({element:f,open:h})=>{const C=()=>{f.removeEventListener("transitionend",C)};function E(I){I.addEventListener("transitionend",C),window.requestAnimationFrame(()=>{I.style.height="0px"})}function k(I){I.addEventListener("transitionend",C),I.style.height=I.scrollHeight+"px"}f.scrollHeight!=0&&(h?k(f):E(f))},x=o`
    & ul {
      display: flex;
      flex-direction: column;
      justify-content: flex-start;
...
`,ya={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:ga,createComponent:ha},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:va,createComponent:fa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:wa,createComponent:xa}],gridItem:je},Ea=t=>{const e=W(t);return()=>e(ya)},Ca={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Sa=({css:t,createGlobalStyles:e})=>{e`
:root {
...
& button.outline.${t}::after {
  ...
  `).join(`
`);function Fe(t,e){const{bau:n,css:o}=t,{div:a,li:i,ul:s}=n.tags,r=Kt(t),c=K(t),l=Yt(t),p=wt(t),m=o`
    & button {
      &::after {
        content: "\u25BC";
        padding: 0 0.3rem;
    ...
    ${Xa()}
  `,u=n.state(""),g=n.state(""),x=n.state(!1),f=n.state(0),h=()=>{x.val=!1};return function(...E){let[{variant:k="outline",color:I,size:B="md",id:R,label:N,placeholder:O,Option:T,options:$,getOptionLabel:H=({label:M})=>M,...F},...q]=Z(E);const Y=n.state($),J=()=>{z.openDialog(),x.val=!0,g.val="",Y.val=$},v=()=>{z.closeDialog(),x.val=!1,g.val=""},d=M=>{const{value:G}=M.target;g.val=G,G?Y.val=$.filter(et=>H(et).match(new RegExp(`${G}`,"i"))):Y.val=$},b=M=>{x.val?v():J()},w=({option:M,index:G})=>et=>{u.val=H(M),f.val=G,v()},y=M=>{switch(console.log("onkeydown",M.key,f.val),M.key){case"Escape":v();break;case"ArrowDown":f.val<Y.val.length-1?f.val++:f.val=0;break;case"ArrowUp":f.val<=0?f.val=Y.val.length-1:f.val--;break;case"Enter":u.val=H(Y.val[f.val]),g.val="",v();break}},L=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":x,"aria-label":N,onclick:b,variant:k,color:I,size:B},()=>!u.val&&N,u),_=l({id:R,value:g,placeholder:O,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":x,oninput:d,onkeydown:y,variant:k,color:I,size:B}),z=r({id:R,triggerEl:L,contentEl:(()=>a({class:D(k,I,B,"content")},_,()=>p({class:D(k,I,B)},Y.val.map((M,G)=>i({class:()=>D(f.val==G&&"active"),onclick:w({option:M,index:G})},T(M))))))(),onClose:h});return a({...F,class:D("autocomplete",m,e==null?void 0:e.class,F==null?void 0:F.class)},L,z)}}const Ve=t=>{const{bau:e,css:n}=t,{div:o,span:a}=e.tags,i=Fe(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ya={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Default",description:"A simple autocomplete.",code:Ka,createComponent:Za}],gridItem:Ve},qa=t=>{const e=W(t);return()=>e(Ya)};function We(t,e){const{bau:n,css:o}=t,{span:a}=n.tags,i=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,tr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Qa,createComponent:Ja}],gridItem:Xe},er=t=>{const e=W(t);return()=>e(tr)};function Ze(t,e){const{bau:n,css:o}=t,{ul:a,li:i,a:s,span:r}=n.tags,c=K(t),l=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`,ar={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:or,createComponent:nr}],gridItem:Ke},rr=t=>{const e=W(t);return()=>e(ar)},Ye=t=>{const e=K(t);return n=>e({...n},`${n.variant} ${n.color} ${n.size}`)},sr=t=>{const{bau:e}=t,{section:n}=e.tags,o=K(t),a=()=>{alert("Click")};return()=>n(o({color:"primary",variant:"outline",onclick:a},"Click me"))},ir=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`);function qt(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,i=o`
    ...
    ${ur()}
  `;return function(...r){let[{variant:c="outline",size:l="md",color:p,...m},...u]=Z(r);return a({...m,class:D("button-group",c,p,l,i,e==null?void 0:e.class,m==null?void 0:m.class)},...u)}}const qe=t=>{const e=["ONE","TWO","THREE"],n=K(t),o=qt(t);return a=>o({...a},e.map(i=>n(a,i)))},dr=t=>{const{bau:e}=t,{section:n}=e.tags,o=["ONE","TWO","THREE"],a=K(t),i=qt(t),s="primary",r="solid";return()=>n(i({color:s,variant:r},o.map(c=>a({color:s,variant:r},c))))},pr=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,fr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:gr,createComponent:hr}],gridItem:Qe},vr=t=>{const e=W(t);return()=>e(fr)},tn=t=>{const e=Ft(t);return n=>e({...n},`Chip ${n.color} ${n.variant}`)},xr=t=>{const{bau:e}=t,{section:n}=e.tags,o=Ft(t);return()=>n(o({variant:"outline",color:"primary"},"My Chip"))},wr=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,yr={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:wr,createComponent:xr}],gridItem:tn},Er=t=>{const e=W(t);return()=>e(yr)};function en(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
...
`,Br={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:_r,createComponent:Nr}],gridItem:on},Or=t=>{const e=W(t);return()=>e(Br)};function an(t,e){const{bau:n,css:o}=t,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
      display: inline-block;
      > * {
        margin: 1rem 0;
      }
...
`,Lr={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Pr,createComponent:Rr}],gridItem:rn},jr=t=>{const e=W(t);return()=>e(Lr)},sn=t=>{const e=Yt(t);return n=>e({name:`myinput-gallery-${n.color}-${n.variant}-${n.size}`,id:`myinput-gallery-${n.color}-${n.variant}-${n.size}`,placeholder:"Enter text",...n})},zr=t=>{const{bau:e}=t,{section:n}=e.tags,o=Yt(t);return()=>n(o({id:"my-input",name:"my-input",placeholder:"Enter Text"}))},Hr=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ur={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:Hr,createComponent:zr}],gridItem:sn},Gr=t=>{const e=W(t);return()=>e(Ur)},Fr=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Vr=t=>{const{bau:e,css:n}=t,{span:o,li:a}=e.tags,i=wt(t),s=({code:r,label:c})=>a({class:n`
          display: flex;
          gap: 1rem;
...
`,Kr={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:Zr,createComponent:Xr}],gridItem:Vr},Yr=t=>{const e=W(t);return()=>e(Kr)};function cn(t,e){const{bau:n,css:o}=t,{dialog:a}=n.tags,s=o`
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
    top: 0;
    left: 0;
...
`,Qr={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:Jr,createComponent:qr}],gridItem:ln},ts=t=>{const e=W(t);return()=>e(Qr)},es=t=>{const{bau:e}=t,{section:n,div:o,h1:a,p:i}=e.tags,s=K(t),r=Kt(t),c=()=>s({variant:"outline",color:"success",onclick:()=>m.open?m.closeDialog():m.openDialog()},"Click"),l=()=>o({},a("My content"),i("My Content")),p=c(),m=r({id:"my-popover-left",triggerEl:p,contentEl:l()});return()=>n(o(p,m))},ns=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,os={title:"Popover",package:"popover",description:"The popover component display a dialog next to a composant.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:ns,createComponent:es}]},as=t=>{const e=W(t);return()=>e(os)},rs=()=>nt.map(t=>`
& button.plain.${t}::after {
  color: var(--color-${t});
}
& button.outline.${t}::after {
...
`).join(`
`);function un(t,e){const{bau:n,css:o}=t,{div:a,li:i}=n.tags,s=K(t),r=Kt(t),c=wt(t),l=o`
    & button {
      &::after {
        content: "\u25BC";
        padding: 0.3rem;
...
`,cs={title:"Modal",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Default",description:"A simple select.",code:is,createComponent:ss}],gridItem:dn},ls=t=>{const e=W(t);return()=>e(cs)};function Nt(t,e){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
    ${(()=>nt.map(r=>`
&.slider.${r} {
  accent-color: var(--color-${r});
}
`).join(`
`))()};
  `;return function(...c){let[{color:l="neutral",variant:p="outline",size:m,...u},...g]=Z(c);return a({...u,type:"range",class:D("slider",l,p,m,s,e==null?void 0:e.class,u.class)},...g)}}const pn=t=>{const{bau:e}=t,n=e.state(0),o=i=>{n.val=i==null?void 0:i.target.value},a=Nt(t);return i=>a({...i,oninput:o})},us=t=>{const{bau:e}=t,{section:n,form:o,label:a,br:i}=e.tags,s=e.state(0),r=l=>{s.val=l==null?void 0:l.target.value},c=Nt(t);return()=>n(o(a("Slider with step, min and max",i,c({oninput:r,name:"slider-simple",step:20,min:-100,max:100}))))},ds=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,ps=t=>{const{bau:e,css:n}=t,{section:o,form:a,label:i,datalist:s,br:r,option:c}=e.tags,l=e.state(0),p=u=>{l.val=u==null?void 0:u.target.value},m=Nt(t);return()=>o(a(i({for:"temp"},"Choose a comfortable temperature"),r,m({oninput:p,class:n`
            width: 300px;
            margin: 0;
...
`,bs=t=>{const{bau:e,css:n}=t,{section:o,form:a,label:i,datalist:s,br:r,option:c}=e.tags,l=e.state(0),p=u=>{l.val=u==null?void 0:u.target.value},m=Nt(t);return()=>o(a({class:n`
            display: flex;
...
`,Rs={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Ds,createComponent:Ms},{title:"Extended Tabs",description:"An extended tabs.",code:$s,createComponent:Is},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:_s,createComponent:Ns},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:Os,createComponent:Bs}],gridItem:gn},Ps=t=>{const e=W(t);return()=>e(Rs)};function Et(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:i}=n.tags;a`
  :root {
...
`,Ws={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:js,createComponent:Ls},{title:"Dense",description:"A dense table.",code:Us,createComponent:Hs},{title:"Zebra",description:"A zebra table.",code:Vs,createComponent:Fs}]},Xs=t=>{const e=W(t);return()=>e(Ws)};function vn(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,i=qt(t),s=K(t),r=Jt(t),c=o`
  ...
  `,l=({label:x,icon:f,...h})=>s({"aria-label":x,title:x,...h},f),p=({count:x,totalCount:f,page:h,rowsPerPage:C})=>a({class:"pages-numbers"},Number(h-1)*Number(C)+(x>0?1:0),"-",Math.min(h*C,f)," of ",f),m=({count:x,page:f,rowsPerPage:h})=>a({class:"pages-numbers"},(f-1)*h+(x>0?1:0),"-",f*h),u=x=>x<=1,g=(x,f,h)=>x>=Math.ceil(f/h);return function(...f){let[{count:h=0,totalCount:C=0,page:E=1,rowsPerPage:k=50,onPageChange:I,isLoading:B=!1,disableFirst:R=()=>u(E),disablePrevious:N=()=>u(E),disableNext:O=()=>g(E,C,k),disableLast:T=()=>g(E,C,k),...$},...H]=Z(f);const F=Math.max(0,Math.ceil(C/k)),q=I({page:1}),Y=I({page:E-1}),J=I({page:E+1}),v=I({page:F}),d=[{label:"First",icon:"⟪",onclick:q,disabled:R()},{label:"Previous",icon:"⟨",onclick:Y,disabled:N()},{label:"Next",icon:"⟩",onclick:J,disabled:O()},{label:"Last",icon:"⟫",onclick:v,disabled:T()}];return a({...$,class:D("table-pagination",c,B&&"disabled",e==null?void 0:e.class,$==null?void 0:$.class)},r({class:"spinner",visibility:B,size:"md"}),C>0?p({count:h,totalCount:C,page:E,maxPages:F,rowsPerPage:k}):m({count:h,page:E,maxPages:F,rowsPerPage:k}),i({variant:"outline",color:"neutral"},d.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const Zs=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Ks=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=e.tags,l=Zs(45),p=({name:E,email:k})=>i(a(E),a(k)),m=()=>r(o({class:n`
    ...
    `}),O=({message:T})=>l(T);return()=>N(()=>R({rowsPerPage:f.val,page:x.val,count:g.val,totalCount:-1,isLoading:p.val,onPageChange:E,disableNext:()=>!1}),s(B(),()=>u.val&&O({message:u.val}),()=>c(h.val.map(I))))},qs=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:i,h2:s,tr:r}=e.tags,c=Ks(t),l=Ys(t),p=(...m)=>a({class:n`
        ...
        `},...m);return()=>o({id:"pagination"},s(r("Table Pagination")),i("Asynchronous Pagination"),p(l()),i("Simple Pagination"),p(c()))};function Qt(t,e){const{bau:n,css:o,window:a}=t,{div:i}=n.tags,s=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,ti=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:i}=e.tags,s=K(t),r=Qt(t),c=()=>o(a("A ",i("tooltip")," can be any component")),l=()=>[o({class:n`
          display: flex;
          justify-content: space-around;
...
`,si={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:ri,createComponent:ai}],gridItem:wn},ii=t=>{const e=W(t);return()=>e(si)},ci=({css:t,createGlobalStyles:e})=>(e`
:root {
