...
`);function he(e,t){const{bau:n,css:o,window:r}=e,{input:a}=n.tags,s=d=>{r.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},l=()=>{try{return localStorage.getItem("theme")}catch{}},c=l();c?s(c):r.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):r.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(St);const m=o`
    ...
    ${$t()}
  `;return function(...i){let[{color:u,variant:g="outline",size:p,...b},...h]=U(i);return a({required:"required",title:"Switch Theme",...b,class:T("theme-switch",m,u,g,p,t==null?void 0:t.class,b.class),type:"checkbox",checked:l()=="dark",onclick:v=>{s(v.target.checked?"dark":"light")}},...h)}}function Et(e){const{tr:t,bau:n,css:o,config:r,states:a}=e,{i:s,header:l,h1:c,div:m,a:d,img:i,b:u,ul:g,li:p}=n.tags,{svg:b,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),v=a.drawerOpen,y=W(e,{class:o`
    ...
    `}),$=he(e),S=()=>s(b({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),M=()=>m({class:o`
        ...
        `},y({"aria-label":"drawer",variant:"none",color:"none",onclick:()=>v.val=!v.val},S()),d({href:`${r.base}/`,class:o`
          ...
          padding: 1rem;
          align-items: center;
        `},$(),y({class:o``,target:"_blank",href:"https://github.com/grucloud/bau",title:"Bau's Github"},i({class:o`
            border-radius: 50%;
            background: black;
...
`))()}
 ...
 `});function pe(e,t){const{bau:n,css:o,window:r}=e,{base:a=""}=t,s=({currentTree:z,data:H,onclickBack:G})=>h(S({variant:"plain",href:`${a}${z.parentTree.children[0].data.href}`,onclick:G({currentTree:z}),class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),S({variant:"plain",href:`${a}${H.href}`},H.name)),l=({data:{name:z,href:H},children:G=[]})=>S({href:`${a}${H}`,"data-ischild":G.length==0},z),c=({subTree:z})=>{var H;return r.location.pathname.replace(a,"")===((H=z==null?void 0:z.data)==null?void 0:H.href)},{renderHeader:m=s,renderMenuItem:d=l,isActive:i=c}=t,{ul:u,li:g,nav:p,div:b,header:h,a:v}=n.tags,y=De(),$=oe(e),S=W(e,{class:o`
      &.button {
        flex-grow: 1;
  ...
  `,P=({variant:z,color:H,size:G,onclickItem:f,onclickBack:x,currentTree:C,pathnameState:k})=>{const{children:E,parentTree:_,data:N}=C;return b({class:T("drillDownMenu",z,H,G)},_&&m({data:N,currentTree:C,onclickBack:x}),E&&$({class:T(z,H,G)},E.map(R=>g({class:()=>T(R.children&&"has-children",i({pathname:k.val,subTree:R})&&"active"),onclick:R.children&&f({currentTree:R})},d(R)))))},F=({tree:z,pathname:H})=>{let G=Le({})(z),f=Pe(H)(G);return f||(console.log("drilldown no sub tree",H),f=G),f};return function(H){const{variant:G="plain",color:f="neutral",size:x,tree:C,pathnameState:k=n.state(r.location.pathname),...E}=H,_=({currentTree:L})=>O=>R(O,j,L,!0),N=({currentTree:L})=>O=>R(O,j,L.parentTree,!1),R=(L,O,X,q)=>{O.firstChild.replaceChildren(y({parent:O,animationHide:`${q?M:D} ${$e}`,animationShow:`${q?A:I} ${$e}`},P({variant:G,color:f,size:x,currentTree:X,onclickItem:_,onclickBack:N,pathnameState:k})))},j=p({class:T(B,t==null?void 0:t.class,E.class)},()=>P({variant:G,color:f,size:x,currentTree:F({tree:C,pathname:k.val}),onclickItem:_,onclickBack:N,pathnameState:k}));return j}}const It={data:{name:"Root"},children:[{data:{name:"Bau UI",href:"/"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tab",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function ze(e){const{tr:t,bau:n,css:o,config:r,states:a,window:s}=e,{div:l,ul:c,li:m,nav:d,a:i,span:u}=n.tags;let g=!1;const p=pe(e,{base:r.base});return function(){return l({bauMounted:({element:h})=>{s.innerWidth<=640&&(g=!0,a.drawerOpen.val=!1)},onclick:h=>{g&&!h.target.dataset.buttonback&&!h.target.parentElement.classList.contains("has-children")&&(a.drawerOpen.val=!1)},style:()=>a.drawerOpen.val?"display:block;":"display:none;",class:T(o`
          ...
          `)},p({tree:It,pathnameState:a.pathname}))}}const Mt=e=>{const{bau:t,css:n,states:o}=e,{div:r}=t.tags,a=Et(e),s=ze(e),l=Tt(e);return function({componentState:m}){return r({class:n`
          display: grid;
...
`).join(`
`);function Ne(e,t){const{bau:n,css:o}=e,{accordionDefs:r}=t,{div:a,ul:s,li:l,header:c,h3:m,button:d}=n.tags,i=n.state(""),u=b=>h=>{i.val==b?i.val="":i.val=b},g=({element:b,open:h})=>{const v=()=>{b.removeEventListener("transitionend",v)};function y(S){S.addEventListener("transitionend",v),window.requestAnimationFrame(()=>{S.style.height="0px"})}function $(S){S.addEventListener("transitionend",v),S.style.height=S.scrollHeight+"px"}b.scrollHeight!=0&&(h?$(b):y(b))},p=o`
    & ul {
      display: flex;
      flex-direction: column;
      justify-content: flex-start;
    ...
    ${Pt()}
  `;return function(...h){let[{color:v,variant:y="outline",size:$,content:S,...M},...D]=U(h);const A=I=>{const{Header:B,Content:P,name:F}=I;return l({class:T(v,y,$),onclick:u(F)},m({class:()=>T(i.val==F&&"active")},d({type:"button","aria-controls":`bau-${F}`,"aria-expanded":({element:z})=>i.val==F},B(I))),a({class:"content",role:"region",id:`bau-${F}`,"data-state":({element:z})=>{const H=i.val==F;return g({element:z,open:H}),H}},P(I)))};return a({class:T("accordion",p,t==null?void 0:t.class,M.class)},s(r.map(A)))}}const V=e=>{const{bau:t,css:n}=e,{div:o,table:r,tbody:a,tr:s,td:l,thead:c,th:m}=t.tags,d=["sm","md","lg"];return function({Item:u,name:g}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},...p),g=Ne(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>a(m("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>a(m("Item 2 Content"))},{name:"Item3",Header:()=>"Item 3",Content:()=>a(m("Item 3 content"))}]});return()=>r({id:"accordion"},c(t("Accordion")),l("Accordion Table"),d({Item:p=>g({...p})}),l("Customization"),s("Default Accordion"),i(g({})),s("Accordion width: fit-content"),i(g({color:"warning",class:o`
          ...
          `})))},Nt={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},jt=({css:e,createGlobalStyles:t})=>{t`
:root {
...
`);function ne(e,t){const{bau:n,css:o,createGlobalStyles:r}=e,{div:a,i:s}=n.tags;jt({css:o,createGlobalStyles:r});const l=o`
 ...
 `}),Vt=e=>{const{bau:t}=e,{section:n,div:o,h1:r}=t.tags,a=De(),s=W(e),l=Rt(e);return function(){const c=t.state(!0),m=o(),d=i=>{m.replaceChildren(a({parent:m,animationHide:`${l.hideRight} 0.5s`,animationShow:`${l.showRight} 0.5s`},o(i.val?"Ciao":"")))};return d(c),n({id:"animate"},o(r("Test Animate"),o(s({onclick:()=>{c.val=!c.val,d(c)}},()=>c.val?"Hide":"Show")),m))}};function je(e,t){const{bau:n}=e,{span:o,img:r}=n.tags,a=n.state(!0),s=n.state(!1),l=()=>a.val=!1,c=m=>{a.val=!1,s.val=!0};return function(...d){let[{color:i,variant:u="outline",size:g,width:p=60,height:b=60,...h},...v]=U(d);return o({class:T(t==null?void 0:t.class,h.class)},()=>a.val?"Loading...":"",()=>s.val&&"Error",r({width:p,height:b,onload:l,onerror:c,class:T(t==null?void 0:t.class,i,u,g,h.class),...h}))}}const Ut=e=>{const{tr:t,bau:n,css:o}=e,{section:r,h2:a,h3:s}=n.tags,l=o`
    > img {
...
`);function He(e,t){const{bau:n,css:o}=e,{div:r,li:a,ul:s}=n.tags,l=be(e),c=W(e),m=ge(e),d=oe(e),i=o`
    ...
    ${Xt()}
  `,u=n.state(""),g=n.state(""),p=n.state(!1),b=n.state(0),h=()=>{p.val=!1};return function(...y){let[{variant:$="outline",color:S,size:M,id:D,label:A,placeholder:I,Option:B,options:P,getOptionLabel:F=({label:O})=>O,...z},...H]=U(y);const G=n.state(P),f=()=>{L.openDialog(),p.val=!0,g.val="",G.val=P},x=()=>{L.closeDialog(),p.val=!1,g.val=""},C=O=>{const{value:X}=O.target;g.val=X,X?G.val=P.filter(q=>F(q).match(new RegExp(`${X}`,"i"))):G.val=P},k=O=>{p.val?x():f()},E=({option:O,index:X})=>q=>{u.val=F(O),b.val=X,x()},_=O=>{switch(console.log("onkeydown",O.key,b.val),O.key){case"Escape":x();break;case"ArrowDown":b.val<G.val.length-1?b.val++:b.val=0;break;case"ArrowUp":b.val<=0?b.val=G.val.length-1:b.val--;break;case"Enter":u.val=F(G.val[b.val]),g.val="",x();break}},N=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":A,onclick:k,variant:$,color:S,size:M},()=>!u.val&&A,u),R=m({id:D,value:g,placeholder:I,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":p,oninput:C,onkeydown:_,variant:$,color:S,size:M}),L=l({id:D,triggerEl:N,contentEl:(()=>r({class:T($,S,M,"content")},R,()=>d({class:T($,S,M)},G.val.map((O,X)=>a({class:()=>T(b.val==X&&"active"),onclick:E({option:O,index:X})},B(O))))))(),onClose:h});return r({...z,class:T("autocomplete",i,t==null?void 0:t.class,z==null?void 0:z.class)},N,L)}}const Wt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:c}=n.tags,m=(...p)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`))()}
  ...
  `;return function(...l){let[{color:c,variant:m="outline",size:d,openState:i,...u},...g]=U(l);return r({class:T(a,t==null?void 0:t.class,u.class)},r({class:()=>T("overlay",i.val&&"overlay-open"),onclick:()=>{i.val=!1}}),r({class:()=>T("content",i.val&&"content-open")},g))}}const na=e=>{const{tr:t,bau:n}=e,{section:o,h2:r}=n.tags,a=n.state(!1),s=aa(e),l=W(e),c=ze(e);return()=>o({id:"drawer"},r(t("Drawer")),l({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),s({openState:a},c()))},oa=e=>{const{tr:t,bau:n,window:o,config:r}=e,{section:a,h2:s,h3:l}=n.tags,c=n.state(o.location.pathname.replace(r.base,"")),m=V(e),d={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},i=pe(e,{base:r.base+"/components/drillDownMenu"});return()=>a({id:"drillDownMenu"},s(t("Drill Down Menu")),i({tree:d,pathnameState:c}),l("Drill Down Table"),m({Item:u=>i({tree:d,...u})}))};function Re(e,t){const{bau:n,css:o}=e,{div:r,span:a,label:s,input:l}=n.tags,c={base:o`
    ...
    `};return function(d,...i){const{variant:u="outline",color:g="neutral",size:p,Component:b,disabled:h,...v}=d;return r({class:T(c.base,h&&c.disabled,t==null?void 0:t.class,d.class)},s({class:T(u,g,p)},b({disabled:h}),l({type:"file",disabled:h,...v})),a({class:"filename-display"}))}}const ra=e=>{const{tr:t,bau:n,css:o}=e,{svg:r,use:a}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,h3:c,h2:m,span:d}=n.tags,i=V(e),u=n.state("No file selected"),g=Re(e),p=h=>{const v=h.target.files[0];v?u.val=v.name:u.val="No file selected"},b=({disabled:h})=>l({class:T(o`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`))()}
  `;return function(...c){let[{color:m="neutral",variant:d="outline",size:i,...u},...g]=U(c);return r({class:T("modal",s,m,d,i,t==null?void 0:t.class,u==null?void 0:u.class)},...g)}}const la=e=>{const{tr:t,bau:n}=e,{section:o,main:r,h2:a,header:s,footer:l,p:c,div:m}=n.tags,d=V(e),i=W(e),u=Ve(e),g=()=>r(Array(10).fill("").map((h,v)=>c(v+1,". Some text here"))),p=h=>{const v=u({id:"my-dialog",...h},s("Header"),g(),l(i({variant:"outline",color:h.color,onclick:()=>{v.close()}},"Cancel"),i({variant:"solid",color:h.color,onclick:()=>{v.close()}},"OK")));return v},b=p({color:"neutral"});return()=>o({id:"modal"},a(t("Modal Examples")),i({variant:"solid",color:"neutral",onclick:()=>{b.showModal()}},"OPEN MODAL"),b,a(t("Modal Table")),d({Item:h=>{const v=p(h);return m(i({...h,onclick:()=>{v.showModal()}},"OPEN MODAL"),v)}}))},ia=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,h1:c,p:m}=n.tags,d=W(e),i=(...M)=>a({class:o`
          ...
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...M),u=be(e),p=(()=>d({onclick:()=>v.open?v.closeDialog():v.openDialog()},"Click"))(),b=()=>a({},c("My content"),m("My Content")),h=b(),v=u({id:"my-popover-left",triggerEl:p,contentEl:h}),y=d({onclick:()=>S.open?S.closeDialog():S.openDialog()},"Click"),$=b(),S=u({id:"my-popover-left",triggerEl:y,contentEl:$});return()=>r({id:"popover",class:o``},l(t("Popover")),s("Basic Popover"),i(a(p,v),a(y,S)))},ca=()=>K.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function Ue(e,t){const{bau:n,css:o}=e,{div:r,li:a}=n.tags,s=W(e),l=be(e),c=oe(e),m=o`
    ...
    ${ca()}
  `,d=n.state(""),i=n.state(!1),u=n.state(0);return function(...p){let[{color:b="neutral",variant:h="outline",size:v,id:y,label:$,Option:S,options:M,getOptionLabel:D=({label:k})=>k,...A},...I]=U(p);const B=()=>{C.openDialog(),C.focus(),i.val=!0},P=()=>{C.closeDialog(),i.val=!1},F=()=>{i.val=!1},z=k=>{i.val?P():B()},H=({option:k,index:E})=>_=>{d.val=D(k),u.val=E,P()},G=k=>{switch(k.preventDefault(),k.key){case"Escape":P();break;case"ArrowDown":u.val<M.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=M.length-1:u.val--;break;case"Enter":i.val?(d.val=D(M[u.val]),P()):B();break}},f=()=>c({tabindex:"0",class:T(b,h)},M.map((k,E)=>a({class:()=>T(u.val==E&&"active"),onclick:H({option:k,index:E})},S(k)))),x=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":i,"aria-label":$,onclick:z,color:b,variant:h,size:v},()=>!d.val&&$,d),C=l({id:y,triggerEl:x,contentEl:f(),onClose:F});return r({...A,class:T("select",b,v,m,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:G},x,C)}}const da=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:c}=n.tags,m=(...p)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`))()};
  `;return function(...c){let[{color:m="neutral",variant:d="outline",size:i,...u},...g]=U(c);return r({...u,type:"range",class:T("slider",m,d,i,s,t==null?void 0:t.class,u.class)},...g)}}const ua=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:c,label:m,datalist:d,option:i,br:u}=n.tags,g=n.state(0),p=S=>{g.val=S==null?void 0:S.target.value},b=(...S)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...S),h=V(e),v=ae(e),y=ae(e),$=ae(e);return()=>r({id:"slider"},l(t("Slider")),c("Slider value: ",g),s("Basic Slider"),b(v({oninput:p,name:"slider-simple"})),s(t("Slider Table")),h({Item:S=>v(S)}),s("Slider Min Max: -1000 1000"),b(y({oninput:p,min:-1e3,max:1e3})),s("Slider Step 20"),b(v({oninput:p,step:20,min:-100,max:100})),s("Slider Vertical"),b(a({class:o`
              display: flex;
...
`;const s=o`
  ...
  `;return function(...c){let[{...m},...d]=U(c);return a({...m,class:T("table-container",s,t==null?void 0:t.class,m==null?void 0:m.class)},...d)}}const fa=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s,th:l,td:c,tr:m,table:d,thead:i,tbody:u,caption:g}=t.tags;function p(I,B,P,F,z){return{name:I,calories:B,fat:P,carbs:F,protein:z}}const b=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],h=(...I)=>r({class:n`
    ...
    `});return()=>o({id:"table"},s(m("Table")),a("Basic Table"),h($(d(g("Basic Table"),y(),u(b.map(v))))),a("Dense Table"),h(S(d(g("Dense Table"),y(),u(b.map(v))))),a("Zebra Table"),h(M(d(g("Zebra Table"),y(),u(b.map(v))))),a("Caption Bottom"),h(D(d(g("Caption Bottom Table"),y(),u(b.map(v))))),a("Overflow Header"),h(A(d(g("Overflow Header"),y(),u(b.map(v))))))};function Xe(e,t){const{bau:n,css:o}=e,{div:r}=n.tags,a=fe(e),s=W(e),l=ve(e),c=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,m=({label:p,icon:b,...h})=>s({"aria-label":p,title:p,...h},b),d=({count:p,totalCount:b,page:h,rowsPerPage:v})=>r({class:"pages-numbers"},Number(h-1)*Number(v)+(p>0?1:0),"-",Math.min(h*v,b)," of ",b),i=({count:p,page:b,rowsPerPage:h})=>r({class:"pages-numbers"},(b-1)*h+(p>0?1:0),"-",b*h),u=p=>p<=1,g=(p,b,h)=>p>=Math.ceil(b/h);return function(...b){let[{count:h=0,totalCount:v=0,page:y=1,rowsPerPage:$=50,onPageChange:S,isLoading:M=!1,disableFirst:D=()=>u(y),disablePrevious:A=()=>u(y),disableNext:I=()=>g(y,v,$),disableLast:B=()=>g(y,v,$),...P},...F]=U(b);const z=Math.max(0,Math.ceil(v/$)),H=S({page:1}),G=S({page:y-1}),f=S({page:y+1}),x=S({page:z}),C=[{label:"First",icon:"⟪",onclick:H,disabled:D()},{label:"Previous",icon:"⟨",onclick:G,disabled:A()},{label:"Next",icon:"⟩",onclick:f,disabled:I()},{label:"Last",icon:"⟫",onclick:x,disabled:B()}];return r({...P,class:T("table-pagination",c,M&&"disabled",t==null?void 0:t.class,P==null?void 0:P.class)},l({class:"spinner",visibility:M,size:"md"}),v>0?d({count:h,totalCount:v,page:y,maxPages:z,rowsPerPage:$}):i({count:h,page:y,maxPages:z,rowsPerPage:$}),a({variant:"outline",color:"neutral"},C.map(k=>m({...k,variant:"outline",color:"neutral"}))))}}const va=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.col"})),wa=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:c}=t.tags,m=va(45),d=({name:y,email:$})=>a(r(y),r($)),i=()=>l(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),u=Xe(e),g=Q(e,{class:n`
      max-width: 650px;
    `}),p=t.state(m),b=t.state({count:m.length,totalCount:m.length,page:1,rowsPerPage:10}),h=t.derive(()=>p.val.slice(b.val.page*b.val.rowsPerPage,(b.val.page+1)*b.val.rowsPerPage)),v=({page:y})=>$=>{b.val.page=y};return()=>g(s(i(),()=>c(h.val.map(d))),()=>u({...b.val,onPageChange:v}))},ya=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:c,div:m}=t.tags,d=t.state(!1),i=t.state([]),u=t.state(""),g=t.derive(()=>i.val.length),p=t.state(1),b=t.state(10),h=t.derive(()=>i.val),v=B=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(B).toString()}`,y=({page:B})=>P=>{p.val=B,$(v({page:B,per_page:b.val}))};$(v({page:1,per_page:b.val}));async function $(B){try{d.val=!0;const P=await fetch(B,{});if(P.ok){const F=await P.json();i.val=F;return}throw P}catch(P){u.val=P.message}finally{d.val=!1}}const S=({name:B,description:P,stargazers_count:F})=>a(r(B),r(P),r({class:n`
            text-align: right;
          `},F)),M=()=>l(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),I=({message:B})=>m(B);return()=>A(()=>D({rowsPerPage:b.val,page:p.val,count:g.val,totalCount:-1,isLoading:d.val,onPageChange:y,disableNext:()=>!1}),s(M(),()=>u.val&&I({message:u.val}),()=>c(h.val.map(S))))},xa=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s,tr:l}=t.tags,c=wa(e),m=ya(e),d=(...i)=>r({class:n`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
          & .table-container {
            width: 100%;
...
`,{nav:e`
  ...
  `,expanded:e`
    ...
    `}),P=ie(e),F={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},z=Oe(e),H=W(e),G=fe(e),f=ce(e),x=Fe(e),C=Ge(e),k={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#m1"},children:[{data:{name:"Sub Menu 1",href:"#menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu2"}}]},E=pe(e,{base:o.base+"/components"}),_=({disabled:w})=>a({class:T(n`
          ...
          `,w&&n`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},h({width:100,height:100,fill:"currentColor"},v({href:"uploadIcon.svg#Capa_1"})),l("Choose a file to upload")),N=Re(e),R=ge(e),j=Ve(e),L=()=>u(Array(10).fill("").map((w,Y)=>c(Y+1,". Some text here"))),O=w=>{const Y=j({id:"my-dialog",...w},g("Header"),L(),p(H({...w,variant:"outline",onclick:()=>{Y.close()}},"Cancel"),H({...w,variant:"solid",onclick:()=>{Y.close()}},"OK")));return Y},X=Ue(e),q=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],Z=w=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},l(w.label),l(w.code)),re=ae(e),qe=ve(e),ye=_e(e),Ye=de(e,{tabDefs:[{name:"Tab1",Header:()=>a("TAB"),Content:()=>a(c("My Tab 1 Content"))},{name:"Tab2",Header:()=>a("TAB 2"),Content:()=>a(c("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>a("Tab Disabled"),Content:()=>a(c("My tab Disabled"))}]}),Ke=he(e),Ze=()=>l("My tooltip"),Je=ue(e),Qe={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},et=We(e,{renderMenuItem:({name:w,href:Y})=>i({href:Y,onclick:tt=>{tt.preventDefault()}},w)}),xe=[{name:"Accordion",Item:w=>S({...w})},{name:"Alert",Item:w=>M({...w},`Alert ${w.color}`)},{name:"Autocomplete",Item:w=>D({...w,options:A,Option:I,getOptionLabel:({label:Y})=>Y,label:"Country",placeholder:"Search countries",id:"country"})},{name:"Avatar",Item:w=>B({...w,src:"./grucloud.svg",alt:"GruCloud"})},{name:"Badge",Item:(w,{index:Y})=>P({...w,content:`${Y*100}`},"☏")},{name:"Breadcrumbs",Item:w=>z({...w,...F})},{name:"Button",Item:w=>H({...w},`${w.variant} ${w.color}`)},{name:"Button Group",Item:w=>G({...w},["ONE","TWO","THREE"].map(Y=>H(w,Y)))},{name:"Calendar",Item:w=>a({class:n`
              border: 1px dotted var(--color-emphasis-200);
              font-size: smaller;
              color: var(--color-content-secondary);
              padding: 0.2rem;
            ...
            `},`${w.color} ${w.variant}`,x({id:`myCheckbox-gallery-${w.color}-${w.variant}`,name:`myCheckbox-gallery-${w.color}-${w.variant}`,...w}))},{name:"Chip",Item:w=>C({...w},`Chip ${w.color}`)},{name:"DrillDown Menu",Item:w=>E({tree:k,...w})},{name:"File Input",Item:w=>N({Component:_,name:"file",accept:"text/*",onchange,...w})},{name:"Input",Item:w=>R({name:"my-input",id:"my-input-with",placeholder:"Enter text",...w})},{name:"Modal",Item:w=>{const Y=O(w);return a(H({...w,onclick:()=>{Y.showModal()}},"OPEN MODAL"),Y)}},{name:"Select",Item:w=>a(X({...w,options:q,Option:Z,getOptionLabel:({label:Y})=>Y,label:"Select a country..."}))},{name:"Slider",Item:w=>a({class:n`
              ...
              color: var(--color-content-secondary);
              padding: 0.2rem;
            `},b(`${w.color} ${w.variant}`,re({...w,id:`my-slider-${w.color}-${w.variant}`})))},{name:"Spinner",Item:w=>qe(w)},{name:"Switch",Item:w=>a({class:n`
              & label {
                display: inline-flex;
                border: 1px dotted var(--color-emphasis-200);
                font-size: smaller;
  ...
  `},za=e=>{const{createGlobalStyles:t}=e;t`
  ...
  `};pt();const we={title:"Bau",base:"/bau/bau-ui"},J=Ct({config:we}),{bau:Ae}=J;J.states={pathname:Ae.state(window.location.pathname.replace(we.base,"")),drawerOpen:Ae.state(!0)};Pa(J);za(J);rt({routes:Ba({context:J}),onLocationChange:La({context:J,LayoutDefault:Mt(J),config:we}),notFoundRoute:Da(J)});
