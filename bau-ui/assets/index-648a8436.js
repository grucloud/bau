...
`)}
  ...
  `}function Un(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let Ge=e=>Object.prototype.toString.call(e??0).slice(8,-1),Gn=e=>Ge(e)=="Object",st=e=>Ge(e)=="Function",je=e=>["Object","Array"].includes(Ge(e)),it=Object.getPrototypeOf,ze=e=>me(e)?e.val:e,me=e=>e==null?void 0:e.__isState,Fn=["splice","push","pop","shift","unshift","sort","reverse"],ke=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const X=e=>!me(e[0])&&Gn(e[0])?e:[{},...e];function Vn(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,s=new Set,i=!1,r,c=v=>n.createElement(v),l=(v,m,b)=>{let x=r;r=m;let y=v(b);return r=x,y},d=()=>{o||(o=window.requestAnimationFrame(()=>{a.forEach(v=>{v.bindings=v.bindings.filter(m=>{var b;return(b=m.element)==null?void 0:b.isConnected}),!v.bindings.length&&!v.computed&&a.delete(v)}),o=void 0}))},p=(v,m,b,x,y,L)=>{var _;if(i){s.add(v);return}for(let U of v.bindings){let{deps:z,element:M,renderInferred:G,render:te,renderItem:oe}=U;if(oe&&m)(_=w(M,x,(...re)=>h(oe(...re)),b,y,L)[m])==null||_.call();else{let re=G?G({element:M}):te({element:M,renderItem:oe})(...z.map(ze));re!==M&&M.replaceWith(U.element=h(re))}}k(v),d()},u=(v,m,b=[])=>({get(x,y,L){var _;if(r==null||r.add(v),y==="_isProxy")return!0;if(!((_=x[y])!=null&&_._isProxy)&&!me(x[y])&&je(x[y]))x[y]=new Proxy(x[y],u(v,m,[...b,y]));else if(Fn.includes(y)){let U=x[y];return(...z)=>{let M=U.apply(x,z);return p(v,y,M,z,m,b),M}}return Reflect.get(x,y,L)},set(x,y,L,_){let U=Reflect.set(x,y,L,_);return p(v,"setItem",U,{prop:y,value:L},m,[...b,y]),U}}),g=(v,m)=>new Proxy(m,u(v,m)),w=(v,m,b,x,y,L)=>{let _=()=>v.replaceChildren(...ke(x,b)),U=z=>v[z]&&v.removeChild(v[z]);return{assign:_,sort:_,reverse:_,setItem:()=>{var M;let z=L[0];(M=v.children[z])==null||M.replaceWith(b(y[z],z))},push:()=>v.append(...ke(m,(z,M)=>b(z,y.length+M))),unshift:()=>v.prepend(...ke(m,b)),pop:()=>U("lastChild"),shift:()=>U("firstChild"),splice:()=>{let[z,M,...G]=m;const{length:te}=v.children;for(let oe=z>=0?Math.min(z+M-1,te-1):te-1;oe>=(z>=0?z:te+z);oe--)v.children[oe].remove();if(G.length){let oe=G.forEach((re,Oe)=>b(re,z+Oe));v.children[z]?v.children[z].after(...oe):v.append(...oe)}}}},f=v=>({oldVal:v,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=je(v)?g(m,v):v,m.valProxy)},set val(m){let b=this,x=b.val;je(m)?(b.valProxy=g(b,m),p(b,"assign",m)):m!==x&&(b.valProxy=m,p(b)),b.oldVal=x}}),h=v=>v==null||v===!1?c("span"):v.nodeType?v:n.createTextNode(v),C=(v,m)=>{let b=new Set;return m.val=l(v,b),b},E=v=>{let m=f(),b=C(v,m);m.computed=!0;for(let x of b)x.listeners.push({computed:v,deps:b,state:m});return m},k=v=>{for(let m of[...v.listeners])C(m.computed,m.state)},I=(v,...m)=>{if(m.length){let b=[];for(let x of m.flat(1/0))x!=null&&b.push(me(x)?q({deps:[x],render:()=>y=>y}):st(x)?F({renderInferred:x}):h(x));v.append(...b)}},B={},R=(v,m)=>v&&(Object.getOwnPropertyDescriptor(v,m)??R(it(v),m)),N=(v,m,b)=>{var x;return B[v+","+m]??(B[v+","+m]=((x=R(b,m))==null?void 0:x.set)??0)},O=(v,m)=>new MutationObserver((b,x)=>{b.filter(y=>y.removedNodes).forEach(y=>[...y.removedNodes].find(L=>L===v&&(m({element:v}),x.disconnect(),!0)))}).observe(v.parentNode,{childList:!0}),T=(v,m)=>new MutationObserver((b,x)=>b.forEach(y=>m({record:y,element:v}))).observe(v,{childList:!0}),$=v=>new Proxy(function(b,...x){var U;let[y,...L]=X(x),_=v?n.createElementNS(v,b):c(b);for(let[z,M]of Object.entries(y)){if(z.startsWith("bau"))continue;let G=N(b,z,it(_))?te=>_[z]=te:te=>_.setAttribute(z,te);M==null||(me(M)?q({deps:[M],render:()=>()=>(G(M.val),_)}):st(M)&&(!z.startsWith("on")||M.isDerived)?F({renderInferred:()=>(G(M({element:_})),_)}):M.renderProp?q({deps:M.deps,render:()=>()=>(G(M.renderProp({element:_})(...M.deps.map(ze))),_)}):G(M))}return y.bauChildMutated&&T(_,y.bauChildMutated),I(_,...L),(U=y.bauCreated)==null||U.call(y,{element:_}),y.bauMounted&&t.requestAnimationFrame(()=>y.bauMounted({element:_})),y.bauUnmounted&&t.requestAnimationFrame(()=>O(_,y.bauUnmounted)),_},{get:(m,b)=>m.bind(void 0,b)}),H=(v,m,b)=>{v.element=h(b);for(let x of m)me(x)&&(a.add(x),x.bindings.push(v));return v.element},F=({renderInferred:v,element:m})=>{let b=new Set,x=l(v,b,{element:m});return H({renderInferred:v},b,x)},q=({deps:v,element:m,render:b,renderItem:x})=>H({deps:v,render:b,renderItem:x},v,b({element:m,renderItem:x})(...v.map(ze))),K=(v,m,b)=>q({deps:[v],render:({renderItem:x})=>y=>(m.append(...ke(y,x)),m),renderItem:b}),J=v=>{i=!0,v(),i=!1,s.forEach(p),s.clear()};return{tags:$(),tagsNS:$,state:f,bind:q,loop:K,derive:E,stateSet:a,batch:J}}const Wn=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},Zn=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Xn=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function Kn(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...s)=>{const i=Xn(a,s),r=Wn(i);return!t.getElementById(r)&&Zn(t,e==null?void 0:e.target,r,o(r,i)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function Yn(e){const t=Vn(),n=Kn();return Hn(n),{bau:t,...n,tr:o=>o,window,...e}}function D(...e){return e.filter(t=>t).join(" ")}function De(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:i=a,animationShow:r=a,...c},l){return o({class:D("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:d,element:p})=>{[...d.removedNodes].forEach(u=>{if(!i()||u.getAttribute("cloned"))return;const g=u.cloneNode(!0);g.setAttribute("cloned",!0),g.style.top=0,g.style.left=0,g.style.width=u.getAttribute("width"),g.style.height=u.getAttribute("height"),g.style.position="absolute",g.style.animation=i(),d.target.appendChild(g),g.addEventListener("animationend",()=>g.parentNode.removeChild(g))}),[...d.addedNodes].forEach(u=>{if(u.getAttribute("cloned"))return;p.style.position="relative";const g=u.getBoundingClientRect();if(u.setAttribute("width",g.width+"px"),u.setAttribute("height",g.height+"px"),r()){u.style.animation=r();const w=()=>{u.removeEventListener("animationend",w),u.style.animation=""};u.addEventListener("animationend",w)}})},...c},l)}}function Y(e,t){const{bau:n,css:o}=e,a={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
...
`);function Fe(e,t){const{bau:n,css:o,window:a}=e,{input:s}=n.tags,i=d=>{a.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?i(c):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Qn);const l=o`
    ...
    ${eo()}
  `;return function(...p){let[{color:u,variant:g="outline",size:w="md",...f},...h]=X(p);return s({required:"required",title:"Switch Theme",...f,class:D("theme-switch",u,g,w,l,t==null?void 0:t.class,f.class),type:"checkbox",checked:r()=="dark",onclick:C=>{i(C.target.checked?"dark":"light")}},...h)}}function to(e){const{tr:t,bau:n,css:o,config:a,states:s}=e,{i,header:r,h1:c,div:l,a:d,img:p,b:u,ul:g,li:w}=n.tags,{svg:f,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),C=s.drawerOpen,E=Y(e,{class:o`
    ...
    `}),k=Fe(e),I=()=>i(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),B=()=>l({class:o`
        ...
        `},B(),R())}}function no({tr:e,bau:t,css:n}){const{footer:o,span:a,a:s,ul:i,li:r,p:c}=t.tags;return function(){return o({class:n`
          grid-area: footer;
          display: flex;
          justify-content: center;
          margin: 1rem;
        ...
        `},a("version: 0.41.0"))}}function we(e,t){const{bau:n,css:o}=e,{ul:a}=n.tags,i=o`
    list-style: none;
    padding: 0;
    margin: 0 0;
    &.solid {
...
`))()}
  ...
  `,hideToRight:e`
   ...
   `});function Ve(e,t){const{bau:n,css:o,window:a}=e,{base:s=""}=t,i=({currentTree:T,data:$})=>f(k({variant:"plain",href:`${s}${T.parentTree.children[0].data.href}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),k({variant:"plain",href:`${s}${$.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},$.name)),r=({data:{name:T,href:$},children:H=[]})=>k({href:`${s}${$}`,"data-ischild":!H.length},T),c=({subTree:T})=>{var $;return a.location.pathname.replace(s,"")===(($=T==null?void 0:T.data)==null?void 0:$.href)},{renderHeader:l=i,renderMenuItem:d=r,isActive:p=c}=t,{li:u,nav:g,div:w,header:f,a:h}=n.tags,C=De(e),E=we(e),k=Y(e,{class:o`
      &.button {
  ...
  `,N=({variant:T,color:$,size:H,currentTree:F,pathnameState:q})=>{const{children:K,parentTree:J,data:v}=F;return w({class:D("drillDownMenu",T,$,H)},J&&l({data:v,currentTree:F}),K&&E({class:D(T,$,H)},K.map(m=>u({class:()=>D(m.children&&"has-children",p({pathname:q.val,subTree:m})&&"active")},d(m)))))},O=({tree:T,pathname:$})=>{let H=xt({})(structuredClone(T)),F=wt($)(H);return F||(console.log("drilldown no sub tree",$),F=H),F};return function($){const{variant:H="plain",color:F="neutral",size:q="md",tree:K,pathnameState:J=n.state(a.location.pathname),...v}=$;let m=1;const b=_=>{const{dataset:U}=_.target;U.buttonback=="true"?m=-1:U.ischild=="false"?m=1:U.ischild=="true"&&(m=0)},x=n.derive(()=>O({tree:K,pathname:J.val})),y=_=>{switch(_){case 1:return`${I} ${Te}`;case-1:return`${B} ${Te}`;default:return""}},L=_=>{switch(_){case 1:return`${B} ${Te} reverse`;case-1:return`${I} ${Te} reverse`;default:return""}};return g({class:D(R,t==null?void 0:t.class,v.class),onclick:b},C({animationHide:()=>y(m),animationShow:()=>L(m)},()=>N({variant:H,color:F,size:q,currentTree:x.val,pathnameState:J})))}}const ao={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tab",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function yt(e){const{tr:t,bau:n,css:o,config:a,states:s,window:i}=e,{div:r,ul:c,li:l,nav:d,a:p,span:u}=n.tags;let g=!1;const w=Ve(e,{base:a.base});return function(){return r({bauMounted:({element:h})=>{i.innerWidth<=640&&(g=!0,s.drawerOpen.val=!1)},onclick:h=>{g&&!h.target.dataset.buttonback&&!h.target.parentElement.classList.contains("has-children")&&(s.drawerOpen.val=!1)},style:()=>s.drawerOpen.val?"display:block;":"display:none;",class:D(o`
          ...
          `)},w({tree:ao,pathnameState:s.pathname}))}}const ro=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:s}=t.tags,i=De(e),r=to(e),c=yt(e),l=no(e),d=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),s(l()));return function({featuresContent:l}){return o({class:i},l.map(r))}}function co({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:s,dd:i,div:r,aside:c,footer:l,a:d}=t.tags,p=({maxSize:u=151})=>({libName:g,size:w})=>r({class:n`
            display: flex;
            margin: 0.3rem;
          `},s({class:n`
              display: flex;
        ...
        `},c({class:n`
          ...
          `},g.map(p({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",d({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function lo(e){const{bau:t,css:n,config:o}=e,{div:a,p:s,a:i,section:r}=t.tags,c=so(e),l=io(e),d=Y(e);Ie(e);const p=co(e),u=(...C)=>a({class:n`
...
"Click me"
        ...
        `},a(c(i(l(u??""),ne.map(g=>l(g)))),s(qn.map(g=>i(l(g),ne.map((w,f)=>r(p({color:w,variant:g},{index:f}))))))))}},ha=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:s}){return o({class:n`
          display: flex;
          gap: 2rem;
          align-items: flex-start;
        `},Jn.map((i,r)=>s({color:"success",variant:"outline",size:i},{index:r})))}},W=e=>{const{bau:t,css:n}=e,{article:o,section:a,h1:s,p:i,h2:r,h3:c,pre:l,div:d,code:p}=t.tags;fe.registerLanguage("javascript",Pt);const u=Lt(e),g=ha(e),w=({text:f})=>l({class:n`
          display: inline-block;
        `},p({class:"hljs language-js",bauCreated:({element:h})=>{h.innerHTML=fe.highlight(f,{language:"js"}).value}}));return function(h){return o({class:n``},s(h.title),i(h.description),h.gridItem&&[r("Variant/Color"),h.gridItem&&u({Item:h.gridItem(e)}),r("Size"),i("Component with size: ",p("sm"),", ",p("md"),", and ",p("lg")),h.gridItem&&g({Item:h.gridItem(e)})],r("Usage"),c("Import"),w({text:h.importStatement}),r("Examples"),h.examples.map(C=>a(s(C.title),i(C.description),d(C.createComponent(e)()),w({text:C.code}))))}},ga=()=>ne.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`).join(`
`);function Ne(e,t){const{bau:n,css:o}=e,{accordionDefs:a}=t,{div:s,ul:i,li:r,header:c,h3:l,button:d}=n.tags,p=n.state(""),u=f=>h=>{p.val==f?p.val="":p.val=f},g=({element:f,open:h})=>{const C=()=>{f.removeEventListener("transitionend",C)};function E(I){I.addEventListener("transitionend",C),window.requestAnimationFrame(()=>{I.style.height="0px"})}function k(I){I.addEventListener("transitionend",C),I.style.height=I.scrollHeight+"px"}f.scrollHeight!=0&&(h?k(f):E(f))},w=o`
    & ul {
      display: flex;
      flex-direction: column;
      justify-content: flex-start;
...
`,Na={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Da,createComponent:Ma},{title:"Custom Alert ",description:"A custom alert.",code:$a,createComponent:Ia}],gridItem:Ht},_a=e=>{const t=W(e);return()=>t(Na)},Ba=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:s=10,deleteAfterDuration:i=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},d={stack:o`
    ...
    `},p=({id:u,status:g})=>{const w=c.val.findIndex(f=>f.id===u);w!=-1&&(c.val[w].status=g)};return function(g={},...w){const f=({id:E})=>{p({id:E,status:"removing"});const k=c.val.findIndex(I=>I.id===E);k!=-1&&c.val.splice(k,1)},h=({Component:E})=>{const k={id:Math.random().toString(10).split(".")[1],Component:E,status:"inserting"};c.val.length>=s&&f({id:c.val[0].id}),c.val.push(k),setTimeout(()=>f(k),i)},C=E=>r({class:d.item,onclick:()=>f(E)},E.Component());return document.addEventListener("alert.add",E=>h(E.detail)),document.addEventListener("alert.remove",E=>f(E.detail)),r({class:D(d.stack,t==null?void 0:t.class,g.class)},n.loop(c,r(),C))}},Oa=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Ba(e,{deleteAfterDuration:2e4}),s=Y(e),i=_e(e);return()=>o(a(),s({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>i({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Ra=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ga={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:za,createComponent:ja},{title:"Component hide and show",description:"Hide and show a component",code:Ua,createComponent:Ha}]},Fa=e=>{const t=W(e);return()=>t(Ga)};function Ut(e,t){const{bau:n,css:o}=e,{span:a,img:s}=n.tags,i=n.state(!0),r=n.state(!1),c=()=>i.val=!1,l=p=>{i.val=!1,r.val=!0},d=o`
  ...
  `;return function(...u){let[{color:g,variant:w="outline",size:f="md",width:h=30,height:C=30,...E},...k]=X(u);return a({class:D(d,t==null?void 0:t.class,E.class)},()=>i.val?"Loading...":"",()=>r.val&&"Error",s({width:h,height:C,onload:c,onerror:l,class:D(g,w,f,d,t==null?void 0:t.class,E.class),...E}))}}const Gt=e=>{const{css:t}=e,n=Ut(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function qe(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    ...
    ${Ka()}
  `;return function(r){const{size:c="md",variant:l="outline",color:d="neutral",name:p,id:u,disabled:g,...w}=r;return a({...w,class:D("input",c,d,l,s,t==null?void 0:t.class,w.class)})}}const Ya=()=>ne.map(e=>`
...
`);function Ft(e,t){const{bau:n,css:o}=e,{div:a,li:s,ul:i}=n.tags,r=Ye(e),c=Y(e),l=qe(e),d=we(e),p=o`
    ...
    ${Ya()}
  `,u=n.state(""),g=n.state(""),w=n.state(!1),f=n.state(0),h=()=>{w.val=!1};return function(...E){let[{variant:k="outline",color:I,size:B="md",id:R,label:N,placeholder:O,Option:T,options:$,getOptionLabel:H=({label:M})=>M,...F},...q]=X(E);const K=n.state($),J=()=>{z.openDialog(),w.val=!0,g.val="",K.val=$},v=()=>{z.closeDialog(),w.val=!1,g.val=""},m=M=>{const{value:G}=M.target;g.val=G,G?K.val=$.filter(te=>H(te).match(new RegExp(`${G}`,"i"))):K.val=$},b=M=>{w.val?v():J()},x=({option:M,index:G})=>te=>{u.val=H(M),f.val=G,v()},y=M=>{switch(console.log("onkeydown",M.key,f.val),M.key){case"Escape":v();break;case"ArrowDown":f.val<K.val.length-1?f.val++:f.val=0;break;case"ArrowUp":f.val<=0?f.val=K.val.length-1:f.val--;break;case"Enter":u.val=H(K.val[f.val]),g.val="",v();break}},L=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":w,"aria-label":N,onclick:b,variant:k,color:I,size:B},()=>!u.val&&N,u),_=l({id:R,value:g,placeholder:O,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":w,oninput:m,onkeydown:y,variant:k,color:I,size:B}),z=r({id:R,triggerEl:L,contentEl:(()=>a({class:D(k,I,B,"content")},_,()=>d({class:D(k,I,B)},K.val.map((M,G)=>s({class:()=>D(f.val==G&&"active"),onclick:x({option:M,index:G})},T(M))))))(),onClose:h});return a({...F,class:D("autocomplete",p,t==null?void 0:t.class,F==null?void 0:F.class)},L,z)}}const Vt=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,s=Ft(e),i=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,or={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:nr,createComponent:tr}],gridItem:Zt},ar=e=>{const t=W(e);return()=>t(or)};function Xt(e,t){const{bau:n,css:o}=e,{ul:a,li:s,a:i,span:r}=n.tags,c=Y(e),l=o`
  ...
  `;return function(...p){let[{color:u,variant:g="outline",size:w="md",items:f,...h},...C]=X(p);return a({...h,class:D(l,t==null?void 0:t.class,h==null?void 0:h.class)},f.map(({href:E,name:k})=>s((E?c:r)({href:E,color:u,variant:g,size:w,class:D(u,g,w)},k))))}}const Kt=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=Xt(e);return o=>n({...o,...t})},rr=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=Xt(e);return()=>n(a(o))},sr=`import breadcrumbs, {
...
`,Pr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Rr,createComponent:Or}],gridItem:on},Lr=e=>{const t=W(e);return()=>t(Pr)};function an(e,t){const{bau:n,css:o}=e,{div:a,span:s,label:i,input:r}=n.tags,c={base:o`
    ...
    `};return function(d,...p){const{variant:u="outline",color:g="neutral",size:w="md",Component:f,disabled:h,...C}=d;return a({class:D(c.base,h&&c.disabled,t==null?void 0:t.class,d.class)},i({class:D(u,g,w)},f({disabled:h}),r({type:"file",disabled:h,...C})),s({class:"filename-display"}))}}const rn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:s,use:i}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),d=an(e),p=g=>{const w=g.target.files[0];w?l.val=w.name:l.val="No file selected"},u=({disabled:g})=>r({class:D(o`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,g&&o`
            ...
            `)},s({width:100,height:100,fill:"currentColor"},i({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return g=>d({Component:u,name:"file",accept:"text/*",onchange:p,...g})},jr=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:s,use:i}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,d=n.state("No file selected"),p=an(e),u=w=>{const f=w.target.files[0];f?d.val=f.name:d.val="No file selected"},g=({disabled:w})=>c({class:D(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`);function un(e,t){const{bau:n,css:o}=e,{div:a,li:s}=n.tags,i=Y(e),r=Ye(e),c=we(e),l=o`
    ...
    ${cs()}
  `,d=n.state(""),p=n.state(!1),u=n.state(0);return function(...w){let[{color:f="neutral",variant:h="outline",size:C="md",id:E,label:k,Option:I,options:B,getOptionLabel:R=({label:b})=>b,...N},...O]=X(w);const T=()=>{m.openDialog(),m.focus(),p.val=!0},$=()=>{m.closeDialog(),p.val=!1},H=()=>{p.val=!1},F=b=>{p.val?$():T()},q=({option:b,index:x})=>y=>{d.val=R(b),u.val=x,$()},K=b=>{switch(b.preventDefault(),b.key){case"Escape":$();break;case"ArrowDown":u.val<B.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=B.length-1:u.val--;break;case"Enter":p.val?(d.val=R(B[u.val]),$()):T();break}},J=()=>c({tabindex:"0",class:D(f,h)},B.map((b,x)=>s({class:()=>D(u.val==x&&"active"),onclick:q({option:b,index:x})},I(b)))),v=i({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":k,onclick:F,color:f,variant:h,size:C},()=>!d.val&&k,d),m=r({id:E,triggerEl:v,contentEl:J(),onClose:H});return a({...N,class:D("select",f,C,l,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:K},v,m)}}const dn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,s=un(e),i=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`;const i=o`
  ...
  `;return function(...c){let[{...l},...d]=X(c);return s({...l,class:D("table-container",i,t==null?void 0:t.class,l==null?void 0:l.class)},...d)}}const Hs=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:s,tr:i,table:r,thead:c,tbody:l,caption:d}=t.tags;function p(h,C,E,k,I){return{name:h,calories:C,fat:E,carbs:k,protein:I}}const u=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],g=({name:h,calories:C})=>i(s(h),s({class:n`
      ...
      max-width: 650px;
    `});return()=>o(f(r(d("Basic Table"),w(),l(u.map(g)))))},Us=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ks={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:Us,createComponent:Hs},{title:"Dense",description:"A dense table.",code:Vs,createComponent:Fs},{title:"Zebra",description:"A zebra table.",code:Xs,createComponent:Zs}]},Ys=e=>{const t=W(e);return()=>t(Ks)};function vn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,s=Je(e),i=Y(e),r=Qe(e),c=o`
  ...
  `,l=({label:w,icon:f,...h})=>i({"aria-label":w,title:w,...h},f),d=({count:w,totalCount:f,page:h,rowsPerPage:C})=>a({class:"pages-numbers"},Number(h-1)*Number(C)+(w>0?1:0),"-",Math.min(h*C,f)," of ",f),p=({count:w,page:f,rowsPerPage:h})=>a({class:"pages-numbers"},(f-1)*h+(w>0?1:0),"-",f*h),u=w=>w<=1,g=(w,f,h)=>w>=Math.ceil(f/h);return function(...f){let[{count:h=0,totalCount:C=0,page:E=1,rowsPerPage:k=50,onPageChange:I,isLoading:B=!1,disableFirst:R=()=>u(E),disablePrevious:N=()=>u(E),disableNext:O=()=>g(E,C,k),disableLast:T=()=>g(E,C,k),...$},...H]=X(f);const F=Math.max(0,Math.ceil(C/k)),q=I({page:1}),K=I({page:E-1}),J=I({page:E+1}),v=I({page:F}),m=[{label:"First",icon:"⟪",onclick:q,disabled:R()},{label:"Previous",icon:"⟨",onclick:K,disabled:N()},{label:"Next",icon:"⟩",onclick:J,disabled:O()},{label:"Last",icon:"⟫",onclick:v,disabled:T()}];return a({...$,class:D("table-pagination",c,B&&"disabled",t==null?void 0:t.class,$==null?void 0:$.class)},r({class:"spinner",visibility:B,size:"md"}),C>0?d({count:h,totalCount:C,page:E,maxPages:F,rowsPerPage:k}):p({count:h,page:E,maxPages:F,rowsPerPage:k}),s({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const qs=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Js=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:s,table:i,thead:r,tbody:c}=t.tags,l=qs(45),d=({name:E,email:k})=>s(a(E),a(k)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),u=vn(e),g=Ce(e,{class:n`
      max-width: 650px;
    `}),w=t.state(l),f=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=t.derive(()=>w.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),C=({page:E})=>k=>{f.val.page=E};return()=>g(i(p(),()=>c(h.val.map(d))),()=>u({...f.val,onPageChange:C}))},Qs=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:s,table:i,thead:r,tbody:c,div:l}=t.tags,d=t.state(!1),p=t.state([]),u=t.state(""),g=t.derive(()=>p.val.length),w=t.state(1),f=t.state(10),h=t.derive(()=>p.val),C=T=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(T).toString()}`,E=({page:T})=>$=>{w.val=T,k(C({page:T,per_page:f.val}))};k(C({page:1,per_page:f.val}));async function k(T){try{d.val=!0;const $=await fetch(T,{});if($.ok){const H=await $.json();p.val=H;return}throw $}catch($){u.val=$.message}finally{d.val=!1}}const I=({name:T,description:$,stargazers_count:H})=>s(a(T),a($),a({class:n`
            text-align: right;
          `},H)),B=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),O=({message:T})=>l(T);return()=>N(()=>R({rowsPerPage:f.val,page:w.val,count:g.val,totalCount:-1,isLoading:d.val,onPageChange:E,disableNext:()=>!1}),i(B(),()=>u.val&&O({message:u.val}),()=>c(h.val.map(I))))},ei=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:s,h2:i,tr:r}=t.tags,c=Js(e),l=Qs(e),d=(...p)=>a({class:n`
