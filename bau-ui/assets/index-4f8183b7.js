...
`);function tt(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(vo);const l=o`
  ...
  `,hideToRight:e`
   ...
   `});function nt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=j=>{var W;return((W=j.parentTree.data)==null?void 0:W.href)??j.parentTree.children[0].data.href},u=({variant:j,color:W,size:U,currentTree:y,data:g})=>C(T({variant:j,color:W,size:U,href:`${c}${l(y)}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),T({variant:j,color:W,size:U,href:`${c}${g.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},g.name)),d=({size:j,subTree:{data:{name:W,href:U},children:y=[]}})=>T({size:j,href:`${c}${U}`,"data-ischild":!y.length},W),p=({pathname:j,subTree:W})=>{var U;return j===((U=W==null?void 0:W.data)==null?void 0:U.href)},{renderHeader:m=u,renderMenuItem:f=d,isActive:h=p}=t,{li:w,nav:v,div:b,header:C,a:k}=n.tags,A=Re(e),N=fe(e),T=q(e,{class:o`
      &.button {
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function Ao({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,d=({maxSize:p=151})=>({libName:m,size:f})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},m.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Io(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=ko(e),l=To(e),u=q(e);Le(e);const d=Ao(e),p=(...v)=>a({class:n`
...
`,sr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:or,createComponent:nr},{title:"Component hide and show",description:"Hide and show a component",code:rr,createComponent:ar}]},ir=e=>{const t=H(e);return()=>t(sr)};function en(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{color:m,variant:f="outline",size:h="md",width:w=30,height:v=30,...b},...C]=V(p);return a({class:B(u,t==null?void 0:t.class,b.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:w,height:v,onload:c,onerror:l,class:B(m,f,h,u,t==null?void 0:t.class,b.class),...b}))}}const tn=e=>{const{css:t}=e,n=en(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function nn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=ct(e),r=q(e),c=ve(e),l=fe(e),u=o`
    ...
    ${mr()}
  `;return function(...p){let[{variant:m="outline",color:f,size:h="md",id:w,label:v,placeholder:b,Option:C,options:k,getOptionLabel:A=({label:_})=>_,...N},...T]=V(p);const D=n.state(""),M=n.state(""),L=n.state(!1),K=n.state(0),J=()=>{L.val=!1},j=n.state(k),W=()=>{F.openDialog(),L.val=!0,M.val="",j.val=k},U=()=>{F.closeDialog(),L.val=!1,M.val=""},y=_=>{const{value:P}=_.target;M.val=P,P?j.val=k.filter(X=>A(X).match(new RegExp(`${P}`,"i"))):j.val=k},g=_=>{L.val?U():W()},x=({option:_,index:P})=>X=>{D.val=A(_),K.val=P,U()},S=_=>{switch(console.log("onkeydown",_.key,K.val),_.key){case"Escape":U();break;case"ArrowDown":K.val<j.val.length-1?K.val++:K.val=0;break;case"ArrowUp":K.val<=0?K.val=j.val.length-1:K.val--;break;case"Enter":D.val=A(j.val[K.val]),M.val="",U();break}},E=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":L,"aria-label":v,onclick:g,variant:m,color:f,size:h},()=>!D.val&&v,D),R=c({id:w,value:M,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":L,oninput:y,onkeydown:S,variant:m,color:f,size:h}),F=s({id:w,triggerEl:E,contentEl:(()=>a({class:B(m,f,h,"content")},R,()=>l({class:B(m,f,h)},j.val.map((_,P)=>i({class:()=>B(K.val==P&&"active"),onclick:x({option:_,index:P})},C(_))))))(),onClose:J});return a({...N,class:B("autocomplete",u,t==null?void 0:t.class,N==null?void 0:N.class)},E,F)}}const on=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=nn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
