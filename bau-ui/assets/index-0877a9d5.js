...
`);function X(e,t={}){const{bau:n,css:o}=e,a=o`
    ...
    ${So()}
  `;return function(...i){let[{size:r=t.size??"md",variant:l=t.variant??"none",color:c=t.color??"none",href:u,...d},...p]=K(i);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:D("button",t.class,l,r,c,a,d.class),href:u},p)}}const Co="light",ko=()=>oe.map(e=>`
...
`);function st(e,t={}){const{bau:n,css:o,window:a}=e,{input:s}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},l=r();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Co);const c=o`
    ...
    ${ko()}
  `;return function(...d){let[{size:p=t.size??"md",variant:b=t.variant??"plain",color:m=t.color??"neutral",...h},...f]=K(d);return s({required:"required",title:"Switch Theme",...h,class:D("theme-switch",m,b,p,c,t==null?void 0:t.class,h.class),type:"checkbox",checked:r()=="dark",onclick:x=>{i(x.target.checked?"dark":"light")}},...f)}}function Eo(e){const{tr:t,bau:n,css:o,config:a,states:s}=e,{i,header:r,h1:l,div:c,a:u,img:d,b:p,ul:b,li:m}=n.tags,{svg:h,path:f}=n.tagsNS("http://www.w3.org/2000/svg"),x=s.drawerOpen,y=X(e,{class:o`
    ...
    `}),w=st(e),E=()=>i(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),A=()=>c({class:o`
        ...
        `},u({class:n`
          ...
          `},p({title:"Bau UI",links:b}),p({title:"Bau Ecosystem",links:m})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},s("v0.66.0"),s("MIT license")))}}function fe(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,s=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
...
`);function de(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
  ...
  `;return function(r){const{variant:l=t.variant??"outline",color:c=t.color??"neutral",...u}=r;return a({type:"text",...u,class:D("input",t.class,t.size??"md",c,l,s,u.class)})}}function ct(e,t={}){const{bau:n,css:o,window:a}=e,s=de(e,t);return function(r){const{variant:l=t.variant??"outline",color:c=t.color??"neutral",...u}=r,p=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,b=o`
    ...
    `;return s({type:"search",...u,color:c,variant:l,class:D("inputSearch",t.class,b,u.class)})}}function _t(e){const{tr:t,bau:n,css:o,config:a,states:s,window:i}=e,{div:r,ul:l,li:c,nav:u,a:d,span:p}=n.tags,b=ct(e,{variant:"plain",color:"neutral",size:"sm"}),h={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:y,children:w,pathnameState:E,variant:A,color:B,size:T})=>{const M=n.state(""),P=n.derive(()=>M.val==""?w:w.filter(N=>N.data.name.match(new RegExp(`${M.val}`,"i")))),O=N=>{M.val=N.target.value};return r({class:o`
        ...
        `},b({autocomplete:!1,name:"search",autofocus:!0,value:M,placeholder:`Search ${P.val.length} components`,size:22,oninput:O}),()=>y({children:P.val,pathnameState:E,variant:A,color:B,size:T}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Key Value List",href:"/components/keyValueList"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Multi Select",href:"/components/multiSelect"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let f=!1;const x=it(e);return function(){return r({bauMounted:({element:w})=>{i.innerWidth<=640&&(f=!0,s.drawerOpen.val=!1)},onclick:w=>{f&&!w.target.dataset.buttonback&&!w.target.parentElement.classList.contains("has-children")&&(s.drawerOpen.val=!1)},style:()=>s.drawerOpen.val?"display:block;":"display:none;",class:D(o`
          ...
          `)},x({tree:h}))}}const Mo=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:s}=t.tags,i=We(e),r=Eo(e),l=_t(e),c=Ao(e),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"outline",color:u=t.color??"neutral",onclick:d,...p},...b]=K(r);return a({...p,onclick:d,class:D("chip",t.class,l,c,u,d&&"clickable",s,p.class)},...b)}}function Io(e){const{bau:t,css:n,config:o}=e,{div:a,h1:s,h2:i,p:r}=t.tags;X(e);const l=n`
...
`);function Xe(e,t={}){const{bau:n,css:o}=e,{div:a,ul:s,li:i,h3:r,button:l}=n.tags,c=o`
    ...
    ${Ra()}
  `;return function(...d){let[{size:p=t.size??"md",variant:b=t.variant??"plain",color:m=t.color??"neutral",data:h=[],...f}]=K(d);const x=n.state(""),y=mt(e,{size:p,variant:b,color:m}),w=A=>B=>{x.val==A?x.val="":x.val=A},E=A=>{const{Header:B,Content:T,name:M}=A,P=()=>r({class:()=>D(x.val==M&&"active")},l({type:"button","aria-controls":`bau-${M}`,"aria-expanded":({element:N})=>x.val==M},B(A))),O=()=>a({id:`bau-${M}`,"data-state":({element:N})=>x.val==M},T(A));return i({class:D(m,b,p),onclick:w(M)},y({Header:P,Content:O}))};return a({class:D("accordion",c,t==null?void 0:t.class,f.class)},s(h.map(E)))}}const on=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,s=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Xe(e,t);return r=>i({...r,data:s})},ja=e=>{const{bau:t}=e,{div:n,p:o,section:a}=t.tags,s=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Xe(e);return()=>a(i({data:s,color:"neutral",variant:"outline"}))},Ha=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,an=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Ua=e=>{const{css:t}=e,n=an(e),o=Xe(e);return()=>o({color:"warning",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,Ga=e=>{const{css:t}=e,n=an(e),o=Xe(e);return()=>o({color:"success",variant:"outline",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              & h3 {
...
`,Wa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:Ha,createComponent:ja},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Fa,createComponent:Ua},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Va,createComponent:Ga}],gridItem:on},Ka=e=>{const t=F(e);return()=>t(Wa)},Xa={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Za=()=>oe.map(e=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`);function $e(e,t={}){const{bau:n,css:o}=e,{div:a,i:s}=n.tags,i=o`
    ...
    ${Za()}
  `,r=X(e),l=({onclick:c})=>r({"aria-label":"Close",onclick:c,class:"button-close"},"✖");return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"outline",color:b=t.color??"neutral",onRemove:m,...h},...f]=K(u);return a({...h,class:D("alert",`alert-${p}`,t.class,p,b,d,i,h.class),role:"alert"},s({class:"icon"},Xa[b]),a({class:"content"},...f),m&&l({onclick:m}))}}const rn=(e,t)=>{const n=$e(e,t);return o=>n({...o},`Alert ${(t==null?void 0:t.size)??""} `)},qa=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=$e(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},Ja=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,dr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:cr,createComponent:ir},{title:"Component hide and show",description:"Hide and show a component",code:ur,createComponent:lr}]},pr=e=>{const t=F(e);return()=>t(dr)};function Ce(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:s}=n.tags,i=a`
  ...
  `;return function(...c){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",...b},...m]=K(c);return s({...b,class:D("skeleton",u,r,t==null?void 0:t.class,b==null?void 0:b.class)},...m)}}function gt(e,t={}){const{bau:n,css:o}=e,{div:a,img:s}=n.tags,i=n.state(!0),r=n.state(!1),l=()=>i.val=!1,c=d=>{i.val=!1,r.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...p){let[{size:b=t.size??"md",variant:m=t.variant??"plain",color:h=t.color??"neutral",width:f=40,height:x=40,alt:y,...w},...E]=K(p);const A=Ce(e,{class:D(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${x}px;
          width: ${f}px;
        `,t==null?void 0:t.class,w.class)});return a({class:D(u,t==null?void 0:t.class,w.class)},()=>i.val&&A(),()=>r.val&&y,s({alt:y,width:f,height:x,onload:l,onerror:c,class:()=>D(!i.val&&"visible",r.val&&"hide",h,m,b,u,t==null?void 0:t.class,w.class),...w}))}}const sn=(e,t)=>{const{css:n}=e,o=gt(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
`);function Ze(e,t={}){const{bau:n,css:o}=e,{div:a,li:s}=n.tags,i=o`
    ...
    ${yr()}
  `;return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",label:p,placeholder:b,Option:m,options:h,defaultOption:f,getOptionLabel:x,getOptionValue:y,onSelect:w=()=>{},id:E,required:A,name:B,loading:T,...M},...P]=K(l);const O=Be(e),N=X(e),j=de(e,{variant:u,color:d,size:c}),R=fe(e),H=xe(e,{variant:u,color:d,size:c}),Z=n.state(f),S=n.state(M.value),g=n.state(!1),v=n.state(0),C=()=>{g.val=!1},k=n.state(h),L=Y=>ae=>Y.val&&x(ae)==x(Y.val),z=()=>{le.openDialog(),g.val=!0,S.val="",k.val=h,v.val=h.findIndex(L(Z));const Y=ke.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),ce.scrollIntoView({block:"end"}))},V=()=>{le.closeDialog(),g.val=!1,v.val=0},U=Y=>{const{value:ae}=Y.target;S.val=ae,ae?k.val=h.filter(Re=>x(Re).match(new RegExp(`${ae}`,"i"))):k.val=h},$=Y=>{le.open?V():z()},J=Y=>{Z.val=Y,me.value=y(Y)},ne=({option:Y,index:ae})=>Re=>{J(Y),v.val=ae,V()},G=()=>{const Y=ke.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},ee=Y=>{switch(Y.key){case"Escape":V();break;case"ArrowDown":v.val<k.val.length-1?v.val++:v.val=0,G();break;case"ArrowUp":v.val<=0?v.val=k.val.length-1:v.val--,G();break;case"Enter":le.open?(J(k.val[v.val]),V()):z(),Y.preventDefault();break}},re=N({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":g,"aria-label":p,onclick:$,variant:u,color:d,size:c,class:T==!0&&"loading",disabled:T},()=>Z.val?x(Z.val):p,()=>T==!0&&H({visibility:T})),ce=j({value:S,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":g,oninput:U,onkeydown:ee,...M}),me=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:f&&y(f),required:A,name:B}),ke=a({class:D(u,d,c,"content")},ce,()=>R({class:D(u,d,c)},k.val.map((Y,ae)=>s({class:()=>D(v.val==ae&&"active",L(Z)(Y)&&"selected"),onclick:ne({option:Y,index:ae})},m(Y))))),le=O({id:E,triggerEl:re,contentEl:ke,onClose:C,class:o`
        overflow: hidden;
      `});return a({...M,class:D("autocomplete",i,t==null?void 0:t.class,M==null?void 0:M.class)},n.bind({deps:[Z],render:()=>Y=>{Y&&(me.value=y(Y),w(Y))}}),re,me,le)}}const cn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:s}=n.tags,i=Ze(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(c.label),s(c.code));return c=>i({...c,options:r,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",id:"country"})},wr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:s}=t.tags,i=Ze(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Cr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:s}=t.tags,i=Ze(e),r="AD",l=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=u=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(u.label),s(u.code));return()=>o(i({options:l,Option:c,defaultOption:l.find(({code:u})=>u==r),getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",id:"country"}))},kr=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
...
`,Tr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Sr,createComponent:wr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Ar,createComponent:Er},{title:"Default Option",description:"A autocomplete with a default option.",code:kr,createComponent:Cr}],gridItem:cn},Dr=e=>{const t=F(e);return()=>t(Tr)};function ln(e,t={}){const{bau:n,css:o}=e,{span:a}=n.tags,s=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
...
`,Nr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Ir,createComponent:Mr}],gridItem:un},$r=e=>{const t=F(e);return()=>t(Nr)};function bt(e,t={}){const{bau:n,css:o,config:a}=e,{ul:s,li:i,span:r}=n.tags,{separator:l="〉"}=t,c=X(e),u=o`
  ...
  `;return function(...p){let[{size:b=t.size??"md",variant:m=t.variant??"plain",color:h=t.color??"neutral",items:f,...x},...y]=K(p);return s({...x,class:D(u,t==null?void 0:t.class,x==null?void 0:x.class)},f.map(({href:w,name:E})=>i((w?c:r)({href:`${a.base}${w}`,color:h,variant:m,size:b,class:D(h,m,b)},E))))}}const dn=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=bt(e,t);return a=>o({...a,...n})},Br=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=bt(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},Or=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,Yr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Jr,createComponent:qr}],gridItem:bn},Qr=e=>{const t=F(e);return()=>t(Yr)};function es(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,s=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:b,Previous:m,Next:h,...f}]=K(l);const x=()=>{i.val<=0?i.val=p.length-1:i.val--},y=()=>{i.val>=p.length-1?i.val=0:i.val++},w=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},p.map(b));return a({...f,class:D("carousel",c,s,t==null?void 0:t.class,f==null?void 0:f.class)},a({class:D("control","control-previous"),onclick:x},m()),a({class:D("control","control-next"),onclick:y},h()),w)}}const ts=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ns=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,s=X(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,cs={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:is,createComponent:ss}],gridItem:hn},ls=e=>{const t=F(e);return()=>t(cs)};function qe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(r);return a({type:"checkbox",...d,class:D(s,u,c,l,t==null?void 0:t.class,d==null?void 0:d.class)})}}const fn=(e,t)=>{const{bau:n,css:o}=e,{label:a}=n.tags,s=qe(e,t);return i=>a({class:o`
          display: flex;
...
`,vs={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:fs,createComponent:hs}]},xs=e=>{const t=F(e);return()=>t(vs)};function ys(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(r);return a({...d,class:D("divider",l,s,t==null?void 0:t.class,d==null?void 0:d.class)},a({class:"content"},...p))}}const ws=e=>{const{bau:t}=e,{section:n}=t.tags,o=ys(e);return()=>n(o("OR"))},Ss=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Us={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Hs,createComponent:js}],gridItem:wn},Fs=e=>{const t=F(e);return()=>t(Us)};function Oe(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",content:d,...p},...b]=K(r);return a({...p,class:D("form",u,c,l,s,t==null?void 0:t.class,p==null?void 0:p.class)},...b)}}function ft(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:s}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...c){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:b,...m},...h]=K(c);const f=X(e),x=xe(e);return n.bind({deps:[b],render:()=>y=>f({...m,class:D("loadingButton",u,d,p,r,y&&"loading",t==null?void 0:t.class,m==null?void 0:m.class)},x({size:u,variant:d,color:p,visibility:y}),s({class:y&&"loading"},h))})}}const Gs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:s,header:i,label:r,img:l,footer:c}=t.tags,u=ft(e),d=$e(e,{variant:"outline",color:"danger"}),p=de(e),b=Oe(e,{class:n`
      & > header {
        text-align: center;
      }
      & > footer {
...
`,Ws=e=>{const{bau:t}=e,{section:n,h1:o,header:a,label:s,footer:i}=t.tags,r=Oe(e),l=X(e,{variant:"solid",color:"primary"}),c=de(e);return function({onSubmitted:d=()=>{}}){return r({onsubmit:async b=>{b.preventDefault();const m=Object.fromEntries(new FormData(b.target.closest("form")));alert(JSON.stringify(m)),d(m)}},a(o("Form with input")),n(s("Branch",c({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(l({type:"submit"},"Click")))}},Ks=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`,Xs=e=>{const{bau:t}=e,{section:n,h1:o,header:a,label:s,footer:i,em:r,span:l}=t.tags,c=t.state(""),u=t.derive(()=>c.val!=="Delete"),d=Oe(e),p=X(e,{variant:"solid",color:"primary"}),b=de(e);return function({onSubmitted:h=()=>{}}){return d({onsubmit:async x=>{x.preventDefault(),h()}},a(o("Delete Protection")),n(s(l("Type ",r("Delete")," to confirm the destruction of the resource."),b({autofocus:!0,placeholder:"Type 'Delete'",name:"check",required:!0,value:c,oninput:x=>c.val=x.target.value}))),i(p({type:"submit",disabled:u},"Delete")))}},Zs=`import { Context } from "@grucloud/bau-ui/context";
...
`,qs={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Simple form",description:"A simple form.",code:Ks,createComponent:Ws},{title:"Form with state",description:"A form with input state and a dervied state.",code:Zs,createComponent:Xs},{title:"Login page",description:"A login page.",code:Vs,createComponent:Gs}]},Js=e=>{const t=F(e);return()=>t(qs)},Sn=(e,t={})=>{const n=de(e,t);return o=>n({name:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,placeholder:"Enter text",...o})},Ys=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=de(e);return()=>n(o("Basic input"),a({id:"my-input",name:"my-input",placeholder:"Enter Text"}),o("Disabled input"),a({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))},Qs=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,ai={title:"Input Search",package:"inputSearch",description:"The inputSearch component is an input of type 'search' with an icon on the left hand side.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/inputSearch/inputSearch.js",importStatement:'import inputSearch from "@grucloud/bau-ui/inputSearch";',examples:[{title:"Basic",description:"A simple inputSearch.",code:oi,createComponent:ni}],gridItem:Cn},ri=e=>{const t=F(e);return()=>t(ai)};function si(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,s=o`
    list-style: none;
    & li {
      margin: 0.5rem 0;
      display: flex;
  ...
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(r);return a({...d,class:D("keyValueList",s,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const ii=e=>{const{bau:t}=e,{section:n,li:o,label:a,span:s}=t.tags,i=si(e);return()=>n(i(o(a("My label"),s("My Value")),o(a("My other label"),s("My Other Value"))))},ci=`import keyValueList from "@grucloud/bau-ui/keyValueList";
import { Context } from "@grucloud/bau-ui/context";
...
`,li={title:"KeyValueList",package:"keyValueList",description:"The keyValueList component displays a list of key value pair",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/keyValueList/keyValueList.js",importStatement:'import keyValueList from "@grucloud/bau-ui/keyValueList";',examples:[{title:"Simple",description:"A simple keyValueList.",code:ci,createComponent:ii}]},ui=e=>{const t=F(e);return()=>t(li)};function kn(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:s}=n.tags,i=()=>oe.map(c=>`
&.${c}{
...
`),r=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=t.size??"md",variant:p=t.variant??"plain",color:b=t.color??"neutral",running:m,...h}]=K(u);return s({...h,role:"progressbar",class:{deps:[m],renderProp:()=>f=>D("linearProgress",d,b,l,f&&"running",t==null?void 0:t.class,h==null?void 0:h.class)}})}}const En=(e,t)=>{const n=kn(e,t);return o=>n({...o,running:!0})},di=e=>{const{bau:t}=e,{section:n,hr:o}=t.tags,a=X(e),s=kn(e),i=t.state(!1);return()=>n(a({variant:"solid",color:"primary",onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,s({running:i}))},pi=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,mi={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:pi,createComponent:di}],gridItem:En},gi=e=>{const t=F(e);return()=>t(mi)},An=(e,t)=>{const n=ft(e,t);return o=>n({...o,loading:!0},"Save")},bi=e=>{const{bau:t}=e,{section:n}=t.tags,o=ft(e),a=t.state(!0);return()=>n(o({variant:"solid",color:"primary",loading:a,onclick:()=>a.val=!a.val},"Save"))},hi=`import loadingButton from "@grucloud/bau-ui/loadingButton";
...
`,fi={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:hi,createComponent:bi}],gridItem:An},vi=e=>{const t=F(e);return()=>t(fi)},xi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],yi=(e,t)=>{const{bau:n,css:o}=e,{span:a,li:s}=n.tags,i=fe(e,t),r=({code:l,label:c})=>s({class:o`
          display: flex;
          gap: 1rem;
        `},a(l),a(c));return l=>i({...l},xi.map(r))},wi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Si=e=>{const{bau:t,css:n}=e,{section:o,span:a,li:s}=t.tags,i=fe(e),r=({code:l,label:c})=>s({class:n`
          display: flex;
          gap: 1rem;
        `},a(l),a(c));return()=>o(i({variant:"outline",color:"primary"},wi.map(r)))},Ci=`import list from "@grucloud/bau-ui/list";
import { Context } from "@grucloud/bau-ui/context";
...
`,ki={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:Ci,createComponent:Si}],gridItem:yi},Ei=e=>{const t=F(e);return()=>t(ki)};function Tn(e,t={}){const{bau:n,css:o,window:a}=e,{dialog:s,div:i}=n.tags,l=o`
    margin: auto;
    padding: 1rem;
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
...
`).join(`
`);function Ni(e,t={}){const{bau:n,css:o}=e,{div:a,li:s,select:i}=n.tags,r=X(e),l=Be(e),c=fe(e),u=qe(e,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Ii()}
  `;return function(...b){let[{size:m=t.size??"md",variant:h=t.variant??"outline",color:f=t.color??"neutral",name:x,label:y,Option:w,options:E,defaultValue:A=[],getOptionLabel:B,getOptionValue:T,renderValue:M,onSelect:P=()=>{},loading:O,...N},...j]=K(b);const R=xe(e,{variant:h,color:f,size:m}),H=n.state(A),Z=n.state(!1),S=n.state(0),g=()=>{J.openDialog(),J.focus(),Z.val=!0},v=()=>{J.closeDialog(),Z.val=!1},C=()=>{Z.val=!1},k=G=>{J.open?v():g(),G.preventDefault()},L=()=>Array.from(ne.selectedOptions).map(({value:G})=>E.find(ee=>T(ee)==G)),z=G=>{switch(G.preventDefault(),G.key){case"Escape":v();break;case"ArrowDown":S.val<E.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=E.length-1:S.val--;break;case"Enter":if(J.open){const ee=G.currentTarget.querySelectorAll("input")[S.val];ee.checked=!ee.checked;const re=ne.options[S.val+1];re.selected=!re.selected,H.val=L()}else g();break}},V=G=>ee=>{const re=[...ne.options].find(({value:ce})=>ce==T(G));ee.target.checked?re.selected=!0:re.selected=!1,H.val=L()},U=()=>c({tabindex:"0",class:D(f,h)},E.map((G,ee)=>s({class:()=>D(S.val==ee&&"active")},n.tags.label(u({checked:A.find(re=>T(re)==T(G)),name:`${x}-${T(G)}`,onchange:V(G)}),w(G))))),$=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":Z,"aria-label":y,onclick:k,color:f,variant:h,size:m,class:O==!0&&"loading",disabled:O},()=>H.val.length?M(H.val):y,()=>O==!0&&R({visibility:O})),J=l({triggerEl:$,contentEl:U(),onClose:C}),ne=i({name:x,multiple:!0,...N},n.tags.option({value:""},"--Category--"),E.map(G=>n.tags.option({value:T(G),selected:A.find(ee=>T(ee)==T(G))},B(G))));return a({...N,class:D("multiSelect",f,m,d,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:z},ne,$,J)}}const $i=e=>{const{bau:t,css:n}=e,{div:o,span:a,form:s,footer:i}=t.tags,r=Ni(e),l=X(e,{variant:"outline",color:"neutral"}),c=Ie(e,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=b=>a(b.group),p=b=>{b.preventDefault();const{selectedOptions:m}=b.target.elements.myMultiSelect;var h=Array.from(m).map(({value:f})=>f);alert(JSON.stringify(h))};return()=>s({onsubmit:p,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
        `},r({name:"myMultiSelect",options:u,Option:d,defaultValue:[{group:"IAM"}],getOptionValue:({group:b})=>b,getOptionLabel:({group:b})=>b,renderValue:b=>o({class:n`
                display: flex;
                gap: 0.2rem;
              `},b.map(m=>c(m.group))),label:"Select services"}),i(l({type:"submit"},"Submit")))},Bi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Oi=e=>{const{bau:t,css:n}=e,{select:o,option:a,form:s}=t.tags,i=X(e,{variant:"outline",color:"neutral"}),r=[{group:"Cabrinha"},{group:"Core"},{group:"Duotone"},{group:"Naish"},{group:"Reedin"},{group:"Slingshot"}],l=c=>{c.preventDefault();const{selectedOptions:u}=c.target.elements.myNativeMultiSelect;var d=Array.from(u).map(({value:p})=>p);alert(JSON.stringify(d))};return()=>s({onsubmit:l,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
        `},o({multiple:!0,name:"myNativeMultiSelect"},r.map(({group:c})=>a({value:c},c))),i({type:"submit"},"Submit"))},Pi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Li={title:"MultiSelect",package:"multiSelect",description:"The multiSelect component allows user to select multiple items from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/multiSelect/multiSelect.js",importStatement:'import multiSelect from "@grucloud/bau-ui/multiSelect";',examples:[{title:"Simple Multi Select",description:"A simple multi select.",code:Bi,createComponent:$i},{title:"Native Multi Select",description:"A native multi select.",code:Pi,createComponent:Oi}]},zi=e=>{const t=F(e);return()=>t(Li)},_i=e=>{const{bau:t}=e,{section:n,div:o,h1:a,p:s}=t.tags,i=X(e),r=Be(e),l=()=>i({variant:"outline",color:"success",onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),c=()=>o({},a("My content"),s("My Content")),u=l(),d=r({id:"my-popover-left",triggerEl:u,contentEl:c()});return()=>n(o(u,d))},Ri=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,ji={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Ri,createComponent:_i}]},Hi=e=>{const t=F(e);return()=>t(ji)};function Ui(e,t={}){const{bau:n,css:o,config:a}=e,{div:s,a:i,span:r,nav:l}=n.tags,c=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
  ...
  `,u=({text:d})=>({name:p,label:b,href:m})=>i({href:`${a.base}${m}`},r({class:"sublabel"},d),s({class:`label ${d}`},b??p));return function(...p){let[{size:b=t.size??"md",variant:m=t.variant??"plain",color:h=t.color??"neutral",data:f={},...x}]=K(p);const{next:y,previous:w}=f;return l({"data-paginationnav":JSON.stringify(f),"aria-label":"pages navigation",...x,class:D("paginationNavigation",b,c,t==null?void 0:t.class,x==null?void 0:x.class)},(w==null?void 0:w.href)&&u({text:"Previous"})(w),(y==null?void 0:y.href)&&u({text:"Next"})(y))}}const Fi=e=>{const{bau:t}=e,{section:n}=t.tags,o=Ui(e),a={next:{name:"next page",label:"Popover",href:"/components/popover"},previous:{name:"previous page",label:"Paper",href:"/components/paper"}};return()=>n(o({variant:"solid",color:"primary",data:a}))},Gi=`import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";
...
`,Vi={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:Gi,createComponent:Fi}]},Wi=e=>{const t=F(e);return()=>t(Vi)},Ki=(e,t)=>{const{bau:n}=e,{div:o}=n.tags,a=Ne(e,t);return s=>a({...s},o(`Paper ${t.size??""}`))},Xi=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=Ne(e);return()=>n(a({size:"md"},o("My content")))},Zi=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`,qi={title:"Paper",package:"paper",description:"The paper component displays child components on a surface area.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paper/paper.js",importStatement:'import paper from "@grucloud/bau-ui/paper";',examples:[{title:"Default",description:"A simple paper.",code:Zi,createComponent:Xi}],variantColorTableDisable:!0,gridItem:Ki},Ji=e=>{const t=F(e);return()=>t(qi)};function Mn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    margin: 0.5rem;
    &.sm {
      transform: scale(0.8);
    }
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",...p}]=K(l);return a({...p,type:"radio",class:D("radio-button",c,d,u,i,t==null?void 0:t.class,p==null?void 0:p.class)})}}const In=(e,t)=>{const{bau:n,css:o}=e,{label:a,form:s}=n.tags,i=Mn(e,t);return r=>s({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,ec={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Qi,createComponent:Yi}],gridItem:In},tc=e=>{const t=F(e);return()=>t(ec)},nc=()=>oe.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function Pe(e,t={}){const{bau:n,css:o}=e,{div:a,li:s,select:i,option:r}=n.tags,l=X(e),c=Be(e),u=fe(e),d=o`
    ...
    ${nc()}
  `;return function(...b){let[{size:m=t.size??"md",variant:h=t.variant??"outline",color:f=t.color??"neutral",label:x,Option:y,options:w,defaultOption:E,getOptionLabel:A,getOptionValue:B,onSelect:T=()=>{},loading:M,...P},...O]=K(b);const N=xe(e,{variant:h,color:f,size:m}),j=n.state(E?A(E):x),R=n.state(!1),H=n.state(0),Z=()=>{V.openDialog(),V.focus(),R.val=!0},S=()=>{V.closeDialog(),R.val=!1},g=()=>{R.val=!1},v=$=>{V.open?S():Z(),$.preventDefault()},C=({option:$,index:J})=>ne=>{j.val=A($),U.value=B($),U.setCustomValidity(""),H.val=J,S(),T($),ne.preventDefault()},k=$=>{switch($.preventDefault(),$.key){case"Escape":S();break;case"ArrowDown":H.val<w.length-1?H.val++:H.val=0;break;case"ArrowUp":H.val<=0?H.val=w.length-1:H.val--;break;case"Enter":V.open?(j.val=A(w[H.val]),U.value=B(r),S()):Z();break}},L=()=>u({tabindex:"0",class:D(f,h)},w.map(($,J)=>s({class:()=>D(H.val==J&&"active"),onclick:C({option:$,index:J})},y($)))),z=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":R,"aria-label":x,onclick:v,color:f,variant:h,size:m,class:M==!0&&"loading",disabled:M},()=>!j.val&&x,j,()=>M==!0&&N({visibility:M})),V=c({triggerEl:z,contentEl:L(),onClose:g}),U=i(P,r({value:""},"--Select Category--"),w.map($=>r({value:B($)},A($))));return U.value=P.value,a({...P,class:D("select",f,m,d,t==null?void 0:t.class,P==null?void 0:P.class),onkeydown:k},U,z,V)}}const Nn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:s}=n.tags,i=Pe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(c.label),s(c.code));return c=>i({...c,options:r,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},oc=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:s}=t.tags,i=Pe(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(c.label),s(c.code));return()=>o(i({options:r,Option:l,getOptionValue:({code:c})=>c,getOptionLabel:({label:c})=>c,label:"Select a country..."}))},ac=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,rc=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:s}=t.tags,i=Pe(e),r="AD",l=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=u=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(u.label),s(u.code));return()=>o(i({options:l,Option:c,defaultOption:l.find(({code:u})=>u==r),getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."}))},sc=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,lc=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:s}=t.tags,i=X(e,{variant:"outline"}),r=Pe(e),l=t.state([]),c=t.state(!1),u=t.state("");async function d({url:m,transform:h=f=>f}){try{c.val=!0;const f=await fetch(m,{});if(f.ok){const x=await f.json();l.val=h(x)}else u.val=f.statusText}catch(f){u.val=f.message}finally{c.val=!1}}const p=()=>d({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:m=>m.sort((h,f)=>h.name.common.localeCompare(f.name.common))});p();const b=m=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(m.flag),s(m.name.common));return()=>o(a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>r({options:l.val,Option:b,getOptionValue:({name:m})=>m.common,getOptionLabel:({name:m})=>m.common,label:"Country",id:"country",loading:c.val}),i({onclick:()=>p()},"Reload")))},uc=`import { Context } from "@grucloud/bau-ui/context";
...
`,dc={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:ac,createComponent:oc},{title:"Default Option",description:"Select with a default option",code:sc,createComponent:rc},{title:"Select AWS region",description:"Select the AWS region",code:cc,createComponent:ic},{title:"Loading Indicator",description:"Select with a loading indicator",code:uc,createComponent:lc}],gridItem:Nn},pc=e=>{const t=F(e);return()=>t(dc)};function $n(e,t={}){const{bau:n,css:o}=e,{select:a}=n.tags,s=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"outline",color:u=t.color??"neutral",...d},...p]=K(r);return a({...d,class:D("select-native",u,l,c,s,t==null?void 0:t.class,d==null?void 0:d.class)},p)}}const Bn=(e,t)=>{const{bau:n}=e,{option:o}=n.tags,a=$n(e,t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a(i,s.map(({label:r,phone:l})=>o({value:l},r)))},mc=e=>{const{bau:t}=e,{section:n,option:o}=t.tags,a=$n(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>n(a(s.map(({label:i,phone:r})=>o({value:r},i))))},gc=`import selectNative from "@grucloud/bau-ui/selectNative";
import { Context } from "@grucloud/bau-ui/context";
...
`,bc={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:gc,createComponent:mc}],gridItem:Bn},hc=e=>{const t=F(e);return()=>t(bc)},fc=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,s=Ce(e),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,xc=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,s=Ce(e),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,wc=e=>{const{bau:t,css:n}=e,{section:o,table:a,tbody:s,tr:i,td:r}=t.tags,l=Ce(e,{class:n`
      height: 2rem;
      width: 10rem;
    `}),c=()=>a(s(new Array(8).fill("").map(()=>i(r(l({class:n`
                ...
                `})),r(l()),r(l()),r(l()),r(l({class:n`
                  width: 20rem;
                `}))))));return()=>o(c())},Sc=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,Cc=e=>{const{bau:t,css:n}=e,{section:o,header:a,span:s,article:i}=t.tags,r=n`
    display: flex;
    flex-direction: column;
    & header {
      display: inline-flex;
  ...
  `,l=Ce(e,{class:n`
    ...
    `}),c=Ce(e);function u({columnsSize:d=4}){return o({class:r},a(new Array(d).fill("").map(()=>l(s("1")))),i(c("")))}return()=>o(u({columnsSize:3}))},kc=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ec={title:"Skeleton",package:"skeleton",description:"The skeleton component is used a loading indicator",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/skeleton/skeleton.js",importStatement:'import skeleton from "@grucloud/bau-ui/skeleton";',examples:[{title:"Card",description:"A card skeleton.",code:vc,createComponent:fc},{title:"List",description:"A list skeleton.",code:yc,createComponent:xc},{title:"Table",description:"A table skeleton.",code:Sc,createComponent:wc},{title:"Tabs",description:"A tabs skeleton.",code:kc,createComponent:Cc}],variantColorTableDisable:!0,variantSizeDisable:!0},Ac=e=>{const t=F(e);return()=>t(Ec)};function Je(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ${(()=>oe.map(r=>`
&.slider.${r} {
  accent-color: var(--color-${r});
}
`).join(`
`))()};
  `;return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",...p},...b]=K(l);return a({...p,type:"range",class:D("slider",d,u,c,i,t==null?void 0:t.class,p.class)},...b)}}const On=e=>{const{bau:t}=e,n=t.state(0),o=s=>{n.val=s==null?void 0:s.target.value},a=Je(e);return s=>a({...s,oninput:o})},Tc=e=>{const{bau:t}=e,{section:n,form:o,label:a,br:s}=t.tags,i=t.state(0),r=c=>{i.val=c==null?void 0:c.target.value},l=Je(e);return()=>n(o(a("Slider with step, min and max",s,l({oninput:r,name:"slider-simple",step:20,min:-100,max:100}))))},Dc=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Mc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:s,datalist:i,br:r,option:l}=t.tags,c=t.state(0),u=p=>{c.val=p==null?void 0:p.target.value},d=Je(e);return()=>o(a(s({for:"temp"},"Choose a comfortable temperature"),r,d({oninput:u,class:n`
            width: 300px;
            margin: 0;
          `,id:"temp",name:"temp",list:"markers"}),i({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(p=>l({value:Number(p),label:p})))))},Ic=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Nc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:s,datalist:i,br:r,option:l}=t.tags,c=t.state(0),u=p=>{c.val=p==null?void 0:p.target.value},d=Je(e);return()=>o(a({class:n`
            display: flex;
          ...
          `}),i({id:"markers-vertical",class:n`
              ...
              flex-direction: column;
              justify-content: space-between;
            `},["0","25","50","75","100"].reverse().map(p=>l({value:Number(p),label:p})))))},$c=`import slider from "@grucloud/bau-ui/slider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Bc={title:"Slide",package:"slider",description:"The slider component allows a user to to choose a number between a range.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/slider/slider.js",importStatement:'import slider from "@grucloud/bau-ui/slider";',examples:[{title:"Default",description:"A simple slider.",code:Dc,createComponent:Tc},{title:"Horizontal Mark",description:"A slider with horizontal mark.",code:Ic,createComponent:Mc},{title:"Vertical Mark",description:"A vertical slider with marks.",code:$c,createComponent:Nc}],gridItem:On},Oc=e=>{const t=F(e);return()=>t(Bc)},Pn=(e,t)=>{const n=xe(e,t);return o=>n({...o})},Pc=e=>{const{bau:t}=e,{section:n}=t.tags,o=X(e),a=xe(e,{size:"lg"}),s=t.state(!0);return()=>n(o({variant:"solid",color:"primary",onclick:()=>s.val=!s.val},()=>s.val?"Stop":"Start"),a({visibility:s}))},Lc=`import spinner from "@grucloud/bau-ui/spinner";
import button from "@grucloud/bau-ui/button";
...
`,zc={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:Lc,createComponent:Pc}],gridItem:Pn},_c=e=>{const t=F(e);return()=>t(zc)},Rc=()=>oe.map(e=>"").join(`
...
`,Ot="stepper-vertical",Uc=e=>{const{bau:t,window:n,css:o}=e,{footer:a,p:s,label:i,section:r,a:l,ul:c,li:u}=t.tags,d=de(e),p=Oe(e),b=zn(e,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`,Gc={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Horizontal Stepper",description:"A simple horizontal stepper.",code:Hc,createComponent:jc},{title:"Vertical Stepper",description:"A simple vertical stepper.",code:Fc,createComponent:Uc}]},Vc=e=>{const t=F(e);return()=>t(Gc)},Wc=()=>oe.map(e=>`
&.switch.plain.${e} {
  &::after {
...
`);function _n(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    ...
    ${Wc()}
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=K(r);return a({...d,class:D("switch",s,u,c,l,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...p)}}const Rn=(e,t)=>{const{bau:n,css:o}=e,{form:a,label:s}=n.tags,i=_n(e,t);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},s("off ",i({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),s("on ",i({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},Kc=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:s}=t.tags,i=_n(e);return()=>o(a(s({class:n`
              display: flex;
              align-items: center;
              gap: 0.5rem;
            `},"My shinny switch",i({variant:"outline",id:"my-shinny-switch"}))))},Xc=`import createSwitch from "@grucloud/bau-ui/switch";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zc={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:Xc,createComponent:Kc}],gridItem:Rn},qc=e=>{const t=F(e);return()=>t(Zc)},Jc=()=>oe.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`,jn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>"TAB",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]},nl=e=>{const{css:t}=e,n=Le(e,{tabDefs:jn(e),class:t`
      flex-direction: column-reverse;
    `});return()=>n({})},ol=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,al=e=>{const{css:t}=e,n=jn(e),o=Le(e,{tabDefs:n,class:t`
      & ul {
        justify-content: center;
      }
...
`,sl={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:Qc,createComponent:Yc},{title:"Extended Tabs",description:"An extended tabs.",code:tl,createComponent:el},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:ol,createComponent:nl},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:rl,createComponent:al}]},il=e=>{const t=F(e);return()=>t(sl)};function ze(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:s}=n.tags;a`
  :root {
...
`;const i=o`
    ...
    width: fit-content;
  `;return function(...l){let[{...c},...u]=K(l);return s({...c,class:D("table-container",i,t==null?void 0:t.class,c==null?void 0:c.class)},...u)}}const cl=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:s,tr:i,table:r,thead:l,tbody:c,caption:u}=t.tags;function d(f,x,y,w,E){return{name:f,calories:x,fat:y,carbs:w,protein:E}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],b=({name:f,calories:x})=>i(s(f),s({class:n`
            text-align: right;
          `},x)),m=()=>l(i(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(h(r(u("Basic Table"),m(),c(p.map(b)))))},ll=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ee(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const ul=[Ee("Frozen yoghurt",159,6,24,4),Ee("Ice cream sandwich",237,9,37,4.3),Ee("Eclair",262,16,24,6),Ee("Cupcake",305,3.7,67,4.3),Ee("Gingerbread",356,16,49,3.9)],dl=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:s,tr:i,table:r,thead:l,tbody:c,caption:u}=t.tags,d=({name:m,calories:h})=>i(s(m),s({class:n`
            text-align: right;
          `},h)),p=()=>l(i(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(b(r(u("Table Dense"),p(),c(ul.map(d)))))},pl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ae(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const ml=[Ae("Frozen yoghurt",159,6,24,4),Ae("Ice cream sandwich",237,9,37,4.3),Ae("Eclair",262,16,24,6),Ae("Cupcake",305,3.7,67,4.3),Ae("Gingerbread",356,16,49,3.9)],gl=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:s,tr:i,table:r,thead:l,tbody:c,caption:u}=t.tags,d=({name:m,calories:h})=>i(s(m),s({class:n`
            text-align: right;
          `},h)),p=()=>l(i(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(b(r(u("Table Zebra"),p(),c(ml.map(d)))))},bl=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,hl={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:ll,createComponent:cl},{title:"Dense",description:"A dense table.",code:pl,createComponent:dl},{title:"Zebra",description:"A zebra table.",code:bl,createComponent:gl}]},fl=e=>{const t=F(e);return()=>t(hl)},vl=e=>{const{bau:t,css:n}=e,{h1:o,h2:a,h3:s,section:i,article:r}=t.tags,l=tn(e),c=r({id:"content",class:n`
        grid-area: content;
...
`,yl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:xl,createComponent:vl}]},wl=e=>{const t=F(e);return()=>t(yl)};function Hn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,s=ht(e),i=X(e),r=xe(e),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:m,icon:h,...f})=>i({"aria-label":m,title:m,...f},h),u=({count:m,totalCount:h,page:f,rowsPerPage:x})=>a({class:"pages-numbers"},Number(f-1)*Number(x)+(m>0?1:0),"-",Math.min(f*x,h)," of ",h),d=({count:m,page:h,rowsPerPage:f})=>a({class:"pages-numbers"},(h-1)*f+(m>0?1:0),"-",h*f),p=m=>m<=1,b=(m,h,f)=>m>=Math.ceil(h/f);return function(...h){let[{size:f=t.size??"md",variant:x=t.variant??"outline",color:y=t.color??"neutral",count:w=0,totalCount:E=0,page:A=1,rowsPerPage:B=50,onPageChange:T,isLoading:M=!1,disableFirst:P=()=>p(A),disablePrevious:O=()=>p(A),disableNext:N=()=>b(A,E,B),disableLast:j=()=>b(A,E,B),...R},...H]=K(h);const Z=Math.max(0,Math.ceil(E/B)),S=T({page:1}),g=T({page:A-1}),v=T({page:A+1}),C=T({page:Z}),k=[{label:"First",icon:"⟪",onclick:S,disabled:P()},{label:"Previous",icon:"⟨",onclick:g,disabled:O()},{label:"Next",icon:"⟩",onclick:v,disabled:N()},{label:"Last",icon:"⟫",onclick:C,disabled:j()}];return a({...R,class:D("table-pagination",l,M&&"disabled",t==null?void 0:t.class,R==null?void 0:R.class)},r({class:"spinner",visibility:M,size:"md"}),E>0?u({count:w,totalCount:E,page:A,maxPages:Z,rowsPerPage:B}):d({count:w,page:A,maxPages:Z,rowsPerPage:B}),s({variant:x,color:y},k.map(L=>c({...L,variant:x,color:y}))))}}const Sl=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Cl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:s,table:i,thead:r,tbody:l}=t.tags,c=Sl(45),u=({name:y,email:w})=>s(a(y),a(w)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),p=Hn(e),b=ze(e,{class:n`
      max-width: 650px;
    `}),m=t.state(c),h=t.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),f=t.derive(()=>m.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),x=({page:y})=>w=>{h.val.page=y};return()=>b(i(d(),()=>l(f.val.map(u))),()=>p({...h.val,onPageChange:x}))},kl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:s,table:i,thead:r,tbody:l,div:c}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),b=t.derive(()=>d.val.length),m=t.state(1),h=t.state(10),f=t.derive(()=>d.val),x=P=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(P).toString()}`,y=({page:P})=>O=>{m.val=P,w(x({page:P,per_page:h.val}))};w(x({page:1,per_page:h.val}));async function w(P){try{u.val=!0;const O=await fetch(P,{});if(O.ok){const N=await O.json();d.val=N;return}throw O}catch(O){p.val=O.message}finally{u.val=!1}}const E=({name:P,description:O,stargazers_count:N})=>s(a(P),a(O),a({class:n`
            text-align: right;
          `},N)),A=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),M=({message:P})=>c(P);return()=>T(()=>B({rowsPerPage:h.val,page:m.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:y,disableNext:()=>!1}),i(A(),()=>p.val&&M({message:p.val}),()=>l(f.val.map(E))))},El=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:s,h2:i,tr:r}=t.tags,l=Cl(e),c=kl(e),u=(...d)=>a({class:n`
  ...
  `;return function(...l){let[{size:c=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",selected:p=!1,disabled:b,onChange:m,...h},...f]=K(l);return s({type:"button",...h,"aria-pressed":{deps:[p],renderProp:()=>x=>x},class:{deps:[p],renderProp:()=>x=>D("toggle",c,d,u,i,x&&"selected",t==null?void 0:t.class,h==null?void 0:h.class)},disabled:b},f)}}const Un=(e,t)=>{const{bau:n}=e,o=_e(e,t);return a=>{const s=n.state(!1);return o({...a,selected:s,onclick:()=>s.val=!s.val},"Toggle Me")}},Al=e=>{const{bau:t}=e,{section:n}=t.tags,o=_e(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Tl=`import toggle from "@grucloud/bau-ui/toggle";
...
`,Dl={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:Tl,createComponent:Al}],gridItem:Un},Ml=e=>{const t=F(e);return()=>t(Dl)},Il=()=>oe.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`);function vt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,s=o`
    ...
    ${Il()}
  `;return function(...r){let[{size:l=t.size??"md",variant:c=t.variant??"outline",color:u=t.color??"neutral",exclusive:d=!1,onChange:p=()=>{},...b},...m]=K(r);const h=new Set,f=x=>{const{value:y}=x.target;d?(h.clear(),h.add(y)):h.has(y)?h.delete(y):h.add(y),p({event:x,values:[...h]})};return a({...b,class:D("toggle-group",l,u,c,s,t==null?void 0:t.class,b==null?void 0:b.class),onclick:f},...m)}}const Fn=(e,t)=>{const{bau:n}=e,o=vt(e,t),a=_e(e,t);return s=>{const i=n.state([""]),r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...s,onChange:({values:c})=>{i.val=c}},r.map(({label:c,value:u})=>()=>a({...s,value:u,selected:i.val.includes(u),"area-label":c},c)))}},Nl=e=>{const{bau:t}=e,{section:n}=t.tags,o=t.state([""]),a=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],s=_e(e),i=vt(e),r="primary",l="solid",c=({values:u})=>{o.val=u};return()=>n(i({color:r,variant:l,exclusive:!0,onChange:c},a.map(({label:u,value:d})=>()=>s({color:r,variant:l,value:d,selected:o.val.includes(d),"area-label":u},u))))},$l=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
...
`,Pl={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:$l,createComponent:Nl},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Ol,createComponent:Bl}],gridItem:Fn},Ll=e=>{const t=F(e);return()=>t(Pl)};function xt(e,t={}){const{bau:n,css:o,window:a}=e,{div:s}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
  ...
  `;return function(...l){let[{titleEl:c,side:u="bottom-start",size:d=t.size??"md",variant:p=t.variant??"outline",color:b=t.color??"neutral",...m},...h]=K(l);const f=s({class:D("container",...u.split("-"))},s({class:D("content",b,p,d),role:"tooltip"},c)),x=T=>`move-to-${T}`,y=(T,M,P)=>{if(T()){const O=x(M);f.classList.add(O),f.classList.add(M),f.classList.remove(P)}},w=(T,M)=>{const P=x(T);f.classList.contains(P)&&(f.classList.remove(P),f.classList.add(M),f.classList.remove(T))},E=T=>{const M=f.getBoundingClientRect();y(()=>M.x<0,"right","left"),y(()=>M.x+M.width>a.innerWidth,"left","right"),y(()=>M.y<0,"bottom","top"),y(()=>M.bottom>a.innerHeight,"top","bottom"),f.classList.add("visible")},A=T=>{f.classList.remove("visible"),w("right","left"),w("left","right"),w("bottom","top"),w("top","bottom")};return s({...m,class:D("tooltip",i,t==null?void 0:t.class,m==null?void 0:m.class),bauMounted:({element:T})=>{T.addEventListener("mouseover",E),T.addEventListener("mouseout",A)},bauUnmounted:({element:T})=>{T.removeEventListener("mouseover",E),T.removeEventListener("mouseout",A)}},...h,f)}}const Gn=(e,t)=>{const{bau:n}=e,{div:o,p:a,em:s}=n.tags,i=X(e),r=xt(e,t),l=()=>o(a("A ",s("tooltip")," can be any component"));return c=>r({titleEl:l(),...c},i(c,`${c.color} ${c.variant}`))},zl=e=>{const{bau:t}=e,{div:n,p:o,em:a}=t.tags,s=X(e),i=xt(e),r=()=>n(o("A ",a("tooltip")," can be any component"));return()=>i({side:"bottom-start",titleEl:r()},s("tooltip"))},_l=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Rl=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:s,section:i}=t.tags,r=Ie(e,{variant:"outline",color:"primary"}),l=xt(e),c=()=>o(a("A ",s("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
...
`,Hl={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import tooltip from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:_l,createComponent:zl},{title:"Grid",description:"Various tooltip position",code:jl,createComponent:Rl}],gridItem:Gn},Ul=e=>{const t=F(e);return()=>t(Hl)},Vn=(e,t)=>{const n=st(e,t);return o=>n(o)},Fl=e=>{const{bau:t}=e,{section:n}=t.tags,o=st(e);return()=>n(o({}))},Gl=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,Vl={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:Gl,createComponent:Fl}],gridItem:Vn},Wl=e=>{const t=F(e);return()=>t(Vl)},Kl=({css:e,createGlobalStyles:t})=>(t`
:root {
...
`,{nav:e`
  ...
  `});function Wn(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:s}=t,{ul:i,li:r,nav:l,div:c}=n.tags,u=Kl({css:o,createGlobalStyles:a}),d=mt(e),p=({depth:b=1,maxDepth:m,color:h,variant:f,size:x})=>y=>{const{children:w,expanded:E}=y,A=n.state(!E),B=()=>c({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:M=>{w&&(A.val=!A.val)}},s(y.data)),T=()=>i({class:D(h,x)},w.map(p({depth:b+1,maxDepth:m})));return r(d({size:x,Header:B,Content:w&&b<m&&T}))};return function({tree:m,maxDepth:h=1/0,size:f=t.size??"md",variant:x=t.variant??"outline",color:y=t.color??"neutral",...w}){return l({class:D(u.nav,f,x,y,t==null?void 0:t.class,w.class)},m.children&&i(m.children.map(p({maxDepth:h,color:y,variant:x,size:f}))))}}const Kn=(e,t)=>{const{bau:n}=e,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Wn(e,{renderMenuItem:({name:r,href:l})=>o({href:l},r),...t});return r=>i({...r,tree:a})},Xl=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Wn(e,{renderMenuItem:({name:i,href:r})=>n({href:r},i)});return()=>s({tree:o})},Zl=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,ql={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:Zl,createComponent:Xl}],gridItem:Kn},Jl=e=>{const t=F(e);return()=>t(ql)},Yl=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=Le(e,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...t});return r=>i(r)},Ql=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:s,p:i,ul:r,li:l}=t.tags,c=nn(e),u=X(e),d=[{name:"Accordion",Item:on(e)},{name:"Alert",Item:rn(e)},{name:"Autocomplete",Item:cn(e)},{name:"Avatar",Item:sn(e)},{name:"Badge",Item:un(e)},{name:"Breadcrumbs",Item:dn(e)},{name:"Button",Item:pn(e)},{name:"Button Group",Item:mn(e)},{name:"Calendar",Item:bn(e)},{name:"Checkbox",Item:fn(e)},{name:"Chip",Item:hn(e)},{name:"DrillDown Menu",Item:xn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:wn(e)},{name:"Input",Item:Sn(e)},{name:"Input Search",Item:Cn(e)},{name:"Linear Progress",Item:En(e)},{name:"Loading Button",Item:An(e)},{name:"Modal",Item:Dn(e)},{name:"Radio Button",Item:In(e)},{name:"Select",Item:Nn(e)},{name:"Select Native",Item:Bn(e)},{name:"Slider",Item:On(e)},{name:"Spinner",Item:Pn(e)},{name:"Switch",Item:Rn(e)},{name:"Tabs",Item:Yl(e)},{name:"Theme Switch",Item:Vn(e)},{name:"Toggle",Item:Un(e)},{name:"Toggle Group",Item:Fn(e)},{name:"Tooltip",Item:Gn(e)},{name:"Tree View",Item:Kn(e)}];return()=>o({class:n`
          overflow-y: scroll;
        `},s("Bau Component Gallery"),i("This page displays the components with various colors and variants."),r({class:n`
          ...
          `},d.map(({name:p})=>l(u({color:"primary",variant:"solid",href:`#${p}`,size:"sm"},p)))),d.map(p=>a({id:p.name,class:n`
              ...
              padding: 1rem;
              margin: 1rem;
            `},c(p))))},eu=({context:e})=>{const t=Ql(e);return[{path:"",action:n=>({title:"Bau UI",component:Bo(e)})},{path:"GettingStarted",action:n=>({title:"Getting Started",component:za(e)})},{path:"components",action:()=>({title:"Component",component:t}),children:[{path:"accordion",action:()=>({title:"Accordion",component:Ka(e)})},{path:"alert",action:()=>({title:"Alert",component:tr(e)})},{path:"alertStack",action:()=>({title:"Alert Stack",component:sr(e)})},{path:"animate",action:()=>({title:"Animate",component:pr(e)})},{path:"autocomplete",action:()=>({title:"Autocomplete",component:Dr(e)})},{path:"avatar",action:()=>({title:"Avatar",component:vr(e)})},{path:"badge",action:()=>({title:"Badge",component:$r(e)})},{path:"breadcrumb",action:()=>({title:"Breadcrumb",component:_r(e)})},{path:"button",action:()=>({title:"Button",component:Gr(e)})},{path:"buttonGroup",action:()=>({title:"Button Group",component:Zr(e)})},{path:"calendar",action:()=>({title:"Calendar",component:Qr(e)})},{path:"carousel",action:()=>({title:"Carousel",component:rs(e)})},{path:"chip",action:()=>({title:"Chip",component:ls(e)})},{path:"checkbox",action:()=>({title:"Checkbox",component:bs(e)})},{path:"collapsible",action:()=>({title:"Collapsible",component:xs(e)})},{path:"divider",action:()=>({title:"Divider",component:ks(e)})},{path:"drawer",action:()=>({title:"Drawer",component:Ms(e)})},{path:"dropdownMenu",action:()=>({title:"Dropdown Menu ",component:Ps(e)})},{path:"drillDownMenu",action:()=>({title:"DrillDown Menu",component:Rs(e)})},{path:"fileInput",action:()=>({title:"File Input",component:Fs(e)})},{path:"form",action:()=>({title:"Form",component:Js(e)})},{path:"input",action:()=>({title:"Input",component:ti(e)})},{path:"inputSearch",action:()=>({title:"Input Search",component:ri(e)})},{path:"keyValueList",action:()=>({title:"Key Value List",component:ui(e)})},{path:"linearProgress",action:()=>({title:"Linear Progress",component:gi(e)})},{path:"list",action:()=>({title:"List",component:Ei(e)})},{path:"loadingButton",action:()=>({title:"Loading Button",component:vi(e)})},{path:"modal",action:()=>({title:"Modal",component:Mi(e)})},{path:"multiSelect",action:()=>({title:"Multi Select",component:zi(e)})},{path:"paginationNavigation",action:()=>({title:"Pagination Navigation",component:Wi(e)})},{path:"paper",action:()=>({title:"Paper",component:Ji(e)})},{path:"popover",action:()=>({title:"Popover",component:Hi(e)})},{path:"radioButton",action:()=>({title:"Radio Button",component:tc(e)})},{path:"select",action:()=>({title:"Select",component:pc(e)})},{path:"selectNative",action:()=>({title:"Select Native",component:hc(e)})},{path:"skeleton",action:()=>({title:"Skeleton",component:Ac(e)})},{path:"slider",action:()=>({title:"Slider",component:Oc(e)})},{path:"spinner",action:()=>({title:"Spinner",component:_c(e)})},{path:"stepper",action:()=>({title:"Stepper",component:Vc(e)})},{path:"switch",action:()=>({title:"Switch",component:qc(e)})},{path:"table",action:()=>({title:"Table",component:fl(e)})},{path:"tableOfContent",action:()=>({title:"Table",component:wl(e)})},{path:"tablePagination",action:()=>({title:"Table Pagination",component:El(e)})},{path:"tabs",action:()=>({title:"Tabs",component:il(e)})},{path:"toggle",action:()=>({title:"Toggle",component:Ml(e)})},{path:"toggleGroup",action:()=>({title:"Toggle Group",component:Ll(e)})},{path:"tooltip",action:()=>({title:"Tooltip",component:Ul(e)})},{path:"themeSwitch",action:()=>({title:"Theme Switch",component:Wl(e)})},{path:"treeView",action:()=>({title:"Tree View",component:Jl(e)})}]},{path:"pages",action:n=>({title:"Pages",component:Lo(e)})}]},tu=e=>({title:e.tr("Page Not Found"),component:()=>"Not Found"}),nu=({context:e,LayoutDefault:t,config:{base:n=""}})=>{const{window:o,bau:a,states:s}=e,i=a.state(),r=t({componentState:i});return document.getElementById("app").replaceChildren(r),({router:c})=>{const u=o.location.pathname.replace(n,""),{title:d,component:p,Layout:b=t}=c.resolve({pathname:u});i.val=p({}),document.title=`${d}`}},ou=e=>{const{createGlobalStyles:t}=e;t`
    :root {
      --header-height: 3rem;
    }
    html {
  ...
  `};uo();const Xn={title:"Bau",base:"/bau/bau-ui"},be=xo({config:Xn}),{bau:au}=be;be.states={drawerOpen:au.state(!0)};ou(be);eo({routes:eu({context:be}),onLocationChange:nu({context:be,LayoutDefault:Mo(be),config:Xn}),notFoundRoute:tu(be)});
