...
`);function N(t,e={}){const{bau:n,css:o}=t,a=o`
    ...
    ${Do()}
  `;return function(...i){var p;let[{size:r=e.size??"md",variant:l=e.variant??"none",color:c=e.color??"none",href:u,...d},...m]=V(i);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:["button",l,r,c,a,e.class,Array.isArray(d.class)?(p=d.class)==null?void 0:p.join(" "):d.class],href:u},m)}}const Bo="light",No=()=>nt.map(t=>`
&.theme-switch.outline.${t} {
  color: var(--color-${t})
}
`).join(`
`);function ce(t,e={}){const{bau:n,css:o,window:a}=t,{input:s}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},l=r();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
    position: relative;
    display: flex;
    justify-content: center;
    align-items: center;
    ...
    ${No()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",...g},...h]=V(d);return s({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:["theme-switch",p,b,m,c,e==null?void 0:e.class,g.class],type:"checkbox",checked:r()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...h)}}function Oo(t){const{tr:e,bau:n,css:o,config:a,states:s}=t,{i,header:r,h1:l,div:c,a:u,img:d,b:m,ul:b,li:p}=n.tags,{svg:g,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),y=s.drawerOpen,f=N(t,{class:o`
    ...
    `}),x=ce(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),k=()=>c({class:o`
        ...
        `},k(),A())}}function Mo({tr:t,bau:e,css:n}){const{section:o,footer:a,span:s,a:i,ul:r,li:l,p:c,div:u,h1:d}=e.tags,m=({links:g,title:h})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},d(h),r(g.map(({href:y,name:f})=>l(i({href:y},f))))),b=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],p=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
        ...
        `},u({class:n`
          ...
          `},m({title:"Bau UI",links:b}),m({title:"Bau Ecosystem",links:p})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},s("v0.85.0"),s("MIT license")))}}function yt(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,s=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:t`
   ...
   `});function le(t,e={}){const{bau:n,css:o,window:a,config:s}=t,{base:i="",hashBased:r=!1}=e,l=`${s.base}${i}`,c=P=>{var C;return((C=P.parentTree.data)==null?void 0:C.href)??P.parentTree.children[0].data.href},u=({variant:P,color:C,size:v,currentTree:w,data:E})=>x(D({variant:P,color:C,size:v,href:`${l}${c(w)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),D({variant:P,color:C,size:v,href:`${l}${E.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},E.name)),d=({size:P,subTree:{data:{name:C,href:v},children:w=[]}})=>D({size:P,href:`${l}${v}`,"data-ischild":!w.length},C),m=({pathname:P,subTree:C})=>{var v;return P===((v=C==null?void 0:C.data)==null?void 0:v.href)},{renderHeader:b=u,renderMenuItem:p=d,isActive:g=m}=e,{li:h,nav:y,div:f,header:x,a:S}=n.tags,k=Kt(t),A=yt(t),D=N(t,{class:o`
      &.button {
  ...
  `,$=({children:P,pathnameState:C,variant:v,color:w,size:E})=>A({class:[v,w,E]},P.map(T=>h({class:()=>[T.children&&"has-children",g({pathname:C.val,subTree:T})&&"active"]},p({variant:v,color:w,size:E,subTree:T})))),j=({variant:P,color:C,size:v,currentTree:w,pathnameState:E})=>{const{children:T,parentTree:G,data:R,renderList:H}=w;return f({class:["drillDownMenu",P,C,v]},G&&b({variant:P,color:C,size:v,data:R,currentTree:w}),T&&H?H({renderListDefault:$,children:T,pathnameState:E,variant:P,color:C,size:v}):$({children:T,pathnameState:E,variant:P,color:C,size:v}))},U=({tree:P,pathname:C})=>{let v=Ge({})({...P}),w=Fe(C)(v);return w||(w=v),w},z=({target:P})=>{let C=`${P.closest("a").pathname.replace(".md","").replace(l,"")}${P.hash}`;return r||(C=C.replace(P.hash,"")),C};return function(C){const{size:v=e.size??"md",variant:w=e.variant??"plain",color:E=e.color??"neutral",tree:T,...G}=C,R=n.state(a.location.pathname.replace(l,""));let H=U({tree:T,pathname:R.val});const J=n.state(JSON.stringify(H.data));let M;a.document.addEventListener("click",Z=>{const{target:at}=Z,it=at.closest("a");if(!it)return;const ct=it.getAttribute("href");ct&&!ct.startsWith("http")&&!ct.startsWith("#")&&!ct.startsWith("?")&&(H=U({tree:T,pathname:z(Z)}),J.val=JSON.stringify(H.data),R.val=z({target:at}))});const X=Z=>{const{buttonback:at,ischild:it}=Z.target.dataset;at=="true"?M=-1:it=="false"?M=1:it=="true"&&(M=0)},tt=Z=>{switch(Z){case 1:return`${B} ${Vt}`;case-1:return`${O} ${Vt}`;default:return""}},W=Z=>{switch(Z){case 1:return`${O} ${Vt} reverse`;case-1:return`${B} ${Vt} reverse`;default:return""}};return y({class:[I,w,E,v,e==null?void 0:e.class,G.class],onclick:X},k({animationHide:()=>tt(M),animationShow:()=>W(M)},n.bind({deps:[J],render:()=>()=>j({variant:w,color:E,size:v,currentTree:H,pathnameState:R})})))}}const Lo=()=>nt.map(t=>`
&.input.${t} {
...
`).join(`
`);function ut(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
  ...
  `;return function(r){var d;const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=r;return a({type:"text",...u,class:["input",e.class,e.size??"md",c,l,s,Array.isArray(r.class)?(d=r.class)==null?void 0:d.join(" "):r.class]})}}function ue(t,e={}){const{bau:n,css:o,window:a}=t,s=ut(t,e);return function(r){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=r,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,b=o`
    ...
    `}),h={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:k,variant:A,color:D,size:B})=>{const O=n.state(""),I=n.derive(()=>O.val==""?S:S.filter(j=>j.data.name.match(new RegExp(`${O.val}`,"i")))),$=j=>{O.val=j.target.value};return b({class:o`
        ...
        `},f({tree:h}))}}const $o=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:s}=e.tags,i=Kt(t),r=Oo(t),l=He(t),c=Mo(t),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `,d=(m="")=>`${u} ease-in-out 0.5s ${m}`;return function({componentState:b}){return s({class:n`
        ...
        `},r(),l(),i({class:n`
            ...
            margin: 0 1rem;
            display: grid;
          `,animationHide:()=>d(),animationShow:()=>d("reverse")},()=>b.val),c())}};function Pt(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,s=o`
    display: inline-flex;
    align-items: center;
    flex-grow: 0;
    box-sizing: border-box;
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",onclick:d,...m},...b]=V(r);return a({...m,onclick:d,class:["chip",e.class,l,c,u,d&&"clickable",s,m.class]},...b)}}function Po(t){const{bau:e,css:n,config:o}=t,{div:a,h1:s,h2:i,p:r}=e.tags;N(t);const l=n`
  ...
  `,r=({title:l,Content:c})=>o({className:"feature"},a(l),s(c()));return function({featuresContent:c}){return o({class:i},c.map(r))}}function Ro({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:s,dd:i,div:r,aside:l,footer:c,a:u}=e.tags,d=({maxSize:m=151})=>({libName:b,size:p})=>r({class:n`
            display: flex;
            margin: 0.3rem;
          `},s({class:n`
              display: flex;
        ...
        `},l({class:n`
          ...
          `},b.map(d({}))),c({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function jo(t){const{bau:e,css:n,config:o}=t,{div:a,p:s,a:i,section:r}=e.tags,l=Po(t),c=zo(t),u=N(t);Pt(t);const d=Ro(t),m=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
)`}),s("Most components accepts the ",r({href:"https://github.com/grucloud/bau/blob/main/bau-ui/constants.d.ts#L1",target:"_blank"},"variant"),", ",r({href:"https://github.com/grucloud/bau/blob/main/bau-ui/constants.d.ts#L3",target:"_blank"},"color"),",  and ",r({href:"https://github.com/grucloud/bau/blob/main/bau-ui/constants.d.ts#L2",target:"_blank"},"size"),", property."),s("Further reading:",l(c(r({href:"components"},"Visit the component gallery")),c(r({href:"https://github.com/grucloud/bau",target:"_blank"},"Learn more about bau")))))}}function ge(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["paper",l,s,e==null?void 0:e.class,d==null?void 0:d.class]},...m)}}function cn(t,e={}){const{bau:n,css:o,window:a}=t,{nav:s,ul:i,li:r,a:l}=n.tags,{headerSelector:c="h2,h3"}=e,u=n.state("no"),d=(h,y)=>{let f=null;return(...x)=>{a.clearTimeout(f),f=a.setTimeout(()=>h(...x),y)}},m=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,b=({value:h,id:y,children:f=[]})=>{const x=l({class:()=>u.val==y?"active":"",href:`#${y}`});return x.innerHTML=h,r({class:()=>u.val==y?"active":""},x,f.length>0&&i(f.map(b)))},p=h=>h.tagName.charAt(1),g=({contentEl:h})=>{const y=h.querySelectorAll(c);let f=2,x={},S={children:[]},k=S;const A=k;let D=[k];return[...y].forEach(B=>{const O=p(B);B.setAttribute("id",B.textContent),!B.innerHTML.includes("<button")&&(x={value:B.innerHTML,id:B.id??B.textContent,children:[]},f==O?(S=x,k.children.push(S)):f<O?(D.push(k),k=S,S.children.push(x),S=x):f>O&&(k=D[O-1],D=D.slice(0,O-1),k.children.push(x),S=x),f=O)}),A};return function(...y){let[{size:f=e.size??"md",variant:x=e.variant??"plain",color:S=e.color??"neutral",contentEl:k,...A}]=V(y);const D=g({contentEl:k}),B=d(()=>{const I=[...k.querySelectorAll(c)].find($=>{const{top:j,height:U}=$.getBoundingClientRect();if(j+U>60)return!0});I&&(u.val=I==null?void 0:I.id)},100);return s({...A,class:["tableOfContent",f,x,S,m,e==null?void 0:e.class,A==null?void 0:A.class],bauMounted:()=>{a.addEventListener("scroll",B)},bauUnmounted:()=>{a.removeEventListener("scroll",B)}},D.children&&i(D.children.map(b)))}}const ln=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:s,tr:i,td:r,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(l(i(c(m??""),nt.map(b=>c(b)))),s(To.map(b=>i(c(b),nt.map((p,g)=>r(d({color:p,variant:b},{index:g}))))))))}},Ha=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:s}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
        `},Ao.map((i,r)=>s(t,{size:i})({color:"success",variant:"outline"},{size:i,index:r})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:s,h1:i,p:r,h2:l,h3:c,pre:u,code:d}=e.tags;Mt.registerLanguage("javascript",sn);const m=cn(t),b=ge(t,{class:n`
      &.paper {
    ...
    `}),p=ln(t),g=Ha(t),h=({text:y})=>u({class:n`
        ...
        `},d({class:"hljs language-js",bauCreated:({element:f})=>{f.innerHTML=Mt.highlight(y,{language:"js"}).value}}));return function(f){const x=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},i(f.title),r(f.description),f.gridItem&&!f.variantColorTableDisable&&[l("Variant/Color"),b(p({Item:f.gridItem(t)}))],f.gridItem&&!f.variantSizeDisable&&[l("Size"),r("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),b(g({item:f.gridItem}))],l("Usage"),c("Import"),h({text:f.importStatement}),l("Examples"),f.examples.map(S=>s(c(S.title),r(S.description),b(S.createComponent(t)({})),h({text:S.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
        ...
        `},x,m({contentEl:x}))}};function he(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
    overflow: hidden;
    background-color: inherit;
    display: flex;
    flex-direction: column;
...
`).join(`
`);function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,ul:s,li:i,h3:r,button:l}=n.tags,c=o`
    & ul {
      display: inline-flex;
      flex-direction: column;
      justify-content: flex-start;
    ...
    ${Va()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",data:g=[],...h}]=V(d);const y=n.state(""),f=he(t,{size:m,variant:b,color:p}),x=k=>A=>{y.val==k?y.val="":y.val=k},S=k=>{const{Header:A,Content:D,name:B}=k,O=()=>r({class:()=>y.val==B&&"active"},l({type:"button","aria-controls":`bau-${B}`,"aria-expanded":({element:$})=>y.val==B},A(k))),I=()=>a({id:`bau-${B}`,"data-state":({element:$})=>y.val==B},D(k));return i({class:[p,b,m],onclick:x(B)},f({Header:O,Content:I}))};return a({class:["accordion",c,e==null?void 0:e.class,h.class]},s(g.map(S)))}}const un=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,s=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Zt(t,e);return r=>i({...r,data:s})},Ja=t=>{const{bau:e}=t,{div:n,p:o,section:a}=e.tags,s=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Zt(t,{color:"neutral",variant:"outline"});return()=>a(i({data:s}))},qa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
&.alert {
  ...
  `).join(`
`);function Tt(t,e={}){const{bau:n,css:o}=t,{div:a,i:s}=n.tags,i=o`
    display: flex;
    max-width: 600px;
    justify-content: flex-start;
    align-items: center;
...
`,gr=t=>{const{bau:e,keyframes:n}=t,{section:o,div:a,input:s,label:i}=e.tags,r=Kt(t),l=n`
    to {
      transform: translateX(1rem);
      opacity: 0;
    }
  `,c={one:()=>a("ONE"),two:()=>a("TWO")};return()=>{const u=e.state("one"),d=({target:m})=>u.val=m.id;return o(i("One",s({type:"radio",id:"one",name:"radio",checked:!0,value:u,oninput:d})),i("Two",s({type:"radio",id:"two",name:"radio",value:u,oninput:d})),r({animationHide:()=>`${l} 0.5s`,animationShow:()=>`${l} 0.5s reverse`},()=>c[u.val]()))}},hr=`import animate from "@grucloud/bau-ui/animate";
import { Context } from "@grucloud/bau-ui/context";
...
`,fr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:hr,createComponent:gr}]},vr=t=>{const e=F(t);return()=>e(fr)};function Et(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:s}=n.tags,i=a`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",...b},...p]=V(c);return s({...b,class:["skeleton",u,r,e==null?void 0:e.class,b==null?void 0:b.class]},...p)}}function fe(t,e={}){const{bau:n,css:o}=t,{div:a,img:s}=n.tags,i=n.state(!0),r=n.state(!1),l=()=>i.val=!1,c=d=>{i.val=!1,r.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",width:h=40,height:y=40,alt:f,...x},...S]=V(m);const k=Et(t,{class:[o`
          ...
          height: ${y}px;
          width: ${h}px;
        `,e==null?void 0:e.class,x.class]});return a({class:[u,e==null?void 0:e.class,x.class]},()=>i.val&&k(),()=>r.val&&f,s({alt:f,width:h,height:y,onload:l,onerror:c,class:()=>[!i.val&&"visible",r.val&&"hide",g,p,b,u,e==null?void 0:e.class,x.class],...x}))}}const pn=(t,e)=>{const{css:n}=t,o=fe(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`).join(`
`);function pt(t,e={}){const{bau:n,css:o,keyframes:a}=t,{svg:s,circle:i}=n.tagsNS("http://www.w3.org/2000/svg"),r=a`
    100% {
...
100% {
  ...
  `;return function({size:u=e.size??"md",color:d=e.color??"primary",variant:m=e.variant??"outline",visibility:b=!0,...p}={}){const g=o`
      ...
      ${Er()}
    `;return s({class:{deps:[b],renderProp:()=>h=>["spinner",g,d,m,h==!1?"":"visibility",e==null?void 0:e.class,p.class]},version:"1.1",x:"0px",y:"0px",width:qt[u],height:qt[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...p},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Tr=()=>nt.map(t=>`
...
`);function Rt(t,e={}){const{bau:n,css:o}=t,{div:a,li:s}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:b,Option:p,options:g,defaultOption:h,getOptionLabel:y,getOptionValue:f,onSelect:x=()=>{},id:S,required:k,name:A,loading:D,...B},...O]=V(l);const I=zt(t),$=N(t),j=ut(t,{variant:u,color:d,size:c}),U=yt(t),z=pt(t,{variant:u,color:d,size:c}),P=n.state(h),C=n.state(B.value),v=n.state(!1),w=n.state(0),E=()=>{v.val=!1},T=n.state(g),G=Y=>ot=>Y.val&&y(ot)==y(Y.val),R=()=>{lt.openDialog(),v.val=!0,C.val="",T.val=g,w.val=g.findIndex(G(P));const Y=Bt.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),it.scrollIntoView({block:"end"}))},H=()=>{lt.closeDialog(),v.val=!1,w.val=0},J=Y=>{const{value:ot}=Y.target;C.val=ot,ot?T.val=g.filter(Gt=>y(Gt).match(new RegExp(`${ot}`,"i"))):T.val=g},M=Y=>{lt.open?H():R()},X=Y=>{P.val=Y,ct.value=f(Y)},tt=({option:Y,index:ot})=>Gt=>{X(Y),w.val=ot,H()},W=()=>{const Y=Bt.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},Z=Y=>{switch(Y.key){case"Escape":H();break;case"ArrowDown":w.val<T.val.length-1?w.val++:w.val=0,W();break;case"ArrowUp":w.val<=0?w.val=T.val.length-1:w.val--,W();break;case"Enter":lt.open?(X(T.val[w.val]),H()):R(),Y.preventDefault();break}},at=$({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":v,"aria-label":m,onclick:M,variant:u,color:d,size:c,class:D==!0&&"loading",disabled:D},()=>P.val?y(P.val):m,()=>D==!0&&z({visibility:D})),it=j({value:C,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":v,oninput:J,onkeydown:Z,...B}),ct=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:h&&f(h),required:k,"aria-hidden":!1,"aria-label":A,name:A}),Bt=a({class:[u,d,c,"content"]},it,()=>U({class:[u,d,c]},T.val.map((Y,ot)=>s({class:()=>[w.val==ot&&"active",G(P)(Y)&&"selected"],onclick:tt({option:Y,index:ot})},p(Y))))),lt=I({id:S,triggerEl:at,contentEl:Bt,onClose:E,class:o`
        overflow: hidden;
      `});return a({...B,class:["autocomplete",i,e==null?void 0:e.class,B==null?void 0:B.class]},n.bind({deps:[P],render:()=>Y=>{Y&&(ct.value=f(Y),x(Y))}}),at,ct,lt)}}const bn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:s}=n.tags,i=Rt(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(c.label),s(c.code));return c=>i({...c,options:r,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",name:"country","aria-label":"country"})},Ar=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Dr=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:s,article:i,footer:r}=e.tags,l=Rt(t),c=N(t,{variant:"outline",color:"primary"}),u=d=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},a(d.label),a(d.code));return()=>s({onsubmit:m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(b))}},i(l({options:Ar,Option:u,getOptionValue:({code:m})=>m,getOptionLabel:({label:m})=>m,label:"Country",placeholder:"Search countries",name:"country"})),r(c({type:"submit"},"Submit")))},Br=`import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,Nr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,l=Rt(t),c=N(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(b.label),r(b.code));return()=>o({onsubmit:p=>{p.preventDefault();const g=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(g))}},a(l({options:d,Option:m,defaultOption:d.find(({code:p})=>p==u),getOptionValue:({code:p})=>p,getOptionLabel:({label:p})=>p,label:"Country",placeholder:"Search countries",name:"country"})),s(c({type:"submit"},"Submit")))},Or=`import { Context } from "@grucloud/bau-ui/context";
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,l=N(t,{variant:"outline"}),c=N(t,{variant:"solid",color:"primary"}),u=Rt(t),d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(m.flag),r(m.name.common));return()=>{const m=e.state([]),b=e.state(!1),p=e.state("");async function g({url:f,transform:x=S=>S}){try{b.val=!0;const S=await fetch(f,{});if(S.ok){const k=await S.json();m.val=x(k)}else p.val=S.statusText}catch(S){p.val=S.message}finally{b.val=!1}}const h=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:f=>f.sort((x,S)=>x.name.common.localeCompare(S.name.common))});return h(),o({onsubmit:f=>{f.preventDefault();const x=Object.fromEntries(new FormData(f.currentTarget));alert(JSON.stringify(x))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({options:m.val,Option:d,getOptionValue:({name:f})=>f.common,getOptionLabel:({name:f})=>f.common,label:"Country",placeholder:"Search countries",name:"country",loading:b.val}),l({onclick:h},"Reload")),s(c({type:"submit"},"Submit")))}},Ir=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,Pr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Br,createComponent:Dr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Ir,createComponent:Mr},{title:"Default Option",description:"A autocomplete with a default option.",code:Or,createComponent:Nr},{title:"URL State",description:"A autocomplete with the state in the URL",code:$r,createComponent:Lr}],gridItem:bn},zr=t=>{const e=F(t);return()=>e(Pr)};function gn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=V(r);return a({...m,class:["badge",s,e==null?void 0:e.class,m==null?void 0:m.class]},a({class:[u,c,l]},d),...b)}}const hn=(t,e)=>{const n=gn(t,e);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},Rr=t=>{const{bau:e}=t,{section:n}=e.tags,o=gn(t);return()=>n(o({content:"10"},"☏"))},jr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,_r={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:jr,createComponent:Rr}],gridItem:hn},Ur=t=>{const e=F(t);return()=>e(_r)};function ve(t,e={}){const{bau:n,css:o,config:a}=t,{ul:s,li:i,span:r}=n.tags,{separator:l="〉"}=e,c=N(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",items:h,...y},...f]=V(m);return s({...y,class:[u,e==null?void 0:e.class,y==null?void 0:y.class]},h.map(({href:x,name:S})=>i((x!=null?c:r)({href:`${a.base}${x}`,color:g,variant:p,size:b,class:[g,p,b]},S))))}}const fn=(t,e)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=ve(t,e);return a=>o({...a,...n})},Gr=t=>{const{bau:e}=t,{section:n}=e.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=ve(t,{variant:"outline",color:"neutral"});return()=>n(a(o))},Fr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`);function ye(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
    ...
    ${ts()}
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["button-group",c,u,l,s,e==null?void 0:e.class,d==null?void 0:d.class]},...m)}}const yn=(t,e)=>{const n=["ONE","TWO","THREE"],o=N(t,e),a=ye(t,e);return s=>a({...s},n.map(i=>o(s,i)))},es=t=>{const{bau:e}=t,{section:n}=e.tags,o=["ONE","TWO","THREE"],a="primary",s="solid",i=N(t,{color:a,variant:s}),r=ye(t,{color:a,variant:s});return()=>{const l=c=>u=>{alert(c)};return n(r(o.map(c=>i({onclick:l(c)},c))))}},ns=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`)}
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...b]=V(l);return a({...m,type:"date",class:["calendar",i,d,u,c,e==null?void 0:e.class,m==null?void 0:m.class]},...b)}}const xn=(t,e)=>{const n=xe(t,e),o=({props:a={},options:s={}})=>`myinput-gallery-${a.color??s.color}-${a.variant??s.variant}-${a.size??s.size}`;return a=>n({"aria-label":o({props:a,options:e}),...a})},rs=t=>{const{bau:e}=t,{form:n,footer:o,article:a,label:s}=e.tags,i=xe(t),r=N(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},a(s("Start date:",i({name:"start",min:"2023-01-01",max:"2024-12-31",required:!0}))),o(r({type:"submit"},"Submit")))},ss=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,ls={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Uncontrolled Calendar",description:"A simple calendar.",code:ss,createComponent:rs},{title:"Controlled Calendar",description:"A controlled calendar.",code:cs,createComponent:is}],gridItem:xn},us=t=>{const e=F(t);return()=>e(ls)};function ds(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:b,Previous:p,Next:g,...h}]=V(l);const y=()=>{i.val<=0?i.val=m.length-1:i.val--},f=()=>{i.val>=m.length-1?i.val=0:i.val++},x=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(b));return a({...h,class:["carousel",c,s,e==null?void 0:e.class,h==null?void 0:h.class]},a({class:["control","control-previous"],onclick:y},p()),a({class:["control","control-next"],onclick:f},g()),x)}}const ms=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ps=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,s=N(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
    ...
    `}),l=()=>s("◀"),c=()=>s("▶");return()=>o(r({slides:ms,Slide:i,Previous:l,Next:c}))},bs=`import carousel from "@grucloud/bau-ui/carousel";
import button from "@grucloud/bau-ui/button";
...
`,ys={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:vs,createComponent:fs}],gridItem:wn},xs=t=>{const e=F(t);return()=>e(ys)};function wt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
    margin: 0.5rem;
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({type:"checkbox",...d,class:[s,u,c,l,e==null?void 0:e.class,d==null?void 0:d.class]})}}const Sn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,s=wt(t,e);return i=>a({class:o`
          display: flex;
        ...
        `},`${i.color} ${i.variant} ${i.size??""}`,s({id:`myCheckbox-gallery-${i.color}-${i.variant}-${i.size}`,name:`myCheckbox-gallery-${i.color}-${i.variant}`,...i}))},ws=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,label:i}=e.tags,r=wt(t,{color:"neutral",variant:"outline"}),l=N(t,{variant:"outline",color:"primary"});return()=>{const c=e.state(!1),u=m=>c.val=m.target.checked;return o({onsubmit:m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(b))}},a(i({class:n`
              ...
              color: var(--color-content-secondary);
              gap: 1rem;
            `},"My Checkbox",r({name:"myCheckbox",checked:c,onchange:u}))),s(l({type:"submit"},"Submit")))}},Ss=`import { Context } from "@grucloud/bau-ui/context";
...
`,Cs=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:s,form:i}=e.tags,r=wt(t,{color:"neutral",variant:"outline"}),l=N(t,{variant:"outline",color:"primary"});return()=>i({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & article {
        ...
        `},s(o("My Checkbox",r({name:"my-checkbox-uncontrolled"})),o("My Checkbox with default",r({name:"my-checkbox-uncontrolled-default",defaultChecked:"on"}))),a(l({type:"submit"},"Submit")))},ks=`import checkbox from "@grucloud/bau-ui/checkbox";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Es=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:s,form:i}=e.tags,r=wt(t,{color:"neutral",variant:"outline"}),l=N(t,{variant:"outline",color:"primary"}),c=N(t,{variant:"solid",color:"primary"});return()=>{const u=m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(b))},d=m=>{const b=window.document.getElementById("my-checkbox");b&&(b.indeterminate=!b.indeterminate)};return i({onsubmit:u,class:n`
        ...
        `},s(o("My Checkbox",r({id:"my-checkbox",name:"my-checkbox"})),l({onclick:d},"Toggle Indeterminate")),a(c({type:"submit"},"Submit")))}},Ts=`import checkbox from "@grucloud/bau-ui/checkbox";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,As=t=>{const{bau:e,css:n,window:o}=t,{form:a,article:s,footer:i,label:r}=e.tags,l="myCheckbox",c=wt(t,{color:"neutral",variant:"outline"}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=new URLSearchParams(o.location.search),m=p=>{const g=new URLSearchParams(o.location.search);g.delete(p.target.name),g.append(p.target.name,p.target.checked),o.history.replaceState("","",`?${g.toString()}${o.location.hash}`)};return a({onsubmit:p=>{p.preventDefault();const g=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(g))}},s(r({class:n`
              ...
              color: var(--color-content-secondary);
              gap: 1rem;
            `},"My Checkbox",c({name:l,defaultChecked:d.get(l)=="true",onchange:m}))),i(u({type:"submit"},"Submit")))}},Ds=`import { Context } from "@grucloud/bau-ui/context";
import checkbox from "@grucloud/bau-ui/checkbox";
import button from "@grucloud/bau-ui/button";
...
`,Is={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Ms,createComponent:Os}]},Ls=t=>{const e=F(t);return()=>e(Is)};function $s(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
    display: flex;
    align-items: center;
    .content {
      margin: 1rem;
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["divider",l,s,e==null?void 0:e.class,d==null?void 0:d.class]},a({class:"content"},...m))}}const Ps=t=>{const{bau:e}=t,{section:n}=e.tags,o=$s(t);return()=>n(o("OR"))},zs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Rs={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:zs,createComponent:Ps}],variantColorTableDisable:!0,variantSizeDisable:!0},js=t=>{const e=F(t);return()=>e(Rs)};function _s(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{color:l,variant:c="outline",size:u,openState:d,...m},...b]=V(r);return a({class:[s,e==null?void 0:e.class,m.class]},a({class:()=>["overlay",d.val&&"overlay-open"],onclick:()=>{d.val=!1}}),a({class:()=>["content",d.val&&"content-open"]},b))}}const Us=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=_s(t),s=N(t,{color:"neutral",variant:"outline"}),i=He(t);return()=>{const r=e.state(!1);return n(o("Click on the button to open and close the drawer."),s({onclick:()=>{r.val=!r.val}},"OPEN DRAWER"),a({openState:r},i()))}},Gs=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,li:s}=n.tags,i=N(t),r=zt(t),l=yt(t),c=o`
    ${Vs()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"outline",color:p=e.color??"neutral",label:g,ListItem:h,items:y,...f},...x]=V(d);const S=n.state(0),k=()=>{U.openDialog(),U.focus()},A=()=>{U.closeDialog()},D=()=>{U.open?A():k()},B=z=>{D(),z.preventDefault()},O=({item:z,index:P})=>C=>{S.val=P,A(),C.preventDefault()},I=z=>{switch(z.preventDefault(),z.key){case"Escape":A();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":D();break}},$=()=>l({tabindex:"0",class:[p,b]},y.map((z,P)=>s({class:()=>[S.val==P&&"active"],onclick:O({item:z,index:P})},h(z)))),j=i({type:"button",onclick:B,color:p,variant:b,size:m},g),U=r({triggerEl:j,contentEl:$()});return a({...f,class:["dropdownMenu",p,m,c,e==null?void 0:e.class,f==null?void 0:f.class],onkeydown:I},j,U)}}const Js=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,s=Cn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=l=>o(a(l.label));return l=>s({...l,items:i,ListItem:r,label:"Action"})},qs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,s=Cn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(s({items:i,ListItem:r,label:"Action"}))},Ws=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Qs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Ys,createComponent:Zs}],gridItem:(t,e)=>kn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},ti=t=>{const e=F(t);return()=>e(Qs)};function En(t,e={}){const{bau:n,css:o}=t,{div:a,label:s,input:i}=n.tags,r={base:o`
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",Component:p,disabled:g,...h}=c;return a({class:[r.base,g&&r.disabled,e==null?void 0:e.class,c.class]},s({class:[m,b,d]},p({disabled:g}),i({type:"file",disabled:g,...h})))}}const Tn=(t,e)=>{const{tr:n,bau:o,css:a,config:s}=t,{svg:i,use:r}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=En(t,e),m=p=>{const g=p.target.files[0];g?u.val=g.name:u.val="No file selected"},b=({disabled:p})=>l({class:[a`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`,oi={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:ni,createComponent:ei}],gridItem:Tn},ai=t=>{const e=F(t);return()=>e(oi)};function bt(t,e={}){const{bau:n,css:o}=t,{form:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=V(r);return a({...m,class:["form",u,c,l,s,e==null?void 0:e.class,m==null?void 0:m.class]},...b)}}function we(t,e={}){const{bau:n,css:o,keyframes:a}=t,{span:s}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",loading:b,...p},...g]=V(c);const h=N(t),y=pt(t);return n.bind({deps:[b],render:()=>f=>h({...p,class:["loadingButton",u,d,m,r,f&&"loading",e==null?void 0:e.class,p==null?void 0:p.class]},y({size:u,variant:d,color:m,visibility:f}),s({class:f&&"loading"},g))})}}const ri=t=>{const{bau:e,css:n,config:o}=t,{section:a,h1:s,header:i,label:r,img:l,footer:c}=e.tags,u=we(t,{variant:"solid",color:"primary"}),d=Tt(t,{variant:"outline",color:"danger"}),m=ut(t),b=bt(t,{class:n`
    ...
    `});return function({onLoggedIn:g=()=>{}}){const h=e.state(!1),y=e.state("");return b({onsubmit:async x=>{x.preventDefault();const{username:S,password:k}=Object.fromEntries(new FormData(x.currentTarget));try{h.val=!0;const A=await fetch("/auth/login",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:S,password:k})});if(A.ok){const D=await A.json();g(D)}else A.status==401?y.val="Invalid username or password":y.val=A.statusText}catch(A){y.val=A.message}finally{h.val=!1}}},i(l({width:"100",height:"100",src:`${o.base}/gc.svg`}),s("Login to Grucloud")),a(()=>y.val&&d(y.val),r("Email",m({type:"email",autofocus:!0,placeholder:"Email",name:"username",autocomplete:"username",required:!0})),r("Password",m({type:"password",placeholder:"Password",name:"password",autocomplete:"current-password",minlength:"8",required:!0}))),c(u({type:"submit",loading:h},"Login")))}},si=`import form from "@grucloud/bau-ui/form";
...
`,ii=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:s,footer:i}=e.tags,r=bt(t),l=N(t,{variant:"solid",color:"primary"}),c=ut(t);return function({onSubmitted:d=()=>{}}){return r({onsubmit:async b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p)),d(p)}},a(o("Form with input")),n(s("Branch",c({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(l({type:"submit"},"Click")))}},ci=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`,di={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Simple form",description:"A simple form.",code:ci,createComponent:ii},{title:"Form with state",description:"A form with input state and a dervied state.",code:ui,createComponent:li},{title:"Login page",description:"A login page.",code:si,createComponent:ri}]},mi=t=>{const e=F(t);return()=>e(di)},An=(t,e={})=>{const n=ut(t,e),o=({color:a,variant:s,size:i,options:r})=>`myinput-gallery-${a??r.color}-${s??r.variant}-${i??r.size}`;return({color:a,variant:s,size:i,...r})=>n({"aria-label":o({color:a,variant:s,size:i,options:e}),name:o({color:a,variant:s,size:i,options:e}),placeholder:"Enter text",color:a,variant:s,size:i,...r})},pi=t=>{const{bau:e}=t,{article:n,footer:o,label:a}=e.tags,s=ut(t),i=bt(t),r=N(t,{variant:"solid",color:"primary"});return()=>i({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},n(a("Basic input",s({name:"my-input",placeholder:"Enter Text"})),a("Required input",s({required:!0,name:"my-required-input",placeholder:"Enter Text"})),a("Input with minLength/maxLength",s({name:"my-required-input-min-max",placeholder:"Enter Text",required:!0,minLength:3,maxLength:24})),a("Input with custom error message",s({name:"my-required-input-custom",placeholder:"Enter Text",required:!0,minLength:3,maxLength:24,oninvalid:c=>{c.target.setCustomValidity("Please select the correct format.")}})),a("Disabled input",s({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))),o(r({type:"submit"},"Submit")))},bi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,gi=t=>{const{bau:e}=t,{article:n,footer:o,label:a}=e.tags,s=ut(t),i=bt(t),r=N(t,{variant:"solid",color:"primary"});return()=>{const l=e.state(""),c=e.derive(()=>l.val=="");return i({onsubmit:m=>{m.preventDefault(),alert(l.val)}},n(a("Input",s({name:"my-input",placeholder:"Enter Text",value:l,oninput:m=>l.val=m.target.value}))),o(r({type:"submit",disabled:c},"Submit")))}},hi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,fi={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Uncontrolled Input",description:"Various uncontrolled inputs.",code:bi,createComponent:pi},{title:"Controlled Input",description:"Various controlled inputs.",code:hi,createComponent:gi}],gridItem:An},vi=t=>{const e=F(t);return()=>e(fi)},Dn=(t,e={})=>{const n=ue(t,e);return o=>n({name:`myinputSearch-gallery-${e.color}-${e.variant}-${e.size}`,id:`myinputSearch-gallery-${e.color??o.color}-${e.variant??o.variant}-${o.size??e.size}`,placeholder:"Enter text",...o})},yi=t=>{const{bau:e}=t,{label:n,footer:o,article:a}=e.tags,s=bt(t),i=ue(t),r=N(t,{variant:"solid",color:"primary"});return()=>s({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},a(n("Basic inputSearch",i({name:"my-inputSearch",placeholder:"Enter Text"})),n("Disabled inputSearch",i({name:"my-inputSearch-disabled",placeholder:"Enter Text",disabled:!0}))),o(r({type:"submit"},"Submit")))},xi=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Ai={title:"KeyValueList",package:"keyValueList",description:"The keyValueList component displays a list of key value pair",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/keyValueList/keyValueList.js",importStatement:'import keyValueList from "@grucloud/bau-ui/keyValueList";',examples:[{title:"Vertical keyValueList",description:"A vertical keyValueList.",code:ki,createComponent:Ci},{title:"Horizontal keyValueList",description:"A horizontal keyValueList.",code:Ti,createComponent:Ei}]},Di=t=>{const e=F(t);return()=>e(Ai)},Bi="modulepreload",Ni=function(t){return"/bau/bau-ui/"+t},Re={},Nn=function(e,n,o){let a=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),i=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));a=Promise.all(n.map(r=>{if(r=Ni(r),r in Re)return;Re[r]=!0;const l=r.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":Bi,l||(u.as="script"),u.crossOrigin="",u.href=r,i&&u.setAttribute("nonce",i),document.head.appendChild(u),l)return new Promise((d,m)=>{u.addEventListener("load",d),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${r}`)))})}))}return a.then(()=>e()).catch(s=>{const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=s,window.dispatchEvent(i),!i.defaultPrevented)throw s})};function On(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=pt(t,{size:"lg"}),i=Tt(t,{color:"danger"}),r=()=>a({class:o`
          height: 100%;
          display: flex;
          justify-content: center;
          align-items: center;
        `},s({visibility:!0})),l=c=>i(c.message);return function({getModule:u,loading:d=r,error:m=l,props:b={}}){const p=n.state(void 0),g=n.state(!0),h=n.state(!1);return u().then(y=>{n.batch(()=>{p.val=y.default(t),g.val=!1})}).catch(y=>{h.val=y.message}),a(()=>{if(h.val)return m({message:h.val});if(g.val)return d();if(p.val)return p.val(b)})}}const Oi=t=>{const{bau:e}=t,{section:n}=e.tags,o=On(t),a=N(t);return()=>{const s=e.state(!1);return n(a({onclick:()=>s.val=!s.val},()=>s.val?"Hide":"Show"),()=>s.val&&o({getModule:()=>Nn(()=>import("./myComponent-B8W3Hpri.js"),[]),props:{message:"myValue"}}))}},Mi=`import { Context } from "@grucloud/bau-ui/context";
...
`),r=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",running:p,...g}]=V(u);return s({...g,role:"progressbar",class:{deps:[p],renderProp:()=>h=>["linearProgress",d,b,l,h&&"running",e==null?void 0:e.class,g==null?void 0:g.class]}})}}const In=(t,e)=>{const n=Mn(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},zi=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=N(t,{variant:"solid",color:"primary"}),s=Mn(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,s({"aria-label":"linear-progress",running:i}))},Ri=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Fi={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:Gi,createComponent:Ui}],gridItem:Ln},Hi=t=>{const e=F(t);return()=>e(Fi)},Vi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Ji=(t,e)=>{const{bau:n,css:o}=t,{span:a,li:s}=n.tags,i=yt(t,e),r=({code:l,label:c})=>s({class:o`
          display: flex;
          gap: 1rem;
        `},a(l),a(c));return l=>i({...l},Vi.map(r))},qi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Wi=t=>{const{bau:e,css:n}=t,{section:o,span:a,li:s}=e.tags,i=yt(t,{variant:"outline",color:"primary"}),r=({code:l,label:c})=>s({class:n`
          display: flex;
          gap: 1rem;
        `},a(l),a(c));return()=>o(i(qi.map(r)))},Ki=`import list from "@grucloud/bau-ui/list";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function oc(t,e={}){const{bau:n,css:o}=t,{div:a,li:s,select:i}=n.tags,r=N(t),l=zt(t),c=yt(t),u=wt(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${nc()}
  `;return function(...b){let[{size:p=e.size??"md",variant:g=e.variant??"outline",color:h=e.color??"neutral",name:y,label:f,Option:x,options:S,defaultValue:k=[],getOptionLabel:A,getOptionValue:D,renderValue:B,onSelect:O=()=>{},loading:I,...$},...j]=V(b);const U=pt(t,{variant:g,color:h,size:p}),z=n.state(k),P=n.state(!1),C=n.state(0),v=()=>{X.openDialog(),X.focus(),P.val=!0},w=()=>{X.closeDialog(),P.val=!1},E=()=>{P.val=!1},T=W=>{X.open?w():v(),W.preventDefault()},G=()=>Array.from(tt.selectedOptions).map(({value:W})=>S.find(Z=>D(Z)==W)),R=W=>{switch(W.preventDefault(),W.key){case"Escape":w();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Z=W.currentTarget.querySelectorAll("input")[C.val];Z.checked=!Z.checked;const at=tt.options[C.val+1];at.selected=!at.selected,z.val=G()}else v();break}},H=W=>Z=>{const at=[...tt.options].find(({value:it})=>it==D(W));Z.target.checked?at.selected=!0:at.selected=!1,z.val=G()},J=()=>c({tabindex:"0",class:[h,g]},S.map((W,Z)=>s({class:()=>C.val==Z&&"active"},n.tags.label(u({checked:k.find(at=>D(at)==D(W)),name:`${y}-${D(W)}`,onchange:H(W)}),x(W))))),M=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":P,"aria-label":f,onclick:T,color:h,variant:g,size:p,class:I==!0&&"loading",disabled:I},()=>z.val.length?B(z.val):f,()=>I==!0&&U({visibility:I})),X=l({triggerEl:M,contentEl:J(),onClose:E}),tt=i({name:y,multiple:!0,...$},n.tags.option({value:""},"--Category--"),S.map(W=>n.tags.option({value:D(W),selected:k.find(Z=>D(Z)==D(W))},A(W))));return a({...$,class:["multiSelect",h,p,d,e==null?void 0:e.class,$==null?void 0:$.class],onkeydown:R},tt,M,X)}}const ac=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:s,footer:i}=e.tags,r=oc(t),l=N(t,{variant:"outline",color:"neutral"}),c=Pt(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=m=>a(m.group);return()=>s({onsubmit:b=>{b.preventDefault();const{selectedOptions:p}=b.target.elements.myMultiSelect,g=Array.from(p).map(({value:h})=>h);alert(JSON.stringify(g))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,cc={title:"MultiSelect",package:"multiSelect",description:"The multiSelect component allows user to select multiple items from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/multiSelect/multiSelect.js",importStatement:'import multiSelect from "@grucloud/bau-ui/multiSelect";',examples:[{title:"Simple Multi Select",description:"A simple multi select.",code:rc,createComponent:ac},{title:"Native Multi Select",description:"A native multi select.",code:ic,createComponent:sc}]},lc=t=>{const e=F(t);return()=>e(cc)},uc=t=>{const{bau:e}=t,{section:n,div:o,h1:a,p:s}=e.tags,i=N(t,{variant:"outline",color:"success"}),r=zt(t),l=()=>i({onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),c=()=>o({},a("My content"),s("My Content")),u=l(),d=r({id:"my-popover-left",triggerEl:u,contentEl:c()});return()=>n(o(u,d))},dc=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,mc={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:dc,createComponent:uc}]},pc=t=>{const e=F(t);return()=>e(mc)};function bc(t,e={}){const{bau:n,css:o,config:a}=t,{div:s,a:i,span:r,nav:l}=n.tags,c=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`).join(`
`)}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=V(l);return a({...m,type:"radio",class:["radio-button",c,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class]})}}const zn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:s}=n.tags,i=Se(t,e);return r=>s({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},a("off ",i({...r,id:`my-myRadioButton-example-off-${r.color}-${r.variant}`})),a("on ",i({...r,id:`my-myRadioButton-example-on-${r.color}-${r.variant}`,checked:!0})))},kc=t=>{const{bau:e,css:n}=t,{label:o,div:a,form:s,article:i,footer:r,fieldset:l,legend:c}=e.tags,u=Se(t),d=N(t,{variant:"outline",color:"primary"});return()=>{const m=e.state("one"),b=({target:g})=>m.val=g.id,p=g=>{g.preventDefault();const h=Object.fromEntries(new FormData(g.currentTarget));alert(JSON.stringify(h))};return s({class:n`
          & label {
            display: inline-flex;
            align-items: center;
            gap: 0.5rem;
        ...
        `,onsubmit:p},i(l(c("One or two"),o("One",u({id:"one",name:"radio",checked:!0,value:m,oninput:b})),o("Two",u({id:"two",name:"radio",value:m,oninput:b}))),a("Choice: ",m)),r(d({type:"submit"},"Submit")))}},Ec=`import { Context } from "@grucloud/bau-ui/context";
...
`,Mc=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,s=jt(t),i=N(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))}},o(s({name:"myRadio",value:"one",radios:[{value:"one",Label:()=>"One"},{value:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},Ic=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Lc=t=>{const{bau:e,config:n}=t,{form:o,article:a,footer:s,img:i}=e.tags,r=jt(t),l=N(t,{variant:"outline",color:"primary"}),c=()=>i({src:`${n.base}/login/github.svg#Capa_1`,alt:"GitHub",width:28,height:28}),u=()=>i({src:`${n.base}/login/gitlab-logo.svg#Capa_1`,alt:"GitLab",width:28,height:28});return()=>o({onsubmit:m=>{m.preventDefault();const b=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(b))}},a(r({name:"git_provider_type",value:"",radios:[{value:"GitHub",Label:()=>[c(),"GitHub"]},{value:"GitLab",Label:()=>[u(),"GitLab"]}]})),s(l({type:"submit"},"Submit")))},$c=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Rc={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:Ic,createComponent:Mc},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Bc,createComponent:Dc},{title:"Url State Radio Button Group",description:"A radio button group with the state in the URL",code:Oc,createComponent:Nc},{title:"Label with Image",description:"A label with an image.",code:$c,createComponent:Lc},{title:"Label with description",description:"A label with name and description.",code:zc,createComponent:Pc}]},jc=t=>{const e=F(t);return()=>e(Rc)};function $t(t,e={}){const{bau:n,css:o,window:a}=t,{section:s,article:i,div:r}=n.tags,{document:l}=a,{direction:c="horizontal"}=e,u=o`
  ...
  `;function d(...p){let[g,...h]=V(p);return s({...g,class:["resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u]},h)}function m(...p){let[g,...h]=V(p);return i({...g,class:["resizablePanel",g==null?void 0:g.class]},h)}function b(...p){let[g,...h]=V(p),y=0,f=0,x,S,k,A,D;const B=()=>c==="horizontal",O=z=>B()?I(z):$(z),I=z=>{const P=z.clientX-y;D&&(A.style.width=`${D.width+P}px`),k&&(S.style.width=`${k.width-P}px`)},$=z=>{const P=z.clientY-f;D&&(A.style.height=`${D.height+P}px`),k&&(S.style.height=`${k.height-P}px`)},j=()=>{S=null,A=null,k=null,D=null,x.style.cursor=null,x.style["user-select"]="auto",l.removeEventListener("mousemove",O),l.removeEventListener("mouseup",j)},U=z=>{y=z.clientX,f=z.clientY;const{target:P}=z,C=P.closest(".handle");x=P.closest(".resizablePanelGroup"),x.style.cursor=B()?"col-resize":"row-resize",x.style["user-select"]="none",S=C.nextSibling,A=C.previousSibling,A&&(D=A.getBoundingClientRect()),S&&(k=S.getBoundingClientRect()),l.addEventListener("mousemove",O),l.addEventListener("mouseup",j)};return r({...g,class:["handle",c],role:"separator",bauMounted:({element:z})=>{z.addEventListener("mousedown",U)},bauUnmounted:({element:z})=>{z.removeEventListener("mousedown",U)}},h)}return{PanelGroup:d,Panel:m,Handle:b}}const _c=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:s,Panel:i,Handle:r}=$t(t,{class:n`
      display: inline-flex;
    ...
    `}),l=()=>i({class:n`
        ...
        `},a("Resize me")),c=()=>a({class:n`
          ...
          padding: 0.2rem;
          z-index: 1;
        `},"⋮");return()=>o(s(l(),r(c())))},Uc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`,Gc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:s,Panel:i,Handle:r}=$t(t,{class:n`
    ...
    `}),l=()=>i({class:n`
        ...
        `},a("Panel1")),c=()=>i({class:n`
          ...
          width: 100px;
          height: 100px;
        `},a("Panel2"));return()=>o(s(l(),r(),c()))},Fc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`,Hc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:s,Panel:i,Handle:r}=$t(t,{direction:"vertical",class:n`
    ...
    `}),l=()=>i({class:n`
        ...
        `},a("Panel2")),u=()=>a({class:n`
          ...
          z-index: 1;
          line-height: 0.5;
        `},"⋯");return()=>o(s(l(),r(u()),c()))},Vc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`,Jc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:s,Panel:i,Handle:r}=$t(t,{class:n`
    ...
    `}),c=()=>i({class:n`
        ...
        `},a("Main")),d=()=>i({class:n`
          ...
          align-items: center;
          min-height: 2rem;
        `},a("Footer"));return()=>o(s(c(),r(),l.PanelGroup(u(),l.Handle(),d())))},qc=`import resizable from "@grucloud/bau-ui/resizable";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function At(t,e={}){const{bau:n,css:o}=t,{div:a,li:s,select:i,option:r}=n.tags,l=N(t),c=zt(t),u=yt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Xc()}
  `;return function(...b){let[{size:p=e.size??"md",variant:g=e.variant??"outline",color:h=e.color??"neutral",label:y,Option:f,options:x,defaultOption:S,getOptionLabel:k,getOptionValue:A,onSelect:D=()=>{},loading:B,...O},...I]=V(b);const $=pt(t,{variant:g,color:h,size:p}),j=n.state(S?k(S):y),U=n.state(!1),z=n.state(0),P=()=>{H.openDialog(),H.focus(),U.val=!0},C=()=>{H.closeDialog(),U.val=!1},v=()=>{U.val=!1},w=M=>{H.open?C():P(),M.preventDefault()},E=({option:M,index:X})=>tt=>{j.val=k(M),J.value=A(M),J.setCustomValidity(""),z.val=X,C(),D(M),tt.preventDefault()},T=M=>{switch(M.preventDefault(),M.key){case"Escape":C();break;case"ArrowDown":z.val<x.length-1?z.val++:z.val=0;break;case"ArrowUp":z.val<=0?z.val=x.length-1:z.val--;break;case"Enter":H.open?(j.val=k(x[z.val]),J.value=A(r),C()):P();break}},G=()=>u({tabindex:"0",class:[h,g]},x.map((M,X)=>s({class:()=>z.val==X&&"active",onclick:E({option:M,index:X})},f(M)))),R=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":U,"aria-label":y,onclick:w,color:h,variant:g,size:p,class:B==!0&&"loading",disabled:B},()=>!j.val&&y,j,()=>B==!0&&$({visibility:B})),H=c({triggerEl:R,contentEl:G(),onClose:v}),J=i({...O,"aria-label":y},r({value:""},"--Select Category--"),x.map(M=>r({value:A(M)},k(M))));return S?J.value=A(S):J.value=O.value,a({...O,class:["select",h,p,d,e==null?void 0:e.class,O==null?void 0:O.class],onkeydown:T},J,R,H)}}const Rn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:s}=n.tags,i=At(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(c.label),s(c.code));return c=>i({...c,options:r,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},Zc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,l=At(t),c=N(t,{variant:"solid",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(m.label),r(m.code));return()=>o({onsubmit:b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))}},a(l({name:"country",options:u,Option:d,getOptionValue:({code:b})=>b,getOptionLabel:({label:b})=>b,label:"Select a country..."})),s(c({type:"submit"},"Submit")))},Yc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Qc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,l=At(t),c=N(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(b.label),r(b.code));return()=>o({onsubmit:p=>{p.preventDefault();const g=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(g))}},a(l({name:"country",options:d,Option:m,defaultOption:d.find(({code:p})=>p==u),getOptionValue:({code:p})=>p,getOptionLabel:({label:p})=>p,label:"Select a country..."})),s(c({type:"submit"},"Submit")))},tl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,ol=t=>{const{bau:e}=t,{form:n,article:o,footer:a,span:s}=e.tags,i=At(t),r=N(t,{variant:"solid",color:"primary"}),l=["eu-north-1","ap-south-1","eu-west-3","eu-west-2","eu-west-1","ap-northeast-3","ap-northeast-2","ap-northeast-1","sa-east-1","ca-central-1","ap-southeast-1","ap-southeast-2","eu-central-1","us-east-1","us-east-2","us-west-1","us-west-2"],c=u=>s({},u);return()=>n({onsubmit:d=>{d.preventDefault();const m=Object.fromEntries(new FormData(d.currentTarget));alert(JSON.stringify(m))}},o(i({name:"region",options:l,Option:c,label:"Select a region",getOptionValue:d=>d,getOptionLabel:d=>d,required:!0,oninvalid:d=>{d.target.setCustomValidity("Please select an AWS region")}})),a(r({type:"submit"},"Submit")))},al=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,rl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,span:i,div:r}=e.tags,l=N(t,{variant:"outline"}),c=N(t,{variant:"solid",color:"primary"}),u=At(t),d=m=>r({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(m.flag),i(m.name.common));return()=>{const m=e.state([]),b=e.state(!1),p=e.state("");async function g({url:f,transform:x=S=>S}){try{b.val=!0;const S=await fetch(f,{});if(S.ok){const k=await S.json();m.val=x(k)}else p.val=S.statusText}catch(S){p.val=S.message}finally{b.val=!1}}const h=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:f=>f.sort((x,S)=>x.name.common.localeCompare(S.name.common))});return h(),o({onsubmit:f=>{f.preventDefault();const x=Object.fromEntries(new FormData(f.currentTarget));alert(JSON.stringify(x))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:m.val,Option:d,getOptionValue:({name:f})=>f.common,getOptionLabel:({name:f})=>f.common,label:"Country",id:"country",loading:b.val,required:!0}),l({onclick:()=>h()},"Reload")),s(c({type:"submit"},"Submit")))}},sl=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`,il={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Yc,createComponent:Zc},{title:"Default Option",description:"Select with a default option",code:tl,createComponent:Qc},{title:"State in URL",description:"Select with state in URL",code:nl,createComponent:el},{title:"Select AWS region",description:"Select the AWS region",code:al,createComponent:ol},{title:"Loading Indicator",description:"Select with a loading indicator",code:sl,createComponent:rl}],gridItem:Rn},cl=t=>{const e=F(t);return()=>e(il)};function Ce(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,s=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["select-native",u,l,c,s,e==null?void 0:e.class,d==null?void 0:d.class]},m)}}const jn=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=Ce(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},s.map(({label:r,phone:l})=>o({value:l},r)))},ll=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,s=N(t,{variant:"outline",color:"primary"}),i=Ce(t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),r.map(({label:c,phone:u})=>n({value:u},c))),a(s({type:"submit"},"Submit")))},ul=`import { Context } from "@grucloud/bau-ui/context";
...
`,dl=t=>{const{bau:e,window:n}=t,{option:o,form:a,footer:s}=e.tags,i=N(t,{variant:"outline",color:"primary"}),r=Ce(t),l=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c="my-select";return()=>{const u=g=>{g.preventDefault();const h=Object.fromEntries(new FormData(g.currentTarget));alert(JSON.stringify(h))},d=g=>{const h=new URLSearchParams(n.location.search);h.delete(c),h.append(c,g.target.value),n.history.replaceState("","",`?${h.toString()}${n.location.hash}`)},b=new URLSearchParams(n.location.search).get(c),p=l.map(({label:g,code:h})=>o({value:h,selected:h==b},g));return a({onsubmit:u},r({name:c,oninput:d},o({value:""},"--Please choose a phone code--"),p),s(i({type:"submit"},"Submit")))}},ml=`import { Context } from "@grucloud/bau-ui/context";
import selectNative from "@grucloud/bau-ui/selectNative";
import button from "@grucloud/bau-ui/button";
...
`,fl=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,s=Et(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,yl=t=>{const{bau:e,css:n}=t,{section:o,table:a,tbody:s,tr:i,td:r}=e.tags,l=Et(t,{class:n`
      height: 2rem;
      width: 10rem;
...
`,wl=t=>{const{bau:e,css:n}=t,{section:o,header:a,span:s,article:i}=e.tags,r=n`
  ...
  `,l=Et(t,{class:n`
    ...
    `}),c=Et(t);function u({columnsSize:d=4}){return o({class:r},a(new Array(d).fill("").map(()=>l(s("1")))),i(c("")))}return()=>o(u({columnsSize:3}))},Sl=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`)};
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...b]=V(l);return a({...m,type:"range",class:["slider",d,u,c,i,e==null?void 0:e.class,m.class]},...b)}}const _n=t=>{const{bau:e}=t,n=e.state(0),o=s=>{n.val=s==null?void 0:s.target.value},a=Dt(t);return s=>a({"aria-label":"slider",...s,oninput:o})},El=t=>{const{bau:e}=t,{form:n,article:o,label:a,br:s,footer:i}=e.tags,r=Dt(t),l=N(t,{variant:"solid",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(a("Slider with step, min and max",s,r({name:"slider-simple",step:20,min:-100,max:100}))),i(l({type:"submit"},"Submit")))},Tl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Bl=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:s,label:i,datalist:r,br:l,option:c}=e.tags,u=Dt(t),d=N(t,{variant:"solid",color:"primary"});return()=>s({onsubmit:b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))}},o(i({for:"temp"},"Choose a comfortable temperature"),l,u({class:n`
            width: 300px;
            margin: 0;
...
`,Ol=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:s,label:i,datalist:r,br:l,option:c}=e.tags,u=Dt(t),d=N(t,{variant:"solid",color:"primary"});return()=>s({onsubmit:b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))}},o({class:n`
            display: flex;
...
`),Gn=(t,e)=>(n,o)=>{const a=new URLSearchParams(t.window.location.search);return a.delete(e),a.append(e,n),o&&Object.entries(o).map(([s,i])=>(a.delete(s),a.append(s,i))),`?${a.toString()}`};function Fn(t,e={}){const{bau:n,css:o,window:a}=t,{div:s,ul:i,li:r,span:l,section:c}=n.tags,u=o`
    display: flex;
    flex-direction: column;
    & > ul {
      display: flex;
  ...
  `;return function(...m){let[{color:b,variant:p="plain",size:g,stepperDefs:h=[],stepperName:y,activeStepIndex:f=n.state(0),...x},...S]=V(m);const k=n.state(h.map(($,j)=>({...$,index:j}))),A=n.state([]);a.history.pushState=new Proxy(a.history.pushState,{apply:($,j,U)=>{$.apply(j,U);const z=U[2]??"";console.log("stepper pushState ",z),["?","#"].includes(z[0])&&I()}});const D=n.derive(()=>k.val[f.val]),B=$=>{const{Header:j,disabled:U,name:z,index:P}=$;return r({class:()=>[D.val.name==z&&"active",f.val<P&&"not-completed",f.val>P&&"completed",U&&"disabled"]},l({class:"step-number"},P+1),l({class:"step-label"},()=>j($)))},O=$=>h.findIndex(({name:j})=>j==$.name),I=()=>{const j=new URLSearchParams(a.location.search).get(y)??h[0].name,U=Math.max(h.findIndex(({name:z})=>z==j),0);U<f.val&&(console.log("remove last step"),A.val.pop()),A.val.some(({name:z})=>j==z)||(console.log("add new step"),A.val.push(h[U])),f.val=U};return I(),s({bauMounted:({element:$})=>{a.addEventListener("popstate",I)},bauUnmounted:()=>{a.removeEventListener("popstate",I)},class:["stepper",p,g,b,u,e==null?void 0:e.class,x.class]},n.loop(k,i(),B),n.loop(A,c(),$=>s({class:()=>["content",$.name==D.val.name&&"visible"]},$.Content({nextStep:h[O($)+1],previousStep:h[O($)-1]}))))}}const je="my-wizard",Gl=t=>{const{bau:e,window:n}=t,{footer:o,p:a,label:s,section:i,a:r,ul:l,li:c}=e.tags,u=ut(t),d=bt(t),m=Fn(t),b=Gn(t,je),p=N(t,{variant:"outline",color:"primary"}),g=N(t,{variant:"solid",color:"primary"});return()=>{const h=({nextStep:x})=>S=>{S.preventDefault();const{organization:k}=S.target.elements;n.history.pushState("","",b(x.name,{organization:k.value}))},y=x=>{var D;x.preventDefault();const{organization:S}=(D=n.document.forms)==null?void 0:D.formStep1.elements,A=new URLSearchParams(n.location.search).get("choice");alert(`organization ${S.value}, choice:${A}`)};return i(m({stepperDefs:[{name:"step1",Header:()=>"Step 1",Content:({nextStep:x})=>d({onsubmit:h({nextStep:x}),id:"formStep1"},s("Organization",u({autofocus:!0,placeholder:"Organization",name:"organization"})),o(g({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:x,previousStep:S})=>d(l(c(r({href:b(x.name,{choice:"choice1"})},"Choice 1")),c(r({href:b(x.name,{choice:"choice2"})},"Choice 2"))),o(p({href:b(S.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:x})=>d({onsubmit:y},a("My stepper 3 Content"),o(p({href:b(x.name)},"Previous: Step 2"),g({type:"submit"},"Save")))}],stepperName:je}))}},Fl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,_e="stepper-vertical",Hl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:s,label:i,section:r,a:l,ul:c,li:u}=e.tags,d=ut(t),m=bt(t),b=Fn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
    ...
    `}),p=Gn(t,_e),g=N(t,{variant:"outline",color:"primary"}),h=N(t,{variant:"solid",color:"primary"});return()=>{const y=({nextStep:S})=>k=>{k.preventDefault();const{organization:A}=k.target.elements;n.history.pushState("","",p(S.name,{organization:A.value}))},f=S=>{var B;S.preventDefault();const{organization:k}=(B=n.document.forms)==null?void 0:B.formStep1.elements,D=new URLSearchParams(n.location.search).get("choice");alert(`organization ${k.value}, choice:${D}`)};return r(b({stepperDefs:[{name:"step1",Header:()=>"Step 1",Content:({nextStep:S})=>m({onsubmit:y({nextStep:S}),id:"formStep1"},i("Organization",d({autofocus:!0,placeholder:"Organization",name:"organization"})),a(h({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:S,previousStep:k})=>m(c(u(l({href:p(S.name,{choice:"choice1"})},"Choice 1")),u(l({href:p(S.name,{choice:"choice2"})},"Choice 2"))),a(g({href:p(k.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:S})=>m({onsubmit:f},s("My stepper 3 Content"),a(g({href:p(S.name)},"Previous: Step 2"),h({type:"submit"},"Save")))}],stepperName:_e}))}},Vl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`).join(`
`);function Yt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
    cursor: pointer;
    position: relative;
    ...
    ${Wl()}
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["switch",s,u,c,l,e==null?void 0:e.class,d.class],type:"checkbox"},...m)}}const Hn=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:s}=n.tags,i=Yt(t,e);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},s("off ",i({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),s("on ",i({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},Kl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:s,article:i}=e.tags,r=Yt(t,{variant:"outline",color:"primary"}),l=N(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
  ...
  `;return()=>a({onsubmit:d=>{d.preventDefault();const m=Object.fromEntries(new FormData(d.currentTarget));alert(JSON.stringify(m))},class:c},i(s("My shinny switch",r({name:"my-shinny-switch"})),s("Switch with default",r({name:"my-switch--default",defaultChecked:"on"}))),o(l({type:"submit"},"Submit")))},Xl=`import { Context } from "@grucloud/bau-ui/context";
...
`,Zl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:s,article:i}=e.tags,r=Yt(t,{variant:"outline",color:"primary"}),l=N(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
    }
  `;return()=>{const u=e.state("on");return a({onsubmit:b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))},class:c},i(s("My controlled switch",r({name:"my-shinny-switch",onchange:b=>{u.val=b.target.value},checked:u}))),o(l({type:"submit"},"Submit")))}},Yl=`import { Context } from "@grucloud/bau-ui/context";
import createSwitch from "@grucloud/bau-ui/switch";
import button from "@grucloud/bau-ui/button";
...
`,Ql=t=>{const{bau:e,css:n,window:o}=t,{footer:a,form:s,label:i,article:r}=e.tags,l="my-shinny-switch",c=Yt(t,{variant:"outline",color:"primary"}),u=N(t,{variant:"outline",color:"primary"}),d=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
    }
  `;return()=>{const m=new URLSearchParams(o.location.search);return s({onsubmit:g=>{g.preventDefault();const h=Object.fromEntries(new FormData(g.currentTarget));alert(JSON.stringify(h))},class:d},r(i("My switch",c({name:l,onchange:g=>{const h=new URLSearchParams(o.location.search);h.delete(g.target.name),h.append(g.target.name,g.target.checked),o.history.replaceState("","",`?${h.toString()}${o.location.hash}`)},defaultChecked:m.get(l)=="true"}))),a(u({type:"submit"},"Submit")))}},tu=`import { Context } from "@grucloud/bau-ui/context";
import createSwitch from "@grucloud/bau-ui/switch";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function _t(t,e={}){const{bau:n,css:o,window:a}=t,{tabDefs:s}=e,{div:i,ul:r,li:l,a:c}=n.tags,u=o`
    display: flex;
    flex-direction: column;
    & > ul {
      display: flex;
    ...
    ${ou()}
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",tabsKey:h="tabs",...y},...f]=V(m);const x=n.state(s),S=I=>x.val.find($=>$.name==I),k=n.state(s[0]),A=()=>{var j,U;const $=new URLSearchParams(a.location.search).get(h)??s[0].name;if($!=k.val.name){const z=S($);(j=k.val.exit)==null||j.call(),k.val=z,(U=z==null?void 0:z.enter)==null||U.call()}};A(),a.history.pushState=new Proxy(a.history.pushState,{apply:(I,$,j)=>{I.apply($,j);const U=j[2]??"";["?","#"].includes(U[0])&&A()}});const D=I=>{const $=new URLSearchParams(a.location.search);return $.delete(h),$.append(h,I),`?${$.toString()}`},B=I=>{const{Header:$,disabled:j,name:U}=I;return l({class:()=>[k.val.name==U&&"active",j&&"disabled"]},c({href:D(U)},$(I)))},O=i({class:["tabs",p,b,g,u,e==null?void 0:e.class,y.class],bauMounted:({element:I})=>{a.addEventListener("popstate",A)},bauUnmounted:()=>{a.removeEventListener("popstate",A)}},n.loop(x,r(),B),n.bind({deps:[k],render:()=>({Content:I})=>I?I(y):""}));return O.addEventListener("tab.add",I=>{var j;const{tab:$}=I.detail;(j=$.enter)==null||j.call(),x.val.push($)},!1),O.addEventListener("tab.remove",I=>{var j;const $=x.val.findIndex(U=>U.name==I.detail.tabName);$>0&&((j=x.val[$].exit)==null||j.call(),x.val.splice($,1))},!1),O}}const au=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,s=_t(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]});return()=>s({})},ru=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,mu={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:ru,createComponent:au},{title:"Extended Tabs",description:"An extended tabs.",code:iu,createComponent:su},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:lu,createComponent:cu},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:du,createComponent:uu}]},pu=t=>{const e=F(t);return()=>e(mu)};function Ut(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:s}=n.tags;a`
  :root {
...
`;const i=o`
    ...
    width: fit-content;
  `;return function(...l){let[{...c},...u]=V(l);return s({...c,class:["table-container",i,e==null?void 0:e.class,c==null?void 0:c.class]},...u)}}const bu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:s,tr:i,table:r,thead:l,tbody:c,caption:u}=e.tags;function d(h,y,f,x,S){return{name:h,calories:y,fat:f,carbs:x,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],b=({name:h,calories:y})=>i(s(h),s({class:n`
            text-align: right;
          `},y)),p=()=>l(i(a({class:n`
              text-align: left;
      ...
      max-width: 650px;
    `});return()=>o(g(r(u("Basic Table"),p(),c(m.map(b)))))},gu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Nt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const hu=[Nt("Frozen yoghurt",159,6,24,4),Nt("Ice cream sandwich",237,9,37,4.3),Nt("Eclair",262,16,24,6),Nt("Cupcake",305,3.7,67,4.3),Nt("Gingerbread",356,16,49,3.9)],fu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:s,tr:i,table:r,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:g})=>i(s(p),s({class:n`
    ...
    `});return()=>o(b(r(u("Table Dense"),m(),c(hu.map(d)))))},vu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ot(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const yu=[Ot("Frozen yoghurt",159,6,24,4),Ot("Ice cream sandwich",237,9,37,4.3),Ot("Eclair",262,16,24,6),Ot("Cupcake",305,3.7,67,4.3),Ot("Gingerbread",356,16,49,3.9)],xu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:s,tr:i,table:r,thead:l,tbody:c,caption:u}=e.tags,d=({name:p,calories:g})=>i(s(p),s({class:n`
    ...
    `});return()=>o(b(r(u("Table Zebra"),m(),c(yu.map(d)))))},wu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Tu={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Eu,createComponent:ku}]},Au=t=>{const e=F(t);return()=>e(Tu)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=ye(t),i=N(t),r=pt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:p,icon:g,...h})=>i({"aria-label":p,title:p,...h},g),u=({count:p,totalCount:g,page:h,rowsPerPage:y})=>a({class:"pages-numbers"},Number(h-1)*Number(y)+(p>0?1:0),"-",Math.min(h*y,g)," of ",g),d=({count:p,page:g,rowsPerPage:h})=>a({class:"pages-numbers"},(g-1)*h+(p>0?1:0),"-",g*h),m=p=>p<=1,b=(p,g,h)=>p>=Math.ceil(g/h);return function(...g){let[{size:h=e.size??"md",variant:y=e.variant??"outline",color:f=e.color??"neutral",count:x=0,totalCount:S=0,page:k=1,rowsPerPage:A=50,onPageChange:D,isLoading:B=!1,disableFirst:O=()=>m(k),disablePrevious:I=()=>m(k),disableNext:$=()=>b(k,S,A),disableLast:j=()=>b(k,S,A),...U},...z]=V(g);const P=Math.max(0,Math.ceil(S/A)),C=D({page:1}),v=D({page:k-1}),w=D({page:k+1}),E=D({page:P}),T=[{label:"First",icon:"⟪",onclick:C,disabled:O()},{label:"Previous",icon:"⟨",onclick:v,disabled:I()},{label:"Next",icon:"⟩",onclick:w,disabled:$()},{label:"Last",icon:"⟫",onclick:E,disabled:j()}];return a({...U,class:["table-pagination",l,B&&"disabled",e==null?void 0:e.class,U==null?void 0:U.class]},r({class:"spinner",visibility:B,size:"md"}),S>0?u({count:x,totalCount:S,page:k,maxPages:P,rowsPerPage:A}):d({count:x,page:k,maxPages:P,rowsPerPage:A}),s({variant:y,color:f},T.map(G=>c({...G,variant:y,color:f}))))}}const Du=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Bu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:s,table:i,thead:r,tbody:l}=e.tags,c=Du(45),u=({name:p,email:g})=>s(a(p),a(g)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=Jn(t),b=Ut(t,{class:n`
      max-width: 650px;
    `});return()=>{const p=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),h=e.derive(()=>p.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:f})=>x=>{g.val.page=f};return b(i(d(),()=>l(h.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:s,table:i,thead:r,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),b=e.derive(()=>d.val.length),p=e.state(1),g=e.state(10),h=e.derive(()=>d.val),y=O=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(O).toString()}`,f=({page:O})=>I=>{p.val=O,x(y({page:O,per_page:g.val}))};x(y({page:1,per_page:g.val}));async function x(O){try{u.val=!0;const I=await fetch(O,{});if(I.ok){const $=await I.json();d.val=$;return}throw I}catch(I){m.val=I.message}finally{u.val=!1}}const S=({name:O,description:I,stargazers_count:$})=>s(a(O),a(I),a({class:n`
            text-align: right;
          `},$)),k=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),A=Jn(t),D=Ut(t,{class:n`
      min-width: 650px;
    `}),B=({message:O})=>c(O);return()=>D(()=>A({rowsPerPage:g.val,page:p.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:f,disableNext:()=>!1}),i(k(),()=>m.val&&B({message:m.val}),()=>l(h.val.map(S))))},Ou=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:s,h2:i,tr:r}=e.tags,l=Bu(t),c=Nu(t),u=(...d)=>a({class:n`
        ...
        `},...d);return()=>o({id:"pagination"},i(r("Table Pagination")),s("Asynchronous Pagination"),u(c()),s("Simple Pagination"),u(l()))};function gt(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{button:s}=n.tags;a`
    :root {
...
`,Lu=t=>{const{bau:e,window:n}=t,{document:o}=n,{form:a,article:s,footer:i}=e.tags,r="my-toogle-uncontrolled",l=gt(t,{variant:"solid",color:"primary"}),c=N(t,{variant:"outline",color:"primary"});return()=>a({onsubmit:d=>{d.preventDefault();const m=o.getElementsByName(r)[0];alert(m.getAttribute("aria-pressed"))}},s(l({name:r},"Toggle Me")),i(c({type:"submit"},"Submit")))},$u=`import { Context } from "@grucloud/bau-ui/context";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function Qt(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
    display: inline-flex;
    border-radius: var(--global-radius);
    & button:not(:last-child) {
      border-top-right-radius: 0;
    ...
    ${_u()}
  `;return function(...r){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",exclusive:d=!1,onChange:m=()=>{},...b},...p]=V(r);const g=new Set,h=y=>{const{value:f}=y.target;d?(g.clear(),g.add(f)):g.has(f)?g.delete(f):g.add(f),m({event:y,values:[...g]})};return a({...b,class:["toggle-group",l,u,c,s,e==null?void 0:e.class,b==null?void 0:b.class],onclick:h},...p)}}const Wn=(t,e)=>{const{bau:n}=t,o=Qt(t,e),a=gt(t,e);return s=>{const i=n.state([""]),r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...s,onChange:({values:c})=>{i.val=c}},r.map(({label:c,value:u})=>()=>a({...s,value:u,selected:i.val.includes(u),"area-label":c},c)))}},Uu=t=>{const{bau:e}=t,{form:n,footer:o,article:a}=e.tags,s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",r="solid",l=gt(t,{color:i,variant:r}),c=Qt(t,{color:i,variant:r}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{var y;p.preventDefault();const h=(y=p.currentTarget.querySelector("button[selected=true]"))==null?void 0:y.name;alert(h)}},a(c({exclusive:!0,onChange:({values:p})=>{d.val=p}},s.map(({label:p,value:g})=>()=>l({value:g,name:p,selected:d.val.includes(g)},p)))),o(u({type:"submit"},"Submit")))}},Gu=`import { Context } from "@grucloud/bau-ui/context";
...
`,Fu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",r="solid",l=gt(t,{variant:r,color:i}),c=Qt(t,{variant:r,color:i}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{p.preventDefault();const h=[...p.currentTarget.querySelectorAll("button[selected=true]")].map(({name:y})=>y);alert(JSON.stringify(h))}},o(c({onChange:({values:p})=>{d.val=p}},s.map(({label:p,value:g})=>()=>l({value:g,name:p,selected:d.val.includes(g)},p)))),a(u({type:"submit"},"Submit")))}},Hu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,Vu=t=>{const{bau:e,window:n}=t,{form:o,footer:a,article:s}=e.tags,i="my-toggle-group",r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],l="primary",c="solid",u=gt(t,{color:l,variant:c}),d=Qt(t,{color:l,variant:c}),m=N(t,{variant:"outline",color:"primary"});return()=>{const b=new URLSearchParams(n.location.search),p=e.state([...b.getAll(i)]);return o({onsubmit:y=>{y.preventDefault();const f=new URLSearchParams(n.location.search);alert(f.getAll(i))}},s(d({name:i,exclusive:!0,onChange:({values:y})=>{p.val=y;const f=new URLSearchParams(n.location.search);f.delete(i),y.forEach(x=>f.append(i,x)),n.history.replaceState("","",`?${f.toString()}${n.location.hash}`)}},r.map(({label:y,value:f})=>()=>u({value:f,name:y,selected:p.val.includes(f)},y)))),a(m({type:"submit"},"Submit")))}},Ju=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,qu={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Gu,createComponent:Uu},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Hu,createComponent:Fu},{title:"State in URL",description:"A toggleGroup with state in the URL.",code:Ju,createComponent:Vu}],gridItem:Wn},Wu=t=>{const e=F(t);return()=>e(qu)};function ke(t,e={}){const{bau:n,css:o,window:a}=t,{div:s}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
  ...
  `;return function(...l){let[{titleEl:c,side:u="bottom-start",size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",...p},...g]=V(l);const h=s({class:["container",...u.split("-")]},s({class:["content",b,m,d],role:"tooltip"},c)),y=D=>`move-to-${D}`,f=(D,B,O)=>{if(D()){const I=y(B);h.classList.add(I),h.classList.add(B),h.classList.remove(O)}},x=(D,B)=>{const O=y(D);h.classList.contains(O)&&(h.classList.remove(O),h.classList.add(B),h.classList.remove(D))},S=D=>{const B=h.getBoundingClientRect();f(()=>B.x<0,"right","left"),f(()=>B.x+B.width>a.innerWidth,"left","right"),f(()=>B.y<0,"bottom","top"),f(()=>B.bottom>a.innerHeight,"top","bottom"),h.classList.add("visible")},k=D=>{h.classList.remove("visible"),x("right","left"),x("left","right"),x("bottom","top"),x("top","bottom")};return s({...p,class:["tooltip",i,e==null?void 0:e.class,p==null?void 0:p.class],bauMounted:({element:D})=>{D.addEventListener("mouseover",S),D.addEventListener("mouseout",k)},bauUnmounted:({element:D})=>{D.removeEventListener("mouseover",S),D.removeEventListener("mouseout",k)}},...g,h)}}const Kn=(t,e)=>{const{bau:n}=t,{div:o,p:a,em:s}=n.tags,i=N(t),r=ke(t,e),l=()=>o(a("A ",s("tooltip")," can be any component"));return c=>r({titleEl:l(),...c},i(c,`${c.color} ${c.variant}`))},Ku=t=>{const{bau:e}=t,{div:n,p:o,em:a}=e.tags,s=N(t),i=ke(t),r=()=>n(o("A ",a("tooltip")," can be any component"));return()=>i({side:"bottom-start",titleEl:r()},s("tooltip"))},Xu=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Zu=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:s,section:i}=e.tags,r=Pt(t,{variant:"outline",color:"primary"}),l=ke(t),c=()=>o(a("A ",s("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
        `},o({class:n`
          ...
          `},l({side:"left-end",titleEl:c()},r("left end")),l({side:"right-end",titleEl:c()},r("right end"))),o({class:n`
            display: flex;
            justify-content: space-around;
          `},l({side:"bottom-start",titleEl:c()},r("bottom start")),l({side:"bottom-centered",titleEl:c()},r("bottom centered")),l({side:"bottom-end",titleEl:c()},r("bottom end"))));return()=>u()},Yu=`import tooltip from "@grucloud/bau-ui/tooltip";
import chip from "@grucloud/bau-ui/chip";
...
`,od={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:nd,createComponent:ed}],gridItem:Xn},ad=t=>{const e=F(t);return()=>e(od)},Zn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,s={...a};return s.children=o==null?void 0:o.map(Zn({parent:n,grandParent:t})),t&&(t.parent=e),s.parent=t,s},rd=({css:t,createGlobalStyles:e})=>(e`
:root {
...
`,{nav:t`
  ...
  `});function Ee(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{renderMenuItem:s}=e,{ul:i,li:r,nav:l,div:c}=n.tags,u=rd({css:o,createGlobalStyles:a}),d=he(t),m=({depth:b=1,maxDepth:p,parent:g,color:h,variant:y,size:f})=>x=>{const{children:S,expanded:k}=x,A=n.state(!k),D=()=>c({class:o`
              cursor: ${S?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:O=>{S&&(A.val=!A.val)}},s({item:x,parent:g,depth:b})),B=()=>i({class:[h,f]},S.map(m({depth:b+1,maxDepth:p,parent:x})));return r(S.length?d({expanded:k,Header:D,Content:S&&b<p&&B}):D())};return function({tree:p,maxDepth:g=1/0,size:h=e.size??"md",variant:y=e.variant??"outline",color:f=e.color??"neutral",...x}){return l({class:[u.nav,h,y,f,e==null?void 0:e.class,x.class]},i(m({maxDepth:g,color:f,variant:y,size:h})(Zn({})({...p}))))}}const Yn=(t,e)=>{const{bau:n}=t,{a:o,span:a}=n.tags,s={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},r=Ee(t,{renderMenuItem:({item:{data:{name:l,href:c}}})=>c?o({href:c},l):a(l),...e});return l=>r({...l,tree:s})},sd=t=>{const{bau:e}=t,{a:n,span:o}=e.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ee(t,{renderMenuItem:({item:{data:{name:r,href:l}}})=>l?n({href:l},r):o(r)});return()=>i({tree:a})},id=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,cd=t=>{const{bau:e,css:n,window:o}=t,{form:a,label:s,article:i,footer:r}=e.tags,l=wt(t,{color:"neutral",variant:"outline"}),c=N(t,{variant:"solid",color:"danger"}),u=e.state(0),d=S=>{S.preventDefault();const k=Object.fromEntries(new FormData(S.currentTarget));alert(JSON.stringify(k))},m={data:{name:"Resources"},expanded:!0,children:[{data:{name:"EC2"},expanded:!0,children:[{data:{name:"Vpc",id:"EC2::Vpc"}},{data:{name:"Subnet",id:"EC2::Subnet"}}]},{data:{name:"IAM"},children:[{data:{name:"Role",id:"IAM:Role"}}]}]},b=({id:S,name:k})=>S??k,p=S=>o.document.getElementById(b(S)),g=({onNode:S})=>k=>{S(k);const{children:A=[]}=k;A.map(g({onNode:S}))},h=({parent:S})=>{if(S){const{children:k}=S,A=p(S.data);if(A){const D=k.every(B=>{const{checked:O,indeterminate:I}=p(B.data);return!O&&!I});A.indeterminate=!D&&k.some(B=>!p(B.data).checked),A.checked=k.every(B=>p(B.data).checked)}h({parent:S.parent})}},y=({item:S,parent:k})=>A=>{h({parent:k}),g({onNode:O=>{const I=p(O.data);I&&(I.checked=A.target.checked,I.indeterminate=!1)}})(S);const B=A.currentTarget.closest("form").querySelectorAll('input[type="checkbox"][data-type="resources"]:checked');u.val=B.length,A.stopPropagation()},x=Ee(t,{renderMenuItem:({item:S,parent:k})=>{const{name:A,id:D}=S.data,B=b(S.data);return s({class:n`
          display: flex;
          align-items: center;
          padding-right: 1rem;
        `,onclick:O=>O.stopPropagation()},l({onclick:y({item:S,parent:k}),name:B,id:B,"data-type":D?"resources":"group"}),A)}});return()=>a({onsubmit:d},i(x({tree:m})),r(c({type:"submit"},()=>`Delete ${u.val} Resource(s)`)))},ld=`import { Context } from "@grucloud/bau-ui/context";
