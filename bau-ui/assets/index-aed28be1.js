(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const _n=(e,t)=>({...e,paths:[...t,e.path]}),vt=({paths:e=[],routes:t})=>t.flatMap(({children:n,...o})=>{const a=_n(o,e);return n?[a,...vt({paths:[...e,o.path],routes:n})]:a}),Pn=({paths:e})=>{const t=e.map(n=>n instanceof RegExp?n.source:n).map(n=>String.raw`\/${n}`).join("");return new RegExp(`^${t}$`)},On=({routes:e=[],notFoundRoute:t})=>{const n=vt({routes:e}).map(o=>({...o,regex:Pn(o)}));return{resolve:({pathname:o})=>{const a=n.find(({regex:i})=>i.test(o));return a?a.action({match:o.match(a.regex)}):t}}};function Rn({routes:e,notFoundRoute:t,onLocationChange:n}){const o=On({routes:e,notFoundRoute:t});return window.addEventListener("popstate",a=>{a.state!=null&&n({router:o})}),window.history.pushState=new Proxy(window.history.pushState,{apply:(a,i,s)=>{a.apply(i,s),n({router:o})}}),document.addEventListener("click",a=>{const{target:i}=a,s=i.getAttribute("href");i.tagName==="A"&&s&&!s.startsWith("http")&&!s.replace(window.location.pathname,"").startsWith("#")&&(history.pushState({},null,s),window.scrollTo({top:0,left:0}),a.preventDefault())}),n({router:o}),o}const Ve=[["neutral",{h:"0",s:"0%",l:"50%"}],["primary",{h:"230",s:"70%",l:"30%"}],["secondary",{h:"338",s:"70%",l:"50%"}],["success",{h:"120",s:"70%",l:"25%"}],["info",{h:"194",s:"70%",l:"30%"}],["warning",{h:"43",s:"70%",l:"25%"}],["danger",{h:"358",s:"70%",l:"30%"}]],Ln=[["light","1.15"],["lighter","1.3"],["lightest","1.5"]],jn=[["dark","0.9"],["darker","0.7"],["darkest","0.5"]],st=e=>`var(--color-${e})`,zn=e=>`var(--color-${e}-lightest)`,Hn=()=>Ve.map(([e])=>`
.outline.${e} {
...
`).join(`
`),Un=()=>Ve.map(([e])=>[`--color-${e}-s: var(--color-${e}-dark-s);`]).join(`
...
`),Vn=([e,{h:t,s:n,l:o}])=>[`--color-${e}-h: ${t};`,`--color-${e}-l: ${o};`,`--color-${e}-base-s: ${n};`,`--color-${e}-s: var(--color-${e}-base-s);`,`--color-${e}-dark-s: calc(${n} - 25%);`,`--color-${e}-hsl: var(--color-${e}-h), var(--color-${e}-s), var(--color-${e}-l);`,`--color-${e}: hsl(var(--color-${e}-hsl));`,...Ln.map(([a,i])=>`--color-${e}-${a}: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) * ${i}));`),...jn.map(([a,i])=>`--color-${e}-${a}: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) * ${i}));`),`--color-${e}-contrast-background: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) / var(--contrast-background-value)));`,`--color-${e}-contrast-foreground: hsl(var(--color-${e}-h), var(--color-${e}-s), calc(var(--color-${e}-l) * var(--contrast-foreground-value)));`].join(`
`);function Wn({createGlobalStyles:e},{colorPalette:t=Ve}={}){e`
    :root {
      --color-scheme: light;
...
`)}
  ...
  `}function Zn(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let We=e=>Object.prototype.toString.call(e??0).slice(8,-1),Xn=e=>We(e)=="Object",ct=e=>We(e)=="Function",Ue=e=>["Object","Array"].includes(We(e)),lt=Object.getPrototypeOf,Ge=e=>me(e)?e.val:e,me=e=>e==null?void 0:e.__isState,Kn=["splice","push","pop","shift","unshift","sort","reverse"],ke=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const X=e=>!me(e[0])&&Xn(e[0])?e:[{},...e];function Yn(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=v=>n.createElement(v),l=(v,m,b)=>{let w=r;r=m;let E=v(b);return r=w,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(v=>{v.bindings=v.bindings.filter(m=>{var b;return(b=m.element)==null?void 0:b.isConnected}),!v.bindings.length&&!v.computed&&a.delete(v)}),o=void 0}))},p=(v,m,b,w,E,_)=>{var I;if(s){i.add(v);return}for(let W of v.bindings){let{deps:N,element:M,renderInferred:V,render:J,renderItem:Q}=W;if(Q&&m)(I=h(M,w,(...ae)=>x(Q(...ae)),b,E,_)[m])==null||I.call();else{let ae=V?V({element:M}):J({element:M,renderItem:Q})(...N.map(Ge));ae!==M&&M.replaceWith(W.element=x(ae))}}S(v),u()},d=(v,m,b=[])=>({get(w,E,_){var I;if(r==null||r.add(v),E==="_isProxy")return!0;if(!((I=w[E])!=null&&I._isProxy)&&!me(w[E])&&Ue(w[E]))w[E]=new Proxy(w[E],d(v,m,[...b,E]));else if(Kn.includes(E)){let W=w[E];return(...N)=>{let M=W.apply(w,N);return p(v,E,M,N,m,b),M}}return Reflect.get(w,E,_)},set(w,E,_,I){let W=Reflect.set(w,E,_,I);return p(v,"setItem",W,{prop:E,value:_},m,[...b,E]),W}}),g=(v,m)=>new Proxy(m,d(v,m)),h=(v,m,b,w,E,_)=>{let I=()=>v.replaceChildren(...ke(w,b)),W=N=>v[N]&&v.removeChild(v[N]);return{assign:I,sort:I,reverse:I,setItem:()=>{var M;let N=_[0];(M=v.children[N])==null||M.replaceWith(b(E[N],N))},push:()=>v.append(...ke(m,(N,M)=>b(N,E.length+M))),unshift:()=>v.prepend(...ke(m,b)),pop:()=>W("lastChild"),shift:()=>W("firstChild"),splice:()=>{let[N,M,...V]=m;const{length:J}=v.children;for(let Q=N>=0?Math.min(N+M-1,J-1):J-1;Q>=(N>=0?N:J+N);Q--)v.children[Q].remove();if(V.length){let Q=V.forEach((ae,Le)=>b(ae,N+Le));v.children[N]?v.children[N].after(...Q):v.append(...Q)}}}},f=v=>({oldVal:v,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=Ue(v)?g(m,v):v,m.valProxy)},set val(m){let b=this,w=b.val;Ue(m)?(b.valProxy=g(b,m),p(b,"assign",m)):m!==w&&(b.valProxy=m,p(b)),b.oldVal=w}}),x=v=>v==null||v===!1?c("span"):v.nodeType?v:n.createTextNode(v),y=(v,m)=>{let b=new Set;return m.val=l(v,b),b},C=v=>{let m=f(),b=y(v,m);m.computed=!0;for(let w of b)w.listeners.push({computed:v,deps:b,state:m});return m},S=v=>{for(let m of[...v.listeners])y(m.computed,m.state)},B=(v,...m)=>{if(m.length){let b=[];for(let w of m.flat(1/0))w!=null&&b.push(me(w)?j({deps:[w],render:()=>E=>E}):ct(w)?te({renderInferred:w}):x(w));v.append(...b)}},P={},L=(v,m)=>v&&(Object.getOwnPropertyDescriptor(v,m)??L(lt(v),m)),D=(v,m,b)=>{var w;return P[v+","+m]??(P[v+","+m]=((w=L(b,m))==null?void 0:w.set)??0)},O=(v,m)=>new t.MutationObserver((b,w)=>{b.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(_=>_===v&&(m({element:v}),w.disconnect(),!0)))}).observe(v.parentNode,{childList:!0}),$=(v,m)=>new t.MutationObserver((b,w)=>b.forEach(E=>m({record:E,element:v}))).observe(v,{childList:!0}),H=v=>new Proxy(function(b,...w){var W;let[E,..._]=X(w),I=v?n.createElementNS(v,b):c(b);for(let[N,M]of Object.entries(E)){if(N.startsWith("bau"))continue;let V=D(b,N,lt(I))?J=>I[N]=J:J=>I.setAttribute(N,J);M==null||(me(M)?j({deps:[M],render:()=>()=>(V(M.val),I)}):ct(M)&&(!N.startsWith("on")||M.isDerived)?te({renderInferred:()=>(V(M({element:I})),I)}):M.renderProp?j({deps:M.deps,render:()=>()=>(V(M.renderProp({element:I})(...M.deps.map(Ge))),I)}):V(M))}return E.bauChildMutated&&$(I,E.bauChildMutated),B(I,..._),(W=E.bauCreated)==null||W.call(E,{element:I}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:I})),E.bauUnmounted&&t.requestAnimationFrame(()=>O(I,E.bauUnmounted)),I},{get:(m,b)=>m.bind(void 0,b)}),q=(v,m,b)=>{v.element=x(b);for(let w of m)me(w)&&(a.add(w),w.bindings.push(v));return v.element},te=({renderInferred:v,element:m})=>{let b=new Set,w=l(v,b,{element:m});return q({renderInferred:v},b,w)},j=({deps:v,element:m,render:b,renderItem:w})=>q({deps:v,render:b,renderItem:w},v,b({element:m,renderItem:w})(...v.map(Ge))),F=(v,m,b)=>j({deps:[v],render:({renderItem:w})=>E=>(m.append(...ke(E,w)),m),renderItem:b}),U=v=>{s=!0,v(),s=!1,i.forEach(p),i.clear()};return{tags:H(),tagsNS:H,state:f,bind:j,loop:F,derive:C,stateSet:a,batch:U}}const qn=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},Jn=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Qn=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function eo(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=Qn(a,i),r=qn(s);return!t.getElementById(r)&&Jn(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function to(e){const t=Yn(),n=eo();return Wn(n),{bau:t,...n,tr:o=>o,window,...e}}function T(...e){return e.filter(t=>t).join(" ")}function Ie(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:T("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:p})=>{[...u.removedNodes].forEach(d=>{if(!s()||d.getAttribute("cloned"))return;const g=d.cloneNode(!0);g.setAttribute("cloned",!0),g.style.top=0,g.style.left=0,g.style.width=d.getAttribute("width"),g.style.height=d.getAttribute("height"),g.style.position="absolute",g.style.animation=s(),u.target.appendChild(g),g.addEventListener("animationend",()=>g.parentNode.removeChild(g))}),[...u.addedNodes].forEach(d=>{if(d.getAttribute("cloned"))return;p.style.position="relative";const g=d.getBoundingClientRect();if(d.setAttribute("width",g.width+"px"),d.setAttribute("height",g.height+"px"),r()){d.style.animation=r();const h=()=>{d.removeEventListener("animationend",h),d.style.animation=""};d.addEventListener("animationend",h)}})},...c},l)}}function K(e,t){const{bau:n,css:o}=e,a={root:o`
    ...
    `,a:o``,disabled:o`
      ...
      cursor: not-allowed;
      pointer-events: none;
    `};return function(...s){let[{color:r,variant:c,size:l="md",disabled:u,href:p,...d},...g]=X(s);return(p?n.tags.a:n.tags.button)({...d,class:T("button",a.root,c,l,r,p?a.a:a.button,u&&a.disabled,t==null?void 0:t.class,d.class),disabled:u,href:p,...!p&&{type:"button"}},g)}}const oe=["neutral","primary","success","danger","warning"],no=["plain","outline","solid"],oo=["sm","md","lg"],ao="light",ro=()=>oe.map(e=>`
...
`);function Ze(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(ao);const l=o`
  ...
  `;return function(...p){let[{color:d,variant:g="outline",size:h="md",...f},...x]=X(p);return i({required:"required",title:"Switch Theme",...f,class:T("theme-switch",d,g,h,l,t==null?void 0:t.class,f.class),type:"checkbox",checked:r()=="dark",onclick:y=>{s(y.target.checked?"dark":"light")}},...x)}}function so(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:p,b:d,ul:g,li:h}=n.tags,{svg:f,path:x}=n.tagsNS("http://www.w3.org/2000/svg"),y=i.drawerOpen,C=K(e,{class:o`
    ...
    `}),S=Ze(e),B=()=>s(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},x({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),P=()=>l({class:o`
        ...
        `},P(),L())}}function io({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:p}=t.tags,d=({links:f,title:x})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
  ...
  `,hideToRight:e`
   ...
   `});function Xe(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=j=>{var F;return((F=j.parentTree.data)==null?void 0:F.href)??j.parentTree.children[0].data.href},u=({variant:j,color:F,size:U,currentTree:v,data:m})=>S(D({variant:j,color:F,size:U,href:`${c}${l(v)}`,class:o`
    ...
    `}),{hideToLeft:O,hideToRight:$}=co(e),H=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `,q=({variant:j,color:F,size:U,currentTree:v,pathnameState:m})=>{const{children:b,parentTree:w,data:E}=v;return C({class:T("drillDownMenu",j,F,U)},w&&g({variant:j,color:F,size:U,data:E,currentTree:v}),b&&L({class:T(j,F,U)},b.map(_=>x({class:()=>T(_.children&&"has-children",f({pathname:m.val,subTree:_})&&"active")},h({variant:j,color:F,size:U,subTree:_})))))},te=({tree:j,pathname:F})=>{let U=xt({})(structuredClone(j)),v=wt(F)(U);return v||(console.error("drilldown no sub tree",F),v=U),v};return function(F){const{variant:U="plain",color:v="neutral",size:m="md",tree:b,...w}=F,E=n.state(a.location.pathname.replace(c,"")),_=n.derive(()=>te({tree:b,pathname:E.val}));a.document.addEventListener("click",V=>{const{target:J}=V,Q=J.getAttribute("href");if(J.tagName==="A"&&Q&&!Q.startsWith("http")){let ae=Q.replace(c,"");r||(ae=ae.replace(J.hash,"")),E.val=ae}});let I=1;const W=V=>{const{dataset:J}=V.target;J.buttonback=="true"?I=-1:J.ischild=="false"?I=1:J.ischild=="true"&&(I=0)},N=V=>{switch(V){case 1:return`${O} ${Te}`;case-1:return`${$} ${Te}`;default:return""}},M=V=>{switch(V){case 1:return`${$} ${Te} reverse`;case-1:return`${O} ${Te} reverse`;default:return""}};return y({class:T(H,t==null?void 0:t.class,w.class),onclick:W},P({animationHide:()=>N(I),animationShow:()=>M(I)},()=>q({variant:U,color:v,size:m,currentTree:_.val,pathnameState:E})))}}const lo={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function yt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:p,span:d}=n.tags;let g=!1;const h=Xe(e);return function(){return r({bauMounted:({element:x})=>{s.innerWidth<=640&&(g=!0,i.drawerOpen.val=!1)},onclick:x=>{g&&!x.target.dataset.buttonback&&!x.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:T(o`
          ...
          `)},h({tree:lo}))}}const uo=e=>{const{bau:t,css:n,states:o,keyframes:a}=e,{div:i}=t.tags,s=Ie(e),r=so(e),c=yt(e),l=io(e),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...r){let[{size:c="md",variant:l="outline",color:u="neutral",onclick:p,...d},...g]=X(r);return a({...d,onclick:p,class:T("chip",i,c,l,u,p&&"clickable",t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}function po(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;K(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function bo({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,p=({maxSize:d=151})=>({libName:g,size:h})=>r({class:n`
            display: flex;
            margin: 0.3rem;
          `},i({class:n`
              display: flex;
        ...
        `},c({class:n`
          ...
          `},g.map(p({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function go(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=po(e),l=mo(e),u=K(e);$e(e);const p=bo(e),d=(...y)=>a({class:n`
        ...
        `},a({class:n`
          ...
          gap: 2rem;
          justify-content: center;
        `},u({color:"primary",variant:"solid",href:"GettingStarted",size:"lg"},"Getting Started"),u({color:"primary",variant:"outline",href:"components",size:"lg"},"Component Gallery"),u({color:"neutral",variant:"outline",href:"https://github.com/grucloud/bau/tree/main/bau-ui",target:"_blank",size:"lg"},"Source Code"));return function({}){return a({class:g},c({name:"Bau UI",text:"Stylable UI Components",tagLine:"Web UI components, easy to use, stylable, lightweight."}),l({featuresContent:f}),p({data:h}),x())}}function ho(e,t={}){const{bau:n,css:o}=e,{div:a,form:i,span:s,pre:r,h3:c,h4:l}=n.tags;return function(p,...d){return a("Login")}}const fo=e=>{const{tr:t,bau:n}=e,{section:o,div:a,h3:i,h2:s}=n.tags,r=ho(e);return()=>o({id:"login"},s(t("Login Examples")),i("Basic"),a(r()))};function vo(e){const{tr:t,bau:n,css:o}=e,{div:a,article:i,h1:s}=n.tags;return function(){return a({class:o`
          grid-area: main;
          display: flex;
        `},i({class:o`
            grid-area: main;
...
"Click me"
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",...p},...d]=X(r);return a({...p,class:T("paper",u,i,t==null?void 0:t.class,p==null?void 0:p.class)},...d)}}const Lt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:p,name:d}){return o({class:n`
        ...
        `},a(c(s(l(d??""),oe.map(g=>l(g)))),i(no.map(g=>s(l(g),oe.map((h,f)=>r(p({color:h,variant:g},{index:f}))))))))}},wa=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:i}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
        `},oo.map((s,r)=>i({color:"success",variant:"outline",size:s},{index:r})))}},G=e=>{const{bau:t,css:n}=e,{article:o,section:a,h1:i,p:s,h2:r,h3:c,pre:l,code:u}=t.tags;fe.registerLanguage("javascript",Rt);const p=Be(e,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),d=Lt(e),g=wa(e),h=({text:f})=>l({class:n`
          display: inline-block;
...
`,zt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Sa=e=>{const{css:t}=e,n=zt(e),o=_e(e);return()=>o({color:"warning",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              width: fit-content;
...
`,Ta=e=>{const{css:t}=e,n=zt(e),o=_e(e);return()=>o({color:"success",variant:"outline",data:n,class:t`
        &.accordion {
          & ul {
            & li {
              & h3 {
...
`,Ma={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:Ea,createComponent:Ca},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:ka,createComponent:Sa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Aa,createComponent:Ta}],gridItem:jt},Da=e=>{const t=G(e);return()=>t(Ma)},Ia={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},$a=({css:e,createGlobalStyles:t})=>{t`
:root {
...
`).join(`
`);function Pe(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i,i:s}=n.tags;$a({css:o,createGlobalStyles:a});const r=o`
    display: flex;
    max-width: 600px;
    justify-content: flex-start;
    align-items: center;
...
`,Pa=e=>{const{css:t}=e,n=Pe(e,{class:t`
      &.alert {
...
`,Ra={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:_a,createComponent:Ba},{title:"Custom Alert ",description:"A custom alert.",code:Oa,createComponent:Pa}],gridItem:Ht},La=e=>{const t=G(e);return()=>t(Ra)},ja=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
...
`,Ua={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:Ha,createComponent:za}]},Ga=e=>{const t=G(e);return()=>t(Ua)},Fa=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=Ie(e),s=K(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
  `,c=t.state(!0);return()=>o(s({onclick:()=>{c.val=!c.val}},()=>c.val?"Hide":"Show"),i({animationHide:()=>`${r} 0.5s`,animationShow:()=>`${r} 0.5s reverse`},()=>a(c.val?"Ciao":"Mondo")))},Va=`import animate from "@grucloud/bau-ui/animate";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Wa=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a,input:i,label:s}=t.tags,r=Ie(e),c=n`
    to {
      transform: translateX(1rem);
      opacity: 0;
    }
  `,l=t.state("one"),u=({target:d})=>l.val=d.id,p={one:()=>a("ONE"),two:()=>a("TWO")};return()=>o(s("One",i({type:"radio",id:"one",name:"radio",checked:!0,value:l,oninput:u})),s("Two",i({type:"radio",id:"two",name:"radio",value:l,oninput:u})),r({animationHide:()=>`${c} 0.5s`,animationShow:()=>`${c} 0.5s reverse`},()=>p[l.val]()))},Za=`import animate from "@grucloud/bau-ui/animate";
import { Context } from "@grucloud/bau-ui/context";
...
`,Xa={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:Va,createComponent:Fa},{title:"Component hide and show",description:"Hide and show a component",code:Za,createComponent:Wa}]},Ka=e=>{const t=G(e);return()=>t(Xa)};function Ut(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},u=o`
    &.sm {
      width: 20px;
      height: 20px;
    }
  ...
  `;return function(...d){let[{color:g,variant:h="outline",size:f="md",width:x=30,height:y=30,...C},...S]=X(d);return a({class:T(u,t==null?void 0:t.class,C.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:x,height:y,onload:c,onerror:l,class:T(g,h,f,u,t==null?void 0:t.class,C.class),...C}))}}const Gt=e=>{const{css:t}=e,n=Ut(e,{class:t`
    ...
    `});return o=>n({...o,src:"https://www.gravatar.com/avatar/00000000000000000000000000000000?d=robohash&f=y",alt:"my avatar"})},Ya=e=>{const{bau:t,css:n}=e,{section:o}=t.tags,a=Ut(e,{class:n`
      > img {
...
`);function tt(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${er()}
  `;return function(r){const{size:c="md",variant:l="outline",color:u="neutral",name:p,id:d,disabled:g,...h}=r;return a({...h,class:T("input",c,u,l,i,t==null?void 0:t.class,h.class)})}}const tr=()=>oe.map(e=>`
...
`);function Ft(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=et(e),r=K(e),c=tt(e),l=we(e),u=o`
  ...
  `,p=n.state(""),d=n.state(""),g=n.state(!1),h=n.state(0),f=()=>{g.val=!1};return function(...y){let[{variant:C="outline",color:S,size:B="md",id:P,label:L,placeholder:D,Option:O,options:$,getOptionLabel:H=({label:N})=>N,...q},...te]=X(y);const j=n.state($),F=()=>{W.openDialog(),g.val=!0,d.val="",j.val=$},U=()=>{W.closeDialog(),g.val=!1,d.val=""},v=N=>{const{value:M}=N.target;d.val=M,M?j.val=$.filter(V=>H(V).match(new RegExp(`${M}`,"i"))):j.val=$},m=N=>{g.val?U():F()},b=({option:N,index:M})=>V=>{p.val=H(N),h.val=M,U()},w=N=>{switch(console.log("onkeydown",N.key,h.val),N.key){case"Escape":U();break;case"ArrowDown":h.val<j.val.length-1?h.val++:h.val=0;break;case"ArrowUp":h.val<=0?h.val=j.val.length-1:h.val--;break;case"Enter":p.val=H(j.val[h.val]),d.val="",U();break}},E=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":g,"aria-label":L,onclick:m,variant:C,color:S,size:B},()=>!p.val&&L,p),_=c({id:P,value:d,placeholder:D,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":g,oninput:v,onkeydown:w,variant:C,color:S,size:B}),W=s({id:P,triggerEl:E,contentEl:(()=>a({class:T(C,S,B,"content")},_,()=>l({class:T(C,S,B)},j.val.map((N,M)=>i({class:()=>T(h.val==M&&"active"),onclick:b({option:N,index:M})},O(N))))))(),onClose:f});return a({...q,class:T("autocomplete",u,t==null?void 0:t.class,q==null?void 0:q.class)},E,W)}}const Vt=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ft(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},a(c.label),a(c.code));return c=>i({...c,options:s,Option:r,getOptionLabel:({label:l})=>l,label:"Country",placeholder:"Search countries",id:"country"})},nr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=Ft(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,ar={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Default",description:"A simple autocomplete.",code:or,createComponent:nr}],gridItem:Vt},rr=e=>{const t=G(e);return()=>t(ar)};function Wt(e,t){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
    position: relative;
    & span {
      display: block;
      position: absolute;
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",content:p,...d},...g]=X(r);return a({...d,class:T("badge",i,t==null?void 0:t.class,d==null?void 0:d.class)},a({class:T(c,l,u)},p),...g)}}const Zt=e=>{const t=Wt(e);return(n,{index:o})=>t({...n,content:`${o*100}`},"☏")},sr=e=>{const{bau:t}=e,{section:n}=t.tags,o=Wt(e);return()=>n(o({content:"10"},"☏"))},ir=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,pr={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:dr,createComponent:ur}],gridItem:Kt},mr=e=>{const t=G(e);return()=>t(pr)},Yt=e=>{const t=K(e);return n=>t({...n},`${n.variant} ${n.color} ${n.size??""}`)},br=e=>{const{bau:t}=e,{section:n}=t.tags,o=K(e),a=()=>{alert("Click")};return()=>n(o({color:"primary",variant:"outline",onclick:a},"Click me"))},gr=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,hr={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Default",description:"A simple button.",code:gr,createComponent:br}],gridItem:Yt},fr=e=>{const t=G(e);return()=>t(hr)},vr=()=>oe.map(e=>`
&.button-group.${e} {
...
`);function nt(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${vr()}
  `;return function(...r){let[{variant:c="outline",size:l="md",color:u,...p},...d]=X(r);return a({...p,class:T("button-group",c,u,l,i,t==null?void 0:t.class,p==null?void 0:p.class)},...d)}}const qt=e=>{const t=["ONE","TWO","THREE"],n=K(e),o=nt(e);return a=>o({...a},t.map(i=>n(a,i)))},xr=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=K(e),i=nt(e),s="primary",r="solid";return()=>n(i({color:s,variant:r},o.map(c=>a({color:s,variant:r},c))))},wr=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,yr={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:wr,createComponent:xr}],gridItem:qt},Cr=e=>{const t=G(e);return()=>t(yr)};function Jt(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>oe.map(r=>`
...
`,kr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Sr,createComponent:Er}],gridItem:Qt},Tr=e=>{const t=G(e);return()=>t(kr)};function Ar(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    display: inline-block;
    position: relative;
    overflow: hidden;
    & img {
  ...
  `,s=n.state(0);return function(...c){let[{color:l,variant:u="plain",size:p="md",slides:d,Slide:g,Previous:h,Next:f,...x}]=X(c);const y=()=>{s.val<=0?s.val=d.length-1:s.val--},C=()=>{s.val>=d.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},d.map(g));return a({...x,class:T("carousel",p,i,t==null?void 0:t.class,x==null?void 0:x.class)},a({class:T("control","control-previous"),onclick:y},h()),a({class:T("control","control-next"),onclick:C},f()),S)}}const Mr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],Dr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=K(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
    ...
    `}),s=({src:u})=>a({src:u}),r=Ar(e,{class:n`
      width: 200px;
      height: 200px;
      & img {
        width: 200px;
...
`,$r={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:Ir,createComponent:Dr}]},Nr=e=>{const t=G(e);return()=>t($r)},en=e=>{const t=$e(e);return n=>t({...n},`Chip ${n.color} ${n.variant} ${n.size??""}`)},Br=e=>{const{bau:t}=e,{section:n}=t.tags,o=$e(e);return()=>n(o({variant:"outline",color:"primary"},"My Chip"))},_r=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,Pr={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:_r,createComponent:Br}],gridItem:en},Or=e=>{const t=G(e);return()=>t(Pr)};function tn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",...p},...d]=X(r);return a({type:"checkbox",required:"required",...p,class:T(i,c,l,u,t==null?void 0:t.class,p==null?void 0:p.class)})}}const nn=e=>{const{bau:t,css:n}=e,{label:o}=t.tags,a=tn(e);return i=>o({class:n`
          ...
          color: var(--color-content-secondary);
          padding: 0.2rem;
        `},`${i.color} ${i.variant} ${i.size??""}`,a({id:`myCheckbox-gallery-${i.color}-${i.variant}-${i.size}`,name:`myCheckbox-gallery-${i.color}-${i.variant}`,...i}))},Rr=e=>{const{bau:t,css:n}=e,{section:o,label:a}=t.tags,i=tn(e),s=t.state(!1),r=c=>{s.val=!!c.target.checked};return()=>o(a({class:n`
            display: inline-flex;
            font-size: smaller;
            align-items: center;
            justify-content: space-between;
...
`,jr={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:Lr,createComponent:Rr}],gridItem:nn},zr=e=>{const t=G(e);return()=>t(jr)},Hr=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=Qe(e),i=K(e),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},Ur=`import button from "@grucloud/bau-ui/button";
...
`,Gr={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Ur,createComponent:Hr}]},Fr=e=>{const t=G(e);return()=>t(Gr)};function Vr(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u,openState:p,...d},...g]=X(r);return a({class:T(i,t==null?void 0:t.class,d.class)},a({class:()=>T("overlay",p.val&&"overlay-open"),onclick:()=>{p.val=!1}}),a({class:()=>T("content",p.val&&"content-open")},g))}}const Wr=e=>{const{bau:t}=e,{section:n,p:o}=t.tags,a=t.state(!1),i=Vr(e),s=K(e),r=yt(e);return()=>n(o("Click on the button to open and close the drawer."),s({color:"neutral",variant:"outline",onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),i({openState:a},r()))},Zr=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Xr={title:"DrilldownMenu",package:"drawer",description:"The drawer show and hide a menu.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drawer/drawer.js",importStatement:'import drawer from "@grucloud/bau-ui/drawer";',examples:[{title:"Default",description:"A simple drawer.",code:Zr,createComponent:Wr}]},Kr=e=>{const t=G(e);return()=>t(Xr)},on=(e,t)=>{const n={data:{name:"Root Menu",href:"#drilldown-gallery"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},o=Xe(e,t);return a=>o({id:"drilldown-gallery",tree:n,...a})},Yr=e=>{const{bau:t}=e,{section:n}=t.tags,o={data:{name:"Root Menu",href:"#drilldown-example"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},a=Xe(e,{base:"/components/drillDownMenu",hashBased:!0});return()=>n({id:"drilldown-example"},a({tree:o}))},qr=`import drillDownMenu, { type Tree } from "@grucloud/bau-ui/drillDownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Jr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:qr,createComponent:Yr}],gridItem:e=>on(e,{base:"/components/drillDownMenu",hashBased:!0})},Qr=e=>{const t=G(e);return()=>t(Jr)};function an(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(u,...p){const{variant:d="outline",color:g="neutral",size:h="md",Component:f,disabled:x,...y}=u;return a({class:T(c.base,x&&c.disabled,t==null?void 0:t.class,u.class)},s({class:T(d,g,h)},f({disabled:x}),r({type:"file",disabled:x,...y})),i({class:"filename-display"}))}}const rn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),u=an(e),p=g=>{const h=g.target.files[0];h?l.val=h.name:l.val="No file selected"},d=({disabled:g})=>r({class:T(o`
          ...
          `,h&&o`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),l(t("Choose a file to upload")));return()=>r(p({Component:g,name:"file",accept:"text/*",onchange:d}),c("File selected: ",u))},ts=`import classNames from "@grucloud/bau-css/classNames";
...
`,ns={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:ts,createComponent:es}],gridItem:rn},os=e=>{const t=G(e);return()=>t(ns)},sn=e=>{const t=tt(e);return n=>t({name:`myinput-gallery-${n.color}-${n.variant}-${n.size}`,id:`myinput-gallery-${n.color}-${n.variant}-${n.size}`,placeholder:"Enter text",...n})},as=e=>{const{bau:t}=e,{section:n}=t.tags,o=tt(e);return()=>n(o({id:"my-input",name:"my-input",placeholder:"Enter Text"}))},rs=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,ss={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:rs,createComponent:as}],gridItem:sn},is=e=>{const t=G(e);return()=>t(ss)};function cn(e,t){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=()=>oe.map(l=>`
&.${l}{
...
`,us={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:ls,createComponent:cs}],gridItem:ln},ds=e=>{const t=G(e);return()=>t(us)},Me={sm:12,md:16,lg:24},ps=()=>oe.map(e=>`
&.${e} {
...
`).join(`
`))()}
  `;return function(...c){let[{color:l="neutral",variant:u="outline",size:p="md",...d},...g]=X(c);return a({class:T("modal",s,l,u,p,t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}const mn=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:s}=t.tags,r=K(e),c=pn(e),l=()=>o(Array(10).fill("").map((p,d)=>s(d+1,". Some text here"))),u=p=>{const d=c({id:"my-dialog",...p},a("Header"),l(),i(r({variant:"outline",color:p.color,onclick:()=>{d.close()}},"Cancel"),r({variant:"solid",color:p.color,onclick:()=>{d.close()}},"OK")));return d};return p=>{const d=u(p);return n(r({...p,onclick:()=>{d.showModal()}},"OPEN MODAL"),d)}},Ss=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:s}=t.tags,r="neutral",c=K(e),l=pn(e),u=()=>o(Array(10).fill("").map((d,g)=>s(g+1,". Some text here"))),p=l({id:"my-dialog"},a("Header"),u(),i(c({variant:"outline",color:r,onclick:()=>{p.close()}},"Cancel"),c({variant:"solid",color:r,onclick:()=>{p.close()}},"OK")));return()=>n(c({variant:"solid",color:"neutral",onclick:()=>{p.showModal()}},"OPEN MODAL"),p)},ks=`import modal from "@grucloud/bau-ui/modal";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ts={title:"Modal",package:"modal",description:"The modal component is a wrapper around the native dialog element.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/modal/modal.js",importStatement:'import modal from "@grucloud/bau-ui/modal";',examples:[{title:"Default",description:"A simple modal.",code:ks,createComponent:Ss}],gridItem:mn},As=e=>{const t=G(e);return()=>t(Ts)},Ms=e=>{const{bau:t}=e,{section:n,div:o,h1:a,p:i}=t.tags,s=K(e),r=et(e),c=()=>s({variant:"outline",color:"success",onclick:()=>p.open?p.closeDialog():p.openDialog()},"Click"),l=()=>o({},a("My content"),i("My Content")),u=c(),p=r({id:"my-popover-left",triggerEl:u,contentEl:l()});return()=>n(o(u,p))},Ds=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function bn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=K(e),r=et(e),c=we(e),l=o`
    & button {
      &::after {
        content: "\u25BC";
        padding: 0.3rem;
    ...
    ${Rs()}
  `,u=n.state(""),p=n.state(!1),d=n.state(0);return function(...h){let[{color:f="neutral",variant:x="outline",size:y="md",id:C,label:S,Option:B,options:P,getOptionLabel:L=({label:b})=>b,...D},...O]=X(h);const $=()=>{m.openDialog(),m.focus(),p.val=!0},H=()=>{m.closeDialog(),p.val=!1},q=()=>{p.val=!1},te=b=>{p.val?H():$()},j=({option:b,index:w})=>E=>{u.val=L(b),d.val=w,H()},F=b=>{switch(b.preventDefault(),b.key){case"Escape":H();break;case"ArrowDown":d.val<P.length-1?d.val++:d.val=0;break;case"ArrowUp":d.val<=0?d.val=P.length-1:d.val--;break;case"Enter":p.val?(u.val=L(P[d.val]),H()):$();break}},U=()=>c({tabindex:"0",class:T(f,x)},P.map((b,w)=>i({class:()=>T(d.val==w&&"active"),onclick:j({option:b,index:w})},B(b)))),v=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":S,onclick:te,color:f,variant:x,size:y},()=>!u.val&&S,u),m=r({id:C,triggerEl:v,contentEl:U(),onClose:q});return a({...D,class:T("select",f,y,l,t==null?void 0:t.class,D==null?void 0:D.class),onkeydown:F},v,m)}}const gn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=bn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},a(c.label),a(c.code));return c=>i({...c,options:s,Option:r,getOptionLabel:({label:l})=>l,label:"Select a country..."})},Ls=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=bn(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`).join(`
`);function vn(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    position: relative;
    ...
    ${ei()}
  `;return function(...r){let[{color:c="neutral",variant:l="plain",size:u="md",...p},...d]=X(r);return a({...p,class:T("switch",i,c,l,u,t==null?void 0:t.class,p.class),type:"checkbox",required:"required"},...d)}}const xn=e=>{const{bau:t,css:n}=e,{form:o,label:a}=t.tags,i=vn(e);return s=>o({class:n`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},a("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),a("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},ti=e=>{const{bau:t,css:n}=e,{section:o,form:a,label:i}=t.tags,s=vn(e);return()=>o(a(i({class:n`
              display: flex;
              align-items: center;
              gap: 0.5rem;
...
`,oi={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:ni,createComponent:ti}],gridItem:xn},ai=e=>{const t=G(e);return()=>t(oi)},ri=()=>oe.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`,yn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags;return[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]},ui=e=>{const{css:t}=e,n=ye(e,{tabDefs:yn(e)});return()=>n({variant:"outline",color:"neutral",class:t`
...
`,pi=e=>{const{css:t}=e,n=yn(e),o=ye(e,{tabDefs:n});return()=>o({variant:"outline",color:"neutral",class:t`
        & ul {
          justify-content: center;
        }
...
`,{nav:e`
  ...
  `});function kn(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=zi({css:o,createGlobalStyles:a}),p=Qe(e),d=({depth:g=1,maxDepth:h,color:f,variant:x,size:y})=>C=>{const{children:S,expanded:B}=C,P=n.state(!B),L=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:O=>{S&&(P.val=!P.val)}},i(C.data)),D=()=>s({class:T(f,y)},S.map(d({depth:g+1,maxDepth:h})));return r(p({Header:L,Content:S&&g<h&&D}))};return function({tree:h,maxDepth:f=1/0,size:x="md",variant:y="plain",color:C="neutral",...S}){return c({class:T(u.nav,x,y,C,t==null?void 0:t.class,S.class)},h.children&&s(h.children.map(d({maxDepth:f,color:C,variant:y,size:x}))))}}const Tn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=kn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Hi=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=kn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Ui=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,Gi={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:Ui,createComponent:Hi}],gridItem:Tn},Fi=e=>{const t=G(e);return()=>t(Gi)},Vi=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:s,ul:r,li:c}=t.tags,l=Lt(e),u=K(e),p=[{name:"Accordion",Item:jt(e)},{name:"Alert",Item:Ht(e)},{name:"Autocomplete",Item:Vt(e)},{name:"Avatar",Item:Gt(e)},{name:"Badge",Item:Zt(e)},{name:"Breadcrumbs",Item:Kt(e)},{name:"Button",Item:Yt(e)},{name:"Button Group",Item:qt(e)},{name:"Calendar",Item:Qt(e)},{name:"Checkbox",Item:nn(e)},{name:"Chip",Item:en(e)},{name:"DrillDown Menu",Item:on(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:rn(e)},{name:"Input",Item:sn(e)},{name:"Linear Progress",Item:ln(e)},{name:"Loading Button",Item:dn(e)},{name:"Modal",Item:mn(e)},{name:"Select",Item:gn(e)},{name:"Slider",Item:hn(e)},{name:"Spinner",Item:fn(e)},{name:"Switch",Item:xn(e)},{name:"Tabs",Item:wn(e)},{name:"Theme Switch",Item:Sn(e)},{name:"Tooltip",Item:En(e)},{name:"Tree View",Item:Tn(e)}];return()=>o(i("Bau Component Gallery"),s("This page displays the components with various colors and variants."),r({class:n`
            display: inline-flex;
            flex-wrap: wrap;
            gap: 1rem;
            list-style: none;
          ...
          `},p.map(({name:d})=>c(u({color:"primary",variant:"solid",href:`#${d}`,size:"sm"},d)))),p.map(d=>a({id:d.name,class:n`
              ...
              padding: 1rem;
              margin: 1rem;
            `},l(d))))},Wi=({context:e})=>[{path:"",action:t=>({title:"Bau UI",component:go(e)})},{path:"GettingStarted",action:t=>({title:"Getting Started",component:xa(e)})},{path:"components",action:()=>({title:"Component",component:Vi(e)}),children:[{path:"accordion",action:()=>({title:"Accordion",component:Da(e)})},{path:"alert",action:()=>({title:"Alert",component:La(e)})},{path:"alertStack",action:()=>({title:"Alert Stack",component:Ga(e)})},{path:"animate",action:()=>({title:"Animate",component:Ka(e)})},{path:"autocomplete",action:()=>({title:"Autocomplete",component:rr(e)})},{path:"avatar",action:()=>({title:"Avatar",component:Qa(e)})},{path:"badge",action:()=>({title:"Badge",component:lr(e)})},{path:"breadcrumb",action:()=>({title:"Breadcrumb",component:mr(e)})},{path:"button",action:()=>({title:"Button",component:fr(e)})},{path:"buttonGroup",action:()=>({title:"Button Group",component:Cr(e)})},{path:"calendar",action:()=>({title:"Calendar",component:Tr(e)})},{path:"carousel",action:()=>({title:"Carousel",component:Nr(e)})},{path:"chip",action:()=>({title:"Chip",component:Or(e)})},{path:"checkbox",action:()=>({title:"Checkbox",component:zr(e)})},{path:"collapsible",action:()=>({title:"Collapsible",component:Fr(e)})},{path:"drawer",action:()=>({title:"Drawer",component:Kr(e)})},{path:"drillDownMenu",action:()=>({title:"DrillDown Menu",component:Qr(e)})},{path:"fileInput",action:()=>({title:"File Input",component:os(e)})},{path:"input",action:()=>({title:"Input",component:is(e)})},{path:"linearProgress",action:()=>({title:"Linear Progress",component:ds(e)})},{path:"list",action:()=>({title:"List",component:Es(e)})},{path:"loadingButton",action:()=>({title:"Loading Button",component:hs(e)})},{path:"modal",action:()=>({title:"Modal",component:As(e)})},{path:"paper",action:()=>({title:"Paper",component:Os(e)})},{path:"popover",action:()=>({title:"Popover",component:$s(e)})},{path:"select",action:()=>({title:"Select",component:Hs(e)})},{path:"slider",action:()=>({title:"Slider",component:Ks(e)})},{path:"spinner",action:()=>({title:"Spinner",component:Qs(e)})},{path:"switch",action:()=>({title:"Switch",component:ai(e)})},{path:"table",action:()=>({title:"Table",component:ki(e)})},{path:"tablePagination",action:()=>({title:"Table Pagination",component:Di(e)})},{path:"tabs",action:()=>({title:"Tabs",component:gi(e)})},{path:"tooltip",action:()=>({title:"Tooltip",component:Pi(e)})},{path:"themeSwitch",action:()=>({title:"Theme Switch",component:ji(e)})},{path:"treeView",action:()=>({title:"Tree View",component:Fi(e)})}]},{path:"pages",action:t=>({title:"Pages",component:vo(e)})}],Zi=e=>({title:e.tr("Page Not Found"),component:()=>"Not Found"}),Xi=({context:e,LayoutDefault:t,config:{base:n=""}})=>{const{window:o,bau:a,states:i}=e,s=a.state(),r=t({componentState:s});return document.getElementById("app").replaceChildren(r),({router:l})=>{const u=o.location.pathname.replace(n,""),{title:p,component:d,Layout:g=t}=l.resolve({pathname:u});s.val=d,document.title=`${p}`}},Ki=e=>{const{createGlobalStyles:t}=e;t`
    :root {
      --header-height: 3rem;
    }
    html {
  ...
  `};Zn();const An={title:"Bau",base:"/bau/bau-ui"},le=to({config:An}),{bau:Yi}=le;le.states={drawerOpen:Yi.state(!0)};Ki(le);Rn({routes:Wi({context:le}),onLocationChange:Xi({context:le,LayoutDefault:uo(le),config:An}),notFoundRoute:Zi(le)});
