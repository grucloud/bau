...
`)}
  ...
  `}function so(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let et=e=>Object.prototype.toString.call(e??0).slice(8,-1),io=e=>et(e)=="Object",vt=e=>et(e)=="Function",qe=e=>["Object","Array"].includes(et(e)),xt=Object.getPrototypeOf,Ye=e=>be(e)?e.val:e,be=e=>e==null?void 0:e.__isState,co=["splice","push","pop","shift","unshift","sort","reverse"],De=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const K=e=>!be(e[0])&&io(e[0])?e:[{},...e];function lo(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=C=>n.createElement(C),l=(C,g,x)=>{let S=r;r=g;let E=C(x);return r=S,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(C=>{C.bindings=C.bindings.filter(g=>{var x;return(x=g.element)==null?void 0:x.isConnected}),!C.bindings.length&&!C.computed&&a.delete(C)}),o=void 0}))},d=(C,g,x,S,E,R)=>{var $;if(s){i.add(C);return}for(let F of C.bindings){let{deps:_,element:P,renderInferred:Z,render:Q,renderItem:te}=F;if(te&&g)($=f(P,S,(...ae)=>w(te(...ae)),x,E,R)[g])==null||$.call();else{let ae=Z?Z({element:P}):Q({element:P,renderItem:te})(..._.map(Ye));ae!==P&&P.replaceWith(F.element=w(ae))}}y(C),u()},p=(C,g,x=[])=>({get(S,E,R){var $;if(r==null||r.add(C),E==="_isProxy")return!0;if(!(($=S[E])!=null&&$._isProxy)&&!be(S[E])&&qe(S[E]))S[E]=new Proxy(S[E],p(C,g,[...x,E]));else if(co.includes(E)){let F=S[E];return(..._)=>{let P=F.apply(S,_);return d(C,E,P,_,g,x),P}}return Reflect.get(S,E,R)},set(S,E,R,$){let F=Reflect.set(S,E,R,$);return d(C,"setItem",F,{prop:E,value:R},g,[...x,E]),F}}),m=(C,g)=>new Proxy(g,p(C,g)),f=(C,g,x,S,E,R)=>{let $=()=>C.replaceChildren(...De(S,x)),F=_=>C[_]&&C.removeChild(C[_]);return{assign:$,sort:$,reverse:$,setItem:()=>{var P;let _=R[0];(P=C.children[_])==null||P.replaceWith(x(E[_],_))},push:()=>C.append(...De(g,(_,P)=>x(_,E.length+P))),unshift:()=>C.prepend(...De(g,x)),pop:()=>F("lastChild"),shift:()=>F("firstChild"),splice:()=>{let[_,P,...Z]=g;const{length:Q}=C.children;for(let te=_>=0?Math.min(_+P-1,Q-1):Q-1;te>=(_>=0?_:Q+_);te--)C.children[te].remove();if(Z.length){let te=Z.forEach((ae,Ve)=>x(ae,_+Ve));C.children[_]?C.children[_].after(...te):C.append(...te)}}}},h=C=>({oldVal:C,bindings:[],listeners:[],__isState:!0,get val(){let g=this;return r==null||r.add(g),g.valProxy??(g.valProxy=qe(C)?m(g,C):C,g.valProxy)},set val(g){let x=this,S=x.val;qe(g)?(x.valProxy=m(x,g),d(x,"assign",g)):g!==S&&(x.valProxy=g,d(x)),x.oldVal=S}}),w=C=>C==null||C===!1?c("span"):C.nodeType?C:n.createTextNode(C),v=(C,g)=>{let x=new Set;return g.val=l(C,x),x},b=C=>{let g=h(),x=v(C,g);g.computed=!0;for(let S of x)S.listeners.push({computed:C,deps:x,state:g});return g},y=C=>{for(let g of[...C.listeners])v(g.computed,g.state)},k=(C,...g)=>{if(g.length){let x=[];for(let S of g.flat(1/0))S!=null&&x.push(be(S)?j({deps:[S],render:()=>E=>E}):vt(S)?J({renderInferred:S}):w(S));C.append(...x)}},I={},B=(C,g)=>C&&(Object.getOwnPropertyDescriptor(C,g)??B(xt(C),g)),M=(C,g,x)=>{var S;return I[C+","+g]??(I[C+","+g]=((S=B(x,g))==null?void 0:S.set)??0)},D=(C,g)=>new t.MutationObserver((x,S)=>{x.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(R=>R===C&&(g({element:C}),S.disconnect(),!0)))}).observe(C.parentNode,{childList:!0}),A=(C,g)=>new t.MutationObserver((x,S)=>x.forEach(E=>g({record:E,element:C}))).observe(C,{childList:!0}),L=C=>new Proxy(function(x,...S){var F;let[E,...R]=K(S),$=C?n.createElementNS(C,x):c(x);for(let[_,P]of Object.entries(E)){if(_.startsWith("bau"))continue;let Z=M(x,_,xt($))?Q=>$[_]=Q:Q=>$.setAttribute(_,Q);P==null||(be(P)?j({deps:[P],render:()=>()=>(Z(P.val),$)}):vt(P)&&(!_.startsWith("on")||P.isDerived)?J({renderInferred:()=>(Z(P({element:$})),$)}):P.renderProp?j({deps:P.deps,render:()=>()=>(Z(P.renderProp({element:$})(...P.deps.map(Ye))),$)}):Z(P))}return E.bauChildMutated&&A($,E.bauChildMutated),k($,...R),(F=E.bauCreated)==null||F.call(E,{element:$}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:$})),E.bauUnmounted&&t.requestAnimationFrame(()=>D($,E.bauUnmounted)),$},{get:(g,x)=>g.bind(void 0,x)}),V=(C,g,x)=>{C.element=w(x);for(let S of g)be(S)&&(a.add(S),S.bindings.push(C));return C.element},J=({renderInferred:C,element:g})=>{let x=new Set,S=l(C,x,{element:g});return V({renderInferred:C},x,S)},j=({deps:C,element:g,render:x,renderItem:S})=>V({deps:C,render:x,renderItem:S},C,x({element:g,renderItem:S})(...C.map(Ye))),W=(C,g,x)=>j({deps:[C],render:({renderItem:S})=>E=>(g.append(...De(E,S)),g),renderItem:x}),U=C=>{s=!0,C(),s=!1,i.forEach(d),i.clear()};return{tags:L(),tagsNS:L,state:h,bind:j,loop:W,derive:b,stateSet:a,batch:U}}const uo=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},po=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},mo=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function go(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=mo(a,i),r=uo(s);return!t.getElementById(r)&&po(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function bo(e){const t=lo(),n=go();return ro(n),{bau:t,...n,tr:o=>o,window,...e}}function N(...e){return e.filter(t=>t).join(" ")}function Pe(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:N("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:d})=>{[...u.removedNodes].forEach(p=>{if(!s()||p.getAttribute("cloned"))return;const m=p.cloneNode(!0);m.setAttribute("cloned",!0),m.style.top=0,m.style.left=0,m.style.width=p.getAttribute("width"),m.style.height=p.getAttribute("height"),m.style.position="absolute",m.style.animation=s(),u.target.appendChild(m),m.addEventListener("animationend",()=>{var f;return(f=m.parentNode)==null?void 0:f.removeChild(m)})}),[...u.addedNodes].forEach(p=>{if(p.getAttribute("cloned"))return;d.style.position="relative";const m=p.getBoundingClientRect();if(p.setAttribute("width",m.width+"px"),p.setAttribute("height",m.height+"px"),r()){p.style.animation=r();const f=()=>{p.removeEventListener("animationend",f),p.style.animation=""};p.addEventListener("animationend",f)}})},...c},l)}}function X(e,t){const{bau:n,css:o}=e,a=o`
    color: inherit;
    display: inline-flex;
    align-items: center;
  ...
  `;return function(...s){let[{color:r,variant:c,size:l="md",href:u,...d},...p]=K(s);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:N("button",c,l,r,a,t==null?void 0:t.class,d.class),href:u},p)}}const ee=["neutral","primary","success","danger","warning"],ho=["plain","outline","solid"],fo=["sm","md","lg"],vo="light",xo=()=>ee.map(e=>`
...
`);function tt(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(vo);const l=o`
    ...
    ${xo()}
  `;return function(...d){let[{color:p,variant:m="outline",size:f="md",...h},...w]=K(d);return i({required:"required",title:"Switch Theme",...h,class:N("theme-switch",p,m,f,l,t==null?void 0:t.class,h.class),type:"checkbox",checked:r()=="dark",onclick:v=>{s(v.target.checked?"dark":"light")}},...w)}}function wo(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:m,li:f}=n.tags,{svg:h,path:w}=n.tagsNS("http://www.w3.org/2000/svg"),v=i.drawerOpen,b=X(e,{class:o`
      background: transparent;
    `}),y=tt(e),k=()=>s(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},w({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),I=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
        ...
        `},I(),B())}}function yo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:d}=t.tags,p=({links:h,title:w})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
  ...
  `;return function(...r){let[{color:c="neutral",variant:l="plain",size:u,...d},...p]=K(r);return a({...d,class:N("list",i,c,l,u,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const Ne="0.3s",Dt=({parent:e,grandParent:t})=>n=>{const{children:o,...a}=n,i=structuredClone(a);return i.children=o==null?void 0:o.map(Dt({parent:n,grandParent:e})),e&&(e.parentTree=t),i.parentTree=e,i},Nt=e=>t=>{var n;if(!e)return t;if(((n=t==null?void 0:t.data)==null?void 0:n.href)==e)return t.children?t:t.parentTree;if(t.children)for(let o=0;o<t.children.length;o++){const a=Nt(e)(t.children[o]);if(a)return a}},Co=({keyframes:e})=>({hideToLeft:e`
  from {
  ...
  `,hideToRight:e`
   ...
   `});function nt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=j=>{var W;return((W=j.parentTree.data)==null?void 0:W.href)??j.parentTree.children[0].data.href},u=({variant:j,color:W,size:U,currentTree:C,data:g})=>y(M({variant:j,color:W,size:U,href:`${c}${l(C)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),M({variant:j,color:W,size:U,href:`${c}${g.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},g.name)),d=({size:j,subTree:{data:{name:W,href:U},children:C=[]}})=>M({size:j,href:`${c}${U}`,"data-ischild":!C.length},W),p=({pathname:j,subTree:W})=>{var U;return j===((U=W==null?void 0:W.data)==null?void 0:U.href)},{renderHeader:m=u,renderMenuItem:f=d,isActive:h=p}=t,{li:w,nav:v,div:b,header:y,a:k}=n.tags,I=Pe(e),B=fe(e),M=X(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:D,hideToRight:A}=Co(e),L=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
  ...
  `;return function(...r){let[{size:c="md",variant:l="outline",color:u="neutral",onclick:d,...p},...m]=K(r);return a({...p,onclick:d,class:N("chip",c,l,u,d&&"clickable",i,t==null?void 0:t.class,p==null?void 0:p.class)},...m)}}function ko(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;X(e);const c=n`
...
"Click me"
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",...d},...p]=K(r);return a({...d,class:N("paper",u,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}function Xt(e,t={}){const{bau:n,css:o,window:a}=e,{nav:i,ul:s,li:r,a:c}=n.tags,{headerSelector:l="h2,h3"}=t,u=n.state("no"),d=(w,v)=>{let b=null;return(...y)=>{a.clearTimeout(b),b=a.setTimeout(()=>w(...y),v)}},p=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,m=({value:w,id:v,children:b=[]})=>{const y=c({class:()=>u.val==v?"active":"",href:`#${v}`});return y.innerHTML=w,r({class:()=>u.val==v?"active":""},y,b.length>0&&s(b.map(m)))},f=w=>w.tagName.charAt(1),h=({contentEl:w})=>{const v=w.querySelectorAll(l);let b=2,y={},k={children:[]},I=k;const B=I;let M=[I];return[...v].forEach(D=>{const A=f(D);D.setAttribute("id",D.textContent),!D.innerHTML.includes("<button")&&(y={value:D.innerHTML,id:D.id??D.textContent,children:[]},b==A?(k=y,I.children.push(k)):b<A?(M.push(I),I=k,k.children.push(y),k=y):b>A&&(I=M[A-1],M=M.slice(0,A-1),I.children.push(y),k=y),b=A)}),B};return function(...v){let[{color:b,variant:y,size:k="md",contentEl:I,...B}]=K(v);const M=h({contentEl:I}),D=d(()=>{const L=[...I.querySelectorAll(l)].find(V=>{const{top:J,height:j}=V.getBoundingClientRect();if(J+j>60)return!0});L&&(u.val=L==null?void 0:L.id)},100);return i({...B,class:N("tableOfContent",k,y,b,p,t==null?void 0:t.class,B==null?void 0:B.class),bauMounted:()=>{a.addEventListener("scroll",D)},bauUnmounted:()=>{a.removeEventListener("scroll",D)}},M.children&&s(M.children.map(m)))}}const Zt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
    ...
    `}),f=Zt(e),h=$a(e),w=({text:v})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:b})=>{b.innerHTML=we.highlight(v,{language:"js"}).value}}));return function(b){const y=a({class:n`
          grid-area: content;
          overflow-x: scroll;
  ...
  `,s=({element:l,closeState:u})=>{l.scrollHeight!=0&&(u.val?r(l):c(l))};function r(l){l.style.height=l.scrollHeight+"px";const u=()=>{l.removeEventListener("transitionend",u)};l.addEventListener("transitionend",u),window.requestAnimationFrame(()=>{l.style.height="0px"})}function c(l){const u=()=>{l.removeEventListener("transitionend",u),l.style.height=null};l.addEventListener("transitionend",u),l.style.height=l.scrollHeight+"px"}return function(...u){let[{color:d,variant:p="plain",size:m="md",Header:f,Content:h,close:w=!0,...v}]=K(u);const b=n.state(w);return a({...v,class:N("collapsible",m,i,t==null?void 0:t.class,v==null?void 0:v.class)},a({class:()=>N("header",h?b.val?"close":"open":""),onclick:y=>{b.val=!b.val,y.stopPropagation()}},f()),a({class:"content",role:"region",bauMounted:({element:y})=>{b.val&&(y.style.height="0px")},"aria-expanded":({element:y})=>(s({element:y,closeState:b}),!b.val)},h&&h()))}}const Pa=()=>ee.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`);function Le(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${Pa()}
  `;return function(...d){let[{color:p,variant:m="outline",size:f="md",data:h=[],...w}]=K(d);const v=n.state(""),b=it(e),y=I=>B=>{v.val==I?v.val="":v.val=I},k=I=>{const{Header:B,Content:M,name:D}=I,A=()=>r({class:()=>N(v.val==D&&"active")},c({type:"button","aria-controls":`bau-${D}`,"aria-expanded":({element:V})=>v.val==D},B(I))),L=()=>a({id:`bau-${D}`,"data-state":({element:V})=>v.val==D},M(I));return s({class:N(p,m,f),onclick:y(D)},b({Header:A,Content:L}))};return a({class:N("accordion",l,t==null?void 0:t.class,w.class)},i(h.map(k)))}}const qt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Le(e);return s=>i({...s,data:a})},Oa=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Le(e);return()=>i({data:a,color:"neutral",variant:"outline"})},_a=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,qa={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ka,createComponent:Va},{title:"Custom Alert ",description:"A custom alert.",code:Za,createComponent:Xa}],gridItem:Jt},Ya=e=>{const t=H(e);return()=>t(qa)},Ja=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},d=({id:p,status:m})=>{const f=c.val.findIndex(h=>h.id===p);f!=-1&&(c.val[f].status=m)};return function(m={},...f){const h=({id:b})=>{d({id:b,status:"removing"});const y=c.val.findIndex(k=>k.id===b);y!=-1&&c.val.splice(y,1)},w=({Component:b})=>{const y={id:Math.random().toString(10).split(".")[1],Component:b,status:"inserting"};c.val.length>=i&&h({id:c.val[0].id}),c.val.push(y),setTimeout(()=>h(y),s)},v=b=>r({class:u.item,onclick:()=>h(b)},b.Component());return document.addEventListener("alert.add",b=>w(b.detail)),document.addEventListener("alert.remove",b=>h(b.detail)),r({class:N(u.stack,t==null?void 0:t.class,m.class)},n.loop(c,r(),v))}},Qa=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Ja(e,{deleteAfterDuration:2e4}),i=X(e),s=je(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},er=`import { Context } from "@grucloud/bau-ui/context";
...
`,ir={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:ar,createComponent:or},{title:"Component hide and show",description:"Hide and show a component",code:sr,createComponent:rr}]},cr=e=>{const t=H(e);return()=>t(ir)};function Qt(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{color:m,variant:f="outline",size:h="md",width:w=30,height:v=30,...b},...y]=K(p);return a({class:N(u,t==null?void 0:t.class,b.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:w,height:v,onload:c,onerror:l,class:N(m,f,h,u,t==null?void 0:t.class,b.class),...b}))}}const en=e=>{const{css:t}=e,n=Qt(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`,dr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:ur,createComponent:lr}],gridItem:en},pr=e=>{const t=H(e);return()=>t(dr)};function ct(e,t){const{bau:n,css:o,window:a}=e,{dialog:i}=n.tags,s=Re(e,{class:o`
    ...
    opacity: 0;
  `;return function(...l){let[{contentEl:u,triggerEl:d,onClose:p,...m},...f]=K(l);const h=b=>{v.style.opacity=1,v.showModal();const y=d.getBoundingClientRect(),k=v.getBoundingClientRect();y.x<a.innerWidth/2?v.style.left=y.left+"px":v.style.left=y.right-k.width+"px",y.y<a.innerHeight/2?v.style.top=y.top+y.height+"px":(v.style.top=Math.max(0,y.top-k.height)+"px",k.height>y.top&&(v.style.height=y.top+"px"))},w=b=>{const y=()=>{v.close(),v.removeEventListener("transitionend",y)};v.addEventListener("transitionend",y),v.style.opacity=0},v=i({role:"presentation",class:N("popover",r,t==null?void 0:t.class,m==null?void 0:m.class),onclick:b=>b.target===v&&(w(),p==null?void 0:p.call())},s(u));return v.closeDialog=w,v.openDialog=h,v}}const mr=()=>ee.map(e=>`
&.input.${e} {
...
`);function Se(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${mr()}
  `;return function(r){const{size:c="md",variant:l="outline",color:u="neutral",disabled:d,...p}=r;return a({type:"text",...p,disabled:d,class:N("input",c,u,l,i,d&&"disabled",t==null?void 0:t.class,p.class)})}}const gr=()=>ee.map(e=>`
...
`);function tn(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=ct(e),r=X(e),c=Se(e),l=fe(e),u=o`
    ...
    ${gr()}
  `;return function(...p){let[{variant:m="outline",color:f,size:h="md",id:w,label:v,placeholder:b,Option:y,options:k,getOptionLabel:I=({label:_})=>_,...B},...M]=K(p);const D=n.state(""),A=n.state(""),L=n.state(!1),V=n.state(0),J=()=>{L.val=!1},j=n.state(k),W=()=>{F.openDialog(),L.val=!0,A.val="",j.val=k},U=()=>{F.closeDialog(),L.val=!1,A.val=""},C=_=>{const{value:P}=_.target;A.val=P,P?j.val=k.filter(Z=>I(Z).match(new RegExp(`${P}`,"i"))):j.val=k},g=_=>{L.val?U():W()},x=({option:_,index:P})=>Z=>{D.val=I(_),V.val=P,U()},S=_=>{switch(console.log("onkeydown",_.key,V.val),_.key){case"Escape":U();break;case"ArrowDown":V.val<j.val.length-1?V.val++:V.val=0;break;case"ArrowUp":V.val<=0?V.val=j.val.length-1:V.val--;break;case"Enter":D.val=I(j.val[V.val]),A.val="",U();break}},E=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":L,"aria-label":v,onclick:g,variant:m,color:f,size:h},()=>!D.val&&v,D),R=c({id:w,value:A,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":L,oninput:C,onkeydown:S,variant:m,color:f,size:h}),F=s({id:w,triggerEl:E,contentEl:(()=>a({class:N(m,f,h,"content")},R,()=>l({class:N(m,f,h)},j.val.map((_,P)=>i({class:()=>N(V.val==P&&"active"),onclick:x({option:_,index:P})},y(_))))))(),onClose:J});return a({...B,class:N("autocomplete",u,t==null?void 0:t.class,B==null?void 0:B.class)},E,F)}}const nn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=tn(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,yr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:wr,createComponent:xr}],gridItem:an},Cr=e=>{const t=H(e);return()=>t(yr)};function rn(e,t){const{bau:n,css:o}=e,{ul:a,li:i,span:s}=n.tags,r=X(e),c=o`
  ...
  `;return function(...u){let[{color:d="neutral",variant:p="plain",size:m="md",items:f,...h},...w]=K(u);return a({...h,class:N(c,t==null?void 0:t.class,h==null?void 0:h.class)},f.map(({href:v,name:b})=>i((v?r:s)({href:v,color:d,variant:p,size:m,class:N(d,p,m)},b))))}}const sn=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=rn(e);return o=>n({...o,...t})},Sr=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=rn(e);return()=>n(a(o))},Er=`import breadcrumbs, {
...
`,zr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:jr,createComponent:Lr}],gridItem:dn},Hr=e=>{const t=H(e);return()=>t(zr)};function Gr(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{color:l,variant:u="plain",size:d="md",slides:p,Slide:m,Previous:f,Next:h,...w}]=K(c);const v=()=>{s.val<=0?s.val=p.length-1:s.val--},b=()=>{s.val>=p.length-1?s.val=0:s.val++},y=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(m));return a({...w,class:N("carousel",d,i,t==null?void 0:t.class,w==null?void 0:w.class)},a({class:N("control","control-previous"),onclick:v},f()),a({class:N("control","control-next"),onclick:b},h()),y)}}const Ur=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],Fr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=X(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,qr={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:Zr,createComponent:Xr}],gridItem:pn},Yr=e=>{const t=H(e);return()=>t(qr)};function mn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",...d},...p]=K(r);return a({type:"checkbox",required:"required",...d,class:N(i,c,l,u,t==null?void 0:t.class,d==null?void 0:d.class)})}}const gn=e=>{const{bau:t,css:n}=e,{label:o}=t.tags,a=mn(e);return i=>o({class:n`
          display: flex;
...
`,ms={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:ps,createComponent:ds}],gridItem:e=>bn(e,{base:"/components/drillDownMenu",hashBased:!0})},gs=e=>{const t=H(e);return()=>t(ms)};function ut(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(u,...d){const{variant:p="outline",color:m="neutral",size:f="md",Component:h,disabled:w,...v}=u;return a({class:N(c.base,w&&c.disabled,t==null?void 0:t.class,u.class)},s({class:N(p,m,f)},h({disabled:w}),r({type:"file",disabled:w,...v})),i({class:"filename-display"}))}}const hn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),u=ut(e),d=m=>{const f=m.target.files[0];f?l.val=f.name:l.val="No file selected"},p=({disabled:m})=>r({class:N(o`
            display: flex;
            align-items: center;
            flex-direction: column;
...
100% {
  ...
  `;return function({size:u="md",color:d="primary",variant:p="outline",visibility:m=!0,...f}={}){const h=o`
      visibility: hidden;
      opacity: 0;
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...c){let[{color:l="neutral",variant:u="plain",size:d="md",...p}]=K(c);return a({...p,type:"radio",class:N("radio-button",d,l,u,s,t==null?void 0:t.class,p==null?void 0:p.class)})}}const En=e=>{const{bau:t,css:n}=e,{label:o,form:a}=t.tags,i=Sn(e);return s=>a({class:n`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`);function He(e,t){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=X(e),l=ct(e),u=fe(e),d=o`
    ...
    ${ii()}
  `;return function(...m){let[{color:f="neutral",variant:h="outline",size:w="md",label:v,Option:b,options:y,getOptionLabel:k=({label:E})=>E,...I},...B]=K(m);const M=n.state(""),D=n.state(!1),A=n.state(0),L=()=>{x.openDialog(),x.focus(),D.val=!0},V=()=>{x.closeDialog(),D.val=!1},J=()=>{D.val=!1},j=E=>{D.val?V():L(),E.preventDefault()},W=({option:E,index:R})=>$=>{M.val=k(E),S.value=M.val,S.setCustomValidity(""),A.val=R,V(),$.preventDefault()},U=E=>{switch(E.preventDefault(),E.key){case"Escape":V();break;case"ArrowDown":A.val<y.length-1?A.val++:A.val=0;break;case"ArrowUp":A.val<=0?A.val=y.length-1:A.val--;break;case"Enter":D.val?(M.val=k(y[A.val]),V()):L();break}},C=()=>u({tabindex:"0",class:N(f,h)},y.map((E,R)=>i({class:()=>N(A.val==R&&"active"),onclick:W({option:E,index:R})},b(E)))),g=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":D,"aria-label":v,onclick:j,color:f,variant:h,size:w},()=>!M.val&&v,M),x=l({triggerEl:g,contentEl:C(),onClose:J}),S=s(I,r({value:""},"--Select Category--"),y.map(E=>r(k(E))));return a({...I,class:N("select",f,w,d,t==null?void 0:t.class,I==null?void 0:I.class),onkeydown:U},S,g,x)}}const kn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=He(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function In(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,span:r}=n.tags,c=o`
    ...
    ${Ti()}
  `;return function(...u){let[{color:d,variant:p="plain",size:m,stepperDefs:f=[],activeStepIndex:h,...w},...v]=K(u);const b=n.state(f.map((B,M)=>({...B,index:M}))),y=n.derive(()=>b.val[h.val]),k=B=>{const{Header:M,disabled:D,name:A,index:L}=B;return s({class:()=>N(y.val.name==A&&"active",h.val<L&&"not-completed",h.val>L&&"completed",D&&"disabled")},r({class:"step-number"},L+1),r({class:"step-label"},()=>M(B)))};return a({class:N("stepper",p,m,d,c,t==null?void 0:t.class,w.class)},n.loop(b,i(),k),n.bind({deps:[y],render:()=>B=>B.Content?B.Content({}):""}))}}const Ai=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=In(e),r=X(e),c=({name:f})=>f,l=[{name:"Step 1",Header:c,Content:()=>a(i("My stepper 1 Content"))},{name:"Step 2",Header:c,Content:()=>a(i("My stepper 2 Content"))},{name:"Step 3",Header:c,Content:()=>a(i("My stepper 3 Content"))}],u=t.state(0),d=()=>{u.val>0&&u.val--},p=()=>{l.length>u.val+1&&u.val++},m=()=>a({class:n`
          display: flex;
          justify-content: space-around;
...
`,Di=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=X(e);return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
            display: flex;
            flex-direction: column;
            gap: 1rem;
          `},l({onclick:d("AWS"),variant:"outline",color:"primary"},r({width:118,height:90,viewBox:"0 0 118 70",fill:"currentColor"},c({href:`${o.base}/aws.svg#aws`}))),l({onclick:d("Azure"),variant:"outline",color:"primary"},r({width:261,height:90,viewBox:"0 0 261 75",fill:"currentColor"},c({href:`${o.base}/azure.svg#azure`}))),l({onclick:d("Google"),variant:"outline",color:"primary"},r({width:473,height:90,viewBox:"0 0 473 75",fill:"currentColor"},c({href:`${o.base}/gcp.svg#gcp`})))))}};function Ue(e,t){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    gap: 1rem;
    padding: 1rem;
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",content:d,...p},...m]=K(r);return a({...p,class:N("form",c,l,u,i,t==null?void 0:t.class,p==null?void 0:p.class)},...m)}}const Fe=e=>{const{bau:t,css:n}=e,{footer:o}=t.tags;return function(...i){return o({class:n`
          display: flex;
          gap: 1rem;
    ...
    `;return y({name:"form-config-azure",onsubmit:M,"data-infra-create":!0,class:D},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",m("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",b({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",pattern:String.raw`\w{32,32}`,title:"Length should be 32 characters.",required:!0}))),u(d("Tenant Id"),s("Retrieve the ",m("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",b({"data-input-azure-tenant-id":!0,autofocus:!0,placeholder:"Tenant Id",name:"tenantId",pattern:String.raw`\w{36,36}`,title:"Length should be 36 characters.",required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",m("APP_ID")," and ",m("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),f({class:n`
                  display: flex;
                  gap: 1rem;
                `},r("App Id",b({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",pattern:String.raw`\w{36,36}`,title:"Length should be 36 characters.",required:!0})),r("Password",b({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",pattern:String.raw`\w{8,64}`,title:"Length should be greater than 8 and below 64",required:!0})))))),v(w({onclick:I}),h({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},Ri=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:m,a:f,table:h,tbody:w,th:v,tr:b,td:y}=t.tags,{svg:k,use:I}=t.tagsNS("http://www.w3.org/2000/svg"),B=ut(e),M=X(e),D=Ue(e),A=We(e),L=Fe(e);return function({onclickPrevious:J,onclickNext:j}){const W=t.state("No file selected"),U=t.state({}),C=t.state(!0),g=$=>{const F=$.target.files[0];if(F){W.val=F.name;const _=new FileReader;_.readAsText(F),_.onload=()=>{try{debugger;if(_.result){const P=JSON.parse(_.result);U.val=P,P.project_id&&(C.val=!1)}}catch{}},_.onerror=()=>{console.log(_.error)}}else W.val=""},x=({fileName:$,content:F})=>h({class:n`
          ...
          `},w(b(v("Credential File"),y($)),b(v("Project Name"),y(F.project_id)),b(v("Service Account"),y(F.client_email)))),S=({})=>c({class:n`
            display: inline-flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
            fill: var(--font-color-base);
            gap: 1rem;
          `},k({width:100,height:100,fill:"currentColor"},I({href:`${o.base}/uploadIcon.svg#Capa_1`})),p("Choose a GCP credential file to upload")),E=$=>{$.preventDefault(),j()},R=n`
      & ol {
        & > li {
          padding: 0.3rem 0;
        }
      }
    `;return D({name:"form-config-google",class:R,onsubmit:E,"data-infra-create":!0},s(i("Google Configuration"),r("GruCloud requires a read-only service account to scan a project's architecture. Please select the service account credential JSON file for the project that will be scanned. Follow the following steps to create and upload this file.")),a(u(d("Visit the ",f({href:"https://console.cloud.google.com/iam-admin/serviceaccounts",target:"_blank"},"service account page")," on the google cloud console"),d("Select your project"),d("Click on ",m("CREATE SERVICE ACCOUNT"),""),d("Set the ",m("Service account name")," to 'grucloud' for instance"),d("Click on ",m("CREATE"),""),d("Select the basic role 'Viewer'"),d("Click on ",m("CONTINUE"),""),d("Click on ",m("DONE"),""),d("Go to the ",m("Actions")," column, click on the three dot icon of the newly created service account"),d("Click on ",m("Manage keys"),""),d("Click on ",m("ADD KEYS"),", then ",m("Create new key"),""),d("Click on ",m("CREATE")," to download the credential file in JSON format.")),B({"data-input-google-upload":!0,Component:S,name:"file",accept:"application/JSON",onchange:g}),()=>x({fileName:W.val,content:U.val})),L(A({onclick:J}),()=>M({type:"submit",variant:"outline",color:"primary",disabled:C.val},"Next",l("▶"))))}},Li=e=>{const{bau:t,css:n}=e,{section:o,div:a,p:i}=t.tags,s=In(e),r=Di(e),c=Oi(e),l=_i(e),u=Ri(e),d=$i(e),p=t.state(""),m=t.state(0),f=({name:k})=>k,h=k=>()=>{p.val=k,m.val++},v=[{name:"Provider Selection",Header:f,Content:()=>r({onclickProvider:h}),enter:async()=>{p.val=""}},{name:"Import",Header:()=>"Import Project",Content:()=>d({providerName:p.val,onclickPrevious:b,onclickImportExistingInfra:()=>{debugger}})},{name:"Configuration",Header:()=>`Configuration ${p.val}`,Content:()=>{switch(p.val){case"AWS":return c({onclickPrevious:b,onclickNext:y});case"Azure":return l({onclickPrevious:b,onclickNext:y});case"Google":return u({onclickPrevious:b,onclickNext:y})}}},{name:"Scan",Header:f,Content:()=>a(i("My stepper 3 Content"))}],b=()=>{m.val>0&&m.val--},y=()=>{v.length>m.val+1&&m.val++};return()=>o({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
        `},s({stepperDefs:v,activeStepIndex:m}))},ji=`import stepper, { type StepperPage } from "@grucloud/bau-ui/stepper";
import { Context } from "@grucloud/bau-ui/context";
...
`);function Dn(e,t){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    ...
    ${Gi()}
  `;return function(...r){let[{color:c="neutral",variant:l="plain",size:u="md",...d},...p]=K(r);return a({...d,class:N("switch",i,c,l,u,t==null?void 0:t.class,d.class),type:"checkbox",required:"required"},...p)}}const Nn=e=>{const{bau:t,css:n}=e,{form:o,label:a}=t.tags,i=Dn(e);return s=>o({class:n`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`);function Ee(e,t){const{bau:n,css:o}=e,{tabDefs:a}=t,{div:i,ul:s,li:r}=n.tags,c=o`
    ...
    ${Ki()}
  `;return function(...u){let[{color:d,variant:p="plain",size:m,...f},...h]=K(u);const w=n.state(a),v=n.state(a[0]),b=I=>w.val.find(B=>B.name==I),y=I=>{const{Header:B,disabled:M,name:D}=I;return r({class:()=>N(v.val.name==D&&"active",M&&"disabled"),onclick:A=>A.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:D},bubbles:!0}))},B(I))},k=i({class:N("tabs",p,m,d,c,t==null?void 0:t.class,f.class)},n.loop(w,s(),y),()=>v.val.Content?v.val.Content({}):"");return k.addEventListener("tab.select",I=>{var D,A;const{tabName:B}=I.detail,M=b(B);M&&((D=v.val.exit)==null||D.call(),v.val=M,(A=M.enter)==null||A.call())},!1),k.addEventListener("tab.add",I=>{var M;const{tab:B}=I.detail;(M=B.enter)==null||M.call(),w.val.push(B)},!1),k.addEventListener("tab.remove",I=>{var M;const B=w.val.findIndex(D=>D.name==I.detail.tabName);B>0&&((M=w.val[B].exit)==null||M.call(),w.val.splice(B,1))},!1),k}}const Mn=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Ee(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return s=>i(s)},Xi=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Ee(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My tab 2 Content"))}]});return()=>i({variant:"outline",color:"neutral"})},Zi=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    box-shadow: var(--shadow-s);
    border-radius: var(--global-radius);
  `;return function(...c){let[{...l},...u]=K(c);return i({...l,class:N("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const ac=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(w,v,b,y,k){return{name:w,calories:v,fat:b,carbs:y,protein:k}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],m=({name:w,calories:v})=>s(i(w),i({class:n`
            text-align: right;
          `},v)),f=()=>c(s(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
              text-align: right;
            `,title:"Calories"},"Calories"))),h=ke(e,{class:n`
      max-width: 650px;
    `});return()=>o(h(r(u("Basic Table"),f(),l(p.map(m)))))},rc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,hc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:bc,createComponent:gc}]},fc=e=>{const t=H(e);return()=>t(hc)};function $n(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=lt(e),s=X(e),r=ze(e),c=o`
  ...
  `,l=({label:f,icon:h,...w})=>s({"aria-label":f,title:f,...w},h),u=({count:f,totalCount:h,page:w,rowsPerPage:v})=>a({class:"pages-numbers"},Number(w-1)*Number(v)+(f>0?1:0),"-",Math.min(w*v,h)," of ",h),d=({count:f,page:h,rowsPerPage:w})=>a({class:"pages-numbers"},(h-1)*w+(f>0?1:0),"-",h*w),p=f=>f<=1,m=(f,h,w)=>f>=Math.ceil(h/w);return function(...h){let[{count:w=0,totalCount:v=0,page:b=1,rowsPerPage:y=50,onPageChange:k,isLoading:I=!1,disableFirst:B=()=>p(b),disablePrevious:M=()=>p(b),disableNext:D=()=>m(b,v,y),disableLast:A=()=>m(b,v,y),...L},...V]=K(h);const J=Math.max(0,Math.ceil(v/y)),j=k({page:1}),W=k({page:b-1}),U=k({page:b+1}),C=k({page:J}),g=[{label:"First",icon:"⟪",onclick:j,disabled:B()},{label:"Previous",icon:"⟨",onclick:W,disabled:M()},{label:"Next",icon:"⟩",onclick:U,disabled:D()},{label:"Last",icon:"⟫",onclick:C,disabled:A()}];return a({...L,class:N("table-pagination",c,I&&"disabled",t==null?void 0:t.class,L==null?void 0:L.class)},r({class:"spinner",visibility:I,size:"md"}),v>0?u({count:w,totalCount:v,page:b,maxPages:J,rowsPerPage:y}):d({count:w,page:b,maxPages:J,rowsPerPage:y}),i({variant:"outline",color:"neutral"},g.map(x=>l({...x,variant:"outline",color:"neutral"}))))}}const vc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),xc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=vc(45),u=({name:b,email:y})=>i(a(b),a(y)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),p=$n(e),m=ke(e,{class:n`
      max-width: 650px;
    `}),f=t.state(l),h=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),w=t.derive(()=>f.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),v=({page:b})=>y=>{h.val.page=b};return()=>m(s(d(),()=>c(w.val.map(u))),()=>p({...h.val,onPageChange:v}))},wc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),m=t.derive(()=>d.val.length),f=t.state(1),h=t.state(10),w=t.derive(()=>d.val),v=A=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(A).toString()}`,b=({page:A})=>L=>{f.val=A,y(v({page:A,per_page:h.val}))};y(v({page:1,per_page:h.val}));async function y(A){try{u.val=!0;const L=await fetch(A,{});if(L.ok){const V=await L.json();d.val=V;return}throw L}catch(L){p.val=L.message}finally{u.val=!1}}const k=({name:A,description:L,stargazers_count:V})=>i(a(A),a(L),a({class:n`
            text-align: right;
          `},V)),I=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),B=$n(e),M=ke(e,{class:n`
      min-width: 650px;
    `}),D=({message:A})=>l(A);return()=>M(()=>B({rowsPerPage:h.val,page:f.val,count:m.val,totalCount:-1,isLoading:u.val,onPageChange:b,disableNext:()=>!1}),s(I(),()=>p.val&&D({message:p.val}),()=>c(w.val.map(k))))},yc=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=xc(e),l=wc(e),u=(...d)=>a({class:n`
  ...
  `;return function(...c){let[{color:l,variant:u,size:d="md",selected:p=!1,disabled:m,onChange:f,...h},...w]=K(c);return i({type:"button",...h,"aria-pressed":{deps:[p],renderProp:()=>v=>v},class:{deps:[p],renderProp:()=>v=>N("toggle",d,l,u,s,v&&"selected",t==null?void 0:t.class,h==null?void 0:h.class)},disabled:m},w)}}const Pn=e=>{const{bau:t}=e,n=Te(e);return console.log("grid item"),o=>{const a=t.state(!1);return n({...o,selected:a,onclick:()=>a.val=!a.val},"Toggle Me")}},Cc=e=>{const{bau:t}=e,{section:n}=t.tags,o=Te(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Sc=`import toggle from "@grucloud/bau-ui/toggle";
...
`,Mc={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Ic,createComponent:Ac},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Nc,createComponent:Dc}],gridItem:On},Bc=e=>{const t=H(e);return()=>t(Mc)};function mt(e,t){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
  ...
  `;return function(...c){let[{titleEl:l,side:u="bottom-start",color:d="neutral",variant:p="outline",size:m="md",...f},...h]=K(c);const w=i({class:N("container",...u.split("-"))},i({class:N("content",d,p,m),role:"tooltip"},l)),v=M=>`move-to-${M}`,b=(M,D,A)=>{if(M()){const L=v(D);w.classList.add(L),w.classList.add(D),w.classList.remove(A)}},y=(M,D)=>{const A=v(M);w.classList.contains(A)&&(w.classList.remove(A),w.classList.add(D),w.classList.remove(M))},k=M=>{const D=w.getBoundingClientRect();b(()=>D.x<0,"right","left"),b(()=>D.x+D.width>a.innerWidth,"left","right"),b(()=>D.y<0,"bottom","top"),b(()=>D.bottom>a.innerHeight,"top","bottom"),w.classList.add("visible")},I=M=>{w.classList.remove("visible"),y("right","left"),y("left","right"),y("bottom","top"),y("top","bottom")};return i({...f,class:N("tooltip",s,t==null?void 0:t.class,f==null?void 0:f.class),bauMounted:({element:M})=>{M.addEventListener("mouseover",k),M.addEventListener("mouseout",I)},bauUnmounted:({element:M})=>{M.removeEventListener("mouseover",k),M.removeEventListener("mouseout",I)}},...h,w)}}const _n=e=>{const{bau:t,css:n}=e,{div:o,p:a,em:i}=t.tags,s=X(e),r=mt(e),c=()=>o({class:n`
          font-size: larger;
...
`,{nav:e`
  ...
  `});function Ln(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Uc({css:o,createGlobalStyles:a}),d=it(e),p=({depth:m=1,maxDepth:f,color:h,variant:w,size:v})=>b=>{const{children:y,expanded:k}=b,I=n.state(!k),B=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:D=>{y&&(I.val=!I.val)}},i(b.data)),M=()=>s({class:N(h,v)},y.map(p({depth:m+1,maxDepth:f})));return r(d({Header:B,Content:y&&m<f&&M}))};return function({tree:f,maxDepth:h=1/0,size:w="md",variant:v="plain",color:b="neutral",...y}){return c({class:N(u.nav,w,v,b,t==null?void 0:t.class,y.class)},f.children&&s(f.children.map(p({maxDepth:h,color:b,variant:v,size:w}))))}}const jn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ln(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Fc=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ln(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Wc=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
