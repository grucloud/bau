...
`);function N(t,e={}){const{bau:n,css:o}=t,a=o`
    ...
    ${Do()}
  `;return function(...i){var p;let[{size:r=e.size??"md",variant:c=e.variant??"none",color:l=e.color??"none",href:u,...d},...m]=V(i);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:["button",c,r,l,a,e.class,Array.isArray(d.class)?(p=d.class)==null?void 0:p.join(" "):d.class],href:u},m)}}const Bo="light",No=()=>nt.map(t=>`
...
`);function ce(t,e={}){const{bau:n,css:o,window:a}=t,{input:s}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?i(c):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const l=o`
  ...
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",...g},...h]=V(d);return s({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:["theme-switch",p,b,m,l,e==null?void 0:e.class,g.class],type:"checkbox",checked:r()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...h)}}function Oo(t){const{tr:e,bau:n,css:o,config:a,states:s}=t,{i,header:r,h1:c,div:l,a:u,img:d,b:m,ul:b,li:p}=n.tags,{svg:g,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),y=s.drawerOpen,f=N(t,{class:o`
    ...
    `}),x=ce(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),k=()=>l({class:o`
        ...
        `},k(),A())}}function Mo({tr:t,bau:e,css:n}){const{section:o,footer:a,span:s,a:i,ul:r,li:c,p:l,div:u,h1:d}=e.tags,m=({links:g,title:h})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},u({class:n`
          ...
          `},m({title:"Bau UI",links:b}),m({title:"Bau Ecosystem",links:p})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},s("v0.86.0"),s("MIT license")))}}function yt(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,s=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:t`
   ...
   `});function le(t,e={}){const{bau:n,css:o,window:a,config:s}=t,{base:i="",hashBased:r=!1}=e,c=`${s.base}${i}`,l=P=>{var C;return((C=P.parentTree.data)==null?void 0:C.href)??P.parentTree.children[0].data.href},u=({variant:P,color:C,size:v,currentTree:w,data:E})=>x(D({variant:P,color:C,size:v,href:`${c}${l(w)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),D({variant:P,color:C,size:v,href:`${c}${E.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},E.name)),d=({size:P,subTree:{data:{name:C,href:v},children:w=[]}})=>D({size:P,href:`${c}${v}`,"data-ischild":!w.length},C),m=({pathname:P,subTree:C})=>{var v;return P===((v=C==null?void 0:C.data)==null?void 0:v.href)},{renderHeader:b=u,renderMenuItem:p=d,isActive:g=m}=e,{li:h,nav:y,div:f,header:x,a:S}=n.tags,k=Kt(t),A=yt(t),D=N(t,{class:o`
      &.button {
...
`);function ut(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
  ...
  `;return function(r){var d;const{variant:c=e.variant??"outline",color:l=e.color??"neutral",...u}=r;return a({type:"text",...u,class:["input",e.class,e.size??"md",l,c,s,Array.isArray(r.class)?(d=r.class)==null?void 0:d.join(" "):r.class]})}}function ue(t,e={}){const{bau:n,css:o,window:a}=t,s=ut(t,e);return function(r){const{variant:c=e.variant??"outline",color:l=e.color??"neutral",...u}=r,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(c=="solid"?"--font-color-inverse-secondary":"--font-color-secondary")}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,b=o`
    ...
    `;return s({type:"search",...u,color:l,variant:c,class:["inputSearch",e.class,b,u.class]})}}function He(t){const{tr:e,bau:n,css:o,config:a,states:s,window:i}=t,{div:r,ul:c,li:l,nav:u,a:d,span:m,form:b}=n.tags,p=ue(t,{variant:"plain",color:"neutral",size:"sm",class:o`
      margin: 0.5rem;
    `}),h={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:k,variant:A,color:D,size:B})=>{const O=n.state(""),I=n.derive(()=>O.val==""?S:S.filter(j=>j.data.name.match(new RegExp(`${O.val}`,"i")))),$=j=>{O.val=j.target.value};return b({class:o`
        ...
        `},f({tree:h}))}}const $o=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:s}=e.tags,i=Kt(t),r=Oo(t),c=He(t),l=Mo(t),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"outline",color:u=e.color??"neutral",onclick:d,...m},...b]=V(r);return a({...m,onclick:d,class:["chip",e.class,c,l,u,d&&"clickable",s,m.class]},...b)}}function Po(t){const{bau:e,css:n,config:o}=t,{div:a,h1:s,h2:i,p:r}=e.tags;N(t);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),s(l()));return function({featuresContent:l}){return o({class:i},l.map(r))}}function Ro({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:s,dd:i,div:r,aside:c,footer:l,a:u}=e.tags,d=({maxSize:m=151})=>({libName:b,size:p})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},b.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function jo(t){const{bau:e,css:n,config:o}=t,{div:a,p:s,a:i,section:r}=e.tags,c=Po(t),l=zo(t),u=N(t);Pt(t);const d=Ro(t),m=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
)`}),s("Most components accepts the ",r({href:"https://github.com/grucloud/bau/blob/main/bau-ui/constants.d.ts#L1",target:"_blank"},"variant"),", ",r({href:"https://github.com/grucloud/bau/blob/main/bau-ui/constants.d.ts#L3",target:"_blank"},"color"),",  and ",r({href:"https://github.com/grucloud/bau/blob/main/bau-ui/constants.d.ts#L2",target:"_blank"},"size"),", property."),s("Further reading:",c(l(r({href:"components"},"Visit the component gallery")),l(r({href:"https://github.com/grucloud/bau",target:"_blank"},"Learn more about bau")))))}}function ge(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
  ...
  `,b=({value:h,id:y,children:f=[]})=>{const x=c({class:()=>u.val==y?"active":"",href:`#${y}`});return x.innerHTML=h,r({class:()=>u.val==y?"active":""},x,f.length>0&&i(f.map(b)))},p=h=>h.tagName.charAt(1),g=({contentEl:h})=>{const y=h.querySelectorAll(l);let f=2,x={},S={children:[]},k=S;const A=k;let D=[k];return[...y].forEach(B=>{const O=p(B);B.setAttribute("id",B.textContent),!B.innerHTML.includes("<button")&&(x={value:B.innerHTML,id:B.id??B.textContent,children:[]},f==O?(S=x,k.children.push(S)):f<O?(D.push(k),k=S,S.children.push(x),S=x):f>O&&(k=D[O-1],D=D.slice(0,O-1),k.children.push(x),S=x),f=O)}),A};return function(...y){let[{size:f=e.size??"md",variant:x=e.variant??"plain",color:S=e.color??"neutral",contentEl:k,...A}]=V(y);const D=g({contentEl:k}),B=d(()=>{const I=[...k.querySelectorAll(l)].find($=>{const{top:j,height:U}=$.getBoundingClientRect();if(j+U>60)return!0});I&&(u.val=I==null?void 0:I.id)},100);return s({...A,class:["tableOfContent",f,x,S,m,e==null?void 0:e.class,A==null?void 0:A.class],bauMounted:()=>{a.addEventListener("scroll",B)},bauUnmounted:()=>{a.removeEventListener("scroll",B)}},D.children&&i(D.children.map(b)))}}const ln=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:s,tr:i,td:r,thead:c,th:l}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(c(i(l(m??""),nt.map(b=>l(b)))),s(To.map(b=>i(l(b),nt.map((p,g)=>r(d({color:p,variant:b},{index:g}))))))))}},Ha=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:s}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
        `},Ao.map((i,r)=>s(t,{size:i})({color:"success",variant:"outline"},{size:i,index:r})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:s,h1:i,p:r,h2:c,h3:l,pre:u,code:d}=e.tags;Mt.registerLanguage("javascript",sn);const m=cn(t),b=ge(t,{class:n`
      &.paper {
...
`).join(`
`);function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,ul:s,li:i,h3:r,button:c}=n.tags,l=o`
    & ul {
      display: inline-flex;
      flex-direction: column;
      justify-content: flex-start;
    ...
    ${Va()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"plain",color:p=e.color??"neutral",data:g=[],...h}]=V(d);const y=n.state(""),f=he(t,{size:m,variant:b,color:p}),x=k=>A=>{y.val==k?y.val="":y.val=k},S=k=>{const{Header:A,Content:D,name:B}=k,O=()=>r({class:()=>y.val==B&&"active"},c({type:"button","aria-controls":`bau-${B}`,"aria-expanded":({element:$})=>y.val==B},A(k))),I=()=>a({id:`bau-${B}`,"data-state":({element:$})=>y.val==B},D(k));return i({class:[p,b,m],onclick:x(B)},f({Header:O,Content:I}))};return a({class:["accordion",l,e==null?void 0:e.class,h.class]},s(g.map(S)))}}const un=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,s=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Zt(t,e);return r=>i({...r,data:s})},Ja=t=>{const{bau:e}=t,{div:n,p:o,section:a}=e.tags,s=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Zt(t,{color:"neutral",variant:"outline"});return()=>a(i({data:s}))},qa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,Ya={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:qa,createComponent:Ja},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Ka,createComponent:Wa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Za,createComponent:Xa}],gridItem:un},Qa=t=>{const e=F(t);return()=>e(Ya)},tr={danger:"⚠",warning:"⚠",success:"✔",primary:"ⓘ",neutral:"ⓘ"},er=()=>nt.map(t=>`
&.alert {
  &.plain.${t} {
    & .icon {
      color: var(--color-${t});
  ...
  `).join(`
`);function Tt(t,e={}){const{bau:n,css:o}=t,{div:a,span:s}=n.tags,i=o`
    display: inline-flex;
    max-width: 600px;
    justify-content: flex-start;
    align-items: center;
...
`,sr={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:or,createComponent:nr},{title:"Custom Alert ",description:"A custom alert.",code:rr,createComponent:ar}],gridItem:mn},ir=t=>{const e=F(t);return()=>e(sr)},cr=(t,e={})=>{const{bau:n,css:o,keyframes:a}=t,{limit:s=10,deleteAfterDuration:i=15e3}=e,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},d=({id:m,status:b})=>{const p=c.val.findIndex(g=>g.id===m);p!=-1&&(c.val[p].status=b)};return function(b={},...p){const g=({id:f})=>{d({id:f,status:"removing"});const x=c.val.findIndex(S=>S.id===f);x!=-1&&c.val.splice(x,1)},h=({Component:f})=>{const x={id:Math.random().toString(10).split(".")[1],Component:f,status:"inserting"};c.val.length>=s&&g({id:c.val[0].id}),c.val.push(x),setTimeout(()=>g(x),i)},y=f=>r({class:u.item,onclick:()=>g(f)},f.Component());return document.addEventListener("alert.add",f=>h(f.detail)),document.addEventListener("alert.remove",f=>g(f.detail)),r({class:[u.stack,e==null?void 0:e.class,b.class]},n.loop(c,r(),y))}},lr=t=>{const{tr:e,bau:n}=t,{section:o}=n.tags,a=cr(t,{deleteAfterDuration:2e4}),s=N(t),i=Tt(t);return()=>o(a(),s({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>i({color:"success"},e("Infrastructure Created"))}}))}},"Success Alert"))},ur=`import { Context } from "@grucloud/bau-ui/context";
...
`,gr=t=>{const{bau:e,keyframes:n}=t,{section:o,div:a,input:s,label:i}=e.tags,r=Kt(t),c=n`
    to {
...
`,fr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:hr,createComponent:gr}]},vr=t=>{const e=F(t);return()=>e(fr)};function Et(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:s}=n.tags,i=a`
  ...
  `;return function(...l){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",...b},...p]=V(l);return s({...b,class:["skeleton",u,r,e==null?void 0:e.class,b==null?void 0:b.class]},...p)}}function fe(t,e={}){const{bau:n,css:o}=t,{div:a,img:s}=n.tags,i=n.state(!0),r=n.state(!1),c=()=>i.val=!1,l=d=>{i.val=!1,r.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...m){let[{size:b=e.size??"md",variant:p=e.variant??"plain",color:g=e.color??"neutral",width:h=40,height:y=40,alt:f,...x},...S]=V(m);const k=Et(t,{class:[o`
          ...
          height: ${y}px;
          width: ${h}px;
        `,e==null?void 0:e.class,x.class]});return a({class:[u,e==null?void 0:e.class,x.class]},()=>i.val&&k(),()=>r.val&&f,s({alt:f,width:h,height:y,onload:c,onerror:l,class:()=>[!i.val&&"visible",r.val&&"hide",g,p,b,u,e==null?void 0:e.class,x.class],...x}))}}const pn=(t,e)=>{const{css:n}=t,o=fe(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`);function Rt(t,e={}){const{bau:n,css:o}=t,{div:a,li:s}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:b,Option:p,options:g,defaultOption:h,getOptionLabel:y,getOptionValue:f,onSelect:x=()=>{},id:S,required:k,name:A,loading:D,...B},...O]=V(c);const I=zt(t),$=N(t),j=ut(t,{variant:u,color:d,size:l}),U=yt(t),z=pt(t,{variant:u,color:d,size:l}),P=n.state(h),C=n.state(B.value),v=n.state(!1),w=n.state(0),E=()=>{v.val=!1},T=n.state(g),G=Y=>ot=>Y.val&&y(ot)==y(Y.val),R=()=>{lt.openDialog(),v.val=!0,C.val="",T.val=g,w.val=g.findIndex(G(P));const Y=Bt.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),it.scrollIntoView({block:"end"}))},H=()=>{lt.closeDialog(),v.val=!1,w.val=0},J=Y=>{const{value:ot}=Y.target;C.val=ot,ot?T.val=g.filter(Gt=>y(Gt).match(new RegExp(`${ot}`,"i"))):T.val=g},M=Y=>{lt.open?H():R()},X=Y=>{P.val=Y,ct.value=f(Y)},tt=({option:Y,index:ot})=>Gt=>{X(Y),w.val=ot,H()},W=()=>{const Y=Bt.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},Z=Y=>{switch(Y.key){case"Escape":H();break;case"ArrowDown":w.val<T.val.length-1?w.val++:w.val=0,W();break;case"ArrowUp":w.val<=0?w.val=T.val.length-1:w.val--,W();break;case"Enter":lt.open?(X(T.val[w.val]),H()):R(),Y.preventDefault();break}},at=$({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":v,"aria-label":m,onclick:M,variant:u,color:d,size:l,class:D==!0&&"loading",disabled:D},()=>P.val?y(P.val):m,()=>D==!0&&z({visibility:D})),it=j({value:C,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":v,oninput:J,onkeydown:Z,...B}),ct=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:h&&f(h),required:k,"aria-hidden":!1,"aria-label":A,name:A}),Bt=a({class:[u,d,l,"content"]},it,()=>U({class:[u,d,l]},T.val.map((Y,ot)=>s({class:()=>[w.val==ot&&"active",G(P)(Y)&&"selected"],onclick:tt({option:Y,index:ot})},p(Y))))),lt=I({id:S,triggerEl:at,contentEl:Bt,onClose:E,class:o`
        overflow: hidden;
      `});return a({...B,class:["autocomplete",i,e==null?void 0:e.class,B==null?void 0:B.class]},n.bind({deps:[P],render:()=>Y=>{Y&&(ct.value=f(Y),x(Y))}}),at,ct,lt)}}const bn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:s}=n.tags,i=Rt(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(l.label),s(l.code));return l=>i({...l,options:r,Option:c,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",name:"country","aria-label":"country"})},Ar=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Dr=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:s,article:i,footer:r}=e.tags,c=Rt(t),l=N(t,{variant:"outline",color:"primary"}),u=d=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Nr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,c=Rt(t),l=N(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,c=N(t,{variant:"outline"}),l=N(t,{variant:"solid",color:"primary"}),u=Rt(t),d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,_r={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:jr,createComponent:Rr}],gridItem:hn},Ur=t=>{const e=F(t);return()=>e(_r)};function ve(t,e={}){const{bau:n,css:o,config:a}=t,{ul:s,li:i,span:r}=n.tags,{separator:c="〉"}=e,l=N(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`);function ye(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
    ...
    ${ts()}
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["button-group",l,u,c,s,e==null?void 0:e.class,d==null?void 0:d.class]},...m)}}const yn=(t,e)=>{const n=["ONE","TWO","THREE"],o=N(t,e),a=ye(t,e);return s=>a({...s},n.map(i=>o(s,i)))},es=t=>{const{bau:e}=t,{section:n}=e.tags,o=["ONE","TWO","THREE"],a="primary",s="solid",i=N(t,{color:a,variant:s}),r=ye(t,{color:a,variant:s});return()=>{const c=l=>u=>{alert(l)};return n(r(o.map(l=>i({onclick:c(l)},l))))}},ns=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`)}
  ...
  `;return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...b]=V(c);return a({...m,type:"date",class:["calendar",i,d,u,l,e==null?void 0:e.class,m==null?void 0:m.class]},...b)}}const xn=(t,e)=>{const n=xe(t,e),o=({props:a={},options:s={}})=>`myinput-gallery-${a.color??s.color}-${a.variant??s.variant}-${a.size??s.size}`;return a=>n({"aria-label":o({props:a,options:e}),...a})},rs=t=>{const{bau:e}=t,{form:n,footer:o,article:a,label:s}=e.tags,i=xe(t),r=N(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:l=>{l.preventDefault();const u=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(u))}},a(s("Start date:",i({name:"start",min:"2023-01-01",max:"2024-12-31",required:!0}))),o(r({type:"submit"},"Submit")))},ss=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,ls={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Uncontrolled Calendar",description:"A simple calendar.",code:ss,createComponent:rs},{title:"Controlled Calendar",description:"A controlled calendar.",code:cs,createComponent:is}],gridItem:xn},us=t=>{const e=F(t);return()=>e(ls)};function ds(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
  ...
  `,i=n.state(0);return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:b,Previous:p,Next:g,...h}]=V(c);const y=()=>{i.val<=0?i.val=m.length-1:i.val--},f=()=>{i.val>=m.length-1?i.val=0:i.val++},x=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(b));return a({...h,class:["carousel",l,s,e==null?void 0:e.class,h==null?void 0:h.class]},a({class:["control","control-previous"],onclick:y},p()),a({class:["control","control-next"],onclick:f},g()),x)}}const ms=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ps=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,s=N(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,ys={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:vs,createComponent:fs}],gridItem:wn},xs=t=>{const e=F(t);return()=>e(ys)};function wt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({type:"checkbox",...d,class:[s,u,l,c,e==null?void 0:e.class,d==null?void 0:d.class]})}}const Sn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,s=wt(t,e);return i=>a({class:o`
          display: flex;
...
`,Cs=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:s,form:i}=e.tags,r=wt(t,{color:"neutral",variant:"outline"}),c=N(t,{variant:"outline",color:"primary"});return()=>i({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & article {
...
`,Is={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Ms,createComponent:Os}]},Ls=t=>{const e=F(t);return()=>e(Is)};function $s(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["divider",c,s,e==null?void 0:e.class,d==null?void 0:d.class]},a({class:"content"},...m))}}const Ps=t=>{const{bau:e}=t,{section:n}=e.tags,o=$s(t);return()=>n(o("OR"))},zs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,li:s}=n.tags,i=N(t),r=zt(t),c=yt(t),l=o`
    ${Vs()}
  `;return function(...d){let[{size:m=e.size??"md",variant:b=e.variant??"outline",color:p=e.color??"neutral",label:g,ListItem:h,items:y,...f},...x]=V(d);const S=n.state(0),k=()=>{U.openDialog(),U.focus()},A=()=>{U.closeDialog()},D=()=>{U.open?A():k()},B=z=>{D(),z.preventDefault()},O=({item:z,index:P})=>C=>{S.val=P,A(),C.preventDefault()},I=z=>{switch(z.preventDefault(),z.key){case"Escape":A();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":D();break}},$=()=>c({tabindex:"0",class:[p,b]},y.map((z,P)=>s({class:()=>[S.val==P&&"active"],onclick:O({item:z,index:P})},h(z)))),j=i({type:"button",onclick:B,color:p,variant:b,size:m},g),U=r({triggerEl:j,contentEl:$()});return a({...f,class:["dropdownMenu",p,m,l,e==null?void 0:e.class,f==null?void 0:f.class],onkeydown:I},j,U)}}const Js=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,s=Cn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>s({...c,items:i,ListItem:r,label:"Action"})},qs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,s=Cn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(s({items:i,ListItem:r,label:"Action"}))},Ws=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Qs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Ys,createComponent:Zs}],gridItem:(t,e)=>kn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},ti=t=>{const e=F(t);return()=>e(Qs)};function En(t,e={}){const{bau:n,css:o}=t,{div:a,label:s,input:i}=n.tags,r={base:o`
    ...
    `};return function(l,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:b=e.color??"neutral",Component:p,disabled:g,...h}=l;return a({class:[r.base,g&&r.disabled,e==null?void 0:e.class,l.class]},s({class:[m,b,d]},p({disabled:g}),i({type:"file",disabled:g,...h})))}}const Tn=(t,e)=>{const{tr:n,bau:o,css:a,config:s}=t,{svg:i,use:r}=o.tagsNS("http://www.w3.org/2000/svg"),{div:c,span:l}=o.tags,u=o.state("No file selected"),d=En(t,e),m=p=>{const g=p.target.files[0];g?u.val=g.name:u.val="No file selected"},b=({disabled:p})=>c({class:[a`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`,oi={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:ni,createComponent:ei}],gridItem:Tn},ai=t=>{const e=F(t);return()=>e(oi)};function bt(t,e={}){const{bau:n,css:o}=t,{form:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...b]=V(r);return a({...m,class:["form",u,l,c,s,e==null?void 0:e.class,m==null?void 0:m.class]},...b)}}function we(t,e={}){const{bau:n,css:o,keyframes:a}=t,{span:s}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",loading:b,...p},...g]=V(l);const h=N(t),y=pt(t);return n.bind({deps:[b],render:()=>f=>h({...p,class:["loadingButton",u,d,m,r,f&&"loading",e==null?void 0:e.class,p==null?void 0:p.class]},y({size:u,variant:d,color:m,visibility:f}),s({class:f&&"loading"},g))})}}const ri=t=>{const{bau:e,css:n,config:o}=t,{section:a,h1:s,header:i,label:r,img:c,footer:l}=e.tags,u=we(t,{variant:"solid",color:"primary"}),d=Tt(t,{variant:"outline",color:"danger"}),m=ut(t),b=bt(t,{class:n`
      max-width: 400px;
      & > header {
        text-align: center;
      }
...
`,ii=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:s,footer:i}=e.tags,r=bt(t),c=N(t,{variant:"solid",color:"primary"}),l=ut(t);return function({onSubmitted:d=()=>{}}){return r({onsubmit:async b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p)),d(p)}},a(o("Form with input")),n(s("Branch",l({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(c({type:"submit"},"Click")))}},ci=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`),r=a`
  ...
  `,c=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:b=e.color??"neutral",running:p,...g}]=V(u);return s({...g,role:"progressbar",class:{deps:[p],renderProp:()=>h=>["linearProgress",d,b,c,h&&"running",e==null?void 0:e.class,g==null?void 0:g.class]}})}}const In=(t,e)=>{const n=Mn(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},zi=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=N(t,{variant:"solid",color:"primary"}),s=Mn(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,s({"aria-label":"linear-progress",running:i}))},Ri=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function oc(t,e={}){const{bau:n,css:o}=t,{div:a,li:s,select:i}=n.tags,r=N(t),c=zt(t),l=yt(t),u=wt(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
...
`,mc={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:dc,createComponent:uc}]},pc=t=>{const e=F(t);return()=>e(mc)};function bc(t,e={}){const{bau:n,css:o,config:a}=t,{div:s,a:i,span:r,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`).join(`
`)}
  `;return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=V(c);return a({...m,type:"radio",class:["radio-button",l,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class]})}}const zn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:s}=n.tags,i=Se(t,e);return r=>s({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,Mc=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,s=jt(t),i=N(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:c=>{c.preventDefault();const l=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(l))}},o(s({name:"myRadio",value:"one",radios:[{value:"one",Label:()=>"One"},{value:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},Ic=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Rc={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:Ic,createComponent:Mc},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Bc,createComponent:Dc},{title:"Url State Radio Button Group",description:"A radio button group with the state in the URL",code:Oc,createComponent:Nc},{title:"Label with Image",description:"A label with an image.",code:$c,createComponent:Lc},{title:"Label with description",description:"A label with name and description.",code:zc,createComponent:Pc}]},jc=t=>{const e=F(t);return()=>e(Rc)};function $t(t,e={}){const{bau:n,css:o,window:a}=t,{section:s,article:i,div:r}=n.tags,{document:c}=a,{direction:l="horizontal"}=e,u=o`
  ...
  `;function d(...p){let[g,...h]=V(p);return s({...g,class:["resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u]},h)}function m(...p){let[g,...h]=V(p);return i({...g,class:["resizablePanel",g==null?void 0:g.class]},h)}function b(...p){let[g,...h]=V(p),y=0,f=0,x,S,k,A,D;const B=()=>l==="horizontal",O=z=>B()?I(z):$(z),I=z=>{const P=z.clientX-y;D&&(A.style.width=`${D.width+P}px`),k&&(S.style.width=`${k.width-P}px`)},$=z=>{const P=z.clientY-f;D&&(A.style.height=`${D.height+P}px`),k&&(S.style.height=`${k.height-P}px`)},j=()=>{S=null,A=null,k=null,D=null,x.style.cursor=null,x.style["user-select"]="auto",c.removeEventListener("mousemove",O),c.removeEventListener("mouseup",j)},U=z=>{y=z.clientX,f=z.clientY;const{target:P}=z,C=P.closest(".handle");x=P.closest(".resizablePanelGroup"),x.style.cursor=B()?"col-resize":"row-resize",x.style["user-select"]="none",S=C.nextSibling,A=C.previousSibling,A&&(D=A.getBoundingClientRect()),S&&(k=S.getBoundingClientRect()),c.addEventListener("mousemove",O),c.addEventListener("mouseup",j)};return r({...g,class:["handle",l],role:"separator",bauMounted:({element:z})=>{z.addEventListener("mousedown",U)},bauUnmounted:({element:z})=>{z.removeEventListener("mousedown",U)}},h)}return{PanelGroup:d,Panel:m,Handle:b}}const _c=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:s,Panel:i,Handle:r}=$t(t,{class:n`
      display: inline-flex;
...
`).join(`
`);function At(t,e={}){const{bau:n,css:o}=t,{div:a,li:s,select:i,option:r}=n.tags,c=N(t),l=zt(t),u=yt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Xc()}
  `;return function(...b){let[{size:p=e.size??"md",variant:g=e.variant??"outline",color:h=e.color??"neutral",label:y,Option:f,options:x,defaultOption:S,getOptionLabel:k,getOptionValue:A,onSelect:D=()=>{},loading:B,...O},...I]=V(b);const $=pt(t,{variant:g,color:h,size:p}),j=n.state(S?k(S):y),U=n.state(!1),z=n.state(0),P=()=>{H.openDialog(),H.focus(),U.val=!0},C=()=>{H.closeDialog(),U.val=!1},v=()=>{U.val=!1},w=M=>{H.open?C():P(),M.preventDefault()},E=({option:M,index:X})=>tt=>{j.val=k(M),J.value=A(M),J.setCustomValidity(""),z.val=X,C(),D(M),tt.preventDefault()},T=M=>{if(H.open)switch(M.preventDefault(),M.key){case"Escape":C();break;case"ArrowDown":z.val<x.length-1?z.val++:z.val=0;break;case"ArrowUp":z.val<=0?z.val=x.length-1:z.val--;break;case"Enter":H.open?(j.val=k(x[z.val]),J.value=A(r),D(x[z.val]),C()):P();break}},G=()=>u({tabindex:"0",class:[h,g]},x.map((M,X)=>s({class:()=>z.val==X&&"active",onclick:E({option:M,index:X})},f(M)))),R=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":U,"aria-label":y,onclick:w,color:h,variant:g,size:p,class:B==!0&&"loading",disabled:B},()=>!j.val&&y,j,()=>B==!0&&$({visibility:B})),H=l({triggerEl:R,contentEl:G(),onClose:v}),J=i({...O,"aria-label":y,tabindex:"-1"},r({value:""},"--Select Category--"),x.map(M=>r({value:A(M)},k(M))));return S?J.value=A(S):J.value=O.value,a({...O,class:["select",h,p,d,e==null?void 0:e.class,O==null?void 0:O.class],onkeydown:T},J,R,H)}}const Rn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:s}=n.tags,i=At(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(l.label),s(l.code));return l=>i({...l,options:r,Option:c,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},Zc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,c=At(t),l=N(t,{variant:"solid",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Qc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,div:i,span:r}=e.tags,c=At(t),l=N(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=b=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,el=t=>{const{bau:e,css:n,window:o}=t,{form:a,article:s,footer:i,div:r,span:c}=e.tags,l="country",u=At(t),d=N(t,{variant:"solid",color:"primary"}),m=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],b=p=>r({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},c(p.label),c(p.code));return()=>{const p=f=>{f.preventDefault();const x=Object.fromEntries(new FormData(f.currentTarget));alert(JSON.stringify(x))},g=({code:f})=>f,h=f=>{const x=new URLSearchParams(o.location.search);x.delete(l),x.append(l,g(f)),o.history.replaceState("","",`?${x.toString()}${o.location.hash}`)},y=new URLSearchParams(o.location.search);return a({onsubmit:p},s(u({name:l,options:m,Option:b,defaultOption:m.find(({code:f})=>f==y.get(l)),getOptionValue:g,getOptionLabel:({label:f})=>f,label:"Select a country...",onSelect:h})),i(d({type:"submit"},"Submit")))}},nl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,rl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:s,span:i,div:r}=e.tags,c=N(t,{variant:"outline"}),l=N(t,{variant:"solid",color:"primary"}),u=At(t),d=m=>r({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,il={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Yc,createComponent:Zc},{title:"Default Option",description:"Select with a default option",code:tl,createComponent:Qc},{title:"State in URL",description:"Select with state in URL",code:nl,createComponent:el},{title:"Select AWS region",description:"Select the AWS region",code:al,createComponent:ol},{title:"Loading Indicator",description:"Select with a loading indicator",code:sl,createComponent:rl}],gridItem:Rn},cl=t=>{const e=F(t);return()=>e(il)};function Ce(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,s=o`
  ...
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["select-native",u,c,l,s,e==null?void 0:e.class,d==null?void 0:d.class]},m)}}const jn=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=Ce(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},s.map(({label:r,phone:c})=>o({value:c},r)))},ll=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,s=N(t,{variant:"outline",color:"primary"}),i=Ce(t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:l=>{l.preventDefault();const u=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),r.map(({label:l,phone:u})=>n({value:u},l))),a(s({type:"submit"},"Submit")))},ul=`import { Context } from "@grucloud/bau-ui/context";
...
`,yl=t=>{const{bau:e,css:n}=t,{section:o,table:a,tbody:s,tr:i,td:r}=e.tags,c=Et(t,{class:n`
      height: 2rem;
      width: 10rem;
...
`,wl=t=>{const{bau:e,css:n}=t,{section:o,header:a,span:s,article:i}=e.tags,r=n`
  ...
  `,c=Et(t,{class:n`
    ...
    `}),l=Et(t);function u({columnsSize:d=4}){return o({class:r},a(new Array(d).fill("").map(()=>c(s("1")))),i(l("")))}return()=>o(u({columnsSize:3}))},Sl=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`)};
  `;return function(...c){let[{size:l=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...b]=V(c);return a({...m,type:"range",class:["slider",d,u,l,i,e==null?void 0:e.class,m.class]},...b)}}const _n=t=>{const{bau:e}=t,n=e.state(0),o=s=>{n.val=s==null?void 0:s.target.value},a=Dt(t);return s=>a({"aria-label":"slider",...s,oninput:o})},El=t=>{const{bau:e}=t,{form:n,article:o,label:a,br:s,footer:i}=e.tags,r=Dt(t),c=N(t,{variant:"solid",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(a("Slider with step, min and max",s,r({name:"slider-simple",step:20,min:-100,max:100}))),i(c({type:"submit"},"Submit")))},Tl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Ol=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:s,label:i,datalist:r,br:c,option:l}=e.tags,u=Dt(t),d=N(t,{variant:"solid",color:"primary"});return()=>s({onsubmit:b=>{b.preventDefault();const p=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(p))}},o({class:n`
            display: flex;
...
`),Gn=(t,e)=>(n,o)=>{const a=new URLSearchParams(t.window.location.search);return a.delete(e),a.append(e,n),o&&Object.entries(o).map(([s,i])=>(a.delete(s),a.append(s,i))),`?${a.toString()}`};function Fn(t,e={}){const{bau:n,css:o,window:a}=t,{div:s,ul:i,li:r,span:c,section:l}=n.tags,u=o`
  ...
  `;return function(...m){let[{color:b,variant:p="plain",size:g,stepperDefs:h=[],stepperName:y,activeStepIndex:f=n.state(0),...x},...S]=V(m);const k=n.state(h.map(($,j)=>({...$,index:j}))),A=n.state([]);a.history.pushState=new Proxy(a.history.pushState,{apply:($,j,U)=>{$.apply(j,U);const z=U[2]??"";["?","#"].includes(z[0])&&I()}});const D=n.derive(()=>k.val[f.val]),B=$=>{const{Header:j,disabled:U,name:z,index:P}=$;return r({class:()=>[D.val.name==z&&"active",f.val<P&&"not-completed",f.val>P&&"completed",U&&"disabled"]},c({class:"step-number"},P+1),c({class:"step-label"},()=>j($)))},O=$=>h.findIndex(({name:j})=>j==$.name),I=()=>{const j=new URLSearchParams(a.location.search).get(y)??h[0].name,U=Math.max(h.findIndex(({name:z})=>z==j),0);U<f.val&&A.val.pop(),A.val.some(({name:z})=>j==z)||A.val.push(h[U]),f.val=U};return I(),s({bauMounted:({element:$})=>{a.addEventListener("popstate",I)},bauUnmounted:()=>{a.removeEventListener("popstate",I)},class:["stepper",p,g,b,u,e==null?void 0:e.class,x.class]},n.loop(k,i(),B),n.loop(A,l(),$=>s({class:()=>["content",$.name==D.val.name&&"visible"]},$.Content({nextStep:h[O($)+1],previousStep:h[O($)-1]}))))}}const je="my-wizard",Gl=t=>{const{bau:e,window:n}=t,{footer:o,p:a,label:s,section:i,a:r,ul:c,li:l}=e.tags,u=ut(t),d=bt(t),m=Fn(t),b=Gn(t,je),p=N(t,{variant:"outline",color:"primary"}),g=N(t,{variant:"solid",color:"primary"});return()=>{const h=({nextStep:x})=>S=>{S.preventDefault();const{organization:k}=S.target.elements;n.history.pushState("","",b(x.name,{organization:k.value}))},y=x=>{var D;x.preventDefault();const{organization:S}=(D=n.document.forms)==null?void 0:D.formStep1.elements,A=new URLSearchParams(n.location.search).get("choice");alert(`organization ${S.value}, choice:${A}`)};return i(m({stepperDefs:[{name:"step1",Header:()=>"Step 1",Content:({nextStep:x})=>d({onsubmit:h({nextStep:x}),id:"formStep1"},s("Organization",u({autofocus:!0,placeholder:"Organization",name:"organization"})),o(g({type:"submit"},"Next: ")))},{name:"step2",Header:()=>"Step 2",Content:({nextStep:x,previousStep:S})=>d(c(l(r({href:b(x.name,{choice:"choice1"})},"Choice 1")),l(r({href:b(x.name,{choice:"choice2"})},"Choice 2"))),o(p({href:b(S.name)},"Previous")))},{name:"step3",Header:()=>"Step 3",Content:({previousStep:x})=>d({onsubmit:y},a("My stepper 3 Content"),o(p({href:b(x.name)},"Previous: Step 2"),g({type:"submit"},"Save")))}],stepperName:je}))}},Fl=`import stepper, { NextUrl, type StepperPage } from "@grucloud/bau-ui/stepper";
import button from "@grucloud/bau-ui/button";
import input from "@grucloud/bau-ui/input";
import form from "@grucloud/bau-ui/form";
...
`,_e="stepper-vertical",Hl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:s,label:i,section:r,a:c,ul:l,li:u}=e.tags,d=ut(t),m=bt(t),b=Fn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`);function Yt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,s=o`
    ...
    ${Wl()}
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(r);return a({...d,class:["switch",s,u,l,c,e==null?void 0:e.class,d.class],type:"checkbox"},...m)}}const Hn=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:s}=n.tags,i=Yt(t,e);return r=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},s("off ",i({...r,id:`my-switch-example-off-${r.color}-${r.variant}`})),s("on ",i({...r,id:`my-switch-example-on-${r.color}-${r.variant}`,checked:!0})))},Kl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:s,article:i}=e.tags,r=Yt(t,{variant:"outline",color:"primary"}),c=N(t,{variant:"outline",color:"primary"}),l=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
...
`,Zl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:s,article:i}=e.tags,r=Yt(t,{variant:"outline",color:"primary"}),c=N(t,{variant:"outline",color:"primary"}),l=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`,Ql=t=>{const{bau:e,css:n,window:o}=t,{footer:a,form:s,label:i,article:r}=e.tags,c="my-shinny-switch",l=Yt(t,{variant:"outline",color:"primary"}),u=N(t,{variant:"outline",color:"primary"}),d=n`
    & label {
      display: flex;
      align-items: center;
      gap: 0.5rem;
...
`;const i=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=V(c);return s({...l,class:["table-container",i,e==null?void 0:e.class,l==null?void 0:l.class]},...u)}}const bu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:s,tr:i,table:r,thead:c,tbody:l,caption:u}=e.tags;function d(h,y,f,x,S){return{name:h,calories:y,fat:f,carbs:x,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],b=({name:h,calories:y})=>i(s(h),s({class:n`
            text-align: right;
          `},y)),p=()=>c(i(a({class:n`
              text-align: left;
...
`,Tu={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Eu,createComponent:ku}]},Au=t=>{const e=F(t);return()=>e(Tu)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=ye(t),i=N(t),r=pt(t),c=o`
  ...
  `,l=({label:p,icon:g,...h})=>i({"aria-label":p,title:p,...h},g),u=({count:p,totalCount:g,page:h,rowsPerPage:y})=>a({class:"pages-numbers"},Number(h-1)*Number(y)+(p>0?1:0),"-",Math.min(h*y,g)," of ",g),d=({count:p,page:g,rowsPerPage:h})=>a({class:"pages-numbers"},(g-1)*h+(p>0?1:0),"-",g*h),m=p=>p<=1,b=(p,g,h)=>p>=Math.ceil(g/h);return function(...g){let[{size:h=e.size??"md",variant:y=e.variant??"outline",color:f=e.color??"neutral",count:x=0,totalCount:S=0,page:k=1,rowsPerPage:A=50,onPageChange:D,isLoading:B=!1,disableFirst:O=()=>m(k),disablePrevious:I=()=>m(k),disableNext:$=()=>b(k,S,A),disableLast:j=()=>b(k,S,A),...U},...z]=V(g);const P=Math.max(0,Math.ceil(S/A)),C=D({page:1}),v=D({page:k-1}),w=D({page:k+1}),E=D({page:P}),T=[{label:"First",icon:"⟪",onclick:C,disabled:O()},{label:"Previous",icon:"⟨",onclick:v,disabled:I()},{label:"Next",icon:"⟩",onclick:w,disabled:$()},{label:"Last",icon:"⟫",onclick:E,disabled:j()}];return a({...U,class:["table-pagination",c,B&&"disabled",e==null?void 0:e.class,U==null?void 0:U.class]},r({class:"spinner",visibility:B,size:"md"}),S>0?u({count:x,totalCount:S,page:k,maxPages:P,rowsPerPage:A}):d({count:x,page:k,maxPages:P,rowsPerPage:A}),s({variant:y,color:f},T.map(G=>l({...G,variant:y,color:f}))))}}const Du=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Bu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:s,table:i,thead:r,tbody:c}=e.tags,l=Du(45),u=({name:p,email:g})=>s(a(p),a(g)),d=()=>r(o({class:n`
    ...
    `});return()=>{const p=e.state(l),g=e.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=e.derive(()=>p.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:f})=>x=>{g.val.page=f};return b(i(d(),()=>c(h.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:s,table:i,thead:r,tbody:c,div:l}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),b=e.derive(()=>d.val.length),p=e.state(1),g=e.state(10),h=e.derive(()=>d.val),y=O=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(O).toString()}`,f=({page:O})=>I=>{p.val=O,x(y({page:O,per_page:g.val}))};x(y({page:1,per_page:g.val}));async function x(O){try{u.val=!0;const I=await fetch(O,{});if(I.ok){const $=await I.json();d.val=$;return}throw I}catch(I){m.val=I.message}finally{u.val=!1}}const S=({name:O,description:I,stargazers_count:$})=>s(a(O),a(I),a({class:n`
      ...
      min-width: 650px;
    `}),B=({message:O})=>l(O);return()=>D(()=>A({rowsPerPage:g.val,page:p.val,count:b.val,totalCount:-1,isLoading:u.val,onPageChange:f,disableNext:()=>!1}),i(k(),()=>m.val&&B({message:m.val}),()=>c(h.val.map(S))))},Ou=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:s,h2:i,tr:r}=e.tags,c=Bu(t),l=Nu(t),u=(...d)=>a({class:n`
        ...
        `},...d);return()=>o({id:"pagination"},i(r("Table Pagination")),s("Asynchronous Pagination"),u(l()),s("Simple Pagination"),u(c()))};function gt(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{button:s}=n.tags;a`
    :root {
...
`);function Qt(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,s=o`
    ...
    ${_u()}
  `;return function(...r){let[{size:c=e.size??"md",variant:l=e.variant??"outline",color:u=e.color??"neutral",exclusive:d=!1,onChange:m=()=>{},...b},...p]=V(r);const g=new Set,h=y=>{const{value:f}=y.target;d?(g.clear(),g.add(f)):g.has(f)?g.delete(f):g.add(f),m({event:y,values:[...g]})};return a({...b,class:["toggle-group",c,u,l,s,e==null?void 0:e.class,b==null?void 0:b.class],onclick:h},...p)}}const Wn=(t,e)=>{const{bau:n}=t,o=Qt(t,e),a=gt(t,e);return s=>{const i=n.state([""]),r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...s,onChange:({values:l})=>{i.val=l}},r.map(({label:l,value:u})=>()=>a({...s,value:u,selected:i.val.includes(u),"area-label":l},l)))}},Uu=t=>{const{bau:e}=t,{form:n,footer:o,article:a}=e.tags,s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",r="solid",c=gt(t,{color:i,variant:r}),l=Qt(t,{color:i,variant:r}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{var y;p.preventDefault();const h=(y=p.currentTarget.querySelector("button[selected=true]"))==null?void 0:y.name;alert(h)}},a(l({exclusive:!0,onChange:({values:p})=>{d.val=p}},s.map(({label:p,value:g})=>()=>c({value:g,name:p,selected:d.val.includes(g)},p)))),o(u({type:"submit"},"Submit")))}},Gu=`import { Context } from "@grucloud/bau-ui/context";
...
`,Fu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",r="solid",c=gt(t,{variant:r,color:i}),l=Qt(t,{variant:r,color:i}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:p=>{p.preventDefault();const h=[...p.currentTarget.querySelectorAll("button[selected=true]")].map(({name:y})=>y);alert(JSON.stringify(h))}},o(l({onChange:({values:p})=>{d.val=p}},s.map(({label:p,value:g})=>()=>c({value:g,name:p,selected:d.val.includes(g)},p)))),a(u({type:"submit"},"Submit")))}},Hu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,Zu=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:s,section:i}=e.tags,r=Pt(t,{variant:"outline",color:"primary"}),c=ke(t),l=()=>o(a("A ",s("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
