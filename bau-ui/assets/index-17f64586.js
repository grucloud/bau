...
`),fc=(e,t)=>(n,o)=>{const a=new URLSearchParams(e.window.location.search);return a.delete(t),a.append(t,n),o&&Object.entries(o).map(([i,s])=>(a.delete(i),a.append(i,s))),`?${a.toString()}`};function vc(e,t={}){const{bau:n,css:o,window:a}=e,{div:i,ul:s,li:r,span:c,footer:l}=n.tags,u=o`
    display: flex;
    flex-direction: column;
    padding: 1rem;
    & > ul {
