...
`);function Z(e,t={}){const{bau:n,css:o}=e,a=o`
    ...
    ${Co()}
  `;return function(...s){let[{size:r=t.size??"md",variant:c=t.variant??"none",color:l=t.color??"none",href:u,...p},...d]=K(s);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...p,class:D("button",t.class,c,r,l,a,p.class),href:u},d)}}const Eo="light",ko=()=>oe.map(e=>`
...
`);function ue(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:p,...d},...b]=K(r);return a({...d,onclick:p,class:D("chip",t.class,c,l,u,p&&"clickable",i,d.class)},...b)}}function No(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;Z(e);const c=n`
...
`,Xa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Simple",description:"A simple accordion.",code:Ua,createComponent:Ha},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Fa,createComponent:Ga},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Wa,createComponent:Va}],gridItem:on},Za=e=>{const t=G(e);return()=>t(Xa)},Ka={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},qa=()=>oe.map(e=>`
&.alert {
  &.sm {
    & .icon {
      font-size: 1.3rem;
...
`);function $e(e,t={}){const{bau:n,css:o}=e,{div:a,i}=n.tags,s=o`
    ...
    ${qa()}
  `,r=Z(e),c=({onclick:l})=>r({"aria-label":"Close",onclick:l,class:"button-close"},"✖");return function(...u){let[{size:p=t.size??"md",variant:d=t.variant??"outline",color:b=t.color??"neutral",onRemove:g,...h},...f]=K(u);return a({...h,class:D("alert",`alert-${d}`,t.class,d,b,p,s,h.class),role:"alert"},i({class:"icon"},Ka[b]),a({class:"content"},...f),g&&c({onclick:g}))}}const rn=(e,t)=>{const n=$e(e,t);return o=>n({...o},`Alert ${(t==null?void 0:t.size)??""} `)},Ja=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=$e(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},Ya=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`);function Ke(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
  ...
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",label:d,placeholder:b,Option:g,options:h,defaultOption:f,getOptionLabel:x,getOptionValue:y,onSelect:w=()=>{},id:k,required:A,name:B,loading:T,...M},...P]=K(c);const O=Be(e),N=Z(e),R=ue(e,{variant:u,color:p,size:l}),j=be(e),U=fe(e,{variant:u,color:p,size:l}),z=n.state(f),S=n.state(M.value),m=n.state(!1),v=n.state(0),C=()=>{m.val=!1},E=n.state(h),H=Y=>ae=>Y.val&&x(ae)==x(Y.val),L=()=>{ce.openDialog(),m.val=!0,S.val="",E.val=h,v.val=h.findIndex(H(z));const Y=Ee.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),ve.scrollIntoView({block:"end"}))},V=()=>{ce.closeDialog(),m.val=!1,v.val=0},F=Y=>{const{value:ae}=Y.target;S.val=ae,ae?E.val=h.filter(Re=>x(Re).match(new RegExp(`${ae}`,"i"))):E.val=h},$=Y=>{ce.open?V():L()},J=Y=>{z.val=Y,Ce.value=y(Y)},ne=({option:Y,index:ae})=>Re=>{J(Y),v.val=ae,V()},X=()=>{const Y=Ee.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},ee=Y=>{switch(Y.key){case"Escape":V();break;case"ArrowDown":v.val<E.val.length-1?v.val++:v.val=0,X();break;case"ArrowUp":v.val<=0?v.val=E.val.length-1:v.val--,X();break;case"Enter":ce.open?(J(E.val[v.val]),V()):L(),Y.preventDefault();break}},ie=N({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":m,"aria-label":d,onclick:$,variant:u,color:p,size:l,class:T==!0&&"loading",disabled:T},()=>z.val?x(z.val):d,()=>T==!0&&U({visibility:T})),ve=R({value:S,placeholder:b,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":m,oninput:F,onkeydown:ee,...M}),Ce=R({class:o`
      ...
      `});return a({...M,class:D("autocomplete",s,t==null?void 0:t.class,M==null?void 0:M.class)},n.bind({deps:[z],render:()=>Y=>{Y&&(Ce.value=y(Y),w(Y))}}),ie,Ce,ce)}}const cn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Ke(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          ...
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return l=>s({...l,options:r,Option:c,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",id:"country"})},Sr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=Ke(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Er=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=Ke(e),r="AD",c=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=u=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,ls={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:cs,createComponent:is}],gridItem:hn},us=e=>{const t=G(e);return()=>t(ls)};function qe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
...
`,ms=e=>{const{bau:t,css:n}=e,{label:o,form:a}=t.tags,i=qe(e,{color:"neutral",variant:"outline"}),s=Z(e),r=c=>{c.preventDefault();const l=Object.fromEntries(new FormData(c.target.closest("form")));alert(JSON.stringify(l))};return()=>a({onsubmit:r,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & label {
...
`,xs={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:vs,createComponent:fs}]},ys=e=>{const t=G(e);return()=>t(xs)};function ws(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...p},...d]=K(r);return a({...p,class:D("divider",c,i,t==null?void 0:t.class,p==null?void 0:p.class)},a({class:"content"},...d))}}const Ss=e=>{const{bau:t}=e,{section:n}=t.tags,o=ws(e);return()=>n(o("OR"))},Cs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",loading:b,...g},...h]=K(l);const f=Z(e),x=fe(e);return n.bind({deps:[b],render:()=>y=>f({...g,class:D("loadingButton",u,p,d,r,y&&"loading",t==null?void 0:t.class,g==null?void 0:g.class)},x({size:u,variant:p,color:d,visibility:y}),i({class:y&&"loading"},h))})}}const Vs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=ft(e),p=$e(e,{variant:"outline",color:"danger"}),d=ue(e),b=Oe(e,{class:n`
      & > header {
        text-align: center;
      }
      & > footer {
...
`,Js={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Simple form",description:"A simple form.",code:Zs,createComponent:Xs},{title:"Form with state",description:"A form with input state and a dervied state.",code:qs,createComponent:Ks},{title:"Login page",description:"A login page.",code:Ws,createComponent:Vs}]},Ys=e=>{const t=G(e);return()=>t(Js)},Sn=(e,t={})=>{const n=ue(e,t);return o=>n({name:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,placeholder:"Enter text",...o})},Qs=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=ue(e);return()=>n(o("Basic input"),a({id:"my-input",name:"my-input",placeholder:"Enter Text"}),o("Disabled input"),a({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))},ei=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function Ti(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s}=n.tags,r=Z(e),c=Be(e),l=be(e),u=qe(e,{color:"neutral",variant:"outline"}),p=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
...
`,qi={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Ki,createComponent:Zi}],gridItem:In},Ji=e=>{const t=G(e);return()=>t(qi)},Yi=()=>oe.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function Le(e,t={}){const{bau:n,css:o,window:a}=e,{tabDefs:i}=t,{div:s,ul:r,li:c,a:l}=n.tags,u=o`
    ...
    ${Xc()}
  `;return function(...d){let[{size:b=t.size??"md",variant:g=t.variant??"outline",color:h=t.color??"neutral",tabsKey:f="tabs",...x},...y]=K(d);const w=n.state(i),k=O=>w.val.find(N=>N.name==O),A=n.state(i[0]),B=()=>{var j,U;const N=new URLSearchParams(a.location.search).get(f)??i[0].name,R=k(N);(j=A.val.exit)==null||j.call(),A.val=R,(U=R==null?void 0:R.enter)==null||U.call()};B(),a.history.pushState=new Proxy(a.history.pushState,{apply:(O,N,R)=>{O.apply(N,R);const j=R[2]??"";["?","#"].includes(j[0])&&B()}});const T=O=>{const N=new URLSearchParams(a.location.search);return N.delete(tabsName),N.append(tabsName,O),`?${N.toString()}`},M=O=>{const{Header:N,disabled:R,name:j}=O;return c({class:()=>D(A.val.name==j&&"active",R&&"disabled")},l({href:T(j)},N(O)))},P=s({class:D("tabs",g,b,h,u,t==null?void 0:t.class,x.class),bauMounted:({element:O})=>{a.addEventListener("popstate",B)},bauUnmounted:()=>{a.removeEventListener("popstate",B)}},n.loop(w,r(),M),n.bind({deps:[A],render:()=>({Content:O})=>O?O(x):""}));return P.addEventListener("tab.add",O=>{var R;const{tab:N}=O.detail;(R=N.enter)==null||R.call(),w.val.push(N)},!1),P.addEventListener("tab.remove",O=>{var R;const N=w.val.findIndex(j=>j.name==O.detail.tabName);N>0&&((R=w.val[N].exit)==null||R.call(),w.val.splice(N,1))},!1),P}}const jn=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,s=Le(e,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...t});return r=>s(r)},Zc=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Le(e,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}],variant:"outline",color:"neutral"});return()=>i({tabsKey:"my-tab"})},Kc=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,qc=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Le(e,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>"Tab Disabled",Content:()=>n(o("My Content Disabled"))}]});return()=>i({variant:"outline",color:"success"})},Jc=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
    ...
    width: fit-content;
  `;return function(...c){let[{...l},...u]=K(c);return i({...l,class:D("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const al=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function p(f,x,y,w,k){return{name:f,calories:x,fat:y,carbs:w,protein:k}}const d=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],b=({name:f,calories:x})=>s(i(f),i({class:n`
            text-align: right;
          `},x)),g=()=>c(s(a({class:n`
              text-align: left;
...
`,hl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:bl,createComponent:gl}]},fl=e=>{const t=G(e);return()=>t(hl)};function Un(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=ht(e),s=Z(e),r=fe(e),c=o`
  ...
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",selected:d=!1,disabled:b,onChange:g,...h},...f]=K(c);return i({type:"button",...h,"aria-pressed":{deps:[d],renderProp:()=>x=>x},class:{deps:[d],renderProp:()=>x=>D("toggle",l,p,u,s,x&&"selected",t==null?void 0:t.class,h==null?void 0:h.class)},disabled:b},f)}}const Gn=(e,t)=>{const{bau:n}=e,o=_e(e,t);return a=>{const i=n.state(!1);return o({...a,selected:i,onclick:()=>i.val=!i.val},"Toggle Me")}},Sl=e=>{const{bau:t}=e,{section:n}=t.tags,o=_e(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Cl=`import toggle from "@grucloud/bau-ui/toggle";
...
`,Wl={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:Vl,createComponent:Fl}],gridItem:Zn},Xl=e=>{const t=G(e);return()=>t(Wl)},Zl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:s,ul:r,li:c}=t.tags,l=nn(e),u=Z(e),p=[{name:"Accordion",Item:on(e)},{name:"Alert",Item:rn(e)},{name:"Autocomplete",Item:cn(e)},{name:"Avatar",Item:sn(e)},{name:"Badge",Item:un(e)},{name:"Breadcrumbs",Item:dn(e)},{name:"Button",Item:pn(e)},{name:"Button Group",Item:mn(e)},{name:"Calendar",Item:bn(e)},{name:"Checkbox",Item:fn(e)},{name:"Chip",Item:hn(e)},{name:"DrillDown Menu",Item:xn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:wn(e)},{name:"Input",Item:Sn(e)},{name:"Input Search",Item:Cn(e)},{name:"Linear Progress",Item:kn(e)},{name:"Loading Button",Item:An(e)},{name:"Modal",Item:Dn(e)},{name:"Radio Button",Item:In(e)},{name:"Select",Item:Nn(e)},{name:"Select Native",Item:Bn(e)},{name:"Slider",Item:On(e)},{name:"Spinner",Item:Pn(e)},{name:"Switch",Item:Rn(e)},{name:"Tabs",Item:jn(e)},{name:"Theme Switch",Item:Wn(e)},{name:"Toggle",Item:Gn(e)},{name:"Toggle Group",Item:Fn(e)},{name:"Tooltip",Item:Vn(e)},{name:"Tree View",Item:Zn(e)}];return()=>o({class:n`
  ...
  `};po();const Kn={title:"Bau",base:"/bau/bau-ui"},me=yo({config:Kn}),{bau:Ql}=me;me.states={drawerOpen:Ql.state(!0)};Yl(me);to({routes:Kl({context:me}),onLocationChange:Jl({context:me,LayoutDefault:Io(me),config:Kn}),notFoundRoute:ql(me)});
