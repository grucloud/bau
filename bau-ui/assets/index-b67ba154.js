...
`}function ct(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let me=e=>Object.prototype.toString.call(e??0).slice(8,-1),dt=e=>me(e)=="Object",we=e=>me(e)=="Function",se=e=>["Object","Array"].includes(me(e)),ye=Object.getPrototypeOf,le=e=>ee(e)?e.val:e,ee=e=>e==null?void 0:e.__isState,ut=["splice","push","pop","shift","unshift","sort","reverse"],ae=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const U=e=>!ee(e[0])&&dt(e[0])?e:[{},...e];function mt(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,r=new Set,a=new Set,s=!1,l,i=f=>n.createElement(f),m=(f,x,k)=>{let C=l;l=x;let T=f(k);return l=C,T},d=()=>{o||(o=window.requestAnimationFrame(()=>{r.forEach(f=>{f.bindings=f.bindings.filter(x=>{var k;return(k=x.element)==null?void 0:k.isConnected}),!f.bindings.length&&!f.computed&&r.delete(f)}),o=void 0}))},c=(f,x,k,C,T,_)=>{var z;if(s){a.add(f);return}for(let X of f.bindings){let{deps:L,element:H,renderInferred:R,render:G,renderItem:V}=X;if(V&&x)(z=g(H,C,(...K)=>b(V(...K)),k,T,_)[x])==null||z.call();else{let K=R?R({element:H}):G({element:H,renderItem:V})(...L.map(le));K!==H&&H.replaceWith(X.element=b(K))}}E(f),d()},u=(f,x,k=[])=>({get(C,T,_){var z;if(l==null||l.add(f),T==="_isProxy")return!0;if(!((z=C[T])!=null&&z._isProxy)&&!ee(C[T])&&se(C[T]))C[T]=new Proxy(C[T],u(f,x,[...k,T]));else if(ut.includes(T)){let X=C[T];return(...L)=>{let H=X.apply(C,L);return c(f,T,H,L,x,k),H}}return Reflect.get(C,T,_)},set(C,T,_,z){let X=Reflect.set(C,T,_,z);return c(f,"setItem",X,{prop:T,value:_},x,[...k,T]),X}}),h=(f,x)=>new Proxy(x,u(f,x)),g=(f,x,k,C,T,_)=>{let z=()=>f.replaceChildren(...ae(C,k)),X=L=>f[L]&&f.removeChild(f[L]);return{assign:z,sort:z,reverse:z,setItem:()=>{var H;let L=_[0];(H=f.children[L])==null||H.replaceWith(k(T[L],L))},push:()=>f.append(...ae(x,(L,H)=>k(L,T.length+H))),unshift:()=>f.prepend(...ae(x,k)),pop:()=>X("lastChild"),shift:()=>X("firstChild"),splice:()=>{let[L,H,...R]=x;const{length:G}=f.children;for(let V=L>=0?Math.min(L+H-1,G-1):G-1;V>=(L>=0?L:G+L);V--)f.children[V].remove();if(R.length){let V=R.forEach((K,re)=>k(K,L+re));f.children[L]?f.children[L].after(...V):f.append(...V)}}}},p=f=>({oldVal:f,bindings:[],listeners:[],__isState:!0,get val(){let x=this;return l==null||l.add(x),x.valProxy??(x.valProxy=se(f)?h(x,f):f,x.valProxy)},set val(x){let k=this,C=k.val;se(x)?(k.valProxy=h(k,x),c(k,"assign",x)):x!==C&&(k.valProxy=x,c(k)),k.oldVal=C}}),b=f=>f==null||f===!1?i("span"):f.nodeType?f:n.createTextNode(f),v=(f,x)=>{let k=new Set;return x.val=m(f,k),k},w=f=>{let x=p(),k=v(f,x);x.computed=!0;for(let C of k)C.listeners.push({computed:f,deps:k,state:x});return x},E=f=>{for(let x of[...f.listeners])v(x.computed,x.state)},S=(f,...x)=>{if(x.length){let k=[];for(let C of x.flat(1/0))C!=null&&k.push(ee(C)?P({deps:[C],render:()=>T=>T}):we(C)?D({renderInferred:C}):b(C));f.append(...k)}},I={},N=(f,x)=>f&&(Object.getOwnPropertyDescriptor(f,x)??N(ye(f),x)),A=(f,x,k)=>{var C;return I[f+","+x]??(I[f+","+x]=((C=N(k,x))==null?void 0:C.set)??0)},B=(f,x)=>new MutationObserver((k,C)=>{k.filter(T=>T.removedNodes).forEach(T=>[...T.removedNodes].find(_=>_===f&&(x({element:f}),C.disconnect(),!0)))}).observe(f.parentNode,{childList:!0}),M=f=>new Proxy(function(k,...C){var X;let[T,..._]=U(C),z=f?n.createElementNS(f,k):i(k);for(let[L,H]of Object.entries(T)){if(L.startsWith("bau"))continue;let R=A(k,L,ye(z))?G=>z[L]=G:G=>z.setAttribute(L,G);H==null||(ee(H)?P({deps:[H],render:()=>()=>(R(H.val),z)}):we(H)&&(!L.startsWith("on")||H.isDerived)?D({renderInferred:()=>(R(H({element:z})),z)}):H.renderProp?P({deps:H.deps,render:()=>()=>(R(H.renderProp({element:z})(...H.deps.map(le))),z)}):R(H))}return S(z,..._),(X=T.bauCreated)==null||X.call(T,{element:z}),T.bauMounted&&t.requestAnimationFrame(()=>T.bauMounted({element:z})),T.bauUnmounted&&t.requestAnimationFrame(()=>B(z,T.bauUnmounted)),z},{get:(x,k)=>x.bind(void 0,k)}),O=(f,x,k)=>{f.element=b(k);for(let C of x)ee(C)&&(r.add(C),C.bindings.push(f));return f.element},D=({renderInferred:f,element:x})=>{let k=new Set,C=m(f,k,{element:x});return O({renderInferred:f},k,C)},P=({deps:f,element:x,render:k,renderItem:C})=>O({deps:f,render:k,renderItem:C},f,k({element:x,renderItem:C})(...f.map(le))),j=(f,x,k)=>P({deps:[f],render:({renderItem:C})=>T=>(x.append(...ae(T,C)),x),renderItem:k}),W=f=>{s=!0,f(),s=!1,a.forEach(c),a.clear()};return{tags:M(),tagsNS:M,state:p,bind:P,loop:j,derive:w,stateSet:r,batch:W}}const ht=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},pt=(e,t,n,o)=>{const r=e.createElement("style");r.id=n,r.append(o),(t??e.head).append(r)},bt=(e,t)=>e.reduce((n,o,r)=>n+o+(t[r]??""),"");function gt(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(r,...a)=>{const s=bt(r,a),l=ht(s);return!t.getElementById(l)&&pt(t,e==null?void 0:e.target,l,o(l,s)),l};return{css:n((o,r)=>`.${o} { ${r} }`),keyframes:n((o,r)=>`@keyframes ${o} { ${r} }`),createGlobalStyles:n((o,r)=>r)}}function ft(e){return{bau:mt(),...gt(),tr:n=>n,window,...e}}function $(...e){return e.filter(t=>t).join(" ")}function Y(e,t){const{bau:n,css:o}=e,r={root:o`
    ...
    `,a:o``,disabled:o`
      ...
      pointer-events: none;
      box-shadow: none;
    `};return function(...s){let[{color:l,variant:i="outline",size:m,disabled:d,href:c,...u},...h]=U(s);return(c?n.tags.a:n.tags.button)({...u,class:$(r.root,i,m,l,c?r.a:r.button,d&&r.disabled,t==null?void 0:t.class,u.class),disabled:d,href:c,...!c&&{type:"button"}},h)}}function vt(e){const{tr:t,bau:n,css:o,config:r}=e,{i:a,header:s,h1:l,div:i,a:m,img:d,b:c,ul:u,li:h}=n.tags,{svg:g,path:p}=n.tagsNS("http://www.w3.org/2000/svg"),b=n.state(!0),v=Y(e),w=()=>a({class:o`
          color: var(--font-color-inverse);
...
`,{hideToLeft:t`
 ...
 `});function he(e,t){const{bau:n,css:o,window:r}=e,{base:a=""}=t,s=({currentTree:D,data:P,onclickBack:j})=>b(E({href:`${a}${D.parentTree.children[0].data.href}`,onclick:j({currentTree:D}),class:o`
  ...
  `;return function(...b){let[{color:v,variant:w="outline",size:E,content:S,...I},...N]=U(b);const A=B=>{const{Header:M,Content:O,name:D}=B;return l({class:$(v,w,E),onclick:u(D)},m({class:()=>$(c.val==D&&"active")},d({type:"button","aria-controls":`bau-${D}`,"aria-expanded":({element:P})=>c.val==D},M(B))),a({class:"content",role:"region",id:`bau-${D}`,"data-state":({element:P})=>{const j=c.val==D;return h({element:P,open:j}),j}},O(B)))};return a({class:$("accordion",g,t==null?void 0:t.class,I.class)},s(r.map(A)))}}const J=["neutral","primary","success","danger","warning"],Tt=["plain","outline","solid"],F=e=>{const{bau:t,css:n}=e,{div:o,table:r,tbody:a,tr:s,td:l,thead:i,th:m}=t.tags;return function({Item:c,name:u}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},r(i(s(m(u??"Variant/Color"),J.map(h=>m(h)))),a(Tt.map(h=>s(m(h),J.map((g,p)=>l(c({color:g,variant:h},{index:p}))))))))}},$t=e=>{const{tr:t,bau:n,css:o}=e,{article:r,div:a,h3:s,h2:l,h1:i,p:m}=n.tags,d=F(e),c=(...g)=>a({class:o`
...
`};function oe(e,t){const{bau:n,css:o,createGlobalStyles:r}=e,{div:a}=n.tags;It({css:o,createGlobalStyles:r});const s=o`
  ...
  `},d={stack:o`
    ...
    `},c=({id:u,status:h})=>{const g=i.val.findIndex(p=>p.id===u);g!=-1&&(i.val[g].status=h)};return function(h={},...g){const p=({id:w})=>{c({id:w,status:"removing"});const E=i.val.findIndex(S=>S.id===w);E!=-1&&i.val.splice(E,1)},b=({Component:w})=>{const E={id:Math.random().toString(10).split(".")[1],Component:w,status:"inserting"};i.val.length>=a&&p({id:i.val[0].id}),i.val.push(E),setTimeout(()=>p(E),s)},v=w=>l({class:d.item,onclick:()=>p(w)},w.Component());return document.addEventListener("alert.add",w=>b(w.detail)),document.addEventListener("alert.remove",w=>p(w.detail)),l({class:$(d.stack,t==null?void 0:t.class,h.class)},n.loop(i,l(),v))}},Dt=e=>{const{tr:t,bau:n}=e,{section:o,h1:r}=n.tags,a=Bt(e,{deleteAfterDuration:2e4}),s=Y(e),l=oe(e);return function(){return o({id:"alert-stack"},a(),r("Alert stack"),s({color:"success",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>l({color:"success"},t("Infrastructure Created"))}}))}},"success alert"),s({color:"danger",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>l({color:"danger"},t("Error creating infrastructure"))}}))}},"danger alert"))}},Pt=({keyframes:e})=>({hideRight:e`
   from {
    transform: translateX(0%);
    opacity: 1;
  }
 ...
 `}),Nt=e=>{const{bau:t}=e,{section:n,div:o,h1:r}=t.tags,a=Te(),s=Y(e),l=Pt(e);return function(){const i=t.state(!0),m=o(),d=c=>{m.replaceChildren(a({parent:m,animationHide:`${l.hideRight} 0.5s`,animationShow:`${l.showRight} 0.5s`},o(c.val?"Ciao":"")))};return d(i),n({id:"animate"},o(r("Test Animate"),o(s({onclick:()=>{i.val=!i.val,d(i)}},()=>i.val?"Hide":"Show")),m))}};function Be(e,t){const{bau:n}=e,{span:o,img:r}=n.tags,a=n.state(!0),s=n.state(!1),l=()=>a.val=!1,i=m=>{a.val=!1,s.val=!0};return function(...d){let[{color:c,variant:u="outline",size:h,width:g=60,height:p=60,...b},...v]=U(d);return o({class:$(t==null?void 0:t.class,b.class)},()=>a.val?"Loading...":"",()=>s.val&&"Error",r({width:g,height:p,onload:l,onerror:i,class:$(t==null?void 0:t.class,c,u,h,b.class),...b}))}}const zt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,h2:a,h3:s}=n.tags,l=o`
  ...
  `,h=n.state(""),g=n.state(""),p=n.state(!1),b=n.state(0),v=()=>{p.val=!1};return function(...E){let[{variant:S="outline",color:I,size:N,id:A,label:B,placeholder:M,Option:O,options:D,getOptionLabel:P=({label:G})=>G,...j},...W]=U(E);const f=n.state(D),x=()=>{R.openDialog(),p.val=!0,g.val="",f.val=D},k=()=>{R.closeDialog(),p.val=!1,g.val=""},C=G=>{const{value:V}=G.target;g.val=V,V?f.val=D.filter(K=>P(K).match(new RegExp(`${V}`,"i"))):f.val=D},T=G=>{console.log("onclickButton",p.val),p.val?k():x()},_=G=>V=>{h.val=P(G),k()},z=G=>{switch(G.key){case"Escape":k();break;case"ArrowDown":b.val++;break;case"ArrowUp":b.val--;break;case"Enter":h.val=P(f.val[b.val]),g.val="",k();break}},X=d({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":B,onclick:T,class:$(S,I,N)},()=>!h.val&&B,h),L=a({id:A,value:g,placeholder:M,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":p,oninput:C,onkeydown:z,class:$(S,I,N)}),R=c({id:A,triggerEl:X,contentEl:(()=>r({class:$(S,I,N,"content")},L,()=>s(f.val.map((G,V)=>l({class:()=>$(b.val==V&&"active"),onclick:_(G)},O(G))))))(),onClose:v});return r({...j,class:$("autocomplete",u,t==null?void 0:t.class,j==null?void 0:j.class)},X,R)}}const Lt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:i}=n.tags,m=(...g)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,content:c,...u},...h]=U(l);return r({...u,class:$("badge",a,t==null?void 0:t.class,u==null?void 0:u.class)},r({class:$(i,m,d)},c),...h)}}const Ht=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s}=t.tags,l=(...c)=>r({class:n`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`).join(`
`))()}
  `;return function(...i){let[{color:m="neutral",variant:d="plain",size:c,...u},...h]=U(i);return r({...u,type:"date",class:$("calendar",s,m,d,c,t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const Rt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,label:i}=n.tags,m=F(e),d=(...g)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{size:i,variant:m="outline",color:d="neutral",onclick:c,...u},...h]=U(l);return r({...u,onclick:c,class:$("chip",a,i,m,d,c&&"clickable",t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const Vt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l}=n.tags,i=F(e),m=(...c)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,...c},...u]=U(l);return r({type:"checkbox",required:"required",...c,class:$(a,i,m,d,t==null?void 0:t.class,c==null?void 0:c.class)})}}const Ut=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,label:s,h2:l,form:i}=n.tags,m=F(e),d=Le(e),c=n.state(!1),u=n.state(!1),h=p=>b=>{p.val=!!b.target.checked},g=(...p)=>a({class:o`
        ...
        `},...p);return()=>r({id:"checkbox"},i(l(t("Checkbox Examples")),g(d({id:"myCheckbox",name:"myCheckbox",checked:c,onchange:h(c)}),s({for:"myCheckbox"},"My Checkbox")),g(d({id:"myCheckbox-disabled",disabled:!0,name:"myCheckbox-disabled",checked:u,onchange:h(u)}),s({for:"myCheckbox-disabled"},"My Disabled Checkbox")),l(t("Checkbox Table")),m({Item:(p,{index:b})=>d({id:`myCheckbox-${b}`,name:`myCheckbox-${b}`,...p})})))};function _t(e,t){const{bau:n,css:o}=e,{div:r}=n.tags,a=o`
    position: fixed;
    top: 80px;
    left: 0px;
    z-index: 2;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,openState:c,...u},...h]=U(l);return r({class:$(a,t==null?void 0:t.class,u.class)},r({class:()=>$("overlay",c.val&&"overlay-open"),onclick:()=>{c.val=!1}}),r({class:()=>$("content",c.val&&"content-open")},h))}}const Xt=e=>{const{tr:t,bau:n}=e,{section:o,h2:r}=n.tags,a=n.state(!1),s=_t(e),l=Y(e),i=Ie(e);return()=>o({id:"drawer"},r(t("Drawer")),l({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),s({openState:a},i()))},Wt=e=>{const{tr:t,bau:n,window:o,config:r}=e,{section:a,h2:s,h3:l}=n.tags,i=n.state(o.location.pathname.replace(r.base,"")),m=F(e),d={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},c=he(e,{base:r.base+"/components/drillDownMenu"});return()=>a({id:"drillDownMenu"},s(t("Drill Down Menu")),c({tree:d,pathnameState:i}),l("Drill Down Table"),m({Item:u=>c({tree:d,...u})}))};function He(e,t){const{bau:n,css:o}=e,{div:r,span:a,label:s,input:l}=n.tags,i={base:o`
    ...
    `};return function(d,...c){const{variant:u="outline",color:h="neutral",size:g,Component:p,disabled:b,...v}=d;return r({class:$(i.base,b&&i.disabled,t==null?void 0:t.class,d.class)},s({class:$(u,h,g)},p({disabled:b}),l({type:"file",disabled:b,...v})),a({class:"filename-display"}))}}const qt=e=>{const{tr:t,bau:n,css:o}=e,{svg:r,use:a}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,h3:i,h2:m,span:d}=n.tags,c=F(e),u=n.state("No file selected"),h=He(e),g=b=>{const v=b.target.files[0];v?u.val=v.name:u.val="No file selected"},p=({disabled:b})=>l({class:$(o`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`).join(`
`))()}
  `;return function(...i){let[{color:m="neutral",variant:d="outline",size:c,...u},...h]=U(i);return r({class:$("modal",s,m,d,c,t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const Zt=e=>{const{tr:t,bau:n}=e,{section:o,main:r,h2:a,header:s,footer:l,p:i,div:m}=n.tags,d=F(e),c=Y(e),u=je(e),h=()=>r(Array(10).fill("").map((b,v)=>i(v+1,". Some text here"))),g=b=>{const v=u({id:"my-dialog",...b},s("Header"),h(),l(c({variant:"outline",onclick:()=>{v.close()}},"Cancel"),c({variant:"solid",onclick:()=>{v.close()}},"OK")));return v},p=g({});return()=>o({id:"modal"},a(t("Modal Examples")),c({variant:"solid",onclick:()=>{p.showModal()}},"OPEN MODAL"),p,a(t("Modal Table")),d({Item:b=>{const v=g(b);return m(c({...b,onclick:()=>{v.showModal()}},"OPEN MODAL"),v)}}))},Jt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,h1:i,p:m}=n.tags,d=Y(e),c=(...I)=>a({class:o`
          display: flex;
          justify-content: space-between;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...I),u=pe(e),g=(()=>d({onclick:()=>v.open?v.closeDialog():v.openDialog()},"Click"))(),p=()=>a({},i("My content"),m("My Content")),b=p(),v=u({id:"my-popover-left",triggerEl:g,contentEl:b}),w=d({onclick:()=>S.open?S.closeDialog():S.openDialog()},"Click"),E=p(),S=u({id:"my-popover-left",triggerEl:w,contentEl:E});return()=>r({id:"popover",class:o``},l(t("Popover")),s("Basic Popover"),c(a(g,v),a(w,S)))};function Ge(e,t){const{bau:n,css:o}=e,{div:r,ul:a,li:s,button:l}=n.tags,i=pe(e),m=o`
    & button {
      cursor: pointer;
      display: inline-flex;
      align-items: center;
  ...
  `,d=n.state(""),c=n.state(!1),u=n.state(0);return function(...g){let[{color:p="neutral",variant:b="outline",size:v,id:w,label:E,Option:S,options:I,getOptionLabel:N=({label:C})=>C,...A},...B]=U(g);const M=()=>{k.openDialog(),c.val=!0},O=()=>{k.closeDialog(),c.val=!1},D=()=>{c.val=!1},P=C=>{c.val?O():M()},j=C=>T=>{d.val=N(C),O()},W=C=>{switch(C.preventDefault(),C.key){case"Escape":O();break;case"ArrowDown":u.val<I.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=I.length-1:u.val--;break;case"Enter":c.val?(d.val=N(I[u.val]),O()):M();break}},f=()=>a(I.map((C,T)=>s({class:()=>$(u.val==T&&"active"),onclick:j(C)},S(C)))),x=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":c,"aria-label":E,onclick:P,class:$(p,b,v)},()=>!d.val&&E,d),k=i({id:w,triggerEl:x,contentEl:f(),onClose:D});return r({...A,class:$("select",m,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:W},x,k)}}const Qt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:i}=n.tags,m=(...g)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`).join(`
`))()};
  `;return function(...i){let[{color:m="neutral",variant:d="outline",size:c,...u},...h]=U(i);return r({...u,type:"range",class:$("slider",m,d,c,s,t==null?void 0:t.class,u.class)},...h)}}const ea=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i,label:m,datalist:d,option:c,br:u}=n.tags,h=n.state(0),g=S=>{h.val=S==null?void 0:S.target.value},p=(...S)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...S),b=F(e),v=ne(e),w=ne(e),E=ne(e);return()=>r({id:"slider"},l(t("Slider")),i("Slider value: ",h),s("Basic Slider"),p(v({oninput:g,name:"slider-simple"})),s(t("Slider Table")),b({Item:S=>v(S)}),s("Slider Min Max: -1000 1000"),p(w({oninput:g,min:-1e3,max:1e3})),s("Slider Step 20"),p(v({oninput:g,step:20,min:-100,max:100})),s("Slider Vertical"),p(a({class:o`
              display: flex;
...
`);function Fe(e,t){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
  ...
  `;return function(...l){let[{color:i="neutral",variant:m="plain",size:d,...c},...u]=U(l);return r({...c,class:$("switch",a,i,m,d,t==null?void 0:t.class,c.class),type:"checkbox",required:"required"},...u)}}const na=e=>{const{tr:t,bau:n,css:o}=e,{section:r,form:a,label:s,div:l,h2:i}=n.tags,m=F(e),d=Fe(e);return()=>r({id:"switch"},i(t("Switch Examples")),a(l({class:o`
            ...
            `},s({for:"my-shinny-switch"},"My shinny switch"),d({id:"my-shinny-switch"}))),i(t("Switch Table")),m({Item:c=>l(d({...c,id:`my-switch-example-${c.color}-${c.variant}`}),d({...c,id:`my-switch-example-${c.color}-${c.variant}`,checked:!0}))}))};function de(e,t){const{bau:n,css:o}=e,{tabDefs:r}=t,{div:a,ul:s,li:l}=n.tags,i=n.state(r),m=n.state(r[0]),d=u=>i.val.find(h=>h.name==u),c={base:o`
      display: flex;
      flex-direction: column;
      & ul {
        display: flex;
    ...
    `};return function(...h){let[{color:g,variant:p="plain",size:b,...v},...w]=U(h);const E=I=>{const{Header:N,disabled:A,name:B}=I;return l({class:()=>$(m.val.name==B&&"active",A&&"disabled"),onclick:M=>M.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:B},bubbles:!0}))},N(I))},S=a({class:$(c.base,p,b,g,t==null?void 0:t.class,v.class)},n.loop(i,s(),E),()=>m.val.Content?m.val.Content({}):"");return S.addEventListener("tab.select",I=>{var B,M;const{tabName:N}=I.detail,A=d(N);A&&((B=m.val.exit)==null||B.call(),m.val=A,(M=A.enter)==null||M.call())},!1),S.addEventListener("tab.add",I=>{var A;const{tab:N}=I.detail;(A=N.enter)==null||A.call(),i.val.push(N)},!1),S.addEventListener("tab.remove",I=>{var A;const N=i.val.findIndex(B=>B.name==I.detail.tabName);N>0&&((A=i.val[N].exit)==null||A.call(),i.val.splice(N,1))},!1),S}}const oa=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i,i:m}=n.tags,d=F(e),c=Y(e),u=(...w)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...w),h=()=>({name:"New Tab",Header:({name:w})=>a(w),Content:()=>a("My Paragraph")}),p=de(e,{tabDefs:[{name:"Tab1",Header:()=>a("TAB"),Content:()=>a(i("My Tab 1 Content"))},{name:"Tab2",Header:()=>a("TAB 2"),Content:()=>a(i("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>a("Tab Disabled"),Content:()=>a(i("My tab Disabled"))}]}),v=de(e,{tabDefs:[{name:"Tab1",Header:()=>a(m({class:o`
                font-size: 1rem;
                margin: 0 0.3rem;
          ...
          `})),s("Add and remove tabs"),u(v({})),l(t("Tabs Table")),d({Item:w=>p(w)}))};function Q(e,t){const{bau:n,css:o,createGlobalStyles:r}=e,{div:a}=n.tags;r`
  :root {
...
`;const s=o`
  ...
  `;return function(...i){let[{...m},...d]=U(i);return a({...m,class:$("table-container",s,t==null?void 0:t.class,m==null?void 0:m.class)},...d)}}const ra=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s,th:l,td:i,tr:m,table:d,thead:c,tbody:u,caption:h}=t.tags;function g(B,M,O,D,P){return{name:B,calories:M,fat:O,carbs:D,protein:P}}const p=[g("Frozen yoghurt",159,6,24,4),g("Ice cream sandwich",237,9,37,4.3),g("Eclair",262,16,24,6),g("Cupcake",305,3.7,67,4.3),g("Gingerbread",356,16,49,3.9)],b=(...B)=>r({class:n`
    ...
    `});return()=>o({id:"table"},s(m("Table")),a("Basic Table"),b(E(d(h("Basic Table"),w(),u(p.map(v))))),a("Dense Table"),b(S(d(h("Dense Table"),w(),u(p.map(v))))),a("Zebra Table"),b(I(d(h("Zebra Table"),w(),u(p.map(v))))),a("Caption Bottom"),b(N(d(h("Caption Bottom Table"),w(),u(p.map(v))))),a("Overflow Header"),b(A(d(h("Overflow Header"),w(),u(p.map(v))))))};function Re(e,t){const{bau:n,css:o}=e,{div:r}=n.tags,a=Y(e),s=be(e),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,i=({label:h,icon:g,...p})=>a({variant:"plain","aria-label":h,title:h,...p},g),m=({count:h,totalCount:g,page:p,rowsPerPage:b})=>r({class:"pages-numbers"},Number(p-1)*Number(b)+(h>0?1:0),"-",Math.min(p*b,g)," of ",g),d=({count:h,page:g,rowsPerPage:p})=>r({class:"pages-numbers"},(g-1)*p+(h>0?1:0),"-",g*p),c=h=>h<=1,u=(h,g,p)=>h>=Math.ceil(g/p);return function(...g){let[{count:p=0,totalCount:b=0,page:v=1,rowsPerPage:w=50,onPageChange:E,isLoading:S=!1,disableFirst:I=()=>c(v),disablePrevious:N=()=>c(v),disableNext:A=()=>u(v,b,w),disableLast:B=()=>u(v,b,w),...M},...O]=U(g);const D=Math.max(0,Math.ceil(b/w)),P=E({page:1}),j=E({page:v-1}),W=E({page:v+1}),f=E({page:D});return r({...M,class:$("table-pagination",l,S&&"disabled",t==null?void 0:t.class,M==null?void 0:M.class)},s({class:"spinner",visibility:S,size:"md"}),b>0?m({count:p,totalCount:b,page:v,maxPages:D,rowsPerPage:w}):d({count:p,page:v,maxPages:D,rowsPerPage:w}),r(i({label:"First",icon:"⟪",onclick:P,disabled:I()}),i({label:"Previous",icon:"⟨",onclick:j,disabled:N()}),i({label:"Next",icon:"⟩",onclick:W,disabled:A()}),i({label:"Last",icon:"⟫",onclick:f,disabled:B()})))}}const sa=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.col"})),la=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:i}=t.tags,m=sa(45),d=({name:w,email:E})=>a(r(w),r(E)),c=()=>l(o({class:n`
    ...
    `}),g=t.state(m),p=t.state({count:m.length,totalCount:m.length,page:1,rowsPerPage:10}),b=t.derive(()=>g.val.slice(p.val.page*p.val.rowsPerPage,(p.val.page+1)*p.val.rowsPerPage)),v=({page:w})=>E=>{p.val.page=w};return()=>h(s(c(),()=>i(b.val.map(d))),()=>u({...p.val,onPageChange:v}))},ia=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:i,div:m}=t.tags,d=t.state(!1),c=t.state([]),u=t.state(""),h=t.derive(()=>c.val.length),g=t.state(1),p=t.state(10),b=t.derive(()=>c.val),v=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,w=({page:M})=>O=>{g.val=M,E(v({page:M,per_page:p.val}))};E(v({page:1,per_page:p.val}));async function E(M){try{d.val=!0;const O=await fetch(M,{});if(O.ok){const D=await O.json();c.val=D;return}throw O}catch(O){u.val=O.message}finally{d.val=!1}}const S=({name:M,description:O,stargazers_count:D})=>a(r(M),r(O),r({class:n`
      ...
      min-width: 650px;
    `}),B=({message:M})=>m(M);return()=>A(()=>N({rowsPerPage:p.val,page:g.val,count:h.val,totalCount:-1,isLoading:d.val,onPageChange:w,disableNext:()=>!1}),s(I(),()=>u.val&&B({message:u.val}),()=>i(b.val.map(S))))},ca=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s,tr:l}=t.tags,i=la(e),m=ia(e),d=(...c)=>r({class:n`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
          & .table-container {
            width: 100%;
    ...
    `}),h=()=>a({class:o`
        ...
        `},c({side:"bottom-start",titleEl:h()},d({},"bottom start")),c({side:"bottom-centered",titleEl:h()},d({},"bottom centered")),c({side:"bottom-end",titleEl:h()},d({},"bottom end")))];return()=>r({id:"tooltip"},s(t("Tooltip")),a({class:o`
          ...
          `},g()),s(t("Tooltip custom")),a({class:o`
            ...
            flex-direction: column;
            gap: 1rem;
          `},u({titleEl:h()},d({},"custom tooltip"))),s(t("Tooltip Table")),m({Item:p=>c({titleEl:h(),...p},d({},`${p.color} ${p.variant}`))}))},ua="light";function Ve(e,t){const{bau:n,css:o,window:r}=e,{input:a}=n.tags,s=d=>{r.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},l=()=>{try{return localStorage.getItem("theme")}catch{}},i=l();i?s(i):r.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):r.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(ua);const m=o`
    position: relative;
    width: 2rem;
    height: 2rem;
    display: flex;
  ...
  `;return function(...c){let[{color:u,variant:h="outline",size:g,...p},...b]=U(c);return a({required:"required",title:"Switch Theme",...p,class:$(m,u,h,g,t==null?void 0:t.class,p.class),type:"checkbox",checked:l()=="dark",onclick:v=>{s(v.target.checked?"dark":"light")}},...b)}}const ma=e=>{const{tr:t,bau:n,css:o}=e,{section:r,form:a,div:s,h2:l}=n.tags,i=F(e),m=Ve(e);return()=>r({id:"theme-switch"},l(t("Theme Switch")),a(s({class:o`
              display: flex;
              align-items: center;
              > * {
                margin: 0.5rem;
              }
            `},m({}))),l(t("Theme Switch Table")),i({Item:d=>m(d)}))},ha=({css:e,createGlobalStyles:t})=>(t`
:root {
  ...
  `,expanded:e`
    ...
    `});function Ue(e,t){const{bau:n,css:o,createGlobalStyles:r,window:a}=e,{renderMenuItem:s}=t,{ul:l,li:i,nav:m,div:d}=n.tags,c=ha({css:o,createGlobalStyles:r}),u=({element:b,closeState:v})=>{b.scrollHeight!=0&&(v.val?h(b):g(b))};function h(b){b.style.height=b.scrollHeight+"px";const v=()=>{b.removeEventListener("transitionend",v)};b.addEventListener("transitionend",v),a.requestAnimationFrame(()=>{b.style.height="0px"})}function g(b){const v=()=>{b.removeEventListener("transitionend",v),b.style.height=null};b.addEventListener("transitionend",v),b.style.height=b.scrollHeight+"px"}const p=({depth:b=1,maxDepth:v})=>w=>{const{children:E,expanded:S}=w,I=n.state(!S);return i({class:()=>$(E?I.val?c.collapsed:c.expanded:"")},d({class:o`
        ...
        `},a({class:o`
          ...
          `},s(t("Pages Examples")),ga(e)()))}}const va=e=>{const{bau:t,css:n,config:o}=e,{section:r,div:a,h1:s,span:l,p:i,ul:m,li:d,a:c,main:u,header:h,footer:g}=t.tags,{svg:p,use:b}=t.tagsNS("http://www.w3.org/2000/svg"),v=F(e),E=Me(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>a(i("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>a(i("Item 2 Content"))},{name:"Item3",Header:()=>"Item 3",Content:()=>a(i("Item 3 content"))}]}),S=oe(e),I=De(e),N=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],A=y=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},l(y.label),l(y.code)),B=Be(e,{class:n`
      > img {
        background: var(--color-gray-100);
        border-radius: 50%;
        margin: 0.3rem;
      }
    `}),M=ie(e),O={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},D=Pe(e),P=Y(e),j=Ne(e),W=ce(e),f=Le(e),x=ze(e),k={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#m1"},children:[{data:{name:"Sub Menu 1",href:"#menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu2"}}]},C=he(e,{base:o.base+"/components"}),T=({disabled:y})=>a({class:$(n`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
          ...
          `,y&&n`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},p({width:100,height:100,fill:"currentColor"},b({href:"uploadIcon.svg#Capa_1"})),l("Choose a file to upload")),_=He(e),z=Oe(e),X=je(e),L=()=>u(Array(10).fill("").map((y,q)=>i(q+1,". Some text here"))),H=y=>{const q=X({id:"my-dialog",...y},h("Header"),L(),g(P({variant:"outline",onclick:()=>{q.close()}},"Cancel"),P({variant:"solid",onclick:()=>{q.close()}},"OK")));return q},R=Ge(e),G=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],V=y=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},l(y.label),l(y.code)),K=ne(e),re=be(e),fe=Fe(e),_e=de(e,{tabDefs:[{name:"Tab1",Header:()=>a("TAB"),Content:()=>a(i("My Tab 1 Content"))},{name:"Tab2",Header:()=>a("TAB 2"),Content:()=>a(i("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>a("Tab Disabled"),Content:()=>a(i("My tab Disabled"))}]}),Xe=Ve(e),We=()=>l("My tooltip"),qe=ue(e),Ye={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},Ke=Ue(e,{renderMenuItem:({name:y,href:q})=>c({href:q,onclick:Ze=>{Ze.preventDefault()}},y)}),ve=[{name:"Accordion",Item:y=>E({...y})},{name:"Alert",Item:y=>S({...y},`Alert ${y.color}`)},{name:"Autocomplete",Item:y=>I({...y,options:N,Option:A,getOptionLabel:({label:q})=>q,label:"Country",placeholder:"Search countries",id:"country"})},{name:"Avatar",Item:y=>B({...y,src:"./grucloud.svg",alt:"GruCloud"})},{name:"Badge",Item:(y,{index:q})=>M({...y,content:`${q*100}`},"☏")},{name:"Breadcrumbs",Item:y=>D({...y,...O})},{name:"Button",Item:y=>P({...y},`${y.variant} ${y.color}`)},{name:"Button Group",Item:y=>j({...y},P({},"ONE"),P({},"TWO"),P({},"THREE"))},{name:"Calendar",Item:y=>W({...y})},{name:"Checkbox",Item:y=>f({id:`myCheckbox-${y.color}-${y.variant}`,name:`myCheckbox-${y.color}-${y.variant}`,...y})},{name:"Chip",Item:y=>x({...y},`Chip ${y.color}`)},{name:"DrillDown Menu",Item:y=>C({tree:k,...y})},{name:"File Input",Item:y=>_({Component:T,name:"file",accept:"text/*",onchange,...y})},{name:"Input",Item:y=>z({name:"my-input",id:"my-input-with",placeholder:"Enter text",...y})},{name:"Modal",Item:y=>{const q=H(y);return a(P({...y,onclick:()=>{q.showModal()}},"OPEN MODAL"),q)}},{name:"Select",Item:y=>a(R({...y,options:G,Option:V,getOptionLabel:({label:q})=>q,label:"Select a country..."}))},{name:"Slider",Item:y=>K({...y,id:`mySwitch-${y.color}-${y.variant}`})},{name:"Spinner",Item:y=>re(y)},{name:"Switch",Item:y=>a(fe({...y,id:`mySwitch-off-${y.color}-${y.variant}`}),fe({...y,id:`mySwitch-on-${y.color}-${y.variant}`,checked:!0}))},{name:"Tabs",Item:y=>_e(y)},{name:"Theme Switch",Item:y=>Xe(y)},{name:"Tooltip",Item:y=>qe({titleEl:We(),...y},P({},`${y.color} ${y.variant}`))},{name:"Tree View",Item:y=>Ke({...y,tree:Ye})}];return()=>r(s("Bau Component Gallery"),i("This page displays the components with various colors and variants."),m({class:n`
            display: inline-flex;
            flex-wrap: wrap;
            gap: 1rem;
            list-style: none;
            padding: 0;
          `},ve.map(({name:y})=>d(x({color:"primary"},c({href:`#${y}`},y))))),ve.map(y=>a({id:y.name,class:n`
              border: 1px dotted var(--color-emphasis-400);
              padding: 1rem;
              margin: 1rem;
            `},v(y))))},wa=({context:e})=>[{path:"",action:t=>({title:"Bau UI",component:Et(e)})},{path:"components",action:()=>({title:"Component",component:va(e)}),children:[{path:"accordion",action:()=>({title:"Accordion",component:$t(e)})},{path:"alert",action:()=>({title:"Alert",component:Mt(e)})},{path:"alertStack",action:()=>({title:"Alert Stack",component:Dt(e)})},{path:"animate",action:()=>({title:"Animate",component:Nt(e)})},{path:"autocomplete",action:()=>({title:"Autocomplete",component:Lt(e)})},{path:"avatar",action:()=>({title:"Avatar",component:zt(e)})},{path:"badge",action:()=>({title:"Badge",component:Ht(e)})},{path:"breadcrumb",action:()=>({title:"Breadcrumb",component:Ot(e)})},{path:"button",action:()=>({title:"Button",component:jt(e)})},{path:"buttonGroup",action:()=>({title:"Button Group",component:Ft(e)})},{path:"calendar",action:()=>({title:"Calendar",component:Rt(e)})},{path:"chip",action:()=>({title:"Chip",component:Vt(e)})},{path:"checkbox",action:()=>({title:"Checkbox",component:Ut(e)})},{path:"drawer",action:()=>({title:"Drawer",component:Xt(e)})},{path:"drillDownMenu",action:()=>({title:"DrillDown Menu",component:Wt(e)})},{path:"fileInput",action:()=>({title:"File Input",component:qt(e)})},{path:"input",action:()=>({title:"Input",component:Kt(e)})},{path:"modal",action:()=>({title:"Modal",component:Zt(e)})},{path:"popover",action:()=>({title:"Popover",component:Jt(e)})},{path:"select",action:()=>({title:"Select",component:Qt(e)})},{path:"slider",action:()=>({title:"Slider",component:ea(e)})},{path:"spinner",action:()=>({title:"Spinner",component:ta(e)})},{path:"switch",action:()=>({title:"Switch",component:na(e)})},{path:"table",action:()=>({title:"Table",component:ra(e)})},{path:"tablePagination",action:()=>({title:"Table Pagination",component:ca(e)})},{path:"tabs",action:()=>({title:"Tabs",component:oa(e)})},{path:"tooltip",action:()=>({title:"Tooltip",component:da(e)})},{path:"themeSwitch",action:()=>({title:"Theme Switch",component:ma(e)})},{path:"treeView",action:()=>({title:"Tree View",component:pa(e)})}]},{path:"pages",action:t=>({title:"Pages",component:fa(e)})}],ya=e=>({title:e.tr("Page Not Found"),component:()=>"Not Found"}),xa=({context:e,LayoutDefault:t,config:{base:n=""}})=>{const{window:o,bau:r,states:a}=e,s=r.state(),l=t({componentState:s});return document.getElementById("app").replaceChildren(l),({router:m})=>{const d=o.location.pathname.replace(n,""),{title:c,component:u,Layout:h=t}=m.resolve({pathname:d});a.pathname.val=d,s.val=u,document.title=`${c}`}},ka=e=>{const{createGlobalStyles:t}=e;it(e,{colorPalette:[["neutral",{h:"0",s:"0%",l:"40%"}],["primary",{h:"230",s:"48%",l:"47%"}],["secondary",{h:"338",s:"100%",l:"48%"}],["success",{h:"120",s:"100%",l:"32%"}],["info",{h:"194",s:"80%",l:"62%"}],["warning",{h:"43",s:"100%",l:"50%"}],["danger",{h:"358",s:"95%",l:"60%"}]]}),t`
    :root {
      --header-height: 3rem;
    }
    html {
