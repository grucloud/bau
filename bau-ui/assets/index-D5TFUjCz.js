...
`,Pu=t=>{const{bau:e,css:n}=t,{form:o,label:a,span:s,footer:i,p:r}=e.tags,c=qn(t),l=O(t),u=e.state(""),d=b=>{b.preventDefault(),alert(u.val)},m=n`
  ...
  `;return()=>o({onsubmit:d,class:m},a(s("Your Message:"),r(c({name:"message",placeholder:"Enter your message",rows:2,value:u,onchange:b=>u.val=b.target.value}))),i(l({type:"submit"},"Submit")))},zu=`import { Context } from "@grucloud/bau-ui/context";
import textareaAutosize from "@grucloud/bau-ui/textareaAutosize";
import button from "@grucloud/bau-ui/button";
