...
`)}
  ...
  `}function po(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let at=e=>Object.prototype.toString.call(e??0).slice(8,-1),mo=e=>at(e)=="Object",St=e=>at(e)=="Function",et=e=>["Object","Array"].includes(at(e)),Ct=Object.getPrototypeOf,tt=e=>we(e)?e.val:e,we=e=>e==null?void 0:e.__isState,go=["splice","push","pop","shift","unshift","sort","reverse"],je=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const Z=e=>!we(e[0])&&mo(e[0])?e:[{},...e];function bo(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=y=>n.createElement(y),l=(y,m,v)=>{let C=r;r=m;let E=y(v);return r=C,E},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(y=>{y.bindings=y.bindings.filter(m=>{var v;return(v=m.element)==null?void 0:v.isConnected}),!y.bindings.length&&!y.computed&&a.delete(y)}),o=void 0}))},p=(y,m,v,C,E,j)=>{var z;if(s){i.add(y);return}for(let V of y.bindings){let{deps:F,element:$,renderInferred:J,render:ne,renderItem:q}=V;if(q&&m)(z=b($,C,(...ee)=>h(q(...ee)),v,E,j)[m])==null||z.call();else{let ee=J?J({element:$}):ne({element:$,renderItem:q})(...F.map(tt));ee!==$&&$.replaceWith(V.element=h(ee))}}S(y),u()},d=(y,m,v=[])=>({get(C,E,j){var z;if(r==null||r.add(y),E==="_isProxy")return!0;if(!((z=C[E])!=null&&z._isProxy)&&!we(C[E])&&et(C[E]))C[E]=new Proxy(C[E],d(y,m,[...v,E]));else if(go.includes(E)){let V=C[E];return(...F)=>{let $=V.apply(C,F);return p(y,E,$,F,m,v),$}}return Reflect.get(C,E,j)},set(C,E,j,z){let V=Reflect.set(C,E,j,z);return p(y,"setItem",V,{prop:E,value:j},m,[...v,E]),V}}),g=(y,m)=>new Proxy(m,d(y,m)),b=(y,m,v,C,E,j)=>{let z=()=>y.replaceChildren(...je(C,v)),V=F=>y[F]&&y.removeChild(y[F]);return{assign:z,sort:z,reverse:z,setItem:()=>{var $;let F=j[0];($=y.children[F])==null||$.replaceWith(v(E[F],F))},push:()=>y.append(...je(m,(F,$)=>v(F,E.length+$))),unshift:()=>y.prepend(...je(m,v)),pop:()=>V("lastChild"),shift:()=>V("firstChild"),splice:()=>{const{length:F}=y.children;let[$,J=F,...ne]=m;for(let q=$>=0?Math.min($+J-1,F-1):F-1;q>=($>=0?$:F+$);q--)y.children[q].remove();if(ne.length){let q=ne.forEach((ee,se)=>v(ee,$+se));y.children[$]?y.children[$].after(...q):y.append(...q)}}}},f=y=>({oldVal:y,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=et(y)?g(m,y):y,m.valProxy)},set val(m){let v=this,C=v.val;et(m)?(v.valProxy=g(v,m),p(v,"assign",m)):m!==C&&(v.valProxy=m,p(v)),v.oldVal=C}}),h=y=>{if(y==null||y===!1){const m=c("span");return m.style.display="none",m}else return y.nodeType?y:n.createTextNode(y)},x=(y,m)=>{let v=new Set;return m.val=l(y,v),v},w=y=>{let m=f(),v=x(y,m);m.computed=!0;for(let C of v)C.listeners.push({computed:y,deps:v,state:m});return m},S=y=>{for(let m of[...y.listeners])x(m.computed,m.state)},k=(y,...m)=>{if(m.length){let v=[];for(let C of m.flat(1/0))C!=null&&v.push(we(C)?R({deps:[C],render:()=>E=>E}):St(C)?H({renderInferred:C}):h(C));y.append(...v)}},A={},B=(y,m)=>y&&(Object.getOwnPropertyDescriptor(y,m)??B(Ct(y),m)),T=(y,m,v)=>{var C;return A[y+","+m]??(A[y+","+m]=((C=B(v,m))==null?void 0:C.set)??0)},M=(y,m)=>new t.MutationObserver((v,C)=>{v.filter(E=>E.removedNodes).forEach(E=>[...E.removedNodes].find(j=>j===y&&(m({element:y}),C.disconnect(),!0)))}).observe(y.parentNode,{childList:!0}),P=(y,m)=>new t.MutationObserver((v,C)=>v.forEach(E=>m({record:E,element:y}))).observe(y,{childList:!0}),O=y=>new Proxy(function(v,...C){var V;let[E,...j]=Z(C),z=y?n.createElementNS(y,v):c(v);for(let[F,$]of Object.entries(E)){if(F.startsWith("bau"))continue;let J=T(v,F,Ct(z))?ne=>ne!==void 0&&(z[F]=ne):ne=>z.setAttribute(F,ne);$==null||(we($)?R({deps:[$],render:()=>()=>(J($.val),z)}):St($)&&(!F.startsWith("on")||$.isDerived)?H({renderInferred:()=>(J($({element:z})),z)}):$.renderProp?R({deps:$.deps,render:()=>()=>(J($.renderProp({element:z})(...$.deps.map(tt))),z)}):J($))}return E.bauChildMutated&&P(z,E.bauChildMutated),k(z,...j),z.autofocus&&z.focus&&t.requestAnimationFrame(()=>z.focus()),(V=E.bauCreated)==null||V.call(E,{element:z}),E.bauMounted&&t.requestAnimationFrame(()=>E.bauMounted({element:z})),E.bauUnmounted&&t.requestAnimationFrame(()=>M(z,E.bauUnmounted)),z},{get:(m,v)=>m.bind(void 0,v)}),N=(y,m,v)=>{y.element=h(v);for(let C of m)we(C)&&(a.add(C),C.bindings.push(y));return y.element},H=({renderInferred:y,element:m})=>{let v=new Set,C=l(y,v,{element:m});return N({renderInferred:y},v,C)},R=({deps:y,element:m,render:v,renderItem:C})=>N({deps:y,render:v,renderItem:C},y,v({element:m,renderItem:C})(...y.map(tt))),U=(y,m,v)=>R({deps:[y],render:({renderItem:C})=>E=>(m.append(...je(E,C)),m),renderItem:v}),L=y=>{s=!0,y(),s=!1,i.forEach(p),i.clear()};return{tags:O(),tagsNS:O,state:f,bind:R,loop:U,derive:w,stateSet:a,batch:L}}const ho=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},fo=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},vo=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function xo(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=vo(a,i),r=ho(s);return!t.getElementById(r)&&fo(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function yo(e){const t=bo(),n=xo();return uo(n),{bau:t,...n,tr:o=>o,window,...e}}function D(...e){return e.filter(t=>t).join(" ")}function Ve(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:D("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:p})=>{[...u.removedNodes].forEach(d=>{if(!s()||d.getAttribute("cloned"))return;const g=d.cloneNode(!0);g.setAttribute("cloned",!0),g.style.top=0,g.style.left=0,g.style.width=d.getAttribute("width"),g.style.height=d.getAttribute("height"),g.style.position="absolute",g.style.animation=s(),u.target.appendChild(g),g.addEventListener("animationend",()=>{var b;return(b=g.parentNode)==null?void 0:b.removeChild(g)})}),[...u.addedNodes].forEach(d=>{if(d.getAttribute("cloned"))return;p.style.position="relative";const g=d.getBoundingClientRect();if(d.setAttribute("width",g.width+"px"),d.setAttribute("height",g.height+"px"),r()){d.style.animation=r();const b=()=>{d.removeEventListener("animationend",b),d.style.animation=""};d.addEventListener("animationend",b)}})},...c},l)}}const oe=["neutral","primary","success","danger","warning"],wo=["plain","outline","solid"],So=["sm","md","lg"],Co=()=>oe.map(e=>`
&.button.plain.${e} {
  &:focus {
...
`);function rt(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Eo);const l=o`
  ...
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",...f},...h]=Z(p);return i({required:"required",title:"Switch Theme",...f,class:D("theme-switch",b,g,d,l,t==null?void 0:t.class,f.class),type:"checkbox",checked:r()=="dark",onclick:x=>{s(x.target.checked?"dark":"light")}},...h)}}function Ao(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:p,b:d,ul:g,li:b}=n.tags,{svg:f,path:h}=n.tagsNS("http://www.w3.org/2000/svg"),x=i.drawerOpen,w=X(e,{class:o`
    ...
    `}),S=rt(e),k=()=>s(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),A=()=>l({class:o`
        ...
        `},p(h),r(f.map(({href:x,name:w})=>c(s({href:x},w))))),g=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],b=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
        ...
        `},u({class:n`
          ...
          `},d({title:"Bau UI",links:g}),d({title:"Bau Ecosystem",links:b})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},i("v0.58.0"),i("MIT license")))}}function he(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:e`
   ...
   `});function st(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=L=>{var y;return((y=L.parentTree.data)==null?void 0:y.href)??L.parentTree.children[0].data.href},u=({variant:L,color:y,size:m,currentTree:v,data:C})=>S(T({variant:L,color:y,size:m,href:`${c}${l(v)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),T({variant:L,color:y,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},C.name)),p=({size:L,subTree:{data:{name:y,href:m},children:v=[]}})=>T({size:L,href:`${c}${m}`,"data-ischild":!v.length},y),d=({pathname:L,subTree:y})=>{var m;return L===((m=y==null?void 0:y.data)==null?void 0:m.href)},{renderHeader:g=u,renderMenuItem:b=p,isActive:f=d}=t,{li:h,nav:x,div:w,header:S,a:k}=n.tags,A=Ve(e),B=he(e),T=X(e,{class:o`
      &.button {
  ...
  `,N=({children:L,pathnameState:y,variant:m,color:v,size:C})=>B({class:D(m,v,C)},L.map(E=>h({class:()=>D(E.children&&"has-children",f({pathname:y.val,subTree:E})&&"active")},b({variant:m,color:v,size:C,subTree:E})))),H=({variant:L,color:y,size:m,currentTree:v,pathnameState:C})=>{const{children:E,parentTree:j,data:z,renderList:V}=v;return w({class:D("drillDownMenu",L,y,m)},j&&g({variant:L,color:y,size:m,data:z,currentTree:v}),E&&V?V({renderListDefault:N,children:E,pathnameState:C,variant:L,color:y,size:m}):N({children:E,pathnameState:C,variant:L,color:y,size:m}))},R=({tree:L,pathname:y})=>{let m=Pt({})({...L}),v=Lt(y)(m);return v||(v=m),v},U=n.state(a.location.pathname.replace(c,""));return a.document.addEventListener("click",L=>{const{target:y}=L,m=y.getAttribute("href");if(y.tagName==="A"&&m&&!m.startsWith("http")&&!m.startsWith("#")&&!m.startsWith("?")){let v=m.replace(c,"");r||(v=v.replace(y.hash,"")),U.val=v}}),function(y){const{size:m=t.size??"md",variant:v=t.variant??"plain",color:C=t.color??"neutral",tree:E,...j}=y;let z,V=n.derive(()=>(z=R({tree:E,pathname:U.val}),z)),F=1;const $=q=>{const{dataset:ee}=q.target;ee.buttonback=="true"?F=-1:ee.ischild=="false"?F=1:ee.ischild=="true"&&(F=0)},J=q=>{switch(q){case 1:return`${M} ${He}`;case-1:return`${P} ${He}`;default:return""}},ne=q=>{switch(q){case 1:return`${P} ${He} reverse`;case-1:return`${M} ${He} reverse`;default:return""}};return x({class:D(O,v,C,m,t==null?void 0:t.class,j.class),onclick:$},A({animationHide:()=>J(F),animationShow:()=>ne(F)},n.bind({deps:[V],render:()=>()=>H({variant:v,color:C,size:m,currentTree:z,pathnameState:U})})))}}const Mo=()=>oe.map(e=>`
&.input.${e} {
...
`);function ue(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(r){const{variant:c=t.variant??"outline",color:l=t.color??"neutral",...u}=r;return a({type:"text",...u,class:D("input",t.class,t.size??"md",l,c,i,u.class)})}}function it(e,t={}){const{bau:n,css:o,window:a}=e,i=ue(e,t);return function(r){const{variant:c=t.variant??"outline",color:l=t.color??"neutral",...u}=r,d=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(c=="solid"?"--font-color-inverse-secondary":`--color-${l}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,g=o`
    ...
    `;return i({type:"search",...u,color:l,variant:c,class:D("inputSearch",t.class,g,u.class)})}}function zt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:p,span:d}=n.tags,g=it(e,{variant:"plain",color:"neutral",size:"sm"}),f={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:w,children:S,pathnameState:k,variant:A,color:B,size:T})=>{const M=n.state(""),P=n.derive(()=>M.val==""?S:S.filter(N=>N.data.name.match(new RegExp(`${M.val}`,"i")))),O=N=>{M.val=N.target.value};return r({class:o`
          display: flex;
          flex-direction: column;
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:p,...d},...g]=Z(r);return a({...d,onclick:p,class:D("chip",t.class,c,l,u,p&&"clickable",i,d.class)},...g)}}function No(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;X(e);const c=n`
...
"Click me"
  ...
  `,g=({value:h,id:x,children:w=[]})=>{const S=c({class:()=>u.val==x?"active":"",href:`#${x}`});return S.innerHTML=h,r({class:()=>u.val==x?"active":""},S,w.length>0&&s(w.map(g)))},b=h=>h.tagName.charAt(1),f=({contentEl:h})=>{const x=h.querySelectorAll(l);let w=2,S={},k={children:[]},A=k;const B=A;let T=[A];return[...x].forEach(M=>{const P=b(M);M.setAttribute("id",M.textContent),!M.innerHTML.includes("<button")&&(S={value:M.innerHTML,id:M.id??M.textContent,children:[]},w==P?(k=S,A.children.push(k)):w<P?(T.push(A),A=k,k.children.push(S),k=S):w>P&&(A=T[P-1],T=T.slice(0,P-1),A.children.push(S),k=S),w=P)}),B};return function(...x){let[{size:w=t.size??"md",variant:S=t.variant??"plain",color:k=t.color??"neutral",contentEl:A,...B}]=Z(x);const T=f({contentEl:A}),M=p(()=>{const O=[...A.querySelectorAll(l)].find(N=>{const{top:H,height:R}=N.getBoundingClientRect();if(H+R>60)return!0});O&&(u.val=O==null?void 0:O.id)},100);return i({...B,class:D("tableOfContent",w,S,k,d,t==null?void 0:t.class,B==null?void 0:B.class),bauMounted:()=>{a.addEventListener("scroll",M)},bauUnmounted:()=>{a.removeEventListener("scroll",M)}},T.children&&s(T.children.map(g)))}}const tn=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:p,name:d}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(c(s(l(d??""),oe.map(g=>l(g)))),i(wo.map(g=>s(l(g),oe.map((b,f)=>r(p({color:b,variant:g},{index:f}))))))))}},Ra=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:i}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},So.map((s,r)=>i(e,{size:s})({color:"success",variant:"outline"},{size:s,index:r})))}},G=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:i,h1:s,p:r,h2:c,h3:l,pre:u,code:p}=t.tags;Te.registerLanguage("javascript",Qt);const d=en(e),g=Ne(e,{class:n`
      &.paper {
    ...
    `}),b=tn(e),f=Ra(e),h=({text:x})=>u({class:n`
        ...
        `},p({class:"hljs language-js",bauCreated:({element:w})=>{w.innerHTML=Te.highlight(x,{language:"js"}).value}}));return function(w){const S=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},s(w.title),r(w.description),w.gridItem&&!w.variantColorTableDisable&&[c("Variant/Color"),g(b({Item:w.gridItem(e)}))],w.gridItem&&!w.variantSizeDisable&&[c("Size"),r("Component with size: ",p("sm"),", ",p("md"),", and ",p("lg")),g(f({item:w.gridItem}))],c("Usage"),l("Import"),h({text:w.importStatement}),c("Examples"),w.examples.map(k=>i(l(k.title),r(k.description),g(k.createComponent(e)({})),h({text:k.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
...
`);function Xe(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${ja()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",data:f=[],...h}]=Z(p);const x=n.state(""),w=pt(e,{size:d,variant:g,color:b}),S=A=>B=>{x.val==A?x.val="":x.val=A},k=A=>{const{Header:B,Content:T,name:M}=A,P=()=>r({class:()=>D(x.val==M&&"active")},c({type:"button","aria-controls":`bau-${M}`,"aria-expanded":({element:N})=>x.val==M},B(A))),O=()=>a({id:`bau-${M}`,"data-state":({element:N})=>x.val==M},T(A));return s({class:D(b,g,d),onclick:S(M)},w({Header:P,Content:O}))};return a({class:D("accordion",l,t==null?void 0:t.class,h.class)},i(f.map(k)))}}const nn=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],s=Xe(e,t);return r=>s({...r,data:i})},Ha=e=>{const{bau:t}=e,{div:n,p:o,section:a}=t.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],s=Xe(e);return()=>a(s({data:i,color:"neutral",variant:"outline"}))},Ua=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`);function $e(e,t={}){const{bau:n,css:o}=e,{div:a,i}=n.tags,s=o`
    ...
    ${Ka()}
  `,r=X(e),c=({onclick:l})=>r({"aria-label":"Close",onclick:l,class:"button-close"},"✖");return function(...u){let[{size:p=t.size??"md",variant:d=t.variant??"outline",color:g=t.color??"neutral",onRemove:b,...f},...h]=Z(u);return a({...f,class:D("alert",`alert-${d}`,t.class,d,g,p,s,f.class),role:"alert"},i({class:"icon"},qa[g]),a({class:"content"},...h),b&&c({onclick:b}))}}const an=(e,t)=>{const n=$e(e,t);return o=>n({...o},`Alert ${(t==null?void 0:t.size)??""} `)},Ja=e=>{const{bau:t}=e,{h4:n,p:o}=t.tags,a=$e(e);return()=>a({color:"danger"},n("Something went wrong"),o("Error code ",404),o("Status ","Not Found"))},Ya=`import alert from "@grucloud/bau-ui/alert";
import { Context } from "@grucloud/bau-ui/context";
...
`,pr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:lr,createComponent:cr},{title:"Component hide and show",description:"Hide and show a component",code:dr,createComponent:ur}]},mr=e=>{const t=G(e);return()=>t(pr)};function Ce(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",...g},...b]=Z(l);return i({...g,class:D("skeleton",u,r,t==null?void 0:t.class,g==null?void 0:g.class)},...b)}}function mt(e,t={}){const{bau:n,css:o}=e,{div:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...d){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:f=t.color??"neutral",width:h=40,height:x=40,alt:w,...S},...k]=Z(d);const A=Ce(e,{class:D(o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${x}px;
          width: ${h}px;
        `,t==null?void 0:t.class,S.class)});return a({class:D(u,t==null?void 0:t.class,S.class)},()=>s.val&&A(),()=>r.val&&w,i({width:h,height:x,onload:c,onerror:l,class:()=>D(!s.val&&"visible",r.val&&"hide",f,b,g,u,t==null?void 0:t.class,S.class),...S}))}}const rn=(e,t)=>{const{css:n}=e,o=mt(e,{...t,class:n`
      > img {
        border-radius: 50%;
      }
...
`,vr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:br,createComponent:gr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:fr,createComponent:hr}],gridItem:rn},xr=e=>{const t=G(e);return()=>t(vr)};function Be(e,t){const{bau:n,css:o,window:a}=e,{dialog:i}=n.tags,s=Ne(e,{class:o`
    ...
    opacity: 0;
  `;return function(...l){let[{contentEl:u,triggerEl:p,onClose:d,...g},...b]=Z(l);const f=w=>{x.style.opacity=1,x.showModal();const S=p.getBoundingClientRect(),k=x.getBoundingClientRect();S.x<a.innerWidth/2?x.style.left=S.left+"px":x.style.left=S.right-k.width+"px",S.y<a.innerHeight/2?x.style.top=S.top+S.height+"px":(x.style.top=Math.max(0,S.top-k.height)+"px",x.scrollHeight>S.top&&(x.style.height=S.top+"px"))},h=w=>{const S=()=>{x.close(),x.removeEventListener("transitionend",S)};x.addEventListener("transitionend",S),x.style.opacity=0},x=i({role:"presentation",class:D("popover",r,t==null?void 0:t.class,g==null?void 0:g.class),onclick:w=>{w.stopPropagation(),w.target===x&&(h(),d==null||d.call())}},s(u));return x.closeDialog=h,x.openDialog=f,x}}const Ge={sm:12,md:16,lg:24},yr=()=>oe.map(e=>`
&.${e} {
...
100% {
  ...
  `;return function({size:u=t.size??"md",color:p=t.color??"primary",variant:d=t.variant??"outline",visibility:g=!0,...b}={}){const f=o`
      ...
      ${yr()}
    `;return i({class:{deps:[g],renderProp:()=>h=>D("spinner",f,p,d,h==!1?"":"visibility",t==null?void 0:t.class,b.class)},version:"1.1",x:"0px",y:"0px",width:Ge[u],height:Ge[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...b},s({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const wr=()=>oe.map(e=>`
...
`);function Ze(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${wr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",label:d,placeholder:g,Option:b,options:f,defaultOption:h,getOptionLabel:x,getOptionValue:w,onSelect:S=()=>{},id:k,required:A,name:B,loading:T,...M},...P]=Z(c);const O=Be(e),N=X(e),H=ue(e,{variant:u,color:p,size:l}),R=he(e),U=ve(e,{variant:u,color:p,size:l}),L=n.state(h),y=n.state(M.value),m=n.state(!1),v=n.state(0),C=()=>{m.val=!1},E=n.state(f),j=Y=>ie=>Y.val&&x(ie)==x(Y.val),z=()=>{pe.openDialog(),m.val=!0,y.val="",E.val=f,v.val=f.findIndex(j(L));const Y=Ee.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),se.scrollIntoView({block:"end"}))},V=()=>{pe.closeDialog(),m.val=!1,y.val="",v.val=0},F=Y=>{const{value:ie}=Y.target;y.val=ie,ie?E.val=f.filter(ce=>x(ce).match(new RegExp(`${ie}`,"i"))):E.val=f},$=Y=>{pe.open?V():z()},J=({option:Y,index:ie})=>ce=>{L.val=Y,v.val=ie,V()},ne=()=>{const Y=Ee.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},q=Y=>{switch(Y.key){case"Escape":V();break;case"ArrowDown":v.val<E.val.length-1?v.val++:v.val=0,ne();break;case"ArrowUp":v.val<=0?v.val=E.val.length-1:v.val--,ne();break;case"Enter":pe.open?(L.val=E.val[v.val],y.val="",V()):z(),Y.preventDefault();break}},ee=N({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":m,"aria-label":d,onclick:$,variant:u,color:p,size:l,class:T==!0&&"loading",disabled:T},()=>L.val?x(L.val):d,()=>T==!0&&U({visibility:T})),se=H({value:y,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":m,oninput:F,onkeydown:q,...M}),xe=H({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
...
`,Dr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Cr,createComponent:Sr},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Tr,createComponent:Ar},{title:"Default Option",description:"A autocomplete with a default option.",code:kr,createComponent:Er}],gridItem:sn},Mr=e=>{const t=G(e);return()=>t(Dr)};function cn(e,t={}){const{bau:n,css:o}=e,{span:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:p,...d},...g]=Z(r);return a({...d,class:D("badge",i,t==null?void 0:t.class,d==null?void 0:d.class)},a({class:D(u,l,c)},p),...g)}}const ln=(e,t)=>{const n=cn(e,t);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},Ir=e=>{const{bau:t}=e,{section:n}=t.tags,o=cn(e);return()=>n(o({content:"10"},"☏"))},Nr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,$r={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Nr,createComponent:Ir}],gridItem:ln},Br=e=>{const t=G(e);return()=>t($r)};function gt(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,{separator:c="〉"}=t,l=X(e),u=o`
  ...
  `;return function(...d){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:f=t.color??"neutral",items:h,...x},...w]=Z(d);return i({...x,class:D(u,t==null?void 0:t.class,x==null?void 0:x.class)},h.map(({href:S,name:k})=>s((S?l:r)({href:`${a.base}${S}`,color:f,variant:b,size:g,class:D(f,b,g)},k))))}}const un=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=gt(e,t);return a=>o({...a,...n})},Or=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=gt(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},Pr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`))()}
  ...
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:p=t.color??"neutral",...d},...g]=Z(c);return a({...d,type:"date",class:D("calendar",s,p,u,l,t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}const gn=(e,t)=>{const n=mn(e,t);return o=>n({...o})},Jr=e=>{const{bau:t}=e,{section:n,label:o}=t.tags,a=t.state("2023-08-08"),i=mn(e);return()=>n(o("Start date:",i({id:"start",min:"2023-01-01",max:"2024-12-31",value:a.val,oninput:s=>{a.val=s.target.value}})))},Yr=`import calendar from "@grucloud/bau-ui/calendar";
import { Context } from "@grucloud/bau-ui/context";
...
`,Qr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Yr,createComponent:Jr}],gridItem:gn},es=e=>{const t=G(e);return()=>t(Qr)};function ts(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:p=t.color??"neutral",slides:d,Slide:g,Previous:b,Next:f,...h}]=Z(c);const x=()=>{s.val<=0?s.val=d.length-1:s.val--},w=()=>{s.val>=d.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},d.map(g));return a({...h,class:D("carousel",l,i,t==null?void 0:t.class,h==null?void 0:h.class)},a({class:D("control","control-previous"),onclick:x},b()),a({class:D("control","control-next"),onclick:w},f()),S)}}const ns=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],os=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=X(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`);function fn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=X(e),r=Be(e),c=he(e),l=o`
    ${Ns()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",label:f,ListItem:h,items:x,...w},...S]=Z(p);const k=n.state(0),A=()=>{R.openDialog(),R.focus()},B=()=>{R.closeDialog()},T=()=>{R.open?B():A()},M=U=>{T(),U.preventDefault()},P=({item:U,index:L})=>y=>{k.val=L,B(),y.preventDefault()},O=U=>{switch(U.preventDefault(),U.key){case"Escape":B();break;case"ArrowDown":k.val<options.length-1?k.val++:k.val=0;break;case"ArrowUp":k.val<=0?k.val=options.length-1:k.val--;break;case"Enter":T();break}},N=()=>c({tabindex:"0",class:D(b,g)},x.map((U,L)=>i({class:()=>D(k.val==L&&"active"),onclick:P({item:U,index:L})},h(U)))),H=s({type:"button",onclick:M,color:b,variant:g,size:d},f),R=r({triggerEl:H,contentEl:N()});return a({...w,class:D("dropdownMenu",b,d,l,t==null?void 0:t.class,w==null?void 0:w.class),onkeydown:O},H,R)}}const $s=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,i=fn(e,t),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>i({...c,items:s,ListItem:r,label:"Action"})},Bs=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,i=fn(e),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(i({items:s,ListItem:r,label:"Action"}))},Os=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Rs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:_s,createComponent:zs}],gridItem:(e,t)=>vn(e,{base:"/components/drillDownMenu",hashBased:!0,...t})},js=e=>{const t=G(e);return()=>t(Rs)};function xn(e,t={}){const{bau:n,css:o}=e,{div:a,label:i,input:s}=n.tags,r={base:o`
    ...
    `};return function(l,...u){const{size:p=t.size??"md",variant:d=t.variant??"outline",color:g=t.color??"neutral",Component:b,disabled:f,...h}=l;return a({class:D(r.base,f&&r.disabled,t==null?void 0:t.class,l.class)},i({class:D(d,g,p)},b({disabled:f}),s({type:"file",disabled:f,...h})))}}const yn=(e,t)=>{const{tr:n,bau:o,css:a,config:i}=e,{svg:s,use:r}=o.tagsNS("http://www.w3.org/2000/svg"),{div:c,span:l}=o.tags,u=o.state("No file selected"),p=xn(e,t),d=b=>{const f=b.target.files[0];f?u.val=f.name:u.val="No file selected"},g=({disabled:b})=>c({class:D(a`
            display: flex;
            align-items: center;
            flex-direction: column;
          ...
          `,b&&a`
            ...
            `)},s({width:100,height:100,fill:"currentColor"},r({href:`${i.base}/uploadIcon.svg#Capa_1`})),l(n("Choose a file to upload")));return b=>p({Component:g,name:"file",accept:"text/*",onchange:d,...b})},Hs=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,u=n.state("No file selected"),p=xn(e),d=b=>{const f=b.target.files[0];f?u.val=f.name:u.val="No file selected"},g=({disabled:b})=>c({class:D(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`,Gs={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:Us,createComponent:Hs}],gridItem:yn},Fs=e=>{const t=G(e);return()=>t(Gs)};function Oe(e,t={}){const{bau:n,css:o}=e,{form:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",content:p,...d},...g]=Z(r);return a({...d,class:D("form",u,l,c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...g)}}function ht(e,t={}){const{bau:n,css:o,keyframes:a}=e,{span:i}=n.tags,s=a`
0% {
      opacity: 1;
}
100% {
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",loading:g,...b},...f]=Z(l);const h=X(e),x=ve(e);return n.bind({deps:[g],render:()=>w=>h({...b,class:D("loadingButton",u,p,d,r,w&&"loading",t==null?void 0:t.class,b==null?void 0:b.class)},x({size:u,variant:p,color:d,visibility:w}),i({class:w&&"loading"},f))})}}const Vs=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=ht(e),p=$e(e,{variant:"outline",color:"danger"}),d=ue(e),g=Oe(e,{class:n`
      & > header {
        text-align: center;
      }
      & > footer {
...
`).join(`
`))()}
  `;return function(...l){let[{size:u=t.size??"md",variant:p=t.variant??"plain",color:d=t.color??"neutral",...g},...b]=Z(l);return a({class:D("modal",r,d,p,u,t==null?void 0:t.class,g==null?void 0:g.class)},i(...b))}}const Tn=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:s}=t.tags,r=X(e),c=An(e),l=()=>o(Array(10).fill("").map((p,d)=>s(d+1,". Some text here"))),u=p=>{const d=c({id:"my-dialog",...p},a("Header"),l(),i(r({variant:"outline",color:p.color,onclick:()=>{d.close()}},"Cancel"),r({variant:"solid",color:p.color,onclick:()=>{d.close()}},"OK")));return d};return p=>{const d=u(p);return n(r({...p,onclick:()=>{d.showModal()}},"OPEN MODAL"),d)}},Si=e=>{const{bau:t}=e,{section:n,main:o,header:a,footer:i,p:s}=t.tags,r="neutral",c=X(e),l=An(e),u=()=>o(Array(10).fill("").map((d,g)=>s(g+1,". Some text here"))),p=l({id:"my-dialog"},a("Header"),u(),i(c({variant:"outline",color:r,onclick:()=>{p.close()}},"Cancel"),c({variant:"solid",color:r,onclick:()=>{p.close()}},"OK")));return()=>n(c({variant:"solid",color:"neutral",onclick:()=>{p.showModal()}},"OPEN MODAL"),p)},Ci=`import modal from "@grucloud/bau-ui/modal";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`);function Ti(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s}=n.tags,r=X(e),c=Be(e),l=he(e),u=qe(e,{color:"neutral",variant:"outline"}),p=o`
    ...
    ${Ai()}
  `;return function(...g){let[{size:b=t.size??"md",variant:f=t.variant??"outline",color:h=t.color??"neutral",name:x,label:w,Option:S,options:k,defaultValue:A=[],getOptionLabel:B,getOptionValue:T,renderValue:M,onSelect:P=()=>{},loading:O,...N},...H]=Z(g);const R=ve(e,{variant:f,color:h,size:b}),U=n.state(A),L=n.state(!1),y=n.state(0),m=()=>{J.openDialog(),J.focus(),L.val=!0},v=()=>{J.closeDialog(),L.val=!1},C=()=>{L.val=!1},E=q=>{J.open?v():m(),q.preventDefault()},j=()=>Array.from(ne.selectedOptions).map(({value:q})=>k.find(ee=>T(ee)==q)),z=q=>{switch(q.preventDefault(),q.key){case"Escape":v();break;case"ArrowDown":y.val<k.length-1?y.val++:y.val=0;break;case"ArrowUp":y.val<=0?y.val=k.length-1:y.val--;break;case"Enter":if(J.open){const ee=q.currentTarget.querySelectorAll("input")[y.val];ee.checked=!ee.checked;const se=ne.options[y.val+1];se.selected=!se.selected,U.val=j()}else m();break}},V=q=>ee=>{const se=[...ne.options].find(({value:xe})=>xe==T(q));ee.target.checked?se.selected=!0:se.selected=!1,U.val=j()},F=()=>l({tabindex:"0",class:D(h,f)},k.map((q,ee)=>i({class:()=>D(y.val==ee&&"active")},n.tags.label(u({checked:A.find(se=>T(se)==T(q)),name:`${x}-${T(q)}`,onchange:V(q)}),S(q))))),$=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":L,"aria-label":w,onclick:E,color:h,variant:f,size:b,class:O==!0&&"loading",disabled:O},()=>U.val.length?M(U.val):w,()=>O==!0&&R({visibility:O})),J=c({triggerEl:$,contentEl:F(),onClose:C}),ne=s({name:x,multiple:!0,...N},n.tags.option({value:""},"--Category--"),k.map(q=>n.tags.option({value:T(q),selected:A.find(ee=>T(ee)==T(q))},B(q))));return a({...N,class:D("multiSelect",h,b,p,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:z},ne,$,J)}}const Di=e=>{const{bau:t,css:n}=e,{div:o,span:a,form:i,footer:s}=t.tags,r=Ti(e),c=X(e,{variant:"outline",color:"neutral"}),l=Ie(e,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],p=g=>a(g.group),d=g=>{g.preventDefault();const{selectedOptions:b}=g.target.elements.myMultiSelect;var f=Array.from(b).map(({value:h})=>h);alert(JSON.stringify(f))};return()=>i({onsubmit:d,class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,Li={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Pi,createComponent:Oi}]},zi=e=>{const t=G(e);return()=>t(Li)};function _i(e,t={}){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
  ...
  `,u=({text:p})=>({name:d,label:g,href:b})=>s({href:`${a.base}${b}`},r({class:"sublabel"},p),i({class:`label ${p}`},g??d));return function(...d){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:f=t.color??"neutral",data:h={},...x}]=Z(d);const{next:w,previous:S}=h;return c({"data-paginationnav":JSON.stringify(h),"aria-label":"pages navigation",...x,class:D("paginationNavigation",g,l,t==null?void 0:t.class,x==null?void 0:x.class)},(S==null?void 0:S.href)&&u({text:"Previous"})(S),(w==null?void 0:w.href)&&u({text:"Next"})(w))}}const Ri=e=>{const{bau:t}=e,{section:n}=t.tags,o=_i(e),a={next:{name:"next page",label:"Popover",href:"/components/popover"},previous:{name:"previous page",label:"Paper",href:"/components/paper"}};return()=>n(o({variant:"solid",color:"primary",data:a}))},ji=`import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";
...
`);function Pe(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=X(e),l=Be(e),u=he(e),p=o`
    ...
    ${Yi()}
  `;return function(...g){let[{size:b=t.size??"md",variant:f=t.variant??"outline",color:h=t.color??"neutral",label:x,Option:w,options:S,defaultOption:k,getOptionLabel:A,getOptionValue:B,onSelect:T=()=>{},loading:M,...P},...O]=Z(g);const N=ve(e,{variant:f,color:h,size:b}),H=n.state(k?A(k):x),R=n.state(!1),U=n.state(0),L=()=>{V.openDialog(),V.focus(),R.val=!0},y=()=>{V.closeDialog(),R.val=!1},m=()=>{R.val=!1},v=$=>{V.open?y():L(),$.preventDefault()},C=({option:$,index:J})=>ne=>{H.val=A($),F.value=B($),F.setCustomValidity(""),U.val=J,y(),T($),ne.preventDefault()},E=$=>{switch($.preventDefault(),$.key){case"Escape":y();break;case"ArrowDown":U.val<S.length-1?U.val++:U.val=0;break;case"ArrowUp":U.val<=0?U.val=S.length-1:U.val--;break;case"Enter":V.open?(H.val=A(S[U.val]),F.value=B(r),y()):L();break}},j=()=>u({tabindex:"0",class:D(h,f)},S.map(($,J)=>i({class:()=>D(U.val==J&&"active"),onclick:C({option:$,index:J})},w($)))),z=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":R,"aria-label":x,onclick:v,color:h,variant:f,size:b,class:M==!0&&"loading",disabled:M},()=>!H.val&&x,H,()=>M==!0&&N({visibility:M})),V=l({triggerEl:z,contentEl:j(),onClose:m}),F=s(P,r({value:""},"--Select Category--"),S.map($=>r({value:B($)},A($))));return F.value=P.value,a({...P,class:D("select",h,b,p,t==null?void 0:t.class,P==null?void 0:P.class),onkeydown:E},F,z,V)}}const In=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Pe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Bt="stepper-vertical",_c=e=>{const{bau:t,window:n,css:o}=e,{footer:a,p:i,label:s,section:r,a:c,ul:l,li:u}=t.tags,p=ue(e),d=Oe(e),g=Ln(e,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`,hl={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:bl,createComponent:gl}]},fl=e=>{const t=G(e);return()=>t(hl)};function Hn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=bt(e),s=X(e),r=ve(e),c=o`
  ...
  `,l=({label:b,icon:f,...h})=>s({"aria-label":b,title:b,...h},f),u=({count:b,totalCount:f,page:h,rowsPerPage:x})=>a({class:"pages-numbers"},Number(h-1)*Number(x)+(b>0?1:0),"-",Math.min(h*x,f)," of ",f),p=({count:b,page:f,rowsPerPage:h})=>a({class:"pages-numbers"},(f-1)*h+(b>0?1:0),"-",f*h),d=b=>b<=1,g=(b,f,h)=>b>=Math.ceil(f/h);return function(...f){let[{size:h=t.size??"md",variant:x=t.variant??"outline",color:w=t.color??"neutral",count:S=0,totalCount:k=0,page:A=1,rowsPerPage:B=50,onPageChange:T,isLoading:M=!1,disableFirst:P=()=>d(A),disablePrevious:O=()=>d(A),disableNext:N=()=>g(A,k,B),disableLast:H=()=>g(A,k,B),...R},...U]=Z(f);const L=Math.max(0,Math.ceil(k/B)),y=T({page:1}),m=T({page:A-1}),v=T({page:A+1}),C=T({page:L}),E=[{label:"First",icon:"⟪",onclick:y,disabled:P()},{label:"Previous",icon:"⟨",onclick:m,disabled:O()},{label:"Next",icon:"⟩",onclick:v,disabled:N()},{label:"Last",icon:"⟫",onclick:C,disabled:H()}];return a({...R,class:D("table-pagination",c,M&&"disabled",t==null?void 0:t.class,R==null?void 0:R.class)},r({class:"spinner",visibility:M,size:"md"}),k>0?u({count:S,totalCount:k,page:A,maxPages:L,rowsPerPage:B}):p({count:S,page:A,maxPages:L,rowsPerPage:B}),i({variant:x,color:w},E.map(j=>l({...j,variant:x,color:w}))))}}const vl=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),xl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=vl(45),u=({name:w,email:S})=>i(a(w),a(S)),p=()=>r(o({class:n`
    ...
    `}),b=t.state(l),f=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),h=t.derive(()=>b.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),x=({page:w})=>S=>{f.val.page=w};return()=>g(s(p(),()=>c(h.val.map(u))),()=>d({...f.val,onPageChange:x}))},yl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),p=t.state([]),d=t.state(""),g=t.derive(()=>p.val.length),b=t.state(1),f=t.state(10),h=t.derive(()=>p.val),x=P=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(P).toString()}`,w=({page:P})=>O=>{b.val=P,S(x({page:P,per_page:f.val}))};S(x({page:1,per_page:f.val}));async function S(P){try{u.val=!0;const O=await fetch(P,{});if(O.ok){const N=await O.json();p.val=N;return}throw O}catch(O){d.val=O.message}finally{u.val=!1}}const k=({name:P,description:O,stargazers_count:N})=>i(a(P),a(O),a({class:n`
      ...
      min-width: 650px;
    `}),M=({message:P})=>l(P);return()=>T(()=>B({rowsPerPage:f.val,page:b.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:w,disableNext:()=>!1}),s(A(),()=>d.val&&M({message:d.val}),()=>c(h.val.map(k))))},wl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=xl(e),l=yl(e),u=(...p)=>a({class:n`
  ...
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",selected:d=!1,disabled:g,onChange:b,...f},...h]=Z(c);return i({type:"button",...f,"aria-pressed":{deps:[d],renderProp:()=>x=>x},class:{deps:[d],renderProp:()=>x=>D("toggle",l,p,u,s,x&&"selected",t==null?void 0:t.class,f==null?void 0:f.class)},disabled:g},h)}}const Un=(e,t)=>{const{bau:n}=e,o=_e(e,t);return a=>{const i=n.state(!1);return o({...a,selected:i,onclick:()=>i.val=!i.val},"Toggle Me")}},Sl=e=>{const{bau:t}=e,{section:n}=t.tags,o=_e(e),a=t.state(!1);return()=>n(o({variant:"plain",selected:a,onclick:()=>a.val=!a.val},"Toggle Me"))},Cl=`import toggle from "@grucloud/bau-ui/toggle";
...
`);function ft(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${Al()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",exclusive:p=!1,onChange:d=()=>{},...g},...b]=Z(r);const f=new Set,h=x=>{const{value:w}=x.target;p?(f.clear(),f.add(w)):f.has(w)?f.delete(w):f.add(w),d({event:x,values:[...f]})};return a({...g,class:D("toggle-group",c,u,l,i,t==null?void 0:t.class,g==null?void 0:g.class),onclick:h},...b)}}const Gn=(e,t)=>{const{bau:n}=e,o=ft(e,t),a=_e(e,t);return i=>{const s=n.state([""]),r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...i,onChange:({values:l})=>{s.val=l}},r.map(({label:l,value:u})=>()=>a({...i,value:u,selected:s.val.includes(u),"area-label":l},l)))}},Tl=e=>{const{bau:t}=e,{section:n}=t.tags,o=t.state([""]),a=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i=_e(e),s=ft(e),r="primary",c="solid",l=({values:u})=>{o.val=u};return()=>n(s({color:r,variant:c,exclusive:!0,onChange:l},a.map(({label:u,value:p})=>()=>i({color:r,variant:c,value:p,selected:o.val.includes(p),"area-label":u},u))))},Dl=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
