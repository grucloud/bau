...
`);function at(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(yo);const l=o`
    ...
    `}),C=at(e),A=()=>s(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},h({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),k=()=>l({class:o`
        ...
        `},u({class:n`
          ...
          `},p({title:"Bau UI",links:m}),p({title:"Bau Ecosystem",links:b})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},i("v0.44.0"),i("MIT license")))}}function Ce(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:e`
   ...
   `});function rt(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=L=>{var G;return((G=L.parentTree.data)==null?void 0:G.href)??L.parentTree.children[0].data.href},u=({variant:L,color:G,size:U,currentTree:y,data:g})=>C(T({variant:L,color:G,size:U,href:`${c}${l(y)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),T({variant:L,color:G,size:U,href:`${c}${g.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},g.name)),d=({size:L,subTree:{data:{name:G,href:U},children:y=[]}})=>T({size:L,href:`${c}${U}`,"data-ischild":!y.length},G),p=({pathname:L,subTree:G})=>{var U;return L===((U=G==null?void 0:G.data)==null?void 0:U.href)},{renderHeader:m=u,renderMenuItem:b=d,isActive:f=p}=t,{li:h,nav:w,div:x,header:C,a:A}=n.tags,k=Ge(e),I=Ce(e),T=V(e,{class:o`
      &.button {
...
"Click me"
  ...
  `,m=({value:h,id:w,children:x=[]})=>{const C=c({class:()=>u.val==w?"active":"",href:`#${w}`});return C.innerHTML=h,r({class:()=>u.val==w?"active":""},C,x.length>0&&s(x.map(m)))},b=h=>h.tagName.charAt(1),f=({contentEl:h})=>{const w=h.querySelectorAll(l);let x=2,C={},A={children:[]},k=A;const I=k;let T=[k];return[...w].forEach(M=>{const B=b(M);M.setAttribute("id",M.textContent),!M.innerHTML.includes("<button")&&(C={value:M.innerHTML,id:M.id??M.textContent,children:[]},x==B?(A=C,k.children.push(A)):x<B?(T.push(k),k=A,A.children.push(C),A=C):x>B&&(k=T[B-1],T=T.slice(0,B-1),k.children.push(C),A=C),x=B)}),I};return function(...w){let[{size:x=t.size??"md",variant:C=t.variant??"plain",color:A=t.color??"neutral",contentEl:k,...I}]=W(w);const T=f({contentEl:k}),M=d(()=>{const j=[...k.querySelectorAll(l)].find(Z=>{const{top:ne,height:L}=Z.getBoundingClientRect();if(ne+L>60)return!0});j&&(u.val=j==null?void 0:j.id)},100);return i({...I,class:D("tableOfContent",x,C,A,p,t==null?void 0:t.class,I==null?void 0:I.class),bauMounted:()=>{a.addEventListener("scroll",M)},bauUnmounted:()=>{a.removeEventListener("scroll",M)}},T.children&&s(T.children.map(m)))}}const en=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
        ...
        `},a(c(s(l(p??""),te.map(m=>l(m)))),i(vo.map(m=>s(l(m),te.map((b,f)=>r(d({color:b,variant:m},{index:f}))))))))}},_a=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:i}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},xo.map((s,r)=>i(e,{size:s})({color:"success",variant:"outline"},{size:s,index:r})))}},H=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:i,h1:s,p:r,h2:c,h3:l,pre:u,code:d}=t.tags;Te.registerLanguage("javascript",Jt);const p=Qt(e),m=Ne(e,{class:n`
      &.paper {
...
`,or={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:nr,createComponent:tr}]},ar=e=>{const t=H(e);return()=>t(or)},rr=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=Ge(e),s=V(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`,lr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:sr,createComponent:rr},{title:"Component hide and show",description:"Hide and show a component",code:cr,createComponent:ir}]},ur=e=>{const t=H(e);return()=>t(lr)};function an(e,t={}){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=d=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...p){let[{size:m=t.size??"md",variant:b=t.variant??"plain",color:f=t.color??"neutral",width:h=40,height:w=40,...x},...C]=W(p);return a({class:D(u,t==null?void 0:t.class,x.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:h,height:w,onload:c,onerror:l,class:D(f,b,m,u,t==null?void 0:t.class,x.class),...x}))}}const rn=e=>{const{css:t}=e,n=an(e,{class:t`
      > img {
        border-radius: 50%;
      }
    `});return o=>n({...o,src:"https://www.gravatar.com/avatar/00000000000000000000000000000000?d=robohash&f=y",alt:"my avatar"})},dr=e=>{const{bau:t,css:n}=e,{section:o}=t.tags,a=an(e,{class:n`
      > img {
...
`);function pt(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${fr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",label:p,placeholder:m,Option:b,options:f,getOptionLabel:h=({label:Y})=>Y,onSelect:w=()=>{},id:x,required:C,name:A,loading:k,...I},...T]=W(c);const M=dt(e),B=V(e),j=Se(e,{variant:u,color:d,size:l}),Z=Ce(e),ne=Me(e,{variant:u,color:d,size:l}),L=n.state(I.value);n.derive(()=>{L.val&&(ae.value=h(L.val),w(L.val))});const G=n.state(""),U=n.state(!1),y=n.state(0),g=()=>{U.val=!1},v=n.state(f),S=Y=>se=>Y.val&&h(se)==h(Y.val),E=()=>{ve.openDialog(),U.val=!0,G.val="",v.val=f,y.val=f.findIndex(S(L));const Y=pe.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),ee.scrollIntoView({block:"end"}))},P=()=>{ve.closeDialog(),U.val=!1,G.val="",y.val=0},$=Y=>{const{value:se}=Y.target;G.val=se,se?v.val=f.filter(me=>h(me).match(new RegExp(`${se}`,"i"))):v.val=f},K=Y=>{ve.open?P():E()},R=({option:Y,index:se})=>me=>{L.val=Y,y.val=se,P()},_=()=>{const Y=pe.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},q=Y=>{switch(console.log("onkeydown",Y.key,y.val),Y.key){case"Escape":P();break;case"ArrowDown":y.val<v.val.length-1?y.val++:y.val=0,_();break;case"ArrowUp":y.val<=0?y.val=v.val.length-1:y.val--,_();break;case"Enter":L.val=v.val[y.val],G.val="",P(),Y.preventDefault();break}},Q=B({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":U,"aria-label":p,onclick:K,variant:u,color:d,size:l,class:k==!0&&"loading",disabled:k},()=>L.val?h(L.val):p,()=>k==!0&&ne({visibility:k})),ee=j({value:G,placeholder:m,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":U,oninput:$,onkeydown:q,...I}),ae=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,value:G,required:C,name:A}),pe=a({class:D(u,d,l,"content")},ee,()=>Z({class:D(u,d,l)},v.val.map((Y,se)=>i({class:()=>D(y.val==se&&"active",S(L)(Y)&&"selected"),onclick:R({option:Y,index:se})},b(Y))))),ve=M({id:x,triggerEl:Q,contentEl:pe,onClose:g,class:o`
        overflow: hidden;
      `});return a({...I,class:D("autocomplete",s,t==null?void 0:t.class,I==null?void 0:I.class)},Q,ae,ve)}}const sn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=pt(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Tr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:kr,createComponent:Er}],gridItem:ln},Ar=e=>{const t=H(e);return()=>t(Tr)};function un(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,c=V(e),l=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
  ...
  `;return function(...d){let[{size:p=t.size??"md",variant:m=t.variant??"plain",color:b=t.color??"neutral",items:f,...h},...w]=W(d);return i({...h,class:D(l,t==null?void 0:t.class,h==null?void 0:h.class)},f.map(({href:x,name:C})=>s((x?c:r)({href:`${a.base}${x}`,color:b,variant:m,size:p,class:D(b,m,p)},C))))}}const dn=e=>{const t={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},n=un(e);return o=>n({...o,...t})},Ir=e=>{const{bau:t}=e,{section:n}=t.tags,o={variant:"outline",color:"neutral",items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},a=un(e);return()=>n(a(o))},Nr=`import breadcrumbs, {
...
`,Dr={title:"Breadcrumbs",package:"breadcrumbs",description:"The breadcrumbs component is an horizonal bar for navigation between pages",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/breadcrumbs/breadcrumbs.js",importStatement:'import breadcrumbs from "@grucloud/bau-ui/breadcrumbs";',examples:[{title:"Default",description:"A simple breadcrumbs.",code:Nr,createComponent:Ir}],gridItem:dn},Mr=e=>{const t=H(e);return()=>t(Dr)},pn=(e,t={})=>{const n=V(e,t);return o=>n({...o},`${o.variant} ${o.color} ${t.size??""}`)},Br=e=>{const{bau:t}=e,{section:n}=t.tags,o=V(e),a=()=>{alert("Click")};return()=>n(o({color:"primary",variant:"outline",onclick:a},"Click me"))},$r=`import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,_r={title:"Button",package:"button",description:"The button component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/button/button.js",importStatement:'import button from "@grucloud/bau-ui/button";',examples:[{title:"Solid Button",description:"A simple button.",code:$r,createComponent:Br},{title:"Disabled Button",description:"A disabled button.",code:Or,createComponent:Pr}],gridItem:pn},Lr=e=>{const t=H(e);return()=>t(_r)},Rr=()=>te.map(e=>`
&.button-group.${e} {
...
`);function mt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${Rr()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"plain",color:u=t.color??"neutral",...d},...p]=W(r);return a({...d,class:D("button-group",l,u,c,i,t==null?void 0:t.class,d==null?void 0:d.class)},...p)}}const mn=e=>{const t=["ONE","TWO","THREE"],n=V(e),o=mt(e);return a=>o({...a},t.map(i=>n(a,i)))},zr=e=>{const{bau:t}=e,{section:n}=t.tags,o=["ONE","TWO","THREE"],a=V(e),i=mt(e),s="primary",r="solid";return()=>n(i({color:s,variant:r},o.map(c=>a({color:s,variant:r},c))))},jr=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,rs={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:as,createComponent:os}],gridItem:vn},ss=e=>{const t=H(e);return()=>t(rs)},is=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=ut(e),i=V(e),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},cs=`import button from "@grucloud/bau-ui/button";
...
`,ls={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:cs,createComponent:is}]},us=e=>{const t=H(e);return()=>t(ls)};function ds(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    position: fixed;
    top: 80px;
    left: 0px;
    z-index: 2;
...
`,Ts={title:"Form",package:"form",description:"The form component displays an html form.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/form/form.js",importStatement:'import form from "@grucloud/bau-ui/form";',examples:[{title:"Login page",description:"A login page.",code:ks,createComponent:Es}]},As=e=>{const t=H(e);return()=>t(Ts)},yn=(e,t={})=>{const n=Se(e,t);return o=>n({name:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,id:`myinput-gallery-${t.color}-${t.variant}-${t.size}`,placeholder:"Enter text",...o})},Is=e=>{const{bau:t}=e,{section:n,h3:o}=t.tags,a=Se(e);return()=>n(o("Basic input"),a({id:"my-input",name:"my-input",placeholder:"Enter Text"}),o("Disabled input"),a({name:"my-input-disabled",placeholder:"Enter Text",disabled:!0}))},Ns=`import input from "@grucloud/bau-ui/input";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ds={title:"Input",package:"input",description:"The input component allows user to enter text.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/input/input.js",importStatement:'import input from "@grucloud/bau-ui/input";',examples:[{title:"Default",description:"A simple input.",code:Ns,createComponent:Is}],gridItem:yn},Ms=e=>{const t=H(e);return()=>t(Ds)};function Cn(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=()=>te.map(l=>`
&.${l}{
...
`,Ps={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:$s,createComponent:Bs}],gridItem:Sn},Os=e=>{const t=H(e);return()=>t(Ps)},En=e=>{const t=bt(e);return n=>t({...n,loading:!0},"Save")},_s=e=>{const{bau:t}=e,{section:n}=t.tags,o=bt(e),a=t.state(!0);return()=>n(o({variant:"solid",color:"primary",loading:a,onclick:()=>a.val=!a.val},"Save"))},Ls=`import loadingButton from "@grucloud/bau-ui/loadingButton";
...
`,Rs={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:Ls,createComponent:_s}],gridItem:En},zs=e=>{const t=H(e);return()=>t(Rs)},js=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Hs=(e,t)=>{const{bau:n,css:o}=e,{span:a,li:i}=n.tags,s=Ce(e,t),r=({code:c,label:l})=>i({class:o`
          display: flex;
          gap: 1rem;
...
`,Qs={title:"Popover",package:"popover",description:"The popover component display a dialog next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/popover/popover.js",importStatement:'import popover from "@grucloud/bau-ui/popover";',examples:[{title:"Default",description:"A simple popover.",code:Js,createComponent:Ys}]},ei=e=>{const t=H(e);return()=>t(Qs)};function ti(e,t={}){const{bau:n,css:o,config:a}=e,{div:i,a:s,span:r,nav:c}=n.tags,l=o`
    margin-top: 3rem;
    margin-bottom: 1rem;
    display: grid;
...
`,ai={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:oi,createComponent:ni}]},ri=e=>{const t=H(e);return()=>t(ai)},si=(e,t)=>{const{bau:n}=e,{div:o}=n.tags,a=Ne(e,t);return i=>a({...i},o(`Paper ${t.size??""}`))},ii=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=Ne(e);return()=>n(a({size:"md"},o("My content")))},ci=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
&.radio-button.${r} {
  ...
  `).join(`
`))()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",...p}]=W(c);return a({...p,type:"radio",class:D("radio-button",l,d,u,s,t==null?void 0:t.class,p==null?void 0:p.class)})}}const An=e=>{const{bau:t,css:n}=e,{label:o,form:a}=t.tags,i=Tn(e);return s=>a({class:n`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,mi={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:pi,createComponent:di}],gridItem:An},gi=e=>{const t=H(e);return()=>t(mi)},bi=()=>te.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`);function Ve(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=V(e),l=dt(e),u=Ce(e),d=o`
    ...
    ${bi()}
  `;return function(...m){let[{size:b=t.size??"md",variant:f=t.variant??"outline",color:h=t.color??"neutral",label:w,Option:x,options:C,getOptionLabel:A=({label:E})=>E,...k},...I]=W(m);const T=n.state(k.value),M=n.state(!1),B=n.state(0),j=()=>{v.openDialog(),v.focus(),M.val=!0},Z=()=>{v.closeDialog(),M.val=!1},ne=()=>{M.val=!1},L=E=>{M.val?Z():j(),E.preventDefault()},G=({option:E,index:P})=>$=>{T.val=A(E),S.value=T.val,S.setCustomValidity(""),B.val=P,Z(),$.preventDefault()},U=E=>{switch(E.preventDefault(),E.key){case"Escape":Z();break;case"ArrowDown":B.val<C.length-1?B.val++:B.val=0;break;case"ArrowUp":B.val<=0?B.val=C.length-1:B.val--;break;case"Enter":M.val?(T.val=A(C[B.val]),Z()):j();break}},y=()=>u({tabindex:"0",class:D(h,f)},C.map((E,P)=>i({class:()=>D(B.val==P&&"active"),onclick:G({option:E,index:P})},x(E)))),g=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":M,"aria-label":w,onclick:L,color:h,variant:f,size:b},()=>!T.val&&w,T),v=l({triggerEl:g,contentEl:y(),onClose:ne}),S=s(k,r({value:""},"--Select Category--"),C.map(E=>r(A(E))));return S.value=k.value,a({...k,class:D("select",h,b,d,t==null?void 0:t.class,k==null?void 0:k.class),onkeydown:U},S,g,v)}}const In=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ve(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},a(c.label),a(c.code));return c=>i({...c,options:s,Option:r,getOptionLabel:({label:l})=>l,label:"Select a country..."})},hi=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=Ve(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ei={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Si,createComponent:Ci}],gridItem:Dn},ki=e=>{const t=H(e);return()=>t(Ei)};function Ke(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    ${(()=>te.map(r=>`
&.slider.${r} {
  accent-color: var(--color-${r});
}
...
`,oc={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Default",description:"A simple switch.",code:nc,createComponent:tc}],gridItem:On},ac=e=>{const t=H(e);return()=>t(oc)},rc=()=>te.map(e=>`
&.tabs.solid.${e} {
}
`).join(`
...
`,gc={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:ic,createComponent:sc},{title:"Extended Tabs",description:"An extended tabs.",code:lc,createComponent:cc},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:dc,createComponent:uc},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:mc,createComponent:pc}],gridItem:_n},bc=e=>{const t=H(e);return()=>t(gc)};function Pe(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{div:i}=n.tags;a`
  :root {
...
`,Ic={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Ac,createComponent:Tc}]},Nc=e=>{const t=H(e);return()=>t(Ic)};function Rn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=mt(e),s=V(e),r=Me(e),c=o`
  ...
  `,l=({label:b,icon:f,...h})=>s({"aria-label":b,title:b,...h},f),u=({count:b,totalCount:f,page:h,rowsPerPage:w})=>a({class:"pages-numbers"},Number(h-1)*Number(w)+(b>0?1:0),"-",Math.min(h*w,f)," of ",f),d=({count:b,page:f,rowsPerPage:h})=>a({class:"pages-numbers"},(f-1)*h+(b>0?1:0),"-",f*h),p=b=>b<=1,m=(b,f,h)=>b>=Math.ceil(f/h);return function(...f){let[{size:h=t.size??"md",variant:w=t.variant??"outline",color:x=t.color??"neutral",count:C=0,totalCount:A=0,page:k=1,rowsPerPage:I=50,onPageChange:T,isLoading:M=!1,disableFirst:B=()=>p(k),disablePrevious:j=()=>p(k),disableNext:Z=()=>m(k,A,I),disableLast:ne=()=>m(k,A,I),...L},...G]=W(f);const U=Math.max(0,Math.ceil(A/I)),y=T({page:1}),g=T({page:k-1}),v=T({page:k+1}),S=T({page:U}),E=[{label:"First",icon:"⟪",onclick:y,disabled:B()},{label:"Previous",icon:"⟨",onclick:g,disabled:j()},{label:"Next",icon:"⟩",onclick:v,disabled:Z()},{label:"Last",icon:"⟫",onclick:S,disabled:ne()}];return a({...L,class:D("table-pagination",c,M&&"disabled",t==null?void 0:t.class,L==null?void 0:L.class)},r({class:"spinner",visibility:M,size:"md"}),A>0?u({count:C,totalCount:A,page:k,maxPages:U,rowsPerPage:I}):d({count:C,page:k,maxPages:U,rowsPerPage:I}),i({variant:w,color:x},E.map(P=>l({...P,variant:w,color:x}))))}}const Dc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Mc=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=Dc(45),u=({name:x,email:C})=>i(a(x),a(C)),d=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
...
`,_c={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:Oc,createComponent:Pc}],gridItem:zn},Lc=e=>{const t=H(e);return()=>t(_c)},Rc=()=>te.map(e=>`
&.toggle-group.${e} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${e}) !important;
  }
...
`,Uc={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:jc,createComponent:zc},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Gc,createComponent:Hc}],gridItem:jn},Fc=e=>{const t=H(e);return()=>t(Uc)};function vt(e,t={}){const{bau:n,css:o,window:a}=e,{div:i}=n.tags,s=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,Qc={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:Jc,createComponent:Yc}],gridItem:Gn},el=e=>{const t=H(e);return()=>t(Qc)},tl=({css:e,createGlobalStyles:t})=>(t`
:root {
...
`,{nav:e`
  ...
  `});function Un(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=tl({css:o,createGlobalStyles:a}),d=ut(e),p=({depth:m=1,maxDepth:b,color:f,variant:h,size:w})=>x=>{const{children:C,expanded:A}=x,k=n.state(!A),I=()=>l({class:o`
              ...
              display: flex;
              width: 100%;
            `,onclick:M=>{C&&(k.val=!k.val)}},i(x.data)),T=()=>s({class:D(f,w)},C.map(p({depth:m+1,maxDepth:b})));return r(d({size:w,Header:I,Content:C&&m<b&&T}))};return function({tree:b,maxDepth:f=1/0,size:h=t.size??"md",variant:w=t.variant??"outline",color:x=t.color??"neutral",...C}){return c({class:D(u.nav,h,w,x,t==null?void 0:t.class,C.class)},b.children&&s(b.children.map(p({maxDepth:f,color:x,variant:w,size:h}))))}}const Fn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Un(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},nl=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Un(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},ol=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,al={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:ol,createComponent:nl}],gridItem:Fn},rl=e=>{const t=H(e);return()=>t(al)},sl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:s,ul:r,li:c}=t.tags,l=en(e),u=V(e),d=[{name:"Accordion",Item:tn(e)},{name:"Alert",Item:on(e)},{name:"Autocomplete",Item:sn(e)},{name:"Avatar",Item:rn(e)},{name:"Badge",Item:ln(e)},{name:"Breadcrumbs",Item:dn(e)},{name:"Button",Item:pn(e)},{name:"Button Group",Item:mn(e)},{name:"Calendar",Item:bn(e)},{name:"Checkbox",Item:vn(e)},{name:"Chip",Item:hn(e)},{name:"DrillDown Menu",Item:xn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:wn(e)},{name:"Input",Item:yn(e)},{name:"Linear Progress",Item:Sn(e)},{name:"Loading Button",Item:En(e)},{name:"Modal",Item:kn(e)},{name:"Radio Button",Item:An(e)},{name:"Select",Item:In(e)},{name:"Select Native",Item:Dn(e)},{name:"Slider",Item:Mn(e)},{name:"Spinner",Item:Bn(e)},{name:"Switch",Item:On(e)},{name:"Tabs",Item:_n(e)},{name:"Theme Switch",Item:Gn(e)},{name:"Toggle",Item:zn(e)},{name:"Toggle Group",Item:jn(e)},{name:"Tooltip",Item:Hn(e)},{name:"Tree View",Item:Fn(e)}];return()=>o({class:n`
  ...
  `};co();const Wn={title:"Bau",base:"/bau/bau-ui"},be=fo({config:Wn}),{bau:dl}=be;be.states={drawerOpen:dl.state(!0)};ul(be);Jn({routes:il({context:be}),onLocationChange:ll({context:be,LayoutDefault:Ao(be),config:Wn}),notFoundRoute:cl(be)});
