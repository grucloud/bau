...
`);function ot(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(wo);const l=o`
    ...
    `}),S=ot(e),k=()=>s(f({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},v({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),I=()=>l({class:o`
        ...
        `},u({class:n`
          ...
          `},d({title:"Bau UI",links:g}),d({title:"Bau Ecosystem",links:b})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},i("v0.56.0"),i("MIT license")))}}function xe(e,t={}){const{bau:n,css:o}=e,{ul:a}=n.tags,i=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:e`
   ...
   `});function at(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=_=>{var w;return((w=_.parentTree.data)==null?void 0:w.href)??_.parentTree.children[0].data.href},u=({variant:_,color:w,size:m,currentTree:h,data:C})=>S(T({variant:_,color:w,size:m,href:`${c}${l(h)}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),T({variant:_,color:w,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},C.name)),p=({size:_,subTree:{data:{name:w,href:m},children:h=[]}})=>T({size:_,href:`${c}${m}`,"data-ischild":!h.length},w),d=({pathname:_,subTree:w})=>{var m;return _===((m=w==null?void 0:w.data)==null?void 0:m.href)},{renderHeader:g=u,renderMenuItem:b=p,isActive:f=d}=t,{li:v,nav:x,div:y,header:S,a:k}=n.tags,I=He(e),B=xe(e),T=K(e,{class:o`
      &.button {
  ...
  `,L=({children:_,pathnameState:w,variant:m,color:h,size:C})=>B({class:D(m,h,C)},_.map(E=>v({class:()=>D(E.children&&"has-children",f({pathname:w.val,subTree:E})&&"active")},b({variant:m,color:h,size:C,subTree:E})))),Z=({variant:_,color:w,size:m,currentTree:h,pathnameState:C})=>{const{children:E,parentTree:R,data:P,renderList:F}=h;return y({class:D("drillDownMenu",_,w,m)},R&&g({variant:_,color:w,size:m,data:P,currentTree:h}),E&&F?F({renderListDefault:L,children:E,pathnameState:C,variant:_,color:w,size:m}):L({children:E,pathnameState:C,variant:_,color:w,size:m}))},H=({tree:_,pathname:w})=>{let m=$t({})({..._}),h=Bt(w)(m);return h||(h=m),h},W=n.state(a.location.pathname.replace(c,""));return a.document.addEventListener("click",_=>{const{target:w}=_,m=w.getAttribute("href");if(w.tagName==="A"&&m&&!m.startsWith("http")&&!m.startsWith("#")&&!m.startsWith("?")){let h=m.replace(c,"");r||(h=h.replace(w.hash,"")),W.val=h}}),function(w){const{size:m=t.size??"md",variant:h=t.variant??"plain",color:C=t.color??"neutral",tree:E,...R}=w;let P,F=n.derive(()=>(P=H({tree:E,pathname:W.val}),P)),U=1;const $=ee=>{const{dataset:ae}=ee.target;ae.buttonback=="true"?U=-1:ae.ischild=="false"?U=1:ae.ischild=="true"&&(U=0)},q=ee=>{switch(ee){case 1:return`${A} ${_e}`;case-1:return`${N} ${_e}`;default:return""}},ne=ee=>{switch(ee){case 1:return`${N} ${_e} reverse`;case-1:return`${A} ${_e} reverse`;default:return""}};return x({class:D(z,h,C,m,t==null?void 0:t.class,R.class),onclick:$},I({animationHide:()=>q(U),animationShow:()=>ne(U)},n.bind({deps:[F],render:()=>()=>Z({variant:h,color:C,size:m,currentTree:P,pathnameState:W})})))}}const To=()=>te.map(e=>`
&.input.${e} {
...
`);function Fe(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${_a()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",data:f=[],...v}]=V(p);const x=n.state(""),y=ut(e,{size:d,variant:g,color:b}),S=I=>B=>{x.val==I?x.val="":x.val=I},k=I=>{const{Header:B,Content:T,name:A}=I,N=()=>r({class:()=>D(x.val==A&&"active")},c({type:"button","aria-controls":`bau-${A}`,"aria-expanded":({element:L})=>x.val==A},B(I))),z=()=>a({id:`bau-${A}`,"data-state":({element:L})=>x.val==A},T(I));return s({class:D(b,g,d),onclick:S(A)},y({Header:N,Content:z}))};return a({class:D("accordion",l,t==null?void 0:t.class,v.class)},i(f.map(k)))}}const Qt=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],s=Fe(e,t);return r=>s({...r,data:i})},za=e=>{const{bau:t}=e,{div:n,p:o,section:a}=t.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],s=Fe(e);return()=>a(s({data:i,color:"neutral",variant:"outline"}))},Ra=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`);function Xe(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${vr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:p=t.color??"neutral",label:d,placeholder:g,Option:b,options:f,defaultOption:v,getOptionLabel:x,getOptionValue:y,onSelect:S=()=>{},id:k,required:I,name:B,loading:T,...A},...N]=V(c);const z=We(e),L=K(e),Z=ye(e,{variant:u,color:p,size:l}),H=xe(e),W=we(e,{variant:u,color:p,size:l}),_=n.state(v),w=n.state(A.value),m=n.state(!1),h=n.state(0),C=()=>{m.val=!1},E=n.state(f),R=Y=>se=>Y.val&&x(se)==x(Y.val),P=()=>{ue.openDialog(),m.val=!0,w.val="",E.val=f,h.val=f.findIndex(R(_));const Y=Se.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),be.scrollIntoView({block:"end"}))},F=()=>{ue.closeDialog(),m.val=!1,w.val="",h.val=0},U=Y=>{const{value:se}=Y.target;w.val=se,se?E.val=f.filter(ie=>x(ie).match(new RegExp(`${se}`,"i"))):E.val=f},$=Y=>{ue.open?F():P()},q=({option:Y,index:se})=>ie=>{_.val=Y,h.val=se,F()},ne=()=>{const Y=Se.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},ee=Y=>{switch(Y.key){case"Escape":F();break;case"ArrowDown":h.val<E.val.length-1?h.val++:h.val=0,ne();break;case"ArrowUp":h.val<=0?h.val=E.val.length-1:h.val--,ne();break;case"Enter":ue.open?(_.val=E.val[h.val],w.val="",F()):P(),Y.preventDefault();break}},ae=L({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":m,"aria-label":d,onclick:$,variant:u,color:p,size:l,class:T==!0&&"loading",disabled:T},()=>_.val?x(_.val):d,()=>T==!0&&W({visibility:T})),be=Z({value:w,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":m,oninput:U,onkeydown:ee,...A}),Pe=Z({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,value:w,required:I,name:B}),Se=a({class:D(u,p,l,"content")},be,()=>H({class:D(u,p,l)},E.val.map((Y,se)=>i({class:()=>D(h.val==se&&"active",R(_)(Y)&&"selected"),onclick:q({option:Y,index:se})},b(Y))))),ue=z({id:k,triggerEl:ae,contentEl:Se,onClose:C,class:o`
        overflow: hidden;
      `});return a({...A,class:D("autocomplete",s,t==null?void 0:t.class,A==null?void 0:A.class)},n.bind({deps:[_],render:()=>Y=>{Y&&(Pe.value=y(Y),S(Y))}}),ae,Pe,ue)}}const on=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Xe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function Ie(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=K(e),l=We(e),u=xe(e),p=o`
    ...
    ${Oi()}
  `;return function(...g){let[{size:b=t.size??"md",variant:f=t.variant??"outline",color:v=t.color??"neutral",label:x,Option:y,options:S,defaultOption:k,getOptionLabel:I,getOptionValue:B,onSelect:T=()=>{},loading:A,...N},...z]=V(g);const L=we(e,{variant:f,color:v,size:b}),Z=n.state(k?I(k):x),H=n.state(!1),W=n.state(0),_=()=>{F.openDialog(),F.focus(),H.val=!0},w=()=>{F.closeDialog(),H.val=!1},m=()=>{H.val=!1},h=$=>{F.open?w():_(),$.preventDefault()},C=({option:$,index:q})=>ne=>{Z.val=I($),U.value=B($),U.setCustomValidity(""),W.val=q,w(),T($),ne.preventDefault()},E=$=>{switch($.preventDefault(),$.key){case"Escape":w();break;case"ArrowDown":W.val<S.length-1?W.val++:W.val=0;break;case"ArrowUp":W.val<=0?W.val=S.length-1:W.val--;break;case"Enter":F.open?(Z.val=I(S[W.val]),U.value=B(r),w()):_();break}},R=()=>u({tabindex:"0",class:D(v,f)},S.map(($,q)=>i({class:()=>D(W.val==q&&"active"),onclick:C({option:$,index:q})},y($)))),P=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":H,"aria-label":x,onclick:h,color:v,variant:f,size:b,class:A==!0&&"loading",disabled:A},()=>!Z.val&&x,Z,()=>A==!0&&L({visibility:A})),F=l({triggerEl:P,contentEl:R(),onClose:m}),U=s(N,r({value:""},"--Select Category--"),S.map($=>r({value:B($)},I($))));return U.value=N.value,a({...N,class:D("select",v,b,p,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:E},U,P,F)}}const Mn=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=Ie(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`);function Ne(e,t={}){const{bau:n,css:o,window:a}=e,{tabDefs:i}=t,{div:s,ul:r,li:c}=n.tags,l=o`
    ...
    ${Dc()}
  `;return function(...p){let[{size:d=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",...f},...v]=V(p);const x=n.state(i),y=a.location.hash.slice(1),S=T=>x.val.find(A=>A.name==T),k=n.state(S(y)??i[0]),I=T=>{const{Header:A,disabled:N,name:z}=T;return c({class:()=>D(k.val.name==z&&"active",N&&"disabled"),onclick:L=>L.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:z},bubbles:!0}))},A(T))},B=s({class:D("tabs",g,d,b,l,t==null?void 0:t.class,f.class)},n.loop(x,r(),I),n.bind({deps:[k],render:()=>({Content:T})=>T?T(f):""}));return B.addEventListener("tab.select",T=>{var z,L;const{tabName:A}=T.detail,N=S(A);N&&((z=k.val.exit)==null||z.call(),k.val=N,(L=N.enter)==null||L.call())},!1),B.addEventListener("tab.add",T=>{var N;const{tab:A}=T.detail;(N=A.enter)==null||N.call(),x.val.push(A)},!1),B.addEventListener("tab.remove",T=>{var N;const A=x.val.findIndex(z=>z.name==T.detail.tabName);A>0&&((N=x.val[A].exit)==null||N.call(),x.val.splice(A,1))},!1),B}}const Ln=(e,t)=>{const{bau:n}=e,{div:o,p:a,a:i}=n.tags,r=Ne(e,{tabDefs:[{name:"Tab1",Header:()=>i({href:"#Tab1"},"TAB 1"),Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>i({href:"#Tab2"},"TAB 2"),Content:()=>o(a("My tab 2 Content"))}],...t});return c=>r(c)},Mc=e=>{const{bau:t}=e,{div:n,p:o,a}=t.tags,s=Ne(e,{tabDefs:[{name:"Tab1",Header:()=>a({href:"#Tab1"},"TAB 1"),Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>a({href:"#Tab2"},"TAB 2"),Content:()=>n(o("My tab 2 Content"))}],variant:"outline",color:"neutral"});return()=>s({})},Ic=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Yc={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:qc,createComponent:Kc}]},Jc=e=>{const t=j(e);return()=>t(Yc)};function zn(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=mt(e),s=K(e),r=we(e),c=o`
  ...
  `,l=({label:b,icon:f,...v})=>s({"aria-label":b,title:b,...v},f),u=({count:b,totalCount:f,page:v,rowsPerPage:x})=>a({class:"pages-numbers"},Number(v-1)*Number(x)+(b>0?1:0),"-",Math.min(v*x,f)," of ",f),p=({count:b,page:f,rowsPerPage:v})=>a({class:"pages-numbers"},(f-1)*v+(b>0?1:0),"-",f*v),d=b=>b<=1,g=(b,f,v)=>b>=Math.ceil(f/v);return function(...f){let[{size:v=t.size??"md",variant:x=t.variant??"outline",color:y=t.color??"neutral",count:S=0,totalCount:k=0,page:I=1,rowsPerPage:B=50,onPageChange:T,isLoading:A=!1,disableFirst:N=()=>d(I),disablePrevious:z=()=>d(I),disableNext:L=()=>g(I,k,B),disableLast:Z=()=>g(I,k,B),...H},...W]=V(f);const _=Math.max(0,Math.ceil(k/B)),w=T({page:1}),m=T({page:I-1}),h=T({page:I+1}),C=T({page:_}),E=[{label:"First",icon:"⟪",onclick:w,disabled:N()},{label:"Previous",icon:"⟨",onclick:m,disabled:z()},{label:"Next",icon:"⟩",onclick:h,disabled:L()},{label:"Last",icon:"⟫",onclick:C,disabled:Z()}];return a({...H,class:D("table-pagination",c,A&&"disabled",t==null?void 0:t.class,H==null?void 0:H.class)},r({class:"spinner",visibility:A,size:"md"}),k>0?u({count:S,totalCount:k,page:I,maxPages:_,rowsPerPage:B}):p({count:S,page:I,maxPages:_,rowsPerPage:B}),i({variant:x,color:y},E.map(R=>l({...R,variant:x,color:y}))))}}const Qc=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),el=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=Qc(45),u=({name:y,email:S})=>i(a(y),a(S)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),d=zn(e),g=$e(e,{class:n`
      max-width: 650px;
    `}),b=t.state(l),f=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),v=t.derive(()=>b.val.slice(f.val.page*f.val.rowsPerPage,(f.val.page+1)*f.val.rowsPerPage)),x=({page:y})=>S=>{f.val.page=y};return()=>g(s(p(),()=>c(v.val.map(u))),()=>d({...f.val,onPageChange:x}))},tl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),p=t.state([]),d=t.state(""),g=t.derive(()=>p.val.length),b=t.state(1),f=t.state(10),v=t.derive(()=>p.val),x=N=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(N).toString()}`,y=({page:N})=>z=>{b.val=N,S(x({page:N,per_page:f.val}))};S(x({page:1,per_page:f.val}));async function S(N){try{u.val=!0;const z=await fetch(N,{});if(z.ok){const L=await z.json();p.val=L;return}throw z}catch(z){d.val=z.message}finally{u.val=!1}}const k=({name:N,description:z,stargazers_count:L})=>i(a(N),a(z),a({class:n`
            text-align: right;
          `},L)),I=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
