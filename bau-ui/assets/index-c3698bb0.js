...
`,{hideToLeft:t`
 ...
 `});function me(e,t){const{bau:n,css:o,window:r}=e,{base:a=""}=t,s=({currentTree:D,data:O,onclickBack:H})=>b(E({href:`${a}${D.parentTree.children[0].data.href}`,onclick:H({currentTree:D}),class:o`
          ...
          `},O.name)),l=({name:D,href:O})=>E({href:`${a}${O}`},D),c=({subTree:D})=>{var O;return r.location.pathname.replace(a,"")===((O=D==null?void 0:D.data)==null?void 0:O.href)},{renderHeader:m=s,renderMenuItem:d=l,isActive:i=c}=t,{ul:u,li:h,nav:g,div:p,header:b,a:v}=n.tags,y=$e(),E=X(e,{class:o`
      flex-grow: 1;
      justify-content: flex-start;
...
`);function ne(e,t){const{bau:n,css:o,createGlobalStyles:r}=e,{div:a,i:s}=n.tags;Bt({css:o,createGlobalStyles:r});const l=o`
 ...
 `}),Ht=e=>{const{bau:t}=e,{section:n,div:o,h1:r}=t.tags,a=$e(),s=X(e),l=Lt(e);return function(){const c=t.state(!0),m=o(),d=i=>{m.replaceChildren(a({parent:m,animationHide:`${l.hideRight} 0.5s`,animationShow:`${l.showRight} 0.5s`},o(i.val?"Ciao":"")))};return d(c),n({id:"animate"},o(r("Test Animate"),o(s({onclick:()=>{c.val=!c.val,d(c)}},()=>c.val?"Hide":"Show")),m))}};function Be(e,t){const{bau:n}=e,{span:o,img:r}=n.tags,a=n.state(!0),s=n.state(!1),l=()=>a.val=!1,c=m=>{a.val=!1,s.val=!0};return function(...d){let[{color:i,variant:u="outline",size:h,width:g=60,height:p=60,...b},...v]=R(d);return o({class:$(t==null?void 0:t.class,b.class)},()=>a.val?"Loading...":"",()=>s.val&&"Error",r({width:g,height:p,onload:l,onerror:c,class:$(t==null?void 0:t.class,i,u,h,b.class),...b}))}}const jt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,h2:a,h3:s}=n.tags,l=o`
    > img {
      background: var(--color-gray-100);
      border-radius: 50%;
      margin: 0.3rem;
    }
  `,c=G(e),m=Be(e,{class:o`
      > img {
        background: var(--color-gray-100);
        border-radius: 50%;
        margin: 0.3rem;
  ...
  `,i=n.state(""),u=n.state(""),h=n.state(!1),g=n.state(0),p=()=>{h.val=!1};return function(...v){let[{variant:y="outline",color:E,size:S,id:B,label:z,placeholder:I,Option:P,options:M,getOptionLabel:j=({label:A})=>A,...D},...O]=R(v);const H=n.state(M),_=()=>{N.openDialog(),h.val=!0,u.val="",H.val=M},f=()=>{N.closeDialog(),h.val=!1,u.val=""},x=A=>{const{value:V}=A.target;u.val=V,V?H.val=M.filter(W=>j(W).match(new RegExp(`${V}`,"i"))):H.val=M},C=A=>{console.log("onclickButton",h.val),h.val?f():_()},k=A=>V=>{i.val=j(A),f()},T=A=>{switch(A.key){case"Escape":f();break;case"ArrowDown":g.val++;break;case"ArrowUp":g.val--;break;case"Enter":i.val=j(H.val[g.val]),u.val="",f();break}},F=m({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,"aria-label":z,onclick:C,class:$(y,E,S)},()=>!i.val&&z,i),L=a({id:B,value:u,placeholder:I,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:x,onkeydown:T,class:$(y,E,S)}),N=c({id:B,triggerEl:F,contentEl:(()=>r({class:$(y,E,S,"content")},L,()=>s({class:$(y,E,S,"content")},H.val.map((A,V)=>l({class:()=>$(g.val==V&&"active"),onclick:k(A)},P(A))))))(),onClose:p});return r({...D,class:$("autocomplete",d,t==null?void 0:t.class,D==null?void 0:D.class)},F,N)}}const Ot=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:c}=n.tags,m=(...g)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...g),d=G(e),i=De(e),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],h=g=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
  ...
  `;return function(...l){let[{color:c,variant:m="outline",size:d,content:i,...u},...h]=R(l);return r({...u,class:$("badge",a,t==null?void 0:t.class,u==null?void 0:u.class)},r({class:$(c,m,d)},i),...h)}}const Gt=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s}=t.tags,l=(...i)=>r({class:n`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...d){let[{color:i,variant:u="outline",size:h,items:g,...p},...b]=R(d);return r({...p,class:$(c,t==null?void 0:t.class,p==null?void 0:p.class)},g.map(({href:v,name:y})=>a((v?s:l)({href:v,class:$(i,u,h)},y))))}}const Ft=e=>{const{tr:t,bau:n}=e,{section:o,h2:r,h3:a}=n.tags,s={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},l=G(e),c=Pe(e);return()=>o({id:"breadcrumbs"},r(t("Breadcrumbs")),a("Bacis Breadcrumb"),c(s),a("Breadcrumbs Table"),l({Item:m=>c({...m,...s})}))},Rt=e=>{const{bau:t,css:n}=e,{section:o,p:r,h3:a}=t.tags,s=G(e),l=X(e);return()=>o({id:"button",class:n`
          & button {
            margin: 0.5rem;
          }
...
`).join(`
`))()}
  `;return function(...c){let[{color:m="neutral",variant:d="plain",size:i,...u},...h]=R(c);return r({...u,type:"date",class:$("calendar",s,m,d,i,t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const _t=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,label:c}=n.tags,m=G(e),d=(...g)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{size:c,variant:m="outline",color:d="neutral",onclick:i,...u},...h]=R(l);return r({...u,onclick:i,class:$("chip",a,c,m,d,i&&"clickable",t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const Xt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l}=n.tags,c=G(e),m=(...i)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...i),d=ze(e);return()=>r({id:"chip"},l(t("Chip")),s("Chip Default"),m(d("My Chip")),s("Chip Clickable"),m(d({color:"danger",onclick:()=>{alert("Clicked")}},"Chip")),s("Chip Table"),c({Item:i=>d({...i},`Chip ${i.color}`)}))};function Le(e,t={}){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
    appearance: none;
  ...
  `;return function(...l){let[{color:c,variant:m="outline",size:d,...i},...u]=R(l);return r({type:"checkbox",required:"required",...i,class:$(a,c,m,d,t==null?void 0:t.class,i==null?void 0:i.class)})}}const Wt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,label:s,h2:l,form:c}=n.tags,m=G(e),d=Le(e),i=n.state(!1),u=n.state(!1),h=p=>b=>{p.val=!!b.target.checked},g=(...p)=>a({class:o`
          display: flex;
          align-items: center;
          label {
            margin-left: 1rem;
  ...
  `;return function(...l){let[{color:c,variant:m="outline",size:d,openState:i,...u},...h]=R(l);return r({class:$(a,t==null?void 0:t.class,u.class)},r({class:()=>$("overlay",i.val&&"overlay-open"),onclick:()=>{i.val=!1}}),r({class:()=>$("content",i.val&&"content-open")},h))}}const Yt=e=>{const{tr:t,bau:n}=e,{section:o,h2:r}=n.tags,a=n.state(!1),s=qt(e),l=X(e),c=Ie(e);return()=>o({id:"drawer"},r(t("Drawer")),l({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),s({openState:a},c()))},Kt=e=>{const{tr:t,bau:n,window:o,config:r}=e,{section:a,h2:s,h3:l}=n.tags,c=n.state(o.location.pathname.replace(r.base,"")),m=G(e),d={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},i=me(e,{base:r.base+"/components/drillDownMenu"});return()=>a({id:"drillDownMenu"},s(t("Drill Down Menu")),i({tree:d,pathnameState:c}),l("Drill Down Table"),m({Item:u=>i({tree:d,...u})}))};function He(e,t){const{bau:n,css:o}=e,{div:r,span:a,label:s,input:l}=n.tags,c={base:o`
    ...
    `};return function(d,...i){const{variant:u="outline",color:h="neutral",size:g,Component:p,disabled:b,...v}=d;return r({class:$(c.base,b&&c.disabled,t==null?void 0:t.class,d.class)},s({class:$(u,h,g)},p({disabled:b}),l({type:"file",disabled:b,...v})),a({class:"filename-display"}))}}const Zt=e=>{const{tr:t,bau:n,css:o}=e,{svg:r,use:a}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,h3:c,h2:m,span:d}=n.tags,i=G(e),u=n.state("No file selected"),h=He(e),g=b=>{const v=b.target.files[0];v?u.val=v.name:u.val="No file selected"},p=({disabled:b})=>l({class:$(o`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`;const s=o`
  ...
  `;return function(...c){let[{...m},...d]=R(c);return a({...m,class:$("table-container",s,t==null?void 0:t.class,m==null?void 0:m.class)},...d)}}const ca=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s,th:l,td:c,tr:m,table:d,thead:i,tbody:u,caption:h}=t.tags;function g(P,M,j,D,O){return{name:P,calories:M,fat:j,carbs:D,protein:O}}const p=[g("Frozen yoghurt",159,6,24,4),g("Ice cream sandwich",237,9,37,4.3),g("Eclair",262,16,24,6),g("Cupcake",305,3.7,67,4.3),g("Gingerbread",356,16,49,3.9)],b=(...P)=>r({class:n`
    ...
    `});return()=>o({id:"table"},s(m("Table")),a("Basic Table"),b(E(d(h("Basic Table"),y(),u(p.map(v))))),a("Dense Table"),b(S(d(h("Dense Table"),y(),u(p.map(v))))),a("Zebra Table"),b(B(d(h("Zebra Table"),y(),u(p.map(v))))),a("Caption Bottom"),b(z(d(h("Caption Bottom Table"),y(),u(p.map(v))))),a("Overflow Header"),b(I(d(h("Overflow Header"),y(),u(p.map(v))))))};function Re(e,t){const{bau:n,css:o}=e,{div:r}=n.tags,a=X(e),s=pe(e),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,expanded:e`
    ...
    `});function Ue(e,t){const{bau:n,css:o,createGlobalStyles:r,window:a}=e,{renderMenuItem:s}=t,{ul:l,li:c,nav:m,div:d}=n.tags,i=va({css:o,createGlobalStyles:r}),u=({element:b,closeState:v})=>{b.scrollHeight!=0&&(v.val?h(b):g(b))};function h(b){b.style.height=b.scrollHeight+"px";const v=()=>{b.removeEventListener("transitionend",v)};b.addEventListener("transitionend",v),a.requestAnimationFrame(()=>{b.style.height="0px"})}function g(b){const v=()=>{b.removeEventListener("transitionend",v),b.style.height=null};b.addEventListener("transitionend",v),b.style.height=b.scrollHeight+"px"}const p=({depth:b=1,maxDepth:v})=>y=>{const{children:E,expanded:S}=y,B=n.state(!S);return c({class:()=>$(E?B.val?i.collapsed:i.expanded:"")},d({class:o`
        ...
        `},a({class:o`
          ...
          `},s(t("Pages Examples")),xa(e)()))}}const ka=e=>{const{bau:t,css:n,config:o}=e,{section:r,div:a,h1:s,span:l,p:c,ul:m,li:d,a:i,main:u,header:h,footer:g,label:p}=t.tags,{svg:b,use:v}=t.tagsNS("http://www.w3.org/2000/svg"),y=G(e),S=Me(e,{accordionDefs:[{name:"Item1",Header:()=>"Item 1",Content:()=>a(c("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>a(c("Item 2 Content"))},{name:"Item3",Header:()=>"Item 3",Content:()=>a(c("Item 3 content"))}]}),B=ne(e),z=De(e),I=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],P=w=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
    ...
    `}),j=le(e),D={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},O=Pe(e),H=X(e),_=Ne(e),f=ie(e),x=Le(e),C=ze(e),k={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#m1"},children:[{data:{name:"Sub Menu 1",href:"#menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu2"}}]},T=me(e,{base:o.base+"/components"}),F=({disabled:w})=>a({class:$(n`
          ...
          `,w&&n`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},b({width:100,height:100,fill:"currentColor"},v({href:"uploadIcon.svg#Capa_1"})),l("Choose a file to upload")),L=He(e),U=je(e),N=Oe(e),A=()=>u(Array(10).fill("").map((w,q)=>c(q+1,". Some text here"))),V=w=>{const q=N({id:"my-dialog",...w},h("Header"),A(),g(H({variant:"outline",onclick:()=>{q.close()}},"Cancel"),H({variant:"solid",onclick:()=>{q.close()}},"OK")));return q},W=Ge(e),Y=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],Z=w=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},l(w.label),l(w.code)),oe=ae(e),_e=pe(e),ge=Fe(e),Xe=ce(e,{tabDefs:[{name:"Tab1",Header:()=>a("TAB"),Content:()=>a(c("My Tab 1 Content"))},{name:"Tab2",Header:()=>a("TAB 2"),Content:()=>a(c("My tab 2 Content"))},{name:"Tab Disabled",disabled:!0,Header:()=>a("Tab Disabled"),Content:()=>a(c("My tab Disabled"))}]}),We=Ve(e),qe=()=>l("My tooltip"),Ye=de(e),Ke={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},Ze=Ue(e,{renderMenuItem:({name:w,href:q})=>i({href:q,onclick:Je=>{Je.preventDefault()}},w)}),fe=[{name:"Accordion",Item:w=>S({...w})},{name:"Alert",Item:w=>B({...w},`Alert ${w.color}`)},{name:"Autocomplete",Item:w=>z({...w,options:I,Option:P,getOptionLabel:({label:q})=>q,label:"Country",placeholder:"Search countries",id:"country"})},{name:"Avatar",Item:w=>M({...w,src:"./grucloud.svg",alt:"GruCloud"})},{name:"Badge",Item:(w,{index:q})=>j({...w,content:`${q*100}`},"☏")},{name:"Breadcrumbs",Item:w=>O({...w,...D})},{name:"Button",Item:w=>H({...w},`${w.variant} ${w.color}`)},{name:"Button Group",Item:w=>_({...w},H({},"ONE"),H({},"TWO"),H({},"THREE"))},{name:"Calendar",Item:w=>a({class:n`
              border: 1px dotted var(--color-emphasis-200);
              font-size: smaller;
              color: var(--color-content-secondary);
              padding: 0.2rem;
