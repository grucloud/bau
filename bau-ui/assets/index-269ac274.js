...
`)}
  ...
  `}function ht(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let ue=e=>Object.prototype.toString.call(e??0).slice(8,-1),pt=e=>ue(e)=="Object",Ce=e=>ue(e)=="Function",re=e=>["Object","Array"].includes(ue(e)),ke=Object.getPrototypeOf,se=e=>ee(e)?e.val:e,ee=e=>e==null?void 0:e.__isState,bt=["splice","push","pop","shift","unshift","sort","reverse"],te=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const U=e=>!ee(e[0])&&pt(e[0])?e:[{},...e];function gt(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,r=new Set,a=new Set,s=!1,l,i=v=>n.createElement(v),m=(v,x,C)=>{let k=l;l=x;let $=v(C);return l=k,$},d=()=>{o||(o=window.requestAnimationFrame(()=>{r.forEach(v=>{v.bindings=v.bindings.filter(x=>{var C;return(C=x.element)==null?void 0:C.isConnected}),!v.bindings.length&&!v.computed&&r.delete(v)}),o=void 0}))},c=(v,x,C,k,$,_)=>{var N;if(s){a.add(v);return}for(let X of v.bindings){let{deps:j,element:L,renderInferred:G,render:V,renderItem:Y}=X;if(Y&&x)(N=b(L,k,(...Z)=>g(Y(...Z)),C,$,_)[x])==null||N.call();else{let Z=G?G({element:L}):V({element:L,renderItem:Y})(...j.map(se));Z!==L&&L.replaceWith(X.element=g(Z))}}E(v),d()},u=(v,x,C=[])=>({get(k,$,_){var N;if(l==null||l.add(v),$==="_isProxy")return!0;if(!((N=k[$])!=null&&N._isProxy)&&!ee(k[$])&&re(k[$]))k[$]=new Proxy(k[$],u(v,x,[...C,$]));else if(bt.includes($)){let X=k[$];return(...j)=>{let L=X.apply(k,j);return c(v,$,L,j,x,C),L}}return Reflect.get(k,$,_)},set(k,$,_,N){let X=Reflect.set(k,$,_,N);return c(v,"setItem",X,{prop:$,value:_},x,[...C,$]),X}}),h=(v,x)=>new Proxy(x,u(v,x)),b=(v,x,C,k,$,_)=>{let N=()=>v.replaceChildren(...te(k,C)),X=j=>v[j]&&v.removeChild(v[j]);return{assign:N,sort:N,reverse:N,setItem:()=>{var L;let j=_[0];(L=v.children[j])==null||L.replaceWith(C($[j],j))},push:()=>v.append(...te(x,(j,L)=>C(j,$.length+L))),unshift:()=>v.prepend(...te(x,C)),pop:()=>X("lastChild"),shift:()=>X("firstChild"),splice:()=>{let[j,L,...G]=x;const{length:V}=v.children;for(let Y=j>=0?Math.min(j+L-1,V-1):V-1;Y>=(j>=0?j:V+j);Y--)v.children[Y].remove();if(G.length){let Y=G.forEach((Z,oe)=>C(Z,j+oe));v.children[j]?v.children[j].after(...Y):v.append(...Y)}}}},p=v=>({oldVal:v,bindings:[],listeners:[],__isState:!0,get val(){let x=this;return l==null||l.add(x),x.valProxy??(x.valProxy=re(v)?h(x,v):v,x.valProxy)},set val(x){let C=this,k=C.val;re(x)?(C.valProxy=h(C,x),c(C,"assign",x)):x!==k&&(C.valProxy=x,c(C)),C.oldVal=k}}),g=v=>v==null||v===!1?i("span"):v.nodeType?v:n.createTextNode(v),f=(v,x)=>{let C=new Set;return x.val=m(v,C),C},y=v=>{let x=p(),C=f(v,x);x.computed=!0;for(let k of C)k.listeners.push({computed:v,deps:C,state:x});return x},E=v=>{for(let x of[...v.listeners])f(x.computed,x.state)},S=(v,...x)=>{if(x.length){let C=[];for(let k of x.flat(1/0))k!=null&&C.push(ee(k)?z({deps:[k],render:()=>$=>$}):Ce(k)?D({renderInferred:k}):g(k));v.append(...C)}},B={},P=(v,x)=>v&&(Object.getOwnPropertyDescriptor(v,x)??P(ke(v),x)),A=(v,x,C)=>{var k;return B[v+","+x]??(B[v+","+x]=((k=P(C,x))==null?void 0:k.set)??0)},M=(v,x)=>new MutationObserver((C,k)=>{C.filter($=>$.removedNodes).forEach($=>[...$.removedNodes].find(_=>_===v&&(x({element:v}),k.disconnect(),!0)))}).observe(v.parentNode,{childList:!0}),I=v=>new Proxy(function(C,...k){var X;let[$,..._]=U(k),N=v?n.createElementNS(v,C):i(C);for(let[j,L]of Object.entries($)){if(j.startsWith("bau"))continue;let G=A(C,j,ke(N))?V=>N[j]=V:V=>N.setAttribute(j,V);L==null||(ee(L)?z({deps:[L],render:()=>()=>(G(L.val),N)}):Ce(L)&&(!j.startsWith("on")||L.isDerived)?D({renderInferred:()=>(G(L({element:N})),N)}):L.renderProp?z({deps:L.deps,render:()=>()=>(G(L.renderProp({element:N})(...L.deps.map(se))),N)}):G(L))}return S(N,..._),(X=$.bauCreated)==null||X.call($,{element:N}),$.bauMounted&&t.requestAnimationFrame(()=>$.bauMounted({element:N})),$.bauUnmounted&&t.requestAnimationFrame(()=>M(N,$.bauUnmounted)),N},{get:(x,C)=>x.bind(void 0,C)}),H=(v,x,C)=>{v.element=g(C);for(let k of x)ee(k)&&(r.add(k),k.bindings.push(v));return v.element},D=({renderInferred:v,element:x})=>{let C=new Set,k=m(v,C,{element:x});return H({renderInferred:v},C,k)},z=({deps:v,element:x,render:C,renderItem:k})=>H({deps:v,render:C,renderItem:k},v,C({element:x,renderItem:k})(...v.map(se))),O=(v,x,C)=>z({deps:[v],render:({renderItem:k})=>$=>(x.append(...te($,k)),x),renderItem:C}),R=v=>{s=!0,v(),s=!1,a.forEach(c),a.clear()};return{tags:I(),tagsNS:I,state:p,bind:z,loop:O,derive:y,stateSet:r,batch:R}}const ft=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},vt=(e,t,n,o)=>{const r=e.createElement("style");r.id=n,r.append(o),(t??e.head).append(r)},wt=(e,t)=>e.reduce((n,o,r)=>n+o+(t[r]??""),"");function yt(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(r,...a)=>{const s=wt(r,a),l=ft(s);return!t.getElementById(l)&&vt(t,e==null?void 0:e.target,l,o(l,s)),l};return{css:n((o,r)=>`.${o} { ${r} }`),keyframes:n((o,r)=>`@keyframes ${o} { ${r} }`),createGlobalStyles:n((o,r)=>r)}}function xt(e){return{bau:gt(),...yt(),tr:n=>n,window,...e}}function T(...e){return e.filter(t=>t).join(" ")}function W(e,t){const{bau:n,css:o}=e,r={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
    ...
    `,a:o``,disabled:o`
      ...
      cursor: not-allowed;
      pointer-events: none;
    `};return function(...s){let[{color:l,variant:i,size:m,disabled:d,href:c,...u},...h]=U(s);return(c?n.tags.a:n.tags.button)({...u,class:T("button",r.root,i,m,l,c?r.a:r.button,d&&r.disabled,t==null?void 0:t.class,u.class),disabled:d,href:c,...!c&&{type:"button"}},h)}}const K=["neutral","primary","success","danger","warning"],Ct=["plain","outline","solid"],kt="light",St=()=>K.map(e=>`
...
`);function me(e,t){const{bau:n,css:o,window:r}=e,{input:a}=n.tags,s=d=>{r.document.documentElement.setAttribute("data-theme",d),localStorage.setItem("theme",d)},l=()=>{try{return localStorage.getItem("theme")}catch{}},i=l();i?s(i):r.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):r.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(kt);const m=o`
    ...
    ${St()}
  `;return function(...c){let[{color:u,variant:h="outline",size:b,...p},...g]=U(c);return a({required:"required",title:"Switch Theme",...p,class:T("theme-switch",m,u,h,b,t==null?void 0:t.class,p.class),type:"checkbox",checked:l()=="dark",onclick:f=>{s(f.target.checked?"dark":"light")}},...g)}}function Et(e){const{tr:t,bau:n,css:o,config:r}=e,{i:a,header:s,h1:l,div:i,a:m,img:d,b:c,ul:u,li:h}=n.tags,{svg:b,path:p}=n.tagsNS("http://www.w3.org/2000/svg"),g=n.state(!0),f=W(e,{class:o`
...
`,{hideToLeft:t`
 ...
 `});function he(e,t){const{bau:n,css:o,window:r}=e,{base:a=""}=t,s=({currentTree:D,data:z,onclickBack:O})=>g(E({href:`${a}${D.parentTree.children[0].data.href}`,onclick:O({currentTree:D}),class:o`
            flex-grow: 0;
          `},"←"),E({href:`${a}${z.href}`},z.name)),l=({name:D,href:z})=>E({href:`${a}${z}`},D),i=({subTree:D})=>{var z;return r.location.pathname.replace(a,"")===((z=D==null?void 0:D.data)==null?void 0:z.href)},{renderHeader:m=s,renderMenuItem:d=l,isActive:c=i}=t,{ul:u,li:h,nav:b,div:p,header:g,a:f}=n.tags,y=Me(),E=W(e,{class:o`
      &.button {
        flex-grow: 1;
...
`);function Pe(e,t){const{bau:n,css:o}=e,{accordionDefs:r}=t,{div:a,ul:s,li:l,header:i,h3:m,button:d}=n.tags,c=n.state(""),u=p=>g=>{c.val==p?c.val="":c.val=p},h=({element:p,open:g})=>{const f=()=>{p.removeEventListener("transitionend",f)};function y(S){S.addEventListener("transitionend",f),window.requestAnimationFrame(()=>{S.style.height="0px"})}function E(S){S.addEventListener("transitionend",f),S.style.height=S.scrollHeight+"px"}p.scrollHeight!=0&&(g?E(p):y(p))},b=o`
    ...
    ${Lt()}
  `;return function(...g){let[{color:f,variant:y="outline",size:E,content:S,...B},...P]=U(g);const A=M=>{const{Header:I,Content:H,name:D}=M;return l({class:T(f,y,E),onclick:u(D)},m({class:()=>T(c.val==D&&"active")},d({type:"button","aria-controls":`bau-${D}`,"aria-expanded":({element:z})=>c.val==D},I(M))),a({class:"content",role:"region",id:`bau-${D}`,"data-state":({element:z})=>{const O=c.val==D;return h({element:z,open:O}),O}},H(M)))};return a({class:T("accordion",b,t==null?void 0:t.class,B.class)},s(r.map(A)))}}const F=e=>{const{bau:t,css:n}=e,{div:o,table:r,tbody:a,tr:s,td:l,thead:i,th:m}=t.tags;return function({Item:c,name:u}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
...
`);function be(e,t){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
    ...
    ${Ut()}
  `;return function(l){const{size:i,variant:m="outline",color:d="neutral",name:c,id:u,disabled:h,...b}=l;return r({...b,class:T("input",i,d,m,a,t==null?void 0:t.class,b.class)})}}function ge(e,t){const{bau:n,css:o}=e,{ul:r}=n.tags,s=o`
    list-style: none;
    padding: 0;
    margin: 0 0;
    &.solid {
...
`).join(`
`))()}
  `;return function(...i){let[{color:m="neutral",variant:d="plain",size:c,...u},...h]=U(i);return r({...u,class:T("list",s,m,d,c,t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const _t=()=>K.map(e=>`
...
`);function ze(e,t){const{bau:n,css:o}=e,{div:r,li:a,ul:s}=n.tags,l=pe(e),i=W(e),m=be(e),d=ge(e),c=o`
    ...
    ${_t()}
  `,u=n.state(""),h=n.state(""),b=n.state(!1),p=n.state(0),g=()=>{b.val=!1};return function(...y){let[{variant:E="outline",color:S,size:B,id:P,label:A,placeholder:M,Option:I,options:H,getOptionLabel:D=({label:G})=>G,...z},...O]=U(y);const R=n.state(H),v=()=>{L.openDialog(),b.val=!0,h.val="",R.val=H},x=()=>{L.closeDialog(),b.val=!1,h.val=""},C=G=>{const{value:V}=G.target;h.val=V,V?R.val=H.filter(Y=>D(Y).match(new RegExp(`${V}`,"i"))):R.val=H},k=G=>{b.val?x():v()},$=({option:G,index:V})=>Y=>{u.val=D(G),p.val=V,x()},_=G=>{switch(console.log("onkeydown",G.key,p.val),G.key){case"Escape":x();break;case"ArrowDown":p.val<R.val.length-1?p.val++:p.val=0;break;case"ArrowUp":p.val<=0?p.val=R.val.length-1:p.val--;break;case"Enter":u.val=D(R.val[p.val]),h.val="",x();break}},N=i({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":b,"aria-label":A,onclick:k,variant:E,color:S,size:B},()=>!u.val&&A,u),X=m({id:P,value:h,placeholder:M,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":b,oninput:C,onkeydown:_,variant:E,color:S,size:B}),L=l({id:P,triggerEl:N,contentEl:(()=>r({class:T(E,S,B,"content")},X,()=>d({class:T(E,S,B)},R.val.map((G,V)=>a({class:()=>T(p.val==V&&"active"),onclick:$({option:G,index:V})},I(G))))))(),onClose:g});return r({...z,class:T("autocomplete",c,t==null?void 0:t.class,z==null?void 0:z.class)},N,L)}}const Xt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:i}=n.tags,m=(...b)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,content:c,...u},...h]=U(l);return r({...u,class:T("badge",a,t==null?void 0:t.class,u==null?void 0:u.class)},r({class:T(i,m,d)},c),...h)}}const Wt=e=>{const{bau:t,css:n}=e,{section:o,div:r,h3:a,h2:s}=t.tags,l=(...c)=>r({class:n`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`))()}
  ...
  `;return function(...i){let[{color:m="neutral",variant:d="plain",size:c,...u},...h]=U(i);return r({...u,type:"date",class:T("calendar",s,m,d,c,t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const Jt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,label:i}=n.tags,m=F(e),d=(...b)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{size:i,variant:m="outline",color:d="neutral",onclick:c,...u},...h]=U(l);return r({...u,onclick:c,class:T("chip",a,i,m,d,c&&"clickable",t==null?void 0:t.class,u==null?void 0:u.class)},...h)}}const Qt=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l}=n.tags,i=F(e),m=(...c)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
  ...
  `;return function(...l){let[{color:i,variant:m="outline",size:d,openState:c,...u},...h]=U(l);return r({class:T(a,t==null?void 0:t.class,u.class)},r({class:()=>T("overlay",c.val&&"overlay-open"),onclick:()=>{c.val=!1}}),r({class:()=>T("content",c.val&&"content-open")},h))}}const aa=e=>{const{tr:t,bau:n}=e,{section:o,h2:r}=n.tags,a=n.state(!1),s=ta(e),l=W(e),i=Le(e);return()=>o({id:"drawer"},r(t("Drawer")),l({onclick:()=>{a.val=!a.val}},"OPEN DRAWER"),s({openState:a},i()))},na=e=>{const{tr:t,bau:n,window:o,config:r}=e,{section:a,h2:s,h3:l}=n.tags,i=n.state(o.location.pathname.replace(r.base,"")),m=F(e),d={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#dd-menu1"},children:[{data:{name:"Sub Menu 1",href:"#dd-menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#dd-menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu3"}}]},c=he(e,{base:r.base+"/components/drillDownMenu"});return()=>a({id:"drillDownMenu"},s(t("Drill Down Menu")),c({tree:d,pathnameState:i}),l("Drill Down Table"),m({Item:u=>c({tree:d,...u})}))};function Fe(e,t){const{bau:n,css:o}=e,{div:r,span:a,label:s,input:l}=n.tags,i={base:o`
    ...
    `};return function(d,...c){const{variant:u="outline",color:h="neutral",size:b,Component:p,disabled:g,...f}=d;return r({class:T(i.base,g&&i.disabled,t==null?void 0:t.class,d.class)},s({class:T(u,h,b)},p({disabled:g}),l({type:"file",disabled:g,...f})),a({class:"filename-display"}))}}const oa=e=>{const{tr:t,bau:n,css:o}=e,{svg:r,use:a}=n.tagsNS("http://www.w3.org/2000/svg"),{section:s,div:l,h3:i,h2:m,span:d}=n.tags,c=F(e),u=n.state("No file selected"),h=Fe(e),b=g=>{const f=g.target.files[0];f?u.val=f.name:u.val="No file selected"},p=({disabled:g})=>l({class:T(o`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`);function Ve(e,t){const{bau:n,css:o}=e,{div:r,li:a}=n.tags,s=W(e),l=pe(e),i=ge(e),m=o`
    ...
    ${ia()}
  `,d=n.state(""),c=n.state(!1),u=n.state(0);return function(...b){let[{color:p="neutral",variant:g="outline",size:f,id:y,label:E,Option:S,options:B,getOptionLabel:P=({label:k})=>k,...A},...M]=U(b);const I=()=>{C.openDialog(),c.val=!0},H=()=>{C.closeDialog(),c.val=!1},D=()=>{c.val=!1},z=k=>{c.val?H():I()},O=({option:k,index:$})=>_=>{d.val=P(k),u.val=$,H()},R=k=>{switch(k.preventDefault(),k.key){case"Escape":H();break;case"ArrowDown":u.val<B.length-1?u.val++:u.val=0;break;case"ArrowUp":u.val<=0?u.val=B.length-1:u.val--;break;case"Enter":c.val?(d.val=P(B[u.val]),H()):I();break}},v=()=>i({class:T(p,g)},B.map((k,$)=>a({class:()=>T(u.val==$&&"active"),onclick:O({option:k,index:$})},S(k)))),x=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":c,"aria-label":E,onclick:z,color:p,variant:g,size:f},()=>!d.val&&E,d),C=l({id:y,triggerEl:x,contentEl:v(),onClose:D});return r({...A,class:T("select",p,f,m,t==null?void 0:t.class,A==null?void 0:A.class),onkeydown:R},x,C)}}const ca=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,span:i}=n.tags,m=(...b)=>a({class:o`
          display: flex;
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`).join(`
`))()};
  `;return function(...i){let[{color:m="neutral",variant:d="outline",size:c,...u},...h]=U(i);return r({...u,type:"range",class:T("slider",m,d,c,s,t==null?void 0:t.class,u.class)},...h)}}const da=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i,label:m,datalist:d,option:c,br:u}=n.tags,h=n.state(0),b=S=>{h.val=S==null?void 0:S.target.value},p=(...S)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
        `},...S),g=F(e),f=ae(e),y=ae(e),E=ae(e);return()=>r({id:"slider"},l(t("Slider")),i("Slider value: ",h),s("Basic Slider"),p(f({oninput:b,name:"slider-simple"})),s(t("Slider Table")),g({Item:S=>f(S)}),s("Slider Min Max: -1000 1000"),p(y({oninput:b,min:-1e3,max:1e3})),s("Slider Step 20"),p(f({oninput:b,step:20,min:-100,max:100})),s("Slider Vertical"),p(a({class:o`
          ...
          `,id:"temp",name:"temp",list:"markers"}),d({id:"markers",class:o`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(S=>c({value:Number(S),label:S})))))},Ee={sm:16,md:32,lg:64};function fe(e,t={}){const{bau:n,css:o}=e,{svg:r,animate:a,animateTransform:s,rect:l}=n.tagsNS("http://www.w3.org/2000/svg");return function({size:m="md",color:d="color-base",variant:c="outline",visibility:u=!0,...h}={}){return r({class:T(o`
...
`);function Ue(e,t){const{bau:n,css:o}=e,{input:r}=n.tags,a=o`
    ...
    ${ma()}
  `;return function(...l){let[{color:i="neutral",variant:m="plain",size:d,...c},...u]=U(l);return r({...c,class:T("switch",a,i,m,d,t==null?void 0:t.class,c.class),type:"checkbox",required:"required"},...u)}}const ha=e=>{const{tr:t,bau:n,css:o}=e,{section:r,form:a,label:s,div:l,h2:i}=n.tags,m=F(e),d=Ue(e);return()=>r({id:"switch"},i(t("Switch Examples")),a(l({class:o`
              display: flex;
              align-items: center;
              > * {
                margin: 0.5rem;
...
`);function ce(e,t){const{bau:n,css:o}=e,{tabDefs:r}=t,{div:a,ul:s,li:l}=n.tags,i=n.state(r),m=n.state(r[0]),d=u=>i.val.find(h=>h.name==u),c={base:o`
      ...
      ${pa()}
    `};return function(...h){let[{color:b,variant:p="plain",size:g,...f},...y]=U(h);const E=B=>{const{Header:P,disabled:A,name:M}=B;return l({class:()=>T(m.val.name==M&&"active",A&&"disabled"),onclick:I=>I.srcElement.dispatchEvent(new CustomEvent("tab.select",{detail:{tabName:M},bubbles:!0}))},P(B))},S=a({class:T("tabs",c.base,p,g,b,t==null?void 0:t.class,f.class)},n.loop(i,s(),E),()=>m.val.Content?m.val.Content({}):"");return S.addEventListener("tab.select",B=>{var M,I;const{tabName:P}=B.detail,A=d(P);A&&((M=m.val.exit)==null||M.call(),m.val=A,(I=A.enter)==null||I.call())},!1),S.addEventListener("tab.add",B=>{var A;const{tab:P}=B.detail;(A=P.enter)==null||A.call(),i.val.push(P)},!1),S.addEventListener("tab.remove",B=>{var A;const P=i.val.findIndex(M=>M.name==B.detail.tabName);P>0&&((A=i.val[P].exit)==null||A.call(),i.val.splice(P,1))},!1),S}}const ba=e=>{const{tr:t,bau:n,css:o}=e,{section:r,div:a,h3:s,h2:l,p:i,i:m}=n.tags,d=F(e),c=W(e),u=(...y)=>a({class:o`
          border: 1px dotted var(--color-gray-500);
          padding: 1rem;
...
`;const s=o`
  ...
  `,i=({label:h,icon:b,...p})=>a({"aria-label":h,title:h,...p},b),m=({count:h,totalCount:b,page:p,rowsPerPage:g})=>r({class:"pages-numbers"},Number(p-1)*Number(g)+(h>0?1:0),"-",Math.min(p*g,b)," of ",b),d=({count:h,page:b,rowsPerPage:p})=>r({class:"pages-numbers"},(b-1)*p+(h>0?1:0),"-",b*p),c=h=>h<=1,u=(h,b,p)=>h>=Math.ceil(b/p);return function(...b){let[{count:p=0,totalCount:g=0,page:f=1,rowsPerPage:y=50,onPageChange:E,isLoading:S=!1,disableFirst:B=()=>c(f),disablePrevious:P=()=>c(f),disableNext:A=()=>u(f,g,y),disableLast:M=()=>u(f,g,y),...I},...H]=U(b);const D=Math.max(0,Math.ceil(g/y)),z=E({page:1}),O=E({page:f-1}),R=E({page:f+1}),v=E({page:D});return r({...I,class:T("table-pagination",l,S&&"disabled",t==null?void 0:t.class,I==null?void 0:I.class)},s({class:"spinner",visibility:S,size:"md"}),g>0?m({count:p,totalCount:g,page:f,maxPages:D,rowsPerPage:y}):d({count:p,page:f,maxPages:D,rowsPerPage:y}),r(i({label:"First",icon:"⟪",onclick:z,disabled:B()}),i({label:"Previous",icon:"⟨",onclick:O,disabled:P()}),i({label:"Next",icon:"⟩",onclick:R,disabled:A()}),i({label:"Last",icon:"⟫",onclick:v,disabled:M()})))}}const fa=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.col"})),va=e=>{const{bau:t,css:n}=e,{th:o,td:r,tr:a,table:s,thead:l,tbody:i}=t.tags,m=fa(45),d=({name:y,email:E})=>a(r(y),r(E)),c=()=>l(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
  ...
  `,expanded:e`
    ...
    `}),H=le(e),D={items:[{href:"/",name:"⌂"},{name:"Dir"},{href:"/dir/subdir",name:"SubDir"}]},z=je(e),O=W(e),R=He(e),v=ie(e),x=Ge(e),C=Oe(e),k={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#m1"},children:[{data:{name:"Sub Menu 1",href:"#menusub2"},children:[{data:{name:"Sub Sub Menu 1",href:"#menusubsub1"}}]},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]},{data:{name:"Menu 3",href:"#menu2"}}]},$=he(e,{base:o.base+"/components"}),_=({disabled:w})=>a({class:T(n`
          ...
          `,w&&n`
              color: var(--color-emphasis-500);
              fill: var(--font-color-disabled);
            `)},g({width:100,height:100,fill:"currentColor"},f({href:"uploadIcon.svg#Capa_1"})),l("Choose a file to upload")),N=Fe(e),X=be(e),j=Re(e),L=()=>u(Array(10).fill("").map((w,q)=>i(q+1,". Some text here"))),G=w=>{const q=j({id:"my-dialog",...w},h("Header"),L(),b(O({...w,variant:"outline",onclick:()=>{q.close()}},"Cancel"),O({...w,variant:"solid",onclick:()=>{q.close()}},"OK")));return q},V=Ve(e),Y=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],Z=w=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
