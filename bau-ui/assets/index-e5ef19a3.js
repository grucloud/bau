...
`)}
  ...
  `}function Gn(){const e=document.getElementById("loading");e&&e.classList.add("m-fadeOut")}let Fe=e=>Object.prototype.toString.call(e??0).slice(8,-1),Fn=e=>Fe(e)=="Object",it=e=>Fe(e)=="Function",ze=e=>["Object","Array"].includes(Fe(e)),ct=Object.getPrototypeOf,He=e=>me(e)?e.val:e,me=e=>e==null?void 0:e.__isState,Vn=["splice","push","pop","shift","unshift","sort","reverse"],ke=(e,t)=>{const n=new Array(e.length);for(let o=0;o<e.length;o++)n[o]=t(e[o],o);return n};const Z=e=>!me(e[0])&&Fn(e[0])?e:[{},...e];function Wn(e){let t=(e==null?void 0:e.window)??window,{document:n}=t,o,a=new Set,i=new Set,s=!1,r,c=f=>n.createElement(f),l=(f,m,b)=>{let x=r;r=m;let C=f(b);return r=x,C},u=()=>{o||(o=t.requestAnimationFrame(()=>{a.forEach(f=>{f.bindings=f.bindings.filter(m=>{var b;return(b=m.element)==null?void 0:b.isConnected}),!f.bindings.length&&!f.computed&&a.delete(f)}),o=void 0}))},p=(f,m,b,x,C,B)=>{var N;if(s){i.add(f);return}for(let W of f.bindings){let{deps:_,element:D,renderInferred:F,render:J,renderItem:ee}=W;if(ee&&m)(N=g(D,x,(...ae)=>v(ee(...ae)),b,C,B)[m])==null||N.call();else{let ae=F?F({element:D}):J({element:D,renderItem:ee})(..._.map(He));ae!==D&&D.replaceWith(W.element=v(ae))}}S(f),u()},d=(f,m,b=[])=>({get(x,C,B){var N;if(r==null||r.add(f),C==="_isProxy")return!0;if(!((N=x[C])!=null&&N._isProxy)&&!me(x[C])&&ze(x[C]))x[C]=new Proxy(x[C],d(f,m,[...b,C]));else if(Vn.includes(C)){let W=x[C];return(..._)=>{let D=W.apply(x,_);return p(f,C,D,_,m,b),D}}return Reflect.get(x,C,B)},set(x,C,B,N){let W=Reflect.set(x,C,B,N);return p(f,"setItem",W,{prop:C,value:B},m,[...b,C]),W}}),h=(f,m)=>new Proxy(m,d(f,m)),g=(f,m,b,x,C,B)=>{let N=()=>f.replaceChildren(...ke(x,b)),W=_=>f[_]&&f.removeChild(f[_]);return{assign:N,sort:N,reverse:N,setItem:()=>{var D;let _=B[0];(D=f.children[_])==null||D.replaceWith(b(C[_],_))},push:()=>f.append(...ke(m,(_,D)=>b(_,C.length+D))),unshift:()=>f.prepend(...ke(m,b)),pop:()=>W("lastChild"),shift:()=>W("firstChild"),splice:()=>{let[_,D,...F]=m;const{length:J}=f.children;for(let ee=_>=0?Math.min(_+D-1,J-1):J-1;ee>=(_>=0?_:J+_);ee--)f.children[ee].remove();if(F.length){let ee=F.forEach((ae,Pe)=>b(ae,_+Pe));f.children[_]?f.children[_].after(...ee):f.append(...ee)}}}},w=f=>({oldVal:f,bindings:[],listeners:[],__isState:!0,get val(){let m=this;return r==null||r.add(m),m.valProxy??(m.valProxy=ze(f)?h(m,f):f,m.valProxy)},set val(m){let b=this,x=b.val;ze(m)?(b.valProxy=h(b,m),p(b,"assign",m)):m!==x&&(b.valProxy=m,p(b)),b.oldVal=x}}),v=f=>f==null||f===!1?c("span"):f.nodeType?f:n.createTextNode(f),y=(f,m)=>{let b=new Set;return m.val=l(f,b),b},E=f=>{let m=w(),b=y(f,m);m.computed=!0;for(let x of b)x.listeners.push({computed:f,deps:b,state:m});return m},S=f=>{for(let m of[...f.listeners])y(m.computed,m.state)},$=(f,...m)=>{if(m.length){let b=[];for(let x of m.flat(1/0))x!=null&&b.push(me(x)?L({deps:[x],render:()=>C=>C}):it(x)?Q({renderInferred:x}):v(x));f.append(...b)}},P={},R=(f,m)=>f&&(Object.getOwnPropertyDescriptor(f,m)??R(ct(f),m)),I=(f,m,b)=>{var x;return P[f+","+m]??(P[f+","+m]=((x=R(b,m))==null?void 0:x.set)??0)},z=(f,m)=>new t.MutationObserver((b,x)=>{b.filter(C=>C.removedNodes).forEach(C=>[...C.removedNodes].find(B=>B===f&&(m({element:f}),x.disconnect(),!0)))}).observe(f.parentNode,{childList:!0}),M=(f,m)=>new t.MutationObserver((b,x)=>b.forEach(C=>m({record:C,element:f}))).observe(f,{childList:!0}),H=f=>new Proxy(function(b,...x){var W;let[C,...B]=Z(x),N=f?n.createElementNS(f,b):c(b);for(let[_,D]of Object.entries(C)){if(_.startsWith("bau"))continue;let F=I(b,_,ct(N))?J=>N[_]=J:J=>N.setAttribute(_,J);D==null||(me(D)?L({deps:[D],render:()=>()=>(F(D.val),N)}):it(D)&&(!_.startsWith("on")||D.isDerived)?Q({renderInferred:()=>(F(D({element:N})),N)}):D.renderProp?L({deps:D.deps,render:()=>()=>(F(D.renderProp({element:N})(...D.deps.map(He))),N)}):F(D))}return C.bauChildMutated&&M(N,C.bauChildMutated),$(N,...B),(W=C.bauCreated)==null||W.call(C,{element:N}),C.bauMounted&&t.requestAnimationFrame(()=>C.bauMounted({element:N})),C.bauUnmounted&&t.requestAnimationFrame(()=>z(N,C.bauUnmounted)),N},{get:(m,b)=>m.bind(void 0,b)}),q=(f,m,b)=>{f.element=v(b);for(let x of m)me(x)&&(a.add(x),x.bindings.push(f));return f.element},Q=({renderInferred:f,element:m})=>{let b=new Set,x=l(f,b,{element:m});return q({renderInferred:f},b,x)},L=({deps:f,element:m,render:b,renderItem:x})=>q({deps:f,render:b,renderItem:x},f,b({element:m,renderItem:x})(...f.map(He))),G=(f,m,b)=>L({deps:[f],render:({renderItem:x})=>C=>(m.append(...ke(C,x)),m),renderItem:b}),U=f=>{s=!0,f(),s=!1,i.forEach(p),i.clear()};return{tags:H(),tagsNS:H,state:w,bind:L,loop:G,derive:E,stateSet:a,batch:U}}const Xn=e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return"bau"+n},Zn=(e,t,n,o)=>{const a=e.createElement("style");a.id=n,a.append(o),(t??e.head).append(a)},Kn=(e,t)=>e.reduce((n,o,a)=>n+o+(t[a]??""),"");function Yn(e){let{document:t}=(e==null?void 0:e.window)??window;const n=o=>(a,...i)=>{const s=Kn(a,i),r=Xn(s);return!t.getElementById(r)&&Zn(t,e==null?void 0:e.target,r,o(r,s)),r};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function qn(e){const t=Wn(),n=Yn();return Un(n),{bau:t,...n,tr:o=>o,window,...e}}function T(...e){return e.filter(t=>t).join(" ")}function De(e,t={}){const{bau:n}=e,{div:o}=n.tags,a=()=>{};return function({animationHide:s=a,animationShow:r=a,...c},l){return o({class:T("animate",t==null?void 0:t.class,c.class),bauChildMutated:({record:u,element:p})=>{[...u.removedNodes].forEach(d=>{if(!s()||d.getAttribute("cloned"))return;const h=d.cloneNode(!0);h.setAttribute("cloned",!0),h.style.top=0,h.style.left=0,h.style.width=d.getAttribute("width"),h.style.height=d.getAttribute("height"),h.style.position="absolute",h.style.animation=s(),u.target.appendChild(h),h.addEventListener("animationend",()=>h.parentNode.removeChild(h))}),[...u.addedNodes].forEach(d=>{if(d.getAttribute("cloned"))return;p.style.position="relative";const h=d.getBoundingClientRect();if(d.setAttribute("width",h.width+"px"),d.setAttribute("height",h.height+"px"),r()){d.style.animation=r();const g=()=>{d.removeEventListener("animationend",g),d.style.animation=""};d.addEventListener("animationend",g)}})},...c},l)}}function Y(e,t){const{bau:n,css:o}=e,a={root:o`
      color: inherit;
      display: inline-flex;
      align-items: center;
...
`);function Ve(e,t){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(eo);const l=o`
    ...
    ${to()}
  `;return function(...p){let[{color:d,variant:h="outline",size:g="md",...w},...v]=Z(p);return i({required:"required",title:"Switch Theme",...w,class:T("theme-switch",d,h,g,l,t==null?void 0:t.class,w.class),type:"checkbox",checked:r()=="dark",onclick:y=>{s(y.target.checked?"dark":"light")}},...v)}}function no(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:p,b:d,ul:h,li:g}=n.tags,{svg:w,path:v}=n.tagsNS("http://www.w3.org/2000/svg"),y=i.drawerOpen,E=Y(e,{class:o`
      background: transparent;
    `}),S=Ve(e),$=()=>s(w({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},v({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),P=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
        ...
        `},P(),R())}}function oo({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:p}=t.tags,d=({links:w,title:v})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},p(v),r(w.map(({href:y,name:E})=>c(s({href:y},E))))),h=[{href:"GettingStarted",name:"Getting Started"},{href:"components",name:"Component Gallery"}],g=[{href:"https://github.com/grucloud/bau/tree/main",name:"bau: a 2Kb alternative to React/Vue/Svelte"},{href:"https://github.com/grucloud/bau/tree/main/bau-css",name:"bau-css: a CSS in JS library in 33 lines."},{href:"https://github.com/grucloud/bau/tree/main/bau-ui",name:"bau-ui: UI Component library."},{href:"https://github.com/grucloud/bau/tree/main/bau-router",name:"bau-router: a router for SPA."}];return function(){return a({class:n`
          grid-area: footer;
          display: flex;
  ...
  `,hideToRight:e`
   ...
   `});function We(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=L=>{var G;return((G=L.parentTree.data)==null?void 0:G.href)??L.parentTree.children[0].data.href},u=({variant:L,color:G,size:U,currentTree:f,data:m})=>S(I({variant:L,color:G,size:U,href:`${c}${l(f)}`,class:o`
          ...
          `,"data-buttonback":!0},"←"),I({variant:L,color:G,size:U,href:`${c}${m.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},m.name)),p=({size:L,subTree:{data:{name:G,href:U},children:f=[]}})=>I({size:L,href:`${c}${U}`,"data-ischild":!f.length},G),d=({pathname:L,subTree:G})=>{var U;return L===((U=G==null?void 0:G.data)==null?void 0:U.href)},{renderHeader:h=u,renderMenuItem:g=p,isActive:w=d}=t,{li:v,nav:y,div:E,header:S,a:$}=n.tags,P=De(e),R=we(e),I=Y(e,{class:o`
      &.button {
  ...
  `,q=({variant:L,color:G,size:U,currentTree:f,pathnameState:m})=>{const{children:b,parentTree:x,data:C}=f;return E({class:T("drillDownMenu",L,G,U)},x&&h({variant:L,color:G,size:U,data:C,currentTree:f}),b&&R({class:T(L,G,U)},b.map(B=>v({class:()=>T(B.children&&"has-children",w({pathname:m.val,subTree:B})&&"active")},g({variant:L,color:G,size:U,subTree:B})))))},Q=({tree:L,pathname:G})=>{let U=xt({})(structuredClone(L)),f=wt(G)(U);return f||(console.error("drilldown no sub tree",G),f=U),f};return function(G){const{variant:U="plain",color:f="neutral",size:m="md",tree:b,...x}=G,C=n.state(a.location.pathname.replace(c,"")),B=n.derive(()=>Q({tree:b,pathname:C.val}));a.document.addEventListener("click",F=>{const{target:J}=F,ee=J.getAttribute("href");if(J.tagName==="A"&&ee&&!ee.startsWith("http")){let ae=ee.replace(c,"");r||(ae=ae.replace(J.hash,"")),C.val=ae}});let N=1;const W=F=>{const{dataset:J}=F.target;J.buttonback=="true"?N=-1:J.ischild=="false"?N=1:J.ischild=="true"&&(N=0)},_=F=>{switch(F){case 1:return`${z} ${Te}`;case-1:return`${M} ${Te}`;default:return""}},D=F=>{switch(F){case 1:return`${M} ${Te} reverse`;case-1:return`${z} ${Te} reverse`;default:return""}};return y({class:T(H,t==null?void 0:t.class,x.class),onclick:W},P({animationHide:()=>_(N),animationShow:()=>D(N)},()=>q({variant:U,color:f,size:m,currentTree:B.val,pathnameState:C})))}}const ro={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};function yt(e){const{tr:t,bau:n,css:o,config:a,states:i,window:s}=e,{div:r,ul:c,li:l,nav:u,a:p,span:d}=n.tags;let h=!1;const g=We(e);return function(){return r({bauMounted:({element:v})=>{s.innerWidth<=640&&(h=!0,i.drawerOpen.val=!1)},onclick:v=>{h&&!v.target.dataset.buttonback&&!v.target.parentElement.classList.contains("has-children")&&(i.drawerOpen.val=!1)},style:()=>i.drawerOpen.val?"display:block;":"display:none;",class:T(o`
            grid-area: sidebar;
            position: sticky;
...
"Click me"
  ...
  `;return function(...r){let[{color:c,variant:l="outline",size:u="md",...p},...d]=Z(r);return a({...p,class:T("paper",u,i,t==null?void 0:t.class,p==null?void 0:p.class)},...d)}}const Lt=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:p,name:d}){return o({class:n`
        ...
        `},a(c(s(l(d??""),oe.map(h=>l(h)))),i(Jn.map(h=>s(l(h),oe.map((g,w)=>r(p({color:g,variant:h},{index:w}))))))))}},ga=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({Item:i}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
  ...
  `,s=({element:l,closeState:u})=>{l.scrollHeight!=0&&(u.val?r(l):c(l))};function r(l){l.style.height=l.scrollHeight+"px";const u=()=>{l.removeEventListener("transitionend",u)};l.addEventListener("transitionend",u),window.requestAnimationFrame(()=>{l.style.height="0px"})}function c(l){const u=()=>{l.removeEventListener("transitionend",u),l.style.height=null};l.addEventListener("transitionend",u),l.style.height=l.scrollHeight+"px"}return function(...u){let[{color:p,variant:d="plain",size:h="md",Header:g,Content:w,close:v=!0,...y},...E]=Z(u);const S=n.state(v);return a({...y,class:T("collapsible",h,i,t==null?void 0:t.class,y==null?void 0:y.class)},a({class:()=>T("header",S.val?"close":"open"),onclick:$=>{S.val=!S.val,$.stopPropagation()}},g()),a({class:"content",role:"region",bauMounted:({element:$})=>{S.val&&($.style.height="0px")},"aria-expanded":({element:$})=>(s({element:$,closeState:S}),!S.val)},w&&w()))}}const fa=()=>oe.map(e=>`
& li.plain.${e} h3::after {
  color: var(--color-${e});
}
...
`);function _e(e,t){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=n.state(""),u=qe(e),p=h=>g=>{l.val==h?l.val="":l.val=h},d=o`
    ...
    ${fa()}
  `;return function(...g){let[{color:w,variant:v="outline",size:y="md",data:E=[],...S},...$]=Z(g);const P=R=>{const{Header:I,Content:z,name:M}=R,H=()=>r({class:()=>T(l.val==M&&"active")},c({type:"button","aria-controls":`bau-${M}`,"aria-expanded":({element:Q})=>l.val==M},I(R))),q=()=>a({id:`bau-${M}`,"data-state":({element:Q})=>l.val==M},z(R));return s({class:T(w,v,y),onclick:p(M)},u({Header:H,Content:q}))};return a({class:T("accordion",d,t==null?void 0:t.class,S.class)},i(E.map(P)))}}const jt=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=_e(e);return s=>i({...s,data:a})},va=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=_e(e);return()=>i({data:a,color:"neutral",variant:"outline"})},xa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,_a={title:"Alert",package:"alert",description:"An alert displays a short, important message in a way that attracts the user's attention without interrupting the user's task.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alert/alert.js",importStatement:'import alert from "@grucloud/bau-ui/alert";',examples:[{title:"Default",description:"A simple danger alert.",code:Ia,createComponent:Da},{title:"Custom Alert ",description:"A custom alert.",code:Na,createComponent:$a}],gridItem:Ht},Ba=e=>{const t=V(e);return()=>t(_a)},Oa=(e,t={})=>{const{bau:n,css:o,keyframes:a}=e,{limit:i=10,deleteAfterDuration:s=15e3}=t,{div:r}=n.tags,c=n.state([]),l={inserting:a`
  ...
  `},u={stack:o`
    ...
    `},p=({id:d,status:h})=>{const g=c.val.findIndex(w=>w.id===d);g!=-1&&(c.val[g].status=h)};return function(h={},...g){const w=({id:E})=>{p({id:E,status:"removing"});const S=c.val.findIndex($=>$.id===E);S!=-1&&c.val.splice(S,1)},v=({Component:E})=>{const S={id:Math.random().toString(10).split(".")[1],Component:E,status:"inserting"};c.val.length>=i&&w({id:c.val[0].id}),c.val.push(S),setTimeout(()=>w(S),s)},y=E=>r({class:u.item,onclick:()=>w(E)},E.Component());return document.addEventListener("alert.add",E=>v(E.detail)),document.addEventListener("alert.remove",E=>w(E.detail)),r({class:T(u.stack,t==null?void 0:t.class,h.class)},n.loop(c,r(),y))}},Pa=e=>{const{tr:t,bau:n}=e,{section:o}=n.tags,a=Oa(e,{deleteAfterDuration:2e4}),i=Y(e),s=Be(e);return()=>o(a(),i({color:"success",variant:"outline",onclick:()=>{document.dispatchEvent(new CustomEvent("alert.add",{detail:{Component:()=>s({color:"success"},t("Infrastructure Created"))}}))}},"Success Alert"))},Ra=`import { Context } from "@grucloud/bau-ui/context";
...
`,Fa={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:Ha,createComponent:za},{title:"Component hide and show",description:"Hide and show a component",code:Ga,createComponent:Ua}]},Va=e=>{const t=V(e);return()=>t(Fa)};function Ut(e,t){const{bau:n,css:o}=e,{span:a,img:i}=n.tags,s=n.state(!0),r=n.state(!1),c=()=>s.val=!1,l=p=>{s.val=!1,r.val=!0},u=o`
  ...
  `;return function(...d){let[{color:h,variant:g="outline",size:w="md",width:v=30,height:y=30,...E},...S]=Z(d);return a({class:T(u,t==null?void 0:t.class,E.class)},()=>s.val?"Loading...":"",()=>r.val&&"Error",i({width:v,height:y,onload:c,onerror:l,class:T(h,g,w,u,t==null?void 0:t.class,E.class),...E}))}}const Gt=e=>{const{css:t}=e,n=Ut(e,{class:t`
      > img {
        border-radius: 50%;
      }
...
`);function Ft(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=Je(e),r=Y(e),c=Qe(e),l=we(e),u=o`
    ...
    ${qa()}
  `,p=n.state(""),d=n.state(""),h=n.state(!1),g=n.state(0),w=()=>{h.val=!1};return function(...y){let[{variant:E="outline",color:S,size:$="md",id:P,label:R,placeholder:I,Option:z,options:M,getOptionLabel:H=({label:_})=>_,...q},...Q]=Z(y);const L=n.state(M),G=()=>{W.openDialog(),h.val=!0,d.val="",L.val=M},U=()=>{W.closeDialog(),h.val=!1,d.val=""},f=_=>{const{value:D}=_.target;d.val=D,D?L.val=M.filter(F=>H(F).match(new RegExp(`${D}`,"i"))):L.val=M},m=_=>{h.val?U():G()},b=({option:_,index:D})=>F=>{p.val=H(_),g.val=D,U()},x=_=>{switch(console.log("onkeydown",_.key,g.val),_.key){case"Escape":U();break;case"ArrowDown":g.val<L.val.length-1?g.val++:g.val=0;break;case"ArrowUp":g.val<=0?g.val=L.val.length-1:g.val--;break;case"Enter":p.val=H(L.val[g.val]),d.val="",U();break}},C=r({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":h,"aria-label":R,onclick:m,variant:E,color:S,size:$},()=>!p.val&&R,p),B=c({id:P,value:d,placeholder:I,autofocus:!0,type:"search",autocomplete:"new-password",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":h,oninput:f,onkeydown:x,variant:E,color:S,size:$}),W=s({id:P,triggerEl:C,contentEl:(()=>a({class:T(E,S,$,"content")},B,()=>l({class:T(E,S,$)},L.val.map((_,D)=>i({class:()=>T(g.val==D&&"active"),onclick:b({option:_,index:D})},z(_))))))(),onClose:w});return a({...q,class:T("autocomplete",u,t==null?void 0:t.class,q==null?void 0:q.class)},C,W)}}const Vt=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=Ft(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,yr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:wr,createComponent:xr}],gridItem:Qt},Cr=e=>{const t=V(e);return()=>t(yr)};function Er(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{color:l,variant:u="plain",size:p="md",slides:d,Slide:h,Previous:g,Next:w,...v}]=Z(c);const y=()=>{s.val<=0?s.val=d.length-1:s.val--},E=()=>{s.val>=d.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},d.map(h));return a({...v,class:T("carousel",p,i,t==null?void 0:t.class,v==null?void 0:v.class)},a({class:T("control","control-previous"),onclick:y},g()),a({class:T("control","control-next"),onclick:E},w()),S)}}const Sr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],kr=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=Y(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,Zr={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Xr,createComponent:Wr}],gridItem:e=>on(e,{base:"/components/drillDownMenu",hashBased:!0})},Kr=e=>{const t=V(e);return()=>t(Zr)};function an(e,t){const{bau:n,css:o}=e,{div:a,span:i,label:s,input:r}=n.tags,c={base:o`
    ...
    `};return function(u,...p){const{variant:d="outline",color:h="neutral",size:g="md",Component:w,disabled:v,...y}=u;return a({class:T(c.base,v&&c.disabled,t==null?void 0:t.class,u.class)},s({class:T(d,h,g)},w({disabled:v}),r({type:"file",disabled:v,...y})),i({class:"filename-display"}))}}const rn=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{div:r,span:c}=n.tags,l=n.state("No file selected"),u=an(e),p=h=>{const g=h.target.files[0];g?l.val=g.name:l.val="No file selected"},d=({disabled:h})=>r({class:T(o`
          ...
          `,h&&o`
            ...
            `)},i({width:100,height:100,fill:"currentColor"},s({href:`${a.base}/uploadIcon.svg#Capa_1`})),c(t("Choose a file to upload")));return h=>u({Component:d,name:"file",accept:"text/*",onchange:p,...h})},Yr=e=>{const{tr:t,bau:n,css:o,config:a}=e,{svg:i,use:s}=n.tagsNS("http://www.w3.org/2000/svg"),{section:r,div:c,span:l}=n.tags,u=n.state("No file selected"),p=an(e),d=g=>{const w=g.target.files[0];w?u.val=w.name:u.val="No file selected"},h=({disabled:g})=>c({class:T(o`
            display: flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`);function un(e,t){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=Y(e),r=Je(e),c=we(e),l=o`
    ...
    ${Ss()}
  `,u=n.state(""),p=n.state(!1),d=n.state(0);return function(...g){let[{color:w="neutral",variant:v="outline",size:y="md",id:E,label:S,Option:$,options:P,getOptionLabel:R=({label:b})=>b,...I},...z]=Z(g);const M=()=>{m.openDialog(),m.focus(),p.val=!0},H=()=>{m.closeDialog(),p.val=!1},q=()=>{p.val=!1},Q=b=>{p.val?H():M()},L=({option:b,index:x})=>C=>{u.val=R(b),d.val=x,H()},G=b=>{switch(b.preventDefault(),b.key){case"Escape":H();break;case"ArrowDown":d.val<P.length-1?d.val++:d.val=0;break;case"ArrowUp":d.val<=0?d.val=P.length-1:d.val--;break;case"Enter":p.val?(u.val=R(P[d.val]),H()):M();break}},U=()=>c({tabindex:"0",class:T(w,v)},P.map((b,x)=>i({class:()=>T(d.val==x&&"active"),onclick:L({option:b,index:x})},$(b)))),f=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":p,"aria-label":S,onclick:Q,color:w,variant:v,size:y},()=>!u.val&&S,u),m=r({id:E,triggerEl:f,contentEl:U(),onClose:q});return a({...I,class:T("select",w,y,l,t==null?void 0:t.class,I==null?void 0:I.class),onkeydown:G},f,m)}}const dn=e=>{const{bau:t,css:n}=e,{div:o,span:a}=t.tags,i=un(e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],r=c=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`;const s=o`
  ...
  `;return function(...c){let[{...l},...u]=Z(c);return i({...l,class:T("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const oi=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function p(v,y,E,S,$){return{name:v,calories:y,fat:E,carbs:S,protein:$}}const d=[p("Frozen yoghurt",159,6,24,4),p("Ice cream sandwich",237,9,37,4.3),p("Eclair",262,16,24,6),p("Cupcake",305,3.7,67,4.3),p("Gingerbread",356,16,49,3.9)],h=({name:v,calories:y})=>s(i(v),i({class:n`
      ...
      max-width: 650px;
    `});return()=>o(w(r(u("Basic Table"),g(),l(d.map(h)))))},ai=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,di={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:ai,createComponent:oi},{title:"Dense",description:"A dense table.",code:ii,createComponent:si},{title:"Zebra",description:"A zebra table.",code:ui,createComponent:li}]},pi=e=>{const t=V(e);return()=>t(di)};function vn(e,t){const{bau:n,css:o}=e,{div:a}=n.tags,i=et(e),s=Y(e),r=tt(e),c=o`
  ...
  `,l=({label:g,icon:w,...v})=>s({"aria-label":g,title:g,...v},w),u=({count:g,totalCount:w,page:v,rowsPerPage:y})=>a({class:"pages-numbers"},Number(v-1)*Number(y)+(g>0?1:0),"-",Math.min(v*y,w)," of ",w),p=({count:g,page:w,rowsPerPage:v})=>a({class:"pages-numbers"},(w-1)*v+(g>0?1:0),"-",w*v),d=g=>g<=1,h=(g,w,v)=>g>=Math.ceil(w/v);return function(...w){let[{count:v=0,totalCount:y=0,page:E=1,rowsPerPage:S=50,onPageChange:$,isLoading:P=!1,disableFirst:R=()=>d(E),disablePrevious:I=()=>d(E),disableNext:z=()=>h(E,y,S),disableLast:M=()=>h(E,y,S),...H},...q]=Z(w);const Q=Math.max(0,Math.ceil(y/S)),L=$({page:1}),G=$({page:E-1}),U=$({page:E+1}),f=$({page:Q}),m=[{label:"First",icon:"⟪",onclick:L,disabled:R()},{label:"Previous",icon:"⟨",onclick:G,disabled:I()},{label:"Next",icon:"⟩",onclick:U,disabled:z()},{label:"Last",icon:"⟫",onclick:f,disabled:M()}];return a({...H,class:T("table-pagination",c,P&&"disabled",t==null?void 0:t.class,H==null?void 0:H.class)},r({class:"spinner",visibility:P,size:"md"}),y>0?u({count:v,totalCount:y,page:E,maxPages:Q,rowsPerPage:S}):p({count:v,page:E,maxPages:Q,rowsPerPage:S}),i({variant:"outline",color:"neutral"},m.map(b=>l({...b,variant:"outline",color:"neutral"}))))}}const mi=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),bi=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=mi(45),u=({name:E,email:S})=>i(a(E),a(S)),p=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),d=vn(e),h=Ce(e,{class:n`
      max-width: 650px;
    `}),g=t.state(l),w=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),v=t.derive(()=>g.val.slice(w.val.page*w.val.rowsPerPage,(w.val.page+1)*w.val.rowsPerPage)),y=({page:E})=>S=>{w.val.page=E};return()=>h(s(p(),()=>c(v.val.map(u))),()=>d({...w.val,onPageChange:y}))},hi=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),p=t.state([]),d=t.state(""),h=t.derive(()=>p.val.length),g=t.state(1),w=t.state(10),v=t.derive(()=>p.val),y=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,E=({page:M})=>H=>{g.val=M,S(y({page:M,per_page:w.val}))};S(y({page:1,per_page:w.val}));async function S(M){try{u.val=!0;const H=await fetch(M,{});if(H.ok){const q=await H.json();p.val=q;return}throw H}catch(H){d.val=H.message}finally{u.val=!1}}const $=({name:M,description:H,stargazers_count:q})=>i(a(M),a(H),a({class:n`
            text-align: right;
          `},q)),P=()=>r(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),z=({message:M})=>l(M);return()=>I(()=>R({rowsPerPage:w.val,page:g.val,count:h.val,totalCount:-1,isLoading:u.val,onPageChange:E,disableNext:()=>!1}),s(P(),()=>d.val&&z({message:d.val}),()=>c(v.val.map($))))},gi=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=bi(e),l=hi(e),u=(...p)=>a({class:n`
...
`,{nav:e`
  ...
  `});function yn(e,t){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Ai({css:o,createGlobalStyles:a}),p=qe(e),d=({depth:h=1,maxDepth:g,color:w,variant:v,size:y})=>E=>{const{children:S,expanded:$}=E,P=n.state(!$),R=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:z=>{S&&(P.val=!P.val)}},i(E.data)),I=()=>s({class:T(w,y)},S.map(d({depth:h+1,maxDepth:g})));return r({},p({Header:R,Content:S&&h<g&&I}))};return function({tree:g,maxDepth:w=1/0,size:v="md",variant:y="plain",color:E="neutral",...S}){return c({class:T(u.nav,v,y,E,t==null?void 0:t.class,S.class)},g.children&&s(g.children.map(d({maxDepth:w,color:E,variant:y,size:v}))))}}const Cn=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=yn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return s=>i({...s,tree:o})},Mi=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=yn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Di=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
