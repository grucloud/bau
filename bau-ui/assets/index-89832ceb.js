...
`)}
  ...
  `}function ho(){const t=document.getElementById("loading");t&&t.classList.add("m-fadeOut")}let se=t=>Object.prototype.toString.call(t??0).slice(8,-1),vo=t=>se(t)=="Object",Ae=t=>se(t)=="Function",ne=t=>["Object","Array"].includes(se(t)),Be=Object.getPrototypeOf,oe=t=>Ct(t)?t.val:t,Ct=t=>t==null?void 0:t.__isState,yo=["splice","push","pop","shift","unshift","sort","reverse"],Ht=(t,e)=>{const n=new Array(t.length);for(let o=0;o<t.length;o++)n[o]=e(t[o],o);return n};const V=t=>!Ct(t[0])&&vo(t[0])?t:[{},...t];function xo(t){let e=(t==null?void 0:t.window)??window,{document:n}=e,o,a=new Set,r=new Set,i=!1,s,l=C=>n.createElement(C),c=(C,v,w)=>{let E=s;s=v;let T=C(w);return s=E,T},u=()=>{o||(o=e.requestAnimationFrame(()=>{a.forEach(C=>{C.bindings=C.bindings.filter(v=>{var w;return(w=v.element)==null?void 0:w.isConnected}),!C.bindings.length&&!C.computed&&a.delete(C)}),o=void 0}))},d=(C,v,w,E,T,G)=>{var R;if(i){r.add(C);return}for(let H of C.bindings){let{deps:J,element:M,renderInferred:X,render:tt,renderItem:W}=H;if(W&&v)(R=b(M,E,(...Z)=>f(W(...Z)),w,T,G)[v])==null||R.call();else{let Z=X?X({element:M}):tt({element:M,renderItem:W})(...J.map(oe));Z!==M&&M.replaceWith(H.element=f(Z))}}x(C),u()},m=(C,v,w=[])=>({get(E,T,G){var R;if(s==null||s.add(C),T==="_isProxy")return!0;if(!((R=E[T])!=null&&R._isProxy)&&!Ct(E[T])&&ne(E[T]))E[T]=new Proxy(E[T],m(C,v,[...w,T]));else if(yo.includes(T)){let H=E[T];return(...J)=>{let M=H.apply(E,J);return d(C,T,M,J,v,w),M}}return Reflect.get(E,T,G)},set(E,T,G,R){let H=Reflect.set(E,T,G,R);return d(C,"setItem",H,{prop:T,value:G},v,[...w,T]),H}}),p=(C,v)=>new Proxy(v,m(C,v)),b=(C,v,w,E,T,G)=>{let R=()=>C.replaceChildren(...Ht(E,w)),H=J=>C[J]&&C.removeChild(C[J]);return{assign:R,sort:R,reverse:R,setItem:()=>{var M;let J=G[0];(M=C.children[J])==null||M.replaceWith(w(T[J],J))},push:()=>C.append(...Ht(v,(J,M)=>w(J,T.length+M))),unshift:()=>C.prepend(...Ht(v,w)),pop:()=>H("lastChild"),shift:()=>H("firstChild"),splice:()=>{const{length:J}=C.children;let[M,X=J,...tt]=v;for(let W=M>=0?Math.min(M+X-1,J-1):J-1;W>=(M>=0?M:J+M);W--)C.children[W].remove();if(tt.length){let W=tt.map((Z,at)=>w(Z,M+at));C.children[M]?C.children[M].before(...W):C.append(...W)}}}},g=C=>({oldVal:C,bindings:[],listeners:[],__isState:!0,get val(){let v=this;return s==null||s.add(v),v.valProxy??(v.valProxy=ne(C)?p(v,C):C,v.valProxy)},set val(v){let w=this,E=w.val;ne(v)?(w.valProxy=p(w,v),d(w,"assign",v)):v!==E&&(w.valProxy=v,d(w)),w.oldVal=E}}),f=C=>{if(C==null||C===!1){const v=l("span");return v.style.display="none",v}else return C.nodeType?C:n.createTextNode(C)},y=(C,v)=>{let w=new Set;return v.val=c(C,w),w},h=C=>{let v=g(),w=y(C,v);v.computed=!0;for(let E of w)E.listeners.push({computed:C,deps:w,state:v});return v},x=C=>{for(let v of[...C.listeners])y(v.computed,v.state)},S=(C,...v)=>{if(v.length){let w=[];for(let E of v.flat(1/0))E!=null&&w.push(Ct(E)?U({deps:[E],render:()=>T=>T}):Ae(E)?j({renderInferred:E}):f(E));C.append(...w)}},k={},D=(C,v)=>C&&(Object.getOwnPropertyDescriptor(C,v)??D(Be(C),v)),A=(C,v,w)=>{var E;return k[C+","+v]??(k[C+","+v]=((E=D(w,v))==null?void 0:E.set)??0)},B=(C,v)=>new e.MutationObserver((w,E)=>{w.filter(T=>T.removedNodes).forEach(T=>[...T.removedNodes].find(G=>G===C&&(v({element:C}),E.disconnect(),!0)))}).observe(C.parentNode,{childList:!0}),O=(C,v)=>new e.MutationObserver((w,E)=>w.forEach(T=>v({record:T,element:C}))).observe(C,{childList:!0}),I=C=>new Proxy(function(w,...E){var H;let[T,...G]=V(E),R=C?n.createElementNS(C,w):l(w);for(let[J,M]of Object.entries(T)){if(J.startsWith("bau"))continue;let X=A(w,J,Be(R))?tt=>tt!==void 0&&(R[J]=tt):tt=>R.setAttribute(J,Array.isArray(tt)?tt.filter(W=>W).join(" "):tt);M==null||(Ct(M)?U({deps:[M],render:()=>()=>(X(M.val),R)}):Ae(M)&&(!J.startsWith("on")||M.isDerived)?j({renderInferred:()=>(X(M({element:R})),R)}):M.renderProp?U({deps:M.deps,render:()=>()=>(X(M.renderProp({element:R})(...M.deps.map(oe))),R)}):X(M))}return T.bauChildMutated&&O(R,T.bauChildMutated),S(R,...G),R.autofocus&&R.focus&&e.requestAnimationFrame(()=>R.focus()),(H=T.bauCreated)==null||H.call(T,{element:R}),T.bauMounted&&e.requestAnimationFrame(()=>T.bauMounted({element:R})),T.bauUnmounted&&e.requestAnimationFrame(()=>B(R,T.bauUnmounted)),R},{get:(v,w)=>v.bind(void 0,w)}),L=(C,v,w)=>{C.element=f(w);for(let E of v)Ct(E)&&(a.add(E),E.bindings.push(C));return C.element},j=({renderInferred:C,element:v})=>{let w=new Set,E=c(C,w,{element:v});return L({renderInferred:C},w,E)},U=({deps:C,element:v,render:w,renderItem:E})=>L({deps:C,render:w,renderItem:E},C,w({element:v,renderItem:E})(...C.map(oe))),z=(C,v,w)=>U({deps:[C],render:({renderItem:E})=>T=>(v.append(...Ht(T,E)),v),renderItem:w}),P=async C=>{i=!0;const v=await C();return i=!1,r.forEach(d),r.clear(),v};return{tags:I(),tagsNS:I,state:g,bind:U,loop:z,derive:h,stateSet:a,batch:P}}const wo=t=>{let e=0,n=11;for(;e<t.length;)n=101*n+t.charCodeAt(e++)>>>0;return"bau"+n},So=(t,e,n,o)=>{const a=t.createElement("style");a.id=n,a.append(o),(e??t.head).append(a)},Co=(t,e)=>t.reduce((n,o,a)=>n+o+(e[a]??""),"");function ko(t){let{document:e}=(t==null?void 0:t.window)??window;const n=o=>(a,...r)=>{const i=Co(a,r),s=wo(i);return!e.getElementById(s)&&So(e,t==null?void 0:t.target,s,o(s,i)),s};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function Eo(t){const e=xo(),n=ko();return fo(n),{bau:e,...n,tr:o=>o,window,...t}}function Kt(t,e={}){const{bau:n,window:o}=t,{div:a}=n.tags,r=()=>{};return function({animationHide:s=r,animationShow:l=r,...c},u){return a({class:["animate",e==null?void 0:e.class,c.class],bauChildMutated:({record:d,element:m})=>{[...d.removedNodes].forEach(p=>{if(!s()||p.getAttribute("cloned"))return;const b=p.cloneNode(!0);o.requestAnimationFrame(()=>{b.setAttribute("cloned",!0),b.style.top=0,b.style.left=0,b.style.width=p.getAttribute("width"),b.style.height=p.getAttribute("height"),b.style.position="absolute",b.style.animation=s(),d.target.appendChild(b),b.addEventListener("animationend",()=>{var g;return(g=b.parentNode)==null?void 0:g.removeChild(b)})})}),[...d.addedNodes].forEach(p=>{p.getAttribute("cloned")||o.requestAnimationFrame(()=>{m.style.position="relative";const b=p.getBoundingClientRect();if(p.setAttribute("width",b.width+"px"),p.setAttribute("height",b.height+"px"),l()){p.style.animation=l();const g=()=>{p.removeEventListener("animationend",g),p.style.animation=""};p.addEventListener("animationend",g)}})})},...c},u)}}const nt=["neutral","primary","success","danger","warning"],To=["plain","outline","solid"],Do=["sm","md","lg"],Ao=()=>nt.map(t=>`
&.button.plain.${t} {
  &:focus {
...
`);function N(t,e={}){const{bau:n,css:o}=t,a=o`
    ...
    ${Ao()}
  `;return function(...i){let[{size:s=e.size??"md",variant:l=e.variant??"none",color:c=e.color??"none",href:u,...d},...m]=V(i);return(u?n.tags.a:n.tags.button)({...!u&&{type:"button"},...d,class:["button",e.class,l,s,c,a,d.class.join(" ")],href:u},m)}}const Bo="light",No=()=>nt.map(t=>`
...
`);function ie(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(Bo);const c=o`
    ...
    ${No()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"plain",color:b=e.color??"neutral",...g},...f]=V(d);return r({required:"required",title:"Switch Theme",name:"theme-switch",...g,class:["theme-switch",b,p,m,c,e==null?void 0:e.class,g.class],type:"checkbox",checked:s()=="dark",onclick:y=>{i(y.target.checked?"dark":"light")}},...f)}}function Oo(t){const{tr:e,bau:n,css:o,config:a,states:r}=t,{i,header:s,h1:l,div:c,a:u,img:d,b:m,ul:p,li:b}=n.tags,{svg:g,path:f}=n.tagsNS("http://www.w3.org/2000/svg"),y=r.drawerOpen,h=N(t,{class:o`
    ...
    `}),x=ie(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),k=()=>c({class:o`
        ...
        `},k(),D())}}function Mo({tr:t,bau:e,css:n}){const{section:o,footer:a,span:r,a:i,ul:s,li:l,p:c,div:u,h1:d}=e.tags,m=({links:g,title:f})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
        ...
        `},u({class:n`
          ...
          `},m({title:"Bau UI",links:p}),m({title:"Bau Ecosystem",links:b})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},r("v0.82.0"),r("MIT license")))}}function vt(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:t`
   ...
   `});function ce(t,e={}){const{bau:n,css:o,window:a,config:r}=t,{base:i="",hashBased:s=!1}=e,l=`${r.base}${i}`,c=P=>{var C;return((C=P.parentTree.data)==null?void 0:C.href)??P.parentTree.children[0].data.href},u=({variant:P,color:C,size:v,currentTree:w,data:E})=>x(A({variant:P,color:C,size:v,href:`${l}${c(w)}`,class:o`
            flex-grow: 0;
...
`);function ut(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:["input",e.class,e.size??"md",c,l,r,s.class.join(" ")]})}}function le(t,e={}){const{bau:n,css:o,window:a}=t,r=ut(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,p=o`
    ...
    `}),f={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:k,variant:D,color:A,size:B})=>{const O=n.state(""),I=n.derive(()=>O.val==""?S:S.filter(j=>j.data.name.match(new RegExp(`${O.val}`,"i")))),L=j=>{O.val=j.target.value};return p({class:o`
        ...
        `},h({tree:f}))}}const Lo=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:r}=e.tags,i=Kt(t),s=Oo(t),l=He(t),c=Mo(t),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `,d=(m="")=>`${u} ease-in-out 0.5s ${m}`;return function({componentState:p}){return r({class:n`
        ...
        `},s(),l(),i({class:n`
            ...
            margin: 0 1rem;
            display: grid;
          `,animationHide:()=>d(),animationShow:()=>d("reverse")},()=>p.val),c())}};function Pt(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
    display: inline-flex;
    align-items: center;
    flex-grow: 0;
    box-sizing: border-box;
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",onclick:d,...m},...p]=V(s);return a({...m,onclick:d,class:["chip",e.class,l,c,u,d&&"clickable",r,m.class]},...p)}}function Po(t){const{bau:e,css:n,config:o}=t,{div:a,h1:r,h2:i,p:s}=e.tags;N(t);const l=n`
...
"Click me"
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(s);return a({...d,class:["paper",l,r,e==null?void 0:e.class,d==null?void 0:d.class]},...m)}}function cn(t,e={}){const{bau:n,css:o,window:a}=t,{nav:r,ul:i,li:s,a:l}=n.tags,{headerSelector:c="h2,h3"}=e,u=n.state("no"),d=(f,y)=>{let h=null;return(...x)=>{a.clearTimeout(h),h=a.setTimeout(()=>f(...x),y)}},m=o`
    grid-area: toc;
    position: sticky;
    right: 0;
    z-index: 1;
  ...
  `,p=({value:f,id:y,children:h=[]})=>{const x=l({class:()=>u.val==y?"active":"",href:`#${y}`});return x.innerHTML=f,s({class:()=>u.val==y?"active":""},x,h.length>0&&i(h.map(p)))},b=f=>f.tagName.charAt(1),g=({contentEl:f})=>{const y=f.querySelectorAll(c);let h=2,x={},S={children:[]},k=S;const D=k;let A=[k];return[...y].forEach(B=>{const O=b(B);B.setAttribute("id",B.textContent),!B.innerHTML.includes("<button")&&(x={value:B.innerHTML,id:B.id??B.textContent,children:[]},h==O?(S=x,k.children.push(S)):h<O?(A.push(k),k=S,S.children.push(x),S=x):h>O&&(k=A[O-1],A=A.slice(0,O-1),k.children.push(x),S=x),h=O)}),D};return function(...y){let[{size:h=e.size??"md",variant:x=e.variant??"plain",color:S=e.color??"neutral",contentEl:k,...D}]=V(y);const A=g({contentEl:k}),B=d(()=>{const I=[...k.querySelectorAll(c)].find(L=>{const{top:j,height:U}=L.getBoundingClientRect();if(j+U>60)return!0});I&&(u.val=I==null?void 0:I.id)},100);return r({...D,class:["tableOfContent",h,x,S,m,e==null?void 0:e.class,D==null?void 0:D.class],bauMounted:()=>{a.addEventListener("scroll",B)},bauUnmounted:()=>{a.removeEventListener("scroll",B)}},A.children&&i(A.children.map(p)))}}const ln=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(l(i(c(m??""),nt.map(p=>c(p)))),r(To.map(p=>i(c(p),nt.map((b,g)=>s(d({color:b,variant:p},{index:g}))))))))}},Ha=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          align-items: flex-start;
        `},Do.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;Mt.registerLanguage("javascript",sn);const m=cn(t),p=be(t,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),b=ln(t),g=Ha(t),f=({text:y})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:h})=>{h.innerHTML=Mt.highlight(y,{language:"js"}).value}}));return function(h){const x=a({class:n`
          grid-area: content;
          overflow-x: scroll;
...
`);function Zt(t,e={}){const{bau:n,css:o}=t,{div:a,ul:r,li:i,h3:s,button:l}=n.tags,c=o`
    ...
    ${Va()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"plain",color:b=e.color??"neutral",data:g=[],...f}]=V(d);const y=n.state(""),h=ge(t,{size:m,variant:p,color:b}),x=k=>D=>{y.val==k?y.val="":y.val=k},S=k=>{const{Header:D,Content:A,name:B}=k,O=()=>s({class:()=>y.val==B&&"active"},l({type:"button","aria-controls":`bau-${B}`,"aria-expanded":({element:L})=>y.val==B},D(k))),I=()=>a({id:`bau-${B}`,"data-state":({element:L})=>y.val==B},A(k));return i({class:[b,p,m],onclick:x(B)},h({Header:O,Content:I}))};return a({class:["accordion",c,e==null?void 0:e.class,f.class]},r(g.map(S)))}}const un=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],i=Zt(t,e);return s=>i({...s,data:r})},Ja=t=>{const{bau:e}=t,{div:n,p:o,section:a}=e.tags,r=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=Zt(t,{color:"neutral",variant:"outline"});return()=>a(i({data:r}))},qa=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,hr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:br,createComponent:pr},{title:"Component hide and show",description:"Hide and show a component",code:fr,createComponent:gr}]},vr=t=>{const e=F(t);return()=>e(hr)};function Et(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",...p},...b]=V(c);return r({...p,class:["skeleton",u,s,e==null?void 0:e.class,p==null?void 0:p.class]},...b)}}function fe(t,e={}){const{bau:n,css:o}=t,{div:a,img:r}=n.tags,i=n.state(!0),s=n.state(!1),l=()=>i.val=!1,c=d=>{i.val=!1,s.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",width:f=40,height:y=40,alt:h,...x},...S]=V(m);const k=Et(t,{class:[o`
          position: absolute;
          top: 0;
          left: 0;
          height: ${y}px;
          width: ${f}px;
        `,e==null?void 0:e.class,x.class]});return a({class:[u,e==null?void 0:e.class,x.class]},()=>i.val&&k(),()=>s.val&&h,r({alt:h,width:f,height:y,onload:l,onerror:c,class:()=>[!i.val&&"visible",s.val&&"hide",g,b,p,u,e==null?void 0:e.class,x.class],...x}))}}const pn=(t,e)=>{const{css:n}=t,o=fe(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
100% {
  ...
  `;return function({size:u=e.size??"md",color:d=e.color??"primary",variant:m=e.variant??"outline",visibility:p=!0,...b}={}){const g=o`
      ...
      ${Er()}
    `;return r({class:{deps:[p],renderProp:()=>f=>["spinner",g,d,m,f==!1?"":"visibility",e==null?void 0:e.class,b.class]},version:"1.1",x:"0px",y:"0px",width:qt[u],height:qt[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...b},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Tr=()=>nt.map(t=>`
...
`);function Rt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Tr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:p,Option:b,options:g,defaultOption:f,getOptionLabel:y,getOptionValue:h,onSelect:x=()=>{},id:S,required:k,name:D,loading:A,...B},...O]=V(l);const I=zt(t),L=N(t),j=ut(t,{variant:u,color:d,size:c}),U=vt(t),z=pt(t,{variant:u,color:d,size:c}),P=n.state(f),C=n.state(B.value),v=n.state(!1),w=n.state(0),E=()=>{v.val=!1},T=n.state(g),G=Y=>ot=>Y.val&&y(ot)==y(Y.val),R=()=>{lt.openDialog(),v.val=!0,C.val="",T.val=g,w.val=g.findIndex(G(P));const Y=Bt.querySelector("li.selected");Y&&(Y.scrollIntoView({block:"center"}),it.scrollIntoView({block:"end"}))},H=()=>{lt.closeDialog(),v.val=!1,w.val=0},J=Y=>{const{value:ot}=Y.target;C.val=ot,ot?T.val=g.filter(Gt=>y(Gt).match(new RegExp(`${ot}`,"i"))):T.val=g},M=Y=>{lt.open?H():R()},X=Y=>{P.val=Y,ct.value=h(Y)},tt=({option:Y,index:ot})=>Gt=>{X(Y),w.val=ot,H()},W=()=>{const Y=Bt.querySelector("li.active");Y&&Y.scrollIntoView({block:"center",behavior:"smooth"})},Z=Y=>{switch(Y.key){case"Escape":H();break;case"ArrowDown":w.val<T.val.length-1?w.val++:w.val=0,W();break;case"ArrowUp":w.val<=0?w.val=T.val.length-1:w.val--,W();break;case"Enter":lt.open?(X(T.val[w.val]),H()):R(),Y.preventDefault();break}},at=L({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":v,"aria-label":m,onclick:M,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>P.val?y(P.val):m,()=>A==!0&&z({visibility:A})),it=j({value:C,placeholder:p,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":v,oninput:J,onkeydown:Z,...B}),ct=j({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,defaultValue:f&&h(f),required:k,"aria-hidden":!1,"aria-label":D,name:D}),Bt=a({class:[u,d,c,"content"]},it,()=>U({class:[u,d,c]},T.val.map((Y,ot)=>r({class:()=>[w.val==ot&&"active",G(P)(Y)&&"selected"],onclick:tt({option:Y,index:ot})},b(Y))))),lt=I({id:S,triggerEl:at,contentEl:Bt,onClose:E,class:o`
        overflow: hidden;
      `});return a({...B,class:["autocomplete",i,e==null?void 0:e.class,B==null?void 0:B.class]},n.bind({deps:[P],render:()=>Y=>{Y&&(ct.value=h(Y),x(Y))}}),at,ct,lt)}}const bn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Rt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Nr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Rt(t),c=N(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Mr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=N(t,{variant:"outline"}),c=N(t,{variant:"solid",color:"primary"}),u=Rt(t),d=m=>i({class:n`
        ...
        `},s(m.flag),s(m.name.common));return()=>{const m=e.state([]),p=e.state(!1),b=e.state("");async function g({url:h,transform:x=S=>S}){try{p.val=!0;const S=await fetch(h,{});if(S.ok){const k=await S.json();m.val=x(k)}else b.val=S.statusText}catch(S){b.val=S.message}finally{p.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((x,S)=>x.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:h=>{h.preventDefault();const x=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(x))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({options:m.val,Option:d,getOptionValue:({name:h})=>h.common,getOptionLabel:({name:h})=>h.common,label:"Country",placeholder:"Search countries",name:"country",loading:p.val}),l({onclick:f},"Reload")),r(c({type:"submit"},"Submit")))}},Ir=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,Pr={title:"Auto Complete",package:"autocomplete",description:"An autocomplete allows to search and select an item from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/autocomplete/autocomplete.js",importStatement:'import autocomplete from "@grucloud/bau-ui/autocomplete";',examples:[{title:"Basic",description:"A simple autocomplete.",code:Br,createComponent:Ar},{title:"Loading Indicator",description:"A autocomplete with a loading indicator.",code:Ir,createComponent:Mr},{title:"Default Option",description:"A autocomplete with a default option.",code:Or,createComponent:Nr},{title:"URL State",description:"A autocomplete with the state in the URL",code:Lr,createComponent:$r}],gridItem:bn},zr=t=>{const e=F(t);return()=>e(Pr)};function gn(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...p]=V(s);return a({...m,class:["badge",r,e==null?void 0:e.class,m==null?void 0:m.class]},a({class:[u,c,l]},d),...p)}}const fn=(t,e)=>{const n=gn(t,e);return(o,{index:a})=>n({...o,content:`${a*100}`},"☏")},Rr=t=>{const{bau:e}=t,{section:n}=e.tags,o=gn(t);return()=>n(o({content:"10"},"☏"))},jr=`import badge from "@grucloud/bau-ui/badge";
import { Context } from "@grucloud/bau-ui/context";
...
`,_r={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:jr,createComponent:Rr}],gridItem:fn},Ur=t=>{const e=F(t);return()=>e(_r)};function he(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=N(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`,Hr=t=>{const{bau:e}=t,{section:n}=e.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=he(t,{variant:"plain",color:"neutral",separator:"/"});return()=>n(a(o))},Vr=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
  type BreadcrumbsProps,
} from "@grucloud/bau-ui/breadcrumbs";
...
`,os={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:ns,createComponent:es}],gridItem:yn},as=t=>{const e=F(t);return()=>e(os)};function ye(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>nt.map(s=>`
...
`,ls={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Uncontrolled Calendar",description:"A simple calendar.",code:ss,createComponent:rs},{title:"Controlled Calendar",description:"A controlled calendar.",code:cs,createComponent:is}],gridItem:xn},us=t=>{const e=F(t);return()=>e(ls)};function ds(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `,i=n.state(0);return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",slides:m,Slide:p,Previous:b,Next:g,...f}]=V(l);const y=()=>{i.val<=0?i.val=m.length-1:i.val--},h=()=>{i.val>=m.length-1?i.val=0:i.val++},x=a({class:"track",style:()=>`transform: translateX(${-100*i.val}%);`},m.map(p));return a({...f,class:["carousel",c,r,e==null?void 0:e.class,f==null?void 0:f.class]},a({class:["control","control-previous"],onclick:y},b()),a({class:["control","control-next"],onclick:h},g()),x)}}const ms=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],ps=t=>{const{bau:e,css:n}=t,{section:o,img:a}=e.tags,r=N(t,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,ys={title:"Chip",package:"chip",description:"The chip component displays text that needs to stand out and get noticed. ",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/chip/chip.js",importStatement:'import chip from "@grucloud/bau-ui/chip";',examples:[{title:"Default",description:"A simple chip.",code:vs,createComponent:hs}],gridItem:wn},xs=t=>{const e=F(t);return()=>e(ys)};function xt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
    margin: 0.5rem;
    width: 1.5rem;
    height: 1.5rem;
    border-radius: var(--global-radius);
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(s);return a({type:"checkbox",...d,class:[r,u,c,l,e==null?void 0:e.class,d==null?void 0:d.class]})}}const Sn=(t,e)=>{const{bau:n,css:o}=t,{label:a}=n.tags,r=xt(t,e);return i=>a({class:o`
          display: flex;
...
`,Cs=t=>{const{bau:e,css:n}=t,{label:o,footer:a,article:r,form:i}=e.tags,s=xt(t,{color:"neutral",variant:"outline"}),l=N(t,{variant:"outline",color:"primary"});return()=>i({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
          & article {
...
`,Is={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Ms,createComponent:Os}]},$s=t=>{const e=F(t);return()=>e(Is)};function Ls(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    display: flex;
    align-items: center;
    .content {
      margin: 1rem;
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=V(s);return a({...d,class:["divider",l,r,e==null?void 0:e.class,d==null?void 0:d.class]},a({class:"content"},...m))}}const Ps=t=>{const{bau:e}=t,{section:n}=e.tags,o=Ls(t);return()=>n(o("OR"))},zs=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`,Rs={title:"Divider",package:"divider",description:"The divider component is a separator between components",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/divider/divider.js",importStatement:'import divider from "@grucloud/bau-ui/divider";',examples:[{title:"Simple Divider",description:"A simple divider.",code:zs,createComponent:Ps}],variantColorTableDisable:!0,variantSizeDisable:!0},js=t=>{const e=F(t);return()=>e(Rs)};function _s(t,e){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{color:l,variant:c="outline",size:u,openState:d,...m},...p]=V(s);return a({class:[r,e==null?void 0:e.class,m.class]},a({class:()=>["overlay",d.val&&"overlay-open"],onclick:()=>{d.val=!1}}),a({class:()=>["content",d.val&&"content-open"]},p))}}const Us=t=>{const{bau:e}=t,{section:n,p:o}=e.tags,a=_s(t),r=N(t,{color:"neutral",variant:"outline"}),i=He(t);return()=>{const s=e.state(!1);return n(o("Click on the button to open and close the drawer."),r({onclick:()=>{s.val=!s.val}},"OPEN DRAWER"),a({openState:s},i()))}},Gs=`import drawer from "@grucloud/bau-ui/drawer";
import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=N(t),s=zt(t),l=vt(t),c=o`
    ${Vs()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"outline",color:b=e.color??"neutral",label:g,ListItem:f,items:y,...h},...x]=V(d);const S=n.state(0),k=()=>{U.openDialog(),U.focus()},D=()=>{U.closeDialog()},A=()=>{U.open?D():k()},B=z=>{A(),z.preventDefault()},O=({item:z,index:P})=>C=>{S.val=P,D(),C.preventDefault()},I=z=>{switch(z.preventDefault(),z.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},L=()=>l({tabindex:"0",class:[b,p]},y.map((z,P)=>r({class:()=>[S.val==P&&"active"],onclick:O({item:z,index:P})},f(z)))),j=i({type:"button",onclick:B,color:b,variant:p,size:m},g),U=s({triggerEl:j,contentEl:L()});return a({...h,class:["dropdownMenu",b,m,c,e==null?void 0:e.class,h==null?void 0:h.class],onkeydown:I},j,U)}}const Js=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=Cn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},qs=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=Cn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Ws=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,Qs={title:"DrilldownMenu",package:"drilldownMenu",description:"The drilldown menu component helps navigate thought hierachical data.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/drilldownMenu/drilldownMenu.js",importStatement:'import drilldownMenu from "@grucloud/bau-ui/drilldownMenu";',examples:[{title:"Default",description:"A simple drilldown menu.",code:Ys,createComponent:Zs}],gridItem:(t,e)=>kn(t,{base:"/components/drillDownMenu",hashBased:!0,...e})},ti=t=>{const e=F(t);return()=>e(Qs)};function En(t,e={}){const{bau:n,css:o}=t,{div:a,label:r,input:i}=n.tags,s={base:o`
    ...
    `};return function(c,...u){const{size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",Component:b,disabled:g,...f}=c;return a({class:[s.base,g&&s.disabled,e==null?void 0:e.class,c.class]},r({class:[m,p,d]},b({disabled:g}),i({type:"file",disabled:g,...f})))}}const Tn=(t,e)=>{const{tr:n,bau:o,css:a,config:r}=t,{svg:i,use:s}=o.tagsNS("http://www.w3.org/2000/svg"),{div:l,span:c}=o.tags,u=o.state("No file selected"),d=En(t,e),m=b=>{const g=b.target.files[0];g?u.val=g.name:u.val="No file selected"},p=({disabled:b})=>l({class:[a`
            display: flex;
            align-items: center;
            flex-direction: column;
...
`,oi={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:ni,createComponent:ei}],gridItem:Tn},ai=t=>{const e=F(t);return()=>e(oi)};function bt(t,e={}){const{bau:n,css:o}=t,{form:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...p]=V(s);return a({...m,class:["form",u,c,l,r,e==null?void 0:e.class,m==null?void 0:m.class]},...p)}}function xe(t,e={}){const{bau:n,css:o,keyframes:a}=t,{span:r}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`,s=o`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",loading:p,...b},...g]=V(c);const f=N(t),y=pt(t);return n.bind({deps:[p],render:()=>h=>f({...b,class:["loadingButton",u,d,m,s,h&&"loading",e==null?void 0:e.class,b==null?void 0:b.class]},y({size:u,variant:d,color:m,visibility:h}),r({class:h&&"loading"},g))})}}const ri=t=>{const{bau:e,css:n,config:o}=t,{section:a,h1:r,header:i,label:s,img:l,footer:c}=e.tags,u=xe(t,{variant:"solid",color:"primary"}),d=Tt(t,{variant:"outline",color:"danger"}),m=ut(t),p=bt(t,{class:n`
      max-width: 400px;
      & > header {
        text-align: center;
      }
...
`,ii=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:r,footer:i}=e.tags,s=bt(t),l=N(t,{variant:"solid",color:"primary"}),c=ut(t);return function({onSubmitted:d=()=>{}}){return s({onsubmit:async p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b)),d(b)}},a(o("Form with input")),n(r("Branch",c({autofocus:!0,placeholder:"Branch",name:"branch",required:!0}))),i(l({type:"submit"},"Click")))}},ci=`import form from "@grucloud/bau-ui/form";
import input from "@grucloud/bau-ui/input";
import button from "@grucloud/bau-ui/button";
...
`,li=t=>{const{bau:e}=t,{section:n,h1:o,header:a,label:r,footer:i,em:s,span:l}=e.tags,c=e.state(""),u=e.derive(()=>c.val!=="Delete"),d=bt(t),m=N(t,{variant:"solid",color:"danger"}),p=ut(t);return function({onSubmitted:g=()=>{}}){return d({onsubmit:async y=>{y.preventDefault(),g()}},a(o("Delete Protection")),n(r(l("Type ",s("Delete")," to confirm the destruction of the resource."),p({autofocus:!0,placeholder:"Type 'Delete'",name:"check",required:!0,value:c,oninput:y=>c.val=y.target.value}))),i(m({type:"submit",disabled:u},"Delete")))}},ui=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ii=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=e.state(!1),r=On(t,{loading:()=>o("My Custom Loading"),error:s=>o("My Custom Error")}),i=N(t);return()=>n(i({onclick:()=>a.val=!a.val},()=>a.val?"Hide":"Show"),()=>a.val&&r({getModule:()=>Nn(()=>import("./myComponent-a7adf959.js"),[]),props:{message:"Additional Props here"}}))},$i=`import { Context } from "@grucloud/bau-ui/context";
import lazy from "@grucloud/bau-ui/lazy";
import button from "@grucloud/bau-ui/button";
export default (context: Context) => {
  const { bau } = context;
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:p=e.color??"neutral",running:b,...g}]=V(u);return r({...g,role:"progressbar",class:{deps:[b],renderProp:()=>f=>["linearProgress",d,p,l,f&&"running",e==null?void 0:e.class,g==null?void 0:g.class]}})}}const In=(t,e)=>{const n=Mn(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},zi=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=N(t,{variant:"solid",color:"primary"}),r=Mn(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},Ri=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,Fi={title:"LoadingButton",package:"loadingButton",description:"The loadingButton component displays a button with a loading indicator.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/loadingButton/loadingButton.js",importStatement:'import loadingButton from "@grucloud/bau-ui/loadingButton";',examples:[{title:"Simple LoadingButton",description:"A simple loadingButton.",code:Gi,createComponent:Ui}],gridItem:$n},Hi=t=>{const e=F(t);return()=>e(Fi)},Vi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Ji=(t,e)=>{const{bau:n,css:o}=t,{span:a,li:r}=n.tags,i=vt(t,e),s=({code:l,label:c})=>r({class:o`
          display: flex;
          gap: 1rem;
        `},a(l),a(c));return l=>i({...l},Vi.map(s))},qi=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Wi=t=>{const{bau:e,css:n}=t,{section:o,span:a,li:r}=e.tags,i=vt(t,{variant:"outline",color:"primary"}),s=({code:l,label:c})=>r({class:n`
          display: flex;
          gap: 1rem;
...
`,Xi={title:"Input",package:"list",description:"The list component displays a list of items.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/list/list.js",importStatement:'import list from "@grucloud/bau-ui/list";',examples:[{title:"Default",description:"A simple list.",code:Ki,createComponent:Wi}],gridItem:Ji},Zi=t=>{const e=F(t);return()=>e(Xi)};function Ln(t,e={}){const{bau:n,css:o,window:a}=t,{dialog:r,div:i}=n.tags,l=o`
    margin: auto;
    padding: 1rem;
    box-shadow: var(--shadow-s);
    background-color: var(--background-color);
...
`).join(`
`);function oc(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=N(t),l=zt(t),c=vt(t),u=xt(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${nc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",name:y,label:h,Option:x,options:S,defaultValue:k=[],getOptionLabel:D,getOptionValue:A,renderValue:B,onSelect:O=()=>{},loading:I,...L},...j]=V(p);const U=pt(t,{variant:g,color:f,size:b}),z=n.state(k),P=n.state(!1),C=n.state(0),v=()=>{X.openDialog(),X.focus(),P.val=!0},w=()=>{X.closeDialog(),P.val=!1},E=()=>{P.val=!1},T=W=>{X.open?w():v(),W.preventDefault()},G=()=>Array.from(tt.selectedOptions).map(({value:W})=>S.find(Z=>A(Z)==W)),R=W=>{switch(W.preventDefault(),W.key){case"Escape":w();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Z=W.currentTarget.querySelectorAll("input")[C.val];Z.checked=!Z.checked;const at=tt.options[C.val+1];at.selected=!at.selected,z.val=G()}else v();break}},H=W=>Z=>{const at=[...tt.options].find(({value:it})=>it==A(W));Z.target.checked?at.selected=!0:at.selected=!1,z.val=G()},J=()=>c({tabindex:"0",class:[f,g]},S.map((W,Z)=>r({class:()=>C.val==Z&&"active"},n.tags.label(u({checked:k.find(at=>A(at)==A(W)),name:`${y}-${A(W)}`,onchange:H(W)}),x(W))))),M=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":P,"aria-label":h,onclick:T,color:f,variant:g,size:b,class:I==!0&&"loading",disabled:I},()=>z.val.length?B(z.val):h,()=>I==!0&&U({visibility:I})),X=l({triggerEl:M,contentEl:J(),onClose:E}),tt=i({name:y,multiple:!0,...L},n.tags.option({value:""},"--Category--"),S.map(W=>n.tags.option({value:A(W),selected:k.find(Z=>A(Z)==A(W))},D(W))));return a({...L,class:["multiSelect",f,b,d,e==null?void 0:e.class,L==null?void 0:L.class],onkeydown:R},tt,M,X)}}const ac=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=oc(t),l=N(t,{variant:"outline",color:"neutral"}),c=Pt(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=m=>a(m.group);return()=>r({onsubmit:p=>{p.preventDefault();const{selectedOptions:b}=p.target.elements.myMultiSelect,g=Array.from(b).map(({value:f})=>f);alert(JSON.stringify(g))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
        `},s({name:"myMultiSelect",options:u,Option:d,defaultValue:[{group:"IAM"}],getOptionValue:({group:p})=>p,getOptionLabel:({group:p})=>p,renderValue:p=>o({class:n`
                ...
                align-items: center;
                gap: 0.2rem;
              `},p.map(b=>c(b.group))),label:"Select services"}),i(l({type:"submit"},"Submit")))},rc=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,hc={title:"Pagination Navigation",package:"paginationNavigation",description:"The paginationNavigation component displays a previous and a next button for navigation",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paginationNavigation/paginationNavigation.js",importStatement:'import paginationNavigation from "@grucloud/bau-ui/paginationNavigation";',examples:[{title:"Simple PaginationNavigation",description:"A simple paginationNavigation.",code:fc,createComponent:gc}]},vc=t=>{const e=F(t);return()=>e(hc)},yc=(t,e)=>{const{bau:n}=t,{div:o}=n.tags,a=be(t,e);return r=>a({...r},o(`Paper ${e.size??""}`))},xc=t=>{const{bau:e}=t,{section:n,div:o}=e.tags,a=be(t,{size:"md"});return()=>n(a(o("My content")))},wc=`import paper from "@grucloud/bau-ui/paper";
import { Context } from "@grucloud/bau-ui/context";
...
`,Sc={title:"Paper",package:"paper",description:"The paper component displays child components on a surface area.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/paper/paper.js",importStatement:'import paper from "@grucloud/bau-ui/paper";',examples:[{title:"Default",description:"A simple paper.",code:wc,createComponent:xc}],variantColorTableDisable:!0,gridItem:yc},Cc=t=>{const e=F(t);return()=>e(Sc)};function we(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    cursor: pointer;
    &.sm {
      transform: scale(0.8);
    }
...
`).join(`
`))()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=V(l);return a({...m,type:"radio",class:["radio-button",c,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class]})}}const zn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:r}=n.tags,i=we(t,e);return s=>r({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `,onsubmit:b},i(l(c("One or two"),o("One",u({id:"one",name:"radio",checked:!0,value:m,oninput:p})),o("Two",u({id:"two",name:"radio",value:m,oninput:p}))),a("Choice: ",m)),s(d({type:"submit"},"Submit")))}},Ec=`import { Context } from "@grucloud/bau-ui/context";
...
`,$c=t=>{const{bau:e,config:n}=t,{form:o,article:a,footer:r,img:i}=e.tags,s=jt(t),l=N(t,{variant:"outline",color:"primary"}),c=()=>i({src:`${n.base}/login/github.svg#Capa_1`,alt:"GitHub",width:28,height:28}),u=()=>i({src:`${n.base}/login/gitlab-logo.svg#Capa_1`,alt:"GitLab",width:28,height:28});return()=>o({onsubmit:m=>{m.preventDefault();const p=Object.fromEntries(new FormData(m.currentTarget));alert(JSON.stringify(p))}},a(s({name:"git_provider_type",value:"",radios:[{value:"GitHub",Label:()=>[c(),"GitHub"]},{value:"GitLab",Label:()=>[u(),"GitLab"]}]})),r(l({type:"submit"},"Submit")))},Lc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Rc={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:Ic,createComponent:Mc},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Bc,createComponent:Ac},{title:"Url State Radio Button Group",description:"A radio button group with the state in the URL",code:Oc,createComponent:Nc},{title:"Label with Image",description:"A label with an image.",code:Lc,createComponent:$c},{title:"Label with description",description:"A label with name and description.",code:zc,createComponent:Pc}]},jc=t=>{const e=F(t);return()=>e(Rc)};function Lt(t,e={}){const{bau:n,css:o,window:a}=t,{section:r,article:i,div:s}=n.tags,{document:l}=a,{direction:c="horizontal"}=e,u=o`
  ...
  `;function d(...b){let[g,...f]=V(b);return r({...g,class:["resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u]},f)}function m(...b){let[g,...f]=V(b);return i({...g,class:["resizablePanel",g==null?void 0:g.class]},f)}function p(...b){let[g,...f]=V(b),y=0,h=0,x,S,k,D,A;const B=()=>c==="horizontal",O=z=>B()?I(z):L(z),I=z=>{const P=z.clientX-y;A&&(D.style.width=`${A.width+P}px`),k&&(S.style.width=`${k.width-P}px`)},L=z=>{const P=z.clientY-h;A&&(D.style.height=`${A.height+P}px`),k&&(S.style.height=`${k.height-P}px`)},j=()=>{S=null,D=null,k=null,A=null,x.style.cursor=null,x.style["user-select"]="auto",l.removeEventListener("mousemove",O),l.removeEventListener("mouseup",j)},U=z=>{y=z.clientX,h=z.clientY;const{target:P}=z,C=P.closest(".handle");x=P.closest(".resizablePanelGroup"),x.style.cursor=B()?"col-resize":"row-resize",x.style["user-select"]="none",S=C.nextSibling,D=C.previousSibling,D&&(A=D.getBoundingClientRect()),S&&(k=S.getBoundingClientRect()),l.addEventListener("mousemove",O),l.addEventListener("mouseup",j)};return s({...g,class:["handle",c],role:"separator",bauMounted:({element:z})=>{z.addEventListener("mousedown",U)},bauUnmounted:({element:z})=>{z.removeEventListener("mousedown",U)}},f)}return{PanelGroup:d,Panel:m,Handle:p}}const _c=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
      display: inline-flex;
...
`,Gc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
      display: inline-flex;
      border: 1px var(--color-emphasis-100) solid;
      width: 600px;
    `}),l=()=>i({class:n`
...
`,Hc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{direction:"vertical",class:n`
      display: inline-flex;
      flex-direction: column;
...
`,Jc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=Lt(t,{class:n`
      display: inline-flex;
    ...
    `}),l=Lt(t,{direction:"vertical",class:n`
      flex-grow: 1;
      display: inline-flex;
      flex-direction: column;
      min-width: fit-content;
...
`).join(`
`);function Dt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,l=N(t),c=zt(t),u=vt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Xc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",label:y,Option:h,options:x,defaultOption:S,getOptionLabel:k,getOptionValue:D,onSelect:A=()=>{},loading:B,...O},...I]=V(p);const L=pt(t,{variant:g,color:f,size:b}),j=n.state(S?k(S):y),U=n.state(!1),z=n.state(0),P=()=>{H.openDialog(),H.focus(),U.val=!0},C=()=>{H.closeDialog(),U.val=!1},v=()=>{U.val=!1},w=M=>{H.open?C():P(),M.preventDefault()},E=({option:M,index:X})=>tt=>{j.val=k(M),J.value=D(M),J.setCustomValidity(""),z.val=X,C(),A(M),tt.preventDefault()},T=M=>{switch(M.preventDefault(),M.key){case"Escape":C();break;case"ArrowDown":z.val<x.length-1?z.val++:z.val=0;break;case"ArrowUp":z.val<=0?z.val=x.length-1:z.val--;break;case"Enter":H.open?(j.val=k(x[z.val]),J.value=D(s),C()):P();break}},G=()=>u({tabindex:"0",class:[f,g]},x.map((M,X)=>r({class:()=>z.val==X&&"active",onclick:E({option:M,index:X})},h(M)))),R=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":U,"aria-label":y,onclick:w,color:f,variant:g,size:b,class:B==!0&&"loading",disabled:B},()=>!j.val&&y,j,()=>B==!0&&L({visibility:B})),H=c({triggerEl:R,contentEl:G(),onClose:v}),J=i({...O,"aria-label":y},s({value:""},"--Select Category--"),x.map(M=>s({value:D(M)},k(M))));return S?J.value=D(S):J.value=O.value,a({...O,class:["select",f,b,d,e==null?void 0:e.class,O==null?void 0:O.class],onkeydown:T},J,R,H)}}const Rn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Dt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Qc=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Dt(t),c=N(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},s(p.label),s(p.code));return()=>o({onsubmit:b=>{b.preventDefault();const g=Object.fromEntries(new FormData(b.currentTarget));alert(JSON.stringify(g))}},a(l({name:"country",options:d,Option:m,defaultOption:d.find(({code:b})=>b==u),getOptionValue:({code:b})=>b,getOptionLabel:({label:b})=>b,label:"Select a country..."})),r(c({type:"submit"},"Submit")))},tl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import select from "@grucloud/bau-ui/select";
...
`,rl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=N(t,{variant:"outline"}),c=N(t,{variant:"solid",color:"primary"}),u=Dt(t),d=m=>s({class:n`
        ...
        `},i(m.flag),i(m.name.common));return()=>{const m=e.state([]),p=e.state(!1),b=e.state("");async function g({url:h,transform:x=S=>S}){try{p.val=!0;const S=await fetch(h,{});if(S.ok){const k=await S.json();m.val=x(k)}else b.val=S.statusText}catch(S){b.val=S.message}finally{p.val=!1}}const f=()=>g({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:h=>h.sort((x,S)=>x.name.common.localeCompare(S.name.common))});return f(),o({onsubmit:h=>{h.preventDefault();const x=Object.fromEntries(new FormData(h.currentTarget));alert(JSON.stringify(x))}},a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>u({name:"country",options:m.val,Option:d,getOptionValue:({name:h})=>h.common,getOptionLabel:({name:h})=>h.common,label:"Country",id:"country",loading:p.val,required:!0}),l({onclick:()=>f()},"Reload")),r(c({type:"submit"},"Submit")))}},sl=`import { Context } from "@grucloud/bau-ui/context";
import select from "@grucloud/bau-ui/select";
import button from "@grucloud/bau-ui/button";
...
`,il={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Yc,createComponent:Zc},{title:"Default Option",description:"Select with a default option",code:tl,createComponent:Qc},{title:"State in URL",description:"Select with state in URL",code:nl,createComponent:el},{title:"Select AWS region",description:"Select the AWS region",code:al,createComponent:ol},{title:"Loading Indicator",description:"Select with a loading indicator",code:sl,createComponent:rl}],gridItem:Rn},cl=t=>{const e=F(t);return()=>e(il)};function Se(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=V(s);return a({...d,class:["select-native",u,l,c,r,e==null?void 0:e.class,d==null?void 0:d.class]},m)}}const jn=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=Se(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},r.map(({label:s,phone:l})=>o({value:l},s)))},ll=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,r=N(t,{variant:"outline",color:"primary"}),i=Se(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),s.map(({label:c,phone:u})=>n({value:u},c))),a(r({type:"submit"},"Submit")))},ul=`import { Context } from "@grucloud/bau-ui/context";
...
`,dl=t=>{const{bau:e,window:n}=t,{option:o,form:a,footer:r}=e.tags,i=N(t,{variant:"outline",color:"primary"}),s=Se(t),l=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c="my-select";return()=>{const u=g=>{g.preventDefault();const f=Object.fromEntries(new FormData(g.currentTarget));alert(JSON.stringify(f))},d=g=>{const f=new URLSearchParams(n.location.search);f.delete(c),f.append(c,g.target.value),n.history.replaceState("","",`?${f.toString()}${n.location.hash}`)},p=new URLSearchParams(n.location.search).get(c),b=l.map(({label:g,code:f})=>o({value:f,selected:f==p},g));return a({onsubmit:u},s({name:c,oninput:d},o({value:""},"--Please choose a phone code--"),b),r(i({type:"submit"},"Submit")))}},ml=`import { Context } from "@grucloud/bau-ui/context";
import selectNative from "@grucloud/bau-ui/selectNative";
import button from "@grucloud/bau-ui/button";
...
`,hl=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=Et(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`).join(`
`))()};
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...p]=V(l);return a({...m,type:"range",class:["slider",d,u,c,i,e==null?void 0:e.class,m.class]},...p)}}const _n=t=>{const{bau:e}=t,n=e.state(0),o=r=>{n.val=r==null?void 0:r.target.value},a=At(t);return r=>a({"aria-label":"slider",...r,oninput:o})},El=t=>{const{bau:e}=t,{form:n,article:o,label:a,br:r,footer:i}=e.tags,s=At(t),l=N(t,{variant:"solid",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(a("Slider with step, min and max",r,s({name:"slider-simple",step:20,min:-100,max:100}))),i(l({type:"submit"},"Submit")))},Tl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,Bl=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=At(t),d=N(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o(i({for:"temp"},"Choose a comfortable temperature"),l,u({class:n`
          ...
          `,id:"temp",name:"temp",list:"markers"}),s({id:"markers",class:n`
              ...
              display: flex;
              justify-content: space-between;
            `},["0","25","50","75","100"].map(p=>c({value:Number(p),label:p})))),a(d({type:"submit"},"Submit")))},Nl=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import slider from "@grucloud/bau-ui/slider";
...
`,Ol=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=At(t),d=N(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o({class:n`
            display: flex;
...
`,_e="stepper-vertical",Hl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=e.tags,d=ut(t),m=bt(t),p=Fn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`);function _t(t,e={}){const{bau:n,css:o,window:a}=t,{tabDefs:r}=e,{div:i,ul:s,li:l,a:c}=n.tags,u=o`
    ...
    ${ou()}
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",tabsKey:f="tabs",...y},...h]=V(m);const x=n.state(r),S=I=>x.val.find(L=>L.name==I),k=n.state(r[0]),D=()=>{var j,U;const L=new URLSearchParams(a.location.search).get(f)??r[0].name;if(L!=k.val.name){const z=S(L);(j=k.val.exit)==null||j.call(),k.val=z,(U=z==null?void 0:z.enter)==null||U.call()}};D(),a.history.pushState=new Proxy(a.history.pushState,{apply:(I,L,j)=>{I.apply(L,j);const U=j[2]??"";["?","#"].includes(U[0])&&D()}});const A=I=>{const L=new URLSearchParams(a.location.search);return L.delete(f),L.append(f,I),`?${L.toString()}`},B=I=>{const{Header:L,disabled:j,name:U}=I;return l({class:()=>[k.val.name==U&&"active",j&&"disabled"]},c({href:A(U)},L(I)))},O=i({class:["tabs",b,p,g,u,e==null?void 0:e.class,y.class],bauMounted:({element:I})=>{a.addEventListener("popstate",D)},bauUnmounted:()=>{a.removeEventListener("popstate",D)}},n.loop(x,s(),B),n.bind({deps:[k],render:()=>({Content:I})=>I?I(y):""}));return O.addEventListener("tab.add",I=>{var j;const{tab:L}=I.detail;(j=L.enter)==null||j.call(),x.val.push(L)},!1),O.addEventListener("tab.remove",I=>{var j;const L=x.val.findIndex(U=>U.name==I.detail.tabName);L>0&&((j=x.val[L].exit)==null||j.call(),x.val.splice(L,1))},!1),O}}const au=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=_t(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]});return()=>r({})},ru=`import tabs, { Tabs } from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const i=o`
  ...
  `;return function(...l){let[{...c},...u]=V(l);return r({...c,class:["table-container",i,e==null?void 0:e.class,c==null?void 0:c.class]},...u)}}const bu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags;function d(f,y,h,x,S){return{name:f,calories:y,fat:h,carbs:x,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],p=({name:f,calories:y})=>i(r(f),r({class:n`
      ...
      max-width: 650px;
    `});return()=>o(g(s(u("Basic Table"),b(),c(m.map(p)))))},gu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Nt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const fu=[Nt("Frozen yoghurt",159,6,24,4),Nt("Ice cream sandwich",237,9,37,4.3),Nt("Eclair",262,16,24,6),Nt("Cupcake",305,3.7,67,4.3),Nt("Gingerbread",356,16,49,3.9)],hu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
          ...
          `},g)),m=()=>l(i(a({class:n`
            ...
            `,title:"Product Name"},"Product Name"),a({class:n`
              text-align: right;
            `,title:"Calories"},"Calories"))),p=Ut(t,{class:n`
      & td,
      th {
        padding: 0.4rem;
      }
    `});return()=>o(p(s(u("Table Dense"),m(),c(fu.map(d)))))},vu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Ot(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const yu=[Ot("Frozen yoghurt",159,6,24,4),Ot("Ice cream sandwich",237,9,37,4.3),Ot("Eclair",262,16,24,6),Ot("Cupcake",305,3.7,67,4.3),Ot("Gingerbread",356,16,49,3.9)],xu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
    ...
    `});return()=>o(p(s(u("Table Zebra"),m(),c(yu.map(d)))))},wu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,Tu={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Eu,createComponent:ku}]},Du=t=>{const e=F(t);return()=>e(Tu)};function Jn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=ve(t),i=N(t),s=pt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:b,icon:g,...f})=>i({"aria-label":b,title:b,...f},g),u=({count:b,totalCount:g,page:f,rowsPerPage:y})=>a({class:"pages-numbers"},Number(f-1)*Number(y)+(b>0?1:0),"-",Math.min(f*y,g)," of ",g),d=({count:b,page:g,rowsPerPage:f})=>a({class:"pages-numbers"},(g-1)*f+(b>0?1:0),"-",g*f),m=b=>b<=1,p=(b,g,f)=>b>=Math.ceil(g/f);return function(...g){let[{size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",count:x=0,totalCount:S=0,page:k=1,rowsPerPage:D=50,onPageChange:A,isLoading:B=!1,disableFirst:O=()=>m(k),disablePrevious:I=()=>m(k),disableNext:L=()=>p(k,S,D),disableLast:j=()=>p(k,S,D),...U},...z]=V(g);const P=Math.max(0,Math.ceil(S/D)),C=A({page:1}),v=A({page:k-1}),w=A({page:k+1}),E=A({page:P}),T=[{label:"First",icon:"⟪",onclick:C,disabled:O()},{label:"Previous",icon:"⟨",onclick:v,disabled:I()},{label:"Next",icon:"⟩",onclick:w,disabled:L()},{label:"Last",icon:"⟫",onclick:E,disabled:j()}];return a({...U,class:["table-pagination",l,B&&"disabled",e==null?void 0:e.class,U==null?void 0:U.class]},s({class:"spinner",visibility:B,size:"md"}),S>0?u({count:x,totalCount:S,page:k,maxPages:P,rowsPerPage:D}):d({count:x,page:k,maxPages:P,rowsPerPage:D}),r({variant:y,color:h},T.map(G=>c({...G,variant:y,color:h}))))}}const Au=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Bu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=Au(45),u=({name:b,email:g})=>r(a(b),a(g)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=Jn(t),p=Ut(t,{class:n`
      max-width: 650px;
    `});return()=>{const b=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),f=e.derive(()=>b.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:h})=>x=>{g.val.page=h};return p(i(d(),()=>l(f.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Nu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),p=e.derive(()=>d.val.length),b=e.state(1),g=e.state(10),f=e.derive(()=>d.val),y=O=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(O).toString()}`,h=({page:O})=>I=>{b.val=O,x(y({page:O,per_page:g.val}))};x(y({page:1,per_page:g.val}));async function x(O){try{u.val=!0;const I=await fetch(O,{});if(I.ok){const L=await I.json();d.val=L;return}throw I}catch(I){m.val=I.message}finally{u.val=!1}}const S=({name:O,description:I,stargazers_count:L})=>r(a(O),a(I),a({class:n`
            text-align: right;
          `},L)),k=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),B=({message:O})=>c(O);return()=>A(()=>D({rowsPerPage:g.val,page:b.val,count:p.val,totalCount:-1,isLoading:u.val,onPageChange:h,disableNext:()=>!1}),i(k(),()=>m.val&&B({message:m.val}),()=>l(f.val.map(S))))},Ou=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=Bu(t),c=Nu(t),u=(...d)=>a({class:n`
        ...
        `},...d);return()=>o({id:"pagination"},i(s("Table Pagination")),r("Asynchronous Pagination"),u(c()),r("Simple Pagination"),u(l()))};function wt(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{button:r}=n.tags;a`
    :root {
...
`,$u=t=>{const{bau:e,window:n}=t,{document:o}=n,{form:a,article:r,footer:i}=e.tags,s="my-toogle-uncontrolled",l=wt(t,{variant:"solid",color:"primary"}),c=N(t,{variant:"outline",color:"primary"});return()=>a({onsubmit:d=>{d.preventDefault();const m=o.getElementsByName(s)[0];alert(m.getAttribute("aria-pressed"))}},r(l({name:s},"Toggle Me")),i(c({type:"submit"},"Submit")))},Lu=`import { Context } from "@grucloud/bau-ui/context";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,Ru={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Controlled Toggle",description:"A controlled toggle.",code:Iu,createComponent:Mu},{title:"Uncontrolled Toggle",description:"A uncontrolled toggle.",code:Lu,createComponent:$u},{title:"State in URL",description:"Toggle with state stored in the URL.",code:zu,createComponent:Pu}],gridItem:qn},ju=t=>{const e=F(t);return()=>e(Ru)},_u=()=>nt.map(t=>`
&.toggle-group.${t} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${t}) !important;
  }
...
`,Fu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=wt(t,{variant:s,color:i}),c=Ce(t,{variant:s,color:i}),u=N(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{b.preventDefault();const f=[...b.currentTarget.querySelectorAll("button[aria-pressed=true]")].map(({name:y})=>y);alert(JSON.stringify(f))}},o(c({onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),a(u({type:"submit"},"Submit")))}},Hu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,Vu={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Gu,createComponent:Uu},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:Hu,createComponent:Fu}],gridItem:Wn},Ju=t=>{const e=F(t);return()=>e(Vu)};function ke(t,e={}){const{bau:n,css:o,window:a}=t,{div:r}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
  ...
  `;return function(...l){let[{titleEl:c,side:u="bottom-start",size:d=e.size??"md",variant:m=e.variant??"outline",color:p=e.color??"neutral",...b},...g]=V(l);const f=r({class:["container",...u.split("-")]},r({class:["content",p,m,d],role:"tooltip"},c)),y=A=>`move-to-${A}`,h=(A,B,O)=>{if(A()){const I=y(B);f.classList.add(I),f.classList.add(B),f.classList.remove(O)}},x=(A,B)=>{const O=y(A);f.classList.contains(O)&&(f.classList.remove(O),f.classList.add(B),f.classList.remove(A))},S=A=>{const B=f.getBoundingClientRect();h(()=>B.x<0,"right","left"),h(()=>B.x+B.width>a.innerWidth,"left","right"),h(()=>B.y<0,"bottom","top"),h(()=>B.bottom>a.innerHeight,"top","bottom"),f.classList.add("visible")},k=A=>{f.classList.remove("visible"),x("right","left"),x("left","right"),x("bottom","top"),x("top","bottom")};return r({...b,class:["tooltip",i,e==null?void 0:e.class,b==null?void 0:b.class],bauMounted:({element:A})=>{A.addEventListener("mouseover",S),A.addEventListener("mouseout",k)},bauUnmounted:({element:A})=>{A.removeEventListener("mouseover",S),A.removeEventListener("mouseout",k)}},...g,f)}}const Kn=(t,e)=>{const{bau:n}=t,{div:o,p:a,em:r}=n.tags,i=N(t),s=ke(t,e),l=()=>o(a("A ",r("tooltip")," can be any component"));return c=>s({titleEl:l(),...c},i(c,`${c.color} ${c.variant}`))},qu=t=>{const{bau:e}=t,{div:n,p:o,em:a}=e.tags,r=N(t),i=ke(t),s=()=>n(o("A ",a("tooltip")," can be any component"));return()=>i({side:"bottom-start",titleEl:s()},r("tooltip"))},Wu=`import tooltip from "@grucloud/bau-ui/tooltip";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`,Ku=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:r,section:i}=e.tags,s=Pt(t,{variant:"outline",color:"primary"}),l=ke(t),c=()=>o(a("A ",r("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
...
`,Zu={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import tooltip from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:Wu,createComponent:qu},{title:"Grid",description:"Various tooltip position",code:Xu,createComponent:Ku}],gridItem:Kn},Yu=t=>{const e=F(t);return()=>e(Zu)},Xn=(t,e)=>{const n=ie(t,e);return o=>n(o)},Qu=t=>{const{bau:e}=t,{section:n}=e.tags,o=ie(t);return()=>n(o({}))},td=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,ed={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:td,createComponent:Qu}],gridItem:Xn},nd=t=>{const e=F(t);return()=>e(ed)},Zn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Zn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},od=({css:t,createGlobalStyles:e})=>(e`
:root {
...
`,{nav:t`
  ...
  `});function Ee(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{renderMenuItem:r}=e,{ul:i,li:s,nav:l,div:c}=n.tags,u=od({css:o,createGlobalStyles:a}),d=ge(t),m=({depth:p=1,maxDepth:b,parent:g,color:f,variant:y,size:h})=>x=>{const{children:S,expanded:k}=x,D=n.state(!k),A=()=>c({class:o`
              cursor: ${S?"pointer":"auto"};
              display: inline-flex;
              justify-content: flex-start;
              align-items: center;
              width: 100%;
            `,onclick:O=>{S&&(D.val=!D.val)}},r({item:x,parent:g,depth:p})),B=()=>i({class:[f,h]},S.map(m({depth:p+1,maxDepth:b,parent:x})));return s(S.length?d({expanded:k,Header:A,Content:S&&p<b&&B}):A())};return function({tree:b,maxDepth:g=1/0,size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",...x}){return l({class:[u.nav,f,y,h,e==null?void 0:e.class,x.class]},i(m({maxDepth:g,color:h,variant:y,size:f})(Zn({})({...b}))))}}const Yn=(t,e)=>{const{bau:n}=t,{a:o,span:a}=n.tags,r={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Ee(t,{renderMenuItem:({item:{data:{name:l,href:c}}})=>c?o({href:c},l):a(l),...e});return l=>s({...l,tree:r})},ad=t=>{const{bau:e}=t,{a:n,span:o}=e.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Ee(t,{renderMenuItem:({item:{data:{name:s,href:l}}})=>l?n({href:l},s):o(s)});return()=>i({tree:a})},rd=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,sd=t=>{const{bau:e,css:n,window:o}=t,{form:a,label:r,article:i,footer:s}=e.tags,l=xt(t,{color:"neutral",variant:"outline"}),c=N(t,{variant:"solid",color:"danger"}),u=e.state(0),d=S=>{S.preventDefault();const k=Object.fromEntries(new FormData(S.currentTarget));alert(JSON.stringify(k))},m={data:{name:"Resources"},expanded:!0,children:[{data:{name:"EC2"},expanded:!0,children:[{data:{name:"Vpc",id:"EC2::Vpc"}},{data:{name:"Subnet",id:"EC2::Subnet"}}]},{data:{name:"IAM"},children:[{data:{name:"Role",id:"IAM:Role"}}]}]},p=({id:S,name:k})=>S??k,b=S=>o.document.getElementById(p(S)),g=({onNode:S})=>k=>{S(k);const{children:D=[]}=k;D.map(g({onNode:S}))},f=({parent:S})=>{if(S){const{children:k}=S,D=b(S.data);if(D){const A=k.every(B=>{const{checked:O,indeterminate:I}=b(B.data);return!O&&!I});D.indeterminate=!A&&k.some(B=>!b(B.data).checked),D.checked=k.every(B=>b(B.data).checked)}f({parent:S.parent})}},y=({item:S,parent:k})=>D=>{f({parent:k}),g({onNode:O=>{const I=b(O.data);I&&(I.checked=D.target.checked,I.indeterminate=!1)}})(S);const B=D.currentTarget.closest("form").querySelectorAll('input[type="checkbox"][data-type="resources"]:checked');u.val=B.length,D.stopPropagation()},x=Ee(t,{renderMenuItem:({item:S,parent:k})=>{const{name:D,id:A}=S.data,B=p(S.data);return r({class:n`
          display: flex;
          align-items: center;
          padding-right: 1rem;
        `,onclick:O=>O.stopPropagation()},l({onclick:y({item:S,parent:k}),name:B,id:B,"data-type":A?"resources":"group"}),D)}});return()=>a({onsubmit:d},i(x({tree:m})),s(c({type:"submit"},()=>`Delete ${u.val} Resource(s)`)))},id=`import { Context } from "@grucloud/bau-ui/context";
...
`,cd={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Simple",description:"A simple treeview.",code:rd,createComponent:ad},{title:"Checkable",description:"A treeview with checkboxes.",code:id,createComponent:sd}],gridItem:Yn},ld=t=>{const e=F(t);return()=>e(cd)},ud=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,i=_t(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...e});return s=>i(s)},dd=t=>{const{bau:e,css:n}=t,{section:o,div:a,h1:r,p:i,ul:s,li:l}=e.tags,c=ln(t),u=N(t),d=[{name:"Accordion",Item:un(t)},{name:"Alert",Item:mn(t)},{name:"Autocomplete",Item:bn(t)},{name:"Avatar",Item:pn(t)},{name:"Badge",Item:fn(t)},{name:"Breadcrumbs",Item:hn(t)},{name:"Button",Item:vn(t)},{name:"Button Group",Item:yn(t)},{name:"Calendar",Item:xn(t)},{name:"Checkbox",Item:Sn(t)},{name:"Chip",Item:wn(t)},{name:"DrillDown Menu",Item:kn(t,{base:"/components",hashBased:!0})},{name:"File Input",Item:Tn(t)},{name:"Input",Item:Dn(t)},{name:"Input Search",Item:An(t)},{name:"Linear Progress",Item:In(t)},{name:"Loading Button",Item:$n(t)},{name:"Modal",Item:Pn(t)},{name:"Radio Button",Item:zn(t)},{name:"Select",Item:Rn(t)},{name:"Select Native",Item:jn(t)},{name:"Slider",Item:_n(t)},{name:"Spinner",Item:Un(t)},{name:"Switch",Item:Hn(t)},{name:"Tabs",Item:ud(t)},{name:"Theme Switch",Item:Xn(t)},{name:"Toggle",Item:qn(t)},{name:"Toggle Group",Item:Wn(t)},{name:"Tooltip",Item:Kn(t)},{name:"Tree View",Item:Yn(t)}];return()=>o({class:n`
          overflow-y: scroll;
  ...
  `};ho();const Qn={title:"Bau",base:"/bau/bau-ui"},ft=Eo({config:Qn}),{bau:fd}=ft;ft.states={drawerOpen:fd.state(!0)};gd(ft);ro({routes:md({context:ft}),onLocationChange:bd({context:ft,LayoutDefault:Lo(ft),config:Qn}),notFoundRoute:pd(ft)});
