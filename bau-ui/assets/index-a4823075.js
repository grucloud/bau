...
`)}
  ...
  `}function vo(){const t=document.getElementById("loading");t&&t.classList.add("m-fadeOut")}let ie=t=>Object.prototype.toString.call(t??0).slice(8,-1),yo=t=>ie(t)=="Object",Ae=t=>ie(t)=="Function",oe=t=>["Object","Array"].includes(ie(t)),Be=Object.getPrototypeOf,ae=t=>Ct(t)?t.val:t,Ct=t=>t==null?void 0:t.__isState,xo=["splice","push","pop","shift","unshift","sort","reverse"],Vt=(t,e)=>{const n=new Array(t.length);for(let o=0;o<t.length;o++)n[o]=e(t[o],o);return n};const J=t=>!Ct(t[0])&&yo(t[0])?t:[{},...t];function wo(t){let e=(t==null?void 0:t.window)??window,{document:n}=e,o,a=new Set,r=new Set,i=!1,s,l=C=>n.createElement(C),c=(C,v,w)=>{let E=s;s=v;let T=C(w);return s=E,T},u=()=>{o||(o=e.requestAnimationFrame(()=>{a.forEach(C=>{C.bindings=C.bindings.filter(v=>{var w;return(w=v.element)==null?void 0:w.isConnected}),!C.bindings.length&&!C.computed&&a.delete(C)}),o=void 0}))},d=(C,v,w,E,T,H)=>{var R;if(i){r.add(C);return}for(let V of C.bindings){let{deps:q,element:I,renderInferred:X,render:nt,renderItem:Z}=V;if(Z&&v)(R=b(I,E,(...Y)=>f(Z(...Y)),w,T,H)[v])==null||R.call();else{let Y=X?X({element:I}):nt({element:I,renderItem:Z})(...q.map(ae));Y!==I&&I.replaceWith(V.element=f(Y))}}x(C),u()},m=(C,v,w=[])=>({get(E,T,H){var R;if(s==null||s.add(C),T==="_isProxy")return!0;if(!((R=E[T])!=null&&R._isProxy)&&!Ct(E[T])&&oe(E[T]))E[T]=new Proxy(E[T],m(C,v,[...w,T]));else if(xo.includes(T)){let V=E[T];return(...q)=>{let I=V.apply(E,q);return d(C,T,I,q,v,w),I}}return Reflect.get(E,T,H)},set(E,T,H,R){let V=Reflect.set(E,T,H,R);return d(C,"setItem",V,{prop:T,value:H},v,[...w,T]),V}}),p=(C,v)=>new Proxy(v,m(C,v)),b=(C,v,w,E,T,H)=>{let R=()=>C.replaceChildren(...Vt(E,w)),V=q=>C[q]&&C.removeChild(C[q]);return{assign:R,sort:R,reverse:R,setItem:()=>{var I;let q=H[0];(I=C.children[q])==null||I.replaceWith(w(T[q],q))},push:()=>C.append(...Vt(v,(q,I)=>w(q,T.length+I))),unshift:()=>C.prepend(...Vt(v,w)),pop:()=>V("lastChild"),shift:()=>V("firstChild"),splice:()=>{const{length:q}=C.children;let[I,X=q,...nt]=v;for(let Z=I>=0?Math.min(I+X-1,q-1):q-1;Z>=(I>=0?I:q+I);Z--)C.children[Z].remove();if(nt.length){let Z=nt.forEach((Y,rt)=>w(Y,I+rt));C.children[I]?C.children[I].after(...Z):C.append(...Z)}}}},g=C=>({oldVal:C,bindings:[],listeners:[],__isState:!0,get val(){let v=this;return s==null||s.add(v),v.valProxy??(v.valProxy=oe(C)?p(v,C):C,v.valProxy)},set val(v){let w=this,E=w.val;oe(v)?(w.valProxy=p(w,v),d(w,"assign",v)):v!==E&&(w.valProxy=v,d(w)),w.oldVal=E}}),f=C=>{if(C==null||C===!1){const v=l("span");return v.style.display="none",v}else return C.nodeType?C:n.createTextNode(C)},y=(C,v)=>{let w=new Set;return v.val=c(C,w),w},h=C=>{let v=g(),w=y(C,v);v.computed=!0;for(let E of w)E.listeners.push({computed:C,deps:w,state:v});return v},x=C=>{for(let v of[...C.listeners])y(v.computed,v.state)},S=(C,...v)=>{if(v.length){let w=[];for(let E of v.flat(1/0))E!=null&&w.push(Ct(E)?U({deps:[E],render:()=>T=>T}):Ae(E)?_({renderInferred:E}):f(E));C.append(...w)}},k={},D=(C,v)=>C&&(Object.getOwnPropertyDescriptor(C,v)??D(Be(C),v)),A=(C,v,w)=>{var E;return k[C+","+v]??(k[C+","+v]=((E=D(w,v))==null?void 0:E.set)??0)},N=(C,v)=>new e.MutationObserver((w,E)=>{w.filter(T=>T.removedNodes).forEach(T=>[...T.removedNodes].find(H=>H===C&&(v({element:C}),E.disconnect(),!0)))}).observe(C.parentNode,{childList:!0}),M=(C,v)=>new e.MutationObserver((w,E)=>w.forEach(T=>v({record:T,element:C}))).observe(C,{childList:!0}),$=C=>new Proxy(function(w,...E){var V;let[T,...H]=J(E),R=C?n.createElementNS(C,w):l(w);for(let[q,I]of Object.entries(T)){if(q.startsWith("bau"))continue;let X=A(w,q,Be(R))?nt=>nt!==void 0&&(R[q]=nt):nt=>R.setAttribute(q,nt);I==null||(Ct(I)?U({deps:[I],render:()=>()=>(X(I.val),R)}):Ae(I)&&(!q.startsWith("on")||I.isDerived)?_({renderInferred:()=>(X(I({element:R})),R)}):I.renderProp?U({deps:I.deps,render:()=>()=>(X(I.renderProp({element:R})(...I.deps.map(ae))),R)}):X(I))}return T.bauChildMutated&&M(R,T.bauChildMutated),S(R,...H),R.autofocus&&R.focus&&e.requestAnimationFrame(()=>R.focus()),(V=T.bauCreated)==null||V.call(T,{element:R}),T.bauMounted&&e.requestAnimationFrame(()=>T.bauMounted({element:R})),T.bauUnmounted&&e.requestAnimationFrame(()=>N(R,T.bauUnmounted)),R},{get:(v,w)=>v.bind(void 0,w)}),P=(C,v,w)=>{C.element=f(w);for(let E of v)Ct(E)&&(a.add(E),E.bindings.push(C));return C.element},_=({renderInferred:C,element:v})=>{let w=new Set,E=c(C,w,{element:v});return P({renderInferred:C},w,E)},U=({deps:C,element:v,render:w,renderItem:E})=>P({deps:C,render:w,renderItem:E},C,w({element:v,renderItem:E})(...C.map(ae))),j=(C,v,w)=>U({deps:[C],render:({renderItem:E})=>T=>(v.append(...Vt(T,E)),v),renderItem:w}),z=async C=>{i=!0;const v=await C();return i=!1,r.forEach(d),r.clear(),v};return{tags:$(),tagsNS:$,state:g,bind:U,loop:j,derive:h,stateSet:a,batch:z}}const So=t=>{let e=0,n=11;for(;e<t.length;)n=101*n+t.charCodeAt(e++)>>>0;return"bau"+n},Co=(t,e,n,o)=>{const a=t.createElement("style");a.id=n,a.append(o),(e??t.head).append(a)},ko=(t,e)=>t.reduce((n,o,a)=>n+o+(e[a]??""),"");function Eo(t){let{document:e}=(t==null?void 0:t.window)??window;const n=o=>(a,...r)=>{const i=ko(a,r),s=So(i);return!e.getElementById(s)&&Co(e,t==null?void 0:t.target,s,o(s,i)),s};return{css:n((o,a)=>`.${o} { ${a} }`),keyframes:n((o,a)=>`@keyframes ${o} { ${a} }`),createGlobalStyles:n((o,a)=>a)}}function To(t){const e=wo(),n=Eo();return ho(n),{bau:e,...n,tr:o=>o,window,...t}}function B(...t){return t.filter(e=>e).join(" ")}function Xt(t,e={}){const{bau:n,window:o}=t,{div:a}=n.tags,r=()=>{};return function({animationHide:s=r,animationShow:l=r,...c},u){return a({class:B("animate",e==null?void 0:e.class,c.class),bauChildMutated:({record:d,element:m})=>{[...d.removedNodes].forEach(p=>{if(!s()||p.getAttribute("cloned"))return;const b=p.cloneNode(!0);o.requestAnimationFrame(()=>{b.setAttribute("cloned",!0),b.style.top=0,b.style.left=0,b.style.width=p.getAttribute("width"),b.style.height=p.getAttribute("height"),b.style.position="absolute",b.style.animation=s(),d.target.appendChild(b),b.addEventListener("animationend",()=>{var g;return(g=b.parentNode)==null?void 0:g.removeChild(b)})})}),[...d.addedNodes].forEach(p=>{p.getAttribute("cloned")||o.requestAnimationFrame(()=>{m.style.position="relative";const b=p.getBoundingClientRect();if(p.setAttribute("width",b.width+"px"),p.setAttribute("height",b.height+"px"),l()){p.style.animation=l();const g=()=>{p.removeEventListener("animationend",g),p.style.animation=""};p.addEventListener("animationend",g)}})})},...c},u)}}const ot=["neutral","primary","success","danger","warning"],Do=["plain","outline","solid"],Ao=["sm","md","lg"],Bo=()=>ot.map(t=>`
&.button.plain.${t} {
  &:focus {
...
`);function ce(t,e={}){const{bau:n,css:o,window:a}=t,{input:r}=n.tags,i=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},s=()=>{try{return localStorage.getItem("theme")}catch{}},l=s();l?i(l):a.matchMedia("(prefers-color-scheme: dark)").matches?i("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?i("light"):i(No);const c=o`
    ...
    `}),x=ce(t),S=()=>i(g({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},f({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),k=()=>c({class:o`
        ...
        `},u({class:n`
          ...
          `},m({title:"Bau UI",links:p}),m({title:"Bau Ecosystem",links:b})),u({class:n`
            ...
            align-items: center;
            gap: 1rem;
          `},r("v0.79.0"),r("MIT license")))}}function yt(t,e={}){const{bau:n,css:o}=t,{ul:a}=n.tags,r=o`
    display: flex;
    flex-direction: column;
    list-style: none;
    padding: 0;
  ...
  `,hideToRight:t`
   ...
   `});function le(t,e={}){const{bau:n,css:o,window:a,config:r}=t,{base:i="",hashBased:s=!1}=e,l=`${r.base}${i}`,c=z=>{var C;return((C=z.parentTree.data)==null?void 0:C.href)??z.parentTree.children[0].data.href},u=({variant:z,color:C,size:v,currentTree:w,data:E})=>x(A({variant:z,color:C,size:v,href:`${l}${c(w)}`,class:o`
            flex-grow: 0;
  ...
  `,P=({children:z,pathnameState:C,variant:v,color:w,size:E})=>D({class:B(v,w,E)},z.map(T=>f({class:()=>B(T.children&&"has-children",g({pathname:C.val,subTree:T})&&"active")},b({variant:v,color:w,size:E,subTree:T})))),_=({variant:z,color:C,size:v,currentTree:w,pathnameState:E})=>{const{children:T,parentTree:H,data:R,renderList:V}=w;return h({class:B("drillDownMenu",z,C,v)},H&&p({variant:z,color:C,size:v,data:R,currentTree:w}),T&&V?V({renderListDefault:P,children:T,pathnameState:E,variant:z,color:C,size:v}):P({children:T,pathnameState:E,variant:z,color:C,size:v}))},U=({tree:z,pathname:C})=>{let v=Ue({})({...z}),w=He(C)(v);return w||(w=v),w},j=({target:z})=>{let v=z.closest("a").getAttribute("href").replace(l,"");return s||(v=v.replace(z.hash,"")),v};return function(C){const{size:v=e.size??"md",variant:w=e.variant??"plain",color:E=e.color??"neutral",tree:T,...H}=C,R=n.state(a.location.pathname.replace(l,""));let V=U({tree:T,pathname:R.val});const q=n.state(JSON.stringify(V.data));let I;a.document.addEventListener("click",Y=>{const{target:rt}=Y,ct=rt.closest("a");if(!ct)return;const lt=ct.getAttribute("href");lt&&!lt.startsWith("http")&&!lt.startsWith("#")&&!lt.startsWith("?")&&(V=U({tree:T,pathname:j(Y)}),q.val=JSON.stringify(V.data),R.val=j({target:rt}))});const X=Y=>{const{buttonback:rt,ischild:ct}=Y.target.dataset;rt=="true"?I=-1:ct=="false"?I=1:ct=="true"&&(I=0)},nt=Y=>{switch(Y){case 1:return`${N} ${Jt}`;case-1:return`${M} ${Jt}`;default:return""}},Z=Y=>{switch(Y){case 1:return`${M} ${Jt} reverse`;case-1:return`${N} ${Jt} reverse`;default:return""}};return y({class:B($,w,E,v,e==null?void 0:e.class,H.class),onclick:X},k({animationHide:()=>nt(I),animationShow:()=>Z(I)},n.bind({deps:[q],render:()=>()=>_({variant:w,color:E,size:v,currentTree:V,pathnameState:R})})))}}const Lo=()=>ot.map(t=>`
&.input.${t} {
...
`);function dt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
  ...
  `;return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s;return a({type:"text",...u,class:B("input",e.class,e.size??"md",c,l,r,u.class)})}}function ue(t,e={}){const{bau:n,css:o,window:a}=t,r=dt(t,e);return function(s){const{variant:l=e.variant??"outline",color:c=e.color??"neutral",...u}=s,m=`url('data:image/svg+xml,<svg fill="${a.getComputedStyle(a.document.documentElement).getPropertyValue(l=="solid"?"--font-color-inverse-secondary":`--color-${c}`)}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>')`,p=o`
    ...
    `;return r({type:"search",...u,color:c,variant:l,class:B("inputSearch",e.class,p,u.class)})}}function Fe(t){const{tr:e,bau:n,css:o,config:a,states:r,window:i}=t,{div:s,ul:l,li:c,nav:u,a:d,span:m,form:p}=n.tags,b=ue(t,{variant:"plain",color:"neutral",size:"sm",class:o`
      margin: 0.5rem;
    `}),f={data:{name:"Root"},children:[{data:{name:"Home",href:"/"}},{data:{name:"Getting Started",href:"/GettingStarted"}},{data:{name:"Components",href:"/components"},renderList:({renderListDefault:x,children:S,pathnameState:k,variant:D,color:A,size:N})=>{const M=n.state(""),$=n.derive(()=>M.val==""?S:S.filter(_=>_.data.name.match(new RegExp(`${M.val}`,"i")))),P=_=>{M.val=_.target.value};return p({class:o`
        ...
        `},b({autocomplete:"off",name:"component-search",autofocus:!0,value:M,placeholder:`Search ${$.val.length} components`,size:32,oninput:P}),()=>x({children:$.val,pathnameState:k,variant:D,color:A,size:N}))},children:[{data:{name:"Accordion",href:"/components/accordion"}},{data:{name:"Alert",href:"/components/alert"}},{data:{name:"Alert Stack",href:"/components/alertStack"}},{data:{name:"Animate",href:"/components/animate"}},{data:{name:"Autocomplete",href:"/components/autocomplete"}},{data:{name:"Avatar",href:"/components/avatar"}},{data:{name:"Badge",href:"/components/badge"}},{data:{name:"Breadcrumb",href:"/components/breadcrumb"}},{data:{name:"Button",href:"/components/button"}},{data:{name:"Button Group",href:"/components/buttonGroup"}},{data:{name:"Calendar",href:"/components/calendar"}},{data:{name:"Carousel",href:"/components/carousel"}},{data:{name:"Chip",href:"/components/chip"}},{data:{name:"Checkbox",href:"/components/checkbox"}},{data:{name:"Collapsible",href:"/components/collapsible"}},{data:{name:"Divider",href:"/components/divider"}},{data:{name:"Drawer",href:"/components/drawer"}},{data:{name:"Dropdown Menu",href:"/components/dropdownMenu"}},{data:{name:"DrillDown Menu",href:"/components/drillDownMenu"}},{data:{name:"File Input",href:"/components/fileInput"}},{data:{name:"Form",href:"/components/form"}},{data:{name:"Input",href:"/components/input"}},{data:{name:"Input Search",href:"/components/inputSearch"}},{data:{name:"Key Value List",href:"/components/keyValueList"}},{data:{name:"Lazy",href:"/components/lazy"}},{data:{name:"Linear Progress",href:"/components/linearProgress"}},{data:{name:"List",href:"/components/list"}},{data:{name:"Loading Button",href:"/components/loadingButton"}},{data:{name:"Modal",href:"/components/modal"}},{data:{name:"Multi Select",href:"/components/multiSelect"}},{data:{name:"Paper",href:"/components/paper"}},{data:{name:"Pagination Navigation",href:"/components/paginationNavigation"}},{data:{name:"Popover",href:"/components/popover"}},{data:{name:"Radio Button",href:"/components/radioButton"}},{data:{name:"Radio Button Group",href:"/components/radioButtonGroup"}},{data:{name:"Resizable",href:"/components/resizable"}},{data:{name:"Select",href:"/components/select"}},{data:{name:"Select Native",href:"/components/selectNative"}},{data:{name:"Skeleton",href:"/components/skeleton"}},{data:{name:"Slider",href:"/components/slider"}},{data:{name:"Spinner",href:"/components/spinner"}},{data:{name:"Stepper",href:"/components/stepper"}},{data:{name:"Switch",href:"/components/switch"}},{data:{name:"Table",href:"/components/table"}},{data:{name:"Table Pagination",href:"/components/tablePagination"}},{data:{name:"Tabs",href:"/components/tabs"}},{data:{name:"Table of content",href:"/components/tableOfContent"}},{data:{name:"Toggle",href:"/components/toggle"}},{data:{name:"Toggle Group",href:"/components/toggleGroup"}},{data:{name:"Tooltip",href:"/components/tooltip"}},{data:{name:"Theme Switch",href:"/components/themeSwitch"}},{data:{name:"Tree View",href:"/components/treeView"}}]}]};let y=!1;const h=le(t);return function(){return s({bauMounted:({element:S})=>{i.innerWidth<=640&&(y=!0,r.drawerOpen.val=!1)},onclick:S=>{y&&!S.target.dataset.buttonback&&!S.target.parentElement.classList.contains("has-children")&&(r.drawerOpen.val=!1)},style:()=>r.drawerOpen.val?"display:block;":"display:none;",class:B(o`
          ...
          `)},h({tree:f}))}}const Po=t=>{const{bau:e,css:n,states:o,keyframes:a}=t,{div:r}=e.tags,i=Xt(t),s=Mo(t),l=Fe(t),c=Io(t),u=a`
    from {
      opacity: 1;
    }
    to {
  ...
  `,d=(m="")=>`${u} ease-in-out 0.5s ${m}`;return function({componentState:p}){return r({class:n`
        ...
        `},s(),l(),i({class:n`
            ...
            margin: 0 1rem;
            display: grid;
          `,animationHide:()=>d(),animationShow:()=>d("reverse")},()=>p.val),c())}};function Lt(t,e={}){const{bau:n,css:o}=t,{span:a}=n.tags,r=o`
    display: inline-flex;
    align-items: center;
    flex-grow: 0;
    box-sizing: border-box;
  ...
  `;return function({name:u,text:d,tagLine:m}){return a({class:l},r(u),i(d),s(m))}}function jo(t){const{bau:e,css:n}=t,{div:o,h1:a,p:r}=e.tags,i=n`
    display: flex;
    flex-direction: row;
    flex-wrap: wrap;
    justify-content: space-between;
  ...
  `,s=({title:l,Content:c})=>o({className:"feature"},a(l),r(c()));return function({featuresContent:c}){return o({class:i},c.map(s))}}function Ro({tr:t,bau:e,css:n}){const{article:o,dl:a,dt:r,dd:i,div:s,aside:l,footer:c,a:u}=e.tags,d=({maxSize:m=151})=>({libName:p,size:b})=>s({class:n`
        ...
        `},l({class:n`
          ...
          `},p.map(d({}))),c({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function _o(t){const{bau:e,css:n,config:o}=t,{div:a,p:r,a:i,section:s}=e.tags,l=zo(t),c=jo(t),u=O(t);Lt(t);const d=Ro(t),m=(...y)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `,p=({value:f,id:y,children:h=[]})=>{const x=l({class:()=>u.val==y?"active":"",href:`#${y}`});return x.innerHTML=f,s({class:()=>u.val==y?"active":""},x,h.length>0&&i(h.map(p)))},b=f=>f.tagName.charAt(1),g=({contentEl:f})=>{const y=f.querySelectorAll(c);let h=2,x={},S={children:[]},k=S;const D=k;let A=[k];return[...y].forEach(N=>{const M=b(N);N.setAttribute("id",N.textContent),!N.innerHTML.includes("<button")&&(x={value:N.innerHTML,id:N.id??N.textContent,children:[]},h==M?(S=x,k.children.push(S)):h<M?(A.push(k),k=S,S.children.push(x),S=x):h>M&&(k=A[M-1],A=A.slice(0,M-1),k.children.push(x),S=x),h=M)}),D};return function(...y){let[{size:h=e.size??"md",variant:x=e.variant??"plain",color:S=e.color??"neutral",contentEl:k,...D}]=J(y);const A=g({contentEl:k}),N=d(()=>{const $=[...k.querySelectorAll(c)].find(P=>{const{top:_,height:U}=P.getBoundingClientRect();if(_+U>60)return!0});$&&(u.val=$==null?void 0:$.id)},100);return r({...D,class:B("tableOfContent",h,x,S,m,e==null?void 0:e.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",N)},bauUnmounted:()=>{a.removeEventListener("scroll",N)}},A.children&&i(A.children.map(p)))}}const ln=t=>{const{bau:e,css:n}=t,{div:o,table:a,tbody:r,tr:i,td:s,thead:l,th:c}=e.tags;return function({Item:d,name:m}){return o({class:n`
        ...
        `},a(l(i(c(m??""),ot.map(p=>c(p)))),r(Do.map(p=>i(c(p),ot.map((b,g)=>s(d({color:b,variant:p},{index:g}))))))))}},Va=t=>{const{bau:e,css:n}=t,{section:o}=e.tags;return function({item:r}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Ao.map((i,s)=>r(t,{size:i})({color:"success",variant:"outline"},{size:i,index:s})))}},F=t=>{const{bau:e,css:n}=t,{div:o,article:a,section:r,h1:i,p:s,h2:l,h3:c,pre:u,code:d}=e.tags;Ot.registerLanguage("javascript",sn);const m=cn(t),p=ge(t,{class:n`
      &.paper {
...
`,dn=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}]},Ka=t=>{const{css:e}=t,n=dn(t),o=Yt(t,{color:"warning",class:e`
      &.accordion {
        & ul {
          & li {
            width: fit-content;
...
`,Za=t=>{const{css:e}=t,n=dn(t),o=Yt(t,{color:"success",variant:"outline",class:e`
      &.accordion {
        & ul {
          & li {
            & h3 {
...
`,vr={title:"Animate",package:"animate",description:"The animate component animates a child component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/animate/animate.js",importStatement:'import animate from "@grucloud/bau-ui/animate";',examples:[{title:"Basic Example",description:"A simple animation example.",code:gr,createComponent:br},{title:"Component hide and show",description:"Hide and show a component",code:hr,createComponent:fr}]},yr=t=>{const e=F(t);return()=>e(vr)};function Et(t,e={}){const{bau:n,css:o,keyframes:a}=t,{div:r}=n.tags,i=a`
  ...
  `;return function(...c){let[{size:u=e.size??"md",variant:d=e.variant??"plain",color:m=e.color??"neutral",...p},...b]=J(c);return r({...p,class:B("skeleton",u,s,e==null?void 0:e.class,p==null?void 0:p.class)},...b)}}function he(t,e={}){const{bau:n,css:o}=t,{div:a,img:r}=n.tags,i=n.state(!0),s=n.state(!1),l=()=>i.val=!1,c=d=>{i.val=!1,s.val=!0},u=o`
    display: inline-flex;
    justify-content: center;
    align-items: center;
    position: relative;
  ...
  `;return function(...m){let[{size:p=e.size??"md",variant:b=e.variant??"plain",color:g=e.color??"neutral",width:f=40,height:y=40,alt:h,...x},...S]=J(m);const k=Et(t,{class:B(o`
          ...
          height: ${y}px;
          width: ${f}px;
        `,e==null?void 0:e.class,x.class)});return a({class:B(u,e==null?void 0:e.class,x.class)},()=>i.val&&k(),()=>s.val&&h,r({alt:h,width:f,height:y,onload:l,onerror:c,class:()=>B(!i.val&&"visible",s.val&&"hide",g,b,p,u,e==null?void 0:e.class,x.class),...x}))}}const pn=(t,e)=>{const{css:n}=t,o=he(t,{...e,class:n`
      > img {
        border-radius: 50%;
      }
...
`,kr={title:"Avatar",package:"avatar",description:"The avatar component displays a small image or initial of a person.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/avatar/avatar.js",importStatement:'import avatar from "@grucloud/bau-ui/avatar";',examples:[{title:"Default",description:"A simple avatar.",code:wr,createComponent:xr},{title:"Not Found",description:"An avatar defaulting to alt when the image is not found.",code:Cr,createComponent:Sr}],gridItem:pn},Er=t=>{const e=F(t);return()=>e(kr)};function Pt(t,e){const{bau:n,css:o,window:a}=t,{dialog:r}=n.tags,i=o`
    width: fit-content;
    margin: 0;
...
100% {
  ...
  `;return function({size:u=e.size??"md",color:d=e.color??"primary",variant:m=e.variant??"outline",visibility:p=!0,...b}={}){const g=o`
      ...
      ${Tr()}
    `;return r({class:{deps:[p],renderProp:()=>f=>B("spinner",g,d,m,f==!1?"":"visibility",e==null?void 0:e.class,b.class)},version:"1.1",x:"0px",y:"0px",width:Wt[u],height:Wt[u],viewBox:"0 0 50 50",enableBackground:"new 0 0 50 50",...b},i({class:"path",cx:"25",cy:"25",r:"20",fill:"none","stroke-width":"5"}))}}const Dr=()=>ot.map(t=>`
...
`);function zt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=o`
    ...
    ${Dr()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",label:m,placeholder:p,Option:b,options:g,defaultOption:f,getOptionLabel:y,getOptionValue:h,onSelect:x=()=>{},id:S,required:k,name:D,loading:A,...N},...M]=J(l);const $=Pt(t),P=O(t),_=dt(t,{variant:u,color:d,size:c}),U=yt(t),j=bt(t,{variant:u,color:d,size:c}),z=n.state(f),C=n.state(N.value),v=n.state(!1),w=n.state(0),E=()=>{v.val=!1},T=n.state(g),H=Q=>at=>Q.val&&y(at)==y(Q.val),R=()=>{ut.openDialog(),v.val=!0,C.val="",T.val=g,w.val=g.findIndex(H(z));const Q=At.querySelector("li.selected");Q&&(Q.scrollIntoView({block:"center"}),ct.scrollIntoView({block:"end"}))},V=()=>{ut.closeDialog(),v.val=!1,w.val=0},q=Q=>{const{value:at}=Q.target;C.val=at,at?T.val=g.filter(Ht=>y(Ht).match(new RegExp(`${at}`,"i"))):T.val=g},I=Q=>{ut.open?V():R()},X=Q=>{z.val=Q,lt.value=h(Q)},nt=({option:Q,index:at})=>Ht=>{X(Q),w.val=at,V()},Z=()=>{const Q=At.querySelector("li.active");Q&&Q.scrollIntoView({block:"center",behavior:"smooth"})},Y=Q=>{switch(Q.key){case"Escape":V();break;case"ArrowDown":w.val<T.val.length-1?w.val++:w.val=0,Z();break;case"ArrowUp":w.val<=0?w.val=T.val.length-1:w.val--,Z();break;case"Enter":ut.open?(X(T.val[w.val]),V()):R(),Q.preventDefault();break}},rt=P({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":v,"aria-label":m,onclick:I,variant:u,color:d,size:c,class:A==!0&&"loading",disabled:A},()=>z.val?y(z.val):m,()=>A==!0&&j({visibility:A})),ct=_({value:C,placeholder:p,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":v,oninput:q,onkeydown:Y,...N}),lt=_({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
      ...
      `,tabindex:-1,defaultValue:f&&h(f),required:k,"aria-hidden":!1,"aria-label":D,name:D}),At=a({class:B(u,d,c,"content")},ct,()=>U({class:B(u,d,c)},T.val.map((Q,at)=>r({class:()=>B(w.val==at&&"active",H(z)(Q)&&"selected"),onclick:nt({option:Q,index:at})},b(Q))))),ut=$({id:S,triggerEl:rt,contentEl:At,onClose:E,class:o`
        overflow: hidden;
      `});return a({...N,class:B("autocomplete",i,e==null?void 0:e.class,N==null?void 0:N.class)},n.bind({deps:[z],render:()=>Q=>{Q&&(lt.value=h(Q),x(Q))}}),rt,lt,ut)}}const bn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=zt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},r(c.label),r(c.code));return c=>i({...c,options:s,Option:l,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",name:"country","aria-label":"country"})},Ar=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],Br=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,article:i,footer:s}=e.tags,l=zt(t),c=O(t,{variant:"outline",color:"primary"}),u=d=>o({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Or=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=zt(t),c=O(t,{variant:"outline",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Ir=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=O(t,{variant:"outline"}),c=O(t,{variant:"solid",color:"primary"}),u=zt(t),d=m=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Lr=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=zt(t),c=O(t,{variant:"outline",color:"primary"}),u=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],d=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Gr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:_r,createComponent:Rr}],gridItem:fn},Ur=t=>{const e=F(t);return()=>e(Gr)};function ve(t,e={}){const{bau:n,css:o,config:a}=t,{ul:r,li:i,span:s}=n.tags,{separator:l="〉"}=e,c=O(t),u=o`
    list-style: none;
    display: flex;
    align-items: center;
    padding-left: 0;
...
`);function ye(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    ...
    ${es()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("button-group",c,u,l,r,e==null?void 0:e.class,d==null?void 0:d.class)},...m)}}const yn=(t,e)=>{const n=["ONE","TWO","THREE"],o=O(t,e),a=ye(t,e);return r=>a({...r},n.map(i=>o(r,i)))},ns=t=>{const{bau:e}=t,{section:n}=e.tags,o=["ONE","TWO","THREE"],a="primary",r="solid",i=O(t,{color:a,variant:r}),s=ye(t,{color:a,variant:r});return()=>{const l=c=>u=>{alert(c)};return n(s(o.map(c=>i({onclick:l(c)},c))))}},os=`import buttonGroup from "@grucloud/bau-ui/buttonGroup";
import button from "@grucloud/bau-ui/button";
...
`,as={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:os,createComponent:ns}],gridItem:yn},rs=t=>{const e=F(t);return()=>e(as)};function xe(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>ot.map(s=>`
...
`))()}
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m},...p]=J(l);return a({...m,type:"date",class:B("calendar",i,d,u,c,e==null?void 0:e.class,m==null?void 0:m.class)},...p)}}const xn=(t,e)=>{const n=xe(t,e),o=({props:a={},options:r={}})=>`myinput-gallery-${a.color??r.color}-${a.variant??r.variant}-${a.size??r.size}`;return a=>n({"aria-label":o({props:a,options:e}),...a})},ss=t=>{const{bau:e}=t,{form:n,footer:o,article:a,label:r}=e.tags,i=xe(t),s=O(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},a(r("Start date:",i({name:"start",min:"2023-01-01",max:"2024-12-31",required:!0}))),o(s({type:"submit"},"Submit")))},is=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
...
`,fs={title:"Carousel",package:"carousel",description:"The carousel component displays images once at a time.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/carousel/carousel.js",importStatement:'import carousel from "@grucloud/bau-ui/carousel";',examples:[{title:"Simple Carousel",description:"A simple carousel displaying a few random pictures.",code:gs,createComponent:bs}]},hs=t=>{const e=F(t);return()=>e(fs)},wn=(t,e)=>{const n=Lt(t,e);return o=>n({...o},`Chip ${o.color} ${o.variant} ${o.size??""}`)},vs=t=>{const{bau:e}=t,{section:n}=e.tags,o=Lt(t,{variant:"outline",color:"primary"});return()=>n(o("My Chip"))},ys=`import chip from "@grucloud/bau-ui/chip";
import { Context } from "@grucloud/bau-ui/context";
...
`,$s={title:"Collapsible",package:"collapsible",description:"The collapsible component expands and collapse a list of elements.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/collapsible/collapsible.js",importStatement:'import collapsible from "@grucloud/bau-ui/collapsible";',examples:[{title:"Simple Collapsible",description:"A simple collapsible, click on the header to expand or collapse the content.",code:Is,createComponent:Ms}]},Ls=t=>{const e=F(t);return()=>e($s)};function Ps(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("divider",l,r,e==null?void 0:e.class,d==null?void 0:d.class)},a({class:"content"},...m))}}const zs=t=>{const{bau:e}=t,{section:n}=e.tags,o=Ps(t);return()=>n(o("OR"))},js=`import divider from "@grucloud/bau-ui/divider";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`);function Cn(t,e={}){const{bau:n,css:o}=t,{div:a,li:r}=n.tags,i=O(t),s=Pt(t),l=yt(t),c=o`
    ${Js()}
  `;return function(...d){let[{size:m=e.size??"md",variant:p=e.variant??"outline",color:b=e.color??"neutral",label:g,ListItem:f,items:y,...h},...x]=J(d);const S=n.state(0),k=()=>{U.openDialog(),U.focus()},D=()=>{U.closeDialog()},A=()=>{U.open?D():k()},N=j=>{A(),j.preventDefault()},M=({item:j,index:z})=>C=>{S.val=z,D(),C.preventDefault()},$=j=>{switch(j.preventDefault(),j.key){case"Escape":D();break;case"ArrowDown":S.val<options.length-1?S.val++:S.val=0;break;case"ArrowUp":S.val<=0?S.val=options.length-1:S.val--;break;case"Enter":A();break}},P=()=>l({tabindex:"0",class:B(b,p)},y.map((j,z)=>r({class:()=>B(S.val==z&&"active"),onclick:M({item:j,index:z})},f(j)))),_=i({type:"button",onclick:N,color:b,variant:p,size:m},g),U=s({triggerEl:_,contentEl:P()});return a({...h,class:B("dropdownMenu",b,m,c,e==null?void 0:e.class,h==null?void 0:h.class),onkeydown:$},_,U)}}const qs=(t,e)=>{const{bau:n}=t,{div:o,span:a}=n.tags,r=Cn(t,e),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o(a(l.label));return l=>r({...l,items:i,ListItem:s,label:"Action"})},Ws=t=>{const{bau:e}=t,{section:n,div:o,span:a}=e.tags,r=Cn(t),i=[{label:"List"},{label:"Plan"},{label:"Apply"}],s=l=>o({onclick:()=>{alert(`click  ${l.label}`)}},a(l.label));return()=>n(r({items:i,ListItem:s,label:"Action"}))},Ks=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,ai={title:"File Input",package:"fileInput",description:"The fileInput component displays wraps the native input file type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/fileInput/fileInput.js",importStatement:'import fileInput from "@grucloud/bau-ui/fileInput";',examples:[{title:"Default",description:"A simple file input.",code:oi,createComponent:ni}],gridItem:Tn},ri=t=>{const e=F(t);return()=>e(ai)};function gt(t,e={}){const{bau:n,css:o}=t,{form:a}=n.tags,r=o`
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",content:d,...m},...p]=J(s);return a({...m,class:B("form",u,c,l,r,e==null?void 0:e.class,m==null?void 0:m.class)},...p)}}function we(t,e={}){const{bau:n,css:o,keyframes:a}=t,{span:r}=n.tags,i=a`
0% {
      opacity: 1;
}
100% {
...
`),s=a`
  ...
  `,l=o`
    ...
    ${i()}
  `;return function(...u){let[{size:d=e.size??"md",variant:m=e.variant??"plain",color:p=e.color??"neutral",running:b,...g}]=J(u);return r({...g,role:"progressbar",class:{deps:[b],renderProp:()=>f=>B("linearProgress",d,p,l,f&&"running",e==null?void 0:e.class,g==null?void 0:g.class)}})}}const In=(t,e)=>{const n=Mn(t,e);return o=>n({...o,"aria-label":"linear-progress",running:!0})},ji=t=>{const{bau:e}=t,{section:n,hr:o}=e.tags,a=O(t,{variant:"solid",color:"primary"}),r=Mn(t),i=e.state(!1);return()=>n(a({onclick:()=>i.val=!i.val},()=>i.val?"Stop":"Start"),o,r({"aria-label":"linear-progress",running:i}))},Ri=`import linearProgress from "@grucloud/bau-ui/linearProgress";
import button from "@grucloud/bau-ui/button";
...
`,_i={title:"LinearProgress",package:"linearProgress",description:"The linearProgress component displays an animated horizontal bar.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/linearProgress/linearProgress.js",importStatement:'import linearProgress from "@grucloud/bau-ui/linearProgress";',examples:[{title:"Simple LinearProgress",description:"A simple linearProgress.",code:Ri,createComponent:ji}],gridItem:In},Gi=t=>{const e=F(t);return()=>e(_i)},$n=(t,e)=>{const n=we(t,e);return o=>n({...o,loading:!0},"Save")},Ui=t=>{const{bau:e}=t,{section:n}=e.tags,o=we(t,{variant:"solid",color:"primary"});return()=>{const a=e.state(!0);return n(o({loading:a,onclick:()=>a.val=!a.val},"Save"))}},Hi=`import { Context } from "@grucloud/bau-ui/context";
import loadingButton from "@grucloud/bau-ui/loadingButton";
...
`).join(`
`);function ac(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i}=n.tags,s=O(t),l=Pt(t),c=yt(t),u=wt(t,{color:"neutral",variant:"outline"}),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${oc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",name:y,label:h,Option:x,options:S,defaultValue:k=[],getOptionLabel:D,getOptionValue:A,renderValue:N,onSelect:M=()=>{},loading:$,...P},..._]=J(p);const U=bt(t,{variant:g,color:f,size:b}),j=n.state(k),z=n.state(!1),C=n.state(0),v=()=>{X.openDialog(),X.focus(),z.val=!0},w=()=>{X.closeDialog(),z.val=!1},E=()=>{z.val=!1},T=Z=>{X.open?w():v(),Z.preventDefault()},H=()=>Array.from(nt.selectedOptions).map(({value:Z})=>S.find(Y=>A(Y)==Z)),R=Z=>{switch(Z.preventDefault(),Z.key){case"Escape":w();break;case"ArrowDown":C.val<S.length-1?C.val++:C.val=0;break;case"ArrowUp":C.val<=0?C.val=S.length-1:C.val--;break;case"Enter":if(X.open){const Y=Z.currentTarget.querySelectorAll("input")[C.val];Y.checked=!Y.checked;const rt=nt.options[C.val+1];rt.selected=!rt.selected,j.val=H()}else v();break}},V=Z=>Y=>{const rt=[...nt.options].find(({value:ct})=>ct==A(Z));Y.target.checked?rt.selected=!0:rt.selected=!1,j.val=H()},q=()=>c({tabindex:"0",class:B(f,g)},S.map((Z,Y)=>r({class:()=>B(C.val==Y&&"active")},n.tags.label(u({checked:k.find(rt=>A(rt)==A(Z)),name:`${y}-${A(Z)}`,onchange:V(Z)}),x(Z))))),I=s({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":z,"aria-label":h,onclick:T,color:f,variant:g,size:b,class:$==!0&&"loading",disabled:$},()=>j.val.length?N(j.val):h,()=>$==!0&&U({visibility:$})),X=l({triggerEl:I,contentEl:q(),onClose:E}),nt=i({name:y,multiple:!0,...P},n.tags.option({value:""},"--Category--"),S.map(Z=>n.tags.option({value:A(Z),selected:k.find(Y=>A(Y)==A(Z))},D(Z))));return a({...P,class:B("multiSelect",f,b,d,e==null?void 0:e.class,P==null?void 0:P.class),onkeydown:R},nt,I,X)}}const rc=t=>{const{bau:e,css:n}=t,{div:o,span:a,form:r,footer:i}=e.tags,s=ac(t),l=O(t,{variant:"outline",color:"neutral"}),c=Lt(t,{size:"sm"}),u=[{group:"EC2"},{group:"ECS"},{group:"IAM"},{group:"Lambda"},{group:"RDS"},{group:"S3"}],d=m=>a(m.group);return()=>r({onsubmit:p=>{p.preventDefault();const{selectedOptions:b}=p.target.elements.myMultiSelect,g=Array.from(b).map(({value:f})=>f);alert(JSON.stringify(g))},class:n`
          display: inline-flex;
          flex-direction: column;
          gap: 1rem;
...
`,lc={title:"MultiSelect",package:"multiSelect",description:"The multiSelect component allows user to select multiple items from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/multiSelect/multiSelect.js",importStatement:'import multiSelect from "@grucloud/bau-ui/multiSelect";',examples:[{title:"Simple Multi Select",description:"A simple multi select.",code:sc,createComponent:rc},{title:"Native Multi Select",description:"A native multi select.",code:cc,createComponent:ic}]},uc=t=>{const e=F(t);return()=>e(lc)},dc=t=>{const{bau:e}=t,{section:n,div:o,h1:a,p:r}=e.tags,i=O(t,{variant:"outline",color:"success"}),s=Pt(t),l=()=>i({onclick:()=>d.open?d.closeDialog():d.openDialog()},"Click"),c=()=>o({},a("My content"),r("My Content")),u=l(),d=s({id:"my-popover-left",triggerEl:u,contentEl:c()});return()=>n(o(u,d))},mc=`import popover from "@grucloud/bau-ui/popover";
import button from "@grucloud/bau-ui/button";
import { Context } from "@grucloud/bau-ui/context";
...
`).join(`
`))()}
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"plain",color:d=e.color??"neutral",...m}]=J(l);return a({...m,type:"radio",class:B("radio-button",c,d,u,i,e==null?void 0:e.class,m==null?void 0:m.class)})}}const zn=(t,e)=>{const{bau:n,css:o}=t,{label:a,form:r}=n.tags,i=Se(t,e);return s=>r({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
...
`,Dc={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:Tc,createComponent:Ec}],gridItem:zn},Ac=t=>{const e=F(t);return()=>e(Dc)};function jt(t,e={}){const{bau:n,css:o}=t,{div:a,label:r}=n.tags,i=Se(t),l=o`
    display: flex;
    flex-direction: row;
    gap: 0.5rem;
    & label {
...
`,Ic=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=jt(t),i=O(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:l=>{l.preventDefault();const c=Object.fromEntries(new FormData(l.currentTarget));alert(JSON.stringify(c))}},o(r({name:"myRadio",value:"one",radios:[{value:"one",Label:()=>"One"},{value:"two",Label:()=>"Two"}]})),a(i({type:"submit"},"Submit")))},$c=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,zc=t=>{const{bau:e}=t,{form:n,article:o,footer:a,small:r,div:i}=e.tags,s=jt(t),l=O(t,{variant:"outline",color:"primary"});return()=>n({onsubmit:u=>{u.preventDefault();const d=Object.fromEntries(new FormData(u.currentTarget));alert(JSON.stringify(d))}},o(s({name:"git_provider_type",value:"",radios:[{value:"GitHub",Label:()=>i("GitHub",r("Login with GitHub"))},{value:"GitLab",Label:()=>i("GitLab",r("Login with GitLab"))}]})),a(l({type:"submit"},"Submit")))},jc=`import { Context } from "@grucloud/bau-ui/context";
import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";
import button from "@grucloud/bau-ui/button";
...
`,Rc={title:"RadioButtonGroup",package:"radioButtonGroup",description:"The radioButtonGroup component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButtonGroup/radioButtonGroup.js",importStatement:'import radioButtonGroup from "@grucloud/bau-ui/radioButtonGroup";',examples:[{title:"Stateless Radio Button Group",description:"A stateless radio button group.",code:$c,createComponent:Ic},{title:"Statefull Radio Button Group",description:"A statefull radio button group.",code:Nc,createComponent:Bc},{title:"Url State Radio Button Group",description:"A radio button group with the state in the URL",code:Mc,createComponent:Oc},{title:"Label with Image",description:"A label with an image.",code:Pc,createComponent:Lc},{title:"Label with description",description:"A label with name and description.",code:jc,createComponent:zc}]},_c=t=>{const e=F(t);return()=>e(Rc)};function $t(t,e={}){const{bau:n,css:o,window:a}=t,{section:r,article:i,div:s}=n.tags,{document:l}=a,{direction:c="horizontal"}=e,u=o`
  ...
  `;function d(...b){let[g,...f]=J(b);return r({...g,class:B("resizablePanelGroup",g==null?void 0:g.class,e==null?void 0:e.class,u)},f)}function m(...b){let[g,...f]=J(b);return i({...g,class:B("resizablePanel",g==null?void 0:g.class)},f)}function p(...b){let[g,...f]=J(b),y=0,h=0,x,S,k,D,A;const N=()=>c==="horizontal",M=j=>N()?$(j):P(j),$=j=>{const z=j.clientX-y;A&&(D.style.width=`${A.width+z}px`),k&&(S.style.width=`${k.width-z}px`)},P=j=>{const z=j.clientY-h;console.log("mouseMoveHandlerHorizontal dy",z,"width"),A&&(D.style.height=`${A.height+z}px`),k&&(S.style.height=`${k.height-z}px`)},_=()=>{console.log("mouseUpHandler"),S=null,D=null,k=null,A=null,x.style.cursor=null,x.style["user-select"]="auto",l.removeEventListener("mousemove",M),l.removeEventListener("mouseup",_)},U=j=>{y=j.clientX,h=j.clientY;const{target:z}=j,C=z.closest(".handle");x=z.closest(".resizablePanelGroup"),console.log("mouseDownHandler",y,h,x),x.style.cursor=N()?"col-resize":"row-resize",x.style["user-select"]="none",S=C.nextSibling,D=C.previousSibling,D&&(A=D.getBoundingClientRect()),S&&(k=S.getBoundingClientRect()),l.addEventListener("mousemove",M),l.addEventListener("mouseup",_)};return s({...g,class:B("handle",c),role:"separator",bauMounted:({element:j})=>{j.addEventListener("mousedown",U)},bauUnmounted:({element:j})=>{j.removeEventListener("mousedown",U)}},f)}return{PanelGroup:d,Panel:m,Handle:p}}const Gc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=$t(t,{class:n`
      display: inline-flex;
...
`,Hc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=$t(t,{class:n`
      display: inline-flex;
      border: 1px var(--color-emphasis-100) solid;
      width: 600px;
    `}),l=()=>i({class:n`
...
`,Vc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=$t(t,{direction:"vertical",class:n`
      display: inline-flex;
      flex-direction: column;
...
`,qc=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,{PanelGroup:r,Panel:i,Handle:s}=$t(t,{class:n`
      display: inline-flex;
...
`).join(`
`);function Dt(t,e={}){const{bau:n,css:o}=t,{div:a,li:r,select:i,option:s}=n.tags,l=O(t),c=Pt(t),u=yt(t),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Zc()}
  `;return function(...p){let[{size:b=e.size??"md",variant:g=e.variant??"outline",color:f=e.color??"neutral",label:y,Option:h,options:x,defaultOption:S,getOptionLabel:k,getOptionValue:D,onSelect:A=()=>{},loading:N,...M},...$]=J(p);const P=bt(t,{variant:g,color:f,size:b}),_=n.state(S?k(S):y),U=n.state(!1),j=n.state(0),z=()=>{V.openDialog(),V.focus(),U.val=!0},C=()=>{V.closeDialog(),U.val=!1},v=()=>{U.val=!1},w=I=>{V.open?C():z(),I.preventDefault()},E=({option:I,index:X})=>nt=>{_.val=k(I),q.value=D(I),q.setCustomValidity(""),j.val=X,C(),A(I),nt.preventDefault()},T=I=>{switch(I.preventDefault(),I.key){case"Escape":C();break;case"ArrowDown":j.val<x.length-1?j.val++:j.val=0;break;case"ArrowUp":j.val<=0?j.val=x.length-1:j.val--;break;case"Enter":V.open?(_.val=k(x[j.val]),q.value=D(s),C()):z();break}},H=()=>u({tabindex:"0",class:B(f,g)},x.map((I,X)=>r({class:()=>B(j.val==X&&"active"),onclick:E({option:I,index:X})},h(I)))),R=l({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":U,"aria-label":y,onclick:w,color:f,variant:g,size:b,class:N==!0&&"loading",disabled:N},()=>!_.val&&y,_,()=>N==!0&&P({visibility:N})),V=c({triggerEl:R,contentEl:H(),onClose:v}),q=i({...M,"aria-label":y},s({value:""},"--Select Category--"),x.map(I=>s({value:D(I)},k(I))));return S?q.value=D(S):q.value=M.value,a({...M,class:B("select",f,b,d,e==null?void 0:e.class,M==null?void 0:M.class),onkeydown:T},q,R,V)}}const jn=(t,e)=>{const{bau:n,css:o}=t,{div:a,span:r}=n.tags,i=Dt(t,e),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"}],l=c=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,tl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,div:i,span:s}=e.tags,l=Dt(t),c=O(t,{variant:"solid",color:"primary"}),u="AD",d=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],m=p=>i({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,nl=t=>{const{bau:e,css:n,window:o}=t,{form:a,article:r,footer:i,div:s,span:l}=e.tags,c="country",u=Dt(t),d=O(t,{variant:"solid",color:"primary"}),m=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],p=b=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,sl=t=>{const{bau:e,css:n}=t,{form:o,article:a,footer:r,span:i,div:s}=e.tags,l=O(t,{variant:"outline"}),c=O(t,{variant:"solid",color:"primary"}),u=Dt(t),d=m=>s({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,cl={title:"Select",package:"select",description:"The select component allows user to select from a list.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/select/select.js",importStatement:'import select from "@grucloud/bau-ui/select";',examples:[{title:"Simple Select",description:"A simple select.",code:Qc,createComponent:Yc},{title:"Default Option",description:"Select with a default option",code:el,createComponent:tl},{title:"State in URL",description:"Select with state in URL",code:ol,createComponent:nl},{title:"Select AWS region",description:"Select the AWS region",code:rl,createComponent:al},{title:"Loading Indicator",description:"Select with a loading indicator",code:il,createComponent:sl}],gridItem:jn},ll=t=>{const e=F(t);return()=>e(cl)};function Rn(t,e={}){const{bau:n,css:o}=t,{select:a}=n.tags,r=o`
    border-radius: var(--global-radius);
    &.sm {
    }
    &.md {
  ...
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("select-native",u,l,c,r,e==null?void 0:e.class,d==null?void 0:d.class)},m)}}const _n=(t,e)=>{const{bau:n}=t,{option:o}=n.tags,a=Rn(t,e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return i=>a({...i,"aria-label":"select-country"},r.map(({label:s,phone:l})=>o({value:l},s)))},ul=t=>{const{bau:e}=t,{option:n,form:o,footer:a}=e.tags,r=O(t,{variant:"outline",color:"primary"}),i=Rn(t),s=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}];return()=>o({onsubmit:c=>{c.preventDefault();const u=Object.fromEntries(new FormData(c.currentTarget));alert(JSON.stringify(u))}},i({name:"my-select"},n({value:""},"--Please choose a phone code--"),s.map(({label:c,phone:u})=>n({value:u},c))),a(r({type:"submit"},"Submit")))},dl=`import { Context } from "@grucloud/bau-ui/context";
...
`,ml={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:dl,createComponent:ul}],gridItem:_n},pl=t=>{const e=F(t);return()=>e(ml)},bl=t=>{const{bau:e,css:n}=t,{section:o,div:a}=e.tags,r=Et(t),i=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,vl=t=>{const{bau:e,css:n}=t,{section:o,table:a,tbody:r,tr:i,td:s}=e.tags,l=Et(t,{class:n`
      height: 2rem;
      width: 10rem;
    `}),c=()=>a(r(new Array(8).fill("").map(()=>i(s(l({class:n`
                ...
                `})),s(l()),s(l()),s(l()),s(l({class:n`
                  width: 20rem;
                `}))))));return()=>o(c())},yl=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,xl=t=>{const{bau:e,css:n}=t,{section:o,header:a,span:r,article:i}=e.tags,s=n`
    display: flex;
    flex-direction: column;
    & header {
      display: inline-flex;
  ...
  `,l=Et(t,{class:n`
    ...
    `}),c=Et(t);function u({columnsSize:d=4}){return o({class:s},a(new Array(d).fill("").map(()=>l(r("1")))),i(c("")))}return()=>o(u({columnsSize:3}))},wl=`import skeleton from "@grucloud/bau-ui/skeleton";
import { Context } from "@grucloud/bau-ui/context";
...
`,Sl={title:"Skeleton",package:"skeleton",description:"The skeleton component is used a loading indicator",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/skeleton/skeleton.js",importStatement:'import skeleton from "@grucloud/bau-ui/skeleton";',examples:[{title:"Card",description:"A card skeleton.",code:gl,createComponent:bl},{title:"List",description:"A list skeleton.",code:hl,createComponent:fl},{title:"Table",description:"A table skeleton.",code:yl,createComponent:vl},{title:"Tabs",description:"A tabs skeleton.",code:wl,createComponent:xl}],variantColorTableDisable:!0,variantSizeDisable:!0},Cl=t=>{const e=F(t);return()=>e(Sl)};function Rt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,i=o`
    ${(()=>ot.map(s=>`
&.slider.${s} {
  accent-color: var(--color-${s});
}
...
`,Nl=t=>{const{bau:e,css:n}=t,{article:o,footer:a,form:r,label:i,datalist:s,br:l,option:c}=e.tags,u=Rt(t),d=O(t,{variant:"solid",color:"primary"});return()=>r({onsubmit:p=>{p.preventDefault();const b=Object.fromEntries(new FormData(p.currentTarget));alert(JSON.stringify(b))}},o({class:n`
            display: flex;
          ...
          `}),s({id:"markers-vertical",class:n`
              ...
              flex-direction: column;
              justify-content: space-between;
            `},["0","25","50","75","100"].reverse().map(p=>c({value:Number(p),label:p})))),a(d({type:"submit"},"Submit")))},Ol=`import { Context } from "@grucloud/bau-ui/context";
import button from "@grucloud/bau-ui/button";
import slider from "@grucloud/bau-ui/slider";
...
`,Ml={title:"Slide",package:"slider",description:"The slider component allows a user to to choose a number between a range.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/slider/slider.js",importStatement:'import slider from "@grucloud/bau-ui/slider";',examples:[{title:"Uncontrolled slider",description:"A uncontrolled slider.",code:El,createComponent:kl},{title:"Controlled slider",description:"A controlled slider.",code:Dl,createComponent:Tl},{title:"Horizontal Mark",description:"A slider with horizontal mark.",code:Bl,createComponent:Al},{title:"Vertical Mark",description:"A vertical slider with marks.",code:Ol,createComponent:Nl}],gridItem:Gn},Il=t=>{const e=F(t);return()=>e(Ml)},Un=(t,e)=>{const n=bt(t,e);return o=>n({...o})},$l=t=>{const{bau:e}=t,{section:n}=e.tags,o=O(t,{variant:"solid",color:"primary"}),a=bt(t,{size:"lg"});return()=>{const r=e.state(!0);return n(o({onclick:()=>r.val=!r.val},()=>r.val?"Stop":"Start"),a({visibility:r}))}},Ll=`import spinner from "@grucloud/bau-ui/spinner";
import button from "@grucloud/bau-ui/button";
...
`,Pl={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:Ll,createComponent:$l}],gridItem:Un},zl=t=>{const e=F(t);return()=>e(Pl)},jl=()=>ot.map(t=>"").join(`
...
`,_e="stepper-vertical",Gl=t=>{const{bau:e,window:n,css:o}=t,{footer:a,p:r,label:i,section:s,a:l,ul:c,li:u}=e.tags,d=dt(t),m=gt(t),p=Fn(t,{class:o`
      &.stepper {
        flex-direction: row;
        & > ul {
          flex-direction: column;
...
`,Hl={title:"Stepper",package:"stepper",description:"The stepper component displays a series of screens that are accessed one after the other.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/stepper/stepper.js",importStatement:'import stepper from "@grucloud/bau-ui/stepper";',examples:[{title:"Horizontal Stepper",description:"A simple horizontal stepper.",code:_l,createComponent:Rl},{title:"Vertical Stepper",description:"A simple vertical stepper.",code:Ul,createComponent:Gl}]},Fl=t=>{const e=F(t);return()=>e(Hl)},Vl=()=>ot.map(t=>`
&.switch.plain.${t} {
  &::after {
...
`);function Qt(t,e={}){const{bau:n,css:o}=t,{input:a}=n.tags,r=o`
    ...
    ${Vl()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"plain",color:u=e.color??"neutral",...d},...m]=J(s);return a({...d,class:B("switch",r,u,c,l,e==null?void 0:e.class,d.class),type:"checkbox"},...m)}}const Vn=(t,e)=>{const{bau:n,css:o}=t,{form:a,label:r}=n.tags,i=Qt(t,e);return s=>a({class:o`
          & label {
            display: inline-flex;
            border: 1px dotted var(--color-emphasis-200);
            font-size: smaller;
        ...
        `},r("off ",i({...s,id:`my-switch-example-off-${s.color}-${s.variant}`})),r("on ",i({...s,id:`my-switch-example-on-${s.color}-${s.variant}`,checked:!0})))},Jl=t=>{const{bau:e,css:n}=t,{footer:o,form:a,label:r,article:i}=e.tags,s=Qt(t,{variant:"outline",color:"primary"}),l=O(t,{variant:"outline",color:"primary"}),c=n`
    & label {
      display: flex;
      align-items: center;
      flex-direction: row;
...
`,Yl={title:"Switch",package:"switch",description:"The switch component allows a user to to choose a boolean value.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/switch/switch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/switch";',examples:[{title:"Uncontrolled Switch",description:"A uncontrolled switch.",code:ql,createComponent:Jl},{title:"Controlled Switch",description:"A controlled switch.",code:Kl,createComponent:Wl},{title:"State in URL",description:"A switch with state in URL",code:Zl,createComponent:Xl}],gridItem:Vn},Ql=t=>{const e=F(t);return()=>e(Yl)},tu=()=>ot.map(t=>`
&.tabs.solid.${t} {
}
`).join(`
...
`,ou=t=>{const{bau:e}=t,{div:n,p:o}=e.tags,r=_t(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>"Tab Disabled",Content:()=>n(o("My Content Disabled"))}],variant:"plain",color:"neutral"});return()=>r({tabsKey:"my-tab"})},au=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,Jn=t=>{const{bau:e}=t,{div:n,p:o}=e.tags;return[{name:"Tab1",Header:()=>"TAB",Content:()=>n(o("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>n(o("My tab 2 Content"))}]},ru=t=>{const{css:e}=t,n=_t(t,{tabDefs:Jn(t),class:e`
      flex-direction: column-reverse;
    `});return()=>n({})},su=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,iu=t=>{const{css:e}=t,n=Jn(t),o=_t(t,{tabDefs:n,class:e`
      & ul {
        justify-content: center;
      }
    `});return()=>o({})},cu=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`,lu={title:"Tabs",package:"tabs",description:"The tabs component displays multiple content and a header for navigation.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tabs/tabs.js",importStatement:'import tabs from "@grucloud/bau-ui/tabs";',examples:[{title:"Default",description:"A simple tabs.",code:nu,createComponent:eu},{title:"Extended Tabs",description:"An extended tabs.",code:au,createComponent:ou},{title:"Bottom Header Tabs",description:"Tabs where the header is at the bottom of the content.",code:su,createComponent:ru},{title:"Centered Header Tabs",description:"Tabs where the headers are centered.",code:cu,createComponent:iu}]},uu=t=>{const e=F(t);return()=>e(lu)};function Gt(t,e){const{bau:n,css:o,createGlobalStyles:a}=t,{div:r}=n.tags;a`
  :root {
...
`;const i=o`
  ...
  `;return function(...l){let[{...c},...u]=J(l);return r({...c,class:B("table-container",i,e==null?void 0:e.class,c==null?void 0:c.class)},...u)}}const du=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags;function d(f,y,h,x,S){return{name:f,calories:y,fat:h,carbs:x,protein:S}}const m=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],p=({name:f,calories:y})=>i(r(f),r({class:n`
      ...
      max-width: 650px;
    `});return()=>o(g(s(u("Basic Table"),b(),c(m.map(p)))))},mu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Bt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const pu=[Bt("Frozen yoghurt",159,6,24,4),Bt("Ice cream sandwich",237,9,37,4.3),Bt("Eclair",262,16,24,6),Bt("Cupcake",305,3.7,67,4.3),Bt("Gingerbread",356,16,49,3.9)],bu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
    ...
    `});return()=>o(p(s(u("Table Dense"),m(),c(pu.map(d)))))},gu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Nt(t,e,n,o,a){return{name:t,calories:e,fat:n,carbs:o,protein:a}}const fu=[Nt("Frozen yoghurt",159,6,24,4),Nt("Ice cream sandwich",237,9,37,4.3),Nt("Eclair",262,16,24,6),Nt("Cupcake",305,3.7,67,4.3),Nt("Gingerbread",356,16,49,3.9)],hu=t=>{const{bau:e,css:n}=t,{section:o,th:a,td:r,tr:i,table:s,thead:l,tbody:c,caption:u}=e.tags,d=({name:b,calories:g})=>i(r(b),r({class:n`
            text-align: right;
          `},g)),m=()=>l(i(a({class:n`
              text-align: left;
            `,title:"Product Name"},"Product Name"),a({class:n`
    ...
    `});return()=>o(p(s(u("Table Zebra"),m(),c(fu.map(d)))))},vu=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`,yu={title:"Table",package:"table",description:"The table container component styles an HTML table.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/table/table.js",importStatement:'import tableContainer from "@grucloud/bau-ui/tableContainer";',examples:[{title:"Default",description:"A simple table.",code:mu,createComponent:du},{title:"Dense",description:"A dense table.",code:gu,createComponent:bu},{title:"Zebra",description:"A zebra table.",code:vu,createComponent:hu}]},xu=t=>{const e=F(t);return()=>e(yu)},wu=t=>{const{bau:e,css:n}=t,{h1:o,h2:a,h3:r,section:i,article:s}=e.tags,l=cn(t),c=s({id:"content",class:n`
        grid-area: content;
      `},o({id:"h1"},"h1"),a({id:"h2-1"},"h2 1"),r({id:"h3-1-1"},"h3 1 1"),r({id:"h3-1-2"},"h3 1 2"),a({id:"h2-2"},"h2 2"),r({id:"h3-2-1"},"h3 2 1"));return()=>i({class:n`
          ...
          grid-template-areas: "content toc";
        `},c,l({contentEl:c}))},Su=`import tableOfContent from "@grucloud/bau-ui/tableOfContent";
import { Context } from "@grucloud/bau-ui/context";
...
`,Cu={title:"TableOfContent",package:"tableOfContent",description:"The tableOfContent component displays a table of content",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tableOfContent/tableOfContent.js",importStatement:'import tableOfContent from "@grucloud/bau-ui/tableOfContent";',examples:[{title:"Simple TableOfContent",description:"A simple tableOfContent.",code:Su,createComponent:wu}]},ku=t=>{const e=F(t);return()=>e(Cu)};function qn(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=ye(t),i=O(t),s=bt(t),l=o`
    display: flex;
    align-items: center;
    justify-content: flex-end;
  ...
  `,c=({label:b,icon:g,...f})=>i({"aria-label":b,title:b,...f},g),u=({count:b,totalCount:g,page:f,rowsPerPage:y})=>a({class:"pages-numbers"},Number(f-1)*Number(y)+(b>0?1:0),"-",Math.min(f*y,g)," of ",g),d=({count:b,page:g,rowsPerPage:f})=>a({class:"pages-numbers"},(g-1)*f+(b>0?1:0),"-",g*f),m=b=>b<=1,p=(b,g,f)=>b>=Math.ceil(g/f);return function(...g){let[{size:f=e.size??"md",variant:y=e.variant??"outline",color:h=e.color??"neutral",count:x=0,totalCount:S=0,page:k=1,rowsPerPage:D=50,onPageChange:A,isLoading:N=!1,disableFirst:M=()=>m(k),disablePrevious:$=()=>m(k),disableNext:P=()=>p(k,S,D),disableLast:_=()=>p(k,S,D),...U},...j]=J(g);const z=Math.max(0,Math.ceil(S/D)),C=A({page:1}),v=A({page:k-1}),w=A({page:k+1}),E=A({page:z}),T=[{label:"First",icon:"⟪",onclick:C,disabled:M()},{label:"Previous",icon:"⟨",onclick:v,disabled:$()},{label:"Next",icon:"⟩",onclick:w,disabled:P()},{label:"Last",icon:"⟫",onclick:E,disabled:_()}];return a({...U,class:B("table-pagination",l,N&&"disabled",e==null?void 0:e.class,U==null?void 0:U.class)},s({class:"spinner",visibility:N,size:"md"}),S>0?u({count:x,totalCount:S,page:k,maxPages:z,rowsPerPage:D}):d({count:x,page:k,maxPages:z,rowsPerPage:D}),r({variant:y,color:h},T.map(H=>c({...H,variant:y,color:h}))))}}const Eu=(t=1e3)=>new Array(t).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),Tu=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l}=e.tags,c=Eu(45),u=({name:b,email:g})=>r(a(b),a(g)),d=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
            text-align: left;
          `},"Email")),m=qn(t),p=Gt(t,{class:n`
      max-width: 650px;
    `});return()=>{const b=e.state(c),g=e.state({count:c.length,totalCount:c.length,page:1,rowsPerPage:10}),f=e.derive(()=>b.val.slice(g.val.page*g.val.rowsPerPage,(g.val.page+1)*g.val.rowsPerPage)),y=({page:h})=>x=>{g.val.page=h};return p(i(d(),()=>l(f.val.map(u))),()=>m({...g.val,onPageChange:y}))}},Du=t=>{const{bau:e,css:n}=t,{th:o,td:a,tr:r,table:i,thead:s,tbody:l,div:c}=e.tags,u=e.state(!1),d=e.state([]),m=e.state(""),p=e.derive(()=>d.val.length),b=e.state(1),g=e.state(10),f=e.derive(()=>d.val),y=M=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(M).toString()}`,h=({page:M})=>$=>{b.val=M,x(y({page:M,per_page:g.val}))};x(y({page:1,per_page:g.val}));async function x(M){try{u.val=!0;const $=await fetch(M,{});if($.ok){const P=await $.json();d.val=P;return}throw $}catch($){m.val=$.message}finally{u.val=!1}}const S=({name:M,description:$,stargazers_count:P})=>r(a(M),a($),a({class:n`
            text-align: right;
          `},P)),k=()=>s(o({class:n`
            text-align: left;
          `},"Name"),o({class:n`
      ...
      min-width: 650px;
    `}),N=({message:M})=>c(M);return()=>A(()=>D({rowsPerPage:g.val,page:b.val,count:p.val,totalCount:-1,isLoading:u.val,onPageChange:h,disableNext:()=>!1}),i(k(),()=>m.val&&N({message:m.val}),()=>l(f.val.map(S))))},Au=t=>{const{bau:e,css:n}=t,{section:o,div:a,h3:r,h2:i,tr:s}=e.tags,l=Tu(t),c=Du(t),u=(...d)=>a({class:n`
        ...
        `},...d);return()=>o({id:"pagination"},i(s("Table Pagination")),r("Asynchronous Pagination"),u(c()),r("Simple Pagination"),u(l()))};function Ut(t,e={}){const{bau:n,css:o,createGlobalStyles:a}=t,{button:r}=n.tags;a`
    :root {
  ...
  `;return function(...l){let[{size:c=e.size??"md",variant:u=e.variant??"outline",color:d=e.color??"neutral",selected:m=!1,disabled:p,onChange:b,...g},...f]=J(l);return r({type:"button",...g,"aria-pressed":{deps:[m],renderProp:()=>y=>y},class:{deps:[m],renderProp:()=>y=>B("toggle",c,d,u,i,y&&"selected",e==null?void 0:e.class,g==null?void 0:g.class)},disabled:p},f)}}const Wn=(t,e)=>{const{bau:n}=t,o=Ut(t,e);return a=>{const r=n.state(!1);return o({...a,selected:r,onclick:()=>r.val=!r.val},"Toggle Me")}},Bu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=Ut(t,{variant:"plain"}),i=O(t,{variant:"outline",color:"primary"});return()=>{const s=e.state(!1);return n({onsubmit:c=>{var m;c.preventDefault();const d=(m=c.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:m.name;alert(d)}},o(r({name:"my-toogle",selected:s,onclick:()=>s.val=!s.val},"Toggle Me")),a(i({type:"submit"},"Submit")))}},Nu=`import { Context } from "@grucloud/bau-ui/context";
...
`,Ou={title:"Toggle",package:"toggle",description:"The toggle component displays a button with 2 states",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggle/toggle.js",importStatement:'import toggle from "@grucloud/bau-ui/toggle";',examples:[{title:"Simple Toggle",description:"A simple toggle.",code:Nu,createComponent:Bu}],gridItem:Wn},Mu=t=>{const e=F(t);return()=>e(Ou)},Iu=()=>ot.map(t=>`
&.toggle-group.${t} {
  & button:not(:last-child) { 
    border-right: 1px solid var(--color-${t}) !important;
  }
...
`);function Ce(t,e={}){const{bau:n,css:o}=t,{div:a}=n.tags,r=o`
    ...
    ${Iu()}
  `;return function(...s){let[{size:l=e.size??"md",variant:c=e.variant??"outline",color:u=e.color??"neutral",exclusive:d=!1,onChange:m=()=>{},...p},...b]=J(s);const g=new Set,f=y=>{const{value:h}=y.target;d?(g.clear(),g.add(h)):g.has(h)?g.delete(h):g.add(h),m({event:y,values:[...g]})};return a({...p,class:B("toggle-group",l,u,c,r,e==null?void 0:e.class,p==null?void 0:p.class),onclick:f},...b)}}const Kn=(t,e)=>{const{bau:n}=t,o=Ce(t,e),a=Ut(t,e);return r=>{const i=n.state([""]),s=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...r,onChange:({values:c})=>{i.val=c}},s.map(({label:c,value:u})=>()=>a({...r,value:u,selected:i.val.includes(u),"area-label":c},c)))}},$u=t=>{const{bau:e}=t,{form:n,footer:o,article:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=Ut(t,{color:i,variant:s}),c=Ce(t,{color:i,variant:s}),u=O(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{var y;b.preventDefault();const f=(y=b.currentTarget.querySelector("button[aria-pressed=true]"))==null?void 0:y.name;alert(f)}},a(c({exclusive:!0,onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),o(u({type:"submit"},"Submit")))}},Lu=`import { Context } from "@grucloud/bau-ui/context";
...
`,Pu=t=>{const{bau:e}=t,{form:n,article:o,footer:a}=e.tags,r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i="primary",s="solid",l=Ut(t,{variant:s,color:i}),c=Ce(t,{variant:s,color:i}),u=O(t,{variant:"outline",color:"primary"});return()=>{const d=e.state([""]);return n({onsubmit:b=>{b.preventDefault();const f=[...b.currentTarget.querySelectorAll("button[aria-pressed=true]")].map(({name:y})=>y);alert(JSON.stringify(f))}},o(c({onChange:({values:b})=>{d.val=b}},r.map(({label:b,value:g})=>()=>l({value:g,name:b,selected:d.val.includes(g)},b)))),a(u({type:"submit"},"Submit")))}},zu=`import { Context } from "@grucloud/bau-ui/context";
import toggleGroup from "@grucloud/bau-ui/toggleGroup";
import toggle from "@grucloud/bau-ui/toggle";
import button from "@grucloud/bau-ui/button";
...
`,ju={title:"Toggle Group",package:"toggleGroup",description:"The toggleGroup component displays a set of toogle button",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/toggleGroup/toggleGroup.js",importStatement:'import toggleGroup from "@grucloud/bau-ui/toggleGroup";',examples:[{title:"Exclusive ToggleGroup",description:"A simple exclusive toggleGroup.",code:Lu,createComponent:$u},{title:"Inclusive ToggleGroup",description:"A simple inclusive toggleGroup.",code:zu,createComponent:Pu}],gridItem:Kn},Ru=t=>{const e=F(t);return()=>e(ju)};function ke(t,e={}){const{bau:n,css:o,window:a}=t,{div:r}=n.tags,i=o`
    position: relative;
    display: inline-block;
    & .container {
      & .content {
...
`,Uu=t=>{const{bau:e,css:n}=t,{div:o,p:a,em:r,section:i}=e.tags,s=Lt(t,{variant:"outline",color:"primary"}),l=ke(t),c=()=>o(a("A ",r("tooltip")," can be any component")),u=()=>i({class:n`
          display: flex;
          flex-direction: column;
          gap: 1rem;
          margin: 1rem;
...
`,Fu={title:"Tooltip",package:"tooltip",description:"The tooltip display information next to a component.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/tooltip/tooltip.js",importStatement:'import tooltip from "@grucloud/bau-ui/tooltip";',examples:[{title:"Default",description:"A simple tooltip.",code:Gu,createComponent:_u},{title:"Grid",description:"Various tooltip position",code:Hu,createComponent:Uu}],gridItem:Xn},Vu=t=>{const e=F(t);return()=>e(Fu)},Zn=(t,e)=>{const n=ce(t,e);return o=>n(o)},Ju=t=>{const{bau:e}=t,{section:n}=e.tags,o=ce(t);return()=>n(o({}))},qu=`import createThemeSwitch from "@grucloud/bau-ui/themeSwitch";
import { Context } from "@grucloud/bau-ui/context";
...
`,Wu={title:"Theme Switch",package:"themeSwitch",description:"The themeSwitch component allows a user to switch between light and dark theme.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/themeSwitch/themeSwitch.js",importStatement:'import createSwitch from "@grucloud/bau-ui/themeSwitch";',examples:[{title:"Default",description:"A simple themeSwitch.",code:qu,createComponent:Ju}],gridItem:Zn},Ku=t=>{const e=F(t);return()=>e(Wu)},Yn=({parent:t,grandParent:e})=>n=>{const{children:o=[],...a}=n,r={...a};return r.children=o==null?void 0:o.map(Yn({parent:n,grandParent:t})),t&&(t.parent=e),r.parent=t,r},Xu=({css:t,createGlobalStyles:e})=>(e`
:root {
...
`,ed={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Simple",description:"A simple treeview.",code:Yu,createComponent:Zu},{title:"Checkable",description:"A treeview with checkboxes.",code:td,createComponent:Qu}],gridItem:Qn},nd=t=>{const e=F(t);return()=>e(ed)},od=(t,e)=>{const{bau:n}=t,{div:o,p:a}=n.tags,i=_t(t,{tabDefs:[{name:"Tab1",Header:()=>"TAB 1",Content:()=>o(a("My Tab 1 Content"))},{name:"Tab2",Header:()=>"TAB 2",Content:()=>o(a("My tab 2 Content"))}],...e});return s=>i(s)},ad=t=>{const{bau:e,css:n}=t,{section:o,div:a,h1:r,p:i,ul:s,li:l}=e.tags,c=ln(t),u=O(t),d=[{name:"Accordion",Item:un(t)},{name:"Alert",Item:mn(t)},{name:"Autocomplete",Item:bn(t)},{name:"Avatar",Item:pn(t)},{name:"Badge",Item:fn(t)},{name:"Breadcrumbs",Item:hn(t)},{name:"Button",Item:vn(t)},{name:"Button Group",Item:yn(t)},{name:"Calendar",Item:xn(t)},{name:"Checkbox",Item:Sn(t)},{name:"Chip",Item:wn(t)},{name:"DrillDown Menu",Item:kn(t,{base:"/components",hashBased:!0})},{name:"File Input",Item:Tn(t)},{name:"Input",Item:Dn(t)},{name:"Input Search",Item:An(t)},{name:"Linear Progress",Item:In(t)},{name:"Loading Button",Item:$n(t)},{name:"Modal",Item:Pn(t)},{name:"Radio Button",Item:zn(t)},{name:"Select",Item:jn(t)},{name:"Select Native",Item:_n(t)},{name:"Slider",Item:Gn(t)},{name:"Spinner",Item:Un(t)},{name:"Switch",Item:Vn(t)},{name:"Tabs",Item:od(t)},{name:"Theme Switch",Item:Zn(t)},{name:"Toggle",Item:Wn(t)},{name:"Toggle Group",Item:Kn(t)},{name:"Tooltip",Item:Xn(t)},{name:"Tree View",Item:Qn(t)}];return()=>o({class:n`
          overflow-y: scroll;
  ...
  `};vo();const to={title:"Bau",base:"/bau/bau-ui"},ht=To({config:to}),{bau:ld}=ht;ht.states={drawerOpen:ld.state(!0)};cd(ht);so({routes:rd({context:ht}),onLocationChange:id({context:ht,LayoutDefault:Po(ht),config:to}),notFoundRoute:sd(ht)});
