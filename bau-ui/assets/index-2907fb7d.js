...
`);function st(e,t={}){const{bau:n,css:o,window:a}=e,{input:i}=n.tags,s=u=>{a.document.documentElement.setAttribute("data-theme",u),localStorage.setItem("theme",u)},r=()=>{try{return localStorage.getItem("theme")}catch{}},c=r();c?s(c):a.matchMedia("(prefers-color-scheme: dark)").matches?s("dark"):a.matchMedia("(prefers-color-scheme: light)").matches?s("light"):s(Eo);const l=o`
  ...
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",...h},...w]=F(d);return i({required:"required",title:"Switch Theme",...h,class:I("theme-switch",b,g,p,l,t==null?void 0:t.class,h.class),type:"checkbox",checked:r()=="dark",onclick:x=>{s(x.target.checked?"dark":"light")}},...w)}}function Ao(e){const{tr:t,bau:n,css:o,config:a,states:i}=e,{i:s,header:r,h1:c,div:l,a:u,img:d,b:p,ul:g,li:b}=n.tags,{svg:h,path:w}=n.tagsNS("http://www.w3.org/2000/svg"),x=i.drawerOpen,v=K(e,{class:o`
    ...
    `}),S=st(e),E=()=>s(h({id:"burger-icon",version:"1.1",viewBox:"0 0 32 32",width:"40px",height:"50px"},w({fill:"currentColor",d:"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"}))),M=()=>l({class:o`
          display: flex;
          align-items: center;
          & a {
        ...
        `},M(),D())}}function Io({tr:e,bau:t,css:n}){const{section:o,footer:a,span:i,a:s,ul:r,li:c,p:l,div:u,h1:d}=t.tags,p=({links:h,title:w})=>o({class:n`
          & ul {
            list-style: none;
            padding-left: 0;
          }
  ...
  `,hideToRight:e`
   ...
   `});function it(e,t={}){const{bau:n,css:o,window:a,config:i}=e,{base:s="",hashBased:r=!1}=t,c=`${i.base}${s}`,l=z=>{var y;return((y=z.parentTree.data)==null?void 0:y.href)??z.parentTree.children[0].data.href},u=({variant:z,color:y,size:m,currentTree:f,data:C})=>S(T({variant:z,color:y,size:m,href:`${c}${l(f)}`,class:o`
            flex-grow: 0;
          `,"data-buttonback":!0},"←"),T({variant:z,color:y,size:m,href:`${c}${C.href}`,class:o`
            flex-grow: 1;
          `,"data-ischild":!0},C.name)),d=({size:z,subTree:{data:{name:y,href:m},children:f=[]}})=>T({size:z,href:`${c}${m}`,"data-ischild":!f.length},y),p=({pathname:z,subTree:y})=>{var m;return z===((m=y==null?void 0:y.data)==null?void 0:m.href)},{renderHeader:g=u,renderMenuItem:b=d,isActive:h=p}=t,{li:w,nav:x,div:v,header:S,a:E}=n.tags,M=Ue(e),D=he(e),T=K(e,{class:o`
      &.button {
        justify-content: flex-start;
      }
    `}),{hideToLeft:A,hideToRight:N}=Do(e),_=o`
    font-weight: var(--font-weight-semibold);
    overflow: hidden;
    position: relative;
    & header {
...
`);function fe(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,i=o`
  ...
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",onclick:d,...p},...g]=F(r);return a({...p,onclick:d,class:I("chip",t.class,c,l,u,d&&"clickable",i,p.class)},...g)}}function $o(e){const{bau:t,css:n,config:o}=e,{div:a,h1:i,h2:s,p:r}=t.tags;K(e);const c=n`
  ...
  `,r=({title:c,Content:l})=>o({className:"feature"},a(c),i(l()));return function({featuresContent:l}){return o({class:s},l.map(r))}}function Po({tr:e,bau:t,css:n}){const{article:o,dl:a,dt:i,dd:s,div:r,aside:c,footer:l,a:u}=t.tags,d=({maxSize:p=151})=>({libName:g,size:b})=>r({class:n`
        ...
        `},c({class:n`
          ...
          `},g.map(d({}))),l({class:n`
            text-align: center;
          `},"The bundle size corresponds to a simple application with a dozen components. ",u({href:"https://github.com/FredericHeem/component-library-bundle-size"},"How is it measured?")))}}function Oo(e){const{bau:t,css:n,config:o}=e,{div:a,p:i,a:s,section:r}=t.tags,c=$o(e),l=Bo(e),u=K(e);Fe(e);const d=Po(e),p=(...x)=>a({class:n`
          background-color: var(--color-emphasis-100);
          border-radius: var(--global-radius);
...
"Click me"
  ...
  `,g=({value:w,id:x,children:v=[]})=>{const S=c({class:()=>u.val==x?"active":"",href:`#${x}`});return S.innerHTML=w,r({class:()=>u.val==x?"active":""},S,v.length>0&&s(v.map(g)))},b=w=>w.tagName.charAt(1),h=({contentEl:w})=>{const x=w.querySelectorAll(l);let v=2,S={},E={children:[]},M=E;const D=M;let T=[M];return[...x].forEach(A=>{const N=b(A);A.setAttribute("id",A.textContent),!A.innerHTML.includes("<button")&&(S={value:A.innerHTML,id:A.id??A.textContent,children:[]},v==N?(E=S,M.children.push(E)):v<N?(T.push(M),M=E,E.children.push(S),E=S):v>N&&(M=T[N-1],T=T.slice(0,N-1),M.children.push(S),E=S),v=N)}),D};return function(...x){let[{size:v=t.size??"md",variant:S=t.variant??"plain",color:E=t.color??"neutral",contentEl:M,...D}]=F(x);const T=h({contentEl:M}),A=d(()=>{const _=[...M.querySelectorAll(l)].find(U=>{const{top:Y,height:W}=U.getBoundingClientRect();if(Y+W>60)return!0});_&&(u.val=_==null?void 0:_.id)},100);return i({...D,class:I("tableOfContent",v,S,E,p,t==null?void 0:t.class,D==null?void 0:D.class),bauMounted:()=>{a.addEventListener("scroll",A)},bauUnmounted:()=>{a.removeEventListener("scroll",A)}},T.children&&s(T.children.map(g)))}}const on=e=>{const{bau:t,css:n}=e,{div:o,table:a,tbody:i,tr:s,td:r,thead:c,th:l}=t.tags;return function({Item:d,name:p}){return o({class:n`
          overflow-x: auto;
          overflow-y: visible;
          width: 100%;
          max-width: 80vw;
        ...
        `},a(c(s(l(p??""),te.map(g=>l(g)))),i(So.map(g=>s(l(g),te.map((b,h)=>r(d({color:b,variant:g},{index:h}))))))))}},ja=e=>{const{bau:t,css:n}=e,{section:o}=t.tags;return function({item:i}){return o({class:n`
          ...
          flex-direction: column;
          align-items: flex-start;
        `},Co.map((s,r)=>i(e,{size:s})({color:"success",variant:"outline"},{size:s,index:r})))}},j=e=>{const{bau:t,css:n}=e,{div:o,article:a,section:i,h1:s,p:r,h2:c,h3:l,pre:u,code:d}=t.tags;Ie.registerLanguage("javascript",tn);const p=nn(e),g=Me(e,{class:n`
      &.paper {
        border: 3px dashed rgba(255, 255, 255, 0.1);
      }
    `}),b=on(e),h=ja(e),w=({text:x})=>u({class:n`
          display: inline-block;
        `},d({class:"hljs language-js",bauCreated:({element:v})=>{v.innerHTML=Ie.highlight(x,{language:"js"}).value}}));return function(v){const S=a({class:n`
          grid-area: content;
          overflow-x: scroll;
        `},s(v.title),r(v.description),v.gridItem&&!v.variantColorTableDisable&&[c("Variant/Color"),g(b({Item:v.gridItem(e)}))],v.gridItem&&!v.variantSizeDisable&&[c("Size"),r("Component with size: ",d("sm"),", ",d("md"),", and ",d("lg")),g(h({item:v.gridItem}))],c("Usage"),l("Import"),w({text:v.importStatement}),c("Examples"),v.examples.map(E=>i(l(E.title),r(E.description),g(E.createComponent(e)({})),w({text:E.code}))));return o({class:n`
          display: grid;
          gap: 1rem;
...
`);function We(e,t={}){const{bau:n,css:o}=e,{div:a,ul:i,li:s,h3:r,button:c}=n.tags,l=o`
    ...
    ${Ha()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"plain",color:b=t.color??"neutral",data:h=[],...w}]=F(d);const x=n.state(""),v=mt(e,{size:p,variant:g,color:b}),S=M=>D=>{x.val==M?x.val="":x.val=M},E=M=>{const{Header:D,Content:T,name:A}=M,N=()=>r({class:()=>I(x.val==A&&"active")},c({type:"button","aria-controls":`bau-${A}`,"aria-expanded":({element:U})=>x.val==A},D(M))),_=()=>a({id:`bau-${A}`,"data-state":({element:U})=>x.val==A},T(M));return s({class:I(b,g,p),onclick:S(A)},v({Header:N,Content:_}))};return a({class:I("accordion",l,t==null?void 0:t.class,w.class)},i(h.map(E)))}}const an=(e,t)=>{const{bau:n}=e,{div:o,p:a}=n.tags,i=[{name:"Item1",Header:()=>"Item 1",Content:()=>o(a("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>o(a("Item 2 Content"))}],s=We(e,t);return r=>s({...r,data:i})},Ga=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,a=[{name:"Item1",Header:()=>"Item 1",Content:()=>n(o("Item 1 Content"))},{name:"Item2",Header:()=>"Item 2",Content:()=>n(o("Item 2 Content"))}],i=We(e);return()=>i({data:a,color:"neutral",variant:"outline"})},Ua=`import accordion, { Accordion } from "@grucloud/bau-ui/accordion";
...
`,qa={title:"Accordion",package:"accordion",description:"An accordion is a stacked list of headers that reveal or hide associated sections of content.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/accordion/accordion.js",importStatement:'import accordion from "@grucloud/bau-ui/accordion";',examples:[{title:"Default ",description:"A simple accordion.",code:Ua,createComponent:Ga},{title:"Customize with with fit-content",description:"Customize the width of the accordion.",code:Va,createComponent:Fa},{title:"Customize the icon",description:"Customize the icon with a cross.",code:Ka,createComponent:Wa}],gridItem:an},Xa=e=>{const t=j(e);return()=>t(qa)},Za={danger:"⚠",warning:"⚠",success:"✔",primary:"ℹ",neutral:"ℹ"},Ya=()=>te.map(e=>`
&.alert {
  &.plain.${e} {
    & .icon {
      color: var(--color-${e})
...
`,ir={title:"Alert Stack",package:"alertStack",description:"An alertStack displays alerts in a stack. To send an alert from any component, send a CustomEvent with the alert to display.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/alertStack/alertStack.js",importStatement:'import alertStack from "@grucloud/bau-ui/alertStack";',examples:[{title:"Default",description:"A simple alertStack.",code:sr,createComponent:rr}]},cr=e=>{const t=j(e);return()=>t(ir)},lr=e=>{const{bau:t,keyframes:n}=e,{section:o,div:a}=t.tags,i=Ue(e),s=K(e),r=n`
    to {
      transform: translateX(100%);
      opacity: 0;
    }
...
`);function gt(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=o`
    ...
    ${wr()}
  `;return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"outline",color:d=t.color??"neutral",label:p,placeholder:g,Option:b,options:h,getOptionLabel:w,getOptionValue:x,onSelect:v=()=>{},id:S,required:E,name:M,loading:D,...T},...A]=F(c);const N=Ke(e),_=K(e),U=fe(e,{variant:u,color:d,size:l}),Y=he(e),W=Ce(e,{variant:u,color:d,size:l}),q=n.state(),z=n.state(T.value),y=n.state(!1),m=n.state(0),f=()=>{y.val=!1},C=n.state(h),k=ee=>se=>ee.val&&w(se)==w(ee.val),R=()=>{pe.openDialog(),y.val=!0,z.val="",C.val=h,m.val=h.findIndex(k(q));const ee=ke.querySelector("li.selected");ee&&(ee.scrollIntoView({block:"center"}),ae.scrollIntoView({block:"end"}))},B=()=>{pe.closeDialog(),y.val=!1,z.val="",m.val=0},H=ee=>{const{value:se}=ee.target;z.val=se,se?C.val=h.filter(Ee=>w(Ee).match(new RegExp(`${se}`,"i"))):C.val=h},P=ee=>{pe.open?B():R()},L=({option:ee,index:se})=>Ee=>{q.val=ee,m.val=se,B()},Z=()=>{const ee=ke.querySelector("li.active");ee&&ee.scrollIntoView({block:"center",behavior:"smooth"})},oe=ee=>{switch(ee.key){case"Escape":B();break;case"ArrowDown":m.val<C.val.length-1?m.val++:m.val=0,Z();break;case"ArrowUp":m.val<=0?m.val=C.val.length-1:m.val--,Z();break;case"Enter":pe.open?(q.val=C.val[m.val],z.val="",B()):R(),ee.preventDefault();break}},Q=_({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":y,"aria-label":p,onclick:P,variant:u,color:d,size:l,class:D==!0&&"loading",disabled:D},()=>q.val?x(q.val):p,()=>D==!0&&W({visibility:D})),ae=U({value:z,placeholder:g,autofocus:!0,type:"search",autocomplete:"off",autocapitalize:"none",spellcheck:!1,role:"combobox","aria-autocomplete":"list","aria-expanded":y,oninput:H,onkeydown:oe,...T}),xe=U({class:o`
        width: 1px;
        opacity: 0;
        left: 0;
        bottom: 0;
        position: absolute;
      `,tabindex:-1,value:z,required:E,name:M}),ke=a({class:I(u,d,l,"content")},ae,()=>Y({class:I(u,d,l)},C.val.map((ee,se)=>i({class:()=>I(m.val==se&&"active",k(q)(ee)&&"selected"),onclick:L({option:ee,index:se})},b(ee))))),pe=N({id:S,triggerEl:Q,contentEl:ke,onClose:f,class:o`
        overflow: hidden;
      `});return n.derive(()=>{q.val&&(xe.value=x(q.val),v(q.val))}),a({...T,class:I("autocomplete",s,t==null?void 0:t.class,T==null?void 0:T.class)},Q,xe,pe)}}const un=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=gt(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return l=>s({...l,options:r,Option:c,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Country",placeholder:"Search countries",id:"country"})},yr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=gt(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
...
`,Cr=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=K(e,{variant:"outline"}),r=gt(e),c=t.state([]),l=t.state(!1),u=t.state("");async function d({url:b,transform:h=w=>w}){try{l.val=!0;const w=await fetch(b,{});if(w.ok){const x=await w.json();c.val=h(x)}else u.val=w.statusText}catch(w){u.val=w.message}finally{l.val=!1}}const p=()=>d({url:"https://restcountries.com/v3.1/all?fields=name,flag",transform:b=>b.sort((h,w)=>h.name.common.localeCompare(w.name.common))});p();const g=b=>a({class:n`
        ...
        `},i(b.flag),i(b.name.common));return()=>o(a({class:n`
            display: flex;
            gap: 1rem;
          `},()=>r({options:c.val,Option:g,getOptionValue:({name:b})=>b.common,getOptionLabel:({name:b})=>b.common,label:"Country",placeholder:"Search countries",id:"country",loading:l.val}),s({onclick:()=>p()},"Reload")))},kr=`import { Context } from "@grucloud/bau-ui/context";
import autocomplete from "@grucloud/bau-ui/autocomplete";
import button from "@grucloud/bau-ui/button";
...
`,Dr={title:"Badge",package:"badge",description:"The badge component displays a number on the top right corner of an icon",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/badge/badge.js",importStatement:'import badge from "@grucloud/bau-ui/badge";',examples:[{title:"Default",description:"A simple badge.",code:Ir,createComponent:Ar}],gridItem:pn},Nr=e=>{const t=j(e);return()=>t(Dr)};function bt(e,t={}){const{bau:n,css:o,config:a}=e,{ul:i,li:s,span:r}=n.tags,{separator:c="〉"}=t,l=K(e),u=o`
  ...
  `;return function(...p){let[{size:g=t.size??"md",variant:b=t.variant??"plain",color:h=t.color??"neutral",items:w,...x},...v]=F(p);return i({...x,class:I(u,t==null?void 0:t.class,x==null?void 0:x.class)},w.map(({href:S,name:E})=>s((S?l:r)({href:`${a.base}${S}`,color:h,variant:b,size:g,class:I(h,b,g)},E))))}}const mn=(e,t)=>{const n={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},o=bt(e,t);return a=>o({...a,...n})},Mr=e=>{const{bau:t}=e,{section:n}=t.tags,o={items:[{href:"/",name:"⌂"},{name:"Dir",href:"/dir"},{href:"/dir/subdir",name:"SubDir"}]},a=bt(e,{variant:"outline",color:"neutral"});return()=>n(a(o))},$r=`import { Context } from "@grucloud/bau-ui/context";
import breadcrumbs, {
...
`,Wr={title:"Button",package:"buttonGroup",description:"The buttonGroup component groups button together.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/buttonGroup/buttonGroup.js",importStatement:'import buttonGroup from "@grucloud/bau-ui/buttonGroup";',examples:[{title:"Default",description:"A simple buttonGroup.",code:Vr,createComponent:Fr}],gridItem:bn},Kr=e=>{const t=j(e);return()=>t(Wr)};function hn(e,t={}){const{bau:n,css:o}=e,{input:a}=n.tags,s=o`
    padding: 0.3rem;
    border-radius: var(--global-radius);
    border: none;
    ${(()=>te.map(r=>`
...
`,Zr={title:"Calendar",package:"calendar",description:"The calendar component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/calendar/calendar.js",importStatement:'import calendar from "@grucloud/bau-ui/calendar";',examples:[{title:"Default",description:"A simple calendar.",code:Xr,createComponent:qr}],gridItem:fn},Yr=e=>{const t=j(e);return()=>t(Zr)};function Jr(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
  ...
  `,s=n.state(0);return function(...c){let[{size:l=t.size??"md",variant:u=t.variant??"plain",color:d=t.color??"neutral",slides:p,Slide:g,Previous:b,Next:h,...w}]=F(c);const x=()=>{s.val<=0?s.val=p.length-1:s.val--},v=()=>{s.val>=p.length-1?s.val=0:s.val++},S=a({class:"track",style:()=>`transform: translateX(${-100*s.val}%);`},p.map(g));return a({...w,class:I("carousel",l,i,t==null?void 0:t.class,w==null?void 0:w.class)},a({class:I("control","control-previous"),onclick:x},b()),a({class:I("control","control-next"),onclick:v},h()),S)}}const Qr=[{src:"https://source.unsplash.com//featured/200x201"},{src:"https://source.unsplash.com//featured/200x202"},{src:"https://source.unsplash.com//featured/200x203"}],es=e=>{const{bau:t,css:n}=e,{section:o,img:a}=t.tags,i=K(e,{class:n`
      &.button {
        opacity: 0.4;
        &:hover {
          opacity: 1;
...
`,us={title:"Checkbox",package:"checkbox",description:"The checkbox component uses the native input date type.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/checkbox/checkbox.js",importStatement:'import checkbox from "@grucloud/bau-ui/checkbox";',examples:[{title:"Default",description:"A simple checkbox.",code:ls,createComponent:cs}],gridItem:wn},ds=e=>{const t=j(e);return()=>t(us)},ps=e=>{const{bau:t}=e,{section:n,div:o}=t.tags,a=mt(e),i=K(e,{variant:"outline"}),s=()=>i("Header"),r=()=>o("Content");return()=>n(a({Header:s,Content:r}))},ms=`import button from "@grucloud/bau-ui/button";
...
`).join(`
`);function yn(e,t={}){const{bau:n,css:o}=e,{div:a,li:i}=n.tags,s=K(e),r=Ke(e),c=he(e),l=o`
    ${Ts()}
  `;return function(...d){let[{size:p=t.size??"md",variant:g=t.variant??"outline",color:b=t.color??"neutral",label:h,ListItem:w,items:x,...v},...S]=F(d);const E=n.state(0),M=()=>{W.openDialog(),W.focus()},D=()=>{W.closeDialog()},T=()=>{W.open?D():M()},A=q=>{T(),q.preventDefault()},N=({item:q,index:z})=>y=>{E.val=z,D(),y.preventDefault()},_=q=>{switch(q.preventDefault(),q.key){case"Escape":D();break;case"ArrowDown":E.val<options.length-1?E.val++:E.val=0;break;case"ArrowUp":E.val<=0?E.val=options.length-1:E.val--;break;case"Enter":T();break}},U=()=>c({tabindex:"0",class:I(b,g)},x.map((q,z)=>i({class:()=>I(E.val==z&&"active"),onclick:N({item:q,index:z})},w(q)))),Y=s({type:"button",onclick:A,color:b,variant:g,size:p},h),W=r({triggerEl:Y,contentEl:U()});return a({...v,class:I("dropdownMenu",b,p,l,t==null?void 0:t.class,v==null?void 0:v.class),onkeydown:_},Y,W)}}const As=(e,t)=>{const{bau:n}=e,{div:o,span:a}=n.tags,i=yn(e,t),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o(a(c.label));return c=>i({...c,items:s,ListItem:r,label:"Action"})},Is=e=>{const{bau:t}=e,{section:n,div:o,span:a}=t.tags,i=yn(e),s=[{label:"List"},{label:"Plan"},{label:"Apply"}],r=c=>o({onclick:()=>{alert(`click  ${c.label}`)}},a(c.label));return()=>n(i({items:s,ListItem:r,label:"Action"}))},Ds=`import dropdownMenu from "@grucloud/bau-ui/dropdownMenu";
import { Context } from "@grucloud/bau-ui/context";
...
`,r=o`
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",loading:g,...b},...h]=F(l);const w=K(e),x=Ce(e);return n.bind({deps:[g],render:()=>v=>w({...b,class:I("loadingButton",u,d,p,r,v&&"loading",t==null?void 0:t.class,b==null?void 0:b.class)},x({size:u,variant:d,color:p,visibility:v}),i({class:v&&"loading"},h))})}}const js=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,label:r,img:c,footer:l}=t.tags,u=vt(e),d=$e(e,{variant:"outline",color:"danger"}),p=fe(e),g=Be(e,{class:n`
      align-items: center;
      & > header {
        text-align: center;
      }
...
`,Bi={title:"RadioButton",package:"radioButton",description:"The radioButton component displays an input of type radio",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/radioButton/radioButton.js",importStatement:'import radioButton from "@grucloud/bau-ui/radioButton";',examples:[{title:"Simple RadioButton",description:"A simple radioButton.",code:$i,createComponent:Mi}],gridItem:Mn},Pi=e=>{const t=j(e);return()=>t(Bi)},Oi=()=>te.map(e=>`
& button.plain.${e}::after {
  color: var(--color-${e});
}
& button.outline.${e}::after {
...
`).join(`
`);function qe(e,t={}){const{bau:n,css:o}=e,{div:a,li:i,select:s,option:r}=n.tags,c=K(e),l=Ke(e),u=he(e),d=o`
    & select {
      width: 0;
      height: 0;
      opacity: 0;
    ...
    ${Oi()}
  `;return function(...g){let[{size:b=t.size??"md",variant:h=t.variant??"outline",color:w=t.color??"neutral",label:x,Option:v,options:S,defaultOption:E,getOptionLabel:M,getOptionValue:D,onSelect:T=()=>{},loading:A,...N},..._]=F(g);Ce(e,{variant:h,color:w,size:b});const U=n.state(E?M(E):x),Y=n.state(!1),W=n.state(0),q=()=>{B.openDialog(),B.focus(),Y.val=!0},z=()=>{B.closeDialog(),Y.val=!1},y=()=>{Y.val=!1},m=P=>{B.open?z():q(),P.preventDefault()},f=({option:P,index:L})=>Z=>{U.val=M(P),H.value=D(P),H.setCustomValidity(""),W.val=L,z(),T(P),Z.preventDefault()},C=P=>{switch(P.preventDefault(),P.key){case"Escape":z();break;case"ArrowDown":W.val<S.length-1?W.val++:W.val=0;break;case"ArrowUp":W.val<=0?W.val=S.length-1:W.val--;break;case"Enter":B.open?(U.val=M(S[W.val]),H.value=D(r),z()):q();break}},k=()=>u({tabindex:"0",class:I(w,h)},S.map((P,L)=>i({class:()=>I(W.val==L&&"active"),onclick:f({option:P,index:L})},v(P)))),R=c({type:"button",role:"combobox","aria-autocomplete":"list","aria-expanded":Y,"aria-label":x,onclick:m,color:w,variant:h,size:b,class:A==!0&&"loading",disabled:A},()=>!U.val&&x,U),B=l({triggerEl:R,contentEl:k(),onClose:y}),H=s(N,r({value:""},"--Select Category--"),S.map(P=>r({value:D(P)},M(P))));return H.value=N.value,a({...N,class:I("select",w,b,d,t==null?void 0:t.class,N==null?void 0:N.class),onkeydown:C},H,R,B)}}const $n=(e,t)=>{const{bau:n,css:o}=e,{div:a,span:i}=n.tags,s=qe(e,t),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:o`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return l=>s({...l,options:r,Option:c,getOptionValue:({code:u})=>u,getOptionLabel:({label:u})=>u,label:"Select a country..."})},Li=e=>{const{bau:t,css:n}=e,{section:o,div:a,span:i}=t.tags,s=qe(e),r=[{code:"AD",label:"Andorra",phone:"376"},{code:"AE",label:"United Arab Emirates",phone:"971"},{code:"AF",label:"Afghanistan",phone:"93"}],c=l=>a({class:n`
          display: flex;
          justify-content: space-between;
          gap: 0.5rem;
        `},i(l.label),i(l.code));return()=>o(s({options:r,Option:c,getOptionValue:({code:l})=>l,getOptionLabel:({label:l})=>l,label:"Select a country..."}))},zi=`import select from "@grucloud/bau-ui/select";
import { Context } from "@grucloud/bau-ui/context";
...
`,Fi={title:"SelectNative",package:"selectNative",description:"The selectNative component encapsulates the native html select.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/selectNative/selectNative.js",importStatement:'import selectNative from "@grucloud/bau-ui/selectNative";',examples:[{title:"Simple SelectNative",description:"A simple selectNative.",code:Ui,createComponent:Gi}],gridItem:Pn},Vi=e=>{const t=j(e);return()=>t(Fi)};function wt(e,t={}){const{bau:n,css:o,keyframes:a}=e,{div:i}=n.tags,s=a`
    0% {
      transform: translateX(-100%);
    }
    50% {
  ...
  `;return function(...l){let[{size:u=t.size??"md",variant:d=t.variant??"plain",color:p=t.color??"neutral",...g},...b]=F(l);return i({...g,class:I("skeleton",u,r,t==null?void 0:t.class,g==null?void 0:g.class)},...b)}}const Wi=e=>{const{bau:t,css:n}=e,{section:o,div:a}=t.tags,i=wt(e),s=()=>a({class:n`
          display: flex;
          gap: 1rem;
          flex-direction: column;
          margin: 1rem;
...
`,uc={title:"Spinner",package:"spinner",description:"The spinner component displays an animated loading spinner.",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/spinner/spinner.js",importStatement:'import spinner from "@grucloud/bau-ui/spinner";',examples:[{title:"Default",description:"A simple spinner.",code:lc,createComponent:cc}],gridItem:Ln},dc=e=>{const t=j(e);return()=>t(uc)},pc=()=>te.map(e=>`
`).join(`
...
`,bc=e=>{const{bau:t,css:n,config:o}=e,{section:a,div:i,h1:s}=t.tags,{svg:r,use:c}=t.tagsNS("http://www.w3.org/2000/svg"),l=K(e,{variant:"outline",color:"primary"});return function({onclickProvider:d}){return a(s("Provider selection"),i({class:n`
    ...
    `;return S({name:"form-config-azure",onsubmit:T,"data-infra-create":!0,class:A},i(a("Azure Configuration"),s("Please follow the instructions to setup a service principal used by Grucloud to scan an Azure infrastructure.")),o(l(u(d("Subscription Id"),s("Retrieve the ",g("Subscription Id")," with the following command:"),p("az account show --query id -otsv"),r("Subscription Id",v({"data-input-azure-subscription-id":!0,autofocus:!0,placeholder:"Subscription Id",name:"subscriptionId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("Tenant Id"),s("Retrieve the ",g("Tenant Id")," with the following command:"),p("az account show"),r("Tenant Id",v({"data-input-azure-tenant-id":!0,placeholder:"Tenant Id",name:"tenantId",minLength:36,maxLength:36,size:36,required:!0}))),u(d("App ID and PASSWORD"),s("Retrieve the ",g("APP_ID")," and ",g("PASSWORD")," by creating a service principal called grucloud:"),p('az ad sp create-for-rbac -n "grucloud"'),b({class:n`
                  ...
                  flex-direction: column;
                  gap: 1rem;
                `},r("App Id",v({"data-input-azure-app-id":!0,placeholder:"App Id",name:"appId",minLength:36,maxLength:36,size:36,required:!0})),r("Password",v({"data-input-azure-password":!0,type:"password",placeholder:"Password",name:"password",minLength:8,maxLength:64,size:64,required:!0})))))),x(w({onclick:M}),h({type:"submit",variant:"outline",color:"primary"},"Next",c("▶"))))}},Cc=e=>{const{bau:t,css:n,config:o}=e,{section:a,h1:i,header:s,p:r,div:c,i:l,ol:u,li:d,span:p,em:g,a:b,table:h,tbody:w,th:x,tr:v,td:S}=t.tags,{svg:E,use:M}=t.tagsNS("http://www.w3.org/2000/svg"),D=ft(e),T=K(e),A=Be(e),N=Ye(e),_=Ze(e);return function({onclickPrevious:Y,onclickNext:W}){const q=t.state("No file selected"),z=t.state({}),y=t.state(!0),m=B=>{const H=B.target.files[0];if(H){q.val=H.name;const P=new FileReader;P.readAsText(H),P.onload=()=>{try{debugger;if(P.result){const L=JSON.parse(P.result);z.val=L,L.project_id&&(y.val=!1)}}catch{}},P.onerror=()=>{console.log(P.error)}}else q.val=""},f=({fileName:B,content:H})=>h({class:n`
          ...
          `},w(v(x("Credential File"),S(B)),v(x("Project Name"),S(H.project_id)),v(x("Service Account"),S(H.client_email)))),C=({})=>c({class:n`
            display: inline-flex;
            align-items: center;
            flex-direction: column;
            stroke: var(--font-color-base);
...
`,Lc=e=>{const{bau:t}=e,{div:n,p:o}=t.tags,i=Pe(e,{tabDefs:[{name:"Tab1",Header:()=>n("TAB 1"),Content:()=>n(o("My Content")),enter:async()=>console.log("tab1 enter"),exit:async()=>console.log("tab1 exit")},{name:"Tab2",Header:()=>n("TAB 2"),Content:()=>n(o("My TAB 2 Content")),enter:async()=>console.log("tab2 enter"),exit:async()=>console.log("tab2 exit")},{name:"Tab Disabled",disabled:!0,Header:()=>n("Tab Disabled"),Content:()=>n(o("My Content Disabled"))}]});return()=>i({variant:"outline",color:"success"})},zc=`import tabs from "@grucloud/bau-ui/tabs";
import { Context } from "@grucloud/bau-ui/context";
...
`;const s=o`
  ...
  `;return function(...c){let[{...l},...u]=F(c);return i({...l,class:I("table-container",s,t==null?void 0:t.class,l==null?void 0:l.class)},...u)}}const Fc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags;function d(w,x,v,S,E){return{name:w,calories:x,fat:v,carbs:S,protein:E}}const p=[d("Frozen yoghurt",159,6,24,4),d("Ice cream sandwich",237,9,37,4.3),d("Eclair",262,16,24,6),d("Cupcake",305,3.7,67,4.3),d("Gingerbread",356,16,49,3.9)],g=({name:w,calories:x})=>s(i(w),i({class:n`
      ...
      max-width: 650px;
    `});return()=>o(h(r(u("Basic Table"),b(),l(p.map(g)))))},Vc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
...
`;function Te(e,t,n,o,a){return{name:e,calories:t,fat:n,carbs:o,protein:a}}const Wc=[Te("Frozen yoghurt",159,6,24,4),Te("Ice cream sandwich",237,9,37,4.3),Te("Eclair",262,16,24,6),Te("Cupcake",305,3.7,67,4.3),Te("Gingerbread",356,16,49,3.9)],Kc=e=>{const{bau:t,css:n}=e,{section:o,th:a,td:i,tr:s,table:r,thead:c,tbody:l,caption:u}=t.tags,d=({name:b,calories:h})=>s(i(b),i({class:n`
    ...
    `});return()=>o(g(r(u("Table Dense"),p(),l(Wc.map(d)))))},qc=`import tableContainer from "@grucloud/bau-ui/tableContainer";
import { Context } from "@grucloud/bau-ui/context";
  ...
  `,l=({label:b,icon:h,...w})=>s({"aria-label":b,title:b,...w},h),u=({count:b,totalCount:h,page:w,rowsPerPage:x})=>a({class:"pages-numbers"},Number(w-1)*Number(x)+(b>0?1:0),"-",Math.min(w*x,h)," of ",h),d=({count:b,page:h,rowsPerPage:w})=>a({class:"pages-numbers"},(h-1)*w+(b>0?1:0),"-",h*w),p=b=>b<=1,g=(b,h,w)=>b>=Math.ceil(h/w);return function(...h){let[{size:w=t.size??"md",variant:x=t.variant??"outline",color:v=t.color??"neutral",count:S=0,totalCount:E=0,page:M=1,rowsPerPage:D=50,onPageChange:T,isLoading:A=!1,disableFirst:N=()=>p(M),disablePrevious:_=()=>p(M),disableNext:U=()=>g(M,E,D),disableLast:Y=()=>g(M,E,D),...W},...q]=F(h);const z=Math.max(0,Math.ceil(E/D)),y=T({page:1}),m=T({page:M-1}),f=T({page:M+1}),C=T({page:z}),k=[{label:"First",icon:"⟪",onclick:y,disabled:N()},{label:"Previous",icon:"⟨",onclick:m,disabled:_()},{label:"Next",icon:"⟩",onclick:f,disabled:U()},{label:"Last",icon:"⟫",onclick:C,disabled:Y()}];return a({...W,class:I("table-pagination",c,A&&"disabled",t==null?void 0:t.class,W==null?void 0:W.class)},r({class:"spinner",visibility:A,size:"md"}),E>0?u({count:S,totalCount:E,page:M,maxPages:z,rowsPerPage:D}):d({count:S,page:M,maxPages:z,rowsPerPage:D}),i({variant:x,color:v},k.map(R=>l({...R,variant:x,color:v}))))}}const al=(e=1e3)=>new Array(e).fill("").map(()=>({name:"my name",email:"myemail@mail.com"})),rl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c}=t.tags,l=al(45),u=({name:v,email:S})=>i(a(v),a(S)),d=()=>r(o({class:n`
    ...
    `}),b=t.state(l),h=t.state({count:l.length,totalCount:l.length,page:1,rowsPerPage:10}),w=t.derive(()=>b.val.slice(h.val.page*h.val.rowsPerPage,(h.val.page+1)*h.val.rowsPerPage)),x=({page:v})=>S=>{h.val.page=v};return()=>g(s(d(),()=>c(w.val.map(u))),()=>p({...h.val,onPageChange:x}))},sl=e=>{const{bau:t,css:n}=e,{th:o,td:a,tr:i,table:s,thead:r,tbody:c,div:l}=t.tags,u=t.state(!1),d=t.state([]),p=t.state(""),g=t.derive(()=>d.val.length),b=t.state(1),h=t.state(10),w=t.derive(()=>d.val),x=N=>`https://api.github.com/orgs/aws/repos?${new URLSearchParams(N).toString()}`,v=({page:N})=>_=>{b.val=N,S(x({page:N,per_page:h.val}))};S(x({page:1,per_page:h.val}));async function S(N){try{u.val=!0;const _=await fetch(N,{});if(_.ok){const U=await _.json();d.val=U;return}throw _}catch(_){p.val=_.message}finally{u.val=!1}}const E=({name:N,description:_,stargazers_count:U})=>i(a(N),a(_),a({class:n`
          ...
          `},"Description"),o({class:n`
            text-align: right;
          `},"Stars")),D=Gn(e),T=Oe(e,{class:n`
      min-width: 650px;
    `}),A=({message:N})=>l(N);return()=>T(()=>D({rowsPerPage:h.val,page:b.val,count:g.val,totalCount:-1,isLoading:u.val,onPageChange:v,disableNext:()=>!1}),s(M(),()=>p.val&&A({message:p.val}),()=>c(w.val.map(E))))},il=e=>{const{bau:t,css:n}=e,{section:o,div:a,h3:i,h2:s,tr:r}=t.tags,c=rl(e),l=sl(e),u=(...d)=>a({class:n`
...
`);function yt(e,t={}){const{bau:n,css:o}=e,{div:a}=n.tags,i=o`
    ...
    ${pl()}
  `;return function(...r){let[{size:c=t.size??"md",variant:l=t.variant??"outline",color:u=t.color??"neutral",exclusive:d=!1,onChange:p=()=>{},...g},...b]=F(r);const h=new Set,w=x=>{const{value:v}=x.target;d?(h.clear(),h.add(v)):h.has(v)?h.delete(v):h.add(v),p({event:x,values:[...h]})};return a({...g,class:I("toggle-group",c,u,l,i,t==null?void 0:t.class,g==null?void 0:g.class),onclick:w},...b)}}const Fn=(e,t)=>{const{bau:n}=e,o=yt(e,t),a=Le(e,t);return i=>{const s=n.state([""]),r=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}];return o({...i,onChange:({values:l})=>{s.val=l}},r.map(({label:l,value:u})=>()=>a({...i,value:u,selected:s.val.includes(u),"area-label":l},l)))}},ml=e=>{const{bau:t}=e,{section:n}=t.tags,o=t.state([""]),a=[{value:"one",label:"ONE"},{value:"two",label:"TWO"},{value:"three",label:"THREE"}],i=Le(e),s=yt(e),r="primary",c="solid",l=({values:u})=>{o.val=u};return()=>n(s({color:r,variant:c,exclusive:!0,onChange:l},a.map(({label:u,value:d})=>()=>i({color:r,variant:c,value:d,selected:o.val.includes(d),"area-label":u},u))))},gl=`import toggleGroup from "@grucloud/bau-ui/toggleGroup";
...
`,{nav:e`
  ...
  `});function Kn(e,t={}){const{bau:n,css:o,createGlobalStyles:a}=e,{renderMenuItem:i}=t,{ul:s,li:r,nav:c,div:l}=n.tags,u=Dl({css:o,createGlobalStyles:a}),d=mt(e),p=({depth:g=1,maxDepth:b,color:h,variant:w,size:x})=>v=>{const{children:S,expanded:E}=v,M=n.state(!E),D=()=>l({class:o`
              cursor: pointer;
              display: flex;
              width: 100%;
            `,onclick:A=>{S&&(M.val=!M.val)}},i(v.data)),T=()=>s({class:I(h,x)},S.map(p({depth:g+1,maxDepth:b})));return r(d({size:x,Header:D,Content:S&&g<b&&T}))};return function({tree:b,maxDepth:h=1/0,size:w=t.size??"md",variant:x=t.variant??"outline",color:v=t.color??"neutral",...S}){return c({class:I(u.nav,w,x,v,t==null?void 0:t.class,S.class)},b.children&&s(b.children.map(p({maxDepth:h,color:v,variant:x,size:w}))))}}const qn=(e,t)=>{const{bau:n}=e,{a:o}=n.tags,a={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},s=Kn(e,{renderMenuItem:({name:r,href:c})=>o({href:c},r),...t});return r=>s({...r,tree:a})},Nl=e=>{const{bau:t}=e,{a:n}=t.tags,o={data:{name:"Root Menu"},children:[{data:{name:"Menu 1",href:"#menu"},expanded:!0,children:[{data:{name:"Sub Menu 1",href:"#menusub2"}},{data:{name:"Sub Menu 2",href:"#menusub1"}}]},{data:{name:"Menu 2",href:"#menu2"},children:[{data:{name:"Sub Menu 21",href:"#menusub21"}}]}]},i=Kn(e,{renderMenuItem:({name:s,href:r})=>n({href:r},s)});return()=>i({tree:o})},Ml=`import treeView, { type Tree } from "@grucloud/bau-ui/treeView";
import { Context } from "@grucloud/bau-ui/context";
...
`,$l={title:"Tree View",package:"treeview",description:"A tree view displays a hierarchical list",sourceCodeUrl:"https://github.com/grucloud/bau/blob/main/bau-ui/treeview/treeview.js",importStatement:'import treeview from "@grucloud/bau-ui/treeview";',examples:[{title:"Default",description:"A simple treeview.",code:Ml,createComponent:Nl}],gridItem:qn},Bl=e=>{const t=j(e);return()=>t($l)},Pl=e=>{const{bau:t,css:n}=e,{section:o,div:a,h1:i,p:s,ul:r,li:c}=t.tags,l=on(e),u=K(e),d=[{name:"Accordion",Item:an(e)},{name:"Alert",Item:sn(e)},{name:"Autocomplete",Item:un(e)},{name:"Avatar",Item:ln(e)},{name:"Badge",Item:pn(e)},{name:"Breadcrumbs",Item:mn(e)},{name:"Button",Item:gn(e)},{name:"Button Group",Item:bn(e)},{name:"Calendar",Item:fn(e)},{name:"Checkbox",Item:wn(e)},{name:"Chip",Item:vn(e)},{name:"DrillDown Menu",Item:Sn(e,{base:"/components",hashBased:!0})},{name:"File Input",Item:Cn(e)},{name:"Input",Item:kn(e)},{name:"Input Search",Item:En(e)},{name:"Linear Progress",Item:An(e)},{name:"Loading Button",Item:In(e)},{name:"Modal",Item:Dn(e)},{name:"Radio Button",Item:Mn(e)},{name:"Select",Item:$n(e)},{name:"Select Native",Item:Pn(e)},{name:"Slider",Item:On(e)},{name:"Spinner",Item:Ln(e)},{name:"Switch",Item:Rn(e)},{name:"Tabs",Item:jn(e)},{name:"Theme Switch",Item:Wn(e)},{name:"Toggle",Item:Un(e)},{name:"Toggle Group",Item:Fn(e)},{name:"Tooltip",Item:Vn(e)},{name:"Tree View",Item:qn(e)}];return()=>o({class:n`
  ...
  `};mo();const Xn={title:"Bau",base:"/bau/bau-ui"},ge=yo({config:Xn}),{bau:Rl}=ge;ge.states={drawerOpen:Rl.state(!0)};_l(ge);no({routes:Ol({context:ge}),onLocationChange:zl({context:ge,LayoutDefault:Mo(ge),config:Xn}),notFoundRoute:Ll(ge)});
